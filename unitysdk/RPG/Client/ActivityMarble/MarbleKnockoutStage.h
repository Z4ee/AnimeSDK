...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_CURRENTMATCHNUMBER_OFFSET UNITYSDK_OFFSET(0xC624920)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PHASE_OFFSET UNITYSDK_OFFSET(0xC624580)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0xC6249A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xC624960)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xC6249C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xC624980)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_TOTALMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xC624940)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_INIT_OFFSET UNITYSDK_OFFSET(0xC623FD0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_OPENSETTLEPAGEVIEW_OFFSET UNITYSDK_OFFSET(0xC6247C0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_OPENSTAGEINFOPAGEVIEW_OFFSET UNITYSDK_OFFSET(0xC624660)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_CURRENTMATCHNUMBER_OFFSET UNITYSDK_OFFSET(0xC624930)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0xC6249B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_PROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xC624970)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_REWARDID_OFFSET UNITYSDK_OFFSET(0xC6249D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xC624990)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_TOTALMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0xC624950)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SYNC_OFFSET UNITYSDK_OFFSET(0xC6245D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC623FC0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleKnockoutStage_TypeDefinitionIndex = 74586;
