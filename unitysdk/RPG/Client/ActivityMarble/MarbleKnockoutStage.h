...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_CURRENTMATCHNUMBER_OFFSET UNITYSDK_OFFSET(0x19A82E00)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x19A82A60)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0x19A82E80)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_PROGRESSNAME_OFFSET UNITYSDK_OFFSET(0x19A82E40)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x19A82EA0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x19A82E60)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_GET_TOTALMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0x19A82E20)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_INIT_OFFSET UNITYSDK_OFFSET(0x19A824B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_OPENSETTLEPAGEVIEW_OFFSET UNITYSDK_OFFSET(0x19A82CA0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_OPENSTAGEINFOPAGEVIEW_OFFSET UNITYSDK_OFFSET(0x19A82B40)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_CURRENTMATCHNUMBER_OFFSET UNITYSDK_OFFSET(0x19A82E10)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_PROGRESSID_OFFSET UNITYSDK_OFFSET(0x19A82E90)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_PROGRESSNAME_OFFSET UNITYSDK_OFFSET(0x19A82E50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_REWARDID_OFFSET UNITYSDK_OFFSET(0x19A82EB0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x19A82E70)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SET_TOTALMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0x19A82E30)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE_SYNC_OFFSET UNITYSDK_OFFSET(0x19A82AB0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEKNOCKOUTSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A824A0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleKnockoutStage_TypeDefinitionIndex = 71279;
