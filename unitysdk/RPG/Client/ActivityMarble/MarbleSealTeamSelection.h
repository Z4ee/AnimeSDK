...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ADDMEMBER_OFFSET UNITYSDK_OFFSET(0x19A990B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CLEARMEMBERS_OFFSET UNITYSDK_OFFSET(0x19A98A80)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEEMPTY_OFFSET UNITYSDK_OFFSET(0x19A902F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEFULLTEAM_OFFSET UNITYSDK_OFFSET(0x19A90200)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEWITHDEFAULTMEMBERS_1_OFFSET UNITYSDK_OFFSET(0x19A986D0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEWITHDEFAULTMEMBERS_OFFSET UNITYSDK_OFFSET(0x19A8FE20)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETFIRSTEMPTYINDEX_OFFSET UNITYSDK_OFFSET(0x19A98E90)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMARBLESEALDATABYTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x19A83B10)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMARBLESUBSEALDATABYTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x19A84E50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMEMBERIDS_OFFSET UNITYSDK_OFFSET(0x19A98B50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMEMBERSCOUNT_OFFSET UNITYSDK_OFFSET(0x19A98F90)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETMEMBERS_OFFSET UNITYSDK_OFFSET(0x19A8D3B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETONFIELDMARBLESEALDATABYTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x19A84C50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETONFIELDMEMBERS_OFFSET UNITYSDK_OFFSET(0x19A97CD0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GETTEAMINDEXBYMARBLESEALDATA_OFFSET UNITYSDK_OFFSET(0x19A98F10)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GET_MAXSELECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19A99230)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_GET__MGR_OFFSET UNITYSDK_OFFSET(0x19A98640)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x19A87CE0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ISFULL_OFFSET UNITYSDK_OFFSET(0x19A98CC0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_ISSAMETEAM_OFFSET UNITYSDK_OFFSET(0x19A98D50)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_REMOVEMEMBER_OFFSET UNITYSDK_OFFSET(0x19A83D20)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SETFULLTEAM_OFFSET UNITYSDK_OFFSET(0x19A98320)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SETISINEDITMODE_OFFSET UNITYSDK_OFFSET(0x19A98B00)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SETMEMBER_OFFSET UNITYSDK_OFFSET(0x19A99170)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SET_MAXSELECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19A99240)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_SYNCSERVERTEAM_OFFSET UNITYSDK_OFFSET(0x19A8FAE0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A982D0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleSealTeamSelection_TypeDefinitionIndex = 71271;
	...
	public:
		...
		::Enum_3_01618AD0437C8486_2 _GameMode; // 0x18
		::System::Boolean _IsInEditMode; // 0x1C
		::System::Int32 _MaxSelectionCount_k__BackingField; // 0x20

		::System::Void _ctor(::System::Int32 a1, ::Enum_3_01618AD0437C8486_2 a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Enum_3_01618AD0437C8486_2))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION__CTOR_OFFSET))(this, a1, a2);
		}

		static ::RPG::Client::ActivityMarble::MarbleSealTeamSelection* CreateEmpty(::Enum_3_01618AD0437C8486_2 a1)
		{
			return ((::RPG::Client::ActivityMarble::MarbleSealTeamSelection*(*)(::Enum_3_01618AD0437C8486_2))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEEMPTY_OFFSET))(a1);
		}

		static ::RPG::Client::ActivityMarble::MarbleSealTeamSelection* CreateFullTeam(::System::Collections::Generic::IList_1<::System::UInt32>* a1, ::Enum_3_01618AD0437C8486_2 a2)
		{
			return ((::RPG::Client::ActivityMarble::MarbleSealTeamSelection*(*)(::System::Collections::Generic::IList_1<::System::UInt32>*, ::Enum_3_01618AD0437C8486_2))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEFULLTEAM_OFFSET))(a1, a2);
		}

		static ::RPG::Client::ActivityMarble::MarbleSealTeamSelection* CreateWithDefaultMembers(::System::Collections::Generic::IEnumerator_1<::System::UInt32>* a1, ::Enum_3_01618AD0437C8486_2 a2)
		{
			return ((::RPG::Client::ActivityMarble::MarbleSealTeamSelection*(*)(::System::Collections::Generic::IEnumerator_1<::System::UInt32>*, ::Enum_3_01618AD0437C8486_2))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEWITHDEFAULTMEMBERS_OFFSET))(a1, a2);
		}

		static ::RPG::Client::ActivityMarble::MarbleSealTeamSelection* CreateWithDefaultMembers_1(::System::Collections::Generic::IList_1<::System::UInt32>* a1, ::Enum_3_01618AD0437C8486_2 a2, ::System::Int32 a3)
		{
			return ((::RPG::Client::ActivityMarble::MarbleSealTeamSelection*(*)(::System::Collections::Generic::IList_1<::System::UInt32>*, ::Enum_3_01618AD0437C8486_2, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALTEAMSELECTION_CREATEWITHDEFAULTMEMBERS_1_OFFSET))(a1, a2, a3);
		}
