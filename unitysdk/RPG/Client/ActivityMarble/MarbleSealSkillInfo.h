...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GETDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8F6C570)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0x8F6C790)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_DESC_OFFSET UNITYSDK_OFFSET(0x8F6C710)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x8F6C880)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x8F6C8F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x8F6C800)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8F6C960)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_ROW_OFFSET UNITYSDK_OFFSET(0x8F6C820)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_GET_UPDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8F6C9E0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_SETUPDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8F69730)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_SET_ID_OFFSET UNITYSDK_OFFSET(0x8F6C810)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO_SET_UPDESCCONTENT_OFFSET UNITYSDK_OFFSET(0x8F6C9F0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLESEALSKILLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8F69710)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleSealSkillInfo_TypeDefinitionIndex = 61426;
