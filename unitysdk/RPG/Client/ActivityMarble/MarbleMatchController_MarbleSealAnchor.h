...
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C05640)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_GETMARBLESEALROOT_OFFSET UNITYSDK_OFFSET(0x9C05ED0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_GET_MARBLESUBSEALID_OFFSET UNITYSDK_OFFSET(0x9C06490)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_LOADMARBLESEAL_OFFSET UNITYSDK_OFFSET(0x9C06370)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_LOADMARBLESUBSEAL_OFFSET UNITYSDK_OFFSET(0x9C065A0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_RELEASEMARBLESEAL_OFFSET UNITYSDK_OFFSET(0x9C06240)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_RELEASEMARBLESUBSEAL_OFFSET UNITYSDK_OFFSET(0x9C064B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR_SETSCALE_OFFSET UNITYSDK_OFFSET(0x9C060B0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__BINDSUBSEALROTATOR_OFFSET UNITYSDK_OFFSET(0x9C06D20)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9C06060)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__GETMARBLESEALENTITY_OFFSET UNITYSDK_OFFSET(0x9C06670)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__ONMODELLOADED_OFFSET UNITYSDK_OFFSET(0x9C06730)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__ONSWIMRINGLOADED_OFFSET UNITYSDK_OFFSET(0x9C06EF0)
#define RPG_CLIENT_ACTIVITYMARBLE_MARBLEMATCHCONTROLLER_MARBLESEALANCHOR__TRIGGERANIM_OFFSET UNITYSDK_OFFSET(0x9C06C10)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int MarbleMatchController_MarbleSealAnchor_TypeDefinitionIndex = 68926;
