...
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW_CREATE_OFFSET UNITYSDK_OFFSET(0x19A99260)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19A99EB0)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19A992E0)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW_LOADMODEL_OFFSET UNITYSDK_OFFSET(0x19A99350)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW_RELEASEMODEL_OFFSET UNITYSDK_OFFSET(0x19A99470)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A99F00)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x19A99250)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW__DISPOSEMARBLESEALENTITY_OFFSET UNITYSDK_OFFSET(0x19A99C20)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW__GETMARBLESEALENTITY_OFFSET UNITYSDK_OFFSET(0x19A994D0)
#define RPG_CLIENT_ACTIVITYMARBLE_UI3DMARBLESEALVIEW__ONMODELLOADED_OFFSET UNITYSDK_OFFSET(0x19A995E0)

namespace RPG::Client::ActivityMarble
{
	inline static constexpr unsigned int UI3DMarbleSealView_TypeDefinitionIndex = 71272;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UI3DMarbleSealView_TypeDefinitionIndex)->GetStaticField(0xBC90);
		}
