...
#define RPG_CLIENT_NPCMANAGER___C__DISPLAYCLASS2_0__CREATENPC_B__0_OFFSET UNITYSDK_OFFSET(0x9DEFBE0)
#define RPG_CLIENT_NPCMANAGER___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9DE9530)
