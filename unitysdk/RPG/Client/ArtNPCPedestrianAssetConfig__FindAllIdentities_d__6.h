...
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x90D7D00)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x90D7E20)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x90D7DB0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x90D7EA0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x90D7E10)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x90D7DC0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x90D7CF0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x90D7440)

namespace RPG::Client
{
	inline static constexpr unsigned int ArtNPCPedestrianAssetConfig__FindAllIdentities_d__6_TypeDefinitionIndex = 56591;
