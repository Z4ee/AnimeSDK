...
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC77B860)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xC77B970)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC77B900)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xC77B9F0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC77B960)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC77B910)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC77B850)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__FINDALLIDENTITIES_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0xC77AFC0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Il2CppArray<::RPG::Client::ArtNPCPedestrianAssetConfig_IdentityData*>* __7__wrap1; // 0x20
