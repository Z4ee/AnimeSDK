...
#define RPG_CLIENT_ROGUEMAGICMODULE___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B69A160)
#define RPG_CLIENT_ROGUEMAGICMODULE___C__DISPLAYCLASS9_0__SHOWENTRANCEPAGEWITHROGUESELECTMAINPAGEPROMISED_B__0_OFFSET UNITYSDK_OFFSET(0x1B69FC20)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicModule___c__DisplayClass9_0_TypeDefinitionIndex = 67408;
