...
#define RPG_CLIENT_STORYLINEUTILS_SHOWSWITCHLINEDIALOGONDEMAND_OFFSET UNITYSDK_OFFSET(0xB1E1010)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryLineUtils_TypeDefinitionIndex = 62685;
