...
#define RPG_CLIENT_STORYLINEUTILS_SHOWSWITCHLINEDIALOGONDEMAND_OFFSET UNITYSDK_OFFSET(0xC93AC10)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryLineUtils_TypeDefinitionIndex = 63618;
