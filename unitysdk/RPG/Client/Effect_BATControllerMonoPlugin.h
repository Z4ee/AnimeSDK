...
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA1C08D0)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN_UPDATERENDERERPACKAGES_OFFSET UNITYSDK_OFFSET(0xA1C05A0)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA1C0920)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA1C0930)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_BATControllerMonoPlugin_TypeDefinitionIndex = 64932;
