...
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x953DBA0)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN_UPDATERENDERERPACKAGES_OFFSET UNITYSDK_OFFSET(0x953D870)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x953DBF0)
#define RPG_CLIENT_EFFECT_BATCONTROLLERMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x953DC00)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_BATControllerMonoPlugin_TypeDefinitionIndex = 57668;
