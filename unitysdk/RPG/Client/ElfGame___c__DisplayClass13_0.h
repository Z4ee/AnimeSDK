...
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x95B2510)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS13_0___DISABLEELFSTREAMING_B__0_OFFSET UNITYSDK_OFFSET(0x95B6330)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfGame___c__DisplayClass13_0_TypeDefinitionIndex = 51739;
