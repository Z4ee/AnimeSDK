...
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_APPLY_1_OFFSET UNITYSDK_OFFSET(0xD1B65B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_APPLY_2_OFFSET UNITYSDK_OFFSET(0xD1B6610)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_APPLY_OFFSET UNITYSDK_OFFSET(0xD1B5B20)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_CREATECOMPARER_OFFSET UNITYSDK_OFFSET(0xD1B6480)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_FILTERROLE_OFFSET UNITYSDK_OFFSET(0xD1B6770)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_FILTERTRAIT_OFFSET UNITYSDK_OFFSET(0xD1B6BF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GETCURSEASONALLROLES_OFFSET UNITYSDK_OFFSET(0xD1B75D0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GETCURSEASONALLTRAITS_OFFSET UNITYSDK_OFFSET(0xD1B78E0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GETFILTERTRAITCOUNTBYTYPE_OFFSET UNITYSDK_OFFSET(0xD1B6DE0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_FILTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0xD1B7040)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_FILTEREDROLES_OFFSET UNITYSDK_OFFSET(0xD1B7220)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_FILTEREDTRAITS_OFFSET UNITYSDK_OFFSET(0xD1B7090)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_ISFILTERON_OFFSET UNITYSDK_OFFSET(0xD1B6ED0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_ROLEFILTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0xD1B6FA0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_ROLEFILTERLIMIT_OFFSET UNITYSDK_OFFSET(0xD1B73B0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_TRAITFILTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0xD1B6FF0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_GET_TRAITFILTERLIMIT_OFFSET UNITYSDK_OFFSET(0xD1B74C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_INIT_OFFSET UNITYSDK_OFFSET(0xD1B6660)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_ISFILTEREDROLE_OFFSET UNITYSDK_OFFSET(0xD1B6B30)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_ISFILTEREDTRAIT_OFFSET UNITYSDK_OFFSET(0xD1B6D20)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_REMOVEROLE_OFFSET UNITYSDK_OFFSET(0xD1B6980)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_REMOVETRAIT_OFFSET UNITYSDK_OFFSET(0xD1B6CA0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER_RESET_OFFSET UNITYSDK_OFFSET(0xD1B66C0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__CREATEROLE_OFFSET UNITYSDK_OFFSET(0xD1B7870)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD1B7C30)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__FORMATIONHASAVATAR_OFFSET UNITYSDK_OFFSET(0xD1B61A0)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__FORMATIONHASTRAIT_OFFSET UNITYSDK_OFFSET(0xD1B6330)
#define RPG_CLIENT_GRIDFIGHTGAMEFORMATIONFILTER__GETCURSEASONALLROLES_B__38_0_OFFSET UNITYSDK_OFFSET(0xD1B7D50)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::GridFightTraitConfig*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormationFilter_TypeDefinitionIndex)->GetStaticField(0x2F440);
		}
		static ::System::Collections::Generic::List_1<::RPG::Client::GridFightRole*>** StaticGet__CurSeasonRoles()
		{
			return (::System::Collections::Generic::List_1<::RPG::Client::GridFightRole*>**)Il2CppClass::FromTypeDefinitionIndex(GridFightGameFormationFilter_TypeDefinitionIndex)->GetStaticField(0x2F448);
		}
		::System::Action* _OnFilterChange; // 0x10
		::System::Collections::Generic::IEnumerable_1<::RPG::Client::GridFightGameFormation*>* _RawDatas; // 0x18
		...
		::System::Collections::Generic::List_1<::RPG::Client::GridFightGameFormation*>* _CachedFilteredFormations; // 0x38
