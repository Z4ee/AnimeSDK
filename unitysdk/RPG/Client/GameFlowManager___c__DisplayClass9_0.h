...
#define RPG_CLIENT_GAMEFLOWMANAGER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBAB84E0)
#define RPG_CLIENT_GAMEFLOWMANAGER___C__DISPLAYCLASS9_0__GETORTRYENTERGAMEFLOW_B__0_OFFSET UNITYSDK_OFFSET(0xBAB8B20)

namespace RPG::Client
{
	inline static constexpr unsigned int GameFlowManager___c__DisplayClass9_0_TypeDefinitionIndex = 60126;
