...
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_ADDMODIFIERSOURCE_OFFSET UNITYSDK_OFFSET(0x1A607C40)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GETBASEVALUE_OFFSET UNITYSDK_OFFSET(0x1A607FA0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A607CF0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GET_DETAIL_OFFSET UNITYSDK_OFFSET(0x1A607B80)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GET_OVERVIEW_OFFSET UNITYSDK_OFFSET(0x1A607B10)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_GET__TRAIT_OFFSET UNITYSDK_OFFSET(0x1A607AC0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_SETUPTRAIT_OFFSET UNITYSDK_OFFSET(0x1A607BF0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6083B0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A608330)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETABILITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A6082B0)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETBATTLEFINALVALUE_OFFSET UNITYSDK_OFFSET(0x1A608180)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETFINALVALUE_OFFSET UNITYSDK_OFFSET(0x1A607D90)
#define RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY__GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A6081E0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitEffectElationProperty_TypeDefinitionIndex = 62447;
	...
	public:
		...
		{
			return (::Class_2_BEDE94774D30A3D8**)Il2CppClass::FromTypeDefinitionIndex(GridFightTraitEffectElationProperty_TypeDefinitionIndex)->GetStaticField(0x2E060);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_723*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTTRAITEFFECTELATIONPROPERTY_ADDMODIFIERSOURCE_OFFSET))(this, a1);
		}
