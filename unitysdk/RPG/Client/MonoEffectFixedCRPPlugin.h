...
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x10CE4420)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x10CE3EC0)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_METHOD_6_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0x10CE4560)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_METHOD_6_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x10CE3FA0)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_METHOD_6_43E290A0B26B39F6_OFFSET UNITYSDK_OFFSET(0x10CE46D0)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_METHOD_6_C1B8E22342A271F3_OFFSET UNITYSDK_OFFSET(0x10CE4130)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_METHOD_6_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0x10CE4020)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x10CE4230)
#define RPG_CLIENT_MONOEFFECTFIXEDCRPPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE4A60)
