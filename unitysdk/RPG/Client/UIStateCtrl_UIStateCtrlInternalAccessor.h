...
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GETSTATEDATABYSTATENAME_OFFSET UNITYSDK_OFFSET(0xCB98830)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_ASSETLOADER_OFFSET UNITYSDK_OFFSET(0xCB98900)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_STATEDATAS_OFFSET UNITYSDK_OFFSET(0xCB988E0)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_PLAYASSUBSTATE_OFFSET UNITYSDK_OFFSET(0xCB98710)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_TRYUPDATESTATUSOFCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xCB98890)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCB986A0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIStateCtrl_UIStateCtrlInternalAccessor_TypeDefinitionIndex = 64639;
