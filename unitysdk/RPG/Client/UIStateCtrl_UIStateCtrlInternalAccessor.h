...
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GETSTATEDATABYSTATENAME_OFFSET UNITYSDK_OFFSET(0xE3BA830)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_ASSETLOADER_OFFSET UNITYSDK_OFFSET(0xE3BA900)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_CURRENTPLAYTIME_OFFSET UNITYSDK_OFFSET(0xE3BA9E0)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_CURRENTSTATEDATA_OFFSET UNITYSDK_OFFSET(0xE3BA920)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0xE3BA980)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_PARENTUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xE3BAA40)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_GET_STATEDATAS_OFFSET UNITYSDK_OFFSET(0xE3BA8E0)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_PLAYASSUBSTATE_OFFSET UNITYSDK_OFFSET(0xE3BA710)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR_TRYUPDATESTATUSOFCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xE3BA890)
#define RPG_CLIENT_UISTATECTRL_UISTATECTRLINTERNALACCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE3BA6A0)
