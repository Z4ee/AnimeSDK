...
#define RPG_CLIENT_POOLABLEBINDER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9FF4B80)
#define RPG_CLIENT_POOLABLEBINDER_ISPOOLABLE_OFFSET UNITYSDK_OFFSET(0x9FF4D60)
#define RPG_CLIENT_POOLABLEBINDER_METHOD_5_336790322D186E73_OFFSET UNITYSDK_OFFSET(0x9FF4C80)
#define RPG_CLIENT_POOLABLEBINDER_METHOD_5_3BC8B8F2BB08C1C2_OFFSET UNITYSDK_OFFSET(0x9FF4740)
#define RPG_CLIENT_POOLABLEBINDER_METHOD_5_D7D030A2E17FBB84_OFFSET UNITYSDK_OFFSET(0x9FF4430)
#define RPG_CLIENT_POOLABLEBINDER_RECORDBEFOREPROPERTYSET_1_OFFSET UNITYSDK_OFFSET(0x9FF4150)
#define RPG_CLIENT_POOLABLEBINDER_RECORDBEFOREPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x9FF3F40)
#define RPG_CLIENT_POOLABLEBINDER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9FF46F0)
#define RPG_CLIENT_POOLABLEBINDER_TRYRECORD_1_OFFSET UNITYSDK_OFFSET(0x9FF45F0)
#define RPG_CLIENT_POOLABLEBINDER_TRYRECORD_OFFSET UNITYSDK_OFFSET(0x9FF4360)
#define RPG_CLIENT_POOLABLEBINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9FF4E70)
#define RPG_CLIENT_POOLABLEBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x9FF4DF0)

namespace RPG::Client
{
	inline static constexpr unsigned int PoolableBinder_TypeDefinitionIndex = 59526;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PoolableBinder_TypeDefinitionIndex)->GetStaticField(0x12550);
		}
		static ::System::String** StaticGet_PoolTag()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PoolableBinder_TypeDefinitionIndex)->GetStaticField(0x12558);
		}
