...
#define RPG_CLIENT_MONOEFFECTDESTINATIONRINGCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x10CE2710)
#define RPG_CLIENT_MONOEFFECTDESTINATIONRINGCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0x10CE2AA0)
#define RPG_CLIENT_MONOEFFECTDESTINATIONRINGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x10CE2E80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectDestinationRingControl_TypeDefinitionIndex = 67573;
