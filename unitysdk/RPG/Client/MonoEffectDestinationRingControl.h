...
#define RPG_CLIENT_MONOEFFECTDESTINATIONRINGCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA93E2C0)
#define RPG_CLIENT_MONOEFFECTDESTINATIONRINGCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA93E650)
#define RPG_CLIENT_MONOEFFECTDESTINATIONRINGCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xA93EA30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectDestinationRingControl_TypeDefinitionIndex = 65221;
