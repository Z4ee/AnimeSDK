...
#define RPG_CLIENT_TABEHAVIORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19752C80)
#define RPG_CLIENT_TABEHAVIORBASE_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x19753450)
#define RPG_CLIENT_TABEHAVIORBASE_GET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x19753520)
#define RPG_CLIENT_TABEHAVIORBASE_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x19753540)
#define RPG_CLIENT_TABEHAVIORBASE_GET_TICKMODE_OFFSET UNITYSDK_OFFSET(0x19753560)
#define RPG_CLIENT_TABEHAVIORBASE_LATETICK_OFFSET UNITYSDK_OFFSET(0x197533F0)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x19752D70)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x197534B0)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19752E10)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_57D80B372834C5D1_OFFSET UNITYSDK_OFFSET(0x19752BE0)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_646174E3BA50E41A_OFFSET UNITYSDK_OFFSET(0x19752C30)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_8457B19F3C23386D_OFFSET UNITYSDK_OFFSET(0x19752F50)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_10_OFFSET UNITYSDK_OFFSET(0x19753310)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_11_OFFSET UNITYSDK_OFFSET(0x19753350)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x19752E90)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x19752ED0)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x19752F10)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x19753190)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_5_OFFSET UNITYSDK_OFFSET(0x197531D0)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_6_OFFSET UNITYSDK_OFFSET(0x19753210)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_7_OFFSET UNITYSDK_OFFSET(0x19753250)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_8_OFFSET UNITYSDK_OFFSET(0x19753290)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_9_OFFSET UNITYSDK_OFFSET(0x197532D0)
#define RPG_CLIENT_TABEHAVIORBASE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19752E50)
#define RPG_CLIENT_TABEHAVIORBASE_SET_ISENABLED_OFFSET UNITYSDK_OFFSET(0x19753510)
#define RPG_CLIENT_TABEHAVIORBASE_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x19753530)
#define RPG_CLIENT_TABEHAVIORBASE_SET_TICKMODE_OFFSET UNITYSDK_OFFSET(0x19753550)
#define RPG_CLIENT_TABEHAVIORBASE_TICK_OFFSET UNITYSDK_OFFSET(0x19753390)
#define RPG_CLIENT_TABEHAVIORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19753570)

namespace RPG::Client
{
	inline static constexpr unsigned int TABehaviorBase_TypeDefinitionIndex = 67608;
