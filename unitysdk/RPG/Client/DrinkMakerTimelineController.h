...
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA19F7F0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xA19EF40)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA19F870)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__INITRANDOMSTARTTIME_OFFSET UNITYSDK_OFFSET(0xA19EFE0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__STARTONRANDOMCLIP_OFFSET UNITYSDK_OFFSET(0xA19F700)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerTimelineController_TypeDefinitionIndex = 67028;
