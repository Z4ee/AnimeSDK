...
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17715630)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x177149B0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177156B0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__INITRANDOMSTARTTIME_OFFSET UNITYSDK_OFFSET(0x17714A50)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__STARTONRANDOMCLIP_OFFSET UNITYSDK_OFFSET(0x17715520)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerTimelineController_TypeDefinitionIndex = 69456;
