...
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB8210F0)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0xB820790)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB821170)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__INITRANDOMSTARTTIME_OFFSET UNITYSDK_OFFSET(0xB820830)
#define RPG_CLIENT_DRINKMAKERTIMELINECONTROLLER__STARTONRANDOMCLIP_OFFSET UNITYSDK_OFFSET(0xB820FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int DrinkMakerTimelineController_TypeDefinitionIndex = 67970;
