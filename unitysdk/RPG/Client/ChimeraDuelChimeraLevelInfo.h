...
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_CONVERTEXPTOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xCBD0240)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCBCFEC0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETDATA_1_OFFSET UNITYSDK_OFFSET(0xCBCD8D0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETDATA_OFFSET UNITYSDK_OFFSET(0xCBD00A0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETLEVELSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0xCBCFF00)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETLEVELUPRULE_OFFSET UNITYSDK_OFFSET(0xCBCD5B0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETSELLRULE_OFFSET UNITYSDK_OFFSET(0xCBCFFD0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_COREFLAMEVESSELLEVELUPRULE_OFFSET UNITYSDK_OFFSET(0xCBCEB20)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_COREFLAMEVESSELSELLRULE_OFFSET UNITYSDK_OFFSET(0xCBCEB40)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_DEFAULTLEVELUPRULE_OFFSET UNITYSDK_OFFSET(0xCBCEAF0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_DEFAULTSELLRULE_OFFSET UNITYSDK_OFFSET(0xCBCEB10)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET__COREFLAMEVESSELLEVELSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0xCBCEB30)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET__DEFAULTLEVELSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0xCBCEB00)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCBCEB50)
...
namespace RPG::Client
{
	...
	public:
		...
		::RPG::Client::ChimeraDuelChimeraLevelInfo_LevelSkillMapping* __CoreflameVesselLevelSkillMapping_k__BackingField; // 0x30
		::RPG::Client::ChimeraDuelChimeraLevelInfo_LevelUpRule* _CoreflameVesselLevelUpRule_k__BackingField; // 0x38
