...
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_CONVERTEXPTOATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1C1C42E0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C1C3F60)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETDATA_1_OFFSET UNITYSDK_OFFSET(0x1C1C1970)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETDATA_OFFSET UNITYSDK_OFFSET(0x1C1C4140)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETLEVELSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0x1C1C3FA0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETLEVELUPRULE_OFFSET UNITYSDK_OFFSET(0x1C1C1650)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GETSELLRULE_OFFSET UNITYSDK_OFFSET(0x1C1C4070)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_COREFLAMEVESSELLEVELUPRULE_OFFSET UNITYSDK_OFFSET(0x1C1C2BC0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_COREFLAMEVESSELSELLRULE_OFFSET UNITYSDK_OFFSET(0x1C1C2BE0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_DEFAULTLEVELUPRULE_OFFSET UNITYSDK_OFFSET(0x1C1C2B90)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET_DEFAULTSELLRULE_OFFSET UNITYSDK_OFFSET(0x1C1C2BB0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET__COREFLAMEVESSELLEVELSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0x1C1C2BD0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO_GET__DEFAULTLEVELSKILLMAPPING_OFFSET UNITYSDK_OFFSET(0x1C1C2BA0)
#define RPG_CLIENT_CHIMERADUELCHIMERALEVELINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1C2BF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelChimeraLevelInfo_TypeDefinitionIndex = 63411;

	class ChimeraDuelChimeraLevelInfo : public ::System::Object
	{
	public:
		::RPG::Client::ChimeraDuelChimeraLevelInfo_SellRule* _DefaultSellRule_k__BackingField; // 0x10
		::RPG::Client::ChimeraDuelChimeraLevelInfo_LevelUpRule* _DefaultLevelUpRule_k__BackingField; // 0x18
		::RPG::Client::ChimeraDuelChimeraLevelInfo_LevelUpRule* _CoreflameVesselLevelUpRule_k__BackingField; // 0x20
		::RPG::Client::ChimeraDuelChimeraLevelInfo_SellRule* _CoreflameVesselSellRule_k__BackingField; // 0x28
		::RPG::Client::ChimeraDuelChimeraLevelInfo_LevelSkillMapping* __DefaultLevelSkillMapping_k__BackingField; // 0x30
