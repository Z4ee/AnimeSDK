...
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGMONOPLUGIN_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x17B66DC0)
#define RPG_CLIENT_UIMUSICVISUALIZATION_MUSICMIXINGMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x17B66E50)
