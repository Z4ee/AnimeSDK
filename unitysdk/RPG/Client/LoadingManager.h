...
#define RPG_CLIENT_LOADINGMANAGER_GET_ENABLECUSTOMPRELOAD_OFFSET UNITYSDK_OFFSET(0x9A3FCF0)
#define RPG_CLIENT_LOADINGMANAGER_GET_FINISHEDWORKCOUNT_OFFSET UNITYSDK_OFFSET(0x9A3FCE0)
#define RPG_CLIENT_LOADINGMANAGER_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x9A3FC20)
#define RPG_CLIENT_LOADINGMANAGER_GET_SKIPSCENEITEMFADING_OFFSET UNITYSDK_OFFSET(0x9A3FD10)
#define RPG_CLIENT_LOADINGMANAGER_GET_TOTALWORKCOUNT_OFFSET UNITYSDK_OFFSET(0x9A3FCD0)
#define RPG_CLIENT_LOADINGMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9A3C9B0)
#define RPG_CLIENT_LOADINGMANAGER_ISGAMELOADING_OFFSET UNITYSDK_OFFSET(0x9A3D180)
#define RPG_CLIENT_LOADINGMANAGER_LATETICK_OFFSET UNITYSDK_OFFSET(0x9A3D430)
#define RPG_CLIENT_LOADINGMANAGER_RECORDPERFORMANCEID_OFFSET UNITYSDK_OFFSET(0x9A3DD80)
#define RPG_CLIENT_LOADINGMANAGER_REGISTELOADINGWORKDEFSCOUNTER_OFFSET UNITYSDK_OFFSET(0x9A3CB40)
#define RPG_CLIENT_LOADINGMANAGER_REPORTEFFECTTRANSITIONBEGIN_OFFSET UNITYSDK_OFFSET(0x9A3DBA0)
#define RPG_CLIENT_LOADINGMANAGER_REPORTEFFECTTRANSITIONEND_OFFSET UNITYSDK_OFFSET(0x9A3DC50)
#define RPG_CLIENT_LOADINGMANAGER_REPORTLOADINGADVINITEND_OFFSET UNITYSDK_OFFSET(0x9A3DA30)
#define RPG_CLIENT_LOADINGMANAGER_REPORTLOADINGBEGIN_OFFSET UNITYSDK_OFFSET(0x9A3DDD0)
#define RPG_CLIENT_LOADINGMANAGER_REPORTLOADINGDATA_OFFSET UNITYSDK_OFFSET(0x9A3E050)
#define RPG_CLIENT_LOADINGMANAGER_REPORTLOADINGTRYFAILCOUNT_OFFSET UNITYSDK_OFFSET(0x9A3D6D0)
#define RPG_CLIENT_LOADINGMANAGER_REPORTLOADINGTRYRESULT_OFFSET UNITYSDK_OFFSET(0x9A3D880)
#define RPG_CLIENT_LOADINGMANAGER_REPORTSCREENSTUCKBEGIN_OFFSET UNITYSDK_OFFSET(0x9A3DAF0)
#define RPG_CLIENT_LOADINGMANAGER_SETLOADFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x9A3D0E0)
#define RPG_CLIENT_LOADINGMANAGER_SETLOADINGCONFIGDATA_OFFSET UNITYSDK_OFFSET(0x9A3D470)
#define RPG_CLIENT_LOADINGMANAGER_SETPROGRESSCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x9A3D130)
#define RPG_CLIENT_LOADINGMANAGER_SET_ENABLECUSTOMPRELOAD_OFFSET UNITYSDK_OFFSET(0x9A3FD00)
#define RPG_CLIENT_LOADINGMANAGER_SET_SKIPSCENEITEMFADING_OFFSET UNITYSDK_OFFSET(0x9A3FD20)
#define RPG_CLIENT_LOADINGMANAGER_STARTTICK_OFFSET UNITYSDK_OFFSET(0x9A3CC40)
#define RPG_CLIENT_LOADINGMANAGER_STOPTICK_OFFSET UNITYSDK_OFFSET(0x9A3CE40)
#define RPG_CLIENT_LOADINGMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x9A3D1D0)
#define RPG_CLIENT_LOADINGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9A3FD30)
#define RPG_CLIENT_LOADINGMANAGER__COMPUTEFINISHEDPROGRESS_OFFSET UNITYSDK_OFFSET(0x9A3F960)
#define RPG_CLIENT_LOADINGMANAGER__COMPUTENEXTPROGRESS_OFFSET UNITYSDK_OFFSET(0x9A3FC70)
#define RPG_CLIENT_LOADINGMANAGER__CONVERTTIMETOSECOND_OFFSET UNITYSDK_OFFSET(0x9A3F340)
#define RPG_CLIENT_LOADINGMANAGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A3C630)
#define RPG_CLIENT_LOADINGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A3C330)
#define RPG_CLIENT_LOADINGMANAGER__CUSTOMUPDATEPRELOADMANAGER_OFFSET UNITYSDK_OFFSET(0x9A3D260)
#define RPG_CLIENT_LOADINGMANAGER__GETMAXLOADINGTIME_OFFSET UNITYSDK_OFFSET(0x9A3F3C0)
#define RPG_CLIENT_LOADINGMANAGER__ISLOADINGTYPEREPORTMATCH_OFFSET UNITYSDK_OFFSET(0x9A3F2A0)
#define RPG_CLIENT_LOADINGMANAGER__ONLOADMAPSTUCKSAMPLEPOINT_OFFSET UNITYSDK_OFFSET(0x9A3C130)
#define RPG_CLIENT_LOADINGMANAGER__ONQUEUENEWWORK_OFFSET UNITYSDK_OFFSET(0x9A3F800)
#define RPG_CLIENT_LOADINGMANAGER__ONWORKFINISH_OFFSET UNITYSDK_OFFSET(0x9A3F9B0)
#define RPG_CLIENT_LOADINGMANAGER__REFRESHWORKDEFCOUNT_OFFSET UNITYSDK_OFFSET(0x9A3CB90)
#define RPG_CLIENT_LOADINGMANAGER__RESETSTUCKCHECKTIMERWHENWORKFINISH_OFFSET UNITYSDK_OFFSET(0x9A3C010)
#define RPG_CLIENT_LOADINGMANAGER__STARTSTUCKCHECK_OFFSET UNITYSDK_OFFSET(0x9A3BBF0)
#define RPG_CLIENT_LOADINGMANAGER__STOPSTUCKCHECK_OFFSET UNITYSDK_OFFSET(0x9A3BDB0)
#define RPG_CLIENT_LOADINGMANAGER__TICKSTUCKCHECK_LOADMAP_OFFSET UNITYSDK_OFFSET(0x9A3BF50)
#define RPG_CLIENT_LOADINGMANAGER__TICKSTUCKCHECK_OFFSET UNITYSDK_OFFSET(0x9A3BE60)
#define RPG_CLIENT_LOADINGMANAGER__TRYADDTOWATCH_OFFSET UNITYSDK_OFFSET(0x9A3F480)
#define RPG_CLIENT_LOADINGMANAGER__UPDATEFINISHPROGRESS_OFFSET UNITYSDK_OFFSET(0x9A3F860)

namespace RPG::Client
{
	inline static constexpr unsigned int LoadingManager_TypeDefinitionIndex = 49058;
	...
	public:
		...
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(LoadingManager_TypeDefinitionIndex)->GetStaticField(0x26890);
		}
		static ::RPG::Client::RPGProfilerMarker** StaticGet__StopTickMarker()
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(LoadingManager_TypeDefinitionIndex)->GetStaticField(0x26898);
		}
		static ::RPG::Client::RPGProfilerMarker** StaticGet__CustomUpdatePreloadManagerMarker()
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(LoadingManager_TypeDefinitionIndex)->GetStaticField(0x268A0);
		}
		...
		::System::Collections::Generic::HashSet_1<::Class_1_8E541422F89D76B8*>* _LoadingWorks; // 0x10
		::System::Action* _LoadFinishCallback; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* _ReportTryLoadFails; // 0x20
		::RPG::Client::LoadingManager_WorkDefCounter* _workDefCounter; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* _ReportTryLoadStates; // 0x30
		::Class_1_520EA3DE1B17EDA7* _AsyncProcessor; // 0x38
		::System::Action_1<::System::Single>* _ProgressChangedCallback; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _ReportNotifyArguments; // 0x48
		::Class_1_0EF666754493EADC* _LoadMapStuckReportData; // 0x50
		...
		::System::UInt64 _EffectTransitionExistTime; // 0x68
		::System::Int32 _WorkActionCallNums; // 0x70
		::System::Single _LeavePerformanceMaxTime; // 0x74
		::System::UInt64 _EffectTransitionExistTimeBegin; // 0x78
		::System::UInt64 _ScreenStuckTimeBegin; // 0x80
		::System::UInt64 _WorkActionTimeBegin; // 0x88
		::System::UInt64 _TotalLoadingTime; // 0x90
		::System::UInt32 _LastStageID; // 0x98
		::System::Int32 _TotalWorkCount; // 0x9C
		::System::UInt64 _ADVInitTimeBegin; // 0xA0
		::System::Boolean _SkipSceneItemFading_k__BackingField; // 0xA8
		::System::Boolean _EnableCustomPreload_k__BackingField; // 0xA9
		::System::UInt64 _ScreenStuckTime; // 0xB0
		::System::Int32 _MainCameraOriginCullingMask; // 0xB8
		::System::Single _DesignDataLoadMaxTime; // 0xBC
		::System::Single _FinishedProgress; // 0xC0
		::System::Boolean _StartTick; // 0xC4
		::System::Boolean _ResetMainCameraCullingFlag; // 0xC5
		::System::Boolean _LogReported; // 0xC6
		::System::Boolean _ResetTargetFPSFlag; // 0xC7
		::System::UInt32 _PerformanceID; // 0xC8
		::System::Single _StuckCheckTimer; // 0xCC
		::System::Int32 _FinishedWorkCount; // 0xD0
		::System::Single _EnterPerformanceMaxTime; // 0xD4
		::System::UInt64 _WorkActionTime; // 0xD8
		::System::UInt64 _TotalLoadingTimeBegin; // 0xE0
		::System::UInt64 _ADVInitTime; // 0xE8
		::System::Int32 _TargetFrameRateBeforeStartTick; // 0xF0
		::System::UInt32 _LastMapID; // 0xF4
		::System::Int32 _LoadingType; // 0xF8
		::System::Single _BattleToMazeMaxTime; // 0xFC
		::System::Single _LoadMapMaxTime; // 0x100
		...
		::System::Void _ctor_1(::Class_1_520EA3DE1B17EDA7* asyncProcessor)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_520EA3DE1B17EDA7*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOADINGMANAGER__CTOR_1_OFFSET))(this, asyncProcessor);
		}
		...
		::System::Void _ResetStuckCheckTimerWhenWorkFinish(::Class_1_8E541422F89D76B8* workDefinition, ::System::Boolean success)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_8E541422F89D76B8*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOADINGMANAGER__RESETSTUCKCHECKTIMERWHENWORKFINISH_OFFSET))(this, workDefinition, success);
		}
		...
		::System::Void _TryAddToWatch(::Class_1_8E541422F89D76B8* workDefinition)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_8E541422F89D76B8*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOADINGMANAGER__TRYADDTOWATCH_OFFSET))(this, workDefinition);
		}
		...
		::System::Void _OnQueueNewWork(::Class_1_8E541422F89D76B8* workDefinition)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_8E541422F89D76B8*))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOADINGMANAGER__ONQUEUENEWWORK_OFFSET))(this, workDefinition);
		}
		...
		::System::Void _OnWorkFinish(::Class_1_8E541422F89D76B8* workDefinition, ::System::Boolean success)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_8E541422F89D76B8*, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_LOADINGMANAGER__ONWORKFINISH_OFFSET))(this, workDefinition, success);
		}
