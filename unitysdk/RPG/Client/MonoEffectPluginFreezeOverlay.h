...
#define RPG_CLIENT_MONOEFFECTPLUGINFREEZEOVERLAY_METHOD_8_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x9CD1EC0)
#define RPG_CLIENT_MONOEFFECTPLUGINFREEZEOVERLAY_METHOD_8_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x9CD2160)
#define RPG_CLIENT_MONOEFFECTPLUGINFREEZEOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD20A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginFreezeOverlay_TypeDefinitionIndex = 57281;
	...
	public:
		...
		::System::Single Field_8_1; // 0x21C
		::System::Single Field_8_2; // 0x220
