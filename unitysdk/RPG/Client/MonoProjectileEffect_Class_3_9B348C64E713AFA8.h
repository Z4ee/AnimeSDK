...
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xC13A9B0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xC13A9E0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_INVOKE_OFFSET UNITYSDK_OFFSET(0xC13A770)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8__CTOR_OFFSET UNITYSDK_OFFSET(0xC13A8C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoProjectileEffect_Class_3_9B348C64E713AFA8_TypeDefinitionIndex = 65589;
