...
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A340CC0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A340CF0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A340CB0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A340BC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoProjectileEffect_Class_3_9B348C64E713AFA8_TypeDefinitionIndex = 67006;
