...
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AD02CE0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AD02D10)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD02AA0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD02BF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoProjectileEffect_Class_3_9B348C64E713AFA8_TypeDefinitionIndex = 70111;
