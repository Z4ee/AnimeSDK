...
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA9ECC40)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA9ECC70)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8_INVOKE_OFFSET UNITYSDK_OFFSET(0xA9EC5C0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_CLASS_3_9B348C64E713AFA8__CTOR_OFFSET UNITYSDK_OFFSET(0xA9ECC20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoProjectileEffect_Class_3_9B348C64E713AFA8_TypeDefinitionIndex = 64668;
