...
#define RPG_CLIENT_FIGHTACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x96AD020)
#define RPG_CLIENT_FIGHTACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x96AD010)
#define RPG_CLIENT_FIGHTACTIVITYDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x96AD680)

namespace RPG::Client
{
	inline static constexpr unsigned int FightActivityData_TypeDefinitionIndex = 49992;
