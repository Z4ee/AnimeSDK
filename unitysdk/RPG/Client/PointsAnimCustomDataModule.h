...
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_METHOD_2_34566E7905D6C48F_OFFSET UNITYSDK_OFFSET(0x19393FC0)
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_METHOD_2_492F60696E500917_OFFSET UNITYSDK_OFFSET(0x19394730)
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_METHOD_2_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x19394A80)
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x19394AE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PointsAnimCustomDataModule_TypeDefinitionIndex = 67465;
