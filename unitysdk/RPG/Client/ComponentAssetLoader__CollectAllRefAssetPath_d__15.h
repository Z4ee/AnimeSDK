...
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9412090)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9412210)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9412270)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9412220)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9412070)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__15__CTOR_OFFSET UNITYSDK_OFFSET(0x9411DF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComponentAssetLoader__CollectAllRefAssetPath_d__15_TypeDefinitionIndex = 55835;

	class ComponentAssetLoader__CollectAllRefAssetPath_d__15 : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::Client::ComponentAssetLoader_ComponentLoadAssetInfo>* _states_5__3; // 0x10
		::System::String* __2__current; // 0x18
		::RPG::Client::ComponentAssetLoader* __4__this; // 0x20
		::Il2CppArray<::System::String*>* _paths_5__5; // 0x28
		::System::Int32 _i_5__2; // 0x30
		::System::Int32 __1__state; // 0x34
		::System::Int32 _k_5__6; // 0x38
		::System::Int32 _j_5__4; // 0x3C
