...
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_2DF312D8F1F2AEB0_OFFSET UNITYSDK_OFFSET(0xA419C90)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_370754945A4AA2A7_OFFSET UNITYSDK_OFFSET(0xA41ACF0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_496FEE6B21ED2447_OFFSET UNITYSDK_OFFSET(0xA41A520)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_4F6F1F5E9E636C20_OFFSET UNITYSDK_OFFSET(0xA41A7B0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_60451B2DE9D371C9_OFFSET UNITYSDK_OFFSET(0xA41A610)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_76AA266C33AD557E_OFFSET UNITYSDK_OFFSET(0xA419EF0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xA41AF90)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA41AEF0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xA4194D0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA41B030)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaTimelineController_TypeDefinitionIndex = 67066;
