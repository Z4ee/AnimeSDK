...
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_139E092F12DFE1A7_OFFSET UNITYSDK_OFFSET(0x193A6080)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_2B65D7A931236279_OFFSET UNITYSDK_OFFSET(0x193A4D30)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_2ED8799B5DC425F3_OFFSET UNITYSDK_OFFSET(0x193A5840)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_486A15F3893ACC02_OFFSET UNITYSDK_OFFSET(0x193A5720)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x193A6360)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_D0898EF70A90254D_OFFSET UNITYSDK_OFFSET(0x193A59E0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_METHOD_5_F018C4D4C383EBB3_OFFSET UNITYSDK_OFFSET(0x193A4F50)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x193A62A0)
#define RPG_CLIENT_GACHATIMELINECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x193A4340)
#define RPG_CLIENT_GACHATIMELINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193A63C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaTimelineController_TypeDefinitionIndex = 72722;
