...
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFAPPLYTEAM_OFFSET UNITYSDK_OFFSET(0x1AEFC9D0)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFAPPLY_OFFSET UNITYSDK_OFFSET(0x1AEF9CD0)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFFAVORITE_OFFSET UNITYSDK_OFFSET(0x1AEFC6C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFFILTER_OFFSET UNITYSDK_OFFSET(0x1AEFB780)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFLIKE_OFFSET UNITYSDK_OFFSET(0x1AEFC370)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFSHARECODEEXPORT_OFFSET UNITYSDK_OFFSET(0x1AEFD370)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFSHARECODEIMPORT_OFFSET UNITYSDK_OFFSET(0x1AEFD250)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTBUILDREFSHOWDETAIL_OFFSET UNITYSDK_OFFSET(0x1AEFB160)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_REPORTSOURCETYPE_OFFSET UNITYSDK_OFFSET(0x1AEFAC40)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER_TOREPORTHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AEFAEA0)
#define RPG_CLIENT_ROGUETOURNBUILDREFREPORTHELPER__GETHASHER_OFFSET UNITYSDK_OFFSET(0x1AEFD490)
