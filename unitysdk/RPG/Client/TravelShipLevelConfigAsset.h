...
#define RPG_CLIENT_TRAVELSHIPLEVELCONFIGASSET_METHOD_4_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0xCAD6E00)
#define RPG_CLIENT_TRAVELSHIPLEVELCONFIGASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xCAD6E90)

namespace RPG::Client
{
	inline static constexpr unsigned int TravelShipLevelConfigAsset_TypeDefinitionIndex = 64358;
