...
#define RPG_CLIENT_PLAYTAROTBOOKTALKPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1E45E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayTarotBookTalkParam_TypeDefinitionIndex = 65036;
