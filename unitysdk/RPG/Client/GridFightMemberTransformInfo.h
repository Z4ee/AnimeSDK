...
#define RPG_CLIENT_GRIDFIGHTMEMBERTRANSFORMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC2E6B0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightMemberTransformInfo_TypeDefinitionIndex = 64916;
