...
#define RPG_CLIENT_FITTOGROUNDIK_GET_IKENABLED_OFFSET UNITYSDK_OFFSET(0xBA282B0)
#define RPG_CLIENT_FITTOGROUNDIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0xBA269C0)
#define RPG_CLIENT_FITTOGROUNDIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xBA282D0)
#define RPG_CLIENT_FITTOGROUNDIK_METHOD_5_048B2CC98DBD1BD8_OFFSET UNITYSDK_OFFSET(0xBA26F80)
#define RPG_CLIENT_FITTOGROUNDIK_METHOD_5_627557CE4CD0ABB4_OFFSET UNITYSDK_OFFSET(0xBA280A0)
#define RPG_CLIENT_FITTOGROUNDIK_METHOD_5_A63D06F4304A4527_OFFSET UNITYSDK_OFFSET(0xBA28160)
#define RPG_CLIENT_FITTOGROUNDIK_PREPROCESS_OFFSET UNITYSDK_OFFSET(0xBA26A20)
#define RPG_CLIENT_FITTOGROUNDIK_PROCESS_OFFSET UNITYSDK_OFFSET(0xBA26B30)
#define RPG_CLIENT_FITTOGROUNDIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0xBA26970)
#define RPG_CLIENT_FITTOGROUNDIK_SET_IKENABLED_OFFSET UNITYSDK_OFFSET(0xBA282C0)
#define RPG_CLIENT_FITTOGROUNDIK__CTOR_OFFSET UNITYSDK_OFFSET(0xBA282E0)

namespace RPG::Client
{
	inline static constexpr unsigned int FitToGroundIK_TypeDefinitionIndex = 64035;
