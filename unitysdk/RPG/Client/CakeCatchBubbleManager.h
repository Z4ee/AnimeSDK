...
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18CCD3E0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER_INTERRUPTALL_OFFSET UNITYSDK_OFFSET(0x18CCD740)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER_PLAYDIALOGUEGROUP_OFFSET UNITYSDK_OFFSET(0x18CCD6C0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER_SHOWCAKEIDENTITYBUBBLE_OFFSET UNITYSDK_OFFSET(0x18CCE0B0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__BUILDPENDINGQUEUE_OFFSET UNITYSDK_OFFSET(0x18CCD8C0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCD480)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__GETDEFAULTBUBBLEOFFSET_OFFSET UNITYSDK_OFFSET(0x18CCDFD0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__ONBUBBLECOMPLETE_OFFSET UNITYSDK_OFFSET(0x18CCDAB0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__PLAYNEXTDIALOGUE_OFFSET UNITYSDK_OFFSET(0x18CCD9F0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__RESOLVEBUBBLEOFFSET_OFFSET UNITYSDK_OFFSET(0x18CCDED0)
#define RPG_CLIENT_CAKECATCHBUBBLEMANAGER__SHOWCAKEDIALOGUEBUBBLE_OFFSET UNITYSDK_OFFSET(0x18CCDB00)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeCatchBubbleManager_TypeDefinitionIndex = 60184;
	...
	public:
		...
		{
			return (::RPG::Client::CakeCatchBubbleManager**)Il2CppClass::FromTypeDefinitionIndex(CakeCatchBubbleManager_TypeDefinitionIndex)->GetStaticField(0x5E880);
		}
		// static const ::System::Int32 _INVALID_RUNTIME_ID = 0xFFFFFFFF; // 0x0
		// static const ::System::Int32 _INVALID_BUBBLE_TIMER_ID = 0x0; // 0x0
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::CakeBubbleOffset>* _SlotOffsetDict; // 0x10
		::System::Collections::Generic::Queue_1<::Class_1_1C87E05DC1AC3C04*>* _PendingQueue; // 0x18
		::System::Action* _OnDialogueGroupEnd; // 0x20
		::System::Boolean _IsPlayingDialogue; // 0x28
