...
#define RPG_CLIENT_CUSTOMTRANSITIONFADEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x9441F10)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomTransitionFadeOut_TypeDefinitionIndex = 59694;
