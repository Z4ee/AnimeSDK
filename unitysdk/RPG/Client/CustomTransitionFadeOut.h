...
#define RPG_CLIENT_CUSTOMTRANSITIONFADEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC905B0)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomTransitionFadeOut_TypeDefinitionIndex = 72748;
