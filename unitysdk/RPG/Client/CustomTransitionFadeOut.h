...
#define RPG_CLIENT_CUSTOMTRANSITIONFADEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x192D7340)

namespace RPG::Client
{
	inline static constexpr unsigned int CustomTransitionFadeOut_TypeDefinitionIndex = 72747;
