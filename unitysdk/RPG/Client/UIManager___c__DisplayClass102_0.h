...
#define RPG_CLIENT_UIMANAGER___C__DISPLAYCLASS102_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17B59A60)
#define RPG_CLIENT_UIMANAGER___C__DISPLAYCLASS102_0___HANDLESHOWUI3D_B__0_OFFSET UNITYSDK_OFFSET(0x17B59A70)

namespace RPG::Client
{
	inline static constexpr unsigned int UIManager___c__DisplayClass102_0_TypeDefinitionIndex = 72986;

	class UIManager___c__DisplayClass102_0 : public ::System::Object
	{
	public:
		::RPG::Client::IUI3DController* ui3d; // 0x10
		::RPG::Client::UIManager* __4__this; // 0x18
