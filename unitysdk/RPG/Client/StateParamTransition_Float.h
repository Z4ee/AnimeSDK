...
#define RPG_CLIENT_STATEPARAMTRANSITION_FLOAT_METHOD_2_0724EFB1A18E7075_OFFSET UNITYSDK_OFFSET(0xC925B00)
#define RPG_CLIENT_STATEPARAMTRANSITION_FLOAT_METHOD_2_BF302FCDF545D0AF_OFFSET UNITYSDK_OFFSET(0xC925DC0)
#define RPG_CLIENT_STATEPARAMTRANSITION_FLOAT_METHOD_2_E968CB1D462997C6_OFFSET UNITYSDK_OFFSET(0xC9259D0)
#define RPG_CLIENT_STATEPARAMTRANSITION_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xC925EC0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateParamTransition_Float_TypeDefinitionIndex = 64394;
