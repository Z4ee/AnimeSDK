...
#define RPG_CLIENT_ELFENTERNEXTDAYHINT__CTOR_OFFSET UNITYSDK_OFFSET(0xB8A6080)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfEnterNextDayHint_TypeDefinitionIndex = 59614;
