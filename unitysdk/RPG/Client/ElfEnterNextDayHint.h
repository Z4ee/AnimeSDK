...
#define RPG_CLIENT_ELFENTERNEXTDAYHINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC61660)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfEnterNextDayHint_TypeDefinitionIndex = 63752;
