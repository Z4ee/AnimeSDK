...
#define RPG_CLIENT_STATEENTERTRIGGERBLOCKBEHAVIOUR_METHOD_4_C4FDF5DB46830B8A_OFFSET UNITYSDK_OFFSET(0x1A4FECF0)
#define RPG_CLIENT_STATEENTERTRIGGERBLOCKBEHAVIOUR_METHOD_4_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x1A4FEEE0)
#define RPG_CLIENT_STATEENTERTRIGGERBLOCKBEHAVIOUR_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A4FEC60)
#define RPG_CLIENT_STATEENTERTRIGGERBLOCKBEHAVIOUR_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A4FEE40)
#define RPG_CLIENT_STATEENTERTRIGGERBLOCKBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FEFE0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateEnterTriggerBlockBehaviour_TypeDefinitionIndex = 68996;
