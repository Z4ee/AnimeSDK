...
#define RPG_CLIENT_HELIOBUSCHALLENGETARGETDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x991FA00)
#define RPG_CLIENT_HELIOBUSCHALLENGETARGETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x991F820)

namespace RPG::Client
{
	inline static constexpr unsigned int HeliobusChallengeTargetData_TypeDefinitionIndex = 53328;
