...
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_CURRENTSKINNAME_OFFSET UNITYSDK_OFFSET(0xB7013C0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_CURRENTSKINPATH_OFFSET UNITYSDK_OFFSET(0xB7013D0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_SKINRESMAP_OFFSET UNITYSDK_OFFSET(0xB6FFF60)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_4E6219BD0A8026FA_OFFSET UNITYSDK_OFFSET(0xB6FE0E0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_6929C20FCC70C1A3_OFFSET UNITYSDK_OFFSET(0xB700FD0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0xB701060)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_SET_CURRENTSKINNAME_OFFSET UNITYSDK_OFFSET(0xB6FDFC0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB7014B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComponentAssetSkinItem_TypeDefinitionIndex = 63986;
