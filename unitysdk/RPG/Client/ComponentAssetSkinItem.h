...
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_CURRENTSKINNAME_OFFSET UNITYSDK_OFFSET(0x180168E0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_CURRENTSKINPATH_OFFSET UNITYSDK_OFFSET(0x180168F0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_GET_SKINRESMAP_OFFSET UNITYSDK_OFFSET(0x18015530)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_4E6219BD0A8026FA_OFFSET UNITYSDK_OFFSET(0x180139A0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_6929C20FCC70C1A3_OFFSET UNITYSDK_OFFSET(0x180164F0)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_METHOD_1_EC2B405D0723571D_OFFSET UNITYSDK_OFFSET(0x18016580)
#define RPG_CLIENT_COMPONENTASSETSKINITEM_SET_CURRENTSKINNAME_OFFSET UNITYSDK_OFFSET(0x18013880)
#define RPG_CLIENT_COMPONENTASSETSKINITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x180169D0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComponentAssetSkinItem_TypeDefinitionIndex = 65357;
