...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARABREAK_METHOD_8_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x9C99190)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARABREAK_METHOD_8_D78B51BFDA4B8B32_OFFSET UNITYSDK_OFFSET(0x9C99380)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARABREAK__CTOR_OFFSET UNITYSDK_OFFSET(0x9C992C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaBreak_TypeDefinitionIndex = 57212;

	class MonoEffectPluginCharaBreak : public ::RPG::Client::MonoEffectPluginCharaOverlayMatBase
	{
	public:
		::UnityEngine::Vector4 MainSpeed; // 0x218
