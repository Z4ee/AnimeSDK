...
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GETCURROUTEEASTEREGGCONDITIONMATCHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xC6BC370)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GETROUTEDISPLAYROWS_OFFSET UNITYSDK_OFFSET(0xC6BC170)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_CURROUTEDISPLAYID_OFFSET UNITYSDK_OFFSET(0xC6BC480)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_ISCURROUTESELECTED_OFFSET UNITYSDK_OFFSET(0xC6BC540)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_PLANETDISPLAYID_OFFSET UNITYSDK_OFFSET(0xC6BC4E0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_REACTPROP_OFFSET UNITYSDK_OFFSET(0xC6BC5A0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_TRYCREATECURMODULEFACADE_OFFSET UNITYSDK_OFFSET(0xC6BBFC0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE__CTOR_OFFSET UNITYSDK_OFFSET(0xC6BBFB0)

namespace RPG::Client
{
	inline static constexpr unsigned int ReShaSceneSelectionModuleUIFacade_TypeDefinitionIndex = 56325;
