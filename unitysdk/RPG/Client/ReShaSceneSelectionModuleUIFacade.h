...
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GETCURROUTEEASTEREGGCONDITIONMATCHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xDE065C0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GETROUTEDISPLAYROWS_OFFSET UNITYSDK_OFFSET(0xDE063C0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_CURROUTEDISPLAYID_OFFSET UNITYSDK_OFFSET(0xDE066D0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_ISCURROUTESELECTED_OFFSET UNITYSDK_OFFSET(0xDE06790)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_PLANETDISPLAYID_OFFSET UNITYSDK_OFFSET(0xDE06730)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_GET_REACTPROP_OFFSET UNITYSDK_OFFSET(0xDE067F0)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE_TRYCREATECURMODULEFACADE_OFFSET UNITYSDK_OFFSET(0xDE06210)
#define RPG_CLIENT_RESHASCENESELECTIONMODULEUIFACADE__CTOR_OFFSET UNITYSDK_OFFSET(0xDE06200)
