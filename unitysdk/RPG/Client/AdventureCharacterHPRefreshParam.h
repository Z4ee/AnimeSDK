...
#define RPG_CLIENT_ADVENTURECHARACTERHPREFRESHPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB22A770)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureCharacterHPRefreshParam_TypeDefinitionIndex = 63741;
	...
	public:
		...
		::Enum_3_71AA90D596A09AC8_12 Reason; // 0x1C
		::System::Boolean Overflow; // 0x20
		::System::Boolean TriggerCommonEffect; // 0x21
