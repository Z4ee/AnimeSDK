...
#define RPG_CLIENT_ADVENTURECHARACTERHPREFRESHPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xC6B8560)
...
namespace RPG::Client
{
	...
	public:
		...
		::Enum_3_71AA90D596A09AC8_13 Reason; // 0x18
		::System::Boolean Overflow; // 0x1C
		::System::Boolean TriggerCommonEffect; // 0x1D
