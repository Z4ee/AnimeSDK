...
#define RPG_CLIENT_RELICPRESETAVATARPLANS_ADDPLAN_OFFSET UNITYSDK_OFFSET(0xC6E3B30)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_CREATEBYSERVER_OFFSET UNITYSDK_OFFSET(0xC6E3230)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_DELETEPLAN_OFFSET UNITYSDK_OFFSET(0xC6E3EC0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC6E37A0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_ISPLANFULL_OFFSET UNITYSDK_OFFSET(0xC6E3AD0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_TRYGETPLAN_OFFSET UNITYSDK_OFFSET(0xC6E3C40)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_UPDATEPLAN_1_OFFSET UNITYSDK_OFFSET(0xC6E43D0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_UPDATEPLAN_2_OFFSET UNITYSDK_OFFSET(0xC6E4520)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_UPDATEPLAN_OFFSET UNITYSDK_OFFSET(0xC6E3D10)
#define RPG_CLIENT_RELICPRESETAVATARPLANS__CTOR_OFFSET UNITYSDK_OFFSET(0xC6E3670)
