...
#define RPG_CLIENT_RELICPRESETAVATARPLANS_ADDPLAN_OFFSET UNITYSDK_OFFSET(0xDE2ECC0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_CREATEBYSERVER_OFFSET UNITYSDK_OFFSET(0xDE2E210)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_DELETEPLAN_OFFSET UNITYSDK_OFFSET(0xDE2F050)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDE2E930)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_ISPLANFULL_OFFSET UNITYSDK_OFFSET(0xDE2EC60)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_TRYGETPLAN_OFFSET UNITYSDK_OFFSET(0xDE2EDD0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_UPDATEPLAN_1_OFFSET UNITYSDK_OFFSET(0xDE2F6F0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_UPDATEPLAN_2_OFFSET UNITYSDK_OFFSET(0xDE2F840)
#define RPG_CLIENT_RELICPRESETAVATARPLANS_UPDATEPLAN_OFFSET UNITYSDK_OFFSET(0xDE2EEA0)
#define RPG_CLIENT_RELICPRESETAVATARPLANS__CTOR_OFFSET UNITYSDK_OFFSET(0xDE2E800)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 MaxPlanCount; // 0x1C
