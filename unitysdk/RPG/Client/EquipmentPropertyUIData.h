...
#define RPG_CLIENT_EQUIPMENTPROPERTYUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19932AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int EquipmentPropertyUIData_TypeDefinitionIndex = 65744;
