...
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x9FFD610)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0x9FFD5A0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0x9FFD5C0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_GAME_OFFSET UNITYSDK_OFFSET(0x9FFD580)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_SETTLEHANDLER_OFFSET UNITYSDK_OFFSET(0x9FFD5E0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0x9FFD5B0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0x9FFD5D0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_GAME_OFFSET UNITYSDK_OFFSET(0x9FFD590)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_SETTLEHANDLER_OFFSET UNITYSDK_OFFSET(0x9FFD5F0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORCHALLENGEBATTLE_OFFSET UNITYSDK_OFFSET(0x9FFD8C0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORSESSIONBATTLE_OFFSET UNITYSDK_OFFSET(0x9FFDD50)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORSHOWCASEBATTLE_OFFSET UNITYSDK_OFFSET(0x9FFDAE0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x9FFD600)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__REPORTCHIMERADUELCHALLENGEBATTLESETTLE_OFFSET UNITYSDK_OFFSET(0x9FFF810)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__REPORTCHIMERADUELCHALLENGEBATTLESTART_OFFSET UNITYSDK_OFFSET(0x9FFED00)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelBattlePageViewModel_TypeDefinitionIndex = 58404;
	...
	public:
		...
		::RPG::Client::ChimeraDuelBattlePageViewModel_TeamViewModel* _EnemyTeam_k__BackingField; // 0x20
		::RPG::Client::ChimeraDuelBattlePageViewModel_GameViewModel* _Game_k__BackingField; // 0x28
