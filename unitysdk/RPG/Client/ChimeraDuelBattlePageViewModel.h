...
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xB678080)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0xB678010)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xB678030)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_GAME_OFFSET UNITYSDK_OFFSET(0xB677FF0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_GET_SETTLEHANDLER_OFFSET UNITYSDK_OFFSET(0xB678050)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_ALLYTEAM_OFFSET UNITYSDK_OFFSET(0xB678020)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_ENEMYTEAM_OFFSET UNITYSDK_OFFSET(0xB678040)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_GAME_OFFSET UNITYSDK_OFFSET(0xB678000)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_SET_SETTLEHANDLER_OFFSET UNITYSDK_OFFSET(0xB678060)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORCHALLENGEBATTLE_OFFSET UNITYSDK_OFFSET(0xB678330)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORSESSIONBATTLE_OFFSET UNITYSDK_OFFSET(0xB6787F0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CREATEFORSHOWCASEBATTLE_OFFSET UNITYSDK_OFFSET(0xB678560)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB678070)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__REPORTCHIMERADUELCHALLENGEBATTLESETTLE_OFFSET UNITYSDK_OFFSET(0xB67A520)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL__REPORTCHIMERADUELCHALLENGEBATTLESTART_OFFSET UNITYSDK_OFFSET(0xB679930)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelBattlePageViewModel_TypeDefinitionIndex = 59334;
