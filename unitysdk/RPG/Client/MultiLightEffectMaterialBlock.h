...
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_GET_EMISSIONSTRENGTH3_OFFSET UNITYSDK_OFFSET(0x9DA3430)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_LATETICK_OFFSET UNITYSDK_OFFSET(0x9DA2180)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_12B94E5E9950DAE4_OFFSET UNITYSDK_OFFSET(0x9DA1990)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_34D52AE3F5033EF9_OFFSET UNITYSDK_OFFSET(0x9DA2EC0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_ABB1ED6E5E3576C6_OFFSET UNITYSDK_OFFSET(0x9DA2460)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9DA33E0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9DA20F0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9DA2060)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_SET_EMISSIONSTRENGTH3_OFFSET UNITYSDK_OFFSET(0x9DA3440)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_START_OFFSET UNITYSDK_OFFSET(0x9DA16D0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA3450)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiLightEffectMaterialBlock_TypeDefinitionIndex = 57891;
