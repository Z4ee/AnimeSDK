...
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_GET_EMISSIONSTRENGTH3_OFFSET UNITYSDK_OFFSET(0x1B6E86C0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_LATETICK_OFFSET UNITYSDK_OFFSET(0x1B6E7470)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_019EFE3898DA3E4C_OFFSET UNITYSDK_OFFSET(0x1B6E8190)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_828DF204BF1C89BB_OFFSET UNITYSDK_OFFSET(0x1B6E6D00)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_METHOD_5_ABB1ED6E5E3576C6_OFFSET UNITYSDK_OFFSET(0x1B6E7730)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B6E8670)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B6E73E0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B6E7350)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_SET_EMISSIONSTRENGTH3_OFFSET UNITYSDK_OFFSET(0x1B6E86D0)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK_START_OFFSET UNITYSDK_OFFSET(0x1B6E6A80)
#define RPG_CLIENT_MULTILIGHTEFFECTMATERIALBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E86E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiLightEffectMaterialBlock_TypeDefinitionIndex = 70653;
	...
	public:
		...
		::UnityEngine::MaterialPropertyBlock* DNCLJJLAFKA; // 0x190
		::System::Boolean ANDBPOGGEAN; // 0x198
