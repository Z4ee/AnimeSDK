...
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xD7462A0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD743170)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0xD740F00)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_GET_ENTITYREF_OFFSET UNITYSDK_OFFSET(0xD746540)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_INITENTITY_OFFSET UNITYSDK_OFFSET(0xD746100)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_ISALLOWSHOWTRIGGEROPTIONS_OFFSET UNITYSDK_OFFSET(0xD744DB0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_28860F33089AB3D6_OFFSET UNITYSDK_OFFSET(0xD745F70)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_33199F5C1EFD6BB6_OFFSET UNITYSDK_OFFSET(0xD744970)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_3514B5B776663B67_OFFSET UNITYSDK_OFFSET(0xD744BD0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_5D973F34E2DFFD37_OFFSET UNITYSDK_OFFSET(0xD745C90)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_959CF5A4AD31A03C_OFFSET UNITYSDK_OFFSET(0xD745050)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD745710)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_METHOD_5_EBF44BC910948FDA_OFFSET UNITYSDK_OFFSET(0xD745BE0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_ONMOVABLEOBJECTMOVEENDED_OFFSET UNITYSDK_OFFSET(0xD740840)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SETUPCURVEEDGECONNECTIONTRIGGER_OFFSET UNITYSDK_OFFSET(0xD7436E0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SETUPMOVABLEOBJECTLOGICTRIGGER_OFFSET UNITYSDK_OFFSET(0xD744650)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SETUPMOVABLEOBJECTTRIGGER_OFFSET UNITYSDK_OFFSET(0xD740380)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_SET_ENTITYREF_OFFSET UNITYSDK_OFFSET(0xD746550)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_START_OFFSET UNITYSDK_OFFSET(0xD7464B0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_TRIGGERDETECTCOLLIDEREVENT_OFFSET UNITYSDK_OFFSET(0xD73E7A0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_TRIGGERRELOADCURVEMOVEMENTEVENT_OFFSET UNITYSDK_OFFSET(0xD740970)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_TRIGGERTOUCHMOVABLEOBJECT_OFFSET UNITYSDK_OFFSET(0xD73E390)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_UPDATELOGICTRIGGERSTATE_OFFSET UNITYSDK_OFFSET(0xD745600)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_UPDATELOGICTRIGGER_OFFSET UNITYSDK_OFFSET(0xD744F30)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD745760)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD746560)
