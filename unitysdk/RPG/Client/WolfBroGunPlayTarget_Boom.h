...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_69225B22C8D30B3E_OFFSET UNITYSDK_OFFSET(0xB4D8550)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0xB4D8540)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_890F5FC885825F9E_OFFSET UNITYSDK_OFFSET(0xB4D8330)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM_METHOD_6_B961D33AD47A2113_OFFSET UNITYSDK_OFFSET(0xB4D81E0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_BOOM__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D8430)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_Boom_TypeDefinitionIndex = 63363;
