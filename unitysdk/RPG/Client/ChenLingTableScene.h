...
#define RPG_CLIENT_CHENLINGTABLESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA89870)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingTableScene_TypeDefinitionIndex = 69196;
