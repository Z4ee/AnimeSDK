...
#define RPG_CLIENT_CHENLINGTABLESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0xB6412E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChenLingTableScene_TypeDefinitionIndex = 67712;
