...
#define RPG_CLIENT_EXPEDITIONBATTLEMAPOVERVIEWVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCEFCBA0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPOVERVIEWVIEWMODEL_GETITEM_OFFSET UNITYSDK_OFFSET(0xCEFCAF0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPOVERVIEWVIEWMODEL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCEFC920)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPOVERVIEWVIEWMODEL_GET_MAPIDS_OFFSET UNITYSDK_OFFSET(0xCEFC910)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPOVERVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCEFC970)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _MapIDs_k__BackingField; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ExpeditionBattleMapItemViewModel*>* _Items; // 0x18
