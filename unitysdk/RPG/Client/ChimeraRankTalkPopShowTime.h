...
#define RPG_CLIENT_CHIMERARANKTALKPOPSHOWTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xCC09900)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraRankTalkPopShowTime_TypeDefinitionIndex = 72409;
