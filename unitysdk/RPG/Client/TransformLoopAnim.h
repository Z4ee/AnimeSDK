...
class Class_3_98D44D81FBACEF55;
...
#define RPG_CLIENT_TRANSFORMLOOPANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xCACBBA0)
#define RPG_CLIENT_TRANSFORMLOOPANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xCACC1E0)
#define RPG_CLIENT_TRANSFORMLOOPANIM_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0xCACBB50)
#define RPG_CLIENT_TRANSFORMLOOPANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xCACC290)

namespace RPG::Client
{
	inline static constexpr unsigned int TransformLoopAnim_TypeDefinitionIndex = 65758;

	class TransformLoopAnim : public ::RPG::Client::TAMonoPlugin_1<::Class_3_98D44D81FBACEF55*>
	{
	public:
		::System::Collections::Generic::List_1<::Class_3_98D44D81FBACEF55_AnimatedItem*>* AnimatedCrowd; // 0x30
