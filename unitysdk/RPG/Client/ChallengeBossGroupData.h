...
#define RPG_CLIENT_CHALLENGEBOSSGROUPDATA_GETBUFFLIST_1_OFFSET UNITYSDK_OFFSET(0xCA28DA0)
#define RPG_CLIENT_CHALLENGEBOSSGROUPDATA_GETBUFFLIST_OFFSET UNITYSDK_OFFSET(0xCA28D30)
#define RPG_CLIENT_CHALLENGEBOSSGROUPDATA_GET_BOSSEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0xCA289D0)
#define RPG_CLIENT_CHALLENGEBOSSGROUPDATA_SET_BOSSEXTRAINFOROW_OFFSET UNITYSDK_OFFSET(0xCA289E0)
#define RPG_CLIENT_CHALLENGEBOSSGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCA289F0)
