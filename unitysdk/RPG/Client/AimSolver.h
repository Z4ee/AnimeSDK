...
#define RPG_CLIENT_AIMSOLVER_GET_AIMERCOUNT_OFFSET UNITYSDK_OFFSET(0x9082310)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_106B26BE164E4FCD_OFFSET UNITYSDK_OFFSET(0x9083A00)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_11923540E96E60E4_OFFSET UNITYSDK_OFFSET(0x9084970)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_3F5823D34C4A0A38_OFFSET UNITYSDK_OFFSET(0x9084E80)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_412B37D6127486C3_OFFSET UNITYSDK_OFFSET(0x90848C0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_4855D279E0E27DA8_OFFSET UNITYSDK_OFFSET(0x9084B90)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_4C7D121ED22BD1D1_OFFSET UNITYSDK_OFFSET(0x9084AD0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_64D17174D10FA3CE_OFFSET UNITYSDK_OFFSET(0x9082CB0)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_8E968BA443B7271D_OFFSET UNITYSDK_OFFSET(0x9085890)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_A17B38030E623502_OFFSET UNITYSDK_OFFSET(0x9084840)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_B530AE696D19BB54_OFFSET UNITYSDK_OFFSET(0x9084580)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x9082360)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_BBCB217B420D617D_OFFSET UNITYSDK_OFFSET(0x9083620)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x9085810)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_EABBE399EFB12E42_OFFSET UNITYSDK_OFFSET(0x9082900)
#define RPG_CLIENT_AIMSOLVER_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x90829B0)
#define RPG_CLIENT_AIMSOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9085AF0)
#define RPG_CLIENT_AIMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9085A90)

namespace RPG::Client
{
	inline static constexpr unsigned int AimSolver_TypeDefinitionIndex = 55866;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AimSolver_TypeDefinitionIndex)->GetStaticField(0x31F20);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Quaternion>** StaticGet__QuaternionCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(AimSolver_TypeDefinitionIndex)->GetStaticField(0x31F28);
		}
		...
		::System::Void Method_1_3F5823D34C4A0A38(::RootMotion::IKJob::IKThreadProxyContext* a1, ::Struct_2_54B2BF9C4C8BC07C& a2)
		{
			return ((::System::Void(*)(::PVOID, ::RootMotion::IKJob::IKThreadProxyContext*, ::Struct_2_54B2BF9C4C8BC07C&))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIMSOLVER_METHOD_1_3F5823D34C4A0A38_OFFSET))(this, a1, a2);
		}
