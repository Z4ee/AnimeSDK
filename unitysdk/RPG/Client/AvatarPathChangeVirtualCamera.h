...
#define RPG_CLIENT_AVATARPATHCHANGEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DB3CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathChangeVirtualCamera_TypeDefinitionIndex = 65750;
