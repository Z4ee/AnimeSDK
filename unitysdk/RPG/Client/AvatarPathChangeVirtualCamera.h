...
#define RPG_CLIENT_AVATARPATHCHANGEVIRTUALCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xB38FAE0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathChangeVirtualCamera_TypeDefinitionIndex = 66684;
