...
#define RPG_CLIENT_MONOPROJECTILEEFFECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC13A850)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC13A700)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xC13A780)
#define RPG_CLIENT_MONOPROJECTILEEFFECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC13A7F0)
#define RPG_CLIENT_MONOPROJECTILEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC13A8B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoProjectileEffect_TypeDefinitionIndex = 65588;
