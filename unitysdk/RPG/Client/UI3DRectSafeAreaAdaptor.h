...
#define RPG_CLIENT_UI3DRECTSAFEAREAADAPTOR_DOSAFEAREAADAPT_OFFSET UNITYSDK_OFFSET(0xE327030)
#define RPG_CLIENT_UI3DRECTSAFEAREAADAPTOR_METHOD_5_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0xE327380)
#define RPG_CLIENT_UI3DRECTSAFEAREAADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE3274F0)
