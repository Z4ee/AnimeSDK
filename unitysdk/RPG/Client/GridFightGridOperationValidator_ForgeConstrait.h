...
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_FORGECONSTRAIT_VALIDATE_OFFSET UNITYSDK_OFFSET(0x194FD330)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_FORGECONSTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x194FCF10)
#define RPG_CLIENT_GRIDFIGHTGRIDOPERATIONVALIDATOR_FORGECONSTRAIT__ISFORGEPLACEMENT_OFFSET UNITYSDK_OFFSET(0x194FD720)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGridOperationValidator_ForgeConstrait_TypeDefinitionIndex = 61926;
