...
{
	inline static constexpr unsigned int MovementStoppedRootMotionBakedData_TypeDefinitionIndex = 68780;

	struct alignas(8) MovementStoppedRootMotionBakedData
	{
		::System::String* startStateName; // 0x10
		::System::String* finishStateName; // 0x18
		::RPG::Client::MovementStoppedRootMotionBakedData_Class_1_3B76E13757985C28_3* Info; // 0x20
