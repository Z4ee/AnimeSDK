...
#define RPG_CLIENT_AVATARICONCONTROL__BINDBUTTON_OFFSET UNITYSDK_OFFSET(0x193E3340)
#define RPG_CLIENT_AVATARICONCONTROL__BINDCHILDCONTROLS_OFFSET UNITYSDK_OFFSET(0x193E8EC0)
#define RPG_CLIENT_AVATARICONCONTROL__BINDHINTAREAS_OFFSET UNITYSDK_OFFSET(0x193E7360)
#define RPG_CLIENT_AVATARICONCONTROL__BINDIMAGES_OFFSET UNITYSDK_OFFSET(0x193E3900)
#define RPG_CLIENT_AVATARICONCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x193E3260)
#define RPG_CLIENT_AVATARICONCONTROL__BINDLEVELPANEL_OFFSET UNITYSDK_OFFSET(0x193E4780)
#define RPG_CLIENT_AVATARICONCONTROL__BINDMARKS_OFFSET UNITYSDK_OFFSET(0x193E53D0)
#define RPG_CLIENT_AVATARICONCONTROL__BINDMATERIAL_OFFSET UNITYSDK_OFFSET(0x193E8C80)
#define RPG_CLIENT_AVATARICONCONTROL__BINDNAMEPANEL_OFFSET UNITYSDK_OFFSET(0x193E4F50)
#define RPG_CLIENT_AVATARICONCONTROL__BINDORDERANDCHECKMARK_OFFSET UNITYSDK_OFFSET(0x193E6A70)
#define RPG_CLIENT_AVATARICONCONTROL__BINDREDDOT_OFFSET UNITYSDK_OFFSET(0x193E8A10)
#define RPG_CLIENT_AVATARICONCONTROL__BINDROGUEHEX_OFFSET UNITYSDK_OFFSET(0x193E8590)
#define RPG_CLIENT_AVATARICONCONTROL__BINDSPECIALMARK_OFFSET UNITYSDK_OFFSET(0x193E63C0)
#define RPG_CLIENT_AVATARICONCONTROL__BINDTUTORIAL_OFFSET UNITYSDK_OFFSET(0x193E97B0)
#define RPG_CLIENT_AVATARICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x193E9AA0)
#define RPG_CLIENT_AVATARICONCONTROL__GETSPECIALMARKCOLORSTATE_OFFSET UNITYSDK_OFFSET(0x193E9A10)
