...
#define RPG_CLIENT_ENTITYINSPECTOR_DIE_OFFSET UNITYSDK_OFFSET(0x1A181440)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_ABILITYSHOW_OFFSET UNITYSDK_OFFSET(0x1A182CA0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_ACTIONDELAY_OFFSET UNITYSDK_OFFSET(0x1A1826B0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_CAMPID_OFFSET UNITYSDK_OFFSET(0x1A182410)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_CHARACTERID_OFFSET UNITYSDK_OFFSET(0x1A1822F0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_COMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A182A70)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x1A182310)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_GROUPENTITYID_OFFSET UNITYSDK_OFFSET(0x1A1825F0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1A182590)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_ISAVATAR_OFFSET UNITYSDK_OFFSET(0x1A182350)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_ISSTORYMODE_OFFSET UNITYSDK_OFFSET(0x1A182650)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_LOCKEDFACETARGET_OFFSET UNITYSDK_OFFSET(0x1A1828D0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_MODELARTPREFAB_OFFSET UNITYSDK_OFFSET(0x1A1821B0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_MODELROOTPREFAB_OFFSET UNITYSDK_OFFSET(0x1A182060)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_MONSTERBASEID_OFFSET UNITYSDK_OFFSET(0x1A182330)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_OWNERENTITYREF_OFFSET UNITYSDK_OFFSET(0x1A182050)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_RUNTIMEID_OFFSET UNITYSDK_OFFSET(0x1A1824D0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_SERVERENTITYID_OFFSET UNITYSDK_OFFSET(0x1A182530)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_STATEALIVE_OFFSET UNITYSDK_OFFSET(0x1A182470)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_TEAM_OFFSET UNITYSDK_OFFSET(0x1A1823B0)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_TURNSPEED_OFFSET UNITYSDK_OFFSET(0x1A182830)
#define RPG_CLIENT_ENTITYINSPECTOR_GET_UNITACTIONDELAY_OFFSET UNITYSDK_OFFSET(0x1A182770)
#define RPG_CLIENT_ENTITYINSPECTOR_INIT_OFFSET UNITYSDK_OFFSET(0x1A181600)
#define RPG_CLIENT_ENTITYINSPECTOR_METHOD_5_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1A182A10)
#define RPG_CLIENT_ENTITYINSPECTOR_METHOD_5_3CF43707BF2E9BBA_OFFSET UNITYSDK_OFFSET(0x1A181BE0)
#define RPG_CLIENT_ENTITYINSPECTOR_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x1A181AE0)
#define RPG_CLIENT_ENTITYINSPECTOR_METHOD_5_AD23FDCC7576BB32_OFFSET UNITYSDK_OFFSET(0x1A181F70)
#define RPG_CLIENT_ENTITYINSPECTOR_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A181E60)
#define RPG_CLIENT_ENTITYINSPECTOR_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A181D30)
#define RPG_CLIENT_ENTITYINSPECTOR_SET_ABILITYSHOW_OFFSET UNITYSDK_OFFSET(0x1A182D00)
#define RPG_CLIENT_ENTITYINSPECTOR_SET_CHARACTERID_OFFSET UNITYSDK_OFFSET(0x1A182300)
#define RPG_CLIENT_ENTITYINSPECTOR_SET_COMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A182C50)
#define RPG_CLIENT_ENTITYINSPECTOR_SET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x1A182320)
#define RPG_CLIENT_ENTITYINSPECTOR_SET_MONSTERBASEID_OFFSET UNITYSDK_OFFSET(0x1A182340)
#define RPG_CLIENT_ENTITYINSPECTOR_START_OFFSET UNITYSDK_OFFSET(0x1A181800)
#define RPG_CLIENT_ENTITYINSPECTOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A181850)
#define RPG_CLIENT_ENTITYINSPECTOR_VISIBLETOGGLEHIDE_OFFSET UNITYSDK_OFFSET(0x1A181580)
#define RPG_CLIENT_ENTITYINSPECTOR_VISIBLETOGGLESHOW_OFFSET UNITYSDK_OFFSET(0x1A181500)
#define RPG_CLIENT_ENTITYINSPECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A182D50)
