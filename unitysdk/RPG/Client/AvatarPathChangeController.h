...
#define RPG_CLIENT_AVATARPATHCHANGECONTROLLER_ADDTICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x9152090)
#define RPG_CLIENT_AVATARPATHCHANGECONTROLLER_CHECKFREESTYLEANIMFINISH_OFFSET UNITYSDK_OFFSET(0x91520F0)
#define RPG_CLIENT_AVATARPATHCHANGECONTROLLER_CLEARTICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x9152170)
#define RPG_CLIENT_AVATARPATHCHANGECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x91521C0)
#define RPG_CLIENT_AVATARPATHCHANGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9152230)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarPathChangeController_TypeDefinitionIndex = 58458;
