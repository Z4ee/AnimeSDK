...
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x95BA060)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_ELFHINTHANDLER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x95BA2A0)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_ELFHINTHANDLER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x95BA230)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x95BA320)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x95BA290)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x95BA240)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x95BA050)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x95B9060)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfHintToastManager___CheckProfilerHints_d__7_TypeDefinitionIndex = 51753;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_ELFHINTTOASTMANAGER___CHECKPROFILERHINTS_D__7__CTOR_OFFSET))(this, __1__state);
		}
