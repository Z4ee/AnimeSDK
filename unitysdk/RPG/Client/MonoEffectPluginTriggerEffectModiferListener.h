...
#define RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CE1150)
#define RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER_METHOD_6_3D32A8D32FBB901A_OFFSET UNITYSDK_OFFSET(0x9CE1580)
#define RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER_METHOD_6_A0C1DAA6261B1CB5_OFFSET UNITYSDK_OFFSET(0x9CE1520)
#define RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER_METHOD_6_D49D4C04CB5F23A5_OFFSET UNITYSDK_OFFSET(0x9CE1350)
#define RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CE0DF0)
#define RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE1710)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginTriggerEffectModiferListener_TypeDefinitionIndex = 57391;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_375*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINTRIGGEREFFECTMODIFERLISTENER_METHOD_6_D49D4C04CB5F23A5_OFFSET))(this, a1);
		}
