...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9B2F3E0)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS62_0___PLAYMATCHEDEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0x9B336C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass62_0_TypeDefinitionIndex = 53544;
