...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C264430)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS62_0___PLAYMATCHEDEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0x1C268730)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass62_0_TypeDefinitionIndex = 65969;
