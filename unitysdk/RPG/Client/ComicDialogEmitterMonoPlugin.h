...
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xA0B3700)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xA0B7440)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xA0B7420)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xA0B7400)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xA0B74F0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_4967C5B92C502D51_1_OFFSET UNITYSDK_OFFSET(0xA0B73E0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_4967C5B92C502D51_OFFSET UNITYSDK_OFFSET(0xA0B73C0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_53DEB092240C71C8_1_OFFSET UNITYSDK_OFFSET(0xA0B73F0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_53DEB092240C71C8_OFFSET UNITYSDK_OFFSET(0xA0B73D0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xA0B7430)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xA0B7410)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0B7850)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B77C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterMonoPlugin_TypeDefinitionIndex = 65345;

	class ComicDialogEmitterMonoPlugin : public ::RPG::Client::TAMonoPlugin_1<::RPG::Client::ComicDialogEmitterBehavior*>
	{
	public:
		static ::System::String** StaticGet_Field_7_27()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ComicDialogEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x5EA20);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET))(this, value);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET))(this, value);
		}
