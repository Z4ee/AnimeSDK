...
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xB6F13E0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xB6F5530)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xB6F5510)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xB6F54F0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xB6F55E0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_4967C5B92C502D51_1_OFFSET UNITYSDK_OFFSET(0xB6F54D0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_4967C5B92C502D51_OFFSET UNITYSDK_OFFSET(0xB6F54B0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_53DEB092240C71C8_1_OFFSET UNITYSDK_OFFSET(0xB6F54E0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_53DEB092240C71C8_OFFSET UNITYSDK_OFFSET(0xB6F54C0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0xB6F5520)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0xB6F5500)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xB6F5980)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB6F58F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterMonoPlugin_TypeDefinitionIndex = 66272;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ComicDialogEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x65EF0);
		}
