...
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x18006870)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x1800A690)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x1800A670)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0x1800A650)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x1800A740)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_4967C5B92C502D51_1_OFFSET UNITYSDK_OFFSET(0x1800A630)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_4967C5B92C502D51_OFFSET UNITYSDK_OFFSET(0x1800A610)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_53DEB092240C71C8_1_OFFSET UNITYSDK_OFFSET(0x1800A640)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_METHOD_7_53DEB092240C71C8_OFFSET UNITYSDK_OFFSET(0x1800A620)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_AUDIOPLAYERGO_OFFSET UNITYSDK_OFFSET(0x1800A680)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN_SET_IFSHOWALLDIALOG_OFFSET UNITYSDK_OFFSET(0x1800A660)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1800AAE0)
#define RPG_CLIENT_COMICDIALOGEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1800AA50)

namespace RPG::Client
{
	inline static constexpr unsigned int ComicDialogEmitterMonoPlugin_TypeDefinitionIndex = 67697;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ComicDialogEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x68B90);
		}
