...
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA51C350)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xA51C3C0)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0xA51C7B0)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xA51C630)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_SETCAMERA_OFFSET UNITYSDK_OFFSET(0xA51C540)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA51C310)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA51C9B0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightParticleEffect_TypeDefinitionIndex = 59309;
