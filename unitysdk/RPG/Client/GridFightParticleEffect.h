...
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBBC3E50)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBBC3EC0)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0xBBC4290)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBBC4120)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_SETCAMERA_OFFSET UNITYSDK_OFFSET(0xBBC4040)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBBC3E10)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBBC4480)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightParticleEffect_TypeDefinitionIndex = 60244;
