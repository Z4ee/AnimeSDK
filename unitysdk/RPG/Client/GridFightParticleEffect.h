...
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9879A70)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9879AE0)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_PLAY_1_OFFSET UNITYSDK_OFFSET(0x9879ED0)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x9879D50)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_SETCAMERA_OFFSET UNITYSDK_OFFSET(0x9879C60)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9879A30)
#define RPG_CLIENT_GRIDFIGHTPARTICLEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x987A0D0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightParticleEffect_TypeDefinitionIndex = 52356;
