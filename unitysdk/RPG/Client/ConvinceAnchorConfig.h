...
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A6ADFA379C021A61_1_OFFSET UNITYSDK_OFFSET(0x9425590)
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A6ADFA379C021A61_OFFSET UNITYSDK_OFFSET(0x94253F0)
#define RPG_CLIENT_CONVINCEANCHORCONFIG_METHOD_1_A9CC58969E11B744_OFFSET UNITYSDK_OFFSET(0x9425450)
#define RPG_CLIENT_CONVINCEANCHORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x94255F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ConvinceAnchorConfig_TypeDefinitionIndex = 49152;
