...
#define RPG_CLIENT_BATTLEASSETPRELOAD_MONSTERASSETPRELOADGROUPCREATEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x918FA60)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleAssetPreload_MonsterAssetPreloadGroupCreateParam_TypeDefinitionIndex = 48293;
