...
#define RPG_CLIENT_FALLINGOBJECTTEMPLATE_METHOD_1_59597AEB8CE7B3F8_OFFSET UNITYSDK_OFFSET(0x196D9CF0)
#define RPG_CLIENT_FALLINGOBJECTTEMPLATE_METHOD_1_70437D85C11C5222_OFFSET UNITYSDK_OFFSET(0x196D9E60)
#define RPG_CLIENT_FALLINGOBJECTTEMPLATE_METHOD_1_78C62398E94F0FB1_OFFSET UNITYSDK_OFFSET(0x196D9F60)
#define RPG_CLIENT_FALLINGOBJECTTEMPLATE_METHOD_1_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0x196D99C0)
#define RPG_CLIENT_FALLINGOBJECTTEMPLATE__CTOR_OFFSET UNITYSDK_OFFSET(0x196DA060)

namespace RPG::Client
{
	inline static constexpr unsigned int FallingObjectTemplate_TypeDefinitionIndex = 67739;
