...
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_CLEAREXTERNALTRANSFORMS_OFFSET UNITYSDK_OFFSET(0xE063C80)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xE0648E0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xE064B40)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xE064A90)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_CONFIGSAVENAME_OFFSET UNITYSDK_OFFSET(0xE064940)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_ISBAKEDATACONTAINERMODE_OFFSET UNITYSDK_OFFSET(0xE05B350)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_ISINSTANCEARRAYRENDERINGMODE_OFFSET UNITYSDK_OFFSET(0xE0648D0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xE064ED0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_GET_RENDERINSTANCECOLLECTMODE_OFFSET UNITYSDK_OFFSET(0xE065840)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_HASANYEXTERNALTRANSFORMINPUT_OFFSET UNITYSDK_OFFSET(0xE05E290)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_HASHOVERBRIDGEDEPENDENCY_OFFSET UNITYSDK_OFFSET(0xE05E2F0)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_PRUNEEXTERNALTRANSFORMSBYFRAMEAGE_OFFSET UNITYSDK_OFFSET(0xE064080)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_REMOVEEXTERNALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE063950)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_SETEXTERNALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE063130)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN_TRYGETEXTERNALELEMENTWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xE05EB10)
#define RPG_CLIENT_SCENE_INSTANCEARRAYMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xE065850)
