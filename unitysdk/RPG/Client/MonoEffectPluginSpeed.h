...
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0EE030)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xC0EDFB0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xC0EDFF0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0xC0EE070)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xC0EE080)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginSpeed_TypeDefinitionIndex = 65556;
