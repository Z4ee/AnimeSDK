...
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CDD9F0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CDD970)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CDD9B0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x9CDDA30)
#define RPG_CLIENT_MONOEFFECTPLUGINSPEED___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CDDA40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginSpeed_TypeDefinitionIndex = 57374;
