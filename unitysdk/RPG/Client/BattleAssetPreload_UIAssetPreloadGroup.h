...
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP_ADDTEMPCACHEUI_OFFSET UNITYSDK_OFFSET(0xC8EF930)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP_REFRESHAFTERENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xC8EF8E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP_REFRESHBEFOREENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xC8EF6F0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP_REMOVETEMPCACHEUI_OFFSET UNITYSDK_OFFSET(0xC8EFA10)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP__ADDSTAGEUIASSETS_OFFSET UNITYSDK_OFFSET(0xC8EF3A0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP__COLLECTRESOURCEIMPLFORCOLLECTIONMODE_OFFSET UNITYSDK_OFFSET(0xC8EF240)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP__COLLECTRESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0xC8EEFC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xC8EFA80)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP__REFRESHINBATTLEUIASSETSFROMLINEUPDATA_OFFSET UNITYSDK_OFFSET(0xC8EF740)
#define RPG_CLIENT_BATTLEASSETPRELOAD_UIASSETPRELOADGROUP__RELEASERESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0xC8EF690)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(BattleAssetPreload_UIAssetPreloadGroup_TypeDefinitionIndex)->GetStaticField(0x14B90);
		}
