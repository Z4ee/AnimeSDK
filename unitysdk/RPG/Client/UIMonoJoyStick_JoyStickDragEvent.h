...
#define RPG_CLIENT_UIMONOJOYSTICK_JOYSTICKDRAGEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xCB6ED00)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMonoJoyStick_JoyStickDragEvent_TypeDefinitionIndex = 68040;
