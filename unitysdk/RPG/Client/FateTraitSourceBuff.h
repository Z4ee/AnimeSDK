...
#define RPG_CLIENT_FATETRAITSOURCEBUFF_GETDESC_OFFSET UNITYSDK_OFFSET(0xB9BC250)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_GETIMGICON_OFFSET UNITYSDK_OFFSET(0xB9BBF50)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_GETNAME_OFFSET UNITYSDK_OFFSET(0xB9BC170)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_GETRARITYBG_OFFSET UNITYSDK_OFFSET(0xB9BC0C0)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_GET_BUFFDATA_OFFSET UNITYSDK_OFFSET(0xB9BBFD0)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0xB9BC370)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xB9BC310)
#define RPG_CLIENT_FATETRAITSOURCEBUFF_SET_BUFFID_OFFSET UNITYSDK_OFFSET(0xB9BC380)
#define RPG_CLIENT_FATETRAITSOURCEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xB9BABE0)
