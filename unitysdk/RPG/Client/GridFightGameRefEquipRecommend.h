...
#define RPG_CLIENT_GRIDFIGHTGAMEREFEQUIPRECOMMEND_COMPARETO_OFFSET UNITYSDK_OFFSET(0xA4D0410)
#define RPG_CLIENT_GRIDFIGHTGAMEREFEQUIPRECOMMEND__CTOR_OFFSET UNITYSDK_OFFSET(0xA4CD730)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameRefEquipRecommend_TypeDefinitionIndex = 59593;
