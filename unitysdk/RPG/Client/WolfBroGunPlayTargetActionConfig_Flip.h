...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FLIP_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xA794C70)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FLIP_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xA794D00)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xA794CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Flip_TypeDefinitionIndex = 56108;
