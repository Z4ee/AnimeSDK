...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FLIP_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x16811320)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_FLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x168113A0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Flip_TypeDefinitionIndex = 68676;
