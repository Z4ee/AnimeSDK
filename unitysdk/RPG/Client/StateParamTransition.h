...
#define RPG_CLIENT_STATEPARAMTRANSITION_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A5014C0)
#define RPG_CLIENT_STATEPARAMTRANSITION_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A501880)
#define RPG_CLIENT_STATEPARAMTRANSITION_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5016C0)
#define RPG_CLIENT_STATEPARAMTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A501AE0)
