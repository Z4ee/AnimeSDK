...
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_CREATE_OFFSET UNITYSDK_OFFSET(0x190E6DD0)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GETBILLBOARDIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x190E6CE0)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GETTARGETENTITYPOS_OFFSET UNITYSDK_OFFSET(0x190E6BD0)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x190E6B40)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x190E6B30)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x190E6CA0)
#define RPG_CLIENT_FOURROTATEVOXELWAYPOINTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x190E70A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _LittleGameEntityID; // 0x1C
		::System::UInt32 _ContainerGroupID; // 0x20
		::UnityEngine::Vector3 _BornPosition; // 0x24
