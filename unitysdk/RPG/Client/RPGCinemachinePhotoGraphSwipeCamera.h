...
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_DISABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xDDCA980)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_ENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xDDCA890)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDDCAB30)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_OVERRIDESWIPECONFIG_OFFSET UNITYSDK_OFFSET(0xDDCA9E0)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xDDCAC60)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_START_OFFSET UNITYSDK_OFFSET(0xDDCAA50)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xDDCAD30)
