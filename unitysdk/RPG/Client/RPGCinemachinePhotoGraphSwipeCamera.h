...
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_DISABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xAF3F8C0)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_ENABLEUPDATE_OFFSET UNITYSDK_OFFSET(0xAF3F7D0)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAF3FA70)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_OVERRIDESWIPECONFIG_OFFSET UNITYSDK_OFFSET(0xAF3F920)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0xAF3FB30)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA_START_OFFSET UNITYSDK_OFFSET(0xAF3F990)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xAF3FBF0)
#define RPG_CLIENT_RPGCINEMACHINEPHOTOGRAPHSWIPECAMERA___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAF3FC00)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCinemachinePhotoGraphSwipeCamera_TypeDefinitionIndex = 64243;
