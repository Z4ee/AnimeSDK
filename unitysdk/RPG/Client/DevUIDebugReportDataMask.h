...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x944B7F0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataMask_TypeDefinitionIndex = 55787;
