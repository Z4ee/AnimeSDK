...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAMASK__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F99C0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataMask_TypeDefinitionIndex = 63019;
