...
#define RPG_CLIENT_DEVUIDEBUGREPORTDATAMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x18094DA0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevUIDebugReportDataMask_TypeDefinitionIndex = 65305;
