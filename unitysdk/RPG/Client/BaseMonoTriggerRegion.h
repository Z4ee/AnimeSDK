...
#define RPG_CLIENT_BASEMONOTRIGGERREGION_GETTRIGGER_OFFSET UNITYSDK_OFFSET(0xC8CCF10)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_OVERLAPPOINT_OFFSET UNITYSDK_OFFSET(0xC8CCF50)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_OVERLAP_OFFSET UNITYSDK_OFFSET(0xC8CCFB0)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_SETTRIGGER_OFFSET UNITYSDK_OFFSET(0xC8CCE50)
#define RPG_CLIENT_BASEMONOTRIGGERREGION_SYNCTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC8CD000)
#define RPG_CLIENT_BASEMONOTRIGGERREGION__CTOR_OFFSET UNITYSDK_OFFSET(0xC8CD150)
