...
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CONE_METHOD_2_38DF093766CC711E_OFFSET UNITYSDK_OFFSET(0x15E61020)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CONE_METHOD_2_4F2C6507D17C6667_OFFSET UNITYSDK_OFFSET(0x15E60A50)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CONE_METHOD_2_742B4CA18DC7C22B_OFFSET UNITYSDK_OFFSET(0x15E60B10)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CONE_METHOD_2_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x15E5FDD0)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CONE_METHOD_2_E19F224D4967A3A0_OFFSET UNITYSDK_OFFSET(0x15E5FE50)
#define RPG_CLIENT_EFFECT_GPUPARTICLESHAPEEMITTERMONOPLUGIN_CONE__CTOR_OFFSET UNITYSDK_OFFSET(0x15E61690)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_GPUParticleShapeEmitterMonoPlugin_Cone_TypeDefinitionIndex = 70454;
