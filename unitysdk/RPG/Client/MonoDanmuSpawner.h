...
#define RPG_CLIENT_MONODANMUSPAWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E457D0)
#define RPG_CLIENT_MONODANMUSPAWNER_DESPAWN_OFFSET UNITYSDK_OFFSET(0x19E432D0)
#define RPG_CLIENT_MONODANMUSPAWNER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E45910)
#define RPG_CLIENT_MONODANMUSPAWNER_GET_GIFTROOTRECT_OFFSET UNITYSDK_OFFSET(0x19E44C30)
#define RPG_CLIENT_MONODANMUSPAWNER_GET_IMAGEROOTRECT_OFFSET UNITYSDK_OFFSET(0x19E44BC0)
#define RPG_CLIENT_MONODANMUSPAWNER_GET_TEXTROOTRECT_OFFSET UNITYSDK_OFFSET(0x19E44B50)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_2CEAC11AEBDD3C75_OFFSET UNITYSDK_OFFSET(0x19E45970)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_422422BBCBC8068C_OFFSET UNITYSDK_OFFSET(0x19E458A0)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19E45820)
#define RPG_CLIENT_MONODANMUSPAWNER_METHOD_5_702463A421B5F338_OFFSET UNITYSDK_OFFSET(0x19E45A40)
#define RPG_CLIENT_MONODANMUSPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0x19E438C0)
#define RPG_CLIENT_MONODANMUSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E45AF0)
