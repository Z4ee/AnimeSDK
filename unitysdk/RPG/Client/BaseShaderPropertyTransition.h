...
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_AWAKE_OFFSET UNITYSDK_OFFSET(0x19F1CD40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARCAMERADITHERALPHA_OFFSET UNITYSDK_OFFSET(0x19F1C810)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x19F1C720)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F1D5E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETCURRENTDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x19F1BB20)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERANIMTIME_OFFSET UNITYSDK_OFFSET(0x19F1BBD0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERTRANSITIONINFO_OFFSET UNITYSDK_OFFSET(0x19F1BCB0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x19F1CCA0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETTARGETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x19F1BB70)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x19F1DB20)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0x19F1DB10)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_ISFORBIDCAMERADITHER_OFFSET UNITYSDK_OFFSET(0x19F1DB40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ISDITHERANIMFINISH_OFFSET UNITYSDK_OFFSET(0x19F1BC50)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0x19F1D2F0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_049407E7CFE73C8B_OFFSET UNITYSDK_OFFSET(0x19F1D9E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_288B0CA3C3E003D9_OFFSET UNITYSDK_OFFSET(0x19F1C530)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_40F411C01C4CB2C1_OFFSET UNITYSDK_OFFSET(0x19F1BE00)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x19F1C680)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_56A14AED8987ABED_OFFSET UNITYSDK_OFFSET(0x19F1D800)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x19F1D470)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x19F1C8D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_E9694624E40011FE_OFFSET UNITYSDK_OFFSET(0x19F1D730)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0x19F1D010)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19F1CE40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0x19F1D510)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x19F1CEF0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDISTANCEDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x19F1C0E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0x19F1C210)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x19F1C180)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x19F1CCE0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETELEVATIONDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0x19F1BD70)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETFINISHCURRENTDITHERTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x19F1C5E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0x19F1CB30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0x19F1DB30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0x19F1CE00)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_TICK_OFFSET UNITYSDK_OFFSET(0x19F1D2B0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19F1DBC0)
