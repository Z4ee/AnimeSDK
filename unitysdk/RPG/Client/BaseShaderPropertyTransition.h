...
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_AWAKE_OFFSET UNITYSDK_OFFSET(0xB3B5B50)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARCAMERADITHERALPHA_OFFSET UNITYSDK_OFFSET(0xB3B5670)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_CLEARDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xB3B5580)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB3B6330)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETCURRENTDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xB3B4980)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERANIMTIME_OFFSET UNITYSDK_OFFSET(0xB3B4A30)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETDITHERTRANSITIONINFO_OFFSET UNITYSDK_OFFSET(0xB3B4B10)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xB3B5AB0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GETTARGETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0xB3B49D0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0xB3B6810)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xB3B6800)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_GET_ISFORBIDCAMERADITHER_OFFSET UNITYSDK_OFFSET(0xB3B6830)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ISDITHERANIMFINISH_OFFSET UNITYSDK_OFFSET(0xB3B4AB0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_LATETICK_OFFSET UNITYSDK_OFFSET(0xB3B6040)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_288B0CA3C3E003D9_OFFSET UNITYSDK_OFFSET(0xB3B5390)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_40F411C01C4CB2C1_OFFSET UNITYSDK_OFFSET(0xB3B4C60)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xB3B54E0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_56A14AED8987ABED_OFFSET UNITYSDK_OFFSET(0xB3B6550)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0xB3B5730)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_8B320F9C06FC45D4_OFFSET UNITYSDK_OFFSET(0xB3B6730)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_B10FB9597F17FCB4_OFFSET UNITYSDK_OFFSET(0xB3B61C0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_E9694624E40011FE_OFFSET UNITYSDK_OFFSET(0xB3B6480)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0xB3B5D60)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB3B5BF0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_ONREFRESHMATERIALS_OFFSET UNITYSDK_OFFSET(0xB3B6260)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0xB3B5C40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDISTANCEDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0xB3B4F40)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUEWITHANIMATION_OFFSET UNITYSDK_OFFSET(0xB3B5070)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0xB3B4FE0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETDITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0xB3B5AF0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETELEVATIONDITHERALPHAVALUE_OFFSET UNITYSDK_OFFSET(0xB3B4BD0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETFINISHCURRENTDITHERTRANSITIONIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0xB3B5440)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SETOWNERENTITY_OFFSET UNITYSDK_OFFSET(0xB3B5990)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_SET_DITHERTIMESCALE_OFFSET UNITYSDK_OFFSET(0xB3B6820)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_START_OFFSET UNITYSDK_OFFSET(0xB3B5BB0)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION_TICK_OFFSET UNITYSDK_OFFSET(0xB3B6000)
#define RPG_CLIENT_BASESHADERPROPERTYTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xB3B68B0)

namespace RPG::Client
{
	inline static constexpr unsigned int BaseShaderPropertyTransition_TypeDefinitionIndex = 64410;
	...
	public:
		...
		::System::Void Method_5_B10FB9597F17FCB4()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_BASESHADERPROPERTYTRANSITION_METHOD_5_B10FB9597F17FCB4_OFFSET))(this);
		}
