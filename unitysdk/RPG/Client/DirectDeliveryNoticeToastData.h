...
#define RPG_CLIENT_DIRECTDELIVERYNOTICETOASTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA177740)

namespace RPG::Client
{
	inline static constexpr unsigned int DirectDeliveryNoticeToastData_TypeDefinitionIndex = 58578;
