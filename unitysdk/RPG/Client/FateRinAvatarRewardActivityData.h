...
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_GETENTRY_OFFSET UNITYSDK_OFFSET(0x1B5D1BE0)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_GETFATERINSUPPORTMODULE_OFFSET UNITYSDK_OFFSET(0x1B5D1B50)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_HASPENDINGREWARD_OFFSET UNITYSDK_OFFSET(0x1B5AA680)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_ISFINISHCONDITIONSCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B5D1A10)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1B5D1C80)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5D1CD0)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D1A00)
#define RPG_CLIENT_FATERINAVATARREWARDACTIVITYDATA__ISFEATURECLOSED_OFFSET UNITYSDK_OFFSET(0x1B5D1A80)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(FateRinAvatarRewardActivityData_TypeDefinitionIndex)->GetStaticField(0x2570);
		}
