...
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_GETPREVIEWFORMULADATA_OFFSET UNITYSDK_OFFSET(0xDEB9EA0)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_GET_ALREADYHAVE_OFFSET UNITYSDK_OFFSET(0xDEB9F70)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_GET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0xDEB9F50)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_GET_CURRENCYITEM_OFFSET UNITYSDK_OFFSET(0xDEB9F10)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_GET_FORMULAID_OFFSET UNITYSDK_OFFSET(0xDEB9EF0)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_GET_ORIGINCURRENCYITEM_OFFSET UNITYSDK_OFFSET(0xDEB9F30)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_SET_ALREADYHAVE_OFFSET UNITYSDK_OFFSET(0xDEB9F80)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_SET_AVAILABLE_OFFSET UNITYSDK_OFFSET(0xDEB9F60)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_SET_CURRENCYITEM_OFFSET UNITYSDK_OFFSET(0xDEB9F20)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_SET_FORMULAID_OFFSET UNITYSDK_OFFSET(0xDEB9F00)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA_SET_ORIGINCURRENCYITEM_OFFSET UNITYSDK_OFFSET(0xDEB9F40)
#define RPG_CLIENT_ROGUEFORMULASHOPITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDEB9B60)
