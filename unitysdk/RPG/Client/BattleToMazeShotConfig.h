...
#define RPG_CLIENT_BATTLETOMAZESHOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB41C150)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleToMazeShotConfig_TypeDefinitionIndex = 65186;
