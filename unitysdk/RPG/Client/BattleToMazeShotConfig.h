...
#define RPG_CLIENT_BATTLETOMAZESHOTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD704A0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleToMazeShotConfig_TypeDefinitionIndex = 69694;
