...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR_GETBASECHARACTERFILTER_OFFSET UNITYSDK_OFFSET(0x9CBB300)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBB370)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x9CBB6C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPREFSPECULAR___IFIXBASEPROXY_GETBASECHARACTERFILTER_OFFSET UNITYSDK_OFFSET(0x9CBB6E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropRefSpecular_TypeDefinitionIndex = 57251;
