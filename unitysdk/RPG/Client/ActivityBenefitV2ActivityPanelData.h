...
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA_ISAVAILABLE_OFFSET UNITYSDK_OFFSET(0x1AD2D430)
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA_ISFINISHCONDITIONSCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AD2D4E0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x1AD2D5E0)
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD2D060)
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD2D180)
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0x1AD2D070)
#define RPG_CLIENT_ACTIVITYBENEFITV2ACTIVITYPANELDATA___ONINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0x1AD2D740)
