...
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xA51B900)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_POWERREQUIRE_OFFSET UNITYSDK_OFFSET(0xA51BBF0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPID_OFFSET UNITYSDK_OFFSET(0xA51B9A0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPNAME_OFFSET UNITYSDK_OFFSET(0xA51BAF0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKICON_OFFSET UNITYSDK_OFFSET(0xA51BCD0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKPROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xA51BB70)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKSUBNAME_OFFSET UNITYSDK_OFFSET(0xA51BA70)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0xA51B990)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_UNLOCKID_OFFSET UNITYSDK_OFFSET(0xA51BC60)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA51BA10)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA51B980)

namespace RPG::Client
{
	inline static constexpr unsigned int SwordTrainingPowerRankData_TypeDefinitionIndex = 50297;
	...
	public:
		...
		static ::RPG::Client::SwordTrainingPowerRankData* Create(::System::UInt32 rankID)
		{
			return ((::RPG::Client::SwordTrainingPowerRankData*(*)(::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_CREATE_OFFSET))(rankID);
		}
