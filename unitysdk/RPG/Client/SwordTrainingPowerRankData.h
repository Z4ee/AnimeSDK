...
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB258860)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_POWERREQUIRE_OFFSET UNITYSDK_OFFSET(0xB258B50)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPID_OFFSET UNITYSDK_OFFSET(0xB258900)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPNAME_OFFSET UNITYSDK_OFFSET(0xB258A50)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKICON_OFFSET UNITYSDK_OFFSET(0xB258C30)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKPROGRESSNAME_OFFSET UNITYSDK_OFFSET(0xB258AD0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKSUBNAME_OFFSET UNITYSDK_OFFSET(0xB2589D0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0xB2588F0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_UNLOCKID_OFFSET UNITYSDK_OFFSET(0xB258BC0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xB258970)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB2588E0)

namespace RPG::Client
{
	inline static constexpr unsigned int SwordTrainingPowerRankData_TypeDefinitionIndex = 57156;
