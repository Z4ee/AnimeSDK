...
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19C73460)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_POWERREQUIRE_OFFSET UNITYSDK_OFFSET(0x19C73870)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPID_OFFSET UNITYSDK_OFFSET(0x19C73530)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKGROUPNAME_OFFSET UNITYSDK_OFFSET(0x19C736F0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKICON_OFFSET UNITYSDK_OFFSET(0x19C739B0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKPROGRESSNAME_OFFSET UNITYSDK_OFFSET(0x19C737B0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANKSUBNAME_OFFSET UNITYSDK_OFFSET(0x19C73630)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0x19C734F0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET_UNLOCKID_OFFSET UNITYSDK_OFFSET(0x19C73910)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x19C735D0)
#define RPG_CLIENT_SWORDTRAININGPOWERRANKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19C734E0)

namespace RPG::Client
{
	inline static constexpr unsigned int SwordTrainingPowerRankData_TypeDefinitionIndex = 59212;
