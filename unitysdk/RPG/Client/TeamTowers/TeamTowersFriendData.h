...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xE1AA670)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_ENDLESSBESTROUND_OFFSET UNITYSDK_OFFSET(0xE1AAC90)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_HASENDLESSRECORD_OFFSET UNITYSDK_OFFSET(0xE1AAD70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xE1AA970)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_ISMARKED_OFFSET UNITYSDK_OFFSET(0xE1AABC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_ISONLINE_OFFSET UNITYSDK_OFFSET(0xE1AAB00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xE1AA920)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_LOGOUTTIMESPAN_OFFSET UNITYSDK_OFFSET(0xE1AAB60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_NICKNAME_OFFSET UNITYSDK_OFFSET(0xE1AA8B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_PLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xE1AAA10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_RANK_OFFSET UNITYSDK_OFFSET(0xE1AADD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0xE1AAC20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xE1AA860)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA_OVERRIDERANK_OFFSET UNITYSDK_OFFSET(0xE1AAE30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE1AA660)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersFriendData_TypeDefinitionIndex = 78551;
