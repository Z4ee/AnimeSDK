...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL_GETFRIENDRANKLIST_OFFSET UNITYSDK_OFFSET(0x18577D30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL_GETSELFRANKDATA_OFFSET UNITYSDK_OFFSET(0x18577D70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL_UPDATERANKINGDATA_OFFSET UNITYSDK_OFFSET(0x18577A30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL__BUILDFRIENDRANKLIST_OFFSET UNITYSDK_OFFSET(0x18577DB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x185782A0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersFriendRankDialogViewModel_TypeDefinitionIndex = 75086;
