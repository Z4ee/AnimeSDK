...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILSTARSVIEWMODEL_GETSTARINFOLIST_OFFSET UNITYSDK_OFFSET(0xE1C0D20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILSTARSVIEWMODEL_GET_ACHIEVEDCOUNT_OFFSET UNITYSDK_OFFSET(0xE1C0D60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILSTARSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xE1BA3C0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersStageDetailStarsViewModel_TypeDefinitionIndex = 78604;
