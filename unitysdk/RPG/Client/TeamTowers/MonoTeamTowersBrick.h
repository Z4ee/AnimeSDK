...
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK_GETSCREENRECT_OFFSET UNITYSDK_OFFSET(0x185761C0)
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK_INIT_OFFSET UNITYSDK_OFFSET(0x18576150)
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18576690)
#define RPG_CLIENT_TEAMTOWERS_MONOTEAMTOWERSBRICK__CTOR_OFFSET UNITYSDK_OFFSET(0x185766E0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int MonoTeamTowersBrick_TypeDefinitionIndex = 75118;

	class MonoTeamTowersBrick : public ::UnityEngine::MonoBehaviour
	{
	public:
		::Class_0_16E4307DCC419505_27* Field_5_0; // 0x18
