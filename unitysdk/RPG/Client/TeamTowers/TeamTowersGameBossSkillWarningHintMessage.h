...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_DESC_OFFSET UNITYSDK_OFFSET(0x18578730)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x18578670)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ISICE_OFFSET UNITYSDK_OFFSET(0x18578840)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ISWIND_OFFSET UNITYSDK_OFFSET(0x185787F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x185786C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x185787A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18578630)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersGameBossSkillWarningHintMessage_TypeDefinitionIndex = 75041;
