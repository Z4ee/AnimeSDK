...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_DESC_OFFSET UNITYSDK_OFFSET(0xE1ABB60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xE1ABAA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ISICE_OFFSET UNITYSDK_OFFSET(0xE1ABC70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_ISWIND_OFFSET UNITYSDK_OFFSET(0xE1ABC20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0xE1ABAF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xE1ABBD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMEBOSSSKILLWARNINGHINTMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE1ABA60)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersGameBossSkillWarningHintMessage_TypeDefinitionIndex = 78540;
