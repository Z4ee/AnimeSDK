...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENLOBBYPAGE_OFFSET UNITYSDK_OFFSET(0x19469250)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSETTINGDIALOG_OFFSET UNITYSDK_OFFSET(0x194738F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSKILLDIALOG_OFFSET UNITYSDK_OFFSET(0x194737E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSTAGEDETAILPAGE_OFFSET UNITYSDK_OFFSET(0x19473620)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_SHOWRECONNECTCONFIRM_OFFSET UNITYSDK_OFFSET(0x19469570)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19473610)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersWindowService_TypeDefinitionIndex = 75084;
