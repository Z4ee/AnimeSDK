...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENLOBBYPAGE_OFFSET UNITYSDK_OFFSET(0xE1B8C10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSETTINGDIALOG_OFFSET UNITYSDK_OFFSET(0xE1C32E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSKILLDIALOG_OFFSET UNITYSDK_OFFSET(0xE1C31D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_OPENSTAGEDETAILPAGE_OFFSET UNITYSDK_OFFSET(0xE1C3010)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE_SHOWRECONNECTCONFIRM_OFFSET UNITYSDK_OFFSET(0xE1B8F30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSWINDOWSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xE1C3000)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersWindowService_TypeDefinitionIndex = 78583;
