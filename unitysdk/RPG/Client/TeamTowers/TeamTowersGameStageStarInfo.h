...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1857AB30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_INITIALHIDE_OFFSET UNITYSDK_OFFSET(0x1857ABF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1857AC40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x1857ABA0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_GET_STARID_OFFSET UNITYSDK_OFFSET(0x1857AAE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1857AC50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSGAMESTAGESTARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1857AAA0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersGameStageStarInfo_TypeDefinitionIndex = 75091;
