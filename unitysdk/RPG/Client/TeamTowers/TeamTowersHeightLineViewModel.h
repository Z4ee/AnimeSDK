...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET_CURHEIGHT_OFFSET UNITYSDK_OFFSET(0xE1AD7A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET_TARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0xE1B0DD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET__PLAYERENTITY_OFFSET UNITYSDK_OFFSET(0xE1B0D60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_ISSKILLLINE_OFFSET UNITYSDK_OFFSET(0xE1B0C80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_SET_TARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0xE1B0DE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xE1ACAF0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersHeightLineViewModel_TypeDefinitionIndex = 78593;
	...
	public:
		...
		::System::UInt32 _TargetHeight_k__BackingField; // 0x1C
