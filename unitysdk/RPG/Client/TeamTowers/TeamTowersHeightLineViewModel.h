...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET_CURHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A3AB090)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET_TARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A3AE6A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_GET__PLAYERENTITY_OFFSET UNITYSDK_OFFSET(0x1A3AE630)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_ISSKILLLINE_OFFSET UNITYSDK_OFFSET(0x1A3AE550)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL_SET_TARGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A3AE6B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSHEIGHTLINEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AA3F0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersHeightLineViewModel_TypeDefinitionIndex = 78592;
