...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1AC92C20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1AC92BD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1AC92D30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1AC92B80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC92C80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x1AC92B30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1AC92D50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0x1AC92CE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_REGISTERONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AC927A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_SELECT_OFFSET UNITYSDK_OFFSET(0x1AC927F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_SET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1AC92D40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC92790)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPlayerSkillViewModel_TypeDefinitionIndex = 78610;
