...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0xE1BA150)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xE1BA100)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0xE1BA260)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xE1BA0B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xE1BA1B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xE1BA060)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0xE1BA280)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0xE1BA210)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_REGISTERONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xE1B9CD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_SELECT_OFFSET UNITYSDK_OFFSET(0xE1B9D20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL_SET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0xE1BA270)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xE1B9CC0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPlayerSkillViewModel_TypeDefinitionIndex = 78611;

	class TeamTowersPlayerSkillViewModel : public ::System::Object
	{
	public:
		::System::Action_1<::RPG::Client::TeamTowers::TeamTowersPlayerSkillViewModel*>* _OnClick; // 0x10
		::Class_1_47CFC2D7B3865B39* _SkillInfo; // 0x18
