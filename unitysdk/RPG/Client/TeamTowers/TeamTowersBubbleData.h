...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBUBBLEDATA_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x1A3A7E50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBUBBLEDATA_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A3A7E40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBUBBLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A7DA0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersBubbleData_TypeDefinitionIndex = 78549;
