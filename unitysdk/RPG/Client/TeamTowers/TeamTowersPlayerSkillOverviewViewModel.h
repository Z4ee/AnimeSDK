...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL_GET_PLAYERSKILLGROUPS_OFFSET UNITYSDK_OFFSET(0xE1B9E10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL_GET_SELECTEDSKILL_OFFSET UNITYSDK_OFFSET(0xE1B9F70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL_REGISTEROVERVIEWREFRESHCALLBACK_OFFSET UNITYSDK_OFFSET(0xE1B9AB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__ADDSKILLGROUP_OFFSET UNITYSDK_OFFSET(0xE1B9B00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xE1B9320)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__INITPLAYERSKILLGROUPS_OFFSET UNITYSDK_OFFSET(0xE1B9470)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__INITPLAYERSKILLS_OFFSET UNITYSDK_OFFSET(0xE1B9600)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL__ONSELECTEDSKILLCHANGED_OFFSET UNITYSDK_OFFSET(0xE1B9D80)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPlayerSkillOverviewViewModel_TypeDefinitionIndex = 78613;

	class TeamTowersPlayerSkillOverviewViewModel : public ::System::Object
	{
	public:
		::System::Action_1<::RPG::Client::TeamTowers::TeamTowersPlayerSkillViewModel*>* _RefreshOverviewCallBack; // 0x10
		::Class_1_7EEA5E93C4D09894* _Repository; // 0x18
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::TeamTowersPlayerSkillType, ::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*>* _PlayerSkillGroupDict; // 0x20
		::System::Collections::Generic::List_1<::Class_1_47CFC2D7B3865B39*>* _PlayerSkillInfoList; // 0x28
		::System::Collections::Generic::List_1<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*>* _PlayerSkillGroups; // 0x30
		::RPG::Client::TeamTowers::TeamTowersPlayerSkillViewModel* _SelectedSkill; // 0x38
