...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC92A80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC92AC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL___C__GET_PLAYERSKILLGROUPS_B__7_0_OFFSET UNITYSDK_OFFSET(0x1AC92B00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL___C___INITPLAYERSKILLS_B__4_0_OFFSET UNITYSDK_OFFSET(0x1AC92AD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPLAYERSKILLOVERVIEWVIEWMODEL___C___INITPLAYERSKILLS_B__4_1_OFFSET UNITYSDK_OFFSET(0x1AC92AE0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPlayerSkillOverviewViewModel___c_TypeDefinitionIndex = 78613;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*, ::System::Collections::Generic::IEnumerable_1<::RPG::Client::TeamTowers::TeamTowersPlayerSkillViewModel*>*>**)Il2CppClass::FromTypeDefinitionIndex(TeamTowersPlayerSkillOverviewViewModel___c_TypeDefinitionIndex)->GetStaticField(0x53B50);
		}
		static ::System::Func_2<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*, ::System::Boolean>** StaticGet___9__7_0()
		{
			return (::System::Func_2<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(TeamTowersPlayerSkillOverviewViewModel___c_TypeDefinitionIndex)->GetStaticField(0x53B58);
		}
		static ::System::Func_2<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*, ::System::Boolean>** StaticGet___9__4_0()
		{
			return (::System::Func_2<::RPG::Client::TeamTowers::TeamTowersPlayerSkillGroupViewModel*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(TeamTowersPlayerSkillOverviewViewModel___c_TypeDefinitionIndex)->GetStaticField(0x53B60);
		}
		static ::RPG::Client::TeamTowers::TeamTowersPlayerSkillOverviewViewModel___c** StaticGet___9()
		{
			return (::RPG::Client::TeamTowers::TeamTowersPlayerSkillOverviewViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(TeamTowersPlayerSkillOverviewViewModel___c_TypeDefinitionIndex)->GetStaticField(0x53B68);
		}
