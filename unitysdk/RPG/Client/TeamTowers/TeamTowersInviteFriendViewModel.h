...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETFRIENDDATALIST_OFFSET UNITYSDK_OFFSET(0x1A3AE820)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETLOBBY_OFFSET UNITYSDK_OFFSET(0x1A3AF2E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETROBOTDATA_OFFSET UNITYSDK_OFFSET(0x1A3AF000)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_GETROBOTIDLIST_OFFSET UNITYSDK_OFFSET(0x1A3AEB20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_INVITEFRIEND_OFFSET UNITYSDK_OFFSET(0x1A3AF110)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_INVITEROBOT_OFFSET UNITYSDK_OFFSET(0x1A3AF170)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_ISFRIENDINLOBBY_OFFSET UNITYSDK_OFFSET(0x1A3AF060)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL_UPDATEFRIENDDATA_OFFSET UNITYSDK_OFFSET(0x1A3AE780)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL__COMPAREFRIEND_OFFSET UNITYSDK_OFFSET(0x1A3AF3A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSINVITEFRIENDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AE6C0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersInviteFriendViewModel_TypeDefinitionIndex = 78593;
