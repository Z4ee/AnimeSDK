...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_GET_NEEDPLAYUNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x1AC99B40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_GET_STAGEDATA_OFFSET UNITYSDK_OFFSET(0x1AC99B10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_GET_STARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AC99B20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_MARKUNLOCKANIMASSEEN_OFFSET UNITYSDK_OFFSET(0x1AC99CE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL_SET_STARSVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1AC99B30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSTAGEDETAILTABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC99B00)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersStageDetailTabViewModel_TypeDefinitionIndex = 78605;
