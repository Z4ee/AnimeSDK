...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xE1AA470)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xE1AA460)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xE1AA450)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0xE1AA480)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xE1AA440)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0xE1AA490)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE1A9D10)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersBossSkillData_TypeDefinitionIndex = 78549;
	...
	public:
		...
		::System::UInt32 _VideoID_k__BackingField; // 0x40
