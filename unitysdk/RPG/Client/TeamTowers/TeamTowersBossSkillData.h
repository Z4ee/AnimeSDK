...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x18577060)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x18577050)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18577040)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x18577070)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0x18577030)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA_GET_VIDEOID_OFFSET UNITYSDK_OFFSET(0x18577080)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSBOSSSKILLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18576AA0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersBossSkillData_TypeDefinitionIndex = 75050;
