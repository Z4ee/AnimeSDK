...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CHECKANDSHOWRECONNECTCONFIRM_OFFSET UNITYSDK_OFFSET(0x1A3B4730)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x1A3B5CF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CREATEMPPLAYEREXTINFO_OFFSET UNITYSDK_OFFSET(0x1A3B5970)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CREATEMPROOMEXTINFO_OFFSET UNITYSDK_OFFSET(0x1A3B5BB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_GAMEMODE_OFFSET UNITYSDK_OFFSET(0x1A3B58B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_INVITETOASTUIPATH_OFFSET UNITYSDK_OFFSET(0x1A3B5900)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_ISINGAME_OFFSET UNITYSDK_OFFSET(0x1A3B65A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_ISSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A3B6610)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ISINACTIVITYGAME_OFFSET UNITYSDK_OFFSET(0x1A3B5E50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONCREATEGAME_OFFSET UNITYSDK_OFFSET(0x1A3B62A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONFINISHGAME_OFFSET UNITYSDK_OFFSET(0x1A3B62F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x1A3B6480)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x1A3B6400)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A3B6350)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A3B63B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1A3B5D40)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_REGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x1A3B60F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_SETINVITEROBOTID_OFFSET UNITYSDK_OFFSET(0x1A3AF1D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_SETSELECTEDGAMETYPE_OFFSET UNITYSDK_OFFSET(0x1A3B4C70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_SET_ISSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A3B6620)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_STARTMATCHWITHROBOTSYNC_OFFSET UNITYSDK_OFFSET(0x1A3B1330)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_START_OFFSET UNITYSDK_OFFSET(0x1A3B5FB0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_STOP_OFFSET UNITYSDK_OFFSET(0x1A3B6050)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_UNREGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x1A3B61E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_0_OFFSET UNITYSDK_OFFSET(0x1A3B6640)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_1_OFFSET UNITYSDK_OFFSET(0x1A3B67D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_2_OFFSET UNITYSDK_OFFSET(0x1A3B6700)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_3_OFFSET UNITYSDK_OFFSET(0x1A3B67C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_4_OFFSET UNITYSDK_OFFSET(0x1A3B67A0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B5880)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__ONACCEPTINVITATIONNOTIFY_OFFSET UNITYSDK_OFFSET(0x1A3B64F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__ONENTERLOBBY_OFFSET UNITYSDK_OFFSET(0x1A3B5DF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__STARTMATCHWITHROBOTSYNC_B__22_0_OFFSET UNITYSDK_OFFSET(0x1A3B6630)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPVPService_TypeDefinitionIndex = 78577;
	...
	public:
		...
		::RPG::Client::TeamTowers::TeamTowersWindowService* _WindowService; // 0x40
		::System::Action* _OnServerConnected; // 0x48
