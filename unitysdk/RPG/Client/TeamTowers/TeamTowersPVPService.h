...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CHECKANDSHOWRECONNECTCONFIRM_OFFSET UNITYSDK_OFFSET(0x19469120)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CHECKCANENTERMPGAME_OFFSET UNITYSDK_OFFSET(0x19468570)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CREATEMPPLAYEREXTINFO_OFFSET UNITYSDK_OFFSET(0x194681F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_CREATEMPROOMEXTINFO_OFFSET UNITYSDK_OFFSET(0x19468430)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_GAMEMODE_OFFSET UNITYSDK_OFFSET(0x19468130)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_INVITETOASTUIPATH_OFFSET UNITYSDK_OFFSET(0x19468180)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_ISINGAME_OFFSET UNITYSDK_OFFSET(0x19469410)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_GET_ISSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x19469480)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ISINACTIVITYGAME_OFFSET UNITYSDK_OFFSET(0x194686D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONCREATEGAME_OFFSET UNITYSDK_OFFSET(0x19468B20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONFINISHGAME_OFFSET UNITYSDK_OFFSET(0x19468B70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONGENERALNOTIFY_OFFSET UNITYSDK_OFFSET(0x19468D00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONONGENERALRSP_OFFSET UNITYSDK_OFFSET(0x19468C80)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x19468BD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONSERVERDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x19468C30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_ONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x194685C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_REGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x19468970)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_SETINVITEROBOTID_OFFSET UNITYSDK_OFFSET(0x19468DC0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_SETSELECTEDGAMETYPE_OFFSET UNITYSDK_OFFSET(0x19468D70)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_SET_ISSERVERCONNECTED_OFFSET UNITYSDK_OFFSET(0x19469490)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_STARTMATCHWITHROBOTSYNC_OFFSET UNITYSDK_OFFSET(0x19468ED0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_START_OFFSET UNITYSDK_OFFSET(0x19468830)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_STOP_OFFSET UNITYSDK_OFFSET(0x194688D0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE_UNREGISTERGUEST_OFFSET UNITYSDK_OFFSET(0x19468A60)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_0_OFFSET UNITYSDK_OFFSET(0x194694B0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_1_OFFSET UNITYSDK_OFFSET(0x194697F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_2_OFFSET UNITYSDK_OFFSET(0x19469720)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_3_OFFSET UNITYSDK_OFFSET(0x194697E0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CHECKANDSHOWRECONNECTCONFIRM_B__23_4_OFFSET UNITYSDK_OFFSET(0x194697C0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x194680F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__ONACCEPTINVITATIONNOTIFY_OFFSET UNITYSDK_OFFSET(0x19469360)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__ONENTERLOBBY_OFFSET UNITYSDK_OFFSET(0x19468670)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSPVPSERVICE__STARTMATCHWITHROBOTSYNC_B__22_0_OFFSET UNITYSDK_OFFSET(0x194694A0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersPVPService_TypeDefinitionIndex = 75079;
	...
	public:
		...
		::System::Action_1<::Class_1_2375E47039821420*>* _OnGeneralNotify; // 0x40
