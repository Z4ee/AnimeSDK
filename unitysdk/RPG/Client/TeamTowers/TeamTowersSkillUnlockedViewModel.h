...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL_GET_NEWSKILLS_OFFSET UNITYSDK_OFFSET(0x19470F50)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL_GET_SELECTEDSKILLINDEX_OFFSET UNITYSDK_OFFSET(0x19470F90)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL_GET_SELECTEDSKILL_OFFSET UNITYSDK_OFFSET(0x19470F10)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL_REGISTERREFRESHCALLBACK_OFFSET UNITYSDK_OFFSET(0x19470E30)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19470BE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL__INITNEWSKILLS_OFFSET UNITYSDK_OFFSET(0x19470BF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSSKILLUNLOCKEDVIEWMODEL__ONSELECTEDSKILLCHANGED_OFFSET UNITYSDK_OFFSET(0x19470E80)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersSkillUnlockedViewModel_TypeDefinitionIndex = 75112;
