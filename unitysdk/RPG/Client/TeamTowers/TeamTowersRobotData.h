...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1946F250)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1946F240)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1946F220)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1946F230)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1946F1C0)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersRobotData_TypeDefinitionIndex = 75061;
