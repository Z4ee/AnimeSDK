...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xE1BEC00)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xE1BEBF0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xE1BEBD0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xE1BEBE0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSROBOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE1BEB70)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersRobotData_TypeDefinitionIndex = 78560;
