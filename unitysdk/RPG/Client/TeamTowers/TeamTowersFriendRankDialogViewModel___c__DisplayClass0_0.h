...
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18577D20)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL___C__DISPLAYCLASS0_0__UPDATERANKINGDATA_B__0_OFFSET UNITYSDK_OFFSET(0x185782F0)
#define RPG_CLIENT_TEAMTOWERS_TEAMTOWERSFRIENDRANKDIALOGVIEWMODEL___C__DISPLAYCLASS0_0__UPDATERANKINGDATA_B__1_OFFSET UNITYSDK_OFFSET(0x18578330)

namespace RPG::Client::TeamTowers
{
	inline static constexpr unsigned int TeamTowersFriendRankDialogViewModel___c__DisplayClass0_0_TypeDefinitionIndex = 75087;

	class TeamTowersFriendRankDialogViewModel___c__DisplayClass0_0 : public ::System::Object
	{
	public:
		::RPG::Client::TeamTowers::TeamTowersFriendRankDialogViewModel* __4__this; // 0x10
