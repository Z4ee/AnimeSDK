...
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xB4356C0)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_GET_FIVEDIMSIDEPUZZLEPANELPATHS_OFFSET UNITYSDK_OFFSET(0xB435650)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_GET_ISSHOWFIVEDIMSIDEPUZZLECHEST_OFFSET UNITYSDK_OFFSET(0xB435630)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xB435670)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_SET_FIVEDIMSIDEPUZZLEPANELPATHS_OFFSET UNITYSDK_OFFSET(0xB435660)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_SET_ISSHOWFIVEDIMSIDEPUZZLECHEST_OFFSET UNITYSDK_OFFSET(0xB435640)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB4331F0)

namespace RPG::Client::Billboard
{
	inline static constexpr unsigned int FiveDimSidePuzzleBillboardData_TypeDefinitionIndex = 69864;
