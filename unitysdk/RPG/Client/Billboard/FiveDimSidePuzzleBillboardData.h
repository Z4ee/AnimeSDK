...
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xC95A040)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_GET_FIVEDIMSIDEPUZZLEPANELPATHS_OFFSET UNITYSDK_OFFSET(0xC959FD0)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_GET_ISSHOWFIVEDIMSIDEPUZZLECHEST_OFFSET UNITYSDK_OFFSET(0xC959FB0)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xC959FF0)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_SET_FIVEDIMSIDEPUZZLEPANELPATHS_OFFSET UNITYSDK_OFFSET(0xC959FE0)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA_SET_ISSHOWFIVEDIMSIDEPUZZLECHEST_OFFSET UNITYSDK_OFFSET(0xC959FC0)
#define RPG_CLIENT_BILLBOARD_FIVEDIMSIDEPUZZLEBILLBOARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC957880)

namespace RPG::Client::Billboard
{
	inline static constexpr unsigned int FiveDimSidePuzzleBillboardData_TypeDefinitionIndex = 74694;
