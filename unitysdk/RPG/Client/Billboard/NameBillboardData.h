...
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA_CLONE_OFFSET UNITYSDK_OFFSET(0xB4370A0)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA_GET_TEXTIDNAME_OFFSET UNITYSDK_OFFSET(0xB436EB0)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA_GET_TEXTSTRINGNAME_OFFSET UNITYSDK_OFFSET(0xB436ED0)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xB436EF0)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA_SET_TEXTIDNAME_OFFSET UNITYSDK_OFFSET(0xB436EC0)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA_SET_TEXTSTRINGNAME_OFFSET UNITYSDK_OFFSET(0xB436EE0)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB432E70)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA__ISSTRINGVALID_OFFSET UNITYSDK_OFFSET(0xB436F80)
#define RPG_CLIENT_BILLBOARD_NAMEBILLBOARDDATA__ISTEXTIDVALID_OFFSET UNITYSDK_OFFSET(0xB436FE0)

namespace RPG::Client::Billboard
{
	inline static constexpr unsigned int NameBillboardData_TypeDefinitionIndex = 69862;
