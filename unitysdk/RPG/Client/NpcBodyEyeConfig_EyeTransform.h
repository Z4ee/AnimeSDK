...
#define RPG_CLIENT_NPCBODYEYECONFIG_EYETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xC2EBF00)

namespace RPG::Client
{
	inline static constexpr unsigned int NpcBodyEyeConfig_EyeTransform_TypeDefinitionIndex = 56147;
