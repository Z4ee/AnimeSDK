...
#define RPG_CLIENT_DYNAMICFLOATINGOBJECT_DYNAMICFLOATINGMANAGERMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A68C3B0)

namespace RPG::Client::DynamicFloatingObject
{
	inline static constexpr unsigned int DynamicFloatingManagerMono_TypeDefinitionIndex = 73463;
