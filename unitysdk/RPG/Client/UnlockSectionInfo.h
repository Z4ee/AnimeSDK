...
#define RPG_CLIENT_UNLOCKSECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCBA5840)

namespace RPG::Client
{
	inline static constexpr unsigned int UnlockSectionInfo_TypeDefinitionIndex = 56683;
