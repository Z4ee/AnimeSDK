...
#define RPG_CLIENT_WAITPLANETFESLARGEBONUS_METHOD_3_16038F01C59057E0_OFFSET UNITYSDK_OFFSET(0x1B9F2780)
#define RPG_CLIENT_WAITPLANETFESLARGEBONUS_METHOD_3_B890B2D7AE48A39D_OFFSET UNITYSDK_OFFSET(0x1B9F26B0)
#define RPG_CLIENT_WAITPLANETFESLARGEBONUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9F2770)

namespace RPG::Client
{
	inline static constexpr unsigned int WaitPlanetFesLargeBonus_TypeDefinitionIndex = 9963;
