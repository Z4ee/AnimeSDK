...
#define RPG_CLIENT_WAITPLANETFESLARGEBONUS_METHOD_3_16038F01C59057E0_OFFSET UNITYSDK_OFFSET(0x185EEC40)
#define RPG_CLIENT_WAITPLANETFESLARGEBONUS_METHOD_3_E422A36A8F3CAC94_OFFSET UNITYSDK_OFFSET(0x185EEB30)
#define RPG_CLIENT_WAITPLANETFESLARGEBONUS__CTOR_OFFSET UNITYSDK_OFFSET(0x185EEC10)

namespace RPG::Client
{
	inline static constexpr unsigned int WaitPlanetFesLargeBonus_TypeDefinitionIndex = 10146;
