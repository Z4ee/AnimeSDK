...
#define RPG_CLIENT_RPGANIMATIONEVENT___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAF3A6C0)
#define RPG_CLIENT_RPGANIMATIONEVENT___C__DISPLAYCLASS11_0___INVOKECALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0xAF3AC40)
#define RPG_CLIENT_RPGANIMATIONEVENT___C__DISPLAYCLASS11_0___INVOKECALLBACK_B__1_OFFSET UNITYSDK_OFFSET(0xAF3AC60)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGAnimationEvent___c__DisplayClass11_0_TypeDefinitionIndex = 67119;
