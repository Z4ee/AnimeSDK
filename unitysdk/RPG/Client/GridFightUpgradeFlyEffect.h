...
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x18FAF560)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_METHOD_5_2EA3D2C84685E32A_OFFSET UNITYSDK_OFFSET(0x18FAFA10)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_METHOD_5_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x18FAFC90)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x18FAF5B0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x18FAF780)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x18FAF520)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FAFD00)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightUpgradeFlyEffect_TypeDefinitionIndex = 61582;
