...
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x98E0B50)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_METHOD_5_2EA3D2C84685E32A_OFFSET UNITYSDK_OFFSET(0x98E1050)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_METHOD_5_90BC2B951C8F8F73_OFFSET UNITYSDK_OFFSET(0x98E12D0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x98E0BA0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x98E0DB0)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x98E0B10)
#define RPG_CLIENT_GRIDFIGHTUPGRADEFLYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x98E1330)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightUpgradeFlyEffect_TypeDefinitionIndex = 52400;
