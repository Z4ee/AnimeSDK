...
#define RPG_CLIENT_MONOCHARACTERCONICALVISIONFORWARD_AWAKE_OFFSET UNITYSDK_OFFSET(0x9C17370)
#define RPG_CLIENT_MONOCHARACTERCONICALVISIONFORWARD_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x9C171F0)
#define RPG_CLIENT_MONOCHARACTERCONICALVISIONFORWARD_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x9C172B0)
#define RPG_CLIENT_MONOCHARACTERCONICALVISIONFORWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9C176C0)
