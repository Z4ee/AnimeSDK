...
#define RPG_CLIENT_MONOROTATABLEREGION3DMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xC143C90)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRotatableRegion3DMap_TypeDefinitionIndex = 64573;
