...
#define RPG_CLIENT_MONOROTATABLEREGION3DMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x9D32A30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRotatableRegion3DMap_TypeDefinitionIndex = 56408;
