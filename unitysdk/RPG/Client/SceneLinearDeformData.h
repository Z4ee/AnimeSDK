...
#define RPG_CLIENT_SCENELINEARDEFORMDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xE05A3D0)
...
namespace RPG::Client
{
	...
	struct alignas(4) SceneLinearDeformData
	{
		...
		{
			return (::RPG::Client::SceneLinearDeformData*)Il2CppClass::FromTypeDefinitionIndex(SceneLinearDeformData_TypeDefinitionIndex)->GetStaticField(0xA840);
		}
