...
class Class_1_60196243EFB570A9;
...
#define RPG_CLIENT_AVATARMODULE_ADDAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x9DA48B0)
#define RPG_CLIENT_AVATARMODULE_ADDTRIALPLAYER_OFFSET UNITYSDK_OFFSET(0x9DA8E50)
#define RPG_CLIENT_AVATARMODULE_BUILDCHALLENGEUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x9D70C80)
#define RPG_CLIENT_AVATARMODULE_BUILDSKILLTREESANDSKILLS_OFFSET UNITYSDK_OFFSET(0x9DA7810)
#define RPG_CLIENT_AVATARMODULE_BUILDUPGRADEDAVATARRELIC_OFFSET UNITYSDK_OFFSET(0x9DA64B0)
#define RPG_CLIENT_AVATARMODULE_CHANGEMULTIPATHAVATARTYPE_OFFSET UNITYSDK_OFFSET(0x9DA85A0)
#define RPG_CLIENT_AVATARMODULE_CHECKPLAYERHASAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA9BE0)
#define RPG_CLIENT_AVATARMODULE_CLEARENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x9DA36C0)
#define RPG_CLIENT_AVATARMODULE_CREATEPLAYERAVATARCLONEBYREALID_OFFSET UNITYSDK_OFFSET(0x9DA4110)
#define RPG_CLIENT_AVATARMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DAA070)
#define RPG_CLIENT_AVATARMODULE_FORMATDISPLAYDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x9DA9060)
#define RPG_CLIENT_AVATARMODULE_GETASSISTAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA8730)
#define RPG_CLIENT_AVATARMODULE_GETAVATARDATALIST_OFFSET UNITYSDK_OFFSET(0x9DA8BB0)
#define RPG_CLIENT_AVATARMODULE_GETAVATAR_1_OFFSET UNITYSDK_OFFSET(0x9DA8460)
#define RPG_CLIENT_AVATARMODULE_GETAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA3EF0)
#define RPG_CLIENT_AVATARMODULE_GETCHALLENGEUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9D70BF0)
#define RPG_CLIENT_AVATARMODULE_GETCOMMONUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA4B20)
#define RPG_CLIENT_AVATARMODULE_GETCURRENTRANK_OFFSET UNITYSDK_OFFSET(0x9DA9DF0)
#define RPG_CLIENT_AVATARMODULE_GETDEFAULTUPGRADEAVATARSET2ID_OFFSET UNITYSDK_OFFSET(0x9DA7430)
#define RPG_CLIENT_AVATARMODULE_GETDEFAULTUPGRADEAVATARSET4ID_OFFSET UNITYSDK_OFFSET(0x9DA7000)
#define RPG_CLIENT_AVATARMODULE_GETMAXPOWERAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA95C0)
#define RPG_CLIENT_AVATARMODULE_GETMAXRANK_OFFSET UNITYSDK_OFFSET(0x9DA9D00)
#define RPG_CLIENT_AVATARMODULE_GETMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA5430)
#define RPG_CLIENT_AVATARMODULE_GETMULTIPATHPLAYERAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA3D60)
#define RPG_CLIENT_AVATARMODULE_GETRANKITEMID_OFFSET UNITYSDK_OFFSET(0x9DA9B50)
#define RPG_CLIENT_AVATARMODULE_GETRECOMMENDRELICAVATARPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x9DA71E0)
#define RPG_CLIENT_AVATARMODULE_GETTRIALAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA8AF0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEAVAILABLEAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA5070)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEAVATARSUBRELICROW_OFFSET UNITYSDK_OFFSET(0x9DA7360)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x9DA5CB0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDAVATARPROMOTION_OFFSET UNITYSDK_OFFSET(0x9DA5DC0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9DA5ED0)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADEDRANK_OFFSET UNITYSDK_OFFSET(0x9DA7D00)
#define RPG_CLIENT_AVATARMODULE_GETUPGRADERELICID_OFFSET UNITYSDK_OFFSET(0x9DA7100)
#define RPG_CLIENT_AVATARMODULE_GET_ALLAVATARSKINS_OFFSET UNITYSDK_OFFSET(0x9DA4B00)
#define RPG_CLIENT_AVATARMODULE_GET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAD3F0)
#define RPG_CLIENT_AVATARMODULE_GET_ALLMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAD430)
#define RPG_CLIENT_AVATARMODULE_GET_ALLSPECIALAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAD410)
#define RPG_CLIENT_AVATARMODULE_GET_ENHANCEREDDOTAVATARIDS_OFFSET UNITYSDK_OFFSET(0x9DA3330)
#define RPG_CLIENT_AVATARMODULE_GET_ENHANCEREDDOTTRIALSTAGEIDS_OFFSET UNITYSDK_OFFSET(0x9DA3730)
#define RPG_CLIENT_AVATARMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x9DA7E10)
#define RPG_CLIENT_AVATARMODULE_GET_ISSHOWENHANCECHANGESIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x9DA3CA0)
#define RPG_CLIENT_AVATARMODULE_GET_LASTSEENENHANCESEASON_OFFSET UNITYSDK_OFFSET(0x9DA30D0)
#define RPG_CLIENT_AVATARMODULE_GET_MAXENHANCEDSEASON_OFFSET UNITYSDK_OFFSET(0x9DA31F0)
#define RPG_CLIENT_AVATARMODULE_GET_PLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x9DAD450)
#define RPG_CLIENT_AVATARMODULE_GET_PREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x9DA9410)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATARBYID_OFFSET UNITYSDK_OFFSET(0x9DA5210)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATARLEVEL_OFFSET UNITYSDK_OFFSET(0x9DA55B0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA54F0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADEEQUIPMENT_OFFSET UNITYSDK_OFFSET(0x9DA56C0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERANK_OFFSET UNITYSDK_OFFSET(0x9DA5AF0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELICSET2_OFFSET UNITYSDK_OFFSET(0x9DA6350)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELICSET4_OFFSET UNITYSDK_OFFSET(0x9DA61A0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADERELIC_OFFSET UNITYSDK_OFFSET(0x9DA57E0)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADESKILLPOINT_OFFSET UNITYSDK_OFFSET(0x9DA7530)
#define RPG_CLIENT_AVATARMODULE_ISNEEDUPGRADESKILLTREE_OFFSET UNITYSDK_OFFSET(0x9DA5840)
#define RPG_CLIENT_AVATARMODULE_ISOWNSKIN_OFFSET UNITYSDK_OFFSET(0x9DA4690)
#define RPG_CLIENT_AVATARMODULE_ISSKINNEW_OFFSET UNITYSDK_OFFSET(0x9DA4700)
#define RPG_CLIENT_AVATARMODULE_NEEDSHOWUPGRADEINLINEUP_OFFSET UNITYSDK_OFFSET(0x9DA5010)
#define RPG_CLIENT_AVATARMODULE_REFRESHENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x9DA3350)
#define RPG_CLIENT_AVATARMODULE_REFRESHENHANCETRIALSTAGEREDDOT_OFFSET UNITYSDK_OFFSET(0x9DA3740)
#define RPG_CLIENT_AVATARMODULE_REMOVEENHANCEREDDOT_OFFSET UNITYSDK_OFFSET(0x9DA3610)
#define RPG_CLIENT_AVATARMODULE_REVERTPREFSSHOWSIMPLIFIEDSKILLDESC_OFFSET UNITYSDK_OFFSET(0x9DA9460)
#define RPG_CLIENT_AVATARMODULE_SETTEMPADVENTUREAVATARS_OFFSET UNITYSDK_OFFSET(0x9DA87E0)
#define RPG_CLIENT_AVATARMODULE_SET_ALLAVATARSKINS_OFFSET UNITYSDK_OFFSET(0x9DA4B10)
#define RPG_CLIENT_AVATARMODULE_SET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAD400)
#define RPG_CLIENT_AVATARMODULE_SET_ALLMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAD440)
#define RPG_CLIENT_AVATARMODULE_SET_ALLSPECIALAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAD420)
#define RPG_CLIENT_AVATARMODULE_SET_ENHANCEREDDOTAVATARIDS_OFFSET UNITYSDK_OFFSET(0x9DA3340)
#define RPG_CLIENT_AVATARMODULE_SET_ISSHOWENHANCECHANGESIMPLEDESC_OFFSET UNITYSDK_OFFSET(0x9DA3D00)
#define RPG_CLIENT_AVATARMODULE_SET_LASTSEENENHANCESEASON_OFFSET UNITYSDK_OFFSET(0x9DA3160)
#define RPG_CLIENT_AVATARMODULE_SWITCHTEAMASSOCIATIONSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x9DA9F30)
#define RPG_CLIENT_AVATARMODULE_TRYGETAVATARSKINDATACACHE_OFFSET UNITYSDK_OFFSET(0x9DA4830)
#define RPG_CLIENT_AVATARMODULE_TRYGETTRIALAVATARSBYIDS_OFFSET UNITYSDK_OFFSET(0x9DA98C0)
#define RPG_CLIENT_AVATARMODULE_UPDATEAVATAREQUIP_OFFSET UNITYSDK_OFFSET(0x9DA97B0)
#define RPG_CLIENT_AVATARMODULE_UPDATERELICSET_OFFSET UNITYSDK_OFFSET(0x9DA9820)
#define RPG_CLIENT_AVATARMODULE_UPDATESKINNEW_OFFSET UNITYSDK_OFFSET(0x9DA4790)
#define RPG_CLIENT_AVATARMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x9DAA600)
#define RPG_CLIENT_AVATARMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x9DAA1D0)
#define RPG_CLIENT_AVATARMODULE__CREATEPLAYERAVATARBYREALID_OFFSET UNITYSDK_OFFSET(0x9DA4020)
#define RPG_CLIENT_AVATARMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA7E70)
#define RPG_CLIENT_AVATARMODULE__DISPOSEUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA4F70)
#define RPG_CLIENT_AVATARMODULE__HASPATHSERVERDATA_OFFSET UNITYSDK_OFFSET(0x9DA4160)
#define RPG_CLIENT_AVATARMODULE__HASROLESERVERDATA_OFFSET UNITYSDK_OFFSET(0x9DAD140)
#define RPG_CLIENT_AVATARMODULE__NOTIFYADDNEWAVATARINFO_OFFSET UNITYSDK_OFFSET(0x9DAC620)
#define RPG_CLIENT_AVATARMODULE__ONAVATARSYNCDATA_OFFSET UNITYSDK_OFFSET(0x9DAD080)
#define RPG_CLIENT_AVATARMODULE__ONCMDADDAVATARSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9DAC380)
#define RPG_CLIENT_AVATARMODULE__ONCMDAVATAREXPUPSCRSP_OFFSET UNITYSDK_OFFSET(0x9DAC7F0)
#define RPG_CLIENT_AVATARMODULE__ONCMDAVATARSPECIALSKILLTREEUNLOCKSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9DACD80)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACB20)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSAVATARSKINSCRSP_OFFSET UNITYSDK_OFFSET(0x9DA4930)
#define RPG_CLIENT_AVATARMODULE__ONCMDDRESSRELICAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACC40)
#define RPG_CLIENT_AVATARMODULE__ONCMDGETAVATARDATASCRSP_OFFSET UNITYSDK_OFFSET(0x9DAA9E0)
#define RPG_CLIENT_AVATARMODULE__ONCMDPLAYERSYNCSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9DAC150)
#define RPG_CLIENT_AVATARMODULE__ONCMDPROMOTEAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9DAC9E0)
#define RPG_CLIENT_AVATARMODULE__ONCMDRANKUPAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACBE0)
#define RPG_CLIENT_AVATARMODULE__ONCMDSETAVATARENHANCEDIDSCRSP_OFFSET UNITYSDK_OFFSET(0x9DA3020)
#define RPG_CLIENT_AVATARMODULE__ONCMDSETPLAYEROUTFITSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACE10)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFAVATARSKINSCRSP_OFFSET UNITYSDK_OFFSET(0x9DA49C0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFEQUIPMENTSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACB80)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEOFFRELICSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACCA0)
#define RPG_CLIENT_AVATARMODULE__ONCMDTAKEPROMOTIONREWARDSCRSP_OFFSET UNITYSDK_OFFSET(0x9DACD00)
#define RPG_CLIENT_AVATARMODULE__ONCMDUNLOCKAVATARSKINSCNOTIFY_OFFSET UNITYSDK_OFFSET(0x9DA4A50)
#define RPG_CLIENT_AVATARMODULE__ONCMDUNLOCKSKILLTREESCRSP_OFFSET UNITYSDK_OFFSET(0x9DACA40)
#define RPG_CLIENT_AVATARMODULE__ONMARKAVATARSCRSP_OFFSET UNITYSDK_OFFSET(0x9DAC760)
#define RPG_CLIENT_AVATARMODULE__ONWORLDLEVELUP_OFFSET UNITYSDK_OFFSET(0x9DACEB0)
#define RPG_CLIENT_AVATARMODULE__REFRESHUPGRADEAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA4DC0)
#define RPG_CLIENT_AVATARMODULE__SENDAVATARSYNCDATA_OFFSET UNITYSDK_OFFSET(0x9DAD0E0)
#define RPG_CLIENT_AVATARMODULE__SETPLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x9DAD200)
#define RPG_CLIENT_AVATARMODULE__SYNCALLAVATARS_OFFSET UNITYSDK_OFFSET(0x9DAB670)
#define RPG_CLIENT_AVATARMODULE__SYNCAVATAR_OFFSET UNITYSDK_OFFSET(0x9DA41F0)
#define RPG_CLIENT_AVATARMODULE__SYNCFORMALMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x9DA4450)
#define RPG_CLIENT_AVATARMODULE__SYNCMULTIPATHAVATARS_OFFSET UNITYSDK_OFFSET(0x9DABBE0)
#define RPG_CLIENT_AVATARMODULE__UPDATEAVATARPATHSERVERDATACACHE_OFFSET UNITYSDK_OFFSET(0x9DAB300)
#define RPG_CLIENT_AVATARMODULE__UPDATEAVATARROLESERVERDATACACHE_OFFSET UNITYSDK_OFFSET(0x9DAAF90)
#define RPG_CLIENT_AVATARMODULE__UPDATENEWAVATARREDDOT_OFFSET UNITYSDK_OFFSET(0x9DAC5B0)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DAD460)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x9DAD4F0)
#define RPG_CLIENT_AVATARMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x9DAD470)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarModule_TypeDefinitionIndex = 57632;

	class AvatarModule : public ::RPG::Client::BaseModule
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllNoSyncPlayerMultiPathAvatars; // 0x10
		::System::Collections::Generic::List_1<::System::UInt32>* _EnhanceRedDotTrialStageIDs_k__BackingField; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* _AvatarRankItemIDs; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_BB4B99DE4C2501EC_3*>* _AvatarRoleServerDataCache; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Boolean>* _AllAvatarSkins_k__BackingField; // 0x30
		::Class_1_15951C7ACBFF8B93* _PlayerOutfitServerAgent; // 0x38
		::RPG::Client::AvatarOutfit* _PlayerOutfit_k__BackingField; // 0x40
		::RPG::GameCore::GameEntity* AvatarUI3DPageShowingAvatar; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllSpecialAvatars_k__BackingField; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllMultiPathAvatars_k__BackingField; // 0x58
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllAvatars_k__BackingField; // 0x60
		::RPG::Client::LRUCache_2<::Struct_2_137AB23E3A00ECA1, ::RPG::Client::IAvatarSkinData*>* _AvatarSkinDataCache; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::AvatarData*>* _AllUpgradedAvatars; // 0x70
		::System::Collections::Generic::List_1<::System::UInt32>* _EnhanceRedDotAvatarIDs_k__BackingField; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_1_F3CA30716D4FAF92_5*>* _AvatarPathServerDataCache; // 0x80
		::System::UInt32 _MaxEnhancedSeason; // 0x88
		...
		static ::RPG::Client::EquipmentItemData* GetChallengeUpgradedEquipment(::RPG::Client::IAvatarInfoProvider* originAvatar, ::Class_1_D17272E82AE804C2_150* equipmentSnapShot)
		{
			return ((::RPG::Client::EquipmentItemData*(*)(::RPG::Client::IAvatarInfoProvider*, ::Class_1_D17272E82AE804C2_150*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE_GETCHALLENGEUPGRADEDEQUIPMENT_OFFSET))(originAvatar, equipmentSnapShot);
		}

		static ::System::Void BuildChallengeUpgradedAvatarRelic(::RPG::Client::AvatarData*& pAvatarData, ::RPG::Client::AvatarData* originAvatarData, ::Class_1_071D0EF220D742B6* relicSnapShot)
		{
			return ((::System::Void(*)(::RPG::Client::AvatarData*&, ::RPG::Client::AvatarData*, ::Class_1_071D0EF220D742B6*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE_BUILDCHALLENGEUPGRADEDAVATARRELIC_OFFSET))(pAvatarData, originAvatarData, relicSnapShot);
		}
		...
		::System::Void _SyncFormalMultiPathAvatars(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataList, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_5*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>*, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_5*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SYNCFORMALMULTIPATHAVATARS_OFFSET))(this, avatarBaseDataList, avatarUniqueDataList);
		}
		...
		static ::RPG::Client::IAvatarInfoProvider* GetUpgradeAvailableAvatar(::Enum_3_63C076C405BE0674_2 lineupType, ::System::UInt32 avatarID)
		{
			return ((::RPG::Client::IAvatarInfoProvider*(*)(::Enum_3_63C076C405BE0674_2, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE_GETUPGRADEAVAILABLEAVATAR_OFFSET))(lineupType, avatarID);
		}
		...
		static ::Class_1_FB243EFAE922024A* GetUpgradeAvatarSubRelicRow(::System::UInt32 avatarID, ::RPG::GameCore::CombatPowerRelicRarityType relicRarityType, ::System::UInt32 relicLevel, ::RPG::GameCore::RelicType relicType)
		{
			return ((::Class_1_FB243EFAE922024A*(*)(::System::UInt32, ::RPG::GameCore::CombatPowerRelicRarityType, ::System::UInt32, ::RPG::GameCore::RelicType))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE_GETUPGRADEAVATARSUBRELICROW_OFFSET))(avatarID, relicRarityType, relicLevel, relicType);
		}
		...
		::RPG::Client::IAvatarInfoProvider* ChangeMultiPathAvatarType(::System::UInt32 newAvatarID, ::System::UInt32 enhancedID, ::System::UInt32 nRank, ::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_13*>* pAvatarSkillTree, ::System::UInt32 skinID)
		{
			return ((::RPG::Client::IAvatarInfoProvider*(*)(::PVOID, ::System::UInt32, ::System::UInt32, ::System::UInt32, ::System::Collections::Generic::List_1<::Class_1_D17272E82AE804C2_13*>*, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE_CHANGEMULTIPATHAVATARTYPE_OFFSET))(this, newAvatarID, enhancedID, nRank, pAvatarSkillTree, skinID);
		}
		...
		::System::Void _NotifyAddNewAvatarInfo(::Class_1_60196243EFB570A9* rsp)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_60196243EFB570A9*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__NOTIFYADDNEWAVATARINFO_OFFSET))(this, rsp);
		}
		...
		::System::Void _SyncAllAvatars(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataList, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_5*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>*, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_5*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SYNCALLAVATARS_OFFSET))(this, avatarBaseDataList, avatarUniqueDataList);
		}
		...
		::System::Void _SyncMultiPathAvatars(::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>* avatarBaseDataList, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_5*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_BB4B99DE4C2501EC_3*>*, ::Google::Protobuf::Collections::RepeatedField_1<::Class_1_F3CA30716D4FAF92_5*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SYNCMULTIPATHAVATARS_OFFSET))(this, avatarBaseDataList, avatarUniqueDataList);
		}
		...
		::System::Void _SetPlayerOutfit(::Class_1_075C34D03AFA1215_7* playerOutfitData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_075C34D03AFA1215_7*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__SETPLAYEROUTFIT_OFFSET))(this, playerOutfitData);
		}
		...
		::System::Void _UpdateAvatarPathServerDataCache(::System::Collections::Generic::IEnumerable_1<::Class_1_F3CA30716D4FAF92_5*>* avatarUniqueDataList)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::Class_1_F3CA30716D4FAF92_5*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARMODULE__UPDATEAVATARPATHSERVERDATACACHE_OFFSET))(this, avatarUniqueDataList);
		}
