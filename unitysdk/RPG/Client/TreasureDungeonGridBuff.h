...
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0x198B4830)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFROW_OFFSET UNITYSDK_OFFSET(0x198B47A0)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFTYPE_OFFSET UNITYSDK_OFFSET(0x198B4850)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFVALUE_OFFSET UNITYSDK_OFFSET(0x198B4810)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0x198B4840)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SET_BUFFVALUE_OFFSET UNITYSDK_OFFSET(0x198B4820)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SYNC_OFFSET UNITYSDK_OFFSET(0x198B2890)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x198B2880)

namespace RPG::Client
{
	inline static constexpr unsigned int TreasureDungeonGridBuff_TypeDefinitionIndex = 65174;
	...
	public:
		...
		::System::UInt32 _BuffValue_k__BackingField; // 0x20
		...
		::System::Void Sync(::Class_1_D17272E82AE804C2_1178* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_1178*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SYNC_OFFSET))(this, a1);
		}
