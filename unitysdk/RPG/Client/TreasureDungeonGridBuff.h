...
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xA62ED10)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFROW_OFFSET UNITYSDK_OFFSET(0xA62EC80)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFTYPE_OFFSET UNITYSDK_OFFSET(0xA62ED30)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_GET_BUFFVALUE_OFFSET UNITYSDK_OFFSET(0xA62ECF0)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SET_BUFFLEVEL_OFFSET UNITYSDK_OFFSET(0xA62ED20)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SET_BUFFVALUE_OFFSET UNITYSDK_OFFSET(0xA62ED00)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SYNC_OFFSET UNITYSDK_OFFSET(0xA62D770)
#define RPG_CLIENT_TREASUREDUNGEONGRIDBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xA62D760)

namespace RPG::Client
{
	inline static constexpr unsigned int TreasureDungeonGridBuff_TypeDefinitionIndex = 55668;
	...
	public:
		...
		::System::Void Sync(::Class_1_FA4F4A67B1C04320_962* serverGridBuff)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_FA4F4A67B1C04320_962*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TREASUREDUNGEONGRIDBUFF_SYNC_OFFSET))(this, serverGridBuff);
		}
