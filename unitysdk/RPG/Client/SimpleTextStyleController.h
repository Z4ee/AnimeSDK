...
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_APPLYSTYLE_OFFSET UNITYSDK_OFFSET(0xE09F510)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xE09F380)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_GET_SIMPLETEXT_OFFSET UNITYSDK_OFFSET(0xE09F2D0)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_SETOUTLINE1WIDTH_OFFSET UNITYSDK_OFFSET(0xE09F4A0)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER_SETSTYLE_OFFSET UNITYSDK_OFFSET(0xE09F3D0)
#define RPG_CLIENT_SIMPLETEXTSTYLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xE09F560)

namespace RPG::Client
{
	inline static constexpr unsigned int SimpleTextStyleController_TypeDefinitionIndex = 72056;
