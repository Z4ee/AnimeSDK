...
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP_REFRESHAFTERENTERBATTLENEW_OFFSET UNITYSDK_OFFSET(0x19F39350)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP_REFRESHBEFOREENTERBATTLENEW_OFFSET UNITYSDK_OFFSET(0x19F391E0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__COLLECTRESOURCEIMPL_OFFSET UNITYSDK_OFFSET(0x19F38BC0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F394C0)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__GETDEFAULTBATTLEMODELPATH_OFFSET UNITYSDK_OFFSET(0x19F39100)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x19F38A30)
#define RPG_CLIENT_BATTLEASSETPRELOAD_RTBATTLECHARACTERPRELOADGROUP__ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x19F38750)
