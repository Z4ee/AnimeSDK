...
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ACA28C0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA2930)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA2990)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ACA2940)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACA28B0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA1F00)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeCoroutineUntil_d__25_TypeDefinitionIndex = 33804;
