...
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC12BE0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC12C50)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC12CB0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC12C60)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC12BD0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKECOROUTINEUNTIL_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC12220)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeCoroutineUntil_d__25_TypeDefinitionIndex = 33434;
