...
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_GET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0x19F40610)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SETVALUEFROMSERVER_OFFSET UNITYSDK_OFFSET(0x19F403E0)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0x19F40620)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x19F405E0)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SYNCCLIENTPREF_OFFSET UNITYSDK_OFFSET(0x19F40570)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19F40630)

namespace RPG::Client
{
	inline static constexpr unsigned int ServerPlayerSettingBoolItem_TypeDefinitionIndex = 63746;
