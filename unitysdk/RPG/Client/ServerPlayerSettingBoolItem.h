...
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_GET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0xE077620)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SETVALUEFROMSERVER_OFFSET UNITYSDK_OFFSET(0xE0773F0)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0xE077630)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SET_DEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0xE0775F0)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM_SYNCCLIENTPREF_OFFSET UNITYSDK_OFFSET(0xE077580)
#define RPG_CLIENT_SERVERPLAYERSETTINGBOOLITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE077640)
