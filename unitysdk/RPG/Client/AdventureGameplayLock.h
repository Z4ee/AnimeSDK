...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_1251ABBEE9F4DFE8_OFFSET UNITYSDK_OFFSET(0x1D305FC0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_6704C83E8C4AC8B9_OFFSET UNITYSDK_OFFSET(0x1D305E60)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1D305FB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureGameplayLock_TypeDefinitionIndex = 10305;
