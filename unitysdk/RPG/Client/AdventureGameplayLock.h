...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_1251ABBEE9F4DFE8_OFFSET UNITYSDK_OFFSET(0x185E3BA0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_39E9E3ED32B3FEF5_OFFSET UNITYSDK_OFFSET(0x185E39E0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x185E3B70)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureGameplayLock_TypeDefinitionIndex = 10155;
