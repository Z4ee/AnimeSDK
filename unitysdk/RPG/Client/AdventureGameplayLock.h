...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_1251ABBEE9F4DFE8_OFFSET UNITYSDK_OFFSET(0x193B05C0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK_METHOD_3_39E9E3ED32B3FEF5_OFFSET UNITYSDK_OFFSET(0x193B03F0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x193B0590)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureGameplayLock_TypeDefinitionIndex = 9956;
