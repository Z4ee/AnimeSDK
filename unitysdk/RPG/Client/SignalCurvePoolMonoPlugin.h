...
#define RPG_CLIENT_SIGNALCURVEPOOLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA480FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePoolMonoPlugin_TypeDefinitionIndex = 58123;
