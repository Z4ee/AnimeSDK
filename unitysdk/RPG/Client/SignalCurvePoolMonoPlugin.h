...
#define RPG_CLIENT_SIGNALCURVEPOOLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB1700A0)

namespace RPG::Client
{
	inline static constexpr unsigned int SignalCurvePoolMonoPlugin_TypeDefinitionIndex = 65410;
