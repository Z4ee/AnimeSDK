...
#define RPG_CLIENT_ST_PARKOUR_BYCOMPARERANK_METHOD_4_1FDE4693B0DDE6D9_OFFSET UNITYSDK_OFFSET(0x185ED2F0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPARERANK_METHOD_4_911084033AD37B3F_OFFSET UNITYSDK_OFFSET(0x185ED3C0)
#define RPG_CLIENT_ST_PARKOUR_BYCOMPARERANK__CTOR_OFFSET UNITYSDK_OFFSET(0x185ED370)

namespace RPG::Client
{
	inline static constexpr unsigned int ST_Parkour_ByCompareRank_TypeDefinitionIndex = 10134;
