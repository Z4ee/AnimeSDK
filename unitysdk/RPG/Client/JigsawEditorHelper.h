...
#define RPG_CLIENT_JIGSAWEDITORHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA663480)

namespace RPG::Client
{
	inline static constexpr unsigned int JigsawEditorHelper_TypeDefinitionIndex = 63166;
