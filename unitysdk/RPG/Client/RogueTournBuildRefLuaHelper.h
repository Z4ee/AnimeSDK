...
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEOBJECTIDUINTDICT_OFFSET UNITYSDK_OFFSET(0xA373E10)
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEUNIONINDEXDOUBLEDICT_OFFSET UNITYSDK_OFFSET(0xA373EE0)
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEUNIONINDEXUINTDICT_OFFSET UNITYSDK_OFFSET(0xA373FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefLuaHelper_TypeDefinitionIndex = 55045;
