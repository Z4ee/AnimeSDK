...
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEOBJECTIDUINTDICT_OFFSET UNITYSDK_OFFSET(0xC7FC280)
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEUNIONINDEXDOUBLEDICT_OFFSET UNITYSDK_OFFSET(0xC7FC360)
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEUNIONINDEXUINTDICT_OFFSET UNITYSDK_OFFSET(0xC7FC440)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefLuaHelper_TypeDefinitionIndex = 63166;
