...
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEOBJECTIDUINTDICT_OFFSET UNITYSDK_OFFSET(0x1984C4C0)
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEUNIONINDEXDOUBLEDICT_OFFSET UNITYSDK_OFFSET(0x1984C5B0)
#define RPG_CLIENT_ROGUETOURNBUILDREFLUAHELPER_CREATEUNIONINDEXUINTDICT_OFFSET UNITYSDK_OFFSET(0x1984C6A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournBuildRefLuaHelper_TypeDefinitionIndex = 64533;
