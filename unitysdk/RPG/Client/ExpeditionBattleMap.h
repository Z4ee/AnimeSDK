...
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GETBEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xCEFB840)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GETRANK_OFFSET UNITYSDK_OFFSET(0xCEFB8C0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GETSPECIALAVATARDICT_OFFSET UNITYSDK_OFFSET(0xCEFBA30)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GETSTARS_OFFSET UNITYSDK_OFFSET(0xCEFA840)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GETSTATE_OFFSET UNITYSDK_OFFSET(0xCEFB530)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GETUNLOCKTIMESTAMP_OFFSET UNITYSDK_OFFSET(0xCEFB7C0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0xCEFB340)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_BGMSTATE_OFFSET UNITYSDK_OFFSET(0xCEFB3C0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_EXPEDITIONBACKGROUNDPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCEFB3A0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_ID_OFFSET UNITYSDK_OFFSET(0xCEFB320)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_MAPICONPATH_OFFSET UNITYSDK_OFFSET(0xCEFB380)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_MAPNAME_OFFSET UNITYSDK_OFFSET(0xCEFB360)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_MAXDAILYCHALLENGECOUNT_OFFSET UNITYSDK_OFFSET(0xCEFB400)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_REMAININGCHALLENGECOUNT_OFFSET UNITYSDK_OFFSET(0xCEFB420)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_ROUTEIDS_OFFSET UNITYSDK_OFFSET(0xCEFB3E0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_GET_ROUTES_OFFSET UNITYSDK_OFFSET(0xCEFB440)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0xCEFB350)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_BGMSTATE_OFFSET UNITYSDK_OFFSET(0xCEFB3D0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_EXPEDITIONBACKGROUNDPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCEFB3B0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_ID_OFFSET UNITYSDK_OFFSET(0xCEFB330)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_MAPICONPATH_OFFSET UNITYSDK_OFFSET(0xCEFB390)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_MAPNAME_OFFSET UNITYSDK_OFFSET(0xCEFB370)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_MAXDAILYCHALLENGECOUNT_OFFSET UNITYSDK_OFFSET(0xCEFB410)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_REMAININGCHALLENGECOUNT_OFFSET UNITYSDK_OFFSET(0xCEFB430)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SET_ROUTEIDS_OFFSET UNITYSDK_OFFSET(0xCEFB3F0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP_SYNCBYSERVER_OFFSET UNITYSDK_OFFSET(0xCEFB450)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xCEFBD10)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP__GETSCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xCEFB5A0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP__HASCHALLENGED_OFFSET UNITYSDK_OFFSET(0xCEFB670)
#define RPG_CLIENT_EXPEDITIONBATTLEMAP__SYNCREMAININGCHALLENGECOUNT_OFFSET UNITYSDK_OFFSET(0xCEFB4E0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::String* _ExpeditionBackgroundPrefabPath_k__BackingField; // 0x10
		::System::String* _MapIconPath_k__BackingField; // 0x18
		::System::Collections::Generic::List_1<::RPG::Client::ExpeditionBattleRoute*>* _Routes_k__BackingField; // 0x20
		::Il2CppArray<::System::UInt32>* _RouteIDs_k__BackingField; // 0x28
		::System::String* _BGMState_k__BackingField; // 0x30
		::System::UInt32 _RemainingChallengeCount_k__BackingField; // 0x38
		::System::UInt32 _ID_k__BackingField; // 0x3C
		::System::UInt32 _MaxDailyChallengeCount_k__BackingField; // 0x40
