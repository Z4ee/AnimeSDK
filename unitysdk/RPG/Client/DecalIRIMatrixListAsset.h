...
#define RPG_CLIENT_DECALIRIMATRIXLISTASSET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xCC98DE0)
#define RPG_CLIENT_DECALIRIMATRIXLISTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xCC98E30)
