...
#define RPG_CLIENT_TACOMPONETSTABLELIZERCONTORLMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA530760)
#define RPG_CLIENT_TACOMPONETSTABLELIZERCONTORLMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA5307B0)
#define RPG_CLIENT_TACOMPONETSTABLELIZERCONTORLMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA5307C0)

namespace RPG::Client
{
	inline static constexpr unsigned int TAComponetStablelizerContorlMonoPlugin_TypeDefinitionIndex = 57967;
