...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_COMPAREPRIORITY_OFFSET UNITYSDK_OFFSET(0x9C99EE0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_COPYORIGINMATERIALCHARACTERCOMMONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x9C9A290)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C9E120)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C9B550)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x9C9E160)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GETINSTANCEMATERIALS_OFFSET UNITYSDK_OFFSET(0x9C99630)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GETRENDERINSTANCEDMATERIALMAP_OFFSET UNITYSDK_OFFSET(0x9C99880)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GETTARGETRENDERERLIST_OFFSET UNITYSDK_OFFSET(0x9C99830)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISAPPLY_OFFSET UNITYSDK_OFFSET(0x9C9EE60)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISEDITORMODE_OFFSET UNITYSDK_OFFSET(0x9C9B530)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISSUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CA3270)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_ISTARGETPARTMONSTER_OFFSET UNITYSDK_OFFSET(0x9CA3250)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET_PARENTPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CA3290)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET__ISAPPLY_OFFSET UNITYSDK_OFFSET(0x9CA32B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_GET__ISRESET_OFFSET UNITYSDK_OFFSET(0x9CA32D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9C9B4F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_ISCONFLICT_OFFSET UNITYSDK_OFFSET(0x9C999B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_ISTARGETGROUPLEADER_OFFSET UNITYSDK_OFFSET(0x9C998D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0AC350B64D89A1AE_1_OFFSET UNITYSDK_OFFSET(0x9C9E320)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0AC350B64D89A1AE_2_OFFSET UNITYSDK_OFFSET(0x9C9DED0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0AC350B64D89A1AE_OFFSET UNITYSDK_OFFSET(0x9C9D500)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0E549C9E38D0E257_OFFSET UNITYSDK_OFFSET(0x9C9A520)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_0F219594B5F172AE_OFFSET UNITYSDK_OFFSET(0x9CA0AA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x9CA30F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_1FE2B10286A019B7_OFFSET UNITYSDK_OFFSET(0x9C9DFD0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_2A5F76182A02F976_OFFSET UNITYSDK_OFFSET(0x9C9E600)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_2BC55A66CB2B0118_OFFSET UNITYSDK_OFFSET(0x9CA1230)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x9C9D8B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_3AC067C2C6518EDA_OFFSET UNITYSDK_OFFSET(0x9CA1DC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_3CEE9D93D2EBC326_OFFSET UNITYSDK_OFFSET(0x9CA1960)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_3EBE3F136A41CCD9_OFFSET UNITYSDK_OFFSET(0x9C9A880)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_41F5D9C0F0A306F5_OFFSET UNITYSDK_OFFSET(0x9CA0EB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0x9CA0590)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_591CEBEAFC47406B_OFFSET UNITYSDK_OFFSET(0x9C9C450)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_5E72916301E347E2_OFFSET UNITYSDK_OFFSET(0x9C9AA20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_6AE9C0C7D4D137B0_OFFSET UNITYSDK_OFFSET(0x9C9AB80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_712E1FA01E5693FE_OFFSET UNITYSDK_OFFSET(0x9C9EB50)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_714674645EE1CBCA_OFFSET UNITYSDK_OFFSET(0x9CA0200)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_74FE0F242303E029_OFFSET UNITYSDK_OFFSET(0x9CA1A60)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x9C9C020)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_8B1FA4185C7C0938_1_OFFSET UNITYSDK_OFFSET(0x9C99510)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_8B1FA4185C7C0938_OFFSET UNITYSDK_OFFSET(0x9C993F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9079FE2639801498_1_OFFSET UNITYSDK_OFFSET(0x9CA2F70)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9079FE2639801498_OFFSET UNITYSDK_OFFSET(0x9CA2D00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_946586516B7DFBDB_OFFSET UNITYSDK_OFFSET(0x9C9F000)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9C08DA5C1FAA2B3E_OFFSET UNITYSDK_OFFSET(0x9CA2010)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_9FA0F2F97B19BDFF_OFFSET UNITYSDK_OFFSET(0x9CA1F00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_A43F688580F32E0F_OFFSET UNITYSDK_OFFSET(0x9C9BD40)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_A44A18C9451109E4_OFFSET UNITYSDK_OFFSET(0x9CA08A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_A80796DA5203C46C_OFFSET UNITYSDK_OFFSET(0x9CA19D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_B2B7B6D6D6477556_OFFSET UNITYSDK_OFFSET(0x9C9EE80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_BF5C484D5D51196F_OFFSET UNITYSDK_OFFSET(0x9C9B440)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C081D0F1BA12AC56_OFFSET UNITYSDK_OFFSET(0x9C9E420)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C5DCE2A551C0E81B_OFFSET UNITYSDK_OFFSET(0x9CA0670)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C6C47C9FFA92653C_1_OFFSET UNITYSDK_OFFSET(0x9C9D7D0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_C6C47C9FFA92653C_OFFSET UNITYSDK_OFFSET(0x9CA3170)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_D0FA121921ED01A5_OFFSET UNITYSDK_OFFSET(0x9C9E500)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_D155D4917B3D2C6A_OFFSET UNITYSDK_OFFSET(0x9CA10C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_DAB3177560EA0C5C_OFFSET UNITYSDK_OFFSET(0x9C9F790)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_E26C99C52BC1E654_OFFSET UNITYSDK_OFFSET(0x9CA02E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_E844C30991F3F8DC_OFFSET UNITYSDK_OFFSET(0x9C9EEF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_EA1C78EF39610042_OFFSET UNITYSDK_OFFSET(0x9C9E7A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x9C9BC00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F1FEBBADC39F3EAB_OFFSET UNITYSDK_OFFSET(0x9CA1560)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x9C9D600)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F94757253A563A02_1_OFFSET UNITYSDK_OFFSET(0x9CA2500)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F94757253A563A02_OFFSET UNITYSDK_OFFSET(0x9CA2170)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_REMOVESUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C9A770)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C9AE00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SETCHARAEFFECTENABLE_OFFSET UNITYSDK_OFFSET(0x9C79BC0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SETOTHEREFFECTTARGET_OFFSET UNITYSDK_OFFSET(0x9C9A920)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SETSUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C9A720)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET_ISSUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CA3280)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET_ISTARGETPARTMONSTER_OFFSET UNITYSDK_OFFSET(0x9CA3260)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET_PARENTPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CA32A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET__ISAPPLY_OFFSET UNITYSDK_OFFSET(0x9CA32C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_SET__ISRESET_OFFSET UNITYSDK_OFFSET(0x9CA32E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_TRYCREATESUBPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C8C780)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CA32F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CA34C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x9CA3500)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE___IFIXBASEPROXY_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0x9CA3480)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaEffectBase_TypeDefinitionIndex = 57214;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_6_41; // 0x108
		::System::Collections::Generic::Dictionary_2<::UnityEngine::Material*, ::System::Collections::Generic::List_1<::UnityEngine::Material*>*>* Field_6_42; // 0x110
		::System::Collections::Generic::Dictionary_2<::UnityEngine::Renderer*, ::RPG::Client::MonoEffectPluginCharaEffectBase_Class_1_0875A0359D7C8064*>* Field_6_43; // 0x118
		::System::Collections::Generic::List_1<::UnityEngine::Renderer*>* Field_6_44; // 0x120
		::System::Collections::Generic::List_1<::UnityEngine::Material*>* Field_6_45; // 0x128
		::System::Collections::Generic::List_1<::System::UInt32>* Field_6_46; // 0x130
		::System::Collections::Generic::List_1<::RPG::Client::MonoEffectPluginCharaEffectBase*>* Field_6_47; // 0x138
		::System::Boolean Field_6_48; // 0x140
		::RPG::Client::MonoEffect* Field_6_49; // 0x148
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_F0BD65B017F2AC0B_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCHARAEFFECTBASE_METHOD_6_81FEFD1B22CE37A2_OFFSET))(this);
		}
