...
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_GET_ISEDITMODE_OFFSET UNITYSDK_OFFSET(0xE21F930)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_04E967564E8CD234_OFFSET UNITYSDK_OFFSET(0xE221970)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_18378026938D76D0_OFFSET UNITYSDK_OFFSET(0xE2207F0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_501509B4B58077AF_OFFSET UNITYSDK_OFFSET(0xE220180)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xE2219E0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_1_OFFSET UNITYSDK_OFFSET(0xE220440)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_2_OFFSET UNITYSDK_OFFSET(0xE2204C0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_3_OFFSET UNITYSDK_OFFSET(0xE220580)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_7BD95CCEB412D95C_OFFSET UNITYSDK_OFFSET(0xE220380)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_A323A7720C85F580_OFFSET UNITYSDK_OFFSET(0xE21F940)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xE220310)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_B7B52CA164574F49_OFFSET UNITYSDK_OFFSET(0xE21FC10)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_D0916E43A07A622E_OFFSET UNITYSDK_OFFSET(0xE21FAB0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_D5FB3B65B0F72BA3_OFFSET UNITYSDK_OFFSET(0xE21FEC0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_METHOD_2_DD14DC5543DE974C_OFFSET UNITYSDK_OFFSET(0xE220690)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0xE221B50)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0xE221A70)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0xE221C30)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0xE221CC0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0xE221D50)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0xE221DF0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0xE220970)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR__CCTOR_OFFSET UNITYSDK_OFFSET(0xE221EC0)
#define RPG_CLIENT_TIMELINE_MANAVIDEOMIXERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xE221E90)

namespace RPG::Client::Timeline
{
	inline static constexpr unsigned int ManaVideoMixerBehaviour_TypeDefinitionIndex = 73253;
	...
	public:
		...
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(ManaVideoMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0x128C0);
		}
		static ::System::Int32* StaticGet_PROPERTY_TRANSPARENCY()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ManaVideoMixerBehaviour_TypeDefinitionIndex)->GetStaticField(0x128C8);
		}
