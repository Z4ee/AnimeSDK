...
#define RPG_CLIENT_TIMELINE_MANAVIDEOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x197ADF30)

namespace RPG::Client::Timeline
{
	inline static constexpr unsigned int ManaVideoBehaviour_TypeDefinitionIndex = 73249;
