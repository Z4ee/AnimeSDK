...
#define RPG_CLIENT_MONOEFFECTPLUGINPROGRESS_MODIFYMATERIALPARAM_METHOD_1_0F76D2A38DFBC84F_OFFSET UNITYSDK_OFFSET(0x19136100)
#define RPG_CLIENT_MONOEFFECTPLUGINPROGRESS_MODIFYMATERIALPARAM_METHOD_1_8C7BB7482AA9590F_OFFSET UNITYSDK_OFFSET(0x191362D0)
#define RPG_CLIENT_MONOEFFECTPLUGINPROGRESS_MODIFYMATERIALPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19136440)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginProgress_ModifyMaterialParam_TypeDefinitionIndex = 66958;
