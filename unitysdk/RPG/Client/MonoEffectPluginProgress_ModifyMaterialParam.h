...
#define RPG_CLIENT_MONOEFFECTPLUGINPROGRESS_MODIFYMATERIALPARAM_METHOD_1_0F76D2A38DFBC84F_OFFSET UNITYSDK_OFFSET(0x9CD97F0)
#define RPG_CLIENT_MONOEFFECTPLUGINPROGRESS_MODIFYMATERIALPARAM_METHOD_1_8C7BB7482AA9590F_OFFSET UNITYSDK_OFFSET(0x9CD99E0)
#define RPG_CLIENT_MONOEFFECTPLUGINPROGRESS_MODIFYMATERIALPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD9B50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginProgress_ModifyMaterialParam_TypeDefinitionIndex = 57361;
