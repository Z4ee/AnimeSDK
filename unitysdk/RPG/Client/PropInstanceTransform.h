...
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_8ACAC425340483C4_OFFSET UNITYSDK_OFFSET(0xC663E80)
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_9DBC9E6BCD10AD9A_OFFSET UNITYSDK_OFFSET(0xC664170)
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC665380)
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_E2D8E94B87A09275_OFFSET UNITYSDK_OFFSET(0xC665400)
#define RPG_CLIENT_PROPINSTANCETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xC665460)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInstanceTransform_TypeDefinitionIndex = 66169;
