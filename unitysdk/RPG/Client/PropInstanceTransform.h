...
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_8ACAC425340483C4_OFFSET UNITYSDK_OFFSET(0xAF20000)
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_9DBC9E6BCD10AD9A_OFFSET UNITYSDK_OFFSET(0xAF1FEF0)
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAF202F0)
#define RPG_CLIENT_PROPINSTANCETRANSFORM_METHOD_1_E2D8E94B87A09275_OFFSET UNITYSDK_OFFSET(0xAF20370)
#define RPG_CLIENT_PROPINSTANCETRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xAF203D0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInstanceTransform_TypeDefinitionIndex = 65242;
