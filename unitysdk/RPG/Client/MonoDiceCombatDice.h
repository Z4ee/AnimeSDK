...
#define RPG_CLIENT_MONODICECOMBATDICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x10CCD370)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_063673DAD124345C_OFFSET UNITYSDK_OFFSET(0x10CCD220)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_0706AD38EA2EAB79_OFFSET UNITYSDK_OFFSET(0x10CCE070)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_0DA02645F51F0244_OFFSET UNITYSDK_OFFSET(0x10CCDF50)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_38BE73FE87B9CF1D_OFFSET UNITYSDK_OFFSET(0x10CCDB00)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0x10CCD890)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_8327FEEFBF3EC917_OFFSET UNITYSDK_OFFSET(0x10CCD470)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_EE6C603D16076D99_OFFSET UNITYSDK_OFFSET(0x10CCD6F0)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_EFF7FA8E1C5E8D3A_OFFSET UNITYSDK_OFFSET(0x10CCD640)
#define RPG_CLIENT_MONODICECOMBATDICE_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x10CCD1B0)
#define RPG_CLIENT_MONODICECOMBATDICE_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x10CCD300)
#define RPG_CLIENT_MONODICECOMBATDICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0x10CCCFB0)
#define RPG_CLIENT_MONODICECOMBATDICE_SETPERFORMANCECONFIGPROXY_OFFSET UNITYSDK_OFFSET(0x10CCD160)
#define RPG_CLIENT_MONODICECOMBATDICE__CTOR_OFFSET UNITYSDK_OFFSET(0x10CCE200)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDiceCombatDice_TypeDefinitionIndex = 60774;
