...
#define RPG_CLIENT_MONODICECOMBATDICE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xA92A270)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_063673DAD124345C_OFFSET UNITYSDK_OFFSET(0xA92A120)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_0706AD38EA2EAB79_OFFSET UNITYSDK_OFFSET(0xA92AF80)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_0DA02645F51F0244_OFFSET UNITYSDK_OFFSET(0xA92AE60)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_38BE73FE87B9CF1D_OFFSET UNITYSDK_OFFSET(0xA92AA00)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xA92A790)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_8327FEEFBF3EC917_OFFSET UNITYSDK_OFFSET(0xA92A370)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_EE6C603D16076D99_OFFSET UNITYSDK_OFFSET(0xA92A5F0)
#define RPG_CLIENT_MONODICECOMBATDICE_METHOD_5_EFF7FA8E1C5E8D3A_OFFSET UNITYSDK_OFFSET(0xA92A540)
#define RPG_CLIENT_MONODICECOMBATDICE_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xA92A0B0)
#define RPG_CLIENT_MONODICECOMBATDICE_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0xA92A200)
#define RPG_CLIENT_MONODICECOMBATDICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0xA929EB0)
#define RPG_CLIENT_MONODICECOMBATDICE_SETPERFORMANCECONFIGPROXY_OFFSET UNITYSDK_OFFSET(0xA92A060)
#define RPG_CLIENT_MONODICECOMBATDICE__CTOR_OFFSET UNITYSDK_OFFSET(0xA92B110)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDiceCombatDice_TypeDefinitionIndex = 58560;
