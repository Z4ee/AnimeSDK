...
#define RPG_CLIENT_CELESTIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x925DC20)

namespace RPG::Client
{
	inline static constexpr unsigned int CelestialConfig_TypeDefinitionIndex = 57072;
