...
#define RPG_CLIENT_CELESTIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9F21890)

namespace RPG::Client
{
	inline static constexpr unsigned int CelestialConfig_TypeDefinitionIndex = 64323;
