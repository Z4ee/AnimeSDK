...
#define RPG_CLIENT_GRIDFIGHTFLOWDIRECTOR_BATTLEGAMEPAGEAFTERINITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA49B090)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFlowDirector_BattleGamePageAfterInitEvent_TypeDefinitionIndex = 59433;
