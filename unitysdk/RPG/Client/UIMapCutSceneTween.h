...
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xCB6D0F0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xCB6CED0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_RESET_OFFSET UNITYSDK_OFFSET(0xCB6CF20)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_SETMAPCUTSCENE_OFFSET UNITYSDK_OFFSET(0xCB6D140)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_SPAWNED_OFFSET UNITYSDK_OFFSET(0xCB6D0B0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_UPDATECOLORGRADINGPARAMS_OFFSET UNITYSDK_OFFSET(0xCB6D3E0)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_UPDATERADIALBLURPARAMS_OFFSET UNITYSDK_OFFSET(0xCB6D590)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN_UPDATE_OFFSET UNITYSDK_OFFSET(0xCB6D720)
#define RPG_CLIENT_UIMAPCUTSCENETWEEN__CTOR_OFFSET UNITYSDK_OFFSET(0xCB6D770)

namespace RPG::Client
{
	inline static constexpr unsigned int UIMapCutSceneTween_TypeDefinitionIndex = 68244;
