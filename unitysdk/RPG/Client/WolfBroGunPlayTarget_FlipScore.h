...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_INIT_OFFSET UNITYSDK_OFFSET(0xB4D9B20)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xB4D9B90)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_2461C65E55CF590F_OFFSET UNITYSDK_OFFSET(0xB4D9D40)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D9C20)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xB4D9D30)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_FlipScore_TypeDefinitionIndex = 63367;
