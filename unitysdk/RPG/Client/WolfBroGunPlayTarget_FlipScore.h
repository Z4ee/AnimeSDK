...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_INIT_OFFSET UNITYSDK_OFFSET(0x16812EF0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x16812F60)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_FLIPSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x16813010)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_FlipScore_TypeDefinitionIndex = 68692;
