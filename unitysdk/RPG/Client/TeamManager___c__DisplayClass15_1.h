...
#define RPG_CLIENT_TEAMMANAGER___C__DISPLAYCLASS15_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A38CD80)
#define RPG_CLIENT_TEAMMANAGER___C__DISPLAYCLASS15_1__LOADBACKGROUNDPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0x1A397F50)

namespace RPG::Client
{
	inline static constexpr unsigned int TeamManager___c__DisplayClass15_1_TypeDefinitionIndex = 60880;

	class TeamManager___c__DisplayClass15_1 : public ::System::Object
	{
	public:
		::RPG::Client::TeamManager___c__DisplayClass15_0* CS___8__locals1; // 0x10
