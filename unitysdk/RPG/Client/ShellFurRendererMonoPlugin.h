...
#define RPG_CLIENT_SHELLFURRENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA47C090)

namespace RPG::Client
{
	inline static constexpr unsigned int ShellFurRendererMonoPlugin_TypeDefinitionIndex = 58112;
