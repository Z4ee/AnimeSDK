...
#define RPG_CLIENT_LIGHTCONTROLDATA_AWAKE_OFFSET UNITYSDK_OFFSET(0xA66FF40)
#define RPG_CLIENT_LIGHTCONTROLDATA_ISCHILDOFENVNODE_OFFSET UNITYSDK_OFFSET(0xA66FE50)
#define RPG_CLIENT_LIGHTCONTROLDATA_RESETTOINITIAL_OFFSET UNITYSDK_OFFSET(0xA6701D0)
#define RPG_CLIENT_LIGHTCONTROLDATA_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xA670150)
#define RPG_CLIENT_LIGHTCONTROLDATA_SETINTENSITY_OFFSET UNITYSDK_OFFSET(0xA6700B0)
#define RPG_CLIENT_LIGHTCONTROLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA670320)

namespace RPG::Client
{
	inline static constexpr unsigned int LightControlData_TypeDefinitionIndex = 64704;
