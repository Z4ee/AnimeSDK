...
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASMIRROR_OFFSET UNITYSDK_OFFSET(0xA3428F0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASPLAYER_OFFSET UNITYSDK_OFFSET(0xA342770)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASREAL_OFFSET UNITYSDK_OFFSET(0xA342880)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ASRIVAL_OFFSET UNITYSDK_OFFSET(0xA342810)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISDEAD_OFFSET UNITYSDK_OFFSET(0xA3418D0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISMIRROR_OFFSET UNITYSDK_OFFSET(0xA3425F0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISPLAYER_OFFSET UNITYSDK_OFFSET(0xA341D40)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISREAL_OFFSET UNITYSDK_OFFSET(0xA3426F0)
#define RPG_CLIENT_FATEGAMEMASTERINFOITEMEXT_ISRIVAL_OFFSET UNITYSDK_OFFSET(0xA342670)

namespace RPG::Client
{
	inline static constexpr unsigned int FateGameMasterInfoItemExt_TypeDefinitionIndex = 58957;
