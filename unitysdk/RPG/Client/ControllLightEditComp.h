...
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP__CTOR_OFFSET UNITYSDK_OFFSET(0x9425010)

namespace RPG::Client
{
	inline static constexpr unsigned int ControllLightEditComp_TypeDefinitionIndex = 57441;
