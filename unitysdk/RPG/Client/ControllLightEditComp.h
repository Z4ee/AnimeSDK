...
#define RPG_CLIENT_CONTROLLLIGHTEDITCOMP__CTOR_OFFSET UNITYSDK_OFFSET(0xB7126C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ControllLightEditComp_TypeDefinitionIndex = 65623;
