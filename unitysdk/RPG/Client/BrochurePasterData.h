...
#define RPG_CLIENT_BROCHUREPASTERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x920E4C0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GETPASTEDPOSITION_OFFSET UNITYSDK_OFFSET(0x920DDE0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GETPASTEDROTATION_OFFSET UNITYSDK_OFFSET(0x920DE20)
#define RPG_CLIENT_BROCHUREPASTERDATA_GETPASTEDSCALE_OFFSET UNITYSDK_OFFSET(0x920DE70)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x920EC00)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x920EB80)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ISPASTED_OFFSET UNITYSDK_OFFSET(0x920ED30)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x920ECE0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ITEMROW_OFFSET UNITYSDK_OFFSET(0x920EBE0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_PASTERIMAGE_OFFSET UNITYSDK_OFFSET(0x920EC30)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_PASTERTEXT_OFFSET UNITYSDK_OFFSET(0x920EC60)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_PROGRESSCOUNT_OFFSET UNITYSDK_OFFSET(0x920ECC0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x920EBC0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x920E8F0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x920EBA0)
#define RPG_CLIENT_BROCHUREPASTERDATA_GET_UNLOCKHINT_OFFSET UNITYSDK_OFFSET(0x920EC90)
#define RPG_CLIENT_BROCHUREPASTERDATA_ISLOCATIONSAME_OFFSET UNITYSDK_OFFSET(0x920D990)
#define RPG_CLIENT_BROCHUREPASTERDATA_RESET_OFFSET UNITYSDK_OFFSET(0x920D2F0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x920E9B0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SETPASTED_OFFSET UNITYSDK_OFFSET(0x920D940)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x920EB90)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ISPASTED_OFFSET UNITYSDK_OFFSET(0x920ED40)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ITEMROW_OFFSET UNITYSDK_OFFSET(0x920EBF0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x920EBD0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x920EBB0)
#define RPG_CLIENT_BROCHUREPASTERDATA_SYNC_OFFSET UNITYSDK_OFFSET(0x920E190)
#define RPG_CLIENT_BROCHUREPASTERDATA_UPDATEPASTED_OFFSET UNITYSDK_OFFSET(0x920DC60)
#define RPG_CLIENT_BROCHUREPASTERDATA_UPDATEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x920D040)
#define RPG_CLIENT_BROCHUREPASTERDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x920ED50)
#define RPG_CLIENT_BROCHUREPASTERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x920E8D0)
#define RPG_CLIENT_BROCHUREPASTERDATA__GETSCALE_OFFSET UNITYSDK_OFFSET(0x920E910)

namespace RPG::Client
{
	inline static constexpr unsigned int BrochurePasterData_TypeDefinitionIndex = 55658;
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(BrochurePasterData_TypeDefinitionIndex)->GetStaticField(0x9FC0);
		}
		static ::System::Single* StaticGet_ProtoScaling()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(BrochurePasterData_TypeDefinitionIndex)->GetStaticField(0x9FC8);
		}
		::RPG::GameCore::PasterConfigRow* _Row_k__BackingField; // 0x10
		::RPG::Client::ItemData* _ItemRow_k__BackingField; // 0x18
		::UnityEngine::Vector2 _PastedPosition; // 0x20
		::System::UInt32 _UniqueID_k__BackingField; // 0x28
		::System::Single _PastedScale; // 0x2C
		::System::Single _PastedRotation; // 0x30
		::System::Boolean _IsPasted_k__BackingField; // 0x34
		...
		::System::Void Sync(::Class_1_E6D4CCE1AC88574F* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E6D4CCE1AC88574F*))((::PBYTE)hIl2Cpp + RPG_CLIENT_BROCHUREPASTERDATA_SYNC_OFFSET))(this, info);
		}

		::System::Void UpdateUniqueID(::Class_1_E6D4CCE1AC88574F* info)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_E6D4CCE1AC88574F*))((::PBYTE)hIl2Cpp + RPG_CLIENT_BROCHUREPASTERDATA_UPDATEUNIQUEID_OFFSET))(this, info);
		}
