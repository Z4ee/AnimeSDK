...
#define RPG_CLIENT_PERSTATEPARAMBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0xAC49CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerStateParamBeat_TypeDefinitionIndex = 65289;
