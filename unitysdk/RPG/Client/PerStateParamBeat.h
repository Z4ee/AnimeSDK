...
#define RPG_CLIENT_PERSTATEPARAMBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0x9F24F40)

namespace RPG::Client
{
	inline static constexpr unsigned int PerStateParamBeat_TypeDefinitionIndex = 58002;
