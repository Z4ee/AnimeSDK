...
#define RPG_CLIENT_PERSTATEPARAMBEAT__CTOR_OFFSET UNITYSDK_OFFSET(0xC35A430)

namespace RPG::Client
{
	inline static constexpr unsigned int PerStateParamBeat_TypeDefinitionIndex = 66216;
