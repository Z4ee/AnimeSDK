...
#define RPG_CLIENT_DEBUGRENDERTESTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18091170)

namespace RPG::Client
{
	inline static constexpr unsigned int DebugRenderTestCamera_TypeDefinitionIndex = 65297;
