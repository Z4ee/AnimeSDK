...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_CREATE_OFFSET UNITYSDK_OFFSET(0x19D260A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_GETFIRSTREACHNODE_OFFSET UNITYSDK_OFFSET(0x19D35E40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_GETFIRSTREACHROWINDEX_OFFSET UNITYSDK_OFFSET(0x19D363B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_GET_ROWS_OFFSET UNITYSDK_OFFSET(0x19D366E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_HASANYIDLELIVETECHTREECANACTIVATE_OFFSET UNITYSDK_OFFSET(0x19D27810)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_ISALLNODEACTIVATED_OFFSET UNITYSDK_OFFSET(0x19D36590)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE_SET_ROWS_OFFSET UNITYSDK_OFFSET(0x19D366F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D35C60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE__DETERMINEROWTYPE_OFFSET UNITYSDK_OFFSET(0x19D35CE0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBaseTechTree_TypeDefinitionIndex = 71791;
