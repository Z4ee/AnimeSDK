...
#define RPG_CLIENT_ACTIVITYIDLELIVE_THANKGIFTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC6082F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_THANKGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xC607FD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_THANKGIFTSERVICE__ONTHANKGIFT_OFFSET UNITYSDK_OFFSET(0xC608060)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ThankGiftService_TypeDefinitionIndex = 75062;
