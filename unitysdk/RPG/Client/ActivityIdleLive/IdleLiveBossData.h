...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GETNODEICON_OFFSET UNITYSDK_OFFSET(0xC59B390)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC59B300)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xC59B2F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC59B310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_NODEICON_OFFSET UNITYSDK_OFFSET(0xC59B2E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC59B320)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBossData_TypeDefinitionIndex = 74846;
