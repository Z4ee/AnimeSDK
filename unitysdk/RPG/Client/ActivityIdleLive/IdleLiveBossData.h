...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GETNODEICON_OFFSET UNITYSDK_OFFSET(0xB121090)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xB121000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0xB120FF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB121010)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA_GET_NODEICON_OFFSET UNITYSDK_OFFSET(0xB120FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBOSSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB121020)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBossData_TypeDefinitionIndex = 70016;
