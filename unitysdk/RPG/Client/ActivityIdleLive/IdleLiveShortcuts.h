...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_ADJUSTCAMERAVIEWPORT_OFFSET UNITYSDK_OFFSET(0x1C102850)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_DIRECTTOMAZEATSUBMISSION_OFFSET UNITYSDK_OFFSET(0x1C1027D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETALLACTIVATETECHTREENODES_OFFSET UNITYSDK_OFFSET(0x1C102030)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETAVATAREQUIPPEDSPEQUIPINFO_OFFSET UNITYSDK_OFFSET(0x1C101FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCAMERAVIEWPORTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C1024D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCHARACTERMEETPERFORMSERVICE_OFFSET UNITYSDK_OFFSET(0x1C101EA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTBATTLETIME_OFFSET UNITYSDK_OFFSET(0x1C102230)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTTEAMINFO_OFFSET UNITYSDK_OFFSET(0x1C102180)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTTEAMPOWER_OFFSET UNITYSDK_OFFSET(0x1C1023E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETEQUIPFLYSERVICE_OFFSET UNITYSDK_OFFSET(0x1C101F40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETFUNCFLYSERVICE_OFFSET UNITYSDK_OFFSET(0x1C101EF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETPURESHOWGIFTSERVICE_OFFSET UNITYSDK_OFFSET(0x1C101F90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETREWARDFLYSERVICE_OFFSET UNITYSDK_OFFSET(0x1C0F22F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETTEAMINFOATNODEBEGIN_OFFSET UNITYSDK_OFFSET(0x1C102130)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETTEAMPOWERATBATTLEBEGIN_OFFSET UNITYSDK_OFFSET(0x1C1020B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETUNLOCKSTATUSQUERYSERVICE_OFFSET UNITYSDK_OFFSET(0x1C101E50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_INITANDENTERBATTLE_OFFSET UNITYSDK_OFFSET(0x1C102520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_TRYGETSTORYLINECONTEXT_OFFSET UNITYSDK_OFFSET(0x1C101D00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS__DOENTERGAMEFLOW_OFFSET UNITYSDK_OFFSET(0x1C102640)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS__GETGAMEFLOW_OFFSET UNITYSDK_OFFSET(0x1C101D50)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveShortcuts_TypeDefinitionIndex = 75016;
