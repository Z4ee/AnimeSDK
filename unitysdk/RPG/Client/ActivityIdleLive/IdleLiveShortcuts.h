...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_ADJUSTCAMERAVIEWPORT_OFFSET UNITYSDK_OFFSET(0xC5D9310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_DIRECTTOMAZEATSUBMISSION_OFFSET UNITYSDK_OFFSET(0xC5D9290)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETALLACTIVATETECHTREENODES_OFFSET UNITYSDK_OFFSET(0xC5D8BC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETAVATAREQUIPPEDSPEQUIPINFO_OFFSET UNITYSDK_OFFSET(0xC5D8A70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCAMERAVIEWPORTSERVICE_OFFSET UNITYSDK_OFFSET(0xC5D8F90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCHARACTERMEETPERFORMSERVICE_OFFSET UNITYSDK_OFFSET(0xC5D8930)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTBATTLETIME_OFFSET UNITYSDK_OFFSET(0xC5D8D60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTTEAMINFO_OFFSET UNITYSDK_OFFSET(0xC5D8D10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETCURRENTTEAMPOWER_OFFSET UNITYSDK_OFFSET(0xC5D8F00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETEQUIPFLYSERVICE_OFFSET UNITYSDK_OFFSET(0xC5D89D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETFUNCFLYSERVICE_OFFSET UNITYSDK_OFFSET(0xC5D8980)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETPURESHOWGIFTSERVICE_OFFSET UNITYSDK_OFFSET(0xC5D8A20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETREWARDFLYSERVICE_OFFSET UNITYSDK_OFFSET(0xC5C8E70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETTEAMINFOATNODEBEGIN_OFFSET UNITYSDK_OFFSET(0xC5D8CC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETTEAMPOWERATBATTLEBEGIN_OFFSET UNITYSDK_OFFSET(0xC5D8C40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_GETUNLOCKSTATUSQUERYSERVICE_OFFSET UNITYSDK_OFFSET(0xC5D88E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_INITANDENTERBATTLE_OFFSET UNITYSDK_OFFSET(0xC5D8FE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS_TRYGETSTORYLINECONTEXT_OFFSET UNITYSDK_OFFSET(0xC5D8890)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS__DOENTERGAMEFLOW_OFFSET UNITYSDK_OFFSET(0xC5D9100)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS__GETGAMEFLOW_OFFSET UNITYSDK_OFFSET(0xC5D8AC0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveShortcuts_TypeDefinitionIndex = 75017;
