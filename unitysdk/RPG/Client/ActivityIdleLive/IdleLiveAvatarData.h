...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B90D470)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GETPROMOTIONBYUNLOCKSTAR_OFFSET UNITYSDK_OFFSET(0x1B90D6A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1B90D810)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_AVATARPOSTYPE_OFFSET UNITYSDK_OFFSET(0x1B90D860)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1B90D8E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_GACHACONFIG_OFFSET UNITYSDK_OFFSET(0x1B90D900)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_PROMOTIONS_OFFSET UNITYSDK_OFFSET(0x1B90DAB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_STAR_OFFSET UNITYSDK_OFFSET(0x1B90DAD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_GET_UNLOCKEDPROMOTIONS_OFFSET UNITYSDK_OFFSET(0x1B90D920)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1B90D8F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_SET_GACHACONFIG_OFFSET UNITYSDK_OFFSET(0x1B90D910)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_SET_PROMOTIONS_OFFSET UNITYSDK_OFFSET(0x1B90DAC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B90D630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B90D620)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARDATA__GET_UNLOCKEDPROMOTIONS_B__16_0_OFFSET UNITYSDK_OFFSET(0x1B90DB20)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarData_TypeDefinitionIndex = 74772;
