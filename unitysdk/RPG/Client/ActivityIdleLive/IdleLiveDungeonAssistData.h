...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC5A3F10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTDATA_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xC5A47D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xC5A47B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTDATA_SET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xC5A47E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTDATA_SET_UID_OFFSET UNITYSDK_OFFSET(0xC5A47C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A47F0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonAssistData_TypeDefinitionIndex = 74895;
