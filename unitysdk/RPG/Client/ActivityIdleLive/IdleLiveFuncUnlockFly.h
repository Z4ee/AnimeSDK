...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB13CA90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLY_FLY_OFFSET UNITYSDK_OFFSET(0xB13C6F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB13CB10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB13CAD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLY__CTOR_OFFSET UNITYSDK_OFFSET(0xB13CE20)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveFuncUnlockFly_TypeDefinitionIndex = 70047;
