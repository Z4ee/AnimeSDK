...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLYSERVICE___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65F940)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEFUNCUNLOCKFLYSERVICE___C__DISPLAYCLASS6_0__SHOWFUNCUNLOCKFLY_B__0_OFFSET UNITYSDK_OFFSET(0x1A65FA40)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveFuncUnlockFlyService___c__DisplayClass6_0_TypeDefinitionIndex = 71687;

	class IdleLiveFuncUnlockFlyService___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		::RPG::Client::ActivityIdleLive::IdleLiveFuncUnlockFly* fly; // 0x10
		::RPG::Client::ActivityIdleLive::IdleLiveFuncUnlockFlyService* __4__this; // 0x18
		::UnityEngine::Transform* dest; // 0x20
