...
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_CREATEFROMRSP_OFFSET UNITYSDK_OFFSET(0x1B9096E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_GETALLRARITYLIST_OFFSET UNITYSDK_OFFSET(0x1B90AA60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_GETDECOMPOSEDNORETRARITYLIST_OFFSET UNITYSDK_OFFSET(0x1B90A910)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_GETDECOMPOSEDRETRARITYLIST_OFFSET UNITYSDK_OFFSET(0x1B90A8C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_GETFADEOUTTYPELIST_OFFSET UNITYSDK_OFFSET(0x1B90ABA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_GETRETAINEDRARITYLIST_OFFSET UNITYSDK_OFFSET(0x1B90A520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT_GETTOTALEQUIPNUM_OFFSET UNITYSDK_OFFSET(0x1B90A960)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B90A510)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT__SUBTRACTDICT_OFFSET UNITYSDK_OFFSET(0x1B90A5B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GETEQUIPRESULT__UNFOLDDICT_OFFSET UNITYSDK_OFFSET(0x1B90A700)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int GetEquipResult_TypeDefinitionIndex = 75000;
