...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17C6E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__0_OFFSET UNITYSDK_OFFSET(0x1A17CB10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__1_OFFSET UNITYSDK_OFFSET(0x1A17CCA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__2_OFFSET UNITYSDK_OFFSET(0x1A17CD50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__4_OFFSET UNITYSDK_OFFSET(0x1A17CB40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__5_OFFSET UNITYSDK_OFFSET(0x1A17CBF0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTeamRecommendInfo___c__DisplayClass4_0_TypeDefinitionIndex = 71483;
