...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB16BC00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__0_OFFSET UNITYSDK_OFFSET(0xB16BFE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__1_OFFSET UNITYSDK_OFFSET(0xB16C170)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__2_OFFSET UNITYSDK_OFFSET(0xB16C220)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__4_OFFSET UNITYSDK_OFFSET(0xB16C010)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEAMRECOMMENDINFO___C__DISPLAYCLASS4_0__GETRECOMMENDDATALISTSORTEDBYWEIGHT_B__5_OFFSET UNITYSDK_OFFSET(0xB16C0C0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTeamRecommendInfo___c__DisplayClass4_0_TypeDefinitionIndex = 69960;
