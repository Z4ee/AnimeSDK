...
#define RPG_CLIENT_ACTIVITYIDLELIVE_AFFIXUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1B780)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int AffixUiData_TypeDefinitionIndex = 71804;
