...
#define RPG_CLIENT_ACTIVITYIDLELIVE_AFFIXUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB106F50)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int AffixUiData_TypeDefinitionIndex = 70281;
