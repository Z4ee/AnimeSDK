...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB14A4E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB14A520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xB14AA30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_PLAY_OFFSET UNITYSDK_OFFSET(0xB14A770)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SETCANVAS_OFFSET UNITYSDK_OFFSET(0xB14A6D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SETREWARDNUM_OFFSET UNITYSDK_OFFSET(0xB14A670)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB14A4A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY__CTOR_OFFSET UNITYSDK_OFFSET(0xB14ABC0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGemFly_TypeDefinitionIndex = 70048;
