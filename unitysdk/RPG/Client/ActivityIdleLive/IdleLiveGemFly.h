...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1A66D0F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A66D130)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1A66D640)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_PLAY_OFFSET UNITYSDK_OFFSET(0x1A66D380)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SETCANVAS_OFFSET UNITYSDK_OFFSET(0x1A66D2E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SETREWARDNUM_OFFSET UNITYSDK_OFFSET(0x1A66D280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1A66D0B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A66D7D0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGemFly_TypeDefinitionIndex = 71571;
