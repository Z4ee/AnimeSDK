...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1C0F06C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1C0F0700)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x1C0F0C10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_PLAY_OFFSET UNITYSDK_OFFSET(0x1C0F0950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SETCANVAS_OFFSET UNITYSDK_OFFSET(0x1C0F08B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SETREWARDNUM_OFFSET UNITYSDK_OFFSET(0x1C0F0850)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1C0F0680)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGEMFLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F0DA0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGemFly_TypeDefinitionIndex = 74877;

	class IdleLiveGemFly : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Single HBDJCFFDGDD; // 0x18
		::System::Single HPOHJAJLEHD; // 0x1C
		::UnityEngine::UI::Text* PDBADDJDFAM; // 0x20
		::UnityEngine::Transform* KNGEKPKBIDK; // 0x28
		::UnityEngine::Transform* GNPBGAKIAHM; // 0x30
		::UnityEngine::Animation* EOIGEGHFJIJ; // 0x38
		::RPG::Client::MonoUILayerOrderAdjuster* KDHFKGMCKCJ; // 0x40
