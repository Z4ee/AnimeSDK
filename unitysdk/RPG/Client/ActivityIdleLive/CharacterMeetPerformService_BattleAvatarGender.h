...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER_GETREALAVATARID_OFFSET UNITYSDK_OFFSET(0xB10B770)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER_NEEDGETREALAVATARIDBYGENDER_OFFSET UNITYSDK_OFFSET(0xB10B710)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xB10B700)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int CharacterMeetPerformService_BattleAvatarGender_TypeDefinitionIndex = 70037;
