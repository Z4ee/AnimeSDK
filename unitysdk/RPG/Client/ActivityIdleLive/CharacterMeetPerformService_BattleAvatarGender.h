...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER_GETREALAVATARID_OFFSET UNITYSDK_OFFSET(0xC583E10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER_NEEDGETREALAVATARIDBYGENDER_OFFSET UNITYSDK_OFFSET(0xC583DB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHARACTERMEETPERFORMSERVICE_BATTLEAVATARGENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xC583DA0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int CharacterMeetPerformService_BattleAvatarGender_TypeDefinitionIndex = 74867;
