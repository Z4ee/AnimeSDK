...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A678EE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0x1A678F40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1A6790D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1A679040)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6670A0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLivePureShowGiftService_TypeDefinitionIndex = 71699;
