...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0xB155D50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0xB155DB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0xB155F40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0xB155EB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEPURESHOWGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xB144440)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLivePureShowGiftService_TypeDefinitionIndex = 70176;
