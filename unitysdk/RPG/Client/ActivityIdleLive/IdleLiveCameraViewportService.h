...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE_APPLYVIEWPORT_OFFSET UNITYSDK_OFFSET(0xC59BA20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC59BCA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE_REGISTERVIEWPORTREFERENCE_OFFSET UNITYSDK_OFFSET(0xC59B460)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE_RESETVIEWPORT_OFFSET UNITYSDK_OFFSET(0xC59BBB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE_SETINBATTLE_OFFSET UNITYSDK_OFFSET(0xC59BC50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE__APPLYVIEWPORT_OFFSET UNITYSDK_OFFSET(0xC59BA70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xC59B3D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xC59BF30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE__SAMPLERATIOSATANIMEND_OFFSET UNITYSDK_OFFSET(0xC59B5D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE__STOPDELAYAPPLYVIEWPORTCOR_OFFSET UNITYSDK_OFFSET(0xC59BE50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE__UPDATERATIO_OFFSET UNITYSDK_OFFSET(0xC59B550)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVECAMERAVIEWPORTSERVICE___ONUISCREENSIZECHANGED_B__18_0_OFFSET UNITYSDK_OFFSET(0xC59C150)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveCameraViewportService_TypeDefinitionIndex = 74980;
	...
	public:
		...
		::System::Boolean _IsInBattle; // 0x30
