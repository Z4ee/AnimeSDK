...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB1726C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB172610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_SETTEXT_OFFSET UNITYSDK_OFFSET(0xB172780)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_TOSTRING_OFFSET UNITYSDK_OFFSET(0xB1727F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU__CTOR_OFFSET UNITYSDK_OFFSET(0xB172870)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB1728A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0xB1728B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTextDanmu_TypeDefinitionIndex = 70059;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU___IFIXBASEPROXY_ONCREATE_OFFSET))(this, a1);
		}
