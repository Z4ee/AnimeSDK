...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC5F2A00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_ONCREATE_OFFSET UNITYSDK_OFFSET(0xC5F2950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_SETTEXT_OFFSET UNITYSDK_OFFSET(0xC5F2AC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC5F2B30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVETEXTDANMU__CTOR_OFFSET UNITYSDK_OFFSET(0xC5F2BB0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveTextDanmu_TypeDefinitionIndex = 74889;
