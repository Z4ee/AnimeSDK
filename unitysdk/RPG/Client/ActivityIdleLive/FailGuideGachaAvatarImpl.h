...
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_GETFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0x19D23620)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_HASTRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x19D237D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x19D23810)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_SHOULDTRIGGER_OFFSET UNITYSDK_OFFSET(0x19D236D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19D23890)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int FailGuideGachaAvatarImpl_TypeDefinitionIndex = 71778;
