...
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_GETFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0xB10E9B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_HASTRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xB10EB60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0xB10EBA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL_SHOULDTRIGGER_OFFSET UNITYSDK_OFFSET(0xB10EA60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEGACHAAVATARIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0xB10EC20)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int FailGuideGachaAvatarImpl_TypeDefinitionIndex = 70255;
