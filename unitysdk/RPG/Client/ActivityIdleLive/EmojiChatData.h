...
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D228E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_GETEMOJICHATCONTENTDATA_OFFSET UNITYSDK_OFFSET(0x19D22970)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_GET_INTERVAL_OFFSET UNITYSDK_OFFSET(0x19D224A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA_SET_INTERVAL_OFFSET UNITYSDK_OFFSET(0x19D224B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19D224C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__GETEMOJINUM_OFFSET UNITYSDK_OFFSET(0x19D22AB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__GETEMOJI_OFFSET UNITYSDK_OFFSET(0x19D22A20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_EMOJICHATDATA__GETSENDERNAME_OFFSET UNITYSDK_OFFSET(0x19D22C40)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int EmojiChatData_TypeDefinitionIndex = 71736;
