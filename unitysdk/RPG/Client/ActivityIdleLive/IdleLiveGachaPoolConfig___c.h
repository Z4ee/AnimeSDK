...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAPOOLCONFIG___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x9B58F60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAPOOLCONFIG___C__CREATE_B__0_0_OFFSET UNITYSDK_OFFSET(0x9B58FA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAPOOLCONFIG___C__CTOR_OFFSET UNITYSDK_OFFSET(0x9B58F90)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGachaPoolConfig___c_TypeDefinitionIndex = 69311;
	...
	public:
		...
		{
			return (::System::Func_2<::System::UInt32, ::RPG::Client::ActivityIdleLive::IdleLiveGachaWorldTagConfig*>**)Il2CppClass::FromTypeDefinitionIndex(IdleLiveGachaPoolConfig___c_TypeDefinitionIndex)->GetStaticField(0x2EFE0);
		}
		static ::RPG::Client::ActivityIdleLive::IdleLiveGachaPoolConfig___c** StaticGet___9()
		{
			return (::RPG::Client::ActivityIdleLive::IdleLiveGachaPoolConfig___c**)Il2CppClass::FromTypeDefinitionIndex(IdleLiveGachaPoolConfig___c_TypeDefinitionIndex)->GetStaticField(0x2EFE8);
		}
