...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETBATTLEPOWERRAW_OFFSET UNITYSDK_OFFSET(0x3B8B4A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETLEVELPROGRESS_OFFSET UNITYSDK_OFFSET(0x3B8B440)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETMETCHARACTERCNT_OFFSET UNITYSDK_OFFSET(0x3B8B3F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B8B4F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3B8B4C0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ChapterRecordUiData_TypeDefinitionIndex = 75113;
