...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETBATTLEPOWERRAW_OFFSET UNITYSDK_OFFSET(0x39E85C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETLEVELPROGRESS_OFFSET UNITYSDK_OFFSET(0x39E8560)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA_GETMETCHARACTERCNT_OFFSET UNITYSDK_OFFSET(0x39E8510)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x39E8720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CHAPTERRECORDUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x39E86F0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ChapterRecordUiData_TypeDefinitionIndex = 71807;
