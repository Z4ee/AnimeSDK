...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_CREATEGEMMERGEDATA_OFFSET UNITYSDK_OFFSET(0x1C0E6750)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C0E6130)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_AVATARITEM_OFFSET UNITYSDK_OFFSET(0x1C0E7330)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_GEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C0E7310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_ISNEWAVATAR_OFFSET UNITYSDK_OFFSET(0x1C0E7350)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1C0E6700)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_SETISNEWAVATAR_OFFSET UNITYSDK_OFFSET(0x1C0E6490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_SET_AVATARITEM_OFFSET UNITYSDK_OFFSET(0x1C0E7340)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA_SET_GEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1C0E7320)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULTITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0E7300)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGachaResultItemData_TypeDefinitionIndex = 74959;
