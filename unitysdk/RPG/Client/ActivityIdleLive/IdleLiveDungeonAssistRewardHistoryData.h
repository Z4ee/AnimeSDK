...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC5A5170)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xC5A52D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_GET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0xC5A52F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xC5A52B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_SET_COUNT_OFFSET UNITYSDK_OFFSET(0xC5A52E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_SET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0xC5A5300)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_SET_UID_OFFSET UNITYSDK_OFFSET(0xC5A52C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A52A0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonAssistRewardHistoryData_TypeDefinitionIndex = 74897;
