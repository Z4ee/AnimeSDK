...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB12A280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0xB12A3E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_GET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0xB12A400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_GET_UID_OFFSET UNITYSDK_OFFSET(0xB12A3C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_SET_COUNT_OFFSET UNITYSDK_OFFSET(0xB12A3F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_SET_REWARDLIST_OFFSET UNITYSDK_OFFSET(0xB12A410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_SET_UID_OFFSET UNITYSDK_OFFSET(0xB12A3D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB12A3B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonAssistRewardHistoryData_TypeDefinitionIndex = 70067;
	...
	public:
		...
		static ::RPG::Client::ActivityIdleLive::IdleLiveDungeonAssistRewardHistoryData* Create(::Class_1_21DCD4640D389503_22* a1)
		{
			return ((::RPG::Client::ActivityIdleLive::IdleLiveDungeonAssistRewardHistoryData*(*)(::Class_1_21DCD4640D389503_22*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONASSISTREWARDHISTORYDATA_CREATE_OFFSET))(a1);
		}
