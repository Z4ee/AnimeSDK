...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE___C__DISPLAYCLASS0_0__CREATE_B__2_OFFSET UNITYSDK_OFFSET(0x9B3A500)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETECHTREE___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9B39840)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBaseTechTree___c__DisplayClass0_0_TypeDefinitionIndex = 69458;
