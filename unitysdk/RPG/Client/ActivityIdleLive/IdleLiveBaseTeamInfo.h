...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CALPOWERLEVELRAWFORRECOMMEND_OFFSET UNITYSDK_OFFSET(0x19D30930)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CALPOWERLEVELRAW_OFFSET UNITYSDK_OFFSET(0x19D2C460)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CALPOWERLEVEL_OFFSET UNITYSDK_OFFSET(0x19D2C3F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CHECKHASAVATARCANDEPLOY_OFFSET UNITYSDK_OFFSET(0x19D2D570)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CHECKISALLSLOTSFULL_OFFSET UNITYSDK_OFFSET(0x19D2CEF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CHECKISFULLBYPOSTYPE_OFFSET UNITYSDK_OFFSET(0x19D31A40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CONFIRMRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0x19D32AF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETACTIVECAPTAINTAGCOUNT_OFFSET UNITYSDK_OFFSET(0x19D332D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALIVEBATTLEAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0x19D32080)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALLAVATARS_OFFSET UNITYSDK_OFFSET(0x19D31880)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALLTABUIDATA_OFFSET UNITYSDK_OFFSET(0x19D315A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALLTEAMSLOTDATAS_OFFSET UNITYSDK_OFFSET(0x19D23E70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETAVATARDATABYID_OFFSET UNITYSDK_OFFSET(0x19D31490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETAVATARSBYPOSTYPE_OFFSET UNITYSDK_OFFSET(0x19D1E600)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETCAPTAINSLOTDATA_OFFSET UNITYSDK_OFFSET(0x19D32F60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETCAPTAINTAG_OFFSET UNITYSDK_OFFSET(0x19D33160)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETLIMITLEVEL_OFFSET UNITYSDK_OFFSET(0x19D31D80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETSLOTDATABYID_OFFSET UNITYSDK_OFFSET(0x19D2BFC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GET_SPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0x19D35450)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_INITBASE_OFFSET UNITYSDK_OFFSET(0x19D2B640)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_MARKALLONSLOTAVATARSEEN_OFFSET UNITYSDK_OFFSET(0x19D2C840)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_ONAVATARINFOPROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0x19D353B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_ONSLOTINFOPROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0x19D35400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_REGISTERMODIFIERBUILDER_OFFSET UNITYSDK_OFFSET(0x19D2BF10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_REGISTERSPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0x19D31540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_SET_SPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0x19D35460)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_UPGRADESLOT_OFFSET UNITYSDK_OFFSET(0x19D319D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__ADDTEAMAVATAR_1_OFFSET UNITYSDK_OFFSET(0x19D33DA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__ADDTEAMAVATAR_OFFSET UNITYSDK_OFFSET(0x19D33A50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__BUILDMODIFIERBUILDERS_OFFSET UNITYSDK_OFFSET(0x19D349B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CALPOWERLEVELRAWFROMLAYOUT_OFFSET UNITYSDK_OFFSET(0x19D2DB90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CHECKTEAMISVALID_OFFSET UNITYSDK_OFFSET(0x19D347B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CLEARALLTEAMAVATAR_OFFSET UNITYSDK_OFFSET(0x19D34FA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19D35470)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__INITTEAMSLOTDATAS_OFFSET UNITYSDK_OFFSET(0x19D2BB90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__REFRESHTEAMSLOTDATAS_OFFSET UNITYSDK_OFFSET(0x19D34AC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__UPDATETEAMPOS_OFFSET UNITYSDK_OFFSET(0x19D33FE0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBaseTeamInfo_TypeDefinitionIndex = 71485;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ActivityIdleLive::IdleLiveTeamAvatarData*>* _AllTeamAvatarDatas; // 0x28
