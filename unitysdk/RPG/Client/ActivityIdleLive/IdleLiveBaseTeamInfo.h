...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CALPOWERLEVELRAWFORRECOMMEND_OFFSET UNITYSDK_OFFSET(0xC594EE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CALPOWERLEVELRAW_OFFSET UNITYSDK_OFFSET(0xC5906B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CALPOWERLEVEL_OFFSET UNITYSDK_OFFSET(0xC590640)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CHECKHASAVATARCANDEPLOY_OFFSET UNITYSDK_OFFSET(0xC591A60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CHECKISALLSLOTSFULL_OFFSET UNITYSDK_OFFSET(0xC591440)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CHECKISFULLBYPOSTYPE_OFFSET UNITYSDK_OFFSET(0xC596190)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_CONFIRMRECOMMENDDATA_OFFSET UNITYSDK_OFFSET(0xC597240)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETACTIVECAPTAINTAGCOUNT_OFFSET UNITYSDK_OFFSET(0xC597A50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALIVEBATTLEAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0xC5967D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALLAVATARS_OFFSET UNITYSDK_OFFSET(0xC595FD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALLTABUIDATA_OFFSET UNITYSDK_OFFSET(0xC595CF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETALLTEAMSLOTDATAS_OFFSET UNITYSDK_OFFSET(0xC587BA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETAVATARDATABYID_OFFSET UNITYSDK_OFFSET(0xC595A40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETAVATARSBYPOSTYPE_OFFSET UNITYSDK_OFFSET(0xC582180)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETCAPTAINSLOTDATA_OFFSET UNITYSDK_OFFSET(0xC5976E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETCAPTAINTAG_OFFSET UNITYSDK_OFFSET(0xC5978E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETLIMITLEVEL_OFFSET UNITYSDK_OFFSET(0xC5964D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GETSLOTDATABYID_OFFSET UNITYSDK_OFFSET(0xC590270)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_GET_SPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0xC599AD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_INITBASE_OFFSET UNITYSDK_OFFSET(0xC58F8D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_MARKALLONSLOTAVATARSEEN_OFFSET UNITYSDK_OFFSET(0xC590DD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_ONAVATARINFOPROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xC599A30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_ONSLOTINFOPROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xC599A80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_REGISTERMODIFIERBUILDER_OFFSET UNITYSDK_OFFSET(0xC5901C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_REGISTERSPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0xC595C90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_SET_SPEQUIPSLOTINFO_OFFSET UNITYSDK_OFFSET(0xC599AE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO_UPGRADESLOT_OFFSET UNITYSDK_OFFSET(0xC596120)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__ADDTEAMAVATAR_1_OFFSET UNITYSDK_OFFSET(0xC598490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__ADDTEAMAVATAR_OFFSET UNITYSDK_OFFSET(0xC598140)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__BUILDMODIFIERBUILDERS_OFFSET UNITYSDK_OFFSET(0xC5990A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CALPOWERLEVELRAWFROMLAYOUT_OFFSET UNITYSDK_OFFSET(0xC592080)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CHECKTEAMISVALID_OFFSET UNITYSDK_OFFSET(0xC598EA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CLEARALLTEAMAVATAR_OFFSET UNITYSDK_OFFSET(0xC599660)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC599AF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__INITTEAMSLOTDATAS_OFFSET UNITYSDK_OFFSET(0xC58FE20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__REFRESHTEAMSLOTDATAS_OFFSET UNITYSDK_OFFSET(0xC5991B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEBASETEAMINFO__UPDATETEAMPOS_OFFSET UNITYSDK_OFFSET(0xC5986D0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveBaseTeamInfo_TypeDefinitionIndex = 74792;

	class IdleLiveBaseTeamInfo : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::ILBattleCharacterLocation, ::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::IdleLiveTeamSlotData*>*>* _AllTeamSlotDatas; // 0x10
		::RPG::Client::ActivityIdleLive::SpEquipSlotInfo* _SpEquipSlotInfo_k__BackingField; // 0x18
		::RPG::Client::ActivityIdleLive::IdleLiveTeamSlotInfo* _SlotInfo; // 0x20
		::RPG::Client::ActivityIdleLive::IdleLiveAvatarInfo* _AvatarInfo; // 0x28
		...
		::System::Collections::Generic::List_1<::RPG::Client::ActivityIdleLive::IdleLiveModifierBuilder_1<::RPG::Client::ActivityIdleLive::IdleLiveDecimal>*>* _ModifierBuilders; // 0x38
