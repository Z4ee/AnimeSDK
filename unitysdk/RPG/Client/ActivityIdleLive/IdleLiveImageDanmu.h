...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B66F20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9B66DD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_METHOD_6_66C47ED41C56178D_OFFSET UNITYSDK_OFFSET(0x9B66EB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B66D10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU__CTOR_OFFSET UNITYSDK_OFFSET(0x9B66F80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU___IFIXBASEPROXY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B66FC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU___IFIXBASEPROXY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B66FB0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveImageDanmu_TypeDefinitionIndex = 69241;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU___IFIXBASEPROXY_ONCREATE_OFFSET))(this, P0);
		}

		::System::Void __iFixBaseProxy_Despawned()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMAGEDANMU___IFIXBASEPROXY_DESPAWNED_OFFSET))(this);
		}
	};
}
