...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x19D28030)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GETTAGRANKDESC_OFFSET UNITYSDK_OFFSET(0x19D2B1C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GETTAGRANK_OFFSET UNITYSDK_OFFSET(0x19D2B450)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19D2B610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19D2B5F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_TAG_OFFSET UNITYSDK_OFFSET(0x19D2B5D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x19D2B620)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19D2B600)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_TAG_OFFSET UNITYSDK_OFFSET(0x19D2B5E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19D2B1B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarTagConfig_TypeDefinitionIndex = 71475;
