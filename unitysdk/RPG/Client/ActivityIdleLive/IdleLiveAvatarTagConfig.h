...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x1B90D3D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GETTAGRANKDESC_OFFSET UNITYSDK_OFFSET(0x1B910A80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GETTAGRANK_OFFSET UNITYSDK_OFFSET(0x1B910D10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B910ED0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B910EB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1B910E90)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B910EE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B910EC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG_SET_TAG_OFFSET UNITYSDK_OFFSET(0x1B910EA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARTAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B910A70)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarTagConfig_TypeDefinitionIndex = 74781;
	...
	public:
		...
		::RPG::GameCore::ILBattleAvatarTag _Tag_k__BackingField; // 0x28
