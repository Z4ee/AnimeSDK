...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x1C0E4280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GETAVATARSTARUPLIST_OFFSET UNITYSDK_OFFSET(0x1C0E5150)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GETCOINMERGEDATA_OFFSET UNITYSDK_OFFSET(0x1C0E64E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_AVATARMERGELIST_OFFSET UNITYSDK_OFFSET(0x1C0E6B50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_HASAVATARUPGRADE_OFFSET UNITYSDK_OFFSET(0x1C0E4F10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_HASSTARUP_OFFSET UNITYSDK_OFFSET(0x1C0E6910)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_ISUPGRADE_OFFSET UNITYSDK_OFFSET(0x1C0E68D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_ITEMLIST_OFFSET UNITYSDK_OFFSET(0x1C0E67D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0E60C0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGachaResult_TypeDefinitionIndex = 74954;
