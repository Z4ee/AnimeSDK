...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A661680)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GETAVATARSTARUPLIST_OFFSET UNITYSDK_OFFSET(0x1A662550)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GETCOINMERGEDATA_OFFSET UNITYSDK_OFFSET(0x1A6638B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_AVATARMERGELIST_OFFSET UNITYSDK_OFFSET(0x1A663F20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_HASAVATARUPGRADE_OFFSET UNITYSDK_OFFSET(0x1A662310)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_HASSTARUP_OFFSET UNITYSDK_OFFSET(0x1A663CE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_ISUPGRADE_OFFSET UNITYSDK_OFFSET(0x1A663CA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT_GET_ITEMLIST_OFFSET UNITYSDK_OFFSET(0x1A663BA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHARESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A663490)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGachaResult_TypeDefinitionIndex = 71648;
