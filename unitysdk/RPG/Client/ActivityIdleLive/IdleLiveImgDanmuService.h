...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C0F5530)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE_GETIMAGEDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F52D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__ADDIMAGEDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F5B20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__CLEARCREATEDTRIGGERS_OFFSET UNITYSDK_OFFSET(0x1C0F56D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__CLEARENDEDIMAGEDANMUS_OFFSET UNITYSDK_OFFSET(0x1C0F53D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F4E00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__INITUNLOCKIDMAPPING_OFFSET UNITYSDK_OFFSET(0x1C0F4F80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__ONSETDANMUENABLE_OFFSET UNITYSDK_OFFSET(0x1C0F5DD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEIMGDANMUSERVICE__ONUNLOCKIDUPDATED_OFFSET UNITYSDK_OFFSET(0x1C0F5950)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveImgDanmuService_TypeDefinitionIndex = 75049;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_7B630EA0921A5074*>* _ActiveImageDanmus; // 0x18
