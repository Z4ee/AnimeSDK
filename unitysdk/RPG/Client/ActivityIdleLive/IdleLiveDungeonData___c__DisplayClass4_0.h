...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A6360)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA___C__DISPLAYCLASS4_0__TRYADDASSISTDATA_B__0_OFFSET UNITYSDK_OFFSET(0xC5A7820)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA___C__DISPLAYCLASS4_0__TRYADDASSISTDATA_B__1_OFFSET UNITYSDK_OFFSET(0xC5A7840)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonData___c__DisplayClass4_0_TypeDefinitionIndex = 74902;
