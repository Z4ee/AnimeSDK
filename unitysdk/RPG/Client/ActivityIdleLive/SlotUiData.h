...
#define RPG_CLIENT_ACTIVITYIDLELIVE_SLOTUIDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x39ECCF0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int SlotUiData_TypeDefinitionIndex = 71826;
