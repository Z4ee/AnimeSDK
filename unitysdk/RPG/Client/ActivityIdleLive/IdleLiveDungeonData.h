...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_CLEARFRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0x1A64BFC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A64BC50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GETCHATSERVICE_OFFSET UNITYSDK_OFFSET(0x1A64BF20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_ASSISTDATAS_OFFSET UNITYSDK_OFFSET(0x1A64D630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A64D710)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_FRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0x1A64D730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1A64D6C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_MAXPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A64D680)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_GET_SAVEDTEAM_OFFSET UNITYSDK_OFFSET(0x1A64D6A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_ISASSISTDATAINFRIENDSOLT_OFFSET UNITYSDK_OFFSET(0x1A64C700)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SETSAVEDTEAM_OFFSET UNITYSDK_OFFSET(0x1A64BEB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A64D720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_FRIENDSOLTDATAS_OFFSET UNITYSDK_OFFSET(0x1A64D740)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_MAXPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A64D690)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_SET_SAVEDTEAM_OFFSET UNITYSDK_OFFSET(0x1A64D6B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_TRYADDASSISTDATA_OFFSET UNITYSDK_OFFSET(0x1A64C1A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_TRYREMOVEASSISTDATA_OFFSET UNITYSDK_OFFSET(0x1A64C540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A64CB10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1A64CB80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_3_OFFSET UNITYSDK_OFFSET(0x1A64CFD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A64C870)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A64BE30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA__GETASSISTDATAS_OFFSET UNITYSDK_OFFSET(0x1A64D290)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA__ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1A64D030)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveDungeonData_TypeDefinitionIndex = 71593;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::UInt32>* _SavedTeam_k__BackingField; // 0x18
		::RPG::Client::ActivityIdleLive::IdleLiveDungeonConfig* _Config_k__BackingField; // 0x20
		...
		::System::Void Update_1(::Class_1_D17272E82AE804C2_558* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_558*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEDUNGEONDATA_UPDATE_1_OFFSET))(this, a1);
		}
