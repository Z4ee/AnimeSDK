...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_ADD_PROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xB113630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_CHECKHASAVATAR_OFFSET UNITYSDK_OFFSET(0xB1140F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETALLAVATARS_OFFSET UNITYSDK_OFFSET(0xB1144E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETAVATARDATABYID_OFFSET UNITYSDK_OFFSET(0xB114180)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETAVATARSBYPOSTYPE_OFFSET UNITYSDK_OFFSET(0xB114230)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETMETAVATARCNT_OFFSET UNITYSDK_OFFSET(0xB1145D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GETSLOTLEVELBYSLOTID_OFFSET UNITYSDK_OFFSET(0xB114060)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GET_ALLAVATARS_OFFSET UNITYSDK_OFFSET(0xB114680)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GET_GOTAVATARCOUNT_OFFSET UNITYSDK_OFFSET(0xB114630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_GET_TOTALAVATARCOUNT_OFFSET UNITYSDK_OFFSET(0xB114620)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_INIT_OFFSET UNITYSDK_OFFSET(0xB1137D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_ONPROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xB1136F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_REMOVE_PROTOCOLRECEIVED_OFFSET UNITYSDK_OFFSET(0xB113690)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_UPDATEADDAVATAR_OFFSET UNITYSDK_OFFSET(0xB113950)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_UPDATEMGRINFO_OFFSET UNITYSDK_OFFSET(0xB113CA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO__CREATEAVATAR_OFFSET UNITYSDK_OFFSET(0xB113BB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xB114770)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveAvatarInfo_TypeDefinitionIndex = 69947;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::ActivityIdleLive::IdleLiveAvatarData*>* _AllAvatarDatas; // 0x20
		...
		::System::Void UpdateAddAvatar(::Class_1_D17272E82AE804C2_491* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_491*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_UPDATEADDAVATAR_OFFSET))(this, a1);
		}

		::System::Void UpdateMgrInfo(::Class_1_0AC743E88BB51C0B* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_0AC743E88BB51C0B*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO_UPDATEMGRINFO_OFFSET))(this, a1);
		}
		...
		::System::Void _CreateAvatar(::Class_1_D17272E82AE804C2_491* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_491*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEAVATARINFO__CREATEAVATAR_OFFSET))(this, a1);
		}
