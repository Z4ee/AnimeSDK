...
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_GETFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0x1B908E30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_HASTRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x1B909520)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B909560)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_SHOULDTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B908EE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9095E0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int FailGuideUpgradeAvatarImpl_TypeDefinitionIndex = 75087;
