...
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_GETFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0x9B29070)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_HASTRIGGERACTION_OFFSET UNITYSDK_OFFSET(0x9B29630)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x9B29670)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_SHOULDTRIGGER_OFFSET UNITYSDK_OFFSET(0x9B29120)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x9B296F0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int FailGuideUpgradeAvatarImpl_TypeDefinitionIndex = 69446;
