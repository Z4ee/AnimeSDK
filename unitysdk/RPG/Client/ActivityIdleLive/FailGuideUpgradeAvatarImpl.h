...
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_GETFAILHINTTEXT_OFFSET UNITYSDK_OFFSET(0xB10EE60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_HASTRIGGERACTION_OFFSET UNITYSDK_OFFSET(0xB10F4F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0xB10F530)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL_SHOULDTRIGGER_OFFSET UNITYSDK_OFFSET(0xB10EF10)
#define RPG_CLIENT_ACTIVITYIDLELIVE_FAILGUIDEUPGRADEAVATARIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0xB10F5B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int FailGuideUpgradeAvatarImpl_TypeDefinitionIndex = 70258;
