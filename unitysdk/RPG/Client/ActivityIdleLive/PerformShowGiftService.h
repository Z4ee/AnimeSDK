...
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BA642C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0x1BA63EB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0x1BA64000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1BA64150)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1BA63D40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA63C00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_PERFORMSHOWGIFTSERVICE__ONPERFORMGIFTADDED_OFFSET UNITYSDK_OFFSET(0x1BA63C80)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int PerformShowGiftService_TypeDefinitionIndex = 75025;
