...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_AWAKE_OFFSET UNITYSDK_OFFSET(0xC5CF6C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC5D01C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC5D0800)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_REGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xC5CF8B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xC5CF900)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC5D0AA0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__INSERTULTRASKILL_OFFSET UNITYSDK_OFFSET(0xC5D0220)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__ONAUTOBATTLESTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0xC5D0730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__ONULTRASKILLBEGIN_OFFSET UNITYSDK_OFFSET(0xC5D0780)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__ONULTRASKILLBTNCLICK_OFFSET UNITYSDK_OFFSET(0xC5D0400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__REFRESHONSPCHANGED_OFFSET UNITYSDK_OFFSET(0xC5D0110)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__REFRESHSP_OFFSET UNITYSDK_OFFSET(0xC5CFCC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEINGAMEULTRASKILLPANEL__RESETSTATE_OFFSET UNITYSDK_OFFSET(0xC5CFC50)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveInGameUltraSkillPanel_TypeDefinitionIndex = 74885;
