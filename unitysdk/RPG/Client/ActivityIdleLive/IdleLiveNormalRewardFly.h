...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B6D2F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B6D330)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x9B6D830)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_PLAY_OFFSET UNITYSDK_OFFSET(0x9B6D560)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SETCANVAS_OFFSET UNITYSDK_OFFSET(0x9B6DAF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SETICON_OFFSET UNITYSDK_OFFSET(0x9B6D4A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SETREWARDNUM_OFFSET UNITYSDK_OFFSET(0x9B6D500)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9B6D2B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVENORMALREWARDFLY__CTOR_OFFSET UNITYSDK_OFFSET(0x9B6DB90)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveNormalRewardFly_TypeDefinitionIndex = 69245;
