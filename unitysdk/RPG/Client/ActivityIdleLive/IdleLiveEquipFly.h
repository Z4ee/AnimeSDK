...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLY_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xB1396B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLY_FLY_OFFSET UNITYSDK_OFFSET(0xB139250)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLY_ONCREATE_OFFSET UNITYSDK_OFFSET(0xB139730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLY_SETCANVAS_OFFSET UNITYSDK_OFFSET(0xB139610)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLY_SPAWNED_OFFSET UNITYSDK_OFFSET(0xB1396F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEEQUIPFLY__CTOR_OFFSET UNITYSDK_OFFSET(0xB1399B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveEquipFly_TypeDefinitionIndex = 70046;
