...
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_APPENDSCROLL_OFFSET UNITYSDK_OFFSET(0xB110C50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_GET_ISSCROLLING_OFFSET UNITYSDK_OFFSET(0xB110B50)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0xB110B60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB110EF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_STARTSCROLL_OFFSET UNITYSDK_OFFSET(0xB110BD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_STOPSCROLL_OFFSET UNITYSDK_OFFSET(0xB110CD0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xB110D20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_GIFTTHANKSCROLLANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB110F40)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int GiftThankScrollAnimator_TypeDefinitionIndex = 70040;
