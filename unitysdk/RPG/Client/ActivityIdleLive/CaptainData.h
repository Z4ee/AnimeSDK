...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B9040A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_ICON_OFFSET UNITYSDK_OFFSET(0x1B904060)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B904070)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_SENDERID_OFFSET UNITYSDK_OFFSET(0x1B904050)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_TOTALDONATECOUNT_OFFSET UNITYSDK_OFFSET(0x1B904080)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_SETTOTALSCCOUNT_OFFSET UNITYSDK_OFFSET(0x1B9041F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_SET_TOTALDONATECOUNT_OFFSET UNITYSDK_OFFSET(0x1B904090)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9041C0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int CaptainData_TypeDefinitionIndex = 74836;
