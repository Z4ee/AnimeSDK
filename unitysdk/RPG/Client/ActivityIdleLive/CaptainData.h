...
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB10A440)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_ICON_OFFSET UNITYSDK_OFFSET(0xB10A400)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB10A410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_SENDERID_OFFSET UNITYSDK_OFFSET(0xB10A3F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_GET_TOTALDONATECOUNT_OFFSET UNITYSDK_OFFSET(0xB10A420)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_SETTOTALSCCOUNT_OFFSET UNITYSDK_OFFSET(0xB10A590)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA_SET_TOTALDONATECOUNT_OFFSET UNITYSDK_OFFSET(0xB10A430)
#define RPG_CLIENT_ACTIVITYIDLELIVE_CAPTAINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB10A560)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int CaptainData_TypeDefinitionIndex = 70007;
