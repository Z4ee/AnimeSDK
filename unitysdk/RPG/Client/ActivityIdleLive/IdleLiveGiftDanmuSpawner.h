...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1C0F32F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_CLEARDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F4280)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_ISSHOWINGDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F44E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1C0F3B00)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C0F4540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_PAUSEDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F30B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_RESUMEDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F31D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_SETINTERACTIONPROVIDER_OFFSET UNITYSDK_OFFSET(0x1C0F3060)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C0F3430)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CANSHOWNEWDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F3740)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CLEANENDEDDANMUS_OFFSET UNITYSDK_OFFSET(0x1C0F3BE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0F4590)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1C0F36A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__ONLOAD_OFFSET UNITYSDK_OFFSET(0x1C0F3340)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__SPAWNDANMU_OFFSET UNITYSDK_OFFSET(0x1C0F4020)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__TRYFETCHGIFTTOSHOW_OFFSET UNITYSDK_OFFSET(0x1C0F3890)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGiftDanmuSpawner_TypeDefinitionIndex = 74880;
