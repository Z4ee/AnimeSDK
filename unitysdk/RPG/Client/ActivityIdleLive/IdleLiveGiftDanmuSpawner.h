...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9B65730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_CLEARDANMU_OFFSET UNITYSDK_OFFSET(0x9B664E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_ISSHOWINGDANMU_OFFSET UNITYSDK_OFFSET(0x9B66720)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9B65E40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9B66780)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_PAUSEDANMU_OFFSET UNITYSDK_OFFSET(0x9B65490)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_RESUMEDANMU_OFFSET UNITYSDK_OFFSET(0x9B655E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_SETINTERACTIONPROVIDER_OFFSET UNITYSDK_OFFSET(0x9B65440)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9B65870)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CANSHOWNEWDANMU_OFFSET UNITYSDK_OFFSET(0x9B65B20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CLEANENDEDDANMUS_OFFSET UNITYSDK_OFFSET(0x9B65F20)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x9B667D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__ISPAUSED_OFFSET UNITYSDK_OFFSET(0x9B65A80)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__ONLOAD_OFFSET UNITYSDK_OFFSET(0x9B65780)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__SPAWNDANMU_OFFSET UNITYSDK_OFFSET(0x9B66330)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__TRYFETCHGIFTTOSHOW_OFFSET UNITYSDK_OFFSET(0x9B65C80)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGiftDanmuSpawner_TypeDefinitionIndex = 69239;
	...
	public:
		...
		::System::Void SetInteractionProvider(::RPG::Client::ActivityIdleLive::IInteractionProvider* interactionProvider)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ActivityIdleLive::IInteractionProvider*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER_SETINTERACTIONPROVIDER_OFFSET))(this, interactionProvider);
		}
		...
		::System::Void _SpawnDanmu(::RPG::Client::ActivityIdleLive::IdleLiveGiftUiData* giftUiData)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ActivityIdleLive::IdleLiveGiftUiData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGIFTDANMUSPAWNER__SPAWNDANMU_OFFSET))(this, giftUiData);
		}
