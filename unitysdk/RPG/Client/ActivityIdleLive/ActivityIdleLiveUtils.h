...
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_CONVERTORDERTOPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1B8FD6F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_CONVERTSLOTDATASTOAVATARDICT_OFFSET UNITYSDK_OFFSET(0x1B8FDA60)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_CREATEBATTLESTATINFO_OFFSET UNITYSDK_OFFSET(0x1B8FE6E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_FORMATPERCENTWITHONEDECIMAL_1_OFFSET UNITYSDK_OFFSET(0x1B8FE5E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_FORMATPERCENTWITHONEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1B8FE070)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GETCANSHOWPROPERTYTYPES_OFFSET UNITYSDK_OFFSET(0x1B8FD830)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GETCHAPTERNUMTEXTIDBYNODEINDEX_OFFSET UNITYSDK_OFFSET(0x1B8FDFE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GETSOLTDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x1B8FD730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x1B9003B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_ASSISTREWARDID_OFFSET UNITYSDK_OFFSET(0x1B9000B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_CHESTID_OFFSET UNITYSDK_OFFSET(0x1B8FF930)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_CRYSTALID_OFFSET UNITYSDK_OFFSET(0x1B8FF730)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_DUNGEONMULTIPLEPLAYERSETTLERATIOLIST_OFFSET UNITYSDK_OFFSET(0x1B8FF250)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_DUNGEONREFRESHTIME_OFFSET UNITYSDK_OFFSET(0x1B9001B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_FORCETOTRACESUBMISSIONID_OFFSET UNITYSDK_OFFSET(0x1B900410)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHACOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8FFA30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHACRYSTALID_OFFSET UNITYSDK_OFFSET(0x1B8FF830)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHAGUARANTEECOUNT_OFFSET UNITYSDK_OFFSET(0x1B8FFD30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHAMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8FFB30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_GACHAREDOTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8FFC30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_INITIALBASEPOWER_OFFSET UNITYSDK_OFFSET(0x1B8FFE30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_INITIALMAXFRIENDSOLTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B8FFFE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_INITIALMAXLEVEL_OFFSET UNITYSDK_OFFSET(0x1B8FF210)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_NEWREDDOTEXCLUDEAVATARIDS_OFFSET UNITYSDK_OFFSET(0x1B900470)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_POWERSIGNIFICANTFIGURES_OFFSET UNITYSDK_OFFSET(0x1B9002B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TABICONFEMALE_OFFSET UNITYSDK_OFFSET(0x1B8F8030)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TABICONMALE_OFFSET UNITYSDK_OFFSET(0x1B8F7F70)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TAGLEVELLIST_OFFSET UNITYSDK_OFFSET(0x1B8FF4C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_GET_TECHPOINTID_OFFSET UNITYSDK_OFFSET(0x1B8FFEE0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_SET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x1B9003E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_SET_FORCETOTRACESUBMISSIONID_OFFSET UNITYSDK_OFFSET(0x1B900440)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS_SET_NEWREDDOTEXCLUDEAVATARIDS_OFFSET UNITYSDK_OFFSET(0x1B9004A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B9004F0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9004E0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_ACTIVITYIDLELIVEUTILS__ISAVATARINTEAM_OFFSET UNITYSDK_OFFSET(0x1B8FECC0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int ActivityIdleLiveUtils_TypeDefinitionIndex = 74765;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ActivityIdleLiveUtils_TypeDefinitionIndex)->GetStaticField(0x56650);
		}
		static ::System::UInt32* StaticGet__ActivityID_k__BackingField()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(ActivityIdleLiveUtils_TypeDefinitionIndex)->GetStaticField(0x11AB0);
		}
		static ::System::UInt32* StaticGet__ForceToTraceSubMissionID_k__BackingField()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(ActivityIdleLiveUtils_TypeDefinitionIndex)->GetStaticField(0x11AB4);
		}
