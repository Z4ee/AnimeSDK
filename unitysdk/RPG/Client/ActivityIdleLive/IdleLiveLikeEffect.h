...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVELIKEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC5D0AF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVELIKEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xC5D0B30)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVELIKEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xC5C7E40)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVELIKEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC5D0AB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVELIKEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC5D0C20)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveLikeEffect_TypeDefinitionIndex = 74886;
