...
#define RPG_CLIENT_ACTIVITYIDLELIVE_DUNGEONSPEQUIPINVENTORYDISPLAYDATA___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B907790)
#define RPG_CLIENT_ACTIVITYIDLELIVE_DUNGEONSPEQUIPINVENTORYDISPLAYDATA___C__DISPLAYCLASS6_0___UPDATESPEQUIPSLOTS_B__0_OFFSET UNITYSDK_OFFSET(0x1B9077A0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int DungeonSpEquipInventoryDisplayData___c__DisplayClass6_0_TypeDefinitionIndex = 75119;
