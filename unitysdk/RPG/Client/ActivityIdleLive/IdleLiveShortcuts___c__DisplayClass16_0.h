...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB15B8D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVESHORTCUTS___C__DISPLAYCLASS16_0__INITANDENTERBATTLE_B__0_OFFSET UNITYSDK_OFFSET(0xB15BC00)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveShortcuts___c__DisplayClass16_0_TypeDefinitionIndex = 70188;
