...
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BA6A3C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO___C__DISPLAYCLASS19_0__GETEQUIPBELONGEDONEBASEDINDEX_B__0_OFFSET UNITYSDK_OFFSET(0x1BA6B540)
#define RPG_CLIENT_ACTIVITYIDLELIVE_SPEQUIPSLOTINFO___C__DISPLAYCLASS19_0__GETEQUIPBELONGEDONEBASEDINDEX_B__1_OFFSET UNITYSDK_OFFSET(0x1BA6B5F0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int SpEquipSlotInfo___c__DisplayClass19_0_TypeDefinitionIndex = 74942;
