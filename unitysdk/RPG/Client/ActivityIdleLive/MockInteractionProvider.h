...
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A188FC0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_HAVENEWINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A189040)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_POPINTERACTIONID_OFFSET UNITYSDK_OFFSET(0x1A189080)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1A189120)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER_UPDATEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1A1890D0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_MOCKINTERACTIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A189030)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int MockInteractionProvider_TypeDefinitionIndex = 71722;
