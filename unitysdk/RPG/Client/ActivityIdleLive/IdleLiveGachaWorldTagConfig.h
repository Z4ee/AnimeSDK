...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0x1A662CF0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A6647B0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A664770)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A664790)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A6647C0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A664780)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A6647A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEGACHAWORLDTAGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A664760)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveGachaWorldTagConfig_TypeDefinitionIndex = 71655;
