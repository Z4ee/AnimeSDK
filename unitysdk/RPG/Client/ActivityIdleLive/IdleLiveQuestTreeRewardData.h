...
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1C0FE000)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_GET_CHESTCOUNT_OFFSET UNITYSDK_OFFSET(0x12370)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_GET_CRYSTALCOUNT_OFFSET UNITYSDK_OFFSET(0x784260)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_GET_TICKETCOUNT_OFFSET UNITYSDK_OFFSET(0x19050)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_SET_CHESTCOUNT_OFFSET UNITYSDK_OFFSET(0x379F970)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_SET_CRYSTALCOUNT_OFFSET UNITYSDK_OFFSET(0xB596A0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA_SET_TICKETCOUNT_OFFSET UNITYSDK_OFFSET(0x18EB0)
#define RPG_CLIENT_ACTIVITYIDLELIVE_IDLELIVEQUESTTREEREWARDDATA__CHECKANDADDREWARD_OFFSET UNITYSDK_OFFSET(0x1C0FE7B0)

namespace RPG::Client::ActivityIdleLive
{
	inline static constexpr unsigned int IdleLiveQuestTreeRewardData_TypeDefinitionIndex = 75076;
