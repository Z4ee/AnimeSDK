...
#define RPG_CLIENT_COROUTINEUTILS___INVOKENEXTFRAMECOROUTINE_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E58EB90)
#define RPG_CLIENT_COROUTINEUTILS___INVOKENEXTFRAMECOROUTINE_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58EBE0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKENEXTFRAMECOROUTINE_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E58EC40)
#define RPG_CLIENT_COROUTINEUTILS___INVOKENEXTFRAMECOROUTINE_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E58EBF0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKENEXTFRAMECOROUTINE_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E58EB80)
#define RPG_CLIENT_COROUTINEUTILS___INVOKENEXTFRAMECOROUTINE_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0x1E58DFB0)
