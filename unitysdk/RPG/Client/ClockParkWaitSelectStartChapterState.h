...
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE_ENABLEDICEPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1BC1A4E0)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE_FINISHROUND_OFFSET UNITYSDK_OFFSET(0x1BC1A390)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE_ISSHOWATTRIBUTEINFO_OFFSET UNITYSDK_OFFSET(0x1BC1A460)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE_ISSHOWDICEPLACEMENT_OFFSET UNITYSDK_OFFSET(0x1BC1A4A0)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE_SETSELECTEDCHAPTERID_OFFSET UNITYSDK_OFFSET(0x1BC1A520)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC13B10)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE__INITWAITSELECTCHAPTERS_OFFSET UNITYSDK_OFFSET(0x1BC1A270)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x1BC1A330)
#define RPG_CLIENT_CLOCKPARKWAITSELECTSTARTCHAPTERSTATE__ONENTER_OFFSET UNITYSDK_OFFSET(0x1BC1A220)
