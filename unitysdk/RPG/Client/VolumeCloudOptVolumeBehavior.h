...
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C817630)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x1C817290)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x1C8170B0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1C817690)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_CA445FA4930F7C4B_OFFSET UNITYSDK_OFFSET(0x1C8172D0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x1C817720)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C817980)

namespace RPG::Client
{
	inline static constexpr unsigned int VolumeCloudOptVolumeBehavior_TypeDefinitionIndex = 70799;
