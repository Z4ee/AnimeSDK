...
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA77D6A0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xA77D3B0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA77DA20)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0xA77D1D0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_91217E1D36C5D86A_OFFSET UNITYSDK_OFFSET(0xA77D3F0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA77D700)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xA77D790)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA77D9E0)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA77DA10)
#define RPG_CLIENT_VOLUMECLOUDOPTVOLUMEBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA77DA80)

namespace RPG::Client
{
	inline static constexpr unsigned int VolumeCloudOptVolumeBehavior_TypeDefinitionIndex = 58035;
