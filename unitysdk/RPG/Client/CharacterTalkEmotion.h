...
#define RPG_CLIENT_CHARACTERTALKEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B929A90)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterTalkEmotion_TypeDefinitionIndex = 71092;
