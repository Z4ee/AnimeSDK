...
#define RPG_CLIENT_CHARACTERTALKEMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x930DF20)

namespace RPG::Client
{
	inline static constexpr unsigned int CharacterTalkEmotion_TypeDefinitionIndex = 58266;
