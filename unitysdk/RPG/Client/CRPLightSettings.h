...
#define RPG_CLIENT_CRPLIGHTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBD740)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPLightSettings_TypeDefinitionIndex = 64919;
