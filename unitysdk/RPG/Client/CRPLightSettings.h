...
#define RPG_CLIENT_CRPLIGHTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11DC00)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPLightSettings_TypeDefinitionIndex = 67926;
