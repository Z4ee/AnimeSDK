...
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_DEBUGPRINTSDFDATA_OFFSET UNITYSDK_OFFSET(0x1B235680)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_ALBEDO_OFFSET UNITYSDK_OFFSET(0x1B235550)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1B231EF0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_CARDBOUNDSEXPAND_OFFSET UNITYSDK_OFFSET(0x1B235640)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_CARDINFOTEXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B235600)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_CARDINFOTEXWIDTH_OFFSET UNITYSDK_OFFSET(0x1B2355F0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_CARDNORMALWEIGHTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B235620)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_DEBUGCARDINDEX_OFFSET UNITYSDK_OFFSET(0x1B235670)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_DEBUGDIRECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1B235660)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_DEBUGSINGLECARD_OFFSET UNITYSDK_OFFSET(0x1B235650)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B235470)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_MAXCARDSPERDIRECTION_OFFSET UNITYSDK_OFFSET(0x1B235610)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B2355A0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_MAXSTEPS_OFFSET UNITYSDK_OFFSET(0x1B235580)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_METALLIC_OFFSET UNITYSDK_OFFSET(0x1B235560)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_MINSTEP_OFFSET UNITYSDK_OFFSET(0x1B235590)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SDFATLASTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B235280)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SDFBOUNDSDATA_OFFSET UNITYSDK_OFFSET(0x1B235360)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SMOOTHNESS_OFFSET UNITYSDK_OFFSET(0x1B235570)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SURFACECARDATLAS_OFFSET UNITYSDK_OFFSET(0x1B2355E0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SURFACECARDBLEND_OFFSET UNITYSDK_OFFSET(0x1B235630)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SURFACECARDINFO_OFFSET UNITYSDK_OFFSET(0x1B2355D0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_SURFACETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B2355B0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_GET_USESURFACECARD_OFFSET UNITYSDK_OFFSET(0x1B2355C0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_REGENERATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B235710)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B2319D0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1B235480)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_SET_SDFATLASTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B235290)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_SET_SDFBOUNDSDATA_OFFSET UNITYSDK_OFFSET(0x1B235370)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN_SHOWSURFACECARDINFO_OFFSET UNITYSDK_OFFSET(0x1B2357A0)
#define RPG_CLIENT_MESHSDFRENDERERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B235830)
