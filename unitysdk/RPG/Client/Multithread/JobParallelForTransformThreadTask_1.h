...
{
	inline static constexpr unsigned int JobParallelForTransformThreadTask_1_TypeDefinitionIndex = 42192;
	...
	public:
		...
		::UnityEngine::Jobs::TransformAccessArray _TransformArray; // 0x0
		TaskData _data; // 0x0
