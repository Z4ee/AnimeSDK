...
#define RPG_CLIENT_ACTIVITYMARBLEUTILS___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB1B8330)
#define RPG_CLIENT_ACTIVITYMARBLEUTILS___C__DISPLAYCLASS21_0__OPENMARBLEMAINPAGE_B__0_OFFSET UNITYSDK_OFFSET(0xB1B8720)
#define RPG_CLIENT_ACTIVITYMARBLEUTILS___C__DISPLAYCLASS21_0__OPENMARBLEMAINPAGE_B__1_OFFSET UNITYSDK_OFFSET(0xB1B88B0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityMarbleUtils___c__DisplayClass21_0_TypeDefinitionIndex = 61511;
