...
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_BUILDTITLECACHE_OFFSET UNITYSDK_OFFSET(0x1747EE60)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_CREATE_OFFSET UNITYSDK_OFFSET(0x1747ECF0)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1747F760)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE_SEARCHBYNAME_OFFSET UNITYSDK_OFFSET(0x1747F850)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1747ED70)
#define RPG_CLIENT_ACHIEVEMENTSEARCHENGINE__ONTEXTLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x17480190)

namespace RPG::Client
{
	inline static constexpr unsigned int AchievementSearchEngine_TypeDefinitionIndex = 58625;
