...
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER_ISCONCERNEDWITH_OFFSET UNITYSDK_OFFSET(0x1AD5E550)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER_UPDATEAFTER_OFFSET UNITYSDK_OFFSET(0x1AD5E940)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER_UPDATEBEFORE_OFFSET UNITYSDK_OFFSET(0x1AD5E5A0)
#define RPG_CLIENT_GRIDFIGHTROLESHOP_CYRENESHOPSUMMARIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD5E9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightRoleShop_CyreneShopSUmmarizer_TypeDefinitionIndex = 62301;
