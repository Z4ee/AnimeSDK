...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING_INIT_OFFSET UNITYSDK_OFFSET(0x9CAD270)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CAD550)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CAD310)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9CAD5F0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CAD610)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPDIFFUSELIGHTING___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CAD620)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropDiffuseLighting_TypeDefinitionIndex = 57229;
