...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_INIT_OFFSET UNITYSDK_OFFSET(0x116B9BA0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_METHOD_6_4CC249C408196EA6_OFFSET UNITYSDK_OFFSET(0x116BA770)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_UNINIT_OFFSET UNITYSDK_OFFSET(0x116BA810)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x116B9C40)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x116BA860)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropPartsSelection_TypeDefinitionIndex = 69940;
