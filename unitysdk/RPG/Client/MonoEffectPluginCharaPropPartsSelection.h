...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_INIT_OFFSET UNITYSDK_OFFSET(0x9CBA570)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_METHOD_6_4CC249C408196EA6_OFFSET UNITYSDK_OFFSET(0x9CBB120)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CBB1C0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CBA610)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9CBB260)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x9CBB280)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPPARTSSELECTION___IFIXBASEPROXY_UNINIT_OFFSET UNITYSDK_OFFSET(0x9CBB290)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropPartsSelection_TypeDefinitionIndex = 57250;
