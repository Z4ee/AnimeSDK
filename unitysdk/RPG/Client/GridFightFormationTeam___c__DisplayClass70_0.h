...
#define RPG_CLIENT_GRIDFIGHTFORMATIONTEAM___C__DISPLAYCLASS70_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD19FAB0)
#define RPG_CLIENT_GRIDFIGHTFORMATIONTEAM___C__DISPLAYCLASS70_0___SYNCTEAM_B__0_OFFSET UNITYSDK_OFFSET(0xD1A1AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightFormationTeam___c__DisplayClass70_0_TypeDefinitionIndex = 64734;

	class GridFightFormationTeam___c__DisplayClass70_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::GridFightFormationRole*>* appendingRoles; // 0x10
