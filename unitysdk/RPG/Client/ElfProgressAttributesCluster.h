...
#define RPG_CLIENT_ELFPROGRESSATTRIBUTESCLUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E3D880)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfProgressAttributesCluster_TypeDefinitionIndex = 60926;
