...
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GETTARGETDESC_OFFSET UNITYSDK_OFFSET(0x198C0A30)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_CURPROGRESS_OFFSET UNITYSDK_OFFSET(0x198C0C20)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_GUIDEGROUPID_OFFSET UNITYSDK_OFFSET(0x198C0BD0)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_ISFINISHALL_OFFSET UNITYSDK_OFFSET(0x198C0C40)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_GET_OBJECTIVECOUNT_OFFSET UNITYSDK_OFFSET(0x198C0B80)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_REFRESH_OFFSET UNITYSDK_OFFSET(0x198C0AD0)
#define RPG_CLIENT_TRIALOBJECTIVEDATA_SET_CURPROGRESS_OFFSET UNITYSDK_OFFSET(0x198C0C30)
#define RPG_CLIENT_TRIALOBJECTIVEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198C0810)
#define RPG_CLIENT_TRIALOBJECTIVEDATA__INITDATA_OFFSET UNITYSDK_OFFSET(0x198C0860)

namespace RPG::Client
{
	inline static constexpr unsigned int TrialObjectiveData_TypeDefinitionIndex = 69087;

	class TrialObjectiveData : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::TextID>* _TargetDescList; // 0x10
		::RPG::GameCore::AvatarDemoConfigRow* _Row; // 0x18
