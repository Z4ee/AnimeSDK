...
#define RPG_CLIENT_CHIMERAENDLESSDATA_CLEARENDLESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xB6A1690)
#define RPG_CLIENT_CHIMERAENDLESSDATA_GET_CURRENTATK_OFFSET UNITYSDK_OFFSET(0xB6A17A0)
#define RPG_CLIENT_CHIMERAENDLESSDATA_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xB6A16E0)
#define RPG_CLIENT_CHIMERAENDLESSDATA_GET_ISDEAD_OFFSET UNITYSDK_OFFSET(0xB6A1860)
#define RPG_CLIENT_CHIMERAENDLESSDATA_SYNCENDLESSATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xB6A15B0)
#define RPG_CLIENT_CHIMERAENDLESSDATA_UPDATEAFTERBATTLEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0xB6A14E0)
#define RPG_CLIENT_CHIMERAENDLESSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB6A14D0)
#define RPG_CLIENT_CHIMERAENDLESSDATA___IFIXBASEPROXY_GET_CURRENTATK_OFFSET UNITYSDK_OFFSET(0xB6A18D0)
#define RPG_CLIENT_CHIMERAENDLESSDATA___IFIXBASEPROXY_GET_CURRENTHP_OFFSET UNITYSDK_OFFSET(0xB6A18C0)
#define RPG_CLIENT_CHIMERAENDLESSDATA___IFIXBASEPROXY_GET_ISDEAD_OFFSET UNITYSDK_OFFSET(0xB6A18E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraEndlessData_TypeDefinitionIndex = 59358;
	...
	public:
		...
		::System::Void SyncEndlessAttribute(::Class_1_2E81B539DAB8D165_1* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_2E81B539DAB8D165_1*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERAENDLESSDATA_SYNCENDLESSATTRIBUTE_OFFSET))(this, a1);
		}
