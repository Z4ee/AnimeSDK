...
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC9A460)
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xAC9A4B0)
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xAC9A4E0)

namespace RPG::Client
{
	inline static constexpr unsigned int PivotBasedFractureMonoPlugin_TypeDefinitionIndex = 65185;
