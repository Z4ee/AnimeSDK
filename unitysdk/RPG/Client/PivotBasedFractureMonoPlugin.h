...
class Class_3_23386931B18AB7BD;
namespace System { class String; }

#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9F746C0)
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9F74710)
#define RPG_CLIENT_PIVOTBASEDFRACTUREMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x9F74740)

namespace RPG::Client
{
	inline static constexpr unsigned int PivotBasedFractureMonoPlugin_TypeDefinitionIndex = 57898;

	class PivotBasedFractureMonoPlugin : public ::RPG::Client::TAMonoPlugin_1<::Class_3_23386931B18AB7BD*>
	{
	public:
