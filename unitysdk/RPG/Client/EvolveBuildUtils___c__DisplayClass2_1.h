...
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B888F90)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__SORTWEAPONLIST_B__1_OFFSET UNITYSDK_OFFSET(0x1B888FB0)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__SORTWEAPONLIST_B__2_OFFSET UNITYSDK_OFFSET(0x1B888FE0)

namespace RPG::Client
{
	inline static constexpr unsigned int EvolveBuildUtils___c__DisplayClass2_1_TypeDefinitionIndex = 63880;
