...
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__CTOR_OFFSET UNITYSDK_OFFSET(0xCEF5330)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__SORTWEAPONLIST_B__1_OFFSET UNITYSDK_OFFSET(0xCEF5350)
#define RPG_CLIENT_EVOLVEBUILDUTILS___C__DISPLAYCLASS2_1__SORTWEAPONLIST_B__2_OFFSET UNITYSDK_OFFSET(0xCEF5380)
