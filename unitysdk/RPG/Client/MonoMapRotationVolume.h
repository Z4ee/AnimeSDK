...
#define RPG_CLIENT_MONOMAPROTATIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x18C5F4A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMapRotationVolume_TypeDefinitionIndex = 65560;
