...
#define RPG_CLIENT_MONOMAPROTATIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1C340)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMapRotationVolume_TypeDefinitionIndex = 56029;
