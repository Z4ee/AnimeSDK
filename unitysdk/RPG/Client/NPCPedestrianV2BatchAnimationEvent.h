...
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC247480)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0xC2477C0)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT_METHOD_6_29C36F9051203275_OFFSET UNITYSDK_OFFSET(0xC2478F0)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT_METHOD_6_6ED8899C7D879331_OFFSET UNITYSDK_OFFSET(0xC247870)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC247A20)
#define RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT___IFIXBASEPROXY_GETEVENTEXECUTORFUN_OFFSET UNITYSDK_OFFSET(0xC247A60)

namespace RPG::Client
{
	inline static constexpr unsigned int NPCPedestrianV2BatchAnimationEvent_TypeDefinitionIndex = 64777;
	...
	public:
		...
		::UnityEngine::Rendering::BatchAnimEventObjCB_ExecuteEventFun* __iFixBaseProxy_GetEventExecutorFun(::System::String* a1)
		{
			return ((::UnityEngine::Rendering::BatchAnimEventObjCB_ExecuteEventFun*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_NPCPEDESTRIANV2BATCHANIMATIONEVENT___IFIXBASEPROXY_GETEVENTEXECUTORFUN_OFFSET))(this, a1);
		}
	};
}
