...
#define RPG_CLIENT_BATTLEPASSUTILS_GETREWARDREDDOTKEY_OFFSET UNITYSDK_OFFSET(0x174C0F30)
#define RPG_CLIENT_BATTLEPASSUTILS_HASNEWACTIVITYQUEST_OFFSET UNITYSDK_OFFSET(0x174C9840)
#define RPG_CLIENT_BATTLEPASSUTILS_ISPURCHASESEEN_OFFSET UNITYSDK_OFFSET(0x174C9AC0)
#define RPG_CLIENT_BATTLEPASSUTILS_RECORDPURCHASESEEN_OFFSET UNITYSDK_OFFSET(0x174C9CA0)
#define RPG_CLIENT_BATTLEPASSUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x174C9E10)

namespace RPG::Client
{
	inline static constexpr unsigned int BattlePassUtils_TypeDefinitionIndex = 60118;
