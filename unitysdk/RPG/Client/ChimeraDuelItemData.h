...
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EFFECTDATA_OFFSET UNITYSDK_OFFSET(0xA016DC0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EFFECTID_OFFSET UNITYSDK_OFFSET(0xA016D70)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTATTACK_OFFSET UNITYSDK_OFFSET(0xA017360)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTHEALTH_OFFSET UNITYSDK_OFFSET(0xA017430)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTICON_OFFSET UNITYSDK_OFFSET(0xA017340)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xA016C20)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_ISMULTITARGET_OFFSET UNITYSDK_OFFSET(0xA016EB0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA016C70)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_PRICE_OFFSET UNITYSDK_OFFSET(0xA016CC0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0xA016CE0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SHOPICON_OFFSET UNITYSDK_OFFSET(0xA017320)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SKILLDATA_OFFSET UNITYSDK_OFFSET(0xA016F80)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0xA016D20)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xA016CA0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_VENDOR_OFFSET UNITYSDK_OFFSET(0xA016D00)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA016C10)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xA017500)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0xA017870)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0xA017750)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0xA017990)
#define RPG_CLIENT_CHIMERADUELITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA017580)
#define RPG_CLIENT_CHIMERADUELITEMDATA__TRYGETFIRSTSKILLDATA_OFFSET UNITYSDK_OFFSET(0xA0175C0)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelItemData_TypeDefinitionIndex = 58372;
