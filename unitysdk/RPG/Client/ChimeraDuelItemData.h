...
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EFFECTDATA_OFFSET UNITYSDK_OFFSET(0x1B5E0E40)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EFFECTID_OFFSET UNITYSDK_OFFSET(0x1B5E0DF0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTATTACK_OFFSET UNITYSDK_OFFSET(0x1B5E13B0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTHEALTH_OFFSET UNITYSDK_OFFSET(0x1B5E1480)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_EQUIPMENTICON_OFFSET UNITYSDK_OFFSET(0x1B5E1360)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B5E0BA0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_ISMULTITARGET_OFFSET UNITYSDK_OFFSET(0x1B5E0EF0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B5E0BF0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_PRICE_OFFSET UNITYSDK_OFFSET(0x1B5E0CB0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_RARITY_OFFSET UNITYSDK_OFFSET(0x1B5E0D00)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SHOPICON_OFFSET UNITYSDK_OFFSET(0x1B5E1310)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SKILLDATA_OFFSET UNITYSDK_OFFSET(0x1B5E0FC0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_SKILLIDS_OFFSET UNITYSDK_OFFSET(0x1B5E0DA0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B5E0C60)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET_VENDOR_OFFSET UNITYSDK_OFFSET(0x1B5E0D50)
#define RPG_CLIENT_CHIMERADUELITEMDATA_GET__ROW_OFFSET UNITYSDK_OFFSET(0x1B5E0B90)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1B5E1550)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETBATTLESKILLDATA_OFFSET UNITYSDK_OFFSET(0x1B5E1930)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETSHOPSKILLDATA_OFFSET UNITYSDK_OFFSET(0x1B5E17E0)
#define RPG_CLIENT_CHIMERADUELITEMDATA_TRYGETSKILLDATAFORDISPLAY_OFFSET UNITYSDK_OFFSET(0x1B5E1A80)
#define RPG_CLIENT_CHIMERADUELITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E15D0)
#define RPG_CLIENT_CHIMERADUELITEMDATA__TRYGETFIRSTSKILLDATA_OFFSET UNITYSDK_OFFSET(0x1B5E1610)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelItemData_TypeDefinitionIndex = 63426;

	class ChimeraDuelItemData : public ::System::Object
	{
	public:
		::Il2CppArray<::RPG::Client::IChimeraDuelSkillData*>* _SkillData; // 0x10
		::RPG::GameCore::ChimeraDuelItemRow* __Row_k__BackingField; // 0x18

		::System::Void _ctor(::System::UInt32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERADUELITEMDATA__CTOR_OFFSET))(this, a1);
		}
		...
		static ::RPG::Client::ChimeraDuelItemData* TryCreate(::System::UInt32 a1)
		{
			return ((::RPG::Client::ChimeraDuelItemData*(*)(::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERADUELITEMDATA_TRYCREATE_OFFSET))(a1);
		}

		::RPG::Client::IChimeraDuelSkillData* _TryGetFirstSkillData(::System::Predicate_1<::RPG::Client::IChimeraDuelSkillData*>* a1)
		{
			return ((::RPG::Client::IChimeraDuelSkillData*(*)(::PVOID, ::System::Predicate_1<::RPG::Client::IChimeraDuelSkillData*>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHIMERADUELITEMDATA__TRYGETFIRSTSKILLDATA_OFFSET))(this, a1);
		}
