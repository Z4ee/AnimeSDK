...
#define RPG_CLIENT_MESHPARTIDMASK_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9B8C570)
#define RPG_CLIENT_MESHPARTIDMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x9B8C620)

namespace RPG::Client
{
	inline static constexpr unsigned int MeshPartIDMask_TypeDefinitionIndex = 57042;
