...
#define RPG_CLIENT_MATERIALGROUPASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xA86B140)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialGroupAsset_TypeDefinitionIndex = 64377;
