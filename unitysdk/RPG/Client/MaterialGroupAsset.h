...
#define RPG_CLIENT_MATERIALGROUPASSET__CTOR_OFFSET UNITYSDK_OFFSET(0xBFB5C70)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialGroupAsset_TypeDefinitionIndex = 65298;
