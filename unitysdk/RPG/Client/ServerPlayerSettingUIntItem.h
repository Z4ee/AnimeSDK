...
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_GET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0x19F40AB0)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SETVALUEFROMSERVER_OFFSET UNITYSDK_OFFSET(0x19F408B0)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0x19F40AC0)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SYNCCLIENTPREF_OFFSET UNITYSDK_OFFSET(0x19F40A40)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19F40AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int ServerPlayerSettingUIntItem_TypeDefinitionIndex = 63747;
