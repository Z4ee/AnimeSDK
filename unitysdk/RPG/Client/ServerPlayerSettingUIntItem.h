...
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_GET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0x1AF79920)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SETVALUEFROMSERVER_OFFSET UNITYSDK_OFFSET(0x1AF79720)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0x1AF79930)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SYNCCLIENTPREF_OFFSET UNITYSDK_OFFSET(0x1AF798B0)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF79940)
