...
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_GET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0xC8B6960)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SETVALUEFROMSERVER_OFFSET UNITYSDK_OFFSET(0xC8B67D0)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SET_CLIENTPREFSETTER_OFFSET UNITYSDK_OFFSET(0xC8B6970)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM_SYNCCLIENTPREF_OFFSET UNITYSDK_OFFSET(0xC8B68F0)
#define RPG_CLIENT_SERVERPLAYERSETTINGUINTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B6980)

namespace RPG::Client
{
	inline static constexpr unsigned int ServerPlayerSettingUIntItem_TypeDefinitionIndex = 62381;
