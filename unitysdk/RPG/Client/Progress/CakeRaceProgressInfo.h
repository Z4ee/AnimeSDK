...
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_CALCULATEALLQUESTSPROGRESSPERCENT_OFFSET UNITYSDK_OFFSET(0xC4B9220)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4B94B0)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_GETQUESTDONECOUNT_OFFSET UNITYSDK_OFFSET(0xC4B8F30)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_GETQUESTTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xC4B9040)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_GET_RESIDENTQUESTIDS_OFFSET UNITYSDK_OFFSET(0xC4B89C0)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_HASFINISHEDQUESTS_OFFSET UNITYSDK_OFFSET(0xC4B9120)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_INIT_OFFSET UNITYSDK_OFFSET(0xC4B89D0)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_SYNCQUESTDATA_OFFSET UNITYSDK_OFFSET(0xC4B8C30)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_TRYGETCURRENTPROGRESSID_OFFSET UNITYSDK_OFFSET(0xC4B8E30)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO_TRYGETPROGRESSPERCENTWITHQUESTID_OFFSET UNITYSDK_OFFSET(0xC4B9420)
#define RPG_CLIENT_PROGRESS_CAKERACEPROGRESSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B95B0)

namespace RPG::Client::Progress
{
	inline static constexpr unsigned int CakeRaceProgressInfo_TypeDefinitionIndex = 69848;
	...
	public:
		...
		::Il2CppArray<::System::UInt32>* _ResidentQuestIDs; // 0x18
