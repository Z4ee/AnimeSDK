...
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xD879EB0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xD879BA0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_PLAYATCURPOS_OFFSET UNITYSDK_OFFSET(0xD879DF0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0xD879CB0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0xD879850)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0xD879EC0)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__GETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0xD879C00)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__PLAY_OFFSET UNITYSDK_OFFSET(0xD879D90)
#define RPG_CLIENT_MONOUIANCHOREDMOVEANIMATION__STOP_OFFSET UNITYSDK_OFFSET(0xD879B30)
