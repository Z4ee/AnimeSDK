...
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA_GET_ORBUID_OFFSET UNITYSDK_OFFSET(0x1AE8A5D0)
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA_SETORBUID_OFFSET UNITYSDK_OFFSET(0x1AE8A580)
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA_SET_ORBUID_OFFSET UNITYSDK_OFFSET(0x1AE8A5E0)
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE8A5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightOrbResultData_TypeDefinitionIndex = 61516;
