...
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA_GET_ORBUID_OFFSET UNITYSDK_OFFSET(0x9874A20)
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA_SETORBUID_OFFSET UNITYSDK_OFFSET(0x98749D0)
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA_SET_ORBUID_OFFSET UNITYSDK_OFFSET(0x9874A30)
#define RPG_CLIENT_GRIDFIGHTORBRESULTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9874A40)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightOrbResultData_TypeDefinitionIndex = 52339;
