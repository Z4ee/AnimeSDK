...
#define RPG_CLIENT_DEVACCOUNTMODEL_ISACCOUNTUIDVALID_OFFSET UNITYSDK_OFFSET(0x18094D10)
#define RPG_CLIENT_DEVACCOUNTMODEL_ISUIDVALID_OFFSET UNITYSDK_OFFSET(0x18094CC0)
#define RPG_CLIENT_DEVACCOUNTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18094CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevAccountModel_TypeDefinitionIndex = 58344;
