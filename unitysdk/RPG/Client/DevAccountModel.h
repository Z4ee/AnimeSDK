...
#define RPG_CLIENT_DEVACCOUNTMODEL_ISACCOUNTUIDVALID_OFFSET UNITYSDK_OFFSET(0xA0F9930)
#define RPG_CLIENT_DEVACCOUNTMODEL_ISUIDVALID_OFFSET UNITYSDK_OFFSET(0xA0F98E0)
#define RPG_CLIENT_DEVACCOUNTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA0F98C0)

namespace RPG::Client
{
	inline static constexpr unsigned int DevAccountModel_TypeDefinitionIndex = 56324;
