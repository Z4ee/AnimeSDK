...
#define RPG_CLIENT_UILAYERCONTROLLER_GET_BASELAYER_OFFSET UNITYSDK_OFFSET(0xA696670)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_64501B5CB67A94C3_OFFSET UNITYSDK_OFFSET(0xA6963A0)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_D7BDEB5B8A3A7B6E_OFFSET UNITYSDK_OFFSET(0xA6965C0)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_D97779B750ED0BB2_OFFSET UNITYSDK_OFFSET(0xA6964F0)
#define RPG_CLIENT_UILAYERCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xA6964A0)
#define RPG_CLIENT_UILAYERCONTROLLER_SET_BASELAYER_OFFSET UNITYSDK_OFFSET(0xA696680)
#define RPG_CLIENT_UILAYERCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xA696350)
#define RPG_CLIENT_UILAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA6966D0)

namespace RPG::Client
{
	inline static constexpr unsigned int UILayerController_TypeDefinitionIndex = 59883;
