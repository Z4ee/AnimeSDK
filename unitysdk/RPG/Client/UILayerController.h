...
#define RPG_CLIENT_UILAYERCONTROLLER_GET_BASELAYER_OFFSET UNITYSDK_OFFSET(0x17022A50)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_800DF0C3AC70E80C_OFFSET UNITYSDK_OFFSET(0x17022960)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0x17022690)
#define RPG_CLIENT_UILAYERCONTROLLER_METHOD_5_9D031EBD3A927318_OFFSET UNITYSDK_OFFSET(0x17022800)
#define RPG_CLIENT_UILAYERCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x170227B0)
#define RPG_CLIENT_UILAYERCONTROLLER_SET_BASELAYER_OFFSET UNITYSDK_OFFSET(0x17022A90)
#define RPG_CLIENT_UILAYERCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x17022640)
#define RPG_CLIENT_UILAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17022AE0)

namespace RPG::Client
{
	inline static constexpr unsigned int UILayerController_TypeDefinitionIndex = 72977;
