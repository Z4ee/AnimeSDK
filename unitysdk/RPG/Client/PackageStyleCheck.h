...
#define RPG_CLIENT_PACKAGESTYLECHECK_CHECKISVIETNAMPACKAGE_OFFSET UNITYSDK_OFFSET(0x1C4D1DD0)

namespace RPG::Client
{
	inline static constexpr unsigned int PackageStyleCheck_TypeDefinitionIndex = 61178;
