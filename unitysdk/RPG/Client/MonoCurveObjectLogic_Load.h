...
#define RPG_CLIENT_MONOCURVEOBJECTLOGIC_LOAD_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x9C1F010)
#define RPG_CLIENT_MONOCURVEOBJECTLOGIC_LOAD_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x9C1EF10)
#define RPG_CLIENT_MONOCURVEOBJECTLOGIC_LOAD_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x9C24250)
#define RPG_CLIENT_MONOCURVEOBJECTLOGIC_LOAD_METHOD_1_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x9C242B0)
#define RPG_CLIENT_MONOCURVEOBJECTLOGIC_LOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x9C1F090)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveObjectLogic_Load_TypeDefinitionIndex = 55961;
