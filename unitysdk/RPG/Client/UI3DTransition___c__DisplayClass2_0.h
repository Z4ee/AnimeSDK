...
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE3280F0)
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS2_0__EXECUTEEXIT_B__0_OFFSET UNITYSDK_OFFSET(0xE3291C0)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DTransition___c__DisplayClass2_0_TypeDefinitionIndex = 72927;

	class UI3DTransition___c__DisplayClass2_0 : public ::System::Object
	{
	public:
		::RPG::Client::IUI3DController* to3d; // 0x10
		::RPG::Client::UIController* to2d; // 0x18
