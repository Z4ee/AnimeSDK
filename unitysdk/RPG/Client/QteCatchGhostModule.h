...
#define RPG_CLIENT_QTECATCHGHOSTMODULE_AUTOFINISH_OFFSET UNITYSDK_OFFSET(0xC672730)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xC672780)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_REGISTERINSTANCE_OFFSET UNITYSDK_OFFSET(0xC6725E0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_UNREGISTERINSTANCE_OFFSET UNITYSDK_OFFSET(0xC6726A0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xC6724A0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC6727E0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__ONADVENTUREPHASEEND_OFFSET UNITYSDK_OFFSET(0xC672540)
#define RPG_CLIENT_QTECATCHGHOSTMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xC672870)

namespace RPG::Client
{
	inline static constexpr unsigned int QteCatchGhostModule_TypeDefinitionIndex = 56326;
