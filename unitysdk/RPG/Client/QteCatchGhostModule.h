...
#define RPG_CLIENT_QTECATCHGHOSTMODULE_AUTOFINISH_OFFSET UNITYSDK_OFFSET(0xAF2CD40)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xAF2CD90)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_REGISTERINSTANCE_OFFSET UNITYSDK_OFFSET(0xAF2CC20)
#define RPG_CLIENT_QTECATCHGHOSTMODULE_UNREGISTERINSTANCE_OFFSET UNITYSDK_OFFSET(0xAF2CCE0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xAF2CB00)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xAF2CDF0)
#define RPG_CLIENT_QTECATCHGHOSTMODULE__ONADVENTUREPHASEEND_OFFSET UNITYSDK_OFFSET(0xAF2CB70)
#define RPG_CLIENT_QTECATCHGHOSTMODULE___IFIXBASEPROXY__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xAF2CE80)

namespace RPG::Client
{
	inline static constexpr unsigned int QteCatchGhostModule_TypeDefinitionIndex = 55575;
