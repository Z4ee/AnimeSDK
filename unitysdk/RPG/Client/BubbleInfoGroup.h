...
#define RPG_CLIENT_BUBBLEINFOGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0x920F010)
#define RPG_CLIENT_BUBBLEINFOGROUP_GETBUBBLEINFOPROVIDERLIST_OFFSET UNITYSDK_OFFSET(0x920F080)
#define RPG_CLIENT_BUBBLEINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x920F070)

namespace RPG::Client
{
	inline static constexpr unsigned int BubbleInfoGroup_TypeDefinitionIndex = 51089;
