...
#define RPG_CLIENT_BUBBLEINFOGROUP_CREATE_OFFSET UNITYSDK_OFFSET(0x18CBA430)
#define RPG_CLIENT_BUBBLEINFOGROUP_GETBUBBLEINFOPROVIDERLIST_OFFSET UNITYSDK_OFFSET(0x18CBA4A0)
#define RPG_CLIENT_BUBBLEINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBA490)

namespace RPG::Client
{
	inline static constexpr unsigned int BubbleInfoGroup_TypeDefinitionIndex = 60161;
