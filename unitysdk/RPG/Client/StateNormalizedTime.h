...
#define RPG_CLIENT_STATENORMALIZEDTIME_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A500CC0)
#define RPG_CLIENT_STATENORMALIZEDTIME_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A500BA0)
#define RPG_CLIENT_STATENORMALIZEDTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A500D70)

namespace RPG::Client
{
	inline static constexpr unsigned int StateNormalizedTime_TypeDefinitionIndex = 68797;
