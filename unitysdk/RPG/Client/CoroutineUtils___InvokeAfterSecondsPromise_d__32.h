...
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSPROMISE_D__32_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ACA26B0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSPROMISE_D__32_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA2740)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSPROMISE_D__32_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ACA27A0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSPROMISE_D__32_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ACA2750)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSPROMISE_D__32_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACA26A0)
#define RPG_CLIENT_COROUTINEUTILS___INVOKEAFTERSECONDSPROMISE_D__32__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA2010)

namespace RPG::Client
{
	inline static constexpr unsigned int CoroutineUtils___InvokeAfterSecondsPromise_d__32_TypeDefinitionIndex = 33802;
