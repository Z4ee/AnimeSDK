...
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_GET_SINGLETONINSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xD596D20)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_GET_TOWERDIRECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xD596D00)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_1FDE3BA9363A99B1_1_OFFSET UNITYSDK_OFFSET(0xD594B10)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_1FDE3BA9363A99B1_OFFSET UNITYSDK_OFFSET(0xD5949F0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0xD594A60)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_D324BB8C61889D31_OFFSET UNITYSDK_OFFSET(0xD594190)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_SET_SINGLETONINSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xD596D30)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_SET_TOWERDIRECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xD596D10)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xD5956D0)
