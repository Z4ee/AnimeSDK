...
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_GET_SINGLETONINSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xBE856D0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_GET_TOWERDIRECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xBE856B0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_1FDE3BA9363A99B1_1_OFFSET UNITYSDK_OFFSET(0xBE834A0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_1FDE3BA9363A99B1_OFFSET UNITYSDK_OFFSET(0xBE833C0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBE83430)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_METHOD_1_D324BB8C61889D31_OFFSET UNITYSDK_OFFSET(0xBE82B60)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_SET_SINGLETONINSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xBE856E0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE_SET_TOWERDIRECTIONTYPE_OFFSET UNITYSDK_OFFSET(0xBE856C0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_LOOPTOWERSLIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xBE84060)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopTowerAnimBehavior_LoopTowerSlide_TypeDefinitionIndex = 66300;
