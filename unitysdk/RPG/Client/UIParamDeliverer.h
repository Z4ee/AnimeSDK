...
#define RPG_CLIENT_UIPARAMDELIVERER_HASKEY_OFFSET UNITYSDK_OFFSET(0x182FF660)
#define RPG_CLIENT_UIPARAMDELIVERER_TRYGETFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x182FF980)
#define RPG_CLIENT_UIPARAMDELIVERER_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x182FF7F0)
#define RPG_CLIENT_UIPARAMDELIVERER__CTOR_OFFSET UNITYSDK_OFFSET(0x182FFA00)

namespace RPG::Client
{
	inline static constexpr unsigned int UIParamDeliverer_TypeDefinitionIndex = 66035;
