...
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0xD7D5910)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CANOVERRIDEBLENDSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0xD7D4770)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CONSUMEBLENDSHAPEVALUEMAP_OFFSET UNITYSDK_OFFSET(0xD7D3D40)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLEAUTOBLINK_OFFSET UNITYSDK_OFFSET(0xD7D3D20)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0xD7D3CC0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0xD7D3D30)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_LOCKEYE_OFFSET UNITYSDK_OFFSET(0xD7D3E90)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_0860F812E446AE7C_OFFSET UNITYSDK_OFFSET(0xD7D5720)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0xD7D4380)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xD7D5890)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_POPDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0xD7D4620)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_PUSHDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0xD7D4570)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_RESET_OFFSET UNITYSDK_OFFSET(0xD7D5B40)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETAUTOBLINKENABLED_OFFSET UNITYSDK_OFFSET(0xD7D4260)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETUPEYEMONO_OFFSET UNITYSDK_OFFSET(0xD7D4020)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_TICK_OFFSET UNITYSDK_OFFSET(0xD7D4950)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xD7D5BE0)
