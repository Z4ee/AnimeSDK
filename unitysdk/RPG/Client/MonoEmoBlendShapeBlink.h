...
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B3A2C10)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CANOVERRIDEBLENDSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0x1B3A1A70)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CONSUMEBLENDSHAPEVALUEMAP_OFFSET UNITYSDK_OFFSET(0x1B3A1040)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLEAUTOBLINK_OFFSET UNITYSDK_OFFSET(0x1B3A1020)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B3A0FC0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1B3A1030)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_LOCKEYE_OFFSET UNITYSDK_OFFSET(0x1B3A1190)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_0860F812E446AE7C_OFFSET UNITYSDK_OFFSET(0x1B3A2A20)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_B43C848B078B3C34_OFFSET UNITYSDK_OFFSET(0x1B3A1680)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x1B3A2B90)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_POPDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0x1B3A1920)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_PUSHDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0x1B3A1870)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_RESET_OFFSET UNITYSDK_OFFSET(0x1B3A2E40)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETAUTOBLINKENABLED_OFFSET UNITYSDK_OFFSET(0x1B3A1560)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETUPEYEMONO_OFFSET UNITYSDK_OFFSET(0x1B3A1320)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_TICK_OFFSET UNITYSDK_OFFSET(0x1B3A1C50)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3A2EE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoBlendShapeBlink_TypeDefinitionIndex = 71113;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* PHCIBEPEPJD; // 0x50
		::System::Single KJLHNBJMPDC; // 0x58
		::Il2CppArray<::System::Single>* HKLHNLMINFB; // 0x60
		::Il2CppArray<::System::Single>* NBKFMDAOAEI; // 0x68
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* LMHPLPAHNME; // 0x70
		::System::Single ONCKGMAEFLO; // 0x78
		::RPG::Client::MonoEmoNpcEyeController* IDHBFDOAIPB; // 0x80
		::System::Collections::Generic::List_1<::RPG::Client::MonoEmoBlendShapeBlink_Class_1_C4D7FDF22DDB24EA*>* NNCFCKNNHBF; // 0x88
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_B43C848B078B3C34_OFFSET))(this);
		}

		::System::Void Method_5_0860F812E446AE7C()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_0860F812E446AE7C_OFFSET))(this);
		}
