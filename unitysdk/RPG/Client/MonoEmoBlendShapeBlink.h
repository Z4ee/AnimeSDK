...
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_AWAKE_OFFSET UNITYSDK_OFFSET(0x9CEA500)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CANOVERRIDEBLENDSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0x9CE92D0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_CONSUMEBLENDSHAPEVALUEMAP_OFFSET UNITYSDK_OFFSET(0x9CE8880)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLEAUTOBLINK_OFFSET UNITYSDK_OFFSET(0x9CE8860)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9CE8800)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x9CE8870)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_LOCKEYE_OFFSET UNITYSDK_OFFSET(0x9CE8A20)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_11D5322717FDFD9D_OFFSET UNITYSDK_OFFSET(0x9CEA320)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x9CE8E80)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_METHOD_5_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x9CEA480)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_POPDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0x9CE9180)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_PUSHDISABLEBLINKREASON_OFFSET UNITYSDK_OFFSET(0x9CE90F0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_RESET_OFFSET UNITYSDK_OFFSET(0x9CEA760)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETAUTOBLINKENABLED_OFFSET UNITYSDK_OFFSET(0x9CE8D60)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_SETUPEYEMONO_OFFSET UNITYSDK_OFFSET(0x9CE8BB0)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK_TICK_OFFSET UNITYSDK_OFFSET(0x9CE9510)
#define RPG_CLIENT_MONOEMOBLENDSHAPEBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x9CEA810)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoBlendShapeBlink_TypeDefinitionIndex = 58283;
