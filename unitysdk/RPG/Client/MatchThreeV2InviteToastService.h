...
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_ACQUIRE_OFFSET UNITYSDK_OFFSET(0x1C998350)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C9986D0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__CANSHOW_OFFSET UNITYSDK_OFFSET(0x1C997B10)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1C997BB0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__ISSHOWING_OFFSET UNITYSDK_OFFSET(0x1C997C10)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1C998530)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SETCANSHOW_OFFSET UNITYSDK_OFFSET(0x1C9987D0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SETDISABLED_OFFSET UNITYSDK_OFFSET(0x1C998C30)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SET__CANSHOW_OFFSET UNITYSDK_OFFSET(0x1C997B60)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C997C60)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ISRELEVANTPLAYTYPEBYSEASON_OFFSET UNITYSDK_OFFSET(0x1C999110)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ISVALIDINVITATION_OFFSET UNITYSDK_OFFSET(0x1C998C80)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1C998FC0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONRECEIVECONTACT_OFFSET UNITYSDK_OFFSET(0x1C998DF0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONTOASTDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0x1C998F20)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__TRYPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x1C998900)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__TRYSTOPCURRENT_OFFSET UNITYSDK_OFFSET(0x1C998BD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeV2InviteToastService_TypeDefinitionIndex = 66084;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* _StartReasonSet; // 0x18
		::System::Collections::Generic::HashSet_1<::System::String*>* _ManuallySetCanShowOnFocus; // 0x20
		::RPG::Client::LuaUIController* _CurrentDialog; // 0x28
		::System::Collections::Generic::Queue_1<::RPG::Client::ChatMessageData*>* _PendingInvitations; // 0x30
