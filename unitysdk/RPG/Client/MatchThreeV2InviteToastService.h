...
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_ACQUIRE_OFFSET UNITYSDK_OFFSET(0xD65F600)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_CLEAR_OFFSET UNITYSDK_OFFSET(0xD65F980)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__CANSHOW_OFFSET UNITYSDK_OFFSET(0xD65EDC0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__ISACTIVE_OFFSET UNITYSDK_OFFSET(0xD65EE60)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_GET__ISSHOWING_OFFSET UNITYSDK_OFFSET(0xD65EEC0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_RELEASE_OFFSET UNITYSDK_OFFSET(0xD65F7E0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SETCANSHOW_OFFSET UNITYSDK_OFFSET(0xD65FA80)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SETDISABLED_OFFSET UNITYSDK_OFFSET(0xD65FEF0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE_SET__CANSHOW_OFFSET UNITYSDK_OFFSET(0xD65EE10)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xD65EF10)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ISRELEVANTPLAYTYPEBYSEASON_OFFSET UNITYSDK_OFFSET(0xD6603D0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ISVALIDINVITATION_OFFSET UNITYSDK_OFFSET(0xD65FF40)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0xD660280)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONRECEIVECONTACT_OFFSET UNITYSDK_OFFSET(0xD6600B0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__ONTOASTDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xD6601E0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__TRYPLAYNEXT_OFFSET UNITYSDK_OFFSET(0xD65FBB0)
#define RPG_CLIENT_MATCHTHREEV2INVITETOASTSERVICE__TRYSTOPCURRENT_OFFSET UNITYSDK_OFFSET(0xD65FE90)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::System::String*>* _StartReasonSet; // 0x28
