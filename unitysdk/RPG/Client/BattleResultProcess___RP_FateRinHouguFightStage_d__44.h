...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINHOUGUFIGHTSTAGE_D__44_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FBA6F0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINHOUGUFIGHTSTAGE_D__44_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBABE0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINHOUGUFIGHTSTAGE_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FBAC40)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINHOUGUFIGHTSTAGE_D__44_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FBABF0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINHOUGUFIGHTSTAGE_D__44_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FBA6E0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_FATERINHOUGUFIGHTSTAGE_D__44__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB6390)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_FateRinHouguFightStage_d__44_TypeDefinitionIndex = 58280;
