...
#define RPG_CLIENT_UIPAGETURNMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA722620)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPageTurnMonoPlugin_TypeDefinitionIndex = 58202;
