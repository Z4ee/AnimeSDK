...
#define RPG_CLIENT_UIPAGETURNMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB426C90)

namespace RPG::Client
{
	inline static constexpr unsigned int UIPageTurnMonoPlugin_TypeDefinitionIndex = 65489;
