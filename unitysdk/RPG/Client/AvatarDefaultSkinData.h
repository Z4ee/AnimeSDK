...
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATEBYADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xB35DB90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0xB35DB30)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xB35DA80)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ACTIONAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB35E480)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVDEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB35EE80)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVENTUREPLAYERROW_OFFSET UNITYSDK_OFFSET(0xB35DE20)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVPLAYERPREFABPATH_OFFSET UNITYSDK_OFFSET(0xB35EE10)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AUDIOEVENTTAG_OFFSET UNITYSDK_OFFSET(0xB35F380)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINBGIMGPATH_OFFSET UNITYSDK_OFFSET(0xB35EA20)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINFRONTIMGPATH_OFFSET UNITYSDK_OFFSET(0xB35EB10)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINIMGPATH_OFFSET UNITYSDK_OFFSET(0xB35E930)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTININTROTEXT_OFFSET UNITYSDK_OFFSET(0xB35ECF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARDROPOFFSET_OFFSET UNITYSDK_OFFSET(0xB35EC00)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xB35DC90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARMINIICONPATH_OFFSET UNITYSDK_OFFSET(0xB35E390)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0xB35F260)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0xB35DC50)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSELFSHOWOFFSET_OFFSET UNITYSDK_OFFSET(0xB35F130)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0xB35E2A0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSKINNAME_OFFSET UNITYSDK_OFFSET(0xB35DFC0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_CHARACTERSKINOVERRIDECONFIGPATH_OFFSET UNITYSDK_OFFSET(0xB35F370)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB35E1B0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0xB35E0C0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0xB35EFE0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSICONPATH_OFFSET UNITYSDK_OFFSET(0xB35F390)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0xB35DD70)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_FREESTYLECHARACTERID_OFFSET UNITYSDK_OFFSET(0xB35EE00)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_MANIKINJSONPATH_OFFSET UNITYSDK_OFFSET(0xB35EEF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xB35DC70)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_PLAYERCARDID_OFFSET UNITYSDK_OFFSET(0xB35EDF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB35E750)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINDESC_OFFSET UNITYSDK_OFFSET(0xB35F220)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINITEMAVATARICONPATH_OFFSET UNITYSDK_OFFSET(0xB35EFF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINTYPE_OFFSET UNITYSDK_OFFSET(0xB35F360)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_UIAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0xB35E660)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ULTRASKILLCUTINPREFABPATH_OFFSET UNITYSDK_OFFSET(0xB35E570)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB35E840)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_MAPTOSKINRES_OFFSET UNITYSDK_OFFSET(0xB35F3A0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0xB35DC60)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0xB35DC80)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB35DB20)
