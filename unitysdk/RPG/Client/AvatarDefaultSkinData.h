...
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATEBYADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x1811F070)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1811F010)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1811EF60)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ACTIONAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1811FB30)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVDEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x18120820)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVENTUREPLAYERROW_OFFSET UNITYSDK_OFFSET(0x1811F3D0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ADVPLAYERPREFABPATH_OFFSET UNITYSDK_OFFSET(0x181207B0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AUDIOEVENTTAG_OFFSET UNITYSDK_OFFSET(0x18120F70)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINBGIMGPATH_OFFSET UNITYSDK_OFFSET(0x18120250)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINFRONTIMGPATH_OFFSET UNITYSDK_OFFSET(0x18120380)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTINIMGPATH_OFFSET UNITYSDK_OFFSET(0x18120120)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARCUTININTROTEXT_OFFSET UNITYSDK_OFFSET(0x181205E0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARDROPOFFSET_OFFSET UNITYSDK_OFFSET(0x181204B0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1811F170)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARMINIICONPATH_OFFSET UNITYSDK_OFFSET(0x1811FA00)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARNAME_OFFSET UNITYSDK_OFFSET(0x18120D80)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0x1811F130)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSELFSHOWOFFSET_OFFSET UNITYSDK_OFFSET(0x18120BE0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0x1811F8D0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_AVATARSKINNAME_OFFSET UNITYSDK_OFFSET(0x1811F520)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_CHARACTERSKINOVERRIDECONFIGPATH_OFFSET UNITYSDK_OFFSET(0x18120F20)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1811F7A0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DEFAULTAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0x1811F670)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSEDSKINID_OFFSET UNITYSDK_OFFSET(0x181209C0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_DRESSICONPATH_OFFSET UNITYSDK_OFFSET(0x18120FC0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ENHANCEDID_OFFSET UNITYSDK_OFFSET(0x1811F2A0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_FREESTYLECHARACTERID_OFFSET UNITYSDK_OFFSET(0x18120770)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_MANIKINJSONPATH_OFFSET UNITYSDK_OFFSET(0x18120890)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x1811F150)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_PLAYERCARDID_OFFSET UNITYSDK_OFFSET(0x18120730)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1811FEC0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINDESC_OFFSET UNITYSDK_OFFSET(0x18120D10)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINITEMAVATARICONPATH_OFFSET UNITYSDK_OFFSET(0x18120A00)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_SKINTYPE_OFFSET UNITYSDK_OFFSET(0x18120ED0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_UIAVATARMODELPATH_OFFSET UNITYSDK_OFFSET(0x1811FD90)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_ULTRASKILLCUTINPREFABPATH_OFFSET UNITYSDK_OFFSET(0x1811FC60)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0x1811FFF0)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_MAPTOSKINRES_OFFSET UNITYSDK_OFFSET(0x18121010)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_AVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0x1811F140)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA_SET_OVERRIDEADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x1811F160)
#define RPG_CLIENT_AVATARDEFAULTSKINDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1811F000)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarDefaultSkinData_TypeDefinitionIndex = 59717;
