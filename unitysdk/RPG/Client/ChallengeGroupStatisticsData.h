...
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xCA36100)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_GET_ISSPECIALTARGETACHIEVED_OFFSET UNITYSDK_OFFSET(0x14AD20)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_GET_ISTIERCE_OFFSET UNITYSDK_OFFSET(0x8F1B0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_SET_ISSPECIALTARGETACHIEVED_OFFSET UNITYSDK_OFFSET(0x14AD30)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA_SET_ISTIERCE_OFFSET UNITYSDK_OFFSET(0x8F1C0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETNORMALMODEMAXLEVELSTARNUM_OFFSET UNITYSDK_OFFSET(0xCA36F60)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETNORMALMODEMAXLEVEL_OFFSET UNITYSDK_OFFSET(0xCA36DC0)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETTIERCESTARSTATE_OFFSET UNITYSDK_OFFSET(0xCA36980)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__GETTOTALCHALLENGETIMES_OFFSET UNITYSDK_OFFSET(0xCA36820)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__SETLINEUP_OFFSET UNITYSDK_OFFSET(0x14AD50)
#define RPG_CLIENT_CHALLENGEGROUPSTATISTICSDATA__SETTIERCESTATISTICS_OFFSET UNITYSDK_OFFSET(0x14AD40)
