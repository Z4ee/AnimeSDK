...
#define RPG_CLIENT_TIMEREWINDCUSTOMPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCA44130)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindCustomPathData_TypeDefinitionIndex = 59688;
