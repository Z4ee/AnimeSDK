...
#define RPG_CLIENT_TIMEREWINDCUSTOMPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA5AE580)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindCustomPathData_TypeDefinitionIndex = 51810;
