...
#define RPG_CLIENT_TIMEREWINDCUSTOMPATHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACCFE60)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindCustomPathData_TypeDefinitionIndex = 63826;
