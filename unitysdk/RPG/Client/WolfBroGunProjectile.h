...
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_FIRE_OFFSET UNITYSDK_OFFSET(0xA79B7F0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0xA79CCC0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ISFIRED_OFFSET UNITYSDK_OFFSET(0xA79CCD0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ISHITTED_OFFSET UNITYSDK_OFFSET(0xA79CCE0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_MOVEFORWARD_OFFSET UNITYSDK_OFFSET(0xA79B280)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ONHITCALLBACK_OFFSET UNITYSDK_OFFSET(0xA79CD10)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ROADMAP_OFFSET UNITYSDK_OFFSET(0xA79CCF0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_09184A844EBD052E_OFFSET UNITYSDK_OFFSET(0xA79C230)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_67E5DD3363DCC43E_OFFSET UNITYSDK_OFFSET(0xA79C6B0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_7D3AFE2824353718_OFFSET UNITYSDK_OFFSET(0xA79CC70)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA79CC30)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_METHOD_5_E5CA75F65C17B667_OFFSET UNITYSDK_OFFSET(0xA79ADA0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA79B720)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA79B6C0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_RAYCAST_OFFSET UNITYSDK_OFFSET(0xA79BBB0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_RESET_OFFSET UNITYSDK_OFFSET(0xA79B5A0)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_SET_ONHITCALLBACK_OFFSET UNITYSDK_OFFSET(0xA79CD20)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_SET_ROADMAP_OFFSET UNITYSDK_OFFSET(0xA79CD00)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE_TICK_OFFSET UNITYSDK_OFFSET(0xA79BA70)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE__CCTOR_OFFSET UNITYSDK_OFFSET(0xA79CD30)
#define RPG_CLIENT_WOLFBROGUNPROJECTILE__CTOR_OFFSET UNITYSDK_OFFSET(0xA79B550)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunProjectile_TypeDefinitionIndex = 56162;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunProjectile_TypeDefinitionIndex)->GetStaticField(0x40650);
		}
		static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_Field_5_15()
		{
			return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(WolfBroGunProjectile_TypeDefinitionIndex)->GetStaticField(0x40658);
		}
		...
		::Class_3_5775A4FEC79026BC* _OnHitCallback_k__BackingField; // 0x58
		...
		::Class_3_5775A4FEC79026BC* get_OnHitCallback()
		{
			return ((::Class_3_5775A4FEC79026BC*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPROJECTILE_GET_ONHITCALLBACK_OFFSET))(this);
		}

		::System::Void set_OnHitCallback(::Class_3_5775A4FEC79026BC* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_5775A4FEC79026BC*))((::PBYTE)hIl2Cpp + RPG_CLIENT_WOLFBROGUNPROJECTILE_SET_ONHITCALLBACK_OFFSET))(this, value);
		}
	};
}
