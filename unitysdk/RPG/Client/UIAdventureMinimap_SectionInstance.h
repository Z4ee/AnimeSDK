...
#define RPG_CLIENT_UIADVENTUREMINIMAP_SECTIONINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xA6718B0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_SectionInstance_TypeDefinitionIndex = 56426;
	...
	public:
		...
		::System::Int32 SectionIndex; // 0x28
		::System::Int32 DynamicVersion; // 0x2C
