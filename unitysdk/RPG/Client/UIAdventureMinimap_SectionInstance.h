...
#define RPG_CLIENT_UIADVENTUREMINIMAP_SECTIONINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB27820)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_SectionInstance_TypeDefinitionIndex = 64591;
	...
	public:
		...
		::System::Int32 ZoneID; // 0x24
		::UnityEngine::Vector2 AnchorPos; // 0x28
		::System::Int32 SectionIndex; // 0x30
		::System::Int32 DynamicVersion; // 0x34
