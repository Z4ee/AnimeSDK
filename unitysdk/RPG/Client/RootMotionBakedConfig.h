...
#define RPG_CLIENT_ROOTMOTIONBAKEDCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0xA3F8390)
#define RPG_CLIENT_ROOTMOTIONBAKEDCONFIG_METHOD_3_25C60997F67081D0_OFFSET UNITYSDK_OFFSET(0xA3F8490)
#define RPG_CLIENT_ROOTMOTIONBAKEDCONFIG_METHOD_3_C28A1E00AC9CDDF5_OFFSET UNITYSDK_OFFSET(0xA3F8580)
#define RPG_CLIENT_ROOTMOTIONBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA3F8880)

namespace RPG::Client
{
	inline static constexpr unsigned int RootMotionBakedConfig_TypeDefinitionIndex = 48661;
