...
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B72960)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE1_GETPROPERTYFIELDS_OFFSET UNITYSDK_OFFSET(0x9B729B0)
#define RPG_CLIENT_MATERIALPROPERTYSERIALIZEFIELDTEMPLATE1__CTOR_OFFSET UNITYSDK_OFFSET(0x9B72AD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MaterialPropertySerializeFieldTemplate1_TypeDefinitionIndex = 57858;
