...
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYHELIOBUS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xD6D48B0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYHELIOBUS_EQUALS_OFFSET UNITYSDK_OFFSET(0xD6D4800)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYHELIOBUS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xD6D49E0)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYHELIOBUS_GET_CONDITIONTEXT_OFFSET UNITYSDK_OFFSET(0xD6D4A30)
#define RPG_CLIENT_MISSIONCHRONICLEPATHUNLOCKCONDITIONDATA_ACTIVITYHELIOBUS__CTOR_OFFSET UNITYSDK_OFFSET(0xD6D47F0)
