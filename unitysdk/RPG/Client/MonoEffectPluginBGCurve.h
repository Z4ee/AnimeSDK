...
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C97610)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_METHOD_6_9E1C80D299917CB2_OFFSET UNITYSDK_OFFSET(0x9C97720)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9C975C0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_1_OFFSET UNITYSDK_OFFSET(0x9C98250)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_2_OFFSET UNITYSDK_OFFSET(0x9C98470)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_OFFSET UNITYSDK_OFFSET(0x9C97650)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x9C98610)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginBGCurve_TypeDefinitionIndex = 57308;
