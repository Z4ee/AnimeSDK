...
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA959510)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_METHOD_6_9E1C80D299917CB2_OFFSET UNITYSDK_OFFSET(0xA959620)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xA9594C0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_1_OFFSET UNITYSDK_OFFSET(0xA95A150)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_2_OFFSET UNITYSDK_OFFSET(0xA95A3A0)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE_SETUP_OFFSET UNITYSDK_OFFSET(0xA959550)
#define RPG_CLIENT_MONOEFFECTPLUGINBGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0xA95A560)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginBGCurve_TypeDefinitionIndex = 64562;
