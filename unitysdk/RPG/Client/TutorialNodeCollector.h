...
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_CLEAR_OFFSET UNITYSDK_OFFSET(0xB39C490)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_METHOD_5_B3C2C518B158EAB8_OFFSET UNITYSDK_OFFSET(0xB39C330)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_METHOD_5_E17350B69258B9AC_OFFSET UNITYSDK_OFFSET(0xB39CA10)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB39BEB0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_SETDYNAMICKEY_1_OFFSET UNITYSDK_OFFSET(0xB39C8E0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xB39C7B0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_START_OFFSET UNITYSDK_OFFSET(0xB39BCC0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_TRYREGISTERALL_OFFSET UNITYSDK_OFFSET(0xB39C050)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_UNREGISTERALL_OFFSET UNITYSDK_OFFSET(0xB39C5C0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xB39CB10)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB39CAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialNodeCollector_TypeDefinitionIndex = 62895;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(TutorialNodeCollector_TypeDefinitionIndex)->GetStaticField(0xA490);
		}
