...
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x16FD89F0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16FD9040)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_METHOD_5_B3C2C518B158EAB8_OFFSET UNITYSDK_OFFSET(0x16FD86E0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_METHOD_5_E17350B69258B9AC_OFFSET UNITYSDK_OFFSET(0x16FD8FA0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16FD81E0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_ONOTHERNODEDYNAMICKEYCLEAR_OFFSET UNITYSDK_OFFSET(0x16FD8850)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_SETDYNAMICKEY_1_OFFSET UNITYSDK_OFFSET(0x16FD8E70)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x16FD8D40)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_START_OFFSET UNITYSDK_OFFSET(0x16FD7F90)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_TRYREGISTERALL_OFFSET UNITYSDK_OFFSET(0x16FD83D0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_UNREGISTERALL_OFFSET UNITYSDK_OFFSET(0x16FD8B30)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x16FD90E0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16FD9080)

namespace RPG::Client
{
	inline static constexpr unsigned int TutorialNodeCollector_TypeDefinitionIndex = 65199;

	class TutorialNodeCollector : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::System::UInt32* StaticGet_Field_5_0()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(TutorialNodeCollector_TypeDefinitionIndex)->GetStaticField(0xCEF0);
		}
