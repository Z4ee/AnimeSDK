...
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B114960)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B114D90)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_METHOD_5_B3C2C518B158EAB8_OFFSET UNITYSDK_OFFSET(0x1B114650)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_METHOD_5_E17350B69258B9AC_OFFSET UNITYSDK_OFFSET(0x1B114CF0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B114160)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_ONOTHERNODEDYNAMICKEYCLEAR_OFFSET UNITYSDK_OFFSET(0x1B1147C0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_SETDYNAMICKEY_1_OFFSET UNITYSDK_OFFSET(0x1B113920)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_SETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1B113680)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_START_OFFSET UNITYSDK_OFFSET(0x1B113F10)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_TRYREGISTERALL_OFFSET UNITYSDK_OFFSET(0x1B114350)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR_UNREGISTERALL_OFFSET UNITYSDK_OFFSET(0x1B114AA0)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B114E30)
#define RPG_CLIENT_TUTORIALNODECOLLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B114DD0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(TutorialNodeCollector_TypeDefinitionIndex)->GetStaticField(0x12FB0);
		}
