...
#define RPG_CLIENT_SDFRAYTRACESYSTEMMONOPLUGIN_EXECUTE_OFFSET UNITYSDK_OFFSET(0x16A4DDB0)
#define RPG_CLIENT_SDFRAYTRACESYSTEMMONOPLUGIN_GET_KEY_OFFSET UNITYSDK_OFFSET(0x16A4DD70)
#define RPG_CLIENT_SDFRAYTRACESYSTEMMONOPLUGIN_HASVALIDBAKEDDATA_OFFSET UNITYSDK_OFFSET(0x16A3D150)
#define RPG_CLIENT_SDFRAYTRACESYSTEMMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16A4DEF0)
