...
#define RPG_CLIENT_SPINEACTIONINFO_METHOD_1_241E980AA407A7FB_OFFSET UNITYSDK_OFFSET(0xA4B4750)
#define RPG_CLIENT_SPINEACTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B4820)

namespace RPG::Client
{
	inline static constexpr unsigned int SpineActionInfo_TypeDefinitionIndex = 56383;
