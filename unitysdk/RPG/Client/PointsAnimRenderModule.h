...
#define RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_3EF939F2ACADDFEB_OFFSET UNITYSDK_OFFSET(0xC4AD5C0)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_6D74C874E8E4B36A_OFFSET UNITYSDK_OFFSET(0xC4AD640)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_8CD1A6D1096A6CB7_1_OFFSET UNITYSDK_OFFSET(0xC4ADCB0)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_8CD1A6D1096A6CB7_OFFSET UNITYSDK_OFFSET(0xC4ADC50)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_E9A575D18A0748D9_1_OFFSET UNITYSDK_OFFSET(0xC4AD940)
#define RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xC4AD570)
#define RPG_CLIENT_POINTSANIMRENDERMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4ADA00)

namespace RPG::Client
{
	inline static constexpr unsigned int PointsAnimRenderModule_TypeDefinitionIndex = 66044;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_DFBCA3F3CBEF1852*))((::PBYTE)hIl2Cpp + RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_8CD1A6D1096A6CB7_OFFSET))(this, a1);
		}

		::System::Void Method_2_8CD1A6D1096A6CB7_1(::Class_1_DFBCA3F3CBEF1852* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_DFBCA3F3CBEF1852*))((::PBYTE)hIl2Cpp + RPG_CLIENT_POINTSANIMRENDERMODULE_METHOD_2_8CD1A6D1096A6CB7_1_OFFSET))(this, a1);
		}
	};
}
