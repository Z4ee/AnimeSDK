...
#define RPG_CLIENT_DICECOMBATTALKOPTIONEXTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A001470)

namespace RPG::Client
{
	inline static constexpr unsigned int DiceCombatTalkOptionExtData_TypeDefinitionIndex = 65028;
