...
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS147_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18FE46F0)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS147_0__PREPAREOPENCONDTIONMISSION_B__0_OFFSET UNITYSDK_OFFSET(0x18FE8810)
#define RPG_CLIENT_HANDBOOKMODULE___C__DISPLAYCLASS147_0__PREPAREOPENCONDTIONMISSION_B__1_OFFSET UNITYSDK_OFFSET(0x18FE8900)

namespace RPG::Client
{
	inline static constexpr unsigned int HandbookModule___c__DisplayClass147_0_TypeDefinitionIndex = 62709;

	class HandbookModule___c__DisplayClass147_0 : public ::System::Object
	{
	public:
		::System::Action* __9__1; // 0x10
		::RPG::Client::HandbookModule* __4__this; // 0x18
