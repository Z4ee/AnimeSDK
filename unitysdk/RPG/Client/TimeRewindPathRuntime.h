...
#define RPG_CLIENT_TIMEREWINDPATHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xCA4B560)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindPathRuntime_TypeDefinitionIndex = 59690;
