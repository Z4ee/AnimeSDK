...
#define RPG_CLIENT_TIMEREWINDPATHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xB2F4760)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindPathRuntime_TypeDefinitionIndex = 58760;
