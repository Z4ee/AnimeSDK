...
#define RPG_CLIENT_TIMEREWINDPATHRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0xA5B5960)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindPathRuntime_TypeDefinitionIndex = 51812;
