...
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA66F830)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA66F970)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA66F9D0)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA66F980)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA66F820)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0xA66EBC0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeSelect__ChangeToNextCoroutine_d__58_TypeDefinitionIndex = 65475;
	...
	public:
		...
		::System::Single deltaDegree; // 0x20
		::System::Single _currentDegree_5__3; // 0x24
