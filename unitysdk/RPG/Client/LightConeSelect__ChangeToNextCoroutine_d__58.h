...
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xBD76AF0)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBD76C30)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xBD76C90)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xBD76C40)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBD76AE0)
#define RPG_CLIENT_LIGHTCONESELECT__CHANGETONEXTCOROUTINE_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0xBD75EB0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightConeSelect__ChangeToNextCoroutine_d__58_TypeDefinitionIndex = 66405;
	...
	public:
		...
		::System::Single _currentDegree_5__3; // 0x28
		::System::Single _timeCounter_5__2; // 0x2C
