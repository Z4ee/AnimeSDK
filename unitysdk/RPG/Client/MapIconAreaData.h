...
#define RPG_CLIENT_MAPICONAREADATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x17FEEDC0)
#define RPG_CLIENT_MAPICONAREADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17FEEDA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MapIconAreaData_TypeDefinitionIndex = 60123;
