...
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETCURRESOLUTIONENEMYDICEHOLDOFFSETY_OFFSET UNITYSDK_OFFSET(0xA1724B0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITANGLEVELOCITY_OFFSET UNITYSDK_OFFSET(0xA171730)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITPOSITIONRANDOMOFFSET_OFFSET UNITYSDK_OFFSET(0xA1717F0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITVELOCITY_OFFSET UNITYSDK_OFFSET(0xA171670)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETPOSITIONDELTA_OFFSET UNITYSDK_OFFSET(0xA1718B0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETPOSOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xA171940)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETROTOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xA171BE0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETUIPOSYOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xA171E80)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_1_OFFSET UNITYSDK_OFFSET(0xA172150)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_2_OFFSET UNITYSDK_OFFSET(0xA172030)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_3_OFFSET UNITYSDK_OFFSET(0xA172390)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_OFFSET UNITYSDK_OFFSET(0xA172270)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FC5102551AF3CB1A_OFFSET UNITYSDK_OFFSET(0xA1725D0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0xA172680)

namespace RPG::Client
{
	inline static constexpr unsigned int DiceCombatPhySimParameter_TypeDefinitionIndex = 55686;
