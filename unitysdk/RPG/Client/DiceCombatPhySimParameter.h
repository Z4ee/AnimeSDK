...
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETCURRESOLUTIONENEMYDICEHOLDOFFSETY_OFFSET UNITYSDK_OFFSET(0xCD76210)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITANGLEVELOCITY_OFFSET UNITYSDK_OFFSET(0xCD75490)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITPOSITIONRANDOMOFFSET_OFFSET UNITYSDK_OFFSET(0xCD75550)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETINITVELOCITY_OFFSET UNITYSDK_OFFSET(0xCD753D0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETPOSITIONDELTA_OFFSET UNITYSDK_OFFSET(0xCD75610)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETPOSOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xCD756A0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETROTOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xCD75940)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_GETUIPOSYOFFSETBYDICETYPE_OFFSET UNITYSDK_OFFSET(0xCD75BE0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_1_OFFSET UNITYSDK_OFFSET(0xCD75EB0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_2_OFFSET UNITYSDK_OFFSET(0xCD75D90)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_3_OFFSET UNITYSDK_OFFSET(0xCD760F0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FAE9C4050544FE63_OFFSET UNITYSDK_OFFSET(0xCD75FD0)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER_METHOD_5_FC5102551AF3CB1A_OFFSET UNITYSDK_OFFSET(0xCD76330)
#define RPG_CLIENT_DICECOMBATPHYSIMPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD763E0)
