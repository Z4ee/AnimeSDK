...
#define RPG_CLIENT_SIMULATEDROGUESENDPACKETCMD_SENDENHANCEROGUEBUFFCSREQ_OFFSET UNITYSDK_OFFSET(0xE0A1DF0)
#define RPG_CLIENT_SIMULATEDROGUESENDPACKETCMD_SENDGETROGUEBUFFENHANCEINFOSCREQ_OFFSET UNITYSDK_OFFSET(0xE0A1D50)
#define RPG_CLIENT_SIMULATEDROGUESENDPACKETCMD_SENDPICKROGUEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0xE0A17F0)
#define RPG_CLIENT_SIMULATEDROGUESENDPACKETCMD_SENDREVIVEROGUEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0xE0A19A0)
#define RPG_CLIENT_SIMULATEDROGUESENDPACKETCMD__CTOR_OFFSET UNITYSDK_OFFSET(0xE0A1EA0)
