...
#define RPG_CLIENT_TIMEREWINDCUSTOMPATHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCA44140)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindCustomPathNode_TypeDefinitionIndex = 59689;
