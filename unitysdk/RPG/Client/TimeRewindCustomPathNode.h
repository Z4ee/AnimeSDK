...
#define RPG_CLIENT_TIMEREWINDCUSTOMPATHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACCFE70)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindCustomPathNode_TypeDefinitionIndex = 63827;
