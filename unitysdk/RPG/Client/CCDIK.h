...
#define RPG_CLIENT_CCDIK_GET_ISPROCESSABLE_OFFSET UNITYSDK_OFFSET(0x92101C0)
#define RPG_CLIENT_CCDIK_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x9210250)
#define RPG_CLIENT_CCDIK_IKRESET_OFFSET UNITYSDK_OFFSET(0x92103B0)
#define RPG_CLIENT_CCDIK_PROCESS_OFFSET UNITYSDK_OFFSET(0x9210440)
#define RPG_CLIENT_CCDIK_SAFEINIT_OFFSET UNITYSDK_OFFSET(0x92102A0)
#define RPG_CLIENT_CCDIK__CTOR_OFFSET UNITYSDK_OFFSET(0x9210710)

namespace RPG::Client
{
	inline static constexpr unsigned int CCDIK_TypeDefinitionIndex = 55806;
