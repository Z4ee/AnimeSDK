...
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x194ED5F0)
#define RPG_CLIENT_ITEMCOSTCALCULATOR___C__DISPLAYCLASS20_0__GETITEMNEEDCOUNT_B__0_OFFSET UNITYSDK_OFFSET(0x194EE600)

namespace RPG::Client
{
	inline static constexpr unsigned int ItemCostCalculator___c__DisplayClass20_0_TypeDefinitionIndex = 65762;
