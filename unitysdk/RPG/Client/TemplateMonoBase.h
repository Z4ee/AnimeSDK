...
#define RPG_CLIENT_TEMPLATEMONOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xA585030)

namespace RPG::Client
{
	inline static constexpr unsigned int TemplateMonoBase_TypeDefinitionIndex = 57979;
