...
#define RPG_CLIENT_TEMPLATEMONOBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC9DEA0)

namespace RPG::Client
{
	inline static constexpr unsigned int TemplateMonoBase_TypeDefinitionIndex = 70741;
