...
#define RPG_CLIENT_MARBLEBATTLESEALDATA_GET_CANLAUNCH_OFFSET UNITYSDK_OFFSET(0xD611500)
#define RPG_CLIENT_MARBLEBATTLESEALDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xD619790)
#define RPG_CLIENT_MARBLEBATTLESEALDATA_GET_ISDEAD_OFFSET UNITYSDK_OFFSET(0xD619740)
#define RPG_CLIENT_MARBLEBATTLESEALDATA_GET_ISENEMY_OFFSET UNITYSDK_OFFSET(0xD614D70)
#define RPG_CLIENT_MARBLEBATTLESEALDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD6199A0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean HasAction; // 0x1C
		::System::Boolean IsOffField; // 0x1D
		::System::Boolean TeamA; // 0x1E
		::System::Boolean IsForbid; // 0x1F
		::System::UInt32 EntityId; // 0x20
		::System::Int32 WhiteAttack; // 0x24
		::System::UInt32 BuffId; // 0x28
		::System::Int32 InitHp; // 0x2C
		::System::UInt32 SealId; // 0x30
