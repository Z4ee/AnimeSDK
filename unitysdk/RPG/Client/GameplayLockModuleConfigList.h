...
#define RPG_CLIENT_GAMEPLAYLOCKMODULECONFIGLIST_METHOD_2_8F580EBAFC286D64_OFFSET UNITYSDK_OFFSET(0x1CD4BEF0)
#define RPG_CLIENT_GAMEPLAYLOCKMODULECONFIGLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD4C0B0)

namespace RPG::Client
{
	inline static constexpr unsigned int GameplayLockModuleConfigList_TypeDefinitionIndex = 10171;
