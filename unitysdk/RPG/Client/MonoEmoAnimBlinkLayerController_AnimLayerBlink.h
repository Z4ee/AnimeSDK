...
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ANIMLAYERBLINK_GET_BLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0xD7D35E0)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ANIMLAYERBLINK_SET_BLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0xD7D35F0)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ANIMLAYERBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xD7D3600)
