...
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ANIMLAYERBLINK_GET_BLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0x19144960)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ANIMLAYERBLINK_SET_BLINKWEIGHT_OFFSET UNITYSDK_OFFSET(0x19144970)
#define RPG_CLIENT_MONOEMOANIMBLINKLAYERCONTROLLER_ANIMLAYERBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0x19144980)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEmoAnimBlinkLayerController_AnimLayerBlink_TypeDefinitionIndex = 67934;
