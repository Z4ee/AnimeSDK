...
#define RPG_CLIENT_ROGUENOUSDICEHANDBOOKREDDOTFILTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x198215B0)
#define RPG_CLIENT_ROGUENOUSDICEHANDBOOKREDDOTFILTER_GET_NEWSURFACEIDS_OFFSET UNITYSDK_OFFSET(0x19821940)
#define RPG_CLIENT_ROGUENOUSDICEHANDBOOKREDDOTFILTER_SET_NEWSURFACEIDS_OFFSET UNITYSDK_OFFSET(0x19821950)
#define RPG_CLIENT_ROGUENOUSDICEHANDBOOKREDDOTFILTER_UPDATEREDDOTS_OFFSET UNITYSDK_OFFSET(0x19821610)
#define RPG_CLIENT_ROGUENOUSDICEHANDBOOKREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19821960)
#define RPG_CLIENT_ROGUENOUSDICEHANDBOOKREDDOTFILTER__UPDATENEWSURFACE_OFFSET UNITYSDK_OFFSET(0x19821660)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueNousDiceHandbookRedDotFilter_TypeDefinitionIndex = 63858;
