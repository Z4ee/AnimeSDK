...
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xE30AEA0)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xE30AD30)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_7D4A14E62F64E1E1_OFFSET UNITYSDK_OFFSET(0xE30ABA0)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xE30AF00)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET_METHOD_2_FEC28CECAEED4E11_OFFSET UNITYSDK_OFFSET(0xE30AD90)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE30AB90)
#define RPG_CLIENT_UI_UISTATECTRL_LINERENDERERMATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xE30AB80)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int LineRendererMaterialSwitchTarget_TypeDefinitionIndex = 73973;
