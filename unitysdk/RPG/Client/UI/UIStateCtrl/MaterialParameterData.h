...
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0xE30B460)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0xE30B540)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_1D4018D4200358D0_2_OFFSET UNITYSDK_OFFSET(0xE30B5F0)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_1D4018D4200358D0_3_OFFSET UNITYSDK_OFFSET(0xE30B650)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xE30B4E0)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xE30B5A0)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_391A84BCD9F51317_2_OFFSET UNITYSDK_OFFSET(0xE30B6B0)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_391A84BCD9F51317_3_OFFSET UNITYSDK_OFFSET(0xE30B700)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_391A84BCD9F51317_4_OFFSET UNITYSDK_OFFSET(0xE30B750)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE30B410)
#define RPG_CLIENT_UI_UISTATECTRL_MATERIALPARAMETERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE30B7A0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int MaterialParameterData_TypeDefinitionIndex = 73960;
