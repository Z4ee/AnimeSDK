...
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_GET_CURRENTCOSTTIME_OFFSET UNITYSDK_OFFSET(0x16FE0DD0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_16480B1867AF51ED_OFFSET UNITYSDK_OFFSET(0x16FE0770)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x16FE0B50)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16FE0D90)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0x16FE09A0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x16FE0850)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_METHOD_2_BA0DC2F7F154B425_OFFSET UNITYSDK_OFFSET(0x16FE0C10)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION_SET_CURRENTCOSTTIME_OFFSET UNITYSDK_OFFSET(0x16FE0DE0)
#define RPG_CLIENT_UI_UISTATECTRL_ASYNCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16FE0DF0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int AsyncAction_TypeDefinitionIndex = 70666;
