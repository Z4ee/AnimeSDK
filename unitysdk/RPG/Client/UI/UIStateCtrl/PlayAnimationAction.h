...
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_0BF1620F1E4289BD_OFFSET UNITYSDK_OFFSET(0xE30C3B0)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0xE30C750)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xE30C0D0)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_41A074549EF25F63_1_OFFSET UNITYSDK_OFFSET(0xE30C620)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xE30C510)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_5A124CAF1E48B74F_OFFSET UNITYSDK_OFFSET(0xE30BE10)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_76CD9B9D1269FA90_OFFSET UNITYSDK_OFFSET(0xE30C300)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION_METHOD_3_F4F1E7D1CC26024A_OFFSET UNITYSDK_OFFSET(0xE30C110)
#define RPG_CLIENT_UI_UISTATECTRL_PLAYANIMATIONACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE30C7A0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int PlayAnimationAction_TypeDefinitionIndex = 73955;
