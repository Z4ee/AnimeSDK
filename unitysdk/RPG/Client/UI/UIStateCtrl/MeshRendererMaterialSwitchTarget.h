...
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_126AEE9DCE6A9399_OFFSET UNITYSDK_OFFSET(0xCB05180)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xCB054A0)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xCB05330)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xCB05500)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET_METHOD_2_FEC28CECAEED4E11_OFFSET UNITYSDK_OFFSET(0xCB05390)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCB05170)
#define RPG_CLIENT_UI_UISTATECTRL_MESHRENDERERMATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xCB05160)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int MeshRendererMaterialSwitchTarget_TypeDefinitionIndex = 69155;
