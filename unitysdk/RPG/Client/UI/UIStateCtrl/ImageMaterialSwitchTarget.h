...
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xE30A780)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_1E1B584909E026DF_OFFSET UNITYSDK_OFFSET(0xE30A230)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_2D99CA5EA537015F_OFFSET UNITYSDK_OFFSET(0xE30A010)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_3AFE2A3ED13F591D_OFFSET UNITYSDK_OFFSET(0xE30A4F0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_4FB5F56430673EA6_OFFSET UNITYSDK_OFFSET(0xE30A160)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_AC3BD55C31CE6E12_OFFSET UNITYSDK_OFFSET(0xE30A370)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_B4F2FE6610DD5A60_OFFSET UNITYSDK_OFFSET(0xE30A1C0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_B7BFE5D35A542E8B_OFFSET UNITYSDK_OFFSET(0xE30A7E0)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET_METHOD_2_FBAC2F70799E5CFB_OFFSET UNITYSDK_OFFSET(0xE30A640)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET__CTOR_1_OFFSET UNITYSDK_OFFSET(0xE30A000)
#define RPG_CLIENT_UI_UISTATECTRL_IMAGEMATERIALSWITCHTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xE309FE0)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int ImageMaterialSwitchTarget_TypeDefinitionIndex = 73972;
