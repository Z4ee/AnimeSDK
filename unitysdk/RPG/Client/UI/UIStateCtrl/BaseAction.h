...
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_GET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xE309D90)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_GET_STATUS_OFFSET UNITYSDK_OFFSET(0xE309D70)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_METHOD_1_8A1C979A2319B852_OFFSET UNITYSDK_OFFSET(0xE309720)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE309D30)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_METHOD_1_FC25C1AE120A80A5_OFFSET UNITYSDK_OFFSET(0xE309870)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_SET_OWNERUISTATECTRL_OFFSET UNITYSDK_OFFSET(0xE309DA0)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION_SET_STATUS_OFFSET UNITYSDK_OFFSET(0xE309D80)
#define RPG_CLIENT_UI_UISTATECTRL_BASEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xE309D20)

namespace RPG::Client::UI::UIStateCtrl
{
	inline static constexpr unsigned int BaseAction_TypeDefinitionIndex = 73967;
