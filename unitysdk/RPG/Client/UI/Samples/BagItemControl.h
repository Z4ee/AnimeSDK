...
#define RPG_CLIENT_UI_SAMPLES_BAGITEMCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0xE3CB080)
#define RPG_CLIENT_UI_SAMPLES_BAGITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE3CB820)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int BagItemControl_TypeDefinitionIndex = 73330;
