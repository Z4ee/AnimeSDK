...
#define RPG_CLIENT_UI_SAMPLES_GRIDFIGHTSETTLERESULTSAMPLEWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBFF30)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int GridFightSettleResultSampleWindow_TypeDefinitionIndex = 73356;
