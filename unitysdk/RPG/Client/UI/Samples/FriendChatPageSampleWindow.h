...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAGESAMPLEWINDOW_CHANGECONTACTNAME_OFFSET UNITYSDK_OFFSET(0x1DDBF9F0)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAGESAMPLEWINDOW_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1DDBF970)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAGESAMPLEWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBF8B0)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAGESAMPLEWINDOW__ONACTIVETABPRECHANGING_OFFSET UNITYSDK_OFFSET(0x1DDBFAA0)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatPageSampleWindow_TypeDefinitionIndex = 73348;
