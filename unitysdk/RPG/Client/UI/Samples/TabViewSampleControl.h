...
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xE3CE190)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xE3CE240)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__BUILDTABSDATADRIVEN_OFFSET UNITYSDK_OFFSET(0xE3CE8A0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__BUILDTABSIMPERATIVE_OFFSET UNITYSDK_OFFSET(0xE3CE800)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__BUILDTABSSTATIC_OFFSET UNITYSDK_OFFSET(0xE3CE5E0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE3CECB0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__ONACTIVETABCHANGED_OFFSET UNITYSDK_OFFSET(0xE3CEC60)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__ONACTIVETABPRECHANGING_OFFSET UNITYSDK_OFFSET(0xE3CEC10)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xE3CE330)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE3CE930)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLECONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0xE3CE290)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int TabViewSampleControl_TypeDefinitionIndex = 73358;
