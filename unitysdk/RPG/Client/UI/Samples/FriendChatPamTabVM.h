...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAMTABVM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBFDA0)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatPamTabVM_TypeDefinitionIndex = 73340;
