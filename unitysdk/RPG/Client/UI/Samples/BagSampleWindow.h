...
#define RPG_CLIENT_UI_SAMPLES_BAGSAMPLEWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xE3CB910)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int BagSampleWindow_TypeDefinitionIndex = 73334;
