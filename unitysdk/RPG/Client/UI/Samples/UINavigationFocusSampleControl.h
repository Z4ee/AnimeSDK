...
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLECONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1DDC1B80)
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDC2490)
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLECONTROL__ONBACKPRESSED_OFFSET UNITYSDK_OFFSET(0x1DDC22D0)
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLECONTROL__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x1DDC2430)
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLECONTROL___BINDING_B__5_2_OFFSET UNITYSDK_OFFSET(0x1DDC24D0)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int UINavigationFocusSampleControl_TypeDefinitionIndex = 73365;
