...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAGESAMPLECONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1DDBE550)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAGESAMPLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBF6D0)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatPageSampleControl_TypeDefinitionIndex = 73337;
