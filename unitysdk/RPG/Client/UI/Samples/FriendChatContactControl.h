...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATCONTACTCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1DDBD870)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATCONTACTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBE030)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatContactControl_TypeDefinitionIndex = 73334;
