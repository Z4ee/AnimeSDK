...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATROOMTABCONTENTCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1DDBFDB0)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATROOMTABCONTENTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBFE00)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatRoomTabContentControl_TypeDefinitionIndex = 73350;
