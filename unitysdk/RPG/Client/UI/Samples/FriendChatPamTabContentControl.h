...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAMTABCONTENTCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0xE3CDE80)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATPAMTABCONTENTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xE3CDED0)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatPamTabContentControl_TypeDefinitionIndex = 73350;
