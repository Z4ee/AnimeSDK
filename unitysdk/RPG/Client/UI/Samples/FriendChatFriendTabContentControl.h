...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATFRIENDTABCONTENTCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1DDBE4A0)
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATFRIENDTABCONTENTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBE4F0)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatFriendTabContentControl_TypeDefinitionIndex = 73336;
