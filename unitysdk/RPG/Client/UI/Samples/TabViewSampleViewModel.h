...
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_GET_ADDTABCOMMAND_OFFSET UNITYSDK_OFFSET(0x1DDC1780)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_GET_CURRENTTABTITLE_OFFSET UNITYSDK_OFFSET(0x1DDC16B0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_GET_REMOVETABCOMMAND_OFFSET UNITYSDK_OFFSET(0x1DDC1840)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_GET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x1DDC15E0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_GET_TABS_OFFSET UNITYSDK_OFFSET(0x1DDC15D0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_SET_CURRENTTABTITLE_OFFSET UNITYSDK_OFFSET(0x1DDC16F0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL_SET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x1DDC1620)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDC12B0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL__GET_ADDTABCOMMAND_B__14_0_OFFSET UNITYSDK_OFFSET(0x1DDC19B0)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL__GET_REMOVETABCOMMAND_B__17_0_OFFSET UNITYSDK_OFFSET(0x1DDC1B00)
#define RPG_CLIENT_UI_SAMPLES_TABVIEWSAMPLEVIEWMODEL__UPDATECURRENTTABTITLE_OFFSET UNITYSDK_OFFSET(0x1DDC1900)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int TabViewSampleViewModel_TypeDefinitionIndex = 73363;

	class TabViewSampleViewModel : public ::Sofa::Core::ObservableObject
	{
	public:
		::System::String* _CurrentTabTitle; // 0x18
		::Class_1_BF01A723AB4005C0<::System::Int32>* _RemoveTabCommand; // 0x20
		::Sofa::Core::SimpleCommand* _AddTabCommand; // 0x28
		::Sofa::Core::ObservableList_1<::RPG::Client::Ui::Samples::TabViewSampleTabViewModel*>* _Tabs_k__BackingField; // 0x30
