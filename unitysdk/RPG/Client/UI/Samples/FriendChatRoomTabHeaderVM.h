...
#define RPG_CLIENT_UI_SAMPLES_FRIENDCHATROOMTABHEADERVM__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBFE40)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int FriendChatRoomTabHeaderVM_TypeDefinitionIndex = 73342;
