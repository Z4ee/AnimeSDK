...
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLEITEMCONTROL__BINDING_OFFSET UNITYSDK_OFFSET(0x1DDC28D0)
#define RPG_CLIENT_UI_SAMPLES_UINAVIGATIONFOCUSSAMPLEITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDC2920)

namespace RPG::Client::Ui::Samples
{
	inline static constexpr unsigned int UINavigationFocusSampleItemControl_TypeDefinitionIndex = 73367;
