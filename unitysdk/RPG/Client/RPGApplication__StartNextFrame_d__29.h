...
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1678FFE0)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16790100)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x16790160)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x16790110)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1678FFD0)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0x1678F3D0)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGApplication__StartNextFrame_d__29_TypeDefinitionIndex = 66367;
