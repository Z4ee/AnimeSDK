...
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xAF3F070)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAF3F190)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xAF3F1F0)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xAF3F1A0)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAF3F060)
#define RPG_CLIENT_RPGAPPLICATION__STARTNEXTFRAME_D__29__CTOR_OFFSET UNITYSDK_OFFSET(0xAF3E520)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGApplication__StartNextFrame_d__29_TypeDefinitionIndex = 64041;
