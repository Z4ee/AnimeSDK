...
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x9D2FC80)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0x9D2FDE0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x9D2FBB0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D2FEF0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D2FE90)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0x9D2FA90)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_SETRENDERERLAYERMASKWITHPOSM_OFFSET UNITYSDK_OFFSET(0x9D2F930)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x9D30000)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRenderPerfOptIndicator_TypeDefinitionIndex = 56038;
