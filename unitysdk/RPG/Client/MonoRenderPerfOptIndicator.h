...
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xA9F3040)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xA9F31A0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xA9F2F70)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA9F32B0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA9F3250)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0xA9F2E50)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_SETRENDERERLAYERMASKWITHPOSM_OFFSET UNITYSDK_OFFSET(0xA9F2CF0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA9F33C0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoRenderPerfOptIndicator_TypeDefinitionIndex = 63281;
