...
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xD85E710)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xD85E870)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xD85E640)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD85E980)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD85E920)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0xD85E5D0)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR_SETRENDERERLAYERMASKWITHPOSM_OFFSET UNITYSDK_OFFSET(0xD85E480)
#define RPG_CLIENT_MONORENDERPERFOPTINDICATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD85E9D0)
