...
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW_CREATE_OFFSET UNITYSDK_OFFSET(0xB0F4940)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW_GET_ROOMCOMPTYPEDATA_OFFSET UNITYSDK_OFFSET(0xB0F48E0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW_GET_ROWTYPE_OFFSET UNITYSDK_OFFSET(0xB0F48D0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDROOMCOMPTYPEROW__CTOR_OFFSET UNITYSDK_OFFSET(0xB0F49C0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaLegendRoomCompTypeRow_TypeDefinitionIndex = 67159;
