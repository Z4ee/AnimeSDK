...
#define RPG_CLIENT_SILVERWOLFRAIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA483110)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfRaidData_TypeDefinitionIndex = 55456;
