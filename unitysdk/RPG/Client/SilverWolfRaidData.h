...
#define RPG_CLIENT_SILVERWOLFRAIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x188E1670)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfRaidData_TypeDefinitionIndex = 64949;
