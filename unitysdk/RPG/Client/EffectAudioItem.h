...
#define RPG_CLIENT_EFFECTAUDIOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA1B5B60)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectAudioItem_TypeDefinitionIndex = 64558;
