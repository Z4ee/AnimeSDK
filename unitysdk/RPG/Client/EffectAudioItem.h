...
#define RPG_CLIENT_EFFECTAUDIOITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB838350)

namespace RPG::Client
{
	inline static constexpr unsigned int EffectAudioItem_TypeDefinitionIndex = 65479;
