...
#define RPG_CLIENT_DYNAMICMATERIALLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A68C4E0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0x1A68D0F0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1A68C830)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCELOAD_OFFSET UNITYSDK_OFFSET(0x1A68CA30)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCEUNLOAD_OFFSET UNITYSDK_OFFSET(0x1A68CA90)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A68D180)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_METHOD_6_2805BA06C41CBB37_OFFSET UNITYSDK_OFFSET(0x1A68C570)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A68C9E0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A68C950)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A68C8C0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SETLOADSTATE_OFFSET UNITYSDK_OFFSET(0x1A68C5C0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1A68C7A0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A68D1E0)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader_TypeDefinitionIndex = 68374;
	...
	public:
		...
		::System::Boolean FMNJGFHAPEA; // 0x28
		::System::Boolean FLIHABMPHLK; // 0x29
