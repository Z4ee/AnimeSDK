...
#define RPG_CLIENT_DYNAMICMATERIALLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA19FA90)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xA1A0710)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA19FDE0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCELOAD_OFFSET UNITYSDK_OFFSET(0xA19FFE0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCEUNLOAD_OFFSET UNITYSDK_OFFSET(0xA1A0040)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xA1A07A0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_METHOD_6_2805BA06C41CBB37_OFFSET UNITYSDK_OFFSET(0xA19FB20)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA19FF90)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA19FF00)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA19FE70)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SETLOADSTATE_OFFSET UNITYSDK_OFFSET(0xA19FB70)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA19FD50)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1A0800)
#define RPG_CLIENT_DYNAMICMATERIALLOADER___IFIXBASEPROXY_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0xA1A0870)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader_TypeDefinitionIndex = 63074;
