...
#define RPG_CLIENT_DYNAMICMATERIALLOADER_AWAKE_OFFSET UNITYSDK_OFFSET(0x951CDE0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0x951DA60)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x951D130)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCELOAD_OFFSET UNITYSDK_OFFSET(0x951D330)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_FORCEUNLOAD_OFFSET UNITYSDK_OFFSET(0x951D390)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x951DAF0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_METHOD_6_2805BA06C41CBB37_OFFSET UNITYSDK_OFFSET(0x951CE70)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x951D2E0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x951D250)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x951D1C0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SETLOADSTATE_OFFSET UNITYSDK_OFFSET(0x951CEC0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x951D0A0)
#define RPG_CLIENT_DYNAMICMATERIALLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x951DB50)
#define RPG_CLIENT_DYNAMICMATERIALLOADER___IFIXBASEPROXY_COLLECTALLREFASSETPATH_OFFSET UNITYSDK_OFFSET(0x951DBC0)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicMaterialLoader_TypeDefinitionIndex = 55840;
