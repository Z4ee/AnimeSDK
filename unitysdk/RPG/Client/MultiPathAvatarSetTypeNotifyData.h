...
#define RPG_CLIENT_MULTIPATHAVATARSETTYPENOTIFYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9DA7C50)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPathAvatarSetTypeNotifyData_TypeDefinitionIndex = 53924;
