...
#define RPG_CLIENT_PLAYEROUTFITHELPER_CHECKSHOWPLAYEROUTFITINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1938F910)
#define RPG_CLIENT_PLAYEROUTFITHELPER_GETPLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0x1938F840)
#define RPG_CLIENT_PLAYEROUTFITHELPER_SETSHOWPLAYEROUTFITINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1938FAD0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlayerOutfitHelper_TypeDefinitionIndex = 59886;
