...
#define RPG_CLIENT_PLAYEROUTFITHELPER_CHECKSHOWPLAYEROUTFITINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xDBB17B0)
#define RPG_CLIENT_PLAYEROUTFITHELPER_GETPLAYEROUTFIT_OFFSET UNITYSDK_OFFSET(0xDBB16E0)
#define RPG_CLIENT_PLAYEROUTFITHELPER_SETSHOWPLAYEROUTFITINPERFORMANCE_OFFSET UNITYSDK_OFFSET(0xDBB1970)
