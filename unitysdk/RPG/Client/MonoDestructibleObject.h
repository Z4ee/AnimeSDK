...
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_BEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0xC0722B0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CANDESTRUCT_OFFSET UNITYSDK_OFFSET(0xC072F90)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0xC070AF0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC071D70)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0xC070C80)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xC0714E0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_INITDESTRUCT_OFFSET UNITYSDK_OFFSET(0xC072840)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_ISBEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0xC072260)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_66CC9828DB1F478F_1_OFFSET UNITYSDK_OFFSET(0xC071060)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0xC071540)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0xC073000)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0xC070DF0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_94C81405F83348DF_OFFSET UNITYSDK_OFFSET(0xC072B10)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC070FD0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xC0729D0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0xC0732D0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0xC070B40)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_RESETDESTRUCTION_OFFSET UNITYSDK_OFFSET(0xC071E50)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC071D10)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC070CE0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0737A0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0xC073830)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0xC0738F0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0xC073890)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDestructibleObject_TypeDefinitionIndex = 64160;
	...
	public:
		...
		::System::Void __iFixBaseProxy_ChangeObjectRefToPathRef(::System::String* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_CHANGEOBJECTREFTOPATHREF_OFFSET))(this, a1);
		}
