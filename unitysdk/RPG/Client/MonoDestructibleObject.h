...
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_BEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9C2B460)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CANDESTRUCT_OFFSET UNITYSDK_OFFSET(0x9C2C140)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9C29B70)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9C2AEB0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x9C29D00)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x9C2A5B0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_INITDESTRUCT_OFFSET UNITYSDK_OFFSET(0x9C2BA70)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_ISBEGINDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9C2B410)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0x9C2C1B0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x9C2A0E0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_8CB9BDF340E2FC64_OFFSET UNITYSDK_OFFSET(0x9C29E60)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9C2A050)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x9C2BC10)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x9C2A610)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_EF17FAB3022DE07B_OFFSET UNITYSDK_OFFSET(0x9C2BD50)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_METHOD_6_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0x9C2C4A0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x9C29BC0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_RESETDESTRUCTION_OFFSET UNITYSDK_OFFSET(0x9C2AF90)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9C2AE50)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x9C29D60)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C2C980)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_CHANGEOBJECTREFTOPATHREF_OFFSET UNITYSDK_OFFSET(0x9C2CA10)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_DISCONNECTEDOBJECTREF_OFFSET UNITYSDK_OFFSET(0x9C2CAE0)
#define RPG_CLIENT_MONODESTRUCTIBLEOBJECT___IFIXBASEPROXY_REFRESHOBJECTREFBYPATHREF_OFFSET UNITYSDK_OFFSET(0x9C2CA80)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoDestructibleObject_TypeDefinitionIndex = 56000;
