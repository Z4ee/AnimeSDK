...
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_CREATE_OFFSET UNITYSDK_OFFSET(0x18A8CA40)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_GET_HASCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18A8CA20)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_GET_ID_OFFSET UNITYSDK_OFFSET(0x18A8C8A0)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18A8C8F0)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_GET_SIMPLENAME_OFFSET UNITYSDK_OFFSET(0x18A8C960)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_GET_TARGETPARAM_OFFSET UNITYSDK_OFFSET(0x18A8C9D0)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET_SET_HASCOMPLETED_OFFSET UNITYSDK_OFFSET(0x18A8CA30)
#define RPG_CLIENT_ACTIVITYSUMMONCHALLENGETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8CAF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivitySummonChallengeTarget_TypeDefinitionIndex = 59169;
