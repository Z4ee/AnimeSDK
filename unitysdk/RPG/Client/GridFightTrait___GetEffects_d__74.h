...
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD351760)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_IGRIDFIGHTTRAITEFFECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD351DE0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_IGRIDFIGHTTRAITEFFECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD351D70)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xD351E60)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD351DD0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD351D80)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD351580)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74__CTOR_OFFSET UNITYSDK_OFFSET(0xD3509C0)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xD351750)
#define RPG_CLIENT_GRIDFIGHTTRAIT___GETEFFECTS_D__74___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0xD351650)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::Collections::Generic::List_1_Enumerator<::RPG::Client::IGridFightTraitEffect*> __7__wrap1; // 0x10
		::RPG::Client::IGridFightTraitEffect* __2__current; // 0x28
		::RPG::Client::IGridFightTraitEffect* _effect_5__3; // 0x30
		::System::Collections::Generic::IEnumerator_1<::RPG::Client::IGridFightTraitEffect*>* __7__wrap3; // 0x38
		::RPG::Client::GridFightTrait* __4__this; // 0x40
