...
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ISCONTAINSENTITY_OFFSET UNITYSDK_OFFSET(0x9D06240)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_METHOD_5_2337B33FCDD17495_OFFSET UNITYSDK_OFFSET(0x9D06540)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9D064B0)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9D06420)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x9D05E70)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x9D06070)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_REFRESHENTITIES_OFFSET UNITYSDK_OFFSET(0x9D06100)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D065E0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHandOverlapTrigger_TypeDefinitionIndex = 56177;
