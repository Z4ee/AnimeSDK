...
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ISCONTAINSENTITY_OFFSET UNITYSDK_OFFSET(0x1ACDE9D0)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_METHOD_5_2337B33FCDD17495_OFFSET UNITYSDK_OFFSET(0x1ACDEC90)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ACDEC00)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ACDEB70)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1ACDE640)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1ACDE810)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER_REFRESHENTITIES_OFFSET UNITYSDK_OFFSET(0x1ACDE880)
#define RPG_CLIENT_MONOHANDOVERLAPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDED30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHandOverlapTrigger_TypeDefinitionIndex = 68745;

	class MonoHandOverlapTrigger : public ::UnityEngine::MonoBehaviour
	{
	public:
		::UnityEngine::Collider* Collider; // 0x18
		::System::Collections::Generic::HashSet_1<::UnityEngine::Collider*>* HCMKFMIKCPJ; // 0x20
