...
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_IFCONTENTCHANGED_OFFSET UNITYSDK_OFFSET(0x192EEC10)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_IFTRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x192EEBF0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_INDEXLIST_OFFSET UNITYSDK_OFFSET(0x192EC850)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_OFFSETSCALELIST_OFFSET UNITYSDK_OFFSET(0x192EC8F0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x192EEC60)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x192EEC30)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_UVRECTLIST_OFFSET UNITYSDK_OFFSET(0x192EC990)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x192EED30)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_B741B463286E5EDA_OFFSET UNITYSDK_OFFSET(0x192EEC80)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_IFCONTENTCHANGED_OFFSET UNITYSDK_OFFSET(0x192EEC20)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_IFTRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x192EEC00)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_INDEXLIST_OFFSET UNITYSDK_OFFSET(0x192EEC50)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x192EEC70)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x192EEC40)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x192EED80)
