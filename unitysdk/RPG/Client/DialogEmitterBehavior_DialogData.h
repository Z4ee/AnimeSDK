...
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_IFCONTENTCHANGED_OFFSET UNITYSDK_OFFSET(0x9453480)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_IFTRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x9453460)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_INDEXLIST_OFFSET UNITYSDK_OFFSET(0x9452480)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_OFFSETSCALELIST_OFFSET UNITYSDK_OFFSET(0x9452520)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x94534D0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x94534A0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_GET_UVRECTLIST_OFFSET UNITYSDK_OFFSET(0x94525C0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x94535A0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_METHOD_1_B741B463286E5EDA_OFFSET UNITYSDK_OFFSET(0x94534F0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_IFCONTENTCHANGED_OFFSET UNITYSDK_OFFSET(0x9453490)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_IFTRANSFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x9453470)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_INDEXLIST_OFFSET UNITYSDK_OFFSET(0x94534C0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_PATTERNCOUNT_OFFSET UNITYSDK_OFFSET(0x94534E0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA_SET_STRIPRECT_OFFSET UNITYSDK_OFFSET(0x94534B0)
#define RPG_CLIENT_DIALOGEMITTERBEHAVIOR_DIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x94535F0)

namespace RPG::Client
{
	inline static constexpr unsigned int DialogEmitterBehavior_DialogData_TypeDefinitionIndex = 58061;
