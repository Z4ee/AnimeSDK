...
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xA0FC0D0)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xA101950)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_IFONLYRENDERER_OFFSET UNITYSDK_OFFSET(0xA101890)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_IFUSESTATICEMOJI_OFFSET UNITYSDK_OFFSET(0xA1018F0)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_IFUSETEXT_OFFSET UNITYSDK_OFFSET(0xA1018A0)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0xA101A00)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xA102070)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA101F40)

namespace RPG::Client
{
	inline static constexpr unsigned int DialogEmitterMonoPlugin_TypeDefinitionIndex = 65353;

	class DialogEmitterMonoPlugin : public ::RPG::Client::TAMonoPlugin_1<::RPG::Client::DialogEmitterBehavior*>
	{
	public:
		static ::System::String** StaticGet_Field_7_40()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x621F0);
		}
