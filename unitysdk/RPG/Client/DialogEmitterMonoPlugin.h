...
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x944DE90)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x94536F0)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_IFONLYRENDERER_OFFSET UNITYSDK_OFFSET(0x9453630)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_IFUSESTATICEMOJI_OFFSET UNITYSDK_OFFSET(0x9453690)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_IFUSETEXT_OFFSET UNITYSDK_OFFSET(0x9453640)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x94537A0)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x9453E10)
#define RPG_CLIENT_DIALOGEMITTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x9453CE0)

namespace RPG::Client
{
	inline static constexpr unsigned int DialogEmitterMonoPlugin_TypeDefinitionIndex = 58066;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DialogEmitterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x44640);
		}
