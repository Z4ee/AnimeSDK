...
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_PROPERTYVECTOR_METHOD_1_12CEF1F3F4C83D6A_OFFSET UNITYSDK_OFFSET(0xAD6BAE0)
#define RPG_CLIENT_POINTSANIMCUSTOMDATAMODULE_PROPERTYVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xAD6C170)

namespace RPG::Client
{
	inline static constexpr unsigned int PointsAnimCustomDataModule_PropertyVector_TypeDefinitionIndex = 65115;
