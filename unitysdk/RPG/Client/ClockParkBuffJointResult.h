...
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_APPEND_OFFSET UNITYSDK_OFFSET(0xCC2D660)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0xCC2D7E0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFCOUNT_OFFSET UNITYSDK_OFFSET(0xCC2E9B0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFDESC_OFFSET UNITYSDK_OFFSET(0xCC2EB90)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFICONPATH_OFFSET UNITYSDK_OFFSET(0xCC2EA00)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFNAME_OFFSET UNITYSDK_OFFSET(0xCC2EAA0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_FIRST_OFFSET UNITYSDK_OFFSET(0xCC2E930)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM1_OFFSET UNITYSDK_OFFSET(0xCC2ECE0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM2_OFFSET UNITYSDK_OFFSET(0xCC2EDF0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM3_OFFSET UNITYSDK_OFFSET(0xCC2EF00)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_REMAINEFFECTTIMES_OFFSET UNITYSDK_OFFSET(0xCC2EC80)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xCC2E8E0)
