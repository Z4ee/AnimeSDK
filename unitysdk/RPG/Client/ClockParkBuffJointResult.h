...
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_APPEND_OFFSET UNITYSDK_OFFSET(0x1BC07AA0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x1BC07C20)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1BC08DF0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFDESC_OFFSET UNITYSDK_OFFSET(0x1BC08FD0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFICONPATH_OFFSET UNITYSDK_OFFSET(0x1BC08E40)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFNAME_OFFSET UNITYSDK_OFFSET(0x1BC08EE0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_FIRST_OFFSET UNITYSDK_OFFSET(0x1BC08D70)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM1_OFFSET UNITYSDK_OFFSET(0x1BC09120)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM2_OFFSET UNITYSDK_OFFSET(0x1BC09230)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM3_OFFSET UNITYSDK_OFFSET(0x1BC09340)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_REMAINEFFECTTIMES_OFFSET UNITYSDK_OFFSET(0x1BC090C0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BC08D20)

namespace RPG::Client
{
	inline static constexpr unsigned int ClockParkBuffJointResult_TypeDefinitionIndex = 61574;
