...
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_APPEND_OFFSET UNITYSDK_OFFSET(0xB6D5A60)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0xB6D5930)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFCOUNT_OFFSET UNITYSDK_OFFSET(0xB6D5C60)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFDESC_OFFSET UNITYSDK_OFFSET(0xB6D5DD0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFICONPATH_OFFSET UNITYSDK_OFFSET(0xB6D5CB0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_BUFFNAME_OFFSET UNITYSDK_OFFSET(0xB6D5D20)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_FIRST_OFFSET UNITYSDK_OFFSET(0xB6D5BE0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM1_OFFSET UNITYSDK_OFFSET(0xB6D5F10)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM2_OFFSET UNITYSDK_OFFSET(0xB6D5FE0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_PARAM3_OFFSET UNITYSDK_OFFSET(0xB6D60B0)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT_GET_REMAINEFFECTTIMES_OFFSET UNITYSDK_OFFSET(0xB6D5E80)
#define RPG_CLIENT_CLOCKPARKBUFFJOINTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xB6D5A10)

namespace RPG::Client
{
	inline static constexpr unsigned int ClockParkBuffJointResult_TypeDefinitionIndex = 57481;
