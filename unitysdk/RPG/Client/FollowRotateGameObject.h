...
#define RPG_CLIENT_FOLLOWROTATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA3CA250)

namespace RPG::Client
{
	inline static constexpr unsigned int FollowRotateGameObject_TypeDefinitionIndex = 63094;
