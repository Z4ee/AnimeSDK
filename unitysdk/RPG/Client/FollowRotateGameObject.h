...
#define RPG_CLIENT_FOLLOWROTATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9709E70)

namespace RPG::Client
{
	inline static constexpr unsigned int FollowRotateGameObject_TypeDefinitionIndex = 55860;
