...
#define RPG_CLIENT_PARTICLESYSTEMPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xC34FB20)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0xC34FDD0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_PLAYONPARTICLEBEGIN_OFFSET UNITYSDK_OFFSET(0xC34FE30)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_PLAY_OFFSET UNITYSDK_OFFSET(0xC34FBE0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_SETAUTOPLAY_OFFSET UNITYSDK_OFFSET(0xC34FE80)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_STOP_OFFSET UNITYSDK_OFFSET(0xC34FD60)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xC34FEF0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xC3500A0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY__TRYPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0xC34FC50)

namespace RPG::Client
{
	inline static constexpr unsigned int ParticleSystemProxy_TypeDefinitionIndex = 56059;
