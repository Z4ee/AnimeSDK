...
#define RPG_CLIENT_PARTICLESYSTEMPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A3015F0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A3018A0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_PLAYONPARTICLEBEGIN_OFFSET UNITYSDK_OFFSET(0x1A301900)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_PLAY_OFFSET UNITYSDK_OFFSET(0x1A3016B0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_SETAUTOPLAY_OFFSET UNITYSDK_OFFSET(0x1A301950)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_STOP_OFFSET UNITYSDK_OFFSET(0x1A301830)
#define RPG_CLIENT_PARTICLESYSTEMPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3019C0)
#define RPG_CLIENT_PARTICLESYSTEMPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A301B70)
#define RPG_CLIENT_PARTICLESYSTEMPROXY__TRYPOSTAUDIO_OFFSET UNITYSDK_OFFSET(0x1A301720)

namespace RPG::Client
{
	inline static constexpr unsigned int ParticleSystemProxy_TypeDefinitionIndex = 57298;
