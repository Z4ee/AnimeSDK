...
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GETRELATEDACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0xBAB4DF0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0xBAB4B60)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_ACTIVITYTITLE_OFFSET UNITYSDK_OFFSET(0xBAB4CD0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_GACHAID_OFFSET UNITYSDK_OFFSET(0xBAB4B40)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_QUESTDISPLAY_OFFSET UNITYSDK_OFFSET(0xBAB4AC0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_RELATEDAVATARID_OFFSET UNITYSDK_OFFSET(0xBAB4B80)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDBUBBLE_OFFSET UNITYSDK_OFFSET(0xBAB4A90)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDDESC_OFFSET UNITYSDK_OFFSET(0xBAB4A30)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDQUEST_OFFSET UNITYSDK_OFFSET(0xBAB46F0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDTIPS_OFFSET UNITYSDK_OFFSET(0xBAB4A60)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDTITLE_OFFSET UNITYSDK_OFFSET(0xBAB4A00)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0xBAB4C10)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_ISRELATEDACTIVITYSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0xBAB1170)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_ISREWARDTAKEABLE_OFFSET UNITYSDK_OFFSET(0xBAB0FE0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAB4380)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaPoolRewardData_TypeDefinitionIndex = 60112;
