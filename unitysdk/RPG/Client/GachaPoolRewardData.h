...
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GETRELATEDACTIVITYPANELDATA_OFFSET UNITYSDK_OFFSET(0x193A3ED0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x193A3BD0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_ACTIVITYTITLE_OFFSET UNITYSDK_OFFSET(0x193A3D70)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_GACHAID_OFFSET UNITYSDK_OFFSET(0x193A3B80)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_QUESTDISPLAY_OFFSET UNITYSDK_OFFSET(0x193A3B00)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_RELATEDAVATARID_OFFSET UNITYSDK_OFFSET(0x193A3C20)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDBUBBLE_OFFSET UNITYSDK_OFFSET(0x193A3A90)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDDESC_OFFSET UNITYSDK_OFFSET(0x193A39B0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDQUEST_OFFSET UNITYSDK_OFFSET(0x193A3800)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDTIPS_OFFSET UNITYSDK_OFFSET(0x193A3A20)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_REWARDTITLE_OFFSET UNITYSDK_OFFSET(0x193A3940)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x193A3CB0)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_ISRELATEDACTIVITYSHOWNEWREDDOT_OFFSET UNITYSDK_OFFSET(0x1939FC60)
#define RPG_CLIENT_GACHAPOOLREWARDDATA_ISREWARDTAKEABLE_OFFSET UNITYSDK_OFFSET(0x1939FB30)
#define RPG_CLIENT_GACHAPOOLREWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x193A3520)
