...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAB2A960)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_44196695CAF284A8_OFFSET UNITYSDK_OFFSET(0xAB2A840)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_697CEBDDAD44641A_OFFSET UNITYSDK_OFFSET(0xAB2A890)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_7CDD8E0732AB7384_OFFSET UNITYSDK_OFFSET(0xAB2A9E0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_9F9ED25754A7CAB9_OFFSET UNITYSDK_OFFSET(0xAB2BB80)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2BB20)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementMatBlendTex_TypeDefinitionIndex = 65302;
