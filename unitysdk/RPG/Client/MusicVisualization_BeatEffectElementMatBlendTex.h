...
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_2EBB03D7F7E1E8C1_OFFSET UNITYSDK_OFFSET(0x1A314A90)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1A314A10)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_B63771BD2393D93A_OFFSET UNITYSDK_OFFSET(0x1A3148F0)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX_METHOD_2_CF0EF72A03B510AB_OFFSET UNITYSDK_OFFSET(0x1A314940)
#define RPG_CLIENT_MUSICVISUALIZATION_BEATEFFECTELEMENTMATBLENDTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A315BE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_BeatEffectElementMatBlendTex_TypeDefinitionIndex = 70777;
