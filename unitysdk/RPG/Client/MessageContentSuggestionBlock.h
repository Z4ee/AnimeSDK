...
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AA20B60)
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK_GET_SUGGESTIONS_OFFSET UNITYSDK_OFFSET(0x1AA20D10)
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AA20B00)
#define RPG_CLIENT_MESSAGECONTENTSUGGESTIONBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA20B50)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageContentSuggestionBlock_TypeDefinitionIndex = 60477;
