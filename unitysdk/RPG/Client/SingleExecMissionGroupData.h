...
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_ADDSUBMISSION_OFFSET UNITYSDK_OFFSET(0xB18A690)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_DELETESUBMISSION_OFFSET UNITYSDK_OFFSET(0xB18A930)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_CURRENTPROGRESS_OFFSET UNITYSDK_OFFSET(0xB18AAB0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xB18B140)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xB18A9C0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTMISSIONLOGICTYPE_OFFSET UNITYSDK_OFFSET(0xB18B060)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xB18AF20)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xB18B280)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWFINISHEFFECT_OFFSET UNITYSDK_OFFSET(0xB18ADE0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0xB18AB60)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISUNKNOW_OFFSET UNITYSDK_OFFSET(0xB18B2B0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MINSUBMISSIONIDINPROGRESS_OFFSET UNITYSDK_OFFSET(0xB18B340)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MISSIONPROGRESSTYPE_OFFSET UNITYSDK_OFFSET(0xB18ACA0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xB18B440)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SUBMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0xB18B5A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0xB18A9D0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB18A650)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__GET_SORTID_B__28_0_OFFSET UNITYSDK_OFFSET(0xB18B5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int SingleExecMissionGroupData_TypeDefinitionIndex = 60955;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__CTOR_OFFSET))(this, groupID);
		}

		::System::Void AddSubMission(::RPG::Client::SubMissionData* subMission)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::SubMissionData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_ADDSUBMISSION_OFFSET))(this, subMission);
		}

		::System::Void DeleteSubMission(::RPG::Client::SubMissionData* subMissionData)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::SubMissionData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_DELETESUBMISSION_OFFSET))(this, subMissionData);
		}
		...
		::System::Boolean _get_SortID_b__28_0(::RPG::Client::SubMissionData* item)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::SubMissionData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__GET_SORTID_B__28_0_OFFSET))(this, item);
		}
	};
}
