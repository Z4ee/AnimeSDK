...
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_ADDSUBMISSION_OFFSET UNITYSDK_OFFSET(0x196CCA00)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_DELETESUBMISSION_OFFSET UNITYSDK_OFFSET(0x196CCDA0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_CURRENTPROGRESS_OFFSET UNITYSDK_OFFSET(0x196CCFC0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x196CD9E0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x196CCE30)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTMISSIONLOGICTYPE_OFFSET UNITYSDK_OFFSET(0x196CD830)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0x196CD630)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x196CDBE0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWFINISHEFFECT_OFFSET UNITYSDK_OFFSET(0x196CD480)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0x196CD120)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISUNKNOW_OFFSET UNITYSDK_OFFSET(0x196CDC40)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MINSUBMISSIONIDINPROGRESS_OFFSET UNITYSDK_OFFSET(0x196CDD40)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MISSIONPROGRESSTYPE_OFFSET UNITYSDK_OFFSET(0x196CD2D0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SORTID_OFFSET UNITYSDK_OFFSET(0x196CE000)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SUBMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0x196CE1B0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x196CCE70)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196CC9C0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__GET_SORTID_B__28_0_OFFSET UNITYSDK_OFFSET(0x196CE200)
