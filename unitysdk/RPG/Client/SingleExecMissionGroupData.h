...
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_ADDSUBMISSION_OFFSET UNITYSDK_OFFSET(0xC8DED70)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_DELETESUBMISSION_OFFSET UNITYSDK_OFFSET(0xC8DF0A0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_CURRENTPROGRESS_OFFSET UNITYSDK_OFFSET(0xC8DF2C0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0xC8DFA50)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0xC8DF1B0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTMISSIONLOGICTYPE_OFFSET UNITYSDK_OFFSET(0xC8DF950)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_HINTTEXT_OFFSET UNITYSDK_OFFSET(0xC8DF7E0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0xC8DFBC0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWFINISHEFFECT_OFFSET UNITYSDK_OFFSET(0xC8DF670)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISSHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0xC8DF390)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_ISUNKNOW_OFFSET UNITYSDK_OFFSET(0xC8DFBF0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MINSUBMISSIONIDINPROGRESS_OFFSET UNITYSDK_OFFSET(0xC8DFC90)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_MISSIONPROGRESSTYPE_OFFSET UNITYSDK_OFFSET(0xC8DF500)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SORTID_OFFSET UNITYSDK_OFFSET(0xC8DFDC0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_SUBMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0xC8DFF30)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0xC8DF1C0)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8DED30)
#define RPG_CLIENT_SINGLEEXECMISSIONGROUPDATA__GET_SORTID_B__28_0_OFFSET UNITYSDK_OFFSET(0xC8DFF80)

namespace RPG::Client
{
	inline static constexpr unsigned int SingleExecMissionGroupData_TypeDefinitionIndex = 61889;
