...
#define RPG_CLIENT_AVATARDEBUGHELPER_ADDFAKETRIALAVATAR_OFFSET UNITYSDK_OFFSET(0xC8010F0)
#define RPG_CLIENT_AVATARDEBUGHELPER_CLEARAVATARUI3DPAGESHOWINGAVATAR_OFFSET UNITYSDK_OFFSET(0xC801270)
#define RPG_CLIENT_AVATARDEBUGHELPER_FAKESYNCOBTAINEDAVATAR_OFFSET UNITYSDK_OFFSET(0xC801140)
#define RPG_CLIENT_AVATARDEBUGHELPER_GETAVATARUI3DPAGESHOWINGAVATAR_OFFSET UNITYSDK_OFFSET(0xC801230)
#define RPG_CLIENT_AVATARDEBUGHELPER_GETFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0xC801190)
#define RPG_CLIENT_AVATARDEBUGHELPER_SETAVATARUI3DPAGESHOWINGAVATAR_OFFSET UNITYSDK_OFFSET(0xC8011F0)
