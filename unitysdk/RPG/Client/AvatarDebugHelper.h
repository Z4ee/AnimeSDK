...
#define RPG_CLIENT_AVATARDEBUGHELPER_ADDFAKETRIALAVATAR_OFFSET UNITYSDK_OFFSET(0xB35D8C0)
#define RPG_CLIENT_AVATARDEBUGHELPER_CLEARAVATARUI3DPAGESHOWINGAVATAR_OFFSET UNITYSDK_OFFSET(0xB35DA40)
#define RPG_CLIENT_AVATARDEBUGHELPER_FAKESYNCOBTAINEDAVATAR_OFFSET UNITYSDK_OFFSET(0xB35D910)
#define RPG_CLIENT_AVATARDEBUGHELPER_GETAVATARUI3DPAGESHOWINGAVATAR_OFFSET UNITYSDK_OFFSET(0xB35DA00)
#define RPG_CLIENT_AVATARDEBUGHELPER_GETFAKEAVATAR_OFFSET UNITYSDK_OFFSET(0xB35D960)
#define RPG_CLIENT_AVATARDEBUGHELPER_SETAVATARUI3DPAGESHOWINGAVATAR_OFFSET UNITYSDK_OFFSET(0xB35D9C0)
