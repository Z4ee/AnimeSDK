...
#define RPG_CLIENT_ASSEMNPCCOLLIDERINFO_GET_DEFAULTINFO_OFFSET UNITYSDK_OFFSET(0x9D3A960)
#define RPG_CLIENT_ASSEMNPCCOLLIDERINFO_METHOD_1_D8DAA86944AD88A4_OFFSET UNITYSDK_OFFSET(0x9D3A9F0)
#define RPG_CLIENT_ASSEMNPCCOLLIDERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D3A9E0)

namespace RPG::Client
{
	inline static constexpr unsigned int AssemNPCColliderInfo_TypeDefinitionIndex = 55399;
