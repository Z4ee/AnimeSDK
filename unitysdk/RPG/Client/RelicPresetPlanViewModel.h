...
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_1_OFFSET UNITYSDK_OFFSET(0x1B675310)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_2_OFFSET UNITYSDK_OFFSET(0x1B6751C0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_OFFSET UNITYSDK_OFFSET(0x1B675150)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_APPLYPLAN_OFFSET UNITYSDK_OFFSET(0x1B676360)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_DELETEPLAN_OFFSET UNITYSDK_OFFSET(0x1B675A60)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETAFFECTEDAVATARIDS_OFFSET UNITYSDK_OFFSET(0x1B676160)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETCURRENTEQUIPPEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1B675D70)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETPLANDATA_OFFSET UNITYSDK_OFFSET(0x1B670760)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETRELICITEMDATALIST_OFFSET UNITYSDK_OFFSET(0x1B6769E0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETRELICITEMDATA_OFFSET UNITYSDK_OFFSET(0x1B671420)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETRELICPRESETEDITVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1B6704B0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_DEFAULTTIPSNAME_OFFSET UNITYSDK_OFFSET(0x1B672AE0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_ISAPPLYING_OFFSET UNITYSDK_OFFSET(0x1B672C80)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1B66E4B0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B672A70)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_PLANUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1B672C30)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_RANKTYPE_OFFSET UNITYSDK_OFFSET(0x1B672D70)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_SERVERCACHENAME_OFFSET UNITYSDK_OFFSET(0x1B672A00)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x1B672D60)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_HASEMPTYSLOT_OFFSET UNITYSDK_OFFSET(0x1B675B90)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ISEMPTYPLAN_OFFSET UNITYSDK_OFFSET(0x1B6745E0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_REPLACERELIC_OFFSET UNITYSDK_OFFSET(0x1B673730)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_SETPLANNAME_OFFSET UNITYSDK_OFFSET(0x1B6750D0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_SET_RANKTYPE_OFFSET UNITYSDK_OFFSET(0x1B672D80)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_UPDATEPLANNAME_OFFSET UNITYSDK_OFFSET(0x1B6755C0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_UPDATEPLANRELICS_OFFSET UNITYSDK_OFFSET(0x1B675700)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_UPDATERELIC_OFFSET UNITYSDK_OFFSET(0x1B6741C0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__ADDPLAN_B__48_0_OFFSET UNITYSDK_OFFSET(0x1B676CD0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__BUILDPROPERTYVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1B673050)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__BUILDSLOTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1B672D90)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B676B80)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66E030)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__DELETEPLAN_B__51_0_OFFSET UNITYSDK_OFFSET(0x1B676DF0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__GETDISPLAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B674640)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__GETRELICBYTYPEDICT_OFFSET UNITYSDK_OFFSET(0x1B674BA0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATEPLANNAME_B__49_0_OFFSET UNITYSDK_OFFSET(0x1B676D40)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATEPLANRELICS_B__50_1_OFFSET UNITYSDK_OFFSET(0x1B676D90)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATEPROPERTYVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1B673C50)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATERANK_OFFSET UNITYSDK_OFFSET(0x1B674DD0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATERELIC_B__35_0_OFFSET UNITYSDK_OFFSET(0x1B676C10)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATESLOTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x1B673990)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::GameCore::RelicType>**)Il2CppClass::FromTypeDefinitionIndex(RelicPresetPlanViewModel_TypeDefinitionIndex)->GetStaticField(0x669D0);
		}
		...
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::AvatarPropertyType, ::RPG::Client::RelicPresetPropertyViewModel*>* PropertyViewModels; // 0x28
		::System::Collections::Generic::List_1<::RPG::GameCore::AvatarPropertyType>* DisplayProperties; // 0x30
		...
		::Class_1_1D95EF1836E9FE9D* _CalculatorService; // 0x58
		::RPG::Client::RelicSmartSuit::RankType _RankType_k__BackingField; // 0x60
		::Enum_3_71AA90D596A09AC8_19 SourceType; // 0x64
