...
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_1_OFFSET UNITYSDK_OFFSET(0x19884400)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_2_OFFSET UNITYSDK_OFFSET(0x198842B0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_OFFSET UNITYSDK_OFFSET(0x19884240)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_APPLYPLAN_OFFSET UNITYSDK_OFFSET(0x19885450)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_DELETEPLAN_OFFSET UNITYSDK_OFFSET(0x19884B50)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETAFFECTEDAVATARIDS_OFFSET UNITYSDK_OFFSET(0x19885250)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETCURRENTEQUIPPEDSLOTS_OFFSET UNITYSDK_OFFSET(0x19884E60)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETPLANDATA_OFFSET UNITYSDK_OFFSET(0x1987F8D0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETRELICITEMDATALIST_OFFSET UNITYSDK_OFFSET(0x19885A90)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETRELICITEMDATA_OFFSET UNITYSDK_OFFSET(0x19880540)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GETRELICPRESETEDITVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1987F620)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_DEFAULTTIPSNAME_OFFSET UNITYSDK_OFFSET(0x19881C60)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_ISAPPLYING_OFFSET UNITYSDK_OFFSET(0x19881E00)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1987D620)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19881BF0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_PLANUNIQUEID_OFFSET UNITYSDK_OFFSET(0x19881DB0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_RANKTYPE_OFFSET UNITYSDK_OFFSET(0x19881EF0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_SERVERCACHENAME_OFFSET UNITYSDK_OFFSET(0x19881B90)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_GET_SLOTS_OFFSET UNITYSDK_OFFSET(0x19881EE0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_HASEMPTYSLOT_OFFSET UNITYSDK_OFFSET(0x19884C80)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ISEMPTYPLAN_OFFSET UNITYSDK_OFFSET(0x19883700)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_REPLACERELIC_OFFSET UNITYSDK_OFFSET(0x19882880)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_SETPLANNAME_OFFSET UNITYSDK_OFFSET(0x198841C0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_SET_RANKTYPE_OFFSET UNITYSDK_OFFSET(0x19881F00)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_UPDATEPLANNAME_OFFSET UNITYSDK_OFFSET(0x198846B0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_UPDATEPLANRELICS_OFFSET UNITYSDK_OFFSET(0x198847F0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL_UPDATERELIC_OFFSET UNITYSDK_OFFSET(0x198832E0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__ADDPLAN_B__48_0_OFFSET UNITYSDK_OFFSET(0x19885D60)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__BUILDPROPERTYVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x198821D0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__BUILDSLOTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x19881F10)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__CCTOR_OFFSET UNITYSDK_OFFSET(0x19885C10)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1987D1A0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__DELETEPLAN_B__51_0_OFFSET UNITYSDK_OFFSET(0x19885E80)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__GETDISPLAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19883760)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__GETRELICBYTYPEDICT_OFFSET UNITYSDK_OFFSET(0x19883CC0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATEPLANNAME_B__49_0_OFFSET UNITYSDK_OFFSET(0x19885DD0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATEPLANRELICS_B__50_1_OFFSET UNITYSDK_OFFSET(0x19885E20)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATEPROPERTYVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x19882DA0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATERANK_OFFSET UNITYSDK_OFFSET(0x19883EF0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATERELIC_B__35_0_OFFSET UNITYSDK_OFFSET(0x19885CA0)
#define RPG_CLIENT_RELICPRESETPLANVIEWMODEL__UPDATESLOTVIEWMODELS_OFFSET UNITYSDK_OFFSET(0x19882AE0)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicPresetPlanViewModel_TypeDefinitionIndex = 63881;
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::GameCore::RelicType>**)Il2CppClass::FromTypeDefinitionIndex(RelicPresetPlanViewModel_TypeDefinitionIndex)->GetStaticField(0x1CCE0);
		}
		...
		::System::Collections::Generic::List_1<::RPG::GameCore::AvatarPropertyType>* DisplayProperties; // 0x28
		::Il2CppArray<::RPG::GameCore::AvatarPropertyType>* RecommendMainAffixs; // 0x30
		...
		::RPG::Client::RelicPresetModel* _Model; // 0x40
		::System::Collections::Generic::List_1<::RPG::Client::RelicPresetSlotViewModel*>* _Slots_k__BackingField; // 0x48
		::Class_1_1D95EF1836E9FE9D* _CalculatorService; // 0x50
		::Class_2_229A7FF636DA17C3* _NetworkService; // 0x58
		::Enum_3_71AA90D596A09AC8_18 SourceType; // 0x60
		::System::UInt32 AvatarID; // 0x64
		::RPG::Client::RelicSmartSuit::RankType _RankType_k__BackingField; // 0x68

		::System::Void _ctor(::System::UInt32 a1, ::Enum_3_71AA90D596A09AC8_18 a2, ::RPG::Client::RelicPresetModel* a3, ::RPG::Client::RelicPresetPlanData* a4, ::Class_1_5D2E9E194E93B02A* a5, ::Class_2_229A7FF636DA17C3* a6, ::Class_1_1D95EF1836E9FE9D* a7)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Enum_3_71AA90D596A09AC8_18, ::RPG::Client::RelicPresetModel*, ::RPG::Client::RelicPresetPlanData*, ::Class_1_5D2E9E194E93B02A*, ::Class_2_229A7FF636DA17C3*, ::Class_1_1D95EF1836E9FE9D*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICPRESETPLANVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7);
		}
		...
		::RPG::Client::Promises::IPromise* AddPlan_2(::System::String* a1, ::System::Collections::Generic::List_1<::System::UInt32>* a2, ::Enum_3_71AA90D596A09AC8_17 a3, ::Enum_3_71AA90D596A09AC8_18 a4)
		{
			return ((::RPG::Client::Promises::IPromise*(*)(::PVOID, ::System::String*, ::System::Collections::Generic::List_1<::System::UInt32>*, ::Enum_3_71AA90D596A09AC8_17, ::Enum_3_71AA90D596A09AC8_18))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICPRESETPLANVIEWMODEL_ADDPLAN_2_OFFSET))(this, a1, a2, a3, a4);
		}
		...
		::System::Void _AddPlan_b__48_0(::Class_1_963E317C37FB5E9A_69* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_963E317C37FB5E9A_69*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICPRESETPLANVIEWMODEL__ADDPLAN_B__48_0_OFFSET))(this, a1);
		}
		...
		::System::Void _DeletePlan_b__51_0(::Class_1_D17272E82AE804C2_894* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_894*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICPRESETPLANVIEWMODEL__DELETEPLAN_B__51_0_OFFSET))(this, a1);
		}
	};
}
