...
#define RPG_CLIENT_GAMECORECAMERADATA_GETENEMYTEAMFORMATION_OFFSET UNITYSDK_OFFSET(0xBAB7050)
#define RPG_CLIENT_GAMECORECAMERADATA_GETFRIENDTEAMFORMATION_OFFSET UNITYSDK_OFFSET(0xBAB6FF0)
#define RPG_CLIENT_GAMECORECAMERADATA_GET_NATIVETIMESCALE_OFFSET UNITYSDK_OFFSET(0xBAB6FD0)
#define RPG_CLIENT_GAMECORECAMERADATA_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xBAB6CF0)
#define RPG_CLIENT_GAMECORECAMERADATA_SET_NATIVETIMESCALE_OFFSET UNITYSDK_OFFSET(0xBAB6FE0)
#define RPG_CLIENT_GAMECORECAMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAB70B0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::GameCore::AdventureCharacterController* LocalPlayerCharacterControllerRef; // 0x10
		::RPG::GameCore::GameEntity* ActiveEntityRef; // 0x18
		::RPG::GameCore::GameEntity* LightTeamEntityRef; // 0x20
		::RPG::GameCore::GameEntity* DarkTeamEntityRef; // 0x28
		::RPG::GameCore::TeamFormationComponent* DarkTeamFormationRef; // 0x30
		::RPG::GameCore::TeamDataComponent* DarkTeamDataComponentRef; // 0x38
		::RPG::GameCore::TeamDataComponent* LightTeamDataComponentRef; // 0x40
		::RPG::GameCore::GameEntity* TargetEntityRef; // 0x48
		...
		::RPG::GameCore::TurnBasedAbilityComponent* ActiveEntityTurnBasedAbilityRef; // 0x68
		::RPG::GameCore::SkillConfig* ActiveSkillConfigRef; // 0x70
		::RPG::GameCore::CharacterDataComponent* TargetEntityCharacterDataRef; // 0x78
		::RPG::GameCore::CharacterDataComponent* ActiveEntityCharacterDataRef; // 0x80
		::RPG::GameCore::SkillCharacterComponent* ActiveEntitySkillCharacterRef; // 0x88
		::RPG::GameCore::GameEntity* LocalPlayerRef; // 0x90
		::RPG::GameCore::TeamFormationComponent* LightTeamFormationRef; // 0x98
		::RPG::GameCore::SkillData* ActiveSkillDataRef; // 0xA0
		::Class_1_1CB8CBC69B962B41* CurrentActiveInsertAbilityRef; // 0xA8
