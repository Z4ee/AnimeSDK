...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_TRIGGEREFFECT_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x17428220)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_TRIGGEREFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x174282A0)
