...
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_FORMATDISPLAYDATABYTYPE_OFFSET UNITYSDK_OFFSET(0x182E4CB0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETAETHERMONSTERAVATARBASEVALUE_OFFSET UNITYSDK_OFFSET(0x182E70B0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETBASEVALUE_OFFSET UNITYSDK_OFFSET(0x182E4EE0)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETFINALVALUE_OFFSET UNITYSDK_OFFSET(0x182E4330)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GETPROPERTYADDVALUE_OFFSET UNITYSDK_OFFSET(0x182E5500)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_GET__AETHERMONSTERAVATARDATA_OFFSET UNITYSDK_OFFSET(0x182E7350)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_SETMODIFER_OFFSET UNITYSDK_OFFSET(0x182E6070)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA_SET__AETHERMONSTERAVATARDATA_OFFSET UNITYSDK_OFFSET(0x182E7360)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x182E3710)
#define RPG_CLIENT_AETHERMONSTERAVATARPROPERTYDATA__GETPROPERTYEXCELBASEDATA_OFFSET UNITYSDK_OFFSET(0x182E7140)

namespace RPG::Client
{
	inline static constexpr unsigned int AetherMonsterAvatarPropertyData_TypeDefinitionIndex = 59471;

	class AetherMonsterAvatarPropertyData : public ::System::Object
	{
	public:
		::System::Collections::Generic::SortedList_2<::RPG::Client::MonsterAvatarPropertySource, ::Class_1_44250175B60B216B*>* _PropertyModifiers; // 0x10
		::RPG::Client::AetherMonsterAvatarData* __AetherMonsterAvatarData_k__BackingField; // 0x18
