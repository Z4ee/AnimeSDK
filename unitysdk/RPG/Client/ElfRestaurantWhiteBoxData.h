...
#define RPG_CLIENT_ELFRESTAURANTWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95F3AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantWhiteBoxData_TypeDefinitionIndex = 59617;
