...
#define RPG_CLIENT_ELFRESTAURANTWHITEBOXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCE91590)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfRestaurantWhiteBoxData_TypeDefinitionIndex = 72668;
