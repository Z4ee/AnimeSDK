...
#define RPG_CLIENT_MONOHANDKILLTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D05E60)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoHandKillTrigger_TypeDefinitionIndex = 56176;
