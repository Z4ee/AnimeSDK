...
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xC357100)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC357170)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_GETSUBPATHDATA_OFFSET UNITYSDK_OFFSET(0xC356810)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_GET_ISMISSIONDATAREADY_OFFSET UNITYSDK_OFFSET(0xC358140)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_ONRECONNECT_OFFSET UNITYSDK_OFFSET(0xC357210)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_REFRESHEARLYACCESSINFO_OFFSET UNITYSDK_OFFSET(0xC357250)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_REQUESTMISSIONDATA_OFFSET UNITYSDK_OFFSET(0xC3577E0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA_SET_ISMISSIONDATAREADY_OFFSET UNITYSDK_OFFSET(0xC358150)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC357160)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__GETDEPENDANTMAINMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xC357A80)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__GETDEPENDANTSUBMISSIONIDS_OFFSET UNITYSDK_OFFSET(0xC357CA0)
#define RPG_CLIENT_PENACONYENDMOSTCHRONICLEDATA__REQUESTMISSIONDATA_B__5_0_OFFSET UNITYSDK_OFFSET(0xC358160)

namespace RPG::Client
{
	inline static constexpr unsigned int PenaconyEndmostChronicleData_TypeDefinitionIndex = 61800;
