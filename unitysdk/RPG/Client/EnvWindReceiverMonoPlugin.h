...
#define RPG_CLIENT_ENVWINDRECEIVERMONOPLUGIN_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA291420)
#define RPG_CLIENT_ENVWINDRECEIVERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA291470)
#define RPG_CLIENT_ENVWINDRECEIVERMONOPLUGIN___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0xA2914A0)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindReceiverMonoPlugin_TypeDefinitionIndex = 65492;
