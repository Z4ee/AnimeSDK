...
#define RPG_CLIENT_MONSTERPHASECHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1955AC70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterPhaseChangeParams_TypeDefinitionIndex = 69033;
