...
#define RPG_CLIENT_MONSTERPHASECHANGEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xC19BD30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterPhaseChangeParams_TypeDefinitionIndex = 67551;
