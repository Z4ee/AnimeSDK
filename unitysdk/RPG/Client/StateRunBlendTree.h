...
namespace RPG::Client { class StateRunBlendTree_Class_1_3B76E13757985C28_4; }
...
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_0F9F7473284990EE_OFFSET UNITYSDK_OFFSET(0x1A503B80)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_253939E38255333C_OFFSET UNITYSDK_OFFSET(0x1A503DC0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_316207AB65D83105_OFFSET UNITYSDK_OFFSET(0x1A503110)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_3FC863B885E15ED5_OFFSET UNITYSDK_OFFSET(0x1A502BD0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_41674EA405344719_OFFSET UNITYSDK_OFFSET(0x1A504640)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_5200FCB2A2AED1C2_OFFSET UNITYSDK_OFFSET(0x1A5042E0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_66019C9C927A7F81_OFFSET UNITYSDK_OFFSET(0x1A5049B0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_8B9FCF9FEE524950_OFFSET UNITYSDK_OFFSET(0x1A504030)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_ADEAE61287244F20_OFFSET UNITYSDK_OFFSET(0x1A502FC0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_AF2A45B2392898DF_OFFSET UNITYSDK_OFFSET(0x1A5047C0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_B03EF55092168CAF_OFFSET UNITYSDK_OFFSET(0x1A5024B0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BAC72019BD607572_OFFSET UNITYSDK_OFFSET(0x1A5035D0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_D1A394DDCA154DC3_OFFSET UNITYSDK_OFFSET(0x1A502F10)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_D806DABEADBC80D3_OFFSET UNITYSDK_OFFSET(0x1A503340)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_DAB6E73F3199851E_OFFSET UNITYSDK_OFFSET(0x1A503480)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_DE161DB52776BD8F_OFFSET UNITYSDK_OFFSET(0x1A5031B0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A502440)
#define RPG_CLIENT_STATERUNBLENDTREE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A5023E0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x1A5027C0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x1A504430)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A503740)
#define RPG_CLIENT_STATERUNBLENDTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A504A50)

namespace RPG::Client
{
	inline static constexpr unsigned int StateRunBlendTree_TypeDefinitionIndex = 68808;
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::StateRunBlendTree_Class_1_3B76E13757985C28_4*>* _poseLerpDatas; // 0xD8
