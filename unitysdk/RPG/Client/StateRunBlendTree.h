...
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_0F9F7473284990EE_OFFSET UNITYSDK_OFFSET(0xA4DE340)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_253939E38255333C_OFFSET UNITYSDK_OFFSET(0xA4DE580)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_316207AB65D83105_OFFSET UNITYSDK_OFFSET(0xA4DD8C0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_3FC863B885E15ED5_OFFSET UNITYSDK_OFFSET(0xA4DD2D0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_41674EA405344719_OFFSET UNITYSDK_OFFSET(0xA4DEE00)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_5200FCB2A2AED1C2_OFFSET UNITYSDK_OFFSET(0xA4DEA90)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_66019C9C927A7F81_OFFSET UNITYSDK_OFFSET(0xA4DF180)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_8B9FCF9FEE524950_OFFSET UNITYSDK_OFFSET(0xA4DE7F0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_AF2A45B2392898DF_OFFSET UNITYSDK_OFFSET(0xA4DEF80)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BA29415E87DA466B_OFFSET UNITYSDK_OFFSET(0xA4DCC30)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BAC72019BD607572_OFFSET UNITYSDK_OFFSET(0xA4DDD80)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_BC809936E0F4F009_OFFSET UNITYSDK_OFFSET(0xA4DD740)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_D1A394DDCA154DC3_OFFSET UNITYSDK_OFFSET(0xA4DD690)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_D806DABEADBC80D3_OFFSET UNITYSDK_OFFSET(0xA4DDAF0)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_DAB6E73F3199851E_OFFSET UNITYSDK_OFFSET(0xA4DDC30)
#define RPG_CLIENT_STATERUNBLENDTREE_METHOD_4_DE161DB52776BD8F_OFFSET UNITYSDK_OFFSET(0xA4DD960)
#define RPG_CLIENT_STATERUNBLENDTREE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA4DCBC0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA4DCB60)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DCEC0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4DEBF0)
#define RPG_CLIENT_STATERUNBLENDTREE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4DDEF0)
#define RPG_CLIENT_STATERUNBLENDTREE__CTOR_OFFSET UNITYSDK_OFFSET(0xA4DF220)
#define RPG_CLIENT_STATERUNBLENDTREE___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4DF290)
#define RPG_CLIENT_STATERUNBLENDTREE___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4DF2B0)
#define RPG_CLIENT_STATERUNBLENDTREE___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4DF2A0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateRunBlendTree_TypeDefinitionIndex = 56239;
