...
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xE286050)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xE2867B0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xE286F60)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_13D8773148BD1DCD_OFFSET UNITYSDK_OFFSET(0xE289820)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0xE286FA0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xE286FF0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xE286C90)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_48EE6F8CA58AC368_OFFSET UNITYSDK_OFFSET(0xE2871A0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0xE2896B0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0xE286D00)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_1_OFFSET UNITYSDK_OFFSET(0xE288B30)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_OFFSET UNITYSDK_OFFSET(0xE288390)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0xE287540)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_A9A50625EA2594BB_OFFSET UNITYSDK_OFFSET(0xE287720)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0xE2895D0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xE289640)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0xE2892D0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xE2870C0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0xE287100)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0xE289590)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0xE289B50)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xE287080)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xE287140)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xE289C10)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xE289BA0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x13530);
		}
		static ::System::Int32* StaticGet__SpeedRatioAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x13534);
		}
		static ::System::Int32* StaticGet__StayAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x13538);
		}
