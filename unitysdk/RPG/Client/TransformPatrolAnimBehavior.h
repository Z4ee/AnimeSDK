...
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x1B2ACAD0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x1B2AD230)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x1B2AD9E0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_13D8773148BD1DCD_OFFSET UNITYSDK_OFFSET(0x1B2B02A0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_3C56C1AF247AC1EC_OFFSET UNITYSDK_OFFSET(0x1B2ADA20)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x1B2ADA70)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B2AD710)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_48EE6F8CA58AC368_OFFSET UNITYSDK_OFFSET(0x1B2ADC20)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0x1B2B0130)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_62167C28EC14CC63_OFFSET UNITYSDK_OFFSET(0x1B2AD780)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_1_OFFSET UNITYSDK_OFFSET(0x1B2AF5B0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_6A8EC1C1458586F1_OFFSET UNITYSDK_OFFSET(0x1B2AEE10)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_9F8F6511E8EF1235_OFFSET UNITYSDK_OFFSET(0x1B2ADFC0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_A9A50625EA2594BB_OFFSET UNITYSDK_OFFSET(0x1B2AE1A0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_1_OFFSET UNITYSDK_OFFSET(0x1B2B0050)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1B2B00C0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_B1EA412ACAE87C15_OFFSET UNITYSDK_OFFSET(0x1B2AFD50)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1B2ADB40)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x1B2ADB80)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x1B2B0010)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x1B2B05D0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1B2ADB00)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x1B2ADBC0)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2B0690)
#define RPG_CLIENT_TRANSFORMPATROLANIMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B0620)

namespace RPG::Client
{
	inline static constexpr unsigned int TransformPatrolAnimBehavior_TypeDefinitionIndex = 70302;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x12AF0);
		}
		static ::System::Int32* StaticGet__CurrentPatrolPointAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x12AF4);
		}
		static ::System::Int32* StaticGet__SpeedRatioAnimatorHash()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TransformPatrolAnimBehavior_TypeDefinitionIndex)->GetStaticField(0x12AF8);
		}
