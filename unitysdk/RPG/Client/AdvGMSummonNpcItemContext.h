...
#define RPG_CLIENT_ADVGMSUMMONNPCITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C7CA80)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvGMSummonNpcItemContext_TypeDefinitionIndex = 67000;
