...
#define RPG_CLIENT_ADVGMSUMMONNPCITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAADB0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvGMSummonNpcItemContext_TypeDefinitionIndex = 69428;
