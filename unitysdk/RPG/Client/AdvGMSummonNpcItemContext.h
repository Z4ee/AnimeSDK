...
#define RPG_CLIENT_ADVGMSUMMONNPCITEMCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x901F640)

namespace RPG::Client
{
	inline static constexpr unsigned int AdvGMSummonNpcItemContext_TypeDefinitionIndex = 59604;
