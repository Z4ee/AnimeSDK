...
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x92415B0)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_GET_FOLLOWGO_OFFSET UNITYSDK_OFFSET(0x92416F0)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_GET_NEEDDESTROY_OFFSET UNITYSDK_OFFSET(0x9241710)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_GET_OWNERDATA_OFFSET UNITYSDK_OFFSET(0x92416D0)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_SET_FOLLOWGO_OFFSET UNITYSDK_OFFSET(0x9241700)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_SET_NEEDDESTROY_OFFSET UNITYSDK_OFFSET(0x9241720)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA_SET_OWNERDATA_OFFSET UNITYSDK_OFFSET(0x92416E0)
#define RPG_CLIENT_CAKERACEHUDFOLLOWHEADICONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9241650)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceHUDFollowHeadIconData_TypeDefinitionIndex = 51142;
