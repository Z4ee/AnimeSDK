...
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C60AC0)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18C60C70)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_METHOD_5_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x18C60E90)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C60BF0)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C61000)
