...
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA9E0CE0)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA9E0E90)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_METHOD_5_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0xA9E10C0)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA9E0E10)
#define RPG_CLIENT_MONOMATERIALPROPERTYMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9E1270)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaterialPropertyModifier_TypeDefinitionIndex = 63169;
