...
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_GET_RAIDCOLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x17986820)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x179867D0)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_ISSHOWNOPASSNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x17986610)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_SET_RAIDCOLLECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x17986830)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA_SHOWCOLLECTIONNEW_OFFSET UNITYSDK_OFFSET(0x17986740)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17986570)
#define RPG_CLIENT_RESIDENTRAIDCOLLECTIONACTIVITYDATA__ONINIT_OFFSET UNITYSDK_OFFSET(0x17986580)
