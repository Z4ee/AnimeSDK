...
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19E400A0)
#define RPG_CLIENT_MONOCURVETRIGGERMANAGER___C__DISPLAYCLASS13_0__UPDATEMOVABLEOBJECTLOGICTRIGGER_B__0_OFFSET UNITYSDK_OFFSET(0x19E40B10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoCurveTriggerManager___c__DisplayClass13_0_TypeDefinitionIndex = 68525;
