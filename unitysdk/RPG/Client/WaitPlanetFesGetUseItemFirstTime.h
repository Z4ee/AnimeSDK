...
#define RPG_CLIENT_WAITPLANETFESGETUSEITEMFIRSTTIME_METHOD_3_0CE1FC8757E09E2B_OFFSET UNITYSDK_OFFSET(0x193BF870)
#define RPG_CLIENT_WAITPLANETFESGETUSEITEMFIRSTTIME_METHOD_3_1BB6A193BFA0B3B7_OFFSET UNITYSDK_OFFSET(0x193BF760)
#define RPG_CLIENT_WAITPLANETFESGETUSEITEMFIRSTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x193BF840)

namespace RPG::Client
{
	inline static constexpr unsigned int WaitPlanetFesGetUseItemFirstTime_TypeDefinitionIndex = 9949;
