...
#define RPG_CLIENT_WAITPLANETFESGETUSEITEMFIRSTTIME_METHOD_3_0CE1FC8757E09E2B_OFFSET UNITYSDK_OFFSET(0x1D321010)
#define RPG_CLIENT_WAITPLANETFESGETUSEITEMFIRSTTIME_METHOD_3_1B6B1FE3D3DE58AE_OFFSET UNITYSDK_OFFSET(0x1D320F40)
#define RPG_CLIENT_WAITPLANETFESGETUSEITEMFIRSTTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1D321000)

namespace RPG::Client
{
	inline static constexpr unsigned int WaitPlanetFesGetUseItemFirstTime_TypeDefinitionIndex = 10263;
