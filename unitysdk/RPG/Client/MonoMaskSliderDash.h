...
#define RPG_CLIENT_MONOMASKSLIDERDASH_GETRATIO_OFFSET UNITYSDK_OFFSET(0x9D1D560)
#define RPG_CLIENT_MONOMASKSLIDERDASH_REFRESHANIM_OFFSET UNITYSDK_OFFSET(0x9D1D5D0)
#define RPG_CLIENT_MONOMASKSLIDERDASH_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x9D1D1F0)
#define RPG_CLIENT_MONOMASKSLIDERDASH__CTOR_OFFSET UNITYSDK_OFFSET(0x9D1D6B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaskSliderDash_TypeDefinitionIndex = 59487;
