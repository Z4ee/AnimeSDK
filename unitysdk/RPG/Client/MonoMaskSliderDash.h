...
#define RPG_CLIENT_MONOMASKSLIDERDASH_GETRATIO_OFFSET UNITYSDK_OFFSET(0xA9E08E0)
#define RPG_CLIENT_MONOMASKSLIDERDASH_REFRESHANIM_OFFSET UNITYSDK_OFFSET(0xA9E0950)
#define RPG_CLIENT_MONOMASKSLIDERDASH_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0xA9E0570)
#define RPG_CLIENT_MONOMASKSLIDERDASH__CTOR_OFFSET UNITYSDK_OFFSET(0xA9E0A30)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoMaskSliderDash_TypeDefinitionIndex = 66882;
