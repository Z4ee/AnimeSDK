...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0x1A35B810)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0x1A35B350)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_0C65243341F1EFB1_OFFSET UNITYSDK_OFFSET(0x1A35BAA0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x1A35BB50)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_5543817C5A5F79C6_OFFSET UNITYSDK_OFFSET(0x1A35BBD0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_7933D8FAF1D97D04_OFFSET UNITYSDK_OFFSET(0x1A35AA90)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_86A88E9E65926C16_OFFSET UNITYSDK_OFFSET(0x1A35ADC0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_913947B6596EB50A_OFFSET UNITYSDK_OFFSET(0x1A35B160)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x1A35B0E0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A35A8A0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A35A6F0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A35AC60)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1A35AF80)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35BCD0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTravelShipStation_TypeDefinitionIndex = 65715;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0xF190);
		}
