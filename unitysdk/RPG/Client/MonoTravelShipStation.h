...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0xC155690)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0xC1551D0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0xC155A20)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_2B1380CB28524A16_OFFSET UNITYSDK_OFFSET(0xC155920)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_5543817C5A5F79C6_OFFSET UNITYSDK_OFFSET(0xC155AA0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_7933D8FAF1D97D04_OFFSET UNITYSDK_OFFSET(0xC154880)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_86A88E9E65926C16_OFFSET UNITYSDK_OFFSET(0xC154BF0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xC154F50)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_FF05AC0AB0D75A04_OFFSET UNITYSDK_OFFSET(0xC154FD0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC154690)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC1544E0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xC154A50)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0xC154DB0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xC155BA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoTravelShipStation_TypeDefinitionIndex = 64344;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0x139B0);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_2B1380CB28524A16_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_FF05AC0AB0D75A04_OFFSET))(this);
		}
