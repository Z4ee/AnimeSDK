...
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_GET_COLLIDERCENTER_OFFSET UNITYSDK_OFFSET(0x1C28DA80)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ISLOOKAT_OFFSET UNITYSDK_OFFSET(0x1C28D5C0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_0C65243341F1EFB1_OFFSET UNITYSDK_OFFSET(0x1C28DD10)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x1C28DDC0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_5543817C5A5F79C6_OFFSET UNITYSDK_OFFSET(0x1C28DE40)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_7933D8FAF1D97D04_OFFSET UNITYSDK_OFFSET(0x1C28CD10)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_86A88E9E65926C16_OFFSET UNITYSDK_OFFSET(0x1C28D030)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_913947B6596EB50A_OFFSET UNITYSDK_OFFSET(0x1C28D3C0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_METHOD_5_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x1C28D340)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C28CB20)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C28C970)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1C28CEE0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION_ONTRIGGERSTAY_OFFSET UNITYSDK_OFFSET(0x1C28D1F0)
#define RPG_CLIENT_MONOTRAVELSHIPSTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C28DF40)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoTravelShipStation_TypeDefinitionIndex)->GetStaticField(0x94A0);
		}
