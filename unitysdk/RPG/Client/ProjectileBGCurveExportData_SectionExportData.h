...
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xDBC4210)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_LASTESTPOINT_OFFSET UNITYSDK_OFFSET(0xDBC3B70)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_STARTPOINT_OFFSET UNITYSDK_OFFSET(0xDBC3C10)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_METHOD_1_808C6C68ABE77F5C_OFFSET UNITYSDK_OFFSET(0xDBC3E00)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_METHOD_1_E95D3AD413F190D9_OFFSET UNITYSDK_OFFSET(0xDBC4260)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDBC43D0)
