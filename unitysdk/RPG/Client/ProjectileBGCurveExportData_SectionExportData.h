...
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0xAD78880)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_LASTESTPOINT_OFFSET UNITYSDK_OFFSET(0xAD78280)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_GET_STARTPOINT_OFFSET UNITYSDK_OFFSET(0xAD78310)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_METHOD_1_05DAE9A4B2E860C3_OFFSET UNITYSDK_OFFSET(0xAD788D0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA_METHOD_1_E134B9B0C81F1AED_OFFSET UNITYSDK_OFFSET(0xAD784D0)
#define RPG_CLIENT_PROJECTILEBGCURVEEXPORTDATA_SECTIONEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAD78A10)

namespace RPG::Client
{
	inline static constexpr unsigned int ProjectileBGCurveExportData_SectionExportData_TypeDefinitionIndex = 64665;
