...
#define RPG_CLIENT_MONOEXUICAMERA2DRETARGET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACD6BC0)
#define RPG_CLIENT_MONOEXUICAMERA2DRETARGET_INIT_OFFSET UNITYSDK_OFFSET(0x1ACD69D0)
#define RPG_CLIENT_MONOEXUICAMERA2DRETARGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACD6CC0)
#define RPG_CLIENT_MONOEXUICAMERA2DRETARGET__CONVERTSCALEFROMPOSZ_OFFSET UNITYSDK_OFFSET(0x1ACD70F0)
#define RPG_CLIENT_MONOEXUICAMERA2DRETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD71D0)
#define RPG_CLIENT_MONOEXUICAMERA2DRETARGET__UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x1ACD6D10)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoExUICamera2DRetarget_TypeDefinitionIndex = 72901;
