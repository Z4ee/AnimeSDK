...
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETAVATARIDBYCHOOSEDELIVERYGROUPID_OFFSET UNITYSDK_OFFSET(0x1A38E650)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETAVATARREWARDLIST_OFFSET UNITYSDK_OFFSET(0x1A38E760)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETFATERINCHOOSEDELIVERYENTRY_OFFSET UNITYSDK_OFFSET(0x1A38DAC0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETFRIENDAVATARIDBYCHOOSEDELIVERYGROUPID_OFFSET UNITYSDK_OFFSET(0x1A38E930)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_DELIVERYENTRYID_OFFSET UNITYSDK_OFFSET(0x1A38CF40)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_REWARDAVATARFRIENDIDLIST_OFFSET UNITYSDK_OFFSET(0x1A38D490)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_REWARDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0x1A38D210)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_VIDEOLIST_OFFSET UNITYSDK_OFFSET(0x1A38CF90)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x1A38D710)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0x1A38D760)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__CHOOSEDELIVERYNOTICETOASTSHOWN_OFFSET UNITYSDK_OFFSET(0x1A38E3D0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A38E9F0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__FATERINONCLOSEAVATARTOASTDIALOGNOTIFY_OFFSET UNITYSDK_OFFSET(0x1A38E190)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__GETINDEXBYGROUPID_OFFSET UNITYSDK_OFFSET(0x1A38E710)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ISFATERINCOLLECTIONACTIVITYISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x1A38DD10)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONFINISHEDMAINMISSION_OFFSET UNITYSDK_OFFSET(0x1A38DC10)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONFINISHSUBMISSION_OFFSET UNITYSDK_OFFSET(0x1A38DE10)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONMAZEHUDFATERINICONTRANSFORMREFRESH_OFFSET UNITYSDK_OFFSET(0x1A38E110)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONSHOWMAZEMAINPAGE_OFFSET UNITYSDK_OFFSET(0x1A38E600)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__TRYSHOWFATERINACTIVITYGUIDETOAST_OFFSET UNITYSDK_OFFSET(0x1A38E4C0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__TRYTRIGGERTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1A38DF80)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinSupportModule_TypeDefinitionIndex = 75674;

	class FateRinSupportModule : public ::RPG::Client::BaseModule
	{
	public:
		::System::Collections::Generic::List_1<::System::UInt32>* _RewardAvatarIDList; // 0x10
		::System::Collections::Generic::List_1<::System::UInt32>* _RewardAvatarFriendIDList; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* _VideoList; // 0x20
		::UnityEngine::Transform* IconTransform; // 0x28
		::System::UInt32 _ActivityOpenMissionID; // 0x30
		::System::Boolean _shouldShowActivityGuideToast; // 0x34
