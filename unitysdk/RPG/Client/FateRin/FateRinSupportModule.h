...
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETAVATARIDBYCHOOSEDELIVERYGROUPID_OFFSET UNITYSDK_OFFSET(0xD009700)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETAVATARREWARDLIST_OFFSET UNITYSDK_OFFSET(0xD009810)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETFATERINCHOOSEDELIVERYENTRY_OFFSET UNITYSDK_OFFSET(0xD008AA0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GETFRIENDAVATARIDBYCHOOSEDELIVERYGROUPID_OFFSET UNITYSDK_OFFSET(0xD0099E0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_DELIVERYENTRYID_OFFSET UNITYSDK_OFFSET(0xD007F20)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_REWARDAVATARFRIENDIDLIST_OFFSET UNITYSDK_OFFSET(0xD008470)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_REWARDAVATARIDLIST_OFFSET UNITYSDK_OFFSET(0xD0081F0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_GET_VIDEOLIST_OFFSET UNITYSDK_OFFSET(0xD007F70)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xD0086F0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ADDNOTIFYHANDLERS_OFFSET UNITYSDK_OFFSET(0xD008740)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__CHOOSEDELIVERYNOTICETOASTSHOWN_OFFSET UNITYSDK_OFFSET(0xD009480)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xD009AA0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__FATERINONCLOSEAVATARTOASTDIALOGNOTIFY_OFFSET UNITYSDK_OFFSET(0xD009170)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__GETINDEXBYGROUPID_OFFSET UNITYSDK_OFFSET(0xD0097C0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ISFATERINCOLLECTIONACTIVITYISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0xD008CF0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONFINISHEDMAINMISSION_OFFSET UNITYSDK_OFFSET(0xD008BF0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONFINISHSUBMISSION_OFFSET UNITYSDK_OFFSET(0xD008DF0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONMAZEHUDFATERINICONTRANSFORMREFRESH_OFFSET UNITYSDK_OFFSET(0xD0090F0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__ONSHOWMAZEMAINPAGE_OFFSET UNITYSDK_OFFSET(0xD0096B0)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__TRYSHOWFATERINACTIVITYGUIDETOAST_OFFSET UNITYSDK_OFFSET(0xD009570)
#define RPG_CLIENT_FATERIN_FATERINSUPPORTMODULE__TRYTRIGGERTUTORIAL_OFFSET UNITYSDK_OFFSET(0xD008F60)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinSupportModule_TypeDefinitionIndex = 79308;

	class FateRinSupportModule : public ::RPG::Client::BaseModule
	{
	public:
		::UnityEngine::Transform* IconTransform; // 0x10
		::System::Collections::Generic::List_1<::System::UInt32>* _RewardAvatarIDList; // 0x18
		::System::Collections::Generic::List_1<::System::UInt32>* _RewardAvatarFriendIDList; // 0x20
		::System::Collections::Generic::List_1<::System::UInt32>* _VideoList; // 0x28
