...
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_ADD_ONQUESTGETREWARD_OFFSET UNITYSDK_OFFSET(0x1B5B36C0)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_GET_INITTABGROUPID_OFFSET UNITYSDK_OFFSET(0x1B5B3680)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_GET_INITTABID_OFFSET UNITYSDK_OFFSET(0x1B5B36A0)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_GET_LONGTAILREWARDITEMLIST_OFFSET UNITYSDK_OFFSET(0x1B5B3570)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_GET_ONUIDISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5B3780)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_GET_STORYQUESTLIST_OFFSET UNITYSDK_OFFSET(0x1B5B3670)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_REMOVE_ONQUESTGETREWARD_OFFSET UNITYSDK_OFFSET(0x1B5B3720)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_SET_INITTABGROUPID_OFFSET UNITYSDK_OFFSET(0x1B5B3690)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_SET_INITTABID_OFFSET UNITYSDK_OFFSET(0x1B5B36B0)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL_SET_ONUIDISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5B3790)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5B1620)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL__DECIDEINITSHOWTAB_OFFSET UNITYSDK_OFFSET(0x1B5B27C0)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL__ONQUESTGETREWARD_OFFSET UNITYSDK_OFFSET(0x1B5B3500)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL__ONUIDISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5B35B0)
#define RPG_CLIENT_FATERIN_REWARD_FATERINRESIDENTREWARDVIEWMODEL__REFRESHCLAIMEDCOUNTS_OFFSET UNITYSDK_OFFSET(0x1B5B1EA0)

namespace RPG::Client::FateRin::Reward
{
	inline static constexpr unsigned int FateRinResidentRewardViewModel_TypeDefinitionIndex = 79407;
	...
	public:
		...
		::Class_0_16E4307DCC419505_318* _OnUIDispose_k__BackingField; // 0x38
