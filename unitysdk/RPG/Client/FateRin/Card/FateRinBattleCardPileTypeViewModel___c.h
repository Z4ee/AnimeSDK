...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xCFDEC10)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDEC50)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL___C___CTOR_B__0_0_OFFSET UNITYSDK_OFFSET(0xCFDEC60)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL___C___CTOR_B__0_2_OFFSET UNITYSDK_OFFSET(0xCFDEC90)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardPileTypeViewModel___c_TypeDefinitionIndex = 79797;
	...
	public:
		...
		{
			return (::System::Func_2<::Class_1_B71FC14BA77C9F77*, ::RPG::GameCore::FateRinHouguOwnerType>**)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleCardPileTypeViewModel___c_TypeDefinitionIndex)->GetStaticField(0x2EE0);
		}
		static ::RPG::Client::FateRin::Card::FateRinBattleCardPileTypeViewModel___c** StaticGet___9()
		{
			return (::RPG::Client::FateRin::Card::FateRinBattleCardPileTypeViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleCardPileTypeViewModel___c_TypeDefinitionIndex)->GetStaticField(0x2EE8);
		}
		static ::System::Comparison_1<::RPG::Client::FateRin::Card::IFateRinBattleCardPileSectionViewModel*>** StaticGet___9__0_2()
		{
			return (::System::Comparison_1<::RPG::Client::FateRin::Card::IFateRinBattleCardPileSectionViewModel*>**)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleCardPileTypeViewModel___c_TypeDefinitionIndex)->GetStaticField(0x2EF0);
		}
