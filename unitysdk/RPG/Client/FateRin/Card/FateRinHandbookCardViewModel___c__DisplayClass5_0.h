...
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDVIEWMODEL___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBEB120)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDVIEWMODEL___C__DISPLAYCLASS5_0___GETCARDVIEWMODELLISTBYTABOWNERTYPE_B__1_OFFSET UNITYSDK_OFFSET(0x1CBEBA20)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDVIEWMODEL___C__DISPLAYCLASS5_0___GETCARDVIEWMODELLISTBYTABOWNERTYPE_B__2_OFFSET UNITYSDK_OFFSET(0x1CBEBA50)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinHandbookCardViewModel___c__DisplayClass5_0_TypeDefinitionIndex = 79866;
