...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBDDC80)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL___C__DISPLAYCLASS0_0___CTOR_B__1_OFFSET UNITYSDK_OFFSET(0x1CBDE0F0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardPileTypeViewModel___c__DisplayClass0_0_TypeDefinitionIndex = 79797;

	class FateRinBattleCardPileTypeViewModel___c__DisplayClass0_0 : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_1371* ownerFactory; // 0x10
		::Class_0_16E4307DCC419505_1370* cardVmFactory; // 0x18
		::Class_1_426391BD841CEF9C* cardGameModel; // 0x20
