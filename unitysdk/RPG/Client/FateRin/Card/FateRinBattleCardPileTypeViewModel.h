...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B49B100)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL_GET_SECTIONVIEWMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B49B310)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL_GET_TABICONPATH_OFFSET UNITYSDK_OFFSET(0x1B49B260)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B49B0E0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B49B0F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49AB70)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL__GETCARDMODELLIST_OFFSET UNITYSDK_OFFSET(0x1B49B000)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardPileTypeViewModel_TypeDefinitionIndex = 76162;

	class FateRinBattleCardPileTypeViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::System::Collections::ObjectModel::ReadOnlyCollection_1<::RPG::Client::FateRin::Card::IFateRinBattleCardPileSectionViewModel*>* _SectionViewModelList_ReadOnly; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Card::IFateRinBattleCardPileSectionViewModel*>* _SectionViewModelList; // 0x28
		::RPG::Client::FateRin::Card::FateRinBattleCardPileType _Type_k__BackingField; // 0x30

		::System::Void _ctor(::RPG::Client::FateRin::Card::FateRinBattleCardPileType a1, ::Class_1_F4140148FE9021F9* a2, ::Class_0_16E4307DCC419505_1289* a3, ::Class_0_16E4307DCC419505_1290* a4, ::Class_1_5F4D64A4B97E38F9* a5)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::FateRin::Card::FateRinBattleCardPileType, ::Class_1_F4140148FE9021F9*, ::Class_0_16E4307DCC419505_1289*, ::Class_0_16E4307DCC419505_1290*, ::Class_1_5F4D64A4B97E38F9*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDPILETYPEVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3, a4, a5);
		}
