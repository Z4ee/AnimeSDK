...
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xCFE4C30)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_DECK_OFFSET UNITYSDK_OFFSET(0xCFE52D0)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_ISINDELETESTATE_OFFSET UNITYSDK_OFFSET(0xCFE52F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0xCFE5320)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_SAVECHANGESTOUPPERPAGE_OFFSET UNITYSDK_OFFSET(0xCFE5330)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_GET_SWITCHDELETESTATE_OFFSET UNITYSDK_OFFSET(0xCFE5310)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_SET_DECK_OFFSET UNITYSDK_OFFSET(0xCFE52E0)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL_SET_ISINDELETESTATE_OFFSET UNITYSDK_OFFSET(0xCFE5300)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE4A30)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__ONCARDCLICK_OFFSET UNITYSDK_OFFSET(0xCFE4F10)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__SAVECHANGESTOUPPERPAGE_OFFSET UNITYSDK_OFFSET(0xCFE51F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__SWITCHDELETESTATE_OFFSET UNITYSDK_OFFSET(0xCFE4E70)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinDeckEditPreviewViewModel_TypeDefinitionIndex = 79835;

	class FateRinDeckEditPreviewViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::RPG::Client::FateRin::Card::FateRinCardDeckViewModel* _Deck_k__BackingField; // 0x20
		...
		::Class_0_16E4307DCC419505_1370* _OwnerVmFactory; // 0x40
		::Class_0_16E4307DCC419505_320<::RPG::Client::FateRin::Card::IFateRinSystemCardViewModel*>* _OnCardClick_k__BackingField; // 0x48
		::Class_0_16E4307DCC419505_318* _SaveChangesToUpperPage_k__BackingField; // 0x50
		::Class_0_16E4307DCC419505_318* _SwitchDeleteState_k__BackingField; // 0x58
		::System::Boolean _DeckModified; // 0x60
		::System::Boolean _IsInDeleteState_k__BackingField; // 0x61

		::System::Void _ctor(::Class_1_4557C77922A20D8C* a1, ::Class_1_7B5BC5F7531D3B01* a2, ::Class_0_16E4307DCC419505_1370* a3, ::Class_1_5F4D64A4B97E38F9* a4)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_4557C77922A20D8C*, ::Class_1_7B5BC5F7531D3B01*, ::Class_0_16E4307DCC419505_1370*, ::Class_1_5F4D64A4B97E38F9*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITPREVIEWVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3, a4);
		}
