...
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1CBDC350)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL_GET_MANACOST_OFFSET UNITYSDK_OFFSET(0x1CBDC430)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0x1CBDC480)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBDC2A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINBATTLECARDMANACOSTVIEWMODEL__ONBATTLECARDMODELCHANGEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1CBDC3C0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinBattleCardManaCostViewModel_TypeDefinitionIndex = 79821;
