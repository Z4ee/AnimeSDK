...
#define RPG_CLIENT_FATERIN_CARD_IFATERINCARDDECKVIEWMODELEXTENSIONS_CONTAINSCARD_OFFSET UNITYSDK_OFFSET(0x1CBEDD00)
#define RPG_CLIENT_FATERIN_CARD_IFATERINCARDDECKVIEWMODELEXTENSIONS_GETALLCARDSCOUNT_OFFSET UNITYSDK_OFFSET(0x1CBF38E0)
#define RPG_CLIENT_FATERIN_CARD_IFATERINCARDDECKVIEWMODELEXTENSIONS_GETALLCARDSLIST_OFFSET UNITYSDK_OFFSET(0x1CBF3720)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int IFateRinCardDeckViewModelExtensions_TypeDefinitionIndex = 79811;
