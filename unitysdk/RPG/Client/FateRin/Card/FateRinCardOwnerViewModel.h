...
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1B49F690)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_DECKSIZELIMIT_OFFSET UNITYSDK_OFFSET(0x1B49F640)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_ISNEUTRAL_OFFSET UNITYSDK_OFFSET(0x1B49F600)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B49F5A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_OWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0x1B49F6A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_TYPENUMBER_OFFSET UNITYSDK_OFFSET(0x1B49F520)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B49F4D0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0x1B49F7F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49F460)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinCardOwnerViewModel_TypeDefinitionIndex = 76190;

	class FateRinCardOwnerViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::RPG::AvatarSystem::IAvatar* _AvatarModel; // 0x20
		::RPG::Client::FateRin::Avatar::IFateRinAvatarViewModel* _Avatar_k__BackingField; // 0x28
		::Class_1_DD62B922D9C7B62B* _Model; // 0x30

		::System::Void _ctor(::Class_1_DD62B922D9C7B62B* a1, ::Class_1_F248B058F5A06B98* a2, ::Class_0_16E4307DCC419505_1272* a3)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_DD62B922D9C7B62B*, ::Class_1_F248B058F5A06B98*, ::Class_0_16E4307DCC419505_1272*))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL__CTOR_OFFSET))(this, a1, a2, a3);
		}
