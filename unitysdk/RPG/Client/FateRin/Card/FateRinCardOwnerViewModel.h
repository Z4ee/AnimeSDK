...
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1CBE26A0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_DECKSIZELIMIT_OFFSET UNITYSDK_OFFSET(0x1CBE2650)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_ISNEUTRAL_OFFSET UNITYSDK_OFFSET(0x1CBE2610)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CBE25B0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_OWNERMARKERICONPATH_OFFSET UNITYSDK_OFFSET(0x1CBE26B0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_TYPENUMBER_OFFSET UNITYSDK_OFFSET(0x1CBE2530)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CBE24E0)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL_GET_UICOLORSTATE_OFFSET UNITYSDK_OFFSET(0x1CBE2800)
#define RPG_CLIENT_FATERIN_CARD_FATERINCARDOWNERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBE2470)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinCardOwnerViewModel_TypeDefinitionIndex = 79823;
