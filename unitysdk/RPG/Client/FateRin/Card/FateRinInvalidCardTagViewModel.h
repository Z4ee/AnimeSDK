...
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B4A8250)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B4A81B0)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B4A82A0)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0x1B4A8310)
#define RPG_CLIENT_FATERIN_CARD_FATERININVALIDCARDTAGVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A81A0)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinInvalidCardTagViewModel_TypeDefinitionIndex = 76206;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::Card::FateRinInvalidCardTagViewModel**)Il2CppClass::FromTypeDefinitionIndex(FateRinInvalidCardTagViewModel_TypeDefinitionIndex)->GetStaticField(0x9310);
		}
