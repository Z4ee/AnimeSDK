...
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_ADD_ONSELECTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xCFE86F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_ISINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xCFE86D0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCFE8580)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0xCFE8540)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABICONPATH_OFFSET UNITYSDK_OFFSET(0xCFE8630)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABREPORTNAME_OFFSET UNITYSDK_OFFSET(0xCFE87B0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABTYPE_OFFSET UNITYSDK_OFFSET(0xCFE8470)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0xCFE8680)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_REMOVE_ONSELECTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0xCFE8750)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xCFE84C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SET_ISINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0xCFE86E0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SET_TABREPORTNAME_OFFSET UNITYSDK_OFFSET(0xCFE87C0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE8360)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinHandbookCardAllTabViewModel_TypeDefinitionIndex = 79859;
