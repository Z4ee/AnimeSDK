...
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_ADD_ONSELECTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1CBE7AB0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_ISINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x1CBE7A90)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1CBE7940)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_OWNERTYPE_OFFSET UNITYSDK_OFFSET(0x1CBE7900)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABICONPATH_OFFSET UNITYSDK_OFFSET(0x1CBE79F0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABREPORTNAME_OFFSET UNITYSDK_OFFSET(0x1CBE7B70)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_TABTYPE_OFFSET UNITYSDK_OFFSET(0x1CBE7830)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_GET_UISTATE_OFFSET UNITYSDK_OFFSET(0x1CBE7A40)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_REMOVE_ONSELECTSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1CBE7B10)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x1CBE7880)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SET_ISINSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x1CBE7AA0)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL_SET_TABREPORTNAME_OFFSET UNITYSDK_OFFSET(0x1CBE7B80)
#define RPG_CLIENT_FATERIN_CARD_FATERINHANDBOOKCARDALLTABVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBE7720)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinHandbookCardAllTabViewModel_TypeDefinitionIndex = 79858;
	...
	public:
		...
		::RPG::Client::FateRin::ViewModelEventHandler* OnSelectStateChange; // 0x28
