...
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITVIEWMODEL___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCFE7CE0)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITVIEWMODEL___C__DISPLAYCLASS2_0___DOSAVEDECKSANDEXIT_B__0_OFFSET UNITYSDK_OFFSET(0xCFE8150)
#define RPG_CLIENT_FATERIN_CARD_FATERINDECKEDITVIEWMODEL___C__DISPLAYCLASS2_0___DOSAVEDECKSANDEXIT_B__1_OFFSET UNITYSDK_OFFSET(0xCFE8220)

namespace RPG::Client::FateRin::Card
{
	inline static constexpr unsigned int FateRinDeckEditViewModel___c__DisplayClass2_0_TypeDefinitionIndex = 79838;
