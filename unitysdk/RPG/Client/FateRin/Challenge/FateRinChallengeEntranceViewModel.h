...
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_ADD_ONVIEWMODELEXITCONFIRM_OFFSET UNITYSDK_OFFSET(0xCFFEAA0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xCFFD910)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_GET_EXIT_OFFSET UNITYSDK_OFFSET(0xCFFEB70)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_GET_INITSELECTINGTABINDEX_OFFSET UNITYSDK_OFFSET(0xCFFEA60)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_GET_ISFIRSTPASSDEEP_OFFSET UNITYSDK_OFFSET(0xCFFEA80)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_GET_LEVELINFOS_OFFSET UNITYSDK_OFFSET(0xCFFE860)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_GET_SHOWRESIDENTREWARD_OFFSET UNITYSDK_OFFSET(0xCFFEB60)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_GET_TABBTNS_OFFSET UNITYSDK_OFFSET(0xCFFE960)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_REMOVE_ONVIEWMODELEXITCONFIRM_OFFSET UNITYSDK_OFFSET(0xCFFEB00)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_SET_INITSELECTINGTABINDEX_OFFSET UNITYSDK_OFFSET(0xCFFEA70)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL_SET_ISFIRSTPASSDEEP_OFFSET UNITYSDK_OFFSET(0xCFFEA90)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL__BUILDSUBPANELVIEWMODELS_OFFSET UNITYSDK_OFFSET(0xCFFD430)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFD2C0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL__EXIT_OFFSET UNITYSDK_OFFSET(0xCFFE2D0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL__SAVESELECTEDBUFFINDEXES_OFFSET UNITYSDK_OFFSET(0xCFFE340)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGEENTRANCEVIEWMODEL__SHOWRESIDENTREWARD_OFFSET UNITYSDK_OFFSET(0xCFFE250)

namespace RPG::Client::FateRin::Challenge
{
	inline static constexpr unsigned int FateRinChallengeEntranceViewModel_TypeDefinitionIndex = 79706;

	class FateRinChallengeEntranceViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_0_16E4307DCC419505_318* _Exit_k__BackingField; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Challenge::FateRinChallengeLevelInfoViewModel*>* _LevelInfos; // 0x28
		::Class_0_16E4307DCC419505_318* _ShowResidentReward_k__BackingField; // 0x30
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Challenge::FateRinChallengeTabBtnViewModel*>* _TabBtns; // 0x38
		::Class_1_E79EE3670D2EC49A* _UIPresentService; // 0x40
		::RPG::Client::FateRin::ViewModelEventHandler* OnViewModelExitConfirm; // 0x48
		::Class_1_96586C089CD5CA69* _Service; // 0x50
