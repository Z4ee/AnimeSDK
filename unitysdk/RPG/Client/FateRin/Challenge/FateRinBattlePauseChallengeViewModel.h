...
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_GET_BUFFVMLIST_OFFSET UNITYSDK_OFFSET(0x1CBFC290)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_GET_CURTURN_OFFSET UNITYSDK_OFFSET(0x1CBFC270)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_GET_DEEPBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1CBFC2D0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_GET_NORMALBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1CBFC2B0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_SET_BUFFVMLIST_OFFSET UNITYSDK_OFFSET(0x1CBFC2A0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_SET_CURTURN_OFFSET UNITYSDK_OFFSET(0x1CBFC280)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_SET_DEEPBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1CBFC2E0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL_SET_NORMALBUFFCOUNT_OFFSET UNITYSDK_OFFSET(0x1CBFC2C0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL__BUILDINFO_OFFSET UNITYSDK_OFFSET(0x1CBFB6C0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBFB640)

namespace RPG::Client::FateRin::Challenge
{
	inline static constexpr unsigned int FateRinBattlePauseChallengeViewModel_TypeDefinitionIndex = 79702;
	...
	public:
		...
		::System::UInt32 _CurTurn_k__BackingField; // 0x34
