...
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBFC260)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINBATTLEPAUSECHALLENGEVIEWMODEL___C__DISPLAYCLASS1_0___BUILDINFO_B__2_OFFSET UNITYSDK_OFFSET(0x1CBFC5D0)

namespace RPG::Client::FateRin::Challenge
{
	inline static constexpr unsigned int FateRinBattlePauseChallengeViewModel___c__DisplayClass1_0_TypeDefinitionIndex = 79704;
