...
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_BOSSICONPATH_OFFSET UNITYSDK_OFFSET(0x1B5A1EA0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_FIGHTNAME_OFFSET UNITYSDK_OFFSET(0x1B5A1E90)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_HAVEPASSED_OFFSET UNITYSDK_OFFSET(0x1B5A1EC0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1B5A1E70)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_GET_PASSEDLEVEL_OFFSET UNITYSDK_OFFSET(0x1B5A1EB0)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1B5A1E80)
#define RPG_CLIENT_FATERIN_CHALLENGE_FATERINCHALLENGETABBTNVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A1D00)

namespace RPG::Client::FateRin::Challenge
{
	inline static constexpr unsigned int FateRinChallengeTabBtnViewModel_TypeDefinitionIndex = 79708;
