...
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODELFACTORY_CREATEBYDAY_OFFSET UNITYSDK_OFFSET(0x1B5A2990)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODELFACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0x1B5A2AD0)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODELFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A2980)

namespace RPG::Client::FateRin::Day
{
	inline static constexpr unsigned int SwitchDayTalkViewModelFactory_TypeDefinitionIndex = 79748;

	class SwitchDayTalkViewModelFactory : public ::System::Object
	{
	public:
		::Class_1_F248B058F5A06B98* _AvatarService; // 0x10
		::Class_1_FD893FD36F6A3A6D_7* _Service; // 0x18
