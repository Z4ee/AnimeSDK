...
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODEL_GET_ENTRIES_OFFSET UNITYSDK_OFFSET(0x1A386A00)
#define RPG_CLIENT_FATERIN_DAY_SWITCHDAYTALKVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A386450)

namespace RPG::Client::FateRin::Day
{
	inline static constexpr unsigned int SwitchDayTalkViewModel_TypeDefinitionIndex = 76114;

	class SwitchDayTalkViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_1_AB4E0A41BB89929E* _Model; // 0x20
		::System::Collections::ObjectModel::ReadOnlyCollection_1<::RPG::Client::FateRin::Day::SwitchDayTalkEntryViewModel*>* _Entries_ReadOnly; // 0x28
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Day::SwitchDayTalkEntryViewModel*>* _Entries; // 0x30
