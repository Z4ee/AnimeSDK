...
#define RPG_CLIENT_FATERIN_REDDOT_FATERINCASEBOARDREDDOTFILTER_GETTEAMDETAILSUBKEYS_OFFSET UNITYSDK_OFFSET(0xD00E430)
#define RPG_CLIENT_FATERIN_REDDOT_FATERINCASEBOARDREDDOTFILTER_ISMAINPAGENEW_OFFSET UNITYSDK_OFFSET(0xD00E480)
#define RPG_CLIENT_FATERIN_REDDOT_FATERINCASEBOARDREDDOTFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xD00E3E0)

namespace RPG::Client::FateRin::RedDot
{
	inline static constexpr unsigned int FateRinCaseBoardRedDotFilter_TypeDefinitionIndex = 79413;
