...
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0xD012970)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL_GET_TALENT_OFFSET UNITYSDK_OFFSET(0xD012D60)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL_SET_TALENT_OFFSET UNITYSDK_OFFSET(0xD012D70)
#define RPG_CLIENT_FATERIN_TALENT_FATERINTALENTUPGRADEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD0128F0)

namespace RPG::Client::FateRin::Talent
{
	inline static constexpr unsigned int FateRinTalentUpgradeViewModel_TypeDefinitionIndex = 79402;

	class FateRinTalentUpgradeViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_1_BDAA5D56149A1E9B* _Service; // 0x20
		::RPG::Client::FateRin::Talent::FateRinTalentViewModel* _Talent_k__BackingField; // 0x28
