...
#define RPG_CLIENT_FATERIN_LOGGING_ILOGGERFACTORYEXTENSIONS_GETCURRENTCLASSLOGGER_OFFSET UNITYSDK_OFFSET(0x1A390AA0)
#define RPG_CLIENT_FATERIN_LOGGING_ILOGGERFACTORYEXTENSIONS_GETLOGGERFOR_OFFSET UNITYSDK_OFFSET(0x1A391170)
#define RPG_CLIENT_FATERIN_LOGGING_ILOGGERFACTORYEXTENSIONS__FINDCALLERTYPE_OFFSET UNITYSDK_OFFSET(0x1A390CB0)

namespace RPG::Client::FateRin::Logging
{
	inline static constexpr unsigned int ILoggerFactoryExtensions_TypeDefinitionIndex = 76079;
