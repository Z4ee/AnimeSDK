...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENDACTIONBUTTONVIEWMODEL___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D36C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENDACTIONBUTTONVIEWMODEL___C__DISPLAYCLASS5_0___ENDPLAYERACTION_B__0_OFFSET UNITYSDK_OFFSET(0x1A5D3B20)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDENDACTIONBUTTONVIEWMODEL___C__DISPLAYCLASS5_0___ENDPLAYERACTION_B__3_OFFSET UNITYSDK_OFFSET(0x1A5D3B80)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudEndActionButtonViewModel___c__DisplayClass5_0_TypeDefinitionIndex = 75947;
