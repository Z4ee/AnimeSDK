...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5CA730)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudCardAreaViewModel_CardPresentationTransition_TypeDefinitionIndex = 75930;

	class FateRinBattleHudCardAreaViewModel_CardPresentationTransition : public ::System::Object
	{
	public:
		::System::Collections::Generic::IReadOnlyList_1<::RPG::Client::FateRin::Battle::IFateRinBattleHudHandCardDisplayViewModel*>* AddedCardVMs; // 0x10
