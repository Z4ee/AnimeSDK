...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_GET_TEXTNODELIST_OFFSET UNITYSDK_OFFSET(0x1B4968C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_GET_TRIGGERNAME_OFFSET UNITYSDK_OFFSET(0x1B4968A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_SET_TEXTNODELIST_OFFSET UNITYSDK_OFFSET(0x1B4968D0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL_SET_TRIGGERNAME_OFFSET UNITYSDK_OFFSET(0x1B4968B0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINTOGGLESPECIALMARKPARAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B496690)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinToggleSpecialMarkParamViewModel_TypeDefinitionIndex = 75913;

	class FateRinToggleSpecialMarkParamViewModel : public ::System::Object
	{
	public:
		::System::String* _TriggerName_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::Battle::FateRinSpecialMarkTextNodeViewModel*>* _TextNodeList_k__BackingField; // 0x18
