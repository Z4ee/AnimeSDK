...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_ADD_ONCARDCHANGED_OFFSET UNITYSDK_OFFSET(0x1CA3F090)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_ADD_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1CA3EFD0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_DRAGPOINTERPOS_OFFSET UNITYSDK_OFFSET(0x1CA3EF70)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_HANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CA3EF50)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_ISSHOWTARGETINGCURVE_OFFSET UNITYSDK_OFFSET(0x1CA3EF90)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_ISTARGETINGENEMY_OFFSET UNITYSDK_OFFSET(0x1CA3EFB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1CA3EF30)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_REMOVE_ONCARDCHANGED_OFFSET UNITYSDK_OFFSET(0x1CA3F0F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_REMOVE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1CA3F030)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_DRAGPOINTERPOS_OFFSET UNITYSDK_OFFSET(0x1CA3EF80)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_HANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1CA3EF60)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_ISSHOWTARGETINGCURVE_OFFSET UNITYSDK_OFFSET(0x1CA3EFA0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_ISTARGETINGENEMY_OFFSET UNITYSDK_OFFSET(0x1CA3EFC0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1CA3EF40)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__APPLYCARDAREADISPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1CA3EB40)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA2B220)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__MAPFINDINGTARGETTOCARDSTATE_OFFSET UNITYSDK_OFFSET(0x1CA3EED0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__MAPPHASETOCARDSTATE_OFFSET UNITYSDK_OFFSET(0x1CA3EE30)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__ONINTERACTIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1CA3EAF0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDFREECARDVIEWMODEL__SYNCCARDFROMAREA_OFFSET UNITYSDK_OFFSET(0x1CA3EDA0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudFreeCardViewModel_TypeDefinitionIndex = 79589;
	...
	public:
		...
		::RPG::Client::FateRin::Battle::IFateRinBattleHudHandCardDisplayViewModel* _HandCardViewModel_k__BackingField; // 0x38
		::UnityEngine::Vector2 _DragPointerPos_k__BackingField; // 0x40
		::System::Boolean _IsTargetingEnemy_k__BackingField; // 0x48
		::System::Boolean _IsShowTargetingCurve_k__BackingField; // 0x49
