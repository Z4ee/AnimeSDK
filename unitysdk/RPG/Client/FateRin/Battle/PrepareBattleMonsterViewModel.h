...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_CHALLENGEBUFFDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0xCFDA3C0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_FIGHTDESCRIPTION_OFFSET UNITYSDK_OFFSET(0xCFDA390)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_FIGHTNAME_OFFSET UNITYSDK_OFFSET(0xCFDA380)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_FIGUREPATH_OFFSET UNITYSDK_OFFSET(0xCFDA370)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_HASCARDREWARD_OFFSET UNITYSDK_OFFSET(0xCFDA3A0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_ISHOUGUMAPFIGHT_OFFSET UNITYSDK_OFFSET(0xCFDA360)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL_GET_REWARDCARDICONPATH_OFFSET UNITYSDK_OFFSET(0xCFDA3B0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCFD94A0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLEMONSTERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD9000)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleMonsterViewModel_TypeDefinitionIndex = 79659;

	class PrepareBattleMonsterViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::System::Collections::Generic::IReadOnlyList_1<::System::String*>* _ChallengeBuffDescriptions_k__BackingField; // 0x20
		::System::String* _FigurePath_k__BackingField; // 0x28
		::System::String* _RewardCardIconPath_k__BackingField; // 0x30
		::RPG::Client::TextID _FightDescription_k__BackingField; // 0x38
		::RPG::Client::TextID _FightName_k__BackingField; // 0x48
		::System::Boolean _IsHouguMapFight_k__BackingField; // 0x58
		::System::Boolean _HasCardReward_k__BackingField; // 0x59
