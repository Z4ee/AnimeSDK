...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B496B20)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL___C__CREATEBYHOUGUMAPFIGHT_B__2_0_OFFSET UNITYSDK_OFFSET(0x1B496B70)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B496B60)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleTalkViewModel___c_TypeDefinitionIndex = 76028;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::Battle::PrepareBattleTalkViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(PrepareBattleTalkViewModel___c_TypeDefinitionIndex)->GetStaticField(0x5B80);
		}
		...
		{
			return (::System::Func_2<::Class_1_61FB8D394B353477*, ::RPG::Client::FateRin::Battle::PrepareBattleTalkEntryViewModel*>**)Il2CppClass::FromTypeDefinitionIndex(PrepareBattleTalkViewModel___c_TypeDefinitionIndex)->GetStaticField(0x5B88);
		}
