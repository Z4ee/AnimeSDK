...
#define RPG_CLIENT_FATERIN_BATTLE_CARDANIMATIONEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5BCA80)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int CardAnimationEventArgs_TypeDefinitionIndex = 75925;
	...
	public:
		...
		::RPG::Client::Promises::IPendingPromise* PendingPromise; // 0x20
		::System::Collections::Generic::IReadOnlyList_1<::RPG::Client::FateRin::Battle::IFateRinBattleHudHandCardDisplayViewModel*>* AddedCardVMs; // 0x28
