...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_GET_TALKER_OFFSET UNITYSDK_OFFSET(0xCFDA3E0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0xCFDA400)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_SET_TALKER_OFFSET UNITYSDK_OFFSET(0xCFDA3F0)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_SET_TEXT_OFFSET UNITYSDK_OFFSET(0xCFDA410)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFDA3D0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleTalkEntryViewModel_TypeDefinitionIndex = 79660;
