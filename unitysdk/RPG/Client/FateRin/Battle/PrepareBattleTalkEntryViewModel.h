...
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_GET_TALKER_OFFSET UNITYSDK_OFFSET(0x1B496960)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1B496980)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_SET_TALKER_OFFSET UNITYSDK_OFFSET(0x1B496970)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1B496990)
#define RPG_CLIENT_FATERIN_BATTLE_PREPAREBATTLETALKENTRYVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B496950)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int PrepareBattleTalkEntryViewModel_TypeDefinitionIndex = 76026;
