...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x1B491E80)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLEXTRAEFFECTLIST_OFFSET UNITYSDK_OFFSET(0x1B491FF0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x1B491E20)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x1B491ED0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x1B491F90)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1B491F30)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B491B80)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleSkillDetailViewModel_TypeDefinitionIndex = 75992;
