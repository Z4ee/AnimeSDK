...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLDESC_OFFSET UNITYSDK_OFFSET(0x1CA499E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLEXTRAEFFECTLIST_OFFSET UNITYSDK_OFFSET(0x1CA49B50)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLNAME_OFFSET UNITYSDK_OFFSET(0x1CA49980)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTAG_OFFSET UNITYSDK_OFFSET(0x1CA49A30)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTYPECOLOR_OFFSET UNITYSDK_OFFSET(0x1CA49AF0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL_GET_SKILLTYPE_OFFSET UNITYSDK_OFFSET(0x1CA49A90)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLESKILLDETAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA20F90)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleSkillDetailViewModel_TypeDefinitionIndex = 79625;

	class FateRinBattleSkillDetailViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::Class_1_5C85CC607D791BFF* _Model; // 0x20
		::System::Collections::Generic::List_1<::RPG::Client::FateRin::IFateRinExtraEffectViewModel*>* _SkillExtraEffectList_k__BackingField; // 0x28
