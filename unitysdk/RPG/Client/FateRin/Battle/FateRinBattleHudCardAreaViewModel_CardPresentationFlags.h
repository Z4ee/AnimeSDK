...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x14E9B0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x14E980)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_EQUALS_OFFSET UNITYSDK_OFFSET(0x14E910)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14E900)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_GET_MARKPENDINGFLYIN_OFFSET UNITYSDK_OFFSET(0x2FC10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_GET_MARKPENDINGREMOVE_OFFSET UNITYSDK_OFFSET(0x14E870)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_GET_MARKSKIPLAYOUT_OFFSET UNITYSDK_OFFSET(0x14E890)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_GET_MARKSKIPREFLOW_OFFSET UNITYSDK_OFFSET(0x14E8B0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_GET_MARKUNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x7EF00)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xCF74320)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xCF74280)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x14E8E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_SET_MARKPENDINGFLYIN_OFFSET UNITYSDK_OFFSET(0x14E860)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_SET_MARKPENDINGREMOVE_OFFSET UNITYSDK_OFFSET(0x14E880)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_SET_MARKSKIPLAYOUT_OFFSET UNITYSDK_OFFSET(0x14E8A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_SET_MARKSKIPREFLOW_OFFSET UNITYSDK_OFFSET(0x14E8C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_SET_MARKUNINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x7EF10)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14E8D0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS__CCTOR_OFFSET UNITYSDK_OFFSET(0xCF74E60)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDCARDAREAVIEWMODEL_CARDPRESENTATIONFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x14E840)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudCardAreaViewModel_CardPresentationFlags_TypeDefinitionIndex = 79565;
	...
	struct alignas(1) FateRinBattleHudCardAreaViewModel_CardPresentationFlags
	{
		...
		{
			return (::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags*)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleHudCardAreaViewModel_CardPresentationFlags_TypeDefinitionIndex)->GetStaticField(0x15430);
		}
		static ::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags* StaticGet_Leave()
		{
			return (::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags*)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleHudCardAreaViewModel_CardPresentationFlags_TypeDefinitionIndex)->GetStaticField(0x15435);
		}
		static ::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags* StaticGet_UninteractableOnly()
		{
			return (::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags*)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleHudCardAreaViewModel_CardPresentationFlags_TypeDefinitionIndex)->GetStaticField(0x1543A);
		}
		static ::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags* StaticGet_FlyIn()
		{
			return (::RPG::Client::FateRin::Battle::FateRinBattleHudCardAreaViewModel_CardPresentationFlags*)Il2CppClass::FromTypeDefinitionIndex(FateRinBattleHudCardAreaViewModel_CardPresentationFlags_TypeDefinitionIndex)->GetStaticField(0x1543F);
		}
