...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1CBD94D0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1CBD94F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_SET_PATH_OFFSET UNITYSDK_OFFSET(0x1CBD94E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1CBD9500)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINSPECIALMARKTEXTNODEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBD94A0)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinSpecialMarkTextNodeViewModel_TypeDefinitionIndex = 79547;
