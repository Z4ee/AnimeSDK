...
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_CANCELCLICKFINDINGTARGET_OFFSET UNITYSDK_OFFSET(0x1CA435E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_CANCELDRAGFINDINGTARGET_OFFSET UNITYSDK_OFFSET(0x1CA436E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_CANCEL_OFFSET UNITYSDK_OFFSET(0x1CA433C0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_DRAGTOTARGET_OFFSET UNITYSDK_OFFSET(0x1CA43350)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_GET_CURRENTPHASE_OFFSET UNITYSDK_OFFSET(0x1CA42F70)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_GET_SELECTEDHANDCARDVM_OFFSET UNITYSDK_OFFSET(0x1CA42FC0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_HITTESTCARDS_OFFSET UNITYSDK_OFFSET(0x1CA43030)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_ISCARDALLOWEDBYTUTORIAL_OFFSET UNITYSDK_OFFSET(0x1CA430A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_ISINCANCELAREA_OFFSET UNITYSDK_OFFSET(0x1CA431F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_ISINSELECTAREA_OFFSET UNITYSDK_OFFSET(0x1CA430F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_RESETIFSELECTING_OFFSET UNITYSDK_OFFSET(0x1CA43580)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_RESETINTERACTION_OFFSET UNITYSDK_OFFSET(0x1CA43410)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_RESETPOINTERSTATE_OFFSET UNITYSDK_OFFSET(0x1CA42BE0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_SELECTCARD_OFFSET UNITYSDK_OFFSET(0x1CA432F0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_TRANSITIONTOANDHANDLE_OFFSET UNITYSDK_OFFSET(0x1CA43500)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_TRANSITIONTO_OFFSET UNITYSDK_OFFSET(0x1CA42310)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_TRYPLAYANDRESETINTERACTION_OFFSET UNITYSDK_OFFSET(0x1CA437B0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN_TRYPLAYSELECTEDCARD_OFFSET UNITYSDK_OFFSET(0x1CA438A0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA421E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__GETPOINTERSTATE_OFFSET UNITYSDK_OFFSET(0x1CA43460)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTERCANCEL_OFFSET UNITYSDK_OFFSET(0x1CA42F20)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTERDRAG_OFFSET UNITYSDK_OFFSET(0x1CA42E60)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTEREVENT_OFFSET UNITYSDK_OFFSET(0x1CA42CF0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTERHOVEREXIT_OFFSET UNITYSDK_OFFSET(0x1CA42DB0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTERHOVER_OFFSET UNITYSDK_OFFSET(0x1CA42C90)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTERPRESS_OFFSET UNITYSDK_OFFSET(0x1CA42E00)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__HANDLEPOINTERRELEASE_OFFSET UNITYSDK_OFFSET(0x1CA42EC0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__ONINPUTINTERRUPTED_OFFSET UNITYSDK_OFFSET(0x1CA42B00)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__SUBSCRIBEEVENTS_OFFSET UNITYSDK_OFFSET(0x1CA423E0)
#define RPG_CLIENT_FATERIN_BATTLE_FATERINBATTLEHUDHOVERBRAIN__UNSUBSCRIBEEVENTS_OFFSET UNITYSDK_OFFSET(0x1CA42770)

namespace RPG::Client::FateRin::Battle
{
	inline static constexpr unsigned int FateRinBattleHudHoverBrain_TypeDefinitionIndex = 79632;

	class FateRinBattleHudHoverBrain : public ::RPG::Client::FateRin::Battle::FateRinBattleHudInputBrainBase
	{
	public:
		::Class_1_9654EDC4BC82BD07* _PointerState; // 0x40
		::Class_1_9654EDC4BC82BD07* _IdleState; // 0x48
		::Class_1_9654EDC4BC82BD07* _DraggingReadyToReleaseState; // 0x50
		::Class_1_9654EDC4BC82BD07* _ClickConfirmPressingState; // 0x58
		::Class_1_9654EDC4BC82BD07* _CancelledAwaitingReleaseState; // 0x60
		::Class_1_9654EDC4BC82BD07* _DraggingInsideSelectAreaState; // 0x68
		::Class_1_9654EDC4BC82BD07* _ClickWaitingInitialReleaseState; // 0x70
		::Class_1_9654EDC4BC82BD07* _ClickWaitingConfirmPressState; // 0x78
