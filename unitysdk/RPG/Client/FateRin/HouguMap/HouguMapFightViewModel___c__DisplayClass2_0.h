...
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3906B0)
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0___DOTRACKFIGHT_B__0_OFFSET UNITYSDK_OFFSET(0x1A390800)
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0___DOTRACKFIGHT_B__1_OFFSET UNITYSDK_OFFSET(0x1A390A00)

namespace RPG::Client::FateRin::HouguMap
{
	inline static constexpr unsigned int HouguMapFightViewModel___c__DisplayClass2_0_TypeDefinitionIndex = 75812;
