...
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5ACA50)
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0___DOTRACKFIGHT_B__0_OFFSET UNITYSDK_OFFSET(0x1B5ACBA0)
#define RPG_CLIENT_FATERIN_HOUGUMAP_HOUGUMAPFIGHTVIEWMODEL___C__DISPLAYCLASS2_0___DOTRACKFIGHT_B__1_OFFSET UNITYSDK_OFFSET(0x1B5ACDB0)

namespace RPG::Client::FateRin::HouguMap
{
	inline static constexpr unsigned int HouguMapFightViewModel___c__DisplayClass2_0_TypeDefinitionIndex = 79445;
