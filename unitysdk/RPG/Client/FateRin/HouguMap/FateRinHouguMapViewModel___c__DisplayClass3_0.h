...
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A38F900)
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C__DISPLAYCLASS3_0___BUILDFIGHTVIEWMODELS_B__1_OFFSET UNITYSDK_OFFSET(0x1A38FE90)

namespace RPG::Client::FateRin::HouguMap
{
	inline static constexpr unsigned int FateRinHouguMapViewModel___c__DisplayClass3_0_TypeDefinitionIndex = 75810;
	...
	public:
		...
		::Class_1_310250D457C6B8CD* overrideService; // 0x18
		::Class_0_16E4307DCC419505_1269* redDotService; // 0x20
		::RPG::Client::FateRin::HouguMap::FateRinHouguMapViewModel* __4__this; // 0x28
