...
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5ABFA0)
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5ABFE0)
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C__GET_ISALLNORMALFIGHTSFINISHED_B__12_0_OFFSET UNITYSDK_OFFSET(0x1B5AC140)
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C___BUILDFIGHTVIEWMODELS_B__3_0_OFFSET UNITYSDK_OFFSET(0x1B5ABFF0)
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C___BUILDFIGHTVIEWMODELS_B__3_2_OFFSET UNITYSDK_OFFSET(0x1B5AC020)
#define RPG_CLIENT_FATERIN_HOUGUMAP_FATERINHOUGUMAPVIEWMODEL___C___BUILDFIGHTVIEWMODELS_B__3_3_OFFSET UNITYSDK_OFFSET(0x1B5AC0E0)

namespace RPG::Client::FateRin::HouguMap
{
	inline static constexpr unsigned int FateRinHouguMapViewModel___c_TypeDefinitionIndex = 79441;
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::FateRin::HouguMap::HouguMapFightViewModel*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(FateRinHouguMapViewModel___c_TypeDefinitionIndex)->GetStaticField(0xABF0);
		}
		static ::System::Func_2<::RPG::Client::FateRin::HouguMap::FateRinHouguMapFight*, ::System::Boolean>** StaticGet___9__3_0()
		{
			return (::System::Func_2<::RPG::Client::FateRin::HouguMap::FateRinHouguMapFight*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(FateRinHouguMapViewModel___c_TypeDefinitionIndex)->GetStaticField(0xABF8);
		}
		static ::System::Func_2<::RPG::Client::FateRin::HouguMap::HouguMapFightViewModel*, ::System::Boolean>** StaticGet___9__3_2()
		{
			return (::System::Func_2<::RPG::Client::FateRin::HouguMap::HouguMapFightViewModel*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(FateRinHouguMapViewModel___c_TypeDefinitionIndex)->GetStaticField(0xAC00);
		}
		static ::RPG::Client::FateRin::HouguMap::FateRinHouguMapViewModel___c** StaticGet___9()
		{
			return (::RPG::Client::FateRin::HouguMap::FateRinHouguMapViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(FateRinHouguMapViewModel___c_TypeDefinitionIndex)->GetStaticField(0xAC08);
		}
		static ::System::Func_2<::RPG::Client::FateRin::HouguMap::HouguMapFightViewModel*, ::System::Boolean>** StaticGet___9__12_0()
		{
			return (::System::Func_2<::RPG::Client::FateRin::HouguMap::HouguMapFightViewModel*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(FateRinHouguMapViewModel___c_TypeDefinitionIndex)->GetStaticField(0xAC10);
		}
