...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONMOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0x1A37B5E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONMOVETOTEAM_OFFSET UNITYSDK_OFFSET(0x1A37B520)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0x1A37B3A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONPERFORMSTART_OFFSET UNITYSDK_OFFSET(0x1A37B2C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSETUPSCALE_OFFSET UNITYSDK_OFFSET(0x1A37B460)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWGRAIL_OFFSET UNITYSDK_OFFSET(0x1A37B840)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWLINE_OFFSET UNITYSDK_OFFSET(0x1A37B920)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWREWARD_OFFSET UNITYSDK_OFFSET(0x1A37BA00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWTEAM_OFFSET UNITYSDK_OFFSET(0x1A37B6A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSIMPLETALK_OFFSET UNITYSDK_OFFSET(0x1A37BAE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONTRACKTEAM_OFFSET UNITYSDK_OFFSET(0x1A37B760)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_APPLYSTATICSTATE_OFFSET UNITYSDK_OFFSET(0x1A37C110)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_CLEARPERFORM_OFFSET UNITYSDK_OFFSET(0x1A37BF20)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GETCURRENTFORTASK_OFFSET UNITYSDK_OFFSET(0x1A37BC80)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GETGRAILFORTASK_OFFSET UNITYSDK_OFFSET(0x1A37BCF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GET_ISPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0x1A37BC10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GET_ISPERFORMING_OFFSET UNITYSDK_OFFSET(0x1A37BBA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOGRAILCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37C650)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0x1A37C510)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOTEAMCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37C4C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOTEAM_OFFSET UNITYSDK_OFFSET(0x1A37C390)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONMOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0x1A37B640)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONMOVETOTEAM_OFFSET UNITYSDK_OFFSET(0x1A37B580)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0x1A37B400)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONPERFORMSTART_OFFSET UNITYSDK_OFFSET(0x1A37B330)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSETUPSCALE_OFFSET UNITYSDK_OFFSET(0x1A37B4C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWGRAIL_OFFSET UNITYSDK_OFFSET(0x1A37B8B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWLINE_OFFSET UNITYSDK_OFFSET(0x1A37B990)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWREWARD_OFFSET UNITYSDK_OFFSET(0x1A37BA70)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWTEAM_OFFSET UNITYSDK_OFFSET(0x1A37B700)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSIMPLETALK_OFFSET UNITYSDK_OFFSET(0x1A37BB40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONTRACKTEAM_OFFSET UNITYSDK_OFFSET(0x1A37B7D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SETUPSCALECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37C330)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SETUPSCALE_OFFSET UNITYSDK_OFFSET(0x1A37C1F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWGRAILCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37D030)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWGRAIL_OFFSET UNITYSDK_OFFSET(0x1A37CD10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWLINECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37D5A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWLINE_OFFSET UNITYSDK_OFFSET(0x1A37D1B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARDCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1A37D8F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARDCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37D850)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARD_OFFSET UNITYSDK_OFFSET(0x1A37D710)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWTEAMCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A37CBE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWTEAM_OFFSET UNITYSDK_OFFSET(0x1A37C6B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SIMPLETALK_OFFSET UNITYSDK_OFFSET(0x1A37DB00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_STARTPERFORM_OFFSET UNITYSDK_OFFSET(0x1A37BD40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_TRACKTEAM_OFFSET UNITYSDK_OFFSET(0x1A37D090)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CLEARPENDINGPROMISES_OFFSET UNITYSDK_OFFSET(0x1A37DC80)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CLEARPERFORM_OFFSET UNITYSDK_OFFSET(0x1A37C030)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A37B150)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__HASPENDINGPROMISE_OFFSET UNITYSDK_OFFSET(0x1A37DE30)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__HASWAITEFFECT_OFFSET UNITYSDK_OFFSET(0x1A37CB50)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__ISPENDING_OFFSET UNITYSDK_OFFSET(0x1A37E400)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__NOTIFYPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0x1A37DDB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__SIMPLETALK_B__60_0_OFFSET UNITYSDK_OFFSET(0x1A37E450)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardPerformViewModel_TypeDefinitionIndex = 75844;

	class CaseBoardPerformViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardSetupScaleParams*>* OnSetupScale; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::RPG::GameCore::FateRinCaseBoardTeamType, ::RPG::GameCore::FateRinCaseBoardTeamType>, ::RPG::Client::Promises::Promise*>* _ShowLinePromises; // 0x28
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FateRinCaseBoardTeamType, ::RPG::Client::Promises::Promise*>* _ShowTeamPromises; // 0x30
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardSimpleTalkParams*>* OnSimpleTalk; // 0x38
		::RPG::Client::Promises::Promise* _ShowRewardPromise; // 0x40
		::RPG::Client::FateRin::ViewModelEventHandler* OnPerformFinished; // 0x48
		::RPG::Client::Promises::Promise* _SimpleTalkPromise; // 0x50
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardMoveToGrailParams*>* OnMoveToGrail; // 0x58
		::RPG::Client::Promises::Promise* _MoveToTeamPromise; // 0x60
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardMoveToTeamParams*>* OnMoveToTeam; // 0x68
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowTeamParams*>* OnShowTeam; // 0x70
		::Class_1_C28E571CD1C66CE4* _State; // 0x78
		::RPG::Client::Promises::Promise* _SetupScalePromise; // 0x80
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowRewardParams*>* OnShowReward; // 0x88
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardTrackTeamParams*>* OnTrackTeam; // 0x90
		::RPG::Client::Promises::Promise* _MoveToGrailPromise; // 0x98
		::RPG::GameCore::GameEntity* _LevelGraphEntity; // 0xA0
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowLineParams*>* OnShowLine; // 0xA8
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowGrailParams*>* OnShowGrail; // 0xB0
		::RPG::Client::FateRin::ViewModelEventHandler* OnPerformStart; // 0xB8
		::RPG::Client::Promises::Promise* _ShowGrailPromise; // 0xC0
		::System::Boolean _HasPerformStarted; // 0xC8
		::System::Boolean _IsStaticStateOnly; // 0xC9
		::System::Boolean _HasPerformFinishedNotified; // 0xCA
