...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONMOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0xCFF6470)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONMOVETOTEAM_OFFSET UNITYSDK_OFFSET(0xCFF63B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xCFF61F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xCFF6110)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSETUPSCALE_OFFSET UNITYSDK_OFFSET(0xCFF62D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWGRAIL_OFFSET UNITYSDK_OFFSET(0xCFF66D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWLINE_OFFSET UNITYSDK_OFFSET(0xCFF6790)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWREWARD_OFFSET UNITYSDK_OFFSET(0xCFF6870)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSHOWTEAM_OFFSET UNITYSDK_OFFSET(0xCFF6530)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONSIMPLETALK_OFFSET UNITYSDK_OFFSET(0xCFF6950)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_ADD_ONTRACKTEAM_OFFSET UNITYSDK_OFFSET(0xCFF65F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_APPLYSTATICSTATE_OFFSET UNITYSDK_OFFSET(0xCFF6FB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_CLEARPERFORM_OFFSET UNITYSDK_OFFSET(0xCFF6DC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GETCURRENTFORTASK_OFFSET UNITYSDK_OFFSET(0xCFF6B10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GETGRAILFORTASK_OFFSET UNITYSDK_OFFSET(0xCFF6B80)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GET_ISPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xCFF6AA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_GET_ISPERFORMING_OFFSET UNITYSDK_OFFSET(0xCFF6A30)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOGRAILCOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF74D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0xCFF73A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOTEAMCOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF7350)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_MOVETOTEAM_OFFSET UNITYSDK_OFFSET(0xCFF7220)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONMOVETOGRAIL_OFFSET UNITYSDK_OFFSET(0xCFF64D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONMOVETOTEAM_OFFSET UNITYSDK_OFFSET(0xCFF6410)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xCFF6260)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONPERFORMSTART_OFFSET UNITYSDK_OFFSET(0xCFF6180)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSETUPSCALE_OFFSET UNITYSDK_OFFSET(0xCFF6340)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWGRAIL_OFFSET UNITYSDK_OFFSET(0xCFF6730)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWLINE_OFFSET UNITYSDK_OFFSET(0xCFF6800)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWREWARD_OFFSET UNITYSDK_OFFSET(0xCFF68E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSHOWTEAM_OFFSET UNITYSDK_OFFSET(0xCFF6590)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONSIMPLETALK_OFFSET UNITYSDK_OFFSET(0xCFF69C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_REMOVE_ONTRACKTEAM_OFFSET UNITYSDK_OFFSET(0xCFF6660)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SETUPSCALECOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF71D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SETUPSCALE_OFFSET UNITYSDK_OFFSET(0xCFF7090)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWGRAILCOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF7E90)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWGRAIL_OFFSET UNITYSDK_OFFSET(0xCFF7B80)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWLINECOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF8400)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWLINE_OFFSET UNITYSDK_OFFSET(0xCFF8000)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARDCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0xCFF8750)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARDCOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF86B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWREWARD_OFFSET UNITYSDK_OFFSET(0xCFF8570)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWTEAMCOMPLETE_OFFSET UNITYSDK_OFFSET(0xCFF7A50)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SHOWTEAM_OFFSET UNITYSDK_OFFSET(0xCFF7520)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_SIMPLETALK_OFFSET UNITYSDK_OFFSET(0xCFF87D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_STARTPERFORM_OFFSET UNITYSDK_OFFSET(0xCFF6BE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL_TRACKTEAM_OFFSET UNITYSDK_OFFSET(0xCFF7EE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CLEARPENDINGPROMISES_OFFSET UNITYSDK_OFFSET(0xCFF8950)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CLEARPERFORM_OFFSET UNITYSDK_OFFSET(0xCFF6ED0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF5FA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__HASPENDINGPROMISE_OFFSET UNITYSDK_OFFSET(0xCFF8AF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__HASWAITEFFECT_OFFSET UNITYSDK_OFFSET(0xCFF79C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__ISPENDING_OFFSET UNITYSDK_OFFSET(0xCFF90B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__NOTIFYPERFORMFINISHED_OFFSET UNITYSDK_OFFSET(0xCFF8A70)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDPERFORMVIEWMODEL__SIMPLETALK_B__60_0_OFFSET UNITYSDK_OFFSET(0xCFF9100)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardPerformViewModel_TypeDefinitionIndex = 79478;

	class CaseBoardPerformViewModel : public ::RPG::Client::FateRin::BaseViewModel
	{
	public:
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowTeamParams*>* OnShowTeam; // 0x20
		::RPG::Client::Promises::Promise* _ShowGrailPromise; // 0x28
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowGrailParams*>* OnShowGrail; // 0x30
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardMoveToTeamParams*>* OnMoveToTeam; // 0x38
		::RPG::Client::Promises::Promise* _SetupScalePromise; // 0x40
		::System::Collections::Generic::Dictionary_2<::RPG::GameCore::FateRinCaseBoardTeamType, ::RPG::Client::Promises::Promise*>* _ShowTeamPromises; // 0x48
		::RPG::Client::Promises::Promise* _MoveToTeamPromise; // 0x50
		::RPG::Client::Promises::Promise* _ShowRewardPromise; // 0x58
		::RPG::Client::Promises::Promise* _SimpleTalkPromise; // 0x60
		::RPG::GameCore::GameEntity* _LevelGraphEntity; // 0x68
		::RPG::Client::Promises::Promise* _MoveToGrailPromise; // 0x70
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardMoveToGrailParams*>* OnMoveToGrail; // 0x78
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowRewardParams*>* OnShowReward; // 0x80
		::RPG::Client::FateRin::ViewModelEventHandler* OnPerformStart; // 0x88
		::Class_1_C28E571CD1C66CE4* _State; // 0x90
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardShowLineParams*>* OnShowLine; // 0x98
		::RPG::Client::FateRin::ViewModelEventHandler* OnPerformFinished; // 0xA0
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardTrackTeamParams*>* OnTrackTeam; // 0xA8
		::System::Collections::Generic::Dictionary_2<::System::ValueTuple_2<::RPG::GameCore::FateRinCaseBoardTeamType, ::RPG::GameCore::FateRinCaseBoardTeamType>, ::RPG::Client::Promises::Promise*>* _ShowLinePromises; // 0xB0
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardSetupScaleParams*>* OnSetupScale; // 0xB8
		::RPG::Client::FateRin::ViewModelEventHandler_1<::RPG::Client::FateRin::CaseBoard::CaseBoardSimpleTalkParams*>* OnSimpleTalk; // 0xC0
