...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A37ED00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL___C__DISPLAYCLASS12_0__GETPAGEENTERCALLBACK_B__0_OFFSET UNITYSDK_OFFSET(0x1A37F190)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardViewModel___c__DisplayClass12_0_TypeDefinitionIndex = 75834;
