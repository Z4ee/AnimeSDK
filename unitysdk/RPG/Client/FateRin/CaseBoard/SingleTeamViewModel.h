...
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0xCFFAD10)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0xCFFACD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0xCFFAD20)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFAD30)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0xCFFADD0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int SingleTeamViewModel_TypeDefinitionIndex = 79489;
