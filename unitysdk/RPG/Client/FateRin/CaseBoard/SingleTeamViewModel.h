...
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1A3800D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0x1A380090)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1A3800E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3800F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_SINGLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A380190)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int SingleTeamViewModel_TypeDefinitionIndex = 75855;
