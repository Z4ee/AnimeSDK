...
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_HOUGU1_OFFSET UNITYSDK_OFFSET(0xCFFBAE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_HOUGU2_OFFSET UNITYSDK_OFFSET(0xCFFBB00)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_ISSHOWMASTER2TAG_OFFSET UNITYSDK_OFFSET(0xCFFBAC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xCFFBA60)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_MASTER2_OFFSET UNITYSDK_OFFSET(0xCFFBAA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0xCFFBA40)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCFFBA80)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0xCFFB9F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_HOUGU1_OFFSET UNITYSDK_OFFSET(0xCFFBAF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_HOUGU2_OFFSET UNITYSDK_OFFSET(0xCFFBB10)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_ISSHOWMASTER2TAG_OFFSET UNITYSDK_OFFSET(0xCFFBAD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xCFFBA70)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_MASTER2_OFFSET UNITYSDK_OFFSET(0xCFFBAB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_MASTER_OFFSET UNITYSDK_OFFSET(0xCFFBA50)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCFFBA90)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFBB20)
#define RPG_CLIENT_FATERIN_CASEBOARD_TRIPLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0xCFFBD20)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int TripleTeamViewModel_TypeDefinitionIndex = 79494;
