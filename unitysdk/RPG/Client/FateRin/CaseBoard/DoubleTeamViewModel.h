...
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_HOUGU_OFFSET UNITYSDK_OFFSET(0x1CBF9300)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0x1CBF92C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0x1CBF92A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0x1CBF92E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0x1CBF9250)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_HOUGU_OFFSET UNITYSDK_OFFSET(0x1CBF9310)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0x1CBF92D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_MASTER_OFFSET UNITYSDK_OFFSET(0x1CBF92B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0x1CBF92F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF9320)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1CBF96E0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int DoubleTeamViewModel_TypeDefinitionIndex = 79487;
	...
	public:
		...
		::RPG::Client::FateRin::CaseBoard::HouguViewModel* _Hougu_k__BackingField; // 0x50
		::RPG::Client::FateRin::CaseBoard::CaseBoardAvatarViewModel* _Master_k__BackingField; // 0x58
