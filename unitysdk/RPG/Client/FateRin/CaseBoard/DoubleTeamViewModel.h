...
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_HOUGU_OFFSET UNITYSDK_OFFSET(0xCFF9FC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xCFF9F80)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0xCFF9F60)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCFF9FA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_GET_TEAMSIZE_OFFSET UNITYSDK_OFFSET(0xCFF9F10)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_HOUGU_OFFSET UNITYSDK_OFFSET(0xCFF9FD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_ISSHOWMASTERTAG_OFFSET UNITYSDK_OFFSET(0xCFF9F90)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_MASTER_OFFSET UNITYSDK_OFFSET(0xCFF9F70)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL_SET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCFF9FB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF9FE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_DOUBLETEAMVIEWMODEL__ONUPDATE_OFFSET UNITYSDK_OFFSET(0xCFFA3A0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int DoubleTeamViewModel_TypeDefinitionIndex = 79488;

	class DoubleTeamViewModel : public ::RPG::Client::FateRin::CaseBoard::TeamViewModel
	{
	public:
		::RPG::Client::FateRin::CaseBoard::HouguViewModel* _Hougu_k__BackingField; // 0x48
