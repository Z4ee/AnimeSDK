...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_CREATEWITHSERVANTTAB_OFFSET UNITYSDK_OFFSET(0x1CBF4860)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_MASTERCLASS_OFFSET UNITYSDK_OFFSET(0x1CBF4620)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0x1CBF4610)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0x1CBF44D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0x1CBF4530)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CBF4480)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1CBF4840)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF4630)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__GETDEFAULTMASTERCLASS_OFFSET UNITYSDK_OFFSET(0x1CBF47C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__GETDEFAULTMASTERTABMAINTITLE_OFFSET UNITYSDK_OFFSET(0x1CBF46D0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailMasterItemViewModel_TypeDefinitionIndex = 79472;

	class CaseBoardDetailMasterItemViewModel : public ::RPG::Client::FateRin::CaseBoard::CaseBoardDetailItemBaseViewModel
	{
	public:
		::RPG::Client::FateRin::CaseBoard::CaseBoardAvatarViewModel* _Master_k__BackingField; // 0x10
		::System::String* _MasterClass_k__BackingField; // 0x18
