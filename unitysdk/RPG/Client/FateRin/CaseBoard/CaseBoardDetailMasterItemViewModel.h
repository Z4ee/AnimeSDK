...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_CREATEWITHSERVANTTAB_OFFSET UNITYSDK_OFFSET(0x1A37A690)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_MASTERCLASS_OFFSET UNITYSDK_OFFSET(0x1A37A450)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_MASTER_OFFSET UNITYSDK_OFFSET(0x1A37A440)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0x1A37A300)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0x1A37A360)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A37A2B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A37A670)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A37A460)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__GETDEFAULTMASTERCLASS_OFFSET UNITYSDK_OFFSET(0x1A37A5F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILMASTERITEMVIEWMODEL__GETDEFAULTMASTERTABMAINTITLE_OFFSET UNITYSDK_OFFSET(0x1A37A500)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailMasterItemViewModel_TypeDefinitionIndex = 75839;
