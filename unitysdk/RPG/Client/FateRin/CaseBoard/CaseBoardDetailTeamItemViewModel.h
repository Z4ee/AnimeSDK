...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0x1CBF4C70)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0x1CBF4D20)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TEAM_OFFSET UNITYSDK_OFFSET(0x1CBF4D90)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1CBF4C30)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILTEAMITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF4DA0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailTeamItemViewModel_TypeDefinitionIndex = 79474;
