...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1CBF8AE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETPAGEENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1CBF8C80)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETPAGEEXITCALLBACK_OFFSET UNITYSDK_OFFSET(0x1CBF8D50)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETTEAMRELATIONS_OFFSET UNITYSDK_OFFSET(0x1CBF90B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETTEAMS_OFFSET UNITYSDK_OFFSET(0x1CBF8F40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_GRAIL_OFFSET UNITYSDK_OFFSET(0x1CBF8950)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1CBF8930)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_PERFORM_OFFSET UNITYSDK_OFFSET(0x1CBF89A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1CBF8F00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1CBF8940)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_SET_PERFORM_OFFSET UNITYSDK_OFFSET(0x1CBF89B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_TRYGETTEAMRELATION_OFFSET UNITYSDK_OFFSET(0x1CBF9100)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_TRYGETTEAM_OFFSET UNITYSDK_OFFSET(0x1CBF8F90)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_UPDATETEAMRELATION_OFFSET UNITYSDK_OFFSET(0x1CBF9170)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_UPDATETEAM_OFFSET UNITYSDK_OFFSET(0x1CBF8FF0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF89C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__ONPAGEENTER_OFFSET UNITYSDK_OFFSET(0x1CBF8E20)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__ONPAGEEXIT_OFFSET UNITYSDK_OFFSET(0x1CBF8E90)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardViewModel_TypeDefinitionIndex = 79465;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::CaseBoard::CaseBoardViewModel**)Il2CppClass::FromTypeDefinitionIndex(CaseBoardViewModel_TypeDefinitionIndex)->GetStaticField(0x4750);
		}
		::RPG::Client::FateRin::CaseBoard::CaseBoardPerformViewModel* _Perform_k__BackingField; // 0x20
		::Class_1_C28E571CD1C66CE4* _State; // 0x28
		::Class_1_5C8F237BF51192A7* _CaseBoardService; // 0x30
