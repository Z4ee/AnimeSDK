...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_ASYNCINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A37EAA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETPAGEENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A37EC40)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETPAGEEXITCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A37ED10)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETTEAMRELATIONS_OFFSET UNITYSDK_OFFSET(0x1A37F070)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GETTEAMS_OFFSET UNITYSDK_OFFSET(0x1A37EF00)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_GRAIL_OFFSET UNITYSDK_OFFSET(0x1A37E910)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A37E8F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_PERFORM_OFFSET UNITYSDK_OFFSET(0x1A37E960)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1A37EEC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A37E900)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_SET_PERFORM_OFFSET UNITYSDK_OFFSET(0x1A37E970)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_TRYGETTEAMRELATION_OFFSET UNITYSDK_OFFSET(0x1A37F0C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_TRYGETTEAM_OFFSET UNITYSDK_OFFSET(0x1A37EF50)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_UPDATETEAMRELATION_OFFSET UNITYSDK_OFFSET(0x1A37F130)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL_UPDATETEAM_OFFSET UNITYSDK_OFFSET(0x1A37EFB0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A37E980)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__ONPAGEENTER_OFFSET UNITYSDK_OFFSET(0x1A37EDE0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDVIEWMODEL__ONPAGEEXIT_OFFSET UNITYSDK_OFFSET(0x1A37EE50)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardViewModel_TypeDefinitionIndex = 75832;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::CaseBoard::CaseBoardViewModel**)Il2CppClass::FromTypeDefinitionIndex(CaseBoardViewModel_TypeDefinitionIndex)->GetStaticField(0xA5F0);
		}
