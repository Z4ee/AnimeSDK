...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_GET_AGILITYLEVEL_OFFSET UNITYSDK_OFFSET(0x1CBF8530)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_GET_ENDURANCELEVEL_OFFSET UNITYSDK_OFFSET(0x1CBF84C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_GET_HOUGULEVEL_OFFSET UNITYSDK_OFFSET(0x1CBF8680)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_GET_LUCKLEVEL_OFFSET UNITYSDK_OFFSET(0x1CBF8610)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_GET_MANALEVEL_OFFSET UNITYSDK_OFFSET(0x1CBF85A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_GET_STRENGTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1CBF8450)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CBF8800)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDSERVANTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBF8750)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardServantViewModel_TypeDefinitionIndex = 79462;
