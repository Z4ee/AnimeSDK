...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_SERVANTCLASS_OFFSET UNITYSDK_OFFSET(0xCFF57C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0xCFF57B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0xCFF5660)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0xCFF56C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCFF5610)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFF57D0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailServantItemViewModel_TypeDefinitionIndex = 79474;
