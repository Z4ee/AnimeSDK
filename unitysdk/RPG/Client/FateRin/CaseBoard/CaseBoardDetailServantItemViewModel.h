...
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_SERVANTCLASS_OFFSET UNITYSDK_OFFSET(0x1A37A970)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_SERVANT_OFFSET UNITYSDK_OFFSET(0x1A37A960)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TABMAINTITLE_OFFSET UNITYSDK_OFFSET(0x1A37A820)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TABSUBTITLE_OFFSET UNITYSDK_OFFSET(0x1A37A880)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A37A7D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_CASEBOARDDETAILSERVANTITEMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A37A980)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int CaseBoardDetailServantItemViewModel_TypeDefinitionIndex = 75840;

	class CaseBoardDetailServantItemViewModel : public ::RPG::Client::FateRin::CaseBoard::CaseBoardDetailItemBaseViewModel
	{
	public:
		::RPG::Client::FateRin::CaseBoard::CaseBoardServantViewModel* _Servant_k__BackingField; // 0x10
		::System::String* _ServantClass_k__BackingField; // 0x18
