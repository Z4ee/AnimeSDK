...
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_COMPUTECATENARYPOINTS_OFFSET UNITYSDK_OFFSET(0x1A380440)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_COMPUTECATENARYSHADOWPOINTS_OFFSET UNITYSDK_OFFSET(0x1A380690)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_FROMTEAM_OFFSET UNITYSDK_OFFSET(0x1A3802C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_RELATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A380300)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_TOTEAM_OFFSET UNITYSDK_OFFSET(0x1A3802E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_FROMTEAM_OFFSET UNITYSDK_OFFSET(0x1A3802D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_RELATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A380310)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_TOTEAM_OFFSET UNITYSDK_OFFSET(0x1A3802F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3803E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A380320)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int TeamRelationViewModel_TypeDefinitionIndex = 75856;
