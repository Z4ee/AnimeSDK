...
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_COMPUTECATENARYPOINTS_OFFSET UNITYSDK_OFFSET(0x1CBFA3C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_COMPUTECATENARYSHADOWPOINTS_OFFSET UNITYSDK_OFFSET(0x1CBFA610)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_FROMTEAM_OFFSET UNITYSDK_OFFSET(0x1CBFA240)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_RELATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1CBFA280)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_GET_TOTEAM_OFFSET UNITYSDK_OFFSET(0x1CBFA260)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_FROMTEAM_OFFSET UNITYSDK_OFFSET(0x1CBFA250)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_RELATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1CBFA290)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_SET_TOTEAM_OFFSET UNITYSDK_OFFSET(0x1CBFA270)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x1CBFA360)
#define RPG_CLIENT_FATERIN_CASEBOARD_TEAMRELATIONVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CBFA2A0)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int TeamRelationViewModel_TypeDefinitionIndex = 79489;

	class TeamRelationViewModel : public ::System::Object
	{
	public:
		::RPG::Client::FateRin::CaseBoard::TeamViewModel* _FromTeam_k__BackingField; // 0x10
		::RPG::Client::FateRin::CaseBoard::TeamViewModel* _ToTeam_k__BackingField; // 0x18
