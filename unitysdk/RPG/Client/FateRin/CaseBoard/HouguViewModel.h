...
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xCFFA2B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_GET_HOUGUID_OFFSET UNITYSDK_OFFSET(0xCFFA990)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xCFFAAA0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_GET_ISCOLLECTED_OFFSET UNITYSDK_OFFSET(0xCFFA9D0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCFFA9B0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xCFFAA20)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_SET_HOUGUID_OFFSET UNITYSDK_OFFSET(0xCFFA9A0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xCFFA9C0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL_UPDATE_OFFSET UNITYSDK_OFFSET(0xCFFA540)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFABC0)
#define RPG_CLIENT_FATERIN_CASEBOARD_HOUGUVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xCFFAC40)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int HouguViewModel_TypeDefinitionIndex = 79477;
