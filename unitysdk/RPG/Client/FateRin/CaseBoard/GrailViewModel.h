...
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A37FCD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_GET_ACQUIREPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A37FA00)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_GET_CASEBOARDSERVICE_OFFSET UNITYSDK_OFFSET(0x1A37F890)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1A37F9E0)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_GET_PROGRESSDESC_OFFSET UNITYSDK_OFFSET(0x1A37FA80)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_GET_TOTALHOUGUCOUNT_OFFSET UNITYSDK_OFFSET(0x1A37FC70)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_SETSHOW_OFFSET UNITYSDK_OFFSET(0x1A37CFD0)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x1A37F9F0)
#define RPG_CLIENT_FATERIN_CASEBOARD_GRAILVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A37FD40)

namespace RPG::Client::FateRin::CaseBoard
{
	inline static constexpr unsigned int GrailViewModel_TypeDefinitionIndex = 75842;
