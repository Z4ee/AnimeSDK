...
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GETCARDHEIGHT_OFFSET UNITYSDK_OFFSET(0xD030540)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_EVENTTRIGGERNODE_OFFSET UNITYSDK_OFFSET(0xD0282C0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_HANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD015110)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_OFFSETNODE_OFFSET UNITYSDK_OFFSET(0xD01FE40)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_GET_ROOT_OFFSET UNITYSDK_OFFSET(0xD0150A0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_PLAYFLYIN_OFFSET UNITYSDK_OFFSET(0xD0260F0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_PLAYREFLOW_OFFSET UNITYSDK_OFFSET(0xD020540)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_PLAYRETURNFROMFREECARD_OFFSET UNITYSDK_OFFSET(0xD01FE80)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_RESETTOIDLE_OFFSET UNITYSDK_OFFSET(0xD0302F0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETEVENTTRIGGEROFFSET_OFFSET UNITYSDK_OFFSET(0xD030440)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETHANDCARDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xD02FB00)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETOFFSETNODEWORLDPOSE_OFFSET UNITYSDK_OFFSET(0xD0161E0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_SETROOTLOCALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD0214D0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW_WORLDTOOFFSETLOCAL_OFFSET UNITYSDK_OFFSET(0xD025F30)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__CANCELCURRENTKEEPVISUALPOS_OFFSET UNITYSDK_OFFSET(0xD02FE50)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD030620)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__ENTERMOTIONWITHSTRATEGY_OFFSET UNITYSDK_OFFSET(0xD02FBA0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__ONMOTIONFINISHED_OFFSET UNITYSDK_OFFSET(0xD0305B0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__REBUILDCURRENTSTRATEGY_OFFSET UNITYSDK_OFFSET(0xD02FED0)
#define RPG_CLIENT_FATERIN_VIEW_CARD_FATERINCARDPOSCONTROLVIEW__WRITERETURNSTARTPOSE_OFFSET UNITYSDK_OFFSET(0xD0301D0)

namespace RPG::Client::FateRin::View::Card
{
	inline static constexpr unsigned int FateRinCardPosControlView_TypeDefinitionIndex = 79319;
