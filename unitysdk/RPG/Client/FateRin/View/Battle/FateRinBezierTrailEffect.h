...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1B5C6B50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1B5C6F20)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT_METHOD_5_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0x1B5C6F90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1B5C67E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0x1B5C6BA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1B5C6B10)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBEZIERTRAILEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C7000)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBezierTrailEffect_TypeDefinitionIndex = 79348;
