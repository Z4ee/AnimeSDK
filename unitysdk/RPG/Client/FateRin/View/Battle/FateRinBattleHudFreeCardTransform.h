...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_GETCARDWORLDPOS_OFFSET UNITYSDK_OFFSET(0xD01DEA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_GETCARDWORLDROTATION_OFFSET UNITYSDK_OFFSET(0xD01DF50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_GETCARDWORLDWIDTH_OFFSET UNITYSDK_OFFSET(0xD01E040)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_INIT_OFFSET UNITYSDK_OFFSET(0xD01D930)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD01D470)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_REFRESHSTATEANDPOS_OFFSET UNITYSDK_OFFSET(0xD01D9D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_SETCARDINDECKPOS_OFFSET UNITYSDK_OFFSET(0xD01E110)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM_SETCARDSIZEREFNODE_OFFSET UNITYSDK_OFFSET(0xD01DFF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__BEGINEASEWITHSOURCE_OFFSET UNITYSDK_OFFSET(0xD01E650)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__BEGINEASE_OFFSET UNITYSDK_OFFSET(0xD01EA40)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__COMPUTELARGEWORLDHALFHEIGHT_OFFSET UNITYSDK_OFFSET(0xD01E890)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0xD01F1E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__ENTERSTATE_OFFSET UNITYSDK_OFFSET(0xD01DAF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__EXITSTATE_OFFSET UNITYSDK_OFFSET(0xD01DA70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETCENTERANCHORSPACE_OFFSET UNITYSDK_OFFSET(0xD01E420)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETCENTERANCHOR_OFFSET UNITYSDK_OFFSET(0xD01E4B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETCURRENTCARDLOGICALWORLDPOS_OFFSET UNITYSDK_OFFSET(0xD01E750)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__GETLARGESCALE_OFFSET UNITYSDK_OFFSET(0xD01E5D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__REFRESHEASETARGETFORCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0xD01D5F0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__REFRESHTARGETINGCURVE_OFFSET UNITYSDK_OFFSET(0xD01D7C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__SETCARDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD01D6C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDFREECARDTRANSFORM__UPDATESTATE_OFFSET UNITYSDK_OFFSET(0xD01DDC0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudFreeCardTransform_TypeDefinitionIndex = 79344;
