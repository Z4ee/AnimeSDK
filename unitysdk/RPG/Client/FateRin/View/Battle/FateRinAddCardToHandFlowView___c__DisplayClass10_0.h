...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOHANDFLOWVIEW___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A399F00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOHANDFLOWVIEW___C__DISPLAYCLASS10_0___CREATECARDANIMATORPLAYACTIONCOMMAND_B__0_OFFSET UNITYSDK_OFFSET(0x1A399F60)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinAddCardToHandFlowView___c__DisplayClass10_0_TypeDefinitionIndex = 75693;

	class FateRinAddCardToHandFlowView___c__DisplayClass10_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::IList_1<::UnityEngine::Vector3>* spawnWorldPositions; // 0x10
		::System::Object* negativeEffectOwner; // 0x18
		::RPG::Client::FateRin::View::Battle::FateRinEffectController* effectController; // 0x20
		::System::Collections::Generic::IList_1<::RPG::Client::FateRin::View::Card::FateRinCardPosControlView*>* posCtrls; // 0x28
