...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINDISCARDCARDFLOWVIEW___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1970EBF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINDISCARDCARDFLOWVIEW___C__DISPLAYCLASS8_0___CREATEPERCARDCOMMAND_B__0_OFFSET UNITYSDK_OFFSET(0x1970F3D0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinDiscardCardFlowView___c__DisplayClass8_0_TypeDefinitionIndex = 75724;
	...
	public:
		...
		::RPG::Client::FateRin::View::Battle::FateRinDiscardCardFlowView* __4__this; // 0x18
