...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_2607E22D710FF025_OFFSET UNITYSDK_OFFSET(0xD0187E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_341A3DF81C331CBB_OFFSET UNITYSDK_OFFSET(0xD018690)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_52B6C8E3328F0DD1_OFFSET UNITYSDK_OFFSET(0xD016420)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_64587FE21067DFC1_OFFSET UNITYSDK_OFFSET(0xD017A70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_73897A3F6F629112_OFFSET UNITYSDK_OFFSET(0xD018960)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_7FFA59D764841066_OFFSET UNITYSDK_OFFSET(0xD017920)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_864765D5C3A0F56E_OFFSET UNITYSDK_OFFSET(0xD018520)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_8EC1D6F2D4E5DAC8_OFFSET UNITYSDK_OFFSET(0xD017CB0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_9DF4AE18A27A14EC_OFFSET UNITYSDK_OFFSET(0xD017BC0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_9E990ADBDFDA373F_OFFSET UNITYSDK_OFFSET(0xD018F80)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_B80FCB706F7045BB_OFFSET UNITYSDK_OFFSET(0xD018CA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_BE4C0A9B4FEBEC5B_OFFSET UNITYSDK_OFFSET(0xD018B70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_C7234EB4F5BB9CC8_OFFSET UNITYSDK_OFFSET(0xD018220)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_METHOD_5_E3C78D781491783F_OFFSET UNITYSDK_OFFSET(0xD018C30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_PLAYADDCARDTODISCARDPILEFLOW_OFFSET UNITYSDK_OFFSET(0xD017090)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_PLAYADDCARDTODRAWPILEFLOW_OFFSET UNITYSDK_OFFSET(0xD016320)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW_PLAYPROJECTIONREPLICATEFLOW_OFFSET UNITYSDK_OFFSET(0xD017180)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINADDCARDTOPILEFLOWVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD019250)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinAddCardToPileFlowView_TypeDefinitionIndex = 79331;
