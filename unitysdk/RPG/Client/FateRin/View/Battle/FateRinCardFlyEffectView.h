...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_CANCELALL_OFFSET UNITYSDK_OFFSET(0x1970B610)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0x1970AE30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_METHOD_5_D41F2EAAA87E2BFD_OFFSET UNITYSDK_OFFSET(0x1970B120)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_PLAYDRAWFLY_OFFSET UNITYSDK_OFFSET(0x1970AED0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_SCHEDULEAFTERDELAY_OFFSET UNITYSDK_OFFSET(0x1970B420)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1970B660)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinCardFlyEffectView_TypeDefinitionIndex = 75716;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_1274*(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDFLYEFFECTVIEW_METHOD_5_D41F2EAAA87E2BFD_OFFSET))(this);
		}
	};
}
