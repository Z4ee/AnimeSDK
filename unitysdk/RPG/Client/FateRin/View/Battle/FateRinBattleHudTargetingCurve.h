...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE_METHOD_5_55157FBA4997D865_OFFSET UNITYSDK_OFFSET(0x1B5C5EB0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE_SETPOINTS_OFFSET UNITYSDK_OFFSET(0x1B5BFF30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C6700)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudTargetingCurve_TypeDefinitionIndex = 79347;
