...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE_METHOD_5_55157FBA4997D865_OFFSET UNITYSDK_OFFSET(0x19709CD0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE_SETPOINTS_OFFSET UNITYSDK_OFFSET(0x19709730)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDTARGETINGCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1970A520)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudTargetingCurve_TypeDefinitionIndex = 75714;
