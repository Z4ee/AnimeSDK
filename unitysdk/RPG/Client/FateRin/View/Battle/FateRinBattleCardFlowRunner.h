...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_CANCELALLFLOWS_OFFSET UNITYSDK_OFFSET(0xD01A200)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_CANCELPROJECTIONREPLICATEFLOW_OFFSET UNITYSDK_OFFSET(0xD01BDE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD01A1B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_GET_ADDCARDTOHANDSPAWNANCHOR_OFFSET UNITYSDK_OFFSET(0xD01A430)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_GET__AUDIOSERVICE_OFFSET UNITYSDK_OFFSET(0xD01A5B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_INIT_OFFSET UNITYSDK_OFFSET(0xD01A170)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYADDCARDTODISCARDPILEFLOW_OFFSET UNITYSDK_OFFSET(0xD01C150)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYADDCARDTODRAWPILEFLOW_OFFSET UNITYSDK_OFFSET(0xD01C080)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYADDCARDTOHANDFLOW_OFFSET UNITYSDK_OFFSET(0xD01B1A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYDISCARDFLOWFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xD01C4A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYDISCARDFLOW_OFFSET UNITYSDK_OFFSET(0xD01C240)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYDRAWFLOW_OFFSET UNITYSDK_OFFSET(0xD01A4A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYFIREOUTFLOWFROMWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xD01CA10)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYFIREOUTFLOW_OFFSET UNITYSDK_OFFSET(0xD01C870)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYPROJECTIONREPLICATEFLOW_OFFSET UNITYSDK_OFFSET(0xD01BC90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYSHUFFLEFLOW_OFFSET UNITYSDK_OFFSET(0xD01CD20)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER_PLAYSTACKABLEADDCARDTOHANDFLOW_OFFSET UNITYSDK_OFFSET(0xD01B280)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER__CTOR_OFFSET UNITYSDK_OFFSET(0xD01D3B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER__TRACK_OFFSET UNITYSDK_OFFSET(0xD01B000)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLECARDFLOWRUNNER__UNTRACK_OFFSET UNITYSDK_OFFSET(0xD01BF50)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleCardFlowRunner_TypeDefinitionIndex = 79341;
