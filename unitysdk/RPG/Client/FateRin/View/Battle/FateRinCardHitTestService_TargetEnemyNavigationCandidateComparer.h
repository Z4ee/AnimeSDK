...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDHITTESTSERVICE_TARGETENEMYNAVIGATIONCANDIDATECOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1970D6C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDHITTESTSERVICE_TARGETENEMYNAVIGATIONCANDIDATECOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1970D7A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINCARDHITTESTSERVICE_TARGETENEMYNAVIGATIONCANDIDATECOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1970D790)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinCardHitTestService_TargetEnemyNavigationCandidateComparer_TypeDefinitionIndex = 75719;
	...
	public:
		...
		{
			return (::RPG::Client::FateRin::View::Battle::FateRinCardHitTestService_TargetEnemyNavigationCandidateComparer**)Il2CppClass::FromTypeDefinitionIndex(FateRinCardHitTestService_TargetEnemyNavigationCandidateComparer_TypeDefinitionIndex)->GetStaticField(0xCCA0);
		}
