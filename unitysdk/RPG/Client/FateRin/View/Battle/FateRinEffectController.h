...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_CANCELALLFOR_OFFSET UNITYSDK_OFFSET(0xD015B60)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD02B240)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD02B030)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD02CB70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYCARDFADEAWAYOUTTRAIL_OFFSET UNITYSDK_OFFSET(0xD02B860)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYCOINEFFECT_OFFSET UNITYSDK_OFFSET(0xD02BAB0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYNEGATIVEADDCARDSIDEEFFECTS_OFFSET UNITYSDK_OFFSET(0xD015A00)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYTRAIL_OFFSET UNITYSDK_OFFSET(0xD02B4B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_SETCOINEFFECTPAUSEFOR_OFFSET UNITYSDK_OFFSET(0xD02C290)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ADDACTIVEEFFECT_OFFSET UNITYSDK_OFFSET(0xD02BDC0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ADDACTIVETRAIL_OFFSET UNITYSDK_OFFSET(0xD02B800)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__CANCELALLINTERNAL_OFFSET UNITYSDK_OFFSET(0xD02B2B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD02CBF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ONTRAILNATURALCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD02C9E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__PLAYCOINFADEIN_OFFSET UNITYSDK_OFFSET(0xD02BFC0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__PLAYCOINFADEOUT_OFFSET UNITYSDK_OFFSET(0xD02C760)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETANIMATIONSTATESPEED_OFFSET UNITYSDK_OFFSET(0xD02C940)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETCOINANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0xD02C550)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETFRONTCOINTIPS_OFFSET UNITYSDK_OFFSET(0xD02BC50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SPAWNPOSITIONEFFECT_OFFSET UNITYSDK_OFFSET(0xD02B9D0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinEffectController_TypeDefinitionIndex = 79365;
