...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_CANCELALLFOR_OFFSET UNITYSDK_OFFSET(0x1B5B6E50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5CC530)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x1B5CC320)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B5CDE60)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYCARDFADEAWAYOUTTRAIL_OFFSET UNITYSDK_OFFSET(0x1B5CCB50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYCOINEFFECT_OFFSET UNITYSDK_OFFSET(0x1B5CCDA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYNEGATIVEADDCARDSIDEEFFECTS_OFFSET UNITYSDK_OFFSET(0x1B5B6CF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_PLAYTRAIL_OFFSET UNITYSDK_OFFSET(0x1B5CC7A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER_SETCOINEFFECTPAUSEFOR_OFFSET UNITYSDK_OFFSET(0x1B5CD580)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ADDACTIVEEFFECT_OFFSET UNITYSDK_OFFSET(0x1B5CD0B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ADDACTIVETRAIL_OFFSET UNITYSDK_OFFSET(0x1B5CCAF0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__CANCELALLINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B5CC5A0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5CDEE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__ONTRAILNATURALCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B5CDCD0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__PLAYCOINFADEIN_OFFSET UNITYSDK_OFFSET(0x1B5CD2B0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__PLAYCOINFADEOUT_OFFSET UNITYSDK_OFFSET(0x1B5CDA50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETANIMATIONSTATESPEED_OFFSET UNITYSDK_OFFSET(0x1B5CDC30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETCOINANIMATIONSPEED_OFFSET UNITYSDK_OFFSET(0x1B5CD840)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SETFRONTCOINTIPS_OFFSET UNITYSDK_OFFSET(0x1B5CCF40)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINEFFECTCONTROLLER__SPAWNPOSITIONEFFECT_OFFSET UNITYSDK_OFFSET(0x1B5CCCC0)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinEffectController_TypeDefinitionIndex = 79364;
