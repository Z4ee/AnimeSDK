...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINFIREOUTCARDFLOWVIEW___C__DISPLAYCLASS4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x197138C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINFIREOUTCARDFLOWVIEW___C__DISPLAYCLASS4_1___PLAYFIREOUTFLOW_B__1_OFFSET UNITYSDK_OFFSET(0x19713910)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinFireOutCardFlowView___c__DisplayClass4_1_TypeDefinitionIndex = 75737;
