...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_GETCARDPOSCONTROL_OFFSET UNITYSDK_OFFSET(0x1B5C0BE0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_INITLAYOUTPARAMS_OFFSET UNITYSDK_OFFSET(0x1B5C04E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_PLAYCARDUNSELECTANIMFROMPOS_OFFSET UNITYSDK_OFFSET(0x1B5C0D10)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_REFLOWHANDCARDS_OFFSET UNITYSDK_OFFSET(0x1B5C0A30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_SETCARDS_OFFSET UNITYSDK_OFFSET(0x1B5C06E0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT_SETINTERACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1B5C0860)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__BUILDANGLES_OFFSET UNITYSDK_OFFSET(0x1B5C1E70)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__BUILDFILTEREDLAYOUTENTRIES_OFFSET UNITYSDK_OFFSET(0x1B5C2190)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__BUILDREFLOWLAYOUTENTRIES_OFFSET UNITYSDK_OFFSET(0x1B5C1240)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__CALCANGLESTEPFORCOUNT_OFFSET UNITYSDK_OFFSET(0x1B5C24C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__COLLECTACTIVECARDS_OFFSET UNITYSDK_OFFSET(0x1B5C1C30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__COMPUTESPREADOFFSETBYSLOTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B5C20D0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5C29C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__FINDCARDBYVM_OFFSET UNITYSDK_OFFSET(0x1B5C0F90)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__FINDCARDSLOT_OFFSET UNITYSDK_OFFSET(0x1B5C2020)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__GETCARDTRANSFORMBYANGLE_OFFSET UNITYSDK_OFFSET(0x1B5C2530)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__GETCURRENTCARDVM_OFFSET UNITYSDK_OFFSET(0x1B5C09C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__HASEXCLUDEDCARD_OFFSET UNITYSDK_OFFSET(0x1B5C1B30)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISCARDINPRELAYOUT_OFFSET UNITYSDK_OFFSET(0x1B5C2430)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISCARDSKIPLAYOUT_OFFSET UNITYSDK_OFFSET(0x1B5C19C0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISEXCLUDEDCARD_OFFSET UNITYSDK_OFFSET(0x1B5C1A50)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISSAMEHANDVM_OFFSET UNITYSDK_OFFSET(0x1B5C1AA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__ISVALIDCARDINDEX_OFFSET UNITYSDK_OFFSET(0x1B5C0CB0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__REFRESHLAYERORDER_OFFSET UNITYSDK_OFFSET(0x1B5C0740)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINBATTLEHUDHANDCARDLAYOUT__SETCARDPOSBYANGLE_OFFSET UNITYSDK_OFFSET(0x1B5C1750)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinBattleHudHandCardLayout_TypeDefinitionIndex = 79344;
