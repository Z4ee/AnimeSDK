...
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINDRAWCARDFLOWVIEW___C__DISPLAYCLASS10_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5CBAA0)
#define RPG_CLIENT_FATERIN_VIEW_BATTLE_FATERINDRAWCARDFLOWVIEW___C__DISPLAYCLASS10_0___CREATEPERCARDCOMMAND_B__0_OFFSET UNITYSDK_OFFSET(0x1B5CC050)

namespace RPG::Client::FateRin::View::Battle
{
	inline static constexpr unsigned int FateRinDrawCardFlowView___c__DisplayClass10_0_TypeDefinitionIndex = 79359;
	...
	public:
		...
		::RPG::Client::FateRin::Battle::IFateRinBattleHudHandCardViewModel* handCardVm; // 0x18
