...
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_GET_BORDERTRANS_OFFSET UNITYSDK_OFFSET(0xCF5DF80)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0xCF5DF50)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_SET_BORDERTRANS_OFFSET UNITYSDK_OFFSET(0xCF5DF90)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0xCF5DF70)
#define RPG_CLIENT_FATERIN_AVATAR_FATERINBATTLEAVATARULTRADETAILOPENPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCF5DFA0)

namespace RPG::Client::FateRin::Avatar
{
	inline static constexpr unsigned int FateRinBattleAvatarUltraDetailOpenParam_TypeDefinitionIndex = 79911;
