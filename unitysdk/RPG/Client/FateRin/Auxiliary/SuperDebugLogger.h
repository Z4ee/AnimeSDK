...
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x1CA204B0)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_ASSERT_OFFSET UNITYSDK_OFFSET(0x1CA20460)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1CA20330)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_LOGINFO_OFFSET UNITYSDK_OFFSET(0x1CA20290)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1CA202E0)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER__BUILDLOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x1CA203E0)
#define RPG_CLIENT_FATERIN_AUXILIARY_SUPERDEBUGLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CA20280)

namespace RPG::Client::FateRin::Auxiliary
{
	inline static constexpr unsigned int SuperDebugLogger_TypeDefinitionIndex = 79736;
