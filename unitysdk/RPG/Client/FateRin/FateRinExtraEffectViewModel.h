...
#define RPG_CLIENT_FATERIN_FATERINEXTRAEFFECTVIEWMODEL_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1A387FE0)
#define RPG_CLIENT_FATERIN_FATERINEXTRAEFFECTVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A387F80)
#define RPG_CLIENT_FATERIN_FATERINEXTRAEFFECTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A387F00)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int FateRinExtraEffectViewModel_TypeDefinitionIndex = 75669;
