...
#define RPG_CLIENT_FATERIN_BASEVIEWMODEL_ADD_ONREFRESH_OFFSET UNITYSDK_OFFSET(0xCF5F560)
#define RPG_CLIENT_FATERIN_BASEVIEWMODEL_REMOVE_ONREFRESH_OFFSET UNITYSDK_OFFSET(0xCF5F5C0)
#define RPG_CLIENT_FATERIN_BASEVIEWMODEL__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCF5F4E0)
#define RPG_CLIENT_FATERIN_BASEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCF5DBF0)
#define RPG_CLIENT_FATERIN_BASEVIEWMODEL__RAISEREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0xCF5E550)

namespace RPG::Client::FateRin
{
	inline static constexpr unsigned int BaseViewModel_TypeDefinitionIndex = 79301;
