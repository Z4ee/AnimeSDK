...
#define RPG_CLIENT_EXPEDITIONBATTLEMAPFUNVIEWMODEL_GET_AVATARICONPATH_OFFSET UNITYSDK_OFFSET(0xCEFBEE0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPFUNVIEWMODEL_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xCEFBE90)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPFUNVIEWMODEL_GET_FUNCNT_OFFSET UNITYSDK_OFFSET(0xCEFBE40)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPFUNVIEWMODEL_GET_FUNDESC_OFFSET UNITYSDK_OFFSET(0xCEFBDD0)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPFUNVIEWMODEL_GET_FUNNAME_OFFSET UNITYSDK_OFFSET(0xCEFBD60)
#define RPG_CLIENT_EXPEDITIONBATTLEMAPFUNVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCEFBFF0)
