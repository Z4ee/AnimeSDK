...
#define RPG_CLIENT_PAYMODULE___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4FB820)
#define RPG_CLIENT_PAYMODULE___C__DISPLAYCLASS36_0__PAY_B__0_OFFSET UNITYSDK_OFFSET(0x1C4FC890)

namespace RPG::Client
{
	inline static constexpr unsigned int PayModule___c__DisplayClass36_0_TypeDefinitionIndex = 66468;
