...
#define RPG_CLIENT_PAYMODULE___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC3545E0)
#define RPG_CLIENT_PAYMODULE___C__DISPLAYCLASS36_0__PAY_B__0_OFFSET UNITYSDK_OFFSET(0xC3557D0)

namespace RPG::Client
{
	inline static constexpr unsigned int PayModule___c__DisplayClass36_0_TypeDefinitionIndex = 62118;
