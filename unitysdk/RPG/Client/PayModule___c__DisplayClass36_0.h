...
#define RPG_CLIENT_PAYMODULE___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17F31CD0)
#define RPG_CLIENT_PAYMODULE___C__DISPLAYCLASS36_0__PAY_B__0_OFFSET UNITYSDK_OFFSET(0x17F33130)

namespace RPG::Client
{
	inline static constexpr unsigned int PayModule___c__DisplayClass36_0_TypeDefinitionIndex = 63483;
	...
	public:
		...
		::RPG::Client::Product* product; // 0x20
