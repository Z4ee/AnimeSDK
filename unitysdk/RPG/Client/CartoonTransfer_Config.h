...
#define RPG_CLIENT_CARTOONTRANSFER_CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C85D0B0)

namespace RPG::Client
{
	inline static constexpr unsigned int CartoonTransfer_Config_TypeDefinitionIndex = 72441;
