...
#define RPG_CLIENT_INVERSEMASK_ADDMASKRECT_OFFSET UNITYSDK_OFFSET(0x99614C0)
#define RPG_CLIENT_INVERSEMASK_ADDMASKREGION_OFFSET UNITYSDK_OFFSET(0x9960C50)
#define RPG_CLIENT_INVERSEMASK_ADDTRANS_OFFSET UNITYSDK_OFFSET(0x9960460)
#define RPG_CLIENT_INVERSEMASK_AWAKE_OFFSET UNITYSDK_OFFSET(0x9962370)
#define RPG_CLIENT_INVERSEMASK_CLEAR_OFFSET UNITYSDK_OFFSET(0x9961DC0)
#define RPG_CLIENT_INVERSEMASK_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x9961D60)
#define RPG_CLIENT_INVERSEMASK_GET_UICAM_OFFSET UNITYSDK_OFFSET(0x99625D0)
#define RPG_CLIENT_INVERSEMASK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x99624E0)
#define RPG_CLIENT_INVERSEMASK_START_OFFSET UNITYSDK_OFFSET(0x99623E0)
#define RPG_CLIENT_INVERSEMASK_UPDATEBLUR_OFFSET UNITYSDK_OFFSET(0x9961CA0)
#define RPG_CLIENT_INVERSEMASK_UPDATEMASKRECT_OFFSET UNITYSDK_OFFSET(0x9961940)
#define RPG_CLIENT_INVERSEMASK_UPDATEMASKREGION_OFFSET UNITYSDK_OFFSET(0x9961330)
#define RPG_CLIENT_INVERSEMASK_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9961EA0)
#define RPG_CLIENT_INVERSEMASK_UPDATETRANS_OFFSET UNITYSDK_OFFSET(0x9960AC0)
#define RPG_CLIENT_INVERSEMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x9962740)
#define RPG_CLIENT_INVERSEMASK__SCALEVECTOR_OFFSET UNITYSDK_OFFSET(0x9961820)
#define RPG_CLIENT_INVERSEMASK__SETPOSITIONBYBOUNDS_OFFSET UNITYSDK_OFFSET(0x9960E00)
#define RPG_CLIENT_INVERSEMASK__SETPOSITIONBYRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9960600)
#define RPG_CLIENT_INVERSEMASK___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9962940)
#define RPG_CLIENT_INVERSEMASK___IFIXBASEPROXY_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x9962920)
#define RPG_CLIENT_INVERSEMASK___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9962960)
#define RPG_CLIENT_INVERSEMASK___IFIXBASEPROXY_START_OFFSET UNITYSDK_OFFSET(0x9962950)
#define RPG_CLIENT_INVERSEMASK___IFIXBASEPROXY_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x9962930)

namespace RPG::Client
{
	inline static constexpr unsigned int InverseMask_TypeDefinitionIndex = 59454;
	...
	public:
		...
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(InverseMask_TypeDefinitionIndex)->GetStaticField(0x21B30);
		}
		static ::System::Int32* StaticGet_m_Count()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InverseMask_TypeDefinitionIndex)->GetStaticField(0x8D70);
		}
