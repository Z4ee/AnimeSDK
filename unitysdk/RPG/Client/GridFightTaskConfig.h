...
#define RPG_CLIENT_GRIDFIGHTTASKCONFIG_GET_LEVELGRAPHPATH_OFFSET UNITYSDK_OFFSET(0x1A5D9A20)
#define RPG_CLIENT_GRIDFIGHTTASKCONFIG_GET_TASKID_OFFSET UNITYSDK_OFFSET(0x1A5D9A10)
#define RPG_CLIENT_GRIDFIGHTTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D99C0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTaskConfig_TypeDefinitionIndex = 62581;
