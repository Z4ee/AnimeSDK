...
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_CHECKSLOTISEFFECTED_OFFSET UNITYSDK_OFFSET(0x1BB12DF0)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_GETSPECIALSLOTLIST_OFFSET UNITYSDK_OFFSET(0x1BB12D40)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_GET_EFFECTSLOTLIST_OFFSET UNITYSDK_OFFSET(0x1BB12F10)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_GET__AREACONFIG_OFFSET UNITYSDK_OFFSET(0x1BB12F60)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_ONTRAITCHANGE_OFFSET UNITYSDK_OFFSET(0x1BB12BF0)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT_SET__AREACONFIG_OFFSET UNITYSDK_OFFSET(0x1BB12F70)
#define RPG_CLIENT_GRIDFIGHTTRAITSPSLOTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BB12AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTraitSPSlotEffect_TypeDefinitionIndex = 65461;
