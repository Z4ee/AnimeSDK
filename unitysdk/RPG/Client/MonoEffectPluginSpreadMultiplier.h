...
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CDDF40)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x9CDDFD0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_ENDSCALECONTROL_OFFSET UNITYSDK_OFFSET(0x9CDE3A0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_GETCURRENTSCALE_OFFSET UNITYSDK_OFFSET(0x9CDDED0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x9CDDAB0)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_SETSCALE_OFFSET UNITYSDK_OFFSET(0x9CDDE70)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER_STARTSCALECONTROL_OFFSET UNITYSDK_OFFSET(0x9CDE330)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CDE410)
#define RPG_CLIENT_MONOEFFECTPLUGINSPREADMULTIPLIER___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x9CDE420)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginSpreadMultiplier_TypeDefinitionIndex = 57375;
