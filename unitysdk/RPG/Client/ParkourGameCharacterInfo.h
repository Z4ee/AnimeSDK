...
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A2EE390)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A2EE300)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_GET_ISOVERTAKING_OFFSET UNITYSDK_OFFSET(0x1A2EE370)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_GET_MINIMAPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A2EE350)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A2EE330)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_GET_RANK_OFFSET UNITYSDK_OFFSET(0x1A2EE310)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_SET_ISOVERTAKING_OFFSET UNITYSDK_OFFSET(0x1A2EE380)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_SET_MINIMAPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A2EE360)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A2EE340)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_SET_RANK_OFFSET UNITYSDK_OFFSET(0x1A2EE320)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_UPDATEMINIMAP_OFFSET UNITYSDK_OFFSET(0x1A2EE490)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2EE430)
#define RPG_CLIENT_PARKOURGAMECHARACTERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EE3F0)
