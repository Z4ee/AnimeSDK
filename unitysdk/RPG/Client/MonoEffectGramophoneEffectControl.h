...
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_0D64F99BAAA7B5C4_OFFSET UNITYSDK_OFFSET(0xC08C0A0)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xC08B140)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_3CF43707BF2E9BBA_OFFSET UNITYSDK_OFFSET(0xC08B2D0)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0xC08B600)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC08B080)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_E52129E82CD2D7F8_1_OFFSET UNITYSDK_OFFSET(0xC08B490)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xC08BEE0)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC08B7D0)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC08B6C0)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC08B880)
#define RPG_CLIENT_MONOEFFECTGRAMOPHONEEFFECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC08C220)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectGramophoneEffectControl_TypeDefinitionIndex = 66150;
