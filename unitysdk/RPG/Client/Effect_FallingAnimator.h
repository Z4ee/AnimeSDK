...
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA1CB4B0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_INIT_OFFSET UNITYSDK_OFFSET(0xA1CAAC0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_356114EF3CF36D59_OFFSET UNITYSDK_OFFSET(0xA1CC5D0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_4CD934F1AB922E45_OFFSET UNITYSDK_OFFSET(0xA1CBD10)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_77FD543600E00498_1_OFFSET UNITYSDK_OFFSET(0xA1CB120)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_77FD543600E00498_2_OFFSET UNITYSDK_OFFSET(0xA1CB370)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xA1CB080)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_METHOD_5_FA7F07669215B524_OFFSET UNITYSDK_OFFSET(0xA1CB2E0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA1CB460)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA1CB410)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_REGENERATE_OFFSET UNITYSDK_OFFSET(0xA1CAA70)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0xA1CB5B0)
#define RPG_CLIENT_EFFECT_FALLINGANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA1CC7C0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_FallingAnimator_TypeDefinitionIndex = 64966;
