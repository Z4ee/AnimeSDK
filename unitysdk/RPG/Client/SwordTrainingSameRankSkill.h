...
#define RPG_CLIENT_SWORDTRAININGSAMERANKSKILL__CTOR_OFFSET UNITYSDK_OFFSET(0x3B894C0)

namespace RPG::Client
{
	inline static constexpr unsigned int SwordTrainingSameRankSkill_TypeDefinitionIndex = 62060;
