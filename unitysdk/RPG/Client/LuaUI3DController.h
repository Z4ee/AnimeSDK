...
#define RPG_CLIENT_LUAUI3DCONTROLLER_CREATE_OFFSET UNITYSDK_OFFSET(0xD59D1E0)
#define RPG_CLIENT_LUAUI3DCONTROLLER_GETENVIRONMENTPROFILEPATH_OFFSET UNITYSDK_OFFSET(0xD59D370)
#define RPG_CLIENT_LUAUI3DCONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0xD59D260)
#define RPG_CLIENT_LUAUI3DCONTROLLER_ISCONTROLLERVALID_OFFSET UNITYSDK_OFFSET(0xD59D320)
#define RPG_CLIENT_LUAUI3DCONTROLLER_ONRELOADENVIRONMENT_OFFSET UNITYSDK_OFFSET(0xD59D4E0)
#define RPG_CLIENT_LUAUI3DCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD59D1B0)
#define RPG_CLIENT_LUAUI3DCONTROLLER__ONACTIVECHANGE_OFFSET UNITYSDK_OFFSET(0xD59D870)
#define RPG_CLIENT_LUAUI3DCONTROLLER__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0xD59D7D0)
#define RPG_CLIENT_LUAUI3DCONTROLLER__ONLOAD_OFFSET UNITYSDK_OFFSET(0xD59D630)
#define RPG_CLIENT_LUAUI3DCONTROLLER__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0xD59D980)
#define RPG_CLIENT_LUAUI3DCONTROLLER__SETUPVIEW_OFFSET UNITYSDK_OFFSET(0xD59D820)
#define RPG_CLIENT_LUAUI3DCONTROLLER__TRYCALLLUA_OFFSET UNITYSDK_OFFSET(0xD59D680)
