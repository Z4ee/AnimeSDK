...
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERMONOPLUGIN_BIND_OFFSET UNITYSDK_OFFSET(0xB739BD0)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERMONOPLUGIN_UNBIND_OFFSET UNITYSDK_OFFSET(0xB739F90)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERMONOPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0xB73A030)
#define RPG_CLIENT_DEFORMATIONCHARACTERCASTERMONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xB739FF0)

namespace RPG::Client
{
	inline static constexpr unsigned int DeformationCharacterCasterMonoPlugin_TypeDefinitionIndex = 65704;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DeformationCharacterCasterMonoPlugin_TypeDefinitionIndex)->GetStaticField(0x3480);
		}
