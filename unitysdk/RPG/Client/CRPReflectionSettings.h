...
#define RPG_CLIENT_CRPREFLECTIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11DC20)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPReflectionSettings_TypeDefinitionIndex = 67929;
