...
#define RPG_CLIENT_CRPREFLECTIONSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9211CB0)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPReflectionSettings_TypeDefinitionIndex = 55431;
