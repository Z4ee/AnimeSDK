...
#define RPG_CLIENT_MONODICECOMBATCOLLECTIONDOFCONTROLLER_METHOD_5_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0xA929BA0)
#define RPG_CLIENT_MONODICECOMBATCOLLECTIONDOFCONTROLLER_METHOD_5_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xA929B30)
#define RPG_CLIENT_MONODICECOMBATCOLLECTIONDOFCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA929CE0)
#define RPG_CLIENT_MONODICECOMBATCOLLECTIONDOFCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xA929960)
#define RPG_CLIENT_MONODICECOMBATCOLLECTIONDOFCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA929A80)
#define RPG_CLIENT_MONODICECOMBATCOLLECTIONDOFCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA929E90)
