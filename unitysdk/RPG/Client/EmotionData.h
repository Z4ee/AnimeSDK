...
#define RPG_CLIENT_EMOTIONDATA_GET_EMOTIONCLIPPATH_OFFSET UNITYSDK_OFFSET(0x1A1790D0)
#define RPG_CLIENT_EMOTIONDATA_GET_EMOTIONICONPATH_OFFSET UNITYSDK_OFFSET(0x1A1790B0)
#define RPG_CLIENT_EMOTIONDATA_GET_EMOTIONID_OFFSET UNITYSDK_OFFSET(0x1A179070)
#define RPG_CLIENT_EMOTIONDATA_GET_EMOTIONNAME_OFFSET UNITYSDK_OFFSET(0x1A179090)
#define RPG_CLIENT_EMOTIONDATA_SET_EMOTIONCLIPPATH_OFFSET UNITYSDK_OFFSET(0x1A1790E0)
#define RPG_CLIENT_EMOTIONDATA_SET_EMOTIONICONPATH_OFFSET UNITYSDK_OFFSET(0x1A1790C0)
#define RPG_CLIENT_EMOTIONDATA_SET_EMOTIONID_OFFSET UNITYSDK_OFFSET(0x1A179080)
#define RPG_CLIENT_EMOTIONDATA_SET_EMOTIONNAME_OFFSET UNITYSDK_OFFSET(0x1A1790A0)
#define RPG_CLIENT_EMOTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1790F0)
