...
#define RPG_CLIENT_CAMERASOMATODYNAMICANCHOROFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x925B980)

namespace RPG::Client
{
	inline static constexpr unsigned int CameraSomatoDynamicAnchorOffset_TypeDefinitionIndex = 57014;
