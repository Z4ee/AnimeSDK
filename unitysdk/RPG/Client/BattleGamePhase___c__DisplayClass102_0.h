...
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS102_0__CTOR_OFFSET UNITYSDK_OFFSET(0x91B0E40)
#define RPG_CLIENT_BATTLEGAMEPHASE___C__DISPLAYCLASS102_0__TRIGGERFRAMECAPTUREPAGE_B__0_OFFSET UNITYSDK_OFFSET(0x91B82A0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleGamePhase___c__DisplayClass102_0_TypeDefinitionIndex = 49428;
