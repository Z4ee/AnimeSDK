...
#define RPG_CLIENT_MUSEUMTURNRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0xC2131B0)

namespace RPG::Client
{
	inline static constexpr unsigned int MuseumTurnResult_TypeDefinitionIndex = 62030;
