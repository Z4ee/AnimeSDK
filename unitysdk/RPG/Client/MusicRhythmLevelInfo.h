...
#define RPG_CLIENT_MUSICRHYTHMLEVELINFO_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x13FB10)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmLevelInfo_TypeDefinitionIndex = 57805;
