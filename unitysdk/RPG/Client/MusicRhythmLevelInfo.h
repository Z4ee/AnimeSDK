...
#define RPG_CLIENT_MUSICRHYTHMLEVELINFO_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x814A0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicRhythmLevelInfo_TypeDefinitionIndex = 50171;
