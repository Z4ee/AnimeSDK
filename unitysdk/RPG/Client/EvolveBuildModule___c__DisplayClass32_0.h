...
#define RPG_CLIENT_EVOLVEBUILDMODULE___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB949E30)
#define RPG_CLIENT_EVOLVEBUILDMODULE___C__DISPLAYCLASS32_0__RETURNTOMAZE_B__0_OFFSET UNITYSDK_OFFSET(0xB952850)
#define RPG_CLIENT_EVOLVEBUILDMODULE___C__DISPLAYCLASS32_0__RETURNTOMAZE_B__1_OFFSET UNITYSDK_OFFSET(0xB952970)

namespace RPG::Client
{
	inline static constexpr unsigned int EvolveBuildModule___c__DisplayClass32_0_TypeDefinitionIndex = 59726;
