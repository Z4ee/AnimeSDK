...
#define RPG_CLIENT_PLANARREFLECTIONFALLBACKBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0xDB29D50)
#define RPG_CLIENT_PLANARREFLECTIONFALLBACKBEHAVIOR_METHOD_3_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0xDB29C20)
#define RPG_CLIENT_PLANARREFLECTIONFALLBACKBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xDB29BB0)
#define RPG_CLIENT_PLANARREFLECTIONFALLBACKBEHAVIOR_METHOD_3_8DCD1FEC09DA5176_OFFSET UNITYSDK_OFFSET(0xDB29DD0)
#define RPG_CLIENT_PLANARREFLECTIONFALLBACKBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xDB29EE0)
#define RPG_CLIENT_PLANARREFLECTIONFALLBACKBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xDB2A6A0)
