...
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13ADB0)
#define RPG_CLIENT_UI3DTRANSITION___C__DISPLAYCLASS3_0__EXECUTESHOW_B__0_OFFSET UNITYSDK_OFFSET(0x16FE5A00)

namespace RPG::Client
{
	inline static constexpr unsigned int UI3DTransition___c__DisplayClass3_0_TypeDefinitionIndex = 72927;
