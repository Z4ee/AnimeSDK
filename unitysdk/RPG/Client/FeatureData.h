...
#define RPG_CLIENT_FEATUREDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1972B770)
#define RPG_CLIENT_FEATUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1972B7B0)

namespace RPG::Client
{
	inline static constexpr unsigned int FeatureData_TypeDefinitionIndex = 57341;
