...
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GETSENDTEXT_OFFSET UNITYSDK_OFFSET(0xC32F430)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0xC32F9D0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_ISAVATARSELECTED_OFFSET UNITYSDK_OFFSET(0xC32F490)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xC32F9C0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC32F420)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__GETFUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0xC32F8B0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__GETSELECTEDAVATARNAME_OFFSET UNITYSDK_OFFSET(0xC32F4A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PamChatQuickFunctionMessage_TypeDefinitionIndex = 59225;

	class PamChatQuickFunctionMessage : public ::System::Object
	{
	public:
		::System::UInt32 _AvatarID_k__BackingField; // 0x10
		::RPG::Client::PamChatQuickFunctionType _Type_k__BackingField; // 0x14
