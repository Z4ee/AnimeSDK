...
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GETSENDTEXT_OFFSET UNITYSDK_OFFSET(0x1A2E06D0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x1A2E0D10)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_ISAVATARSELECTED_OFFSET UNITYSDK_OFFSET(0x1A2E0760)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A2E0D00)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E06C0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__GETFUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1A2E0BF0)
#define RPG_CLIENT_PAMCHATQUICKFUNCTIONMESSAGE__GETSELECTEDAVATARNAME_OFFSET UNITYSDK_OFFSET(0x1A2E07B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PamChatQuickFunctionMessage_TypeDefinitionIndex = 60496;
