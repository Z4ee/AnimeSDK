...
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_APPENDBATTLEAREABLOCKROOT_OFFSET UNITYSDK_OFFSET(0x9977AC0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_GET_BASEOFFSET_OFFSET UNITYSDK_OFFSET(0x9977B70)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_HIDESTAGE_OFFSET UNITYSDK_OFFSET(0x99775E0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_INITORIGINPOS_OFFSET UNITYSDK_OFFSET(0x9977760)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_INITROTATION_OFFSET UNITYSDK_OFFSET(0x99777D0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x99770D0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x9977480)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_MOVESTAGETOTARGET_OFFSET UNITYSDK_OFFSET(0x99778D0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_ONBATTLEFINISH_OFFSET UNITYSDK_OFFSET(0x99779A0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x99773C0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_RESETSTAGEPOS_OFFSET UNITYSDK_OFFSET(0x9977A10)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SETBASEOFFSET_OFFSET UNITYSDK_OFFSET(0x9977850)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SETOWNERBLOCK_OFFSET UNITYSDK_OFFSET(0x9977430)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SHOWSTAGEIFHIDE_OFFSET UNITYSDK_OFFSET(0x9977540)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_SHOWSTAGE_OFFSET UNITYSDK_OFFSET(0x9977260)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x99771D0)
#define RPG_CLIENT_LEVELSTAGEVISABLECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9977B90)

namespace RPG::Client
{
	inline static constexpr unsigned int LevelStageVisableController_TypeDefinitionIndex = 56258;
