...
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_GET_TOTALTIME_OFFSET UNITYSDK_OFFSET(0x15100150)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x151000D0)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_071850D2764E9D4C_OFFSET UNITYSDK_OFFSET(0x150FD670)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0x150FDC50)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0x150FD620)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x150FD5B0)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_63A8438E4C8CEB3A_OFFSET UNITYSDK_OFFSET(0x15100270)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x150FDB30)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x150FDB70)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x150FDBB0)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x150FDAF0)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x150FDBF0)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x15100980)
#define RPG_CLIENT_EFFECT_KALEIDOSCOPEANIMATORBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x15100970)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_KaleidoscopeAnimatorBehavior_TypeDefinitionIndex = 67334;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Effect_KaleidoscopeAnimatorBehavior_TypeDefinitionIndex)->GetStaticField(0x14800);
		}
