...
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_CREATEINBATTLE_OFFSET UNITYSDK_OFFSET(0xA2B6920)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_CREATEOUTSIDEBATTLE_OFFSET UNITYSDK_OFFSET(0xA2B6660)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_CREATE_OFFSET UNITYSDK_OFFSET(0xA2B6880)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_DOSHOWUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xA2B7650)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GETCANSHOWUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xA2B6D50)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GETTUTORIALANDTUTORIALUNLOCKID_OFFSET UNITYSDK_OFFSET(0xA2B7380)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_CARDDATA_OFFSET UNITYSDK_OFFSET(0xA2B79F0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_ISFULLCARDUNLOCKED_OFFSET UNITYSDK_OFFSET(0xA2B7D50)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_NAME_OFFSET UNITYSDK_OFFSET(0xA2B7DF0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_STAGEMERGEDID_OFFSET UNITYSDK_OFFSET(0xA2B79D0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET_UNLOCKCHIPINDEX_OFFSET UNITYSDK_OFFSET(0xA2B75B0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET__CARDID_OFFSET UNITYSDK_OFFSET(0xA2B7A90)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_GET__MODULE_OFFSET UNITYSDK_OFFSET(0xA2B7080)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_OPENRESULTPAGE_OFFSET UNITYSDK_OFFSET(0xA2B7210)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_SETSHOWNUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xA2B78B0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_SET_STAGEMERGEDID_OFFSET UNITYSDK_OFFSET(0xA2B79E0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD_TRYSHOWUNLOCKCHIP_OFFSET UNITYSDK_OFFSET(0xA2B6ED0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA2B6AB0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__GETNEXTSTAGEUNLOCKQUESTSTATUS_OFFSET UNITYSDK_OFFSET(0xA2B6DA0)
#define RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__ONQUESTUPDATED_OFFSET UNITYSDK_OFFSET(0xA2B7910)

namespace RPG::Client
{
	inline static constexpr unsigned int EvolveBuildDemonKingCard_TypeDefinitionIndex = 58824;

	class EvolveBuildDemonKingCard : public ::System::Object
	{
	public:
		// static const ::System::UInt32 _AllChipIndex = 0x5; // 0x0
		::System::Collections::Generic::Dictionary_2<::RPG::Client::DemonKingCardGuideType, ::Il2CppArray<::System::UInt32>*>* _TutorialUnlockIDs; // 0x10
		::RPG::Client::EvolveBuildCard* _CardData; // 0x18
		...
		::Enum_3_4608E37A1B3D374A_23 _GetNextStageUnlockQuestStatus()
		{
			return ((::Enum_3_4608E37A1B3D374A_23(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_EVOLVEBUILDDEMONKINGCARD__GETNEXTSTAGEUNLOCKQUESTSTATUS_OFFSET))(this);
		}
