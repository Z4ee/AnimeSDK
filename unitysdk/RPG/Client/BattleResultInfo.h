...
#define RPG_CLIENT_BATTLERESULTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x91B6500)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultInfo_TypeDefinitionIndex = 51038;

	class BattleResultInfo : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::UInt32>* ScoringItems; // 0x10
		...
		::System::Collections::Generic::List_1<::Class_1_9E75A6F37EAB58DE*>* DropItems; // 0x28
		...
		::System::UInt32 TotalScoring; // 0x40
		::System::UInt32 AddAvatarExp; // 0x44
