...
#define RPG_CLIENT_NOTIFYSETBATTLEENTITYVIEWACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0xABDB5D0)

namespace RPG::Client
{
	inline static constexpr unsigned int NotifySetBattleEntityViewActive_TypeDefinitionIndex = 65756;
