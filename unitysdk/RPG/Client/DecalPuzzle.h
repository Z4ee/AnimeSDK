...
#define RPG_CLIENT_DECALPUZZLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x9449690)
#define RPG_CLIENT_DECALPUZZLE_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x9449960)
#define RPG_CLIENT_DECALPUZZLE_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x94498E0)
#define RPG_CLIENT_DECALPUZZLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x94497E0)
#define RPG_CLIENT_DECALPUZZLE_RESET_OFFSET UNITYSDK_OFFSET(0x9449430)
#define RPG_CLIENT_DECALPUZZLE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x9449570)
#define RPG_CLIENT_DECALPUZZLE_START_OFFSET UNITYSDK_OFFSET(0x9449880)
#define RPG_CLIENT_DECALPUZZLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x9449780)
#define RPG_CLIENT_DECALPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9449980)

namespace RPG::Client
{
	inline static constexpr unsigned int DecalPuzzle_TypeDefinitionIndex = 56073;
