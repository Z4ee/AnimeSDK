...
#define RPG_CLIENT_LISTVIEW_ADD_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xD4A4A80)
#define RPG_CLIENT_LISTVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xD4A6900)
#define RPG_CLIENT_LISTVIEW_CLEARITEMSSOURCE_OFFSET UNITYSDK_OFFSET(0xD4A5BE0)
#define RPG_CLIENT_LISTVIEW_GET_ITEMPREFABS_OFFSET UNITYSDK_OFFSET(0xD4A4750)
#define RPG_CLIENT_LISTVIEW_GET_ITEMSSOURCE_OFFSET UNITYSDK_OFFSET(0xD4A4710)
#define RPG_CLIENT_LISTVIEW_GET_ITEMTOTALCOUNT_OFFSET UNITYSDK_OFFSET(0xD4A4660)
#define RPG_CLIENT_LISTVIEW_GET_KIND_OFFSET UNITYSDK_OFFSET(0xD4A44F0)
#define RPG_CLIENT_LISTVIEW_GET_LOOPGRIDVIEW_OFFSET UNITYSDK_OFFSET(0xD4A45B0)
#define RPG_CLIENT_LISTVIEW_GET_LOOPLISTVIEW2_OFFSET UNITYSDK_OFFSET(0xD4A4570)
#define RPG_CLIENT_LISTVIEW_GET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xD4A47F0)
#define RPG_CLIENT_LISTVIEW_GET_STATICLISTVIEW_OFFSET UNITYSDK_OFFSET(0xD4A4530)
#define RPG_CLIENT_LISTVIEW_GET_UNDERLYING_OFFSET UNITYSDK_OFFSET(0xD4A45F0)
#define RPG_CLIENT_LISTVIEW_INDEXOF_OFFSET UNITYSDK_OFFSET(0xD4A6390)
#define RPG_CLIENT_LISTVIEW_INIT_OFFSET UNITYSDK_OFFSET(0xD4A4B40)
#define RPG_CLIENT_LISTVIEW_METHOD_5_2439B52C953E2E46_OFFSET UNITYSDK_OFFSET(0xD4A5050)
#define RPG_CLIENT_LISTVIEW_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xD4A69A0)
#define RPG_CLIENT_LISTVIEW_METHOD_5_3ACBDC463BA17370_OFFSET UNITYSDK_OFFSET(0xD4A59E0)
#define RPG_CLIENT_LISTVIEW_METHOD_5_4E66CC6A96439F85_OFFSET UNITYSDK_OFFSET(0xD4A6A80)
#define RPG_CLIENT_LISTVIEW_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xD4A5680)
#define RPG_CLIENT_LISTVIEW_METHOD_5_85CFBB2F05144F1F_OFFSET UNITYSDK_OFFSET(0xD4A4950)
#define RPG_CLIENT_LISTVIEW_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xD4A5540)
#define RPG_CLIENT_LISTVIEW_MOVETOITEM_OFFSET UNITYSDK_OFFSET(0xD4A5DA0)
#define RPG_CLIENT_LISTVIEW_NEWITEM_OFFSET UNITYSDK_OFFSET(0xD4A5780)
#define RPG_CLIENT_LISTVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD4A6950)
#define RPG_CLIENT_LISTVIEW_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0xD4A5C30)
#define RPG_CLIENT_LISTVIEW_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xD4A5850)
#define RPG_CLIENT_LISTVIEW_REMOVE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xD4A4AE0)
#define RPG_CLIENT_LISTVIEW_SET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xD4A4A10)
#define RPG_CLIENT_LISTVIEW_SNAPTOITEM_OFFSET UNITYSDK_OFFSET(0xD4A5F60)
#define RPG_CLIENT_LISTVIEW_TRYGETSHOWNITEM_OFFSET UNITYSDK_OFFSET(0xD4A62A0)
#define RPG_CLIENT_LISTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD4A6AF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ListView_TypeDefinitionIndex = 72483;
