...
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x1955A7F0)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x1955A830)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA_GET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x1955A810)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0x1955A800)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA_SET_ROW_OFFSET UNITYSDK_OFFSET(0x1955A840)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA_SET_SKILLLIST_OFFSET UNITYSDK_OFFSET(0x1955A820)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1955A560)
#define RPG_CLIENT_MONSTERGUIDEPHASEDATA__INITSKILLDATA_OFFSET UNITYSDK_OFFSET(0x1955A850)

namespace RPG::Client
{
	inline static constexpr unsigned int MonsterGuidePhaseData_TypeDefinitionIndex = 60361;
