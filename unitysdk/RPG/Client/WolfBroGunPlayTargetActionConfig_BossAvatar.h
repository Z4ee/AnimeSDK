...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSAVATAR_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xCC3DB30)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSAVATAR_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xCC3DBC0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3DBB0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_BossAvatar_TypeDefinitionIndex = 64275;
