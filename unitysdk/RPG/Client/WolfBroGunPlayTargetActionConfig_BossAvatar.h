...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSAVATAR_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x17427C80)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_BOSSAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x17427D00)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_BossAvatar_TypeDefinitionIndex = 65646;
