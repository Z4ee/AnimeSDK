...
#define RPG_CLIENT_PULLREFRESHCONTROL_INIT_OFFSET UNITYSDK_OFFSET(0x1614E6B0)
#define RPG_CLIENT_PULLREFRESHCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1614EAC0)
#define RPG_CLIENT_PULLREFRESHCONTROL__ISREACHBOTTOM_OFFSET UNITYSDK_OFFSET(0x1614E900)
#define RPG_CLIENT_PULLREFRESHCONTROL__ONDRAG_OFFSET UNITYSDK_OFFSET(0x1614E9E0)
#define RPG_CLIENT_PULLREFRESHCONTROL__ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1614EA50)
#define RPG_CLIENT_PULLREFRESHCONTROL__SETDRAGHANDLER_OFFSET UNITYSDK_OFFSET(0x1614E720)
#define RPG_CLIENT_PULLREFRESHCONTROL__SETENDDRAGHANDLER_OFFSET UNITYSDK_OFFSET(0x1614E810)

namespace RPG::Client
{
	inline static constexpr unsigned int PullRefreshControl_TypeDefinitionIndex = 69350;
