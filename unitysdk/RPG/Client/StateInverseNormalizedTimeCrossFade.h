...
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A5007F0)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_5D78D43F96BE4E52_OFFSET UNITYSDK_OFFSET(0x1A500950)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_B9ACD9B7FC591188_OFFSET UNITYSDK_OFFSET(0x1A500A50)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A500860)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A500B90)

namespace RPG::Client
{
	inline static constexpr unsigned int StateInverseNormalizedTimeCrossFade_TypeDefinitionIndex = 68794;
