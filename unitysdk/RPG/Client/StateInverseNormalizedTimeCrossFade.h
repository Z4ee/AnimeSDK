...
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0xC924AF0)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_5D78D43F96BE4E52_OFFSET UNITYSDK_OFFSET(0xC924C50)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_B9ACD9B7FC591188_OFFSET UNITYSDK_OFFSET(0xC924D50)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC924B60)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE__CTOR_OFFSET UNITYSDK_OFFSET(0xC924E90)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC924EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateInverseNormalizedTimeCrossFade_TypeDefinitionIndex = 64385;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Animator*, ::UnityEngine::AnimatorStateInfo, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET))(this, a1, a2, a3);
		}
	};
}
