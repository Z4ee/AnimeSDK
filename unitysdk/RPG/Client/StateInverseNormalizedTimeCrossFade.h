...
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_AWAKE_OFFSET UNITYSDK_OFFSET(0xE0ED700)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_5D78D43F96BE4E52_OFFSET UNITYSDK_OFFSET(0xE0ED860)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_METHOD_4_B9ACD9B7FC591188_OFFSET UNITYSDK_OFFSET(0xE0ED960)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE0ED770)
#define RPG_CLIENT_STATEINVERSENORMALIZEDTIMECROSSFADE__CTOR_OFFSET UNITYSDK_OFFSET(0xE0EDAA0)
