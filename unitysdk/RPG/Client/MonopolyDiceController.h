...
#define RPG_CLIENT_MONOPOLYDICECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xD886130)
#define RPG_CLIENT_MONOPOLYDICECONTROLLER_ROTATE_OFFSET UNITYSDK_OFFSET(0xD886260)
#define RPG_CLIENT_MONOPOLYDICECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xD8860D0)
#define RPG_CLIENT_MONOPOLYDICECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD886520)
#define RPG_CLIENT_MONOPOLYDICECONTROLLER__INIT_B__1_0_OFFSET UNITYSDK_OFFSET(0xD886580)
#define RPG_CLIENT_MONOPOLYDICECONTROLLER__ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xD886440)

namespace RPG::Client
{
	inline static constexpr unsigned int MonopolyDiceController_TypeDefinitionIndex = 72759;
