...
#define RPG_CLIENT_GRIDFIGHTTEAM___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBC099E0)
#define RPG_CLIENT_GRIDFIGHTTEAM___C__DISPLAYCLASS9_0__GETROLESBYID_B__0_OFFSET UNITYSDK_OFFSET(0xBC15F50)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightTeam___c__DisplayClass9_0_TypeDefinitionIndex = 60937;
