...
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER___C__DISPLAYCLASS35_1__CTOR_OFFSET UNITYSDK_OFFSET(0x194ACF00)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEMODULEREDDOTFILTER___C__DISPLAYCLASS35_1___RECONSTRUCTTYPEGROUPIDLIST_B__1_OFFSET UNITYSDK_OFFSET(0x194AD3F0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityAetherDivideModuleRedDotFilter___c__DisplayClass35_1_TypeDefinitionIndex = 63828;
