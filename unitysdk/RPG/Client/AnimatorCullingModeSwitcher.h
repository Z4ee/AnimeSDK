...
#define RPG_CLIENT_ANIMATORCULLINGMODESWITCHER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x1B3166E0)
#define RPG_CLIENT_ANIMATORCULLINGMODESWITCHER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1B3165A0)
#define RPG_CLIENT_ANIMATORCULLINGMODESWITCHER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1B3166A0)
#define RPG_CLIENT_ANIMATORCULLINGMODESWITCHER_START_OFFSET UNITYSDK_OFFSET(0x1B316450)
#define RPG_CLIENT_ANIMATORCULLINGMODESWITCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B316620)
#define RPG_CLIENT_ANIMATORCULLINGMODESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B316780)

namespace RPG::Client
{
	inline static constexpr unsigned int AnimatorCullingModeSwitcher_TypeDefinitionIndex = 71076;
