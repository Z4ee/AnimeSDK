...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT_GET_RANDOMVALUE_OFFSET UNITYSDK_OFFSET(0x15E6C7B0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT_METHOD_1_6CC538194602C49B_OFFSET UNITYSDK_OFFSET(0x15E6C230)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x15E6C840)
