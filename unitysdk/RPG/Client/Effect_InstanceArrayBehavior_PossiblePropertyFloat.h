...
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT_GET_RANDOMVALUE_OFFSET UNITYSDK_OFFSET(0x150FB430)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT_METHOD_1_6CC538194602C49B_OFFSET UNITYSDK_OFFSET(0x150FAEB0)
#define RPG_CLIENT_EFFECT_INSTANCEARRAYBEHAVIOR_POSSIBLEPROPERTYFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x150FB4C0)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_InstanceArrayBehavior_PossiblePropertyFloat_TypeDefinitionIndex = 67455;
