...
#define RPG_CLIENT_AUDIENCELAYOUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x90EF860)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceLayoutConfig_TypeDefinitionIndex = 56507;
