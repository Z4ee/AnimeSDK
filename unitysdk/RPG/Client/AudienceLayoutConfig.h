...
#define RPG_CLIENT_AUDIENCELAYOUTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9D515D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceLayoutConfig_TypeDefinitionIndex = 63751;
