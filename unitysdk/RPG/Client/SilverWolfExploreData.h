...
#define RPG_CLIENT_SILVERWOLFEXPLOREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF89EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfExploreData_TypeDefinitionIndex = 67954;
