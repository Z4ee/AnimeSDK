...
#define RPG_CLIENT_UISTATECTRL_COMPLETECURRENTSTATEIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x17B942B0)
#define RPG_CLIENT_UISTATECTRL_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x17B94F00)
#define RPG_CLIENT_UISTATECTRL_GET_INTERNALACCESSOR_OFFSET UNITYSDK_OFFSET(0x17B94F60)
#define RPG_CLIENT_UISTATECTRL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B94C10)
#define RPG_CLIENT_UISTATECTRL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B949E0)
#define RPG_CLIENT_UISTATECTRL_PAUSE_OFFSET UNITYSDK_OFFSET(0x17B94630)
#define RPG_CLIENT_UISTATECTRL_PLAYSTATE_OFFSET UNITYSDK_OFFSET(0x17B93F70)
#define RPG_CLIENT_UISTATECTRL_RESUME_OFFSET UNITYSDK_OFFSET(0x17B94940)
#define RPG_CLIENT_UISTATECTRL_UPDATE_OFFSET UNITYSDK_OFFSET(0x17B94BC0)
#define RPG_CLIENT_UISTATECTRL__CTOR_OFFSET UNITYSDK_OFFSET(0x17B94FD0)
#define RPG_CLIENT_UISTATECTRL__FORCECOMPLETECURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x17B94390)
#define RPG_CLIENT_UISTATECTRL__GETCURRENTSTATEACTIONSSTATUS_OFFSET UNITYSDK_OFFSET(0x17B93E40)
#define RPG_CLIENT_UISTATECTRL__GETSTATEDATABYSTATENAME_OFFSET UNITYSDK_OFFSET(0x17B94D90)
#define RPG_CLIENT_UISTATECTRL__INITSTATEDATAS_OFFSET UNITYSDK_OFFSET(0x17B94AC0)
#define RPG_CLIENT_UISTATECTRL__NOTIFYPLAYINGASYNCACTIONS_OFFSET UNITYSDK_OFFSET(0x17B946D0)
#define RPG_CLIENT_UISTATECTRL__PLAYSTATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x17B94030)
#define RPG_CLIENT_UISTATECTRL__SETPARENT_OFFSET UNITYSDK_OFFSET(0x17B94D10)
#define RPG_CLIENT_UISTATECTRL__STARTSTATE_OFFSET UNITYSDK_OFFSET(0x17B938C0)
#define RPG_CLIENT_UISTATECTRL__TICKSTATE_OFFSET UNITYSDK_OFFSET(0x17B93A70)
#define RPG_CLIENT_UISTATECTRL__TICK_OFFSET UNITYSDK_OFFSET(0x17B93960)
#define RPG_CLIENT_UISTATECTRL__TRYUPDATESTATUSOFCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x17B93DC0)

namespace RPG::Client
{
	inline static constexpr unsigned int UIStateCtrl_TypeDefinitionIndex = 69078;
	...
	public:
		...
		::System::Void Pause()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_UISTATECTRL_PAUSE_OFFSET))(this);
		}

		::System::Void Resume()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_UISTATECTRL_RESUME_OFFSET))(this);
		}
		...
		::System::Void _NotifyPlayingAsyncActions(::System::Boolean a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_UISTATECTRL__NOTIFYPLAYINGASYNCACTIONS_OFFSET))(this, a1);
		}
