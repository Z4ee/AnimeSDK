...
#define RPG_CLIENT_MATCHTHREEENERGYPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B352F0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeEnergyPerformance_TypeDefinitionIndex = 53553;
