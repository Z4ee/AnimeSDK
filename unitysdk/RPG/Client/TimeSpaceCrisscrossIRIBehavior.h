...
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x17894E40)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x17895E90)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_3BCF0226A6CDC13B_OFFSET UNITYSDK_OFFSET(0x17895120)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x17895F40)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x178961F0)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x17896250)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x17896190)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x17896090)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_AA7E3074254D484A_OFFSET UNITYSDK_OFFSET(0x17894EC0)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_METHOD_3_EA0BA3E4AF50C583_OFFSET UNITYSDK_OFFSET(0x17893BC0)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x178962B0)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x17896340)
#define RPG_CLIENT_TIMESPACECRISSCROSSIRIBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x17896330)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeSpaceCrisscrossIRIBehavior_TypeDefinitionIndex = 67083;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(TimeSpaceCrisscrossIRIBehavior_TypeDefinitionIndex)->GetStaticField(0xB6A0);
		}
