...
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWROUTEENDVIEWMODEL_GET_BATTLEUSEROUND_OFFSET UNITYSDK_OFFSET(0xCEF7F60)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWROUTEENDVIEWMODEL_GET_ISROUTEWIN_OFFSET UNITYSDK_OFFSET(0xCEF7EC0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWROUTEENDVIEWMODEL_GET_LEVELPROGRESS_OFFSET UNITYSDK_OFFSET(0xCEF7F10)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWROUTEENDVIEWMODEL_ISALLAVATARDEAD_OFFSET UNITYSDK_OFFSET(0xCEF8090)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWROUTEENDVIEWMODEL_ISAVATARDEAD_OFFSET UNITYSDK_OFFSET(0xCEF7FC0)
#define RPG_CLIENT_EXPEDITIONBATTLEFLOWROUTEENDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCEF7FB0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::ExpeditionBattleRoute* _Route; // 0x10
		::Class_1_107413F390DDC212* _RouteEnd; // 0x18
