...
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_B1B448B2EC103605_OFFSET UNITYSDK_OFFSET(0x17B6B060)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_D09831639F615812_1_OFFSET UNITYSDK_OFFSET(0x17B6AF90)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x17B6ACC0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_ECD37C0004A0B2D4_OFFSET UNITYSDK_OFFSET(0x17B6A8E0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0x17B6AB40)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_EDE7801417BC8FDC_OFFSET UNITYSDK_OFFSET(0x17B6AD20)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x17B6A770)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x17B6AA30)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B6AC10)
#define RPG_CLIENT_STATETRANSITIONAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6B1B0)

namespace RPG::Client
{
	inline static constexpr unsigned int StateTransitionAudio_TypeDefinitionIndex = 65776;
