...
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_B1B448B2EC103605_OFFSET UNITYSDK_OFFSET(0xC92ACB0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_D09831639F615812_1_OFFSET UNITYSDK_OFFSET(0xC92ABE0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_D09831639F615812_OFFSET UNITYSDK_OFFSET(0xC92A910)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_ECD37C0004A0B2D4_OFFSET UNITYSDK_OFFSET(0xC92A530)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_ED34DCC6F6541B09_OFFSET UNITYSDK_OFFSET(0xC92A790)
#define RPG_CLIENT_STATETRANSITIONAUDIO_METHOD_4_EDE7801417BC8FDC_OFFSET UNITYSDK_OFFSET(0xC92A970)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xC92A3C0)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xC92A680)
#define RPG_CLIENT_STATETRANSITIONAUDIO_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC92A860)
#define RPG_CLIENT_STATETRANSITIONAUDIO__CTOR_OFFSET UNITYSDK_OFFSET(0xC92AE00)
#define RPG_CLIENT_STATETRANSITIONAUDIO___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xC92AE10)
#define RPG_CLIENT_STATETRANSITIONAUDIO___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xC92AE20)
#define RPG_CLIENT_STATETRANSITIONAUDIO___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC92AE30)

namespace RPG::Client
{
	inline static constexpr unsigned int StateTransitionAudio_TypeDefinitionIndex = 64405;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Animator*, ::UnityEngine::AnimatorStateInfo, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_STATETRANSITIONAUDIO___IFIXBASEPROXY_ONSTATEENTER_OFFSET))(this, a1, a2, a3);
		}

		::System::Void __iFixBaseProxy_OnStateExit(::UnityEngine::Animator* a1, ::UnityEngine::AnimatorStateInfo a2, ::System::Int32 a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Animator*, ::UnityEngine::AnimatorStateInfo, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_STATETRANSITIONAUDIO___IFIXBASEPROXY_ONSTATEEXIT_OFFSET))(this, a1, a2, a3);
		}

		::System::Void __iFixBaseProxy_OnStateUpdate(::UnityEngine::Animator* a1, ::UnityEngine::AnimatorStateInfo a2, ::System::Int32 a3)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Animator*, ::UnityEngine::AnimatorStateInfo, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_STATETRANSITIONAUDIO___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET))(this, a1, a2, a3);
		}
	};
}
