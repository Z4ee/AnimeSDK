...
#define RPG_CLIENT_PROPSELECTIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17B4C0D0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionEffectConfig_TypeDefinitionIndex = 60368;
