...
#define RPG_CLIENT_PROPSELECTIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAF23340)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionEffectConfig_TypeDefinitionIndex = 55561;
