...
#define RPG_CLIENT_PROPSELECTIONEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1614CAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int PropSelectionEffectConfig_TypeDefinitionIndex = 57551;
