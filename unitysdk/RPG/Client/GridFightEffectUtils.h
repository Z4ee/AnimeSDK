...
#define RPG_CLIENT_GRIDFIGHTEFFECTUTILS_SETANIMSPEEDINCHILDREN_OFFSET UNITYSDK_OFFSET(0xA4731F0)
#define RPG_CLIENT_GRIDFIGHTEFFECTUTILS_SETPARTICLESYSTEMSPEEDINCHILDREN_OFFSET UNITYSDK_OFFSET(0xA473050)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEffectUtils_TypeDefinitionIndex = 59346;
