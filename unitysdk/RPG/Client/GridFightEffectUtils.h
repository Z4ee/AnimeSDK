...
#define RPG_CLIENT_GRIDFIGHTEFFECTUTILS_SETANIMSPEEDINCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A63EFC0)
#define RPG_CLIENT_GRIDFIGHTEFFECTUTILS_SETPARTICLESYSTEMSPEEDINCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A63EE30)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightEffectUtils_TypeDefinitionIndex = 61570;
