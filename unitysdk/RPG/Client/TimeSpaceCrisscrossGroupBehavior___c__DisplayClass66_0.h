...
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS66_0__CTOR_OFFSET UNITYSDK_OFFSET(0x17891110)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS66_0__UPDATETSCSTATE_B__0_OFFSET UNITYSDK_OFFSET(0x178919A0)
#define RPG_CLIENT_TIMESPACECRISSCROSSGROUPBEHAVIOR___C__DISPLAYCLASS66_0__UPDATETSCSTATE_B__1_OFFSET UNITYSDK_OFFSET(0x178919D0)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeSpaceCrisscrossGroupBehavior___c__DisplayClass66_0_TypeDefinitionIndex = 67062;
