...
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xC689860)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xC6898A0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0xC689820)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0xC689830)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0xC6897F0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0xC689840)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0xC689850)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0xC689730)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0xC6895A0)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0xC689810)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0xC689800)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED_METHOD_6_C88F24B4C4F38CAF_OFFSET UNITYSDK_OFFSET(0xC689660)
#define RPG_CLIENT_RPGCOPYMINBYCHILDPREFERRED__CTOR_OFFSET UNITYSDK_OFFSET(0xC6898E0)

namespace RPG::Client
{
	inline static constexpr unsigned int RPGCopyMinByChildPreferred_TypeDefinitionIndex = 67870;
