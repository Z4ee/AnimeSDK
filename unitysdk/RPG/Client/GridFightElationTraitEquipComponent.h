...
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_CANCRAFTTO_OFFSET UNITYSDK_OFFSET(0xD165AD0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_CRAFTTO_OFFSET UNITYSDK_OFFSET(0xD166890)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETCRAFTEDEQUIP_OFFSET UNITYSDK_OFFSET(0xD166800)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETCRAFTTOCOMBINATION_OFFSET UNITYSDK_OFFSET(0xD166BC0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETCURENABLERECIPE_OFFSET UNITYSDK_OFFSET(0xD1672E0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETEQUIPCONFIGS_OFFSET UNITYSDK_OFFSET(0xD168420)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETRECOMMENDS_OFFSET UNITYSDK_OFFSET(0xD164FA0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GETUNLOCKNEEDLAYER_OFFSET UNITYSDK_OFFSET(0xD165890)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_BASICEQUIPCONFIGS_OFFSET UNITYSDK_OFFSET(0xD167190)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_EQUIPCOUNT_OFFSET UNITYSDK_OFFSET(0xD165270)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_HASOCCUPIED_OFFSET UNITYSDK_OFFSET(0xD1652C0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0xD1653D0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xD167C50)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_PRIMARYRECOMMENDEQUIPS_OFFSET UNITYSDK_OFFSET(0xD1651D0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET_SECONDARYRECOMMENDEQUIPS_OFFSET UNITYSDK_OFFSET(0xD165220)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_GET__DATACONTEXT_OFFSET UNITYSDK_OFFSET(0xD168910)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_HASCRAFTABLE_OFFSET UNITYSDK_OFFSET(0xD165570)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_INITCONFIG_OFFSET UNITYSDK_OFFSET(0xD167EA0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_ISCRAFTED_OFFSET UNITYSDK_OFFSET(0xD165800)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_ISOCCUPIED_OFFSET UNITYSDK_OFFSET(0xD165330)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0xD165630)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_SETUPTRAITEFFECT_OFFSET UNITYSDK_OFFSET(0xD167E50)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0xD168050)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD168990)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETEQUIPBYUID_OFFSET UNITYSDK_OFFSET(0xD168630)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETNEEDEQUIPID_OFFSET UNITYSDK_OFFSET(0xD165EC0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETOCCUPYNEEDEQUIPID_OFFSET UNITYSDK_OFFSET(0xD166390)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__GETRECOMMEND_OFFSET UNITYSDK_OFFSET(0xD164CC0)
#define RPG_CLIENT_GRIDFIGHTELATIONTRAITEQUIPCOMPONENT__UPDATE_B__24_3_OFFSET UNITYSDK_OFFSET(0xD168A30)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::GridFightEquipItemData*>* _CurCraftedEquips; // 0x20
		::RPG::GameCore::GridFightTraitElationTemplateConfigRow* _ConfigRow; // 0x28
