...
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GETFUNCID_OFFSET UNITYSDK_OFFSET(0x16A11AB0)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x16A11A60)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0x16A11C70)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x16A11C50)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0x16A11AF0)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_REFRESH_OFFSET UNITYSDK_OFFSET(0x16A11960)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0x16A11C80)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_SET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x16A11C60)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x16A117E0)
