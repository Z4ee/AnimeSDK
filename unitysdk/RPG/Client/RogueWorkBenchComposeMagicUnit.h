...
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GETFUNCID_OFFSET UNITYSDK_OFFSET(0xC87A0E0)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0xC87A090)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xC87A280)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xC87A120)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_REFRESH_OFFSET UNITYSDK_OFFSET(0xC879F90)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xC87A290)
#define RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0xC879E20)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueWorkBenchComposeMagicUnit_TypeDefinitionIndex = 62986;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_0319A031DCA9B495_20*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEWORKBENCHCOMPOSEMAGICUNIT__CTOR_OFFSET))(this, a1, a2);
		}
