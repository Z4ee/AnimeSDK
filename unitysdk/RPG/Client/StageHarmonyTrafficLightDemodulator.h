...
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTDEMODULATOR_METHOD_3_D4F7E73269C0B79B_OFFSET UNITYSDK_OFFSET(0xB1BDDB0)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xB1BDE40)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xB1BDE90)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyTrafficLightDemodulator_TypeDefinitionIndex = 65411;
