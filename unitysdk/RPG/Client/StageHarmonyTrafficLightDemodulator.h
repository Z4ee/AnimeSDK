...
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTDEMODULATOR_METHOD_3_D4F7E73269C0B79B_OFFSET UNITYSDK_OFFSET(0xC915B40)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTDEMODULATOR_METHOD_3_F4B1CC0F7E08D926_OFFSET UNITYSDK_OFFSET(0xC915BD0)
#define RPG_CLIENT_STAGEHARMONYTRAFFICLIGHTDEMODULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC915C20)

namespace RPG::Client
{
	inline static constexpr unsigned int StageHarmonyTrafficLightDemodulator_TypeDefinitionIndex = 66338;
