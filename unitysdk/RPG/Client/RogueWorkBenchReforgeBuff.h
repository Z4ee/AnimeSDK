...
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GETFUNCID_OFFSET UNITYSDK_OFFSET(0xDFCFC90)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0xDFCFC40)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xDFCFE50)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0xDFCFE30)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0xDFCFCD0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_REFRESH_OFFSET UNITYSDK_OFFSET(0xDFCFAD0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_REPORTBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0xDFCFB40)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0xDFCFE60)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_SET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0xDFCFE40)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xDFCF9E0)
