...
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GETFUNCID_OFFSET UNITYSDK_OFFSET(0x184E2AB0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x184E2A60)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_GET_COSTDATA_OFFSET UNITYSDK_OFFSET(0x184E2C50)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0x184E2AF0)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_REFRESH_OFFSET UNITYSDK_OFFSET(0x184E2910)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_REPORTBUFFSELECTION_OFFSET UNITYSDK_OFFSET(0x184E2980)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF_SET_COSTDATA_OFFSET UNITYSDK_OFFSET(0x184E2C60)
#define RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x184E2830)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueWorkBenchReforgeBuff_TypeDefinitionIndex = 64354;
	...
	public:
		...
		::System::Void _ctor(::System::UInt32 a1, ::Class_1_0319A031DCA9B495_20* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32, ::Class_1_0319A031DCA9B495_20*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ROGUEWORKBENCHREFORGEBUFF__CTOR_OFFSET))(this, a1, a2);
		}
