...
#define RPG_CLIENT_PROP_DRONEHUDPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xDC50060)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DroneHudParam_TypeDefinitionIndex = 78090;
