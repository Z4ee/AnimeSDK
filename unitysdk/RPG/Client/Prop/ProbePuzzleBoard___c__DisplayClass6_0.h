...
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14F33710)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___C__DISPLAYCLASS6_0___ONMODEPROBETRIGGERED_B__0_OFFSET UNITYSDK_OFFSET(0x14F34E20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ProbePuzzleBoard___c__DisplayClass6_0_TypeDefinitionIndex = 74822;

	class ProbePuzzleBoard___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		::RPG::Client::Prop::ProbePuzzleItem* puzzleProbe; // 0x10
		::RPG::Client::Prop::ProbePuzzleBoard* __4__this; // 0x18
