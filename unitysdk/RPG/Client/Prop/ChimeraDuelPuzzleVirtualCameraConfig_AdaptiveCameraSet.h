...
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_482F98D76EE0F67C_OFFSET UNITYSDK_OFFSET(0xDC25760)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_5AA26BB73B32743F_OFFSET UNITYSDK_OFFSET(0xDC25970)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_67AEF306C0668389_OFFSET UNITYSDK_OFFSET(0xDC259E0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_6E5CBF6743011AF7_OFFSET UNITYSDK_OFFSET(0xDC257F0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_B981968D52A481FE_OFFSET UNITYSDK_OFFSET(0xDC25BA0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_C8F1E529227E18C5_OFFSET UNITYSDK_OFFSET(0xDC25880)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_EBD32C8C133C4897_OFFSET UNITYSDK_OFFSET(0xDC25240)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET__CTOR_OFFSET UNITYSDK_OFFSET(0xDC25C50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelPuzzleVirtualCameraConfig_AdaptiveCameraSet_TypeDefinitionIndex = 77843;
