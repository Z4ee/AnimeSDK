...
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_482F98D76EE0F67C_OFFSET UNITYSDK_OFFSET(0xA057DE0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_5AA26BB73B32743F_OFFSET UNITYSDK_OFFSET(0xA057FF0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_67AEF306C0668389_OFFSET UNITYSDK_OFFSET(0xA058060)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_6E5CBF6743011AF7_OFFSET UNITYSDK_OFFSET(0xA057E70)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_832172BF04246E66_OFFSET UNITYSDK_OFFSET(0xA057960)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_B981968D52A481FE_OFFSET UNITYSDK_OFFSET(0xA058220)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET_METHOD_1_C8F1E529227E18C5_OFFSET UNITYSDK_OFFSET(0xA057F00)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET__CTOR_OFFSET UNITYSDK_OFFSET(0xA0582D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelPuzzleVirtualCameraConfig_AdaptiveCameraSet_TypeDefinitionIndex = 63764;
