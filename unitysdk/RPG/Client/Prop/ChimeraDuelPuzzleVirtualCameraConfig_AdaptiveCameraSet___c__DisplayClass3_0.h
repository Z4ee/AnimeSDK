...
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET___C__DISPLAYCLASS3_0__ADAPT_B__1_OFFSET UNITYSDK_OFFSET(0xC51AC90)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_ADAPTIVECAMERASET___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC51A6B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelPuzzleVirtualCameraConfig_AdaptiveCameraSet___c__DisplayClass3_0_TypeDefinitionIndex = 72835;
