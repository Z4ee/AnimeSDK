...
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_CREATE_OFFSET UNITYSDK_OFFSET(0x189DABD0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_GET_WRAPPER_OFFSET UNITYSDK_OFFSET(0x189DABB0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_GET__REFERENCESCREENHEIGHT_OFFSET UNITYSDK_OFFSET(0x189DAB30)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x189DAF20)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x189DB8C0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_SETTARGETPOSITION_1_OFFSET UNITYSDK_OFFSET(0x189DBA70)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_SETTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x189DBA10)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_SETTARGET_OFFSET UNITYSDK_OFFSET(0x189DB930)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_SETTICKACTIVE_OFFSET UNITYSDK_OFFSET(0x189DBB70)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER_SET_WRAPPER_OFFSET UNITYSDK_OFFSET(0x189DABC0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x189DBBC0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER__INITIALIZE_OFFSET UNITYSDK_OFFSET(0x189DADA0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCONTROLLER__TICK_OFFSET UNITYSDK_OFFSET(0x189DAF70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraBillboardController_TypeDefinitionIndex = 77996;
