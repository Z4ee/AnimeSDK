...
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADBF780)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_PROP_CHIMERADUELBUBBLELISTENEVENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xADBF9B0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_PROP_CHIMERADUELBUBBLELISTENEVENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADBF940)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xADBFA30)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADBF9A0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xADBF950)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADBF760)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0xADBF350)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENTMANAGER___MATCHLISTENEVENTS_D__11___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0xADBF770)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelBubbleEventManager___MatchListenEvents_d__11_TypeDefinitionIndex = 71771;
	...
	public:
		...
		::RPG::Client::Prop::ChimeraDuelBubbleEvent* evt; // 0x18
		::System::Collections::Generic::List_1<::Class_1_FC01049DA05831B0*>* listenEvents; // 0x20
		::Class_1_FC01049DA05831B0* __2__current; // 0x28
		::RPG::Client::Prop::ChimeraDuelBubbleEvent* __3__evt; // 0x30
		::System::Collections::Generic::List_1_Enumerator<::Class_1_FC01049DA05831B0*> __7__wrap1; // 0x38
