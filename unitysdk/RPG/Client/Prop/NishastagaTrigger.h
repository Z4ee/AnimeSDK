...
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xDCA4B60)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDCA4BB0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_GET_OWNENTITY_OFFSET UNITYSDK_OFFSET(0xDCA5870)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xDCA4DF0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0xDCA7890)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xDCA6D40)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xDCA70B0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_56E076CBC69B0772_OFFSET UNITYSDK_OFFSET(0xDCA5F50)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_A0374C870A27A45B_OFFSET UNITYSDK_OFFSET(0xDCA76E0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_C436A2848092EB88_OFFSET UNITYSDK_OFFSET(0xDCA7530)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_DDDEE766A0E3D16C_OFFSET UNITYSDK_OFFSET(0xDCA5920)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_E69AA2E64A20143D_OFFSET UNITYSDK_OFFSET(0xDCA6DA0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_F8B57AB93A05117D_OFFSET UNITYSDK_OFFSET(0xDCA6370)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_METHOD_5_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0xDCA7190)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDCA7100)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_RESETITEMATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xDCA74E0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_RESET_OFFSET UNITYSDK_OFFSET(0xDCA49E0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_SETITEMATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xDCA73F0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER_SPAWNED_OFFSET UNITYSDK_OFFSET(0xDCA4990)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0xDCA7BB0)
#define RPG_CLIENT_PROP_NISHASTAGATRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xDCA7AD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int NishastagaTrigger_TypeDefinitionIndex = 78488;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(NishastagaTrigger_TypeDefinitionIndex)->GetStaticField(0x65080);
		}
		static ::System::Int32* StaticGet_CMJDEJDJKBO()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NishastagaTrigger_TypeDefinitionIndex)->GetStaticField(0x14C70);
		}
