...
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_METHOD_5_8A9E4FD6EC45F453_OFFSET UNITYSDK_OFFSET(0xA132090)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA132190)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA132140)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE_SETNOUSDICEBRANCH_OFFSET UNITYSDK_OFFSET(0xA131C80)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONNOUSDICE__CTOR_OFFSET UNITYSDK_OFFSET(0xA1321F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueCollectionNousDice_TypeDefinitionIndex = 64398;
