...
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAE179F0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xAE17EC0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_GETBLLSTATE_OFFSET UNITYSDK_OFFSET(0xAE18C30)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_16548462D618EA0D_OFFSET UNITYSDK_OFFSET(0xAE18F70)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_1_OFFSET UNITYSDK_OFFSET(0xAE19A50)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0xAE19980)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xAE18340)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xAE18770)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xAE17F20)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0xAE17FC0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_F95252B816F4814F_OFFSET UNITYSDK_OFFSET(0xAE19130)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLAPPEAR_OFFSET UNITYSDK_OFFSET(0xAE188B0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLOUTOFPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE18A20)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xAE18CC0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0xAE193B0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0xAE19460)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAE17DF0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_RESETDSTTARGET_OFFSET UNITYSDK_OFFSET(0xAE18BA0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_SETGRAVITYAFFECT_OFFSET UNITYSDK_OFFSET(0xAE18C70)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAE17C90)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE19C70)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__ONEXIT_OFFSET UNITYSDK_OFFSET(0xAE19B20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallBallController_TypeDefinitionIndex = 72084;
	...
	public:
		...
		::RPG::Client::Prop::GravityBallBallController_Class_1_2C965BD9B9CA3DE5* Field_5_19; // 0x78
