...
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xDC67B90)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xDC67E40)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_GETBLLSTATE_OFFSET UNITYSDK_OFFSET(0xDC68B30)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_16548462D618EA0D_OFFSET UNITYSDK_OFFSET(0xDC68E50)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_1_OFFSET UNITYSDK_OFFSET(0xDC698F0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0xDC69820)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xDC682C0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0xDC686F0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xDC67EA0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0xDC67F40)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_F95252B816F4814F_OFFSET UNITYSDK_OFFSET(0xDC69010)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLAPPEAR_OFFSET UNITYSDK_OFFSET(0xDC68830)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLOUTOFPUZZLE_OFFSET UNITYSDK_OFFSET(0xDC68920)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0xDC68BC0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0xDC69290)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0xDC69340)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDC67DF0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_RESETDSTTARGET_OFFSET UNITYSDK_OFFSET(0xDC68AA0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_SETGRAVITYAFFECT_OFFSET UNITYSDK_OFFSET(0xDC68B70)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDC67D90)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC69B10)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__ONEXIT_OFFSET UNITYSDK_OFFSET(0xDC699C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallBallController_TypeDefinitionIndex = 78117;
