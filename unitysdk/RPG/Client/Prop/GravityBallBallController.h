...
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A924AA0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A924F70)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_GETBLLSTATE_OFFSET UNITYSDK_OFFSET(0x1A925CE0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_16548462D618EA0D_OFFSET UNITYSDK_OFFSET(0x1A926000)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_1_OFFSET UNITYSDK_OFFSET(0x1A926AA0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_570C5557A774C69E_OFFSET UNITYSDK_OFFSET(0x1A9269D0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0x1A9253F0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_A1C464B05BB7A5C1_OFFSET UNITYSDK_OFFSET(0x1A925820)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x1A924FD0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_D0EAB95EE152A65F_OFFSET UNITYSDK_OFFSET(0x1A925070)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_METHOD_5_F95252B816F4814F_OFFSET UNITYSDK_OFFSET(0x1A9261C0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLAPPEAR_OFFSET UNITYSDK_OFFSET(0x1A925960)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONBALLOUTOFPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A925AD0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1A925D70)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1A926440)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONCOLLISIONSTAY_OFFSET UNITYSDK_OFFSET(0x1A9264F0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A924EA0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_RESETDSTTARGET_OFFSET UNITYSDK_OFFSET(0x1A925C50)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_SETGRAVITYAFFECT_OFFSET UNITYSDK_OFFSET(0x1A925D20)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A924D40)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A926CC0)
#define RPG_CLIENT_PROP_GRAVITYBALLBALLCONTROLLER__ONEXIT_OFFSET UNITYSDK_OFFSET(0x1A926B70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallBallController_TypeDefinitionIndex = 78116;

	class GravityBallBallController : public ::UnityEngine::MonoBehaviour
	{
	public:
		// static const ::System::String* HIKEJIIFBLA; // 0x0
		// static const ::System::String* FPOABENNEJF; // 0x0
		// static const ::System::String* LFHPHINNNKI; // 0x0
		// static const ::System::String* LFAIOAGLOKO; // 0x0
		// static const ::System::String* ONHBILHKLGM; // 0x0
		// static const ::System::String* ENANLIOGEMI; // 0x0
		// static const ::System::String* KAAGIDFNLGC; // 0x0
		::UnityEngine::Rigidbody* PANDMEPOLJP; // 0x18
		::UnityEngine::Transform* ICMGAIJCGBI; // 0x20
		::RPG::Client::Prop::GravityBallBallController_BallState BLDNGENJNEL; // 0x28
		::System::Single LPEEFIFKNFH; // 0x2C
		::System::Single NACCCMEJFHI; // 0x30
		...
		::RPG::Client::Prop::GravityBallBallController_Class_1_2C965BD9B9CA3DE5* MEGKBJCPBAG; // 0x78
		::System::Boolean LPNDGOJBCCC; // 0x80
		::System::Boolean HHAILANFBED; // 0x81
		::System::Collections::Generic::Dictionary_2<::UnityEngine::Collider*, ::Il2CppArray<::UnityEngine::ContactPoint>*>* AMOJOCPHCFJ; // 0x88
		::System::Single FMIKOFLIGIN; // 0x90
		::System::Boolean OLJCOAMKGNH; // 0x94
