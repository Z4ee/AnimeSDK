...
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_CHANGEFLOATINGMODE_OFFSET UNITYSDK_OFFSET(0xA0B1110)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA0C05B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_START_OFFSET UNITYSDK_OFFSET(0xA0C03B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0C0640)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C09F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int JigsawPuzzleRandomFloating_TypeDefinitionIndex = 64112;
