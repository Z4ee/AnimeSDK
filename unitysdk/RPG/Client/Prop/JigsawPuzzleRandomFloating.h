...
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_CHANGEFLOATINGMODE_OFFSET UNITYSDK_OFFSET(0xC576850)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC5864C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_START_OFFSET UNITYSDK_OFFSET(0xC5862C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING_UPDATE_OFFSET UNITYSDK_OFFSET(0xC586550)
#define RPG_CLIENT_PROP_JIGSAWPUZZLERANDOMFLOATING__CTOR_OFFSET UNITYSDK_OFFSET(0xC586900)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int JigsawPuzzleRandomFloating_TypeDefinitionIndex = 73181;
