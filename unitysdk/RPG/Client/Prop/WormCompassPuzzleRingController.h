...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_ANIMATIONTOTARGETCOL_OFFSET UNITYSDK_OFFSET(0xC6539D0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_DELAYSHOW_OFFSET UNITYSDK_OFFSET(0xC65ADA0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_ENABLEROUTEEFFECT_OFFSET UNITYSDK_OFFSET(0xC657800)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_INITRING_OFFSET UNITYSDK_OFFSET(0xC650790)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_LOGICTOTARGETCOL_OFFSET UNITYSDK_OFFSET(0xC65C710)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_REFRESHOBJECTSTATUS_OFFSET UNITYSDK_OFFSET(0xC650C00)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0xC6594D0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC65C3B0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC65CA00)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLERINGCONTROLLER__DELAYSHOW_B__21_0_OFFSET UNITYSDK_OFFSET(0xC65CA10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleRingController_TypeDefinitionIndex = 73452;
