...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA055290)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA0554F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA055480)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA055570)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA0554E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA055490)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA055280)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0xA0551F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleShopView__GetTeamMemberSlots_d__10_TypeDefinitionIndex = 63839;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10__CTOR_OFFSET))(this, __1__state);
		}
