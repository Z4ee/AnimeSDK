...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x189F3E70)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x189F4080)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189F4010)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x189F4100)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189F4070)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x189F4020)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189F3E60)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__GETTEAMMEMBERSLOTS_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x189F3D60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleShopView__GetTeamMemberSlots_d__10_TypeDefinitionIndex = 77918;

	class ChimeraDuelMainPuzzleShopView__GetTeamMemberSlots_d__10 : public ::System::Object
	{
	public:
		::RPG::Client::Prop::ChimeraDuelTeamMemberSlotView* __2__current; // 0x10
		::RPG::Client::Prop::ChimeraDuelMainPuzzleShopView* __4__this; // 0x18
