...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_CHECKBLOCK_OFFSET UNITYSDK_OFFSET(0x1611E780)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1611E1F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1611E6D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_INITCONDITIONGROUP_OFFSET UNITYSDK_OFFSET(0x1611C740)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0x1611E3E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1611ECB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleConditionGroup_TypeDefinitionIndex = 78209;
