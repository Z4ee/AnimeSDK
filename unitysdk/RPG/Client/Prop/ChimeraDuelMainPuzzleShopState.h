...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETKEYMAPANCHOR_OFFSET UNITYSDK_OFFSET(0x189F3250)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETPROXY_OFFSET UNITYSDK_OFFSET(0x189F36B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETTEAMMEMBERSLOT_OFFSET UNITYSDK_OFFSET(0x189F31D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_DRAGGEDCHIMERASLOT_OFFSET UNITYSDK_OFFSET(0x189F2580)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_TEAMMEMBERSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0x189F3180)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_VIEW_OFFSET UNITYSDK_OFFSET(0x189F24D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__STATETYPE_OFFSET UNITYSDK_OFFSET(0x189F2400)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__UINAME_OFFSET UNITYSDK_OFFSET(0x189F2490)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__UIPATH_OFFSET UNITYSDK_OFFSET(0x189F2450)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_INSTANTIATEBILLBOARD_OFFSET UNITYSDK_OFFSET(0x189F3090)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x189F26B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x189F2D90)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PLAYPERFORMANCEANDGETCANCELHANDLER_OFFSET UNITYSDK_OFFSET(0x189F3320)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PREPAREENTERBYUI_OFFSET UNITYSDK_OFFSET(0x189F2670)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_REMOVEPROXY_OFFSET UNITYSDK_OFFSET(0x189F37F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_RPG_CLIENT_PROP_IDUELCHIMERAPROXYCONTAINER_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x189F3630)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_SET_DRAGGEDCHIMERASLOT_OFFSET UNITYSDK_OFFSET(0x189F2590)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x189F25A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x189F2ED0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleShopState_TypeDefinitionIndex = 77914;

	class ChimeraDuelMainPuzzleShopState : public ::RPG::Client::Prop::ChimeraDuelMainPuzzleMonoStateBase
	{
	public:
		::System::Collections::Generic::List_1<::RPG::Client::Prop::DuelChimeraProxy*>* _TeamMemberProxies; // 0x28
		...
		::Class_1_085A149A901F5E47* _PerformancePlayer; // 0x40
		::System::Collections::Generic::List_1<::RPG::Client::Prop::ChimeraDuelTeamMemberSlot*>* _TeamMemberSlots; // 0x48
