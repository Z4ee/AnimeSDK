...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETKEYMAPANCHOR_OFFSET UNITYSDK_OFFSET(0x16E2E3A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETPROXY_OFFSET UNITYSDK_OFFSET(0x16E2E800)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GETTEAMMEMBERSLOT_OFFSET UNITYSDK_OFFSET(0x16E2E320)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_DRAGGEDCHIMERASLOT_OFFSET UNITYSDK_OFFSET(0x16E2D760)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_TEAMMEMBERSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0x16E2E2D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET_VIEW_OFFSET UNITYSDK_OFFSET(0x16E2D6B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__STATETYPE_OFFSET UNITYSDK_OFFSET(0x16E2D5E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__UINAME_OFFSET UNITYSDK_OFFSET(0x16E2D670)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_GET__UIPATH_OFFSET UNITYSDK_OFFSET(0x16E2D630)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_INSTANTIATEBILLBOARD_OFFSET UNITYSDK_OFFSET(0x16E2E1E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x16E2D890)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x16E2DEE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PLAYPERFORMANCEANDGETCANCELHANDLER_OFFSET UNITYSDK_OFFSET(0x16E2E470)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PREPAREENTERBYUI_OFFSET UNITYSDK_OFFSET(0x16E2D850)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_REMOVEPROXY_OFFSET UNITYSDK_OFFSET(0x16E2E930)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_RPG_CLIENT_PROP_IDUELCHIMERAPROXYCONTAINER_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x16E2E780)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_SET_DRAGGEDCHIMERASLOT_OFFSET UNITYSDK_OFFSET(0x16E2D770)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E2D780)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE__ONUISCREENSIZECHANGED_OFFSET UNITYSDK_OFFSET(0x16E2E020)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleShopState_TypeDefinitionIndex = 74429;

	class ChimeraDuelMainPuzzleShopState : public ::RPG::Client::Prop::ChimeraDuelMainPuzzleMonoStateBase
	{
	public:
		::RPG::Client::Prop::ChimeraDuelShopDraggedChimeraSlot* _DraggedChimeraSlot_k__BackingField; // 0x28
		...
		::Class_2_0BF0926D4A749938* _PerformanceExecuteContext; // 0x48
		...
		::System::Action* PlayPerformanceAndGetCancelHandler(::System::Collections::Generic::IEnumerable_1<::Class_0_16E4307DCC419505_782*>* a1, ::System::Action_1<::System::Boolean>* a2)
		{
			return ((::System::Action*(*)(::PVOID, ::System::Collections::Generic::IEnumerable_1<::Class_0_16E4307DCC419505_782*>*, ::System::Action_1<::System::Boolean>*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPSTATE_PLAYPERFORMANCEANDGETCANCELHANDLER_OFFSET))(this, a1, a2);
		}
