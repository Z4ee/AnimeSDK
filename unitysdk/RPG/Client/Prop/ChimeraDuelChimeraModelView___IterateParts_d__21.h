...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA045650)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_RENDERER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA045790)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_RENDERER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA045720)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xA045810)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA045780)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA045730)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA045640)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0xA042760)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView___IterateParts_d__21_TypeDefinitionIndex = 63778;

	class ChimeraDuelChimeraModelView___IterateParts_d__21 : public ::System::Object
	{
	public:
		::RPG::Client::Prop::ChimeraDuelChimeraModelView* __4__this; // 0x10
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21__CTOR_OFFSET))(this, __1__state);
		}
