...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADC3E20)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_RENDERER__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xADC3F60)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_RENDERER__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADC3EF0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xADC3FE0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADC3F50)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xADC3F00)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADC3E10)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW___ITERATEPARTS_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0xADC0D00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView___IterateParts_d__21_TypeDefinitionIndex = 71824;
