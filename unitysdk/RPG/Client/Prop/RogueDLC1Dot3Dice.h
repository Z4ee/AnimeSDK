...
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xAEB3FE0)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_METHOD_5_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xAEB3DB0)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_METHOD_5_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xAEB3920)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_METHOD_5_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0xAEB34F0)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_RESETDICE_OFFSET UNITYSDK_OFFSET(0xAEB3890)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_SPAWNED_OFFSET UNITYSDK_OFFSET(0xAEB3F60)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_STARTROTATE_1_OFFSET UNITYSDK_OFFSET(0xAEB3E10)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_STARTROTATE_OFFSET UNITYSDK_OFFSET(0xAEB3640)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE_UPDATE_OFFSET UNITYSDK_OFFSET(0xAEB3470)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE__CCTOR_OFFSET UNITYSDK_OFFSET(0xAEB4B90)
#define RPG_CLIENT_PROP_ROGUEDLC1DOT3DICE__CTOR_OFFSET UNITYSDK_OFFSET(0xAEB4050)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueDLC1Dot3Dice_TypeDefinitionIndex = 72447;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(RogueDLC1Dot3Dice_TypeDefinitionIndex)->GetStaticField(0x5590);
		}
