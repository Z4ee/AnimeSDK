...
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_1E2C0B86BA2D02B7_OFFSET UNITYSDK_OFFSET(0xA056DF0)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_689F570C13938115_OFFSET UNITYSDK_OFFSET(0xA056D40)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_95ADE8ED590C5559_OFFSET UNITYSDK_OFFSET(0xA056E90)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_D95160FA61EDB70B_OFFSET UNITYSDK_OFFSET(0xA056A20)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA056FE0)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xA057140)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelModelVfxPlayer_TypeDefinitionIndex = 63783;
