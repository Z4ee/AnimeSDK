...
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_0BC942C41895B4DC_OFFSET UNITYSDK_OFFSET(0x18FEAEE0)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_1E2C0B86BA2D02B7_OFFSET UNITYSDK_OFFSET(0x18FEAF90)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_95ADE8ED590C5559_OFFSET UNITYSDK_OFFSET(0x18FEB030)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_D95160FA61EDB70B_OFFSET UNITYSDK_OFFSET(0x18FEABC0)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18FEB180)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEB2F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelModelVfxPlayer_TypeDefinitionIndex = 74377;
