...
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_0BC942C41895B4DC_OFFSET UNITYSDK_OFFSET(0xC516640)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_1E2C0B86BA2D02B7_OFFSET UNITYSDK_OFFSET(0xC5197A0)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_95ADE8ED590C5559_OFFSET UNITYSDK_OFFSET(0xC519840)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_METHOD_5_D95160FA61EDB70B_OFFSET UNITYSDK_OFFSET(0xC5083A0)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC519990)
#define RPG_CLIENT_PROP_CHIMERADUELMODELVFXPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xC519B00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelModelVfxPlayer_TypeDefinitionIndex = 72852;
