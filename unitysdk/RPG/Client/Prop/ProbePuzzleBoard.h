...
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA1284D0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA127AB0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA128480)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_0A0A3F0F2DFB2D03_OFFSET UNITYSDK_OFFSET(0xA129FE0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_1A6BA74B1FDC4CEB_OFFSET UNITYSDK_OFFSET(0xA12AFC0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_1C1866DEF4DE26A9_OFFSET UNITYSDK_OFFSET(0xA12A8C0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0xA128150)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_METHOD_6_CE017E2A52468EF8_OFFSET UNITYSDK_OFFSET(0xA128CB0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_RESET_OFFSET UNITYSDK_OFFSET(0xA128970)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_SETRESETNUMBER_OFFSET UNITYSDK_OFFSET(0xA1288E0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xA1281D0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xA12B560)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA12B420)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA12B650)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA12B5D0)
#define RPG_CLIENT_PROP_PROBEPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA12B5E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ProbePuzzleBoard_TypeDefinitionIndex = 64227;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5070);
		}
		static ::System::Int32* StaticGet_Field_6_30()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x2A10);
		}
		static ::System::Int32* StaticGet_Field_6_29()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x2A14);
		}
		static ::UnityEngine::Vector3* StaticGet_Field_6_32()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x2A18);
		}
		static ::UnityEngine::Vector3* StaticGet_Field_6_31()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(ProbePuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x2A24);
		}
