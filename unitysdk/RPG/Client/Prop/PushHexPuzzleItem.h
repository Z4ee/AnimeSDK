...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_BACKUPORIGIN_OFFSET UNITYSDK_OFFSET(0xC5F48D0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xC5F3340)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_METHOD_7_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xC5F4FB0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_METHOD_7_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xC5F5080)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xC5F5340)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0xC5F4B10)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM_REFRESHDIRECTION_OFFSET UNITYSDK_OFFSET(0xC5F3B40)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC5F5430)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xC5F5440)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0xC5F54A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleItem_TypeDefinitionIndex = 73139;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::Prop::PuzzleBoardBase*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PUSHHEXPUZZLEITEM___IFIXBASEPROXY_INIT_OFFSET))(this, a1);
		}
