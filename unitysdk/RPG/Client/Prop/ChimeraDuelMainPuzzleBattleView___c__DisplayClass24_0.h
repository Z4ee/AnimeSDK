...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x189EB620)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW___C__DISPLAYCLASS24_0__LOADMASTERGROUP_B__0_OFFSET UNITYSDK_OFFSET(0x189EC4B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleBattleView___c__DisplayClass24_0_TypeDefinitionIndex = 77902;

	class ChimeraDuelMainPuzzleBattleView___c__DisplayClass24_0 : public ::System::Object
	{
	public:
		::RPG::Client::ChimeraDuelMasterData* allyMasterData; // 0x10
