...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME_INIT_OFFSET UNITYSDK_OFFSET(0xA12C720)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME_METHOD_7_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xA12E0E0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xA12E3B0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA12E3C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleFrame_TypeDefinitionIndex = 64068;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::Prop::PuzzleBoardBase*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME___IFIXBASEPROXY_INIT_OFFSET))(this, P0);
		}
	};
}
