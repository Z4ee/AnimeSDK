...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME_INIT_OFFSET UNITYSDK_OFFSET(0x1663C4B0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME_METHOD_7_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x1663DD60)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1663E020)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleFrame_TypeDefinitionIndex = 78147;
