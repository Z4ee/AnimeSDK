...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME_INIT_OFFSET UNITYSDK_OFFSET(0xAEACE70)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME_METHOD_7_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0xAEAE830)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0xAEAEB00)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEFRAME___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xAEAEB10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleFrame_TypeDefinitionIndex = 72115;
