...
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xAEF3C10)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_88667086FB91B538_OFFSET UNITYSDK_OFFSET(0xAEF7C80)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xAEF78E0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xAEF7B30)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xAEF5FE0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xAEF7970)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xAEF3AC0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_RESET_OFFSET UNITYSDK_OFFSET(0xAEF4700)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xAEF7A30)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETCANDRAG_OFFSET UNITYSDK_OFFSET(0xAEF3F30)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETFINISHSTATE_OFFSET UNITYSDK_OFFSET(0xAEF5930)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_VORTEXDRAG_OFFSET UNITYSDK_OFFSET(0xAEF57D0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_VORTEXEXPAND_OFFSET UNITYSDK_OFFSET(0xAEF5A20)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xAEF7D60)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAEF7D40)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0xAEF7DC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int VortexBoxPuzzleItem_TypeDefinitionIndex = 72356;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VortexBoxPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x4720);
		}
