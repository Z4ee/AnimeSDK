...
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xDD42F10)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_88667086FB91B538_OFFSET UNITYSDK_OFFSET(0xDD46EE0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xDD46B40)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_METHOD_6_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xDD46D90)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xDD453B0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xDD46BD0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xDD42DC0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_RESET_OFFSET UNITYSDK_OFFSET(0xDD43AB0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xDD46C90)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETCANDRAG_OFFSET UNITYSDK_OFFSET(0xDD43230)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_SETFINISHSTATE_OFFSET UNITYSDK_OFFSET(0xDD44D10)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_VORTEXDRAG_OFFSET UNITYSDK_OFFSET(0xDD44BC0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM_VORTEXEXPAND_OFFSET UNITYSDK_OFFSET(0xDD44E00)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD46FC0)
#define RPG_CLIENT_PROP_VORTEXBOXPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xDD46FA0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int VortexBoxPuzzleItem_TypeDefinitionIndex = 78389;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VortexBoxPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x15090);
		}
