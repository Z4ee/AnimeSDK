...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC58BEE0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_INITBLOCK_OFFSET UNITYSDK_OFFSET(0xC58BF20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_LOGICROTATETATUMX_OFFSET UNITYSDK_OFFSET(0xC58C4D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_LOGICROTATETATUMY_OFFSET UNITYSDK_OFFSET(0xC58C570)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_LOGICROTATETATUMZ_OFFSET UNITYSDK_OFFSET(0xC58C610)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_REFRESHLIGHTSTATUS_OFFSET UNITYSDK_OFFSET(0xC58BFF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK_SETSELECT_OFFSET UNITYSDK_OFFSET(0xC58C470)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xC58C6B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleBlock_TypeDefinitionIndex = 73196;
