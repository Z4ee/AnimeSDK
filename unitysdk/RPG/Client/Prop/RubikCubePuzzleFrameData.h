...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEFRAMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B057A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleFrameData_TypeDefinitionIndex = 78365;
