...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_BINDDUMMYTOUI_OFFSET UNITYSDK_OFFSET(0xAECB9E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_CALCBILLBOARDSCREENROTATE_OFFSET UNITYSDK_OFFSET(0xAECCC30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_DESTROYBOARD_OFFSET UNITYSDK_OFFSET(0xAECAB60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ENDCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xAECB1E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_GETGROUP_OFFSET UNITYSDK_OFFSET(0xAECB8C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITBOARD_1_OFFSET UNITYSDK_OFFSET(0xAEC9B70)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITBOARD_2_OFFSET UNITYSDK_OFFSET(0xAEC9760)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITBOARD_OFFSET UNITYSDK_OFFSET(0xAEC9700)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xAECA990)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_INITDUMMYBLOCK_OFFSET UNITYSDK_OFFSET(0xAEC9BD0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_0D372435D9CAE4BC_OFFSET UNITYSDK_OFFSET(0xAECEE10)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_0F6F8E8BE3B8322B_OFFSET UNITYSDK_OFFSET(0xAECEA10)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_13275269230D5342_OFFSET UNITYSDK_OFFSET(0xAECED30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_1B4BF40856AAD721_OFFSET UNITYSDK_OFFSET(0xAECEC90)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_2C5421072C50A323_OFFSET UNITYSDK_OFFSET(0xAECFFF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_30851BD42FA88FCF_OFFSET UNITYSDK_OFFSET(0xAED0AE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xAECE0E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAECB0A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_4D2A473556700CDC_1_OFFSET UNITYSDK_OFFSET(0xAECB550)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0xAECE3B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xAECF250)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_7AAD06186762BE3C_OFFSET UNITYSDK_OFFSET(0xAECF110)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_A0D8189C4327374C_OFFSET UNITYSDK_OFFSET(0xAECF2E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_A3FAE12D7B6ACD62_OFFSET UNITYSDK_OFFSET(0xAECFEE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_AEF524F2D408CDB8_OFFSET UNITYSDK_OFFSET(0xAED0730)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_BCFFE6CBFC0AF90C_OFFSET UNITYSDK_OFFSET(0xAECD0B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xAECB380)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_D0B68C1DD4B91F49_OFFSET UNITYSDK_OFFSET(0xAECE7D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_METHOD_5_F11610AE8CED7CFB_OFFSET UNITYSDK_OFFSET(0xAECAEB0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONCLICKACTION0_OFFSET UNITYSDK_OFFSET(0xAECE750)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONCLICKACTION1_OFFSET UNITYSDK_OFFSET(0xAECE990)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONCLICKEXIT_OFFSET UNITYSDK_OFFSET(0xAECE6C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAECB100)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONINPUTDEVICECLASSSWITCHED_OFFSET UNITYSDK_OFFSET(0xAECAD70)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAECE650)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONRELOAD_OFFSET UNITYSDK_OFFSET(0xAECD510)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONSELECTORDER_OFFSET UNITYSDK_OFFSET(0xAECD630)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONSTARTCONTROL_OFFSET UNITYSDK_OFFSET(0xAECAFF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_ONSTARTROTATE_OFFSET UNITYSDK_OFFSET(0xAECCF80)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHATTACHDUMMYBLOCKROTATION_OFFSET UNITYSDK_OFFSET(0xAECCAC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHDUMMYBLOCKATTACH_OFFSET UNITYSDK_OFFSET(0xAECBAC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHXZDUMMYBLOCKATTACH_OFFSET UNITYSDK_OFFSET(0xAECBB60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_REFRESHYDUMMYBLOCKATTACH_OFFSET UNITYSDK_OFFSET(0xAECC020)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_RESETCONTROLBOARD_OFFSET UNITYSDK_OFFSET(0xAECB7F0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_STARTCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xAECE170)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_UNBINDDUMMYFROMUI_OFFSET UNITYSDK_OFFSET(0xAECBA50)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xAECDA60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xAED0C40)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONTROLBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xAED0BF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleControlBoard_TypeDefinitionIndex = 72323;
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::Client::Prop::RubikCubePuzzleAxis>**)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0xB4B0);
		}
		static ::Il2CppArray<::RPG::Client::Prop::RubikCubeGroup>** StaticGet_Field_5_13()
		{
			return (::Il2CppArray<::RPG::Client::Prop::RubikCubeGroup>**)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0xB4B8);
		}
		static ::Il2CppArray<::RPG::Client::Prop::RubikCubePuzzleAxis>** StaticGet_Field_5_55()
		{
			return (::Il2CppArray<::RPG::Client::Prop::RubikCubePuzzleAxis>**)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0xB4C0);
		}
		static ::System::Single* StaticGet_Field_5_33()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0x43D0);
		}
		static ::System::Int32* StaticGet_Field_5_34()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RubikCubePuzzleControlBoard_TypeDefinitionIndex)->GetStaticField(0x43D4);
		}
