...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1665AD90)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_INITOBJECT_OFFSET UNITYSDK_OFFSET(0x16659B90)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0x16659BE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0x1665A490)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1665ADD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleConditionObject_TypeDefinitionIndex = 78350;
