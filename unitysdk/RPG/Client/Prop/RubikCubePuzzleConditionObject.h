...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDD1AE40)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_INITOBJECT_OFFSET UNITYSDK_OFFSET(0xDD19E80)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xDD19ED0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0xDD1A540)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xDD1AE80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleConditionObject_TypeDefinitionIndex = 78351;
