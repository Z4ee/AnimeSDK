...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC611AE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_INITOBJECT_OFFSET UNITYSDK_OFFSET(0xC610950)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xC6109A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0xC611250)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECONDITIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC611B20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleConditionObject_TypeDefinitionIndex = 73340;
