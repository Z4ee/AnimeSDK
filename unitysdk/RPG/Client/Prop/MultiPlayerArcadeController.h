...
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC599310)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_GET_NEEDSCENETV_OFFSET UNITYSDK_OFFSET(0xC599EB0)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC599850)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC599390)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC599350)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_SET_NEEDSCENETV_OFFSET UNITYSDK_OFFSET(0xC599EC0)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xC599580)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC599ED0)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER__FINDSCENETVS_OFFSET UNITYSDK_OFFSET(0xC5995D0)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER__INIT_OFFSET UNITYSDK_OFFSET(0xC599890)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER__ONSCHEDULESTART_OFFSET UNITYSDK_OFFSET(0xC599E60)
#define RPG_CLIENT_PROP_MULTIPLAYERARCADECONTROLLER__UNREGISTERWAITFOROPENSCHEDULE_OFFSET UNITYSDK_OFFSET(0xC5993E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int MultiPlayerArcadeController_TypeDefinitionIndex = 72704;
