...
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_CHECKPOINTSOVERLAYONSCREEN_OFFSET UNITYSDK_OFFSET(0x148603E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_CONVERTBOARDTOWORLDPOS_OFFSET UNITYSDK_OFFSET(0x14865F70)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_CONVERTWORLDTOBOARDPOS_OFFSET UNITYSDK_OFFSET(0x1485CB30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x148580A0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_ENTERPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1485C6A0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_EXITPERFORMANCE_OFFSET UNITYSDK_OFFSET(0x1485C6F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_FINDPATH_OFFSET UNITYSDK_OFFSET(0x148699A0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GETENTITY_OFFSET UNITYSDK_OFFSET(0x1485AED0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GETIGNORECOVERPOS_OFFSET UNITYSDK_OFFSET(0x148692C0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GETORTHOGRAPHICSIZE_OFFSET UNITYSDK_OFFSET(0x1485C900)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_GOLDGEARASSET_OFFSET UNITYSDK_OFFSET(0x1486E8C0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_HOVERITEM_OFFSET UNITYSDK_OFFSET(0x1486E880)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_OPCOUNT_OFFSET UNITYSDK_OFFSET(0x1486E900)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x1486E860)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_REACHPOINT_OFFSET UNITYSDK_OFFSET(0x1486E920)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_SELECTITEM_OFFSET UNITYSDK_OFFSET(0x1486E8A0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_GET_SILVERGEARASSET_OFFSET UNITYSDK_OFFSET(0x1486E8E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_HASIGNORECOVERCUBES_OFFSET UNITYSDK_OFFSET(0x14869260)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x14855880)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x1485AF20)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_ISPUZZLESTART_OFFSET UNITYSDK_OFFSET(0x1485AF70)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_0457507DF38D8288_OFFSET UNITYSDK_OFFSET(0x1485FB90)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_0865E94460F11643_1_OFFSET UNITYSDK_OFFSET(0x14864860)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_0865E94460F11643_OFFSET UNITYSDK_OFFSET(0x148646F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_094B0097F108028C_OFFSET UNITYSDK_OFFSET(0x14865E90)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_0D97457E251B0734_OFFSET UNITYSDK_OFFSET(0x14863B30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x1485ADB0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_159C9D9875436268_OFFSET UNITYSDK_OFFSET(0x14868B60)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_1C64B8C0F1A72497_OFFSET UNITYSDK_OFFSET(0x14866B80)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_1E3DFBB09C3E70E9_OFFSET UNITYSDK_OFFSET(0x1486D590)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0x14858E50)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x148562F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_2928A55194B8E32E_OFFSET UNITYSDK_OFFSET(0x1485CF20)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_2C772DDA1A50CF21_OFFSET UNITYSDK_OFFSET(0x1485EA80)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x1485FB30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_30D1209326FA87FC_1_OFFSET UNITYSDK_OFFSET(0x14857A80)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_30D1209326FA87FC_2_OFFSET UNITYSDK_OFFSET(0x14858C70)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_30D1209326FA87FC_3_OFFSET UNITYSDK_OFFSET(0x14858D00)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_30D1209326FA87FC_4_OFFSET UNITYSDK_OFFSET(0x14855FE0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x1485AE40)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_3879EA6D7539708A_OFFSET UNITYSDK_OFFSET(0x1485DF30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_38ADAA156D5E6758_OFFSET UNITYSDK_OFFSET(0x1486D500)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_3B44871AFE34BC4F_OFFSET UNITYSDK_OFFSET(0x1485F0E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_3C77BCE628081A11_OFFSET UNITYSDK_OFFSET(0x14864C30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_41A074549EF25F63_1_OFFSET UNITYSDK_OFFSET(0x148640C0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x14863820)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_421A462C2ECF66DF_OFFSET UNITYSDK_OFFSET(0x14861140)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x1485B000)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_431B41F82025C3EE_OFFSET UNITYSDK_OFFSET(0x1485C9D0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_44566536665BE7EB_1_OFFSET UNITYSDK_OFFSET(0x14869160)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_44566536665BE7EB_OFFSET UNITYSDK_OFFSET(0x148690F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_446BE43D2AA5DB95_OFFSET UNITYSDK_OFFSET(0x1485A200)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_4E8A3F7A0113D485_OFFSET UNITYSDK_OFFSET(0x14861890)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_4FD6AFA6F158FADD_OFFSET UNITYSDK_OFFSET(0x148691D0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0x14863550)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x14864B00)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_5213E75FA17D9E65_OFFSET UNITYSDK_OFFSET(0x1485BCF0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_54FF506E09E1174A_OFFSET UNITYSDK_OFFSET(0x14866210)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_56AAF22972BD1A66_OFFSET UNITYSDK_OFFSET(0x14857190)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_5B56B56BFFE4CC00_OFFSET UNITYSDK_OFFSET(0x1485CA10)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_5F59867914726945_OFFSET UNITYSDK_OFFSET(0x14863F30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_65FFC22DF0ABA763_OFFSET UNITYSDK_OFFSET(0x1485CC00)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_6719DA68505926D8_OFFSET UNITYSDK_OFFSET(0x14860A30)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_68BD5489BD21F18D_OFFSET UNITYSDK_OFFSET(0x14868ED0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x148560D0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x14857BA0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_73C23613314BF1A1_OFFSET UNITYSDK_OFFSET(0x1485E420)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_752BB3BCDA90FF0A_OFFSET UNITYSDK_OFFSET(0x14859470)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_775B6D644F07B554_OFFSET UNITYSDK_OFFSET(0x14858D80)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x1485B200)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_87318FF00D6BC7EB_OFFSET UNITYSDK_OFFSET(0x1485FC60)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_8D3DBB818193843D_OFFSET UNITYSDK_OFFSET(0x148605E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_916B8A6B72C96F5C_OFFSET UNITYSDK_OFFSET(0x1485E660)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x14864A60)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_974A70E8019154E7_OFFSET UNITYSDK_OFFSET(0x148639F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_A149D247F7723D05_OFFSET UNITYSDK_OFFSET(0x1485F4A0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x14858F50)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0x1485A7D0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x1485AB50)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_AE86A66C8FD43296_OFFSET UNITYSDK_OFFSET(0x14868CE0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_B19261A0CF994DEF_OFFSET UNITYSDK_OFFSET(0x14860AA0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x1485E560)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x14857C60)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_D740A9BE179A9A5F_OFFSET UNITYSDK_OFFSET(0x14866040)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_DFF98536D8B4074F_OFFSET UNITYSDK_OFFSET(0x148633F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x14863A80)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x14858EB0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_E702603535BCED6C_OFFSET UNITYSDK_OFFSET(0x1485C220)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_EB98D3E386F8F884_OFFSET UNITYSDK_OFFSET(0x1485CFF0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_ECF6C62C44B499CA_OFFSET UNITYSDK_OFFSET(0x14868E20)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x1485E5E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_FADBDF6B666E37DE_OFFSET UNITYSDK_OFFSET(0x14857610)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_FF23CF46ADBA32C4_OFFSET UNITYSDK_OFFSET(0x148642B0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_FF2DB8C5D4C76BA8_OFFSET UNITYSDK_OFFSET(0x14868C00)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_MOVEITEMASYNC_OFFSET UNITYSDK_OFFSET(0x14865AE0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_REMOVEEFFECT_OFFSET UNITYSDK_OFFSET(0x1485F040)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_RESETORTHOGRAPHICCAMERA_OFFSET UNITYSDK_OFFSET(0x1485C7E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x1485A900)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_ROTATEITEM_OFFSET UNITYSDK_OFFSET(0x14860D20)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SETNPCBUBBLETALK_OFFSET UNITYSDK_OFFSET(0x1485E780)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_GOLDGEARASSET_OFFSET UNITYSDK_OFFSET(0x1486E8D0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_HOVERITEM_OFFSET UNITYSDK_OFFSET(0x1486E890)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_OPCOUNT_OFFSET UNITYSDK_OFFSET(0x1486E910)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x1486E870)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_REACHPOINT_OFFSET UNITYSDK_OFFSET(0x1486E930)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_SELECTITEM_OFFSET UNITYSDK_OFFSET(0x1486E8B0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SET_SILVERGEARASSET_OFFSET UNITYSDK_OFFSET(0x1486E8F0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x14859010)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_SWITCHCAMERAANCHOR_OFFSET UNITYSDK_OFFSET(0x1485C860)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x1485BAD0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_TRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x1485ED60)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0x1485AFB0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1486ED10)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1486E940)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OpticalIllusionPuzzleBoard_TypeDefinitionIndex = 74745;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x57D0);
		}
		static ::System::String** StaticGet_BUBBLE_UNIQUE_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x57D8);
		}
		static ::System::String** StaticGet_SOUND_ITEM_MOVE_BLOCK()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x57E0);
		}
		static ::System::String** StaticGet_GAME_KEY()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x57E8);
		}
		static ::System::String** StaticGet_SOUND_MIRROR_MOVE_START()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x57F0);
		}
		static ::System::String** StaticGet_SOUND_MIRROR_MOVE_END()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x57F8);
		}
		static ::RPG::Client::MirrormentValleyConfig** StaticGet_MirrorValleyConfig()
		{
			return (::RPG::Client::MirrormentValleyConfig**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5800);
		}
		static ::System::String** StaticGet_CONFIRM_DIALOG_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5808);
		}
		static ::System::String** StaticGet_POST_PROCESS_ASSET()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5810);
		}
		static ::System::String** StaticGet_SOUND_MIRROR_MOVE_BLOCK()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5818);
		}
		static ::System::String** StaticGet_GUIDE_DIALOG_NAME()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5820);
		}
		static ::System::String** StaticGet_START_SOUND()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5828);
		}
		static ::System::String** StaticGet_SOUND_WAY_PASS()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5830);
		}
		static ::System::String** StaticGet_SOUND_ITEM_SELECT()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5838);
		}
		static ::System::String** StaticGet_END_SOUND()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x5840);
		}
		static ::System::Single* StaticGet_FloatEpsilon()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3210);
		}
		static ::System::UInt32* StaticGet_CLOCK_BOY_ID()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3214);
		}
		static ::System::Single* StaticGet_RotateStep()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3218);
		}
		static ::System::Single* StaticGet_OverlayEpsilon()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(OpticalIllusionPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x321C);
		}
		...
		::RPG::Client::Billboard::BillboardNotifyParam* Method_6_2C772DDA1A50CF21(::RPG::GameCore::GameEntity* a1)
		{
			return ((::RPG::Client::Billboard::BillboardNotifyParam*(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD_METHOD_6_2C772DDA1A50CF21_OFFSET))(this, a1);
		}
