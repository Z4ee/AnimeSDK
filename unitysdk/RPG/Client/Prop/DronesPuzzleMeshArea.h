...
#define RPG_CLIENT_PROP_DRONESPUZZLEMESHAREA_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1A912260)
#define RPG_CLIENT_PROP_DRONESPUZZLEMESHAREA_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1A912300)
#define RPG_CLIENT_PROP_DRONESPUZZLEMESHAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9123A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesPuzzleMeshArea_TypeDefinitionIndex = 78102;
