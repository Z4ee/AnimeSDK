...
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___C__DISPLAYCLASS100_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAE751E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___C__DISPLAYCLASS100_1___BFS_B__1_OFFSET UNITYSDK_OFFSET(0xAE75B80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OpticalIllusionPuzzleBoard___c__DisplayClass100_1_TypeDefinitionIndex = 72203;
