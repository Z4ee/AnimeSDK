...
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC544B50)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC545150)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC5451B0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC545160)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC544B40)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0xC5441A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DestroyRootPuzzleChess___DoMove_d__17_TypeDefinitionIndex = 73065;
