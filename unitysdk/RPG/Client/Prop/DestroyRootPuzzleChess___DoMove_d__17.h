...
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19015DA0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x190163A0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19016400)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x190163B0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19015D90)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOMOVE_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x190153F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DestroyRootPuzzleChess___DoMove_d__17_TypeDefinitionIndex = 74590;
