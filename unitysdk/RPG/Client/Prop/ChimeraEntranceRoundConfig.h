...
#define RPG_CLIENT_PROP_CHIMERAENTRANCEROUNDCONFIG_INITANCHORCONFIGS_OFFSET UNITYSDK_OFFSET(0xA05D0A0)
#define RPG_CLIENT_PROP_CHIMERAENTRANCEROUNDCONFIG_TRYGETCHIMERATALKINFOLIST_OFFSET UNITYSDK_OFFSET(0xA05D340)
#define RPG_CLIENT_PROP_CHIMERAENTRANCEROUNDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA05D4E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraEntranceRoundConfig_TypeDefinitionIndex = 63936;
