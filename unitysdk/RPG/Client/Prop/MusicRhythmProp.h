...
#define RPG_CLIENT_PROP_MUSICRHYTHMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xA0D5D80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int MusicRhythmProp_TypeDefinitionIndex = 63639;
