...
#define RPG_CLIENT_PROP_MUSICRHYTHMPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x16129CC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int MusicRhythmProp_TypeDefinitionIndex = 77710;
