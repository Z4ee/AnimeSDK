...
#define RPG_CLIENT_PROP_ORACLEITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDCC6750)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OracleItemData_TypeDefinitionIndex = 78260;
