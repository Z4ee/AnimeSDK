...
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CANWATERLEVELCHANGE_OFFSET UNITYSDK_OFFSET(0xA17BB00)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_CHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xA17B760)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA17E870)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0xA17ED80)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA17DBA0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_METHOD_6_54D9F076DD3781B1_OFFSET UNITYSDK_OFFSET(0xA17E1D0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_ONCHANGEWATERLEVELEND_OFFSET UNITYSDK_OFFSET(0xA17A4C0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA17E5D0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA17EAA0)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_TRYSAVEDATATOSERVER_OFFSET UNITYSDK_OFFSET(0xA179A70)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS__CTOR_OFFSET UNITYSDK_OFFSET(0xA17EF00)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA17F070)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA17F000)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA17F010)
#define RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xA17F080)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelPuzzleBoardPlus_TypeDefinitionIndex = 64369;
	...
	public:
		...
		::System::Boolean Method_6_54D9F076DD3781B1()
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS_METHOD_6_54D9F076DD3781B1_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy_InitPuzzle(::RPG::GameCore::GameEntity* P0, ::RPG::GameCore::TaskContext* P1, ::RPG::GameCore::PropInitPuzzle* P2)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, P0, P1, P2);
		}

		::System::Void __iFixBaseProxy_ResetPuzzle()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_RESETPUZZLE_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy_Dispose()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_DISPOSE_OFFSET))(this);
		}

		::System::Void __iFixBaseProxy_TickPuzzle(::System::Single P0)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELPUZZLEBOARDPLUS___IFIXBASEPROXY_TICKPUZZLE_OFFSET))(this, P0);
		}
	};
}
