...
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_CANITEMMOVE_OFFSET UNITYSDK_OFFSET(0xC63FE70)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC640C40)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0xC63DE30)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_GETITEM_OFFSET UNITYSDK_OFFSET(0xC63FAF0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITBOXMANWITHSAVEDATA_OFFSET UNITYSDK_OFFSET(0xC63DF30)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITCHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xC63E6C0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITITEMS_OFFSET UNITYSDK_OFFSET(0xC63DCA0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xC63E120)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC63E2A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xC63E640)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ITEM2BOARDLOCAL_OFFSET UNITYSDK_OFFSET(0xC63D3D0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_0485642989684DA8_OFFSET UNITYSDK_OFFSET(0xC63FFE0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_1F8838DB7F586784_OFFSET UNITYSDK_OFFSET(0xC63EF70)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xC63E320)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_66746A96792CE392_OFFSET UNITYSDK_OFFSET(0xC640070)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_66FF6A49D33160A6_OFFSET UNITYSDK_OFFSET(0xC63F190)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0xC63F0C0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D20F759FC2EC43FB_1_OFFSET UNITYSDK_OFFSET(0xC63FC10)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D20F759FC2EC43FB_OFFSET UNITYSDK_OFFSET(0xC63FB90)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D5A1784FA4448BA9_OFFSET UNITYSDK_OFFSET(0xC640780)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DA79A5A83B1812EC_OFFSET UNITYSDK_OFFSET(0xC63EC40)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DA8DF0AEAF419758_OFFSET UNITYSDK_OFFSET(0xC63EAA0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E21C737250B730B9_OFFSET UNITYSDK_OFFSET(0xC63EEA0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xC63D800)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ONITEMMOVE_OFFSET UNITYSDK_OFFSET(0xC6403D0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC640830)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_STARTANIMCHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xC63E970)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_STARTCHANGEWATERLEVELIMMEDIATE_OFFSET UNITYSDK_OFFSET(0xC63EB70)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_TICK_OFFSET UNITYSDK_OFFSET(0xC63F370)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_WORLDFORWARDRIGHT2DIR_OFFSET UNITYSDK_OFFSET(0xC63FC90)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_WORLDPOSITION2COORD_OFFSET UNITYSDK_OFFSET(0xC63F2C0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN__CCTOR_OFFSET UNITYSDK_OFFSET(0xC640E10)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN__CTOR_OFFSET UNITYSDK_OFFSET(0xC640D10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxman_TypeDefinitionIndex = 73433;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxman_TypeDefinitionIndex)->GetStaticField(0x9130);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D20F759FC2EC43FB_OFFSET))(this);
		}

		::System::Void Method_5_D20F759FC2EC43FB_1()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D20F759FC2EC43FB_1_OFFSET))(this);
		}
