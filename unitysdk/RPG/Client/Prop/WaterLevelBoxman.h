...
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_CANITEMMOVE_OFFSET UNITYSDK_OFFSET(0x17B23DE0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B24BB0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0x17B21D50)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_GETITEM_OFFSET UNITYSDK_OFFSET(0x17B23A60)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITBOXMANWITHSAVEDATA_OFFSET UNITYSDK_OFFSET(0x17B21E50)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITCHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0x17B22630)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITITEMS_OFFSET UNITYSDK_OFFSET(0x17B21BC0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0x17B22040)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x17B221C0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITWATERLEVEL_OFFSET UNITYSDK_OFFSET(0x17B225B0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ITEM2BOARDLOCAL_OFFSET UNITYSDK_OFFSET(0x17B212F0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_0485642989684DA8_OFFSET UNITYSDK_OFFSET(0x17B23F50)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_1F8838DB7F586784_OFFSET UNITYSDK_OFFSET(0x17B22EE0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0x17B22290)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_66746A96792CE392_OFFSET UNITYSDK_OFFSET(0x17B23FE0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_66FF6A49D33160A6_OFFSET UNITYSDK_OFFSET(0x17B23100)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_71912DBB0D113575_1_OFFSET UNITYSDK_OFFSET(0x17B23B80)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_71912DBB0D113575_OFFSET UNITYSDK_OFFSET(0x17B23B00)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x17B23030)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_D5A1784FA4448BA9_OFFSET UNITYSDK_OFFSET(0x17B246F0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DA79A5A83B1812EC_OFFSET UNITYSDK_OFFSET(0x17B22BB0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DA8DF0AEAF419758_OFFSET UNITYSDK_OFFSET(0x17B22A10)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E21C737250B730B9_OFFSET UNITYSDK_OFFSET(0x17B22E10)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0x17B21720)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ONITEMMOVE_OFFSET UNITYSDK_OFFSET(0x17B24340)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x17B247A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_STARTANIMCHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0x17B228E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_STARTCHANGEWATERLEVELIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x17B22AE0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_TICK_OFFSET UNITYSDK_OFFSET(0x17B232E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_WORLDFORWARDRIGHT2DIR_OFFSET UNITYSDK_OFFSET(0x17B23C00)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_WORLDPOSITION2COORD_OFFSET UNITYSDK_OFFSET(0x17B23230)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B24D80)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x17B24C80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxman_TypeDefinitionIndex = 78443;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxman_TypeDefinitionIndex)->GetStaticField(0x14ED0);
		}
