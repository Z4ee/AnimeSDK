...
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_CANITEMMOVE_OFFSET UNITYSDK_OFFSET(0xA179280)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA179FE0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_DUMPSAVEDATA_OFFSET UNITYSDK_OFFSET(0xA177080)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_GETITEM_OFFSET UNITYSDK_OFFSET(0xA178EF0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITBOXMANWITHSAVEDATA_OFFSET UNITYSDK_OFFSET(0xA177190)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITCHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xA177970)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITITEMS_OFFSET UNITYSDK_OFFSET(0xA176ED0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xA1773E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA177550)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_INITWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xA1778F0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ITEM2BOARDLOCAL_OFFSET UNITYSDK_OFFSET(0xA1765E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_0485642989684DA8_OFFSET UNITYSDK_OFFSET(0xA1793F0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_1F8838DB7F586784_OFFSET UNITYSDK_OFFSET(0xA178280)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_2450CFC043E97F54_OFFSET UNITYSDK_OFFSET(0xA1775D0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_66746A96792CE392_OFFSET UNITYSDK_OFFSET(0xA179480)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_66FF6A49D33160A6_OFFSET UNITYSDK_OFFSET(0xA178520)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_8E1539320211F6E5_OFFSET UNITYSDK_OFFSET(0xA179BD0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DA79A5A83B1812EC_OFFSET UNITYSDK_OFFSET(0xA177F20)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DA8DF0AEAF419758_OFFSET UNITYSDK_OFFSET(0xA177D80)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DDA8A2337932DF10_OFFSET UNITYSDK_OFFSET(0xA1783C0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E21C737250B730B9_OFFSET UNITYSDK_OFFSET(0xA1781B0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E83C51340BE6FC16_1_OFFSET UNITYSDK_OFFSET(0xA179020)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E83C51340BE6FC16_OFFSET UNITYSDK_OFFSET(0xA178FA0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xA176A10)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_ONITEMMOVE_OFFSET UNITYSDK_OFFSET(0xA1797E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA179C90)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_STARTANIMCHANGEWATERLEVEL_OFFSET UNITYSDK_OFFSET(0xA177C50)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_STARTCHANGEWATERLEVELIMMEDIATE_OFFSET UNITYSDK_OFFSET(0xA177E50)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_TICK_OFFSET UNITYSDK_OFFSET(0xA178700)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_WORLDFORWARDRIGHT2DIR_OFFSET UNITYSDK_OFFSET(0xA1790A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN_WORLDPOSITION2COORD_OFFSET UNITYSDK_OFFSET(0xA178650)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN__CCTOR_OFFSET UNITYSDK_OFFSET(0xA17A180)
#define RPG_CLIENT_PROP_WATERLEVELBOXMAN__CTOR_OFFSET UNITYSDK_OFFSET(0xA17A080)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxman_TypeDefinitionIndex = 64364;

	class WaterLevelBoxman : public ::UnityEngine::MonoBehaviour
	{
	public:
		static ::System::Single* StaticGet_Field_5_32()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxman_TypeDefinitionIndex)->GetStaticField(0x4400);
		}
		...
		// static const ::System::String* Field_5_20; // 0x0
		...
		::RPG::GameCore::PropOptionTrigger_ButtonParam* Field_5_11; // 0x68
		::System::Collections::Generic::List_1<::RPG::GameCore::OptionTriggerInfo*>* Field_5_12; // 0x70
		::RPG::GameCore::OptionTriggerInfo* Field_5_13; // 0x78
		::RPG::GameCore::OptionTriggerInfo* Field_5_14; // 0x80
		::RPG::GameCore::OptionTriggerInfo* Field_5_15; // 0x88
		::RPG::GameCore::OptionTriggerInfo* Field_5_16; // 0x90
		::RPG::Client::Prop::WaterLevelBoxItem* Field_5_21; // 0x98
		::RPG::Client::Prop::WaterLevelPuzzleBoardPlus* Field_5_22; // 0xA0
		::System::Boolean Field_5_23; // 0xA8
		::System::Boolean Field_5_24; // 0xA9
		::System::Boolean Field_5_25; // 0xAA
		::RPG::Client::Prop::BoxmanCoord Field_5_26; // 0xAC
		::UnityEngine::Vector3 Field_5_27; // 0xB4
		::System::Boolean Field_5_28; // 0xC0
		::System::Boolean Field_5_29; // 0xC1
		::System::Boolean Field_5_30; // 0xC2
		::Il2CppArray<::RPG::Client::Prop::WaterLevelBoxItem*>* Field_5_31; // 0xC8
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_DDA8A2337932DF10_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E83C51340BE6FC16_OFFSET))(this);
		}

		::System::Void Method_5_E83C51340BE6FC16_1()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_E83C51340BE6FC16_1_OFFSET))(this);
		}
		...
		::System::Boolean Method_5_8E1539320211F6E5(::RPG::Client::Prop::BoxmanCoord a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::RPG::Client::Prop::BoxmanCoord))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_WATERLEVELBOXMAN_METHOD_5_8E1539320211F6E5_OFFSET))(this, a1);
		}
