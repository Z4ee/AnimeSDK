...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x189B94A0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_CANBOXSELECT_OFFSET UNITYSDK_OFFSET(0x189B6B90)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_DUMPPERSISTENTDATA_OFFSET UNITYSDK_OFFSET(0x189BA7F0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0x189B95D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_INTERACT_OFFSET UNITYSDK_OFFSET(0x189B9ED0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_ISNORMALBOX_OFFSET UNITYSDK_OFFSET(0x189B4580)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x189B9B20)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_LOADPERSISTENTDATA_OFFSET UNITYSDK_OFFSET(0x189B4E20)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_1920CD45C76CCBBB_OFFSET UNITYSDK_OFFSET(0x189BA1B0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0x189BA720)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0x189B9E40)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_9E49294C33DF47C3_OFFSET UNITYSDK_OFFSET(0x189BA040)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_D17B49CABC597E3E_1_OFFSET UNITYSDK_OFFSET(0x189BA110)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0x189B9FA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0x189BA5D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_MOVE_OFFSET UNITYSDK_OFFSET(0x189B80D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0x189BA510)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0x189B45D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_RESET_OFFSET UNITYSDK_OFFSET(0x189B8EC0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0x189B8480)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_SETFINISHSTATE_OFFSET UNITYSDK_OFFSET(0x189B8320)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x189BA8C0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x189BA830)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItem_TypeDefinitionIndex = 78377;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13B20);
		}
		static ::System::Int32* StaticGet_JLGAGGNJAHI()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13B24);
		}
		static ::System::Int32* StaticGet_NMGIHKOHOAI()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13B28);
		}
