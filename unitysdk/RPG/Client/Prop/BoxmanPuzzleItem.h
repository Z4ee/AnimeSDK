...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xAD9A000)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_CANBOXSELECT_OFFSET UNITYSDK_OFFSET(0xAD9AC60)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_DUMPPERSISTENTDATA_OFFSET UNITYSDK_OFFSET(0xAD9B1D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0xAD9A0E0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_INTERACT_OFFSET UNITYSDK_OFFSET(0xAD9A690)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_ISNORMALBOX_OFFSET UNITYSDK_OFFSET(0xAD9B370)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAD9A630)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_LOADPERSISTENTDATA_OFFSET UNITYSDK_OFFSET(0xAD9B0F0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAD9AEA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xAD9AE00)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_9E49294C33DF47C3_OFFSET UNITYSDK_OFFSET(0xAD9A7F0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_B386444429A36A77_OFFSET UNITYSDK_OFFSET(0xAD9A950)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_D17B49CABC597E3E_1_OFFSET UNITYSDK_OFFSET(0xAD9A8C0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_D17B49CABC597E3E_OFFSET UNITYSDK_OFFSET(0xAD9A760)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_METHOD_6_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xAD9ACC0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xAD99000)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0xAD9AAA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xAD9AFA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_RESET_OFFSET UNITYSDK_OFFSET(0xAD9AF00)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xAD9AB60)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM_SETFINISHSTATE_OFFSET UNITYSDK_OFFSET(0xAD9B210)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xAD9B450)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAD9B3C0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM___IFIXBASEPROXY_ONSELECT_OFFSET UNITYSDK_OFFSET(0xAD9B4E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItem_TypeDefinitionIndex = 72345;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x1120);
		}
		static ::System::Int32* StaticGet_Field_6_30()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x1124);
		}
		static ::System::Int32* StaticGet_Field_6_29()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleItem_TypeDefinitionIndex)->GetStaticField(0x1128);
		}
