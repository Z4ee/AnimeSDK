...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_DELAYSHOW_OFFSET UNITYSDK_OFFSET(0x1613F5C0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_GET_CURRCOL_OFFSET UNITYSDK_OFFSET(0x16140880)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_GET_CURRENTBOARDOBJ_OFFSET UNITYSDK_OFFSET(0x16134100)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_GET_CURRROW_OFFSET UNITYSDK_OFFSET(0x16140800)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_HIDEBOARD_OFFSET UNITYSDK_OFFSET(0x1613FF50)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_INITITEM_OFFSET UNITYSDK_OFFSET(0x161352F0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16140CE0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_REFRESHOBJECTSTATUS_OFFSET UNITYSDK_OFFSET(0x16140900)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SETCURRROWCOL_OFFSET UNITYSDK_OFFSET(0x16140BE0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SETROWCOL_OFFSET UNITYSDK_OFFSET(0x16140B60)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SET_CURRCOL_OFFSET UNITYSDK_OFFSET(0x16140890)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SET_CURRROW_OFFSET UNITYSDK_OFFSET(0x16140810)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16140DA0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE__DELAYSHOW_B__19_0_OFFSET UNITYSDK_OFFSET(0x16140DB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleItemBase_TypeDefinitionIndex = 74974;
