...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_DELAYSHOW_OFFSET UNITYSDK_OFFSET(0xAF16130)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_GET_CURRCOL_OFFSET UNITYSDK_OFFSET(0xAF173C0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_GET_CURRENTBOARDOBJ_OFFSET UNITYSDK_OFFSET(0xAF0AAC0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_GET_CURRROW_OFFSET UNITYSDK_OFFSET(0xAF17340)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_HIDEBOARD_OFFSET UNITYSDK_OFFSET(0xAF16A90)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_INITITEM_OFFSET UNITYSDK_OFFSET(0xAF0BC40)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAF17820)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_REFRESHOBJECTSTATUS_OFFSET UNITYSDK_OFFSET(0xAF17440)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SETCURRROWCOL_OFFSET UNITYSDK_OFFSET(0xAF17720)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SETROWCOL_OFFSET UNITYSDK_OFFSET(0xAF176A0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SET_CURRCOL_OFFSET UNITYSDK_OFFSET(0xAF173D0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE_SET_CURRROW_OFFSET UNITYSDK_OFFSET(0xAF17350)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xAF17900)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEITEMBASE__DELAYSHOW_B__19_0_OFFSET UNITYSDK_OFFSET(0xAF17910)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleItemBase_TypeDefinitionIndex = 72427;
