...
#define RPG_CLIENT_PROP_CHIMERADUELSHOPTEAMDRAGAREAS_DRAGMOVE_OFFSET UNITYSDK_OFFSET(0xDC27F60)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPTEAMDRAGAREAS_SETSTALLAREADISABLED_OFFSET UNITYSDK_OFFSET(0xDC28630)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPTEAMDRAGAREAS__CTOR_OFFSET UNITYSDK_OFFSET(0xDC28680)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPTEAMDRAGAREAS__ISINSTALLDRAGAREA_OFFSET UNITYSDK_OFFSET(0xDC28490)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelShopTeamDragAreas_TypeDefinitionIndex = 77869;
