...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGELINERENDEREMISSION_OFFSET UNITYSDK_OFFSET(0xADF7990)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0xADF4BC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADF45B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETANSWERBASEPOINTPROPIDLIST_OFFSET UNITYSDK_OFFSET(0xADF26D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETBASEPOINT_OFFSET UNITYSDK_OFFSET(0xADF5E70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETSTONE_OFFSET UNITYSDK_OFFSET(0xADF5F50)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xADF8280)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xADF82A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYERHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xADF2430)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYINGSTONEMOVEANIM_OFFSET UNITYSDK_OFFSET(0xADF6040)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xADF82C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GIVEBACKHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xADF6BF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF29D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xADF4B70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_0F9BA4683D398D7A_OFFSET UNITYSDK_OFFSET(0xADF3640)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0xADF6D80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_2DD8EB2A8AB21975_OFFSET UNITYSDK_OFFSET(0xADF7540)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_31B86CF031D1C6B2_OFFSET UNITYSDK_OFFSET(0xADF8040)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0xADF86F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CAB3F134E5CEF52_OFFSET UNITYSDK_OFFSET(0xADF4D80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xADF3330)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xADF7AA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_7206DC8F66A4D2A8_OFFSET UNITYSDK_OFFSET(0xADF58D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_78DD1D9F31D0769E_OFFSET UNITYSDK_OFFSET(0xADF4CC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8080E22F79F246F0_OFFSET UNITYSDK_OFFSET(0xADF3B80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8608350DFEDEE4FD_OFFSET UNITYSDK_OFFSET(0xADF6FF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8719F90BD885137A_OFFSET UNITYSDK_OFFSET(0xADF8380)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_889C45DCDD74975A_OFFSET UNITYSDK_OFFSET(0xADF55C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8A2905DAFB806E28_OFFSET UNITYSDK_OFFSET(0xADF7360)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xADF6E10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_A984848EA3E436DA_OFFSET UNITYSDK_OFFSET(0xADF4660)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_C1E0405EEC95DC65_OFFSET UNITYSDK_OFFSET(0xADF6260)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_CB8E229BDF290D41_OFFSET UNITYSDK_OFFSET(0xADF3920)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_E21AC6EE08DC160A_OFFSET UNITYSDK_OFFSET(0xADF5A20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_EBBE08F2874773A2_OFFSET UNITYSDK_OFFSET(0xADF8250)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_F63565EA57F495CC_OFFSET UNITYSDK_OFFSET(0xADF42A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0xADF67E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PICKUPSTONE_OFFSET UNITYSDK_OFFSET(0xADF2070)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLACESTONE_OFFSET UNITYSDK_OFFSET(0xADF1EC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYEREFFECTATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xADF82E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYSTONEMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xADF60A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF41D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xADF8290)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xADF82B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xADF82D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF32D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SWAPSTONE_OFFSET UNITYSDK_OFFSET(0xADF2220)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF6F50)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xADF7E70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONEFADEOUT_OFFSET UNITYSDK_OFFSET(0xADF7BB0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONELINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xADF7D30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xADF8B00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xADF87B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADF8C30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF8B60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xADF8C40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF8BD0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF8B70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xADF8CE0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___SWITCHPLAYEREFFECT_B__39_0_OFFSET UNITYSDK_OFFSET(0xADF8B50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard_TypeDefinitionIndex = 72025;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x6D30);
		}
		static ::System::Int32* StaticGet_Field_6_25()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x32A0);
		}
