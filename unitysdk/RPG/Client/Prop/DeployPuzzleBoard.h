...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGELINERENDEREMISSION_OFFSET UNITYSDK_OFFSET(0xDC47FF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0xDC44CA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDC44690)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETANSWERBASEPOINTPROPIDLIST_OFFSET UNITYSDK_OFFSET(0xDC42580)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETBASEPOINT_OFFSET UNITYSDK_OFFSET(0xDC461F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETSTONE_OFFSET UNITYSDK_OFFSET(0xDC462A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xDC48A60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xDC48A80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYERHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xDC422E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYINGSTONEMOVEANIM_OFFSET UNITYSDK_OFFSET(0xDC46360)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xDC48AA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GIVEBACKHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xDC47170)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xDC42890)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xDC44C50)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xDC48100)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xDC46670)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_1AB9D4E0D4B0F708_OFFSET UNITYSDK_OFFSET(0xDC47B90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xDC44750)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0xDC47340)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_2CD6D17D088D5DB9_OFFSET UNITYSDK_OFFSET(0xDC43BC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0xDC48ED0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xDC43220)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3D18881BFBA2A416_OFFSET UNITYSDK_OFFSET(0xDC48A30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0xDC45C70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_4F60CBE29BD2AB9A_OFFSET UNITYSDK_OFFSET(0xDC475B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_5C894234121A7CB4_OFFSET UNITYSDK_OFFSET(0xDC45800)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_740A14CA31FF6391_OFFSET UNITYSDK_OFFSET(0xDC44DA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8719F90BD885137A_OFFSET UNITYSDK_OFFSET(0xDC48B60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0xDC44E70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_97889423B3D78768_OFFSET UNITYSDK_OFFSET(0xDC473D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_AB1A253BFABC50A9_OFFSET UNITYSDK_OFFSET(0xDC48820)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0xDC438A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_D2967792C8AA78E6_OFFSET UNITYSDK_OFFSET(0xDC479A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_DA8915F72DE34BAE_OFFSET UNITYSDK_OFFSET(0xDC43530)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_F63565EA57F495CC_OFFSET UNITYSDK_OFFSET(0xDC44380)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_FCFC6D239F675EAB_OFFSET UNITYSDK_OFFSET(0xDC45B30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0xDC46D50)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PICKUPSTONE_OFFSET UNITYSDK_OFFSET(0xDC41EE0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLACESTONE_OFFSET UNITYSDK_OFFSET(0xDC41D10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYEREFFECTATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xDC48AC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYSTONEMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xDC463C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xDC442B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xDC48A70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xDC48A90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xDC48AB0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xDC431C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SWAPSTONE_OFFSET UNITYSDK_OFFSET(0xDC420A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xDC47510)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xDC485C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONEFADEOUT_OFFSET UNITYSDK_OFFSET(0xDC48270)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONELINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xDC483F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xDC492F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xDC48F90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___SWITCHPLAYEREFFECT_B__39_0_OFFSET UNITYSDK_OFFSET(0xDC49340)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard_TypeDefinitionIndex = 78058;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x64620);
		}
		static ::System::Int32* StaticGet_FGPHAJJDGOG()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x147E0);
		}
