...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGELINERENDEREMISSION_OFFSET UNITYSDK_OFFSET(0xC53CFF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0xC539CC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC5396B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETANSWERBASEPOINTPROPIDLIST_OFFSET UNITYSDK_OFFSET(0xC5375A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETBASEPOINT_OFFSET UNITYSDK_OFFSET(0xC53B200)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETSTONE_OFFSET UNITYSDK_OFFSET(0xC53B2B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xC53DA60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xC53DA80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYERHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xC537300)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYINGSTONEMOVEANIM_OFFSET UNITYSDK_OFFSET(0xC53B370)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xC53DAA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GIVEBACKHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0xC53C170)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC5378B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC539C70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xC53D100)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xC53B670)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_1AB9D4E0D4B0F708_OFFSET UNITYSDK_OFFSET(0xC53CB90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0xC539770)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0xC53C340)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_2CD6D17D088D5DB9_OFFSET UNITYSDK_OFFSET(0xC538BE0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_30C43A604CECBEA3_OFFSET UNITYSDK_OFFSET(0xC53A820)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0xC53DED0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0xC538240)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3D18881BFBA2A416_OFFSET UNITYSDK_OFFSET(0xC53DA30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0xC53AC80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_4F60CBE29BD2AB9A_OFFSET UNITYSDK_OFFSET(0xC53C5B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_740A14CA31FF6391_OFFSET UNITYSDK_OFFSET(0xC539DC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8719F90BD885137A_OFFSET UNITYSDK_OFFSET(0xC53DB60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0xC539E90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_97889423B3D78768_OFFSET UNITYSDK_OFFSET(0xC53C3D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_AB1A253BFABC50A9_OFFSET UNITYSDK_OFFSET(0xC53D820)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0xC5388C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_D2967792C8AA78E6_OFFSET UNITYSDK_OFFSET(0xC53C9A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_DA8915F72DE34BAE_OFFSET UNITYSDK_OFFSET(0xC538550)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_F63565EA57F495CC_OFFSET UNITYSDK_OFFSET(0xC5393A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_FCFC6D239F675EAB_OFFSET UNITYSDK_OFFSET(0xC53AB40)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0xC53BD50)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PICKUPSTONE_OFFSET UNITYSDK_OFFSET(0xC536F00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLACESTONE_OFFSET UNITYSDK_OFFSET(0xC536D30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYEREFFECTATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xC53DAC0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYSTONEMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xC53B3D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC5392D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0xC53DA70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xC53DA90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0xC53DAB0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xC5381E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SWAPSTONE_OFFSET UNITYSDK_OFFSET(0xC5370C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xC53C510)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xC53D5C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONEFADEOUT_OFFSET UNITYSDK_OFFSET(0xC53D270)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONELINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xC53D3F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xC53E2E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC53DF90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC53E410)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC53E340)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC53E420)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC53E3B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xC53E350)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xC53E4B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___SWITCHPLAYEREFFECT_B__39_0_OFFSET UNITYSDK_OFFSET(0xC53E330)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard_TypeDefinitionIndex = 73047;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x15830);
		}
		static ::System::Int32* StaticGet_Field_6_1()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7DD0);
		}
		...
		::System::Void Method_6_30C43A604CECBEA3(::System::Boolean a1, ::System::Single a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_30C43A604CECBEA3_OFFSET))(this, a1, a2);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, a1, a2, a3);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET))(this, a1);
		}
	};
}
