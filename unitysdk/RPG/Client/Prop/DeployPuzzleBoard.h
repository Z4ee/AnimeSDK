...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGELINERENDEREMISSION_OFFSET UNITYSDK_OFFSET(0x1A904D90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x1A901A60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A901450)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETANSWERBASEPOINTPROPIDLIST_OFFSET UNITYSDK_OFFSET(0x1A8FF340)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETBASEPOINT_OFFSET UNITYSDK_OFFSET(0x1A902FA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GETSTONE_OFFSET UNITYSDK_OFFSET(0x1A903050)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0x1A905800)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0x1A905820)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYERHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0x1A8FF0A0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_ISPLAYINGSTONEMOVEANIM_OFFSET UNITYSDK_OFFSET(0x1A903110)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0x1A905840)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_GIVEBACKHOLDINGSTONE_OFFSET UNITYSDK_OFFSET(0x1A903F10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A8FF650)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x1A901A10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0x1A904EA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x1A903410)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_1AB9D4E0D4B0F708_OFFSET UNITYSDK_OFFSET(0x1A904930)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_229CEF33F0AF9039_OFFSET UNITYSDK_OFFSET(0x1A901510)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_292F9610D63D1947_OFFSET UNITYSDK_OFFSET(0x1A9040E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_2CD6D17D088D5DB9_OFFSET UNITYSDK_OFFSET(0x1A900980)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0x1A905C70)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x1A8FFFE0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_3D18881BFBA2A416_OFFSET UNITYSDK_OFFSET(0x1A9057D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_489E0B827662C211_OFFSET UNITYSDK_OFFSET(0x1A902A20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_4F60CBE29BD2AB9A_OFFSET UNITYSDK_OFFSET(0x1A904350)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_5C894234121A7CB4_OFFSET UNITYSDK_OFFSET(0x1A9025C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_740A14CA31FF6391_OFFSET UNITYSDK_OFFSET(0x1A901B60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8719F90BD885137A_OFFSET UNITYSDK_OFFSET(0x1A905900)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_8DC652D916C182B2_OFFSET UNITYSDK_OFFSET(0x1A901C30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_97889423B3D78768_OFFSET UNITYSDK_OFFSET(0x1A904170)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_AB1A253BFABC50A9_OFFSET UNITYSDK_OFFSET(0x1A9055C0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x1A900660)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_D2967792C8AA78E6_OFFSET UNITYSDK_OFFSET(0x1A904740)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_DA8915F72DE34BAE_OFFSET UNITYSDK_OFFSET(0x1A9002F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_F63565EA57F495CC_OFFSET UNITYSDK_OFFSET(0x1A901140)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_METHOD_6_FCFC6D239F675EAB_OFFSET UNITYSDK_OFFSET(0x1A9028E0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0x1A903AF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PICKUPSTONE_OFFSET UNITYSDK_OFFSET(0x1A8FECA0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLACESTONE_OFFSET UNITYSDK_OFFSET(0x1A8FEAD0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYEREFFECTATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x1A905860)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_PLAYSTONEMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0x1A903170)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A901070)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTHOLDSTONEPROPID_OFFSET UNITYSDK_OFFSET(0x1A905810)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_CURRENTPICKUPBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0x1A905830)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SET_PUZZLESOLVED_OFFSET UNITYSDK_OFFSET(0x1A905850)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A8FFF80)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_SWAPSTONE_OFFSET UNITYSDK_OFFSET(0x1A8FEE60)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A9042B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0x1A905360)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONEFADEOUT_OFFSET UNITYSDK_OFFSET(0x1A905010)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD_TRIGGERSTONELINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0x1A905190)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A906090)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A905D30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___SWITCHPLAYEREFFECT_B__39_0_OFFSET UNITYSDK_OFFSET(0x1A9060E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard_TypeDefinitionIndex = 78057;

	class DeployPuzzleBoard : public ::RPG::Client::Prop::PuzzleBoardBase
	{
	public:
		static ::System::String** StaticGet_DAIANGHGOLL()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x629B0);
		}
		static ::System::Int32* StaticGet_FGPHAJJDGOG()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DeployPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x143F0);
		}
		...
		::UnityEngine::Transform* FFJJFHKHAGO; // 0xD0
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::Prop::DeployPuzzleStone*>* HGPPLINHPMA; // 0xD8
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::Client::Prop::DeployPuzzleBasePoint*>* BasePointDatas; // 0xE0
		::System::Collections::Generic::List_1<::Class_1_8CF94E0F14A91ED3_4*>* EKIMGDAIDFC; // 0xE8
		::RPG::Client::Prop::DeployPuzzleHint* GANMIDIBHJD; // 0xF0
		::System::Collections::Generic::List_1<::UnityEngine::LineRenderer*>* NEBOHGCDMJM; // 0xF8
		::RPG::GameCore::DeployBoardState JJBOPOPCOCH; // 0x100
		::System::Collections::Generic::Queue_1<::Class_1_AA6FF9C9B64B58C9*>* JJBBCLAFCJP; // 0x108
		::System::Collections::Generic::List_1<::System::Single>* JIBHPJNMNNI; // 0x110
		::System::Boolean KOIBFKMANPG; // 0x118
		::RPG::Client::MonoEffect* DPKPBPDIOKO; // 0x120
		::System::Boolean FMLPNLBGCDJ; // 0x128
		::System::Collections::Generic::List_1<::Class_1_E84B715B4BB2E65F*>* BPFKMMLBFCN; // 0x130
		::System::Collections::Generic::List_1<::Class_1_DD6E273E77666B37*>* OPAJCMDPKNI; // 0x138
		::System::Int32 IFEPJHGNCOI; // 0x140
		::System::Int32 JCLIFKACIJD; // 0x144
		::System::Int32 EDMKJDNECNE; // 0x148
		::RPG::Client::RuntimeGroupManager* KDCJFIMPKLP; // 0x150
