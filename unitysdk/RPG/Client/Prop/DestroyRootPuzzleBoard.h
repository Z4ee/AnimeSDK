...
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ACTIVELAUNCHER_OFFSET UNITYSDK_OFFSET(0xC541B70)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xC540AB0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC540AF0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC53F270)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC541380)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ISREFACTORAIMOTHER_OFFSET UNITYSDK_OFFSET(0xC541D80)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_010173A32C39341F_OFFSET UNITYSDK_OFFSET(0xC5417C0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0xC540640)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0xC542030)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_308ABEB3EBCF889F_OFFSET UNITYSDK_OFFSET(0xC540030)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xC5411C0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_652F3820D8B242FF_OFFSET UNITYSDK_OFFSET(0xC53F9E0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_E374F6C9CEE8E680_OFFSET UNITYSDK_OFFSET(0xC541CF0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_METHOD_6_EB7282B6745B4611_OFFSET UNITYSDK_OFFSET(0xC540CC0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_MOVECHESS_OFFSET UNITYSDK_OFFSET(0xC541620)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ONCHESSACTIONEND_OFFSET UNITYSDK_OFFSET(0xC541DE0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC540F80)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_ROTATECHESS_OFFSET UNITYSDK_OFFSET(0xC541AA0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_SETCHESSFINISHSTATE_OFFSET UNITYSDK_OFFSET(0xC541E40)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xC5413D0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xC542280)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC5420B0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xC542340)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC5423A0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC542330)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC542410)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC5423B0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xC5424A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DestroyRootPuzzleBoard_TypeDefinitionIndex = 73061;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DestroyRootPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7E10);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, a1, a2, a3);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DESTROYROOTPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET))(this, a1);
		}
	};
}
