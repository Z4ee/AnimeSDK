...
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_DEACTIVATEINDELAY_OFFSET UNITYSDK_OFFSET(0xC5CF8D0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC5D0F40)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_GET_HASSTEPPED_OFFSET UNITYSDK_OFFSET(0xC5D12D0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_INITSTATE_OFFSET UNITYSDK_OFFSET(0xC5D07D0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_METHOD_5_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0xC5D1040)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0xC5CFCF0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0xC5D09A0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0xC5D08B0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_SET_HASSTEPPED_OFFSET UNITYSDK_OFFSET(0xC5D12E0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE_TRIGGERSOUND_OFFSET UNITYSDK_OFFSET(0xC5D10C0)
#define RPG_CLIENT_PROP_PADSPUZZLEPADBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC5D07B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzlePadBase_TypeDefinitionIndex = 73275;
