...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0xA148410)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0xA1480B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA147F20)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GETLOOKATVECTOR_OFFSET UNITYSDK_OFFSET(0xA147DB0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GETXAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA147CE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GET_AXISXVALUE_OFFSET UNITYSDK_OFFSET(0xA147F80)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA147630)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_LOCKCAMERACONTROL_OFFSET UNITYSDK_OFFSET(0xA1485C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_METHOD_5_953DD38710057F4B_OFFSET UNITYSDK_OFFSET(0xA147C50)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA1475E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xA148050)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_SETXAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA147D40)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_SET_AXISXVALUE_OFFSET UNITYSDK_OFFSET(0xA147FE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_UNLOCKCAMERACONTROL_OFFSET UNITYSDK_OFFSET(0xA148680)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA148750)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCameraController_TypeDefinitionIndex = 64272;
