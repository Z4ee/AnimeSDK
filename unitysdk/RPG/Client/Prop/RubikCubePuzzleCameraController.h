...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0x14F52D80)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0x14F52A30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0x14F528A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GETLOOKATVECTOR_OFFSET UNITYSDK_OFFSET(0x14F52730)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GETXAXISVALUE_OFFSET UNITYSDK_OFFSET(0x14F52660)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_GET_AXISXVALUE_OFFSET UNITYSDK_OFFSET(0x14F52900)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x14F51E80)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_LOCKCAMERACONTROL_OFFSET UNITYSDK_OFFSET(0x14F52F30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_METHOD_5_953DD38710057F4B_OFFSET UNITYSDK_OFFSET(0x14F525D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x14F51E30)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0x14F529D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_SETXAXISVALUE_OFFSET UNITYSDK_OFFSET(0x14F526C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_SET_AXISXVALUE_OFFSET UNITYSDK_OFFSET(0x14F52960)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER_UNLOCKCAMERACONTROL_OFFSET UNITYSDK_OFFSET(0x14F52FF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x14F530C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCameraController_TypeDefinitionIndex = 74866;
