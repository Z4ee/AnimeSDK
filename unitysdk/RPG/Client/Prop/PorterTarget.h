...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x166375B0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_62593EE2FE331D20_OFFSET UNITYSDK_OFFSET(0x16637600)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_729AA4D1DEC0970C_OFFSET UNITYSDK_OFFSET(0x16636910)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_95AA3C6CB470ECEA_OFFSET UNITYSDK_OFFSET(0x16636190)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16636E70)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_EDE104A2956E181A_OFFSET UNITYSDK_OFFSET(0x166360D0)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x166376A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 78303;
