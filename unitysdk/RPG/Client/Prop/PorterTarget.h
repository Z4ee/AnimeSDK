...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_00C5E99C9B0EC08D_OFFSET UNITYSDK_OFFSET(0xA126360)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA127910)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_514DADE30A6B3A71_OFFSET UNITYSDK_OFFSET(0xA126170)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_6E896AACE3F012D5_OFFSET UNITYSDK_OFFSET(0xA126B20)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA1270E0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_ED65AE7582736594_OFFSET UNITYSDK_OFFSET(0xA127960)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xA127A00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 64224;
