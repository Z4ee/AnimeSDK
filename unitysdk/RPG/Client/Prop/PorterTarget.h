...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC5EE3E0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_514DADE30A6B3A71_OFFSET UNITYSDK_OFFSET(0xC5ECD60)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_729AA4D1DEC0970C_OFFSET UNITYSDK_OFFSET(0xC5ED670)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_8706B4640D53FE36_OFFSET UNITYSDK_OFFSET(0xC5EE430)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_95AA3C6CB470ECEA_OFFSET UNITYSDK_OFFSET(0xC5ECF30)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC5EDBD0)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xC5EE4D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 73293;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_8706B4640D53FE36_OFFSET))(this);
		}
	};
}
