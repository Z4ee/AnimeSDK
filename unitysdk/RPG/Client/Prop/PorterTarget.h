...
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x14F30F40)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_62593EE2FE331D20_OFFSET UNITYSDK_OFFSET(0x14F30F90)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_729AA4D1DEC0970C_OFFSET UNITYSDK_OFFSET(0x14F302B0)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_95AA3C6CB470ECEA_OFFSET UNITYSDK_OFFSET(0x14F2FB30)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x14F30810)
#define RPG_CLIENT_PROP_PORTERTARGET_METHOD_1_EDE104A2956E181A_OFFSET UNITYSDK_OFFSET(0x14F2FA70)
#define RPG_CLIENT_PROP_PORTERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x14F31030)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterTarget_TypeDefinitionIndex = 74818;
