...
#define RPG_CLIENT_PROP_CHIMERADUELJUMPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDC159B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelJumpText_TypeDefinitionIndex = 77802;
	...
	public:
		...
		::System::Int32 InitialValue; // 0x18
