...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLELIGHT_INITLIGHT_OFFSET UNITYSDK_OFFSET(0xA1629B0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLELIGHT_SETSELECTEDNUMBER_OFFSET UNITYSDK_OFFSET(0xA162AB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0xA162BC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleLight_TypeDefinitionIndex = 64322;
