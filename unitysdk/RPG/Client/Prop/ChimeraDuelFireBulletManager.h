...
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_FIREBULLET_OFFSET UNITYSDK_OFFSET(0xADC6DE0)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xADC5B80)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_METHOD_5_99382C0940D13276_OFFSET UNITYSDK_OFFSET(0xADC6FC0)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xADC6DA0)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xADC6D60)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_METHOD_5_F67E13B59A5D6477_OFFSET UNITYSDK_OFFSET(0xADC7560)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xADC5D20)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_START_OFFSET UNITYSDK_OFFSET(0xADC5AD0)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0xADC6580)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER_UNINIT_OFFSET UNITYSDK_OFFSET(0xADC63E0)
#define RPG_CLIENT_PROP_CHIMERADUELFIREBULLETMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xADC7780)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelFireBulletManager_TypeDefinitionIndex = 71795;
