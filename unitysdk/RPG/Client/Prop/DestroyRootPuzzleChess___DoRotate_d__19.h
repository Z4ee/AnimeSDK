...
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOROTATE_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xC5451D0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOROTATE_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC5454A0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOROTATE_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xC545500)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOROTATE_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xC5454B0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOROTATE_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC5451C0)
#define RPG_CLIENT_PROP_DESTROYROOTPUZZLECHESS___DOROTATE_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0xC544650)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DestroyRootPuzzleChess___DoRotate_d__19_TypeDefinitionIndex = 73066;
