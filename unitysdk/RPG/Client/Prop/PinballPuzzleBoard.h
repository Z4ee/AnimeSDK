...
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANACTIVEPLATE_OFFSET UNITYSDK_OFFSET(0x1662F460)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0x1662AF60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1662A050)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ENDPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x16632EB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GETPINBALLITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x1662C490)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_CURRENTSELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0x16627AF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_OWNERTRANS_OFFSET UNITYSDK_OFFSET(0x16634840)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PINBALLITEMS_DEBUG_OFFSET UNITYSDK_OFFSET(0x16634850)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PLATEREMAINCOUNT_OFFSET UNITYSDK_OFFSET(0x16634860)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0x16629BE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPINBALL_OFFSET UNITYSDK_OFFSET(0x16629330)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x166292A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x1662AFA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0x1662B2C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LAUNCH_OFFSET UNITYSDK_OFFSET(0x16631560)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_0076C796B2045359_OFFSET UNITYSDK_OFFSET(0x1662E570)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_0120539054A2AC4D_OFFSET UNITYSDK_OFFSET(0x1662A5C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0x1662FA80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0x1662FB10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2083A1568CE00304_OFFSET UNITYSDK_OFFSET(0x16632B00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_227FF8FF03B4EC11_OFFSET UNITYSDK_OFFSET(0x1662D960)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2AF6663D58564F35_OFFSET UNITYSDK_OFFSET(0x1662BBA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_378D17F5AC4A22EE_OFFSET UNITYSDK_OFFSET(0x1662F4B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_3809AF1D89D86A94_OFFSET UNITYSDK_OFFSET(0x1662CF80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_43A478BA01FE29B7_OFFSET UNITYSDK_OFFSET(0x1662D8F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_464B80C09A37526F_OFFSET UNITYSDK_OFFSET(0x1662DED0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x1662E500)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_51BBA01F511E6107_OFFSET UNITYSDK_OFFSET(0x16633E20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_1_OFFSET UNITYSDK_OFFSET(0x16633BA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_2_OFFSET UNITYSDK_OFFSET(0x16634230)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0x16633B40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_601EF3E7226D7DC2_OFFSET UNITYSDK_OFFSET(0x16633F40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_6C1C98B7B5F38CA0_OFFSET UNITYSDK_OFFSET(0x1662FE20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_7CE4CE3EBCB70547_OFFSET UNITYSDK_OFFSET(0x1662F8E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_7F6685FB6B418CB3_OFFSET UNITYSDK_OFFSET(0x1662DE20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_81FEFD1B22CE37A2_OFFSET UNITYSDK_OFFSET(0x166300C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x16631360)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_8AEE3C4E6BD69BAB_OFFSET UNITYSDK_OFFSET(0x1662C1C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1662FE70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_98BACA2FF165A70D_OFFSET UNITYSDK_OFFSET(0x1662B270)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9CD607631367DD7F_OFFSET UNITYSDK_OFFSET(0x16631D60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9F218BA7C451254A_OFFSET UNITYSDK_OFFSET(0x16633C00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x1662AE90)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A27DC2C5A103933A_OFFSET UNITYSDK_OFFSET(0x1662AAF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A88E33775C007389_OFFSET UNITYSDK_OFFSET(0x16628CA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x1662E810)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0x16629F20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B398A0CD4E90F689_1_OFFSET UNITYSDK_OFFSET(0x16631EE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B398A0CD4E90F689_OFFSET UNITYSDK_OFFSET(0x16631C60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B3F1A3A8F66EAE32_OFFSET UNITYSDK_OFFSET(0x1662B8C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x1662AC70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_BF1183757C521F0F_OFFSET UNITYSDK_OFFSET(0x16633AA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x1662FEF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16630080)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CAEE376DC5422269_OFFSET UNITYSDK_OFFSET(0x166315B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CFB00179EC6A3756_OFFSET UNITYSDK_OFFSET(0x16633770)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D09831639F615812_OFFSET UNITYSDK_OFFSET(0x16628B70)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D2594BF9DC46F655_OFFSET UNITYSDK_OFFSET(0x16630550)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D3855D86A1D70EA9_OFFSET UNITYSDK_OFFSET(0x16631FE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D41059BB825399DF_OFFSET UNITYSDK_OFFSET(0x1662C6D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_DE62129A329C6551_OFFSET UNITYSDK_OFFSET(0x16633600)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x1662F5B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_EE83221383696989_OFFSET UNITYSDK_OFFSET(0x166305F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x16631C10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F81C848FE9ED44F9_OFFSET UNITYSDK_OFFSET(0x16633940)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F86E3F6E3E2B1642_OFFSET UNITYSDK_OFFSET(0x16633870)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0x166329C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONINTERACTSTATION_OFFSET UNITYSDK_OFFSET(0x1662C510)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTEND_OFFSET UNITYSDK_OFFSET(0x1662B210)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTSTART_OFFSET UNITYSDK_OFFSET(0x1662F300)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEACTIVE_OFFSET UNITYSDK_OFFSET(0x1662F340)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1662F3D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLCONFIGPOSTOMATRIXPOS_OFFSET UNITYSDK_OFFSET(0x1662C430)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLDEBUG_SELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0x16628540)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_REPORTINTERACTPLATE_OFFSET UNITYSDK_OFFSET(0x16634290)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x1662AFE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x1662D0A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPLAYERCONTROLMODE_OFFSET UNITYSDK_OFFSET(0x1662D140)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_SWITCHCURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x1662C680)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x1662B4C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x16634870)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PinballPuzzleBoard_TypeDefinitionIndex = 78296;
