...
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANACTIVEPLATE_OFFSET UNITYSDK_OFFSET(0xAE9FF40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xAE9C090)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAE9B270)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ENDPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xAEA34C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GETPINBALLITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0xAE9D400)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_CURRENTSELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0xAE992B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_OWNERTRANS_OFFSET UNITYSDK_OFFSET(0xAEA4DF0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PINBALLITEMS_DEBUG_OFFSET UNITYSDK_OFFSET(0xAEA4E00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_GET_PLATEREMAINCOUNT_OFFSET UNITYSDK_OFFSET(0xAEA4E10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xAE9AE60)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPINBALL_OFFSET UNITYSDK_OFFSET(0xAE9A760)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE9A6D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAE9C0D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE9C330)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_LAUNCH_OFFSET UNITYSDK_OFFSET(0xAEA1D50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_01F8C9B8FEC4A2CF_OFFSET UNITYSDK_OFFSET(0xAEA3C10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_070546811DD6F16C_OFFSET UNITYSDK_OFFSET(0xAEA4010)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_08C689627757D0F9_OFFSET UNITYSDK_OFFSET(0xAEA3D10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_102A1038C38883F3_OFFSET UNITYSDK_OFFSET(0xAEA0470)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1676349FAEF4B05E_OFFSET UNITYSDK_OFFSET(0xAEA1DA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_18982EFD3B740683_OFFSET UNITYSDK_OFFSET(0xAE9F160)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1AD3CAF2B0982C3F_OFFSET UNITYSDK_OFFSET(0xAEA0AC0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_1CFEF2C87EA4995A_OFFSET UNITYSDK_OFFSET(0xAE9D680)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_2083A1568CE00304_OFFSET UNITYSDK_OFFSET(0xAEA3100)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_228E3444D290BEE7_OFFSET UNITYSDK_OFFSET(0xAEA1B40)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_24B05D2E15A5C3C8_OFFSET UNITYSDK_OFFSET(0xAE9EAB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_280628713361E10F_OFFSET UNITYSDK_OFFSET(0xAEA0EC0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0xAEA0500)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_3972738626E6BB6F_OFFSET UNITYSDK_OFFSET(0xAE9CB10)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_41782CE468D1B24D_OFFSET UNITYSDK_OFFSET(0xAEA41C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_5152ABC5D08CE614_OFFSET UNITYSDK_OFFSET(0xAE9A260)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_529341EF7E8B39BE_OFFSET UNITYSDK_OFFSET(0xAEA02D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_1_OFFSET UNITYSDK_OFFSET(0xAEA4160)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_2_OFFSET UNITYSDK_OFFSET(0xAEA47E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_540DB5DAE524BF3C_OFFSET UNITYSDK_OFFSET(0xAEA4100)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_5FB066975C67F812_OFFSET UNITYSDK_OFFSET(0xAE9E6E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_601EF3E7226D7DC2_OFFSET UNITYSDK_OFFSET(0xAEA4500)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0xAEA2380)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0xAE9BC50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_74EB46AAC179C832_OFFSET UNITYSDK_OFFSET(0xAE9B730)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_78E88B7CB3CC1E2A_OFFSET UNITYSDK_OFFSET(0xAEA24A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_825CC99DD653DEE0_OFFSET UNITYSDK_OFFSET(0xAE9F3B0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_8AEE3C4E6BD69BAB_OFFSET UNITYSDK_OFFSET(0xAE9D130)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9547E82748FE6C69_OFFSET UNITYSDK_OFFSET(0xAEA0820)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xAEA0870)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_96A53A17AC5D0E93_OFFSET UNITYSDK_OFFSET(0xAE9F0F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xAE9BFC0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_A3CD8010EE7E2C0B_OFFSET UNITYSDK_OFFSET(0xAEA3E20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_1_OFFSET UNITYSDK_OFFSET(0xAEA0040)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xAE9B140)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_B3F1A3A8F66EAE32_OFFSET UNITYSDK_OFFSET(0xAE9C830)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_BA410EA09457B5C1_OFFSET UNITYSDK_OFFSET(0xAE9C2E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C2D94B542F8BDBB0_OFFSET UNITYSDK_OFFSET(0xAE9FF90)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xAEA08F0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C8F93DC0DF0652A4_1_OFFSET UNITYSDK_OFFSET(0xAEA2600)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C8F93DC0DF0652A4_OFFSET UNITYSDK_OFFSET(0xAEA23D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_C9748511121817AE_OFFSET UNITYSDK_OFFSET(0xAE9EA00)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0xAE9E670)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xAEA0A80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_CB613A5EF970C11B_OFFSET UNITYSDK_OFFSET(0xAE9A130)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D2594BF9DC46F655_OFFSET UNITYSDK_OFFSET(0xAEA0E20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_D6288EFA98A301E9_OFFSET UNITYSDK_OFFSET(0xAE9DE80)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_E658B2206C1568CD_OFFSET UNITYSDK_OFFSET(0xAEA26D0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xAEA43E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xAE9BDD0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_F81C848FE9ED44F9_OFFSET UNITYSDK_OFFSET(0xAEA3E90)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_METHOD_6_FD7514C64FB1B043_OFFSET UNITYSDK_OFFSET(0xAEA2FC0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONINTERACTSTATION_OFFSET UNITYSDK_OFFSET(0xAE9D490)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTEND_OFFSET UNITYSDK_OFFSET(0xAE9C280)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPINBALLITEMINTERACTSTART_OFFSET UNITYSDK_OFFSET(0xAE9FDE0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEACTIVE_OFFSET UNITYSDK_OFFSET(0xAE9FE20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_ONPLATEDEACTIVE_OFFSET UNITYSDK_OFFSET(0xAE9FEB0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLCONFIGPOSTOMATRIXPOS_OFFSET UNITYSDK_OFFSET(0xAE9D3A0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_PINBALLDEBUG_SELECTPINBALLITEM_OFFSET UNITYSDK_OFFSET(0xAE99B50)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_REPORTINTERACTPLATE_OFFSET UNITYSDK_OFFSET(0xAEA4840)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE9C110)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPINBALLCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xAE9DFA0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_STARTPLAYERCONTROLMODE_OFFSET UNITYSDK_OFFSET(0xAE9E050)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_SWITCHCURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0xAE9D630)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE9C4C0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xAEA4E20)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xAEA5330)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAEA5320)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xAEA5310)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAEA5370)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xAEA5420)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xAEA53E0)
#define RPG_CLIENT_PROP_PINBALLPUZZLEBOARD___IFIXBASEPROXY_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xAEA5480)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PinballPuzzleBoard_TypeDefinitionIndex = 72264;
