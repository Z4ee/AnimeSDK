...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xC58D960)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC58DA00)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC58C6F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_8131D4D8C02BAA62_OFFSET UNITYSDK_OFFSET(0xC58DB60)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_82C6003DE55F189A_OFFSET UNITYSDK_OFFSET(0xC58D9A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xC58E6D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC58D920)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_ROTATECUBE_OFFSET UNITYSDK_OFFSET(0xC58DD40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_SELECTCUBEGROUP_OFFSET UNITYSDK_OFFSET(0xC58E1A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xC58D8E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xC58E960)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC58EBE0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xC58EDF0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC58ED20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xC58ED90)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xC58ED30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleBoard_TypeDefinitionIndex = 73197;
	...
	public:
		...
		::System::Void Method_6_82C6003DE55F189A(::RPG::Client::Prop::LightRubikCubePuzzleCube* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::Prop::LightRubikCubePuzzleCube*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_82C6003DE55F189A_OFFSET))(this, a1);
		}

		::System::Void Method_6_8131D4D8C02BAA62()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_8131D4D8C02BAA62_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, a1, a2, a3);
		}
