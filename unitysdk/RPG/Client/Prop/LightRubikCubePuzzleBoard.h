...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xAE468C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xAE46960)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE454E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_BE7B5626303AAB02_OFFSET UNITYSDK_OFFSET(0xAE46900)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_METHOD_6_D70C8B847AF08ADE_OFFSET UNITYSDK_OFFSET(0xAE46AD0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xAE47ED0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE46880)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_ROTATECUBE_OFFSET UNITYSDK_OFFSET(0xAE46CC0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_SELECTCUBEGROUP_OFFSET UNITYSDK_OFFSET(0xAE479A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE46840)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xAE48160)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xAE483E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xAE485F0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE48520)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE48590)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xAE48530)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleBoard_TypeDefinitionIndex = 72175;
