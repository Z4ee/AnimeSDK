...
#define RPG_CLIENT_PROP_TELEPORTGATESWITCH_INITSWITCH_OFFSET UNITYSDK_OFFSET(0xAEEF920)
#define RPG_CLIENT_PROP_TELEPORTGATESWITCH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAEEFB30)
#define RPG_CLIENT_PROP_TELEPORTGATESWITCH_ONUSESWITCH_OFFSET UNITYSDK_OFFSET(0xAEEFBC0)
#define RPG_CLIENT_PROP_TELEPORTGATESWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0xAEEFC00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int TeleportGateSwitch_TypeDefinitionIndex = 72401;
	...
	public:
		...
		::RPG::Client::Prop::TeleportGatePuzzleBoard* Field_5_1; // 0x20
		::RPG::GameCore::PropComponent* Field_5_2; // 0x28
		::Class_2_2679F01039F3FC24* Field_5_3; // 0x30
