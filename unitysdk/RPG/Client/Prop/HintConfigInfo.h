...
#define RPG_CLIENT_PROP_HINTCONFIGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xDC6F230)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int HintConfigInfo_TypeDefinitionIndex = 78052;
