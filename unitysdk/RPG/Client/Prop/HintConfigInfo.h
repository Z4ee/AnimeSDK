...
#define RPG_CLIENT_PROP_HINTCONFIGINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA0A0080)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int HintConfigInfo_TypeDefinitionIndex = 63972;
