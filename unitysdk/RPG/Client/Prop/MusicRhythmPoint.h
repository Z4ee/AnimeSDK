...
#define RPG_CLIENT_PROP_MUSICRHYTHMPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1484F280)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int MusicRhythmPoint_TypeDefinitionIndex = 74224;
