...
#define RPG_CLIENT_PROP_MUSICRHYTHMPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x16129CB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int MusicRhythmPoint_TypeDefinitionIndex = 77708;
