...
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_BINDDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A8E4700)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_GET__DRAGHANDLERELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8E4330)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SETCROSSSTALLDRAGAREALISTENER_OFFSET UNITYSDK_OFFSET(0x1A8E48F0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SETDRAGAREAS_OFFSET UNITYSDK_OFFSET(0x1A8E46B0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A8E4640)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_SIMULATEDRAGOVERSLOT_OFFSET UNITYSDK_OFFSET(0x1A8E4940)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT_UNBINDDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A8E4800)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E4450)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__MOVEINDRAGPLANE_OFFSET UNITYSDK_OFFSET(0x1A8E4B20)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__MOVEVIEW_OFFSET UNITYSDK_OFFSET(0x1A8E4D10)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPDRAGGEDCHIMERASLOT__ONDRAGEVENT_OFFSET UNITYSDK_OFFSET(0x1A8E4BF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelShopDraggedChimeraSlot_TypeDefinitionIndex = 77885;

	class ChimeraDuelShopDraggedChimeraSlot : public ::System::Object
	{
	public:
		::RPG::Client::Prop::ChimeraDuelShopTeamDragAreas* _DragAreas; // 0x10
		::RPG::Client::EventTriggerListener* _BoundEventTrigger; // 0x18
		::RPG::Client::Prop::ChimeraDuelShopDraggedChimeraSlotView* _View; // 0x20
		::RPG::Client::Prop::ChimeraDuelShopChimeraInstance* Instance; // 0x28
		::System::Action_1<::System::Boolean>* _InStallDragAreaListener; // 0x30
