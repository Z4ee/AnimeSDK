...
#define RPG_CLIENT_PROP_WORMCOMPASSBLOCKGRIDDATA_METHOD_1_7841B7A88F86B0EE_OFFSET UNITYSDK_OFFSET(0x17B32960)
#define RPG_CLIENT_PROP_WORMCOMPASSBLOCKGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B329F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassBlockGridData_TypeDefinitionIndex = 78452;
