...
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x14F09310)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__MOVETOTARGETPOSPERFORM_B__0_OFFSET UNITYSDK_OFFSET(0x14F09630)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__MOVETOTARGETPOSPERFORM_B__1_OFFSET UNITYSDK_OFFSET(0x14F09750)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM___C__DISPLAYCLASS16_0__MOVETOTARGETPOSPERFORM_B__2_OFFSET UNITYSDK_OFFSET(0x14F098B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleItem___c__DisplayClass16_0_TypeDefinitionIndex = 74776;

	class OraclePuzzleItem___c__DisplayClass16_0 : public ::System::Object
	{
	public:
		::System::Action* OnPerformDone; // 0x10
		::RPG::Client::Prop::OraclePuzzleItem* __4__this; // 0x18
