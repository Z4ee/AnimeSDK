...
#define RPG_CLIENT_PROP_CHASEBAILUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xADAB010)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChaseBailuConfig_TypeDefinitionIndex = 71716;
