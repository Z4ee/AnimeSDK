...
#define RPG_CLIENT_PROP_CHASEBAILUCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC4EEC80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChaseBailuConfig_TypeDefinitionIndex = 72738;
