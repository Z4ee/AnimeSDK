...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA15B140)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCubeData_TypeDefinitionIndex = 64280;
