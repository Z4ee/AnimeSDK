...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xDD2B400)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCubeData_TypeDefinitionIndex = 78360;
