...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAE42360)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GETINPUTLASERSLOT_OFFSET UNITYSDK_OFFSET(0xAE41E20)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xAE42D40)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GET_ISMAINROTATE_OFFSET UNITYSDK_OFFSET(0xAE42DB0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xAE42DA0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_GOBACKINIT_OFFSET UNITYSDK_OFFSET(0xAE40BF0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_HIDEOUTPUTLASER_OFFSET UNITYSDK_OFFSET(0xAE42430)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_INITRING_OFFSET UNITYSDK_OFFSET(0xAE3F910)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0xAE42D50)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_732EDB3121B072B2_OFFSET UNITYSDK_OFFSET(0xAE42AF0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_A82BC93906D19A8C_OFFSET UNITYSDK_OFFSET(0xAE425A0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_METHOD_5_DF4DF66B472E49E5_OFFSET UNITYSDK_OFFSET(0xAE42A40)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_REFRESHLIGHTSTATUS_OFFSET UNITYSDK_OFFSET(0xAE40800)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_REGISTERSWITCH_OFFSET UNITYSDK_OFFSET(0xAE423A0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_ROTATE_OFFSET UNITYSDK_OFFSET(0xAE40EC0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING_SELECT_OFFSET UNITYSDK_OFFSET(0xAE42660)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLERING__CTOR_OFFSET UNITYSDK_OFFSET(0xAE42DC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleRing_TypeDefinitionIndex = 72165;
