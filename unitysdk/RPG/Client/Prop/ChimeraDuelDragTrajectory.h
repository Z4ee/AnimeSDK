...
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_BINDDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x16E20120)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_SETDRAGFOLLOWER_OFFSET UNITYSDK_OFFSET(0x16E20060)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_SETDRAGREGION_OFFSET UNITYSDK_OFFSET(0x16E20010)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_SETHIGHLIGHTED_OFFSET UNITYSDK_OFFSET(0x16E1F0F0)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_SETPAUSELISTENINGDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x16E20310)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_SETSOURCE_OFFSET UNITYSDK_OFFSET(0x16E1F1D0)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_SETTARGET_OFFSET UNITYSDK_OFFSET(0x16E1F4D0)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY_UNBINDDRAGEVENTTRIGGER_OFFSET UNITYSDK_OFFSET(0x16E20220)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__CCTOR_OFFSET UNITYSDK_OFFSET(0x16E20400)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x16E203E0)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__ONDRAGEVENT_OFFSET UNITYSDK_OFFSET(0x16E20360)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__REFRESHSTATEVIEWOFCOLOR_OFFSET UNITYSDK_OFFSET(0x16E1EF80)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__REFRESHSTATEVIEWOFFOLLOWER_OFFSET UNITYSDK_OFFSET(0x16E1F070)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__REFRESHSTATEVIEW_OFFSET UNITYSDK_OFFSET(0x16E1EEE0)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__SETTARGETFORCURVE_OFFSET UNITYSDK_OFFSET(0x16E1F7B0)
#define RPG_CLIENT_PROP_CHIMERADUELDRAGTRAJECTORY__SETTARGETFORFOLLOWER_OFFSET UNITYSDK_OFFSET(0x16E1FF30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelDragTrajectory_TypeDefinitionIndex = 74381;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChimeraDuelDragTrajectory_TypeDefinitionIndex)->GetStaticField(0x145F0);
		}
