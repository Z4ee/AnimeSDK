...
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xAEDDB60)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0xAEDDA60)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xAEDDB20)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_4307B2A4B4A12C1A_1_OFFSET UNITYSDK_OFFSET(0xAEDDCE0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xAEDDBC0)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_8F7C3089F41CC993_OFFSET UNITYSDK_OFFSET(0xAEDD650)
#define RPG_CLIENT_PROP_SIGNITEM_METHOD_1_CD8EB704BDED69B6_OFFSET UNITYSDK_OFFSET(0xAEDD9A0)
#define RPG_CLIENT_PROP_SIGNITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAEDDE00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int SignItem_TypeDefinitionIndex = 72358;
