...
#define RPG_CLIENT_PROP_BLOCKSCREENHEXPUZZLE_METHOD_8_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0xAD943D0)
#define RPG_CLIENT_PROP_BLOCKSCREENHEXPUZZLE_METHOD_8_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0xAD942A0)
#define RPG_CLIENT_PROP_BLOCKSCREENHEXPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0xAD944B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockScreenHexPuzzle_TypeDefinitionIndex = 72097;
