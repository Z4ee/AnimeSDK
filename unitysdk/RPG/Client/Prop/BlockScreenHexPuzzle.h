...
#define RPG_CLIENT_PROP_BLOCKSCREENHEXPUZZLE_METHOD_8_E3DE31A03057E055_OFFSET UNITYSDK_OFFSET(0x16DEE4A0)
#define RPG_CLIENT_PROP_BLOCKSCREENHEXPUZZLE_METHOD_8_F0BD65B017F2AC0B_OFFSET UNITYSDK_OFFSET(0x16DEE370)
#define RPG_CLIENT_PROP_BLOCKSCREENHEXPUZZLE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEE580)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockScreenHexPuzzle_TypeDefinitionIndex = 74644;

	class BlockScreenHexPuzzle : public ::RPG::Client::Prop::HexPuzzleBoardBase
	{
	public:
		// static const ::System::Single Field_8_0; // 0x0
		::System::Boolean Field_8_1; // 0xE8
		::System::UInt32 Field_8_2; // 0xEC
