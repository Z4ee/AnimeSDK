...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEFRAGMENT_GETOUTPUTLASER_OFFSET UNITYSDK_OFFSET(0xAE41C60)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEFRAGMENT_INITFRAGMENT_OFFSET UNITYSDK_OFFSET(0xAE41300)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEFRAGMENT_ISFRAGMENTMATCH_OFFSET UNITYSDK_OFFSET(0xAE41560)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEFRAGMENT_SETFRAGMENTCOMPLETE_OFFSET UNITYSDK_OFFSET(0xAE418C0)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE41280)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleFragment_TypeDefinitionIndex = 72162;
