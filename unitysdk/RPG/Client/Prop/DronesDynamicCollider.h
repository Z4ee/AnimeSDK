...
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA081110)
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER_SWITCH_OFFSET UNITYSDK_OFFSET(0xA0811C0)
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xA081330)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesDynamicCollider_TypeDefinitionIndex = 64011;
