...
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19016770)
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER_SWITCH_OFFSET UNITYSDK_OFFSET(0x19016810)
#define RPG_CLIENT_PROP_DRONESDYNAMICCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19016970)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesDynamicCollider_TypeDefinitionIndex = 74605;
