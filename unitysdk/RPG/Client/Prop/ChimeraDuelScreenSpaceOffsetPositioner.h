...
#define RPG_CLIENT_PROP_CHIMERADUELSCREENSPACEOFFSETPOSITIONER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC51AD40)
#define RPG_CLIENT_PROP_CHIMERADUELSCREENSPACEOFFSETPOSITIONER_START_OFFSET UNITYSDK_OFFSET(0xC51ACD0)
#define RPG_CLIENT_PROP_CHIMERADUELSCREENSPACEOFFSETPOSITIONER__CTOR_OFFSET UNITYSDK_OFFSET(0xC51AF50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelScreenSpaceOffsetPositioner_TypeDefinitionIndex = 72855;
