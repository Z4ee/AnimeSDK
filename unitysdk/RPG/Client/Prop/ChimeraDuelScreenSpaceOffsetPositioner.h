...
#define RPG_CLIENT_PROP_CHIMERADUELSCREENSPACEOFFSETPOSITIONER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18FEC6D0)
#define RPG_CLIENT_PROP_CHIMERADUELSCREENSPACEOFFSETPOSITIONER_START_OFFSET UNITYSDK_OFFSET(0x18FEC660)
#define RPG_CLIENT_PROP_CHIMERADUELSCREENSPACEOFFSETPOSITIONER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEC8E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelScreenSpaceOffsetPositioner_TypeDefinitionIndex = 74380;
