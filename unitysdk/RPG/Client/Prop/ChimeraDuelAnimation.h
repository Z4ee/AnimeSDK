...
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x189DBE60)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_INIT_OFFSET UNITYSDK_OFFSET(0x189DBEB0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x189DC0A0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_PLAY_OFFSET UNITYSDK_OFFSET(0x189DC220)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_RPG_CLIENT_PROP_ICHIMERADUELTICKABLE_ONSTARTEDTICKING_OFFSET UNITYSDK_OFFSET(0x189DC4C0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_RPG_CLIENT_PROP_ICHIMERADUELTICKABLE_ONSTOPPEDTICKING_OFFSET UNITYSDK_OFFSET(0x189DC500)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_TICK_OFFSET UNITYSDK_OFFSET(0x189DC320)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION_UNINIT_OFFSET UNITYSDK_OFFSET(0x189DC0F0)
#define RPG_CLIENT_PROP_CHIMERADUELANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x189DC540)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelAnimation_TypeDefinitionIndex = 77824;
