...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x189BB200)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189BB850)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x189BB8B0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x189BB860)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189BB1F0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTINTERACT_D__5__CTOR_OFFSET UNITYSDK_OFFSET(0x189BA030)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItem__StartInteract_d__5_TypeDefinitionIndex = 78379;
