...
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xAEFD190)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAEFCC40)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xAEFCEB0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xAEFC460)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_1_OFFSET UNITYSDK_OFFSET(0xAEFD010)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_1B167429A8B82AD3_OFFSET UNITYSDK_OFFSET(0xAEFD080)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_28141171CE1C76E0_OFFSET UNITYSDK_OFFSET(0xAEFD4F0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_36726F9E10ADB55F_OFFSET UNITYSDK_OFFSET(0xAEFD570)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0xAEFD0F0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0xAEFDA20)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xAEFD8C0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xAEFCFA0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_1_OFFSET UNITYSDK_OFFSET(0xAEFD480)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0xAEFD280)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_FD1A8012013ED9C5_OFFSET UNITYSDK_OFFSET(0xAEFD2F0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ONWATERLEVELCHANGEEND_OFFSET UNITYSDK_OFFSET(0xAEFCD90)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_REFRESHCURRENTACTIVEINDEX_OFFSET UNITYSDK_OFFSET(0xAEFC7C0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xAEFCCC0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAEFDAE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelController_TypeDefinitionIndex = 72414;
