...
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x161268A0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x161263F0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x16126590)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x16125DD0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_28141171CE1C76E0_OFFSET UNITYSDK_OFFSET(0x16126BB0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0x16126690)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x16126750)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_4D2A473556700CDC_1_OFFSET UNITYSDK_OFFSET(0x16126EF0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x16126D90)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_7033EFB970A18315_OFFSET UNITYSDK_OFFSET(0x16126810)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_1_OFFSET UNITYSDK_OFFSET(0x16126B40)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_A1781348F0A89177_OFFSET UNITYSDK_OFFSET(0x16126930)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x16126C30)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_EDBE0DAF47EEEEED_OFFSET UNITYSDK_OFFSET(0x16126620)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_METHOD_5_FD1A8012013ED9C5_OFFSET UNITYSDK_OFFSET(0x161269A0)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_ONWATERLEVELCHANGEEND_OFFSET UNITYSDK_OFFSET(0x16126540)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_REFRESHCURRENTACTIVEINDEX_OFFSET UNITYSDK_OFFSET(0x16126110)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x16126470)
#define RPG_CLIENT_PROP_WATERLEVELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16126FB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelController_TypeDefinitionIndex = 74961;
