...
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA12ECA0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_ENTERCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xA12F6B0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_EXITCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xA12FD80)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_GETLOOKATVECTOR_OFFSET UNITYSDK_OFFSET(0xA12F540)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_GETXAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA12F400)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA12ED10)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_LOCKCAMERACONTROL_OFFSET UNITYSDK_OFFSET(0xA130120)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_METHOD_6_953DD38710057F4B_OFFSET UNITYSDK_OFFSET(0xA12F370)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_SETXAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA12F460)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_SETYAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA12F4D0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xA12EB70)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER_UNLOCKCAMERACONTROL_OFFSET UNITYSDK_OFFSET(0xA1301E0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA1302B0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA130320)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER___IFIXBASEPROXY_ENTERCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xA1303B0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER___IFIXBASEPROXY_EXITCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xA130430)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xA130370)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLER___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA1302C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PuzzleCameraController_TypeDefinitionIndex = 64343;
