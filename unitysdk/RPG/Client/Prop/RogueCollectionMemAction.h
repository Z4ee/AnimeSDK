...
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0xAEB19D0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xAEB1C60)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xAEB1B60)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAEB2440)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_49C02964BD29CEE0_OFFSET UNITYSDK_OFFSET(0xAEB1E60)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_89C03AF435ED2C78_OFFSET UNITYSDK_OFFSET(0xAEB1DD0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_8F537CE539CF0103_OFFSET UNITYSDK_OFFSET(0xAEB1CC0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_BD3078E21D74E44F_OFFSET UNITYSDK_OFFSET(0xAEB1A90)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_METHOD_5_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xAEB1800)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAEB1BC0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_START_OFFSET UNITYSDK_OFFSET(0xAEB1190)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xAEB1390)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONMEMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xAEB24C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueCollectionMemAction_TypeDefinitionIndex = 72444;
