...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xA050370)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA050440)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_GETCHIMERADUELGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA04FF00)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_LOADLINEUP_OFFSET UNITYSDK_OFFSET(0xA04F8F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0xA050CE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_36D9A2B328C51377_OFFSET UNITYSDK_OFFSET(0xA050B90)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_3A08FD6F6C9BA32C_OFFSET UNITYSDK_OFFSET(0xA050590)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA050290)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_D958BE5293B4CE71_OFFSET UNITYSDK_OFFSET(0xA0508E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA050E30)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA050E90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleEntranceView_TypeDefinitionIndex = 63826;
