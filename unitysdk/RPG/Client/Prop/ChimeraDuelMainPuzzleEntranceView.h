...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x16E2A1F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16E2A2C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_GETCHIMERADUELGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x16E29DA0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_LOADLINEUP_OFFSET UNITYSDK_OFFSET(0x16E29840)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0x16E2AB60)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_36D9A2B328C51377_OFFSET UNITYSDK_OFFSET(0x16E2AA10)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_3A08FD6F6C9BA32C_OFFSET UNITYSDK_OFFSET(0x16E2A400)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16E2A130)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_D958BE5293B4CE71_OFFSET UNITYSDK_OFFSET(0x16E2A760)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x16E2ACB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleEntranceView_TypeDefinitionIndex = 74420;
