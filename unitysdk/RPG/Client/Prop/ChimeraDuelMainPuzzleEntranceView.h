...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xADCFAF0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADCFBC0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_GETCHIMERADUELGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xADCF680)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_LOADLINEUP_OFFSET UNITYSDK_OFFSET(0xADCF070)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0xADD0460)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_36D9A2B328C51377_OFFSET UNITYSDK_OFFSET(0xADD0310)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_3A08FD6F6C9BA32C_OFFSET UNITYSDK_OFFSET(0xADCFD10)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xADCFA10)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW_METHOD_6_D958BE5293B4CE71_OFFSET UNITYSDK_OFFSET(0xADD0060)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xADD05D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEENTRANCEVIEW___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADD0630)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleEntranceView_TypeDefinitionIndex = 71873;
