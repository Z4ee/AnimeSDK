...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_GET_COLORSTATUS_OFFSET UNITYSDK_OFFSET(0xA1626C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_INITPILLARANDPEDESTAL_OFFSET UNITYSDK_OFFSET(0xA160760)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA162600)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xA1635E0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SETCOLORSTATUS_OFFSET UNITYSDK_OFFSET(0xA163CC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SET_COLORSTATUS_OFFSET UNITYSDK_OFFSET(0xA163D60)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL__CTOR_OFFSET UNITYSDK_OFFSET(0xA163DD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzlePillarAndPedestal_TypeDefinitionIndex = 64328;
