...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_GET_COLORSTATUS_OFFSET UNITYSDK_OFFSET(0xC628240)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_INITPILLARANDPEDESTAL_OFFSET UNITYSDK_OFFSET(0xC626470)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC628180)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xC629140)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SETCOLORSTATUS_OFFSET UNITYSDK_OFFSET(0xC629820)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL_SET_COLORSTATUS_OFFSET UNITYSDK_OFFSET(0xC6298C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPILLARANDPEDESTAL__CTOR_OFFSET UNITYSDK_OFFSET(0xC629930)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzlePillarAndPedestal_TypeDefinitionIndex = 73397;
