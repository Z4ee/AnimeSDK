...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_CLOSEUI_OFFSET UNITYSDK_OFFSET(0xC55C280)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0xC555040)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0xC5534C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENDAIM_OFFSET UNITYSDK_OFFSET(0xC5585D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENDCONTROL_OFFSET UNITYSDK_OFFSET(0xC55B210)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_FORCECAMERAPOSITIONFORWARD_OFFSET UNITYSDK_OFFSET(0xC55C2C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xC5537F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0xC55C620)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETDISTANCEBYFOVDEGREE_1_OFFSET UNITYSDK_OFFSET(0xC55C940)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETDISTANCEBYFOVDEGREE_OFFSET UNITYSDK_OFFSET(0xC558420)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETW_OFFSET UNITYSDK_OFFSET(0xC55A470)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_INITCAMERALIMIT_OFFSET UNITYSDK_OFFSET(0xC553780)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC554770)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_3F41C18B18C95AA8_OFFSET UNITYSDK_OFFSET(0xC55C860)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0xC55BFE0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0xC55B8C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC55C230)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0xC55C6C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_E7882E2DCB48277F_OFFSET UNITYSDK_OFFSET(0xC55C7E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0xC55C780)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC55B1C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_PLAYDOLLYZOOM_OFFSET UNITYSDK_OFFSET(0xC557CF0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xC55C680)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_SETAIM_OFFSET UNITYSDK_OFFSET(0xC553B70)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_SETFOV_OFFSET UNITYSDK_OFFSET(0xC553890)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTAIM_OFFSET UNITYSDK_OFFSET(0xC554720)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTCAMERAANIM_OFFSET UNITYSDK_OFFSET(0xC5588E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTCONTROL_OFFSET UNITYSDK_OFFSET(0xC553900)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC55B520)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC55CA00)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__REGISTERINPUT_OFFSET UNITYSDK_OFFSET(0xC552860)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__UNREGISTERINPUT_OFFSET UNITYSDK_OFFSET(0xC556050)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleCameraController_TypeDefinitionIndex = 73103;
