...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_CLOSEUI_OFFSET UNITYSDK_OFFSET(0xA096C90)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0xA090B40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0xA08EFE0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENDAIM_OFFSET UNITYSDK_OFFSET(0xA093DD0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ENDCONTROL_OFFSET UNITYSDK_OFFSET(0xA0965E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_FORCECAMERAPOSITIONFORWARD_OFFSET UNITYSDK_OFFSET(0xA096CD0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xA08F2F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0xA097030)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETDISTANCEBYFOVDEGREE_1_OFFSET UNITYSDK_OFFSET(0xA097F50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETDISTANCEBYFOVDEGREE_OFFSET UNITYSDK_OFFSET(0xA0980F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_GETW_OFFSET UNITYSDK_OFFSET(0xA098010)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_INITCAMERALIMIT_OFFSET UNITYSDK_OFFSET(0xA08F280)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xA090260)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_3F41C18B18C95AA8_OFFSET UNITYSDK_OFFSET(0xA0972C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_56A1C36F6B66CD4A_OFFSET UNITYSDK_OFFSET(0xA098170)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0xA097660)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA097270)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_DF7CEFC0E6C5FD0D_OFFSET UNITYSDK_OFFSET(0xA0970D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_E7882E2DCB48277F_OFFSET UNITYSDK_OFFSET(0xA0971F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_METHOD_5_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0xA097190)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA096590)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_PLAYDOLLYZOOM_OFFSET UNITYSDK_OFFSET(0xA097D70)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xA097090)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_SETAIM_OFFSET UNITYSDK_OFFSET(0xA08F670)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_SETFOV_OFFSET UNITYSDK_OFFSET(0xA08F390)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTAIM_OFFSET UNITYSDK_OFFSET(0xA090210)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTCAMERAANIM_OFFSET UNITYSDK_OFFSET(0xA097380)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_STARTCONTROL_OFFSET UNITYSDK_OFFSET(0xA08F400)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0968F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA0983C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__REGISTERINPUT_OFFSET UNITYSDK_OFFSET(0xA08E3D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLECAMERACONTROLLER__UNREGISTERINPUT_OFFSET UNITYSDK_OFFSET(0xA091B20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleCameraController_TypeDefinitionIndex = 64034;
	...
	public:
		...
		::System::Boolean Field_5_42; // 0x120
