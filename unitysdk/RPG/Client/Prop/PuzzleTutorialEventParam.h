...
#define RPG_CLIENT_PROP_PUZZLETUTORIALEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x166401C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PuzzleTutorialEventParam_TypeDefinitionIndex = 78313;
