...
#define RPG_CLIENT_PROP_PUZZLETUTORIALEVENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xAEB0E10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PuzzleTutorialEventParam_TypeDefinitionIndex = 72281;
