...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0xC629080)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_INITPEDESTAL_OFFSET UNITYSDK_OFFSET(0xC628740)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_METHOD_5_7AAD06186762BE3C_OFFSET UNITYSDK_OFFSET(0xC628D90)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_SETCANINTERACTION_OFFSET UNITYSDK_OFFSET(0xC627540)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_SETCANSELECTACTIVE_OFFSET UNITYSDK_OFFSET(0xC628EC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_SETSELECTTYPE_OFFSET UNITYSDK_OFFSET(0xC6275F0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL_UPDATE_OFFSET UNITYSDK_OFFSET(0xC628F50)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEPEDESTAL__CTOR_OFFSET UNITYSDK_OFFSET(0xC629110)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzlePedestal_TypeDefinitionIndex = 73393;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(StableSystemPuzzlePedestal_TypeDefinitionIndex)->GetStaticField(0x8FC0);
		}
