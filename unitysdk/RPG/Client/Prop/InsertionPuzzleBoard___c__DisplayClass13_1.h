...
#define RPG_CLIENT_PROP_INSERTIONPUZZLEBOARD___C__DISPLAYCLASS13_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAE247C0)
#define RPG_CLIENT_PROP_INSERTIONPUZZLEBOARD___C__DISPLAYCLASS13_1__PLAYERROTATEAROUNDCENTER_B__0_OFFSET UNITYSDK_OFFSET(0xAE28940)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int InsertionPuzzleBoard___c__DisplayClass13_1_TypeDefinitionIndex = 72122;

	class InsertionPuzzleBoard___c__DisplayClass13_1 : public ::System::Object
	{
	public:
		::RPG::Client::Prop::InsertionPuzzleBoard___c__DisplayClass13_0* CS___8__locals1; // 0x10
