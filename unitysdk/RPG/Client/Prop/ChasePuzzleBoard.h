...
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA02E010)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02D960)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_METHOD_6_3CE8A1831DA14AB7_OFFSET UNITYSDK_OFFSET(0xA02DC80)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_METHOD_6_B09E78EE7EE4F8FA_OFFSET UNITYSDK_OFFSET(0xA02DD50)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA02DFC0)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_METHOD_6_D06F23B2919326F8_OFFSET UNITYSDK_OFFSET(0xA02E150)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02DE90)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02DB70)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD_TRIGGERRUNAWAY_OFFSET UNITYSDK_OFFSET(0xA02D360)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA02E270)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA02E350)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02E280)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02E2F0)
#define RPG_CLIENT_PROP_CHASEPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA02E290)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChasePuzzleBoard_TypeDefinitionIndex = 63675;
