...
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0xC519C60)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_25CD86BF8626C8D9_1_OFFSET UNITYSDK_OFFSET(0xC519E00)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xC519CD0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_306FF05D4DB1C493_OFFSET UNITYSDK_OFFSET(0xC50F1F0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0xC519C70)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_E11FB2B3A67852DB_OFFSET UNITYSDK_OFFSET(0xC519F80)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xC519BF0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW__DITHEROUT_B__10_0_OFFSET UNITYSDK_OFFSET(0xC51A150)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelNpcModelView_TypeDefinitionIndex = 72854;
