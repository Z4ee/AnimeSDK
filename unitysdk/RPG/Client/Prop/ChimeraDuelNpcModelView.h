...
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0xADD5B90)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_25CD86BF8626C8D9_1_OFFSET UNITYSDK_OFFSET(0xADD5D30)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_25CD86BF8626C8D9_OFFSET UNITYSDK_OFFSET(0xADD5C00)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_306FF05D4DB1C493_OFFSET UNITYSDK_OFFSET(0xADCB130)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_B3A88D7849969A71_OFFSET UNITYSDK_OFFSET(0xADD5BA0)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW_METHOD_5_E11FB2B3A67852DB_OFFSET UNITYSDK_OFFSET(0xADD5E90)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xADD5B20)
#define RPG_CLIENT_PROP_CHIMERADUELNPCMODELVIEW__DITHEROUT_B__10_0_OFFSET UNITYSDK_OFFSET(0xADD6060)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelNpcModelView_TypeDefinitionIndex = 71832;
