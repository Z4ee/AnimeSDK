...
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_AWAKE_OFFSET UNITYSDK_OFFSET(0x18FF89D0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_AUDIOSOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0x18FF8980)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_INFOPANELANCHOR_OFFSET UNITYSDK_OFFSET(0x18FF8960)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_ISJUMPING_OFFSET UNITYSDK_OFFSET(0x18FF87F0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_TALKPANELANCHOR_OFFSET UNITYSDK_OFFSET(0x18FF8970)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET__CAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x18FF8840)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_REACTDITHERHIDE_OFFSET UNITYSDK_OFFSET(0x18FF9360)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_RELOAD_OFFSET UNITYSDK_OFFSET(0x18FF90D0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETCAMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0x18FF9130)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETCOLLIDERENABLED_OFFSET UNITYSDK_OFFSET(0x18FF91F0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0x18FF9180)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STARTDITHERSHOW_OFFSET UNITYSDK_OFFSET(0x18FF9250)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STARTMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0x18FF9470)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STOPMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0x18FF94D0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_TRYTRIGGERJUMPANIMATION_OFFSET UNITYSDK_OFFSET(0x18FF9530)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_UPDATE_OFFSET UNITYSDK_OFFSET(0x18FF8B30)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF9620)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE__PROJECTPIVOTPOSITION_OFFSET UNITYSDK_OFFSET(0x18FF8E30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraNewMembersModelInstance_TypeDefinitionIndex = 74532;
