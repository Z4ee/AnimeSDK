...
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_AWAKE_OFFSET UNITYSDK_OFFSET(0xA064AB0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_AUDIOSOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0xA064A60)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_INFOPANELANCHOR_OFFSET UNITYSDK_OFFSET(0xA064A40)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_ISJUMPING_OFFSET UNITYSDK_OFFSET(0xA0648D0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET_TALKPANELANCHOR_OFFSET UNITYSDK_OFFSET(0xA064A50)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_GET__CAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xA064920)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_REACTDITHERHIDE_OFFSET UNITYSDK_OFFSET(0xA065450)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_RELOAD_OFFSET UNITYSDK_OFFSET(0xA0651C0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETCAMERATRANSFORM_OFFSET UNITYSDK_OFFSET(0xA065220)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETCOLLIDERENABLED_OFFSET UNITYSDK_OFFSET(0xA0652E0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0xA065270)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STARTDITHERSHOW_OFFSET UNITYSDK_OFFSET(0xA065340)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STARTMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xA065560)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_STOPMOVEANIMATION_OFFSET UNITYSDK_OFFSET(0xA0655C0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_TRYTRIGGERJUMPANIMATION_OFFSET UNITYSDK_OFFSET(0xA065620)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE_UPDATE_OFFSET UNITYSDK_OFFSET(0xA064C20)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xA065710)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSMODELINSTANCE__PROJECTPIVOTPOSITION_OFFSET UNITYSDK_OFFSET(0xA064F20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraNewMembersModelInstance_TypeDefinitionIndex = 63938;
