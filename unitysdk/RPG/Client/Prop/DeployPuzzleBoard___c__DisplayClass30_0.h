...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1900CF10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___C__DISPLAYCLASS30_0__SWAPSTONE_B__0_OFFSET UNITYSDK_OFFSET(0x190100B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEBOARD___C__DISPLAYCLASS30_0__SWAPSTONE_B__1_OFFSET UNITYSDK_OFFSET(0x19010220)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleBoard___c__DisplayClass30_0_TypeDefinitionIndex = 74576;
