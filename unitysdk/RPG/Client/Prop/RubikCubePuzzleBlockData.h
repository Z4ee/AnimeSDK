...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC60A180)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleBlockData_TypeDefinitionIndex = 73348;
