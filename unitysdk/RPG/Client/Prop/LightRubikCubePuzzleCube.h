...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0xA0CFA10)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0xA0C8B70)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0CB690)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0xA0D03D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETCOLORMATERIALS_OFFSET UNITYSDK_OFFSET(0xA0CA6E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GETGROUP_OFFSET UNITYSDK_OFFSET(0xA0CF160)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA0C7E60)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITCUBE_OFFSET UNITYSDK_OFFSET(0xA0C72D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0xA0CA8E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_6D8B8CD47CD59618_OFFSET UNITYSDK_OFFSET(0xA0D0C50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA0CB650)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xA0D08C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0xA0D0840)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERFRAME_OFFSET UNITYSDK_OFFSET(0xA0C9A30)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xA0C9380)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEX_OFFSET UNITYSDK_OFFSET(0xA0CB6D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEY_OFFSET UNITYSDK_OFFSET(0xA0CCAD0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xA0CDDE0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0xA0CF960)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0xA0C8FC0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_SETBLOCKMATERIAL_OFFSET UNITYSDK_OFFSET(0xA0CF9C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xA0C9610)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE__CTOR_OFFSET UNITYSDK_OFFSET(0xA0D0CB0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0xA0D0E00)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0xA0D0E80)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0D0D30)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0xA0D0E50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xA0D0EB0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0xA0D0D20)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xA0D0EA0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0xA0D0E90)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEX_OFFSET UNITYSDK_OFFSET(0xA0D0D40)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEY_OFFSET UNITYSDK_OFFSET(0xA0D0D50)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xA0D0D60)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0xA0D0D80)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBE___IFIXBASEPROXY_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0xA0D0D70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleCube_TypeDefinitionIndex = 64134;
