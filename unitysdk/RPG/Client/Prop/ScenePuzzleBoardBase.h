...
#define RPG_CLIENT_PROP_SCENEPUZZLEBOARDBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAEDD450)
#define RPG_CLIENT_PROP_SCENEPUZZLEBOARDBASE_METHOD_6_90C7606F2C268BB2_OFFSET UNITYSDK_OFFSET(0xAEDCFF0)
#define RPG_CLIENT_PROP_SCENEPUZZLEBOARDBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xAEDD130)
#define RPG_CLIENT_PROP_SCENEPUZZLEBOARDBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xAEDD510)
#define RPG_CLIENT_PROP_SCENEPUZZLEBOARDBASE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAEDD5B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ScenePuzzleBoardBase_TypeDefinitionIndex = 72351;
