...
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_ADDLIGHTINDIR_OFFSET UNITYSDK_OFFSET(0x189C9CF0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_ANIMROTATEREFRESHDIRECTION_OFFSET UNITYSDK_OFFSET(0x189C8EA0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_CANCELHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x189C1000)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_CANSELECT_OFFSET UNITYSDK_OFFSET(0x189C4900)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_CONNECTNEIGHBOURWITHPOWER_OFFSET UNITYSDK_OFFSET(0x189C57E0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189C1D80)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETABSDIRBYLOCALDIR_OFFSET UNITYSDK_OFFSET(0x189C9650)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETALLCONNECTEDNEIGHBOURS_OFFSET UNITYSDK_OFFSET(0x189C5100)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETALLOUTCONNECTEDNEIGHBOURS_OFFSET UNITYSDK_OFFSET(0x189C6F40)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETINTERFACECOUNT_OFFSET UNITYSDK_OFFSET(0x189C59A0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETNEIGHBOURBYDIR_OFFSET UNITYSDK_OFFSET(0x189C2320)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETNEIGHBOURDIR_OFFSET UNITYSDK_OFFSET(0x189C9750)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x189C9090)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GETTRANSFORMUP_OFFSET UNITYSDK_OFFSET(0x189C7D70)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_GET_RECORDEDCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x189C9E70)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_HASINTERFACE_OFFSET UNITYSDK_OFFSET(0x189C91C0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_INIT_OFFSET UNITYSDK_OFFSET(0x189C3160)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_ISCONNECTEDWITH_OFFSET UNITYSDK_OFFSET(0x189C9130)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_ISDIRIN_OFFSET UNITYSDK_OFFSET(0x189C9DB0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_LIGHTCENTER_OFFSET UNITYSDK_OFFSET(0x189C6BC0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_LIGHTDIR_OFFSET UNITYSDK_OFFSET(0x189C6CA0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_LIGHTUPALLINTERFACE_OFFSET UNITYSDK_OFFSET(0x189C5A70)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_METHOD_7_6092AEA4D26D2BAB_OFFSET UNITYSDK_OFFSET(0x189C9280)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_METHOD_7_627C7524E98F4AC5_OFFSET UNITYSDK_OFFSET(0x189C8F60)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_METHOD_7_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x189C8060)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_METHOD_7_9A1F0FE9325E6340_OFFSET UNITYSDK_OFFSET(0x189C8FE0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_METHOD_7_BDB9601CB2A37614_OFFSET UNITYSDK_OFFSET(0x189C9560)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_ONHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x189C10C0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0x189C49B0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_RECORDCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x189C7C10)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_REFRESHDIRECTION_OFFSET UNITYSDK_OFFSET(0x189C3330)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_RESETDIR_OFFSET UNITYSDK_OFFSET(0x189C73F0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_RESETLIGHTINDIR_OFFSET UNITYSDK_OFFSET(0x189C96C0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_RESETPOWER_OFFSET UNITYSDK_OFFSET(0x189C3EF0)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_SETLIGHTINDIR_OFFSET UNITYSDK_OFFSET(0x189C7140)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_SETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x189C7F20)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_SETLOCKRELATION_OFFSET UNITYSDK_OFFSET(0x189C4960)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_SETPOWERCENTERLIGHT_OFFSET UNITYSDK_OFFSET(0x189C5A20)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_SETUPNEIGHOUR_OFFSET UNITYSDK_OFFSET(0x189C2B30)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_SET_RECORDEDCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0x189C9E90)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM_START_OFFSET UNITYSDK_OFFSET(0x189C8010)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x189C9F70)
#define RPG_CLIENT_PROP_CABLEPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x189C9EB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CablePuzzleItem_TypeDefinitionIndex = 78136;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C40);
		}
		static ::System::Int32* StaticGet_CFFILJELCDI()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C44);
		}
		static ::System::Int32* StaticGet_KJEFHEDGDPJ()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C48);
		}
		static ::System::Int32* StaticGet_DEOAKFBHPJG()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C4C);
		}
		static ::System::Int32* StaticGet_GNNBFJCPIAI()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C50);
		}
		static ::System::Int32* StaticGet_CKLFPDDDCEE()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C54);
		}
		static ::System::Int32* StaticGet_NBHJKDOPFNG()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CablePuzzleItem_TypeDefinitionIndex)->GetStaticField(0x13C58);
		}
