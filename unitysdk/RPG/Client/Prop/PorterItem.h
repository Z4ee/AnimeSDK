...
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xC5EC230)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xC5EC670)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_46D78B8894C3D058_OFFSET UNITYSDK_OFFSET(0xC5EC520)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_6434F3E6F6B1EC67_OFFSET UNITYSDK_OFFSET(0xC5EC3F0)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_95AA3C6CB470ECEA_OFFSET UNITYSDK_OFFSET(0xC5EC330)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xC5EC7C0)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_9681042564541CD6_2_OFFSET UNITYSDK_OFFSET(0xC5EC850)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xC5EC2A0)
#define RPG_CLIENT_PROP_PORTERITEM_METHOD_1_E986FF079803291E_OFFSET UNITYSDK_OFFSET(0xC5EBBB0)
#define RPG_CLIENT_PROP_PORTERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC5EC8E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PorterItem_TypeDefinitionIndex = 73292;
