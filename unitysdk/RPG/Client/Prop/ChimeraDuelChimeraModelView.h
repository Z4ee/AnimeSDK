...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_BUILDCHIMERA_OFFSET UNITYSDK_OFFSET(0x189E0630)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_BUILDHOLLOW_OFFSET UNITYSDK_OFFSET(0x189E1F90)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_GET_ANIMATOR_OFFSET UNITYSDK_OFFSET(0x189DFAA0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_GET_OUTLINEDRAWER_OFFSET UNITYSDK_OFFSET(0x189DF980)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_GET__BODYCONSTVALUE_OFFSET UNITYSDK_OFFSET(0x189DF990)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_HIDEOUTLINE_OFFSET UNITYSDK_OFFSET(0x189E03A0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0x189E30C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_SETSHADOWCASTINGENABLED_OFFSET UNITYSDK_OFFSET(0x189E3060)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_SHOWHIGHLIGHTOUTLINE_OFFSET UNITYSDK_OFFSET(0x189DFB50)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDBLUSH_OFFSET UNITYSDK_OFFSET(0x189E2630)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDBODY_OFFSET UNITYSDK_OFFSET(0x189E26F0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDEYE_OFFSET UNITYSDK_OFFSET(0x189E1B20)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDFACE_OFFSET UNITYSDK_OFFSET(0x189E29C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDITEMS_1_OFFSET UNITYSDK_OFFSET(0x189E2C30)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDITEMS_OFFSET UNITYSDK_OFFSET(0x189E2E60)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDMATERIALPATH_OFFSET UNITYSDK_OFFSET(0x189E31E0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDPARTS_1_OFFSET UNITYSDK_OFFSET(0x189E2F20)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__BUILDPARTS_OFFSET UNITYSDK_OFFSET(0x189E1170)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x189E3750)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__CREATEMATERIALPARTCONFIG_OFFSET UNITYSDK_OFFSET(0x189E25C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x189E3740)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__GETCHIMERACONFIG_OFFSET UNITYSDK_OFFSET(0x189E0980)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__GETVERSION_OFFSET UNITYSDK_OFFSET(0x189E0C20)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ISASSETEXISTS_OFFSET UNITYSDK_OFFSET(0x189E34F0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ISGAMEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x189E36E0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ISVALID_OFFSET UNITYSDK_OFFSET(0x189E0AD0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__ITERATEPARTS_OFFSET UNITYSDK_OFFSET(0x189DFC20)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__LOADANDBINDCHIMERA_OFFSET UNITYSDK_OFFSET(0x189E0C70)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__LOADMATERIALWITHFALLBACK_OFFSET UNITYSDK_OFFSET(0x189E3110)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__SYNCLOADMATERIAL_OFFSET UNITYSDK_OFFSET(0x189E2B70)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__TRYLOADMATERIAL_OFFSET UNITYSDK_OFFSET(0x189E3650)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW__TRYSETWWISESWITCH_OFFSET UNITYSDK_OFFSET(0x189E1CB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView_TypeDefinitionIndex = 77852;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ChimeraDuelChimeraModelView_TypeDefinitionIndex)->GetStaticField(0x13E20);
		}
