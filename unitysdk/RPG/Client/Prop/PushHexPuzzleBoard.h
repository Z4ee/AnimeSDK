...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0xAEACEF0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xAEAC800)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_0BE999401C7B391E_OFFSET UNITYSDK_OFFSET(0xAEADDA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_290A3E8A6F71CEC9_OFFSET UNITYSDK_OFFSET(0xAEADCD0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_55B8349E0B606444_OFFSET UNITYSDK_OFFSET(0xAEAE140)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_56E076CBC69B0772_OFFSET UNITYSDK_OFFSET(0xAEAE040)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0xAEADBF0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0xAEADFB0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0xAEADE90)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_810DD818C57F797D_OFFSET UNITYSDK_OFFSET(0xAEAE330)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0xAEAE240)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0xAEAE520)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0xAEAD590)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0xAEAD940)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0xAEAE2D0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xAEAE720)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 72114;
	...
	public:
		...
		::Struct_2_2F8FC043285F98CD_1 Method_8_5E0B2F98EE594DCF(::RPG::Client::Prop::PushHexPuzzleItem* a1, ::RPG::Client::Prop::HexDirection a2)
		{
			return ((::Struct_2_2F8FC043285F98CD_1(*)(::PVOID, ::RPG::Client::Prop::PushHexPuzzleItem*, ::RPG::Client::Prop::HexDirection))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET))(this, a1, a2);
		}
