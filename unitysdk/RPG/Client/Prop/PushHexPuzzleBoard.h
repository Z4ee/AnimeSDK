...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0xC5F3450)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xC5F2DB0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_265045B8E51327D0_OFFSET UNITYSDK_OFFSET(0xC5F4750)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_2C0AE2B203ECAB6A_OFFSET UNITYSDK_OFFSET(0xC5F4120)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5605FB9C073CE2FB_OFFSET UNITYSDK_OFFSET(0xC5F4480)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0xC5F4050)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_6803718BFB5F9D29_OFFSET UNITYSDK_OFFSET(0xC5F41E0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0xC5F43F0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0xC5F42D0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_9B1F2653496E5C47_OFFSET UNITYSDK_OFFSET(0xC5F4570)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0xC5F4660)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0xC5F4930)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0xC5F3A20)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0xC5F3DA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0xC5F46F0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC5F4B70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 73136;
