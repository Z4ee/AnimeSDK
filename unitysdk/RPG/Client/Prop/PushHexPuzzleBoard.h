...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x14F35F20)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0x14F35880)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_265045B8E51327D0_OFFSET UNITYSDK_OFFSET(0x14F37220)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_2C0AE2B203ECAB6A_OFFSET UNITYSDK_OFFSET(0x14F36BF0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5605FB9C073CE2FB_OFFSET UNITYSDK_OFFSET(0x14F36F50)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0x14F36B20)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_6803718BFB5F9D29_OFFSET UNITYSDK_OFFSET(0x14F36CB0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0x14F36EC0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0x14F36DA0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_9B1F2653496E5C47_OFFSET UNITYSDK_OFFSET(0x14F37040)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0x14F37130)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0x14F37400)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0x14F364F0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x14F36870)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0x14F371C0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x14F37640)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 74661;
