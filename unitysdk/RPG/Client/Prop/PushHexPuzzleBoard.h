...
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x1663C530)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0x1663BE90)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_265045B8E51327D0_OFFSET UNITYSDK_OFFSET(0x1663D830)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_2C0AE2B203ECAB6A_OFFSET UNITYSDK_OFFSET(0x1663D200)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5605FB9C073CE2FB_OFFSET UNITYSDK_OFFSET(0x1663D560)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_5E0B2F98EE594DCF_OFFSET UNITYSDK_OFFSET(0x1663D130)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_6803718BFB5F9D29_OFFSET UNITYSDK_OFFSET(0x1663D2C0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_703AF19EA2713271_OFFSET UNITYSDK_OFFSET(0x1663D4D0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_72279D6ACE251992_OFFSET UNITYSDK_OFFSET(0x1663D3B0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_METHOD_8_9B1F2653496E5C47_OFFSET UNITYSDK_OFFSET(0x1663D650)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_MOVEITEM_OFFSET UNITYSDK_OFFSET(0x1663D740)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_RECOVERORIGIN_OFFSET UNITYSDK_OFFSET(0x1663DA10)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1663CB00)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_REFRESHITEMSPOSITION_OFFSET UNITYSDK_OFFSET(0x1663CE80)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD_START_OFFSET UNITYSDK_OFFSET(0x1663D7D0)
#define RPG_CLIENT_PROP_PUSHHEXPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1663DC50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PushHexPuzzleBoard_TypeDefinitionIndex = 78146;
