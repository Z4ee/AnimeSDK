...
#define RPG_CLIENT_PROP_CHIMERAGOALSSTATECONTROLLER_GET_STATE_OFFSET UNITYSDK_OFFSET(0xA063B60)
#define RPG_CLIENT_PROP_CHIMERAGOALSSTATECONTROLLER_ONENTER_OFFSET UNITYSDK_OFFSET(0xA063BB0)
#define RPG_CLIENT_PROP_CHIMERAGOALSSTATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA063DB0)
#define RPG_CLIENT_PROP_CHIMERAGOALSSTATECONTROLLER___IFIXBASEPROXY_ONENTER_OFFSET UNITYSDK_OFFSET(0xA063DC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraGoalsStateController_TypeDefinitionIndex = 63946;
