...
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_DISABLECAMERA_OFFSET UNITYSDK_OFFSET(0xC4CAC40)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4CAEA0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_ENABLECAMERA_OFFSET UNITYSDK_OFFSET(0xC4C9B90)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_GETAXISVALUE_OFFSET UNITYSDK_OFFSET(0xC4D4670)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xC4C9A50)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_690254C4B3C33267_OFFSET UNITYSDK_OFFSET(0xC4D4990)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_953DD38710057F4B_OFFSET UNITYSDK_OFFSET(0xC4D45F0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_9D967D80C41C7781_OFFSET UNITYSDK_OFFSET(0xC4D4B60)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_E1B1897755057184_OFFSET UNITYSDK_OFFSET(0xC4D4A20)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_METHOD_5_E9A8695D8BBAA196_OFFSET UNITYSDK_OFFSET(0xC4D4B00)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC4D45A0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_RESETCAMERA_OFFSET UNITYSDK_OFFSET(0xC4CBED0)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC4D4550)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLECAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D4BB0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockProjectionPuzzleCameraController_TypeDefinitionIndex = 72729;
