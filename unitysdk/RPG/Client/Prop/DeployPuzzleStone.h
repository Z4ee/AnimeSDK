...
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_GETCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xC53CD30)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_GET_ATTACHEDBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xC53F240)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_GET_PROPID_OFFSET UNITYSDK_OFFSET(0xC53F220)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_METHOD_5_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0xC53F1D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_ONPUZZLEDESTROY_OFFSET UNITYSDK_OFFSET(0xC53C300)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0xC53C130)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_ONRESET_OFFSET UNITYSDK_OFFSET(0xC53A4D0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_PICKUPFROMBASEPOINT_OFFSET UNITYSDK_OFFSET(0xC53E940)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_PLACETOBASEPOINT_OFFSET UNITYSDK_OFFSET(0xC53A550)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_SET_ATTACHEDBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xC53F250)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_SET_PROPID_OFFSET UNITYSDK_OFFSET(0xC53F230)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE__CTOR_OFFSET UNITYSDK_OFFSET(0xC53F260)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleStone_TypeDefinitionIndex = 73055;
