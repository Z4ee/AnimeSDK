...
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_GETCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA078D20)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_GET_ATTACHEDBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xA07AF00)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_GET_PROPID_OFFSET UNITYSDK_OFFSET(0xA07AEE0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_METHOD_5_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0xA07AE90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_ONPUZZLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA078390)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_ONPUZZLEFINISHED_OFFSET UNITYSDK_OFFSET(0xA078200)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_ONRESET_OFFSET UNITYSDK_OFFSET(0xA0768B0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_PICKUPFROMBASEPOINT_OFFSET UNITYSDK_OFFSET(0xA07A6F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_PLACETOBASEPOINT_OFFSET UNITYSDK_OFFSET(0xA076930)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_SET_ATTACHEDBASEPOINTPROPID_OFFSET UNITYSDK_OFFSET(0xA07AF10)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE_SET_PROPID_OFFSET UNITYSDK_OFFSET(0xA07AEF0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLESTONE__CTOR_OFFSET UNITYSDK_OFFSET(0xA07AF20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleStone_TypeDefinitionIndex = 63986;
