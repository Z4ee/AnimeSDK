...
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A90E9C0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_ENTITY_OFFSET UNITYSDK_OFFSET(0x1A911DE0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_ISFORBIDPLAYERINPUT_OFFSET UNITYSDK_OFFSET(0x1A911530)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_ISOVERRIDEDRONEFUNCBTN_OFFSET UNITYSDK_OFFSET(0x1A911940)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_GET_NOTIFYADVENTUREFUNCBTNENABLEEFFECTSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x1A911DF0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A90D050)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x1A90D010)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_1F130271093617A5_OFFSET UNITYSDK_OFFSET(0x1A911600)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_32FE792EB1B0F498_OFFSET UNITYSDK_OFFSET(0x1A911740)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_3FC5D2EAE16048C0_OFFSET UNITYSDK_OFFSET(0x1A90F560)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0x1A90F310)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_4358F70A163BCEAE_OFFSET UNITYSDK_OFFSET(0x1A90F4E0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_7646FFE662147970_1_OFFSET UNITYSDK_OFFSET(0x1A90F990)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0x1A9116C0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x1A911D80)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_885DF4DA0F709E3E_OFFSET UNITYSDK_OFFSET(0x1A90F9E0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x1A9115A0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x1A911540)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A56EAB6E8DBE44E9_OFFSET UNITYSDK_OFFSET(0x1A911B50)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_A84CEAF7AFA573B3_OFFSET UNITYSDK_OFFSET(0x1A90DA80)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_B386444429A36A77_OFFSET UNITYSDK_OFFSET(0x1A911E00)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_B484DF6A9226D45B_OFFSET UNITYSDK_OFFSET(0x1A911AA0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_BE4EBC8FF4054312_OFFSET UNITYSDK_OFFSET(0x1A90D660)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_C450A961450309C9_1_OFFSET UNITYSDK_OFFSET(0x1A911A20)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x1A9119A0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1A90F080)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_METHOD_6_D296277FE17812A6_OFFSET UNITYSDK_OFFSET(0x1A9101E0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_ONMOVEMENTEND_OFFSET UNITYSDK_OFFSET(0x1A910090)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_RESETDRONESPOSITION_OFFSET UNITYSDK_OFFSET(0x1A90F120)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A90F0D0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_SET_NOTIFYADVENTUREFUNCBTNENABLEEFFECTSHOWSTATE_OFFSET UNITYSDK_OFFSET(0x1A910010)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_STARTCONTROL_OFFSET UNITYSDK_OFFSET(0x1A90DF20)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A90DA30)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_STOPCONTROL_OFFSET UNITYSDK_OFFSET(0x1A90EC70)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x1A90FB80)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__BUILDACHIEVEMENTAREAS_B__14_0_OFFSET UNITYSDK_OFFSET(0x1A912110)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A911EF0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__INITPUZZLE_B__2_0_OFFSET UNITYSDK_OFFSET(0x1A911FF0)
#define RPG_CLIENT_PROP_DRONESPUZZLEBOARD__INITPUZZLE_B__2_1_OFFSET UNITYSDK_OFFSET(0x1A912080)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DronesPuzzleBoard_TypeDefinitionIndex = 78093;
