...
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADA7E20)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADA8010)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADA8070)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xADA8020)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADA7E10)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__DELAYREFRESH_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0xADA3F30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CablePuzzleBoard__DelayRefresh_d__9_TypeDefinitionIndex = 72100;
