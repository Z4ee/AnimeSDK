...
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_GET_DELTAATTACK_OFFSET UNITYSDK_OFFSET(0x18FEF0E0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_GET_DELTAHEALTH_OFFSET UNITYSDK_OFFSET(0x18FEF100)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_GET_UPGRADE_OFFSET UNITYSDK_OFFSET(0x18FEF120)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_PREPAREUPGRADE_OFFSET UNITYSDK_OFFSET(0x18FEF8F0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_SET_DELTAATTACK_OFFSET UNITYSDK_OFFSET(0x18FEF0F0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_SET_DELTAHEALTH_OFFSET UNITYSDK_OFFSET(0x18FEF110)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_SET_UPGRADE_OFFSET UNITYSDK_OFFSET(0x18FEF130)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_TRYCREATEFORCOREFLAME_OFFSET UNITYSDK_OFFSET(0x18FEF610)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x18FEF1B0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT_VISITTARGETS_OFFSET UNITYSDK_OFFSET(0x18FEF150)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18FEF140)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPVIEWJUMPTEXTEFFECT__IGNOREZERO_OFFSET UNITYSDK_OFFSET(0x18FEF5A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelShopViewJumpTextEffect_TypeDefinitionIndex = 74407;
	...
	public:
		...
		::System::Nullable_1<::System::Int32> _DeltaHealth_k__BackingField; // 0x24
