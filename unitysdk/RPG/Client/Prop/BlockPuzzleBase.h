...
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_GET_HASINIT_OFFSET UNITYSDK_OFFSET(0xC4D64E0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC4D5F40)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_ISPLAYERONBOARD_OFFSET UNITYSDK_OFFSET(0xC4D62E0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_METHOD_6_8369B9BE7F06A56A_OFFSET UNITYSDK_OFFSET(0xC4D6490)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_METHOD_6_D2F6A7A22BCB944C_OFFSET UNITYSDK_OFFSET(0xC4D6070)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_METHOD_6_DD31BD6ABA02C7FF_OFFSET UNITYSDK_OFFSET(0xC4D5FC0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE_WORLDPOSITIONTOBLOCKPOSITION_OFFSET UNITYSDK_OFFSET(0xC4D61D0)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D6540)
#define RPG_CLIENT_PROP_BLOCKPUZZLEBASE___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC4D6550)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockPuzzleBase_TypeDefinitionIndex = 72735;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_BLOCKPUZZLEBASE___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, a1, a2, a3);
		}
	};
}
