...
#define RPG_CLIENT_PROP_POLYGONMESH_METHOD_1_E8947406FBA55064_OFFSET UNITYSDK_OFFSET(0xDCD0590)
#define RPG_CLIENT_PROP_POLYGONMESH_METHOD_1_EA6474AC2169BCED_OFFSET UNITYSDK_OFFSET(0xDCF5490)
#define RPG_CLIENT_PROP_POLYGONMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xDCF56A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PolygonMesh_TypeDefinitionIndex = 78256;
