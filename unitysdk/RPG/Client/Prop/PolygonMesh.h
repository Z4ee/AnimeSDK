...
#define RPG_CLIENT_PROP_POLYGONMESH_METHOD_1_E8947406FBA55064_OFFSET UNITYSDK_OFFSET(0xC5C7010)
#define RPG_CLIENT_PROP_POLYGONMESH_METHOD_1_EA6474AC2169BCED_OFFSET UNITYSDK_OFFSET(0xC5EB990)
#define RPG_CLIENT_PROP_POLYGONMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xC5EBBA0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PolygonMesh_TypeDefinitionIndex = 73245;
