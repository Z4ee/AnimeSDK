...
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_AWAKE_OFFSET UNITYSDK_OFFSET(0xDC69E80)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xDC6A890)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_HIDE_OFFSET UNITYSDK_OFFSET(0xDC6A720)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_INIT_OFFSET UNITYSDK_OFFSET(0xDC6A560)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_METHOD_6_0C247A24E7FC3289_OFFSET UNITYSDK_OFFSET(0xDC6AE50)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDC6AFC0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_UPDATESHOWANIMATION_OFFSET UNITYSDK_OFFSET(0xDC6A770)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xDC6AF00)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0xDC6B020)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallLinearMoveObstacle_TypeDefinitionIndex = 78120;
