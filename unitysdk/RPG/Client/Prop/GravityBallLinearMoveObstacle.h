...
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_AWAKE_OFFSET UNITYSDK_OFFSET(0xC55F720)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xC560130)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_HIDE_OFFSET UNITYSDK_OFFSET(0xC55FFC0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_INIT_OFFSET UNITYSDK_OFFSET(0xC55FE00)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_METHOD_6_0C247A24E7FC3289_OFFSET UNITYSDK_OFFSET(0xC5606F0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC560860)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_UPDATESHOWANIMATION_OFFSET UNITYSDK_OFFSET(0xC560010)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xC5607A0)
#define RPG_CLIENT_PROP_GRAVITYBALLLINEARMOVEOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC5608C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int GravityBallLinearMoveObstacle_TypeDefinitionIndex = 73109;
