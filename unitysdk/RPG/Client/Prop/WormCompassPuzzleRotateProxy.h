...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xA195640)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_METHOD_5_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xA1959F0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA195720)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_REMOVEROTATE_OFFSET UNITYSDK_OFFSET(0xA192AA0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_ROTATE_OFFSET UNITYSDK_OFFSET(0xA190530)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xA195800)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xA195A80)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY__ONROTATEREMOVE_OFFSET UNITYSDK_OFFSET(0xA195980)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleRotateProxy_TypeDefinitionIndex = 64384;
