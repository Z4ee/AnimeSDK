...
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xC65CAF0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_METHOD_5_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xC65CF70)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC65CC10)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_REMOVEROTATE_OFFSET UNITYSDK_OFFSET(0xC659ED0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_ROTATE_OFFSET UNITYSDK_OFFSET(0xC6576E0)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xC65CD30)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xC65D000)
#define RPG_CLIENT_PROP_WORMCOMPASSPUZZLEROTATEPROXY__ONROTATEREMOVE_OFFSET UNITYSDK_OFFSET(0xC65CF00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WormCompassPuzzleRotateProxy_TypeDefinitionIndex = 73453;
