...
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDCE7030)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_ENTERCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xDCE7310)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_EXITCAMERAMODE_OFFSET UNITYSDK_OFFSET(0xDCE7750)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xDCE7970)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xDCE70F0)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_METHOD_6_791B304BAE2CAAFF_OFFSET UNITYSDK_OFFSET(0xDCE6890)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_SETFOLLOWINFO_OFFSET UNITYSDK_OFFSET(0xDCE7250)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xDCE6660)
#define RPG_CLIENT_PROP_PINBALLCAMERACONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDCE7A30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PinballCameraController_TypeDefinitionIndex = 78424;
