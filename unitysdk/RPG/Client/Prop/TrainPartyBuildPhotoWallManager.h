...
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xDD41420)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER_BLOCKNOTIFY_OFFSET UNITYSDK_OFFSET(0xDD41D40)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER_CLEARALLIMAGES_OFFSET UNITYSDK_OFFSET(0xDD41A20)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER_CLEARIMAGE_OFFSET UNITYSDK_OFFSET(0xDD41C00)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDD418D0)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER_SHOWIMAGE_OFFSET UNITYSDK_OFFSET(0xDD41AB0)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xDD42340)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER__INITDISPLAYWALL_OFFSET UNITYSDK_OFFSET(0xDD41570)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER__INITSLOTTOINDEXMAP_OFFSET UNITYSDK_OFFSET(0xDD41D80)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER__ONADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0xDD422C0)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER__ONDYNAMICITEMSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xDD41F10)
#define RPG_CLIENT_PROP_TRAINPARTYBUILDPHOTOWALLMANAGER__ONPHOTOWALLPREVIEW_OFFSET UNITYSDK_OFFSET(0xDD420B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int TrainPartyBuildPhotoWallManager_TypeDefinitionIndex = 77713;
