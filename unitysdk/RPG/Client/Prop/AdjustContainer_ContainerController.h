...
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_09124A4A24353C26_OFFSET UNITYSDK_OFFSET(0xAD7D430)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_0C5935972D4E4937_OFFSET UNITYSDK_OFFSET(0xAD7C4F0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_152DB1D5ED5EBC1C_OFFSET UNITYSDK_OFFSET(0xAD7CEF0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_41AA181104E03F2C_OFFSET UNITYSDK_OFFSET(0xAD7B2E0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xAD7DDD0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_4852C8351A25DF62_OFFSET UNITYSDK_OFFSET(0xAD7CB20)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_4EA6B1791DACA9CC_OFFSET UNITYSDK_OFFSET(0xAD79A90)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_5BCE9210F4ACDD0B_1_OFFSET UNITYSDK_OFFSET(0xAD7DC10)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0xAD7D750)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_5D3D37F2BAE9FB65_OFFSET UNITYSDK_OFFSET(0xAD7DF00)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_66F42CE2EDA79734_OFFSET UNITYSDK_OFFSET(0xAD7D910)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_735EE20B25F86BF4_1_OFFSET UNITYSDK_OFFSET(0xAD7E450)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0xAD7E3A0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_7A197CEF49C8F61D_OFFSET UNITYSDK_OFFSET(0xAD7A860)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0xAD7CFE0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0xAD7E4F0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0xAD7E0F0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0xAD7E340)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0xAD7D3C0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_B75D122F21CFAD25_OFFSET UNITYSDK_OFFSET(0xAD7B110)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_E3595C70D352D71F_OFFSET UNITYSDK_OFFSET(0xAD7A440)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD7E560)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER___REGENERATENOREUSE_B__6_2_OFFSET UNITYSDK_OFFSET(0xAD7E620)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdjustContainer_ContainerController_TypeDefinitionIndex = 71693;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_4EA6B1791DACA9CC_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_0C5935972D4E4937_OFFSET))(this, a1);
		}
