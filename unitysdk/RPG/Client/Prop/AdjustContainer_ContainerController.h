...
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x193A8050)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_09124A4A24353C26_OFFSET UNITYSDK_OFFSET(0x193A7750)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_19844080C13BA28F_OFFSET UNITYSDK_OFFSET(0x193A7BD0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_2DF7969B85DC261B_OFFSET UNITYSDK_OFFSET(0x193A4120)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_435B33488FBCBE0B_OFFSET UNITYSDK_OFFSET(0x193A4560)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_51AC7912135C5E23_OFFSET UNITYSDK_OFFSET(0x193A50C0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_735EE20B25F86BF4_1_OFFSET UNITYSDK_OFFSET(0x193A86E0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x193A8630)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0x193A8190)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_95F9978EEF8F29E5_OFFSET UNITYSDK_OFFSET(0x193A7070)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_969EF16C38E0FD30_OFFSET UNITYSDK_OFFSET(0x193A8780)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x193A8380)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_9E38127F40B34F1F_1_OFFSET UNITYSDK_OFFSET(0x193A7EF0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_9E38127F40B34F1F_2_OFFSET UNITYSDK_OFFSET(0x193A7160)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_9E38127F40B34F1F_OFFSET UNITYSDK_OFFSET(0x193A7A70)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_A27D06F9481FAFDB_1_OFFSET UNITYSDK_OFFSET(0x193A85D0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x193A76E0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_B75D122F21CFAD25_OFFSET UNITYSDK_OFFSET(0x193A4E80)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_B8A8F4F120B2F6D5_OFFSET UNITYSDK_OFFSET(0x193A6400)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_E7AB99EDC5373156_OFFSET UNITYSDK_OFFSET(0x193A6C60)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER_METHOD_1_EFF275E2C18C04F2_OFFSET UNITYSDK_OFFSET(0x193A3660)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193A87F0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERCONTROLLER___REGENERATENOREUSE_B__6_2_OFFSET UNITYSDK_OFFSET(0x193A88B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdjustContainer_ContainerController_TypeDefinitionIndex = 74240;
