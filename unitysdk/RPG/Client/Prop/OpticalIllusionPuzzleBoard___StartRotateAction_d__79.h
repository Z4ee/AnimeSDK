...
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___STARTROTATEACTION_D__79_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1486F5E0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___STARTROTATEACTION_D__79_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1486FA50)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___STARTROTATEACTION_D__79_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1486FAB0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___STARTROTATEACTION_D__79_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1486FA60)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___STARTROTATEACTION_D__79_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1486F5D0)
#define RPG_CLIENT_PROP_OPTICALILLUSIONPUZZLEBOARD___STARTROTATEACTION_D__79__CTOR_OFFSET UNITYSDK_OFFSET(0x14868BF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OpticalIllusionPuzzleBoard___StartRotateAction_d__79_TypeDefinitionIndex = 74755;
