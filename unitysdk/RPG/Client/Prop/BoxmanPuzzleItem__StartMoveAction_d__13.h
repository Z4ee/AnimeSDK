...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTMOVEACTION_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA01EA10)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTMOVEACTION_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA01EC40)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTMOVEACTION_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA01ECA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTMOVEACTION_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xA01EC50)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTMOVEACTION_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA01EA00)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTMOVEACTION_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0xA01E0F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItem__StartMoveAction_d__13_TypeDefinitionIndex = 64301;
