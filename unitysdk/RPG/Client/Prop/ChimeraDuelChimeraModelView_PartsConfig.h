...
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELBODY_OFFSET UNITYSDK_OFFSET(0xA045890)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELHORN_OFFSET UNITYSDK_OFFSET(0xA0458B0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELITEMMATOVERRIDE_OFFSET UNITYSDK_OFFSET(0xA045910)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELTAIL_OFFSET UNITYSDK_OFFSET(0xA0458F0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_GET_MODELWING_OFFSET UNITYSDK_OFFSET(0xA0458D0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELBODY_OFFSET UNITYSDK_OFFSET(0xA0458A0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELHORN_OFFSET UNITYSDK_OFFSET(0xA0458C0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELITEMMATOVERRIDE_OFFSET UNITYSDK_OFFSET(0xA045920)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELTAIL_OFFSET UNITYSDK_OFFSET(0xA045900)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG_SET_MODELWING_OFFSET UNITYSDK_OFFSET(0xA0458E0)
#define RPG_CLIENT_PROP_CHIMERADUELCHIMERAMODELVIEW_PARTSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA044E30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelChimeraModelView_PartsConfig_TypeDefinitionIndex = 63777;
	...
	public:
		...
		::RPG::GameCore::ChimeraWingsPartType _ModelWing_k__BackingField; // 0x18
