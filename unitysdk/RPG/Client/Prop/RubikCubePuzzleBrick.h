...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_COPYFROM_OFFSET UNITYSDK_OFFSET(0xDD17D20)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDD17AF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_INITBRICK_OFFSET UNITYSDK_OFFSET(0xDD17BF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_ISTATUM_OFFSET UNITYSDK_OFFSET(0xDD182E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_LOGICROTATETATUMX_OFFSET UNITYSDK_OFFSET(0xDD184A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_LOGICROTATETATUMY_OFFSET UNITYSDK_OFFSET(0xDD18540)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_LOGICROTATETATUMZ_OFFSET UNITYSDK_OFFSET(0xDD185E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_ONTRIGGERDISSOLVE_OFFSET UNITYSDK_OFFSET(0xDD180E0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xDD18060)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK_SETSELECT_OFFSET UNITYSDK_OFFSET(0xDD18350)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLEBRICK__CTOR_OFFSET UNITYSDK_OFFSET(0xDD18680)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleBrick_TypeDefinitionIndex = 78349;
