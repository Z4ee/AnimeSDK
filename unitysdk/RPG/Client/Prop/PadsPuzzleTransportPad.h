...
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_INITSTATE_OFFSET UNITYSDK_OFFSET(0xDCDB0C0)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_METHOD_7_0581090195E9C81F_OFFSET UNITYSDK_OFFSET(0xDCDB8E0)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_METHOD_7_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0xDCDB650)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_PUZZLEENTER_OFFSET UNITYSDK_OFFSET(0xDCDB3B0)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_PUZZLERESET_OFFSET UNITYSDK_OFFSET(0xDCDB590)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_PUZZLESUCCEED_OFFSET UNITYSDK_OFFSET(0xDCDB4D0)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD_TRIGGERTELEPORTEFFECT_OFFSET UNITYSDK_OFFSET(0xDCD7590)
#define RPG_CLIENT_PROP_PADSPUZZLETRANSPORTPAD__CTOR_OFFSET UNITYSDK_OFFSET(0xDCDB9C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzleTransportPad_TypeDefinitionIndex = 78277;
