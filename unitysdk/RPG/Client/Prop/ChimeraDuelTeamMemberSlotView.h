...
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_0E077E62EF2EFC16_OFFSET UNITYSDK_OFFSET(0x18FE90A0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_5AFB73477BDE8482_OFFSET UNITYSDK_OFFSET(0x18FF0100)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0x18FF0730)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x18FF0440)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_B28695407764C700_OFFSET UNITYSDK_OFFSET(0x18FF0530)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x18FF06E0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x18FF09B0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelTeamMemberSlotView_TypeDefinitionIndex = 74403;
