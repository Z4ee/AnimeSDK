...
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_0E077E62EF2EFC16_OFFSET UNITYSDK_OFFSET(0x1A8E6A60)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_5AFB73477BDE8482_OFFSET UNITYSDK_OFFSET(0x1A8E6480)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_7619D212F4D762A1_OFFSET UNITYSDK_OFFSET(0x1A8E6B00)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x1A8E67C0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_METHOD_5_B28695407764C700_OFFSET UNITYSDK_OFFSET(0x1A8E68B0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A8E6AB0)
#define RPG_CLIENT_PROP_CHIMERADUELTEAMMEMBERSLOTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E6D80)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelTeamMemberSlotView_TypeDefinitionIndex = 77888;

	class ChimeraDuelTeamMemberSlotView : public ::UnityEngine::MonoBehaviour
	{
	public:
		::RPG::Client::Prop::ChimeraDuelTeamMemberSlotView_Class_1_91BF8C5CC9598023* EPKIDMNCGAA; // 0x18
		::RPG::Client::Prop::ChimeraArrangementModelInstance_MotionConfig* CMKFBCIKJIC; // 0x20
