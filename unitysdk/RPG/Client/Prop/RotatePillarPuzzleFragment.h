...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xDD10170)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xDD10160)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xDD0F2F0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISMAINROTATE_OFFSET UNITYSDK_OFFSET(0xDD100C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xDD100B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT0_OFFSET UNITYSDK_OFFSET(0xDD10180)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT1_OFFSET UNITYSDK_OFFSET(0xDD10190)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT2_OFFSET UNITYSDK_OFFSET(0xDD101A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT3_OFFSET UNITYSDK_OFFSET(0xDD101B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_01EA2A2B0FBDD6EC_OFFSET UNITYSDK_OFFSET(0xDD0D250)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xDD0E330)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_09ABBA5088B6E51D_OFFSET UNITYSDK_OFFSET(0xDD0E380)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_4B49CB2CD4D222F8_OFFSET UNITYSDK_OFFSET(0xDD0FD40)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_730F88EAC5E19842_OFFSET UNITYSDK_OFFSET(0xDD0F750)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_9BA0A0AC3056DE7A_OFFSET UNITYSDK_OFFSET(0xDD0FCA0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_A3230FC76D17AAB8_OFFSET UNITYSDK_OFFSET(0xDD0F560)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0xDD0F380)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_B1EA5948E7D176CF_OFFSET UNITYSDK_OFFSET(0xDD0EB20)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0xDD100D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D34B35D59998D28C_OFFSET UNITYSDK_OFFSET(0xDD0FF70)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D7D0CD092E7E5457_OFFSET UNITYSDK_OFFSET(0xDD0E240)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_F59BE9A39F733D1E_OFFSET UNITYSDK_OFFSET(0xDD0EF30)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_FB2B76D3FA17269F_OFFSET UNITYSDK_OFFSET(0xDD0DE90)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xDD0D760)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xDD0D5F0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT0_OFFSET UNITYSDK_OFFSET(0xDD0D8D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT1_OFFSET UNITYSDK_OFFSET(0xDD0DA40)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT2_OFFSET UNITYSDK_OFFSET(0xDD0DBB0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT3_OFFSET UNITYSDK_OFFSET(0xDD0DD20)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD101C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xDD0D230)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__ONROTATEFINISH_B__13_0_OFFSET UNITYSDK_OFFSET(0xDD102F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzleFragment_TypeDefinitionIndex = 78335;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x65980);
		}
		static ::System::String** StaticGet__ChangeToCompleteSound()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x65988);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StartRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x65990);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StopRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x65998);
		}
		static ::System::Int32* StaticGet__UniqueIDCnt()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x14ED0);
		}
