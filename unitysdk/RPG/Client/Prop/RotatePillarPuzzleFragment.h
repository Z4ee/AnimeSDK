...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0x14F49550)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0x14F49540)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x14F48680)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISMAINROTATE_OFFSET UNITYSDK_OFFSET(0x14F494A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0x14F49490)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT0_OFFSET UNITYSDK_OFFSET(0x14F49560)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT1_OFFSET UNITYSDK_OFFSET(0x14F49570)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT2_OFFSET UNITYSDK_OFFSET(0x14F49580)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT3_OFFSET UNITYSDK_OFFSET(0x14F49590)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_01EA2A2B0FBDD6EC_OFFSET UNITYSDK_OFFSET(0x14F465F0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x14F476C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_09ABBA5088B6E51D_OFFSET UNITYSDK_OFFSET(0x14F47710)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_4B49CB2CD4D222F8_OFFSET UNITYSDK_OFFSET(0x14F49120)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_730F88EAC5E19842_OFFSET UNITYSDK_OFFSET(0x14F48AE0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_9BA0A0AC3056DE7A_OFFSET UNITYSDK_OFFSET(0x14F49080)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_A3230FC76D17AAB8_OFFSET UNITYSDK_OFFSET(0x14F488F0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0x14F48710)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_B1EA5948E7D176CF_OFFSET UNITYSDK_OFFSET(0x14F47EB0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0x14F494B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D34B35D59998D28C_OFFSET UNITYSDK_OFFSET(0x14F49350)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D7D0CD092E7E5457_OFFSET UNITYSDK_OFFSET(0x14F475D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_F59BE9A39F733D1E_OFFSET UNITYSDK_OFFSET(0x14F482C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_FB2B76D3FA17269F_OFFSET UNITYSDK_OFFSET(0x14F47230)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0x14F46B00)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0x14F46990)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT0_OFFSET UNITYSDK_OFFSET(0x14F46C70)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT1_OFFSET UNITYSDK_OFFSET(0x14F46DE0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT2_OFFSET UNITYSDK_OFFSET(0x14F46F50)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT3_OFFSET UNITYSDK_OFFSET(0x14F470C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x14F495A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x14F465D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__ONROTATEFINISH_B__13_0_OFFSET UNITYSDK_OFFSET(0x14F496D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzleFragment_TypeDefinitionIndex = 74849;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC370);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StartRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC378);
		}
		static ::System::String** StaticGet__ChangeToCompleteSound()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC380);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StopRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0xC388);
		}
		static ::System::Int32* StaticGet__UniqueIDCnt()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x47B0);
		}
