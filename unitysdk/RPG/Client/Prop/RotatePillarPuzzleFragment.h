...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xC606BE0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xC606BD0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC605D10)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISMAINROTATE_OFFSET UNITYSDK_OFFSET(0xC606B30)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xC606B20)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT0_OFFSET UNITYSDK_OFFSET(0xC606BF0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT1_OFFSET UNITYSDK_OFFSET(0xC606C00)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT2_OFFSET UNITYSDK_OFFSET(0xC606C10)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_GET_LIGHT3_OFFSET UNITYSDK_OFFSET(0xC606C20)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_01EA2A2B0FBDD6EC_OFFSET UNITYSDK_OFFSET(0xC603BD0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0xC604CB0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_09ABBA5088B6E51D_OFFSET UNITYSDK_OFFSET(0xC604D00)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_4B49CB2CD4D222F8_OFFSET UNITYSDK_OFFSET(0xC6067B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_730F88EAC5E19842_OFFSET UNITYSDK_OFFSET(0xC606170)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_9BA0A0AC3056DE7A_OFFSET UNITYSDK_OFFSET(0xC606710)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_A3230FC76D17AAB8_OFFSET UNITYSDK_OFFSET(0xC605F80)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_ABE7CF9FA1B8CCA3_OFFSET UNITYSDK_OFFSET(0xC605DA0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_B1EA5948E7D176CF_OFFSET UNITYSDK_OFFSET(0xC6054A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_BADDA70ED68283AE_OFFSET UNITYSDK_OFFSET(0xC606B40)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_BF272444CBE086CA_OFFSET UNITYSDK_OFFSET(0xC6058B0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D34B35D59998D28C_OFFSET UNITYSDK_OFFSET(0xC6069E0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_D7D0CD092E7E5457_OFFSET UNITYSDK_OFFSET(0xC604BC0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_FB2B76D3FA17269F_OFFSET UNITYSDK_OFFSET(0xC604810)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_CLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xC6040E0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_COUNTERCLOCKWISELIGHT_OFFSET UNITYSDK_OFFSET(0xC603F70)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT0_OFFSET UNITYSDK_OFFSET(0xC604250)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT1_OFFSET UNITYSDK_OFFSET(0xC6043C0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT2_OFFSET UNITYSDK_OFFSET(0xC604530)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_SET_LIGHT3_OFFSET UNITYSDK_OFFSET(0xC6046A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0xC606C30)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC603BB0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT__ONROTATEFINISH_B__13_0_OFFSET UNITYSDK_OFFSET(0xC606D60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzleFragment_TypeDefinitionIndex = 73324;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x1B1D0);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_StartRotateSound()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x1B1D8);
		}
		static ::System::String** StaticGet__ChangeToNotCompleteSound()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x1B1E0);
		}
		static ::System::String** StaticGet__ChangeToCompleteSound()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x1B1E8);
		}
		static ::System::Int32* StaticGet__UniqueIDCnt()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleFragment_TypeDefinitionIndex)->GetStaticField(0x8AA0);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_ROTATEPILLARPUZZLEFRAGMENT_METHOD_1_BF272444CBE086CA_OFFSET))(this);
		}
