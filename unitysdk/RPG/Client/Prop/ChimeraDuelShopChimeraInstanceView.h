...
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_0094A08E076C3CCD_OFFSET UNITYSDK_OFFSET(0x1A8E35C0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x1A8E3840)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_38BA5162C5819E36_OFFSET UNITYSDK_OFFSET(0x1A8E3FA0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x1A8E3D90)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0x1A8E3EF0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_7A4EB7A4DA062DE3_OFFSET UNITYSDK_OFFSET(0x1A8E3910)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_7D21D8548943D577_OFFSET UNITYSDK_OFFSET(0x1A8E31F0)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_8CA05BCD86E125DF_OFFSET UNITYSDK_OFFSET(0x1A8E3440)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW_METHOD_5_D33BA2B6C0CF2EDA_OFFSET UNITYSDK_OFFSET(0x1A8E3240)
#define RPG_CLIENT_PROP_CHIMERADUELSHOPCHIMERAINSTANCEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E4050)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelShopChimeraInstanceView_TypeDefinitionIndex = 77870;
