...
#define RPG_CLIENT_PROP_ORACLEPUZZLESOLUTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAE85B90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleSolutionItem_TypeDefinitionIndex = 72231;
