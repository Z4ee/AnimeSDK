...
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_GETBOXTYPE_OFFSET UNITYSDK_OFFSET(0xAE2E5D0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_ISSIDE1_OFFSET UNITYSDK_OFFSET(0xAE2E830)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_0C5E7E6B860B221F_OFFSET UNITYSDK_OFFSET(0xAE2DF20)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0xAE2D690)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xAE2E410)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETINISOMETRIC_OFFSET UNITYSDK_OFFSET(0xAE2E3B0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETINITSTATE_OFFSET UNITYSDK_OFFSET(0xAE2DC60)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETLINKERENABLE_OFFSET UNITYSDK_OFFSET(0xAE2E570)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAE2E880)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int IsometricViewPuzzleItem_TypeDefinitionIndex = 72141;
