...
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_GETBOXTYPE_OFFSET UNITYSDK_OFFSET(0xC575170)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_ISSIDE1_OFFSET UNITYSDK_OFFSET(0xC5753D0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_0C5E7E6B860B221F_OFFSET UNITYSDK_OFFSET(0xC574AC0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_1293CB739F1151A1_OFFSET UNITYSDK_OFFSET(0xC574230)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_METHOD_5_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xC574FB0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETINISOMETRIC_OFFSET UNITYSDK_OFFSET(0xC574F50)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETINITSTATE_OFFSET UNITYSDK_OFFSET(0xC574800)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM_SETLINKERENABLE_OFFSET UNITYSDK_OFFSET(0xC575110)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC575420)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int IsometricViewPuzzleItem_TypeDefinitionIndex = 73163;
