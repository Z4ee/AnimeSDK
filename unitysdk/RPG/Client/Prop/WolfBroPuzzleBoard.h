...
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ACTIVATEBULLET_OFFSET UNITYSDK_OFFSET(0xDD50C10)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ARCHIVE_OFFSET UNITYSDK_OFFSET(0xDD52690)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_BOOMPROPHITTARGETS_OFFSET UNITYSDK_OFFSET(0xDD515F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDD51850)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ENABLETELEPORTTIMING_OFFSET UNITYSDK_OFFSET(0xDD53510)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_CACHEDCAMERAAXIS_OFFSET UNITYSDK_OFFSET(0xDD57070)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xDD58870)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_ISBULLETACTIVATED_OFFSET UNITYSDK_OFFSET(0xDD57020)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_ISLOCK_OFFSET UNITYSDK_OFFSET(0xDD57000)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_GET_ISMINISTATE_OFFSET UNITYSDK_OFFSET(0xDD57010)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_HITTARGETS_OFFSET UNITYSDK_OFFSET(0xDD512E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xDD4FA50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_INTERRUPTEDPLAYERPROJECTILES_OFFSET UNITYSDK_OFFSET(0xDD533C0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xDD51D90)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_07FFFDF63DF475EA_OFFSET UNITYSDK_OFFSET(0xDD511E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_0D64F99BAAA7B5C4_OFFSET UNITYSDK_OFFSET(0xDD565B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_119DF0CE89C21899_OFFSET UNITYSDK_OFFSET(0xDD51E70)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_1754A6BBAA1C72DD_OFFSET UNITYSDK_OFFSET(0xDD54520)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xDD553C0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_28BB8707B4CC88A2_OFFSET UNITYSDK_OFFSET(0xDD58580)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_39845204DD04FC33_OFFSET UNITYSDK_OFFSET(0xDD53AB0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_3C111959D3BB5616_OFFSET UNITYSDK_OFFSET(0xDD563C0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_41A074549EF25F63_OFFSET UNITYSDK_OFFSET(0xDD506F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_45AA2F5085C2C40D_OFFSET UNITYSDK_OFFSET(0xDD52940)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_6423291ED13007B8_OFFSET UNITYSDK_OFFSET(0xDD554E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_70595BBE3E0E4F2A_OFFSET UNITYSDK_OFFSET(0xDD566A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7223CD34BEFCBF48_OFFSET UNITYSDK_OFFSET(0xDD55810)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7243ADD7DCCD2F93_OFFSET UNITYSDK_OFFSET(0xDD536D0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_741FA71FA66D57DE_OFFSET UNITYSDK_OFFSET(0xDD571E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7646FFE662147970_OFFSET UNITYSDK_OFFSET(0xDD508F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7A097E7EF929F289_1_OFFSET UNITYSDK_OFFSET(0xDD50640)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7A097E7EF929F289_2_OFFSET UNITYSDK_OFFSET(0xDD53310)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7A097E7EF929F289_OFFSET UNITYSDK_OFFSET(0xDD542F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_7E7F03005FFBCB2E_OFFSET UNITYSDK_OFFSET(0xDD51F80)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_854CB545243705CE_OFFSET UNITYSDK_OFFSET(0xDD54010)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_881A1C0293E74A8A_OFFSET UNITYSDK_OFFSET(0xDD51380)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0xDD50D90)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_926A87EF7B2C87F9_1_OFFSET UNITYSDK_OFFSET(0xDD56DD0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_926A87EF7B2C87F9_OFFSET UNITYSDK_OFFSET(0xDD56A30)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_9AD47D8DC12F1689_OFFSET UNITYSDK_OFFSET(0xDD526F0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_9EBD28FD8FFC1A2A_OFFSET UNITYSDK_OFFSET(0xDD56F60)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_A7E8B52E9ABB8DB9_OFFSET UNITYSDK_OFFSET(0xDD55330)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_A99F72575AFE3206_OFFSET UNITYSDK_OFFSET(0xDD50C70)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_AE4D94368D34D119_OFFSET UNITYSDK_OFFSET(0xDD51670)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_B014C83A11FE985E_OFFSET UNITYSDK_OFFSET(0xDD53D60)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0xDD50250)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_B8817F4F77EFC234_OFFSET UNITYSDK_OFFSET(0xDD57090)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_C8F03EB4AC0A2737_OFFSET UNITYSDK_OFFSET(0xDD552E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_CC95B1519A868AD0_OFFSET UNITYSDK_OFFSET(0xDD51C50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_CF44BB80676FF7A6_OFFSET UNITYSDK_OFFSET(0xDD520D0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D02F0567C550BE1C_OFFSET UNITYSDK_OFFSET(0xDD50570)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D7B51E636B36E189_OFFSET UNITYSDK_OFFSET(0xDD551A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D824A072379CF8DA_OFFSET UNITYSDK_OFFSET(0xDD56180)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_D85A69A177ED1ECC_OFFSET UNITYSDK_OFFSET(0xDD56510)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DC029EEDE931ACB9_OFFSET UNITYSDK_OFFSET(0xDD543A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DE1C1F4DF5D06882_1_OFFSET UNITYSDK_OFFSET(0xDD54C40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DE1C1F4DF5D06882_2_OFFSET UNITYSDK_OFFSET(0xDD54CB0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0xDD54AC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_E08B4BAE62D9AAD5_OFFSET UNITYSDK_OFFSET(0xDD55EB0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_EBAC71FBE1837205_1_OFFSET UNITYSDK_OFFSET(0xDD51C00)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_EBAC71FBE1837205_OFFSET UNITYSDK_OFFSET(0xDD53E30)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_METHOD_6_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xDD56B40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_PICKUPBULLET_OFFSET UNITYSDK_OFFSET(0xDD50EF0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTMONSTERALERT_OFFSET UNITYSDK_OFFSET(0xDD56BD0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTMONSTERCHASE_OFFSET UNITYSDK_OFFSET(0xDD56830)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHHIDE_OFFSET UNITYSDK_OFFSET(0xDD580E0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHHIT_OFFSET UNITYSDK_OFFSET(0xDD57F50)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHLOOK_OFFSET UNITYSDK_OFFSET(0xDD57DC0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHPROPHIT_OFFSET UNITYSDK_OFFSET(0xDD53E80)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHPROP_OFFSET UNITYSDK_OFFSET(0xDD57B40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_REPORTPUSHTV_OFFSET UNITYSDK_OFFSET(0xDD58270)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_RESETACHIEVEMENTCHASE_OFFSET UNITYSDK_OFFSET(0xDD532B0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xDD50970)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_RESTOREARCHIVE_OFFSET UNITYSDK_OFFSET(0xDD52890)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_SET_CACHEDCAMERAAXIS_OFFSET UNITYSDK_OFFSET(0xDD57080)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0xDD588D0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_SHUTDOWNPUZZLE_OFFSET UNITYSDK_OFFSET(0xDD50A90)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xDD4FEB0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0xDD51DE0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_UNWAITRESTOREARCHIVE_OFFSET UNITYSDK_OFFSET(0xDD52630)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_UNWAITSTARTUP_OFFSET UNITYSDK_OFFSET(0xDD52540)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_USEBULLET_OFFSET UNITYSDK_OFFSET(0xDD50D30)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_WAITRESTOREARCHIVE_OFFSET UNITYSDK_OFFSET(0xDD525A0)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD_WAITSTARTUP_OFFSET UNITYSDK_OFFSET(0xDD52450)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD58C40)
#define RPG_CLIENT_PROP_WOLFBROPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xDD58930)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WolfBroPuzzleBoard_TypeDefinitionIndex = 78218;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7640);
		}
		static ::System::String** StaticGet_DOBADCFCODL()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7648);
		}
		static ::System::String** StaticGet_BFPPABCIJGF()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7650);
		}
		static ::System::String** StaticGet_GEIACHKCJLF()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7658);
		}
		static ::System::String** StaticGet_NJPGOEKBMGB()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7660);
		}
		static ::System::String** StaticGet_AFGHHGCPEDB()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7668);
		}
		static ::System::String** StaticGet_OPOBMKOAENH()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7670);
		}
		static ::RPG::Client::Prop::WolfBroPuzzleBoard** StaticGet__Instance_k__BackingField()
		{
			return (::RPG::Client::Prop::WolfBroPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x7678);
		}
		static ::System::UInt32* StaticGet_MBLMPINMAME()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(WolfBroPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x2020);
		}
