...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_DESTROYCAMARA_OFFSET UNITYSDK_OFFSET(0x19025F50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19026580)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_FINISHROTATESTEP_OFFSET UNITYSDK_OFFSET(0x1901D930)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_GET_PUZZLESTEP_OFFSET UNITYSDK_OFFSET(0x1902AC30)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITCAMERA_OFFSET UNITYSDK_OFFSET(0x1901F880)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITDATA_OFFSET UNITYSDK_OFFSET(0x1901DE70)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x1901DA20)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_INITVIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x19025750)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ISENABLEPUZZLEUI_OFFSET UNITYSDK_OFFSET(0x190293E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x1901FD90)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ISZERO_OFFSET UNITYSDK_OFFSET(0x190274C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_027D81190483B79F_OFFSET UNITYSDK_OFFSET(0x19027530)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_0B583D287B1D1E72_OFFSET UNITYSDK_OFFSET(0x19029D90)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0x19029190)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_22D0ADB352880F38_OFFSET UNITYSDK_OFFSET(0x190289F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_311DDAC730F6D367_OFFSET UNITYSDK_OFFSET(0x1902A930)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_3BCF0226A6CDC13B_OFFSET UNITYSDK_OFFSET(0x19027020)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x19029670)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x190231E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_5176DC743E478510_OFFSET UNITYSDK_OFFSET(0x19023370)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0x190297F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x190236D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_757507C4F0AFCAD2_OFFSET UNITYSDK_OFFSET(0x19021680)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x190200C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x190268C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x1901FDE0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0x19024BB0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_A27D06F9481FAFDB_OFFSET UNITYSDK_OFFSET(0x1901FC90)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_A977A1D96BC50369_OFFSET UNITYSDK_OFFSET(0x190290A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_AA169839CB93802A_OFFSET UNITYSDK_OFFSET(0x19020E50)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_B005DDBE7172D6E5_OFFSET UNITYSDK_OFFSET(0x19023A70)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_B2C52ACF9D9B435B_OFFSET UNITYSDK_OFFSET(0x19028C20)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x190252C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_C521AF86F7597260_OFFSET UNITYSDK_OFFSET(0x1902A4F0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_D0BD1377F2594D33_OFFSET UNITYSDK_OFFSET(0x19028AA0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x190294A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_DE52BD42C4B0B772_OFFSET UNITYSDK_OFFSET(0x190289A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_E098C2C2038255DD_OFFSET UNITYSDK_OFFSET(0x19026AC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_E67FFDAAD9BAA098_OFFSET UNITYSDK_OFFSET(0x1901FEE0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x1901FB20)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_METHOD_6_FD647A48096EB173_OFFSET UNITYSDK_OFFSET(0x19024260)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1902B040)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ONPUZZLEPREFINISH_OFFSET UNITYSDK_OFFSET(0x1902A080)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0x190264A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ROTATEX_OFFSET UNITYSDK_OFFSET(0x19020110)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ROTATEY_OFFSET UNITYSDK_OFFSET(0x190217A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_ROTATEZ_OFFSET UNITYSDK_OFFSET(0x190224C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETAIMFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902AC40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETAVATARTELEPORTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902AE40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETDOLLYZOOMSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902AD40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETROTATEPUZZLESTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902AF40)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_SETROUTEID_OFFSET UNITYSDK_OFFSET(0x1902A8E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_STARTAIM_OFFSET UNITYSDK_OFFSET(0x19025080)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0x1901E4C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_TICKPUZZLE_OFFSET UNITYSDK_OFFSET(0x190276C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETAIMFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902ACC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETAVATARTELEPORTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902AEC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETDOLLYZOOMSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902ADC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UNSETROTATEPUZZLESTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1902AFC0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD_UPDATEALLPARAMETER_OFFSET UNITYSDK_OFFSET(0x1901D980)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1902B2C0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1902B180)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISHIMMEDIATELY_B__114_0_OFFSET UNITYSDK_OFFSET(0x1902B3D0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISHIMMEDIATELY_B__114_1_OFFSET UNITYSDK_OFFSET(0x1902B720)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISH_B__115_0_OFFSET UNITYSDK_OFFSET(0x1902B730)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONAIMFINISH_B__115_1_OFFSET UNITYSDK_OFFSET(0x1902B9A0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__ONHACKDEVICEPUZZLEFINISH_B__122_0_OFFSET UNITYSDK_OFFSET(0x1902B9B0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEBOARD__TICKPUZZLE_B__105_1_OFFSET UNITYSDK_OFFSET(0x1902B3C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleBoard_TypeDefinitionIndex = 74624;
	...
	public:
		...
		{
			return (::RPG::Client::Prop::FastDeliverPuzzleBoard**)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3040);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_Field_6_1()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3048);
		}
		static ::System::String** StaticGet__GameKey()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x3050);
		}
		static ::System::Int32* StaticGet_Field_6_3()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FastDeliverPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x23F0);
		}
		...
		::Class_0_16E4307DCC419505_997* Field_6_17; // 0xB8
