...
#define RPG_CLIENT_PROP_CHIMERAENTRANCECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC51FA90)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraEntranceConfig_TypeDefinitionIndex = 73002;
