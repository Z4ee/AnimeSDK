...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_CLEARSELECT_OFFSET UNITYSDK_OFFSET(0xAEE15C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETBASENORMALIZEPOS_OFFSET UNITYSDK_OFFSET(0xAEE1470)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETCOREAREA_OFFSET UNITYSDK_OFFSET(0xAEE2AC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETPILLAR_OFFSET UNITYSDK_OFFSET(0xAEE28B0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GET_SELECTPILALRCNT_OFFSET UNITYSDK_OFFSET(0xAEE2300)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xAEE0C70)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISCORESTABLE_OFFSET UNITYSDK_OFFSET(0xAEE0920)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPILLARNEARCORE_OFFSET UNITYSDK_OFFSET(0xAEE31B0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAEE0C20)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAEE2DB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHCANDIDATESELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xAEE1610)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHFINISHSTATUS_OFFSET UNITYSDK_OFFSET(0xAEE2BB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xAEE1510)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SOLVEPILLARSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xAEE2970)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xAEE32C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xAEE3470)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAEE33D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBoard_TypeDefinitionIndex = 72368;
