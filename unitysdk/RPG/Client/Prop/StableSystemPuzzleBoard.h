...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_CLEARSELECT_OFFSET UNITYSDK_OFFSET(0x17B0AC50)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETBASENORMALIZEPOS_OFFSET UNITYSDK_OFFSET(0x17B0AB00)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETCOREAREA_OFFSET UNITYSDK_OFFSET(0x17B0BD00)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETPILLAR_OFFSET UNITYSDK_OFFSET(0x17B0BB10)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GET_SELECTPILALRCNT_OFFSET UNITYSDK_OFFSET(0x17B0B6C0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0x17B0A330)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISCORESTABLE_OFFSET UNITYSDK_OFFSET(0x17B09FE0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPILLARNEARCORE_OFFSET UNITYSDK_OFFSET(0x17B0C2B0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x17B0A2E0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0x17B0BFB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHCANDIDATESELECTPILLAR_OFFSET UNITYSDK_OFFSET(0x17B0ACA0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHFINISHSTATUS_OFFSET UNITYSDK_OFFSET(0x17B0BDC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0x17B0ABA0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SOLVEPILLARSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x17B0BBB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x17B0C3C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBoard_TypeDefinitionIndex = 78400;
	...
	public:
		...
		::System::Boolean PIPLLENMLIM; // 0xA0
