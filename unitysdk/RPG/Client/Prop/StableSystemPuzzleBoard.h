...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_CLEARSELECT_OFFSET UNITYSDK_OFFSET(0xC6267F0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETBASENORMALIZEPOS_OFFSET UNITYSDK_OFFSET(0xC6266A0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETCOREAREA_OFFSET UNITYSDK_OFFSET(0xC627C10)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GETPILLAR_OFFSET UNITYSDK_OFFSET(0xC627A20)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_GET_SELECTPILALRCNT_OFFSET UNITYSDK_OFFSET(0xC6274D0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC625ED0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISCORESTABLE_OFFSET UNITYSDK_OFFSET(0xC625B80)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPILLARNEARCORE_OFFSET UNITYSDK_OFFSET(0xC628260)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC625E80)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_ONPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC627EC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHCANDIDATESELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xC626840)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_REFRESHFINISHSTATUS_OFFSET UNITYSDK_OFFSET(0xC627CD0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SELECTPILLAR_OFFSET UNITYSDK_OFFSET(0xC626740)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD_SOLVEPILLARSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xC627AC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xC628370)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xC628510)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xC628480)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBoard_TypeDefinitionIndex = 73390;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET))(this);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*, ::RPG::GameCore::TaskContext*, ::RPG::GameCore::PropInitPuzzle*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET))(this, a1, a2, a3);
		}
	};
}
