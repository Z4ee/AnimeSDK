...
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x17B26B40)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17B269C0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x17B26BD0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_GET_ISGATEOPEN_OFFSET UNITYSDK_OFFSET(0x17B26EB0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x17B26440)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_METHOD_5_983BE009C423EFE5_OFFSET UNITYSDK_OFFSET(0x17B26E60)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_METHOD_5_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x17B26C60)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_RESETGATE_OFFSET UNITYSDK_OFFSET(0x17B26AE0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_SETGATESTATE_OFFSET UNITYSDK_OFFSET(0x17B267A0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x17B26A10)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B26EC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelGateController_TypeDefinitionIndex = 78447;
