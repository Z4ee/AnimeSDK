...
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_DISABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x161276F0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16127570)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_ENABLETRIGGER_OFFSET UNITYSDK_OFFSET(0x16127780)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_GET_ISGATEOPEN_OFFSET UNITYSDK_OFFSET(0x16127A50)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x16126FF0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_METHOD_5_983BE009C423EFE5_OFFSET UNITYSDK_OFFSET(0x16127A00)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_METHOD_5_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0x16127810)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_RESETGATE_OFFSET UNITYSDK_OFFSET(0x16127690)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_SETGATESTATE_OFFSET UNITYSDK_OFFSET(0x16127350)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x161275C0)
#define RPG_CLIENT_PROP_WATERLEVELGATECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16127A60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelGateController_TypeDefinitionIndex = 74962;
