...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECUBEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAE4FBF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleCubeData_TypeDefinitionIndex = 72180;
