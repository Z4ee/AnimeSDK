...
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_BLOCKCOORD2LOCALPOS_OFFSET UNITYSDK_OFFSET(0xA0B9920)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_CLEARALLMOVEALBEITEMS_OFFSET UNITYSDK_OFFSET(0xA0B9B20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_CREATEMOVEABLEITEMFROMUI_OFFSET UNITYSDK_OFFSET(0xA0B8960)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0B3CD0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_FRAMEPOS2LOCALPOS_OFFSET UNITYSDK_OFFSET(0xA0BCDB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETACTIVEITEM_OFFSET UNITYSDK_OFFSET(0xA0B8910)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETCLAMPEDPOINT_OFFSET UNITYSDK_OFFSET(0xA0B73A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETINBOXITEMSCOUNT_OFFSET UNITYSDK_OFFSET(0xA0B9E70)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_GETINBOXITEMS_OFFSET UNITYSDK_OFFSET(0xA0B9BC0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0AFD40)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ISCURSORACTIVE_OFFSET UNITYSDK_OFFSET(0xA0B2F30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA0B3C80)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ISVERTICALMODE_OFFSET UNITYSDK_OFFSET(0xA0B88C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0B12F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LOADJIGSAWCONFIG_OFFSET UNITYSDK_OFFSET(0xA0B0310)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LOCALPOS2BLOCKCOORD_OFFSET UNITYSDK_OFFSET(0xA0B9850)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_LOCALPOS2FRAMEPOS_OFFSET UNITYSDK_OFFSET(0xA0BCD20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERJOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0xA0B5020)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0xA0B5400)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0xA0B5A60)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0xA0B5460)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSMENU_OFFSET UNITYSDK_OFFSET(0xA0B60B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONCONTROLLERPRESSX_OFFSET UNITYSDK_OFFSET(0xA0B5CA0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONDRAGGINGITEMBEGIN_OFFSET UNITYSDK_OFFSET(0xA0B6D20)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONDRAGGINGITEMEND_OFFSET UNITYSDK_OFFSET(0xA0B4C60)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONDRAGGINGITEM_OFFSET UNITYSDK_OFFSET(0xA0B7660)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONHOVERITEM_OFFSET UNITYSDK_OFFSET(0xA0B63B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONPUZZLEINTERACTUPDATE_OFFSET UNITYSDK_OFFSET(0xA0B1B60)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONQUIT_OFFSET UNITYSDK_OFFSET(0xA0B33A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONSELECTITEMUP_OFFSET UNITYSDK_OFFSET(0xA0B69A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0xA0B6880)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_REFRESHBOARD_OFFSET UNITYSDK_OFFSET(0xA0B7C30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_REFRESHITEMS_OFFSET UNITYSDK_OFFSET(0xA0B7F10)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_REGENBOARD_OFFSET UNITYSDK_OFFSET(0xA0B7BF0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_RELEASELASTACTIVEITEM_OFFSET UNITYSDK_OFFSET(0xA0B6CB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_RESET_OFFSET UNITYSDK_OFFSET(0xA0B0400)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_ROTATEONCE_OFFSET UNITYSDK_OFFSET(0xA0B9B70)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETACTIVEITEM_OFFSET UNITYSDK_OFFSET(0xA0B56C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETANIMATORSENABLE_OFFSET UNITYSDK_OFFSET(0xA0B0640)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETCURSORACTIVE_OFFSET UNITYSDK_OFFSET(0xA0B4A00)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETCURSORVISIBLE_OFFSET UNITYSDK_OFFSET(0xA0B7B10)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xA0B4550)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETINNERUIRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA0B9FB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETINTERACTON_OFFSET UNITYSDK_OFFSET(0xA0B3700)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SETUIRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA0B9F60)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SHOWDEFAULTCURSOR_OFFSET UNITYSDK_OFFSET(0xA0B4770)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_SHOWJOYSTICKCURSOR_OFFSET UNITYSDK_OFFSET(0xA0B99D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0B07E0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_TRYAUTOABSORBITEM_OFFSET UNITYSDK_OFFSET(0xA0B6FB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD_TRYHIGHLIGHTCURSOR_OFFSET UNITYSDK_OFFSET(0xA0B2FA0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xA0BD010)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CHECKISGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xA0BB030)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CONFIGBOARDITEM_OFFSET UNITYSDK_OFFSET(0xA0BA230)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA0BCE40)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__FOLLOWATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xA0B18B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__GETBOARDITEM_OFFSET UNITYSDK_OFFSET(0xA0BA580)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__GETMOVEABLEITEM_OFFSET UNITYSDK_OFFSET(0xA0BA910)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__GETSUCCESSITEM_OFFSET UNITYSDK_OFFSET(0xA0BA670)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HASFULLNEIGHBOURBOARDITEM_OFFSET UNITYSDK_OFFSET(0xA0BACB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HIDEOUTLINE_OFFSET UNITYSDK_OFFSET(0xA0BC0F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HIGHLIGHTPUZZLEBOARD_OFFSET UNITYSDK_OFFSET(0xA0B1060)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__HIGHLIGHTROATETIP_OFFSET UNITYSDK_OFFSET(0xA0B9790)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__INITBACKGROUNDHINT_OFFSET UNITYSDK_OFFSET(0xA0B8260)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__INITDISSOLVEPARAMS_OFFSET UNITYSDK_OFFSET(0xA0BB7A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__INITFRAMERECTS_OFFSET UNITYSDK_OFFSET(0xA0B0BF0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISFULLBOARDITEM_OFFSET UNITYSDK_OFFSET(0xA0BABB0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISINAUTOABSORBAREA_OFFSET UNITYSDK_OFFSET(0xA0B29E0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISINBOARDAREA_OFFSET UNITYSDK_OFFSET(0xA0B2EA0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISMOVEABLEITEMALREADYCREATED_OFFSET UNITYSDK_OFFSET(0xA0B9120)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISSHAPEMATCH_OFFSET UNITYSDK_OFFSET(0xA0BAF30)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ISTARGETFULL_OFFSET UNITYSDK_OFFSET(0xA0BAC40)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__JIGSAWPUZZLEBEGINDATAREPORT_OFFSET UNITYSDK_OFFSET(0xA0B11B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__JIGSAWPUZZLEENDDATAREPORT_OFFSET UNITYSDK_OFFSET(0xA0B3940)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOADBOARDEFFECT_OFFSET UNITYSDK_OFFSET(0xA0B0CD0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOADCURSORITEM_OFFSET UNITYSDK_OFFSET(0xA0B7860)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOADSUCCESSEFFECT_OFFSET UNITYSDK_OFFSET(0xA0BB280)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOCALPOS2SCREENPOS_OFFSET UNITYSDK_OFFSET(0xA0B5790)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__LOCALPOS2WORLDPOS_OFFSET UNITYSDK_OFFSET(0xA0BCB70)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONARTMODELLOAD_OFFSET UNITYSDK_OFFSET(0xA0BA0D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONARTMODELUNLOAD_OFFSET UNITYSDK_OFFSET(0xA0BA180)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONCONTROLLERPRESSX_B__14_0_OFFSET UNITYSDK_OFFSET(0xA0BD0C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONEVENT_OFFSET UNITYSDK_OFFSET(0xA0B4170)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONGAMEFINISH_OFFSET UNITYSDK_OFFSET(0xA0BB160)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONNOTIFYSWITCHTOJOYSTICK_OFFSET UNITYSDK_OFFSET(0xA0B4590)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONSETFINISHPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0B44D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__OVERRIDEARTMODELPOSEANIMATION_OFFSET UNITYSDK_OFFSET(0xA0B83F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__PLAYDISSOLVECURVEANIMATION_OFFSET UNITYSDK_OFFSET(0xA0BC630)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__PLAYOUTLINEFADEANIAMTION_OFFSET UNITYSDK_OFFSET(0xA0B4370)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__REFRESHMOVEITEMSRENDERORDER_OFFSET UNITYSDK_OFFSET(0xA0BB5B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RESETARTMODELPOSEANIMATION_OFFSET UNITYSDK_OFFSET(0xA0B4010)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RETURNALLITEMSTOUIBOX_OFFSET UNITYSDK_OFFSET(0xA0B6170)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RETURNCURSORTOUIBOX_OFFSET UNITYSDK_OFFSET(0xA0B5C40)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__RETURNITEMTOUIBOX_OFFSET UNITYSDK_OFFSET(0xA0B2880)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETBOARDDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0xA0BC2C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETBOARDOUTLINEOFFSET_OFFSET UNITYSDK_OFFSET(0xA0BC820)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETDISSOLVEPROGRESS_OFFSET UNITYSDK_OFFSET(0xA0B1600)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETFRAMEDISSOLVERATE_OFFSET UNITYSDK_OFFSET(0xA0BC4A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SETMOVEABLEITEMORDER2TOP_OFFSET UNITYSDK_OFFSET(0xA0B67C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__SHOWJOYSTICKCURSOR_OFFSET UNITYSDK_OFFSET(0xA0B58D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRIGGEROUTLINEFADEPERFORM_OFFSET UNITYSDK_OFFSET(0xA0BCA00)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRYAUTOABSORBPENDINGITEMS_OFFSET UNITYSDK_OFFSET(0xA0BA000)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRYGETBOARDLOCALPOS_OFFSET UNITYSDK_OFFSET(0xA0B92F0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__TRYUPDATECURLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xA0B5340)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__WORLDPOS2SCREENPOS_OFFSET UNITYSDK_OFFSET(0xA0BCC40)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA0BD2B0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0BD110)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA0BD210)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_LATEUPDATEPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0BD180)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONCONTROLLERJOYSTICKINPUT_OFFSET UNITYSDK_OFFSET(0xA0BD2C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONCONTROLLERJOYSTICKRELEASE_OFFSET UNITYSDK_OFFSET(0xA0BD2D0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0xA0BD380)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0xA0BD320)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONCONTROLLERPRESSMENU_OFFSET UNITYSDK_OFFSET(0xA0BD400)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONCONTROLLERPRESSX_OFFSET UNITYSDK_OFFSET(0xA0BD3C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONDRAGGINGITEMBEGIN_OFFSET UNITYSDK_OFFSET(0xA0BD5C0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONDRAGGINGITEMEND_OFFSET UNITYSDK_OFFSET(0xA0BD6A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONDRAGGINGITEM_OFFSET UNITYSDK_OFFSET(0xA0BD780)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONHOVERITEM_OFFSET UNITYSDK_OFFSET(0xA0BD440)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONPUZZLEINTERACTUPDATE_OFFSET UNITYSDK_OFFSET(0xA0BD200)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONSELECTITEMUP_OFFSET UNITYSDK_OFFSET(0xA0BD510)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_ONSELECTITEM_OFFSET UNITYSDK_OFFSET(0xA0BD4A0)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA0BD120)
#define RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD___ONEVENT_B__7_0_OFFSET UNITYSDK_OFFSET(0xA0BD040)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int JigsawPuzzleBoard_TypeDefinitionIndex = 64099;
	...
	public:
		...
		{
			return (::RPG::Client::JigsawCommonConfig**)Il2CppClass::FromTypeDefinitionIndex(JigsawPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x30FE0);
		}
		static ::System::String** StaticGet__Gamekey()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(JigsawPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x30FE8);
		}
		static ::System::String** StaticGet_JIGSAW_CONFIG_PATH()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(JigsawPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x30FF0);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_375*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_JIGSAWPUZZLEBOARD__ONEVENT_OFFSET))(this, pEvent);
		}
