...
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER_METHOD_5_25DEA5C65A602671_OFFSET UNITYSDK_OFFSET(0xADE92D0)
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xADE9450)
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER_START_OFFSET UNITYSDK_OFFSET(0xADE9280)
#define RPG_CLIENT_PROP_CHIMERAVIEWBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0xADE97A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraViewBuilder_TypeDefinitionIndex = 72001;
