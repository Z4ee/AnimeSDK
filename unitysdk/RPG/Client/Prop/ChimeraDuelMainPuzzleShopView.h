...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW_ADD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xA054730)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW_GETTEAMMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0xA055160)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW_REMOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xA055010)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xA055100)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLESHOPVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA055210)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleShopView_TypeDefinitionIndex = 63838;
