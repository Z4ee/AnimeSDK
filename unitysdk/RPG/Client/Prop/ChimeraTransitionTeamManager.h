...
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_FILLPOSITION_OFFSET UNITYSDK_OFFSET(0xC52C3D0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xC52C1A0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC52D250)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_RUN_OFFSET UNITYSDK_OFFSET(0xC52CB10)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_STARTTRANSITION_OFFSET UNITYSDK_OFFSET(0xC52C580)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONBETWEENAREAS_OFFSET UNITYSDK_OFFSET(0xC52C1F0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONTO_OFFSET UNITYSDK_OFFSET(0xC52C760)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC52CCD0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC52D4D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraTransitionTeamManager_TypeDefinitionIndex = 72950;

	class ChimeraTransitionTeamManager : public ::UnityEngine::MonoBehaviour
	{
	public:
		::RPG::Client::Prop::ChimeraBattlePuzzleBoard* Field_5_0; // 0x18
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1203*>* Field_5_1; // 0x20
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1203*>* Field_5_2; // 0x28
