...
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_FILLPOSITION_OFFSET UNITYSDK_OFFSET(0xA069620)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xA069460)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA06A2D0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_RUN_OFFSET UNITYSDK_OFFSET(0xA069BF0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_STARTTRANSITION_OFFSET UNITYSDK_OFFSET(0xA069760)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONBETWEENAREAS_OFFSET UNITYSDK_OFFSET(0xA0694B0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONTO_OFFSET UNITYSDK_OFFSET(0xA0698D0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA069D40)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA06A540)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraTransitionTeamManager_TypeDefinitionIndex = 63881;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1018*>* Field_5_1; // 0x20
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1018*>* Field_5_2; // 0x28
