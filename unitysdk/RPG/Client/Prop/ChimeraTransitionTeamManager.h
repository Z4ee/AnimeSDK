...
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_FILLPOSITION_OFFSET UNITYSDK_OFFSET(0xADE7EC0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_INIT_OFFSET UNITYSDK_OFFSET(0xADE7D00)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xADE8B70)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_RUN_OFFSET UNITYSDK_OFFSET(0xADE8490)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_STARTTRANSITION_OFFSET UNITYSDK_OFFSET(0xADE8000)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONBETWEENAREAS_OFFSET UNITYSDK_OFFSET(0xADE7D50)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_TRANSITIONTO_OFFSET UNITYSDK_OFFSET(0xADE8170)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0xADE85E0)
#define RPG_CLIENT_PROP_CHIMERATRANSITIONTEAMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xADE8DE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraTransitionTeamManager_TypeDefinitionIndex = 71928;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1147*>* Field_5_1; // 0x20
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_1147*>* Field_5_2; // 0x28
