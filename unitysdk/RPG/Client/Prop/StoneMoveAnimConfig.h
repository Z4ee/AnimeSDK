...
#define RPG_CLIENT_PROP_STONEMOVEANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAEE48C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StoneMoveAnimConfig_TypeDefinitionIndex = 72020;
