...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTFADEIN_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xDBE8D50)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTFADEIN_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xDBE95A0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTFADEIN_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xDBE9600)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTFADEIN_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xDBE95B0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTFADEIN_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDBE8D40)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEM__STARTFADEIN_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0xDBE85C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItem__StartFadeIn_d__7_TypeDefinitionIndex = 78379;
