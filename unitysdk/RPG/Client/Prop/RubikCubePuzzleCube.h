...
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ANIMROTATEANYANGLE_OFFSET UNITYSDK_OFFSET(0xC61E760)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ANIMROTATE_OFFSET UNITYSDK_OFFSET(0xC61F530)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_CANCELALLSELECT_OFFSET UNITYSDK_OFFSET(0xC61E410)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_CONDITIONGROUPSETANIMATIONFINISH_OFFSET UNITYSDK_OFFSET(0xC610B90)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC61ADC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GETCENTEROID_OFFSET UNITYSDK_OFFSET(0xC61F170)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GETGROUP_OFFSET UNITYSDK_OFFSET(0xC61DEE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GET_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0xC620BC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GET_ISDRAG_OFFSET UNITYSDK_OFFSET(0xC620BA0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_GET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xC620B80)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_INITCUBE_OFFSET UNITYSDK_OFFSET(0xC60B350)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_INITSECONDORDER_OFFSET UNITYSDK_OFFSET(0xC619C60)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_2CB2A75807271EAA_OFFSET UNITYSDK_OFFSET(0xC61F660)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xC620B20)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xC61FDD0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_METHOD_5_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0xC61B1A0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xC61FF70)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ONROTATESTART_OFFSET UNITYSDK_OFFSET(0xC61FB10)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ONSTOPDRAG_OFFSET UNITYSDK_OFFSET(0xC61E620)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_PLAYROTATESOUND_OFFSET UNITYSDK_OFFSET(0xC6193C0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REFRESHALLFRAMESTATUS_OFFSET UNITYSDK_OFFSET(0xC60BC40)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERFRAME_1_OFFSET UNITYSDK_OFFSET(0xC610CF0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERFRAME_OFFSET UNITYSDK_OFFSET(0xC61B3B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xC60DFE0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_REGISTERSWITCH_OFFSET UNITYSDK_OFFSET(0xC61B2D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_RESETCUBE_OFFSET UNITYSDK_OFFSET(0xC6195D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ROTATEX_OFFSET UNITYSDK_OFFSET(0xC61B490)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ROTATEY_OFFSET UNITYSDK_OFFSET(0xC61C290)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_ROTATEZ_OFFSET UNITYSDK_OFFSET(0xC61CFC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SDKREPORTPLAYERACION_OFFSET UNITYSDK_OFFSET(0xC61F700)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SELECTBRICK_OFFSET UNITYSDK_OFFSET(0xC6187D0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SELECTGROUPTEST_OFFSET UNITYSDK_OFFSET(0xC61E5B0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SELECTGROUP_OFFSET UNITYSDK_OFFSET(0xC61DD50)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SETBLOCKSELECT_OFFSET UNITYSDK_OFFSET(0xC619BC0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SET_ISDRAG_OFFSET UNITYSDK_OFFSET(0xC620BB0)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_SET_ISROTATE_OFFSET UNITYSDK_OFFSET(0xC620B90)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE_UNREGISTERROTATEFINISHCALLBACK_OFFSET UNITYSDK_OFFSET(0xC60E270)
#define RPG_CLIENT_PROP_RUBIKCUBEPUZZLECUBE__CTOR_OFFSET UNITYSDK_OFFSET(0xC620D10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RubikCubePuzzleCube_TypeDefinitionIndex = 73351;
