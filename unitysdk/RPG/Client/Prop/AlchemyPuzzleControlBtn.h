...
#define RPG_CLIENT_PROP_ALCHEMYPUZZLECONTROLBTN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE33240)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AlchemyPuzzleControlBtn_TypeDefinitionIndex = 77736;
