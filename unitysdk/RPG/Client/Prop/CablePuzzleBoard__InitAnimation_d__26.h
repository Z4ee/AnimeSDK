...
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xADA8090)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADA8B20)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xADA8B80)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xADA8B30)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADA8080)
#define RPG_CLIENT_PROP_CABLEPUZZLEBOARD__INITANIMATION_D__26__CTOR_OFFSET UNITYSDK_OFFSET(0xADA6B10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int CablePuzzleBoard__InitAnimation_d__26_TypeDefinitionIndex = 72101;
