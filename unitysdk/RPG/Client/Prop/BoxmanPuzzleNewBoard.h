...
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_DESTROYINTERACTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xAD9E640)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADA1A50)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_INITITEMS_OFFSET UNITYSDK_OFFSET(0xAD9C300)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xAD9E3D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xAD9C2B0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_01509228E3A9577B_OFFSET UNITYSDK_OFFSET(0xADA0380)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_0946D2F262750751_OFFSET UNITYSDK_OFFSET(0xADA0300)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0xAD9E5C0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_61019C706ABBB921_OFFSET UNITYSDK_OFFSET(0xADA08B0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_6F826D2C1894C968_OFFSET UNITYSDK_OFFSET(0xADA0A40)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_82DA7C9763B3C65E_OFFSET UNITYSDK_OFFSET(0xADA0E00)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_86EBD5D37B0318E4_OFFSET UNITYSDK_OFFSET(0xAD9E810)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xADA0270)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xADA01D0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9AB55F553C4AC6E8_OFFSET UNITYSDK_OFFSET(0xADA0B70)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_9CA35E5BF1A50E77_OFFSET UNITYSDK_OFFSET(0xADA0980)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_METHOD_8_B8817F4F77EFC234_OFFSET UNITYSDK_OFFSET(0xADA0070)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_ONINTERACTTARGETFINISH_OFFSET UNITYSDK_OFFSET(0xADA0EC0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xADA0E70)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_RECOVERFROMPUZZLESTATE_OFFSET UNITYSDK_OFFSET(0xAD9DCF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xADA0FF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_UPDATE_OFFSET UNITYSDK_OFFSET(0xAD9EA30)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xADA1E20)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xADA1D10)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xADA1FB0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_INITITEMS_OFFSET UNITYSDK_OFFSET(0xADA1ED0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_INITOPTIONS_OFFSET UNITYSDK_OFFSET(0xADA1EF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xADA1E60)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_ONITEMMOVEFINISH_OFFSET UNITYSDK_OFFSET(0xADA1F10)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_RECOVERFROMPUZZLESTATE_OFFSET UNITYSDK_OFFSET(0xADA1EE0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xADA1FA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xADA1F00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleNewBoard_TypeDefinitionIndex = 72349;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(BoxmanPuzzleNewBoard_TypeDefinitionIndex)->GetStaticField(0x2960);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_185*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD_RECOVERFROMPUZZLESTATE_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_43BD383C98B4C0C5_185*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_BOXMANPUZZLENEWBOARD___IFIXBASEPROXY_RECOVERFROMPUZZLESTATE_OFFSET))(this, P0);
		}
