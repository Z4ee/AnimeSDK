...
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_DRAWHINTCONNECTION_OFFSET UNITYSDK_OFFSET(0xA076420)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_METHOD_5_2DD8EB2A8AB21975_OFFSET UNITYSDK_OFFSET(0xA07ABD0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_METHOD_5_808A56A256840289_OFFSET UNITYSDK_OFFSET(0xA07A980)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_ONINIT_OFFSET UNITYSDK_OFFSET(0xA074610)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_ONPUZZLEDESTROY_OFFSET UNITYSDK_OFFSET(0xA0780F0)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_ROTATESUBOBJECT_OFFSET UNITYSDK_OFFSET(0xA078E90)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_TRIGGERHINTLINERENDERSFADEOUT_OFFSET UNITYSDK_OFFSET(0xA079560)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_UPDATE_OFFSET UNITYSDK_OFFSET(0xA07A920)
#define RPG_CLIENT_PROP_DEPLOYPUZZLEHINT__CTOR_OFFSET UNITYSDK_OFFSET(0xA07AD60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int DeployPuzzleHint_TypeDefinitionIndex = 63984;
	...
	public:
		...
		::System::Void Method_5_2DD8EB2A8AB21975(::System::Single a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_DEPLOYPUZZLEHINT_METHOD_5_2DD8EB2A8AB21975_OFFSET))(this, a1);
		}
