...
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xDD477E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xDD47AC0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xDD47970)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xDD474E0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xDD47BF0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_RESET_OFFSET UNITYSDK_OFFSET(0xDD47BA0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xDD47870)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD47D50)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xDD47D40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxItem_TypeDefinitionIndex = 78441;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxItem_TypeDefinitionIndex)->GetStaticField(0x150A0);
		}
