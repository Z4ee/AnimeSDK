...
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0xA1766A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0xA176980)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0xA176830)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_MOVE_OFFSET UNITYSDK_OFFSET(0xA1763A0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0xA176AB0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_RESET_OFFSET UNITYSDK_OFFSET(0xA176A60)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0xA176730)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xA176C10)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA176C00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxItem_TypeDefinitionIndex = 64361;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxItem_TypeDefinitionIndex)->GetStaticField(0x4370);
		}
