...
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_8FA0679D147955F9_OFFSET UNITYSDK_OFFSET(0x17B213B0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x17B21690)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_METHOD_5_F9725EED05F07EC1_OFFSET UNITYSDK_OFFSET(0x17B21540)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_MOVE_OFFSET UNITYSDK_OFFSET(0x17B210B0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_REFERSHPOSITION_OFFSET UNITYSDK_OFFSET(0x17B217C0)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_RESET_OFFSET UNITYSDK_OFFSET(0x17B21770)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM_SETBOXSELECT_OFFSET UNITYSDK_OFFSET(0x17B21440)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B21920)
#define RPG_CLIENT_PROP_WATERLEVELBOXITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17B21910)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int WaterLevelBoxItem_TypeDefinitionIndex = 78440;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(WaterLevelBoxItem_TypeDefinitionIndex)->GetStaticField(0x14EB0);
		}
		...
		::UnityEngine::Vector3 OODFLGPMAKO; // 0x44
