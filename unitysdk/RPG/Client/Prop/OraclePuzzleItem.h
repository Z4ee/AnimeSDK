...
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1660DEB0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETCENTERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x1660EBD0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETRASTERSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0x1660EC90)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0x1660EF80)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ISPINNED_OFFSET UNITYSDK_OFFSET(0x1660F480)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_METHOD_6_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0x1660E860)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_MOVETOPINNEDPOS_OFFSET UNITYSDK_OFFSET(0x1660F4C0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_MOVETOTARGETPOSPERFORM_OFFSET UNITYSDK_OFFSET(0x1660F5A0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONDRAGBEGIN_OFFSET UNITYSDK_OFFSET(0x1660E070)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1660E250)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONHOVEREXIT_OFFSET UNITYSDK_OFFSET(0x1660E020)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONHOVER_OFFSET UNITYSDK_OFFSET(0x1660DFD0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONSELECTUP_OFFSET UNITYSDK_OFFSET(0x1660DF90)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1660DF50)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x1660E810)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETDITHERALPHAWITHANIM_OFFSET UNITYSDK_OFFSET(0x1660F770)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x1660DD40)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1660EB80)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_STARTMOVETOANIMATION_OFFSET UNITYSDK_OFFSET(0x1660F2B0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_TICK_OFFSET UNITYSDK_OFFSET(0x1660D990)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1660FA40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleItem_TypeDefinitionIndex = 78260;
