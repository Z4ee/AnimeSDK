...
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14F07A80)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETCENTERLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x14F087A0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETRASTERSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0x14F08860)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_GETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0x14F08B50)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ISPINNED_OFFSET UNITYSDK_OFFSET(0x14F09030)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_METHOD_6_8923446497E3D0C5_OFFSET UNITYSDK_OFFSET(0x14F08430)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_MOVETOPINNEDPOS_OFFSET UNITYSDK_OFFSET(0x14F09070)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_MOVETOTARGETPOSPERFORM_OFFSET UNITYSDK_OFFSET(0x14F09150)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONDRAGBEGIN_OFFSET UNITYSDK_OFFSET(0x14F07C40)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONDRAG_OFFSET UNITYSDK_OFFSET(0x14F07E20)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONHOVEREXIT_OFFSET UNITYSDK_OFFSET(0x14F07BF0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONHOVER_OFFSET UNITYSDK_OFFSET(0x14F07BA0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONSELECTUP_OFFSET UNITYSDK_OFFSET(0x14F07B60)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_ONSELECT_OFFSET UNITYSDK_OFFSET(0x14F07B20)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x14F083E0)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETDITHERALPHAWITHANIM_OFFSET UNITYSDK_OFFSET(0x14F09320)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETDITHERALPHA_OFFSET UNITYSDK_OFFSET(0x14F07910)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0x14F08750)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_STARTMOVETOANIMATION_OFFSET UNITYSDK_OFFSET(0x14F08E80)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM_TICK_OFFSET UNITYSDK_OFFSET(0x14F07560)
#define RPG_CLIENT_PROP_ORACLEPUZZLEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x14F095E0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzleItem_TypeDefinitionIndex = 74775;
