...
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_DISABLE_OFFSET UNITYSDK_OFFSET(0xC4EF260)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC4EF0A0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_ENABLE_OFFSET UNITYSDK_OFFSET(0xC4EF0F0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_INIT_OFFSET UNITYSDK_OFFSET(0xC4EEC90)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_METHOD_5_5D9E900D04946B98_OFFSET UNITYSDK_OFFSET(0xC4EEE70)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_METHOD_5_92C4EECBB004EECB_OFFSET UNITYSDK_OFFSET(0xC4EF370)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_REGISTERTRIGGERS_OFFSET UNITYSDK_OFFSET(0xC4EECE0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA_UNREGISTERTRIGGERS_OFFSET UNITYSDK_OFFSET(0xC4EEFA0)
#define RPG_CLIENT_PROP_CHASEPUZZLEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xC4EF9D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChasePuzzleArea_TypeDefinitionIndex = 72739;
	...
	public:
		...
		::Class_0_16E4307DCC419505_542* Method_5_5D9E900D04946B98(::System::Int32 a1)
		{
			return ((::Class_0_16E4307DCC419505_542*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHASEPUZZLEAREA_METHOD_5_5D9E900D04946B98_OFFSET))(this, a1);
		}
