...
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_INITPILLARPROPS_OFFSET UNITYSDK_OFFSET(0xC5D75D0)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_METHOD_7_FEB104F83913DCF9_OFFSET UNITYSDK_OFFSET(0xC5D71C0)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR_ONPILLARHIT_OFFSET UNITYSDK_OFFSET(0xC5D78D0)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR__CTOR_OFFSET UNITYSDK_OFFSET(0xC5D7CE0)
#define RPG_CLIENT_PROP_PILLARPUZZLE_PILLARPUZZLEBOARDREVERSENEIGHBOUR___IFIXBASEPROXY_INITPILLARPROPS_OFFSET UNITYSDK_OFFSET(0xC5D7F60)

namespace RPG::Client::Prop::PillarPuzzle
{
	inline static constexpr unsigned int PillarPuzzleBoardReverseNeighbour_TypeDefinitionIndex = 73486;
