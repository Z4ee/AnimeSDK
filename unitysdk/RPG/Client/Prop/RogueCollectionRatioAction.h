...
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_METHOD_5_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0xAEB3340)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xAEB2C40)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_METHOD_5_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xAEB2D20)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAEB2C90)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_START_OFFSET UNITYSDK_OFFSET(0xAEB2A90)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION_UPDATE_OFFSET UNITYSDK_OFFSET(0xAEB2B20)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xAEB33B0)
#define RPG_CLIENT_PROP_ROGUECOLLECTIONRATIOACTION___LOADACTIONEFFECT_B__5_0_OFFSET UNITYSDK_OFFSET(0xAEB33C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RogueCollectionRatioAction_TypeDefinitionIndex = 72446;
