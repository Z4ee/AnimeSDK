...
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_GET_BLENDSOURCE_OFFSET UNITYSDK_OFFSET(0xA057890)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_GET_BLENDTARGET_OFFSET UNITYSDK_OFFSET(0xA057870)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG_METHOD_1_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0xA0578B0)
#define RPG_CLIENT_PROP_CHIMERADUELPUZZLEVIRTUALCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA057DC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelPuzzleVirtualCameraConfig_TypeDefinitionIndex = 63763;
