...
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_09124A4A24353C26_OFFSET UNITYSDK_OFFSET(0x193AA180)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_100C37D9D1141569_OFFSET UNITYSDK_OFFSET(0x193A5660)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_3DB6944F89094FEC_OFFSET UNITYSDK_OFFSET(0x193A44A0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0x193A9C30)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_6D006271A1FDA1A1_OFFSET UNITYSDK_OFFSET(0x193A90D0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B45A873CFEB6DEE0_OFFSET UNITYSDK_OFFSET(0x193A6020)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B75D122F21CFAD25_OFFSET UNITYSDK_OFFSET(0x193A4D90)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_B93DCFC57470A0D2_OFFSET UNITYSDK_OFFSET(0x193A7550)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_C3E4F3CB916E5633_OFFSET UNITYSDK_OFFSET(0x193A3B40)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_D1305BC17A89C222_OFFSET UNITYSDK_OFFSET(0x193A34B0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_D4248573D6F716B1_OFFSET UNITYSDK_OFFSET(0x193A7810)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_F026F9F94BAA5E1F_1_OFFSET UNITYSDK_OFFSET(0x193A7660)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE_METHOD_1_F026F9F94BAA5E1F_OFFSET UNITYSDK_OFFSET(0x193A7600)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x193AA230)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE___REGENERATENOREUSE_B__11_0_OFFSET UNITYSDK_OFFSET(0x193AA2E0)
#define RPG_CLIENT_PROP_ADJUSTCONTAINER_CONTAINERINSTANCE___REGENERATENOREUSE_B__11_1_OFFSET UNITYSDK_OFFSET(0x193AA2F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int AdjustContainer_ContainerInstance_TypeDefinitionIndex = 74238;
