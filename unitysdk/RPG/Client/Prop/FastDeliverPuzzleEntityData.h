...
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEENTITYDATA_GET_ISROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xA098DA0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEENTITYDATA_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xA0988E0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEENTITYDATA_SET_ISROTATEFINISH_OFFSET UNITYSDK_OFFSET(0xA098DB0)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEENTITYDATA_STARTROTATE_OFFSET UNITYSDK_OFFSET(0xA098400)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEENTITYDATA_TICK_OFFSET UNITYSDK_OFFSET(0xA098940)
#define RPG_CLIENT_PROP_FASTDELIVERPUZZLEENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA098DC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int FastDeliverPuzzleEntityData_TypeDefinitionIndex = 64036;
