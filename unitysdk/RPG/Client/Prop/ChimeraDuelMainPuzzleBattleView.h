...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA04AA00)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETALLYMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0xA04D3C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETENEMYMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0xA04D400)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETMASTERANCHOR_OFFSET UNITYSDK_OFFSET(0xA04D440)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETMASTERTALKANCHOR_OFFSET UNITYSDK_OFFSET(0xA04CDE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXIES_OFFSET UNITYSDK_OFFSET(0xA04AD90)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXYLIST_OFFSET UNITYSDK_OFFSET(0xA04D240)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXY_OFFSET UNITYSDK_OFFSET(0xA04D2C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GET_ALLYMASTERID_OFFSET UNITYSDK_OFFSET(0xA04A7A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GET_ENEMYMASTERID_OFFSET UNITYSDK_OFFSET(0xA04A7B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADCHIMERAWITHANCHOR_OFFSET UNITYSDK_OFFSET(0xA04AE70)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADCHIMERA_OFFSET UNITYSDK_OFFSET(0xA04B710)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADMASTERGROUP_OFFSET UNITYSDK_OFFSET(0xA04C6C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_34174C70D4D8D91A_OFFSET UNITYSDK_OFFSET(0xA04A610)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_45BB10B1B69F1922_OFFSET UNITYSDK_OFFSET(0xA04B210)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_651389C8EB0A0E71_OFFSET UNITYSDK_OFFSET(0xA04C350)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_921FC9B720328DC4_OFFSET UNITYSDK_OFFSET(0xA04D4A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_99ABFE8933D176BE_OFFSET UNITYSDK_OFFSET(0xA04B670)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_BE3D392B274FB7D7_OFFSET UNITYSDK_OFFSET(0xA04CBC0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_D9CE4FE9E294B1B7_OFFSET UNITYSDK_OFFSET(0xA04B300)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_REMOVEPROXY_OFFSET UNITYSDK_OFFSET(0xA04D340)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_REORDER_OFFSET UNITYSDK_OFFSET(0xA04B7B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_RESET_OFFSET UNITYSDK_OFFSET(0xA04CE60)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_START_OFFSET UNITYSDK_OFFSET(0xA04A7C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UNLOADMASTERGROUP_OFFSET UNITYSDK_OFFSET(0xA04C640)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UNLOADMASTERNPCMODEL_OFFSET UNITYSDK_OFFSET(0xA04A0E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xA04A9A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xA04D570)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__GETPROXIES_B__29_0_OFFSET UNITYSDK_OFFSET(0xA04D6D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA04D730)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleBattleView_TypeDefinitionIndex = 63820;
	...
	public:
		...
		::System::Void Method_6_45BB10B1B69F1922(::RPG::Client::Prop::DuelChimeraProxy* a1)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::Prop::DuelChimeraProxy*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_45BB10B1B69F1922_OFFSET))(this, a1);
		}
		...
		::RPG::Client::Prop::DuelChimeraProxy* _GetProxies_b__29_0(::System::Int32 uid)
		{
			return ((::RPG::Client::Prop::DuelChimeraProxy*(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__GETPROXIES_B__29_0_OFFSET))(this, uid);
		}
