...
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_DISPOSE_OFFSET UNITYSDK_OFFSET(0x189E90A0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETALLYMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0x189EC010)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETENEMYMEMBERSLOTS_OFFSET UNITYSDK_OFFSET(0x189EC050)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETMASTERANCHOR_OFFSET UNITYSDK_OFFSET(0x189EC090)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETMASTERTALKANCHOR_OFFSET UNITYSDK_OFFSET(0x189EB840)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXIES_OFFSET UNITYSDK_OFFSET(0x189E95E0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXYLIST_OFFSET UNITYSDK_OFFSET(0x189EBE20)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GETPROXY_OFFSET UNITYSDK_OFFSET(0x189EBEA0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GET_ALLYMASTERID_OFFSET UNITYSDK_OFFSET(0x189E8E80)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_GET_ENEMYMASTERID_OFFSET UNITYSDK_OFFSET(0x189E8E90)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADCHIMERAWITHANCHOR_OFFSET UNITYSDK_OFFSET(0x189E96D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADCHIMERA_OFFSET UNITYSDK_OFFSET(0x189E9FE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_LOADMASTERGROUP_OFFSET UNITYSDK_OFFSET(0x189EAFE0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_34174C70D4D8D91A_OFFSET UNITYSDK_OFFSET(0x189E8D10)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_651389C8EB0A0E71_OFFSET UNITYSDK_OFFSET(0x189EAC60)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_7BAF473253F09AFA_OFFSET UNITYSDK_OFFSET(0x189E9AA0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_921FC9B720328DC4_OFFSET UNITYSDK_OFFSET(0x189EC0F0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_99ABFE8933D176BE_OFFSET UNITYSDK_OFFSET(0x189E9F40)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_BE3D392B274FB7D7_OFFSET UNITYSDK_OFFSET(0x189EB630)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_METHOD_6_D9CE4FE9E294B1B7_OFFSET UNITYSDK_OFFSET(0x189E9BD0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_REMOVEPROXY_OFFSET UNITYSDK_OFFSET(0x189EBF70)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_REORDER_OFFSET UNITYSDK_OFFSET(0x189EA0B0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x189EB8C0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_START_OFFSET UNITYSDK_OFFSET(0x189E8EA0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UNLOADMASTERGROUP_OFFSET UNITYSDK_OFFSET(0x189EAF60)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UNLOADMASTERNPCMODEL_OFFSET UNITYSDK_OFFSET(0x189E8540)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x189E9040)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x189EC1D0)
#define RPG_CLIENT_PROP_CHIMERADUELMAINPUZZLEBATTLEVIEW__GETPROXIES_B__29_0_OFFSET UNITYSDK_OFFSET(0x189EC330)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelMainPuzzleBattleView_TypeDefinitionIndex = 77899;
