...
#define RPG_CLIENT_PROP_OPTICALILLUSIONCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x161302A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OpticalIllusionCamera_TypeDefinitionIndex = 78229;
