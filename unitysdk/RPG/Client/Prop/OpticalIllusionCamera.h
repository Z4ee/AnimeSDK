...
#define RPG_CLIENT_PROP_OPTICALILLUSIONCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC5A0C20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OpticalIllusionCamera_TypeDefinitionIndex = 73219;
