...
#define RPG_CLIENT_PROP_CHIMERAJUMPTEXTSHOWPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8EEB10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraJumpTextShowParam_TypeDefinitionIndex = 77947;
