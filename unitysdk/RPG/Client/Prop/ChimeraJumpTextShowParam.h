...
#define RPG_CLIENT_PROP_CHIMERAJUMPTEXTSHOWPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xADE3050)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraJumpTextShowParam_TypeDefinitionIndex = 71915;
