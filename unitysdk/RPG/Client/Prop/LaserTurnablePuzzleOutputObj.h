...
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEOUTPUTOBJ_SETLASERVISIBLE_OFFSET UNITYSDK_OFFSET(0xA0C2E60)
#define RPG_CLIENT_PROP_LASERTURNABLEPUZZLEOUTPUTOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C31F0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LaserTurnablePuzzleOutputObj_TypeDefinitionIndex = 64117;
