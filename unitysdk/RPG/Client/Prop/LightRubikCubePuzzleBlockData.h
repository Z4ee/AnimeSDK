...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLEBLOCKDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C67D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleBlockData_TypeDefinitionIndex = 64126;
