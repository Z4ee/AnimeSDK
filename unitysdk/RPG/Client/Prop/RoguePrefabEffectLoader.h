...
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_4529D5FBB820A524_OFFSET UNITYSDK_OFFSET(0xA137450)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xA136FF0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_E48346E1F8A611CB_OFFSET UNITYSDK_OFFSET(0xA137220)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA137180)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA137130)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_START_OFFSET UNITYSDK_OFFSET(0xA136FA0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xA137710)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER___ACTIVEEFFECT_B__3_0_OFFSET UNITYSDK_OFFSET(0xA137740)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER___GETEFFECTPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0xA1377A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RoguePrefabEffectLoader_TypeDefinitionIndex = 64406;
