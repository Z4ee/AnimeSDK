...
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_4529D5FBB820A524_OFFSET UNITYSDK_OFFSET(0xDD08AA0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xDD08620)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_METHOD_5_E48346E1F8A611CB_OFFSET UNITYSDK_OFFSET(0xDD08860)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xDD087C0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDD08770)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER_START_OFFSET UNITYSDK_OFFSET(0xDD085D0)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0xDD08D60)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER___ACTIVEEFFECT_B__3_0_OFFSET UNITYSDK_OFFSET(0xDD08D90)
#define RPG_CLIENT_PROP_ROGUEPREFABEFFECTLOADER___GETEFFECTPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0xDD08DF0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RoguePrefabEffectLoader_TypeDefinitionIndex = 78486;
