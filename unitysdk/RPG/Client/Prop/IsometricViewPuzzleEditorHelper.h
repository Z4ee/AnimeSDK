...
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEEDITORHELPER_ADJUST_OFFSET UNITYSDK_OFFSET(0xA0AE740)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEEDITORHELPER_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0xA0AE3F0)
#define RPG_CLIENT_PROP_ISOMETRICVIEWPUZZLEEDITORHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA0AEB00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int IsometricViewPuzzleEditorHelper_TypeDefinitionIndex = 64092;
