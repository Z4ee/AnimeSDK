...
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_CREATEFACTORY_OFFSET UNITYSDK_OFFSET(0xDC0B020)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0xDC0B150)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_ARG_OFFSET UNITYSDK_OFFSET(0xDC0B240)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xDC0B260)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xDC0B2C0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_SKILLID_OFFSET UNITYSDK_OFFSET(0xDC0B2A0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xDC0B280)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_ARG_OFFSET UNITYSDK_OFFSET(0xDC0B250)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xDC0B270)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_DURATION_OFFSET UNITYSDK_OFFSET(0xDC0B2D0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_SKILLID_OFFSET UNITYSDK_OFFSET(0xDC0B2B0)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0xDC0B290)
#define RPG_CLIENT_PROP_CHIMERADUELBUBBLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xDC0AFD0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraDuelBubbleEvent_TypeDefinitionIndex = 77805;
	...
	public:
		...
		::System::Int32 _Arg_k__BackingField; // 0x18
