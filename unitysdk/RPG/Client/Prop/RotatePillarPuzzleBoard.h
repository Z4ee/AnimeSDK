...
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xA139350)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA139060)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA137BA0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA138E00)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_METHOD_6_AF95FECCB88B1BB8_OFFSET UNITYSDK_OFFSET(0xA139390)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONCLICKEXIT_OFFSET UNITYSDK_OFFSET(0xA138060)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONINPUTDEVICECLASSSWITCHED_OFFSET UNITYSDK_OFFSET(0xA1385F0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONRELOAD_OFFSET UNITYSDK_OFFSET(0xA138840)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONROTATE_OFFSET UNITYSDK_OFFSET(0xA1387A0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA138690)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_ONUISHOW_OFFSET UNITYSDK_OFFSET(0xA138330)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA138C70)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SDKREPORT_BEGIN_OFFSET UNITYSDK_OFFSET(0xA139650)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SDKREPORT_END_OFFSET UNITYSDK_OFFSET(0xA138E50)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SDKREPORT_STEP_OFFSET UNITYSDK_OFFSET(0xA139830)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_SETPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA138930)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA137FA0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0xA139AC0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xA139AA0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD__GETUNIQUEID_OFFSET UNITYSDK_OFFSET(0xA1395D0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD___IFIXBASEPROXY_CANPUZZLEUNLOAD_OFFSET UNITYSDK_OFFSET(0xA139BA0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA139B90)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD___IFIXBASEPROXY_INITPUZZLE_OFFSET UNITYSDK_OFFSET(0xA139B00)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD___IFIXBASEPROXY_ISPUZZLEFINISH_OFFSET UNITYSDK_OFFSET(0xA139BE0)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD___IFIXBASEPROXY_RESETPUZZLE_OFFSET UNITYSDK_OFFSET(0xA139B50)
#define RPG_CLIENT_PROP_ROTATEPILLARPUZZLEBOARD___IFIXBASEPROXY_STARTPUZZLE_OFFSET UNITYSDK_OFFSET(0xA139B10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int RotatePillarPuzzleBoard_TypeDefinitionIndex = 64252;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(RotatePillarPuzzleBoard_TypeDefinitionIndex)->GetStaticField(0x58E0);
		}
