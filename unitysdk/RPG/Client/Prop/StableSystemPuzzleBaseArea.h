...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0x17B0A210)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_ISSTABLE_OFFSET UNITYSDK_OFFSET(0x17B09F70)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_INITBASEAREA_OFFSET UNITYSDK_OFFSET(0x17B09CD0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTABLE_OFFSET UNITYSDK_OFFSET(0x17B09DB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0x17B09D30)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_SET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0x17B0A220)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B0A2D0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBaseArea_TypeDefinitionIndex = 78399;
	...
	public:
		...
		::RPG::Client::Prop::StableSystemPuzzleBoard* MIPPNCGOJNM; // 0x40
