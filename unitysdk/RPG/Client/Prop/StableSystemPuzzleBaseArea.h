...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0xC625DB0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_ISSTABLE_OFFSET UNITYSDK_OFFSET(0xC625B10)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_INITBASEAREA_OFFSET UNITYSDK_OFFSET(0xC625870)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTABLE_OFFSET UNITYSDK_OFFSET(0xC625950)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xC6258D0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_SET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0xC625DC0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xC625E70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBaseArea_TypeDefinitionIndex = 73389;
