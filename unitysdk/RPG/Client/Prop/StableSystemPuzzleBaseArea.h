...
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0xA160080)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_GET_ISSTABLE_OFFSET UNITYSDK_OFFSET(0xA15FDE0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_INITBASEAREA_OFFSET UNITYSDK_OFFSET(0xA15FB40)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTABLE_OFFSET UNITYSDK_OFFSET(0xA15FC20)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_REFRESHSTATUS_OFFSET UNITYSDK_OFFSET(0xA15FBA0)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA_SET_AREASTATUS_OFFSET UNITYSDK_OFFSET(0xA160090)
#define RPG_CLIENT_PROP_STABLESYSTEMPUZZLEBASEAREA__CTOR_OFFSET UNITYSDK_OFFSET(0xA160140)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int StableSystemPuzzleBaseArea_TypeDefinitionIndex = 64320;
