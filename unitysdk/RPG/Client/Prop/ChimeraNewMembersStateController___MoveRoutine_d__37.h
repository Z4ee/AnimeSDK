...
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSSTATECONTROLLER___MOVEROUTINE_D__37_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A8F2320)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSSTATECONTROLLER___MOVEROUTINE_D__37_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A8F2960)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSSTATECONTROLLER___MOVEROUTINE_D__37_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A8F29C0)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSSTATECONTROLLER___MOVEROUTINE_D__37_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A8F2970)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSSTATECONTROLLER___MOVEROUTINE_D__37_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A8F2310)
#define RPG_CLIENT_PROP_CHIMERANEWMEMBERSSTATECONTROLLER___MOVEROUTINE_D__37__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F1D60)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraNewMembersStateController___MoveRoutine_d__37_TypeDefinitionIndex = 78029;
