...
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_DRAG_OFFSET UNITYSDK_OFFSET(0xADAFC80)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_FINISHMOTION_OFFSET UNITYSDK_OFFSET(0xADAF6C0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET_AUDIOSOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0xADAEFC0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET_DRAGHANDLEPOSITION_OFFSET UNITYSDK_OFFSET(0xADAF010)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET_SWAPMOTIONCONFIG_OFFSET UNITYSDK_OFFSET(0xADAF1B0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_GET__DRAGHANDLERELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0xADAF0B0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xADAF200)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_PLACEAT_OFFSET UNITYSDK_OFFSET(0xADAFB90)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_PLAYDITHERFALL_OFFSET UNITYSDK_OFFSET(0xADAF970)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_REACTDITHERSHOW_OFFSET UNITYSDK_OFFSET(0xADAF9F0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_RELOAD_OFFSET UNITYSDK_OFFSET(0xADAF910)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_RESETSCALE_OFFSET UNITYSDK_OFFSET(0xADAF640)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_RESET_OFFSET UNITYSDK_OFFSET(0xADAF510)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_SETDIMMED_OFFSET UNITYSDK_OFFSET(0xADAF800)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_SETSCALED_OFFSET UNITYSDK_OFFSET(0xADAFB00)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_SETVISIBILITY_OFFSET UNITYSDK_OFFSET(0xADAF790)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_STARTMOTION_OFFSET UNITYSDK_OFFSET(0xADAFEE0)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE_UPDATE_OFFSET UNITYSDK_OFFSET(0xADAF250)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xADB0080)
#define RPG_CLIENT_PROP_CHIMERAARRANGEMENTMODELINSTANCE__TICKMOTION_OFFSET UNITYSDK_OFFSET(0xADAF2A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraArrangementModelInstance_TypeDefinitionIndex = 71956;
