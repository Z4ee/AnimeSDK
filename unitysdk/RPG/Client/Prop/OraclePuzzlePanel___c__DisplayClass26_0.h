...
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x16613200)
#define RPG_CLIENT_PROP_ORACLEPUZZLEPANEL___C__DISPLAYCLASS26_0__PLAYSELECTEDITEMHELPERHINTPERFORM_B__0_OFFSET UNITYSDK_OFFSET(0x166132A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int OraclePuzzlePanel___c__DisplayClass26_0_TypeDefinitionIndex = 78268;
