...
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM_SETPREVIEWSTATE_OFFSET UNITYSDK_OFFSET(0xC4D5190)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0xC4D5D10)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D5F30)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockProjectionPuzzleProjectionItem_TypeDefinitionIndex = 72734;
