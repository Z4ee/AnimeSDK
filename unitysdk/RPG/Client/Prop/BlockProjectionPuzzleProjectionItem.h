...
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM_SETPREVIEWSTATE_OFFSET UNITYSDK_OFFSET(0xAD92E50)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM_SETSTATE_OFFSET UNITYSDK_OFFSET(0xAD93A50)
#define RPG_CLIENT_PROP_BLOCKPROJECTIONPUZZLEPROJECTIONITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xAD93C70)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BlockProjectionPuzzleProjectionItem_TypeDefinitionIndex = 71712;
