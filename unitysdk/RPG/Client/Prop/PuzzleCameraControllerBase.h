...
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14F203A0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_ENTERCAMERAMODE_OFFSET UNITYSDK_OFFSET(0x14F393E0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_EXITCAMERAMODE_OFFSET UNITYSDK_OFFSET(0x14F39990)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x14F20CF0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_INIT_OFFSET UNITYSDK_OFFSET(0x14F20510)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_METHOD_5_8C97CA3BAB7FB2D7_OFFSET UNITYSDK_OFFSET(0x14F1FAC0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_METHOD_5_C1356D9974792827_OFFSET UNITYSDK_OFFSET(0x14F209B0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE_TICK_OFFSET UNITYSDK_OFFSET(0x14F399F0)
#define RPG_CLIENT_PROP_PUZZLECAMERACONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x14F20D40)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PuzzleCameraControllerBase_TypeDefinitionIndex = 74936;
