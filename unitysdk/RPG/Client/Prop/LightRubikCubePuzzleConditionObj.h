...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_DISPOSE_OFFSET UNITYSDK_OFFSET(0xAE493D0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_INITOBJECT_OFFSET UNITYSDK_OFFSET(0xAE486A0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_SETFINISH_OFFSET UNITYSDK_OFFSET(0xAE49310)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0xAE494C0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xAE495C0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleConditionObj_TypeDefinitionIndex = 72179;
