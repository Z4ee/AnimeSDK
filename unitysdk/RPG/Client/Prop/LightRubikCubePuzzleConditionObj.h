...
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC58F920)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_INITOBJECT_OFFSET UNITYSDK_OFFSET(0xC58EE90)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_SETFINISH_OFFSET UNITYSDK_OFFSET(0xC58F860)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0xC58F9E0)
#define RPG_CLIENT_PROP_LIGHTRUBIKCUBEPUZZLECONDITIONOBJ__CTOR_OFFSET UNITYSDK_OFFSET(0xC58FAE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int LightRubikCubePuzzleConditionObj_TypeDefinitionIndex = 73201;
