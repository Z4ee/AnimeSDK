...
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER_METHOD_5_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xDC08DD0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER_UPDATECANVASSCALEACCORDINGTOSCREENRATIO_OFFSET UNITYSDK_OFFSET(0xDC00DE0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xDC08F00)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraBillboardCanvasAdaptingScaler_TypeDefinitionIndex = 77996;
