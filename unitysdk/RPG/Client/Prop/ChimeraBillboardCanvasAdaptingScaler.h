...
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER_METHOD_5_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xA03C9F0)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER_UPDATECANVASSCALEACCORDINGTOSCREENRATIO_OFFSET UNITYSDK_OFFSET(0xA034A80)
#define RPG_CLIENT_PROP_CHIMERABILLBOARDCANVASADAPTINGSCALER__CTOR_OFFSET UNITYSDK_OFFSET(0xA03CB20)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int ChimeraBillboardCanvasAdaptingScaler_TypeDefinitionIndex = 63916;
