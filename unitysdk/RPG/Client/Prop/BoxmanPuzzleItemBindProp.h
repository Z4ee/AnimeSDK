...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xAD9C280)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_361C06486F56B4E7_OFFSET UNITYSDK_OFFSET(0xAD9BFC0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xAD9BF40)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_93DFDE03653CA351_OFFSET UNITYSDK_OFFSET(0xAD9BEF0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xAD9C290)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xAD9C2A0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItemBindProp_TypeDefinitionIndex = 72342;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_SET_CANINTERACT_OFFSET))(this, value);
		}
	};
}
