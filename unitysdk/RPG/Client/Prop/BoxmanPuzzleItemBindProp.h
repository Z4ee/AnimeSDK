...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xA01ED30)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_361C06486F56B4E7_OFFSET UNITYSDK_OFFSET(0xA01D770)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xA01ECB0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_93DFDE03653CA351_OFFSET UNITYSDK_OFFSET(0xA01D170)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xA01ED40)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xA01ED50)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItemBindProp_TypeDefinitionIndex = 64295;
