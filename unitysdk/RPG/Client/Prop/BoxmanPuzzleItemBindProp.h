...
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xDBE9FC0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_361C06486F56B4E7_OFFSET UNITYSDK_OFFSET(0xDBE7FA0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_7DB49B5407C8FD68_OFFSET UNITYSDK_OFFSET(0xDBE9F40)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_METHOD_1_93DFDE03653CA351_OFFSET UNITYSDK_OFFSET(0xDBE79A0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xDBE9FD0)
#define RPG_CLIENT_PROP_BOXMANPUZZLEITEMBINDPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xDBE9FE0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int BoxmanPuzzleItemBindProp_TypeDefinitionIndex = 78375;
