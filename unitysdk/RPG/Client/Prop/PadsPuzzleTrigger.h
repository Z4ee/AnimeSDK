...
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xAE8D910)
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xAE8D990)
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER_START_OFFSET UNITYSDK_OFFSET(0xAE8D860)
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xAE8DA10)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzleTrigger_TypeDefinitionIndex = 72239;
