...
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x14F14EC0)
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x14F14F40)
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER_START_OFFSET UNITYSDK_OFFSET(0x14F14E20)
#define RPG_CLIENT_PROP_PADSPUZZLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x14F14FC0)

namespace RPG::Client::Prop
{
	inline static constexpr unsigned int PadsPuzzleTrigger_TypeDefinitionIndex = 74786;
