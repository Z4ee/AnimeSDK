...
#define RPG_CLIENT_MUSICALBUMMODULE_GETMUSICALBUMITEMDATA_OFFSET UNITYSDK_OFFSET(0xC21F130)
#define RPG_CLIENT_MUSICALBUMMODULE_GETUNLOCKMUSICALBUMGROUPDATAS_OFFSET UNITYSDK_OFFSET(0xC21F220)
#define RPG_CLIENT_MUSICALBUMMODULE_GET_CURUSEMUSICID_OFFSET UNITYSDK_OFFSET(0xC21D8C0)
#define RPG_CLIENT_MUSICALBUMMODULE_GET_ONLINEPLAYROOMPLAYINGINFO_OFFSET UNITYSDK_OFFSET(0xC21F5D0)
#define RPG_CLIENT_MUSICALBUMMODULE_GET_PLAYINGINFO_OFFSET UNITYSDK_OFFSET(0xC21F5B0)
#define RPG_CLIENT_MUSICALBUMMODULE_INIT_OFFSET UNITYSDK_OFFSET(0xC21EAF0)
#define RPG_CLIENT_MUSICALBUMMODULE_SETCURPLAYINGINFO_OFFSET UNITYSDK_OFFSET(0xC21ECF0)
#define RPG_CLIENT_MUSICALBUMMODULE_SETONLINEPLAYROOMCURPLAYINGINFO_OFFSET UNITYSDK_OFFSET(0xC21EE60)
#define RPG_CLIENT_MUSICALBUMMODULE_SETTRIALMUSICID_OFFSET UNITYSDK_OFFSET(0xC21EEC0)
#define RPG_CLIENT_MUSICALBUMMODULE_SET_ONLINEPLAYROOMPLAYINGINFO_OFFSET UNITYSDK_OFFSET(0xC21F5E0)
#define RPG_CLIENT_MUSICALBUMMODULE_SET_PLAYINGINFO_OFFSET UNITYSDK_OFFSET(0xC21F5C0)
#define RPG_CLIENT_MUSICALBUMMODULE_UNLOCKBACKGROUNDMUSICCSREQ_OFFSET UNITYSDK_OFFSET(0xC21F0A0)
#define RPG_CLIENT_MUSICALBUMMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xC21DEA0)
#define RPG_CLIENT_MUSICALBUMMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xC21F5F0)
#define RPG_CLIENT_MUSICALBUMMODULE__GETGROUPDATA_OFFSET UNITYSDK_OFFSET(0xC21E280)
#define RPG_CLIENT_MUSICALBUMMODULE__ONGETJUKEBOXDATASCRSP_OFFSET UNITYSDK_OFFSET(0xC21E160)
#define RPG_CLIENT_MUSICALBUMMODULE__ONPLAYBACKGROUNDMUSICSCRSP_OFFSET UNITYSDK_OFFSET(0xC21E490)
#define RPG_CLIENT_MUSICALBUMMODULE__ONTRIALBACKGROUNDMUSICSCRSP_OFFSET UNITYSDK_OFFSET(0xC21E430)
#define RPG_CLIENT_MUSICALBUMMODULE__ONUNLOCKBACKGROUNDMUSICSCRSP_OFFSET UNITYSDK_OFFSET(0xC21E560)
#define RPG_CLIENT_MUSICALBUMMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0xC21F760)
#define RPG_CLIENT_MUSICALBUMMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0xC21F700)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicAlbumModule_TypeDefinitionIndex = 62050;
	...
	public:
		...
		::RPG::Client::PlayingMusicItemsInfo* _OnlinePlayRoomPlayingInfo_k__BackingField; // 0x20
		...
		::System::Void SetOnlinePlayRoomCurPlayingInfo(::Class_1_C2DCB7BEBD8D0D3B* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_C2DCB7BEBD8D0D3B*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MUSICALBUMMODULE_SETONLINEPLAYROOMCURPLAYINGINFO_OFFSET))(this, a1);
		}
