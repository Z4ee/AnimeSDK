...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x1AC63D70)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0x1AC63DB0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC63E10)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetInfoRowTierceControl_TypeDefinitionIndex = 76461;
