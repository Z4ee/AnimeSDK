...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xC9F2C40)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0xC9F2C80)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F2CE0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetInfoRowTierceControl_TypeDefinitionIndex = 80094;
