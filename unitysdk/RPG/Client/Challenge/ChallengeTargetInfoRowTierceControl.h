...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB4C3760)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL_METHOD_5_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0xB4C37A0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWTIERCECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C3800)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetInfoRowTierceControl_TypeDefinitionIndex = 74079;
