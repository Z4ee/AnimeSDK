...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GETSUCCESSHINTANIMLENGTH_OFFSET UNITYSDK_OFFSET(0xC9F25E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GET_PRIVATECOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xC9F27B0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GET_PRIVATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xC9F2A30)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_GET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xC9F1B50)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_PLAYSUCCESSHINTANIM_OFFSET UNITYSDK_OFFSET(0xC9F2630)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_REFRESHCOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xC9F28B0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_REFRESHNAMEPARAMS_OFFSET UNITYSDK_OFFSET(0xC9F2730)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_REFRESHNAME_OFFSET UNITYSDK_OFFSET(0xC9F2570)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_SET_PRIVATECOMPLETESTATUS_OFFSET UNITYSDK_OFFSET(0xC9F2830)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_SET_PRIVATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xC9F2AB0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL_SET_TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0xC9F1C00)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__CONVERTSTATETOTRIGGERNAME_OFFSET UNITYSDK_OFFSET(0xC9F2910)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F2B90)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC9F1C50)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0xC9F2B00)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETINFOROWCONTROL__SETTRIGGER_OFFSET UNITYSDK_OFFSET(0xC9F2680)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetInfoRowControl_TypeDefinitionIndex = 80092;
