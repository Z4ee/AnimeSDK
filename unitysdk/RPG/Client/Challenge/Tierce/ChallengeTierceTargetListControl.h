...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_GETTARGETCONTROL_OFFSET UNITYSDK_OFFSET(0xB4D47C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_GET_TARGETS_OFFSET UNITYSDK_OFFSET(0xB4E8BE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_METHOD_5_65A711E80B8FA950_OFFSET UNITYSDK_OFFSET(0xB4E8BF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL_SET_TARGETS_OFFSET UNITYSDK_OFFSET(0xB4D3720)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4E8D10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETARGETLISTCONTROL___REFRESH_B__9_0_OFFSET UNITYSDK_OFFSET(0xB4E8D20)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTargetListControl_TypeDefinitionIndex = 74190;
