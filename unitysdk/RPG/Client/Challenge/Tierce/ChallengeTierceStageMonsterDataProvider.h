...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETBOSSMONSTERBYSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xB4D69A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETCOVERBOSSMONSTER_OFFSET UNITYSDK_OFFSET(0xB4D6B00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETMONSTERWAVESBYSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0xB4D63D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETSTAGECOUNT_OFFSET UNITYSDK_OFFSET(0xB4D6380)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D6370)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageMonsterDataProvider_TypeDefinitionIndex = 74226;
