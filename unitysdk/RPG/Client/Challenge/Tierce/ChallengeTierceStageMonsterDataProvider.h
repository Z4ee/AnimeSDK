...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETBOSSMONSTERBYSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0x18766FF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETCOVERBOSSMONSTER_OFFSET UNITYSDK_OFFSET(0x187671A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETMONSTERWAVESBYSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0x187668A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER_GETSTAGECOUNT_OFFSET UNITYSDK_OFFSET(0x18766850)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEMONSTERDATAPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18766840)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageMonsterDataProvider_TypeDefinitionIndex = 76610;
