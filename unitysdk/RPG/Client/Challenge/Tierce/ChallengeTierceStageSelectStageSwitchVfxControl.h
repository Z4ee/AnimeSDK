...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL_GET_SELECTEDSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0x18BF25A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL_METHOD_5_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0x18BF2660)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL_SET_SELECTEDSTAGEINDEX_OFFSET UNITYSDK_OFFSET(0x18BF25E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTAGESWITCHVFXCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF26D0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectStageSwitchVfxControl_TypeDefinitionIndex = 80224;
