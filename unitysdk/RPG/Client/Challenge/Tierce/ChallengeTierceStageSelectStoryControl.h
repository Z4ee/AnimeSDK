...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATECHALLENGEFEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x18BF2820)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATECHALLENGETHEME_OFFSET UNITYSDK_OFFSET(0x18BF26E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATECHALLENGE_OFFSET UNITYSDK_OFFSET(0x18BF2B20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATESTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0x18BF36F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATESTAGEISFINAL_OFFSET UNITYSDK_OFFSET(0x18BF3250)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATESTAGERECOMMENDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0x18BF3800)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATESTAGERESULT_OFFSET UNITYSDK_OFFSET(0x18BF3470)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_GET_PRIVATESTAGE_OFFSET UNITYSDK_OFFSET(0x18BF3A20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATECHALLENGEFEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x18BF2860)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATECHALLENGETHEME_OFFSET UNITYSDK_OFFSET(0x18BF2720)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATECHALLENGE_OFFSET UNITYSDK_OFFSET(0x18BF2B60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATESTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0x18BF3730)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATESTAGEISFINAL_OFFSET UNITYSDK_OFFSET(0x18BF3290)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATESTAGERECOMMENDDAMAGETYPES_OFFSET UNITYSDK_OFFSET(0x18BF3840)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATESTAGERESULT_OFFSET UNITYSDK_OFFSET(0x18BF34B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL_SET_PRIVATESTAGE_OFFSET UNITYSDK_OFFSET(0x18BF3A60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18BF5C90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x18BF3FA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x18BF3F10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTSTORYCONTROL__SET_PRIVATESTAGERECOMMENDDAMAGETYPES_B__55_0_OFFSET UNITYSDK_OFFSET(0x18BF5CF0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectStoryControl_TypeDefinitionIndex = 80225;
	...
	public:
		...
		::UnityEngine::RectTransform* _NodeThemeBgRoot; // 0x78
		::System::String* _ThemeBgName; // 0x80
		::RPG::Client::Challenge::ChallengeTargetInfoRowControl* _PassTarget; // 0x88
		::RPG::Client::Challenge::Tierce::ChallengeTierceTargetListControl* _TargetList; // 0x90
		::RPG::Client::LocalizedText* _TextFeverRuleName; // 0x98
		::RPG::Client::LocalizedText* _TextFeverRuleDesc; // 0xA0
		::RPG::Client::Challenge::Story::ChallengeStoryFeverMazeBuffIconGroupControl* _FeverMazeBuffs; // 0xA8
		::RPG::Client::LocalizedText* _TextStageName; // 0xB0
		::RPG::Client::LocalizedText* _TextIndex; // 0xB8
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* _NodesFinal; // 0xC0
		::System::Collections::Generic::List_1<::UnityEngine::RectTransform*>* _NodesNotFinal; // 0xC8
		::UnityEngine::RectTransform* _NodePassed; // 0xD0
		::UnityEngine::RectTransform* _NodeNotPassed; // 0xD8
		::RPG::Client::LocalizedText* _TextResult; // 0xE0
		::RPG::Client::TextID _TextIDNoResult; // 0xE8
		::RPG::Client::TextID _TextIDResult; // 0xF8
		::RPG::Client::AnimatorButton* _BtnEdit; // 0x108
		::RPG::Client::AnimatorButton* _BtnBuff; // 0x110
		::RPG::Client::Challenge::ChallengeAvatarLineupSlotsControl* _AvatarLineupSlots; // 0x118
		::RPG::Client::MonoPrefabSwitcher* _SwitcherBuff; // 0x120
		::System::String* _StateHasBuff; // 0x128
		::System::String* _StateNoBuff; // 0x130
		::UnityEngine::UI::Image* _IconBuff; // 0x138
		::RPG::Client::AnimatorButton* _BtnBoss; // 0x140
		::RPG::Client::LocalizedText* _TextBossLevel; // 0x148
		::UnityEngine::UI::Image* _ImageBoss; // 0x150
		::RPG::Client::PrefabLoadMeta* _PrefabDamageType; // 0x158
		::RPG::Client::Challenge::Tierce::ChallengeTierceNodeListControl* _ListDamageType; // 0x160
		::UnityEngine::Animation* _AnimSwitch; // 0x168
		::System::String* _AnimNameSwitch; // 0x170
