...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ADD_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0xCA1F100)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA1F8A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0xCA1F8F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_COUNTOFSLOT_OFFSET UNITYSDK_OFFSET(0xCA1EFD0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_ISNEEDFORCESAVE_OFFSET UNITYSDK_OFFSET(0xCA1ECC0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0xCA1F030)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_RELATEDSTAGE_OFFSET UNITYSDK_OFFSET(0xCA1ECB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARROLEIDS_OFFSET UNITYSDK_OFFSET(0xCA1F970)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARS_OFFSET UNITYSDK_OFFSET(0xCA1FAC0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_REMOVE_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0xCA1F160)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0xCA1FC10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0xCA1F070)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CHECKISLINEUPCHANGED_OFFSET UNITYSDK_OFFSET(0xCA1ED80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCA1F1C0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditTeamViewModel_TypeDefinitionIndex = 80298;
