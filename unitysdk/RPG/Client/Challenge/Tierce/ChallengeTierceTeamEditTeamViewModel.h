...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ADD_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0x1877CE20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1877D5C0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0x1877D610)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_COUNTOFSLOT_OFFSET UNITYSDK_OFFSET(0x1877CCF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_ISNEEDFORCESAVE_OFFSET UNITYSDK_OFFSET(0x1877C9E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0x1877CD50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_GET_RELATEDSTAGE_OFFSET UNITYSDK_OFFSET(0x1877C9D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARROLEIDS_OFFSET UNITYSDK_OFFSET(0x1877D690)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_ITERATEMODIFIEDAVATARS_OFFSET UNITYSDK_OFFSET(0x1877D7E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_REMOVE_ONMODIFIEDBUFFIDCHANGED_OFFSET UNITYSDK_OFFSET(0x1877CE80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SETMODIFIEDAVATARBYSLOT_OFFSET UNITYSDK_OFFSET(0x1877D930)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL_SET_MODIFIEDBUFFID_OFFSET UNITYSDK_OFFSET(0x1877CD90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CHECKISLINEUPCHANGED_OFFSET UNITYSDK_OFFSET(0x1877CAA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITTEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1877CEE0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditTeamViewModel_TypeDefinitionIndex = 76660;

	class ChallengeTierceTeamEditTeamViewModel : public ::System::Object
	{
	public:
		::RPG::Client::Challenge::Tierce::ChallengeTierceStageViewModel* _RelatedStage_k__BackingField; // 0x10
		::Il2CppArray<::RPG::AvatarSystem::IAvatar*>* _ModifiedAvatars; // 0x18
		::Class_1_19DB14C0C5CFE108* _TeamConflictCheckService; // 0x20
		::System::Action* OnModifiedBuffIDChanged; // 0x28
