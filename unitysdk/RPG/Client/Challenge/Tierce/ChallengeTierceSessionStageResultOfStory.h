...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY_GET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xB4D54E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY_WITHOBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xB4D5580)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0xB4D5500)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0xB4D5520)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY__CTOR_3_OFFSET UNITYSDK_OFFSET(0xB4D5560)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D54F0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSessionStageResultOfStory_TypeDefinitionIndex = 74146;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_A16A135FC5A0DDB9*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY__CTOR_1_OFFSET))(this, a1);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D17272E82AE804C2_161*))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESESSIONSTAGERESULTOFSTORY__CTOR_3_OFFSET))(this, a1);
		}
