...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL_GET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xB4CC030)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL_SET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xB4CC040)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4CC050)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceMemoryEnvironmentHintViewModel_TypeDefinitionIndex = 74249;
