...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL_GET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xC9FBB10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL_SET_CHALLENGEDATAREF_OFFSET UNITYSDK_OFFSET(0xC9FBB20)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEMEMORYENVIRONMENTHINTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9FBB30)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceMemoryEnvironmentHintViewModel_TypeDefinitionIndex = 80270;
