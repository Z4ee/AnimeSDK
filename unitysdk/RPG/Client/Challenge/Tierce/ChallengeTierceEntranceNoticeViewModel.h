...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xB4C6770)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_INTRODUCE_OFFSET UNITYSDK_OFFSET(0xB4C6780)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_SETSEEN_OFFSET UNITYSDK_OFFSET(0xB4C6990)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xB4C6830)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CHECKSEEN_OFFSET UNITYSDK_OFFSET(0xB4C68B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C6980)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__GETBITSETMASK_OFFSET UNITYSDK_OFFSET(0xB4C6BA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__SETSEEN_OFFSET UNITYSDK_OFFSET(0xB4C69E0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceNoticeViewModel_TypeDefinitionIndex = 74237;
