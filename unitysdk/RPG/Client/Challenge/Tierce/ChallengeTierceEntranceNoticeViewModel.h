...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1C866130)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_INTRODUCE_OFFSET UNITYSDK_OFFSET(0x1C866140)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_SETSEEN_OFFSET UNITYSDK_OFFSET(0x1C866350)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_TRYCREATE_OFFSET UNITYSDK_OFFSET(0x1C8661F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CHECKSEEN_OFFSET UNITYSDK_OFFSET(0x1C866270)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C866340)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__GETBITSETMASK_OFFSET UNITYSDK_OFFSET(0x1C866560)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__SETSEEN_OFFSET UNITYSDK_OFFSET(0x1C8663A0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceNoticeViewModel_TypeDefinitionIndex = 80257;
