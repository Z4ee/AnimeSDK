...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0xC9F6140)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_GET_INTRODUCE_OFFSET UNITYSDK_OFFSET(0xC9F6150)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_SETSEEN_OFFSET UNITYSDK_OFFSET(0xC9F6360)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL_TRYCREATE_OFFSET UNITYSDK_OFFSET(0xC9F6200)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CHECKSEEN_OFFSET UNITYSDK_OFFSET(0xC9F6280)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F6350)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__GETBITSETMASK_OFFSET UNITYSDK_OFFSET(0xC9F6570)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCENOTICEVIEWMODEL__SETSEEN_OFFSET UNITYSDK_OFFSET(0xC9F63B0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceNoticeViewModel_TypeDefinitionIndex = 80258;
