...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0xB4D5600)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0xB4D5B10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL_SET_CONTENT_OFFSET UNITYSDK_OFFSET(0xB4D5610)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D5B80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMCONTROL__REFRESH_OFFSET UNITYSDK_OFFSET(0xB4D5670)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSettleConfirmControl_TypeDefinitionIndex = 74199;
