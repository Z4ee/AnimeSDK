...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFSTORY_GET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xC9FF320)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFSTORY_SET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xC9FF330)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xC9FF340)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfStory_TypeDefinitionIndex = 80143;
