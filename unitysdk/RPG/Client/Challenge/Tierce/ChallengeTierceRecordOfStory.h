...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFSTORY_GET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xB4CF330)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFSTORY_SET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xB4CF340)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFSTORY__CTOR_OFFSET UNITYSDK_OFFSET(0xB4CF350)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfStory_TypeDefinitionIndex = 74126;
