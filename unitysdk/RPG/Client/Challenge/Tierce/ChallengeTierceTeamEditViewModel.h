...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1877E3E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GETALLAVATARS_OFFSET UNITYSDK_OFFSET(0x1877EBD0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GETTEAM_OFFSET UNITYSDK_OFFSET(0x1877E960)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_CHALLENGE_OFFSET UNITYSDK_OFFSET(0x1877DFB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_COUNTOFTEAMSLOTS_OFFSET UNITYSDK_OFFSET(0x1877E120)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_COUNTOFTEAMS_OFFSET UNITYSDK_OFFSET(0x1877DFC0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_FRIENDRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0x1877E180)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_HASBUFF_OFFSET UNITYSDK_OFFSET(0x1877E1A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_STATISTICSRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0x1877E190)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_SUBMITCHANGE_OFFSET UNITYSDK_OFFSET(0x1877F3A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_TRYSTARTCHALLENGE_OFFSET UNITYSDK_OFFSET(0x1877F220)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1877E230)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL__EXPORTPLAN_OFFSET UNITYSDK_OFFSET(0x1877ECA0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditViewModel_TypeDefinitionIndex = 76664;
	...
	public:
		...
		::System::Collections::Generic::IReadOnlyList_1<::RPG::Client::Challenge::Tierce::ChallengeTierceTeamEditTeamViewModel*>* _Teams; // 0x50
