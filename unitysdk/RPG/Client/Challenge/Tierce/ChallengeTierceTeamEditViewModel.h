...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB4EBDE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GETALLAVATARS_OFFSET UNITYSDK_OFFSET(0xB4EC360)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GETTEAM_OFFSET UNITYSDK_OFFSET(0xB4EC1B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_CHALLENGE_OFFSET UNITYSDK_OFFSET(0xB4EBA90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_COUNTOFTEAMSLOTS_OFFSET UNITYSDK_OFFSET(0xB4EBBB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_COUNTOFTEAMS_OFFSET UNITYSDK_OFFSET(0xB4EBAA0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_FRIENDRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0xB4EBBE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_HASBUFF_OFFSET UNITYSDK_OFFSET(0xB4EBC00)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_GET_STATISTICSRECOMMENDATION_OFFSET UNITYSDK_OFFSET(0xB4EBBF0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_SUBMITCHANGE_OFFSET UNITYSDK_OFFSET(0xB4ECB10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_TRYSTARTCHALLENGE_OFFSET UNITYSDK_OFFSET(0xB4EC860)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4EBC30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL__EXPORTPLAN_OFFSET UNITYSDK_OFFSET(0xB4EC430)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditViewModel_TypeDefinitionIndex = 74280;

	class ChallengeTierceTeamEditViewModel : public ::System::Object
	{
	public:
		::Class_1_19DB14C0C5CFE108* _TeamConflictCheckService; // 0x10
		::Class_1_7D46F1066EF90FA6_3* _ObtainedAvatarService; // 0x18
		::RPG::Client::Challenge::Tierce::ChallengeTierceChallengeViewModel* _Challenge_k__BackingField; // 0x20
		::Class_1_FA2301FC3580108A* _PlayerReturnTrialAvatarService; // 0x28
		::RPG::Client::Challenge::Tierce::ChallengeTierceStatisticsLineupRecommendationViewModel* _StatisticsRecommendation_k__BackingField; // 0x30
		::System::Collections::Generic::IReadOnlyList_1<::RPG::Client::Challenge::Tierce::ChallengeTierceTeamEditTeamViewModel*>* _Teams; // 0x38
		::Class_1_06E38C65842C3B24* _Tierce; // 0x40
		::RPG::Client::ChallengeGroupData* _GroupData; // 0x48
		::RPG::Client::Challenge::Tierce::ChallengeTierceFriendLineupRecommendationViewModel* _FriendRecommendation_k__BackingField; // 0x50
