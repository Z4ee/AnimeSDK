...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xCA1B120)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xCA1B350)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCA1B2E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xCA1B3D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCA1B340)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xCA1B2F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCA1B110)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGEVIEWMODEL_FACTORY__CREATEALL_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0xCA1B0F0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageViewModel_Factory__CreateAll_d__4_TypeDefinitionIndex = 80250;

	class ChallengeTierceStageViewModel_Factory__CreateAll_d__4 : public ::System::Object
	{
	public:
		::Class_1_06E38C65842C3B24* tierce; // 0x10
		::Class_1_06E38C65842C3B24* __3__tierce; // 0x18
		::RPG::Client::Challenge::Tierce::ChallengeTierceStageViewModel* __2__current; // 0x20
		::RPG::Client::Challenge::Tierce::ChallengeTierceStageViewModel_Factory* __4__this; // 0x28
