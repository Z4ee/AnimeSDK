...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_GETANIMLENGTH_OFFSET UNITYSDK_OFFSET(0xCA001F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_GET_STAGE_OFFSET UNITYSDK_OFFSET(0xC9FFB10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_METHOD_5_669256140B61F98F_OFFSET UNITYSDK_OFFSET(0xC9FFBB0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_METHOD_5_B39416EBE5B2947C_OFFSET UNITYSDK_OFFSET(0xC9FFC60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_METHOD_5_C9830113AF7A4377_OFFSET UNITYSDK_OFFSET(0xCA00100)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0xCA002B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_SET_STAGE_OFFSET UNITYSDK_OFFSET(0xC9FFB50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCA00310)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceResultStageControl_TypeDefinitionIndex = 80211;
