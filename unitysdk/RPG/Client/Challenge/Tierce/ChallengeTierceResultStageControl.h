...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_GETANIMLENGTH_OFFSET UNITYSDK_OFFSET(0x18760A90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x18760330)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_METHOD_5_3456633D994FB6C5_OFFSET UNITYSDK_OFFSET(0x18760480)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_METHOD_5_669256140B61F98F_OFFSET UNITYSDK_OFFSET(0x187603D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_METHOD_5_C9830113AF7A4377_OFFSET UNITYSDK_OFFSET(0x187609A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x18760B50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL_SET_STAGE_OFFSET UNITYSDK_OFFSET(0x18760370)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERESULTSTAGECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18760BB0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceResultStageControl_TypeDefinitionIndex = 76578;
