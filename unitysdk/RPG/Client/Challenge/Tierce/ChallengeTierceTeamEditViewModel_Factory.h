...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0x18C06040)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x18C06020)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditViewModel_Factory_TypeDefinitionIndex = 80302;

	class ChallengeTierceTeamEditViewModel_Factory : public ::System::Object
	{
	public:
		::RPG::Client::Challenge::Tierce::ChallengeTierceStatisticsLineupRecommendationViewModel_Factory* _StatisticsRecommendationFactory; // 0x10
		::Class_1_FA2301FC3580108A* _PlayerReturnTrialAvatarService; // 0x18
		::Class_1_56190D054EB32434* _Repository; // 0x20
		::Class_1_7D46F1066EF90FA6_3* _ObtainedAvatarService; // 0x28
		::RPG::Client::Challenge::Tierce::ChallengeTierceTeamEditTeamViewModel_Factory* _TeamFactory; // 0x30
		::RPG::Client::Challenge::Tierce::ChallengeTierceFriendLineupRecommendationViewModel_Factory* _FriendRecommendationFactory; // 0x38
