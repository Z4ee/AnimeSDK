...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0x1877FB70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMEDITVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1877FB30)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamEditViewModel_Factory_TypeDefinitionIndex = 76665;
	...
	public:
		...
		::RPG::Client::Challenge::Tierce::ChallengeTierceTeamEditTeamViewModel_Factory* _TeamFactory; // 0x18
		::Class_1_FA2301FC3580108A* _PlayerReturnTrialAvatarService; // 0x20
		::RPG::Client::Challenge::Tierce::ChallengeTierceStatisticsLineupRecommendationViewModel_Factory* _StatisticsRecommendationFactory; // 0x28
		::RPG::Client::Challenge::Tierce::ChallengeTierceFriendLineupRecommendationViewModel_Factory* _FriendRecommendationFactory; // 0x30
		::Class_1_56190D054EB32434* _Repository; // 0x38
