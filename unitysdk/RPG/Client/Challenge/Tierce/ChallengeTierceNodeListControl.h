...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_BINDVIEWMODEL_1_OFFSET UNITYSDK_OFFSET(0x1C86BE90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_BINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C86BD90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_BINDITEM_OFFSET UNITYSDK_OFFSET(0x1C86BD70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x1C86BD50)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1C86BB40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_184A831148A944B5_OFFSET UNITYSDK_OFFSET(0x1C86BB80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_36EB20BAEC6C0B33_OFFSET UNITYSDK_OFFSET(0x1C86BF70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_AF8C0870C2DDC5FB_OFFSET UNITYSDK_OFFSET(0x1C86C0E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_F37642F7827EADFF_OFFSET UNITYSDK_OFFSET(0x1C86C540)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_BINDITEM_OFFSET UNITYSDK_OFFSET(0x1C86BD80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x1C86BD60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1C85FAE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C86C640)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceNodeListControl_TypeDefinitionIndex = 80194;

	class ChallengeTierceNodeListControl : public ::UnityEngine::MonoBehaviour
	{
	public:
		::System::Collections::Generic::IReadOnlyList_1<::System::Object*>* GCIKKMGIPIO; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* KFEBMMBEPOO; // 0x20
		::System::Collections::Generic::List_1<::System::Action*>* FOOLPPOKOPJ; // 0x28
