...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_BINDVIEWMODEL_1_OFFSET UNITYSDK_OFFSET(0xB4CC380)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_BINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB4CC280)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_BINDITEM_OFFSET UNITYSDK_OFFSET(0xB4CC260)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xB4CC240)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0xB4CC060)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_184A831148A944B5_OFFSET UNITYSDK_OFFSET(0xB4CC0D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_36EB20BAEC6C0B33_OFFSET UNITYSDK_OFFSET(0xB4CC460)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_AF8C0870C2DDC5FB_OFFSET UNITYSDK_OFFSET(0xB4CC5D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_METHOD_5_F37642F7827EADFF_OFFSET UNITYSDK_OFFSET(0xB4CCA30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_BINDITEM_OFFSET UNITYSDK_OFFSET(0xB4CC270)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_CREATEITEM_OFFSET UNITYSDK_OFFSET(0xB4CC250)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL_SET_ITEMS_OFFSET UNITYSDK_OFFSET(0xB4CC070)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4CCB30)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceNodeListControl_TypeDefinitionIndex = 74178;
