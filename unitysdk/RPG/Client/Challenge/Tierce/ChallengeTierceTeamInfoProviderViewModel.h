...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_GET_FIRSTAVATAR_OFFSET UNITYSDK_OFFSET(0x18C061B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_GET_ISSHOWAVATARTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x18C07810)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_ISAVATARINTEAM_OFFSET UNITYSDK_OFFSET(0x18C07650)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_TRYGETAVATARTEAMINDEX_OFFSET UNITYSDK_OFFSET(0x18C07700)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_VISITALLAVATARS_OFFSET UNITYSDK_OFFSET(0x18C06F30)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL_VISITAVATARSINTEAM_OFFSET UNITYSDK_OFFSET(0x18C07460)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCETEAMINFOPROVIDERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C061C0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceTeamInfoProviderViewModel_TypeDefinitionIndex = 80255;
