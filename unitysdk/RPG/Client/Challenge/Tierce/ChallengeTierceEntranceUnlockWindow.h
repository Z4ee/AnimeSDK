...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKWINDOW_GET__TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1C8667D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKWINDOW_SET__TYPEDDATACONTEXT_OFFSET UNITYSDK_OFFSET(0x1C866880)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8668B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKWINDOW__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C866A40)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKWINDOW__ONENTRANCEANIMEND_OFFSET UNITYSDK_OFFSET(0x1C866AE0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEENTRANCEUNLOCKWINDOW__ONINITIALIZECOMPONENT_OFFSET UNITYSDK_OFFSET(0x1C866980)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceEntranceUnlockWindow_TypeDefinitionIndex = 80209;
