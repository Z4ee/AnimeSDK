...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL_METHOD_5_53F8E7A039DF377D_OFFSET UNITYSDK_OFFSET(0x1C864110)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL_METHOD_5_DA42B87A2F252530_OFFSET UNITYSDK_OFFSET(0x1C8640B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1C864070)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCEBADGENOTICECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8645A0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceBadgeNoticeControl_TypeDefinitionIndex = 80189;
