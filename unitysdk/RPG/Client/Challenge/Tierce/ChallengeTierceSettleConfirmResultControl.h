...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMRESULTCONTROL_METHOD_5_45E10D749EF38FBE_OFFSET UNITYSDK_OFFSET(0xB4D5920)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMRESULTCONTROL_METHOD_5_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xB4D5F10)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESETTLECONFIRMRESULTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4D5F50)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceSettleConfirmResultControl_TypeDefinitionIndex = 74201;
