...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTVIEWMODEL_FACTORY_CREATE_OFFSET UNITYSDK_OFFSET(0x18BFB9A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCESTAGESELECTVIEWMODEL_FACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFB980)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceStageSelectViewModel_Factory_TypeDefinitionIndex = 80295;
