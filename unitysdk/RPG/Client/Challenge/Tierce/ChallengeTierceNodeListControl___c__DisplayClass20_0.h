...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C86C630)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCENODELISTCONTROL___C__DISPLAYCLASS20_0___BINDITEMS_B__0_OFFSET UNITYSDK_OFFSET(0x1C86C6B0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceNodeListControl___c__DisplayClass20_0_TypeDefinitionIndex = 80196;

	class ChallengeTierceNodeListControl___c__DisplayClass20_0 : public ::System::Object
	{
	public:
		::RPG::Client::Challenge::Tierce::ChallengeTierceNodeListControl* __4__this; // 0x10
