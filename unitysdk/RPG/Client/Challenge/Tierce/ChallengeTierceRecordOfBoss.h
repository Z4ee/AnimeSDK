...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFBOSS_GET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xC9FF2A0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFBOSS_SET_OBTAINEDSCORE_OFFSET UNITYSDK_OFFSET(0xC9FF2B0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFBOSS__CTOR_OFFSET UNITYSDK_OFFSET(0xC9FF2C0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfBoss_TypeDefinitionIndex = 80141;
