...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_GET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xC9FF2D0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_GET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xC9FF2F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_SET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xC9FF2E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_SET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xC9FF300)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY__CTOR_OFFSET UNITYSDK_OFFSET(0xC9FF310)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfMemory_TypeDefinitionIndex = 80142;

	class ChallengeTierceRecordOfMemory : public ::RPG::Client::Challenge::Tierce::ChallengeTierceRecordBase
	{
	public:
		::System::Int32 _UsedRoundCount_k__BackingField; // 0x10
		::System::Int32 _LeftRoundCount_k__BackingField; // 0x14
