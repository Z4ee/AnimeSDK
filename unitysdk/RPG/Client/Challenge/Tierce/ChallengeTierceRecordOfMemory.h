...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_GET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xB4CF2E0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_GET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xB4CF300)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_SET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xB4CF2F0)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_SET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0xB4CF310)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY__CTOR_OFFSET UNITYSDK_OFFSET(0xB4CF320)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfMemory_TypeDefinitionIndex = 74125;
