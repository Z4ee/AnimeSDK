...
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_GET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x1875FA60)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_GET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x1875FA80)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_SET_LEFTROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x1875FA70)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY_SET_USEDROUNDCOUNT_OFFSET UNITYSDK_OFFSET(0x1875FA90)
#define RPG_CLIENT_CHALLENGE_TIERCE_CHALLENGETIERCERECORDOFMEMORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1875FAA0)

namespace RPG::Client::Challenge::Tierce
{
	inline static constexpr unsigned int ChallengeTierceRecordOfMemory_TypeDefinitionIndex = 76509;
