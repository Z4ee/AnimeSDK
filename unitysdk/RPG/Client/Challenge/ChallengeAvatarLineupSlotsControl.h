...
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_GET_AVATARS_OFFSET UNITYSDK_OFFSET(0x1C85F8F0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_GET_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1C85F8E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_METHOD_5_EA814E2C09B7783E_OFFSET UNITYSDK_OFFSET(0x1C85F990)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_SET_AVATARS_OFFSET UNITYSDK_OFFSET(0x1C85F930)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C85FB40)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL___REFRESH_B__9_0_OFFSET UNITYSDK_OFFSET(0x1C85FB80)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL___REFRESH_B__9_1_OFFSET UNITYSDK_OFFSET(0x1C85FBA0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeAvatarLineupSlotsControl_TypeDefinitionIndex = 80086;
