...
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_GET_AVATARS_OFFSET UNITYSDK_OFFSET(0x1AC608F0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_GET_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1AC608E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_METHOD_5_EA814E2C09B7783E_OFFSET UNITYSDK_OFFSET(0x1AC60990)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL_SET_AVATARS_OFFSET UNITYSDK_OFFSET(0x1AC60930)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC60B40)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL___REFRESH_B__9_0_OFFSET UNITYSDK_OFFSET(0x1AC60B80)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL___REFRESH_B__9_1_OFFSET UNITYSDK_OFFSET(0x1AC60BA0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEAVATARLINEUPSLOTSCONTROL___REFRESH_B__9_2_OFFSET UNITYSDK_OFFSET(0x1AC60DE0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeAvatarLineupSlotsControl_TypeDefinitionIndex = 76453;
