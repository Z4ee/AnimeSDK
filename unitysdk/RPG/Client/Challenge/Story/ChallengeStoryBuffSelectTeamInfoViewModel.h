...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_AVATARS_OFFSET UNITYSDK_OFFSET(0xC9F31C0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0xC9F3200)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0xC9F31E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_AVATARS_OFFSET UNITYSDK_OFFSET(0xC9F31D0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0xC9F3210)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0xC9F31F0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F3220)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryBuffSelectTeamInfoViewModel_TypeDefinitionIndex = 80311;
