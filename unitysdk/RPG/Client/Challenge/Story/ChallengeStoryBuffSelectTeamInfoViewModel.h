...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_AVATARS_OFFSET UNITYSDK_OFFSET(0x1C863190)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0x1C8631D0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x1C8631B0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_AVATARS_OFFSET UNITYSDK_OFFSET(0x1C8631A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0x1C8631E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0x1C8631C0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8631F0)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryBuffSelectTeamInfoViewModel_TypeDefinitionIndex = 80310;
