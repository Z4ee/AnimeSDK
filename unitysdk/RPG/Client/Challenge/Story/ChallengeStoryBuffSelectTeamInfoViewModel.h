...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_AVATARS_OFFSET UNITYSDK_OFFSET(0xB4C3C10)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0xB4C3C50)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0xB4C3C30)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_AVATARS_OFFSET UNITYSDK_OFFSET(0xB4C3C20)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0xB4C3C60)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0xB4C3C40)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYBUFFSELECTTEAMINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C3C70)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryBuffSelectTeamInfoViewModel_TypeDefinitionIndex = 74289;
