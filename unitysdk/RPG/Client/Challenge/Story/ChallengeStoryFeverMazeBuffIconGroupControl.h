...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GETFIRSTSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC64BC0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x1AC64700)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0x1AC64C60)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_SET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x1AC64740)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC64FE0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1AC647E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0x1AC64B60)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__REFRESHCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1AC64F00)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0x1AC64CE0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_0_OFFSET UNITYSDK_OFFSET(0x1AC65030)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_1_OFFSET UNITYSDK_OFFSET(0x1AC650B0)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconGroupControl_TypeDefinitionIndex = 76670;
