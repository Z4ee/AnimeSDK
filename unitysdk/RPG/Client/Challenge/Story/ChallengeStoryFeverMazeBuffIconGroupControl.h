...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GETFIRSTSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0xC9F3A70)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0xC9F35C0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0xC9F3B10)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_SET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0xC9F3600)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F3E90)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0xC9F36A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0xC9F3A10)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__REFRESHCHECKSTATE_OFFSET UNITYSDK_OFFSET(0xC9F3DB0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0xC9F3B90)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_0_OFFSET UNITYSDK_OFFSET(0xC9F3EE0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_1_OFFSET UNITYSDK_OFFSET(0xC9F3F60)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconGroupControl_TypeDefinitionIndex = 80308;
