...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GETFIRSTSELECTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1C863A50)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_GET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x1C8635A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0x1C863AF0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL_SET_FEVERMAZEBUFFIDS_OFFSET UNITYSDK_OFFSET(0x1C8635E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C863E70)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1C863680)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0x1C8639F0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__REFRESHCHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1C863D90)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL__SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0x1C863B70)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_0_OFFSET UNITYSDK_OFFSET(0x1C863EC0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONGROUPCONTROL___ENSUREINITIALIZEINTERACTION_B__15_1_OFFSET UNITYSDK_OFFSET(0x1C863F40)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconGroupControl_TypeDefinitionIndex = 80307;
