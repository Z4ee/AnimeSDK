...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_GET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0x1C863200)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_SET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0x1C863240)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C863570)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1C8632A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__REFRESHCONTENT_OFFSET UNITYSDK_OFFSET(0x1C863470)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_0_OFFSET UNITYSDK_OFFSET(0x1C863580)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_1_OFFSET UNITYSDK_OFFSET(0x1C863590)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconControl_TypeDefinitionIndex = 80306;
