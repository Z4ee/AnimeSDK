...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_GET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0x1AC64360)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_SET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0x1AC643A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC646D0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0x1AC64400)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__REFRESHCONTENT_OFFSET UNITYSDK_OFFSET(0x1AC645E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_0_OFFSET UNITYSDK_OFFSET(0x1AC646E0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_1_OFFSET UNITYSDK_OFFSET(0x1AC646F0)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconControl_TypeDefinitionIndex = 76669;
