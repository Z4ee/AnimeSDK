...
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_GET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0xC9F3230)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL_SET_FEVERMAZEBUFFID_OFFSET UNITYSDK_OFFSET(0xC9F3270)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F3590)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__ENSUREINITIALIZEINTERACTION_OFFSET UNITYSDK_OFFSET(0xC9F32D0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL__REFRESHCONTENT_OFFSET UNITYSDK_OFFSET(0xC9F34A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_0_OFFSET UNITYSDK_OFFSET(0xC9F35A0)
#define RPG_CLIENT_CHALLENGE_STORY_CHALLENGESTORYFEVERMAZEBUFFICONCONTROL___ENSUREINITIALIZEINTERACTION_B__10_1_OFFSET UNITYSDK_OFFSET(0xC9F35B0)

namespace RPG::Client::Challenge::Story
{
	inline static constexpr unsigned int ChallengeStoryFeverMazeBuffIconControl_TypeDefinitionIndex = 80307;
