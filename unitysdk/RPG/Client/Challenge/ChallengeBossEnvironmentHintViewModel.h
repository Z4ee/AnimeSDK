...
#define RPG_CLIENT_CHALLENGE_CHALLENGEBOSSENVIRONMENTHINTVIEWMODEL_GET_BOSSMONSTERDATA_OFFSET UNITYSDK_OFFSET(0xB4C13E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEBOSSENVIRONMENTHINTVIEWMODEL_GET_BOSSMONSTERGUIDEDATA_OFFSET UNITYSDK_OFFSET(0xB4C13F0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEBOSSENVIRONMENTHINTVIEWMODEL_GET_CURRENTSTAGEBUFFID_OFFSET UNITYSDK_OFFSET(0xB4C13D0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEBOSSENVIRONMENTHINTVIEWMODEL_GET_CURRENTSTAGENUMBER_OFFSET UNITYSDK_OFFSET(0xB4C13C0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEBOSSENVIRONMENTHINTVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C1400)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeBossEnvironmentHintViewModel_TypeDefinitionIndex = 74084;
	...
	public:
		...
		::System::Int32 _CurrentStageNumber_k__BackingField; // 0x28
		::System::Nullable_1<::System::UInt32> _CurrentStageBuffID_k__BackingField; // 0x2C
