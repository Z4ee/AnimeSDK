...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_GET_MONSTERGUIDE_OFFSET UNITYSDK_OFFSET(0x1C85E440)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x1C85E7A0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_DFFB81CA3843CA77_OFFSET UNITYSDK_OFFSET(0x1C85E8A0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_F03D63E1E8386224_OFFSET UNITYSDK_OFFSET(0x1C85EC90)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0x1C85E830)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x1C85E520)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_SET_MONSTERGUIDE_OFFSET UNITYSDK_OFFSET(0x1C85E480)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C85EEB0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL___REFRESH_B__11_0_OFFSET UNITYSDK_OFFSET(0x1C85EEC0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL___REFRESH_B__11_1_OFFSET UNITYSDK_OFFSET(0x1C85EED0)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossGuideTagListControl_TypeDefinitionIndex = 80313;
	...
	public:
		...
		::System::Void Method_5_F03D63E1E8386224(::System::Int32 a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGLISTCONTROL_METHOD_5_F03D63E1E8386224_OFFSET))(this, a1);
		}
