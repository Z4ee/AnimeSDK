...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL_GET_AVATARS_OFFSET UNITYSDK_OFFSET(0xB4BF600)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL_GET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0xB4BF640)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL_GET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0xB4BF620)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL_SET_AVATARS_OFFSET UNITYSDK_OFFSET(0xB4BF610)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL_SET_CURRENTBUFFID_OFFSET UNITYSDK_OFFSET(0xB4BF650)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL_SET_TEAMINDEX_OFFSET UNITYSDK_OFFSET(0xB4BF630)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSBUFFSELECTTEAMINFOVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4BF660)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossBuffSelectTeamInfoViewModel_TypeDefinitionIndex = 74295;
