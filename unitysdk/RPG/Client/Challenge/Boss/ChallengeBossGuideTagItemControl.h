...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x1AC5F1A0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_ONCLICK_OFFSET UNITYSDK_OFFSET(0x1AC5F0D0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_SHOULDSHOWRIGHTBAR_OFFSET UNITYSDK_OFFSET(0x1AC5F280)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0x1AC5F220)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC5F130)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_SHOULDSHOWRIGHTBAR_OFFSET UNITYSDK_OFFSET(0x1AC5F2F0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC5F350)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossGuideTagItemControl_TypeDefinitionIndex = 76675;
