...
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_BTNROOT_OFFSET UNITYSDK_OFFSET(0xC9EE1F0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xC9EE2A0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_GET_SHOULDSHOWRIGHTBAR_OFFSET UNITYSDK_OFFSET(0xC9EE380)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_ISSPECIAL_OFFSET UNITYSDK_OFFSET(0xC9EE320)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_NAME_OFFSET UNITYSDK_OFFSET(0xC9EE230)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL_SET_SHOULDSHOWRIGHTBAR_OFFSET UNITYSDK_OFFSET(0xC9EE3F0)
#define RPG_CLIENT_CHALLENGE_BOSS_CHALLENGEBOSSGUIDETAGITEMCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9EE450)

namespace RPG::Client::Challenge::Boss
{
	inline static constexpr unsigned int ChallengeBossGuideTagItemControl_TypeDefinitionIndex = 80313;
