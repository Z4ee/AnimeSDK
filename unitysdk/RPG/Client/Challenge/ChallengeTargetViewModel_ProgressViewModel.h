...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C863170)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL_GET_TOTAL_OFFSET UNITYSDK_OFFSET(0x1C863180)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C862F40)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetViewModel_ProgressViewModel_TypeDefinitionIndex = 80099;
