...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4C3BF0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL_GET_TOTAL_OFFSET UNITYSDK_OFFSET(0xB4C3C00)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_PROGRESSVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C3A20)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetViewModel_ProgressViewModel_TypeDefinitionIndex = 74083;
