...
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL_GET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1AC61DB0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL_SET_GROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1AC61DF0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC61F50)
#define RPG_CLIENT_CHALLENGE_CHALLENGEGROUPTYPENAMECONTROL__REFRESH_OFFSET UNITYSDK_OFFSET(0x1AC61E40)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeGroupTypeNameControl_TypeDefinitionIndex = 76456;
