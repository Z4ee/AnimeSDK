...
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_ISNEWFINISHED_OFFSET UNITYSDK_OFFSET(0xB4C3BA0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_NAMEPARAMS_OFFSET UNITYSDK_OFFSET(0xB4C2FD0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_NAME_OFFSET UNITYSDK_OFFSET(0xB4C2F90)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_PROGRESSCURRENT_OFFSET UNITYSDK_OFFSET(0xB4C3B60)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_PROGRESSTOTAL_OFFSET UNITYSDK_OFFSET(0xB4C3B80)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0xB4C38A0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_SHOULDHIDEPROGRESS_OFFSET UNITYSDK_OFFSET(0xB4C39E0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET_STATE_OFFSET UNITYSDK_OFFSET(0xB4C3810)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_GET__MODELHASPROGRESSTOSHOW_OFFSET UNITYSDK_OFFSET(0xB4C3830)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_SET_ISNEWFINISHED_OFFSET UNITYSDK_OFFSET(0xB4C3BB0)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL_SET_SHOULDHIDEPROGRESS_OFFSET UNITYSDK_OFFSET(0xB4C3A30)
#define RPG_CLIENT_CHALLENGE_CHALLENGETARGETVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xB4C3BC0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeTargetViewModel_TypeDefinitionIndex = 74082;
	...
	public:
		...
		::System::Boolean _ShouldHideProgress; // 0x28
		::System::Boolean _IsNewFinished_k__BackingField; // 0x29
