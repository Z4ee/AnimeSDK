...
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1AC5FFD0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL_METHOD_5_884D1F26F1876C89_OFFSET UNITYSDK_OFFSET(0x1AC60060)
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x1AC60010)
#define RPG_CLIENT_CHALLENGE_CHALLENGEATTACKDAMAGETYPECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC600F0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeAttackDamageTypeControl_TypeDefinitionIndex = 76449;
