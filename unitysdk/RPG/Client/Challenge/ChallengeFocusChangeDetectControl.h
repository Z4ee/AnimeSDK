...
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL_GET_ONFOCUSED_OFFSET UNITYSDK_OFFSET(0xC9F0150)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC9F0410)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC9F0160)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC9F0270)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONUIFOCUSCONTROLLERCHANGED_OFFSET UNITYSDK_OFFSET(0xC9F02F0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeFocusChangeDetectControl_TypeDefinitionIndex = 80088;
