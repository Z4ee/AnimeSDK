...
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL_GET_ONFOCUSED_OFFSET UNITYSDK_OFFSET(0x1C860130)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C8603F0)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONBINDVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x1C860140)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C860250)
#define RPG_CLIENT_CHALLENGE_CHALLENGEFOCUSCHANGEDETECTCONTROL__ONUIFOCUSCONTROLLERCHANGED_OFFSET UNITYSDK_OFFSET(0x1C8602D0)

namespace RPG::Client::Challenge
{
	inline static constexpr unsigned int ChallengeFocusChangeDetectControl_TypeDefinitionIndex = 80087;
