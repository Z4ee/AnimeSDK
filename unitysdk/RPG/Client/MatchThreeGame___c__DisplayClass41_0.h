...
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS41_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBF79CF0)
#define RPG_CLIENT_MATCHTHREEGAME___C__DISPLAYCLASS41_0___UPDATEROYALEPLAYERREALTIMEDATA_B__0_OFFSET UNITYSDK_OFFSET(0xBF80F70)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeGame___c__DisplayClass41_0_TypeDefinitionIndex = 61638;

	class MatchThreeGame___c__DisplayClass41_0 : public ::System::Object
	{
	public:
		::Class_1_1CBA230307F9C289_25* playerData; // 0x10
