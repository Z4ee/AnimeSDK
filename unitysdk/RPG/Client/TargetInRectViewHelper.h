...
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_METHOD_5_364218EFFA097A51_OFFSET UNITYSDK_OFFSET(0xA5488D0)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_METHOD_5_7A50CDD4EBE01E4D_OFFSET UNITYSDK_OFFSET(0xA549CD0)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_START_OFFSET UNITYSDK_OFFSET(0xA5486F0)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_UPDATE_OFFSET UNITYSDK_OFFSET(0xA548A90)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA549EA0)

namespace RPG::Client
{
	inline static constexpr unsigned int TargetInRectViewHelper_TypeDefinitionIndex = 56780;
