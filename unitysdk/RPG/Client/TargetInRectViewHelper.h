...
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_METHOD_5_364218EFFA097A51_OFFSET UNITYSDK_OFFSET(0xC9D3B60)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_METHOD_5_7A50CDD4EBE01E4D_OFFSET UNITYSDK_OFFSET(0xC9D4F50)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_START_OFFSET UNITYSDK_OFFSET(0xC9D3990)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9D3D20)
#define RPG_CLIENT_TARGETINRECTVIEWHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9D5120)

namespace RPG::Client
{
	inline static constexpr unsigned int TargetInRectViewHelper_TypeDefinitionIndex = 64946;
