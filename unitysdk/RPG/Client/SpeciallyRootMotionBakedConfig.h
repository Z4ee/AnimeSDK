...
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0xA4B45D0)
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG_METHOD_3_D312AC433EF9B2FD_OFFSET UNITYSDK_OFFSET(0xA4B4630)
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA4B4740)

namespace RPG::Client
{
	inline static constexpr unsigned int SpeciallyRootMotionBakedConfig_TypeDefinitionIndex = 48662;
