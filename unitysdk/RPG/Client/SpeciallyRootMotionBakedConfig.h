...
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0xB1A5B90)
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG_METHOD_3_D312AC433EF9B2FD_OFFSET UNITYSDK_OFFSET(0xB1A5BF0)
#define RPG_CLIENT_SPECIALLYROOTMOTIONBAKEDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A5D00)

namespace RPG::Client
{
	inline static constexpr unsigned int SpeciallyRootMotionBakedConfig_TypeDefinitionIndex = 55411;
