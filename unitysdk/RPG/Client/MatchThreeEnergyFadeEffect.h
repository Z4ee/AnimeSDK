...
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xA82D0E0)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_METHOD_5_308A4BF208DA297E_OFFSET UNITYSDK_OFFSET(0xA82CF30)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_METHOD_5_45145A6EAA55CDC0_OFFSET UNITYSDK_OFFSET(0xA82CC50)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_METHOD_5_5138086028772073_OFFSET UNITYSDK_OFFSET(0xA82CE80)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xA82D170)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA82D120)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xA826560)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xA82D0A0)
#define RPG_CLIENT_MATCHTHREEENERGYFADEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xA82D250)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeEnergyFadeEffect_TypeDefinitionIndex = 60696;
