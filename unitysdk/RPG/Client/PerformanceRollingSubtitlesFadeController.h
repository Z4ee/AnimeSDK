...
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_STARTFADE_OFFSET UNITYSDK_OFFSET(0x18654D60)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x18654920)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x186549D0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18654F70)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__ONFADEOUTFINISH_OFFSET UNITYSDK_OFFSET(0x18654C10)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__STARTFADEIN_OFFSET UNITYSDK_OFFSET(0x18654E90)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__STARTFADEOUT_OFFSET UNITYSDK_OFFSET(0x18654F00)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER___ONFADEOUTFINISH_B__5_0_OFFSET UNITYSDK_OFFSET(0x18654F80)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesFadeController_TypeDefinitionIndex = 72769;
