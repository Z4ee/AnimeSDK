...
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_STARTFADE_OFFSET UNITYSDK_OFFSET(0xAC53580)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xAC53150)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xAC53210)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC53790)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__ONFADEOUTFINISH_OFFSET UNITYSDK_OFFSET(0xAC53440)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__STARTFADEIN_OFFSET UNITYSDK_OFFSET(0xAC536B0)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER__STARTFADEOUT_OFFSET UNITYSDK_OFFSET(0xAC53720)
#define RPG_CLIENT_PERFORMANCEROLLINGSUBTITLESFADECONTROLLER___ONFADEOUTFINISH_B__5_0_OFFSET UNITYSDK_OFFSET(0xAC537A0)

namespace RPG::Client
{
	inline static constexpr unsigned int PerformanceRollingSubtitlesFadeController_TypeDefinitionIndex = 67112;
