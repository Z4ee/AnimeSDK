...
#define RPG_CLIENT_GRIDFIGHTGRIDPUTDOWNEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xBB92A60)
#define RPG_CLIENT_GRIDFIGHTGRIDPUTDOWNEFFECT_ONCREATE_OFFSET UNITYSDK_OFFSET(0xBB928C0)
#define RPG_CLIENT_GRIDFIGHTGRIDPUTDOWNEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xBB92AA0)
#define RPG_CLIENT_GRIDFIGHTGRIDPUTDOWNEFFECT_PLAY_OFFSET UNITYSDK_OFFSET(0xBB92AE0)
#define RPG_CLIENT_GRIDFIGHTGRIDPUTDOWNEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xBB92A20)
#define RPG_CLIENT_GRIDFIGHTGRIDPUTDOWNEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBB92D10)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGridPutDownEffect_TypeDefinitionIndex = 60284;
