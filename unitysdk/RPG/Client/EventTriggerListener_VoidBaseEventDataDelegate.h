...
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDBASEEVENTDATADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xCECE650)
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDBASEEVENTDATADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xCECE690)
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDBASEEVENTDATADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xCECDE20)
#define RPG_CLIENT_EVENTTRIGGERLISTENER_VOIDBASEEVENTDATADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xCECE5D0)

namespace RPG::Client
{
	inline static constexpr unsigned int EventTriggerListener_VoidBaseEventDataDelegate_TypeDefinitionIndex = 72458;
