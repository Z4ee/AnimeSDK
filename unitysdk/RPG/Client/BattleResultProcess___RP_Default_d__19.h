...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FB9570)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FB95B0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FB9610)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FB95C0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FB9560)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB5090)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_Default_d__19_TypeDefinitionIndex = 58272;
