...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xB414330)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB414370)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xB4143D0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xB414380)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB414320)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_DEFAULT_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0xB410D20)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_Default_d__19_TypeDefinitionIndex = 57025;
