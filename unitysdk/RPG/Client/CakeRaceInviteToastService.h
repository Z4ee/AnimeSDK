...
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET_GAMEFLOW_OFFSET UNITYSDK_OFFSET(0xB4A4770)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET_ISFORCEVALID_OFFSET UNITYSDK_OFFSET(0xB4A4750)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET_UIMANAGER_OFFSET UNITYSDK_OFFSET(0xB4A46D0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__DISABLED_OFFSET UNITYSDK_OFFSET(0xB4A4810)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__ISACTIVE_OFFSET UNITYSDK_OFFSET(0xB4A42E0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__ISRUNNING_OFFSET UNITYSDK_OFFSET(0xB4A4820)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_GET__ISSHOWING_OFFSET UNITYSDK_OFFSET(0xB4A46C0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SETCANSHOW_OFFSET UNITYSDK_OFFSET(0xB4A3B10)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SETDISABLED_OFFSET UNITYSDK_OFFSET(0xB4A40E0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SETRUNNING_OFFSET UNITYSDK_OFFSET(0xB4A3EF0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SET_ISFORCEVALID_OFFSET UNITYSDK_OFFSET(0xB4A4760)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SET__DISABLED_OFFSET UNITYSDK_OFFSET(0xB4A4150)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE_SET__ISRUNNING_OFFSET UNITYSDK_OFFSET(0xB4A4830)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4A34E0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__INIT_OFFSET UNITYSDK_OFFSET(0xB4A3900)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ISVALIDINVITATION_OFFSET UNITYSDK_OFFSET(0xB4A4340)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0xB4A4570)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ONRECEIVECONTACT_OFFSET UNITYSDK_OFFSET(0xB4A41A0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__ONTOASTDIALOGEXIT_OFFSET UNITYSDK_OFFSET(0xB4A44E0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__TRYPLAYNEXT_OFFSET UNITYSDK_OFFSET(0xB4A3BC0)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE__TRYSTOPCURRENT_OFFSET UNITYSDK_OFFSET(0xB4A3E90)
#define RPG_CLIENT_CAKERACEINVITETOASTSERVICE___TRYPLAYNEXT_B__8_0_OFFSET UNITYSDK_OFFSET(0xB4A4840)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceInviteToastService_TypeDefinitionIndex = 58999;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(CakeRaceInviteToastService_TypeDefinitionIndex)->GetStaticField(0x115D0);
		}
		...
		::System::Collections::Generic::List_1<::RPG::Client::CakeRace::CakeRaceUIType>* _AutomaticallySetCanShowOnFocusTypes; // 0x20
		::System::Collections::Generic::HashSet_1<::System::String*>* _AutomaticallySetCanShowOnFocus; // 0x28
