...
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_GETBLACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1BD3D380)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_GET_HASBLACKQUEST_OFFSET UNITYSDK_OFFSET(0x1BD3D230)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_GET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1BD3D210)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SELECTMEMBER_OFFSET UNITYSDK_OFFSET(0x1BD3CFA0)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SELECT_OFFSET UNITYSDK_OFFSET(0x1BD3D130)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SET_OPTIONS_OFFSET UNITYSDK_OFFSET(0x1BD3D220)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION_SYNC_OFFSET UNITYSDK_OFFSET(0x1BD3CD90)
#define RPG_CLIENT_GRIDFIGHTFATEPRAYSELECTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD3CD20)
