...
#define RPG_CLIENT_SDKLOGINPHASE___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19F24050)
#define RPG_CLIENT_SDKLOGINPHASE___C__DISPLAYCLASS8_0___INITSDK_B__0_OFFSET UNITYSDK_OFFSET(0x19F25340)

namespace RPG::Client
{
	inline static constexpr unsigned int SDKLoginPhase___c__DisplayClass8_0_TypeDefinitionIndex = 58426;
