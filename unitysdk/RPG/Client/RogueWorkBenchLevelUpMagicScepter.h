...
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GETFUNCID_OFFSET UNITYSDK_OFFSET(0x16A14810)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GETFUNCTYPE_OFFSET UNITYSDK_OFFSET(0x16A147C0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x16A149B0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_GET_LEVELUPSCEPTERITEMLIST_OFFSET UNITYSDK_OFFSET(0x16A14600)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_OPENFUNCUIPAGE_OFFSET UNITYSDK_OFFSET(0x16A14850)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_REFRESH_OFFSET UNITYSDK_OFFSET(0x16A144D0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER_SET_ISDISABLE_OFFSET UNITYSDK_OFFSET(0x16A149C0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16A142B0)
#define RPG_CLIENT_ROGUEWORKBENCHLEVELUPMAGICSCEPTER__GENERATELEVELUPINFODATA_OFFSET UNITYSDK_OFFSET(0x16A142E0)
