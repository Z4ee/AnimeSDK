...
#define RPG_CLIENT_CHIMERAMODULE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93C73A0)
#define RPG_CLIENT_CHIMERAMODULE_FINISHENDLESSGAME_OFFSET UNITYSDK_OFFSET(0x93C3C90)
#define RPG_CLIENT_CHIMERAMODULE_FINISHFINALROUND_OFFSET UNITYSDK_OFFSET(0x93C3B60)
#define RPG_CLIENT_CHIMERAMODULE_FINISHORDINARYROUND_OFFSET UNITYSDK_OFFSET(0x93C3850)
#define RPG_CLIENT_CHIMERAMODULE_GETCHIMERADATA_OFFSET UNITYSDK_OFFSET(0x93C30F0)
#define RPG_CLIENT_CHIMERAMODULE_GETCURRENTROUNDID_OFFSET UNITYSDK_OFFSET(0x93C2CA0)
#define RPG_CLIENT_CHIMERAMODULE_GETWORKIDARRAY_OFFSET UNITYSDK_OFFSET(0x93C2A20)
#define RPG_CLIENT_CHIMERAMODULE_GET_ACTIVITYID_OFFSET UNITYSDK_OFFSET(0x93C6A70)
#define RPG_CLIENT_CHIMERAMODULE_GET_ARRANGEMENTINFO_OFFSET UNITYSDK_OFFSET(0x93C6B20)
#define RPG_CLIENT_CHIMERAMODULE_GET_AVATARSELECTQUESTID_OFFSET UNITYSDK_OFFSET(0x93C6A90)
#define RPG_CLIENT_CHIMERAMODULE_GET_BATTLEVIEW_OFFSET UNITYSDK_OFFSET(0x93C6AA0)
#define RPG_CLIENT_CHIMERAMODULE_GET_CHIMERAINFO_OFFSET UNITYSDK_OFFSET(0x93C6AC0)
#define RPG_CLIENT_CHIMERAMODULE_GET_CURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x93C4120)
#define RPG_CLIENT_CHIMERAMODULE_GET_DOINGROUND_OFFSET UNITYSDK_OFFSET(0x93C6C00)
#define RPG_CLIENT_CHIMERAMODULE_GET_ENDLESSMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6BA0)
#define RPG_CLIENT_CHIMERAMODULE_GET_GALLERYINFO_OFFSET UNITYSDK_OFFSET(0x93C6BE0)
#define RPG_CLIENT_CHIMERAMODULE_GET_ISINBATTLEEXITTRANSITION_OFFSET UNITYSDK_OFFSET(0x93C6C20)
#define RPG_CLIENT_CHIMERAMODULE_GET_LIMITACTIVITYREWARDID_OFFSET UNITYSDK_OFFSET(0x93C6A80)
#define RPG_CLIENT_CHIMERAMODULE_GET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0x93C6B00)
#define RPG_CLIENT_CHIMERAMODULE_GET_RANKMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6B80)
#define RPG_CLIENT_CHIMERAMODULE_GET_SETTLEMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6B60)
#define RPG_CLIENT_CHIMERAMODULE_GET_TALKMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6BC0)
#define RPG_CLIENT_CHIMERAMODULE_GET_WORKINFO_OFFSET UNITYSDK_OFFSET(0x93C6B40)
#define RPG_CLIENT_CHIMERAMODULE_GET_WORKROUNDINFO_OFFSET UNITYSDK_OFFSET(0x93C6AE0)
#define RPG_CLIENT_CHIMERAMODULE_INIT_OFFSET UNITYSDK_OFFSET(0x93C6CA0)
#define RPG_CLIENT_CHIMERAMODULE_ISENDLESSFAIL_OFFSET UNITYSDK_OFFSET(0x93C32C0)
#define RPG_CLIENT_CHIMERAMODULE_ISENDLESSOVER_OFFSET UNITYSDK_OFFSET(0x93C3260)
#define RPG_CLIENT_CHIMERAMODULE_ISINENDLESSMODE_OFFSET UNITYSDK_OFFSET(0x93C3210)
#define RPG_CLIENT_CHIMERAMODULE_SENDCHIMERAQUITENDLESSBYPROMISE_OFFSET UNITYSDK_OFFSET(0x93C68C0)
#define RPG_CLIENT_CHIMERAMODULE_SET_ARRANGEMENTINFO_OFFSET UNITYSDK_OFFSET(0x93C6B30)
#define RPG_CLIENT_CHIMERAMODULE_SET_BATTLEVIEW_OFFSET UNITYSDK_OFFSET(0x93C6AB0)
#define RPG_CLIENT_CHIMERAMODULE_SET_CHIMERAINFO_OFFSET UNITYSDK_OFFSET(0x93C6AD0)
#define RPG_CLIENT_CHIMERAMODULE_SET_CURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x93C4130)
#define RPG_CLIENT_CHIMERAMODULE_SET_DOINGROUND_OFFSET UNITYSDK_OFFSET(0x93C6C10)
#define RPG_CLIENT_CHIMERAMODULE_SET_ENDLESSMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6BB0)
#define RPG_CLIENT_CHIMERAMODULE_SET_GALLERYINFO_OFFSET UNITYSDK_OFFSET(0x93C6BF0)
#define RPG_CLIENT_CHIMERAMODULE_SET_ISINBATTLEEXITTRANSITION_OFFSET UNITYSDK_OFFSET(0x93C6C30)
#define RPG_CLIENT_CHIMERAMODULE_SET_PHASEINFO_OFFSET UNITYSDK_OFFSET(0x93C6B10)
#define RPG_CLIENT_CHIMERAMODULE_SET_RANKMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6B90)
#define RPG_CLIENT_CHIMERAMODULE_SET_SETTLEMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6B70)
#define RPG_CLIENT_CHIMERAMODULE_SET_TALKMANAGER_OFFSET UNITYSDK_OFFSET(0x93C6BD0)
#define RPG_CLIENT_CHIMERAMODULE_SET_WORKINFO_OFFSET UNITYSDK_OFFSET(0x93C6B50)
#define RPG_CLIENT_CHIMERAMODULE_SET_WORKROUNDINFO_OFFSET UNITYSDK_OFFSET(0x93C6AF0)
#define RPG_CLIENT_CHIMERAMODULE_STARTENDLESSMODE_OFFSET UNITYSDK_OFFSET(0x93C3DE0)
#define RPG_CLIENT_CHIMERAMODULE_STARTWORK_OFFSET UNITYSDK_OFFSET(0x93C33D0)
#define RPG_CLIENT_CHIMERAMODULE__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x93C4140)
#define RPG_CLIENT_CHIMERAMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x93C7A70)
#define RPG_CLIENT_CHIMERAMODULE__GETENDLESSWORKROUNDID_OFFSET UNITYSDK_OFFSET(0x93C2FD0)
#define RPG_CLIENT_CHIMERAMODULE__GETWORKROUNDID_OFFSET UNITYSDK_OFFSET(0x93C2E60)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERADOFINALROUNDSCRSP_OFFSET UNITYSDK_OFFSET(0x93C6160)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERAFINISHENDLESSROUNDSCRSP_OFFSET UNITYSDK_OFFSET(0x93C5B20)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERAFINISHROUND_OFFSET UNITYSDK_OFFSET(0x93C5350)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERAQUITENDLESSSCRSP_OFFSET UNITYSDK_OFFSET(0x93C5E90)
#define RPG_CLIENT_CHIMERAMODULE__ONCHIMERASTARTENDLESSSCRSP_OFFSET UNITYSDK_OFFSET(0x93C59A0)
#define RPG_CLIENT_CHIMERAMODULE__ONGETDATASCRSP_OFFSET UNITYSDK_OFFSET(0x93C42C0)
#define RPG_CLIENT_CHIMERAMODULE__ONMODULEINITREQ_OFFSET UNITYSDK_OFFSET(0x93C7960)
#define RPG_CLIENT_CHIMERAMODULE__STARTWORK_OFFSET UNITYSDK_OFFSET(0x93C3500)
#define RPG_CLIENT_CHIMERAMODULE__TRYRESOLVEPROMISE_OFFSET UNITYSDK_OFFSET(0x93C40C0)
#define RPG_CLIENT_CHIMERAMODULE__UPDATECURRENTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x93C3F90)
#define RPG_CLIENT_CHIMERAMODULE__UPDATECURRENTWORKREMAINHP_OFFSET UNITYSDK_OFFSET(0x93C3FF0)
#define RPG_CLIENT_CHIMERAMODULE___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93C7B80)
#define RPG_CLIENT_CHIMERAMODULE___IFIXBASEPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x93C7AF0)
#define RPG_CLIENT_CHIMERAMODULE___IFIXBASEPROXY__ADDPACKETHANDLERS_OFFSET UNITYSDK_OFFSET(0x93C7A90)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::Promises::Promise* _QuitEndlessPromise; // 0x10
		::RPG::Client::ChimeraEndlessManager* _EndlessManager_k__BackingField; // 0x18
		::RPG::Client::ChimeraWorkInfo* _WorkInfo_k__BackingField; // 0x20
		::RPG::Client::Promises::Promise* _FinishOrdinaryRoundPromise; // 0x28
		::RPG::Client::Promises::Promise* _FinishFinalRoundPromise; // 0x30
		::RPG::Client::Promises::Promise_1<::System::UInt32>* _StartEndlessPromise; // 0x38
		...
		::RPG::Client::ChimeraPhaseInfo* _PhaseInfo_k__BackingField; // 0x50
		...
		::RPG::Client::ChimeraDoingRoundData* _DoingRound_k__BackingField; // 0x68
		...
		::RPG::Client::ChimeraTeamRankManager* _RankManager_k__BackingField; // 0x80
		::RPG::Client::Promises::Promise* _FinishEndlessRoundPromise; // 0x88
		::RPG::Client::ChimeraInfo* _ChimeraInfo_k__BackingField; // 0x90
