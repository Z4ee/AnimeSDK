...
#define RPG_CLIENT_MULTIPATHHELPER_CHECKHARMONYHEROISUNLOCKEDBYREQUEST_OFFSET UNITYSDK_OFFSET(0x19085A70)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKHASCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x19085BC0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKISMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x19084D40)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKISUNLOCKEDBYREQUEST_OFFSET UNITYSDK_OFFSET(0x19085AD0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKSUPPORTSEARLYUNLOCK_OFFSET UNITYSDK_OFFSET(0x190855C0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKSUPPORTSREPEATUNLOCKREWARD_OFFSET UNITYSDK_OFFSET(0x19085680)
#define RPG_CLIENT_MULTIPATHHELPER_CLEARCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x19085C90)
#define RPG_CLIENT_MULTIPATHHELPER_GETALLMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x19085E30)
#define RPG_CLIENT_MULTIPATHHELPER_GETCACHEDTRANSFERITEM_OFFSET UNITYSDK_OFFSET(0x19085D60)
#define RPG_CLIENT_MULTIPATHHELPER_GETCHANGECONFIG_OFFSET UNITYSDK_OFFSET(0x19085740)
#define RPG_CLIENT_MULTIPATHHELPER_GETDESC_OFFSET UNITYSDK_OFFSET(0x19085860)
#define RPG_CLIENT_MULTIPATHHELPER_GETGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x19084EC0)
#define RPG_CLIENT_MULTIPATHHELPER_GETMULTIPATHAVATARTYPESBYROLE_OFFSET UNITYSDK_OFFSET(0x19086420)
#define RPG_CLIENT_MULTIPATHHELPER_GETUNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0x190854C0)
#define RPG_CLIENT_MULTIPATHHELPER_UNLOCKAVATARPATH_OFFSET UNITYSDK_OFFSET(0x19085960)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiPathHelper_TypeDefinitionIndex = 59884;
