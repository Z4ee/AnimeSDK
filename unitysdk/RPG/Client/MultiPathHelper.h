...
#define RPG_CLIENT_MULTIPATHHELPER_CHECKHARMONYHEROISUNLOCKEDBYREQUEST_OFFSET UNITYSDK_OFFSET(0x1B6E9680)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKHASCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x1B6E97D0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKISMULTIPATHAVATAR_OFFSET UNITYSDK_OFFSET(0x1B6E8940)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKISUNLOCKEDBYREQUEST_OFFSET UNITYSDK_OFFSET(0x1B6E96E0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKSUPPORTSEARLYUNLOCK_OFFSET UNITYSDK_OFFSET(0x1B6E91D0)
#define RPG_CLIENT_MULTIPATHHELPER_CHECKSUPPORTSREPEATUNLOCKREWARD_OFFSET UNITYSDK_OFFSET(0x1B6E9290)
#define RPG_CLIENT_MULTIPATHHELPER_CLEARCACHEDTRANSFERITEMBYUNLOCKAVATAR_OFFSET UNITYSDK_OFFSET(0x1B6E98A0)
#define RPG_CLIENT_MULTIPATHHELPER_GETALLMULTIPATHAVATARTYPES_OFFSET UNITYSDK_OFFSET(0x1B6E9A40)
#define RPG_CLIENT_MULTIPATHHELPER_GETCACHEDTRANSFERITEM_OFFSET UNITYSDK_OFFSET(0x1B6E9970)
#define RPG_CLIENT_MULTIPATHHELPER_GETCHANGECONFIG_OFFSET UNITYSDK_OFFSET(0x1B6E9350)
#define RPG_CLIENT_MULTIPATHHELPER_GETDESC_OFFSET UNITYSDK_OFFSET(0x1B6E9470)
#define RPG_CLIENT_MULTIPATHHELPER_GETGENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1B6E8AC0)
#define RPG_CLIENT_MULTIPATHHELPER_GETMULTIPATHAVATARTYPESBYROLE_OFFSET UNITYSDK_OFFSET(0x1B6EA030)
#define RPG_CLIENT_MULTIPATHHELPER_GETUNLOCKTOAST_OFFSET UNITYSDK_OFFSET(0x1B6E90D0)
#define RPG_CLIENT_MULTIPATHHELPER_UNLOCKAVATARPATH_OFFSET UNITYSDK_OFFSET(0x1B6E9570)
