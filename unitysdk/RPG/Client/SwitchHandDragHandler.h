...
#define RPG_CLIENT_SWITCHHANDDRAGHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B46A310)
#define RPG_CLIENT_SWITCHHANDDRAGHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B46A360)

namespace RPG::Client
{
	inline static constexpr unsigned int SwitchHandDragHandler_TypeDefinitionIndex = 72846;
