...
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD_DISPOSE_OFFSET UNITYSDK_OFFSET(0xDD722A0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xDD722E0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD_METHOD_1_34EEB7902D04C0FD_OFFSET UNITYSDK_OFFSET(0xDD72390)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD_METHOD_1_A6EE3276D5055243_OFFSET UNITYSDK_OFFSET(0xDD72340)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xDD723E0)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD_METHOD_1_E2D0B9E78ACBE575_OFFSET UNITYSDK_OFFSET(0xDD72420)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD__CCTOR_OFFSET UNITYSDK_OFFSET(0xDD72430)
#define RPG_CLIENT_PROPSELECTIONEFFECT_CLASS_1_F34E36657A6030BD__CTOR_OFFSET UNITYSDK_OFFSET(0xDD70EB0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PropSelectionEffect_Class_1_F34E36657A6030BD_TypeDefinitionIndex)->GetStaticField(0x15180);
		}
		::RPG::Client::PropSelectionEffect* CEODOONOFBM; // 0x10
		::RPG::Client::PropSelectionState ACHIDNBOBLA; // 0x18
		::RPG::Client::PropSelectionState DLNIGFGLPLJ; // 0x1C
