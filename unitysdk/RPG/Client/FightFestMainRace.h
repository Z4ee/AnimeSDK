...
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_PHASEID_OFFSET UNITYSDK_OFFSET(0xB9C74D0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RACEBGFIGUREPATH_OFFSET UNITYSDK_OFFSET(0xB9C7670)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RACEDATA_OFFSET UNITYSDK_OFFSET(0xB9C7470)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RACEID_OFFSET UNITYSDK_OFFSET(0xB9C7450)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0xB9C7520)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_RIVALINFO_OFFSET UNITYSDK_OFFSET(0xB9C74B0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_SELFINFO_OFFSET UNITYSDK_OFFSET(0xB9C7490)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_STAGEENDDESC_OFFSET UNITYSDK_OFFSET(0xB9C75F0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xB9C7570)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_RACEDATA_OFFSET UNITYSDK_OFFSET(0xB9C7480)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_RACEID_OFFSET UNITYSDK_OFFSET(0xB9C7460)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_RIVALINFO_OFFSET UNITYSDK_OFFSET(0xB9C74C0)
#define RPG_CLIENT_FIGHTFESTMAINRACE_SET_SELFINFO_OFFSET UNITYSDK_OFFSET(0xB9C74A0)
#define RPG_CLIENT_FIGHTFESTMAINRACE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9C7300)

namespace RPG::Client
{
	inline static constexpr unsigned int FightFestMainRace_TypeDefinitionIndex = 59978;

	class FightFestMainRace : public ::System::Object
	{
	public:
		::RPG::GameCore::FightFestMainRaceRow* _Row; // 0x10
