...
#define RPG_CLIENT_WOLFBROGUNPLAYROADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1680B630)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayRoadConfig_TypeDefinitionIndex = 68715;
