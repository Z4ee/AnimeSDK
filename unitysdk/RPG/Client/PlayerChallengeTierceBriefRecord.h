...
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_GET_BADGEEXPIRETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AE02E40)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_GET_BADGEICONPATH_OFFSET UNITYSDK_OFFSET(0x1AE02E20)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_GET_HASBADGE_OFFSET UNITYSDK_OFFSET(0x1AE02E00)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_GET_ISSPECIALTARGETACHIEVED_OFFSET UNITYSDK_OFFSET(0x1AE02DE0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE02DC0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_RESET_OFFSET UNITYSDK_OFFSET(0x1AE02EE0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_SET_BADGEEXPIRETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AE02E50)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_SET_BADGEICONPATH_OFFSET UNITYSDK_OFFSET(0x1AE02E30)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_SET_HASBADGE_OFFSET UNITYSDK_OFFSET(0x1AE02E10)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_SET_ISSPECIALTARGETACHIEVED_OFFSET UNITYSDK_OFFSET(0x1AE02DF0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AE02DD0)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD_SYNC_OFFSET UNITYSDK_OFFSET(0x1AE02E60)
#define RPG_CLIENT_PLAYERCHALLENGETIERCEBRIEFRECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE02F30)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean _IsSpecialTargetAchieved_k__BackingField; // 0x1C
		::System::Boolean _HasBadge_k__BackingField; // 0x1D
