...
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x974BEC0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x974AFD0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x974B900)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x974B9B0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_METHOD_7_193B69F9A0A775CE_OFFSET UNITYSDK_OFFSET(0x974A3A0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x974BF10)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM___IFIXBASEPROXY_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x974BF60)

namespace RPG::Client
{
	inline static constexpr unsigned int GPUParticleTransformLoopAnim_TypeDefinitionIndex = 57554;
