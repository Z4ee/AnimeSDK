...
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GETTICKLODTEMPLATENAME_OFFSET UNITYSDK_OFFSET(0x193950E0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x19394270)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x19394AC0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_RENDERBUDGETDATA_OFFSET UNITYSDK_OFFSET(0x19394B70)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_GET_RENDERINSTANCECOLLECTMODE_OFFSET UNITYSDK_OFFSET(0x193950D0)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM_METHOD_7_193B69F9A0A775CE_OFFSET UNITYSDK_OFFSET(0x19393640)
#define RPG_CLIENT_GPUPARTICLETRANSFORMLOOPANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x19395130)
