...
namespace RPG::Client
{
	...
	public:
		...
		::System::Int32 __InitAnimationDropDown_b__55_0(::RPG::Client::RenderTestPageContext_AnimationDropDownItem* X, ::RPG::Client::RenderTestPageContext_AnimationDropDownItem* Y)
		{
			return ((::System::Int32(*)(::PVOID, ::RPG::Client::RenderTestPageContext_AnimationDropDownItem*, ::RPG::Client::RenderTestPageContext_AnimationDropDownItem*))((::PBYTE)hIl2Cpp + RPG_CLIENT_RENDERTESTPAGECONTEXT___C___INITANIMATIONDROPDOWN_B__55_0_OFFSET))(this, X, Y);
		}
	};
}
