...
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7C3B90)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7C3C90)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7C3F00)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_GETTARGETGO_OFFSET UNITYSDK_OFFSET(0xD7C3F50)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_IGNOREINEDITOR_OFFSET UNITYSDK_OFFSET(0xD7C3B50)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_ONPREREATTACH_OFFSET UNITYSDK_OFFSET(0xD7C3FA0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_ONREATTACHED_OFFSET UNITYSDK_OFFSET(0xD7C3FF0)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7C3D20)
#define RPG_CLIENT_MONOEFFECTPLUGINPLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C4040)
