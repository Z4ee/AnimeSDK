...
#define RPG_CLIENT_SERIALIZEDIMAGE_CULL_OFFSET UNITYSDK_OFFSET(0xC8B47B0)
#define RPG_CLIENT_SERIALIZEDIMAGE_GET_MESH_OFFSET UNITYSDK_OFFSET(0xC8B4810)
#define RPG_CLIENT_SERIALIZEDIMAGE_SET_MESH_OFFSET UNITYSDK_OFFSET(0xC8B4820)
#define RPG_CLIENT_SERIALIZEDIMAGE_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0xC8B46C0)
#define RPG_CLIENT_SERIALIZEDIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0xC8B4830)
#define RPG_CLIENT_SERIALIZEDIMAGE___IFIXBASEPROXY_CULL_OFFSET UNITYSDK_OFFSET(0xC8B4870)
#define RPG_CLIENT_SERIALIZEDIMAGE___IFIXBASEPROXY_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0xC8B4860)

namespace RPG::Client
{
	inline static constexpr unsigned int SerializedImage_TypeDefinitionIndex = 67875;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Rect, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_SERIALIZEDIMAGE___IFIXBASEPROXY_CULL_OFFSET))(this, a1, a2);
		}
	};
}
