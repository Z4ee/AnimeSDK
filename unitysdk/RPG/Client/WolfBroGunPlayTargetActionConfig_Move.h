...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xCC3DF40)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVE_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xCC3DFD0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC3DFC0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Move_TypeDefinitionIndex = 64266;
