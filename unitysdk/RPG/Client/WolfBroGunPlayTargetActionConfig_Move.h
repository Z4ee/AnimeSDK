...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x168113B0)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x16811430)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_Move_TypeDefinitionIndex = 68674;
