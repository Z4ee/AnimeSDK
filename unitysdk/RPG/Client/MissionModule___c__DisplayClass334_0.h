...
#define RPG_CLIENT_MISSIONMODULE___C__DISPLAYCLASS334_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC026630)
#define RPG_CLIENT_MISSIONMODULE___C__DISPLAYCLASS334_0__GETMAINMISSIONDATAWITHPROMISE_B__0_OFFSET UNITYSDK_OFFSET(0xC034760)

namespace RPG::Client
{
	inline static constexpr unsigned int MissionModule___c__DisplayClass334_0_TypeDefinitionIndex = 61855;
	...
	public:
		...
		::RPG::Client::Promises::Promise_1<::System::Collections::Generic::List_1<::RPG::Client::MainMissionData*>*>* promise; // 0x20
