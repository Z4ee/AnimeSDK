...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEOUTLINE_GETBASECHARACTERFILTER_OFFSET UNITYSDK_OFFSET(0xA977BB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEOUTLINE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA977C20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA978370)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPFACEOUTLINE___IFIXBASEPROXY_GETBASECHARACTERFILTER_OFFSET UNITYSDK_OFFSET(0xA9783D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropFaceOutline_TypeDefinitionIndex = 64490;
