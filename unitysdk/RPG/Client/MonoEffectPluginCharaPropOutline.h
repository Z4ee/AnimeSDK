...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA97A970)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xA97A9B0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xA97BC20)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xA97BC40)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropOutline_TypeDefinitionIndex = 64501;
