...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xC0C71A0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xC0C71E0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C8440)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0xC0C8460)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropOutline_TypeDefinitionIndex = 65422;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET))(this);
		}
	};
}
