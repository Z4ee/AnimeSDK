...
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CB8950)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE_UPDATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CB8990)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9CB9C00)
#define RPG_CLIENT_MONOEFFECTPLUGINCHARAPROPOUTLINE___IFIXBASEPROXY_ISNEEDLUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x9CB9C20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginCharaPropOutline_TypeDefinitionIndex = 57247;
