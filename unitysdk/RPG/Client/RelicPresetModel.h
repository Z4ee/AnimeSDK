...
#define RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETAPPLYDETAIL_OFFSET UNITYSDK_OFFSET(0x19881550)
#define RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETSAVEDIALOG_OFFSET UNITYSDK_OFFSET(0x198812B0)
#define RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETSAVEVIEWMODELBYPLANDATA_OFFSET UNITYSDK_OFFSET(0x19881720)
#define RPG_CLIENT_RELICPRESETMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19880BB0)
#define RPG_CLIENT_RELICPRESETMODEL_GETAVATARRELICPRESETPLAN_OFFSET UNITYSDK_OFFSET(0x1987C200)
#define RPG_CLIENT_RELICPRESETMODEL_GETORCREATEAVATARPLANS_OFFSET UNITYSDK_OFFSET(0x198810C0)
#define RPG_CLIENT_RELICPRESETMODEL_INIT_OFFSET UNITYSDK_OFFSET(0x19880B70)
#define RPG_CLIENT_RELICPRESETMODEL_ISAVATARPLANFULL_OFFSET UNITYSDK_OFFSET(0x19881000)
#define RPG_CLIENT_RELICPRESETMODEL_SETAVATARPLANS_OFFSET UNITYSDK_OFFSET(0x198811F0)
#define RPG_CLIENT_RELICPRESETMODEL_TRYFINDPLANBYUNIQUEID_OFFSET UNITYSDK_OFFSET(0x19880DF0)
#define RPG_CLIENT_RELICPRESETMODEL_TRYGETPLANS_OFFSET UNITYSDK_OFFSET(0x1987D0D0)
#define RPG_CLIENT_RELICPRESETMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19881880)

namespace RPG::Client
{
	inline static constexpr unsigned int RelicPresetModel_TypeDefinitionIndex = 63873;
	...
	public:
		...
		::RPG::Client::RelicPresetSaveDialogViewModel* CreateRelicPresetSaveDialog(::System::UInt32 a1, ::Enum_3_71AA90D596A09AC8_18 a2)
		{
			return ((::RPG::Client::RelicPresetSaveDialogViewModel*(*)(::PVOID, ::System::UInt32, ::Enum_3_71AA90D596A09AC8_18))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETSAVEDIALOG_OFFSET))(this, a1, a2);
		}
		...
		::RPG::Client::RelicPresetCustomSaveViewModel* CreateRelicPresetSaveViewModelByPlanData(::System::UInt32 a1, ::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData* a2, ::Enum_3_71AA90D596A09AC8_18 a3)
		{
			return ((::RPG::Client::RelicPresetCustomSaveViewModel*(*)(::PVOID, ::System::UInt32, ::RPG::Client::RelicSmartSuit::RelicSmartSuitCalculationResultData*, ::Enum_3_71AA90D596A09AC8_18))((::PBYTE)hIl2Cpp + RPG_CLIENT_RELICPRESETMODEL_CREATERELICPRESETSAVEVIEWMODELBYPLANDATA_OFFSET))(this, a1, a2, a3);
		}
	};
}
