...
#define RPG_CLIENT_PROXYEFFECTPROP__CTOR_OFFSET UNITYSDK_OFFSET(0xA236A20)

namespace RPG::Client
{
	inline static constexpr unsigned int ProxyEffectProp_TypeDefinitionIndex = 48993;
