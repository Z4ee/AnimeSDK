...
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYADVPLAYERID_OFFSET UNITYSDK_OFFSET(0x915D610)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARID_OFFSET UNITYSDK_OFFSET(0x915CFC0)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARROWWRAP_OFFSET UNITYSDK_OFFSET(0x915CF40)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARSKINDATA_OFFSET UNITYSDK_OFFSET(0x915D510)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYAVATARSKINID_OFFSET UNITYSDK_OFFSET(0x915D200)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYDISPLAYINFO_OFFSET UNITYSDK_OFFSET(0x915D410)
#define RPG_CLIENT_AVATARSKINDATAFACTORY_CREATEBYSPECIALAVATARID_OFFSET UNITYSDK_OFFSET(0x915D480)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarSkinDataFactory_TypeDefinitionIndex = 50779;
