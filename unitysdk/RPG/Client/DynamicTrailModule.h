...
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_0A5DD54A2675889F_OFFSET UNITYSDK_OFFSET(0xA1A6480)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_18E27E0AADCE7FDC_OFFSET UNITYSDK_OFFSET(0xA1AA070)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_2B0FDB087B81F04A_OFFSET UNITYSDK_OFFSET(0xA1A99C0)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_2E70293D08C556A8_OFFSET UNITYSDK_OFFSET(0xA1A9E90)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_508D4DD02D3DB74E_OFFSET UNITYSDK_OFFSET(0xA1A86F0)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0xA1A8380)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_5835DC16FC46989B_OFFSET UNITYSDK_OFFSET(0xA1A5F60)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xA1A6090)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_8CA88D55ECEFAD59_OFFSET UNITYSDK_OFFSET(0xA1A6800)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA1A8840)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_C2A4063B80814910_OFFSET UNITYSDK_OFFSET(0xA1A9720)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_CD9F3CEFB366C27A_OFFSET UNITYSDK_OFFSET(0xA1A88E0)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_D109CE569415FA03_OFFSET UNITYSDK_OFFSET(0xA1A6210)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_E52129E82CD2D7F8_OFFSET UNITYSDK_OFFSET(0xA1A6540)
#define RPG_CLIENT_DYNAMICTRAILMODULE_METHOD_1_F63FE1AA9633F811_OFFSET UNITYSDK_OFFSET(0xA1A6900)
#define RPG_CLIENT_DYNAMICTRAILMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0xA1AAA50)

namespace RPG::Client
{
	inline static constexpr unsigned int DynamicTrailModule_TypeDefinitionIndex = 64940;
