...
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_CREATE_OFFSET UNITYSDK_OFFSET(0x9FCC9A0)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_GETDESC_OFFSET UNITYSDK_OFFSET(0x9FCD080)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_GETTITLE_OFFSET UNITYSDK_OFFSET(0x9FCCFF0)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_GET_NOMINATETYPE_OFFSET UNITYSDK_OFFSET(0x9FCD9F0)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_ISSATISFY_OFFSET UNITYSDK_OFFSET(0x9FCCA30)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE_SET_NOMINATETYPE_OFFSET UNITYSDK_OFFSET(0x9FCDA00)
#define RPG_CLIENT_PLANETFESSUMMARYPLAYERNOMINATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9FCCFE0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesSummaryPlayerNominate_TypeDefinitionIndex = 54237;
