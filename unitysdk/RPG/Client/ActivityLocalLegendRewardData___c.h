...
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC61F560)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC61F5A0)
#define RPG_CLIENT_ACTIVITYLOCALLEGENDREWARDDATA___C__HASUNTAKENREWARD_B__1_0_OFFSET UNITYSDK_OFFSET(0xC61F5B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Func_2<::RPG::Client::ActivityLocalLegendRewardGroup*, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ActivityLocalLegendRewardData___c_TypeDefinitionIndex)->GetStaticField(0x61870);
		}
		static ::RPG::Client::ActivityLocalLegendRewardData___c** StaticGet___9()
		{
			return (::RPG::Client::ActivityLocalLegendRewardData___c**)Il2CppClass::FromTypeDefinitionIndex(ActivityLocalLegendRewardData___c_TypeDefinitionIndex)->GetStaticField(0x61878);
		}
