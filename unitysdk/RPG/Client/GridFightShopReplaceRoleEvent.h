...
#define RPG_CLIENT_GRIDFIGHTSHOPREPLACEROLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xA5900A0)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightShopReplaceRoleEvent_TypeDefinitionIndex = 60049;
