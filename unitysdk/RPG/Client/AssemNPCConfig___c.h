...
#define RPG_CLIENT_ASSEMNPCCONFIG___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC77E670)
#define RPG_CLIENT_ASSEMNPCCONFIG___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC77E6B0)
#define RPG_CLIENT_ASSEMNPCCONFIG___C__INSERTNPCTODIC_B__5_0_OFFSET UNITYSDK_OFFSET(0xC77E6C0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Comparison_1<::RPG::Client::AssemNPC*>**)Il2CppClass::FromTypeDefinitionIndex(AssemNPCConfig___c_TypeDefinitionIndex)->GetStaticField(0x657D0);
		}
		static ::RPG::Client::AssemNPCConfig___c** StaticGet___9()
		{
			return (::RPG::Client::AssemNPCConfig___c**)Il2CppClass::FromTypeDefinitionIndex(AssemNPCConfig___c_TypeDefinitionIndex)->GetStaticField(0x657D8);
		}
