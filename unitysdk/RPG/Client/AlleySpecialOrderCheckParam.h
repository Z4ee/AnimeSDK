...
#define RPG_CLIENT_ALLEYSPECIALORDERCHECKPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C86350)

namespace RPG::Client
{
	inline static constexpr unsigned int AlleySpecialOrderCheckParam_TypeDefinitionIndex = 62351;
