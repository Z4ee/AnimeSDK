...
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_DISPATCH_OFFSET UNITYSDK_OFFSET(0x1ABC7080)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x1ABC70E0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET UNITYSDK_OFFSET(0x1ABC71C0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_RESET_OFFSET UNITYSDK_OFFSET(0x1ABC6DB0)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC6980)
#define RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA__INITDATACHANGECOLLECTOR_OFFSET UNITYSDK_OFFSET(0x1ABC6C30)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightGameEventData_TypeDefinitionIndex = 61633;
	...
	public:
		...
		::RPG::Client::GridFightPrayQuestChangeCollector* PrayQuestData; // 0x10
		::RPG::Client::GridFightOrbChangeCollector* OrbData; // 0x18
		::RPG::Client::GridFightTrackChangeCollector* TrackData; // 0x20
		::RPG::Client::GridFightConsumableChangeCollector* ConsumableData; // 0x28
		::RPG::Client::GridFightNPCChangeCollector* NPCData; // 0x30
		::RPG::Client::GridFightPlayerChangeCollector* PlayerData; // 0x38
		::RPG::Client::GridFightAugmentChangeCollector* AugmentData; // 0x40
		::RPG::Client::GridFightEquipChangeCollector* EquipData; // 0x48
		::RPG::Client::GridFightStageChangeCollector* StageData; // 0x50
		::RPG::Client::GridFightTraitChangeCollector* TraitData; // 0x58
		::RPG::Client::GridFightForgeChangeCollector* ForgeData; // 0x60
		::RPG::Client::GridFightProjectionChangeCollector* ProjData; // 0x68
		::RPG::Client::GridFightShopChangeCollector* ShopData; // 0x70
		::RPG::Client::GridFightRoleChangeCollector* RoleData; // 0x78
		::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_0_16E4307DCC419505_803*>* _CollectorsLUT; // 0x80
		...
		::Class_0_16E4307DCC419505_803* GetCollector(::System::String* a1)
		{
			return ((::Class_0_16E4307DCC419505_803*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_GETCOLLECTOR_OFFSET))(this, a1);
		}

		::System::Void RegisterCollector(::System::String* a1, ::Class_0_16E4307DCC419505_803* a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::String*, ::Class_0_16E4307DCC419505_803*))((::PBYTE)hIl2Cpp + RPG_CLIENT_GRIDFIGHTGAMEEVENTDATA_REGISTERCOLLECTOR_OFFSET))(this, a1, a2);
		}
