...
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x188E0DA0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_HASREWARDAVAIL_OFFSET UNITYSDK_OFFSET(0x188E0FE0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_QUESTCLOSE_OFFSET UNITYSDK_OFFSET(0x188E0ED0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_QUESTFINISH_OFFSET UNITYSDK_OFFSET(0x188E0E20)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_UNLOCKMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x188E10F0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x188E11B0)
