...
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0x1AF89A70)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_HASREWARDAVAIL_OFFSET UNITYSDK_OFFSET(0x1AF89CB0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_QUESTCLOSE_OFFSET UNITYSDK_OFFSET(0x1AF89BA0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_QUESTFINISH_OFFSET UNITYSDK_OFFSET(0x1AF89AF0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_UNLOCKMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0x1AF89DC0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF89E80)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 FinalQuestID; // 0x24
