...
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_GOTOID_OFFSET UNITYSDK_OFFSET(0xC8C6650)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_HASREWARDAVAIL_OFFSET UNITYSDK_OFFSET(0xC8C6890)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_QUESTCLOSE_OFFSET UNITYSDK_OFFSET(0xC8C6780)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_QUESTFINISH_OFFSET UNITYSDK_OFFSET(0xC8C66D0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA_GET_UNLOCKMISSIONFINISH_OFFSET UNITYSDK_OFFSET(0xC8C69A0)
#define RPG_CLIENT_SILVERWOLFBASEMISSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C6A60)

namespace RPG::Client
{
	inline static constexpr unsigned int SilverWolfBaseMissionData_TypeDefinitionIndex = 63579;
