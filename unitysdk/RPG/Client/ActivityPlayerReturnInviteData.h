...
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9C42700)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x9C428C0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x9C42840)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x9C42880)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x9C42860)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_GET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x9C428A0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_INIT_OFFSET UNITYSDK_OFFSET(0x9C42640)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_BOUNDINVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x9C428D0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITATIONCODE_OFFSET UNITYSDK_OFFSET(0x9C42850)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNTMAX_OFFSET UNITYSDK_OFFSET(0x9C42890)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_INVITEDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x9C42870)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SET_ISINVITATIONCODEBOUND_OFFSET UNITYSDK_OFFSET(0x9C428B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITEEDATA_OFFSET UNITYSDK_OFFSET(0x9C427E0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA_SYNCINVITERDATA_OFFSET UNITYSDK_OFFSET(0x9C42770)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CLEARDATA_OFFSET UNITYSDK_OFFSET(0x9C426B0)
#define RPG_CLIENT_ACTIVITYPLAYERRETURNINVITEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9C428E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityPlayerReturnInviteData_TypeDefinitionIndex = 57068;
	...
	public:
		...
		::System::Boolean _IsInvitationCodeBound_k__BackingField; // 0x20
		::System::UInt32 _InvitedPlayerCountMax_k__BackingField; // 0x24
		::System::UInt32 _InvitedPlayerCount_k__BackingField; // 0x28
