...
#define RPG_CLIENT_TEAMMANAGER___C__DISPLAYCLASS21_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCA041C0)
#define RPG_CLIENT_TEAMMANAGER___C__DISPLAYCLASS21_0___CREATEMEMBERENTITY_B__0_OFFSET UNITYSDK_OFFSET(0xCA041D0)

namespace RPG::Client
{
	inline static constexpr unsigned int TeamManager___c__DisplayClass21_0_TypeDefinitionIndex = 56808;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::GameCore::GameEntity*))((::PBYTE)hIl2Cpp + RPG_CLIENT_TEAMMANAGER___C__DISPLAYCLASS21_0___CREATEMEMBERENTITY_B__0_OFFSET))(this, a1);
		}
	};
}
