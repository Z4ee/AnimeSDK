...
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x193A32A0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_GET_DRAWDATA_OFFSET UNITYSDK_OFFSET(0x193A3310)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_GET_GACHAPOOL_OFFSET UNITYSDK_OFFSET(0x193A32F0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_GET_MAXRARITY_OFFSET UNITYSDK_OFFSET(0x193A3330)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_SET_DRAWDATA_OFFSET UNITYSDK_OFFSET(0x193A3320)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_SET_GACHAPOOL_OFFSET UNITYSDK_OFFSET(0x193A3300)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_SET_MAXRARITY_OFFSET UNITYSDK_OFFSET(0x193A3340)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1939C090)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaModule_DrawInfoCache_TypeDefinitionIndex = 64363;

	class GachaModule_DrawInfoCache : public ::System::Object
	{
	public:
		::RPG::Client::GachaDrawData* _DrawData_k__BackingField; // 0x10
		::RPG::Client::BaseGachaPoolData* _GachaPool_k__BackingField; // 0x18
