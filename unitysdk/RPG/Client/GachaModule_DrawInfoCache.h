...
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_CLEAR_OFFSET UNITYSDK_OFFSET(0x9758360)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_GET_DRAWDATA_OFFSET UNITYSDK_OFFSET(0x97583D0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_GET_GACHAPOOL_OFFSET UNITYSDK_OFFSET(0x97583B0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_GET_MAXRARITY_OFFSET UNITYSDK_OFFSET(0x97583F0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_SET_DRAWDATA_OFFSET UNITYSDK_OFFSET(0x97583E0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_SET_GACHAPOOL_OFFSET UNITYSDK_OFFSET(0x97583C0)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE_SET_MAXRARITY_OFFSET UNITYSDK_OFFSET(0x9758400)
#define RPG_CLIENT_GACHAMODULE_DRAWINFOCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x9752B80)

namespace RPG::Client
{
	inline static constexpr unsigned int GachaModule_DrawInfoCache_TypeDefinitionIndex = 52211;
