...
#define RPG_CLIENT_STATEAUTOBLINK_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4D7FF0)
#define RPG_CLIENT_STATEAUTOBLINK_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4D8280)
#define RPG_CLIENT_STATEAUTOBLINK_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4D80D0)
#define RPG_CLIENT_STATEAUTOBLINK__CTOR_OFFSET UNITYSDK_OFFSET(0xA4D8330)
#define RPG_CLIENT_STATEAUTOBLINK___IFIXBASEPROXY_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0xA4D8350)
#define RPG_CLIENT_STATEAUTOBLINK___IFIXBASEPROXY_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0xA4D8370)
#define RPG_CLIENT_STATEAUTOBLINK___IFIXBASEPROXY_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA4D8360)

namespace RPG::Client
{
	inline static constexpr unsigned int StateAutoBlink_TypeDefinitionIndex = 56220;
