...
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x186725A0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18672770)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL_REFRESHANDTRYTOAST_OFFSET UNITYSDK_OFFSET(0x186731B0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL_RESET_OFFSET UNITYSDK_OFFSET(0x18672BD0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__ADDAVATAR_OFFSET UNITYSDK_OFFSET(0x186730D0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__CREATEAVATARMAP_OFFSET UNITYSDK_OFFSET(0x186733F0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18672680)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__GETADDEDAVATARS_OFFSET UNITYSDK_OFFSET(0x18673900)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__ONPLAYERSETHEROBASICTYPE_OFFSET UNITYSDK_OFFSET(0x186727F0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__TRYTOASTIFLACKEQUIP_1_OFFSET UNITYSDK_OFFSET(0x18672AD0)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__TRYTOASTIFLACKEQUIP_OFFSET UNITYSDK_OFFSET(0x18673B10)
#define RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL___ONPLAYERSETHEROBASICTYPE_G__CONVERTTOROLEID_5_0_OFFSET UNITYSDK_OFFSET(0x18672AA0)

namespace RPG::Client
{
	inline static constexpr unsigned int AvatarTeamEditLackEquipToasterViewModel_TypeDefinitionIndex = 57427;

	class AvatarTeamEditLackEquipToasterViewModel : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::RPG::AvatarSystem::IAvatar*>* _AvatarsByID; // 0x10
		::Class_0_16E4307DCC419505_641* _QueryMultiplePathConfigService; // 0x18

		::System::Void _ctor(::Class_0_16E4307DCC419505_641* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_641*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AVATARTEAMEDITLACKEQUIPTOASTERVIEWMODEL__CTOR_OFFSET))(this, a1);
		}
