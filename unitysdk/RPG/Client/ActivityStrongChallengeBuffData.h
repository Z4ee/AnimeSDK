...
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_CREATEBYID_OFFSET UNITYSDK_OFFSET(0xC687370)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0xC687190)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_GET_COST_OFFSET UNITYSDK_OFFSET(0xC6871A0)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_GET_DESCPARAMS_OFFSET UNITYSDK_OFFSET(0xC687320)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xC6872B0)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_GET_ICON_OFFSET UNITYSDK_OFFSET(0xC687260)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC6871F0)
#define RPG_CLIENT_ACTIVITYSTRONGCHALLENGEBUFFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC687420)
