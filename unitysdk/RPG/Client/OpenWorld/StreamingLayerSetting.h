...
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_22BD8D72769270B8_OFFSET UNITYSDK_OFFSET(0x9EAEB30)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_3D21ABACCE7E1D6F_OFFSET UNITYSDK_OFFSET(0x9EAEC70)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_C01E7BA2861FC0AA_OFFSET UNITYSDK_OFFSET(0x9EAEE10)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_E9A11033FF6FC2DF_OFFSET UNITYSDK_OFFSET(0x9EAEFA0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9EAF050)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int StreamingLayerSetting_TypeDefinitionIndex = 60474;
