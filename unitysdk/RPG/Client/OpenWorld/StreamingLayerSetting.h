...
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_2593F628332844CE_OFFSET UNITYSDK_OFFSET(0x191EF6A0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_28872D6E4B46BF42_OFFSET UNITYSDK_OFFSET(0x191EF870)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_BC88CEC0C10F4677_OFFSET UNITYSDK_OFFSET(0x191EF4C0)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING_METHOD_3_DB6B779165662A1C_OFFSET UNITYSDK_OFFSET(0x191EF330)
#define RPG_CLIENT_OPENWORLD_STREAMINGLAYERSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x191EF940)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int StreamingLayerSetting_TypeDefinitionIndex = 73655;
