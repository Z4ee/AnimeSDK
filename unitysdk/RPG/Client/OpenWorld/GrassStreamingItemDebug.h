...
#define RPG_CLIENT_OPENWORLD_GRASSSTREAMINGITEMDEBUG_DRAWBOUNDSGIZMO_OFFSET UNITYSDK_OFFSET(0xABF7D50)
#define RPG_CLIENT_OPENWORLD_GRASSSTREAMINGITEMDEBUG_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xABF7C00)
#define RPG_CLIENT_OPENWORLD_GRASSSTREAMINGITEMDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xABF8180)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int GrassStreamingItemDebug_TypeDefinitionIndex = 67921;
