...
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_CELLBOUND_OFFSET UNITYSDK_OFFSET(0xABF8220)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_CELLSIZE_OFFSET UNITYSDK_OFFSET(0xABF81E0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_CELLSUBDATA_OFFSET UNITYSDK_OFFSET(0xABF81A0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xABF82C0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_LIGHTVISIBILITYDATA_OFFSET UNITYSDK_OFFSET(0xABF8300)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_USECOMPRESSION_OFFSET UNITYSDK_OFFSET(0xABF8280)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_02B8FAA3BE7582C4_OFFSET UNITYSDK_OFFSET(0xABF8430)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_1C298FA6BB9350FA_OFFSET UNITYSDK_OFFSET(0xABF84E0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_1FCC3BCBD5E9F995_OFFSET UNITYSDK_OFFSET(0xABF8340)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_6E01F0CC6DB3685D_OFFSET UNITYSDK_OFFSET(0xABF86B0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_FA3756AC469A42D7_OFFSET UNITYSDK_OFFSET(0xABF90E0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_CELLBOUND_OFFSET UNITYSDK_OFFSET(0xABF8250)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_CELLSIZE_OFFSET UNITYSDK_OFFSET(0xABF8200)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_CELLSUBDATA_OFFSET UNITYSDK_OFFSET(0xABF81C0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_INDEX_OFFSET UNITYSDK_OFFSET(0xABF82E0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_LIGHTVISIBILITYDATA_OFFSET UNITYSDK_OFFSET(0xABF8320)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_USECOMPRESSION_OFFSET UNITYSDK_OFFSET(0xABF82A0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0xABF9270)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xABF9220)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int OfflineCullingCellData_TypeDefinitionIndex = 67891;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(OfflineCullingCellData_TypeDefinitionIndex)->GetStaticField(0x101F0);
		}
