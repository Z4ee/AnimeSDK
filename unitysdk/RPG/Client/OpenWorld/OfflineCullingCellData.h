...
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_CELLBOUND_OFFSET UNITYSDK_OFFSET(0x191E00B0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_CELLSIZE_OFFSET UNITYSDK_OFFSET(0x191E0070)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_CELLSUBDATA_OFFSET UNITYSDK_OFFSET(0x191E0030)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x191E0150)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_LIGHTVISIBILITYDATA_OFFSET UNITYSDK_OFFSET(0x191E0190)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_GET_USECOMPRESSION_OFFSET UNITYSDK_OFFSET(0x191E0110)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_02B8FAA3BE7582C4_OFFSET UNITYSDK_OFFSET(0x191E02C0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_1FCC3BCBD5E9F995_OFFSET UNITYSDK_OFFSET(0x191E01D0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_595E641DF1B4387D_OFFSET UNITYSDK_OFFSET(0x191E0370)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_9390D296E70A7430_OFFSET UNITYSDK_OFFSET(0x191E04C0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_METHOD_3_F8F4A6517C8F0D4E_OFFSET UNITYSDK_OFFSET(0x191E12F0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_CELLBOUND_OFFSET UNITYSDK_OFFSET(0x191E00E0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_CELLSIZE_OFFSET UNITYSDK_OFFSET(0x191E0090)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_CELLSUBDATA_OFFSET UNITYSDK_OFFSET(0x191E0050)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x191E0170)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_LIGHTVISIBILITYDATA_OFFSET UNITYSDK_OFFSET(0x191E01B0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA_SET_USECOMPRESSION_OFFSET UNITYSDK_OFFSET(0x191E0130)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x191E14B0)
#define RPG_CLIENT_OPENWORLD_OFFLINECULLINGCELLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x191E1460)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int OfflineCullingCellData_TypeDefinitionIndex = 73650;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(OfflineCullingCellData_TypeDefinitionIndex)->GetStaticField(0x10D00);
		}
