...
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_1_OFFSET UNITYSDK_OFFSET(0xC3162A0)
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_OFFSET UNITYSDK_OFFSET(0xC3153E0)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0xC317140)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0xC317120)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0xC317100)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_553318531FFFA4F6_OFFSET UNITYSDK_OFFSET(0xC315960)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0xC3168D0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_AC178E7C3533AC6E_OFFSET UNITYSDK_OFFSET(0xC315DB0)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_B5B6A4F2781B1BF6_OFFSET UNITYSDK_OFFSET(0xC315F40)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC3167C0)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC316740)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC3166B0)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0xC317150)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0xC317130)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0xC317110)
#define RPG_CLIENT_OPENWORLD_VOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xC317160)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int Volume_TypeDefinitionIndex = 69065;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_1_8F713D8ADA87F44A*>* VolumeComponents; // 0x100
		...
		::System::Void Method_6_B5B6A4F2781B1BF6(::Class_1_D70A30D666F20D90* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_D70A30D666F20D90*))((::PBYTE)hIl2Cpp + RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_B5B6A4F2781B1BF6_OFFSET))(this, a1);
		}
