...
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_1_OFFSET UNITYSDK_OFFSET(0x191F1200)
#define RPG_CLIENT_OPENWORLD_VOLUME_FROMSTAGECONFIG_OFFSET UNITYSDK_OFFSET(0x191F0200)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0x191F20A0)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0x191F2080)
#define RPG_CLIENT_OPENWORLD_VOLUME_GET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0x191F2060)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_3F16A63999F7FECF_OFFSET UNITYSDK_OFFSET(0x191F0780)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_8C3DB70FFBBF01C7_OFFSET UNITYSDK_OFFSET(0x191F1830)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_919BC32C7F31A55F_OFFSET UNITYSDK_OFFSET(0x191F0E30)
#define RPG_CLIENT_OPENWORLD_VOLUME_METHOD_6_AC178E7C3533AC6E_OFFSET UNITYSDK_OFFSET(0x191F0C90)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x191F1720)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x191F16A0)
#define RPG_CLIENT_OPENWORLD_VOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x191F1610)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGIONVOLUMEINDEX_OFFSET UNITYSDK_OFFSET(0x191F20B0)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_ATTACHREGION_OFFSET UNITYSDK_OFFSET(0x191F2090)
#define RPG_CLIENT_OPENWORLD_VOLUME_SET_OWNERSTAGE_OFFSET UNITYSDK_OFFSET(0x191F2070)
#define RPG_CLIENT_OPENWORLD_VOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x191F20C0)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int Volume_TypeDefinitionIndex = 73883;
