...
#define RPG_CLIENT_OPENWORLD_STREAMINGLODSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x18296D60)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int StreamingLodSetting_TypeDefinitionIndex = 70353;
