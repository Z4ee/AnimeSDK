...
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_1_OFFSET UNITYSDK_OFFSET(0xDA06340)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_2_OFFSET UNITYSDK_OFFSET(0xDA06670)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_OFFSET UNITYSDK_OFFSET(0xDA062C0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_16C90E0F008EA620_OFFSET UNITYSDK_OFFSET(0xDA04EE0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_40E03D354D1ACC85_OFFSET UNITYSDK_OFFSET(0xDA05640)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_7951E2DB4B5A91D5_OFFSET UNITYSDK_OFFSET(0xDA055A0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_C97E2C3DD6E5FF49_OFFSET UNITYSDK_OFFSET(0xDA073D0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_DF0DE2420FA94983_OFFSET UNITYSDK_OFFSET(0xDA053D0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xDA06FC0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_SETREGIONVOLUME_OFFSET UNITYSDK_OFFSET(0xDA06160)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_UPDATEVOLUME_1_OFFSET UNITYSDK_OFFSET(0xDA04650)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_UPDATEVOLUME_OFFSET UNITYSDK_OFFSET(0xDA03650)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_WRITEREGIONTOSTAGEVOLUMECONFIGV2_OFFSET UNITYSDK_OFFSET(0xDA05B60)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xDA05590)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int VolumeBase_TypeDefinitionIndex = 73882;
