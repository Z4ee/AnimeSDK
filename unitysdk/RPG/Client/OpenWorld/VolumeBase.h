...
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_1_OFFSET UNITYSDK_OFFSET(0x191F2F80)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_2_OFFSET UNITYSDK_OFFSET(0x191F32B0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_CHECKBOUNDCONTAIN_OFFSET UNITYSDK_OFFSET(0x191F2F00)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_16C90E0F008EA620_OFFSET UNITYSDK_OFFSET(0x191F1B20)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_40E03D354D1ACC85_OFFSET UNITYSDK_OFFSET(0x191F2280)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_7951E2DB4B5A91D5_OFFSET UNITYSDK_OFFSET(0x191F21E0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_C97E2C3DD6E5FF49_OFFSET UNITYSDK_OFFSET(0x191F4010)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_METHOD_5_DF0DE2420FA94983_OFFSET UNITYSDK_OFFSET(0x191F2010)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x191F3C00)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_SETREGIONVOLUME_OFFSET UNITYSDK_OFFSET(0x191F2DA0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_UPDATEVOLUME_1_OFFSET UNITYSDK_OFFSET(0x191F1290)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_UPDATEVOLUME_OFFSET UNITYSDK_OFFSET(0x191F0290)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE_WRITEREGIONTOSTAGEVOLUMECONFIGV2_OFFSET UNITYSDK_OFFSET(0x191F27A0)
#define RPG_CLIENT_OPENWORLD_VOLUMEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x191F21D0)

namespace RPG::Client::OpenWorld
{
	inline static constexpr unsigned int VolumeBase_TypeDefinitionIndex = 73881;

	class VolumeBase : public ::UnityEngine::MonoBehaviour
	{
	public:
		::RPG::GameCore::StageVolumeConfigV2* HGHJHAFMFJB; // 0x18
		::System::String* LJJECANBODH; // 0x20
		::UnityEngine::Matrix4x4 HGPFBOLEACI; // 0x28
		::UnityEngine::Matrix4x4 OGDJFPCDAJL; // 0x68
		::RPG::Client::RuntimeRegionVolume* CANMGDCKKGM; // 0xA8
