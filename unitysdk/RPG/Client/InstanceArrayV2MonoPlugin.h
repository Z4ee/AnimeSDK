...
#define RPG_CLIENT_INSTANCEARRAYV2MONOPLUGIN_GET_AUTOPLAY_OFFSET UNITYSDK_OFFSET(0x16C35380)
#define RPG_CLIENT_INSTANCEARRAYV2MONOPLUGIN_METHOD_7_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x16C353E0)
#define RPG_CLIENT_INSTANCEARRAYV2MONOPLUGIN_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16C35390)
#define RPG_CLIENT_INSTANCEARRAYV2MONOPLUGIN_METHOD_7_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x16C35430)
#define RPG_CLIENT_INSTANCEARRAYV2MONOPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x16C354B0)

namespace RPG::Client
{
	inline static constexpr unsigned int InstanceArrayV2MonoPlugin_TypeDefinitionIndex = 67463;
