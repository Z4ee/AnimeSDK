...
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDENHANCEROGUEBUFFCSREQ_OFFSET UNITYSDK_OFFSET(0x1C1ACDD0)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDGETROGUEBUFFENHANCEINFOSCREQ_OFFSET UNITYSDK_OFFSET(0x1C1ACD30)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDPICKROGUEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0x1C1AC850)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD_SENDREVIVEROGUEAVATARCSREQ_OFFSET UNITYSDK_OFFSET(0x1C1AC970)
#define RPG_CLIENT_CHESSROGUESENDPACKETCMD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1ACE80)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueSendPacketCmd_TypeDefinitionIndex = 67319;
