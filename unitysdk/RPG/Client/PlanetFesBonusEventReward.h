...
#define RPG_CLIENT_PLANETFESBONUSEVENTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x9F8BA50)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesBonusEventReward_TypeDefinitionIndex = 54214;
