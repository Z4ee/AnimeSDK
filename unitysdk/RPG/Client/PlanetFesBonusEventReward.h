...
#define RPG_CLIENT_PLANETFESBONUSEVENTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3642B0)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesBonusEventReward_TypeDefinitionIndex = 66652;
