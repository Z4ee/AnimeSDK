...
#define RPG_CLIENT_PLANETFESBONUSEVENTREWARD__CTOR_OFFSET UNITYSDK_OFFSET(0xACB0110)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesBonusEventReward_TypeDefinitionIndex = 61377;
