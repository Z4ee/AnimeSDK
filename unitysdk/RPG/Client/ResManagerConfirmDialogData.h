...
#define RPG_CLIENT_RESMANAGERCONFIRMDIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC719CF0)

namespace RPG::Client
{
	inline static constexpr unsigned int ResManagerConfirmDialogData_TypeDefinitionIndex = 67938;
