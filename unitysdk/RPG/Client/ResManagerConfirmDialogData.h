...
#define RPG_CLIENT_RESMANAGERCONFIRMDIALOGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1739F5A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ResManagerConfirmDialogData_TypeDefinitionIndex = 69424;
	...
	public:
		...
		::RPG::Client::TextID CancelBtnLabel; // 0x48
