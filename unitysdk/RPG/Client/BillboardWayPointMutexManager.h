...
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FE0190)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_BOARDSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x19FE0E60)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_GLOBALSHOW_OFFSET UNITYSDK_OFFSET(0x19FE0E70)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x19FE0E90)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SETGLOBALBOARDSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x19FE0340)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SET_GLOBALSHOW_OFFSET UNITYSDK_OFFSET(0x19FE0E80)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x19FE0EA0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x19FE0260)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ADJUSTBILLBOARDINDEX_OFFSET UNITYSDK_OFFSET(0x19FE0B60)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CANBILLBOARDSHOW_OFFSET UNITYSDK_OFFSET(0x19FE03C0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CANWAYPOINTSHOW_OFFSET UNITYSDK_OFFSET(0x19FE0450)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__COMPAREBILLBOARDSBYCAMERADISTANCE_OFFSET UNITYSDK_OFFSET(0x19FE0D90)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CREATEMUTEXCONFIG_OFFSET UNITYSDK_OFFSET(0x19FE0AF0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FDFFB0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x19FE0970)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__GETENTITYMUTEXSTATUS_OFFSET UNITYSDK_OFFSET(0x19FE04F0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__NOTIFYMUTEXSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19FE07E0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ONBILLBOARDVISIBLECHANGE_OFFSET UNITYSDK_OFFSET(0x19FE0910)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ONMUTEXSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19FE06F0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__SORTBILLBOARDS_OFFSET UNITYSDK_OFFSET(0x19FE0CC0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__TICKBILLBOARD_OFFSET UNITYSDK_OFFSET(0x19FE02E0)

namespace RPG::Client
{
	inline static constexpr unsigned int BillboardWayPointMutexManager_TypeDefinitionIndex = 57778;
