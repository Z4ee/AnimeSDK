...
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC95C5B0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_BOARDSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xC95D280)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_GLOBALSHOW_OFFSET UNITYSDK_OFFSET(0xC95D290)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xC95D2B0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SETGLOBALBOARDSHOWTYPE_OFFSET UNITYSDK_OFFSET(0xC95C760)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SET_GLOBALSHOW_OFFSET UNITYSDK_OFFSET(0xC95D2A0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_SET_VISIBLE_OFFSET UNITYSDK_OFFSET(0xC95D2C0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0xC95C680)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ADJUSTBILLBOARDINDEX_OFFSET UNITYSDK_OFFSET(0xC95CF80)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CANBILLBOARDSHOW_OFFSET UNITYSDK_OFFSET(0xC95C7E0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CANWAYPOINTSHOW_OFFSET UNITYSDK_OFFSET(0xC95C870)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__COMPAREBILLBOARDSBYCAMERADISTANCE_OFFSET UNITYSDK_OFFSET(0xC95D1B0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CREATEMUTEXCONFIG_OFFSET UNITYSDK_OFFSET(0xC95CF10)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xC95C3D0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__GETENTITYBYRUNTIMEID_OFFSET UNITYSDK_OFFSET(0xC95CD90)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__GETENTITYMUTEXSTATUS_OFFSET UNITYSDK_OFFSET(0xC95C910)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__NOTIFYMUTEXSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xC95CC00)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ONBILLBOARDVISIBLECHANGE_OFFSET UNITYSDK_OFFSET(0xC95CD30)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__ONMUTEXSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xC95CB10)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__SORTBILLBOARDS_OFFSET UNITYSDK_OFFSET(0xC95D0E0)
#define RPG_CLIENT_BILLBOARDWAYPOINTMUTEXMANAGER__TICKBILLBOARD_OFFSET UNITYSDK_OFFSET(0xC95C700)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Collections::Generic::List_1<::RPG::Client::UIBillboard*>* ActiveBillboards; // 0x18
		...
		::System::Boolean _Visible_k__BackingField; // 0x3C
		::System::Boolean _GlobalShow_k__BackingField; // 0x3D
