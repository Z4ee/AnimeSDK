...
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ELATIONACTIVITY_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9E79CB0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ELATIONACTIVITY_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E79DB0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ELATIONACTIVITY_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9E79E10)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ELATIONACTIVITY_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9E79DC0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ELATIONACTIVITY_D__40_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9E79CA0)
#define RPG_CLIENT_BATTLERESULTPROCESS___RP_ELATIONACTIVITY_D__40__CTOR_OFFSET UNITYSDK_OFFSET(0x9E76EF0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess___RP_ElationActivity_d__40_TypeDefinitionIndex = 56264;
