...
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_CHECKISLOCKED_OFFSET UNITYSDK_OFFSET(0x8ED1C60)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_CHECKUNLOCKCONDITION_OFFSET UNITYSDK_OFFSET(0x8ED1D30)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x8ED14D0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_ACTIVITYMODULEID_OFFSET UNITYSDK_OFFSET(0x8ED1FE0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_BEGINTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x8ED2060)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_COMPLETEDPROGRESS_OFFSET UNITYSDK_OFFSET(0x8ED22F0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_ENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x8ED20E0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0x8ED2160)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_ISNEW_OFFSET UNITYSDK_OFFSET(0x8ED22D0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8ED21E0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_QUESTIDLIST_OFFSET UNITYSDK_OFFSET(0x8ED1BE0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x8ED2170)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x8ED23F0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x8ED1980)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_TOTALPROGRESS_OFFSET UNITYSDK_OFFSET(0x8ED2310)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_GET_TYPEGOURPID_OFFSET UNITYSDK_OFFSET(0x8ED2370)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_ISHAVINGCANTAKEREWARDQUEST_OFFSET UNITYSDK_OFFSET(0x8ED1AC0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_ISINSCHEDULE_OFFSET UNITYSDK_OFFSET(0x8ED1DC0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_SETSEEN_OFFSET UNITYSDK_OFFSET(0x8ED17C0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_SET_COMPLETEDPROGRESS_OFFSET UNITYSDK_OFFSET(0x8ED2300)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_SET_ISNEW_OFFSET UNITYSDK_OFFSET(0x8ED22E0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_SET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x8ED2400)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_UPDATETIMESTAMP_OFFSET UNITYSDK_OFFSET(0x8ED1A60)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA_UPDATE_OFFSET UNITYSDK_OFFSET(0x8ED1550)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8ED1540)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA__UPDATECOMPLETEDPROGRESS_OFFSET UNITYSDK_OFFSET(0x8ED15A0)
#define RPG_CLIENT_ACTIVITYAETHERDIVIDEDATA__UPDATEISNEW_OFFSET UNITYSDK_OFFSET(0x8ED16E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ActivityAetherDivideData_TypeDefinitionIndex = 49788;
	...
	public:
		...
		::System::UInt32 _BeginTimeStamp; // 0x24
		::System::UInt32 UnlockID; // 0x28
		::System::UInt32 _CompletedProgress_k__BackingField; // 0x2C
