...
#define RPG_CLIENT_PRERELEASECHARAPARAM_SCHEDULEINFO_GET_SCHEDULEDATA_OFFSET UNITYSDK_OFFSET(0x141150)

namespace RPG::Client
{
	inline static constexpr unsigned int PreReleaseCharaParam_ScheduleInfo_TypeDefinitionIndex = 61377;
