...
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1C96BE30)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1C96BC50)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1C96BCA0)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_SHORTDESC_OFFSET UNITYSDK_OFFSET(0x1C96BD80)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_SKILLTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x1C96BD10)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1C96BC10)
