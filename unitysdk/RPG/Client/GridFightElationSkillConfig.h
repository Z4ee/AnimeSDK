...
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_DESC_OFFSET UNITYSDK_OFFSET(0x1A63F940)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1A63F760)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_NAMETEXTID_OFFSET UNITYSDK_OFFSET(0x1A63F7B0)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_SHORTDESC_OFFSET UNITYSDK_OFFSET(0x1A63F890)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG_GET_SKILLTYPETEXTID_OFFSET UNITYSDK_OFFSET(0x1A63F820)
#define RPG_CLIENT_GRIDFIGHTELATIONSKILLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63F720)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightElationSkillConfig_TypeDefinitionIndex = 62450;
