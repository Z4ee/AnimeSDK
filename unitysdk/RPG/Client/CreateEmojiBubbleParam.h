...
#define RPG_CLIENT_CREATEEMOJIBUBBLEPARAM_CREATEEMOJIICONINFOS_OFFSET UNITYSDK_OFFSET(0xB7145E0)
#define RPG_CLIENT_CREATEEMOJIBUBBLEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB7145D0)
...
namespace RPG::Client
{
	...
	public:
		...
		::System::Boolean UseDummyPosition; // 0x30
		::System::Boolean IsFromOnlineChat; // 0x31
		::System::Boolean IsVertical; // 0x32
