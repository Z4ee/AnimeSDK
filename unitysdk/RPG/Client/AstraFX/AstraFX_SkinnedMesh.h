...
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_AFTERCREATERESOURCES_OFFSET UNITYSDK_OFFSET(0x19B3ACD0)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_AFTEREXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x19B3AD50)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_BEFOREEXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x19B3AD10)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_RESETSIMULATIONSTATE_OFFSET UNITYSDK_OFFSET(0x19B39F70)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3AD90)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFX_SkinnedMesh_TypeDefinitionIndex = 70283;
