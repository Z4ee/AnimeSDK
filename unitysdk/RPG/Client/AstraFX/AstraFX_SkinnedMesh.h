...
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_AFTERCREATERESOURCES_OFFSET UNITYSDK_OFFSET(0xC788130)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_AFTEREXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0xC7881B0)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_BEFOREEXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0xC788170)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_RESETSIMULATIONSTATE_OFFSET UNITYSDK_OFFSET(0xC7873D0)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xC7881F0)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFX_SkinnedMesh_TypeDefinitionIndex = 73584;
