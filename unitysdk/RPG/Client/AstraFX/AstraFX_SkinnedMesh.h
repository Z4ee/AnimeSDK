...
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_AFTERCREATERESOURCES_OFFSET UNITYSDK_OFFSET(0x1B338CA0)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_AFTEREXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x1B338D20)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_BEFOREEXECUTEPASSES_OFFSET UNITYSDK_OFFSET(0x1B338CE0)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_RESETSIMULATIONSTATE_OFFSET UNITYSDK_OFFSET(0x1B337F40)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B338D60)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFX_SkinnedMesh_TypeDefinitionIndex = 73583;
