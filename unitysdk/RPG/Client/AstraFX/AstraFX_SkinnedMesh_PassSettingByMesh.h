...
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH_GET_THREADGROUPSEXPLANATION_OFFSET UNITYSDK_OFFSET(0xB336090)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH_GET_VALID_OFFSET UNITYSDK_OFFSET(0xB336020)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xB3363A0)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFX_SkinnedMesh_PassSettingByMesh_TypeDefinitionIndex = 68786;
