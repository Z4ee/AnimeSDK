...
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH_GET_THREADGROUPSEXPLANATION_OFFSET UNITYSDK_OFFSET(0x90E4200)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH_GET_VALID_OFFSET UNITYSDK_OFFSET(0x90E4190)
#define RPG_CLIENT_ASTRAFX_ASTRAFX_SKINNEDMESH_PASSSETTINGBYMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x90E4560)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFX_SkinnedMesh_PassSettingByMesh_TypeDefinitionIndex = 60407;
