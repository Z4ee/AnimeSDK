...
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x9D410F0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x9D411C0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x9D414E0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D416D0)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFXDataManager_TypeDefinitionIndex = 67817;
	...
	public:
		...
		{
			return (::RPG::Client::AstraFX::AstraFXDataManager**)Il2CppClass::FromTypeDefinitionIndex(AstraFXDataManager_TypeDefinitionIndex)->GetStaticField(0x30860);
		}
