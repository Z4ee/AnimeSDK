...
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_GET_ISPROVIDER_OFFSET UNITYSDK_OFFSET(0x90E2880)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_GET_ISRECEIVER_OFFSET UNITYSDK_OFFSET(0x90E2890)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x90E28A0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_METHOD_7_6F5BAC0D28CE0D38_OFFSET UNITYSDK_OFFSET(0x90E2780)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_METHOD_7_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x90E25A0)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE_METHOD_7_A6CE5DAA2387E1E2_OFFSET UNITYSDK_OFFSET(0x90E2650)
#define RPG_CLIENT_ASTRAFX_ASTRAFXDATANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x90E29F0)

namespace RPG::Client::AstraFX
{
	inline static constexpr unsigned int AstraFXDataNode_TypeDefinitionIndex = 60398;
