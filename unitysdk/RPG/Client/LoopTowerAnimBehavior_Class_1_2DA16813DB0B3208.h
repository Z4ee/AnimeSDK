...
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_CLASS_1_2DA16813DB0B3208_METHOD_1_4BC0DE51B4283898_OFFSET UNITYSDK_OFFSET(0x9A729C0)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_CLASS_1_2DA16813DB0B3208_METHOD_1_9B9D8886EE7C5A8A_OFFSET UNITYSDK_OFFSET(0x9A73390)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_CLASS_1_2DA16813DB0B3208_METHOD_1_DE973A2760D546FC_OFFSET UNITYSDK_OFFSET(0x9A72E60)
#define RPG_CLIENT_LOOPTOWERANIMBEHAVIOR_CLASS_1_2DA16813DB0B3208__CTOR_OFFSET UNITYSDK_OFFSET(0x9A72470)

namespace RPG::Client
{
	inline static constexpr unsigned int LoopTowerAnimBehavior_Class_1_2DA16813DB0B3208_TypeDefinitionIndex = 58088;
	...
	public:
		...
		::Class_1_469A5FF005CF3F5C* Field_1_3; // 0x18
		::RPG::Client::PipelineCameraEngine* Field_1_4; // 0x20
		::System::Single Field_1_1; // 0x28
		::RPG::Client::LoopTowerAnimBehavior_TowerDirectionType Field_1_2; // 0x2C
