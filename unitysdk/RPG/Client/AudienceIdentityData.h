...
#define RPG_CLIENT_AUDIENCEIDENTITYDATA_METHOD_1_DB5B838B087C7494_OFFSET UNITYSDK_OFFSET(0x90ED960)
#define RPG_CLIENT_AUDIENCEIDENTITYDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x90EF7D0)
#define RPG_CLIENT_AUDIENCEIDENTITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x90EF810)
#define RPG_CLIENT_AUDIENCEIDENTITYDATA___IFIXBASEPROXY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x90EF820)

namespace RPG::Client
{
	inline static constexpr unsigned int AudienceIdentityData_TypeDefinitionIndex = 56481;
