...
#define RPG_CLIENT_MONOLINERENDERERWIDTHSETTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC126730)
#define RPG_CLIENT_MONOLINERENDERERWIDTHSETTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC1265E0)
#define RPG_CLIENT_MONOLINERENDERERWIDTHSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC126810)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoLineRendererWidthSetter_TypeDefinitionIndex = 66408;
