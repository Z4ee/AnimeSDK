...
#define RPG_CLIENT_MONOLINERENDERERWIDTHSETTER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA9D8770)
#define RPG_CLIENT_MONOLINERENDERERWIDTHSETTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA9D8610)
#define RPG_CLIENT_MONOLINERENDERERWIDTHSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9D8850)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoLineRendererWidthSetter_TypeDefinitionIndex = 65478;
