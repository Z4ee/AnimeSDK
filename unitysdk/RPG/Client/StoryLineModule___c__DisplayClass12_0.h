...
#define RPG_CLIENT_STORYLINEMODULE___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC9384D0)
#define RPG_CLIENT_STORYLINEMODULE___C__DISPLAYCLASS12_0__SWITCHLINE_B__0_OFFSET UNITYSDK_OFFSET(0xC93AB60)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryLineModule___c__DisplayClass12_0_TypeDefinitionIndex = 63615;

	class StoryLineModule___c__DisplayClass12_0 : public ::System::Object
	{
	public:
		::System::UInt32 entryID; // 0x10
