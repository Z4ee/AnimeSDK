...
#define RPG_CLIENT_CRPVCBACKGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0xB4579D0)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPVCBackground_TypeDefinitionIndex = 65170;
