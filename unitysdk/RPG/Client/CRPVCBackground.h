...
#define RPG_CLIENT_CRPVCBACKGROUND__CTOR_OFFSET UNITYSDK_OFFSET(0x9EBAE20)

namespace RPG::Client
{
	inline static constexpr unsigned int CRPVCBackground_TypeDefinitionIndex = 64249;
