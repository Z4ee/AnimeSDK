...
#define RPG_CLIENT_ATTACHPOINTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B3E140)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachPointOverride_TypeDefinitionIndex = 65317;
