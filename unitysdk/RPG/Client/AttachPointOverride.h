...
#define RPG_CLIENT_ATTACHPOINTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B33C110)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachPointOverride_TypeDefinitionIndex = 68329;
