...
#define RPG_CLIENT_ATTACHPOINTOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xB339120)

namespace RPG::Client
{
	inline static constexpr unsigned int AttachPointOverride_TypeDefinitionIndex = 63946;
