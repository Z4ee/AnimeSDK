...
#define RPG_CLIENT_GPUPARTICLEOCCLUDER_OBB__CTOR_OFFSET UNITYSDK_OFFSET(0x7F260)

namespace RPG::Client
{
	inline static constexpr unsigned int GpuParticleOccluder_OBB_TypeDefinitionIndex = 57088;
