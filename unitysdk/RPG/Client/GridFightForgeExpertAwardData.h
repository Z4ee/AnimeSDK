...
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_GET_COINNUM_OFFSET UNITYSDK_OFFSET(0x1BD48C90)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_GET_ROLE_OFFSET UNITYSDK_OFFSET(0x1BD48CB0)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_SET_COINNUM_OFFSET UNITYSDK_OFFSET(0x1BD48CA0)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA_SET_ROLE_OFFSET UNITYSDK_OFFSET(0x1BD48CC0)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA__BUILDROLE_OFFSET UNITYSDK_OFFSET(0x1BD488F0)
#define RPG_CLIENT_GRIDFIGHTFORGEEXPERTAWARDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD48820)
