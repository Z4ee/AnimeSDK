...
#define RPG_CLIENT_CHOOSEDELIVERYMODULE___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBFAED0)
#define RPG_CLIENT_CHOOSEDELIVERYMODULE___C__DISPLAYCLASS20_0___ONCHOOSEDELIVERYSCRSP_B__0_OFFSET UNITYSDK_OFFSET(0x1BBFBA30)
#define RPG_CLIENT_CHOOSEDELIVERYMODULE___C__DISPLAYCLASS20_0___ONCHOOSEDELIVERYSCRSP_B__1_OFFSET UNITYSDK_OFFSET(0x1BBFBA60)

namespace RPG::Client
{
	inline static constexpr unsigned int ChooseDeliveryModule___c__DisplayClass20_0_TypeDefinitionIndex = 63586;
