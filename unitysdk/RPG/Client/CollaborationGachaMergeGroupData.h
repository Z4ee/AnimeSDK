...
#define RPG_CLIENT_COLLABORATIONGACHAMERGEGROUPDATA_GETSORTEDGACHAPOOLGROUPS_OFFSET UNITYSDK_OFFSET(0xCC4CB70)
#define RPG_CLIENT_COLLABORATIONGACHAMERGEGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC4CAF0)
