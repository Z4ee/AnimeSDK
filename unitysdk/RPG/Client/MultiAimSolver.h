...
#define RPG_CLIENT_MULTIAIMSOLVER_GET_AIMERCOUNT_OFFSET UNITYSDK_OFFSET(0x9D99E40)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_106B26BE164E4FCD_OFFSET UNITYSDK_OFFSET(0x9D9AD60)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_11923540E96E60E4_OFFSET UNITYSDK_OFFSET(0x9D9B700)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_262E11E993897B67_OFFSET UNITYSDK_OFFSET(0x9D9A950)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_412B37D6127486C3_OFFSET UNITYSDK_OFFSET(0x9D9B650)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_4855D279E0E27DA8_OFFSET UNITYSDK_OFFSET(0x9D9B920)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_4C7D121ED22BD1D1_OFFSET UNITYSDK_OFFSET(0x9D9B860)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_A17B38030E623502_OFFSET UNITYSDK_OFFSET(0x9D9B5D0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_A5FE044F664519B0_OFFSET UNITYSDK_OFFSET(0x9D9B3D0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_B05CCFBE7A977EDF_OFFSET UNITYSDK_OFFSET(0x9D9BCE0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_BA1BB49741CFDFE1_OFFSET UNITYSDK_OFFSET(0x9D99E90)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_BA287C3724AB3014_OFFSET UNITYSDK_OFFSET(0x9D9D0F0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0x9D9D070)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_D98D4F0F1165F6B5_OFFSET UNITYSDK_OFFSET(0x9D9A7E0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_EABBE399EFB12E42_OFFSET UNITYSDK_OFFSET(0x9D9A430)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_F7BA13C72A6B3F58_OFFSET UNITYSDK_OFFSET(0x9D9A4E0)
#define RPG_CLIENT_MULTIAIMSOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D9D370)
#define RPG_CLIENT_MULTIAIMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D9D310)

namespace RPG::Client
{
	inline static constexpr unsigned int MultiAimSolver_TypeDefinitionIndex = 55923;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(MultiAimSolver_TypeDefinitionIndex)->GetStaticField(0x44150);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet__BoneIdxAndDepth()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MultiAimSolver_TypeDefinitionIndex)->GetStaticField(0x44158);
		}
		...
		::System::Void Method_1_B05CCFBE7A977EDF(::RootMotion::IKJob::IKThreadProxyContext* a1, ::Struct_2_54B2BF9C4C8BC07C& a2)
		{
			return ((::System::Void(*)(::PVOID, ::RootMotion::IKJob::IKThreadProxyContext*, ::Struct_2_54B2BF9C4C8BC07C&))((::PBYTE)hIl2Cpp + RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_B05CCFBE7A977EDF_OFFSET))(this, a1, a2);
		}
