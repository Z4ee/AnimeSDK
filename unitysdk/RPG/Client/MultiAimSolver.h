...
#define RPG_CLIENT_MULTIAIMSOLVER_GET_AIMERCOUNT_OFFSET UNITYSDK_OFFSET(0xC1AF0E0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_11923540E96E60E4_OFFSET UNITYSDK_OFFSET(0xC1B0A50)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_323EC9261331AA3B_OFFSET UNITYSDK_OFFSET(0xC1B0080)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_412B37D6127486C3_OFFSET UNITYSDK_OFFSET(0xC1B09B0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_4C7D121ED22BD1D1_OFFSET UNITYSDK_OFFSET(0xC1B0B70)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0xC1AF840)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_98710A5E8A56A8E3_OFFSET UNITYSDK_OFFSET(0xC1AF130)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_A17B38030E623502_OFFSET UNITYSDK_OFFSET(0xC1B0930)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_A5FE044F664519B0_OFFSET UNITYSDK_OFFSET(0xC1B0740)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_B05CCFBE7A977EDF_OFFSET UNITYSDK_OFFSET(0xC1B11D0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_BA287C3724AB3014_OFFSET UNITYSDK_OFFSET(0xC1B22B0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_C50A2293958CA940_OFFSET UNITYSDK_OFFSET(0xC1B2230)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_D98D4F0F1165F6B5_OFFSET UNITYSDK_OFFSET(0xC1AFAE0)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_DBF11F8CA09BDDA0_OFFSET UNITYSDK_OFFSET(0xC1AFC50)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_EABBE399EFB12E42_OFFSET UNITYSDK_OFFSET(0xC1AF790)
#define RPG_CLIENT_MULTIAIMSOLVER_METHOD_1_F5AA1E120098469D_OFFSET UNITYSDK_OFFSET(0xC1B0C30)
#define RPG_CLIENT_MULTIAIMSOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC1B2510)
#define RPG_CLIENT_MULTIAIMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1B24B0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Quaternion>**)Il2CppClass::FromTypeDefinitionIndex(MultiAimSolver_TypeDefinitionIndex)->GetStaticField(0x65790);
		}
		static ::System::Collections::Generic::List_1<::System::Int32>** StaticGet__BoneIdxAndDepth()
		{
			return (::System::Collections::Generic::List_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MultiAimSolver_TypeDefinitionIndex)->GetStaticField(0x65798);
		}
