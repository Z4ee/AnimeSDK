...
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_DESTROYMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xC718EF0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_DESTROYRENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xC718E20)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_DISABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0xC719260)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0xC719140)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETCACHEDMATERIALSREADONLY_OFFSET UNITYSDK_OFFSET(0xC719010)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETCACHEDMATERIALS_OFFSET UNITYSDK_OFFSET(0xC718F50)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETCACHEDORIGINMATERIALS_OFFSET UNITYSDK_OFFSET(0xC7190C0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0xC718E80)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETRENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xC718DB0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_GETSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0xC719410)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_ISEMPTYDEFAULT_OFFSET UNITYSDK_OFFSET(0xC717CC0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_REMOVEKEYWORDCACHE_OFFSET UNITYSDK_OFFSET(0xC7191F0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_RETURNSHAREDMATERIALS_OFFSET UNITYSDK_OFFSET(0xC7194E0)
#define RPG_CLIENT_RENDERERMATERIALCACHEMANAGEREXT_SETMATKEYWORD_OFFSET UNITYSDK_OFFSET(0xC719310)

namespace RPG::Client
{
	inline static constexpr unsigned int RendererMaterialCacheManagerExt_TypeDefinitionIndex = 65289;
