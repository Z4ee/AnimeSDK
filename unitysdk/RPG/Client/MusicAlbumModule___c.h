...
#define RPG_CLIENT_MUSICALBUMMODULE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B717340)
#define RPG_CLIENT_MUSICALBUMMODULE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B717380)
#define RPG_CLIENT_MUSICALBUMMODULE___C__GETUNLOCKMUSICALBUMGROUPDATAS_B__11_0_OFFSET UNITYSDK_OFFSET(0x1B717390)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::MusicAlbumModule___c**)Il2CppClass::FromTypeDefinitionIndex(MusicAlbumModule___c_TypeDefinitionIndex)->GetStaticField(0x294F0);
		}
		static ::System::Comparison_1<::RPG::Client::MusicAlbumGroupData*>** StaticGet___9__11_0()
		{
			return (::System::Comparison_1<::RPG::Client::MusicAlbumGroupData*>**)Il2CppClass::FromTypeDefinitionIndex(MusicAlbumModule___c_TypeDefinitionIndex)->GetStaticField(0x294F8);
		}
