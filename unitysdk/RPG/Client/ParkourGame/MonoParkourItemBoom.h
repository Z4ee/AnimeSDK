...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMBOOM_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xDA293F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMBOOM_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xDA29370)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMBOOM__CTOR_OFFSET UNITYSDK_OFFSET(0xDA29400)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemBoom_TypeDefinitionIndex = 74043;
