...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x9ECBC60)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBBE0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9ECBC70)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE___IFIXBASEPROXY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBC80)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemObstacle_TypeDefinitionIndex = 60800;
