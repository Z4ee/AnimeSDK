...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xDA294B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xDA29430)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0xDA294C0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemObstacle_TypeDefinitionIndex = 74044;
