...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1A2E66F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A2E6670)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E6700)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemObstacle_TypeDefinitionIndex = 70744;
