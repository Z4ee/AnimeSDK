...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A2E6960)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A2E6EB0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A2E6E10)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1A2E71D0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A2E7010)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A2E7180)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_REGISTEREVENTS_OFFSET UNITYSDK_OFFSET(0x1A2E68E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_SPAWNED_OFFSET UNITYSDK_OFFSET(0x1A2E6E60)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2E6F90)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7410)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E7350)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__ENABLEDRAGHINT_OFFSET UNITYSDK_OFFSET(0x1A2E7240)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__INIT_OFFSET UNITYSDK_OFFSET(0x1A2E69B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__ONPOINTERUPCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A2E6F10)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__SETUPSTATE_OFFSET UNITYSDK_OFFSET(0x1A2E7080)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURJOYSTICKPROVIDER__UPDATEPRESSDRAGHINTVIEW_OFFSET UNITYSDK_OFFSET(0x1A2E72A0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourJoyStickProvider_TypeDefinitionIndex = 70748;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoParkourJoyStickProvider_TypeDefinitionIndex)->GetStaticField(0x13610);
		}
