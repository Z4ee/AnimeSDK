...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x9ECBD30)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBCE0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9ECBD40)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE___IFIXBASEPROXY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBD70)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemObstacleMovable_TypeDefinitionIndex = 60801;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ParkourGame::MonoParkourCharacter*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE___IFIXBASEPROXY_ONTRIGGERED_OFFSET))(this, P0);
		}
	};
}
