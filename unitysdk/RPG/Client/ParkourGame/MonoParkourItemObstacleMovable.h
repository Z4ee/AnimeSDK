...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xAC253E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAC25390)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xAC253F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMOBSTACLEMOVABLE___IFIXBASEPROXY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAC25420)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemObstacleMovable_TypeDefinitionIndex = 68250;
