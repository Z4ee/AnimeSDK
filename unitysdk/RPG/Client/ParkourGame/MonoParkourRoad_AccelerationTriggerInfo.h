...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ACCELERATIONTRIGGERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xC33B010)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_AccelerationTriggerInfo_TypeDefinitionIndex = 69239;
