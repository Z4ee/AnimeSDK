...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xDA28260)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVE_METHOD_5_5EA00B7C45AF82A4_OFFSET UNITYSDK_OFFSET(0xDA28300)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0xDA28730)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCurveMove_TypeDefinitionIndex = 74036;
