...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSPEEDUP_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x9ECBF00)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSPEEDUP_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBE80)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSPEEDUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9ECBF10)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSPEEDUP___IFIXBASEPROXY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBF20)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemSpeedUp_TypeDefinitionIndex = 60803;
