...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVEITEM_SETPOSANDROT_OFFSET UNITYSDK_OFFSET(0x1C4DB050)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DB110)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCurveMoveItem_TypeDefinitionIndex = 74036;
