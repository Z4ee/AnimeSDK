...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVEITEM_SETPOSANDROT_OFFSET UNITYSDK_OFFSET(0x9ECAFD0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCURVEMOVEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9ECB090)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCurveMoveItem_TypeDefinitionIndex = 60793;
