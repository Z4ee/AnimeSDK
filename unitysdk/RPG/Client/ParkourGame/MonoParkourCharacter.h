...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAC23F20)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAC23FF0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAC23FA0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC24040)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCharacter_TypeDefinitionIndex = 68239;
