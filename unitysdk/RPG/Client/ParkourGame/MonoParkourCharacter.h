...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC333CA0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC333D70)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC333D20)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURCHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC333DC0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourCharacter_TypeDefinitionIndex = 69213;
