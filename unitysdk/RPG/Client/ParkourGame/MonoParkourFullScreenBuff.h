...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_METHOD_5_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0xDA28A60)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0xDA28F30)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xDA28880)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_ONENABLE_OFFSET UNITYSDK_OFFSET(0xDA28760)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_SETUPDURATION_OFFSET UNITYSDK_OFFSET(0xDA289B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_UPDATE_OFFSET UNITYSDK_OFFSET(0xDA28E80)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xDA28FC0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourFullScreenBuff_TypeDefinitionIndex = 74040;
