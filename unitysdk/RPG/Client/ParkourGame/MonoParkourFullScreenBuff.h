...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_METHOD_5_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0x1A2E5CA0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_METHOD_5_89FADE33F34E4AE0_OFFSET UNITYSDK_OFFSET(0x1A2E6170)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A2E5AC0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A2E59A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_SETUPDURATION_OFFSET UNITYSDK_OFFSET(0x1A2E5BF0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A2E60C0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURFULLSCREENBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E6200)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourFullScreenBuff_TypeDefinitionIndex = 70740;
