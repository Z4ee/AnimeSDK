...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_DEBUG_UPDATEALLSPEEDREGIONINFO_OFFSET UNITYSDK_OFFSET(0x1C4DEEE0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_47424911C5436EA2_OFFSET UNITYSDK_OFFSET(0x1C4DDB70)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_5389068FEB5B4D81_OFFSET UNITYSDK_OFFSET(0x1C4DF200)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_72D8343319FB1CDB_OFFSET UNITYSDK_OFFSET(0x1C4DE8E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_921B5EE2DA323FBF_OFFSET UNITYSDK_OFFSET(0x1C4E1ED0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_97013D7C4AA8CA8B_OFFSET UNITYSDK_OFFSET(0x1C4DE770)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0x1C4E2130)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_CF9A8F549904EB45_OFFSET UNITYSDK_OFFSET(0x1C4E1890)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_D87B4D4B0BD2A856_OFFSET UNITYSDK_OFFSET(0x1C4E0220)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1C4DD2F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEENDPOINTPYNEXTCONNECTIONSTART_OFFSET UNITYSDK_OFFSET(0x1C4E0110)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEGENERATE_OFFSET UNITYSDK_OFFSET(0x1C4E10A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATENEXTCONNECTIONSTARTPOINT_OFFSET UNITYSDK_OFFSET(0x1C4DF040)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4E22B0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_TypeDefinitionIndex = 74055;
