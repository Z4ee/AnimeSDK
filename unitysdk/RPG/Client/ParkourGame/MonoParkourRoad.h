...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_DEBUG_UPDATEALLSPEEDREGIONINFO_OFFSET UNITYSDK_OFFSET(0xC338210)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_61D63D85BCB76B0E_OFFSET UNITYSDK_OFFSET(0xC338530)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_72D8343319FB1CDB_OFFSET UNITYSDK_OFFSET(0xC337C90)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_853E3C989ACA913F_OFFSET UNITYSDK_OFFSET(0xC3370A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_921B5EE2DA323FBF_OFFSET UNITYSDK_OFFSET(0xC33AC20)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0xC33AE80)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_EBA1FCD99A55B4C2_OFFSET UNITYSDK_OFFSET(0xC337B90)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_F908AFB307A0D324_OFFSET UNITYSDK_OFFSET(0xC3392D0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_FC9369A30C0BC9DC_OFFSET UNITYSDK_OFFSET(0xC33A700)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xC336730)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEENDPOINTPYNEXTCONNECTIONSTART_OFFSET UNITYSDK_OFFSET(0xC3391C0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEGENERATE_OFFSET UNITYSDK_OFFSET(0xC339F10)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATENEXTCONNECTIONSTARTPOINT_OFFSET UNITYSDK_OFFSET(0xC338370)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xC33B000)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_TypeDefinitionIndex = 69235;
