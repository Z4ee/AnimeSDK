...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_DEBUG_UPDATEALLSPEEDREGIONINFO_OFFSET UNITYSDK_OFFSET(0xAC28420)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_61D63D85BCB76B0E_OFFSET UNITYSDK_OFFSET(0xAC28790)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_72D8343319FB1CDB_OFFSET UNITYSDK_OFFSET(0xAC27EA0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_853E3C989ACA913F_OFFSET UNITYSDK_OFFSET(0xAC272B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_921B5EE2DA323FBF_OFFSET UNITYSDK_OFFSET(0xAC2AF80)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_CA9AD3D703CC4954_OFFSET UNITYSDK_OFFSET(0xAC2B1F0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_EBA1FCD99A55B4C2_OFFSET UNITYSDK_OFFSET(0xAC27DA0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_F908AFB307A0D324_OFFSET UNITYSDK_OFFSET(0xAC29560)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_METHOD_5_FC9369A30C0BC9DC_OFFSET UNITYSDK_OFFSET(0xAC2AA90)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xAC268E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEENDPOINTPYNEXTCONNECTIONSTART_OFFSET UNITYSDK_OFFSET(0xAC29450)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATEGENERATE_OFFSET UNITYSDK_OFFSET(0xAC2A1C0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD_UPDATENEXTCONNECTIONSTARTPOINT_OFFSET UNITYSDK_OFFSET(0xAC285A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURROAD__CTOR_OFFSET UNITYSDK_OFFSET(0xAC2B3A0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourRoad_TypeDefinitionIndex = 68261;
