...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xAC254B0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAC25430)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0xAC254C0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY___IFIXBASEPROXY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xAC254D0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemSkillEnergy_TypeDefinitionIndex = 68251;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::ParkourGame::MonoParkourCharacter*))((::PBYTE)hIl2Cpp + RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY___IFIXBASEPROXY_ONTRIGGERED_OFFSET))(this, P0);
		}
	};
}
