...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x9ECBE00)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBD80)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x9ECBE10)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY___IFIXBASEPROXY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x9ECBE20)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemSkillEnergy_TypeDefinitionIndex = 60802;
