...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0xDA295E0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0xDA29560)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0xDA295F0)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemSkillEnergy_TypeDefinitionIndex = 74046;
