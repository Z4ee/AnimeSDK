...
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_GET_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x1A2E6820)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY_ONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A2E67A0)
#define RPG_CLIENT_PARKOURGAME_MONOPARKOURITEMSKILLENERGY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2E6830)

namespace RPG::Client::ParkourGame
{
	inline static constexpr unsigned int MonoParkourItemSkillEnergy_TypeDefinitionIndex = 70746;
