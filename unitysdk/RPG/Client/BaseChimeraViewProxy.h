...
#define RPG_CLIENT_BASECHIMERAVIEWPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18684BD0)
#define RPG_CLIENT_BASECHIMERAVIEWPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x18684D10)

namespace RPG::Client
{
	inline static constexpr unsigned int BaseChimeraViewProxy_TypeDefinitionIndex = 65599;
