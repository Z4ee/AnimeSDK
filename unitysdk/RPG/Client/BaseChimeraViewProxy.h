...
#define RPG_CLIENT_BASECHIMERAVIEWPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC8C1350)
#define RPG_CLIENT_BASECHIMERAVIEWPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xC8C1490)
