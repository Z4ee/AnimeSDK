...
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_GET_ACTIONNAME_OFFSET UNITYSDK_OFFSET(0x1B889AC0)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_GET_ACTIONTOKEN_OFFSET UNITYSDK_OFFSET(0x1B889A80)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1B889AA0)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_GET_ROUTEID_OFFSET UNITYSDK_OFFSET(0x1B889A60)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_SET_ACTIONTOKEN_OFFSET UNITYSDK_OFFSET(0x1B889A90)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x1B889AB0)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH_SET_ROUTEID_OFFSET UNITYSDK_OFFSET(0x1B889A70)
#define RPG_CLIENT_EXPEDITIONBATTLEACTIONDISPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B889BA0)
