...
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0x116C3D10)
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0x116C3DF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0x116C3C80)
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0x116C3EB0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0x116C3F40)
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0x116C3BF0)
#define RPG_CLIENT_MONOEFFECTPLUGINCHILDNODEFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x116C3F50)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginChildNodeFollow_TypeDefinitionIndex = 70015;
	...
	public:
		...
		::Class_2_0FB6F5068D635FD7_2* KADDKEGNCHE; // 0x38
