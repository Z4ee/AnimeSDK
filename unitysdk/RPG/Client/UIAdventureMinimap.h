...
#define RPG_CLIENT_UIADVENTUREMINIMAP_ADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0x17005770)
#define RPG_CLIENT_UIADVENTUREMINIMAP_AWAKE_OFFSET UNITYSDK_OFFSET(0x16FFBF00)
#define RPG_CLIENT_UIADVENTUREMINIMAP_GETSUBNAVMAPDATA_OFFSET UNITYSDK_OFFSET(0x1700D5F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP_GET__ISPLAYERINHIDEAREA_OFFSET UNITYSDK_OFFSET(0x17005DB0)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ISUSEFIVEDIMCOMPLETEICON_OFFSET UNITYSDK_OFFSET(0x1700D520)
#define RPG_CLIENT_UIADVENTUREMINIMAP_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16FFDA40)
#define RPG_CLIENT_UIADVENTUREMINIMAP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16FFD530)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ACTIVEICON_OFFSET UNITYSDK_OFFSET(0x17009D90)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ACTIVETRACKINGEFFECT_OFFSET UNITYSDK_OFFSET(0x1700A610)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0x16FFC340)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CALC2DROTATION_1_OFFSET UNITYSDK_OFFSET(0x17007810)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CALC2DROTATION_OFFSET UNITYSDK_OFFSET(0x16FFE510)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CALCPLAYERPOS_OFFSET UNITYSDK_OFFSET(0x16FFE7F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1700D910)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKISSHOWCHESTICONICONBYSUBMAP_OFFSET UNITYSDK_OFFSET(0x1700CB90)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKISSHOWPLAYERICONBYSUBMAP_OFFSET UNITYSDK_OFFSET(0x1700D4D0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKISSHOWTRACEMAPPINGINFOICONBYSUBMAP_OFFSET UNITYSDK_OFFSET(0x1700C8F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKISSHOWTRACEMISSIONICONBYSUBMAP_OFFSET UNITYSDK_OFFSET(0x1700C0F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKISSHOWTRANSPORTICONBYSUBMAP_OFFSET UNITYSDK_OFFSET(0x1700A8F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKMINIMAPSECTIONVISIBLE_OFFSET UNITYSDK_OFFSET(0x170072F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CHECKNEEDCHANGE2DMAP_OFFSET UNITYSDK_OFFSET(0x17006340)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CLEARSECTIONS_OFFSET UNITYSDK_OFFSET(0x17006EE0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CLIPICON_OFFSET UNITYSDK_OFFSET(0x17007EB0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CREATECIRCLE_OFFSET UNITYSDK_OFFSET(0x170095A0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CREATESECTIONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170073D0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1700D6B0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__DEACTIVEICON_OFFSET UNITYSDK_OFFSET(0x1700A4A0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__DESTROYINSTANCEDLAYER_OFFSET UNITYSDK_OFFSET(0x17006430)
#define RPG_CLIENT_UIADVENTUREMINIMAP__DESTROYLAYER_OFFSET UNITYSDK_OFFSET(0x170065A0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__FILLSECTIONANIMIMAGEIDX_OFFSET UNITYSDK_OFFSET(0x170078B0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__FINDZONEINSTANCE_OFFSET UNITYSDK_OFFSET(0x17007090)
#define RPG_CLIENT_UIADVENTUREMINIMAP__GETNAVIICONPATH_OFFSET UNITYSDK_OFFSET(0x1700AD60)
#define RPG_CLIENT_UIADVENTUREMINIMAP__INIT_OFFSET UNITYSDK_OFFSET(0x16FFC860)
#define RPG_CLIENT_UIADVENTUREMINIMAP__INSTANTIATEZONE_OFFSET UNITYSDK_OFFSET(0x17006780)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ISINVIEWABLESECTIONS_OFFSET UNITYSDK_OFFSET(0x170079B0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ISSECTIONVISIBLEINROGUE_OFFSET UNITYSDK_OFFSET(0x17007260)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ISSHOWMAINMAP_OFFSET UNITYSDK_OFFSET(0x17006E80)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ISTRACKINGCIRCLESHOWBYAREA_OFFSET UNITYSDK_OFFSET(0x17007BA0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ISUSETILETYPEICON_OFFSET UNITYSDK_OFFSET(0x1700BAE0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__LOADICONIMAGE_OFFSET UNITYSDK_OFFSET(0x17009E10)
#define RPG_CLIENT_UIADVENTUREMINIMAP__NEXTICON_OFFSET UNITYSDK_OFFSET(0x17009830)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONADVENTUREPHASEENTERED_OFFSET UNITYSDK_OFFSET(0x170059E0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONASYNCLOADSPRITE_OFFSET UNITYSDK_OFFSET(0x1700BB50)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONENTERNEXTROGUEROOM_OFFSET UNITYSDK_OFFSET(0x170062D0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONMAPENTER3DAREA_OFFSET UNITYSDK_OFFSET(0x170056D0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONMAPEXIT3DAREA_OFFSET UNITYSDK_OFFSET(0x17005720)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONMAZEMAPINFOUPDATED_OFFSET UNITYSDK_OFFSET(0x17005A30)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONMINIMAPSECTIONFSVCHANGE_OFFSET UNITYSDK_OFFSET(0x17005990)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONREFRESHALLSBUMAPICONNAVIICONS_OFFSET UNITYSDK_OFFSET(0x1700BF60)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONSECTIONUNLOCK_OFFSET UNITYSDK_OFFSET(0x170057C0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONTEAMLEADERENTITYCHANGED_OFFSET UNITYSDK_OFFSET(0x1700BEC0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__ONUISWITCHHANDGAMEGESTURECHANGED_OFFSET UNITYSDK_OFFSET(0x1700BE20)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHALLSBUMAPICONNAVIICONS_OFFSET UNITYSDK_OFFSET(0x17005A80)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHICONS_OFFSET UNITYSDK_OFFSET(0x170007F0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHLAYER_OFFSET UNITYSDK_OFFSET(0x16FFEA60)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHLIMITAREA_OFFSET UNITYSDK_OFFSET(0x17005110)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHNAVIICONS_OFFSET UNITYSDK_OFFSET(0x1700AE60)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHPLAYERPANEL_OFFSET UNITYSDK_OFFSET(0x17006260)
#define RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHSECTIONS_OFFSET UNITYSDK_OFFSET(0x16FFF150)
#define RPG_CLIENT_UIADVENTUREMINIMAP__RESETSECTIONBOUNDS_OFFSET UNITYSDK_OFFSET(0x17005930)
#define RPG_CLIENT_UIADVENTUREMINIMAP__SETMAPROTATION_OFFSET UNITYSDK_OFFSET(0x16FFE6A0)
#define RPG_CLIENT_UIADVENTUREMINIMAP__SETUPMAPVIEW_OFFSET UNITYSDK_OFFSET(0x17005E10)
#define RPG_CLIENT_UIADVENTUREMINIMAP__TICKSECTIONANIM_OFFSET UNITYSDK_OFFSET(0x17005300)
#define RPG_CLIENT_UIADVENTUREMINIMAP__TRYGETMAZEINFO_OFFSET UNITYSDK_OFFSET(0x17005C30)
#define RPG_CLIENT_UIADVENTUREMINIMAP__TRYGETSUBMAPICON_OFFSET UNITYSDK_OFFSET(0x17008190)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureMinimap_TypeDefinitionIndex = 65984;
	...
	public:
		...
		{
			return (::RPG::Client::RPGProfilerMarker**)Il2CppClass::FromTypeDefinitionIndex(UIAdventureMinimap_TypeDefinitionIndex)->GetStaticField(0x4B630);
		}
		...
		::System::Boolean _IsTrackingCircleShowByArea(::Class_0_16E4307DCC419505_656* a1)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_656*))((::PBYTE)hIl2Cpp + RPG_CLIENT_UIADVENTUREMINIMAP__ISTRACKINGCIRCLESHOWBYAREA_OFFSET))(this, a1);
		}

		::System::Void _RefreshIcons(::System::Single a1, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_656*>* a2, ::UnityEngine::Transform* a3, ::UnityEngine::Vector3 a4, ::UnityEngine::Vector3 a5)
		{
			return ((::System::Void(*)(::PVOID, ::System::Single, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_656*>*, ::UnityEngine::Transform*, ::UnityEngine::Vector3, ::UnityEngine::Vector3))((::PBYTE)hIl2Cpp + RPG_CLIENT_UIADVENTUREMINIMAP__REFRESHICONS_OFFSET))(this, a1, a2, a3, a4, a5);
		}
		...
		::RPG::Client::UIAdventureMinimap_SubMapIcon* _TryGetSubMapIcon(::Class_0_16E4307DCC419505_656* a1)
		{
			return ((::RPG::Client::UIAdventureMinimap_SubMapIcon*(*)(::PVOID, ::Class_0_16E4307DCC419505_656*))((::PBYTE)hIl2Cpp + RPG_CLIENT_UIADVENTUREMINIMAP__TRYGETSUBMAPICON_OFFSET))(this, a1);
		}

		::System::Void _LoadIconImage(::RPG::Client::UIAdventureMinimap_Icon* a1, ::System::UInt32 a2, ::Class_0_16E4307DCC419505_656* a3)
		{
			return ((::System::Void(*)(::PVOID, ::RPG::Client::UIAdventureMinimap_Icon*, ::System::UInt32, ::Class_0_16E4307DCC419505_656*))((::PBYTE)hIl2Cpp + RPG_CLIENT_UIADVENTUREMINIMAP__LOADICONIMAGE_OFFSET))(this, a1, a2, a3);
		}
		...
		::System::Boolean _ClipIcon(::Class_0_16E4307DCC419505_656* a1, ::UnityEngine::Vector3 a2, ::System::Single a3)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_656*, ::UnityEngine::Vector3, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_UIADVENTUREMINIMAP__CLIPICON_OFFSET))(this, a1, a2, a3);
		}
