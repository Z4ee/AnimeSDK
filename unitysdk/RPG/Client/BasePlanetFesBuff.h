...
#define RPG_CLIENT_BASEPLANETFESBUFF_GET_DESC_OFFSET UNITYSDK_OFFSET(0x186918C0)
#define RPG_CLIENT_BASEPLANETFESBUFF_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x18691A20)
#define RPG_CLIENT_BASEPLANETFESBUFF_GET_ICON_OFFSET UNITYSDK_OFFSET(0x18691810)
#define RPG_CLIENT_BASEPLANETFESBUFF_GET_ID_OFFSET UNITYSDK_OFFSET(0x186917D0)
#define RPG_CLIENT_BASEPLANETFESBUFF_GET_LARGEICON_OFFSET UNITYSDK_OFFSET(0x18691970)
#define RPG_CLIENT_BASEPLANETFESBUFF_GET_SOURCE_OFFSET UNITYSDK_OFFSET(0x186917F0)
#define RPG_CLIENT_BASEPLANETFESBUFF_INITBYCONFIG_OFFSET UNITYSDK_OFFSET(0x18691AB0)
#define RPG_CLIENT_BASEPLANETFESBUFF_INITSOURCE_OFFSET UNITYSDK_OFFSET(0x18691BC0)
#define RPG_CLIENT_BASEPLANETFESBUFF_ISAVATARBUFF_OFFSET UNITYSDK_OFFSET(0x18691A70)
#define RPG_CLIENT_BASEPLANETFESBUFF_SET_ID_OFFSET UNITYSDK_OFFSET(0x186917E0)
#define RPG_CLIENT_BASEPLANETFESBUFF_SET_SOURCE_OFFSET UNITYSDK_OFFSET(0x18691800)
#define RPG_CLIENT_BASEPLANETFESBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x18691FD0)
#define RPG_CLIENT_BASEPLANETFESBUFF__GETDESC_OFFSET UNITYSDK_OFFSET(0x18691CB0)
#define RPG_CLIENT_BASEPLANETFESBUFF__GETICONPATH_OFFSET UNITYSDK_OFFSET(0x18691C10)
#define RPG_CLIENT_BASEPLANETFESBUFF__GETLARGEICONPATH_OFFSET UNITYSDK_OFFSET(0x18691C60)

namespace RPG::Client
{
	inline static constexpr unsigned int BasePlanetFesBuff_TypeDefinitionIndex = 63581;

	class BasePlanetFesBuff : public ::System::Object
	{
	public:
		::RPG::Client::PlanetFesBuffSource* _Source_k__BackingField; // 0x10
		::RPG::GameCore::PlanetFesEffectRow* _Row; // 0x18
