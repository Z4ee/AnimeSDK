...
#define RPG_CLIENT_MONOEXUICAMERA2D_INITCANVASRANGE_OFFSET UNITYSDK_OFFSET(0x9CFE4F0)
#define RPG_CLIENT_MONOEXUICAMERA2D_INIT_OFFSET UNITYSDK_OFFSET(0x9CFD760)
#define RPG_CLIENT_MONOEXUICAMERA2D_MANUALUPDATE_OFFSET UNITYSDK_OFFSET(0x9CFDB60)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEMOVE_OFFSET UNITYSDK_OFFSET(0x9CFD910)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEZOOM_OFFSET UNITYSDK_OFFSET(0x9CFD980)
#define RPG_CLIENT_MONOEXUICAMERA2D_SETLOCKPOSITIONANDZOOM_OFFSET UNITYSDK_OFFSET(0x9CFD9F0)
#define RPG_CLIENT_MONOEXUICAMERA2D__CONVERTSCALEFROMPOSZ_OFFSET UNITYSDK_OFFSET(0x9CFE540)
#define RPG_CLIENT_MONOEXUICAMERA2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9CFE620)
#define RPG_CLIENT_MONOEXUICAMERA2D__INITEXUICAMERA_OFFSET UNITYSDK_OFFSET(0x9CFD7B0)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATECONTENTRECT_OFFSET UNITYSDK_OFFSET(0x9CFDF80)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATECONTENTZOOM_OFFSET UNITYSDK_OFFSET(0x9CFE260)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATEPARAM_OFFSET UNITYSDK_OFFSET(0x9CFDC50)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATEPOSITION_OFFSET UNITYSDK_OFFSET(0x9CFDD30)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATESWIPESPEEDRATIO_OFFSET UNITYSDK_OFFSET(0x9CFE300)
#define RPG_CLIENT_MONOEXUICAMERA2D__UPDATE_OFFSET UNITYSDK_OFFSET(0x9CFDBE0)
#define RPG_CLIENT_MONOEXUICAMERA2D___IFIXBASEPROXY_INITCANVASRANGE_OFFSET UNITYSDK_OFFSET(0x9CFE7E0)
#define RPG_CLIENT_MONOEXUICAMERA2D___IFIXBASEPROXY__UPDATE_OFFSET UNITYSDK_OFFSET(0x9CFE740)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoExUICamera2D_TypeDefinitionIndex = 59827;
	...
	public:
		...
		::System::Void SetEnableMove(::System::Boolean enable)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEMOVE_OFFSET))(this, enable);
		}

		::System::Void SetEnableZoom(::System::Boolean enable)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEXUICAMERA2D_SETENABLEZOOM_OFFSET))(this, enable);
		}

		::System::Void SetLockPositionAndZoom(::System::Boolean isLock, ::UnityEngine::Vector3 targetPosition, ::System::Single targetScale)
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean, ::UnityEngine::Vector3, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEXUICAMERA2D_SETLOCKPOSITIONANDZOOM_OFFSET))(this, isLock, targetPosition, targetScale);
		}
		...
		{
			return ((::System::Single(*)(::PVOID, ::System::Single, ::System::Single, ::System::Single, ::System::Single, ::System::Single))((::PBYTE)hIl2Cpp + RPG_CLIENT_MONOEXUICAMERA2D__CONVERTSCALEFROMPOSZ_OFFSET))(this, minZ, maxZ, minScale, maxScale, z);
		}
