...
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B32C2B0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_GET_MAXSPAWNCOUNT_OFFSET UNITYSDK_OFFSET(0x1B32BDC0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_02AC375691BAA612_OFFSET UNITYSDK_OFFSET(0x1B32BA90)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_2330DA4597DE0EDD_OFFSET UNITYSDK_OFFSET(0x1B32BA40)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x1B32BC20)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_ADE9B05D0E6295A7_OFFSET UNITYSDK_OFFSET(0x1B32BB40)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_FEF062A2DC4257FF_OFFSET UNITYSDK_OFFSET(0x1B32BDD0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_FF0F49349B17A89D_OFFSET UNITYSDK_OFFSET(0x1B32BC80)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B32C310)

namespace RPG::Client
{
	inline static constexpr unsigned int ArtNPCPedestrianAssetConfig_TypeDefinitionIndex = 69192;
	...
	public:
		...
		::Class_0_16E4307DCC419505_1044* Method_3_ADE9B05D0E6295A7(::System::String* a1)
		{
			return ((::Class_0_16E4307DCC419505_1044*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_ADE9B05D0E6295A7_OFFSET))(this, a1);
		}
