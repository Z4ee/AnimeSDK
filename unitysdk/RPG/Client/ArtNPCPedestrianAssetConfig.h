...
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19B2DFC0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_GET_MAXSPAWNCOUNT_OFFSET UNITYSDK_OFFSET(0x19B2DAD0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_02AC375691BAA612_OFFSET UNITYSDK_OFFSET(0x19B2D7A0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_2330DA4597DE0EDD_OFFSET UNITYSDK_OFFSET(0x19B2D750)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x19B2D930)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_ADE9B05D0E6295A7_OFFSET UNITYSDK_OFFSET(0x19B2D850)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_FEF062A2DC4257FF_OFFSET UNITYSDK_OFFSET(0x19B2DAE0)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_FF0F49349B17A89D_OFFSET UNITYSDK_OFFSET(0x19B2D990)
#define RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B2E020)

namespace RPG::Client
{
	inline static constexpr unsigned int ArtNPCPedestrianAssetConfig_TypeDefinitionIndex = 66152;
	...
	public:
		...
		::Class_0_16E4307DCC419505_992* Method_3_ADE9B05D0E6295A7(::System::String* a1)
		{
			return ((::Class_0_16E4307DCC419505_992*(*)(::PVOID, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ARTNPCPEDESTRIANASSETCONFIG_METHOD_3_ADE9B05D0E6295A7_OFFSET))(this, a1);
		}
