...
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_CABINETICONPATH_OFFSET UNITYSDK_OFFSET(0x9FDA250)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_DIMENSIONINCREMENTSCONFIGARRAY_OFFSET UNITYSDK_OFFSET(0x9FDA500)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ID_OFFSET UNITYSDK_OFFSET(0x9FDA020)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_IPDESC_OFFSET UNITYSDK_OFFSET(0x9FDA470)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x9FDA910)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ISREWARDTAKEN_OFFSET UNITYSDK_OFFSET(0x9FDA970)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x9FDA600)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_MISSIONDESCPARAMS_OFFSET UNITYSDK_OFFSET(0x9FDA3F0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_MISSIONDESC_OFFSET UNITYSDK_OFFSET(0x9FDA360)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_QUESTDATA_OFFSET UNITYSDK_OFFSET(0x9FDA1A0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_QUESTID_OFFSET UNITYSDK_OFFSET(0x9FDA120)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_REQUIREDUNLOCKCABINETID_OFFSET UNITYSDK_OFFSET(0x9FDA0A0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_REWARDID_OFFSET UNITYSDK_OFFSET(0x9FDA580)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_ROW_OFFSET UNITYSDK_OFFSET(0x9FDA030)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_SORTPARAM_OFFSET UNITYSDK_OFFSET(0x9FD9FA0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_TITLE_OFFSET UNITYSDK_OFFSET(0x9FDA2D0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x9FD9EF0)
#define RPG_CLIENT_CHESSROGUECABINETDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9FD9E40)

namespace RPG::Client
{
	inline static constexpr unsigned int ChessRogueCabinetDataItem_TypeDefinitionIndex = 61620;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::UInt32))((::PBYTE)hIl2Cpp + RPG_CLIENT_CHESSROGUECABINETDATAITEM__CTOR_OFFSET))(this, id);
		}
