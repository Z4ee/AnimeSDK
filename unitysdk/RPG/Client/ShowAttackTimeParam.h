...
#define RPG_CLIENT_SHOWATTACKTIMEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xB16B9A0)

namespace RPG::Client
{
	inline static constexpr unsigned int ShowAttackTimeParam_TypeDefinitionIndex = 67487;
	...
	public:
		...
		::System::Boolean ShowInActionMode; // 0x21
