...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS107_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD630CE0)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS107_0__DOPLAYSTEPBONUSTEXT_B__0_OFFSET UNITYSDK_OFFSET(0xD633920)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass107_0_TypeDefinitionIndex = 65949;
