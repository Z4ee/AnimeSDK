...
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS107_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A894190)
#define RPG_CLIENT_MATCHTHREEBOARD___C__DISPLAYCLASS107_0__DOPLAYSTEPBONUSTEXT_B__0_OFFSET UNITYSDK_OFFSET(0x1A896DE0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeBoard___c__DisplayClass107_0_TypeDefinitionIndex = 62964;

	class MatchThreeBoard___c__DisplayClass107_0 : public ::System::Object
	{
	public:
		::RPG::Client::MatchThreeExtraStep* extraStep; // 0x10
