...
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_GETTARGETAVATARID_OFFSET UNITYSDK_OFFSET(0x1C35E3C0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_GET_PERCENTINCREASE_OFFSET UNITYSDK_OFFSET(0x1C35DDD0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_ISAVATARBUFF_OFFSET UNITYSDK_OFFSET(0x1C35DE10)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_ISEFFECTIVEONAVATAR_OFFSET UNITYSDK_OFFSET(0x1C35DFC0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1C35E020)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1C35E5E0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__GETDESC_OFFSET UNITYSDK_OFFSET(0x1C35E400)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__GETICONPATH_OFFSET UNITYSDK_OFFSET(0x1C35DEC0)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__GETLARGEICONPATH_OFFSET UNITYSDK_OFFSET(0x1C35DF40)
#define RPG_CLIENT_PLANETFESAVATARINCOMEBUFF__ONINITPARAM_OFFSET UNITYSDK_OFFSET(0x1C35DE50)
