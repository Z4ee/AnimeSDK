...
#define RPG_CLIENT_MONOATLASMOUTHTALK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E2AF90)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoAtlasMouthTalk_TypeDefinitionIndex = 68494;
