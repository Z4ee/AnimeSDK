...
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9D260D0)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9D260C0)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_METHOD_5_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x9D26620)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_METHOD_5_33ACA6CB2ABC73F7_1_OFFSET UNITYSDK_OFFSET(0x9D262E0)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_METHOD_5_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0x9D25700)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_METHOD_5_39590AB2089F9F4D_OFFSET UNITYSDK_OFFSET(0x9D25620)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x9D254E0)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_RPG_CLIENT_IPOOLABLECOMPONENT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9D261F0)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_RPG_CLIENT_IPOOLABLECOMPONENT_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9D261B0)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE_SETENABLE_OFFSET UNITYSDK_OFFSET(0x9D26240)
#define RPG_CLIENT_MONOPARENTTRANSFORMDECOUPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9D267B0)
