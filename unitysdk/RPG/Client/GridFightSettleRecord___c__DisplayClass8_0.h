...
#define RPG_CLIENT_GRIDFIGHTSETTLERECORD___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBBFAB40)
#define RPG_CLIENT_GRIDFIGHTSETTLERECORD___C__DISPLAYCLASS8_0__GETROLESBYID_B__0_OFFSET UNITYSDK_OFFSET(0xBBFD960)

namespace RPG::Client
{
	inline static constexpr unsigned int GridFightSettleRecord___c__DisplayClass8_0_TypeDefinitionIndex = 60980;
