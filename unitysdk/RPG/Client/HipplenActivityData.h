...
#define RPG_CLIENT_HIPPLENACTIVITYDATA_ISSHOWDAILYGOTOREDDOT_OFFSET UNITYSDK_OFFSET(0x992EF00)
#define RPG_CLIENT_HIPPLENACTIVITYDATA_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x992F2F0)
#define RPG_CLIENT_HIPPLENACTIVITYDATA_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x992F2A0)
#define RPG_CLIENT_HIPPLENACTIVITYDATA_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x992EDD0)
#define RPG_CLIENT_HIPPLENACTIVITYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x992ED60)
#define RPG_CLIENT_HIPPLENACTIVITYDATA__HASRESIDENTREWARDSTOTAKE_OFFSET UNITYSDK_OFFSET(0x992F010)
#define RPG_CLIENT_HIPPLENACTIVITYDATA___IFIXBASEPROXY_ISSHOWMAPPINGINFONEWCONTENTREDDOT_OFFSET UNITYSDK_OFFSET(0x992F410)
#define RPG_CLIENT_HIPPLENACTIVITYDATA___IFIXBASEPROXY_ISSHOWMAPPINGINFOREWARDREDDOT_OFFSET UNITYSDK_OFFSET(0x992F3A0)
#define RPG_CLIENT_HIPPLENACTIVITYDATA___IFIXBASEPROXY_ISSHOWNORMALREDDOT_OFFSET UNITYSDK_OFFSET(0x992F330)

namespace RPG::Client
{
	inline static constexpr unsigned int HipplenActivityData_TypeDefinitionIndex = 49925;
