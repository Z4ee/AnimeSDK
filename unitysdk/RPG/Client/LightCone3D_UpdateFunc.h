...
#define RPG_CLIENT_LIGHTCONE3D_UPDATEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xD43D150)
#define RPG_CLIENT_LIGHTCONE3D_UPDATEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xD43D180)
#define RPG_CLIENT_LIGHTCONE3D_UPDATEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0xD43D030)
#define RPG_CLIENT_LIGHTCONE3D_UPDATEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0xD43D0E0)

namespace RPG::Client
{
	inline static constexpr unsigned int LightCone3D_UpdateFunc_TypeDefinitionIndex = 72886;
