...
#define RPG_CLIENT_MONODANMUITEM_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xD74AFC0)
#define RPG_CLIENT_MONODANMUITEM_GETWORLDEDGE_OFFSET UNITYSDK_OFFSET(0xD74B280)
#define RPG_CLIENT_MONODANMUITEM_GETWORLDHEIGHT_OFFSET UNITYSDK_OFFSET(0xD74A290)
#define RPG_CLIENT_MONODANMUITEM_GET_ISENDED_OFFSET UNITYSDK_OFFSET(0xD749CC0)
#define RPG_CLIENT_MONODANMUITEM_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xD74ADD0)
#define RPG_CLIENT_MONODANMUITEM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xD74ADE0)
#define RPG_CLIENT_MONODANMUITEM_HASLEFTRIGHTEDGE_OFFSET UNITYSDK_OFFSET(0xD74A160)
#define RPG_CLIENT_MONODANMUITEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD74B070)
#define RPG_CLIENT_MONODANMUITEM_ONCREATE_OFFSET UNITYSDK_OFFSET(0xD74AE50)
#define RPG_CLIENT_MONODANMUITEM_SETSTARTED_OFFSET UNITYSDK_OFFSET(0xD749A00)
#define RPG_CLIENT_MONODANMUITEM_SPAWNED_OFFSET UNITYSDK_OFFSET(0xD74AF20)
#define RPG_CLIENT_MONODANMUITEM_UPDATE_OFFSET UNITYSDK_OFFSET(0xD74ADF0)
#define RPG_CLIENT_MONODANMUITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xD74B320)
