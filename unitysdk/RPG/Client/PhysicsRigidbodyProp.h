...
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1C820FE0)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_METHOD_5_4D7DB0CF65D56E84_OFFSET UNITYSDK_OFFSET(0x1C821300)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_METHOD_5_7541FB7EB0923E08_OFFSET UNITYSDK_OFFSET(0x1C821620)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1C8210C0)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_PAUSEMOVE_OFFSET UNITYSDK_OFFSET(0x1C821230)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_RESUMEMOVE_OFFSET UNITYSDK_OFFSET(0x1C8212A0)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP_START_OFFSET UNITYSDK_OFFSET(0x1C820E50)
#define RPG_CLIENT_PHYSICSRIGIDBODYPROP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C821770)
