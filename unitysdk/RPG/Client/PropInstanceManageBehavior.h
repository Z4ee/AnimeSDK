...
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_GET_TRANSFORMVARIENTS_OFFSET UNITYSDK_OFFSET(0x16147E10)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x161473F0)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_LATETICK_OFFSET UNITYSDK_OFFSET(0x16147B50)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x16147F50)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_35DAF4D75B1606BC_OFFSET UNITYSDK_OFFSET(0x161487C0)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x16147F10)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x161478E0)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_4343F372F34C05BF_2_OFFSET UNITYSDK_OFFSET(0x16147A70)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_4343F372F34C05BF_3_OFFSET UNITYSDK_OFFSET(0x16147AE0)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x16147880)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_557CBF1730FC2E87_OFFSET UNITYSDK_OFFSET(0x16147320)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_62652CF13F1CE80E_OFFSET UNITYSDK_OFFSET(0x16148000)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_67AC84F438ADD7E8_OFFSET UNITYSDK_OFFSET(0x16148BA0)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_704FAC4600717444_OFFSET UNITYSDK_OFFSET(0x16146AE0)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_B76CD5CB3E297DF3_OFFSET UNITYSDK_OFFSET(0x16147430)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_C706B1EC6D2E1C64_OFFSET UNITYSDK_OFFSET(0x16146B90)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_C83B2479936B63C3_OFFSET UNITYSDK_OFFSET(0x16148310)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR_METHOD_3_D7852DE078ACC1F1_OFFSET UNITYSDK_OFFSET(0x16147950)
#define RPG_CLIENT_PROPINSTANCEMANAGEBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16149500)

namespace RPG::Client
{
	inline static constexpr unsigned int PropInstanceManageBehavior_TypeDefinitionIndex = 67589;
