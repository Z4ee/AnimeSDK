...
#define RPG_CLIENT_POSCONSTRAINTBONES__CTOR_OFFSET UNITYSDK_OFFSET(0xC4B2F60)

namespace RPG::Client
{
	inline static constexpr unsigned int PosConstraintBones_TypeDefinitionIndex = 65683;
