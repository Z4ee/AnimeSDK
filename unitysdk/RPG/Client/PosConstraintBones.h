...
#define RPG_CLIENT_POSCONSTRAINTBONES__CTOR_OFFSET UNITYSDK_OFFSET(0xAD71510)

namespace RPG::Client
{
	inline static constexpr unsigned int PosConstraintBones_TypeDefinitionIndex = 64761;
