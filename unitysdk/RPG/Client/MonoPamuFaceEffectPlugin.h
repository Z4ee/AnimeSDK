...
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xA9E81B0)
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN_START_OFFSET UNITYSDK_OFFSET(0xA9E8170)
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xA9E8850)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPamuFaceEffectPlugin_TypeDefinitionIndex = 63275;
