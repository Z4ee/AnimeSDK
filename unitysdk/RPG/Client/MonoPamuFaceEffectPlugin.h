...
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC1364D0)
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN_START_OFFSET UNITYSDK_OFFSET(0xC136490)
#define RPG_CLIENT_MONOPAMUFACEEFFECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xC136B70)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoPamuFaceEffectPlugin_TypeDefinitionIndex = 64192;
