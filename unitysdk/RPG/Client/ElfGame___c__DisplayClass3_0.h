...
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18E30D70)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__0_OFFSET UNITYSDK_OFFSET(0x18E375F0)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__1_OFFSET UNITYSDK_OFFSET(0x18E37620)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfGame___c__DisplayClass3_0_TypeDefinitionIndex = 60903;
