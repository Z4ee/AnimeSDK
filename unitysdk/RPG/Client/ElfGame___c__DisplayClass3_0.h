...
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x95B0270)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__0_OFFSET UNITYSDK_OFFSET(0x95B6350)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__1_OFFSET UNITYSDK_OFFSET(0x95B6380)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfGame___c__DisplayClass3_0_TypeDefinitionIndex = 51740;
