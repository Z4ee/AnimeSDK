...
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB8BB370)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__0_OFFSET UNITYSDK_OFFSET(0xB8C1B70)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__1_OFFSET UNITYSDK_OFFSET(0xB8C1BA0)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfGame___c__DisplayClass3_0_TypeDefinitionIndex = 59618;
