...
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA236980)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__0_OFFSET UNITYSDK_OFFSET(0xA23CA60)
#define RPG_CLIENT_ELFGAME___C__DISPLAYCLASS3_0__PREPARESHOWELFUIAFTERFINISHMISSION_B__1_OFFSET UNITYSDK_OFFSET(0xA23CA90)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfGame___c__DisplayClass3_0_TypeDefinitionIndex = 58688;
