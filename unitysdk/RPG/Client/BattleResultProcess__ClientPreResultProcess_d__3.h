...
#define RPG_CLIENT_BATTLERESULTPROCESS__CLIENTPRERESULTPROCESS_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F80820)
#define RPG_CLIENT_BATTLERESULTPROCESS__CLIENTPRERESULTPROCESS_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F80D40)
#define RPG_CLIENT_BATTLERESULTPROCESS__CLIENTPRERESULTPROCESS_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F80DA0)
#define RPG_CLIENT_BATTLERESULTPROCESS__CLIENTPRERESULTPROCESS_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F80D50)
#define RPG_CLIENT_BATTLERESULTPROCESS__CLIENTPRERESULTPROCESS_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F80810)
#define RPG_CLIENT_BATTLERESULTPROCESS__CLIENTPRERESULTPROCESS_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x19F7CCE0)

namespace RPG::Client
{
	inline static constexpr unsigned int BattleResultProcess__ClientPreResultProcess_d__3_TypeDefinitionIndex = 61095;
