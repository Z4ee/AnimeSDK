...
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_DESPAWNED_OFFSET UNITYSDK_OFFSET(0x9B50810)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x9B50630)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x9B50640)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_GET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x9B50520)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x9B506B0)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x9B50590)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x9B50850)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_SETVISIBLE_OFFSET UNITYSDK_OFFSET(0x9B50650)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_SET_POSINDEX_OFFSET UNITYSDK_OFFSET(0x9B50530)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE_SPAWNED_OFFSET UNITYSDK_OFFSET(0x9B507D0)
#define RPG_CLIENT_MATCHTHREESELECTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B508D0)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeSelectionState_TypeDefinitionIndex = 53585;
