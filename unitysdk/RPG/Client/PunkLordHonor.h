...
#define RPG_CLIENT_PUNKLORDHONOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0xC66BF90)
#define RPG_CLIENT_PUNKLORDHONOR_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC66BFC0)
#define RPG_CLIENT_PUNKLORDHONOR_GET_ROW_OFFSET UNITYSDK_OFFSET(0xC66BF70)
#define RPG_CLIENT_PUNKLORDHONOR_SET_ROW_OFFSET UNITYSDK_OFFSET(0xC66BF80)
#define RPG_CLIENT_PUNKLORDHONOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC66BF30)
