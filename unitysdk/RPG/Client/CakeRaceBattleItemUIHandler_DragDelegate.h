...
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AABD4D0)
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AABD560)
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AABC640)
#define RPG_CLIENT_CAKERACEBATTLEITEMUIHANDLER_DRAGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AABD460)

namespace RPG::Client
{
	inline static constexpr unsigned int CakeRaceBattleItemUIHandler_DragDelegate_TypeDefinitionIndex = 60224;
