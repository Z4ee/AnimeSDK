...
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0xB45FA50)
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB45FAB0)

namespace RPG::Client
{
	inline static constexpr unsigned int CachedAssetLoader_AssetDependencyData_TypeDefinitionIndex = 55555;

	class CachedAssetLoader_AssetDependencyData : public ::System::Object
	{
	public:
		::RPG::Client::CachedAssetLogicType OwnerLogicType; // 0x10
		::System::Int32 MemorySize; // 0x14
		::System::Int32 OwnerCount; // 0x18
