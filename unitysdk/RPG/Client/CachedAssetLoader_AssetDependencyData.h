...
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A125E20)
#define RPG_CLIENT_CACHEDASSETLOADER_ASSETDEPENDENCYDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A125E70)
...
namespace RPG::Client
{
	...
	{
	public:
		::System::UInt64 AssetNameHash; // 0x10
		::System::Int32 RefCount; // 0x18
		::RPG::Client::CachedAssetLogicType OwnerLogicType; // 0x1C
		::System::Int32 MemorySize; // 0x20
		::RPG::Client::CachedAssetLogicType LogicType; // 0x24
		::System::Int32 OwnerCount; // 0x28
