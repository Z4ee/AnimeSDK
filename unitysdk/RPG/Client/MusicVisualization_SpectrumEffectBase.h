...
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_DISABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0xAB2F730)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ENABLEVISUALRENDERER_OFFSET UNITYSDK_OFFSET(0xAB2F6B0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONCHANGEMUSICINDEX_OFFSET UNITYSDK_OFFSET(0xAB2F7C0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONCHANGEMUSICSTATE_OFFSET UNITYSDK_OFFSET(0xAB2F860)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONCURRENTMUSICSTART_OFFSET UNITYSDK_OFFSET(0xAB2FB30)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONCURRENTMUSICWILLEND_OFFSET UNITYSDK_OFFSET(0xAB2FB90)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONLODCHANGING_OFFSET UNITYSDK_OFFSET(0xAB2F8F0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xAB2FBF0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xAB2FD30)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_PAUSEVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0xAB2F630)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_PLAYVISUALEFFECT_OFFSET UNITYSDK_OFFSET(0xAB2F5B0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_REGIST_OFFSET UNITYSDK_OFFSET(0xAB2E6B0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_SETSPECTRUMDATA_OFFSET UNITYSDK_OFFSET(0xAB2F980)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_TICKEVENT_OFFSET UNITYSDK_OFFSET(0xAB2FA20)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_TICK_OFFSET UNITYSDK_OFFSET(0xAB2FAD0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE_UNREGIST_OFFSET UNITYSDK_OFFSET(0xAB2EA70)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xAB2F560)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE___IFIXBASEPROXY_ONPOLYMERREBUILDAFTERFADING_OFFSET UNITYSDK_OFFSET(0xAB2FFE0)
#define RPG_CLIENT_MUSICVISUALIZATION_SPECTRUMEFFECTBASE___IFIXBASEPROXY_ONPOLYMERREBUILDBEFOREFADING_OFFSET UNITYSDK_OFFSET(0xAB2FFF0)

namespace RPG::Client
{
	inline static constexpr unsigned int MusicVisualization_SpectrumEffectBase_TypeDefinitionIndex = 65314;
