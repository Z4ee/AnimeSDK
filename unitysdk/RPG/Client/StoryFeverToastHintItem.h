...
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xE0FFEE0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_FADEIN_OFFSET UNITYSDK_OFFSET(0xE0FF3B0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_FADEOUT_OFFSET UNITYSDK_OFFSET(0xE0FF540)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_ANIMATING_OFFSET UNITYSDK_OFFSET(0xE100170)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_CURSTATUS_OFFSET UNITYSDK_OFFSET(0xE100130)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xE0FEFD0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xE1000F0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_POSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xE100110)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_TIMEPOINT_OFFSET UNITYSDK_OFFSET(0xE100150)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_HIDE_OFFSET UNITYSDK_OFFSET(0xE0FF480)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xE0FF6D0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_METHOD_5_0DC5168DCA324602_OFFSET UNITYSDK_OFFSET(0xE100050)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_METHOD_5_901A4F07F0046C04_OFFSET UNITYSDK_OFFSET(0xE0FFD90)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_METHOD_5_996B9749A311D0D4_OFFSET UNITYSDK_OFFSET(0xE0FFD40)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0xE0FF020)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_ANIMATING_OFFSET UNITYSDK_OFFSET(0xE100180)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_CURSTATUS_OFFSET UNITYSDK_OFFSET(0xE100140)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xE100100)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_POSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xE100120)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_TIMEPOINT_OFFSET UNITYSDK_OFFSET(0xE100160)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SHOW_OFFSET UNITYSDK_OFFSET(0xE0FF350)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xE100190)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryFeverToastHintItem_TypeDefinitionIndex = 72041;
