...
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0xB1DC500)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_FADEIN_OFFSET UNITYSDK_OFFSET(0xB1DB950)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_FADEOUT_OFFSET UNITYSDK_OFFSET(0xB1DBAE0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_ANIMATING_OFFSET UNITYSDK_OFFSET(0xB1DC790)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_CURSTATUS_OFFSET UNITYSDK_OFFSET(0xB1DC750)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0xB1DB590)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xB1DC710)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_POSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xB1DC730)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_GET_TIMEPOINT_OFFSET UNITYSDK_OFFSET(0xB1DC770)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_HIDE_OFFSET UNITYSDK_OFFSET(0xB1DBA20)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB1DBC80)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_METHOD_5_0DC5168DCA324602_OFFSET UNITYSDK_OFFSET(0xB1DC670)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_METHOD_5_192FD0E0087FC305_OFFSET UNITYSDK_OFFSET(0xB1DC250)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_METHOD_5_1A0D3B20C2CC55DC_OFFSET UNITYSDK_OFFSET(0xB1DC2A0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0xB1DB5A0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_ANIMATING_OFFSET UNITYSDK_OFFSET(0xB1DC7A0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_CURSTATUS_OFFSET UNITYSDK_OFFSET(0xB1DC760)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_LIFETIME_OFFSET UNITYSDK_OFFSET(0xB1DC720)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_POSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xB1DC740)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SET_TIMEPOINT_OFFSET UNITYSDK_OFFSET(0xB1DC780)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM_SHOW_OFFSET UNITYSDK_OFFSET(0xB1DB8F0)
#define RPG_CLIENT_STORYFEVERTOASTHINTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB1DC7B0)

namespace RPG::Client
{
	inline static constexpr unsigned int StoryFeverToastHintItem_TypeDefinitionIndex = 66436;
