...
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL___C__CCTOR_OFFSET UNITYSDK_OFFSET(0xC4D4250)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL___C__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D4290)
#define RPG_CLIENT_ACTIVITYBENEFITV2REWARDOVERVIEWVIEWMODEL___C___CTOR_B__26_0_OFFSET UNITYSDK_OFFSET(0xC4D42A0)
...
namespace RPG::Client
{
	...
	public:
		...
		{
			return (::RPG::Client::ActivityBenefitV2RewardOverviewViewModel___c**)Il2CppClass::FromTypeDefinitionIndex(ActivityBenefitV2RewardOverviewViewModel___c_TypeDefinitionIndex)->GetStaticField(0x62630);
		}
		static ::System::Func_2<::RPG::Client::ItemDisplayData*, ::System::UInt32>** StaticGet___9__26_0()
		{
			return (::System::Func_2<::RPG::Client::ItemDisplayData*, ::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(ActivityBenefitV2RewardOverviewViewModel___c_TypeDefinitionIndex)->GetStaticField(0x62638);
		}
