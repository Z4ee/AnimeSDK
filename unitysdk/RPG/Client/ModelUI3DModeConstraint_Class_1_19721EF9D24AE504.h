...
#define RPG_CLIENT_MODELUI3DMODECONSTRAINT_CLASS_1_19721EF9D24AE504__CTOR_OFFSET UNITYSDK_OFFSET(0x19E249E0)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::BaseShaderPropertyTransition* LPHDGEKELNH; // 0x10
		::System::String* BJEGPHCFBFH; // 0x18
