...
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_CREATEFORMASTER_OFFSET UNITYSDK_OFFSET(0x1A508DE0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A506F90)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_CHIMERAS_OFFSET UNITYSDK_OFFSET(0x1A509740)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_MASTERDATA_OFFSET UNITYSDK_OFFSET(0x1A509720)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_PLAYERICON_OFFSET UNITYSDK_OFFSET(0x1A5096A0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0x1A509680)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_RANKICON_OFFSET UNITYSDK_OFFSET(0x1A509700)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_RANKLEVEL_OFFSET UNITYSDK_OFFSET(0x1A5096C0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_GET_RANKNAME_OFFSET UNITYSDK_OFFSET(0x1A5096E0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_CHIMERAS_OFFSET UNITYSDK_OFFSET(0x1A509750)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_MASTERDATA_OFFSET UNITYSDK_OFFSET(0x1A509730)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_PLAYERICON_OFFSET UNITYSDK_OFFSET(0x1A5096B0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_PLAYERNAME_OFFSET UNITYSDK_OFFSET(0x1A509690)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_RANKICON_OFFSET UNITYSDK_OFFSET(0x1A509710)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_RANKLEVEL_OFFSET UNITYSDK_OFFSET(0x1A5096D0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL_SET_RANKNAME_OFFSET UNITYSDK_OFFSET(0x1A5096F0)
#define RPG_CLIENT_CHIMERADUELBATTLEPAGEVIEWMODEL_TEAMVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A509760)

namespace RPG::Client
{
	inline static constexpr unsigned int ChimeraDuelBattlePageViewModel_TeamViewModel_TypeDefinitionIndex = 60608;
	...
	public:
		...
		::System::String* _RankIcon_k__BackingField; // 0x28
