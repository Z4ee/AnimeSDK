...
#define RPG_CLIENT_SPACEZOOFEATUREDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x196DE4D0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_GET_FEATUREID_OFFSET UNITYSDK_OFFSET(0x196DE7F0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_GET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x196DE810)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_GET_ROW_OFFSET UNITYSDK_OFFSET(0x196DDDF0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_SET_FEATUREID_OFFSET UNITYSDK_OFFSET(0x196DE800)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_SET_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x196DE820)
#define RPG_CLIENT_SPACEZOOFEATUREDATA_SYNCSTATE_OFFSET UNITYSDK_OFFSET(0x196DE3A0)
#define RPG_CLIENT_SPACEZOOFEATUREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196DE7E0)
