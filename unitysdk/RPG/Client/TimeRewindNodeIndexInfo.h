...
#define RPG_CLIENT_TIMEREWINDNODEINDEXINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1978D610)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindNodeIndexInfo_TypeDefinitionIndex = 63829;
