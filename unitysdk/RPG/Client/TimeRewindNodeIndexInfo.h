...
#define RPG_CLIENT_TIMEREWINDNODEINDEXINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA5B5950)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindNodeIndexInfo_TypeDefinitionIndex = 51813;
