...
#define RPG_CLIENT_TIMEREWINDNODEINDEXINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1787D220)

namespace RPG::Client
{
	inline static constexpr unsigned int TimeRewindNodeIndexInfo_TypeDefinitionIndex = 60976;
