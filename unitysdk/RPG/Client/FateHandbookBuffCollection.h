...
#define RPG_CLIENT_FATEHANDBOOKBUFFCOLLECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C1902C0)
#define RPG_CLIENT_FATEHANDBOOKBUFFCOLLECTION_GET_BUFFITEMLIST_OFFSET UNITYSDK_OFFSET(0x1C1906C0)
#define RPG_CLIENT_FATEHANDBOOKBUFFCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1902B0)
#define RPG_CLIENT_FATEHANDBOOKBUFFCOLLECTION__GENERATEBUFFHANDBOOKLIST_OFFSET UNITYSDK_OFFSET(0x1C190350)

namespace RPG::Client
{
	inline static constexpr unsigned int FateHandbookBuffCollection_TypeDefinitionIndex = 64130;
