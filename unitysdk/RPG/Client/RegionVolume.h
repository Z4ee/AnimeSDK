...
#define RPG_CLIENT_REGIONVOLUME_ADDEDGEWORLDPOS_OFFSET UNITYSDK_OFFSET(0xAF87620)
#define RPG_CLIENT_REGIONVOLUME_DELETEEDGE_OFFSET UNITYSDK_OFFSET(0xAF876D0)
#define RPG_CLIENT_REGIONVOLUME_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xAF86030)
#define RPG_CLIENT_REGIONVOLUME_GETINSIDE_OFFSET UNITYSDK_OFFSET(0xAF86640)
#define RPG_CLIENT_REGIONVOLUME_GETLOCALPOSITIONINSIDE_OFFSET UNITYSDK_OFFSET(0xAF86760)
#define RPG_CLIENT_REGIONVOLUME_GETLOCALSPACEBOTTOMFACE_1_OFFSET UNITYSDK_OFFSET(0xAF872C0)
#define RPG_CLIENT_REGIONVOLUME_GETLOCALSPACEBOTTOMFACE_OFFSET UNITYSDK_OFFSET(0xAF87230)
#define RPG_CLIENT_REGIONVOLUME_GETNAME_OFFSET UNITYSDK_OFFSET(0xAF87790)
#define RPG_CLIENT_REGIONVOLUME_GETNORMAL_OFFSET UNITYSDK_OFFSET(0xAF86D90)
#define RPG_CLIENT_REGIONVOLUME_GETPIVOT_OFFSET UNITYSDK_OFFSET(0xAF86C10)
#define RPG_CLIENT_REGIONVOLUME_GETROTATION_OFFSET UNITYSDK_OFFSET(0xAF86CD0)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACEBOTTOMFACE_1_OFFSET UNITYSDK_OFFSET(0xAF87120)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACEBOTTOMFACE_OFFSET UNITYSDK_OFFSET(0xAF87090)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACETOPFACE_1_OFFSET UNITYSDK_OFFSET(0xAF87400)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACETOPFACE_OFFSET UNITYSDK_OFFSET(0xAF87370)
#define RPG_CLIENT_REGIONVOLUME_GETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xAF86080)
#define RPG_CLIENT_REGIONVOLUME_GET_HIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xAF87A20)
#define RPG_CLIENT_REGIONVOLUME_LOAD_OFFSET UNITYSDK_OFFSET(0xAF85930)
#define RPG_CLIENT_REGIONVOLUME_LOCALTOWORLD_1_OFFSET UNITYSDK_OFFSET(0xAF86F30)
#define RPG_CLIENT_REGIONVOLUME_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0xAF864B0)
#define RPG_CLIENT_REGIONVOLUME_METHOD_5_27358BB662782B3E_OFFSET UNITYSDK_OFFSET(0xAF87800)
#define RPG_CLIENT_REGIONVOLUME_METHOD_5_43D01116D59C5E43_OFFSET UNITYSDK_OFFSET(0xAF87880)
#define RPG_CLIENT_REGIONVOLUME_METHOD_5_BBFF6C534C16DF1C_OFFSET UNITYSDK_OFFSET(0xAF87900)
#define RPG_CLIENT_REGIONVOLUME_ONCHANGEMESH_OFFSET UNITYSDK_OFFSET(0xAF85D40)
#define RPG_CLIENT_REGIONVOLUME_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0xAF85380)
#define RPG_CLIENT_REGIONVOLUME_RANDOMHSV_OFFSET UNITYSDK_OFFSET(0xAF857D0)
#define RPG_CLIENT_REGIONVOLUME_SETBOUNDS_OFFSET UNITYSDK_OFFSET(0xAF86220)
#define RPG_CLIENT_REGIONVOLUME_SETHEIGHT_OFFSET UNITYSDK_OFFSET(0xAF85FD0)
#define RPG_CLIENT_REGIONVOLUME_SETLOCALSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xAF85C70)
#define RPG_CLIENT_REGIONVOLUME_SETWORLDSPACEVERTICES_OFFSET UNITYSDK_OFFSET(0xAF862D0)
#define RPG_CLIENT_REGIONVOLUME_SET_HIGHLIGHT_OFFSET UNITYSDK_OFFSET(0xAF87A30)
#define RPG_CLIENT_REGIONVOLUME_UPDATEEDGEWORLDPOS_OFFSET UNITYSDK_OFFSET(0xAF87550)
#define RPG_CLIENT_REGIONVOLUME_UPDATEVERTSWITHEXTEND_OFFSET UNITYSDK_OFFSET(0xAF85B70)
#define RPG_CLIENT_REGIONVOLUME_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0xAF863F0)
#define RPG_CLIENT_REGIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xAF87A40)

namespace RPG::Client
{
	inline static constexpr unsigned int RegionVolume_TypeDefinitionIndex = 57361;
