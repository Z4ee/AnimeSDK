...
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1B696950)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_DISPLAYDATAITEM_OFFSET UNITYSDK_OFFSET(0x1B696B80)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_EFFECT_OFFSET UNITYSDK_OFFSET(0x1B6969F0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_EXTRAEFFECTS_OFFSET UNITYSDK_OFFSET(0x1B696A40)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0x1B696B30)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x1B6969A0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1B696BC0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1B696890)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_MAGICUNITID_OFFSET UNITYSDK_OFFSET(0x1B696840)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_MOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x1B696A90)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B6968E0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0x1B696AE0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_SET_ISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1B696BD0)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM_SYNCISUNLOCKED_OFFSET UNITYSDK_OFFSET(0x1B696010)
#define RPG_CLIENT_ROGUEMAGICHANDBOOKMAGICUNITDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6954A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueMagicHandbookMagicUnitDataItem_TypeDefinitionIndex = 67401;
