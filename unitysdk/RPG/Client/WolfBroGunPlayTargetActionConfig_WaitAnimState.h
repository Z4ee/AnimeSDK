...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_WAITANIMSTATE_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x16811720)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_WAITANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x168117A0)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_WaitAnimState_TypeDefinitionIndex = 68673;
