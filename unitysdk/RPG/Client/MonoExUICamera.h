...
#define RPG_CLIENT_MONOEXUICAMERA_CLAMPINNERRECT_OFFSET UNITYSDK_OFFSET(0x18C3A900)
#define RPG_CLIENT_MONOEXUICAMERA_CLAMPOUTERRECT_OFFSET UNITYSDK_OFFSET(0x18C3CA60)
#define RPG_CLIENT_MONOEXUICAMERA_CLAMPRECT_OFFSET UNITYSDK_OFFSET(0x18C3C840)
#define RPG_CLIENT_MONOEXUICAMERA_CLAMPZOOM_OFFSET UNITYSDK_OFFSET(0x18C3CCB0)
#define RPG_CLIENT_MONOEXUICAMERA_DAMPINGCAMERA_OFFSET UNITYSDK_OFFSET(0x18C3DA50)
#define RPG_CLIENT_MONOEXUICAMERA_FOCUSCAMERA_1_OFFSET UNITYSDK_OFFSET(0x18C3DFE0)
#define RPG_CLIENT_MONOEXUICAMERA_FOCUSCAMERA_OFFSET UNITYSDK_OFFSET(0x18C3DF50)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERADISTANCE_OFFSET UNITYSDK_OFFSET(0x18C3F130)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAEULER_OFFSET UNITYSDK_OFFSET(0x18C3B860)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAORIGINPOS_OFFSET UNITYSDK_OFFSET(0x18C3F7A0)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAOUTINFO_OFFSET UNITYSDK_OFFSET(0x18C3BE50)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAPIVOT_OFFSET UNITYSDK_OFFSET(0x18C3F4E0)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x18C3B740)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERASPEED_OFFSET UNITYSDK_OFFSET(0x18C3F550)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAZOOMINFO_OFFSET UNITYSDK_OFFSET(0x18C3CE20)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERAZOOMRATIO_OFFSET UNITYSDK_OFFSET(0x18C3CF00)
#define RPG_CLIENT_MONOEXUICAMERA_GETCAMERA_OFFSET UNITYSDK_OFFSET(0x18C3B3A0)
#define RPG_CLIENT_MONOEXUICAMERA_GETCANVASPOS_OFFSET UNITYSDK_OFFSET(0x18C3F800)
#define RPG_CLIENT_MONOEXUICAMERA_GETCANVASRANGE_OFFSET UNITYSDK_OFFSET(0x18C3BB60)
#define RPG_CLIENT_MONOEXUICAMERA_GETCURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x18C3BB10)
#define RPG_CLIENT_MONOEXUICAMERA_GETFRUSTUMBOTTOM_OFFSET UNITYSDK_OFFSET(0x18C3C7B0)
#define RPG_CLIENT_MONOEXUICAMERA_GETFRUSTUMHEIGHT_OFFSET UNITYSDK_OFFSET(0x18C3CBB0)
#define RPG_CLIENT_MONOEXUICAMERA_GETFRUSTUMLEFT_OFFSET UNITYSDK_OFFSET(0x18C3C4E0)
#define RPG_CLIENT_MONOEXUICAMERA_GETFRUSTUMRIGHT_OFFSET UNITYSDK_OFFSET(0x18C3C600)
#define RPG_CLIENT_MONOEXUICAMERA_GETFRUSTUMTOP_OFFSET UNITYSDK_OFFSET(0x18C3C720)
#define RPG_CLIENT_MONOEXUICAMERA_GETFRUSTUMWIDTH_OFFSET UNITYSDK_OFFSET(0x18C3CB10)
#define RPG_CLIENT_MONOEXUICAMERA_GETOUTINFO_OFFSET UNITYSDK_OFFSET(0x18C3B9E0)
#define RPG_CLIENT_MONOEXUICAMERA_GETSCREENLENGTH_OFFSET UNITYSDK_OFFSET(0x18C3D9B0)
#define RPG_CLIENT_MONOEXUICAMERA_GETSTATE_OFFSET UNITYSDK_OFFSET(0x18C3BA80)
#define RPG_CLIENT_MONOEXUICAMERA_GETZOOMRANGE_OFFSET UNITYSDK_OFFSET(0x18C3D170)
#define RPG_CLIENT_MONOEXUICAMERA_GOTOSTATE_OFFSET UNITYSDK_OFFSET(0x18C3ABF0)
#define RPG_CLIENT_MONOEXUICAMERA_INITCANVASRANGE_OFFSET UNITYSDK_OFFSET(0x18C3BD70)
#define RPG_CLIENT_MONOEXUICAMERA_INITSTATES_OFFSET UNITYSDK_OFFSET(0x18C3A220)
#define RPG_CLIENT_MONOEXUICAMERA_INIT_OFFSET UNITYSDK_OFFSET(0x18C3A070)
#define RPG_CLIENT_MONOEXUICAMERA_ISALMOSTZERO_OFFSET UNITYSDK_OFFSET(0x18C3CD50)
#define RPG_CLIENT_MONOEXUICAMERA_ISLOCKX_OFFSET UNITYSDK_OFFSET(0x18C3F920)
#define RPG_CLIENT_MONOEXUICAMERA_ISLOCKY_OFFSET UNITYSDK_OFFSET(0x18C3F960)
#define RPG_CLIENT_MONOEXUICAMERA_MOVECAMERAIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x18C3D3E0)
#define RPG_CLIENT_MONOEXUICAMERA_MOVECAMERA_OFFSET UNITYSDK_OFFSET(0x18C3D210)
#define RPG_CLIENT_MONOEXUICAMERA_RECOVERCAMERAHARD_OFFSET UNITYSDK_OFFSET(0x18C3E190)
#define RPG_CLIENT_MONOEXUICAMERA_RECOVERCAMERASOFT_OFFSET UNITYSDK_OFFSET(0x18C3E600)
#define RPG_CLIENT_MONOEXUICAMERA_REFRESH_OFFSET UNITYSDK_OFFSET(0x18C3A9B0)
#define RPG_CLIENT_MONOEXUICAMERA_SAFEFRAME_OFFSET UNITYSDK_OFFSET(0x18C3DE90)
#define RPG_CLIENT_MONOEXUICAMERA_SETBORDERRECVSPEED_OFFSET UNITYSDK_OFFSET(0x18C3F9A0)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAANIMATIONSTATUS_OFFSET UNITYSDK_OFFSET(0x18C3A6D0)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAINITPOS_OFFSET UNITYSDK_OFFSET(0x18C3AB60)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAORIGINPOS_OFFSET UNITYSDK_OFFSET(0x18C3F740)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAPIVOT_OFFSET UNITYSDK_OFFSET(0x18C3E590)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x18C3B470)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERASPEED_OFFSET UNITYSDK_OFFSET(0x18C3F5C0)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAZOOMRATIO_OFFSET UNITYSDK_OFFSET(0x18C3CFC0)
#define RPG_CLIENT_MONOEXUICAMERA_SETCAMERAZOOMSPEED_OFFSET UNITYSDK_OFFSET(0x18C3F630)
#define RPG_CLIENT_MONOEXUICAMERA_SETCANVASMARGIN_OFFSET UNITYSDK_OFFSET(0x18C3D030)
#define RPG_CLIENT_MONOEXUICAMERA_SETCANVASRECT_OFFSET UNITYSDK_OFFSET(0x18C3A720)
#define RPG_CLIENT_MONOEXUICAMERA_SETDRAGGOPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x18C3B7F0)
#define RPG_CLIENT_MONOEXUICAMERA_SETENABLENAVIGATOR_OFFSET UNITYSDK_OFFSET(0x18C3FAA0)
#define RPG_CLIENT_MONOEXUICAMERA_SETINPUTPROVIDER_OFFSET UNITYSDK_OFFSET(0x18C3BA30)
#define RPG_CLIENT_MONOEXUICAMERA_SETLOCKXY_OFFSET UNITYSDK_OFFSET(0x18C3F8C0)
#define RPG_CLIENT_MONOEXUICAMERA_SETSWIPEENABLE_OFFSET UNITYSDK_OFFSET(0x18C3FA00)
#define RPG_CLIENT_MONOEXUICAMERA_SETZOOMENABLE_OFFSET UNITYSDK_OFFSET(0x18C3FA50)
#define RPG_CLIENT_MONOEXUICAMERA_SETZOOMRANGE_OFFSET UNITYSDK_OFFSET(0x18C3F690)
#define RPG_CLIENT_MONOEXUICAMERA_SET_PANEL0_OFFSET UNITYSDK_OFFSET(0x18C3A020)
#define RPG_CLIENT_MONOEXUICAMERA_SWIPECAMERA_OFFSET UNITYSDK_OFFSET(0x18C3D460)
#define RPG_CLIENT_MONOEXUICAMERA_UPDATE_OFFSET UNITYSDK_OFFSET(0x18C3AE10)
#define RPG_CLIENT_MONOEXUICAMERA_ZOOMCAMERABASE_OFFSET UNITYSDK_OFFSET(0x18C3EB70)
#define RPG_CLIENT_MONOEXUICAMERA_ZOOMCAMERA_OFFSET UNITYSDK_OFFSET(0x18C3F1B0)
#define RPG_CLIENT_MONOEXUICAMERA_ZOOMDAMPINGCAMERA_OFFSET UNITYSDK_OFFSET(0x18C3F4A0)
#define RPG_CLIENT_MONOEXUICAMERA_ZOOMRECOVERCAMERA_OFFSET UNITYSDK_OFFSET(0x18C3E980)
#define RPG_CLIENT_MONOEXUICAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18C3FB70)
#define RPG_CLIENT_MONOEXUICAMERA__FRUSTUMRECT_OFFSET UNITYSDK_OFFSET(0x18C3D880)
#define RPG_CLIENT_MONOEXUICAMERA__GETZOOMSPEEDBYPOINTERPOSITION_OFFSET UNITYSDK_OFFSET(0x18C3ED70)
#define RPG_CLIENT_MONOEXUICAMERA__SWIPESPEED_OFFSET UNITYSDK_OFFSET(0x18C3D600)
#define RPG_CLIENT_MONOEXUICAMERA__UPDATECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x18C3B1D0)
#define RPG_CLIENT_MONOEXUICAMERA__UPDATEDRAGGOPOSITION_OFFSET UNITYSDK_OFFSET(0x18C3AFA0)
#define RPG_CLIENT_MONOEXUICAMERA__UPDATE_OFFSET UNITYSDK_OFFSET(0x18C3AEC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoExUICamera_TypeDefinitionIndex = 69655;
