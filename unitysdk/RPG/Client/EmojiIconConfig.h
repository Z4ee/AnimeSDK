...
#define RPG_CLIENT_EMOJIICONCONFIG_GET_EMOJIICONASSET_OFFSET UNITYSDK_OFFSET(0xCE9A020)
#define RPG_CLIENT_EMOJIICONCONFIG_GET_EMOJIICONPATH_OFFSET UNITYSDK_OFFSET(0xCE9A0B0)
#define RPG_CLIENT_EMOJIICONCONFIG_GET_FLIPBOOKFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0xCE9A390)
#define RPG_CLIENT_EMOJIICONCONFIG_GET_FLIPBOOKSPEED_OFFSET UNITYSDK_OFFSET(0xCE9A2C0)
#define RPG_CLIENT_EMOJIICONCONFIG_GET_ISFLIPBOOK_OFFSET UNITYSDK_OFFSET(0xCE9A1F0)
#define RPG_CLIENT_EMOJIICONCONFIG_SET_EMOJIICONASSET_OFFSET UNITYSDK_OFFSET(0xCE9A060)
#define RPG_CLIENT_EMOJIICONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCE9A450)
