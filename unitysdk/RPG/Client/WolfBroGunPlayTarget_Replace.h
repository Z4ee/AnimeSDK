...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGET_REPLACE__CTOR_OFFSET UNITYSDK_OFFSET(0xA798800)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTarget_Replace_TypeDefinitionIndex = 56129;
