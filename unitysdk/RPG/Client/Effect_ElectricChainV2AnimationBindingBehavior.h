...
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_GET__OWNER_OFFSET UNITYSDK_OFFSET(0x150E7D30)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_METHOD_3_1283EC0876EAAACF_OFFSET UNITYSDK_OFFSET(0x150E76B0)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x150E7640)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x150E7DB0)
#define RPG_CLIENT_EFFECT_ELECTRICCHAINV2ANIMATIONBINDINGBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x150E8190)

namespace RPG::Client
{
	inline static constexpr unsigned int Effect_ElectricChainV2AnimationBindingBehavior_TypeDefinitionIndex = 67308;
