...
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_CREATE_OFFSET UNITYSDK_OFFSET(0xA3BE2D0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GETCURLEGENDROWS_OFFSET UNITYSDK_OFFSET(0xA3BE9C0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GETLEGENDROW_OFFSET UNITYSDK_OFFSET(0xA3BEA70)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GETLISTVIEWITEMPREFABINDEX_OFFSET UNITYSDK_OFFSET(0xA3BEB90)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_GET_CURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xA3BE1A0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_SELECTTAB_OFFSET UNITYSDK_OFFSET(0xA3BE910)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_SET_CURRENTTABINDEX_OFFSET UNITYSDK_OFFSET(0xA3BE1B0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL_SHOWDIALOG_OFFSET UNITYSDK_OFFSET(0xA3BE1C0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xA3BE410)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITATTRIBUTELISTROWS_OFFSET UNITYSDK_OFFSET(0xA3BF0C0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITATTRIBUTELIST_OFFSET UNITYSDK_OFFSET(0xA3BE5C0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITROOMCOMPTYPELISTROWS_OFFSET UNITYSDK_OFFSET(0xA3BECA0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INITROOMCOMPTYPELIST_OFFSET UNITYSDK_OFFSET(0xA3BE4F0)
#define RPG_CLIENT_ROGUETOURNPERSONALEGENDVIEWMODEL__INIT_OFFSET UNITYSDK_OFFSET(0xA3BE4A0)

namespace RPG::Client
{
	inline static constexpr unsigned int RogueTournPersonaLegendViewModel_TypeDefinitionIndex = 59758;
