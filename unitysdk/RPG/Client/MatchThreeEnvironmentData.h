...
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_CREATE_OFFSET UNITYSDK_OFFSET(0xBF75090)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_GET_DESC_OFFSET UNITYSDK_OFFSET(0xBF75290)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0xBF751B0)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_GET_ID_OFFSET UNITYSDK_OFFSET(0xBF75190)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0xBF75210)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0xBF75310)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA_SET_ID_OFFSET UNITYSDK_OFFSET(0xBF751A0)
#define RPG_CLIENT_MATCHTHREEENVIRONMENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBF75180)

namespace RPG::Client
{
	inline static constexpr unsigned int MatchThreeEnvironmentData_TypeDefinitionIndex = 61546;
