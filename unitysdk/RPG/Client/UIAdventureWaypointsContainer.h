...
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_GETDISTANCE_OFFSET UNITYSDK_OFFSET(0xE33FF10)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE33EB10)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_REFRESHWAYPOINTITEM_OFFSET UNITYSDK_OFFSET(0xE33EDA0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_START_OFFSET UNITYSDK_OFFSET(0xE33E950)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_UPDATESAFEZONE_OFFSET UNITYSDK_OFFSET(0xE33EBB0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xE3401D0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__GETARROWROTATION_OFFSET UNITYSDK_OFFSET(0xE33FC80)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__ONSETWAYPOINTSAFEZONE_OFFSET UNITYSDK_OFFSET(0xE33FFD0)
