...
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_GETDISTANCE_OFFSET UNITYSDK_OFFSET(0x1700EEB0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1700DAE0)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_REFRESHWAYPOINTITEM_OFFSET UNITYSDK_OFFSET(0x1700DD40)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_START_OFFSET UNITYSDK_OFFSET(0x1700D950)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER_UPDATESAFEZONE_OFFSET UNITYSDK_OFFSET(0x1700DB80)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1700F170)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__GETARROWROTATION_OFFSET UNITYSDK_OFFSET(0x1700EC20)
#define RPG_CLIENT_UIADVENTUREWAYPOINTSCONTAINER__ONSETWAYPOINTSAFEZONE_OFFSET UNITYSDK_OFFSET(0x1700EF70)

namespace RPG::Client
{
	inline static constexpr unsigned int UIAdventureWaypointsContainer_TypeDefinitionIndex = 66005;
