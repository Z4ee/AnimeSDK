...
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA959150)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xA959230)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA959070)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xA9592F0)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xA959360)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xA958FD0)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xA959370)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE___IFIXBASEPROXY_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xA959380)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE___IFIXBASEPROXY_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xA9593C0)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE___IFIXBASEPROXY_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xA959400)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffectPluginAutoHide_TypeDefinitionIndex = 64561;
