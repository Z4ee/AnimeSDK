...
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_AWAKEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD782940)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_DESTROYPLUGIN_OFFSET UNITYSDK_OFFSET(0xD782A00)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_DISPOSEPLUGIN_OFFSET UNITYSDK_OFFSET(0xD782860)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_ENDOFLATETICK_OFFSET UNITYSDK_OFFSET(0xD782AC0)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xD782B30)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE_RESETPLUGIN_OFFSET UNITYSDK_OFFSET(0xD7827C0)
#define RPG_CLIENT_MONOEFFECTPLUGINAUTOHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xD782B40)
