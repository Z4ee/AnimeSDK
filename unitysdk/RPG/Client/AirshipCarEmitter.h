...
#define RPG_CLIENT_AIRSHIPCAREMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0xB2E5490)
#define RPG_CLIENT_AIRSHIPCAREMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0xB2E4930)
#define RPG_CLIENT_AIRSHIPCAREMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB2E5050)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0xB2E56B0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB2E5690)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0xB2E49E0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0xB2E4A30)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_26BC5457168EC899_OFFSET UNITYSDK_OFFSET(0xB2E4DD0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_4DE65AB3A4860CEB_OFFSET UNITYSDK_OFFSET(0xB2E50A0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_795F027B3CD81A67_OFFSET UNITYSDK_OFFSET(0xB2E4FB0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_959552A5A036D346_OFFSET UNITYSDK_OFFSET(0xB2E5290)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_9C0516FF3847DE51_OFFSET UNITYSDK_OFFSET(0xB2E4D80)
#define RPG_CLIENT_AIRSHIPCAREMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0xB2E4AA0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0xB2E4CD0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_RESET_OFFSET UNITYSDK_OFFSET(0xB2E55E0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0xB2E56C0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB2E56A0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TICK_OFFSET UNITYSDK_OFFSET(0xB2E5230)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0xB2E4EE0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0xB2E4AF0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0xB2E54F0)
#define RPG_CLIENT_AIRSHIPCAREMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB2E56D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipCarEmitter_TypeDefinitionIndex = 55916;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_589*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPCAREMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
