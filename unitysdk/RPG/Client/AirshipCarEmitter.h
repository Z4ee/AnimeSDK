...
#define RPG_CLIENT_AIRSHIPCAREMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9098290)
#define RPG_CLIENT_AIRSHIPCAREMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x90976C0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9097E30)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9098520)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9098500)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x9097770)
#define RPG_CLIENT_AIRSHIPCAREMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x90977C0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_26BC5457168EC899_OFFSET UNITYSDK_OFFSET(0x9097BB0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_2F22101E49EA7CA0_OFFSET UNITYSDK_OFFSET(0x9097D90)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_959552A5A036D346_OFFSET UNITYSDK_OFFSET(0x9098090)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_9C0516FF3847DE51_OFFSET UNITYSDK_OFFSET(0x9097B60)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_FCB175EE4400634C_OFFSET UNITYSDK_OFFSET(0x9097E80)
#define RPG_CLIENT_AIRSHIPCAREMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x9097830)
#define RPG_CLIENT_AIRSHIPCAREMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x9097AB0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x90983E0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x9098530)
#define RPG_CLIENT_AIRSHIPCAREMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x9098510)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x9098030)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x9097CC0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x9097880)
#define RPG_CLIENT_AIRSHIPCAREMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x90982F0)
#define RPG_CLIENT_AIRSHIPCAREMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9098540)

namespace RPG::Client
{
	inline static constexpr unsigned int AirshipCarEmitter_TypeDefinitionIndex = 48434;
	...
	public:
		...
		{
			return ((::Class_0_16E4307DCC419505_488*(*)(::PVOID, ::System::UInt32, ::System::String*))((::PBYTE)hIl2Cpp + RPG_CLIENT_AIRSHIPCAREMITTER_CREATEMANAGER_OFFSET))(this, a1, a2);
		}
