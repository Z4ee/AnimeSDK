...
#define RPG_CLIENT_AIRSHIPCAREMITTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C60740)
#define RPG_CLIENT_AIRSHIPCAREMITTER_CREATEMANAGER_OFFSET UNITYSDK_OFFSET(0x19C5FBE0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C60300)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x19C609D0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x19C609B0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_GET_WAITEMITTIMER_OFFSET UNITYSDK_OFFSET(0x19C5FC90)
#define RPG_CLIENT_AIRSHIPCAREMITTER_ISREADYTOEMIT_OFFSET UNITYSDK_OFFSET(0x19C5FCE0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_26BC5457168EC899_OFFSET UNITYSDK_OFFSET(0x19C60080)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_4DE65AB3A4860CEB_OFFSET UNITYSDK_OFFSET(0x19C60350)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_795F027B3CD81A67_OFFSET UNITYSDK_OFFSET(0x19C60260)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_959552A5A036D346_OFFSET UNITYSDK_OFFSET(0x19C60540)
#define RPG_CLIENT_AIRSHIPCAREMITTER_METHOD_5_9C0516FF3847DE51_OFFSET UNITYSDK_OFFSET(0x19C60030)
#define RPG_CLIENT_AIRSHIPCAREMITTER_READYTOEMIT_OFFSET UNITYSDK_OFFSET(0x19C5FD50)
#define RPG_CLIENT_AIRSHIPCAREMITTER_RESETTIMER_OFFSET UNITYSDK_OFFSET(0x19C5FF80)
#define RPG_CLIENT_AIRSHIPCAREMITTER_RESET_OFFSET UNITYSDK_OFFSET(0x19C60900)
#define RPG_CLIENT_AIRSHIPCAREMITTER_SET_CURRENTEMITINTERVAL_OFFSET UNITYSDK_OFFSET(0x19C609E0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_SET_CURRENTMAXALIVECOUNT_OFFSET UNITYSDK_OFFSET(0x19C609C0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TICK_OFFSET UNITYSDK_OFFSET(0x19C604E0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TRYDESTROY_OFFSET UNITYSDK_OFFSET(0x19C60190)
#define RPG_CLIENT_AIRSHIPCAREMITTER_TRYEMIT_OFFSET UNITYSDK_OFFSET(0x19C5FDA0)
#define RPG_CLIENT_AIRSHIPCAREMITTER_UPDATELEVELINFO_OFFSET UNITYSDK_OFFSET(0x19C607D0)
#define RPG_CLIENT_AIRSHIPCAREMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C609F0)
