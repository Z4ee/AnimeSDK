...
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x19C83AC0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_EMIT_OFFSET UNITYSDK_OFFSET(0x19C843D0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x19C839B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_218124418542E081_OFFSET UNITYSDK_OFFSET(0x19C83E90)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_413756351A6E8A48_OFFSET UNITYSDK_OFFSET(0x19C84640)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_8BBAEEFBF2212B92_OFFSET UNITYSDK_OFFSET(0x19C84750)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_9B2C6D465D86BE6A_OFFSET UNITYSDK_OFFSET(0x19C84A00)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67DCF72B717FA9F_1_OFFSET UNITYSDK_OFFSET(0x19C83D40)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67DCF72B717FA9F_2_OFFSET UNITYSDK_OFFSET(0x19C848B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67DCF72B717FA9F_OFFSET UNITYSDK_OFFSET(0x19C840A0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_C56DC3B2E26040B8_OFFSET UNITYSDK_OFFSET(0x19C84240)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x19C84060)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x19C841F0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CFFF42C2DBAED4BB_OFFSET UNITYSDK_OFFSET(0x19C84BE0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCOLOR_OFFSET UNITYSDK_OFFSET(0x19C83A70)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET UNITYSDK_OFFSET(0x19C83A20)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDPOOL_OFFSET UNITYSDK_OFFSET(0x19C839D0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x19C839C0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_STOP_OFFSET UNITYSDK_OFFSET(0x19C844B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19C83C00)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C84CE0)
