...
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_BINDCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x90B9FA0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_EMIT_OFFSET UNITYSDK_OFFSET(0x90BA7A0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_GET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x90B9E90)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_0DEBA9294EADE4AB_OFFSET UNITYSDK_OFFSET(0x90BAA40)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_1_OFFSET UNITYSDK_OFFSET(0x90BA220)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_2_OFFSET UNITYSDK_OFFSET(0x90BACD0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_3ABD0165571B5EF8_OFFSET UNITYSDK_OFFSET(0x90BA4D0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_660474B0F8C5FECE_OFFSET UNITYSDK_OFFSET(0x90BA600)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_6B72D4EE8C6E907F_OFFSET UNITYSDK_OFFSET(0x90BA300)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_93569AEF92075BB5_OFFSET UNITYSDK_OFFSET(0x90BAB60)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_B67699D6DDA99366_OFFSET UNITYSDK_OFFSET(0x90BADB0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_BA35AAB815742E34_OFFSET UNITYSDK_OFFSET(0x90BB030)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x90BA490)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_METHOD_5_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x90BA5B0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCOLOR_OFFSET UNITYSDK_OFFSET(0x90B9F50)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET UNITYSDK_OFFSET(0x90B9F00)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDPOOL_OFFSET UNITYSDK_OFFSET(0x90B9EB0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SET_BGCCMATH_OFFSET UNITYSDK_OFFSET(0x90B9EA0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_STOP_OFFSET UNITYSDK_OFFSET(0x90BA880)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x90BA0E0)
#define RPG_CLIENT_ALLEYROUTEBIRDEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x90BB0D0)

namespace RPG::Client
{
	inline static constexpr unsigned int AlleyRouteBirdEmitter_TypeDefinitionIndex = 50600;
	...
	public:
		...
		::Class_0_16E4307DCC419505_552* Field_5_4; // 0x30
		...
		::Class_0_16E4307DCC419505_554* Field_5_10; // 0x58
		...
		::System::Void SetBirdConfig(::Class_0_16E4307DCC419505_552* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_552*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ALLEYROUTEBIRDEMITTER_SETBIRDCONFIG_OFFSET))(this, a1);
		}
