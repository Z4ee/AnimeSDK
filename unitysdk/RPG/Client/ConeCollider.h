...
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_0452194CF7C240C7_OFFSET UNITYSDK_OFFSET(0xB709980)
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_DA008CFDB996753E_OFFSET UNITYSDK_OFFSET(0xB70A350)
#define RPG_CLIENT_CONECOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0xB709700)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYANGLE_OFFSET UNITYSDK_OFFSET(0xB709670)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYRADIUS_OFFSET UNITYSDK_OFFSET(0xB7098E0)
#define RPG_CLIENT_CONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xB70B0E0)

namespace RPG::Client
{
	inline static constexpr unsigned int ConeCollider_TypeDefinitionIndex = 64456;
