...
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_0452194CF7C240C7_OFFSET UNITYSDK_OFFSET(0x1A293740)
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_DA008CFDB996753E_OFFSET UNITYSDK_OFFSET(0x1A294110)
#define RPG_CLIENT_CONECOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0x1A2934C0)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYANGLE_OFFSET UNITYSDK_OFFSET(0x1A293430)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYRADIUS_OFFSET UNITYSDK_OFFSET(0x1A2936A0)
#define RPG_CLIENT_CONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A294EA0)
