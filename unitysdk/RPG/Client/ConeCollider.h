...
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_0452194CF7C240C7_OFFSET UNITYSDK_OFFSET(0x941C580)
#define RPG_CLIENT_CONECOLLIDER_METHOD_6_DA008CFDB996753E_OFFSET UNITYSDK_OFFSET(0x941D030)
#define RPG_CLIENT_CONECOLLIDER_RECREATE_OFFSET UNITYSDK_OFFSET(0x941C300)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYANGLE_OFFSET UNITYSDK_OFFSET(0x941C270)
#define RPG_CLIENT_CONECOLLIDER_SUBMITBYRADIUS_OFFSET UNITYSDK_OFFSET(0x941C4E0)
#define RPG_CLIENT_CONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x941DF80)

namespace RPG::Client
{
	inline static constexpr unsigned int ConeCollider_TypeDefinitionIndex = 56293;
