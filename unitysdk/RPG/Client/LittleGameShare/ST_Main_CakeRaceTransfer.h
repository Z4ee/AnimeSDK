...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER_METHOD_5_439F93D1C22D4A6F_OFFSET UNITYSDK_OFFSET(0x1D311CA0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER_METHOD_5_89FF8065F4AF78FD_OFFSET UNITYSDK_OFFSET(0x1D30D380)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30D370)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceTransfer_TypeDefinitionIndex = 10317;
