...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER_METHOD_5_05365EE80780A158_OFFSET UNITYSDK_OFFSET(0x193B9720)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER_METHOD_5_89FF8065F4AF78FD_OFFSET UNITYSDK_OFFSET(0x193B9800)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x193B97B0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceTransfer_TypeDefinitionIndex = 9966;
