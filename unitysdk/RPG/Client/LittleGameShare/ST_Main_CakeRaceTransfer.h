...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER_METHOD_5_05365EE80780A158_OFFSET UNITYSDK_OFFSET(0x185EAA30)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER_METHOD_5_89FF8065F4AF78FD_OFFSET UNITYSDK_OFFSET(0x185E8A10)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETRANSFER__CTOR_OFFSET UNITYSDK_OFFSET(0x185E89C0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceTransfer_TypeDefinitionIndex = 10161;
