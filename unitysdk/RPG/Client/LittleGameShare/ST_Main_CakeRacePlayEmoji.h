...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYEMOJI_METHOD_5_01A57DB0E8B2691D_OFFSET UNITYSDK_OFFSET(0x1D30D040)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYEMOJI_METHOD_5_8843A94A9304FD29_OFFSET UNITYSDK_OFFSET(0x1D3118E0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYEMOJI__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30D030)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRacePlayEmoji_TypeDefinitionIndex = 10337;
