...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND_METHOD_5_A8407068FDC9323C_OFFSET UNITYSDK_OFFSET(0x185E8440)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND_METHOD_5_BDF196C5E4646231_OFFSET UNITYSDK_OFFSET(0x185EA460)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND__CTOR_OFFSET UNITYSDK_OFFSET(0x185E83F0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRacePathFind_TypeDefinitionIndex = 10159;
