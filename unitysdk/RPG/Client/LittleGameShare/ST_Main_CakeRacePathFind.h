...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND_METHOD_5_A8407068FDC9323C_OFFSET UNITYSDK_OFFSET(0x1CD4FD80)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND_METHOD_5_CB6D1EB93E2BC9DE_OFFSET UNITYSDK_OFFSET(0x1CD54720)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD4FD70)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRacePathFind_TypeDefinitionIndex = 10315;
