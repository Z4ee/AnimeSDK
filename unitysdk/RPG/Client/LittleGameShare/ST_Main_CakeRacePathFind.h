...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND_METHOD_5_A8407068FDC9323C_OFFSET UNITYSDK_OFFSET(0x193B8C60)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND_METHOD_5_BDF196C5E4646231_OFFSET UNITYSDK_OFFSET(0x193B8B80)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPATHFIND__CTOR_OFFSET UNITYSDK_OFFSET(0x193B8C10)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRacePathFind_TypeDefinitionIndex = 9964;
