...
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMETASKCONFIG_METHOD_3_E558D91C88788E46_OFFSET UNITYSDK_OFFSET(0x193B6CD0)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMETASKCONFIG_METHOD_3_F006F3778E086F09_OFFSET UNITYSDK_OFFSET(0x193B6D20)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMETASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x193B6DE0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int LittleGameTaskConfig_TypeDefinitionIndex = 9988;
