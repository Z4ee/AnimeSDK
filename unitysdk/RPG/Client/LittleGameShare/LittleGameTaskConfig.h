...
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMETASKCONFIG_METHOD_3_E558D91C88788E46_OFFSET UNITYSDK_OFFSET(0x1B9E9BF0)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMETASKCONFIG_METHOD_3_F006F3778E086F09_OFFSET UNITYSDK_OFFSET(0x1B9E9C40)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMETASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9D00)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int LittleGameTaskConfig_TypeDefinitionIndex = 10003;
