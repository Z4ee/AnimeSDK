...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEROOTDECISION_METHOD_5_15064AE286BCA10F_OFFSET UNITYSDK_OFFSET(0x1B9E89A0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEROOTDECISION_METHOD_5_8866CC7EB1D3CF9B_OFFSET UNITYSDK_OFFSET(0x1B9ED280)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEROOTDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E8990)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceRootDecision_TypeDefinitionIndex = 9989;
