...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEROOTDECISION_METHOD_5_15064AE286BCA10F_OFFSET UNITYSDK_OFFSET(0x185E87F0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEROOTDECISION_METHOD_5_AA3A6EE6AEB72989_OFFSET UNITYSDK_OFFSET(0x185EA790)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEROOTDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x185E87A0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceRootDecision_TypeDefinitionIndex = 10170;
