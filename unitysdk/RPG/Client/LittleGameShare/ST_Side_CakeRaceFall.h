...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACEFALL_METHOD_5_0110F9823B876265_OFFSET UNITYSDK_OFFSET(0x1B9E9690)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACEFALL_METHOD_5_02CE37564ADEF1B7_OFFSET UNITYSDK_OFFSET(0x1B9ED730)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACEFALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9680)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceFall_TypeDefinitionIndex = 9982;
