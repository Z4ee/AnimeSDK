...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACEFALL_METHOD_5_0110F9823B876265_OFFSET UNITYSDK_OFFSET(0x16E89140)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACEFALL_METHOD_5_05DC59C39842C635_OFFSET UNITYSDK_OFFSET(0x16E8A900)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACEFALL__CTOR_OFFSET UNITYSDK_OFFSET(0x16E890F0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceFall_TypeDefinitionIndex = 9989;
