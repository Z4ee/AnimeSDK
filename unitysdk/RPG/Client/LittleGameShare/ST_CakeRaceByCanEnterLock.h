...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK_METHOD_5_24E6FA3335062B69_OFFSET UNITYSDK_OFFSET(0x16E89970)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK_METHOD_5_2A5F5222EDA60A4A_OFFSET UNITYSDK_OFFSET(0x16E85CC0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x16E85C70)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByCanEnterLock_TypeDefinitionIndex = 9995;
