...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK_METHOD_5_12DB56A7DF2CD2CF_OFFSET UNITYSDK_OFFSET(0x1B9EA610)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK_METHOD_5_2A5F5222EDA60A4A_OFFSET UNITYSDK_OFFSET(0x1B9E5DE0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK_METHOD_5_562D7EA2DB9CA2D8_OFFSET UNITYSDK_OFFSET(0x1B9EA5C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK_METHOD_5_75393B8208F3D8C3_OFFSET UNITYSDK_OFFSET(0x1B9E76D0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCANENTERLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E5DD0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByCanEnterLock_TypeDefinitionIndex = 9988;
