...
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESHAREUTILS_EVALUATEOPERATION_OFFSET UNITYSDK_OFFSET(0xB6012A0)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESHAREUTILS_GETGAMECONFIGPATH_1_OFFSET UNITYSDK_OFFSET(0xB6011F0)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESHAREUTILS_GETGAMECONFIGPATH_OFFSET UNITYSDK_OFFSET(0xB601100)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int LittleGameShareUtils_TypeDefinitionIndex = 35511;
