...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATID_METHOD_5_1DE86B7B1F9FA6BE_OFFSET UNITYSDK_OFFSET(0x1B9EB320)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATID_METHOD_5_2A0418999B19B61E_OFFSET UNITYSDK_OFFSET(0x1B9E6280)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATID_METHOD_5_88A445500FC15EF1_OFFSET UNITYSDK_OFFSET(0x1B9E77C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATID_METHOD_5_D81C8E74060C0848_OFFSET UNITYSDK_OFFSET(0x1B9EB2D0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATID__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E6270)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByCompareSupportCatID_TypeDefinitionIndex = 9998;
