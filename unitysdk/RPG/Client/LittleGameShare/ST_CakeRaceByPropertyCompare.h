...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE_METHOD_5_1940D816D2682AF5_OFFSET UNITYSDK_OFFSET(0x1CD540B0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE_METHOD_5_4BE50A0452A54AE1_OFFSET UNITYSDK_OFFSET(0x1CD54060)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE_METHOD_5_B33E0511F177F870_OFFSET UNITYSDK_OFFSET(0x1CD4E1C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE_METHOD_5_DB09771289D5E922_OFFSET UNITYSDK_OFFSET(0x1CD4F020)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD4E1B0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByPropertyCompare_TypeDefinitionIndex = 10323;
