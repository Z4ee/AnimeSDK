...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE_METHOD_5_22AB930F87CCE276_OFFSET UNITYSDK_OFFSET(0x185EA3D0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE_METHOD_5_B33E0511F177F870_OFFSET UNITYSDK_OFFSET(0x185E71B0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYPROPERTYCOMPARE__CTOR_OFFSET UNITYSDK_OFFSET(0x185E7160)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByPropertyCompare_TypeDefinitionIndex = 10168;
