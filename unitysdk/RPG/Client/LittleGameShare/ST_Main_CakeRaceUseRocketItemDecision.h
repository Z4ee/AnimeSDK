...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION_METHOD_5_09012FD920A76EE8_OFFSET UNITYSDK_OFFSET(0x16E88AA0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION_METHOD_5_1186E436D5FAABFD_OFFSET UNITYSDK_OFFSET(0x16E8A750)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x16E88A50)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseRocketItemDecision_TypeDefinitionIndex = 10001;
