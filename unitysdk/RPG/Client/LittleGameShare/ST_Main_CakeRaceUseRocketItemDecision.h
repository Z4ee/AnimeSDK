...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION_METHOD_5_09012FD920A76EE8_OFFSET UNITYSDK_OFFSET(0x185E9080)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION_METHOD_5_1186E436D5FAABFD_OFFSET UNITYSDK_OFFSET(0x185EAD30)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x185E9030)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseRocketItemDecision_TypeDefinitionIndex = 10175;
