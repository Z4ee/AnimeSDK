...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION_METHOD_5_09012FD920A76EE8_OFFSET UNITYSDK_OFFSET(0x1B9E90B0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION_METHOD_5_D8AE7D85C02F08BC_OFFSET UNITYSDK_OFFSET(0x1B9ED640)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEROCKETITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E90A0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseRocketItemDecision_TypeDefinitionIndex = 9994;
