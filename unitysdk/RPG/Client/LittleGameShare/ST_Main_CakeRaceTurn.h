...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETURN_METHOD_5_9BC6C69BF9BD0415_OFFSET UNITYSDK_OFFSET(0x185E8BA0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETURN_METHOD_5_ADCC45BD499E9725_OFFSET UNITYSDK_OFFSET(0x185EAAC0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACETURN__CTOR_OFFSET UNITYSDK_OFFSET(0x185E8B50)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceTurn_TypeDefinitionIndex = 10160;
