...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISSKILLCD_METHOD_5_07E4554F39C2787D_OFFSET UNITYSDK_OFFSET(0x1B9E69A0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISSKILLCD_METHOD_5_3344C7577E32EF48_OFFSET UNITYSDK_OFFSET(0x1B9EC680)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISSKILLCD_METHOD_5_A3C695AB8FE4FB87_OFFSET UNITYSDK_OFFSET(0x1B9EC630)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISSKILLCD_METHOD_5_AD00105D79A32AE8_OFFSET UNITYSDK_OFFSET(0x1B9E7900)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISSKILLCD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E6990)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByIsSkillCD_TypeDefinitionIndex = 9995;
