...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION_METHOD_5_A414EEC3193C9207_OFFSET UNITYSDK_OFFSET(0x1B9E8FE0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION_METHOD_5_B46C57ECA80FBF73_OFFSET UNITYSDK_OFFSET(0x1B9ED550)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E8FD0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseItemDecision_TypeDefinitionIndex = 9991;
