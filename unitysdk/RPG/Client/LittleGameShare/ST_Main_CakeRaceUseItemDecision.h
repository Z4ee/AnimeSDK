...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION_METHOD_5_A414EEC3193C9207_OFFSET UNITYSDK_OFFSET(0x16E88990)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION_METHOD_5_D24565187027A101_OFFSET UNITYSDK_OFFSET(0x16E8A600)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x16E88940)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseItemDecision_TypeDefinitionIndex = 9998;
