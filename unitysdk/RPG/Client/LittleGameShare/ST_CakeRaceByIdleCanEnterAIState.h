...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYIDLECANENTERAISTATE_METHOD_5_4D61D47E699F9476_OFFSET UNITYSDK_OFFSET(0x16E86640)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYIDLECANENTERAISTATE_METHOD_5_A5286B12210E23F3_OFFSET UNITYSDK_OFFSET(0x16E89C40)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYIDLECANENTERAISTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E865F0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByIdleCanEnterAIState_TypeDefinitionIndex = 10007;
