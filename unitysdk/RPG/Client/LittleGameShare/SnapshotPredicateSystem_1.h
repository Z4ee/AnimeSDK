...
{
	inline static constexpr unsigned int SnapshotPredicateSystem_1_TypeDefinitionIndex = 34424;
	...
	public:
		...
		::Class_0_16E4307DCC419505_33* _SnapshotPredicationHistorySystemRef; // 0x0
