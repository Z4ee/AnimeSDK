...
{
	inline static constexpr unsigned int SnapshotPredicateSystem_1_TypeDefinitionIndex = 36235;
	...
	public:
		...
		::Class_0_16E4307DCC419505_48* _SnapshotPredicationHistorySystemRef; // 0x0
