...
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESTTASKCONFIG_METHOD_4_4D1CDCD9589F74A7_OFFSET UNITYSDK_OFFSET(0x1B9E9B20)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESTTASKCONFIG_METHOD_4_CB890B25D5D40713_OFFSET UNITYSDK_OFFSET(0x1B9E7CC0)
#define RPG_CLIENT_LITTLEGAMESHARE_LITTLEGAMESTTASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9BE0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int LittleGameSTTaskConfig_TypeDefinitionIndex = 10005;
