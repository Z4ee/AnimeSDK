...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION_METHOD_5_51E1C5EDAE61404D_OFFSET UNITYSDK_OFFSET(0x185EAB50)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION_METHOD_5_A818A74B86007B7A_OFFSET UNITYSDK_OFFSET(0x185E8CF0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x185E8CA0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseFoodItemDecision_TypeDefinitionIndex = 10174;
