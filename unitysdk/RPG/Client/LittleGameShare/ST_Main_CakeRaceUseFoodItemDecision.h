...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION_METHOD_5_A818A74B86007B7A_OFFSET UNITYSDK_OFFSET(0x1B9E8DA0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION_METHOD_5_DD6700E70800D15E_OFFSET UNITYSDK_OFFSET(0x1B9ED500)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSEFOODITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E8D90)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseFoodItemDecision_TypeDefinitionIndex = 9993;
