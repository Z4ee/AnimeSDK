...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE_METHOD_5_850CF98CA6244E36_OFFSET UNITYSDK_OFFSET(0x185EAF70)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE_METHOD_5_F8FAC8F15481C778_OFFSET UNITYSDK_OFFSET(0x185E9870)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x185E9820)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceSetAIState_TypeDefinitionIndex = 10164;
