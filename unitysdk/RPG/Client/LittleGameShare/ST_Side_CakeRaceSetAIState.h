...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE_METHOD_5_850CF98CA6244E36_OFFSET UNITYSDK_OFFSET(0x16E8A990)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE_METHOD_5_F8FAC8F15481C778_OFFSET UNITYSDK_OFFSET(0x16E89290)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E89240)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceSetAIState_TypeDefinitionIndex = 9990;
