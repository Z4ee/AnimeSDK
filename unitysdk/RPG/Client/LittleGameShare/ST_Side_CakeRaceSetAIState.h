...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE_METHOD_5_D2F7FA13DAE2C9D0_OFFSET UNITYSDK_OFFSET(0x1D311FC0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE_METHOD_5_F8FAC8F15481C778_OFFSET UNITYSDK_OFFSET(0x1D30DFE0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETAISTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D30DFD0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceSetAIState_TypeDefinitionIndex = 10319;
