...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE_METHOD_5_1D18276D7315E5FC_OFFSET UNITYSDK_OFFSET(0x16E86010)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE_METHOD_5_954DCED628E2F679_OFFSET UNITYSDK_OFFSET(0x16E89A90)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYCOMPARESUPPORTCATBEHINDDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E85FC0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByCompareSupportCatBehindDistance_TypeDefinitionIndex = 10004;
