...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESTABLESCOPEGUARDER_METHOD_5_9EF87F1F61B4EDAC_OFFSET UNITYSDK_OFFSET(0x185EB090)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESTABLESCOPEGUARDER_METHOD_5_E792206B071B7532_OFFSET UNITYSDK_OFFSET(0x185E9BB0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESTABLESCOPEGUARDER__CTOR_OFFSET UNITYSDK_OFFSET(0x185E9B60)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceStableScopeGuarder_TypeDefinitionIndex = 10166;
