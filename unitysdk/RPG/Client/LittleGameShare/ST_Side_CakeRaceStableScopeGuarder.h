...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESTABLESCOPEGUARDER_METHOD_5_9EF87F1F61B4EDAC_OFFSET UNITYSDK_OFFSET(0x193BAF20)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESTABLESCOPEGUARDER_METHOD_5_E792206B071B7532_OFFSET UNITYSDK_OFFSET(0x193BB0C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESTABLESCOPEGUARDER__CTOR_OFFSET UNITYSDK_OFFSET(0x193BB070)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceStableScopeGuarder_TypeDefinitionIndex = 9970;
