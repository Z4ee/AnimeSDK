...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYMESSAGE_METHOD_5_3290B738179185FE_OFFSET UNITYSDK_OFFSET(0x185EA640)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYMESSAGE_METHOD_5_7718D964872D8FF0_OFFSET UNITYSDK_OFFSET(0x185E86E0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x185E8690)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRacePlayMessage_TypeDefinitionIndex = 10183;
