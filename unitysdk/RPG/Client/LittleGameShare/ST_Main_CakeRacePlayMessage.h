...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYMESSAGE_METHOD_5_7718D964872D8FF0_OFFSET UNITYSDK_OFFSET(0x1CD4FFA0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYMESSAGE_METHOD_5_F61EB0A515C8E3A4_OFFSET UNITYSDK_OFFSET(0x1CD54860)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEPLAYMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD4FF90)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRacePlayMessage_TypeDefinitionIndex = 10338;
