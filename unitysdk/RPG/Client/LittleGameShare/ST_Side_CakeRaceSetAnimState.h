...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETANIMSTATE_METHOD_5_A63261443F40ABC1_OFFSET UNITYSDK_OFFSET(0x1B9E9900)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETANIMSTATE_METHOD_5_B92A4097475AAC61_OFFSET UNITYSDK_OFFSET(0x1B9ED7D0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_SIDE_CAKERACESETANIMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E98F0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Side_CakeRaceSetAnimState_TypeDefinitionIndex = 9984;
