...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_LITTLEGAMESHARE_DONOTHING_METHOD_5_D44CD389D2A41168_OFFSET UNITYSDK_OFFSET(0x1B9ED6E0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_LITTLEGAMESHARE_DONOTHING_METHOD_5_F12AE8D3E62D2284_OFFSET UNITYSDK_OFFSET(0x1B9E9470)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_LITTLEGAMESHARE_DONOTHING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9460)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_LittleGameShare_DoNothing_TypeDefinitionIndex = 9977;
