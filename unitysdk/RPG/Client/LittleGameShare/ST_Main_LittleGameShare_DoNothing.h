...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_LITTLEGAMESHARE_DONOTHING_METHOD_5_807E8D678934F725_OFFSET UNITYSDK_OFFSET(0x185EAE50)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_LITTLEGAMESHARE_DONOTHING_METHOD_5_F12AE8D3E62D2284_OFFSET UNITYSDK_OFFSET(0x185E94C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_LITTLEGAMESHARE_DONOTHING__CTOR_OFFSET UNITYSDK_OFFSET(0x185E9470)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_LittleGameShare_DoNothing_TypeDefinitionIndex = 10157;
