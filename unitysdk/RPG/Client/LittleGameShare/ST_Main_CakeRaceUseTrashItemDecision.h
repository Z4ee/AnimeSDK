...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSETRASHITEMDECISION_METHOD_5_32D3EA889B40311B_OFFSET UNITYSDK_OFFSET(0x1B9E9270)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSETRASHITEMDECISION_METHOD_5_E05E0A47119F2879_OFFSET UNITYSDK_OFFSET(0x1B9ED690)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSETRASHITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9E9260)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseTrashItemDecision_TypeDefinitionIndex = 9992;
