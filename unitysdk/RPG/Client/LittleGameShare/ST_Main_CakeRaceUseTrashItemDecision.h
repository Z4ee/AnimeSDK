...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSETRASHITEMDECISION_METHOD_5_32D3EA889B40311B_OFFSET UNITYSDK_OFFSET(0x16E88CA0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSETRASHITEMDECISION_METHOD_5_D60B8E37BE104290_OFFSET UNITYSDK_OFFSET(0x16E8A7E0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACEUSETRASHITEMDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x16E88C50)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceUseTrashItemDecision_TypeDefinitionIndex = 9999;
