...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISAISTATE_METHOD_5_363F0F30B6C8F994_OFFSET UNITYSDK_OFFSET(0x185E6E20)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISAISTATE_METHOD_5_7E846F6F252DFF69_OFFSET UNITYSDK_OFFSET(0x185EA2B0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_CAKERACEBYISAISTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x185E6DD0)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_CakeRaceByIsAIState_TypeDefinitionIndex = 10167;
