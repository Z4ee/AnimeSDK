...
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACESELECTSKILLDECISION_METHOD_5_69E6DD3D0007EC9E_OFFSET UNITYSDK_OFFSET(0x193B9660)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACESELECTSKILLDECISION_METHOD_5_9E82239B816267C0_OFFSET UNITYSDK_OFFSET(0x193B94C0)
#define RPG_CLIENT_LITTLEGAMESHARE_ST_MAIN_CAKERACESELECTSKILLDECISION__CTOR_OFFSET UNITYSDK_OFFSET(0x193B9610)

namespace RPG::Client::LittleGameShare
{
	inline static constexpr unsigned int ST_Main_CakeRaceSelectSkillDecision_TypeDefinitionIndex = 9975;
