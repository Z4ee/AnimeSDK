...
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_HANDBOOKGOTOCOMMAND_EXECUTE_OFFSET UNITYSDK_OFFSET(0x9B90B40)
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_HANDBOOKGOTOCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x9B90410)
#define RPG_CLIENT_MESSAGECONTENTGOTOBLOCK_HANDBOOKGOTOCOMMAND__GETFARMTYPEID_OFFSET UNITYSDK_OFFSET(0x9B90A10)

namespace RPG::Client
{
	inline static constexpr unsigned int MessageContentGotoBlock_HandBookGotoCommand_TypeDefinitionIndex = 51328;
