...
#define RPG_CLIENT_TRANSFEREXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC8E50)

namespace RPG::Client
{
	inline static constexpr unsigned int TransferExtraInfo_TypeDefinitionIndex = 63791;
