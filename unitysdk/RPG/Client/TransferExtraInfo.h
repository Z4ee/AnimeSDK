...
#define RPG_CLIENT_TRANSFEREXTRAINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A9A20)

namespace RPG::Client
{
	inline static constexpr unsigned int TransferExtraInfo_TypeDefinitionIndex = 68167;
