...
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_CREATEBYROW_OFFSET UNITYSDK_OFFSET(0xA338660)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_EXPREQUIREDTOTAL_OFFSET UNITYSDK_OFFSET(0xA339920)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0xA33A760)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_ISCLAIMEDPERMANENT_OFFSET UNITYSDK_OFFSET(0xA33A750)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xA33A670)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDLIMITEDTIME_OFFSET UNITYSDK_OFFSET(0xA33A600)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET_REWARDIDPERMANENT_OFFSET UNITYSDK_OFFSET(0xA33A6E0)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_GET__ROW_OFFSET UNITYSDK_OFFSET(0xA33A680)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_ISCLAIMABLEIFLEVELREACHED_OFFSET UNITYSDK_OFFSET(0xA339D40)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCLIMITEDTIMECLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0xA339090)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM_SYNCPERMANENTCLAIMEDSTATUS_OFFSET UNITYSDK_OFFSET(0xA339040)
#define RPG_CLIENT_FATEEXPREWARDLEVELDATAITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xA33A5F0)

namespace RPG::Client
{
	inline static constexpr unsigned int FateExpRewardLevelDataItem_TypeDefinitionIndex = 58882;
