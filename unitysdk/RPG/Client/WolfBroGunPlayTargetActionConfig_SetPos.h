...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SETPOS_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0x17428190)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SETPOS__CTOR_OFFSET UNITYSDK_OFFSET(0x17428210)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_SetPos_TypeDefinitionIndex = 65635;
