...
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SETPOS_METHOD_2_47FCE72550F759BF_OFFSET UNITYSDK_OFFSET(0xA795080)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SETPOS_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0xA795110)
#define RPG_CLIENT_WOLFBROGUNPLAYTARGETACTIONCONFIG_SETPOS__CTOR_OFFSET UNITYSDK_OFFSET(0xA795100)

namespace RPG::Client
{
	inline static constexpr unsigned int WolfBroGunPlayTargetActionConfig_SetPos_TypeDefinitionIndex = 56104;
