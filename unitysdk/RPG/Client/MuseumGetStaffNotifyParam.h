...
#define RPG_CLIENT_MUSEUMGETSTAFFNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1909E140)

namespace RPG::Client
{
	inline static constexpr unsigned int MuseumGetStaffNotifyParam_TypeDefinitionIndex = 63397;
