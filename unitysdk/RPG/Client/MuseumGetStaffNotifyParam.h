...
#define RPG_CLIENT_MUSEUMGETSTAFFNOTIFYPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9DB8CA0)

namespace RPG::Client
{
	inline static constexpr unsigned int MuseumGetStaffNotifyParam_TypeDefinitionIndex = 53963;
