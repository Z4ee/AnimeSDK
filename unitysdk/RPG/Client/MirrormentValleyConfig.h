...
#define RPG_CLIENT_MIRRORMENTVALLEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9BB1CC0)

namespace RPG::Client
{
	inline static constexpr unsigned int MirrormentValleyConfig_TypeDefinitionIndex = 48645;
