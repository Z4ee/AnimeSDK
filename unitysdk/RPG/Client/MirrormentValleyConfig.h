...
#define RPG_CLIENT_MIRRORMENTVALLEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16963A70)

namespace RPG::Client
{
	inline static constexpr unsigned int MirrormentValleyConfig_TypeDefinitionIndex = 60181;
