...
#define RPG_CLIENT_MIRRORMENTVALLEYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA8AC780)

namespace RPG::Client
{
	inline static constexpr unsigned int MirrormentValleyConfig_TypeDefinitionIndex = 55394;
