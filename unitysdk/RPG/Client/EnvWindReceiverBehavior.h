...
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_AABB_OFFSET UNITYSDK_OFFSET(0x18D94F30)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x18D94F80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0x18D94F10)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x18D94F60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0x18D96F10)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_092CD57850778EFC_OFFSET UNITYSDK_OFFSET(0x18D97FF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_0B7E3489D2C0938B_OFFSET UNITYSDK_OFFSET(0x18D992F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_0C6D78F7FB2736C2_OFFSET UNITYSDK_OFFSET(0x18D99710)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_19FB5FBEA9EA66CD_OFFSET UNITYSDK_OFFSET(0x18D98260)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2C9E083DC9C549F9_OFFSET UNITYSDK_OFFSET(0x18D98710)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_34AFF6E2F5322D1D_OFFSET UNITYSDK_OFFSET(0x18D98790)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0x18D997F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x18D99780)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_96189EDEF38976A6_OFFSET UNITYSDK_OFFSET(0x18D988F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_ACD91D865E237BC7_OFFSET UNITYSDK_OFFSET(0x18D98640)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B06F516E4459C742_1_OFFSET UNITYSDK_OFFSET(0x18D98E50)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B06F516E4459C742_OFFSET UNITYSDK_OFFSET(0x18D94FF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_BF622B900A7F3625_OFFSET UNITYSDK_OFFSET(0x18D99270)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_C796A0B42720FBD3_OFFSET UNITYSDK_OFFSET(0x18D99080)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_1_OFFSET UNITYSDK_OFFSET(0x18D99650)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0x18D95240)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_ED79705457B92B5C_OFFSET UNITYSDK_OFFSET(0x18D94FA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_AABB_OFFSET UNITYSDK_OFFSET(0x18D94F50)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0x18D94F90)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0x18D94F20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0x18D94F70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0x18D98890)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D99880)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18D99860)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindReceiverBehavior_TypeDefinitionIndex = 67857;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14A20);
		}
		static ::System::Int32* StaticGet__WindVelocityID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14A24);
		}
		static ::System::Int32* StaticGet__AABBSizeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14A28);
		}
		static ::System::Int32* StaticGet__FlagWaveAmplitudeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x14A2C);
		}
