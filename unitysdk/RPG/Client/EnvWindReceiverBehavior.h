...
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_AABB_OFFSET UNITYSDK_OFFSET(0xA28CA40)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0xA28CA90)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0xA28CA20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0xA28CA70)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_GET__OWNERMONOPLUGIN_OFFSET UNITYSDK_OFFSET(0xA28E7F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_146E6E50FAF07D8F_OFFSET UNITYSDK_OFFSET(0xA2901A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0xA28FB90)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_2F2B436D8A949630_OFFSET UNITYSDK_OFFSET(0xA28FFC0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_1_OFFSET UNITYSDK_OFFSET(0xA291060)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xA290FF0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0xA28FF10)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_1_OFFSET UNITYSDK_OFFSET(0xA291220)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_2_OFFSET UNITYSDK_OFFSET(0xA291280)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_3_OFFSET UNITYSDK_OFFSET(0xA2912E0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_4_OFFSET UNITYSDK_OFFSET(0xA291340)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_5_OFFSET UNITYSDK_OFFSET(0xA2913B0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0xA2911C0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_1_OFFSET UNITYSDK_OFFSET(0xA290730)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5BCE9210F4ACDD0B_OFFSET UNITYSDK_OFFSET(0xA28CB00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_5FAD56E9E208220A_OFFSET UNITYSDK_OFFSET(0xA290BA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_6041E775D6263614_OFFSET UNITYSDK_OFFSET(0xA290040)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_66CC9828DB1F478F_OFFSET UNITYSDK_OFFSET(0xA290EC0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_89EF21CA0414B145_OFFSET UNITYSDK_OFFSET(0xA28F8A0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0xA290C20)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_B7CCB99AAB7A4C8B_OFFSET UNITYSDK_OFFSET(0xA290F80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0xA28CAB0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E824431C22EF9361_OFFSET UNITYSDK_OFFSET(0xA290910)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_METHOD_3_E876C8B6D3B840A6_OFFSET UNITYSDK_OFFSET(0xA28CD00)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_AABB_OFFSET UNITYSDK_OFFSET(0xA28CA60)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_CONTAINWINDTRIGGERSCOUNT_OFFSET UNITYSDK_OFFSET(0xA28CAA0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_SELECTED_OFFSET UNITYSDK_OFFSET(0xA28CA30)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_SET_WINDVELOCITY_OFFSET UNITYSDK_OFFSET(0xA28CA80)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR_TICK_OFFSET UNITYSDK_OFFSET(0xA290140)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0xA2910F0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA2910D0)
#define RPG_CLIENT_ENVWINDRECEIVERBEHAVIOR___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xA291150)

namespace RPG::Client
{
	inline static constexpr unsigned int EnvWindReceiverBehavior_TypeDefinitionIndex = 65491;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x43B0);
		}
		static ::System::Int32* StaticGet__WindVelocityID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x43B4);
		}
		static ::System::Int32* StaticGet__FlagWaveFrequencyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x43B8);
		}
		static ::System::Int32* StaticGet__FlagWaveAmplitudeID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnvWindReceiverBehavior_TypeDefinitionIndex)->GetStaticField(0x43BC);
		}
