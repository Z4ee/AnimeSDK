...
#define RPG_CLIENT_MONOEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC079680)
#define RPG_CLIENT_MONOEFFECT_BEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0xC07A3F0)
#define RPG_CLIENT_MONOEFFECT_DESPAWNED_OFFSET UNITYSDK_OFFSET(0xC07A340)
#define RPG_CLIENT_MONOEFFECT_GETATTACH_OFFSET UNITYSDK_OFFSET(0xC07ABF0)
#define RPG_CLIENT_MONOEFFECT_GETCASTERENTITY_OFFSET UNITYSDK_OFFSET(0xC07AB30)
#define RPG_CLIENT_MONOEFFECT_GETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0xC07A860)
#define RPG_CLIENT_MONOEFFECT_GETPATHINHIERARCHY_OFFSET UNITYSDK_OFFSET(0xC07B0D0)
#define RPG_CLIENT_MONOEFFECT_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xC07AA70)
#define RPG_CLIENT_MONOEFFECT_GETTASKTIMESCALE_OFFSET UNITYSDK_OFFSET(0xC07AC40)
#define RPG_CLIENT_MONOEFFECT_GET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xC07AF90)
#define RPG_CLIENT_MONOEFFECT_GET_EFFECTNAME_OFFSET UNITYSDK_OFFSET(0xC07AE80)
#define RPG_CLIENT_MONOEFFECT_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xC07B0B0)
#define RPG_CLIENT_MONOEFFECT_GET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xC07A800)
#define RPG_CLIENT_MONOEFFECT_GET_INSTANCEEFFECTID_OFFSET UNITYSDK_OFFSET(0xC07AE60)
#define RPG_CLIENT_MONOEFFECT_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC07AEE0)
#define RPG_CLIENT_MONOEFFECT_GET_ISMANUALTICK_OFFSET UNITYSDK_OFFSET(0xC07AEC0)
#define RPG_CLIENT_MONOEFFECT_GET_ISMAZESKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xC07AF00)
#define RPG_CLIENT_MONOEFFECT_GET_ISRESET_OFFSET UNITYSDK_OFFSET(0xC07B050)
#define RPG_CLIENT_MONOEFFECT_GET_ISUIEFFECT_OFFSET UNITYSDK_OFFSET(0xC07AF20)
#define RPG_CLIENT_MONOEFFECT_GET_OVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xC07AFF0)
#define RPG_CLIENT_MONOEFFECT_GET_UNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0xC07AE40)
#define RPG_CLIENT_MONOEFFECT_GET_UNIQUEEFFECTNAME_OFFSET UNITYSDK_OFFSET(0xC07AEA0)
#define RPG_CLIENT_MONOEFFECT_INIT_OFFSET UNITYSDK_OFFSET(0xC0796D0)
#define RPG_CLIENT_MONOEFFECT_ISAFTERFADE_OFFSET UNITYSDK_OFFSET(0xC07ACC0)
#define RPG_CLIENT_MONOEFFECT_ISAFTERFINISH_OFFSET UNITYSDK_OFFSET(0xC07AD20)
#define RPG_CLIENT_MONOEFFECT_ISCANREVIVE_OFFSET UNITYSDK_OFFSET(0xC07ADE0)
#define RPG_CLIENT_MONOEFFECT_ISREMOVED_OFFSET UNITYSDK_OFFSET(0xC07AD80)
#define RPG_CLIENT_MONOEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC079A00)
#define RPG_CLIENT_MONOEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC0798F0)
#define RPG_CLIENT_MONOEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC0797D0)
#define RPG_CLIENT_MONOEFFECT_SETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0xC07A670)
#define RPG_CLIENT_MONOEFFECT_SETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xC07A8C0)
#define RPG_CLIENT_MONOEFFECT_SET_BEHAVIOR_OFFSET UNITYSDK_OFFSET(0xC07AFA0)
#define RPG_CLIENT_MONOEFFECT_SET_EFFECTNAME_OFFSET UNITYSDK_OFFSET(0xC07AE90)
#define RPG_CLIENT_MONOEFFECT_SET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xC07B0C0)
#define RPG_CLIENT_MONOEFFECT_SET_GORENDERERCACHE_OFFSET UNITYSDK_OFFSET(0xC07AF40)
#define RPG_CLIENT_MONOEFFECT_SET_INSTANCEEFFECTID_OFFSET UNITYSDK_OFFSET(0xC07AE70)
#define RPG_CLIENT_MONOEFFECT_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xC07AEF0)
#define RPG_CLIENT_MONOEFFECT_SET_ISMANUALTICK_OFFSET UNITYSDK_OFFSET(0xC07AED0)
#define RPG_CLIENT_MONOEFFECT_SET_ISMAZESKILLEFFECT_OFFSET UNITYSDK_OFFSET(0xC07AF10)
#define RPG_CLIENT_MONOEFFECT_SET_ISUIEFFECT_OFFSET UNITYSDK_OFFSET(0xC07AF30)
#define RPG_CLIENT_MONOEFFECT_SET_UNIQUEEFFECTID_OFFSET UNITYSDK_OFFSET(0xC07AE50)
#define RPG_CLIENT_MONOEFFECT_SET_UNIQUEEFFECTNAME_OFFSET UNITYSDK_OFFSET(0xC07AEB0)
#define RPG_CLIENT_MONOEFFECT_SPAWNED_OFFSET UNITYSDK_OFFSET(0xC07A290)
#define RPG_CLIENT_MONOEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC07B250)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoEffect_TypeDefinitionIndex = 65363;
