...
namespace RPG::Client
{
	...
	public:
		...
		::System::UInt32 _GetProperAllyEntityID_b__0_0(::RPG::Client::MarbleBattleSealData* x)
		{
			return ((::System::UInt32(*)(::PVOID, ::RPG::Client::MarbleBattleSealData*))((::PBYTE)hIl2Cpp + RPG_CLIENT_MARBLEBATTLEINPUTHANDLER___C__GETPROPERALLYENTITYID_B__0_0_OFFSET))(this, x);
		}
	};
}
