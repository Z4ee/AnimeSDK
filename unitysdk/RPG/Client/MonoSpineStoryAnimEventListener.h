...
#define RPG_CLIENT_MONOSPINESTORYANIMEVENTLISTENER_SETSWITCHBACKGROUNDCALLBACK_OFFSET UNITYSDK_OFFSET(0xC146AA0)
#define RPG_CLIENT_MONOSPINESTORYANIMEVENTLISTENER_SWITCHBACKGROUND_OFFSET UNITYSDK_OFFSET(0xC146A20)
#define RPG_CLIENT_MONOSPINESTORYANIMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0xC146B20)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSpineStoryAnimEventListener_TypeDefinitionIndex = 56343;
