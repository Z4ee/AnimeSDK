...
#define RPG_CLIENT_MONOSPINESTORYANIMEVENTLISTENER_SETSWITCHBACKGROUNDCALLBACK_OFFSET UNITYSDK_OFFSET(0xA9F86F0)
#define RPG_CLIENT_MONOSPINESTORYANIMEVENTLISTENER_SWITCHBACKGROUND_OFFSET UNITYSDK_OFFSET(0xA9F8670)
#define RPG_CLIENT_MONOSPINESTORYANIMEVENTLISTENER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9F8770)

namespace RPG::Client
{
	inline static constexpr unsigned int MonoSpineStoryAnimEventListener_TypeDefinitionIndex = 55592;
