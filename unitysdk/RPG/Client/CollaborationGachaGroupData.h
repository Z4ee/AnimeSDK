...
#define RPG_CLIENT_COLLABORATIONGACHAGROUPDATA_GETSORTEDAVATARGACHAPOOLS_OFFSET UNITYSDK_OFFSET(0xCC4C650)
#define RPG_CLIENT_COLLABORATIONGACHAGROUPDATA_GETSORTEDWEAPONGACHAPOOLS_OFFSET UNITYSDK_OFFSET(0xCC4C8A0)
#define RPG_CLIENT_COLLABORATIONGACHAGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC4C5D0)
