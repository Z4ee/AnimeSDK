...
#define RPG_CLIENT_COLLABORATIONGACHAGROUPDATA_GETSORTEDAVATARGACHAPOOLS_OFFSET UNITYSDK_OFFSET(0xA0B0700)
#define RPG_CLIENT_COLLABORATIONGACHAGROUPDATA_GETSORTEDWEAPONGACHAPOOLS_OFFSET UNITYSDK_OFFSET(0xA0B08A0)
#define RPG_CLIENT_COLLABORATIONGACHAGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0B0680)

namespace RPG::Client
{
	inline static constexpr unsigned int CollaborationGachaGroupData_TypeDefinitionIndex = 59173;
