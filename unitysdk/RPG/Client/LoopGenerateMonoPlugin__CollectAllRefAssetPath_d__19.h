...
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__COLLECTALLREFASSETPATH_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD58CEA0)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__COLLECTALLREFASSETPATH_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD58CFD0)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__COLLECTALLREFASSETPATH_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD58D030)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__COLLECTALLREFASSETPATH_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD58CFE0)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__COLLECTALLREFASSETPATH_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD58CE90)
#define RPG_CLIENT_LOOPGENERATEMONOPLUGIN__COLLECTALLREFASSETPATH_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0xD58C970)
...
namespace RPG::Client
{
	...
	{
	public:
		::RPG::Client::LoopGenerateMonoPlugin* __4__this; // 0x10
		::System::Collections::Generic::List_1<::RPG::Client::LoopGenerateBehavior_SliderTemplate>* _sliderTemplates_5__3; // 0x18
