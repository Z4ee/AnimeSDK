...
#define RPG_CLIENT_PLANETFESLANDCOLLECTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xACC0120)

namespace RPG::Client
{
	inline static constexpr unsigned int PlanetFesLandCollectData_TypeDefinitionIndex = 61358;
