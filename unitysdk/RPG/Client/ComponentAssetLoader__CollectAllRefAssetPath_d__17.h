...
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A287670)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2877C0)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A287820)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A2877D0)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A287660)
#define RPG_CLIENT_COMPONENTASSETLOADER__COLLECTALLREFASSETPATH_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2873B0)
...
namespace RPG::Client
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* _paths_5__5; // 0x20
