...
#define RPG_CLIENT_NAVMESHLINKPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xAB77080)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshLinkParams_TypeDefinitionIndex = 63302;
