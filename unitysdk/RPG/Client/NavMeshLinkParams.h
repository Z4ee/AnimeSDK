...
#define RPG_CLIENT_NAVMESHLINKPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xC2871A0)

namespace RPG::Client
{
	inline static constexpr unsigned int NavMeshLinkParams_TypeDefinitionIndex = 64219;
