...
#define RPG_CLIENT_MONOPREFABSWITCHER_CLOSEALLNODES_OFFSET UNITYSDK_OFFSET(0xD857870)
#define RPG_CLIENT_MONOPREFABSWITCHER_OPENCURRENTSTATENODES_OFFSET UNITYSDK_OFFSET(0xD858100)
#define RPG_CLIENT_MONOPREFABSWITCHER_SWITCHSTATE_OFFSET UNITYSDK_OFFSET(0xD857630)
#define RPG_CLIENT_MONOPREFABSWITCHER_TRYSETCURRENTSYSTEMNAME_OFFSET UNITYSDK_OFFSET(0xD8576F0)
#define RPG_CLIENT_MONOPREFABSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xD8583A0)
