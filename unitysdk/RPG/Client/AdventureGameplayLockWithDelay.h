...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCKWITHDELAY_METHOD_4_38EF2DF33254A0BF_OFFSET UNITYSDK_OFFSET(0x16E83770)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCKWITHDELAY_METHOD_4_B20391A191C34184_OFFSET UNITYSDK_OFFSET(0x16E83990)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCKWITHDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x16E83740)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureGameplayLockWithDelay_TypeDefinitionIndex = 9982;
