...
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCKWITHDELAY_METHOD_4_38EF2DF33254A0BF_OFFSET UNITYSDK_OFFSET(0x1CD48FE0)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCKWITHDELAY_METHOD_4_F705B2CAB5C5B16E_OFFSET UNITYSDK_OFFSET(0x1CD49200)
#define RPG_CLIENT_ADVENTUREGAMEPLAYLOCKWITHDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1CD48FD0)

namespace RPG::Client
{
	inline static constexpr unsigned int AdventureGameplayLockWithDelay_TypeDefinitionIndex = 10306;
