...
#define RPG_CLIENT_TALKEMOTIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC9C6CD0)

namespace RPG::Client
{
	inline static constexpr unsigned int TalkEmotionData_TypeDefinitionIndex = 66484;
