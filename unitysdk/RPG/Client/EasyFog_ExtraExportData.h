...
#define RPG_CLIENT_EASYFOG_EXTRAEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17727B90)

namespace RPG::Client
{
	inline static constexpr unsigned int EasyFog_ExtraExportData_TypeDefinitionIndex = 67624;
