...
#define RPG_CLIENT_EASYFOG_EXTRAEXPORTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A69EE30)

namespace RPG::Client
{
	inline static constexpr unsigned int EasyFog_ExtraExportData_TypeDefinitionIndex = 70747;
