...
#define RPG_CLIENT_ELFHINTTOASTMANAGER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x95B9E40)
#define RPG_CLIENT_ELFHINTTOASTMANAGER___C__DISPLAYCLASS7_0___CHECKPROFILERHINTS_B__0_OFFSET UNITYSDK_OFFSET(0x95B9E50)

namespace RPG::Client
{
	inline static constexpr unsigned int ElfHintToastManager___c__DisplayClass7_0_TypeDefinitionIndex = 51750;
