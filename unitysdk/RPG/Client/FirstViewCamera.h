...
#define RPG_CLIENT_FIRSTVIEWCAMERA_AWAKE_OFFSET UNITYSDK_OFFSET(0xBA25FE0)
#define RPG_CLIENT_FIRSTVIEWCAMERA_SETDESTINATION_OFFSET UNITYSDK_OFFSET(0xBA25F60)
#define RPG_CLIENT_FIRSTVIEWCAMERA_SETTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xBA25F10)
#define RPG_CLIENT_FIRSTVIEWCAMERA_START_OFFSET UNITYSDK_OFFSET(0xBA26070)
#define RPG_CLIENT_FIRSTVIEWCAMERA_UPDATE_OFFSET UNITYSDK_OFFSET(0xBA26100)
#define RPG_CLIENT_FIRSTVIEWCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xBA26950)

namespace RPG::Client
{
	inline static constexpr unsigned int FirstViewCamera_TypeDefinitionIndex = 56161;
