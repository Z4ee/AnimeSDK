...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKSHIPCOLLISIONCOMPONENT_CHECKBOUNDINTERSECT_OFFSET UNITYSDK_OFFSET(0x8EE3740)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKSHIPCOLLISIONCOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0x8EE1F00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKSHIPCOLLISIONCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x8EEDAE0)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackShipCollisionComponent_TypeDefinitionIndex = 60753;
