...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKSHIPCOLLISIONCOMPONENT_CHECKBOUNDINTERSECT_OFFSET UNITYSDK_OFFSET(0x9ABF140)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKSHIPCOLLISIONCOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0x9ABF090)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKSHIPCOLLISIONCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9ABF2F0)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackShipCollisionComponent_TypeDefinitionIndex = 68202;
