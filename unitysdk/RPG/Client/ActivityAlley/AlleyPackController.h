...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYGOOD_OFFSET UNITYSDK_OFFSET(0x9AB1D00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDALLEYPACKSHIP_OFFSET UNITYSDK_OFFSET(0x9AB1770)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ADDUIAREA_OFFSET UNITYSDK_OFFSET(0x9AB8A40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_BEGINDRAGTARGET_OFFSET UNITYSDK_OFFSET(0x9AB59D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CANCELSETTLECURGOOD_OFFSET UNITYSDK_OFFSET(0x9AB7540)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x9AAB3F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARMATCHANI_OFFSET UNITYSDK_OFFSET(0x9AB1250)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARSHIP_OFFSET UNITYSDK_OFFSET(0x9AB1870)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_CLEARUIAREA_OFFSET UNITYSDK_OFFSET(0x9AB8AB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_COMBINEGOOD_OFFSET UNITYSDK_OFFSET(0x9AB0590)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AB6F20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x9AB4990)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETALLEYPLACINGSHIPINFO_OFFSET UNITYSDK_OFFSET(0x9AB2180)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTADJUSTYPOS_OFFSET UNITYSDK_OFFSET(0x9AAED30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GETINTERSECTBOUND_OFFSET UNITYSDK_OFFSET(0x9AB3B80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_ALLGOODDATADICT_OFFSET UNITYSDK_OFFSET(0x9AB28F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB8C40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURGROUPDATA_OFFSET UNITYSDK_OFFSET(0x9AABE30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x9AB6D20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_GET_SHIPDATA_OFFSET UNITYSDK_OFFSET(0x9AB28E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x9AB6D40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ISINSELECTGROUP_OFFSET UNITYSDK_OFFSET(0x9AB3D80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATETICK_OFFSET UNITYSDK_OFFSET(0x9AB3430)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9AB7200)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REGISTERGOODOPERATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB8950)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVECURGOOD_OFFSET UNITYSDK_OFFSET(0x9AB4E80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_REMOVESHIP_OFFSET UNITYSDK_OFFSET(0x9AB1C20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x9AB8B20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATECURGOOD_OFFSET UNITYSDK_OFFSET(0x9AB4FB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_ROTATESHIP_OFFSET UNITYSDK_OFFSET(0x9AB8760)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SELECTGOOD_OFFSET UNITYSDK_OFFSET(0x9AB6860)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETLAYERRECURSIVE_OFFSET UNITYSDK_OFFSET(0x9AB2900)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SETTLEGOOD_OFFSET UNITYSDK_OFFSET(0x9AB1170)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURALLEYPACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB8C50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SET_CURJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x9AB6D30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SHOWFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x9AB2C00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHJOYSTICKSTATE_OFFSET UNITYSDK_OFFSET(0x9AB6B90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_SWITCHSELECTTARGET_OFFSET UNITYSDK_OFFSET(0x9AB5690)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x9AB3130)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYAUTOSETTLE_OFFSET UNITYSDK_OFFSET(0x9AB7C80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x9AB7C30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_TRYSHOWMATCHANI_OFFSET UNITYSDK_OFFSET(0x9AB7770)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UNSELECTCURGOOD_OFFSET UNITYSDK_OFFSET(0x9AB4B00)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATEDRAGMOUSEPOSOFFSET_OFFSET UNITYSDK_OFFSET(0x9AAB450)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9AB7170)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB19F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADDALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x9AB1E20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ADJUSTPOSFROMMOUSE_OFFSET UNITYSDK_OFFSET(0x9AB1FE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CANCELSETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB75B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CHECKGOODCANSETTLE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB4910)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__COMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB7250)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB8CF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DECOMBINEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB8630)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x9AB26D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__DISPOSEALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x9AB27C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETCURMOUSEHOVERCMPT_OFFSET UNITYSDK_OFFSET(0x9AB5810)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__GETVIRTUALCURSOR_OFFSET UNITYSDK_OFFSET(0x9AB6C30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKCMPTCONTAINER_OFFSET UNITYSDK_OFFSET(0x9AB21D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITALLEYPACKGRID_OFFSET UNITYSDK_OFFSET(0x9AB2260)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x9AB2FF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x9AB6940)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__INITSHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB1AB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURCMPTOUTSIDESHIP_OFFSET UNITYSDK_OFFSET(0x9AB5DC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORINUIAREA_OFFSET UNITYSDK_OFFSET(0x9AB5F50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ISCURSORPOINTGOOD_OFFSET UNITYSDK_OFFSET(0x9AB6CB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__LOADFINISHORDEREFFECT_OFFSET UNITYSDK_OFFSET(0x9AB2E50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONALLEYPACKENABLE3DCONTROL_OFFSET UNITYSDK_OFFSET(0x9AB6AD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCANCEL_OFFSET UNITYSDK_OFFSET(0x9AB5290)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSMENUCONFIRM_OFFSET UNITYSDK_OFFSET(0x9AB4660)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERPRESSRT_OFFSET UNITYSDK_OFFSET(0x9AB4F50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ONCONTROLLERREMOVE_OFFSET UNITYSDK_OFFSET(0x9AB4E20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSDRAG_OFFSET UNITYSDK_OFFSET(0x9AB6670)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSENDDRAG_OFFSET UNITYSDK_OFFSET(0x9AB6810)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__PROCESSSELECTITEM_OFFSET UNITYSDK_OFFSET(0x9AB6380)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REFRESHJOYSTICKFACTOR_OFFSET UNITYSDK_OFFSET(0x9AB6280)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x9AB3FB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RELEASEEFFECTASSET_OFFSET UNITYSDK_OFFSET(0x9AB30A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKCMPT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB23F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLEYPACKGOODDATA_OFFSET UNITYSDK_OFFSET(0x9AB2880)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEALLGOODS_OFFSET UNITYSDK_OFFSET(0x9AB2510)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVECURSHIP_OFFSET UNITYSDK_OFFSET(0x9AB1C70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB7ED0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__REMOVESHIPCOLLISIONCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9AB2660)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETCURSORPOS_OFFSET UNITYSDK_OFFSET(0x9AB4270)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__RESETINPUTPOSPARAM_OFFSET UNITYSDK_OFFSET(0x9AB6A40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__ROTATESHIP_B__111_0_OFFSET UNITYSDK_OFFSET(0x9AB8DE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB7320)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__SETTLEGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB83B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKGAMEPADINPUT_OFFSET UNITYSDK_OFFSET(0x9AB39D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKINPUT_OFFSET UNITYSDK_OFFSET(0x9AB3730)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKJOYSTICKMOVECMPT_OFFSET UNITYSDK_OFFSET(0x9AB52D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUTPOSCAL_OFFSET UNITYSDK_OFFSET(0x9AB31E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x9AB3190)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TICKREFRESHCURSORSTATE_OFFSET UNITYSDK_OFFSET(0x9AB3A20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODADDCALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB2120)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODCANCELSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB8BE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB81A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODONDRAGSTARTCALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB5970)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB8700)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSELECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB74D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRIGGERGOODSETTLECALLBACK_OFFSET UNITYSDK_OFFSET(0x9AB8B70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYENDDRAG_OFFSET UNITYSDK_OFFSET(0x9AB5BF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSELECT_OFFSET UNITYSDK_OFFSET(0x9AB5530)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__TRYSTARTDRAG_OFFSET UNITYSDK_OFFSET(0x9AB4C80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNINITINPUTMANAGER_OFFSET UNITYSDK_OFFSET(0x9AB69C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNREGISTERCONTROLLERJOYSTICK_OFFSET UNITYSDK_OFFSET(0x9AB4470)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONTROLLER__UNSELECTGOOD_INTERNAL_OFFSET UNITYSDK_OFFSET(0x9AB8200)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackController_TypeDefinitionIndex = 68183;
