...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD1AA00)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackConfig_TypeDefinitionIndex = 73998;
