...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ALLEYPACKRENDERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8EDB5D0)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackComponent_AlleyPackRenderData_TypeDefinitionIndex = 60747;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Material*>* OriginMaterials; // 0x28
