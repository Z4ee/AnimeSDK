...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ALLEYPACKIDLESTATE_ENTER_OFFSET UNITYSDK_OFFSET(0x194B6F50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ALLEYPACKIDLESTATE_EXIT_OFFSET UNITYSDK_OFFSET(0x194B7050)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ALLEYPACKIDLESTATE_TICK_OFFSET UNITYSDK_OFFSET(0x194B6FD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ALLEYPACKIDLESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x194AE830)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackComponent_AlleyPackIdleState_TypeDefinitionIndex = 70693;
