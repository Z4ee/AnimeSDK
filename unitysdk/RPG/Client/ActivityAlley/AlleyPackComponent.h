...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_AUTOSETTLE_OFFSET UNITYSDK_OFFSET(0x194B0990)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_BEGINDRAG_OFFSET UNITYSDK_OFFSET(0x194B1430)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CANCELSETTLE_OFFSET UNITYSDK_OFFSET(0x194B0AA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CHECKBOUNDINTERSECT_OFFSET UNITYSDK_OFFSET(0x194B0CE0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CLEARANCHORSETTLEEFFECT_OFFSET UNITYSDK_OFFSET(0x194B0250)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x194AF4A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DOROTATE_OFFSET UNITYSDK_OFFSET(0x194B1BD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DOSELECT_OFFSET UNITYSDK_OFFSET(0x194B1A70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ENABLECOLLIDERTRIGGER_OFFSET UNITYSDK_OFFSET(0x194B0C40)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x194B18A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x194B28B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_DRAGMERGEDBOUND_OFFSET UNITYSDK_OFFSET(0x194B2970)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_DRAGSTATE_OFFSET UNITYSDK_OFFSET(0x194B28A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_FIRSTHEADANCHOR_OFFSET UNITYSDK_OFFSET(0x194B0EF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0x194AE8A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x194B0200)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONSELECT_OFFSET UNITYSDK_OFFSET(0x194AF770)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONSETTLE_OFFSET UNITYSDK_OFFSET(0x194AFA70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0x194AF8E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_REFRESHCANANCHORSTATUS_OFFSET UNITYSDK_OFFSET(0x194B1100)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SETTLE_OFFSET UNITYSDK_OFFSET(0x194B04E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SET_DRAGMERGEDBOUND_OFFSET UNITYSDK_OFFSET(0x194B2990)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SHOWANCHORSETTLEEFFECT_OFFSET UNITYSDK_OFFSET(0x194AFDD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0x194B0F60)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_TRIGGERREMOVEAUDIO_OFFSET UNITYSDK_OFFSET(0x194B0340)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__BEGINROTATE_OFFSET UNITYSDK_OFFSET(0x194B1F90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x194B3100)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x194B2E90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__COLLECTANCHORS_OFFSET UNITYSDK_OFFSET(0x194AE9A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__COLLECTRENDERDATA_OFFSET UNITYSDK_OFFSET(0x194AECD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x194AE760)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__DISPOSERENDERDATA_OFFSET UNITYSDK_OFFSET(0x194AF4F0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x194B30B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__GETTIMERRESET_OFFSET UNITYSDK_OFFSET(0x194B2F20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x194B1E70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__RESETDRAGCOLOR_OFFSET UNITYSDK_OFFSET(0x194B2B90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__SETDRAGCOLOR_OFFSET UNITYSDK_OFFSET(0x194B2CF0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__SWITCHDRAGSTATE_OFFSET UNITYSDK_OFFSET(0x194AFB90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TICKTSTATE_OFFSET UNITYSDK_OFFSET(0x194B2820)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERREMOVEAUDIO_OFFSET UNITYSDK_OFFSET(0x194B0390)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERROTATEAUDIO_OFFSET UNITYSDK_OFFSET(0x194B2690)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERSETTLEAUDIO_OFFSET UNITYSDK_OFFSET(0x194B0070)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__UPDATEDRAGSTATE_OFFSET UNITYSDK_OFFSET(0x194B1060)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackComponent_TypeDefinitionIndex = 70688;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyPackComponent_TypeDefinitionIndex)->GetStaticField(0x95F0);
		}
		...
		::System::Void _ChangeState(::Class_0_16E4307DCC419505_1137* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_1137*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CHANGESTATE_OFFSET))(this, a1);
		}
