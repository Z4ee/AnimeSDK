...
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_AUTOSETTLE_OFFSET UNITYSDK_OFFSET(0x1AD125C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_BEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1AD13060)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CANCELSETTLE_OFFSET UNITYSDK_OFFSET(0x1AD126D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CHECKBOUNDINTERSECT_OFFSET UNITYSDK_OFFSET(0x1AD12910)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_CLEARANCHORSETTLEEFFECT_OFFSET UNITYSDK_OFFSET(0x1AD11E80)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD110E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DOROTATE_OFFSET UNITYSDK_OFFSET(0x1AD13800)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_DOSELECT_OFFSET UNITYSDK_OFFSET(0x1AD136A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ENABLECOLLIDERTRIGGER_OFFSET UNITYSDK_OFFSET(0x1AD12870)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ENDDRAG_OFFSET UNITYSDK_OFFSET(0x1AD134D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD144E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_DRAGMERGEDBOUND_OFFSET UNITYSDK_OFFSET(0x1AD145A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_DRAGSTATE_OFFSET UNITYSDK_OFFSET(0x1AD144D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_GET_FIRSTHEADANCHOR_OFFSET UNITYSDK_OFFSET(0x1AD12B20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_INIT_OFFSET UNITYSDK_OFFSET(0x1AD104E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x1AD11E30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1AD113B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONSETTLE_OFFSET UNITYSDK_OFFSET(0x1AD116B0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0x1AD11520)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_REFRESHCANANCHORSTATUS_OFFSET UNITYSDK_OFFSET(0x1AD12D30)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SETTLE_OFFSET UNITYSDK_OFFSET(0x1AD12110)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SET_DRAGMERGEDBOUND_OFFSET UNITYSDK_OFFSET(0x1AD145C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_SHOWANCHORSETTLEEFFECT_OFFSET UNITYSDK_OFFSET(0x1AD11A10)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_TICK_OFFSET UNITYSDK_OFFSET(0x1AD12B90)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT_TRIGGERREMOVEAUDIO_OFFSET UNITYSDK_OFFSET(0x1AD11F70)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__BEGINROTATE_OFFSET UNITYSDK_OFFSET(0x1AD13BC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD14D20)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x1AD14AC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__COLLECTANCHORS_OFFSET UNITYSDK_OFFSET(0x1AD105E0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__COLLECTRENDERDATA_OFFSET UNITYSDK_OFFSET(0x1AD10910)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD103A0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__DISPOSERENDERDATA_OFFSET UNITYSDK_OFFSET(0x1AD11130)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1AD14CD0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__GETTIMERRESET_OFFSET UNITYSDK_OFFSET(0x1AD14B50)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__ONROTATEFINISH_OFFSET UNITYSDK_OFFSET(0x1AD13AA0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__RESETDRAGCOLOR_OFFSET UNITYSDK_OFFSET(0x1AD147C0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__SETDRAGCOLOR_OFFSET UNITYSDK_OFFSET(0x1AD14920)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__SWITCHDRAGSTATE_OFFSET UNITYSDK_OFFSET(0x1AD117D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TICKTSTATE_OFFSET UNITYSDK_OFFSET(0x1AD14450)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERREMOVEAUDIO_OFFSET UNITYSDK_OFFSET(0x1AD11FC0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERROTATEAUDIO_OFFSET UNITYSDK_OFFSET(0x1AD142D0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__TRIGGERSETTLEAUDIO_OFFSET UNITYSDK_OFFSET(0x1AD11CB0)
#define RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__UPDATEDRAGSTATE_OFFSET UNITYSDK_OFFSET(0x1AD12C90)

namespace RPG::Client::ActivityAlley
{
	inline static constexpr unsigned int AlleyPackComponent_TypeDefinitionIndex = 73987;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AlleyPackComponent_TypeDefinitionIndex)->GetStaticField(0x14290);
		}
		...
		::System::Void _ChangeState(::Class_0_16E4307DCC419505_1195* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_1195*))((::PBYTE)hIl2Cpp + RPG_CLIENT_ACTIVITYALLEY_ALLEYPACKCOMPONENT__CHANGESTATE_OFFSET))(this, a1);
		}
