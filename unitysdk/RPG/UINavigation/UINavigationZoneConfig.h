...
#define RPG_UINAVIGATION_UINAVIGATIONZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51F0B0)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationZoneConfig_TypeDefinitionIndex = 52031;
