...
#define RPG_UINAVIGATION_UINAVIGATIONZONECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB882920)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationZoneConfig_TypeDefinitionIndex = 47799;
