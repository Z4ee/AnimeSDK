...
#define RPG_UINAVIGATION_UINAVIGATIONAREACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB877C40)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationAreaConfig_TypeDefinitionIndex = 47798;
