...
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0x1B517CE0)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_GET_NAVIGATIONAREA_OFFSET UNITYSDK_OFFSET(0x1B5163B0)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_METHOD_5_1554A5A4DE9C7FA9_OFFSET UNITYSDK_OFFSET(0x1B517D60)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B516240)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5160C0)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_POSTONCHILDDESELECTED_OFFSET UNITYSDK_OFFSET(0x1B517C90)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_POSTONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0x1B517C40)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION_POSTONNAVIGATION_OFFSET UNITYSDK_OFFSET(0x1B517BF0)
#define RPG_UINAVIGATION_UINAVIGATIONEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B517BE0)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationExtension_TypeDefinitionIndex = 52032;

	class UINavigationExtension : public ::UnityEngine::MonoBehaviour
	{
	public:
		::RPG::UINavigation::UINavigationArea* AIGJIOJMHMB; // 0x18
