...
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0x1B516290)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_12A10FF739C8C066_OFFSET UNITYSDK_OFFSET(0x1B5165E0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_2BF2BE327F577697_OFFSET UNITYSDK_OFFSET(0x1B516490)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_5CE279A17BFB4762_OFFSET UNITYSDK_OFFSET(0x1B515A60)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_6E37671A3C35FC0E_OFFSET UNITYSDK_OFFSET(0x1B517090)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_93F5C564DEBFDC7B_OFFSET UNITYSDK_OFFSET(0x1B517950)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_AD0064E4659DB694_OFFSET UNITYSDK_OFFSET(0x1B516B10)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_METHOD_6_E23C97CEA99B7CE1_OFFSET UNITYSDK_OFFSET(0x1B515B10)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B516110)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B515DF0)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION_POSTONCHILDSELECTED_OFFSET UNITYSDK_OFFSET(0x1B516F30)
#define RPG_UINAVIGATION_UINAVIGATIONCHATEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B517BD0)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationChatExtension_TypeDefinitionIndex = 52018;
	...
	public:
		...
		::UnityEngine::RectTransform* AFMADGMODAL; // 0x28
