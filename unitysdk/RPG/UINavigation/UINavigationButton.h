...
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ADDCUSTOMINCONTROLACTION_OFFSET UNITYSDK_OFFSET(0x1B514BD0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ADDINCONTROLACTION_OFFSET UNITYSDK_OFFSET(0x1B515030)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ADDSELECTIONCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B514F10)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ADD__ONSELECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B513F10)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B513FF0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_CLEARACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0x1B515400)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_CLEARCUSTOMINCONTROLACTIONS_OFFSET UNITYSDK_OFFSET(0x1B514D80)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_GETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0x1B5153B0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_GETCONTROLACTIONS_OFFSET UNITYSDK_OFFSET(0x1B515460)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0x1B514B50)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_GET_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1B513EC0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_GET_SELECTABLE_OFFSET UNITYSDK_OFFSET(0x1B513DE0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ISNAVIGABLE_OFFSET UNITYSDK_OFFSET(0x1B5144C0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1B514770)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ONMOVE_OFFSET UNITYSDK_OFFSET(0x1B514240)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ONNAVIGATION_OFFSET UNITYSDK_OFFSET(0x1B514830)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1B514320)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_ONSUBMIT_OFFSET UNITYSDK_OFFSET(0x1B5142B0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_REMOVECUSTOMINCONTROLACTION_OFFSET UNITYSDK_OFFSET(0x1B514CD0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_REMOVEINCONTROLACTION_OFFSET UNITYSDK_OFFSET(0x1B515190)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_REMOVESELECTIONCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B514FA0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_REMOVE__ONSELECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B513F80)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_RESET_OFFSET UNITYSDK_OFFSET(0x1B5141B0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_SELECT_OFFSET UNITYSDK_OFFSET(0x1B5149F0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_SETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0x1B515280)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON_SETCLICKONSELECT_OFFSET UNITYSDK_OFFSET(0x1B514B00)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON__CLICKBUTTON_OFFSET UNITYSDK_OFFSET(0x1B5146B0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5159E0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON__ISBUTTONNAVIGABLE_OFFSET UNITYSDK_OFFSET(0x1B514910)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON__MARKZONESHOULDUPDATEINCONTROLHINTS_OFFSET UNITYSDK_OFFSET(0x1B5152E0)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON__SETSELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0x1B514520)
#define RPG_UINAVIGATION_UINAVIGATIONBUTTON__UPDATEACTIONHINTSTATUS_OFFSET UNITYSDK_OFFSET(0x1B5145A0)
