...
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ADDCUSTOMINCONTROLACTIONHINT_OFFSET UNITYSDK_OFFSET(0xE7FF930)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_AWAKE_OFFSET UNITYSDK_OFFSET(0xE7FE340)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_CANENTER_OFFSET UNITYSDK_OFFSET(0xE7FED30)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_CLEARCUSTOMINCONTROLACTIONHINTS_OFFSET UNITYSDK_OFFSET(0xE7FF8A0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_CLEARSELECTED_OFFSET UNITYSDK_OFFSET(0xE7F9A00)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ENTERONGAMEOBJECTSELECTED_OFFSET UNITYSDK_OFFSET(0xE7FF250)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ENTER_OFFSET UNITYSDK_OFFSET(0xE7FEF90)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_EXIT_OFFSET UNITYSDK_OFFSET(0xE7FE9B0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_GETINCONTROLACTIONHINTS_OFFSET UNITYSDK_OFFSET(0xE7FFAA0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0xE7F1120)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_GET_ALLNAVIGATIONZONES_OFFSET UNITYSDK_OFFSET(0xE7F1BC0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_GET_INCONTROLACTIONS_OFFSET UNITYSDK_OFFSET(0xE7FE1A0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_GET_SELECTED_OFFSET UNITYSDK_OFFSET(0xE7F99C0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_GET_ZONEMANAGER_OFFSET UNITYSDK_OFFSET(0xE7F1080)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ISMANAGERFOCUSED_OFFSET UNITYSDK_OFFSET(0xE7FB7F0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ISTOPZONE_OFFSET UNITYSDK_OFFSET(0xE7F08E0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xE7FEB80)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_MARKSHOULDREBUILDINCONTROLACTION_OFFSET UNITYSDK_OFFSET(0xE7F1C20)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_MARKSHOULDUPDATEINCONTROLHINT_OFFSET UNITYSDK_OFFSET(0xE7F7820)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xE7FE570)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE7FE810)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xE7FE680)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xE7FEA30)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_ONZONEREMOVED_OFFSET UNITYSDK_OFFSET(0xE7FF6A0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_SAVESELECTED_OFFSET UNITYSDK_OFFSET(0xE7FF650)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_SETUPINCONTROLACTIONHINTS_OFFSET UNITYSDK_OFFSET(0xE7FF710)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0xE7FE040)
#define RPG_UINAVIGATION_UINAVIGATIONZONE_SHOWRETURNACTIONHINT_OFFSET UNITYSDK_OFFSET(0xE7FFA20)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__APPENDHINTS_OFFSET UNITYSDK_OFFSET(0xE800190)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__APPENDHINT_OFFSET UNITYSDK_OFFSET(0xE8008F0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__APPENDSORTEDACTIONHINTS_OFFSET UNITYSDK_OFFSET(0xE8002C0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__BINDINCONTROLBUTTON_OFFSET UNITYSDK_OFFSET(0xE7FE440)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__CCTOR_OFFSET UNITYSDK_OFFSET(0xE800F40)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__CHECKSELECTIONINCONTROLHINTS_OFFSET UNITYSDK_OFFSET(0xE7FF340)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__CLASSIFYSHORTCUT_OFFSET UNITYSDK_OFFSET(0xE8009F0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xE800E40)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__ENTERWITHOUTSELECTION_OFFSET UNITYSDK_OFFSET(0xE7FF1F0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__GETENTERINCONTROLBUTTON_OFFSET UNITYSDK_OFFSET(0xE800BD0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__GETFIRSTSELECTABLE_OFFSET UNITYSDK_OFFSET(0xE7FF120)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__GETSELECTEDNAVIGATIONBUTTON_OFFSET UNITYSDK_OFFSET(0xE800660)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__HANDLEENTEREXITONACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0xE800D40)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__HASVALIDSELECTED_OFFSET UNITYSDK_OFFSET(0xE7FF0D0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__ISINPUTDEVICEMATCH_OFFSET UNITYSDK_OFFSET(0xE7FEF10)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__ISOWNERFOCUSED_OFFSET UNITYSDK_OFFSET(0xE7FE2C0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__MARKSHOULDUPDATENAVIGATIONZONE_OFFSET UNITYSDK_OFFSET(0xE800C90)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__ONACTIVECHANGED_OFFSET UNITYSDK_OFFSET(0xE7FE0D0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__REBUILDALLACTIONHINTS_OFFSET UNITYSDK_OFFSET(0xE7FFB40)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__REBUILDINCONTROLACTIONS_OFFSET UNITYSDK_OFFSET(0xE7FFD30)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__REFRESHINCONTROLACTIONHINT_OFFSET UNITYSDK_OFFSET(0xE7FEC40)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__TRYAPPENDBUTTONSUBMITFALLBACK_OFFSET UNITYSDK_OFFSET(0xE8006D0)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__TRYAPPENDRETURNFALLBACK_OFFSET UNITYSDK_OFFSET(0xE800820)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__TRYENTERONENABLE_OFFSET UNITYSDK_OFFSET(0xE7FE790)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__TRYREBUILDINCONTROLACTIONS_OFFSET UNITYSDK_OFFSET(0xE7FE220)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__TRYUPDATEZONEMANAGER_OFFSET UNITYSDK_OFFSET(0xE7FE130)
#define RPG_UINAVIGATION_UINAVIGATIONZONE__UNBINDINCONTROLBUTTON_OFFSET UNITYSDK_OFFSET(0xE7FE5C0)
...
namespace RPG::UINavigation
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::RPG::UINavigation::UINavigationZone*>**)Il2CppClass::FromTypeDefinitionIndex(UINavigationZone_TypeDefinitionIndex)->GetStaticField(0x26FA0);
		}
