...
#define RPG_UINAVIGATION_UINAVIGATIONAREA_FIRSTSELECTABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B513DA0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_FIRSTSELECTABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B513DD0)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_FIRSTSELECTABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B511740)
#define RPG_UINAVIGATION_UINAVIGATIONAREA_FIRSTSELECTABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B513D30)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationArea_FirstSelectableDelegate_TypeDefinitionIndex = 52024;
