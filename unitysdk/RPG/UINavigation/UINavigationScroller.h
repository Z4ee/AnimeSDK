...
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xCFC7E10)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_GETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0xCFC83A0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xCFC8070)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCFC8000)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_ONINCONTROLACTIONSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xCFC8460)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xCFC81D0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER_SHOULDSHOWINCONTROLACTIONHINT_OFFSET UNITYSDK_OFFSET(0xCFC8280)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__CHECKCANSCROLL_OFFSET UNITYSDK_OFFSET(0xCFC8330)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFC84C0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__GETLAYOUTGROUPRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCFC7F60)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER__REFRESHSCROLLSTATUS_OFFSET UNITYSDK_OFFSET(0xCFC80C0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER___IFIXBASEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xCFC8530)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER___IFIXBASEPROXY_GETACTIONHINTNAME_OFFSET UNITYSDK_OFFSET(0xCFC85D0)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCFC8580)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER___IFIXBASEPROXY_ONINCONTROLACTIONSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0xCFC8620)
#define RPG_UINAVIGATION_UINAVIGATIONSCROLLER___IFIXBASEPROXY_SHOULDSHOWINCONTROLACTIONHINT_OFFSET UNITYSDK_OFFSET(0xCFC8590)

namespace RPG::UINavigation
{
	inline static constexpr unsigned int UINavigationScroller_TypeDefinitionIndex = 48417;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Boolean))((::PBYTE)hIl2Cpp + RPG_UINAVIGATION_UINAVIGATIONSCROLLER___IFIXBASEPROXY_ONINCONTROLACTIONSTATUSCHANGE_OFFSET))(this, a1);
		}
	};
}
