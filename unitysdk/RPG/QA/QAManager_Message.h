...
#define RPG_QA_QAMANAGER_MESSAGE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x88FA0)
#define RPG_QA_QAMANAGER_MESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x88F80)
#define RPG_QA_QAMANAGER_MESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x88F60)

namespace RPG::QA
{
	inline static constexpr unsigned int QAManager_Message_TypeDefinitionIndex = 41856;
