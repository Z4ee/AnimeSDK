...
#define RPG_QA_PROFILERSOCKETSENDER_COMMONSOCKETCLOSE_OFFSET UNITYSDK_OFFSET(0x19D45830)
#define RPG_QA_PROFILERSOCKETSENDER_COMMONSOCKETCONNECT_OFFSET UNITYSDK_OFFSET(0x19D454A0)
#define RPG_QA_PROFILERSOCKETSENDER_COMMONSOCKETSENDSTR_OFFSET UNITYSDK_OFFSET(0x19D45690)
#define RPG_QA_PROFILERSOCKETSENDER_CONNECT_OFFSET UNITYSDK_OFFSET(0x19D44D00)
#define RPG_QA_PROFILERSOCKETSENDER_SENDAUTOSAVEPATH_OFFSET UNITYSDK_OFFSET(0x19D45400)
#define RPG_QA_PROFILERSOCKETSENDER_SENDEND_OFFSET UNITYSDK_OFFSET(0x19D45380)
#define RPG_QA_PROFILERSOCKETSENDER_SENDFILTEREDRECORD_OFFSET UNITYSDK_OFFSET(0x19D45310)
#define RPG_QA_PROFILERSOCKETSENDER_SENDRECORDDIFF_OFFSET UNITYSDK_OFFSET(0x19D45280)
#define RPG_QA_PROFILERSOCKETSENDER_SENDRECORD_OFFSET UNITYSDK_OFFSET(0x19D44F80)
#define RPG_QA_PROFILERSOCKETSENDER_SEND_OFFSET UNITYSDK_OFFSET(0x19D45140)
#define RPG_QA_PROFILERSOCKETSENDER_SETCONFIGTITLE_OFFSET UNITYSDK_OFFSET(0x19D45450)
#define RPG_QA_PROFILERSOCKETSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D45870)

namespace RPG::QA
{
	inline static constexpr unsigned int ProfilerSocketSender_TypeDefinitionIndex = 49457;
	...
	public:
		...
		{
			return (::System::Net::Sockets::Socket**)Il2CppClass::FromTypeDefinitionIndex(ProfilerSocketSender_TypeDefinitionIndex)->GetStaticField(0x6B070);
		}
