...
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_ENCODEQUERY_OFFSET UNITYSDK_OFFSET(0x19D48BE0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_ENCODEREPLY_OFFSET UNITYSDK_OFFSET(0x19D48CB0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_ENCODE_OFFSET UNITYSDK_OFFSET(0x19D488E0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_READINT32LE_OFFSET UNITYSDK_OFFSET(0x19D48B30)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_READLENPREFIXEDSTRING_OFFSET UNITYSDK_OFFSET(0x19D49B50)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_READUINT16LE_OFFSET UNITYSDK_OFFSET(0x19D48BA0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_TRYDECODEHEADER_OFFSET UNITYSDK_OFFSET(0x19D494F0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_TRYDECODEREPLY_OFFSET UNITYSDK_OFFSET(0x19D49580)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_TRYDECODE_OFFSET UNITYSDK_OFFSET(0x19D48A30)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITEINT32LE_OFFSET UNITYSDK_OFFSET(0x19D48990)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITELENPREFIXEDSTRING_OFFSET UNITYSDK_OFFSET(0x19D492D0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITEUINT16LE_OFFSET UNITYSDK_OFFSET(0x19D489F0)
#define RPG_QA_REMOTEDEBUG_REMOTEDEBUGFRAMECODEC_WRITEUINT32LE_OFFSET UNITYSDK_OFFSET(0x19D48C50)

namespace RPG::QA::RemoteDebug
{
	inline static constexpr unsigned int RemoteDebugFrameCodec_TypeDefinitionIndex = 49471;
