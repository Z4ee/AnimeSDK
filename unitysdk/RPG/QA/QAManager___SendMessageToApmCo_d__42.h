...
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A377E60)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A378E10)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A378E70)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A378E20)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A377E50)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x1A377CF0)
