...
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xCFB8270)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCFB91B0)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xCFB9210)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xCFB91C0)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xCFB8260)
#define RPG_QA_QAMANAGER___SENDMESSAGETOAPMCO_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0xCFB8100)

namespace RPG::QA
{
	inline static constexpr unsigned int QAManager___SendMessageToApmCo_d__42_TypeDefinitionIndex = 48449;
