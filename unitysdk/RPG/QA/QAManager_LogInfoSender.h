...
#define RPG_QA_QAMANAGER_LOGINFOSENDER_SENDLOG_OFFSET UNITYSDK_OFFSET(0xAB01C90)
#define RPG_QA_QAMANAGER_LOGINFOSENDER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB014D0)

namespace RPG::QA
{
	inline static constexpr unsigned int QAManager_LogInfoSender_TypeDefinitionIndex = 41855;
