...
#define RPG_QA_PROFILEPIPELINE_RPGLUAPROFILER_FRAMESAMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A374A00)

namespace RPG::QA::ProfilePipeline::RPGLuaProfiler
{
	inline static constexpr unsigned int FrameSample_TypeDefinitionIndex = 52122;
