...
#define RPG_QA_PROFILEPIPELINE_RPGLUAPROFILER_SESSION__CTOR_OFFSET UNITYSDK_OFFSET(0xCFB5350)

namespace RPG::QA::ProfilePipeline::RPGLuaProfiler
{
	inline static constexpr unsigned int Session_TypeDefinitionIndex = 48458;
