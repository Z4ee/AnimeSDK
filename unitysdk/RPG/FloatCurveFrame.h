...
#define RPG_FLOATCURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x20F6AD0)
#define RPG_FLOATCURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xCC60)
#define RPG_FLOATCURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0xCC80)
