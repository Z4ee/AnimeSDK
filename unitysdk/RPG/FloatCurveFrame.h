...
#define RPG_FLOATCURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x22C8E60)
...
#define RPG_FLOATCURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x2A140)

namespace RPG
{
	inline static constexpr unsigned int FloatCurveFrame_TypeDefinitionIndex = 8848;
