...
#define RPG_FLOATCURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3A53AB0)
#define RPG_FLOATCURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0x213E0)
#define RPG_FLOATCURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0x784700)
#define RPG_FLOATCURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9800)

namespace RPG
{
	inline static constexpr unsigned int FloatCurveFrame_TypeDefinitionIndex = 6329;
