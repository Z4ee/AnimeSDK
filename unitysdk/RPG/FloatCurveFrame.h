...
#define RPG_FLOATCURVEFRAME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x3B98C10)
#define RPG_FLOATCURVEFRAME_GETTIME_OFFSET UNITYSDK_OFFSET(0xD4B0)
#define RPG_FLOATCURVEFRAME_GETVALUE_OFFSET UNITYSDK_OFFSET(0xD4D0)
#define RPG_FLOATCURVEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x2F440)
