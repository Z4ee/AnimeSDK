...
#define RPG_HASHUTILS_THREADFILESTREAM_READ_OFFSET UNITYSDK_OFFSET(0x163BC4A0)
#define RPG_HASHUTILS_THREADFILESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x163BB3D0)

namespace RPG
{
	inline static constexpr unsigned int HashUtils_ThreadFileStream_TypeDefinitionIndex = 6364;

	class HashUtils_ThreadFileStream : public ::System::IO::FileStream
	{
	public:
		::System::Int32 _SleepFreq; // 0x68
		::System::Int32 _ReadCount; // 0x6C
