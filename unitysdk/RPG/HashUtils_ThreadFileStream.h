...
#define RPG_HASHUTILS_THREADFILESTREAM_READ_OFFSET UNITYSDK_OFFSET(0x19F6FE50)
#define RPG_HASHUTILS_THREADFILESTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6EC60)

namespace RPG
{
	inline static constexpr unsigned int HashUtils_ThreadFileStream_TypeDefinitionIndex = 6747;
