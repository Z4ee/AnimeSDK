...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSTAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB19680)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2SolverStage_TypeDefinitionIndex = 35232;
	...
	public:
		...
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2AtomicInt completionCount; // 0x28
