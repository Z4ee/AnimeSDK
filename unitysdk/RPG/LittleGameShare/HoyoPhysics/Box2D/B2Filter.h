...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF990)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Filter_TypeDefinitionIndex = 35119;
