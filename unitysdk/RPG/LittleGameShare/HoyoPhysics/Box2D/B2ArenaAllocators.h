...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2CREATEARENAALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1C2A9980)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2DESTROYARENAALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1C2A99F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GETARENAALLOCATION_OFFSET UNITYSDK_OFFSET(0x1C2AA230)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GETARENACAPACITY_OFFSET UNITYSDK_OFFSET(0x1C2A9F70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GETMAXARENAALLOCATION_OFFSET UNITYSDK_OFFSET(0x1C2AA4F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ARENAALLOCATORS_B2GROWARENA_OFFSET UNITYSDK_OFFSET(0x1C2A9CB0)
