...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x676D90)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Segment_TypeDefinitionIndex = 35197;
