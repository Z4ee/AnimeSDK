...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2OVERLAPRESULTFCN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB339F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2OVERLAPRESULTFCN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33A70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2OVERLAPRESULTFCN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB2F170)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2OVERLAPRESULTFCN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB33980)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2OverlapResultFcn_TypeDefinitionIndex = 35101;
