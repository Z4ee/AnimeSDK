...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2COLLISIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2BAA00)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2SimplexCache*)Il2CppClass::FromTypeDefinitionIndex(B2Collisions_TypeDefinitionIndex)->GetStaticField(0xB810);
		}
