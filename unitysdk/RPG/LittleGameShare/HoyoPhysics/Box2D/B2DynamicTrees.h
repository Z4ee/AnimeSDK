...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ALLOCATENODE_OFFSET UNITYSDK_OFFSET(0xB637390)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2BUILDTREE_OFFSET UNITYSDK_OFFSET(0xB63B790)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_CREATEPROXY_OFFSET UNITYSDK_OFFSET(0xB605840)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_CREATE_OFFSET UNITYSDK_OFFSET(0xB605060)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_DESTROYPROXY_OFFSET UNITYSDK_OFFSET(0xB605A20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_DESTROY_OFFSET UNITYSDK_OFFSET(0xB605430)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_ENLARGEPROXY_OFFSET UNITYSDK_OFFSET(0xB605DF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETAABB_OFFSET UNITYSDK_OFFSET(0xB639DE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETAREARATIO_OFFSET UNITYSDK_OFFSET(0xB639B40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETBYTECOUNT_OFFSET UNITYSDK_OFFSET(0xB639D90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETCATEGORYBITS_OFFSET UNITYSDK_OFFSET(0xB639AB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETHEIGHT_OFFSET UNITYSDK_OFFSET(0xB639AF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETPROXYCOUNT_OFFSET UNITYSDK_OFFSET(0xB6399F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETROOTBOUNDS_OFFSET UNITYSDK_OFFSET(0xB639CE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_GETUSERDATA_OFFSET UNITYSDK_OFFSET(0xB639DA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0xB605C20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_REBUILD_OFFSET UNITYSDK_OFFSET(0xB607D70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_SETCATEGORYBITS_OFFSET UNITYSDK_OFFSET(0xB639A10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_VALIDATENOENLARGED_OFFSET UNITYSDK_OFFSET(0xB639D80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2DYNAMICTREE_VALIDATE_OFFSET UNITYSDK_OFFSET(0xB608350)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2FINDBESTSIBLING_OFFSET UNITYSDK_OFFSET(0xB6375B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2FREENODE_OFFSET UNITYSDK_OFFSET(0xB637550)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2INSERTLEAF_OFFSET UNITYSDK_OFFSET(0xB639140)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ISALLOCATED_OFFSET UNITYSDK_OFFSET(0xB637370)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ISLEAF_OFFSET UNITYSDK_OFFSET(0xB637360)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2MAXUINT16_OFFSET UNITYSDK_OFFSET(0xB637380)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2PARTITIONMID_OFFSET UNITYSDK_OFFSET(0xB639E20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2PARTITIONSAH_OFFSET UNITYSDK_OFFSET(0xB63A590)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2REMOVELEAF_OFFSET UNITYSDK_OFFSET(0xB639680)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES_B2ROTATENODES_OFFSET UNITYSDK_OFFSET(0xB637E30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DYNAMICTREES__CCTOR_OFFSET UNITYSDK_OFFSET(0xB63C7A0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2DynamicTrees_TypeDefinitionIndex = 35116;
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2TreeNode*)Il2CppClass::FromTypeDefinitionIndex(B2DynamicTrees_TypeDefinitionIndex)->GetStaticField(0xF5D0);
		}
