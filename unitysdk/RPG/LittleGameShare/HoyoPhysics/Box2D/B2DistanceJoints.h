...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ENABLELIMIT_OFFSET UNITYSDK_OFFSET(0xB62E310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ENABLEMOTOR_OFFSET UNITYSDK_OFFSET(0xB62EB80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ENABLESPRING_OFFSET UNITYSDK_OFFSET(0xB62E980)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETCURRENTLENGTH_OFFSET UNITYSDK_OFFSET(0xB62E770)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETLENGTH_OFFSET UNITYSDK_OFFSET(0xB62E2C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMAXLENGTH_OFFSET UNITYSDK_OFFSET(0xB62E720)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMAXMOTORFORCE_OFFSET UNITYSDK_OFFSET(0xB62EDA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMINLENGTH_OFFSET UNITYSDK_OFFSET(0xB62E6D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMOTORFORCE_OFFSET UNITYSDK_OFFSET(0xB62ECE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETMOTORSPEED_OFFSET UNITYSDK_OFFSET(0xB62EC90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETSPRINGDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0xB62EB30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_GETSPRINGHERTZ_OFFSET UNITYSDK_OFFSET(0xB62EAE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ISLIMITENABLED_OFFSET UNITYSDK_OFFSET(0xB62E360)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ISMOTORENABLED_OFFSET UNITYSDK_OFFSET(0xB62EBE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_ISSPRINGENABLED_OFFSET UNITYSDK_OFFSET(0xB62E9D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETLENGTHRANGE_OFFSET UNITYSDK_OFFSET(0xB62E3B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETLENGTH_OFFSET UNITYSDK_OFFSET(0xB62E060)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETMAXMOTORFORCE_OFFSET UNITYSDK_OFFSET(0xB62ED40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETMOTORSPEED_OFFSET UNITYSDK_OFFSET(0xB62EC30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETSPRINGDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0xB62EA80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2DISTANCEJOINT_SETSPRINGHERTZ_OFFSET UNITYSDK_OFFSET(0xB62EA20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2GETDISTANCEJOINTFORCE_OFFSET UNITYSDK_OFFSET(0xB62EDF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2PREPAREDISTANCEJOINT_OFFSET UNITYSDK_OFFSET(0xB62F010)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2SOLVEDISTANCEJOINT_OFFSET UNITYSDK_OFFSET(0xB62F950)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCEJOINTS_B2WARMSTARTDISTANCEJOINT_OFFSET UNITYSDK_OFFSET(0xB62F4E0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2DistanceJoints_TypeDefinitionIndex = 35112;
