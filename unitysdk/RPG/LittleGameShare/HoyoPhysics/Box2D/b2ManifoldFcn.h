...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDFCN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33840)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDFCN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33910)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDFCN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB337D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDFCN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB336E0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2ManifoldFcn_TypeDefinitionIndex = 35104;
