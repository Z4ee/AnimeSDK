...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2CLEARBIT_OFFSET UNITYSDK_OFFSET(0xB603F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2COUNTSETBITS_OFFSET UNITYSDK_OFFSET(0xB6042E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2CREATEBITSET_1_OFFSET UNITYSDK_OFFSET(0xB6040A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2CREATEBITSET_OFFSET UNITYSDK_OFFSET(0xB604020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2DESTROYBITSET_OFFSET UNITYSDK_OFFSET(0xB604160)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2GETBITSETBYTES_OFFSET UNITYSDK_OFFSET(0xB604010)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2GETBIT_OFFSET UNITYSDK_OFFSET(0xB603FC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2GROWBITSET_OFFSET UNITYSDK_OFFSET(0xB603E10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2INPLACEUNION_OFFSET UNITYSDK_OFFSET(0xB6043D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2SETBITCOUNTANDCLEAR_OFFSET UNITYSDK_OFFSET(0xB6041B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2SETBITGROW_OFFSET UNITYSDK_OFFSET(0xB603DB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2SETBIT_OFFSET UNITYSDK_OFFSET(0xB603D70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS__CUSTOMFILL_OFFSET UNITYSDK_OFFSET(0xB604110)
