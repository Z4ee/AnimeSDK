...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2CLEARBIT_OFFSET UNITYSDK_OFFSET(0x1C2AAA20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2COUNTSETBITS_OFFSET UNITYSDK_OFFSET(0x1C2AAD80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2CREATEBITSET_1_OFFSET UNITYSDK_OFFSET(0x1C2AAB40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2CREATEBITSET_OFFSET UNITYSDK_OFFSET(0x1C2AAAC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2DESTROYBITSET_OFFSET UNITYSDK_OFFSET(0x1C2AAC00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2GETBITSETBYTES_OFFSET UNITYSDK_OFFSET(0x1C2AAAB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2GETBIT_OFFSET UNITYSDK_OFFSET(0x1C2AAA60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2GROWBITSET_OFFSET UNITYSDK_OFFSET(0x1C2AA8B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2INPLACEUNION_OFFSET UNITYSDK_OFFSET(0x1C2AAE70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2SETBITCOUNTANDCLEAR_OFFSET UNITYSDK_OFFSET(0x1C2AAC50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2SETBITGROW_OFFSET UNITYSDK_OFFSET(0x1C2AA850)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS_B2SETBIT_OFFSET UNITYSDK_OFFSET(0x1C2AA810)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BITSETS__CUSTOMFILL_OFFSET UNITYSDK_OFFSET(0x1C2AABB0)
