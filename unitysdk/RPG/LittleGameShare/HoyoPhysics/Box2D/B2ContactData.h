...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF490)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2ContactData_TypeDefinitionIndex = 35074;
