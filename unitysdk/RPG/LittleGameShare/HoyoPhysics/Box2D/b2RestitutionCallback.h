...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RESTITUTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33E00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RESTITUTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33EB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RESTITUTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33DD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2RESTITUTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB33D60)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2RestitutionCallback_TypeDefinitionIndex = 35098;
