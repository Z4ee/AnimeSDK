...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2ADDTYPE_OFFSET UNITYSDK_OFFSET(0xB62C950)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CAPSULEANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB621BF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB622280)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CHAINSEGMENTANDCAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB629020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CHAINSEGMENTANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB628870)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CHAINSEGMENTANDPOLYGONMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB6292B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB621650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2COMPUTEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB62DB00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CONTACT_GETDATA_OFFSET UNITYSDK_OFFSET(0xB62DCE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2CREATECONTACT_OFFSET UNITYSDK_OFFSET(0xB606FA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2DESTROYCONTACT_OFFSET UNITYSDK_OFFSET(0xB608E80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2GETCONTACTFULLID_OFFSET UNITYSDK_OFFSET(0xB62DCB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2GETCONTACTSIM_OFFSET UNITYSDK_OFFSET(0xB60B9A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2INITIALIZECONTACTREGISTERS_OFFSET UNITYSDK_OFFSET(0xB620EF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2POLYGONANDCAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB625880)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2POLYGONANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB624750)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2POLYGONMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB625AF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2SEGMENTANDCAPSULEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB628480)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2SEGMENTANDCIRCLEMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB628300)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2SEGMENTANDPOLYGONMANIFOLD_OFFSET UNITYSDK_OFFSET(0xB628600)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS_B2UPDATECONTACT_OFFSET UNITYSDK_OFFSET(0xB62CC00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONTACTS__CCTOR_OFFSET UNITYSDK_OFFSET(0xB620E90)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Contacts_TypeDefinitionIndex = 35085;
	...
	public:
		...
		{
			return (::Il2CppArray<::RPG::LittleGameShare::HoyoPhysics::Box2D::B2ContactRegister>**)Il2CppClass::FromTypeDefinitionIndex(B2Contacts_TypeDefinitionIndex)->GetStaticField(0x5A5F0);
		}
		static ::System::Boolean* StaticGet_s_initialized()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(B2Contacts_TypeDefinitionIndex)->GetStaticField(0xF550);
		}
