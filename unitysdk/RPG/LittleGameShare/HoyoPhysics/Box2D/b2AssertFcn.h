...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ASSERTFCN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB32EE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ASSERTFCN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB32F50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ASSERTFCN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB32EC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ASSERTFCN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB32E40)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2AssertFcn_TypeDefinitionIndex = 35093;
