...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2CREATESOLVERSET_OFFSET UNITYSDK_OFFSET(0x1C3085F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2DESTROYSOLVERSET_OFFSET UNITYSDK_OFFSET(0x1C308660)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2MERGESOLVERSETS_OFFSET UNITYSDK_OFFSET(0x1C30AD90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRANSFERBODY_OFFSET UNITYSDK_OFFSET(0x1C30B640)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRANSFERJOINT_OFFSET UNITYSDK_OFFSET(0x1C30BA60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRYSLEEPISLAND_OFFSET UNITYSDK_OFFSET(0x1C3096E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2WAKESOLVERSET_OFFSET UNITYSDK_OFFSET(0x1C308910)
