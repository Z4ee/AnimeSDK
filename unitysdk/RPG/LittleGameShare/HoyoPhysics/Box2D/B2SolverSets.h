...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2CREATESOLVERSET_OFFSET UNITYSDK_OFFSET(0x1C77C370)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2DESTROYSOLVERSET_OFFSET UNITYSDK_OFFSET(0x1C77C3E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2MERGESOLVERSETS_OFFSET UNITYSDK_OFFSET(0x1C77EB40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRANSFERBODY_OFFSET UNITYSDK_OFFSET(0x1C77F420)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRANSFERJOINT_OFFSET UNITYSDK_OFFSET(0x1C77F850)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2TRYSLEEPISLAND_OFFSET UNITYSDK_OFFSET(0x1C77D470)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERSETS_B2WAKESOLVERSET_OFFSET UNITYSDK_OFFSET(0x1C77C690)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2SolverSets_TypeDefinitionIndex = 36092;
