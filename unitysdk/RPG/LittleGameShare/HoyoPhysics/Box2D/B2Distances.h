...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2COMPUTESIMPLEXWITNESSPOINTS_OFFSET UNITYSDK_OFFSET(0xB632410)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2EVALUATESEPARATION_OFFSET UNITYSDK_OFFSET(0xB635FF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2FINDMINSEPARATION_OFFSET UNITYSDK_OFFSET(0xB635890)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2FINDSUPPORT_OFFSET UNITYSDK_OFFSET(0xB631810)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2GETSWEEPTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB6306A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEOFFSETPROXY_OFFSET UNITYSDK_OFFSET(0xB631050)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_1_OFFSET UNITYSDK_OFFSET(0xB631330)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_2_OFFSET UNITYSDK_OFFSET(0xB631530)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_OFFSET UNITYSDK_OFFSET(0xB630C90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESEPARATIONFUNCTION_OFFSET UNITYSDK_OFFSET(0xB634B90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESIMPLEXCACHE_OFFSET UNITYSDK_OFFSET(0xB632120)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESIMPLEXFROMCACHE_OFFSET UNITYSDK_OFFSET(0xB631BD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SEGMENTDISTANCE_OFFSET UNITYSDK_OFFSET(0xB630820)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SHAPECAST_OFFSET UNITYSDK_OFFSET(0xB634650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SHAPEDISTANCE_OFFSET UNITYSDK_OFFSET(0xB632E40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SOLVESIMPLEX2_OFFSET UNITYSDK_OFFSET(0xB632570)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SOLVESIMPLEX3_OFFSET UNITYSDK_OFFSET(0xB632800)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2TIMEOFIMPACT_OFFSET UNITYSDK_OFFSET(0xB636610)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2TRANSFORMPROXY_OFFSET UNITYSDK_OFFSET(0xB630E70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2WEIGHT2_OFFSET UNITYSDK_OFFSET(0xB631740)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2WEIGHT3_OFFSET UNITYSDK_OFFSET(0xB631790)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Distances_TypeDefinitionIndex = 35114;
