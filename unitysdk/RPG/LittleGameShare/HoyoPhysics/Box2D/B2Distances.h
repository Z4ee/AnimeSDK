...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2COMPUTESIMPLEXWITNESSPOINTS_OFFSET UNITYSDK_OFFSET(0x1C2D8CA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2EVALUATESEPARATION_OFFSET UNITYSDK_OFFSET(0x1C2DC890)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2FINDMINSEPARATION_OFFSET UNITYSDK_OFFSET(0x1C2DC130)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2FINDSUPPORT_OFFSET UNITYSDK_OFFSET(0x1C2D8090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2GETSWEEPTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C2D6F20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEOFFSETPROXY_OFFSET UNITYSDK_OFFSET(0x1C2D78D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_1_OFFSET UNITYSDK_OFFSET(0x1C2D7BB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_2_OFFSET UNITYSDK_OFFSET(0x1C2D7DB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKEPROXY_OFFSET UNITYSDK_OFFSET(0x1C2D7510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESEPARATIONFUNCTION_OFFSET UNITYSDK_OFFSET(0x1C2DB430)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESIMPLEXCACHE_OFFSET UNITYSDK_OFFSET(0x1C2D89B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2MAKESIMPLEXFROMCACHE_OFFSET UNITYSDK_OFFSET(0x1C2D8450)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SEGMENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C2D70A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SHAPECAST_OFFSET UNITYSDK_OFFSET(0x1C2DAEF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SHAPEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C2D96D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SOLVESIMPLEX2_OFFSET UNITYSDK_OFFSET(0x1C2D8E00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2SOLVESIMPLEX3_OFFSET UNITYSDK_OFFSET(0x1C2D9090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2TIMEOFIMPACT_OFFSET UNITYSDK_OFFSET(0x1C2DCEB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2TRANSFORMPROXY_OFFSET UNITYSDK_OFFSET(0x1C2D76F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2WEIGHT2_OFFSET UNITYSDK_OFFSET(0x1C2D7FC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2DISTANCES_B2WEIGHT3_OFFSET UNITYSDK_OFFSET(0x1C2D8010)
