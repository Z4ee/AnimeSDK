...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2HULLS_B2COMPUTEHULL_OFFSET UNITYSDK_OFFSET(0xB643B90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2HULLS_B2RECURSEHULL_OFFSET UNITYSDK_OFFSET(0xB642F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2HULLS_B2VALIDATEHULL_OFFSET UNITYSDK_OFFSET(0xB645690)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Hulls_TypeDefinitionIndex = 35138;
