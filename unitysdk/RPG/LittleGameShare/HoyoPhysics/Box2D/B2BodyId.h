...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C2BA580)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1C2BA510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C2BA5F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1C2BA4A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYID__CTOR_OFFSET UNITYSDK_OFFSET(0x3B77160)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2BodyId_TypeDefinitionIndex = 35908;
