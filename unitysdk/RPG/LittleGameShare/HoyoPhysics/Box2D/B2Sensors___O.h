...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::b2TreeQueryCallbackFcn_1<::RPG::LittleGameShare::HoyoPhysics::Box2D::B2SensorQueryContext>**)Il2CppClass::FromTypeDefinitionIndex(B2Sensors___O_TypeDefinitionIndex)->GetStaticField(0x5DEC0);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::b2TaskCallback** StaticGet__1___b2SensorTask()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::b2TaskCallback**)Il2CppClass::FromTypeDefinitionIndex(B2Sensors___O_TypeDefinitionIndex)->GetStaticField(0x5DEC8);
		}
	};
}
