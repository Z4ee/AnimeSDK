...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHF_ATAN2_OFFSET UNITYSDK_OFFSET(0xC317610)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHF_COS_OFFSET UNITYSDK_OFFSET(0xC3175F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHF_SIN_OFFSET UNITYSDK_OFFSET(0xC3175D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHF_SQRT_OFFSET UNITYSDK_OFFSET(0xC3175B0)
