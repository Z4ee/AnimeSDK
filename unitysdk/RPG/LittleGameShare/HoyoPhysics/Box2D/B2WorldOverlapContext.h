...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDOVERLAPCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x3B78C30)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2WorldOverlapContext_TypeDefinitionIndex = 36131;
