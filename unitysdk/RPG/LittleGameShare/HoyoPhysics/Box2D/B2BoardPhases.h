...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_CREATEPROXY_OFFSET UNITYSDK_OFFSET(0xB6056F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_DESTROYPROXY_OFFSET UNITYSDK_OFFSET(0xB605920)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_ENLARGEPROXY_OFFSET UNITYSDK_OFFSET(0xB605CC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_GETSHAPEINDEX_OFFSET UNITYSDK_OFFSET(0xB608210)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_MOVEPROXY_OFFSET UNITYSDK_OFFSET(0xB605AF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_REBUILDTREES_OFFSET UNITYSDK_OFFSET(0xB607CD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BROADPHASE_TESTOVERLAP_OFFSET UNITYSDK_OFFSET(0xB607B20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2BUFFERMOVE_OFFSET UNITYSDK_OFFSET(0xB604510)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2CREATEBROADPHASE_OFFSET UNITYSDK_OFFSET(0xB6045A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2DESTROYBROADPHASE_OFFSET UNITYSDK_OFFSET(0xB605180)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2FINDPAIRSTASK_OFFSET UNITYSDK_OFFSET(0xB606630)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2PAIRQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0xB605F50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2UNBUFFERMOVE_OFFSET UNITYSDK_OFFSET(0xB605670)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2UPDATEBROADPHASEPAIRS_OFFSET UNITYSDK_OFFSET(0xB606AC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2VALIDATEBROADPHASE_OFFSET UNITYSDK_OFFSET(0xB6082C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2VALIDATENOENLARGED_OFFSET UNITYSDK_OFFSET(0xB608360)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2_PROXY_ID_OFFSET UNITYSDK_OFFSET(0xB6044F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2_PROXY_KEY_OFFSET UNITYSDK_OFFSET(0xB604500)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BOARDPHASES_B2_PROXY_TYPE_OFFSET UNITYSDK_OFFSET(0xB6044E0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2BoardPhases_TypeDefinitionIndex = 35040;
