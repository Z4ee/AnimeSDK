...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ADDCONTACTTOGRAPH_OFFSET UNITYSDK_OFFSET(0xC2D9890)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ADDJOINTTOGRAPH_OFFSET UNITYSDK_OFFSET(0xC2DAA20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ASSIGNJOINTCOLOR_OFFSET UNITYSDK_OFFSET(0xC2DA390)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0xC2D95E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2CREATEJOINTINGRAPH_OFFSET UNITYSDK_OFFSET(0xC2DA660)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2DESTROYGRAPH_OFFSET UNITYSDK_OFFSET(0xC2D9720)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2REMOVECONTACTFROMGRAPH_OFFSET UNITYSDK_OFFSET(0xC2DA210)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2REMOVEJOINTFROMGRAPH_OFFSET UNITYSDK_OFFSET(0xC2DAC80)
