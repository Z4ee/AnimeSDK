...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ADDCONTACTTOGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BADA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ADDJOINTTOGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BBF20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2ASSIGNJOINTCOLOR_OFFSET UNITYSDK_OFFSET(0x1C2BB890)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BAAF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2CREATEJOINTINGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BBB60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2DESTROYGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BAC30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2REMOVECONTACTFROMGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BB710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CONSTRAINTGRAPHS_B2REMOVEJOINTFROMGRAPH_OFFSET UNITYSDK_OFFSET(0x1C2BC190)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2ConstraintGraphs_TypeDefinitionIndex = 35929;
