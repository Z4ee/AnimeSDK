...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORBEGINTOUCHEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7B0780)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2SensorBeginTouchEvent_TypeDefinitionIndex = 35200;
