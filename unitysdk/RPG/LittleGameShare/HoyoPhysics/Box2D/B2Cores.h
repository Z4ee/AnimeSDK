...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2GETLENGTHUNITSPERMETER_OFFSET UNITYSDK_OFFSET(0xC2F3270)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2GETVERSION_OFFSET UNITYSDK_OFFSET(0xC2F31F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2SETLENGTHUNITSPERMETER_OFFSET UNITYSDK_OFFSET(0xC2F3210)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_10_OFFSET UNITYSDK_OFFSET(0xC2F3370)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_11_OFFSET UNITYSDK_OFFSET(0xC2F3380)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_1_OFFSET UNITYSDK_OFFSET(0xC2F32E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_2_OFFSET UNITYSDK_OFFSET(0xC2F32F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_3_OFFSET UNITYSDK_OFFSET(0xC2F3300)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_4_OFFSET UNITYSDK_OFFSET(0xC2F3310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_5_OFFSET UNITYSDK_OFFSET(0xC2F3320)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_6_OFFSET UNITYSDK_OFFSET(0xC2F3330)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_7_OFFSET UNITYSDK_OFFSET(0xC2F3340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_8_OFFSET UNITYSDK_OFFSET(0xC2F3350)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_9_OFFSET UNITYSDK_OFFSET(0xC2F3360)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES_B2_CHECK_DEF_OFFSET UNITYSDK_OFFSET(0xC2F32D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CORES__CCTOR_OFFSET UNITYSDK_OFFSET(0xC2F3390)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(B2Cores_TypeDefinitionIndex)->GetStaticField(0xB820);
		}
