...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SETITEM_CLEAR_OFFSET UNITYSDK_OFFSET(0x7B0860)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2SetItem_TypeDefinitionIndex = 35211;
