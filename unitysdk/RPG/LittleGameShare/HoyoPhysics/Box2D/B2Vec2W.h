...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2W__CTOR_OFFSET UNITYSDK_OFFSET(0x3A02E60)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Vec2W_TypeDefinitionIndex = 35256;
