...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_B2TRACYCZONEC_OFFSET UNITYSDK_OFFSET(0x1C2FCBE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_B2TRACYCZONEEND_OFFSET UNITYSDK_OFFSET(0x1C2FCC00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_B2TRACYCZONENC_OFFSET UNITYSDK_OFFSET(0x1C2FCBF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PROFILING_TRACYCFRAMEMARK_OFFSET UNITYSDK_OFFSET(0x1C2FCC10)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Profiling_TypeDefinitionIndex = 36045;
