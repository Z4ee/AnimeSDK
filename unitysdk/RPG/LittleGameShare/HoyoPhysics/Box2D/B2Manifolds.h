...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2CLASSIFYNORMAL_OFFSET UNITYSDK_OFFSET(0xB651DF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2CLIPPOLYGONS_OFFSET UNITYSDK_OFFSET(0xB650470)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2CLIPSEGMENTS_OFFSET UNITYSDK_OFFSET(0xB6517B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECAPSULEANDCIRCLE_OFFSET UNITYSDK_OFFSET(0xB621CB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECAPSULES_OFFSET UNITYSDK_OFFSET(0xB622340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECHAINSEGMENTANDCAPSULE_OFFSET UNITYSDK_OFFSET(0xB629180)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECHAINSEGMENTANDCIRCLE_OFFSET UNITYSDK_OFFSET(0xB628930)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECHAINSEGMENTANDPOLYGON_OFFSET UNITYSDK_OFFSET(0xB629380)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDECIRCLES_OFFSET UNITYSDK_OFFSET(0xB621710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDEPOLYGONANDCAPSULE_OFFSET UNITYSDK_OFFSET(0xB6259D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDEPOLYGONANDCIRCLE_OFFSET UNITYSDK_OFFSET(0xB624810)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDEPOLYGONS_OFFSET UNITYSDK_OFFSET(0xB625BB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDESEGMENTANDCAPSULE_OFFSET UNITYSDK_OFFSET(0xB628550)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDESEGMENTANDCIRCLE_OFFSET UNITYSDK_OFFSET(0xB6283D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2COLLIDESEGMENTANDPOLYGON_OFFSET UNITYSDK_OFFSET(0xB628750)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2FINDMAXSEPARATION_OFFSET UNITYSDK_OFFSET(0xB651170)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2MAKECAPSULE_OFFSET UNITYSDK_OFFSET(0xB6500C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MANIFOLDS_B2_MAKE_ID_OFFSET UNITYSDK_OFFSET(0xB6500B0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Manifolds_TypeDefinitionIndex = 35158;
