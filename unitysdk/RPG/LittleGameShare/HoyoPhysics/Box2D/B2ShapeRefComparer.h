...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SHAPEREFCOMPARER_COMPARE_OFFSET UNITYSDK_OFFSET(0xC31FC10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SHAPEREFCOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC31FC20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SHAPEREFCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0xC31FC00)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2ShapeRefComparer**)Il2CppClass::FromTypeDefinitionIndex(B2ShapeRefComparer_TypeDefinitionIndex)->GetStaticField(0x2A650);
		}
