...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTBODYDEF_OFFSET UNITYSDK_OFFSET(0x1AB22F20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTCHAINDEF_OFFSET UNITYSDK_OFFSET(0x1AB230D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTFILTER_OFFSET UNITYSDK_OFFSET(0x1AB23020)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTQUERYFILTER_OFFSET UNITYSDK_OFFSET(0x1AB23040)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTSHAPEDEF_OFFSET UNITYSDK_OFFSET(0x1AB23050)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTSURFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AB230B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTWORLDDEF_OFFSET UNITYSDK_OFFSET(0x1AB22E50)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Types_TypeDefinitionIndex = 35254;
