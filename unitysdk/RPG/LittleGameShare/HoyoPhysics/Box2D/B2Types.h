...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTBODYDEF_OFFSET UNITYSDK_OFFSET(0x1C789710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTCHAINDEF_OFFSET UNITYSDK_OFFSET(0x1C7898C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTFILTER_OFFSET UNITYSDK_OFFSET(0x1C789810)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTQUERYFILTER_OFFSET UNITYSDK_OFFSET(0x1C789830)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTSHAPEDEF_OFFSET UNITYSDK_OFFSET(0x1C789840)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTSURFACEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1C7898A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TYPES_B2DEFAULTWORLDDEF_OFFSET UNITYSDK_OFFSET(0x1C789640)
