...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2GETWELDJOINTFORCE_OFFSET UNITYSDK_OFFSET(0x1C316080)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2GETWELDJOINTTORQUE_OFFSET UNITYSDK_OFFSET(0x1C316120)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2PREPAREWELDJOINT_OFFSET UNITYSDK_OFFSET(0x1C316150)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2SOLVEWELDJOINT_OFFSET UNITYSDK_OFFSET(0x1C3169C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WARMSTARTWELDJOINT_OFFSET UNITYSDK_OFFSET(0x1C316650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETANGULARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1C316030)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETANGULARHERTZ_OFFSET UNITYSDK_OFFSET(0x1C315F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETLINEARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1C315ED0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_GETLINEARHERTZ_OFFSET UNITYSDK_OFFSET(0x1C315E20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETANGULARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1C315FD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETANGULARHERTZ_OFFSET UNITYSDK_OFFSET(0x1C315F20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETLINEARDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1C315E70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WELDJOINTS_B2WELDJOINT_SETLINEARHERTZ_OFFSET UNITYSDK_OFFSET(0x1C315DC0)
