...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2GETMOTORJOINTFORCE_OFFSET UNITYSDK_OFFSET(0xC30F7B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2GETMOTORJOINTTORQUE_OFFSET UNITYSDK_OFFSET(0xC30FC20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2MOTORJOINT_GETCORRECTIONFACTOR_OFFSET UNITYSDK_OFFSET(0xC319E00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2MOTORJOINT_GETMAXFORCE_OFFSET UNITYSDK_OFFSET(0xC319BE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2MOTORJOINT_GETMAXTORQUE_OFFSET UNITYSDK_OFFSET(0xC319CE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2MOTORJOINT_SETCORRECTIONFACTOR_OFFSET UNITYSDK_OFFSET(0xC319D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2MOTORJOINT_SETMAXFORCE_OFFSET UNITYSDK_OFFSET(0xC319B30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2MOTORJOINT_SETMAXTORQUE_OFFSET UNITYSDK_OFFSET(0xC319C30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2PREPAREMOTORJOINT_OFFSET UNITYSDK_OFFSET(0xC310A80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2SOLVEMOTORJOINT_OFFSET UNITYSDK_OFFSET(0xC312EC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOTORJOINTS_B2WARMSTARTMOTORJOINT_OFFSET UNITYSDK_OFFSET(0xC311F00)
