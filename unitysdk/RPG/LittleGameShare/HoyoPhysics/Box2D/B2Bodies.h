...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYANGULARIMPULSE_OFFSET UNITYSDK_OFFSET(0x1C2B5B50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYFORCETOCENTER_OFFSET UNITYSDK_OFFSET(0x1C2B5240)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYFORCE_OFFSET UNITYSDK_OFFSET(0x1C2B5060)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYLINEARIMPULSETOCENTER_OFFSET UNITYSDK_OFFSET(0x1C2B5870)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYLINEARIMPULSE_OFFSET UNITYSDK_OFFSET(0x1C2B5550)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYMASSFROMSHAPES_OFFSET UNITYSDK_OFFSET(0x1C2B79E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_APPLYTORQUE_OFFSET UNITYSDK_OFFSET(0x1C2B53F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_COMPUTEAABB_OFFSET UNITYSDK_OFFSET(0x1C2B2420)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_DISABLE_OFFSET UNITYSDK_OFFSET(0x1C2B91D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ENABLECONTACTEVENTS_OFFSET UNITYSDK_OFFSET(0x1C2B9DD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ENABLEHITEVENTS_OFFSET UNITYSDK_OFFSET(0x1C2B9E90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ENABLESLEEP_OFFSET UNITYSDK_OFFSET(0x1C2B9110)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ENABLE_OFFSET UNITYSDK_OFFSET(0x1C2B9490)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETANGULARDAMPING_OFFSET UNITYSDK_OFFSET(0x1C2B7CF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2B43E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETCONTACTCAPACITY_OFFSET UNITYSDK_OFFSET(0x1C2B1E00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETCONTACTDATA_OFFSET UNITYSDK_OFFSET(0x1C2B1E90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETGRAVITYSCALE_OFFSET UNITYSDK_OFFSET(0x1C2B7E90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETJOINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1C2BA150)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETJOINTS_OFFSET UNITYSDK_OFFSET(0x1C2BA1D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETLINEARDAMPING_OFFSET UNITYSDK_OFFSET(0x1C2B7B50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETLINEARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2B42F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETLOCALCENTEROFMASS_OFFSET UNITYSDK_OFFSET(0x1C2B75C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETLOCALPOINTVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2B4CD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETLOCALPOINT_OFFSET UNITYSDK_OFFSET(0x1C2B3780)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETLOCALVECTOR_OFFSET UNITYSDK_OFFSET(0x1C2B3A40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETMASSDATA_OFFSET UNITYSDK_OFFSET(0x1C2B78E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETMASS_OFFSET UNITYSDK_OFFSET(0x1C2B74C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETMOTIONLOCKS_OFFSET UNITYSDK_OFFSET(0x1C2B9B80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETNAME_OFFSET UNITYSDK_OFFSET(0x1C2B7340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1C2B3530)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETROTATIONALINERTIA_OFFSET UNITYSDK_OFFSET(0x1C2B7540)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1C2B35F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETSHAPECOUNT_OFFSET UNITYSDK_OFFSET(0x1C2B9F50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETSHAPES_OFFSET UNITYSDK_OFFSET(0x1C2B9FD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETSLEEPTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1C2B9090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C2B36B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1C2B5CC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x1C2B7440)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETWORLDCENTEROFMASS_OFFSET UNITYSDK_OFFSET(0x1C2B7680)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETWORLDPOINTVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2B4EB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETWORLDPOINT_OFFSET UNITYSDK_OFFSET(0x1C2B38C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_GETWORLDVECTOR_OFFSET UNITYSDK_OFFSET(0x1C2B3B80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ISAWAKE_OFFSET UNITYSDK_OFFSET(0x1C2B7F50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ISBULLET_OFFSET UNITYSDK_OFFSET(0x1C2B9D10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1C2B8F00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_ISSLEEPENABLED_OFFSET UNITYSDK_OFFSET(0x1C2B8F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETANGULARDAMPING_OFFSET UNITYSDK_OFFSET(0x1C2B7C10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2B4640)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETAWAKE_OFFSET UNITYSDK_OFFSET(0x1C2B7FD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETBULLET_OFFSET UNITYSDK_OFFSET(0x1C2B9C20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETGRAVITYSCALE_OFFSET UNITYSDK_OFFSET(0x1C2B7DB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETLINEARDAMPING_OFFSET UNITYSDK_OFFSET(0x1C2B7A70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETLINEARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2B44C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETMASSDATA_OFFSET UNITYSDK_OFFSET(0x1C2B7740)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETMOTIONLOCKS_OFFSET UNITYSDK_OFFSET(0x1C2B99B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETNAME_OFFSET UNITYSDK_OFFSET(0x1C2B72A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETSLEEPTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1C2B9000)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETTARGETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C2B4790)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C2B3CC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1C2B5D40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2BODY_SETUSERDATA_OFFSET UNITYSDK_OFFSET(0x1C2B73C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2CREATEBODY_OFFSET UNITYSDK_OFFSET(0x1C2B0140)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2CREATEISLANDFORBODY_OFFSET UNITYSDK_OFFSET(0x1C2AF1D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2DESTROYBODYCONTACTS_OFFSET UNITYSDK_OFFSET(0x1C2AF730)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2DESTROYBODY_OFFSET UNITYSDK_OFFSET(0x1C2B0BC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2GETBODYFULLID_OFFSET UNITYSDK_OFFSET(0x1C2AEF30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2GETBODYSIM_OFFSET UNITYSDK_OFFSET(0x1C2AF100)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2GETBODYSTATE_OFFSET UNITYSDK_OFFSET(0x1C2AF160)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2GETBODYTRANSFORMQUICK_OFFSET UNITYSDK_OFFSET(0x1C2AEF60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2GETBODYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1C2AEFD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2LIMITVELOCITY_OFFSET UNITYSDK_OFFSET(0x1C2AEE30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2MAKEBODYID_OFFSET UNITYSDK_OFFSET(0x1C2AF090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2MAKESWEEP_OFFSET UNITYSDK_OFFSET(0x1C2AEDF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2REMOVEBODYFROMISLAND_OFFSET UNITYSDK_OFFSET(0x1C2AF4A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2SHOULDBODIESCOLLIDE_OFFSET UNITYSDK_OFFSET(0x1C2ACEC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2UPDATEBODYMASSDATA_OFFSET UNITYSDK_OFFSET(0x1C2B2640)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES_B2WAKEBODY_OFFSET UNITYSDK_OFFSET(0x1C2B0B90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2BA400)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2BodyState**)Il2CppClass::FromTypeDefinitionIndex(B2Bodies_TypeDefinitionIndex)->GetStaticField(0x25D60);
		}
