...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2GETMOUSEJOINTFORCE_OFFSET UNITYSDK_OFFSET(0x1C2F0C30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2GETMOUSEJOINTTORQUE_OFFSET UNITYSDK_OFFSET(0x1C2F1030)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2MOUSEJOINT_GETMAXFORCE_OFFSET UNITYSDK_OFFSET(0x1C2FB500)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2MOUSEJOINT_GETSPRINGDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1C2FB450)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2MOUSEJOINT_GETSPRINGHERTZ_OFFSET UNITYSDK_OFFSET(0x1C2FB3A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2MOUSEJOINT_SETMAXFORCE_OFFSET UNITYSDK_OFFSET(0x1C2FB4A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2MOUSEJOINT_SETSPRINGDAMPINGRATIO_OFFSET UNITYSDK_OFFSET(0x1C2FB3F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2MOUSEJOINT_SETSPRINGHERTZ_OFFSET UNITYSDK_OFFSET(0x1C2FB340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2PREPAREMOUSEJOINT_OFFSET UNITYSDK_OFFSET(0x1C2F2340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2SOLVEMOUSEJOINT_OFFSET UNITYSDK_OFFSET(0x1C2F4990)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MOUSEJOINTS_B2WARMSTARTMOUSEJOINT_OFFSET UNITYSDK_OFFSET(0x1C2F3610)
