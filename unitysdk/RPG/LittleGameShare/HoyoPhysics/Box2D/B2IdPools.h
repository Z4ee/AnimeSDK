...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2ALLOCID_OFFSET UNITYSDK_OFFSET(0xC2CF4D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2CREATEIDPOOL_OFFSET UNITYSDK_OFFSET(0xC30B440)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2DESTROYIDPOOL_OFFSET UNITYSDK_OFFSET(0xC30B780)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2FREEID_OFFSET UNITYSDK_OFFSET(0xC2D0700)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2GETIDBYTES_OFFSET UNITYSDK_OFFSET(0xC30B340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2GETIDCAPACITY_OFFSET UNITYSDK_OFFSET(0xC30B320)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2GETIDCOUNT_OFFSET UNITYSDK_OFFSET(0xC30B300)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2VALIDATEFREEID_OFFSET UNITYSDK_OFFSET(0xC30B810)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2IDPOOLS_B2VALIDATEUSEDID_OFFSET UNITYSDK_OFFSET(0xC30B820)
