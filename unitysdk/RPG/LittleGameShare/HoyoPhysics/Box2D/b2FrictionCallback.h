...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FRICTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C799EF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FRICTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C799FA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FRICTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C799EC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FRICTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C799E50)
