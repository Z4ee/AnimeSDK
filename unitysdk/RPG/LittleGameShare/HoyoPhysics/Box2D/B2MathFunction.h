...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_CENTER_OFFSET UNITYSDK_OFFSET(0xC318EA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_CONTAINS_OFFSET UNITYSDK_OFFSET(0xC318E60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_EXTENTS_OFFSET UNITYSDK_OFFSET(0xC318EE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_OVERLAPS_OFFSET UNITYSDK_OFFSET(0xC318FD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2AABB_UNION_OFFSET UNITYSDK_OFFSET(0xC318F20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ABSFLOAT_OFFSET UNITYSDK_OFFSET(0xC317690)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ABSINT_OFFSET UNITYSDK_OFFSET(0xC317650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ABS_OFFSET UNITYSDK_OFFSET(0xC317970)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ADD_OFFSET UNITYSDK_OFFSET(0xC3177C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ATAN2_OFFSET UNITYSDK_OFFSET(0xC318530)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CLAMPFLOAT_OFFSET UNITYSDK_OFFSET(0xC3176B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CLAMPINT_OFFSET UNITYSDK_OFFSET(0xC317660)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CLAMP_OFFSET UNITYSDK_OFFSET(0xC317B20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2COMPUTEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0xC318310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2COMPUTECOSSIN_OFFSET UNITYSDK_OFFSET(0xC318030)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2COMPUTEROTATIONBETWEENUNITVECTORS_OFFSET UNITYSDK_OFFSET(0xC3199D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CROSSSV_OFFSET UNITYSDK_OFFSET(0xC317760)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CROSSVS_OFFSET UNITYSDK_OFFSET(0xC317730)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2CROSS_OFFSET UNITYSDK_OFFSET(0xC317700)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2DISTANCESQUARED_OFFSET UNITYSDK_OFFSET(0xC317FA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2DISTANCE_OFFSET UNITYSDK_OFFSET(0xC317C20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2DOT_OFFSET UNITYSDK_OFFSET(0xC3176D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2GETINVERSE22_OFFSET UNITYSDK_OFFSET(0xC318D80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2GETLENGTHANDNORMALIZE_OFFSET UNITYSDK_OFFSET(0xC317D90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INTEGRATEROTATION_OFFSET UNITYSDK_OFFSET(0xC317ED0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVMULROT_OFFSET UNITYSDK_OFFSET(0xC318750)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVMULTRANSFORMS_OFFSET UNITYSDK_OFFSET(0xC318C30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVROTATEVECTOR_OFFSET UNITYSDK_OFFSET(0xC318A40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2INVTRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0xC318AE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISNORMALIZEDROT_OFFSET UNITYSDK_OFFSET(0xC318200)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISNORMALIZED_OFFSET UNITYSDK_OFFSET(0xC317D00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDAABB_OFFSET UNITYSDK_OFFSET(0xC319710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDFLOAT_OFFSET UNITYSDK_OFFSET(0xC319460)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDPLANE_OFFSET UNITYSDK_OFFSET(0xC319840)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDROTATION_OFFSET UNITYSDK_OFFSET(0xC3194A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC319570)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ISVALIDVEC2_OFFSET UNITYSDK_OFFSET(0xC319470)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LEFTPERP_OFFSET UNITYSDK_OFFSET(0xC317790)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LENGTHSQUARED_OFFSET UNITYSDK_OFFSET(0xC317F80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LENGTH_OFFSET UNITYSDK_OFFSET(0xC317BF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2LERP_OFFSET UNITYSDK_OFFSET(0xC317840)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAKEAABB_OFFSET UNITYSDK_OFFSET(0xC319010)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAKEROTFROMUNITVECTOR_OFFSET UNITYSDK_OFFSET(0xC3181F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAKEROT_OFFSET UNITYSDK_OFFSET(0xC317FD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAXFLOAT_OFFSET UNITYSDK_OFFSET(0xC317680)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAXINT_OFFSET UNITYSDK_OFFSET(0xC317640)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MAX_OFFSET UNITYSDK_OFFSET(0xC317A90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MINFLOAT_OFFSET UNITYSDK_OFFSET(0xC317670)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MININT_OFFSET UNITYSDK_OFFSET(0xC317630)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MIN_OFFSET UNITYSDK_OFFSET(0xC317A00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULADD_OFFSET UNITYSDK_OFFSET(0xC3178F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULMV_OFFSET UNITYSDK_OFFSET(0xC318D40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULROT_OFFSET UNITYSDK_OFFSET(0xC318700)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULSUB_OFFSET UNITYSDK_OFFSET(0xC317930)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULSV_OFFSET UNITYSDK_OFFSET(0xC3178C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MULTRANSFORMS_OFFSET UNITYSDK_OFFSET(0xC318B20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2MUL_OFFSET UNITYSDK_OFFSET(0xC317890)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NEG_OFFSET UNITYSDK_OFFSET(0xC317820)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NLERP_OFFSET UNITYSDK_OFFSET(0xC318240)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NORMALIZEROT_OFFSET UNITYSDK_OFFSET(0xC317E40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2NORMALIZE_OFFSET UNITYSDK_OFFSET(0xC317C60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2PLANESEPARATION_OFFSET UNITYSDK_OFFSET(0xC319390)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2RELATIVEANGLE_OFFSET UNITYSDK_OFFSET(0xC3187A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2RIGHTPERP_OFFSET UNITYSDK_OFFSET(0xC3177B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROTATEVECTOR_OFFSET UNITYSDK_OFFSET(0xC3189F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROT_GETANGLE_OFFSET UNITYSDK_OFFSET(0xC318340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROT_GETXAXIS_OFFSET UNITYSDK_OFFSET(0xC3186D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2ROT_GETYAXIS_OFFSET UNITYSDK_OFFSET(0xC3186E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2SOLVE22_OFFSET UNITYSDK_OFFSET(0xC318DD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2SPRINGDAMPER_OFFSET UNITYSDK_OFFSET(0xC319420)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2SUB_OFFSET UNITYSDK_OFFSET(0xC3177F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0xC318A90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION_B2UNWINDANGLE_OFFSET UNITYSDK_OFFSET(0xC3189D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MATHFUNCTION__CCTOR_OFFSET UNITYSDK_OFFSET(0xC319AF0)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Transform*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0xB570);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Rot* StaticGet_b2Rot_identity()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Rot*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0xB580);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Mat22* StaticGet_b2Mat22_zero()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Mat22*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0xB588);
		}
		static ::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2* StaticGet_b2Vec2_zero()
		{
			return (::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2*)Il2CppClass::FromTypeDefinitionIndex(B2MathFunction_TypeDefinitionIndex)->GetStaticField(0xB598);
		}
