...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2COMPAREVISITORS_OFFSET UNITYSDK_OFFSET(0xC31E570)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2DESTROYSENSOR_OFFSET UNITYSDK_OFFSET(0xC2D0310)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2OVERLAPSENSORS_OFFSET UNITYSDK_OFFSET(0xC31EF10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2SENSORQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0xC31E050)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2SENSORTASK_OFFSET UNITYSDK_OFFSET(0xC31E580)
