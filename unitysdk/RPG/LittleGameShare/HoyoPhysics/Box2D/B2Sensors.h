...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2COMPAREVISITORS_OFFSET UNITYSDK_OFFSET(0xB658DE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2DESTROYSENSOR_OFFSET UNITYSDK_OFFSET(0xB60AF10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2OVERLAPSENSORS_OFFSET UNITYSDK_OFFSET(0xB659780)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2SENSORQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0xB6588C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SENSORS_B2SENSORTASK_OFFSET UNITYSDK_OFFSET(0xB658DF0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Sensors_TypeDefinitionIndex = 35207;
