...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICCOMPAREEXCHANGEINT_OFFSET UNITYSDK_OFFSET(0xB603D40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICFETCHADDINT_OFFSET UNITYSDK_OFFSET(0xB603D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICLOADINT_OFFSET UNITYSDK_OFFSET(0xB603D20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICLOADU32_OFFSET UNITYSDK_OFFSET(0xB603D60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICSTOREINT_OFFSET UNITYSDK_OFFSET(0xB603D10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICSTOREU32_OFFSET UNITYSDK_OFFSET(0xB603D50)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Atomics_TypeDefinitionIndex = 35037;
