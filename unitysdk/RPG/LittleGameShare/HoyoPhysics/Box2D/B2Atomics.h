...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICCOMPAREEXCHANGEINT_OFFSET UNITYSDK_OFFSET(0x1C2AA7E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICFETCHADDINT_OFFSET UNITYSDK_OFFSET(0x1C2AA7D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICLOADINT_OFFSET UNITYSDK_OFFSET(0x1C2AA7C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICLOADU32_OFFSET UNITYSDK_OFFSET(0x1C2AA800)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICSTOREINT_OFFSET UNITYSDK_OFFSET(0x1C2AA7B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ATOMICS_B2ATOMICSTOREU32_OFFSET UNITYSDK_OFFSET(0x1C2AA7F0)
