...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CASTRESULTFCN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB32FF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CASTRESULTFCN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB330D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CASTRESULTFCN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB30280)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2CASTRESULTFCN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB32F80)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2CastResultFcn_TypeDefinitionIndex = 35102;
