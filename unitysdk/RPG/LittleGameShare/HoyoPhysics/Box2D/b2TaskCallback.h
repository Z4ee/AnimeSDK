...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TASKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33F50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TASKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33FF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TASKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB26CF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TASKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB33EE0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2TaskCallback_TypeDefinitionIndex = 35094;
