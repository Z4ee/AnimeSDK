...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2BULLETBODYTASK_OFFSET UNITYSDK_OFFSET(0x1C310900)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2CONTINUOUSQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C30CBA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2EXECUTEBLOCK_OFFSET UNITYSDK_OFFSET(0x1C30F040)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2EXECUTEMAINSTAGE_OFFSET UNITYSDK_OFFSET(0x1C30F670)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2EXECUTESTAGE_OFFSET UNITYSDK_OFFSET(0x1C30F3E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2FINALIZEBODIESTASK_OFFSET UNITYSDK_OFFSET(0x1C30E380)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2INTEGRATEPOSITIONSTASK_OFFSET UNITYSDK_OFFSET(0x1C30C970)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2INTEGRATEVELOCITIESTASK_OFFSET UNITYSDK_OFFSET(0x1C30C110)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2MAKESOFT_OFFSET UNITYSDK_OFFSET(0x1C30C080)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2PAUSE_OFFSET UNITYSDK_OFFSET(0x1C30C0F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2PREPAREJOINTSTASK_OFFSET UNITYSDK_OFFSET(0x1C30C610)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SIMDSHIFT_OFFSET UNITYSDK_OFFSET(0x1C30C070)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVECONTINUOUS_OFFSET UNITYSDK_OFFSET(0x1C30D570)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVEJOINTSTASK_OFFSET UNITYSDK_OFFSET(0x1C30C710)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVERTASK_OFFSET UNITYSDK_OFFSET(0x1C30F7E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2SOLVE_OFFSET UNITYSDK_OFFSET(0x1C310A10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_B2WARMSTARTJOINTSTASK_OFFSET UNITYSDK_OFFSET(0x1C30C670)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS_GETWORKERSTARTINDEX_OFFSET UNITYSDK_OFFSET(0x1C30F370)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2SOLVERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C314F60)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(B2Solvers_TypeDefinitionIndex)->GetStaticField(0xCBF0);
		}
