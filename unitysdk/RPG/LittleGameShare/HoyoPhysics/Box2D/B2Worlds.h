...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2ADDNONTOUCHINGCONTACT_OFFSET UNITYSDK_OFFSET(0x1AB2A910)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2BODY_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AB2CAB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2CHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AB2CB90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2COLLIDETASK_OFFSET UNITYSDK_OFFSET(0x1AB2A240)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2COLLIDE_OFFSET UNITYSDK_OFFSET(0x1AB2AC50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2CONTACT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AB32CD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2CREATEWORLD_OFFSET UNITYSDK_OFFSET(0x1AB26DC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2DEFAULTADDTASKFCN_OFFSET UNITYSDK_OFFSET(0x1AB26CB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2DEFAULTFINISHTASKFCN_OFFSET UNITYSDK_OFFSET(0x1AB26D20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2DEFAULTFRICTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB26D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2DEFAULTRESTITUTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB26D50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2DESTROYWORLD_OFFSET UNITYSDK_OFFSET(0x1AB290E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2GETWORLDLOCKED_OFFSET UNITYSDK_OFFSET(0x1AB14250)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2INITWORLD_OFFSET UNITYSDK_OFFSET(0x1AB26E80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2JOINT_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AB2CC00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2REMOVENONTOUCHINGCONTACT_OFFSET UNITYSDK_OFFSET(0x1AB2AB70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2SHAPE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AB2CB20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2UPDATETREESTASK_OFFSET UNITYSDK_OFFSET(0x1AB2A8A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2VALIDATECONNECTIVITY_OFFSET UNITYSDK_OFFSET(0x1AB32CC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2VALIDATECONTACTS_OFFSET UNITYSDK_OFFSET(0x1AB2C3A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2VALIDATESOLVERSETS_OFFSET UNITYSDK_OFFSET(0x1AB14190)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_CASTMOVER_OFFSET UNITYSDK_OFFSET(0x1AB31520)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_CASTRAYCLOSEST_OFFSET UNITYSDK_OFFSET(0x1AB308B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_CASTRAY_OFFSET UNITYSDK_OFFSET(0x1AB302E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_CASTSHAPE_OFFSET UNITYSDK_OFFSET(0x1AB30F70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_COLLIDEMOVER_OFFSET UNITYSDK_OFFSET(0x1AB31CE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_DUMPMEMORYSTATS_OFFSET UNITYSDK_OFFSET(0x1AB2D6C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ENABLECONTINUOUS_OFFSET UNITYSDK_OFFSET(0x1AB2CDC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ENABLESLEEPING_OFFSET UNITYSDK_OFFSET(0x1AB2CC70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ENABLESPECULATIVE_OFFSET UNITYSDK_OFFSET(0x1AB32CA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ENABLEWARMSTARTING_OFFSET UNITYSDK_OFFSET(0x1AB2CD30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_EXPLODE_OFFSET UNITYSDK_OFFSET(0x1AB32A40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETAWAKEBODYCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB2CD80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETBODYEVENTS_OFFSET UNITYSDK_OFFSET(0x1AB2C8C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETCONTACTEVENTS_OFFSET UNITYSDK_OFFSET(0x1AB2C9A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETCOUNTERS_OFFSET UNITYSDK_OFFSET(0x1AB2D110)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETGRAVITY_OFFSET UNITYSDK_OFFSET(0x1AB32260)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETHITEVENTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AB2CF50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETJOINTEVENTS_OFFSET UNITYSDK_OFFSET(0x1AB2CA60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETMAXIMUMLINEARSPEED_OFFSET UNITYSDK_OFFSET(0x1AB2D090)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETPROFILE_OFFSET UNITYSDK_OFFSET(0x1AB2D0B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETRESTITUTIONTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AB2CEA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETSENSOREVENTS_OFFSET UNITYSDK_OFFSET(0x1AB2C910)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_GETUSERDATA_OFFSET UNITYSDK_OFFSET(0x1AB2D500)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ISCONTINUOUSENABLED_OFFSET UNITYSDK_OFFSET(0x1AB2CDF0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ISSLEEPINGENABLED_OFFSET UNITYSDK_OFFSET(0x1AB2CD10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_ISWARMSTARTINGENABLED_OFFSET UNITYSDK_OFFSET(0x1AB2CD60)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_OVERLAPAABB_OFFSET UNITYSDK_OFFSET(0x1AB2F1A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_OVERLAPSHAPE_OFFSET UNITYSDK_OFFSET(0x1AB2F8C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_REBUILDSTATICTREE_OFFSET UNITYSDK_OFFSET(0x1AB32C00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETCONTACTTUNING_OFFSET UNITYSDK_OFFSET(0x1AB2CF70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETCUSTOMFILTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB321E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETFRICTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB2D520)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETGRAVITY_OFFSET UNITYSDK_OFFSET(0x1AB32240)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETHITEVENTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AB2CEC0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETMAXIMUMLINEARSPEED_OFFSET UNITYSDK_OFFSET(0x1AB2D060)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETPRESOLVECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB32210)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETRESTITUTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB2D5F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETRESTITUTIONTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AB2CE10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_SETUSERDATA_OFFSET UNITYSDK_OFFSET(0x1AB2D4E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_B2WORLD_STEP_OFFSET UNITYSDK_OFFSET(0x1AB2C3B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_EXPLOSIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB32280)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_MOVERCASTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB313B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_RAYCASTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB30080)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_RAYCASTCLOSESTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB306D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_SHAPECASTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB30D70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_TREECOLLIDECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB31A00)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_TREEOVERLAPCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB2F570)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2WORLDS_TREEQUERYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AB2F0C0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Worlds_TypeDefinitionIndex = 35273;
