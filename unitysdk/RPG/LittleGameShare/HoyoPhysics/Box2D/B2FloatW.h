...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW_ASSPAN_OFFSET UNITYSDK_OFFSET(0x7AFA40)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x7AF9C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW__CTOR_OFFSET UNITYSDK_OFFSET(0x7AF9A0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2FloatW_TypeDefinitionIndex = 35132;
