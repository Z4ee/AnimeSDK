...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW_ASSPAN_OFFSET UNITYSDK_OFFSET(0x3B77990)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x3B77910)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FLOATW__CTOR_OFFSET UNITYSDK_OFFSET(0x25B40)
