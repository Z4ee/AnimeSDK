...
{
	inline static constexpr unsigned int B2RevoluteJoint_TypeDefinitionIndex = 35190;

	struct alignas(4) B2RevoluteJoint
	{
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2 linearImpulse; // 0x10
		...
		::System::Single targetAngle; // 0x30
		::System::Single maxMotorTorque; // 0x34
		::System::Single motorSpeed; // 0x38
		::System::Single lowerAngle; // 0x3C
		::System::Single upperAngle; // 0x40
