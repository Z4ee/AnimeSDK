...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1C789990)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1C789A50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1C789AD0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1C789A20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1C7899F0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1C7899C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1C789970)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2VEC2__CTOR_OFFSET UNITYSDK_OFFSET(0x6B9800)
