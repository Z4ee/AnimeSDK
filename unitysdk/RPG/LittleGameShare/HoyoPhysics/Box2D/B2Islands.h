...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2ADDCONTACTTOISLAND_OFFSET UNITYSDK_OFFSET(0xB646530)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2ADDJOINTTOISLAND_OFFSET UNITYSDK_OFFSET(0xB646960)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2CREATEISLAND_OFFSET UNITYSDK_OFFSET(0xB6087C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2DESTROYISLAND_OFFSET UNITYSDK_OFFSET(0xB608B80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2LINKCONTACT_OFFSET UNITYSDK_OFFSET(0xB6465E0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2LINKJOINT_OFFSET UNITYSDK_OFFSET(0xB610220)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2MERGEAWAKEISLANDS_OFFSET UNITYSDK_OFFSET(0xB610650)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2MERGEISLAND_OFFSET UNITYSDK_OFFSET(0xB646A10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2SPLITISLANDTASK_OFFSET UNITYSDK_OFFSET(0xB646CA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2SPLITISLAND_OFFSET UNITYSDK_OFFSET(0xB611830)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2UNLINKCONTACT_OFFSET UNITYSDK_OFFSET(0xB62CB20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2UNLINKJOINT_OFFSET UNITYSDK_OFFSET(0xB6100C0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2VALIDATEISLAND_OFFSET UNITYSDK_OFFSET(0xB646D50)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int B2Islands_TypeDefinitionIndex = 35144;
