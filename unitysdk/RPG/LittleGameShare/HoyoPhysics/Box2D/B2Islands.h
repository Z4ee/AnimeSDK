...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2ADDCONTACTTOISLAND_OFFSET UNITYSDK_OFFSET(0x1C2ECE70)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2ADDJOINTTOISLAND_OFFSET UNITYSDK_OFFSET(0x1C2ED270)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2CREATEISLAND_OFFSET UNITYSDK_OFFSET(0x1C2AF210)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2DESTROYISLAND_OFFSET UNITYSDK_OFFSET(0x1C2AF590)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2LINKCONTACT_OFFSET UNITYSDK_OFFSET(0x1C2ECF10)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2LINKJOINT_OFFSET UNITYSDK_OFFSET(0x1C2B6B90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2MERGEAWAKEISLANDS_OFFSET UNITYSDK_OFFSET(0x1C2B6FB0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2MERGEISLAND_OFFSET UNITYSDK_OFFSET(0x1C2ED320)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2SPLITISLANDTASK_OFFSET UNITYSDK_OFFSET(0x1C2ED5B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2SPLITISLAND_OFFSET UNITYSDK_OFFSET(0x1C2B8100)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2UNLINKCONTACT_OFFSET UNITYSDK_OFFSET(0x1C2D3340)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2UNLINKJOINT_OFFSET UNITYSDK_OFFSET(0x1C2B6A20)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ISLANDS_B2VALIDATEISLAND_OFFSET UNITYSDK_OFFSET(0x1C2ED660)
