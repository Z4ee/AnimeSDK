...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PRESOLVEFCN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33C50)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PRESOLVEFCN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33D30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PRESOLVEFCN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB1AB30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2PRESOLVEFCN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB33BE0)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2PreSolveFcn_TypeDefinitionIndex = 35100;
