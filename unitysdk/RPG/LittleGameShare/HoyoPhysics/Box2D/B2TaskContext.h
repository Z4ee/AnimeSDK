...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2TASKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3157D0)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	{
	public:
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2BitSet jointStateBitSet; // 0x10
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2BitSet contactStateBitSet; // 0x20
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Array_1<::RPG::LittleGameShare::HoyoPhysics::Box2D::B2SensorHit> sensorHits; // 0x30
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2BitSet enlargedSimBitSet; // 0x40
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2BitSet awakeIslandBitSet; // 0x50
