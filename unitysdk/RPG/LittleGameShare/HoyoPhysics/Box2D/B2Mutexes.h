...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MUTEXES_B2CREATEMUTEX_OFFSET UNITYSDK_OFFSET(0x1C2FBB80)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MUTEXES_B2DESTROYMUTEX_OFFSET UNITYSDK_OFFSET(0x1C2FBB90)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MUTEXES_B2LOCKMUTEX_OFFSET UNITYSDK_OFFSET(0x1C2FBBA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MUTEXES_B2UNLOCKMUTEX_OFFSET UNITYSDK_OFFSET(0x1C2FBBE0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2MUTEXES__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2FBC10)
