...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ALLOCFCN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C7996B0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ALLOCFCN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C799720)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ALLOCFCN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C7996A0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2ALLOCFCN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C799630)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2AllocFcn_TypeDefinitionIndex = 35952;
