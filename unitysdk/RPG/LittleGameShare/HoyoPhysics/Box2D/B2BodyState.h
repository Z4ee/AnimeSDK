...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE_CLEAR_OFFSET UNITYSDK_OFFSET(0xC2CF590)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE_COPYFROM_OFFSET UNITYSDK_OFFSET(0xC2D9290)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE_CREATE_OFFSET UNITYSDK_OFFSET(0xC2D9200)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xC2D8F60)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	public:
		...
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2 linearVelocity; // 0x28
