...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE_CLEAR_OFFSET UNITYSDK_OFFSET(0xB60A190)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE_COPYFROM_OFFSET UNITYSDK_OFFSET(0xB613F30)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE_CREATE_OFFSET UNITYSDK_OFFSET(0xB613EA0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2BODYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB613C00)
...
namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	...
	{
	public:
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Rot deltaRotation; // 0x10
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2 linearVelocity; // 0x18
		::RPG::LittleGameShare::HoyoPhysics::Box2D::B2Vec2 deltaPosition; // 0x20
