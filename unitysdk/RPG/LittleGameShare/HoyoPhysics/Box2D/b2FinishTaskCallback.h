...
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FINISHTASKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33450)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FINISHTASKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB33490)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FINISHTASKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB224D0)
#define RPG_LITTLEGAMESHARE_HOYOPHYSICS_BOX2D_B2FINISHTASKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB33360)

namespace RPG::LittleGameShare::HoyoPhysics::Box2D
{
	inline static constexpr unsigned int b2FinishTaskCallback_TypeDefinitionIndex = 35096;
