...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B50AC60)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1B50AB40)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1B50AB30)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B50AD20)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B50ACB0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1B50ABC0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B50AD90)
