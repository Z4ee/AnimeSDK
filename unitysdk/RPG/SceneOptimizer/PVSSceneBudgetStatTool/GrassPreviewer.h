...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_CLEAR_OFFSET UNITYSDK_OFFSET(0xCFB9920)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_EXECUTE_OFFSET UNITYSDK_OFFSET(0xCFB9800)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_GET_KEY_OFFSET UNITYSDK_OFFSET(0xCFB97F0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xCFB99E0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCFB9970)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER_REGISTER_OFFSET UNITYSDK_OFFSET(0xCFB9880)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GRASSPREVIEWER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFB9A50)

namespace RPG::SceneOptimizer::PVSSceneBudgetStatTool
{
	inline static constexpr unsigned int GrassPreviewer_TypeDefinitionIndex = 48428;
