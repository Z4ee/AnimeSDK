...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_PVSSCENEBUDGETSTATTOOLWINDOWVISUALIZEHELPER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAB04260)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_PVSSCENEBUDGETSTATTOOLWINDOWVISUALIZEHELPER___C__DISPLAYCLASS7_0__REMOVEBOUNDS_B__0_OFFSET UNITYSDK_OFFSET(0xAB05080)

namespace RPG::SceneOptimizer::PVSSceneBudgetStatTool
{
	inline static constexpr unsigned int PVSSceneBudgetStatToolWindowVisualizeHelper___c__DisplayClass7_0_TypeDefinitionIndex = 41843;
