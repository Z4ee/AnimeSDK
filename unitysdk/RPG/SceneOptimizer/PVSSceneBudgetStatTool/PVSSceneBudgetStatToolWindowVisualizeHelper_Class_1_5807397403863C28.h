...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_PVSSCENEBUDGETSTATTOOLWINDOWVISUALIZEHELPER_CLASS_1_5807397403863C28__CTOR_OFFSET UNITYSDK_OFFSET(0x1B50AF20)
...
namespace RPG::SceneOptimizer::PVSSceneBudgetStatTool
{
	...
	{
	public:
		::UnityEngine::Color FGAGBOPDDOE; // 0x10
		::UnityEngine::Bounds IJNBNFHBENO; // 0x20
