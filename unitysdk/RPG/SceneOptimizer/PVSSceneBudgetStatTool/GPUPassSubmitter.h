...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_EXECUTE_OFFSET UNITYSDK_OFFSET(0xE7EC6F0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_GET_KEY_OFFSET UNITYSDK_OFFSET(0xE7EC650)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xE7EC930)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_REGISTER_OFFSET UNITYSDK_OFFSET(0xE7EC660)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xE7EC770)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE7EC9A0)
