...
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_EXECUTE_OFFSET UNITYSDK_OFFSET(0xB8701C0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_GET_KEY_OFFSET UNITYSDK_OFFSET(0xB870120)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB8703F0)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_REGISTER_OFFSET UNITYSDK_OFFSET(0xB870130)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER_UPDATE_OFFSET UNITYSDK_OFFSET(0xB870230)
#define RPG_SCENEOPTIMIZER_PVSSCENEBUDGETSTATTOOL_GPUPASSSUBMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB870460)

namespace RPG::SceneOptimizer::PVSSceneBudgetStatTool
{
	inline static constexpr unsigned int GPUPassSubmitter_TypeDefinitionIndex = 47812;
