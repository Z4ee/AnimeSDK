...
#define AKOBSTRUCTIONOCCLUSION_CASTRAYS_OFFSET UNITYSDK_OFFSET(0x1F7ED860)
#define AKOBSTRUCTIONOCCLUSION_INITINTERVALSANDFADERATES_OFFSET UNITYSDK_OFFSET(0x1F7ED500)
#define AKOBSTRUCTIONOCCLUSION_UPDATEOBSTRUCTIONOCCLUSIONVALUES_OFFSET UNITYSDK_OFFSET(0x1F7ED540)
#define AKOBSTRUCTIONOCCLUSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F7EDC00)
#define AKOBSTRUCTIONOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7EDF40)

inline static constexpr unsigned int AkObstructionOcclusion_TypeDefinitionIndex = 33796;
