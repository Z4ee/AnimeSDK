...
#define AKOBSTRUCTIONOCCLUSION_CASTRAYS_OFFSET UNITYSDK_OFFSET(0x1E3A9F00)
#define AKOBSTRUCTIONOCCLUSION_INITINTERVALSANDFADERATES_OFFSET UNITYSDK_OFFSET(0x1E3A9BA0)
#define AKOBSTRUCTIONOCCLUSION_UPDATEOBSTRUCTIONOCCLUSIONVALUES_OFFSET UNITYSDK_OFFSET(0x1E3A9BE0)
#define AKOBSTRUCTIONOCCLUSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E3AA2C0)
#define AKOBSTRUCTIONOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3AA600)

inline static constexpr unsigned int AkObstructionOcclusion_TypeDefinitionIndex = 33160;
