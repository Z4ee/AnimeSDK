...
#define AKOBSTRUCTIONOCCLUSION_CASTRAYS_OFFSET UNITYSDK_OFFSET(0x1BD6A960)
#define AKOBSTRUCTIONOCCLUSION_INITINTERVALSANDFADERATES_OFFSET UNITYSDK_OFFSET(0x1BD6A4F0)
#define AKOBSTRUCTIONOCCLUSION_UPDATEOBSTRUCTIONOCCLUSIONVALUES_OFFSET UNITYSDK_OFFSET(0x1BD6A560)
#define AKOBSTRUCTIONOCCLUSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1BD6AE80)
#define AKOBSTRUCTIONOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BD6B440)

inline static constexpr unsigned int AkObstructionOcclusion_TypeDefinitionIndex = 42135;
