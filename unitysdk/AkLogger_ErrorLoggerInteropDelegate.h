...
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EED5870)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EED58A0)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EED5860)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EED57F0)
