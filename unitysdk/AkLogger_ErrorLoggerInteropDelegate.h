...
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FA255B0)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FA255E0)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FA25090)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA25070)

inline static constexpr unsigned int AkLogger_ErrorLoggerInteropDelegate_TypeDefinitionIndex = 33707;
