...
#define CLASS_2_8E5D70424DCBD156_DISPOSE_OFFSET UNITYSDK_OFFSET(0x178706D0)
#define CLASS_2_8E5D70424DCBD156_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x178707A0)
#define CLASS_2_8E5D70424DCBD156_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17870AB0)
#define CLASS_2_8E5D70424DCBD156_TICK_OFFSET UNITYSDK_OFFSET(0x17870B30)
#define CLASS_2_8E5D70424DCBD156__CTOR_OFFSET UNITYSDK_OFFSET(0x178706C0)

inline static constexpr unsigned int Class_2_8E5D70424DCBD156_TypeDefinitionIndex = 52459;

class Class_2_8E5D70424DCBD156 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CheckUIMode* Field_2_0; // 0x18
