...
#define CLASS_2_8E5D70424DCBD156_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18497060)
#define CLASS_2_8E5D70424DCBD156_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18497130)
#define CLASS_2_8E5D70424DCBD156_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18497430)
#define CLASS_2_8E5D70424DCBD156_TICK_OFFSET UNITYSDK_OFFSET(0x184974B0)
#define CLASS_2_8E5D70424DCBD156__CTOR_OFFSET UNITYSDK_OFFSET(0x18497050)

inline static constexpr unsigned int Class_2_8E5D70424DCBD156_TypeDefinitionIndex = 55156;

class Class_2_8E5D70424DCBD156 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::CheckUIMode* OFKGLJOAMLD; // 0x18
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x20
	::Class_3_07C3C4D2990C49EE* FDEKPPBCMLO; // 0x28
