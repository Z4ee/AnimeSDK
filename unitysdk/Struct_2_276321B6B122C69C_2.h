...
#define STRUCT_2_276321B6B122C69C_2_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7DFB0)
#define STRUCT_2_276321B6B122C69C_2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7DE80)
#define STRUCT_2_276321B6B122C69C_2_EQUALS_OFFSET UNITYSDK_OFFSET(0x2BC6B70)
#define STRUCT_2_276321B6B122C69C_2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7DD60)
#define STRUCT_2_276321B6B122C69C_2_GET_ID_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define STRUCT_2_276321B6B122C69C_2_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1E110)
#define STRUCT_2_276321B6B122C69C_2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x13FEE4E0)
#define STRUCT_2_276321B6B122C69C_2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x13FEE3C0)
#define STRUCT_2_276321B6B122C69C_2_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x2BC6B50)
#define STRUCT_2_276321B6B122C69C_2_SET_ID_OFFSET UNITYSDK_OFFSET(0x2C4C0)
#define STRUCT_2_276321B6B122C69C_2_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x21F0)
#define STRUCT_2_276321B6B122C69C_2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2BC6B40)
#define STRUCT_2_276321B6B122C69C_2__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBE0)

inline static constexpr unsigned int Struct_2_276321B6B122C69C_2_TypeDefinitionIndex = 48600;
