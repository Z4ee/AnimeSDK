...
#define CLASS_1_5B567C8A01BAEDFE_314_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5126F0)
#define CLASS_1_5B567C8A01BAEDFE_314_CLONE_OFFSET UNITYSDK_OFFSET(0x1A512560)
#define CLASS_1_5B567C8A01BAEDFE_314_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A512600)
#define CLASS_1_5B567C8A01BAEDFE_314_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5125A0)
#define CLASS_1_5B567C8A01BAEDFE_314_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A512650)
#define CLASS_1_5B567C8A01BAEDFE_314_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A512740)
#define CLASS_1_5B567C8A01BAEDFE_314_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A512710)
#define CLASS_1_5B567C8A01BAEDFE_314_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A5124E0)
#define CLASS_1_5B567C8A01BAEDFE_314_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A512510)
#define CLASS_1_5B567C8A01BAEDFE_314_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A512680)
#define CLASS_1_5B567C8A01BAEDFE_314_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5126E0)
#define CLASS_1_5B567C8A01BAEDFE_314__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A512790)
#define CLASS_1_5B567C8A01BAEDFE_314__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A512530)
#define CLASS_1_5B567C8A01BAEDFE_314__CTOR_OFFSET UNITYSDK_OFFSET(0x1A512520)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_314_TypeDefinitionIndex = 31264;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_314*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_314_TypeDefinitionIndex)->GetStaticField(0xD400);
	}
