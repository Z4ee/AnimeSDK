...
#define CLASS_2_E4B8DB164A00261E_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB7C7550)
#define CLASS_2_E4B8DB164A00261E_METHOD_2_7DE6CFC02F305A54_OFFSET UNITYSDK_OFFSET(0xB7C7FA0)
#define CLASS_2_E4B8DB164A00261E_METHOD_2_C73225BEC2FFD906_OFFSET UNITYSDK_OFFSET(0xB7C7C70)
#define CLASS_2_E4B8DB164A00261E_METHOD_2_C9BB6C74C25011DA_OFFSET UNITYSDK_OFFSET(0xB7C7840)
#define CLASS_2_E4B8DB164A00261E_METHOD_2_D09AC5057F1B1192_OFFSET UNITYSDK_OFFSET(0xB7C8420)
#define CLASS_2_E4B8DB164A00261E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB7C75F0)
#define CLASS_2_E4B8DB164A00261E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB7C85D0)
#define CLASS_2_E4B8DB164A00261E_TICK_OFFSET UNITYSDK_OFFSET(0xB7C7590)
#define CLASS_2_E4B8DB164A00261E__CTOR_OFFSET UNITYSDK_OFFSET(0xB7C7540)

inline static constexpr unsigned int Class_2_E4B8DB164A00261E_TypeDefinitionIndex = 50173;

class Class_2_E4B8DB164A00261E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::UseSkillByComplexSkillAI* Field_2_1; // 0x18
