...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHINTERNALPROCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6300)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHINTERNALPROCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6340)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHINTERNALPROCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF380)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHINTERNALPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF6280)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchInternalProcess_TypeDefinitionIndex = 36826;
