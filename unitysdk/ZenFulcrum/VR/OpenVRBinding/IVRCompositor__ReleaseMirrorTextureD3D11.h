...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EF9B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EFA00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EF6C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EF6A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ReleaseMirrorTextureD3D11_TypeDefinitionIndex = 35811;
