...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB6320)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB6370)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB6310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASEMIRRORTEXTURED3D11__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB62A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ReleaseMirrorTextureD3D11_TypeDefinitionIndex = 37752;
