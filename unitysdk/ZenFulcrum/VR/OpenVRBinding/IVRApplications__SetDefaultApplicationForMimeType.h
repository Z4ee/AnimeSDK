...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF67C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6800)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF0A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__SETDEFAULTAPPLICATIONFORMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF6740)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__SetDefaultApplicationForMimeType_TypeDefinitionIndex = 36816;
