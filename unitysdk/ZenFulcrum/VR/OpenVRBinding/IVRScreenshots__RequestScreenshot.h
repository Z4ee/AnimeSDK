...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B522FC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B523070)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B522F90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B522F10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__RequestScreenshot_TypeDefinitionIndex = 36238;
