...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7C10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7CC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7880)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__REQUESTSCREENSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD7860)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__RequestScreenshot_TypeDefinitionIndex = 30218;
