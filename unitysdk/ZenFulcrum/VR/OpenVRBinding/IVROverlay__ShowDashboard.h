...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWDASHBOARD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A709840)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWDASHBOARD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A709870)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWDASHBOARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7092F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWDASHBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7092D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ShowDashboard_TypeDefinitionIndex = 35890;
