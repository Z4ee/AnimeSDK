...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSORTEDTRACKEDDEVICEINDICESOFCLASS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B526960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSORTEDTRACKEDDEVICEINDICESOFCLASS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B526A20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSORTEDTRACKEDDEVICEINDICESOFCLASS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B526930)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSORTEDTRACKEDDEVICEINDICESOFCLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5268C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetSortedTrackedDeviceIndicesOfClass_TypeDefinitionIndex = 35967;
