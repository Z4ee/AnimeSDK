...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B520DC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B520EB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B520D60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B520CF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ShowKeyboard_TypeDefinitionIndex = 36192;
