...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6F70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6FE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF620)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__SETSCENECOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF6F00)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperone__SetSceneColor_TypeDefinitionIndex = 36833;
