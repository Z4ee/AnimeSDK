...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB3BF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB3C60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFABA90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__RELOADFROMDISK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB3B80)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__ReloadFromDisk_TypeDefinitionIndex = 37709;
