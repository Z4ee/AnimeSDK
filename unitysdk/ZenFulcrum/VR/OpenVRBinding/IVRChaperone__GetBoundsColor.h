...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6A50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6B20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF690)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF69D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperone__GetBoundsColor_TypeDefinitionIndex = 36834;
