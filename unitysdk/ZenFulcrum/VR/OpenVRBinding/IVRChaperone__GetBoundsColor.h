...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB240)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CA0340)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETBOUNDSCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB220)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperone__GetBoundsColor_TypeDefinitionIndex = 30032;
