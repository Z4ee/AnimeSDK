...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51ED30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51EDC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51ED20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51ECB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetKeyboardTransformAbsolute_TypeDefinitionIndex = 36196;
