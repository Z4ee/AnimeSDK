...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDBB20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDBBB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDBB10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDTRANSFORMABSOLUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDBAA0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetKeyboardTransformAbsolute_TypeDefinitionIndex = 37837;
