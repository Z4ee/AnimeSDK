...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B513CA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B513D00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B50DDD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B513C20)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__AddApplicationManifest_TypeDefinitionIndex = 36015;
