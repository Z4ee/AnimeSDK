...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E5230)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E5290)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6D09F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__ADDAPPLICATIONMANIFEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E5210)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__AddApplicationManifest_TypeDefinitionIndex = 35715;
