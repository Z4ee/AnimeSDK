...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISFULLSCREEN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EECA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISFULLSCREEN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EECD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISFULLSCREEN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EE9F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__ISFULLSCREEN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EE9D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__IsFullscreen_TypeDefinitionIndex = 35798;
