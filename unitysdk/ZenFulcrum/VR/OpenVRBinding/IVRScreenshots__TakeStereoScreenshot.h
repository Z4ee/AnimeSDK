...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__TAKESTEREOSCREENSHOT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD85B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__TAKESTEREOSCREENSHOT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD8620)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__TAKESTEREOSCREENSHOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD8210)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__TAKESTEREOSCREENSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD81F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__TakeStereoScreenshot_TypeDefinitionIndex = 30223;
