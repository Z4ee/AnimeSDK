...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDXGIOUTPUTINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE2330)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDXGIOUTPUTINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE2380)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDXGIOUTPUTINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE2320)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDXGIOUTPUTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE22B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetDXGIOutputInfo_TypeDefinitionIndex = 37600;
