...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSTHATSUPPORTMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF57D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSTHATSUPPORTMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5840)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSTHATSUPPORTMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSTHATSUPPORTMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF5750)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationsThatSupportMimeType_TypeDefinitionIndex = 36819;
