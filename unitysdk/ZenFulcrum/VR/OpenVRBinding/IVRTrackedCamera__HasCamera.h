...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__HASCAMERA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CEC7B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__HASCAMERA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CEC820)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__HASCAMERA_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CEC460)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__HASCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x18CEC440)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__HasCamera_TypeDefinitionIndex = 29983;
