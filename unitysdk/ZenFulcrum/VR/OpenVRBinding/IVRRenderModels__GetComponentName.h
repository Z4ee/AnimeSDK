...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBE470)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBE500)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBE440)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBE3C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetComponentName_TypeDefinitionIndex = 37854;
