...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUSPENDRENDERING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A050)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUSPENDRENDERING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A0A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUSPENDRENDERING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A040)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUSPENDRENDERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B519FD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__SuspendRendering_TypeDefinitionIndex = 36109;
