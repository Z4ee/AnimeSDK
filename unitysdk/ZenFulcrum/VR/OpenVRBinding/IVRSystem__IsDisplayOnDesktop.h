...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISDISPLAYONDESKTOP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D269870)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISDISPLAYONDESKTOP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D2698A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISDISPLAYONDESKTOP_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D269860)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISDISPLAYONDESKTOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2697F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__IsDisplayOnDesktop_TypeDefinitionIndex = 36743;
