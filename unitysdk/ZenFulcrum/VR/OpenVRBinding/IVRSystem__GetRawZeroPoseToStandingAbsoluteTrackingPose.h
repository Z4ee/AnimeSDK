...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRAWZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC3210)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRAWZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC3240)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRAWZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC31F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRAWZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC3180)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetRawZeroPoseToStandingAbsoluteTrackingPose_TypeDefinitionIndex = 37607;
