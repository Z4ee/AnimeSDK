...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7420)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD7040)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD7020)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__GetScreenshotPropertyType_TypeDefinitionIndex = 30220;
