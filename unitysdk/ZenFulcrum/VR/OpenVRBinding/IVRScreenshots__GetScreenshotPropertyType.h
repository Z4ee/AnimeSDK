...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22EED0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22EF60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22EEC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22EE50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__GetScreenshotPropertyType_TypeDefinitionIndex = 37022;
