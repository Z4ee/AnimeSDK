...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__SUBMITSCREENSHOT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F2E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__SUBMITSCREENSHOT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__SUBMITSCREENSHOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F2B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__SUBMITSCREENSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22F240)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__SubmitScreenshot_TypeDefinitionIndex = 37026;
