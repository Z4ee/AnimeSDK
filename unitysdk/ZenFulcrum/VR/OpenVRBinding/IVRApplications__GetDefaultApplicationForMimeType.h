...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5AD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5B40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF0E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF5A50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetDefaultApplicationForMimeType_TypeDefinitionIndex = 36817;
