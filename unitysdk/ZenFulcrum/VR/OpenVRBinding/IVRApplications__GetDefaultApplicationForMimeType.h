...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D7FD940)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D7FD9B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D7F6EF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETDEFAULTAPPLICATIONFORMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FD8C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetDefaultApplicationForMimeType_TypeDefinitionIndex = 37676;
