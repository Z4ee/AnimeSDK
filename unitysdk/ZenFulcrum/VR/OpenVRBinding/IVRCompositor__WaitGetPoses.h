...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__WAITGETPOSES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB6DA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__WAITGETPOSES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB6E30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__WAITGETPOSES_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB6A20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__WAITGETPOSES__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB6A00)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__WaitGetPoses_TypeDefinitionIndex = 30059;
