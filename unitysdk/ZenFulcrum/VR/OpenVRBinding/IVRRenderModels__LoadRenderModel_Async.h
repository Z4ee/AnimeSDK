...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADRENDERMODEL_ASYNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E600)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADRENDERMODEL_ASYNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E660)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADRENDERMODEL_ASYNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E5F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADRENDERMODEL_ASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22E570)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__LoadRenderModel_Async_TypeDefinitionIndex = 36985;
