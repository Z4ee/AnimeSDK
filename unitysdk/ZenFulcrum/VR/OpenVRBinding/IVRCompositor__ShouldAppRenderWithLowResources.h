...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B225DD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B225E00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B225DC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B225D50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ShouldAppRenderWithLowResources_TypeDefinitionIndex = 36888;
