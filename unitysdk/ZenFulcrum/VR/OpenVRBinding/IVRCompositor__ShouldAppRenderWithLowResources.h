...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB5730)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB5760)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB5480)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOULDAPPRENDERWITHLOWRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB5460)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ShouldAppRenderWithLowResources_TypeDefinitionIndex = 30086;
