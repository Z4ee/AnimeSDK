...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERAXISTYPENAMEFROMENUM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1AF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERAXISTYPENAMEFROMENUM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1B60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERAXISTYPENAMEFROMENUM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1AE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERAXISTYPENAMEFROMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC1A70)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetControllerAxisTypeNameFromEnum_TypeDefinitionIndex = 37630;
