...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__POLLNEXTOVERLAYEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDB440)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__POLLNEXTOVERLAYEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDB4F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__POLLNEXTOVERLAYEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDB420)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__POLLNEXTOVERLAYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDB3B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__PollNextOverlayEvent_TypeDefinitionIndex = 37807;
