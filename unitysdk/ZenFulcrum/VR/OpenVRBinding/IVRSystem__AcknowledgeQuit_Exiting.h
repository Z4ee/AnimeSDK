...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_EXITING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_EXITING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC11B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_EXITING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1170)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_EXITING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC1100)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__AcknowledgeQuit_Exiting_TypeDefinitionIndex = 37636;
