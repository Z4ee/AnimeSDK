...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4150)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4200)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF3CC0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF40E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRSystem__GetControllerStatePacked_TypeDefinitionIndex = 37036;
