...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SYNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1040)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SYNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC10D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SYNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1030)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC0FC0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__Sync_TypeDefinitionIndex = 37867;
