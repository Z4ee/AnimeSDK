...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__CANCELAPPLICATIONLAUNCH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4AD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__CANCELAPPLICATIONLAUNCH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4B00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__CANCELAPPLICATIONLAUNCH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEEDD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__CANCELAPPLICATIONLAUNCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF4A60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__CancelApplicationLaunch_TypeDefinitionIndex = 36807;
