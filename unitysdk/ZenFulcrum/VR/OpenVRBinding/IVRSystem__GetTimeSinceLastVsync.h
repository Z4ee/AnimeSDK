...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTIMESINCELASTVSYNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5A650)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTIMESINCELASTVSYNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5A6C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTIMESINCELASTVSYNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5A640)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTIMESINCELASTVSYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF5A5C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetTimeSinceLastVsync_TypeDefinitionIndex = 37598;
