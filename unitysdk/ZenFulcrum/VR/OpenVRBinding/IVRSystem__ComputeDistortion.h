...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__COMPUTEDISTORTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A71A230)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__COMPUTEDISTORTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A71A300)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__COMPUTEDISTORTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A719E60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__COMPUTEDISTORTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A719E40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__ComputeDistortion_TypeDefinitionIndex = 35655;
