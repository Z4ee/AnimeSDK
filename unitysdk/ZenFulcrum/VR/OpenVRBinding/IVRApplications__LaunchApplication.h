...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6060)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6090)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEECA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF5FF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchApplication_TypeDefinitionIndex = 36803;
