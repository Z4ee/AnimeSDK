...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__FORCEBOUNDSVISIBLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB1C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__FORCEBOUNDSVISIBLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB210)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__FORCEBOUNDSVISIBLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CA0A00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__FORCEBOUNDSVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB1A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperone__ForceBoundsVisible_TypeDefinitionIndex = 30034;
