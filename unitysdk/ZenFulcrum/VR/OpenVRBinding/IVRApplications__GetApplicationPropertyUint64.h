...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5450)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF54F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEEFD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF53D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationPropertyUint64_TypeDefinitionIndex = 36813;
