...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E5960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E5A00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6D5BB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYUINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E5940)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationPropertyUint64_TypeDefinitionIndex = 35731;
