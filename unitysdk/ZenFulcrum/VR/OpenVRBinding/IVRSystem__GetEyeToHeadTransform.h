...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE26C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE2730)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE26A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE2630)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetEyeToHeadTransform_TypeDefinitionIndex = 37597;
