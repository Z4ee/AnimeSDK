...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5258D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B525940)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5258B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETEYETOHEADTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B525840)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetEyeToHeadTransform_TypeDefinitionIndex = 35956;
