...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSEATEDZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CE5270)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSEATEDZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CE52A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSEATEDZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE4EE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSEATEDZEROPOSETOSTANDINGABSOLUTETRACKINGPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE4EC0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetSeatedZeroPoseToStandingAbsoluteTrackingPose_TypeDefinitionIndex = 29945;
