...
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GETGENERICINTERFACE_OFFSET UNITYSDK_OFFSET(0x1A728AB0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GETINITTOKEN_OFFSET UNITYSDK_OFFSET(0x1A728D30)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GETSTRINGFORHMDERROR_OFFSET UNITYSDK_OFFSET(0x1A728980)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_APPLICATIONS_OFFSET UNITYSDK_OFFSET(0x1A729D50)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_CHAPERONESETUP_OFFSET UNITYSDK_OFFSET(0x1A7292D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_CHAPERONE_OFFSET UNITYSDK_OFFSET(0x1A729110)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_COMPOSITOR_OFFSET UNITYSDK_OFFSET(0x1A729490)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_EXTENDEDDISPLAY_OFFSET UNITYSDK_OFFSET(0x1A7299D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_OPENVRINTERNAL_MODULECONTEXT_OFFSET UNITYSDK_OFFSET(0x1A728EA0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_OVERLAY_OFFSET UNITYSDK_OFFSET(0x1A729650)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_RENDERMODELS_OFFSET UNITYSDK_OFFSET(0x1A729810)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_SCREENSHOTS_OFFSET UNITYSDK_OFFSET(0x1A729F10)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A729B90)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_SYSTEM_OFFSET UNITYSDK_OFFSET(0x1A728F50)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_TRACKEDCAMERA_OFFSET UNITYSDK_OFFSET(0x1A72A0D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_GET_VRTOKEN_OFFSET UNITYSDK_OFFSET(0x1A728E30)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_INITINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A728560)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_INIT_OFFSET UNITYSDK_OFFSET(0x1A72A290)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_ISHMDPRESENT_OFFSET UNITYSDK_OFFSET(0x1A728780)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_ISINTERFACEVERSIONVALID_OFFSET UNITYSDK_OFFSET(0x1A728BF0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_ISRUNTIMEINSTALLED_OFFSET UNITYSDK_OFFSET(0x1A728880)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_SET_VRTOKEN_OFFSET UNITYSDK_OFFSET(0x1A728E70)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_SHUTDOWNINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A728680)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A72A5E0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72A660)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int OpenVR_TypeDefinitionIndex = 36089;
	...
	public:
		...
		{
			return (::ZenFulcrum::VR::OpenVRBinding::OpenVR_COpenVRContext**)Il2CppClass::FromTypeDefinitionIndex(OpenVR_TypeDefinitionIndex)->GetStaticField(0xFD0);
		}
		static ::System::UInt32* StaticGet__VRToken_k__BackingField()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(OpenVR_TypeDefinitionIndex)->GetStaticField(0xED0);
		}
