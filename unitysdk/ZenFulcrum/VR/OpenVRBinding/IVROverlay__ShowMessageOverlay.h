...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22D360)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22D3C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22D320)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22D2A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ShowMessageOverlay_TypeDefinitionIndex = 36982;
