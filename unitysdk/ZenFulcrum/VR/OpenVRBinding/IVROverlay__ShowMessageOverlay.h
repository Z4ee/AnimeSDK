...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5211C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B521220)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B521180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWMESSAGEOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B521100)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ShowMessageOverlay_TypeDefinitionIndex = 36200;
