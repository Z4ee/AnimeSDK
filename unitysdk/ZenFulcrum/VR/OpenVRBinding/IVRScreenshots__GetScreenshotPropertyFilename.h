...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBF790)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBF870)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBF750)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBF6E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__GetScreenshotPropertyFilename_TypeDefinitionIndex = 37882;
