...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B522BA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B522C80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B522B60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__GETSCREENSHOTPROPERTYFILENAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B522AF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__GetScreenshotPropertyFilename_TypeDefinitionIndex = 36241;
