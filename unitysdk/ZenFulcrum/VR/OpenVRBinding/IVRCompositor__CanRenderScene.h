...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAD0A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAD0D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CACDF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CACDD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__CanRenderScene_TypeDefinitionIndex = 30081;
