...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB43C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB43F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB43B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CANRENDERSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB4340)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__CanRenderScene_TypeDefinitionIndex = 37742;
