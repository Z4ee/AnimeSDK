...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISHOVERTARGETOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51E300)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISHOVERTARGETOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51E350)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISHOVERTARGETOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51E2F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISHOVERTARGETOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51E280)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__IsHoverTargetOverlay_TypeDefinitionIndex = 36173;
