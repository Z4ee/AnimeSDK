...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D7FCDF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D7FCE70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D7F6FE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FCD80)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationLaunchArguments_TypeDefinitionIndex = 37679;
