...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B514250)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5142D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B50E4A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONLAUNCHARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5141E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationLaunchArguments_TypeDefinitionIndex = 36038;
