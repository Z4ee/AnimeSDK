...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F55C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F5640)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F4F00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CREATEDASHBOARDOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F4EE0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__CreateDashboardOverlay_TypeDefinitionIndex = 35885;
