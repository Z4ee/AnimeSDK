...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__GETRESOURCEFULLPATH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22EAB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__GETRESOURCEFULLPATH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22EB20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__GETRESOURCEFULLPATH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22EA80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__GETRESOURCEFULLPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22EA00)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRResources__GetResourceFullPath_TypeDefinitionIndex = 37029;
