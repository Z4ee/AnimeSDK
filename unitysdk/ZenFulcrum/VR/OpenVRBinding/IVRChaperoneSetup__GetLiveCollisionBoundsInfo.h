...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVECOLLISIONBOUNDSINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D7FF100)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVECOLLISIONBOUNDSINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D7FF160)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVECOLLISIONBOUNDSINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D7F78A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVECOLLISIONBOUNDSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FF080)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__GetLiveCollisionBoundsInfo_TypeDefinitionIndex = 37702;
