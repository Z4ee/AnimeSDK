...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB9170)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB91C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB8E80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__CLEAROVERLAYTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB8E60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ClearOverlayTexture_TypeDefinitionIndex = 30159;
