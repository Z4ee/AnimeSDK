...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC0510)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC0580)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC0500)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC0490)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__GetSettingsErrorNameFromEnum_TypeDefinitionIndex = 37866;
