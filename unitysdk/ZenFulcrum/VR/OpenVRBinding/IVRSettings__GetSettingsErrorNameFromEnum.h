...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDA2A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDA310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD9FB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETSETTINGSERRORNAMEFROMENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD9F90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__GetSettingsErrorNameFromEnum_TypeDefinitionIndex = 30205;
