...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D269120)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D269200)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2690E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D269070)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetStringTrackedDeviceProperty_TypeDefinitionIndex = 36761;
