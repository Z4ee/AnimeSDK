...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5A4B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5A590)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5A470)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETSTRINGTRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF5A400)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetStringTrackedDeviceProperty_TypeDefinitionIndex = 37620;
