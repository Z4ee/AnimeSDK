...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETKEYBOARDTEXT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CBC220)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETKEYBOARDTEXT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CBC280)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETKEYBOARDTEXT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CBBCC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETKEYBOARDTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBBCA0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetKeyboardText_TypeDefinitionIndex = 30174;
