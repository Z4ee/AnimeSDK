...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__FINDOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2275E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__FINDOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B227640)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__FINDOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B2275D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__FINDOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B227550)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__FindOverlay_TypeDefinitionIndex = 36903;
