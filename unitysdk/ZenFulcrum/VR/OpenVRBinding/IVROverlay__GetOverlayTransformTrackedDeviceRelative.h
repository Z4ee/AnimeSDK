...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTRANSFORMTRACKEDDEVICERELATIVE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2299A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTRANSFORMTRACKEDDEVICERELATIVE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B229A50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTRANSFORMTRACKEDDEVICERELATIVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B229980)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTRANSFORMTRACKEDDEVICERELATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B229910)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayTransformTrackedDeviceRelative_TypeDefinitionIndex = 36939;
