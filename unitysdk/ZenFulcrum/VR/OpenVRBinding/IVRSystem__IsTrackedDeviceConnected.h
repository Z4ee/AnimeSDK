...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISTRACKEDDEVICECONNECTED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A722F10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISTRACKEDDEVICECONNECTED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A722F60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISTRACKEDDEVICECONNECTED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A722C10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ISTRACKEDDEVICECONNECTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A722BF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__IsTrackedDeviceConnected_TypeDefinitionIndex = 35673;
