...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF28B0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF2980)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF2700)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF2830)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRRenderModels__GetComponentStatePacked_TypeDefinitionIndex = 37050;
