...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CA77D0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CA78A0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CA7000)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__GETCOMPONENTSTATEPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA77B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRRenderModels__GetComponentStatePacked_TypeDefinitionIndex = 30248;
