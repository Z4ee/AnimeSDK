...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETBOOLTRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDF610)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETBOOLTRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDF6C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETBOOLTRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDF270)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETBOOLTRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDF250)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetBoolTrackedDeviceProperty_TypeDefinitionIndex = 29954;
