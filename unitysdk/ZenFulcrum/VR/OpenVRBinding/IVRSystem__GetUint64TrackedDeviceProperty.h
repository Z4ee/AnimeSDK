...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC3CE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC3D90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC3CC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETUINT64TRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC3C50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetUint64TrackedDeviceProperty_TypeDefinitionIndex = 37618;
