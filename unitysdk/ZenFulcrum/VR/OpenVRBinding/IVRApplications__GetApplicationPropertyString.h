...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAA2F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAA3C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C99950)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAA2D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationPropertyString_TypeDefinitionIndex = 30009;
