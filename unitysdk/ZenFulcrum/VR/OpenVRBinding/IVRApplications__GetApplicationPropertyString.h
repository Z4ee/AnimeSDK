...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB1190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB1260)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFAAD70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB1110)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationPropertyString_TypeDefinitionIndex = 37670;
