...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2282C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B228390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B228290)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B228220)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayImageData_TypeDefinitionIndex = 36911;
