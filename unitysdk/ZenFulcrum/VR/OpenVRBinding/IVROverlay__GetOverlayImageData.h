...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CBE150)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CBE220)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CBDCF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYIMAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBDCD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayImageData_TypeDefinitionIndex = 30109;
