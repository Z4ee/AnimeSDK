...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELCOUNT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A70E0A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELCOUNT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A70E0D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A70DDF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A70DDD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetRenderModelCount_TypeDefinitionIndex = 35911;
