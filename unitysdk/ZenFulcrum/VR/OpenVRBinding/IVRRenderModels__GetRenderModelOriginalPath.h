...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E1E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E290)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E1B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22E130)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetRenderModelOriginalPath_TypeDefinitionIndex = 37001;
