...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDEE30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDEEE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDEE00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELORIGINALPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDED80)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetRenderModelOriginalPath_TypeDefinitionIndex = 37860;
