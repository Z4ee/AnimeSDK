...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A701D40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A701DB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A7019D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETDASHBOARDOVERLAYSCENEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7019B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetDashboardOverlaySceneProcess_TypeDefinitionIndex = 35888;
