...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB69A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB69F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB66B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB6690)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__UnlockGLSharedTextureForAccess_TypeDefinitionIndex = 30095;
