...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2262D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B226320)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B2262C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__UNLOCKGLSHAREDTEXTUREFORACCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B226250)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__UnlockGLSharedTextureForAccess_TypeDefinitionIndex = 36897;
