...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E990)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E9D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E980)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22E900)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__RenderModelHasComponent_TypeDefinitionIndex = 36999;
