...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBF3E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBF420)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBF3D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__RENDERMODELHASCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBF350)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__RenderModelHasComponent_TypeDefinitionIndex = 37858;
