...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B231D30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B231DC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B231D00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B231C90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetHiddenAreaMesh_TypeDefinitionIndex = 36766;
