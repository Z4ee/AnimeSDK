...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CE28A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CE2930)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE2470)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETHIDDENAREAMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE2450)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetHiddenAreaMesh_TypeDefinitionIndex = 29964;
