...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRDRIVERMANAGER_GETDRIVERCOUNT_OFFSET UNITYSDK_OFFSET(0x1EFAC7C0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRDRIVERMANAGER_GETDRIVERNAME_OFFSET UNITYSDK_OFFSET(0x1EFAC7F0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRDRIVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFAC6F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRDriverManager_TypeDefinitionIndex = 37915;
