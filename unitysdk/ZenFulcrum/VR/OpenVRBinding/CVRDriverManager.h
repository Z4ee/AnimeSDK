...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRDRIVERMANAGER_GETDRIVERCOUNT_OFFSET UNITYSDK_OFFSET(0x1D7F8770)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRDRIVERMANAGER_GETDRIVERNAME_OFFSET UNITYSDK_OFFSET(0x1D7F87A0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRDRIVERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7F86A0)
