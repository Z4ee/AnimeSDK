...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E5E90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E5EF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6D8A00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E5E70)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetStartingApplication_TypeDefinitionIndex = 35739;
