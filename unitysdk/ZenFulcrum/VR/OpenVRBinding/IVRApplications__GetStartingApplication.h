...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B514EC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B514F20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B50E4F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETSTARTINGAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B514E40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetStartingApplication_TypeDefinitionIndex = 36039;
