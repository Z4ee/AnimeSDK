...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANDEVICEEXTENSIONSREQUIRED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B225260)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANDEVICEEXTENSIONSREQUIRED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2252E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANDEVICEEXTENSIONSREQUIRED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B225240)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANDEVICEEXTENSIONSREQUIRED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2251D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetVulkanDeviceExtensionsRequired_TypeDefinitionIndex = 36899;
