...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBDEC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBDF10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBDEB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBDE40)
