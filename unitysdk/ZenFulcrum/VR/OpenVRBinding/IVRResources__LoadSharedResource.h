...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__LOADSHAREDRESOURCE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD6A70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__LOADSHAREDRESOURCE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD6AE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__LOADSHAREDRESOURCE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD6430)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRESOURCES__LOADSHAREDRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD6410)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRResources__LoadSharedResource_TypeDefinitionIndex = 30226;
