...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTSTATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22DCE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTSTATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22DDB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22DCB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22DC30)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetComponentState_TypeDefinitionIndex = 36998;
