...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B225170)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2251A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B225160)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETTRACKINGSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2250F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetTrackingSpace_TypeDefinitionIndex = 36860;
