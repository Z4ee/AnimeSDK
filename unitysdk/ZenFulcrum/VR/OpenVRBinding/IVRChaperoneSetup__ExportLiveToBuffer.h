...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__EXPORTLIVETOBUFFER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB720)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__EXPORTLIVETOBUFFER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB780)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__EXPORTLIVETOBUFFER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CA4380)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__EXPORTLIVETOBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB700)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__ExportLiveToBuffer_TypeDefinitionIndex = 30054;
