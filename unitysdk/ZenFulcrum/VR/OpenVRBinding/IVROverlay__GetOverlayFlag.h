...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAG_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B228020)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAG_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2280D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAG_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B228000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B227F90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayFlag_TypeDefinitionIndex = 36916;
