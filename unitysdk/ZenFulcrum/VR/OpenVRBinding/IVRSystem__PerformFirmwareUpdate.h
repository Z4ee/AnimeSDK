...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__PERFORMFIRMWAREUPDATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CE7D50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__PERFORMFIRMWAREUPDATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CE7DA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__PERFORMFIRMWAREUPDATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE7A60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__PERFORMFIRMWAREUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE7A40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__PerformFirmwareUpdate_TypeDefinitionIndex = 29974;
