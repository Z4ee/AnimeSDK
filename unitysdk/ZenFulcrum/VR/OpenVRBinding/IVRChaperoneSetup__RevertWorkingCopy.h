...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E74F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E7520)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6DC700)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__REVERTWORKINGCOPY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E74D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__RevertWorkingCopy_TypeDefinitionIndex = 35757;
