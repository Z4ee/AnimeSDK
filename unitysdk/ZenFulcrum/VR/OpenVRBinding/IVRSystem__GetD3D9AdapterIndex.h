...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETD3D9ADAPTERINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B525460)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETD3D9ADAPTERINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B525490)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETD3D9ADAPTERINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B525450)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETD3D9ADAPTERINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5253E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetD3D9AdapterIndex_TypeDefinitionIndex = 35958;
