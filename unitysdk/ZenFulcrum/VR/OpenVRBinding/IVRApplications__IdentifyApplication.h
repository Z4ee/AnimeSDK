...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5DC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5E20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEEE10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__IDENTIFYAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF5D50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__IdentifyApplication_TypeDefinitionIndex = 36808;
