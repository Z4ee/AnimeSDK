...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYCOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBBD00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYCOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBBDB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBBCD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBBC60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayColor_TypeDefinitionIndex = 37776;
