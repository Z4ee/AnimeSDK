...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETPRIMARYDASHBOARDDEVICE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B229D60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETPRIMARYDASHBOARDDEVICE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B229D90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETPRIMARYDASHBOARDDEVICE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B229D50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETPRIMARYDASHBOARDDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B229CE0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetPrimaryDashboardDevice_TypeDefinitionIndex = 36973;
