...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMFRAMEBUFFER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CEB1E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMFRAMEBUFFER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CEB2F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMFRAMEBUFFER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CEADB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMFRAMEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CEAD90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__GetVideoStreamFrameBuffer_TypeDefinitionIndex = 29989;
