...
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B226A80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B226B30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B226A50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2269D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRExtendedDisplay__GetWindowBounds_TypeDefinitionIndex = 36780;
