...
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F38C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F3970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F3540)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F3520)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRExtendedDisplay__GetWindowBounds_TypeDefinitionIndex = 35698;
