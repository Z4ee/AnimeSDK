...
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A8E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A990)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A8B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETWINDOWBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51A830)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRExtendedDisplay__GetWindowBounds_TypeDefinitionIndex = 35998;
