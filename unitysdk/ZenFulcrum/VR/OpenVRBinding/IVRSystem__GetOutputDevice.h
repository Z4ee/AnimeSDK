...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2321B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B232260)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B232190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETOUTPUTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B232110)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetOutputDevice_TypeDefinitionIndex = 36742;
