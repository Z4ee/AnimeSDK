...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYRENDERMODEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CBF990)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYRENDERMODEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CBFA80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYRENDERMODEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CBF530)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYRENDERMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBF510)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayRenderModel_TypeDefinitionIndex = 30131;
