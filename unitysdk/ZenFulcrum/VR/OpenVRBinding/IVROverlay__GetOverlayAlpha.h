...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F7B90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F7C00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F7820)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F7800)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayAlpha_TypeDefinitionIndex = 35838;
