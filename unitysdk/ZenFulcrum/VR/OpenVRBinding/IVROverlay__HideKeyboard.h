...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CC4570)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CC45A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CC42D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC42B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__HideKeyboard_TypeDefinitionIndex = 30175;
