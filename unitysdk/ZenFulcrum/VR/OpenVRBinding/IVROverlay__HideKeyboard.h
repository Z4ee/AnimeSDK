...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDAD50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDAD80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDAD40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__HIDEKEYBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDACD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__HideKeyboard_TypeDefinitionIndex = 37836;
