...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASESHAREDGLTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB4830)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASESHAREDGLTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB48A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASESHAREDGLTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB44E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__RELEASESHAREDGLTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB44C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ReleaseSharedGLTexture_TypeDefinitionIndex = 30093;
