...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURESIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6FCFD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURESIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6FD060)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURESIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6FCC30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6FCC10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayTextureSize_TypeDefinitionIndex = 35884;
