...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E61F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E6230)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6D31A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E61D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchApplicationFromMimeType_TypeDefinitionIndex = 35723;
