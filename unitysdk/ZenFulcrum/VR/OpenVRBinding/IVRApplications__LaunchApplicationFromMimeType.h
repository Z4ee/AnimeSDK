...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6140)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEED50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHAPPLICATIONFROMMIMETYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF60C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchApplicationFromMimeType_TypeDefinitionIndex = 36805;
