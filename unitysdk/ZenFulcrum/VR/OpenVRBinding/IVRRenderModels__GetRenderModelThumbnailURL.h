...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELTHUMBNAILURL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDEFC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELTHUMBNAILURL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDF070)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELTHUMBNAILURL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDEF90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELTHUMBNAILURL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDEF10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetRenderModelThumbnailURL_TypeDefinitionIndex = 37859;
