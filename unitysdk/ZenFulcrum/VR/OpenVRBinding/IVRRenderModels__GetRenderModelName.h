...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B521EE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B521F60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B521EC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B521E50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetRenderModelName_TypeDefinitionIndex = 36210;
