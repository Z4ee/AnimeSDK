...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD3310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD3390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD2F80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETRENDERMODELNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD2F60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetRenderModelName_TypeDefinitionIndex = 30190;
