...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCUMULATIVESTATS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB4DA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCUMULATIVESTATS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB4E30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCUMULATIVESTATS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB4D90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCUMULATIVESTATS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB4D10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetCumulativeStats_TypeDefinitionIndex = 37729;
