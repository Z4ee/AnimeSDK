...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B519670)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5196A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B519660)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5195F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__PostPresentHandoff_TypeDefinitionIndex = 36084;
