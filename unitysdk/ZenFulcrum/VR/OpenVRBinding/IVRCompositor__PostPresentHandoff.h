...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B225810)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B225840)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B225800)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__POSTPRESENTHANDOFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B225790)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__PostPresentHandoff_TypeDefinitionIndex = 36866;
