...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__APPLYTRANSFORM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1320)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__APPLYTRANSFORM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC13D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__APPLYTRANSFORM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC1300)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__APPLYTRANSFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC1280)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__ApplyTransform_TypeDefinitionIndex = 37610;
