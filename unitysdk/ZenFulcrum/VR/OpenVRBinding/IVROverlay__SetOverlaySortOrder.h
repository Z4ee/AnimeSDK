...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CCB5D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CCB640)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CCB260)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYSORTORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCB240)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlaySortOrder_TypeDefinitionIndex = 30121;
