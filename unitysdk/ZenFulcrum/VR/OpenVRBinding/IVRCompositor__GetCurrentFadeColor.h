...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EB130)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EB180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6EAD60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETCURRENTFADECOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6EAD40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetCurrentFadeColor_TypeDefinitionIndex = 35790;
