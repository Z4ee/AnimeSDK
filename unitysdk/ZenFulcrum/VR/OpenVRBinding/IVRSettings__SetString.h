...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETSTRING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDD650)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETSTRING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDD6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETSTRING_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDCF90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDCF70)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__SetString_TypeDefinitionIndex = 30210;
