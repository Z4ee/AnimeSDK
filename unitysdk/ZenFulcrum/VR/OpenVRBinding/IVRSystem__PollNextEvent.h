...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5AFD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5B060)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5AFC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF5AF40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__PollNextEvent_TypeDefinitionIndex = 37622;
