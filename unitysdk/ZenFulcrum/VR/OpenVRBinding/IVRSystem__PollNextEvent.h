...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7236A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A723730)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A723340)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A723320)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__PollNextEvent_TypeDefinitionIndex = 35681;
