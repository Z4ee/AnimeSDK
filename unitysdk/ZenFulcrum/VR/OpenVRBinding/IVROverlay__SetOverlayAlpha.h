...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CC7BF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CC7C70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CC78C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYALPHA__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC78A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayAlpha_TypeDefinitionIndex = 30117;
