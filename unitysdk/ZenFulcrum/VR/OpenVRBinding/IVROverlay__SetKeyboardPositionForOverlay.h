...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDPOSITIONFOROVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22ADB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDPOSITIONFOROVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22AE40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDPOSITIONFOROVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22AD80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETKEYBOARDPOSITIONFOROVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22AD10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetKeyboardPositionForOverlay_TypeDefinitionIndex = 36979;
