...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYWIDTHINMETERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDD970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYWIDTHINMETERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDD9F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYWIDTHINMETERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDD960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYWIDTHINMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDD8F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayWidthInMeters_TypeDefinitionIndex = 37784;
