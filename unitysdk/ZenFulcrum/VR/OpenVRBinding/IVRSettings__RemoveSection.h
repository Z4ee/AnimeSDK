...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB840)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB8C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB2C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVESECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDB2A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__RemoveSection_TypeDefinitionIndex = 30215;
