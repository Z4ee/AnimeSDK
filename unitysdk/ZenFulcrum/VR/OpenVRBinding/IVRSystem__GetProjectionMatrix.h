...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC2D80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC2E30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC2D40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC2CD0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetProjectionMatrix_TypeDefinitionIndex = 37594;
