...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B232330)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2323E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B2322F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B232280)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetProjectionMatrix_TypeDefinitionIndex = 36735;
