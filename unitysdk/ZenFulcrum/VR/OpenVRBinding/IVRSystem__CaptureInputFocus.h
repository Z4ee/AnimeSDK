...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDE890)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDE8C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDE5E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__CAPTUREINPUTFOCUS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDE5C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__CaptureInputFocus_TypeDefinitionIndex = 29970;
