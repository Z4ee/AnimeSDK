...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B228180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2281F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B228170)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B228100)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayFlags_TypeDefinitionIndex = 36981;
