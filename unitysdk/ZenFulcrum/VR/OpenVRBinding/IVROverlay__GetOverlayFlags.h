...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51BFE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51C050)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51BFD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51BF60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayFlags_TypeDefinitionIndex = 36199;
