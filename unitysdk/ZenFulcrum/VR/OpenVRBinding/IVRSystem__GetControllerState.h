...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERSTATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A71BAF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERSTATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A71BBA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERSTATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A71B750)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETCONTROLLERSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A71B730)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetControllerState_TypeDefinitionIndex = 35685;
