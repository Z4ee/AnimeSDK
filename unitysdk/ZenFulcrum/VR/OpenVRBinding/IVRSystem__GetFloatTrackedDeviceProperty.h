...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETFLOATTRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B231BB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETFLOATTRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B231C60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETFLOATTRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B231B90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETFLOATTRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B231B20)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetFloatTrackedDeviceProperty_TypeDefinitionIndex = 36757;
