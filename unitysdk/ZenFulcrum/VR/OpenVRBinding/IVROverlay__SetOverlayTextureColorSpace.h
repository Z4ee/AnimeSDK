...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURECOLORSPACE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A707BF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURECOLORSPACE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A707C80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURECOLORSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A707880)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURECOLORSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A707860)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayTextureColorSpace_TypeDefinitionIndex = 35847;
