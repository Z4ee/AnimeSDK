...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB0D20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB0DA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFAAAB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB0CB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationKeyByProcessId_TypeDefinitionIndex = 37661;
