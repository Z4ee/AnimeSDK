...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4E60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4EE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEEC50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYPROCESSID__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF4DF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationKeyByProcessId_TypeDefinitionIndex = 36802;
