...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF63F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF6460)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEECF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF6370)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchTemplateApplication_TypeDefinitionIndex = 36804;
