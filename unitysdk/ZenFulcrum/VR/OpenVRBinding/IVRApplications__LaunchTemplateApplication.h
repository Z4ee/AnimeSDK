...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5156C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B515730)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B50DFC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHTEMPLATEAPPLICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B515640)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchTemplateApplication_TypeDefinitionIndex = 36022;
