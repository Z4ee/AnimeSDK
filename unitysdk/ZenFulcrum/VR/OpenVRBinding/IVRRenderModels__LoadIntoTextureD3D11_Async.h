...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADINTOTEXTURED3D11_ASYNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E4D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADINTOTEXTURED3D11_ASYNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E540)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADINTOTEXTURED3D11_ASYNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22E4C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__LOADINTOTEXTURED3D11_ASYNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22E450)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__LoadIntoTextureD3D11_Async_TypeDefinitionIndex = 36990;
