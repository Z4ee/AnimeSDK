...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYKEY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51C400)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYKEY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51C4C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYKEY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51C3D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51C360)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayKey_TypeDefinitionIndex = 36126;
