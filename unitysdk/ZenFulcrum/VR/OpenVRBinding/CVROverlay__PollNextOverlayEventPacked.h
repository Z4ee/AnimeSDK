...
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF2140)
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF21F0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF1880)
#define ZENFULCRUM_VR_OPENVRBINDING_CVROVERLAY__POLLNEXTOVERLAYEVENTPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF20D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVROverlay__PollNextOverlayEventPacked_TypeDefinitionIndex = 37047;
