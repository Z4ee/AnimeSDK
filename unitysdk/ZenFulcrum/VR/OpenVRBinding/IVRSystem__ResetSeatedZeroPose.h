...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__RESETSEATEDZEROPOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D269FE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__RESETSEATEDZEROPOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A010)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__RESETSEATEDZEROPOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D269FD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__RESETSEATEDZEROPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D269F60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__ResetSeatedZeroPose_TypeDefinitionIndex = 36746;
