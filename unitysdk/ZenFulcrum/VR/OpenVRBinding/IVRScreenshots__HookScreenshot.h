...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__HOOKSCREENSHOT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F020)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__HOOKSCREENSHOT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F080)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__HOOKSCREENSHOT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F010)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__HOOKSCREENSHOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22EF90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__HookScreenshot_TypeDefinitionIndex = 37021;
