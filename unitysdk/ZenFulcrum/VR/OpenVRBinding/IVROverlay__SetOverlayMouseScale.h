...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B980)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22BA10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22B900)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayMouseScale_TypeDefinitionIndex = 36952;
