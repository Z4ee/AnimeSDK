...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51F7E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51F870)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51F7D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYMOUSESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51F760)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayMouseScale_TypeDefinitionIndex = 36170;
