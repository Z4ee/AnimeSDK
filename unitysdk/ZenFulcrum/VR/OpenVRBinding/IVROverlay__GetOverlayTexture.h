...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB9970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB9AE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB9920)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB98B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayTexture_TypeDefinitionIndex = 37823;
