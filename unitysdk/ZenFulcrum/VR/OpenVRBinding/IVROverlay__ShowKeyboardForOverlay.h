...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARDFOROVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B520FC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARDFOROVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5210D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARDFOROVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B520F50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SHOWKEYBOARDFOROVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B520EE0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ShowKeyboardForOverlay_TypeDefinitionIndex = 36193;
