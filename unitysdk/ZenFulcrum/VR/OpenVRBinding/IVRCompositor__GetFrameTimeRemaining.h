...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMEREMAINING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB51A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMEREMAINING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB51D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMEREMAINING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB5190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMEREMAINING__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB5120)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetFrameTimeRemaining_TypeDefinitionIndex = 37728;
