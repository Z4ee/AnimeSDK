...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORQUIT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B517C70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORQUIT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B517CA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORQUIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B517C60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORQUIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B517BF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__CompositorQuit_TypeDefinitionIndex = 36097;
