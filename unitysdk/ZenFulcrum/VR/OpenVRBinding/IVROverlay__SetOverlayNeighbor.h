...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBC640)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBC6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBC620)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBC5B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayNeighbor_TypeDefinitionIndex = 37817;
