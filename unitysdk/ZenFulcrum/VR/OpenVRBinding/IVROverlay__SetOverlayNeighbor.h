...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A7058F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7059A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A705550)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYNEIGHBOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A705530)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayNeighbor_TypeDefinitionIndex = 35876;
