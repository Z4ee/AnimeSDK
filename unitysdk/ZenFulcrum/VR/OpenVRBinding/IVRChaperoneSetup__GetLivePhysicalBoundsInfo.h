...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB3370)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB33D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFABCC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB32F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__GetLivePhysicalBoundsInfo_TypeDefinitionIndex = 37714;
