...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E6E80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E6EE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6DF540)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__GETLIVEPHYSICALBOUNDSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E6E60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__GetLivePhysicalBoundsInfo_TypeDefinitionIndex = 35773;
