...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISOVERLAYVISIBLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22A5A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISOVERLAYVISIBLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22A5F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISOVERLAYVISIBLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22A590)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__ISOVERLAYVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22A520)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__IsOverlayVisible_TypeDefinitionIndex = 36946;
