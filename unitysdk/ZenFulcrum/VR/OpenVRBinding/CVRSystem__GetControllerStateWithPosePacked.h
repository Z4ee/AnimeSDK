...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEWITHPOSEPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF42A0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEWITHPOSEPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF4390)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEWITHPOSEPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF3E70)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__GETCONTROLLERSTATEWITHPOSEPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF4230)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRSystem__GetControllerStateWithPosePacked_TypeDefinitionIndex = 37038;
