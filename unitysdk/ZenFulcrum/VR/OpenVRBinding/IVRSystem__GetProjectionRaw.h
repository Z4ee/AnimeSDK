...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONRAW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A71F6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONRAW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A71F7F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONRAW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A71F280)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETPROJECTIONRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A71F260)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetProjectionRaw_TypeDefinitionIndex = 35654;
