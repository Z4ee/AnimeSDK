...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CBEF40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CBEFD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CBEBD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYMOUSESCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBEBB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlayMouseScale_TypeDefinitionIndex = 30149;
