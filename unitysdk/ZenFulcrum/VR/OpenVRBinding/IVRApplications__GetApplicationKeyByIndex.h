...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CA9F10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CA9F90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C96880)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18CA9EF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationKeyByIndex_TypeDefinitionIndex = 29999;
