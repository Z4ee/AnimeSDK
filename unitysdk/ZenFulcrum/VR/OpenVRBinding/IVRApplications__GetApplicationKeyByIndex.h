...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB0C00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB0C80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFAAA60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONKEYBYINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB0B90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationKeyByIndex_TypeDefinitionIndex = 37660;
