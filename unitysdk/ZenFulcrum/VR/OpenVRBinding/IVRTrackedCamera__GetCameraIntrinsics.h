...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAINTRINSICS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5280F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAINTRINSICS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5281C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAINTRINSICS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5280C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAINTRINSICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B528050)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__GetCameraIntrinsics_TypeDefinitionIndex = 36005;
