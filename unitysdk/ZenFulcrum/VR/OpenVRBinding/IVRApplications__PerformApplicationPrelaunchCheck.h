...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__PERFORMAPPLICATIONPRELAUNCHCHECK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB23C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__PERFORMAPPLICATIONPRELAUNCHCHECK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB23F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__PERFORMAPPLICATIONPRELAUNCHCHECK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFAB100)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__PERFORMAPPLICATIONPRELAUNCHCHECK__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB2350)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__PerformApplicationPrelaunchCheck_TypeDefinitionIndex = 37682;
