...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB0300)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB0390)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFAF930)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB0280)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRSystem__PollNextEventPacked_TypeDefinitionIndex = 37893;
