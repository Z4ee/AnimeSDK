...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E4E50)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E4EE0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E3BA0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRSYSTEM__POLLNEXTEVENTPACKED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E4E30)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRSystem__PollNextEventPacked_TypeDefinitionIndex = 35952;
