...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__IMPORTFROMBUFFERTOWORKING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E73A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__IMPORTFROMBUFFERTOWORKING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6E7400)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__IMPORTFROMBUFFERTOWORKING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6DFEB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__IMPORTFROMBUFFERTOWORKING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6E7380)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__ImportFromBufferToWorking_TypeDefinitionIndex = 35775;
