...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB30F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB3150)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB2B90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETVULKANINSTANCEEXTENSIONSREQUIRED__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB2B70)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetVulkanInstanceExtensionsRequired_TypeDefinitionIndex = 30096;
