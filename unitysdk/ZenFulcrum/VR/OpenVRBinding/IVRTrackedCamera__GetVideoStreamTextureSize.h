...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMTEXTURESIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5C3E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMTEXTURESIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5C4E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMTEXTURESIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF5C3B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETVIDEOSTREAMTEXTURESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF5C340)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__GetVideoStreamTextureSize_TypeDefinitionIndex = 37651;
