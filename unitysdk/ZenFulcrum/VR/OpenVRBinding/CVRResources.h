...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRESOURCES_GETRESOURCEFULLPATH_OFFSET UNITYSDK_OFFSET(0x1BBF2AC0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRESOURCES_LOADSHAREDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1BBF2A90)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF29C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRResources_TypeDefinitionIndex = 37055;
