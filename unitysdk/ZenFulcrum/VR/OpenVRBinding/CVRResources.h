...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRESOURCES_GETRESOURCEFULLPATH_OFFSET UNITYSDK_OFFSET(0x1B511D90)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRESOURCES_LOADSHAREDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1B511D60)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B511C90)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRResources_TypeDefinitionIndex = 36273;
