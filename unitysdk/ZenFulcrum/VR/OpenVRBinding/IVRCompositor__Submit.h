...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F13C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F1490)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F1000)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F0FE0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__Submit_TypeDefinitionIndex = 35782;
