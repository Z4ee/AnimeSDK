...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B225F90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B226060)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B225F60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SUBMIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B225EF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__Submit_TypeDefinitionIndex = 36864;
