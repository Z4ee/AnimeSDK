...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F6070)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F60C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F5D80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__DESTROYOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F5D60)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__DestroyOverlay_TypeDefinitionIndex = 35823;
