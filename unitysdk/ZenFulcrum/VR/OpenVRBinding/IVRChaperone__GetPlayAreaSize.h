...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETPLAYAREASIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB4A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETPLAYAREASIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAB510)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETPLAYAREASIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C9F590)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONE__GETPLAYAREASIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAB480)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperone__GetPlayAreaSize_TypeDefinitionIndex = 30028;
