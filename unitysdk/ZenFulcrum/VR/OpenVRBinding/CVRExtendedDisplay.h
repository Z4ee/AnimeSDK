...
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY_GETDXGIOUTPUTINFO_OFFSET UNITYSDK_OFFSET(0x1EFAC9B0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY_GETEYEOUTPUTVIEWPORT_OFFSET UNITYSDK_OFFSET(0x1EFAC950)
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY_GETWINDOWBOUNDS_OFFSET UNITYSDK_OFFSET(0x1EFAC900)
#define ZENFULCRUM_VR_OPENVRBINDING_CVREXTENDEDDISPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFAC820)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRExtendedDisplay_TypeDefinitionIndex = 37899;
