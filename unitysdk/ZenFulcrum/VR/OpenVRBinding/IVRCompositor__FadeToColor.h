...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FADETOCOLOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAEBE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FADETOCOLOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAECD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FADETOCOLOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CAE740)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FADETOCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAE720)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__FadeToColor_TypeDefinitionIndex = 30069;
