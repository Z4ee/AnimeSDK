...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARSKYBOXOVERRIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B517970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARSKYBOXOVERRIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5179A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARSKYBOXOVERRIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B517960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARSKYBOXOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5178F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ClearSkyboxOverride_TypeDefinitionIndex = 36094;
