...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC4670)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC46C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC4660)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC45F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__SetDisplayVisibility_TypeDefinitionIndex = 37603;
