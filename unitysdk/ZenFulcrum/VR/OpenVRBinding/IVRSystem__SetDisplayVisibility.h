...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A0A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A0F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A090)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__SETDISPLAYVISIBILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D26A020)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__SetDisplayVisibility_TypeDefinitionIndex = 36744;
