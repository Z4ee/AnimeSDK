...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETINT32_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F980)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETINT32_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22FA10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETINT32_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22F8E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__GetInt32_TypeDefinitionIndex = 37014;
