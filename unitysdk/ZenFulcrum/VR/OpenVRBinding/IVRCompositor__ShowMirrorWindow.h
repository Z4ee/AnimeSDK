...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F0FA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F0FD0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F0D00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F0CE0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ShowMirrorWindow_TypeDefinitionIndex = 35802;
