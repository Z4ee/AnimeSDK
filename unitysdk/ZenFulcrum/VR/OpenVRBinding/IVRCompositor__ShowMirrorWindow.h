...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CED6B00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CED6B30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CED6AF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__SHOWMIRRORWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED6A80)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ShowMirrorWindow_TypeDefinitionIndex = 37743;
