...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD01C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD0210)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CCFED0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCFEB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__FreeTexture_TypeDefinitionIndex = 30186;
