...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERCOUNT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A380)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERCOUNT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A3B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERCOUNT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A370)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51A300)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRDriverManager__GetDriverCount_TypeDefinitionIndex = 36249;
