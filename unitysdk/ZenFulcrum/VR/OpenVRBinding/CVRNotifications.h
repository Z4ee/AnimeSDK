...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRNOTIFICATIONS_CREATENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1EFACAC0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRNOTIFICATIONS_REMOVENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1EFACB30)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRNOTIFICATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFAC9F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRNotifications_TypeDefinitionIndex = 37911;
