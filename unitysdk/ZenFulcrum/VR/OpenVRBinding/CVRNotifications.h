...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRNOTIFICATIONS_CREATENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1B50FF10)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRNOTIFICATIONS_REMOVENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1B50FF80)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRNOTIFICATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B50FE40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRNotifications_TypeDefinitionIndex = 36270;
