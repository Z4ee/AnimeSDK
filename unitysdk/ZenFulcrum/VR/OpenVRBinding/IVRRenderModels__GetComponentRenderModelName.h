...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDE7E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDE850)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDE7B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDE730)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetComponentRenderModelName_TypeDefinitionIndex = 37856;
