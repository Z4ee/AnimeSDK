...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A70D500)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A70D570)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A70CE40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__GETCOMPONENTRENDERMODELNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A70CE20)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__GetComponentRenderModelName_TypeDefinitionIndex = 35915;
