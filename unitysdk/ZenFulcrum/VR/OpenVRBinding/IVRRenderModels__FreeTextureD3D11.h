...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURED3D11_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBE180)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURED3D11_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBE1D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURED3D11_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBE170)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREETEXTURED3D11__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBE100)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__FreeTextureD3D11_TypeDefinitionIndex = 37850;
