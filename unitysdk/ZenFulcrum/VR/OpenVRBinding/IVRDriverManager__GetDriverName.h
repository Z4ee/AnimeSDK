...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F2A90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F2B10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F2700)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRDRIVERMANAGER__GETDRIVERNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F26E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRDriverManager__GetDriverName_TypeDefinitionIndex = 35950;
