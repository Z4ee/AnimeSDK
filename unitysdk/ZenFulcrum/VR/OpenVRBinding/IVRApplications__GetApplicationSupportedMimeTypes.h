...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSUPPORTEDMIMETYPES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF55A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSUPPORTEDMIMETYPES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF5610)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSUPPORTEDMIMETYPES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF130)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONSUPPORTEDMIMETYPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF5520)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationSupportedMimeTypes_TypeDefinitionIndex = 36818;
