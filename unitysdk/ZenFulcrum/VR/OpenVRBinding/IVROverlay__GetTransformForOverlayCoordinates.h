...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDAAB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDAB80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDAA80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDAA10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetTransformForOverlayCoordinates_TypeDefinitionIndex = 37806;
