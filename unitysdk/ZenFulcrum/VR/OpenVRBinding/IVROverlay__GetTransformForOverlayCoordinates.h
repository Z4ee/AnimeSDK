...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6FF2D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6FF3A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6FEED0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETTRANSFORMFOROVERLAYCOORDINATES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6FEEB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetTransformForOverlayCoordinates_TypeDefinitionIndex = 35865;
