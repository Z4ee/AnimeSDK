...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__DRIVERDEBUGREQUEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDF190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__DRIVERDEBUGREQUEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDF220)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__DRIVERDEBUGREQUEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDEE00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__DRIVERDEBUGREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDEDE0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__DriverDebugRequest_TypeDefinitionIndex = 29973;
