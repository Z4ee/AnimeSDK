...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRECOMMENDEDRENDERTARGETSIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D268D40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRECOMMENDEDRENDERTARGETSIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D268DB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRECOMMENDEDRENDERTARGETSIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D268D30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETRECOMMENDEDRENDERTARGETSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D268CB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetRecommendedRenderTargetSize_TypeDefinitionIndex = 36734;
