...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B800)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B8D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B7D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINTERSECTIONMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22B760)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayIntersectionMask_TypeDefinitionIndex = 36980;
