...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_FREERENDERMODEL_OFFSET UNITYSDK_OFFSET(0x1BBF2330)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_FREETEXTURED3D11_OFFSET UNITYSDK_OFFSET(0x1BBF2420)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_FREETEXTURE_OFFSET UNITYSDK_OFFSET(0x1BBF2390)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTBUTTONMASK_OFFSET UNITYSDK_OFFSET(0x1BBF2520)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBF24B0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1BBF24E0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTRENDERMODELNAME_OFFSET UNITYSDK_OFFSET(0x1BBF2550)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTSTATE_OFFSET UNITYSDK_OFFSET(0x1BBF2590)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELCOUNT_OFFSET UNITYSDK_OFFSET(0x1BBF2480)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELERRORNAMEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1BBF27E0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELNAME_OFFSET UNITYSDK_OFFSET(0x1BBF2450)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELORIGINALPATH_OFFSET UNITYSDK_OFFSET(0x1BBF27A0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELTHUMBNAILURL_OFFSET UNITYSDK_OFFSET(0x1BBF2760)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADINTOTEXTURED3D11_ASYNC_OFFSET UNITYSDK_OFFSET(0x1BBF23F0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADRENDERMODEL_ASYNC_OFFSET UNITYSDK_OFFSET(0x1BBF2300)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADTEXTURED3D11_ASYNC_OFFSET UNITYSDK_OFFSET(0x1BBF23C0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADTEXTURE_ASYNC_OFFSET UNITYSDK_OFFSET(0x1BBF2360)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_RENDERMODELHASCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1BBF2730)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF2220)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int CVRRenderModels_TypeDefinitionIndex = 37049;
