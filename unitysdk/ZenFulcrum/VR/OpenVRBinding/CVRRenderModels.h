...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_FREERENDERMODEL_OFFSET UNITYSDK_OFFSET(0x1D7FA190)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_FREETEXTURED3D11_OFFSET UNITYSDK_OFFSET(0x1D7FA280)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_FREETEXTURE_OFFSET UNITYSDK_OFFSET(0x1D7FA1F0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTBUTTONMASK_OFFSET UNITYSDK_OFFSET(0x1D7FA380)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1D7FA310)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTNAME_OFFSET UNITYSDK_OFFSET(0x1D7FA340)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTRENDERMODELNAME_OFFSET UNITYSDK_OFFSET(0x1D7FA3B0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETCOMPONENTSTATE_OFFSET UNITYSDK_OFFSET(0x1D7FA3F0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELCOUNT_OFFSET UNITYSDK_OFFSET(0x1D7FA2E0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELERRORNAMEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1D7FA640)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELNAME_OFFSET UNITYSDK_OFFSET(0x1D7FA2B0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELORIGINALPATH_OFFSET UNITYSDK_OFFSET(0x1D7FA600)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_GETRENDERMODELTHUMBNAILURL_OFFSET UNITYSDK_OFFSET(0x1D7FA5C0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADINTOTEXTURED3D11_ASYNC_OFFSET UNITYSDK_OFFSET(0x1D7FA250)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADRENDERMODEL_ASYNC_OFFSET UNITYSDK_OFFSET(0x1D7FA160)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADTEXTURED3D11_ASYNC_OFFSET UNITYSDK_OFFSET(0x1D7FA220)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_LOADTEXTURE_ASYNC_OFFSET UNITYSDK_OFFSET(0x1D7FA1C0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS_RENDERMODELHASCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1D7FA590)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRRENDERMODELS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D7FA070)
