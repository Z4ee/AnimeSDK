...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENTWITHPOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CE8640)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENTWITHPOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CE8710)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENTWITHPOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE8230)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__POLLNEXTEVENTWITHPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE8210)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__PollNextEventWithPose_TypeDefinitionIndex = 29962;
