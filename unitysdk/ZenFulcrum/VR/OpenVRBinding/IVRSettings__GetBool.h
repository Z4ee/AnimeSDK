...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETBOOL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE0310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETBOOL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE03A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETBOOL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE02F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__GETBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE0270)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__GetBool_TypeDefinitionIndex = 37872;
