...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CC63C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CC6430)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CC6050)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC6030)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ReleaseNativeOverlayHandle_TypeDefinitionIndex = 30163;
