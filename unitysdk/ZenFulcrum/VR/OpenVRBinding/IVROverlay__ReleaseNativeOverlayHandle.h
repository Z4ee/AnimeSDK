...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDB5A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDB610)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDB590)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDB520)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ReleaseNativeOverlayHandle_TypeDefinitionIndex = 37824;
