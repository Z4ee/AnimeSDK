...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22A950)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22A9C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22A940)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__RELEASENATIVEOVERLAYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22A8D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__ReleaseNativeOverlayHandle_TypeDefinitionIndex = 36965;
