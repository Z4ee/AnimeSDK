...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CE16F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CE17B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE1300)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE12E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetDeviceToAbsoluteTrackingPose_TypeDefinitionIndex = 29943;
