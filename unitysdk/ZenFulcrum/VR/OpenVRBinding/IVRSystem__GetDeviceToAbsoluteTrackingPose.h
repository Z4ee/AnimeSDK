...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B525650)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B525710)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B525620)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETDEVICETOABSOLUTETRACKINGPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5255B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetDeviceToAbsoluteTrackingPose_TypeDefinitionIndex = 35963;
