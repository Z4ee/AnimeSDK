...
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_CHECKCLEAR_OFFSET UNITYSDK_OFFSET(0x1D26E1C0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D26E110)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRAPPLICATIONS_OFFSET UNITYSDK_OFFSET(0x1D26D610)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCHAPERONESETUP_OFFSET UNITYSDK_OFFSET(0x1D26C4D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCHAPERONE_OFFSET UNITYSDK_OFFSET(0x1D26C1F0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCOMPOSITOR_OFFSET UNITYSDK_OFFSET(0x1D26C7B0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VREXTENDEDDISPLAY_OFFSET UNITYSDK_OFFSET(0x1D26D050)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VROVERLAY_OFFSET UNITYSDK_OFFSET(0x1D26CA90)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRRENDERMODELS_OFFSET UNITYSDK_OFFSET(0x1D26CD70)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSCREENSHOTS_OFFSET UNITYSDK_OFFSET(0x1D26D8F0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSETTINGS_OFFSET UNITYSDK_OFFSET(0x1D26D330)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSYSTEM_OFFSET UNITYSDK_OFFSET(0x1D26BF10)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRTRACKEDCAMERA_OFFSET UNITYSDK_OFFSET(0x1D26DBD0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D26BE50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int OpenVR_COpenVRContext_TypeDefinitionIndex = 37172;
	...
	public:
		...
		::ZenFulcrum::VR::OpenVRBinding::CVRSettings* m_pVRSettings; // 0x20
		::ZenFulcrum::VR::OpenVRBinding::CVRRenderModels* m_pVRRenderModels; // 0x28
		::ZenFulcrum::VR::OpenVRBinding::CVRChaperone* m_pVRChaperone; // 0x30
		::ZenFulcrum::VR::OpenVRBinding::CVRCompositor* m_pVRCompositor; // 0x38
		::ZenFulcrum::VR::OpenVRBinding::CVROverlay* m_pVROverlay; // 0x40
		::ZenFulcrum::VR::OpenVRBinding::CVRChaperoneSetup* m_pVRChaperoneSetup; // 0x48
		::ZenFulcrum::VR::OpenVRBinding::CVRSystem* m_pVRSystem; // 0x50
		::ZenFulcrum::VR::OpenVRBinding::CVRApplications* m_pVRApplications; // 0x58
		::ZenFulcrum::VR::OpenVRBinding::CVRScreenshots* m_pVRScreenshots; // 0x60
