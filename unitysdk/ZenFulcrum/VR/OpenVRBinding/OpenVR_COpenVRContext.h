...
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_CHECKCLEAR_OFFSET UNITYSDK_OFFSET(0x1B52BBA0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B52BAF0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRAPPLICATIONS_OFFSET UNITYSDK_OFFSET(0x1B52AFF0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCHAPERONESETUP_OFFSET UNITYSDK_OFFSET(0x1B529EB0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCHAPERONE_OFFSET UNITYSDK_OFFSET(0x1B529BD0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRCOMPOSITOR_OFFSET UNITYSDK_OFFSET(0x1B52A190)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VREXTENDEDDISPLAY_OFFSET UNITYSDK_OFFSET(0x1B52AA30)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VROVERLAY_OFFSET UNITYSDK_OFFSET(0x1B52A470)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRRENDERMODELS_OFFSET UNITYSDK_OFFSET(0x1B52A750)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSCREENSHOTS_OFFSET UNITYSDK_OFFSET(0x1B52B2D0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B52AD10)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRSYSTEM_OFFSET UNITYSDK_OFFSET(0x1B5298F0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT_VRTRACKEDCAMERA_OFFSET UNITYSDK_OFFSET(0x1B52B5B0)
#define ZENFULCRUM_VR_OPENVRBINDING_OPENVR_COPENVRCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B529830)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int OpenVR_COpenVRContext_TypeDefinitionIndex = 36390;

	class OpenVR_COpenVRContext : public ::System::Object
	{
	public:
		::ZenFulcrum::VR::OpenVRBinding::CVRCompositor* m_pVRCompositor; // 0x10
		::ZenFulcrum::VR::OpenVRBinding::CVRScreenshots* m_pVRScreenshots; // 0x18
		::ZenFulcrum::VR::OpenVRBinding::CVRChaperone* m_pVRChaperone; // 0x20
		::ZenFulcrum::VR::OpenVRBinding::CVRRenderModels* m_pVRRenderModels; // 0x28
		::ZenFulcrum::VR::OpenVRBinding::CVRSettings* m_pVRSettings; // 0x30
		::ZenFulcrum::VR::OpenVRBinding::CVRSystem* m_pVRSystem; // 0x38
		::ZenFulcrum::VR::OpenVRBinding::CVRChaperoneSetup* m_pVRChaperoneSetup; // 0x40
		::ZenFulcrum::VR::OpenVRBinding::CVRTrackedCamera* m_pVRTrackedCamera; // 0x48
		::ZenFulcrum::VR::OpenVRBinding::CVRApplications* m_pVRApplications; // 0x50
		::ZenFulcrum::VR::OpenVRBinding::CVROverlay* m_pVROverlay; // 0x58
		::ZenFulcrum::VR::OpenVRBinding::CVRExtendedDisplay* m_pVRExtendedDisplay; // 0x60
