...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETLASTFRAMERENDERER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB5520)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETLASTFRAMERENDERER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB5550)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETLASTFRAMERENDERER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFB5510)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETLASTFRAMERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB54A0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetLastFrameRenderer_TypeDefinitionIndex = 37741;
