...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__ACQUIREVIDEOSTREAMINGSERVICE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A2D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__ACQUIREVIDEOSTREAMINGSERVICE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A340)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__ACQUIREVIDEOSTREAMINGSERVICE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A2C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__ACQUIREVIDEOSTREAMINGSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D26A250)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__AcquireVideoStreamingService_TypeDefinitionIndex = 36789;
