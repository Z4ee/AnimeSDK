...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CB0970)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CB0A00)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CB0610)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETFRAMETIMING__CTOR_OFFSET UNITYSDK_OFFSET(0x18CB05F0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetFrameTiming_TypeDefinitionIndex = 30065;
