...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__COMMITWORKINGCOPY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF7060)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__COMMITWORKINGCOPY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBF70D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__COMMITWORKINGCOPY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBEF850)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCHAPERONESETUP__COMMITWORKINGCOPY__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBF6FF0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRChaperoneSetup__CommitWorkingCopy_TypeDefinitionIndex = 36838;
