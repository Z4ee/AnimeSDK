...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARLASTSUBMITTEDFRAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAD3C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARLASTSUBMITTEDFRAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAD3F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARLASTSUBMITTEDFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CAD120)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__CLEARLASTSUBMITTEDFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAD100)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ClearLastSubmittedFrame_TypeDefinitionIndex = 30063;
