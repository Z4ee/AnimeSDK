...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A702480)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7024D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A702190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A702170)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetHighQualityOverlay_TypeDefinitionIndex = 35824;
