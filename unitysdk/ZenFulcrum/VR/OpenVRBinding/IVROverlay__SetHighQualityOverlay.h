...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51EAF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51EB40)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51EAE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETHIGHQUALITYOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51EA70)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetHighQualityOverlay_TypeDefinitionIndex = 36124;
