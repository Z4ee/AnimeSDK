...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVEKEYINSECTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE09F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVEKEYINSECTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE0A80)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVEKEYINSECTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEE09D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__REMOVEKEYINSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEE0950)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__RemoveKeyInSection_TypeDefinitionIndex = 37877;
