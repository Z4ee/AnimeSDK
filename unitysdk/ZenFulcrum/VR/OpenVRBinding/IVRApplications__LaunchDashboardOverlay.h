...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHDASHBOARDOVERLAY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAAD30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHDASHBOARDOVERLAY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAAD60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHDASHBOARDOVERLAY_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C98230)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__LAUNCHDASHBOARDOVERLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAAD10)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__LaunchDashboardOverlay_TypeDefinitionIndex = 30004;
