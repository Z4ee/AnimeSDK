...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CC01D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CC0240)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CBFE60)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CBFE40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlaySortOrder_TypeDefinitionIndex = 30122;
