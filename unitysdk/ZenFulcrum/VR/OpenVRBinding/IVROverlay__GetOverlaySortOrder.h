...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CED98F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CED9960)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CED98E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__GETOVERLAYSORTORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED9870)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__GetOverlaySortOrder_TypeDefinitionIndex = 37783;
