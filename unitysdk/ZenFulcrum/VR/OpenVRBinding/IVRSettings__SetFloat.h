...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETFLOAT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDC6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETFLOAT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDC7A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETFLOAT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDC0B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDC090)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__SetFloat_TypeDefinitionIndex = 30209;
