...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B514450)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5144F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B50E250)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5143D0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationPropertyBool_TypeDefinitionIndex = 36030;
