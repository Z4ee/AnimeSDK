...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CAA200)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CAA2A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C9A030)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRAPPLICATIONS__GETAPPLICATIONPROPERTYBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x18CAA1E0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRApplications__GetApplicationPropertyBool_TypeDefinitionIndex = 30010;
