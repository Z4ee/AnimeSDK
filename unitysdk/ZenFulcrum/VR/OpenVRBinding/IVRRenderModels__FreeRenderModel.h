...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREERENDERMODEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5213D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREERENDERMODEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B521420)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREERENDERMODEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5213C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRRENDERMODELS__FREERENDERMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B521350)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRRenderModels__FreeRenderModel_TypeDefinitionIndex = 36204;
