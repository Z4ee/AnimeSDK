...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTRANSFORMOVERLAYRELATIVE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A708500)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTRANSFORMOVERLAYRELATIVE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7085B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTRANSFORMOVERLAYRELATIVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A708160)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTRANSFORMOVERLAYRELATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A708140)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayTransformOverlayRelative_TypeDefinitionIndex = 35861;
