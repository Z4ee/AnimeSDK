...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A722060)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A7220D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A721D70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A721D50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetTrackedDeviceIndexForControllerRole_TypeDefinitionIndex = 35670;
