...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2695E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D269650)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2695D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEINDEXFORCONTROLLERROLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D269560)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetTrackedDeviceIndexForControllerRole_TypeDefinitionIndex = 36752;
