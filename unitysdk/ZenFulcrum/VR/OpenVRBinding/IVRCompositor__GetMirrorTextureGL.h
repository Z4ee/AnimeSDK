...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETMIRRORTEXTUREGL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B225010)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETMIRRORTEXTUREGL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2250C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETMIRRORTEXTUREGL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B224FF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__GETMIRRORTEXTUREGL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B224F80)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__GetMirrorTextureGL_TypeDefinitionIndex = 36894;
