...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC28D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC2980)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFC28B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFC2840)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetInt32TrackedDeviceProperty_TypeDefinitionIndex = 37617;
