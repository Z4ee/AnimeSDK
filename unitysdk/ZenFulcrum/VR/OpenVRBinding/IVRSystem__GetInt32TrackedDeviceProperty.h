...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A71E260)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A71E310)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A71DED0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETINT32TRACKEDDEVICEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A71DEB0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetInt32TrackedDeviceProperty_TypeDefinitionIndex = 35676;
