...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B2241A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B2241F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B224190)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__FORCEINTERLEAVEDREPROJECTIONON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B224120)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__ForceInterleavedReprojectionOn_TypeDefinitionIndex = 36889;
