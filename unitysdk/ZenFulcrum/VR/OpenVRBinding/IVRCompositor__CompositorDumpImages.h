...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORDUMPIMAGES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B517AF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORDUMPIMAGES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B517B20)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORDUMPIMAGES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B517AE0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRCOMPOSITOR__COMPOSITORDUMPIMAGES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B517A70)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRCompositor__CompositorDumpImages_TypeDefinitionIndex = 36105;
