...
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETDXGIOUTPUTINFO_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CED73A0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETDXGIOUTPUTINFO_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CED7410)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETDXGIOUTPUTINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CED7390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETDXGIOUTPUTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED7310)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRExtendedDisplay__GetDXGIOutputInfo_TypeDefinitionIndex = 37641;
