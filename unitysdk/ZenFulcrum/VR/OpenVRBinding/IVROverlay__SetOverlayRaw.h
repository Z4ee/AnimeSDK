...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYRAW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDC9D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYRAW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDCAA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYRAW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDC990)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYRAW__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDC920)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayRaw_TypeDefinitionIndex = 37821;
