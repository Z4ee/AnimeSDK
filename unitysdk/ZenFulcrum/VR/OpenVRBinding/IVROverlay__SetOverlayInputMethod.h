...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CC91E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CC9270)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CC8E70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x18CC8E50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayInputMethod_TypeDefinitionIndex = 30148;
