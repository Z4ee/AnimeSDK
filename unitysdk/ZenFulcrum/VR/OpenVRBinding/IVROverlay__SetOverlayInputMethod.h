...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDC2F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDC380)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CEDC2E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYINPUTMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1CEDC270)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayInputMethod_TypeDefinitionIndex = 37809;
