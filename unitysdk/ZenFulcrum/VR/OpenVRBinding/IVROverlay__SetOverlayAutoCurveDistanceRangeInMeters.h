...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYAUTOCURVEDISTANCERANGEINMETERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBBB90)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYAUTOCURVEDISTANCERANGEINMETERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBBC30)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYAUTOCURVEDISTANCERANGEINMETERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EFBBB70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYAUTOCURVEDISTANCERANGEINMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFBBB00)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayAutoCurveDistanceRangeInMeters_TypeDefinitionIndex = 37786;
