...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22C3D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22C460)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22C3C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22C350)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayTexture_TypeDefinitionIndex = 36960;
