...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAPROJECTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A8C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAPROJECTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A9B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAPROJECTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D26A880)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAPROJECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D26A810)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__GetCameraProjection_TypeDefinitionIndex = 36788;
