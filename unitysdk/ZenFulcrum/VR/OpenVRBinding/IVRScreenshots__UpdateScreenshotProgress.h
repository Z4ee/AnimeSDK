...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__UPDATESCREENSHOTPROGRESS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F580)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__UPDATESCREENSHOTPROGRESS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F5F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__UPDATESCREENSHOTPROGRESS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22F570)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSCREENSHOTS__UPDATESCREENSHOTPROGRESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22F500)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRScreenshots__UpdateScreenshotProgress_TypeDefinitionIndex = 37024;
