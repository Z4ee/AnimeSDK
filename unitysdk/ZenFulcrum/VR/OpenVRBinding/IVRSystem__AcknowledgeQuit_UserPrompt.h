...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A719630)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A719660)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A719390)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__ACKNOWLEDGEQUIT_USERPROMPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A719370)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__AcknowledgeQuit_UserPrompt_TypeDefinitionIndex = 35696;
