...
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFLAG_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B420)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFLAG_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B4D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFLAG_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B22B400)
#define ZENFULCRUM_VR_OPENVRBINDING_IVROVERLAY__SETOVERLAYFLAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22B390)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVROverlay__SetOverlayFlag_TypeDefinitionIndex = 36915;
