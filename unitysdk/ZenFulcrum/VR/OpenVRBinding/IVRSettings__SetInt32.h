...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETINT32_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDCEA0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETINT32_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDCF50)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETINT32_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDC7E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSETTINGS__SETINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDC7C0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSettings__SetInt32_TypeDefinitionIndex = 30208;
