...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAFRAMESIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CEA1C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAFRAMESIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CEA2C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAFRAMESIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE9D70)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRTRACKEDCAMERA__GETCAMERAFRAMESIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE9D50)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRTrackedCamera__GetCameraFrameSize_TypeDefinitionIndex = 29984;
