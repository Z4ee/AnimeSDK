...
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_ACQUIREVIDEOSTREAMINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1EFB0620)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAERRORNAMEFROMENUM_OFFSET UNITYSDK_OFFSET(0x1EFB04C0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAFRAMESIZE_OFFSET UNITYSDK_OFFSET(0x1EFB0540)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAINTRINSICS_OFFSET UNITYSDK_OFFSET(0x1EFB05A0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETCAMERAPROJECTION_OFFSET UNITYSDK_OFFSET(0x1EFB05E0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMFRAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1EFB0680)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMTEXTURED3D11_OFFSET UNITYSDK_OFFSET(0x1EFB0730)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMTEXTUREGL_OFFSET UNITYSDK_OFFSET(0x1EFB0790)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_GETVIDEOSTREAMTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x1EFB06E0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_HASCAMERA_OFFSET UNITYSDK_OFFSET(0x1EFB0510)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_RELEASEVIDEOSTREAMINGSERVICE_OFFSET UNITYSDK_OFFSET(0x1EFB0650)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA_RELEASEVIDEOSTREAMTEXTUREGL_OFFSET UNITYSDK_OFFSET(0x1EFB07E0)
#define ZENFULCRUM_VR_OPENVRBINDING_CVRTRACKEDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1EFB03C0)
