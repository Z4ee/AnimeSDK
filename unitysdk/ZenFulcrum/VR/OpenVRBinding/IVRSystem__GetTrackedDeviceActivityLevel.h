...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1D2693E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1D269430)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1D2693D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1D269360)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetTrackedDeviceActivityLevel_TypeDefinitionIndex = 36750;
