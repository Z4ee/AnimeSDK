...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B526DC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B526E10)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B526DB0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRSYSTEM__GETTRACKEDDEVICEACTIVITYLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B526D40)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRSystem__GetTrackedDeviceActivityLevel_TypeDefinitionIndex = 35968;
