...
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A6F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A7F0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B51A6C0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B51A650)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRExtendedDisplay__GetEyeOutputViewport_TypeDefinitionIndex = 35999;
