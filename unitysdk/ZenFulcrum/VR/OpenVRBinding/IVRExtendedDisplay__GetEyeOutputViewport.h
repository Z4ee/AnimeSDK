...
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1CED74E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1CED75E0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1CED74B0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVREXTENDEDDISPLAY__GETEYEOUTPUTVIEWPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1CED7440)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRExtendedDisplay__GetEyeOutputViewport_TypeDefinitionIndex = 37640;
