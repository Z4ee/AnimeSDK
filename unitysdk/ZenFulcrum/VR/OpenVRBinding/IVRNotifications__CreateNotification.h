...
#define ZENFULCRUM_VR_OPENVRBINDING_IVRNOTIFICATIONS__CREATENOTIFICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F3EC0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRNOTIFICATIONS__CREATENOTIFICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F3FF0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRNOTIFICATIONS__CREATENOTIFICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6F39D0)
#define ZENFULCRUM_VR_OPENVRBINDING_IVRNOTIFICATIONS__CREATENOTIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6F39B0)

namespace ZenFulcrum::VR::OpenVRBinding
{
	inline static constexpr unsigned int IVRNotifications__CreateNotification_TypeDefinitionIndex = 35922;
