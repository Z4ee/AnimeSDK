...
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_DOWNLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E15D0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int DownloadManager_Download_TypeDefinitionIndex = 32678;
