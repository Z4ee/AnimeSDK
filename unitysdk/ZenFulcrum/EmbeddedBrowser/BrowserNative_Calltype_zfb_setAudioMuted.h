...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C773E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C77450)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C5CEB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED__CTOR_OFFSET UNITYSDK_OFFSET(0x18C773C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAudioMuted_TypeDefinitionIndex = 30470;
