...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C457E30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C457EC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C457AF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C457AE0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAudioMuted_TypeDefinitionIndex = 31058;
