...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FB6D3C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FB6D450)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FB6D0B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAUDIOMUTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB6D090)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAudioMuted_TypeDefinitionIndex = 33244;
