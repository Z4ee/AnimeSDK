...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C77700)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C77760)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C56650)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETREADYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C776E0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setReadyCallback_TypeDefinitionIndex = 30464;
