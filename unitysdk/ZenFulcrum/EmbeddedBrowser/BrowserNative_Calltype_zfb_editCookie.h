...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1F1A90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1F1B30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1F1710)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1F1700)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_editCookie_TypeDefinitionIndex = 31088;
