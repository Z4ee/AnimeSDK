...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCOMMANDTOFOCUSEDFRAME_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4F480)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCOMMANDTOFOCUSEDFRAME_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4F510)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCOMMANDTOFOCUSEDFRAME_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB3CC40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCOMMANDTOFOCUSEDFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB4F410)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendCommandToFocusedFrame_TypeDefinitionIndex = 37300;
