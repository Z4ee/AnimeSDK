...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C758D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C75900)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C75630)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x18C75610)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_noop_TypeDefinitionIndex = 30443;
