...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C74530)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C74580)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C74240)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74220)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getHWnd_TypeDefinitionIndex = 30460;
