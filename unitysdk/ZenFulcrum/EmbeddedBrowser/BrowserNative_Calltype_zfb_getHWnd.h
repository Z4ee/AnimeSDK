...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FBC0FF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FBC1060)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FBC0CF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC0CD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getHWnd_TypeDefinitionIndex = 33234;
