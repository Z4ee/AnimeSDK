...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D5540)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D55C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D5200)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D51F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerConsoleCallback_TypeDefinitionIndex = 31075;
