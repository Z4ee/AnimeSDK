...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFCE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFD40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4DC3F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONSOLECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EFC70)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerConsoleCallback_TypeDefinitionIndex = 36507;
