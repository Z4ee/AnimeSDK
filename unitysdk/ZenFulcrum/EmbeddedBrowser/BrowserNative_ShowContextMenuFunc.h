...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C7ACE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C7ADC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C7A910)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7A8F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ShowContextMenuFunc_TypeDefinitionIndex = 30422;
