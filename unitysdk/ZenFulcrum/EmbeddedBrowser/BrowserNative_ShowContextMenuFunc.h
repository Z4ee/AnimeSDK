...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B6180)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B6260)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B5DB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B5D90)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ShowContextMenuFunc_TypeDefinitionIndex = 36142;
