...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C74DB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C74E20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C6FCA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_INIT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74D90)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_init_TypeDefinitionIndex = 30456;
