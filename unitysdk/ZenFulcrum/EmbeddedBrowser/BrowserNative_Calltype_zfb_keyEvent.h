...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB07A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB0870)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1DCB0420)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCB0400)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_keyEvent_TypeDefinitionIndex = 32624;
