...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B0310)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B03C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6A7820)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_KEYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B02F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_keyEvent_TypeDefinitionIndex = 36205;
