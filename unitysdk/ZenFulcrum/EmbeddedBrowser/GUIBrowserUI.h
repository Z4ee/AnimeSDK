...
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C83850)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x18C846E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x18C84700)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x18C846B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_KEYEVENTS_OFFSET UNITYSDK_OFFSET(0x18C846D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x18C84670)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x18C844A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x18C84650)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x18C84690)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_INPUTUPDATE_OFFSET UNITYSDK_OFFSET(0x18C83C90)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x18C84730)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18C83B30)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONGUI_OFFSET UNITYSDK_OFFSET(0x18C844C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x18C84780)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x18C84740)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x18C84760)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONSELECT_OFFSET UNITYSDK_OFFSET(0x18C84720)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SETCURSOR_OFFSET UNITYSDK_OFFSET(0x18C845B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x18C846F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x18C84710)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x18C84680)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x18C84660)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x18C846A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_UPDATETEXTURE_OFFSET UNITYSDK_OFFSET(0x18C83BF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_WATCHRESIZE_OFFSET UNITYSDK_OFFSET(0x18C83B90)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI__AWAKE_B__4_0_OFFSET UNITYSDK_OFFSET(0x18C84870)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18C847F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int GUIBrowserUI_TypeDefinitionIndex = 30521;
