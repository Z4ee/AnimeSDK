...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FA39600)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FA39680)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FA392F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA392D0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerDialogCallback_TypeDefinitionIndex = 33267;
