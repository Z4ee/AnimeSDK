...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_DISPLAYDIALOGFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C192330)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_DISPLAYDIALOGFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C192420)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_DISPLAYDIALOGFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C191F10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_DISPLAYDIALOGFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C191F00)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_DisplayDialogFunc_TypeDefinitionIndex = 31009;
