...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE830)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE860)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6A9AC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AE810)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyAllBrowsers_TypeDefinitionIndex = 36174;
