...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F0DEAF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F0DEB20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F0DE860)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0DE840)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyAllBrowsers_TypeDefinitionIndex = 33228;
