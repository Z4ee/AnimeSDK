...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B949770)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B9497A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B9494D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9494C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyAllBrowsers_TypeDefinitionIndex = 31042;
