...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETCOOKIES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AF650)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETCOOKIES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AF6B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETCOOKIES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AF300)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETCOOKIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AF2E0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getCookies_TypeDefinitionIndex = 36219;
