...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E818BF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E818CA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E8188A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E818880)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_mouseMove_TypeDefinitionIndex = 32621;
