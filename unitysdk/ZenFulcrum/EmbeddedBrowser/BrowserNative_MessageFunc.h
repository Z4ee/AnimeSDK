...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB50C30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB50C60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB50C20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB50BB0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_MessageFunc_TypeDefinitionIndex = 37216;
