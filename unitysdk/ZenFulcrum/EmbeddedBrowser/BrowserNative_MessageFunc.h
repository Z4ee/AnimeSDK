...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E64E6C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E64E6F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E64E1C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_MESSAGEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1E64E1A0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_MessageFunc_TypeDefinitionIndex = 32553;
