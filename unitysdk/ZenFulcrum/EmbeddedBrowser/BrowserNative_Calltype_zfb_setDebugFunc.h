...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETDEBUGFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4FD40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETDEBUGFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4FD70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETDEBUGFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4A390)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETDEBUGFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB4FCD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setDebugFunc_TypeDefinitionIndex = 37251;
