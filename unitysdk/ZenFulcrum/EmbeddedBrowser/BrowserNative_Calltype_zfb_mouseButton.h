...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EF6F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EF7C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E96E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EF680)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_mouseButton_TypeDefinitionIndex = 36503;
