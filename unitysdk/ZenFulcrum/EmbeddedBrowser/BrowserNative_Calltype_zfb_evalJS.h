...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EE580)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EE630)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4E1510)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EE510)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_evalJS_TypeDefinitionIndex = 36508;
