...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_FLATCOLORTEXTURE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C392810)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_FLATCOLORTEXTURE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C392900)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_FLATCOLORTEXTURE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C392440)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_FLATCOLORTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C392430)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_flatColorTexture_TypeDefinitionIndex = 31032;
