...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4572D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C457390)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C456EF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1C456EE0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_downloadCommand_TypeDefinitionIndex = 31090;
