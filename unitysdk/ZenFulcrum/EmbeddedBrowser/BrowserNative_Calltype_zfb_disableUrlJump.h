...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE910)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE980)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A698000)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AE8F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_disableUrlJump_TypeDefinitionIndex = 36189;
