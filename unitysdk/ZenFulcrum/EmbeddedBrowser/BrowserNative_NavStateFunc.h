...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8C360)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8C430)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8C320)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF8C2B0)
