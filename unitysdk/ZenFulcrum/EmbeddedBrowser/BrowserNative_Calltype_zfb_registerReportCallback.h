...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C76400)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C76460)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C56D30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C763E0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerReportCallback_TypeDefinitionIndex = 30474;
