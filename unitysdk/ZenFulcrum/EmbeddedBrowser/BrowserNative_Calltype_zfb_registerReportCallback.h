...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7613E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E761460)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7610A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E761080)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerReportCallback_TypeDefinitionIndex = 32613;
