...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C419550)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4195D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C419210)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERREPORTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C419200)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerReportCallback_TypeDefinitionIndex = 31062;
