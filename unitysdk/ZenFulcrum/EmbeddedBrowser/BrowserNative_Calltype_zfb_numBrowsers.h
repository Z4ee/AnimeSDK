...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFB30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFB60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFB20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EFAB0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_numBrowsers_TypeDefinitionIndex = 36481;
