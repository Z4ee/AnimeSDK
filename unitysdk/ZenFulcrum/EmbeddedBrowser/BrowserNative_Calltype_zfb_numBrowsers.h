...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C7E1C50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C7E1C80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C7E1C40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C7E1BD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_numBrowsers_TypeDefinitionIndex = 38122;
