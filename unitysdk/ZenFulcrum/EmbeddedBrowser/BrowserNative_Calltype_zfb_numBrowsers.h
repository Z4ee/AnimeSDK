...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8A160)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8A190)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF8A150)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NUMBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF8A0E0)
