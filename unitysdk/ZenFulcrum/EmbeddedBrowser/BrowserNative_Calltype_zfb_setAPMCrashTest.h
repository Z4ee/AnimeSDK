...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B27A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B27F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B24B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B2490)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAPMCrashTest_TypeDefinitionIndex = 36162;
