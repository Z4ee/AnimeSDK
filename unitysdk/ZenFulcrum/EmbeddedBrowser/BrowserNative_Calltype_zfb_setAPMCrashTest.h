...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1911A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C191210)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C190EA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1C190E90)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAPMCrashTest_TypeDefinitionIndex = 31030;
