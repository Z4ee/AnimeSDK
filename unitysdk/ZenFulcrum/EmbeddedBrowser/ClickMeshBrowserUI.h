...
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B4F2650)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_CREATE_OFFSET UNITYSDK_OFFSET(0x1B4F25E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_CURSORUPDATED_OFFSET UNITYSDK_OFFSET(0x1B4F3390)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1B4F3500)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B4F3520)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1B4F34D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_KEYEVENTS_OFFSET UNITYSDK_OFFSET(0x1B4F34F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_LOOKRAY_OFFSET UNITYSDK_OFFSET(0x1B4F2760)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1B4F3490)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1B4F3450)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4F3470)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_GET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1B4F34B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_INPUTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B4F2860)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_LOOKOFF_OFFSET UNITYSDK_OFFSET(0x1B4F31F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_LOOKON_OFFSET UNITYSDK_OFFSET(0x1B4F3220)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_ONGUI_OFFSET UNITYSDK_OFFSET(0x1B4F3250)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SETCURSOR_OFFSET UNITYSDK_OFFSET(0x1B4F33B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1B4F3510)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B4F3530)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1B4F34E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1B4F34A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1B4F3460)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4F3480)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI_SET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1B4F34C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4F35C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CLICKMESHBROWSERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F3540)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int ClickMeshBrowserUI_TypeDefinitionIndex = 36538;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::KeyCode>**)Il2CppClass::FromTypeDefinitionIndex(ClickMeshBrowserUI_TypeDefinitionIndex)->GetStaticField(0x65430);
		}
