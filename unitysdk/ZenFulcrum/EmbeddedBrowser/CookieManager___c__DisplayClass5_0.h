...
#define ZENFULCRUM_EMBEDDEDBROWSER_COOKIEMANAGER___C__DISPLAYCLASS5_0__CB_GETCOOKIEFUNC_B__0_OFFSET UNITYSDK_OFFSET(0x1A6B8890)
#define ZENFULCRUM_EMBEDDEDBROWSER_COOKIEMANAGER___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B87A0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int CookieManager___c__DisplayClass5_0_TypeDefinitionIndex = 36254;
