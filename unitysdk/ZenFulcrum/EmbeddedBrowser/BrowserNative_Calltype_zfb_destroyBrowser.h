...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE890)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE8E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A694810)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AE870)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyBrowser_TypeDefinitionIndex = 36182;
