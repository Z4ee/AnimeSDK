...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B9497C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B949830)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B941850)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9497B0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyBrowser_TypeDefinitionIndex = 31050;
