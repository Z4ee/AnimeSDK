...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F0DEB50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F0DEBC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F0D6C10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYBROWSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0DEB30)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyBrowser_TypeDefinitionIndex = 33236;
