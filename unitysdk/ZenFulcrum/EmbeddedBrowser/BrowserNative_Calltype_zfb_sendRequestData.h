...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E819050)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E819100)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E818CD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E818CB0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendRequestData_TypeDefinitionIndex = 32591;
