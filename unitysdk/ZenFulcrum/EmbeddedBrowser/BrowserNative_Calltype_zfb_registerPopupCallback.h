...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C304150)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C304210)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C303B70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERPOPUPCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C303B60)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerPopupCallback_TypeDefinitionIndex = 31083;
