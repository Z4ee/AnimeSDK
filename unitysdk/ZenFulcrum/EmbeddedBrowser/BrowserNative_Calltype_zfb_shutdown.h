...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B2DF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B2E20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6ACA70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B2DD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_shutdown_TypeDefinitionIndex = 36178;
