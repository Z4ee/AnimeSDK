...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AFC10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AFD00)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A69EA00)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AFBF0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getMouseCustomCursor_TypeDefinitionIndex = 36212;
