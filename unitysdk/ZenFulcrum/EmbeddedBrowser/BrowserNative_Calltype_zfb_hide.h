...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FBC17A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FBC1810)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FBC14A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC1480)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_hide_TypeDefinitionIndex = 33241;
