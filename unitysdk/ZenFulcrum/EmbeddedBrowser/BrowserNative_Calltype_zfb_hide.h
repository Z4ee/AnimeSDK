...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C74D30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C74D80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C5C650)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74D10)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_hide_TypeDefinitionIndex = 30467;
