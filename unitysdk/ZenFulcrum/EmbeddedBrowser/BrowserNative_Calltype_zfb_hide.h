...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7E1020)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7E1090)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7E0D30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_HIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7E0D10)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_hide_TypeDefinitionIndex = 32606;
