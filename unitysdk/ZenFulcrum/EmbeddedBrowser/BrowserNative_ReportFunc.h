...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C458720)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4587F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C458340)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C458330)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ReportFunc_TypeDefinitionIndex = 31013;
