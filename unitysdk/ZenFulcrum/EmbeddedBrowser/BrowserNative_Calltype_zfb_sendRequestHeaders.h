...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4F8F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4F970)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4F8D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB4F860)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendRequestHeaders_TypeDefinitionIndex = 37253;
