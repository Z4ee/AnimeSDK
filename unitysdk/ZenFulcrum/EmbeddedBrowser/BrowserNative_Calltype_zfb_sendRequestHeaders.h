...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B2400)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B2480)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B2070)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B2050)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendRequestHeaders_TypeDefinitionIndex = 36171;
