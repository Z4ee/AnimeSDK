...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1F9284A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1F928550)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F928100)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9280E0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendDialogResults_TypeDefinitionIndex = 33268;
