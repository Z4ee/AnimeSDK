...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1F1F30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1F1FE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1F1B50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1F1B40)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendDialogResults_TypeDefinitionIndex = 31082;
