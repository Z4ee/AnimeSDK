...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C766B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C76750)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C65C20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDDIALOGRESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C76690)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendDialogResults_TypeDefinitionIndex = 30494;
