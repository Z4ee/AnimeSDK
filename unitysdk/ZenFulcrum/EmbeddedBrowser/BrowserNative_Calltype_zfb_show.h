...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C77830)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C77880)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C5BF80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x18C77810)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_show_TypeDefinitionIndex = 30468;
