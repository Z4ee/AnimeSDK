...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E4CF880)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E4CF8F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E4CF590)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4CF570)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_show_TypeDefinitionIndex = 32607;
