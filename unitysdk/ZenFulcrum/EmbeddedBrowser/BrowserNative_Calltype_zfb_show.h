...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C191E80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C191EF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C191B80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1C191B70)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_show_TypeDefinitionIndex = 31056;
