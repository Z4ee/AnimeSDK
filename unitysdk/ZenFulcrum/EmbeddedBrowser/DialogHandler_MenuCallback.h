...
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D5CB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D5D20)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D59B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D59A0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int DialogHandler_MenuCallback_TypeDefinitionIndex = 31124;
