...
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FA0A550)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FA0A5C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FA0A250)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_MENUCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA0A230)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int DialogHandler_MenuCallback_TypeDefinitionIndex = 33310;
