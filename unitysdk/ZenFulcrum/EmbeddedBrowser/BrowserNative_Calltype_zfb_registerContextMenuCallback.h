...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFDD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFE30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4EFDC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EFD50)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerContextMenuCallback_TypeDefinitionIndex = 36516;
