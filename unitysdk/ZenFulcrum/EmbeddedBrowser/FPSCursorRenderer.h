...
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_GET_ENABLEINPUT_OFFSET UNITYSDK_OFFSET(0x18C832C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18C831F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_ONGUI_OFFSET UNITYSDK_OFFSET(0x18C83350)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_SETCURSOR_OFFSET UNITYSDK_OFFSET(0x18C83560)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_SETUPBROWSERINPUT_OFFSET UNITYSDK_OFFSET(0x18C82D10)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_SET_ENABLEINPUT_OFFSET UNITYSDK_OFFSET(0x18C832D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER_START_OFFSET UNITYSDK_OFFSET(0x18C832E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSCURSORRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83570)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int FPSCursorRenderer_TypeDefinitionIndex = 30520;
	...
	public:
		...
		{
			return (::ZenFulcrum::EmbeddedBrowser::FPSCursorRenderer**)Il2CppClass::FromTypeDefinitionIndex(FPSCursorRenderer_TypeDefinitionIndex)->GetStaticField(0x36340);
		}
