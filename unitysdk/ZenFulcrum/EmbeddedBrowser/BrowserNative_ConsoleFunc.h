...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C458270)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C458320)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C457EE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1C457ED0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ConsoleFunc_TypeDefinitionIndex = 31005;
