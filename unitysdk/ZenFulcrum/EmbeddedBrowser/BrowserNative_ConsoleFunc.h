...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B3660)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B36F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B32D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A691480)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ConsoleFunc_TypeDefinitionIndex = 36137;
