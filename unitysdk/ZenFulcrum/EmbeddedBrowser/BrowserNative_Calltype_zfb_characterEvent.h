...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C72DE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C72E70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C6C030)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C72DC0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_characterEvent_TypeDefinitionIndex = 30486;
