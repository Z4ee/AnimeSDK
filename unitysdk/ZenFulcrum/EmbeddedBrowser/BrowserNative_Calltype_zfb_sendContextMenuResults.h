...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E8423D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E842460)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E842090)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E842070)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendContextMenuResults_TypeDefinitionIndex = 32636;
