...
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B4F5E60)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B4F5ED0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4F5D10)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4F5DF0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int DialogHandler_DialogCallback_TypeDefinitionIndex = 36556;
