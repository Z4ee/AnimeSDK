...
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB55A40)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB55AB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB558F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DIALOGHANDLER_DIALOGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB559D0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int DialogHandler_DialogCallback_TypeDefinitionIndex = 37338;
