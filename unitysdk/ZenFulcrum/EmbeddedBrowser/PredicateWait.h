...
#define ZENFULCRUM_EMBEDDEDBROWSER_PREDICATEWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C511F70)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int PredicateWait_TypeDefinitionIndex = 31163;
