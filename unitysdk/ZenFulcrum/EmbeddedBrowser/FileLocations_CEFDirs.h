...
#define ZENFULCRUM_EMBEDDEDBROWSER_FILELOCATIONS_CEFDIRS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83830)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int FileLocations_CEFDirs_TypeDefinitionIndex = 30548;
	...
	public:
		...
		::System::String* resourcesPath; // 0x30
