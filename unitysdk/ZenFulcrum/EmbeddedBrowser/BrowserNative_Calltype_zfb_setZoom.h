...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C77790)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C77800)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C5F0A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C77770)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setZoom_TypeDefinitionIndex = 30478;
