...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E623180)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E623210)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E622E60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETZOOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E622E40)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setZoom_TypeDefinitionIndex = 32617;
