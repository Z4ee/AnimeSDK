...
#define ZENFULCRUM_EMBEDDEDBROWSER_COOKIEMANAGER_COOKIEFETCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18C7D2A0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int CookieManager_CookieFetch_TypeDefinitionIndex = 30532;
	...
	public:
		...
		::ZenFulcrum::EmbeddedBrowser::CookieManager* manager; // 0x28
