...
#define ZENFULCRUM_EMBEDDEDBROWSER_COOKIEMANAGER_COOKIEFETCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1F92A830)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int CookieManager_CookieFetch_TypeDefinitionIndex = 33306;
