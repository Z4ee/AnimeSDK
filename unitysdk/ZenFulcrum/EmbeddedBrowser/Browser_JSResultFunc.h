...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB45AA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB45B00)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB44AF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB459B0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser_JSResultFunc_TypeDefinitionIndex = 37177;
