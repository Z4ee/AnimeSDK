...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C745D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C74640)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C61990)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C745B0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getImage_TypeDefinitionIndex = 30472;
