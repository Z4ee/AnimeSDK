...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_TICK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E8197C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_TICK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E8197F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_TICK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E819520)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_TICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E819500)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_tick_TypeDefinitionIndex = 32602;
