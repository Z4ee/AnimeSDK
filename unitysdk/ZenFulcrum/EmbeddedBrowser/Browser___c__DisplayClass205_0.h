...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS205_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1EF050)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS205_0___RESIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1C1EF060)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass205_0_TypeDefinitionIndex = 30978;
