...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C73190)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C731E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C72EA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES__CTOR_OFFSET UNITYSDK_OFFSET(0x18C72E80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_clearCookies_TypeDefinitionIndex = 30501;
