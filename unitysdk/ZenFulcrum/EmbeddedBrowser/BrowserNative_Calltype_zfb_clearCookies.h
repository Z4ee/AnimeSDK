...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE630)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE680)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A6AE340)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6AE320)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_clearCookies_TypeDefinitionIndex = 36221;
