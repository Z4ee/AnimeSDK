...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E439880)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E4398F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E439590)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CLEARCOOKIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1E439570)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_clearCookies_TypeDefinitionIndex = 32640;
