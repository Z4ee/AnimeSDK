...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_FORWARDJSCALLFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E86F020)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_FORWARDJSCALLFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E86F0E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_FORWARDJSCALLFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E86ECA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_FORWARDJSCALLFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1E86EC80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ForwardJSCallFunc_TypeDefinitionIndex = 32557;
