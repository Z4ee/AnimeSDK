...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS245_0__CB_SHOWCONTEXTMENUFUNC_B__0_OFFSET UNITYSDK_OFFSET(0x1C1EF360)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS245_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1EF350)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass245_0_TypeDefinitionIndex = 30990;
