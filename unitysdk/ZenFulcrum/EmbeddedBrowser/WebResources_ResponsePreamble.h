...
#define ZENFULCRUM_EMBEDDEDBROWSER_WEBRESOURCES_RESPONSEPREAMBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6CD8C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int WebResources_ResponsePreamble_TypeDefinitionIndex = 36335;
