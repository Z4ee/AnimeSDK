...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B1720)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A6B1780)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A691ED0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6B1700)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerNavStateCallback_TypeDefinitionIndex = 36193;
