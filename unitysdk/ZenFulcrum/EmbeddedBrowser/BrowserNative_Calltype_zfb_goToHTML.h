...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C74BE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C74C50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C5A180)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML__CTOR_OFFSET UNITYSDK_OFFSET(0x18C74BC0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_goToHTML_TypeDefinitionIndex = 30476;
