...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C4A94D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C4A9560)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C4A9150)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOHTML__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A9140)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_goToHTML_TypeDefinitionIndex = 31064;
