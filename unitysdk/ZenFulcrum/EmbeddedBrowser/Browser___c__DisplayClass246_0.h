...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS246_0__CB_CONSOLEFUNC_B__0_OFFSET UNITYSDK_OFFSET(0x1EF80C80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS246_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF7D6E0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass246_0_TypeDefinitionIndex = 38064;
