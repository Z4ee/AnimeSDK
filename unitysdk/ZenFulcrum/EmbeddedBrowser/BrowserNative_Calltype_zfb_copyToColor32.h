...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D3EC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D3F70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C2D3B20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2D3B10)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_copyToColor32_TypeDefinitionIndex = 31033;
