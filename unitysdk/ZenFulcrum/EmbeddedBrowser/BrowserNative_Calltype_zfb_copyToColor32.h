...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E6216F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E6217A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E621350)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x1E621330)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_copyToColor32_TypeDefinitionIndex = 32584;
