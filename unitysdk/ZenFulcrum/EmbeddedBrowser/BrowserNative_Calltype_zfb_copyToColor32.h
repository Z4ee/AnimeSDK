...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C73210)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C732A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C61D70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_COPYTOCOLOR32__CTOR_OFFSET UNITYSDK_OFFSET(0x18C731F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_copyToColor32_TypeDefinitionIndex = 30445;
