...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B94A400)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B94A480)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B93F570)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B94A3F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerChangeCallback_TypeDefinitionIndex = 31078;
