...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4EC00)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB4EC60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB3A270)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB4EB90)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerChangeCallback_TypeDefinitionIndex = 37292;
