...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C77380)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C773B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C6CC80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x18C77360)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAPMEnabled_TypeDefinitionIndex = 30441;
