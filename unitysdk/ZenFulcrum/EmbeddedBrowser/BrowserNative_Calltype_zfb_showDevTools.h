...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E615300)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E615390)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E614FC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E614FA0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_showDevTools_TypeDefinitionIndex = 32619;
