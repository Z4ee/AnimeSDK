...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C778B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C77920)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C5D870)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHOWDEVTOOLS__CTOR_OFFSET UNITYSDK_OFFSET(0x18C77890)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_showDevTools_TypeDefinitionIndex = 30480;
