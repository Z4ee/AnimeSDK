...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1EF89C10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1EF89CA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1EF89BF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY__CTOR_OFFSET UNITYSDK_OFFSET(0x1EF89B80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_memcpy_TypeDefinitionIndex = 38108;
