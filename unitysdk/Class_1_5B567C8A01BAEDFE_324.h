...
#define CLASS_1_5B567C8A01BAEDFE_324_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A814180)
#define CLASS_1_5B567C8A01BAEDFE_324_CLONE_OFFSET UNITYSDK_OFFSET(0x1A813FF0)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A814090)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A814030)
#define CLASS_1_5B567C8A01BAEDFE_324_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8140E0)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A8141D0)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A8141A0)
#define CLASS_1_5B567C8A01BAEDFE_324_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A813F70)
#define CLASS_1_5B567C8A01BAEDFE_324_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A813FA0)
#define CLASS_1_5B567C8A01BAEDFE_324_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A814110)
#define CLASS_1_5B567C8A01BAEDFE_324_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A814170)
#define CLASS_1_5B567C8A01BAEDFE_324__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A814220)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A813FC0)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_OFFSET UNITYSDK_OFFSET(0x1A813FB0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex = 31471;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_324*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex)->GetStaticField(0x1A200);
	}
