...
#define CLASS_1_5B567C8A01BAEDFE_324_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C9B0A80)
#define CLASS_1_5B567C8A01BAEDFE_324_CLONE_OFFSET UNITYSDK_OFFSET(0x1C9B0770)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C9B0880)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C9B07B0)
#define CLASS_1_5B567C8A01BAEDFE_324_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C9B09E0)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C9B0AD0)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C9B0AA0)
#define CLASS_1_5B567C8A01BAEDFE_324_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C9B06F0)
#define CLASS_1_5B567C8A01BAEDFE_324_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C9B0720)
#define CLASS_1_5B567C8A01BAEDFE_324_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C9B0A10)
#define CLASS_1_5B567C8A01BAEDFE_324_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C9B0A70)
#define CLASS_1_5B567C8A01BAEDFE_324__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C9B0B20)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9B0740)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9B0730)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex = 32595;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_324*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex)->GetStaticField(0xE760);
	}
