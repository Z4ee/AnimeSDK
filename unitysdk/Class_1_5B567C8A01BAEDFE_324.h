...
#define CLASS_1_5B567C8A01BAEDFE_324_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DEB02E0)
#define CLASS_1_5B567C8A01BAEDFE_324_CLONE_OFFSET UNITYSDK_OFFSET(0x1DEAFFD0)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DEB00E0)
#define CLASS_1_5B567C8A01BAEDFE_324_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEB0010)
#define CLASS_1_5B567C8A01BAEDFE_324_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEB0240)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DEB0330)
#define CLASS_1_5B567C8A01BAEDFE_324_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DEB0300)
#define CLASS_1_5B567C8A01BAEDFE_324_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DEAFF50)
#define CLASS_1_5B567C8A01BAEDFE_324_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DEAFF80)
#define CLASS_1_5B567C8A01BAEDFE_324_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEB0270)
#define CLASS_1_5B567C8A01BAEDFE_324_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DEB02D0)
#define CLASS_1_5B567C8A01BAEDFE_324__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEB0380)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEAFFA0)
#define CLASS_1_5B567C8A01BAEDFE_324__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEAFF90)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex = 33146;

class Class_1_5B567C8A01BAEDFE_324 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_324*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_324*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_324_TypeDefinitionIndex)->GetStaticField(0x38C60);
	}
