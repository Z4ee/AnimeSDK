...
#define CLASS_1_5B567C8A01BAEDFE_339_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19806BA0)
#define CLASS_1_5B567C8A01BAEDFE_339_CLONE_OFFSET UNITYSDK_OFFSET(0x19806A10)
#define CLASS_1_5B567C8A01BAEDFE_339_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19806AB0)
#define CLASS_1_5B567C8A01BAEDFE_339_EQUALS_OFFSET UNITYSDK_OFFSET(0x19806A50)
#define CLASS_1_5B567C8A01BAEDFE_339_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19806B00)
#define CLASS_1_5B567C8A01BAEDFE_339_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19806BF0)
#define CLASS_1_5B567C8A01BAEDFE_339_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19806BC0)
#define CLASS_1_5B567C8A01BAEDFE_339_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19806990)
#define CLASS_1_5B567C8A01BAEDFE_339_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198069C0)
#define CLASS_1_5B567C8A01BAEDFE_339_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19806B30)
#define CLASS_1_5B567C8A01BAEDFE_339_WRITETO_OFFSET UNITYSDK_OFFSET(0x19806B90)
#define CLASS_1_5B567C8A01BAEDFE_339__CCTOR_OFFSET UNITYSDK_OFFSET(0x19806C40)
#define CLASS_1_5B567C8A01BAEDFE_339__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198069E0)
#define CLASS_1_5B567C8A01BAEDFE_339__CTOR_OFFSET UNITYSDK_OFFSET(0x198069D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_339_TypeDefinitionIndex = 32233;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_339*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_339_TypeDefinitionIndex)->GetStaticField(0x65620);
	}
