...
#define CLASS_1_5B567C8A01BAEDFE_339_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A36C670)
#define CLASS_1_5B567C8A01BAEDFE_339_CLONE_OFFSET UNITYSDK_OFFSET(0x1A36C480)
#define CLASS_1_5B567C8A01BAEDFE_339_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A36C580)
#define CLASS_1_5B567C8A01BAEDFE_339_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A36C4F0)
#define CLASS_1_5B567C8A01BAEDFE_339_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A36C5D0)
#define CLASS_1_5B567C8A01BAEDFE_339_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A36C6C0)
#define CLASS_1_5B567C8A01BAEDFE_339_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A36C690)
#define CLASS_1_5B567C8A01BAEDFE_339_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A36C3D0)
#define CLASS_1_5B567C8A01BAEDFE_339_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A36C430)
#define CLASS_1_5B567C8A01BAEDFE_339_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A36C600)
#define CLASS_1_5B567C8A01BAEDFE_339_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A36C660)
#define CLASS_1_5B567C8A01BAEDFE_339__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A36C710)
#define CLASS_1_5B567C8A01BAEDFE_339__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A36C450)
#define CLASS_1_5B567C8A01BAEDFE_339__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36C440)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_339_TypeDefinitionIndex = 31945;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_339*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_339_TypeDefinitionIndex)->GetStaticField(0x57CE0);
	}
