...
#define DEBUGINFORENDERINGDETAIL__CTOR_OFFSET UNITYSDK_OFFSET(0xCB4D8B0)

inline static constexpr unsigned int DebugInfoRenderingDetail_TypeDefinitionIndex = 38443;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DebugInfoRenderingDetail_TypeDefinitionIndex)->GetStaticField(0x131E0);
	}
