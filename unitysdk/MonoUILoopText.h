...
#define MONOUILOOPTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0xF645DC0)
#define MONOUILOOPTEXT_CLEARLOOPTEXT_OFFSET UNITYSDK_OFFSET(0xF647D50)
#define MONOUILOOPTEXT_CLEARTEXTKEY_OFFSET UNITYSDK_OFFSET(0xF647DC0)
#define MONOUILOOPTEXT_GETMOVEDELAY_OFFSET UNITYSDK_OFFSET(0xF646840)
#define MONOUILOOPTEXT_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0xF647F60)
#define MONOUILOOPTEXT_GETRAWTEXT_OFFSET UNITYSDK_OFFSET(0xF646BF0)
#define MONOUILOOPTEXT_GETSINGLELOOPTIME_OFFSET UNITYSDK_OFFSET(0xF646890)
#define MONOUILOOPTEXT_ISLOOPING_OFFSET UNITYSDK_OFFSET(0xF646B60)
#define MONOUILOOPTEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xF648490)
#define MONOUILOOPTEXT_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0xF648260)
#define MONOUILOOPTEXT_SETKEY_OFFSET UNITYSDK_OFFSET(0xF647A30)
#define MONOUILOOPTEXT_SETLOOPONCECALL_OFFSET UNITYSDK_OFFSET(0xF646BA0)
#define MONOUILOOPTEXT_SETTEXTINNER_OFFSET UNITYSDK_OFFSET(0xF646E00)
#define MONOUILOOPTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0xF645FF0)
#define MONOUILOOPTEXT_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0xF646C30)
#define MONOUILOOPTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0xF646260)
#define MONOUILOOPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xF6484E0)

inline static constexpr unsigned int MonoUILoopText_TypeDefinitionIndex = 57168;
