...
#define MONOUILOOPTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x18E890A0)
#define MONOUILOOPTEXT_CLEARLOOPTEXT_OFFSET UNITYSDK_OFFSET(0x18E8B030)
#define MONOUILOOPTEXT_CLEARTEXTKEY_OFFSET UNITYSDK_OFFSET(0x18E8B0A0)
#define MONOUILOOPTEXT_GETMOVEDELAY_OFFSET UNITYSDK_OFFSET(0x18E89B20)
#define MONOUILOOPTEXT_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x18E8B240)
#define MONOUILOOPTEXT_GETRAWTEXT_OFFSET UNITYSDK_OFFSET(0x18E89ED0)
#define MONOUILOOPTEXT_GETSINGLELOOPTIME_OFFSET UNITYSDK_OFFSET(0x18E89B70)
#define MONOUILOOPTEXT_ISLOOPING_OFFSET UNITYSDK_OFFSET(0x18E89E40)
#define MONOUILOOPTEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18E8B760)
#define MONOUILOOPTEXT_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x18E8B540)
#define MONOUILOOPTEXT_SETKEY_OFFSET UNITYSDK_OFFSET(0x18E8AD10)
#define MONOUILOOPTEXT_SETLOOPONCECALL_OFFSET UNITYSDK_OFFSET(0x18E89E80)
#define MONOUILOOPTEXT_SETTEXTINNER_OFFSET UNITYSDK_OFFSET(0x18E8A0E0)
#define MONOUILOOPTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x18E892D0)
#define MONOUILOOPTEXT_SHOWTEXT_OFFSET UNITYSDK_OFFSET(0x18E89F10)
#define MONOUILOOPTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x18E89540)
#define MONOUILOOPTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E8B7B0)

inline static constexpr unsigned int MonoUILoopText_TypeDefinitionIndex = 57888;
