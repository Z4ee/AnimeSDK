...
#define CLASS_1_6B6A4C789452DEC6_METHOD_1_2CFF050FB165446D_OFFSET UNITYSDK_OFFSET(0x16115AF0)
#define CLASS_1_6B6A4C789452DEC6_METHOD_1_5B48DCA42B80B50C_OFFSET UNITYSDK_OFFSET(0x16115810)
#define CLASS_1_6B6A4C789452DEC6_METHOD_1_7084FF42BE358A08_OFFSET UNITYSDK_OFFSET(0x16115850)
#define CLASS_1_6B6A4C789452DEC6_METHOD_1_BBB3C454899600EF_OFFSET UNITYSDK_OFFSET(0x16115BA0)
#define CLASS_1_6B6A4C789452DEC6_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x16115C60)
#define CLASS_1_6B6A4C789452DEC6__CTOR_OFFSET UNITYSDK_OFFSET(0x16115800)
...
{
public:
	::RPG::GameCore::PPEffectFilterPriority NALMBOOCCIN; // 0x10
	::RPG::GameCore::PPEffectFilterPriorityGroup OMJNGMHJPBD; // 0x14
	::System::Boolean IOBJFEJFLJP; // 0x18
	::System::Boolean BHMGBPJCFBK; // 0x19
	::System::Boolean KCOEPCMEJCB; // 0x1A
