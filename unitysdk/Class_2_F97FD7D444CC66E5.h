...
#define CLASS_2_F97FD7D444CC66E5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16CC04F0)
#define CLASS_2_F97FD7D444CC66E5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16CC00E0)
#define CLASS_2_F97FD7D444CC66E5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16CC0440)
#define CLASS_2_F97FD7D444CC66E5_TICK_OFFSET UNITYSDK_OFFSET(0x16CC0490)
#define CLASS_2_F97FD7D444CC66E5__CTOR_OFFSET UNITYSDK_OFFSET(0x16CC00D0)

inline static constexpr unsigned int Class_2_F97FD7D444CC66E5_TypeDefinitionIndex = 56544;

class Class_2_F97FD7D444CC66E5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::FinishLevelGraph* OFKGLJOAMLD; // 0x18
