...
#define CLASS_1_B10FFA91399295A9_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19601A40)
#define CLASS_1_B10FFA91399295A9_CLONE_OFFSET UNITYSDK_OFFSET(0x19601600)
#define CLASS_1_B10FFA91399295A9_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x196016B0)
#define CLASS_1_B10FFA91399295A9_EQUALS_OFFSET UNITYSDK_OFFSET(0x19601680)
#define CLASS_1_B10FFA91399295A9_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x196017B0)
#define CLASS_1_B10FFA91399295A9_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19601C50)
#define CLASS_1_B10FFA91399295A9_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19601B60)
#define CLASS_1_B10FFA91399295A9_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x19601630)
#define CLASS_1_B10FFA91399295A9_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x19601650)
#define CLASS_1_B10FFA91399295A9_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19601470)
#define CLASS_1_B10FFA91399295A9_METHOD_1_6E1EC2DF63D7020F_OFFSET UNITYSDK_OFFSET(0x19601670)
#define CLASS_1_B10FFA91399295A9_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x19601640)
#define CLASS_1_B10FFA91399295A9_METHOD_1_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x19601660)
#define CLASS_1_B10FFA91399295A9_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x196014A0)
#define CLASS_1_B10FFA91399295A9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19601910)
#define CLASS_1_B10FFA91399295A9_WRITETO_OFFSET UNITYSDK_OFFSET(0x19601970)
#define CLASS_1_B10FFA91399295A9__CCTOR_OFFSET UNITYSDK_OFFSET(0x19601DC0)
#define CLASS_1_B10FFA91399295A9__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196014F0)
#define CLASS_1_B10FFA91399295A9__CTOR_OFFSET UNITYSDK_OFFSET(0x196014B0)

inline static constexpr unsigned int Class_1_B10FFA91399295A9_TypeDefinitionIndex = 24205;

class Class_1_B10FFA91399295A9 : public ::System::Object
{
public:
	static ::Google::Protobuf::FieldCodec_1<::Class_1_E0BAE492EF64CE43*>** StaticGet_Field_1_7()
	{
		return (::Google::Protobuf::FieldCodec_1<::Class_1_E0BAE492EF64CE43*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B10FFA91399295A9_TypeDefinitionIndex)->GetStaticField(0x308E0);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_B10FFA91399295A9*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_B10FFA91399295A9*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B10FFA91399295A9_TypeDefinitionIndex)->GetStaticField(0x308E8);
	}
	// static const ::System::Int32 Field_1_2 = 0x1; // 0x0
	// static const ::System::Int32 Field_1_4 = 0x2; // 0x0
	// static const ::System::Int32 Field_1_6 = 0x3; // 0x0
	::Class_1_355A2207C3B7A99D* Field_1_5; // 0x10
	::Google::Protobuf::UnknownFieldSet* Field_1_1; // 0x18
	::Google::Protobuf::Collections::RepeatedField_1<::Class_1_E0BAE492EF64CE43*>* Field_1_8; // 0x20
