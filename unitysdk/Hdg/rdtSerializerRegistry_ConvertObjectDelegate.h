...
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB19FFD0)
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB1A0010)
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB19D970)
#define HDG_RDTSERIALIZERREGISTRY_CONVERTOBJECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB19FEE0)
