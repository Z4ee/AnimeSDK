...
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_READ_OFFSET UNITYSDK_OFFSET(0x38E5100)
#define HDG_RDTTCPMESSAGEGAMEOBJECTS_WRITE_OFFSET UNITYSDK_OFFSET(0x38E50F0)

namespace Hdg
{
	inline static constexpr unsigned int rdtTcpMessageGameObjects_TypeDefinitionIndex = 45206;
