...
#define HDG_RDTTCPMESSAGECOMPONENTS_PROPERTY_CLONE_OFFSET UNITYSDK_OFFSET(0x25880)
#define HDG_RDTTCPMESSAGECOMPONENTS_PROPERTY_DESERIALISE_OFFSET UNITYSDK_OFFSET(0x258B0)
#define HDG_RDTTCPMESSAGECOMPONENTS_PROPERTY_READ_OFFSET UNITYSDK_OFFSET(0x258D0)
#define HDG_RDTTCPMESSAGECOMPONENTS_PROPERTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x25810)
#define HDG_RDTTCPMESSAGECOMPONENTS_PROPERTY_WRITE_OFFSET UNITYSDK_OFFSET(0x258C0)

namespace Hdg
{
	inline static constexpr unsigned int rdtTcpMessageComponents_Property_TypeDefinitionIndex = 37913;
