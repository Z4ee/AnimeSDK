...
#define HDG_RDTTCPMESSAGEUPDATEGAMEOBJECTPROPERTIES_HASFLAG_OFFSET UNITYSDK_OFFSET(0x3A9B940)
#define HDG_RDTTCPMESSAGEUPDATEGAMEOBJECTPROPERTIES_READ_OFFSET UNITYSDK_OFFSET(0x3A9B910)
#define HDG_RDTTCPMESSAGEUPDATEGAMEOBJECTPROPERTIES_SETFLAG_OFFSET UNITYSDK_OFFSET(0x3A9B920)
#define HDG_RDTTCPMESSAGEUPDATEGAMEOBJECTPROPERTIES_WRITE_OFFSET UNITYSDK_OFFSET(0x3A9B900)
