...
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_READPROPERTIES_OFFSET UNITYSDK_OFFSET(0x83F3770)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_READ_OFFSET UNITYSDK_OFFSET(0x255F0)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x255A0)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_WRITEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x83F0480)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_WRITE_OFFSET UNITYSDK_OFFSET(0x255E0)

namespace Hdg
{
	inline static constexpr unsigned int rdtTcpMessageComponents_Component_TypeDefinitionIndex = 37915;
