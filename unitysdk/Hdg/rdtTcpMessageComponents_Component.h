...
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_READPROPERTIES_OFFSET UNITYSDK_OFFSET(0x15344DD0)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_READ_OFFSET UNITYSDK_OFFSET(0x38E4F90)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38E4F40)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_WRITEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1533F7C0)
#define HDG_RDTTCPMESSAGECOMPONENTS_COMPONENT_WRITE_OFFSET UNITYSDK_OFFSET(0x38E4F80)

namespace Hdg
{
	inline static constexpr unsigned int rdtTcpMessageComponents_Component_TypeDefinitionIndex = 45204;
