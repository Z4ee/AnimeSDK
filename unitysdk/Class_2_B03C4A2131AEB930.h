...
#define CLASS_2_B03C4A2131AEB930_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1138B150)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x1138B670)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x1138B1A0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1138B460)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0x1138B7A0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_ACD91D865E237BC7_OFFSET UNITYSDK_OFFSET(0x1138B2B0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x1138B620)
#define CLASS_2_B03C4A2131AEB930_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1138B240)
#define CLASS_2_B03C4A2131AEB930_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1138B510)
#define CLASS_2_B03C4A2131AEB930_TICK_OFFSET UNITYSDK_OFFSET(0x1138B560)
#define CLASS_2_B03C4A2131AEB930__CTOR_OFFSET UNITYSDK_OFFSET(0x1138B140)

inline static constexpr unsigned int Class_2_B03C4A2131AEB930_TypeDefinitionIndex = 47613;

class Class_2_B03C4A2131AEB930 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_5F51D4049EA87B7B* Field_2_4; // 0x18
	::RPG::GameCore::WaitUIOnTop* Field_2_0; // 0x20
