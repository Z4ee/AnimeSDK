...
#define CLASS_2_B03C4A2131AEB930_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13558870)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_61EC2AC0BD93363E_OFFSET UNITYSDK_OFFSET(0x13558DB0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x135588C0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x13558B90)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_98511BB23D2E3748_OFFSET UNITYSDK_OFFSET(0x13558EE0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_ACD91D865E237BC7_OFFSET UNITYSDK_OFFSET(0x135589E0)
#define CLASS_2_B03C4A2131AEB930_METHOD_2_F4ADC37B63F4E9EF_OFFSET UNITYSDK_OFFSET(0x13558D60)
#define CLASS_2_B03C4A2131AEB930_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13558970)
#define CLASS_2_B03C4A2131AEB930_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13558C50)
#define CLASS_2_B03C4A2131AEB930_TICK_OFFSET UNITYSDK_OFFSET(0x13558CA0)
#define CLASS_2_B03C4A2131AEB930__CTOR_OFFSET UNITYSDK_OFFSET(0x13558860)

inline static constexpr unsigned int Class_2_B03C4A2131AEB930_TypeDefinitionIndex = 55078;

class Class_2_B03C4A2131AEB930 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::Class_1_5F51D4049EA87B7B* Field_2_0; // 0x18
	::RPG::GameCore::WaitUIOnTop* Field_2_1; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_2_A48F3719AA1CF200_5*))((::PBYTE)hIl2Cpp + CLASS_2_B03C4A2131AEB930_METHOD_2_98511BB23D2E3748_OFFSET))(this, a1);
	}
};
