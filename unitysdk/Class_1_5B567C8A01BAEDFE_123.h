...
#define CLASS_1_5B567C8A01BAEDFE_123_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DFAA640)
#define CLASS_1_5B567C8A01BAEDFE_123_CLONE_OFFSET UNITYSDK_OFFSET(0x1DFAA2E0)
#define CLASS_1_5B567C8A01BAEDFE_123_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DFAA440)
#define CLASS_1_5B567C8A01BAEDFE_123_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DFAA350)
#define CLASS_1_5B567C8A01BAEDFE_123_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DFAA5A0)
#define CLASS_1_5B567C8A01BAEDFE_123_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DFAA690)
#define CLASS_1_5B567C8A01BAEDFE_123_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DFAA660)
#define CLASS_1_5B567C8A01BAEDFE_123_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DFAA230)
#define CLASS_1_5B567C8A01BAEDFE_123_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DFAA290)
#define CLASS_1_5B567C8A01BAEDFE_123_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DFAA5D0)
#define CLASS_1_5B567C8A01BAEDFE_123_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DFAA630)
#define CLASS_1_5B567C8A01BAEDFE_123__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DFAA6E0)
#define CLASS_1_5B567C8A01BAEDFE_123__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFAA2B0)
#define CLASS_1_5B567C8A01BAEDFE_123__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFAA2A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_123_TypeDefinitionIndex = 28130;

class Class_1_5B567C8A01BAEDFE_123 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_123*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_123*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_123_TypeDefinitionIndex)->GetStaticField(0x598C0);
	}
