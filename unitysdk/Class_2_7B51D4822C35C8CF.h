...
#define CLASS_2_7B51D4822C35C8CF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9A3C340)
#define CLASS_2_7B51D4822C35C8CF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x9A3C380)
#define CLASS_2_7B51D4822C35C8CF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9A3C5C0)
#define CLASS_2_7B51D4822C35C8CF_TICK_OFFSET UNITYSDK_OFFSET(0x9A3C610)
#define CLASS_2_7B51D4822C35C8CF__CTOR_OFFSET UNITYSDK_OFFSET(0x9A3C250)

inline static constexpr unsigned int Class_2_7B51D4822C35C8CF_TypeDefinitionIndex = 50877;

class Class_2_7B51D4822C35C8CF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ModifierPlayerChangeEffect* Field_2_0; // 0x18
