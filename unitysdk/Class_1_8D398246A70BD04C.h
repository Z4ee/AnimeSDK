...
#define CLASS_1_8D398246A70BD04C_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E715920)
#define CLASS_1_8D398246A70BD04C_CLONE_OFFSET UNITYSDK_OFFSET(0x1E715140)
#define CLASS_1_8D398246A70BD04C_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E715220)
#define CLASS_1_8D398246A70BD04C_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E7151F0)
#define CLASS_1_8D398246A70BD04C_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E715500)
#define CLASS_1_8D398246A70BD04C_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E715A50)
#define CLASS_1_8D398246A70BD04C_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E7159E0)
#define CLASS_1_8D398246A70BD04C_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E715190)
#define CLASS_1_8D398246A70BD04C_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E7150B0)
#define CLASS_1_8D398246A70BD04C_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E7151A0)
#define CLASS_1_8D398246A70BD04C_METHOD_1_8633AE51B23EBDFD_1_OFFSET UNITYSDK_OFFSET(0x1E7151E0)
#define CLASS_1_8D398246A70BD04C_METHOD_1_8633AE51B23EBDFD_OFFSET UNITYSDK_OFFSET(0x1E7151C0)
#define CLASS_1_8D398246A70BD04C_METHOD_1_C229FF62B898C0B2_1_OFFSET UNITYSDK_OFFSET(0x1E7151D0)
#define CLASS_1_8D398246A70BD04C_METHOD_1_C229FF62B898C0B2_OFFSET UNITYSDK_OFFSET(0x1E7151B0)
#define CLASS_1_8D398246A70BD04C_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E7150E0)
#define CLASS_1_8D398246A70BD04C_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E715750)
#define CLASS_1_8D398246A70BD04C_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E7157B0)
#define CLASS_1_8D398246A70BD04C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E715C60)
#define CLASS_1_8D398246A70BD04C__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E715100)
#define CLASS_1_8D398246A70BD04C__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7150F0)

inline static constexpr unsigned int Class_1_8D398246A70BD04C_TypeDefinitionIndex = 25158;

class Class_1_8D398246A70BD04C : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_8D398246A70BD04C*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_8D398246A70BD04C*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8D398246A70BD04C_TypeDefinitionIndex)->GetStaticField(0x3A060);
	}
	// static const ::System::Int32 KLHBIKCMBGP = 0x1; // 0x0
	// static const ::System::Int32 IBJNBJNDPIK = 0x2; // 0x0
	// static const ::System::Int32 AHIEOOANGKK = 0x3; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt32 IOLMENCNJLF; // 0x18
	::System::Double BCLKCLDFMOA; // 0x20
	::System::Double DHMPJFBLLMO; // 0x28
