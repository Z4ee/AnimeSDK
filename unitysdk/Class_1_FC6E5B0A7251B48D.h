...
#define CLASS_1_FC6E5B0A7251B48D_METHOD_1_D44B7F51DEAAFB41_OFFSET UNITYSDK_OFFSET(0x1D0E3650)
#define CLASS_1_FC6E5B0A7251B48D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0E3760)

inline static constexpr unsigned int Class_1_FC6E5B0A7251B48D_TypeDefinitionIndex = 15236;

class Class_1_FC6E5B0A7251B48D : public ::System::Object
{
public:
	::RPG::GameCore::UpgradeAvatarSubRelicType AMAPBCEEKFP; // 0x10
