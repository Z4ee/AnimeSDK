...
#define CLASS_1_5B567C8A01BAEDFE_287_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x198AE6D0)
#define CLASS_1_5B567C8A01BAEDFE_287_CLONE_OFFSET UNITYSDK_OFFSET(0x198AE540)
#define CLASS_1_5B567C8A01BAEDFE_287_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x198AE5E0)
#define CLASS_1_5B567C8A01BAEDFE_287_EQUALS_OFFSET UNITYSDK_OFFSET(0x198AE580)
#define CLASS_1_5B567C8A01BAEDFE_287_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198AE630)
#define CLASS_1_5B567C8A01BAEDFE_287_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198AE720)
#define CLASS_1_5B567C8A01BAEDFE_287_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x198AE6F0)
#define CLASS_1_5B567C8A01BAEDFE_287_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x198AE4C0)
#define CLASS_1_5B567C8A01BAEDFE_287_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x198AE4F0)
#define CLASS_1_5B567C8A01BAEDFE_287_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198AE660)
#define CLASS_1_5B567C8A01BAEDFE_287_WRITETO_OFFSET UNITYSDK_OFFSET(0x198AE6C0)
#define CLASS_1_5B567C8A01BAEDFE_287__CCTOR_OFFSET UNITYSDK_OFFSET(0x198AE770)
#define CLASS_1_5B567C8A01BAEDFE_287__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198AE510)
#define CLASS_1_5B567C8A01BAEDFE_287__CTOR_OFFSET UNITYSDK_OFFSET(0x198AE500)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_287_TypeDefinitionIndex = 30942;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_287*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_287_TypeDefinitionIndex)->GetStaticField(0x50100);
	}
