...
#define CLASS_1_68DDCD4A4411AB4A_METHOD_1_7B1769B98A2C7F62_OFFSET UNITYSDK_OFFSET(0x15BA1B10)
#define CLASS_1_68DDCD4A4411AB4A_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x15BA1A30)
#define CLASS_1_68DDCD4A4411AB4A_METHOD_1_D8EB89DF128EDA39_OFFSET UNITYSDK_OFFSET(0x15BA1A80)
#define CLASS_1_68DDCD4A4411AB4A_METHOD_1_DA7D5FED1E10712C_OFFSET UNITYSDK_OFFSET(0x15BA2070)
#define CLASS_1_68DDCD4A4411AB4A__CTOR_OFFSET UNITYSDK_OFFSET(0x15B98E00)
...
public:
	...
	::System::Single MNLKCLNDPEI; // 0x20
	::System::Single DFFJJAANLCE; // 0x24
	::System::Boolean GKIBGGINIOD; // 0x28
	::System::Single LEPFDNGLCKB; // 0x2C
	::System::Single AJEECMDPPMD; // 0x30
	::System::Single FANGHNBBPDA; // 0x34
	::System::Single MGAANNGNDFJ; // 0x38
	::System::Single ABKEJOMBJPO; // 0x3C
