...
#define CLASS_2_E24FE4D931E5A5ED_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16B73F40)
#define CLASS_2_E24FE4D931E5A5ED_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16B73F80)
#define CLASS_2_E24FE4D931E5A5ED_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x175DBCC0)
#define CLASS_2_E24FE4D931E5A5ED_TICK_OFFSET UNITYSDK_OFFSET(0x175DBD10)
#define CLASS_2_E24FE4D931E5A5ED__CTOR_OFFSET UNITYSDK_OFFSET(0x16B73F30)

inline static constexpr unsigned int Class_2_E24FE4D931E5A5ED_TypeDefinitionIndex = 51033;

class Class_2_E24FE4D931E5A5ED : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::UnloadLevelGroup* Field_2_0; // 0x18
