...
#define CLASS_2_E24FE4D931E5A5ED_DISPOSE_OFFSET UNITYSDK_OFFSET(0x184DA950)
#define CLASS_2_E24FE4D931E5A5ED_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x184DA990)
#define CLASS_2_E24FE4D931E5A5ED_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x184DAAE0)
#define CLASS_2_E24FE4D931E5A5ED_TICK_OFFSET UNITYSDK_OFFSET(0x184DAB30)
#define CLASS_2_E24FE4D931E5A5ED__CTOR_OFFSET UNITYSDK_OFFSET(0x184DA940)

inline static constexpr unsigned int Class_2_E24FE4D931E5A5ED_TypeDefinitionIndex = 53717;

class Class_2_E24FE4D931E5A5ED : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::UnloadLevelGroup* OFKGLJOAMLD; // 0x20
