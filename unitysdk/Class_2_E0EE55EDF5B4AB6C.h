...
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_285337D3C1CF4702_OFFSET UNITYSDK_OFFSET(0x1679BE60)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_2BC55A66CB2B0118_1_OFFSET UNITYSDK_OFFSET(0x1679BE10)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_2BC55A66CB2B0118_OFFSET UNITYSDK_OFFSET(0x1679BDC0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1679BC90)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_87ABDF76B9D06C76_OFFSET UNITYSDK_OFFSET(0x1679BA40)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_C445993D022B1BA1_OFFSET UNITYSDK_OFFSET(0x1679BCF0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_DE7035732E1EE275_OFFSET UNITYSDK_OFFSET(0x1679B930)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x1679B7A0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_FA656FDDBAF8003E_OFFSET UNITYSDK_OFFSET(0x1679B630)
#define CLASS_2_E0EE55EDF5B4AB6C_RECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1679BD50)
#define CLASS_2_E0EE55EDF5B4AB6C__CTOR_OFFSET UNITYSDK_OFFSET(0x1679B560)
#define CLASS_2_E0EE55EDF5B4AB6C__ONDESTROYED_OFFSET UNITYSDK_OFFSET(0x1679BFB0)
#define CLASS_2_E0EE55EDF5B4AB6C__TRYFETCHEQUIPTOSELECT_B__8_0_OFFSET UNITYSDK_OFFSET(0x1679C0A0)
#define CLASS_2_E0EE55EDF5B4AB6C__TRYFETCHEQUIPTOSELECT_B__8_1_OFFSET UNITYSDK_OFFSET(0x1679C2F0)
#define CLASS_2_E0EE55EDF5B4AB6C___REQUESTGETPENDINGEQUIP_B__14_0_OFFSET UNITYSDK_OFFSET(0x1679C350)

inline static constexpr unsigned int Class_2_E0EE55EDF5B4AB6C_TypeDefinitionIndex = 74989;

class Class_2_E0EE55EDF5B4AB6C : public ::RPG::Client::BaseGameFlowContext
{
public:
	::RPG::Client::Promises::Promise* BBEFPKDHLBK; // 0x20
	::RPG::Client::Promises::Promise_1<::Class_1_B87B938F2BCBD84D_3*>* EHDMEHABELJ; // 0x28
	::Class_1_4CFEF021C34E7902* HEMMHLHDGBO; // 0x30
	::Class_1_65F865B949733340* EPAAHFFBKFG; // 0x38
