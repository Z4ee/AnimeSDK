...
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_285337D3C1CF4702_OFFSET UNITYSDK_OFFSET(0x139F6A40)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_2BC55A66CB2B0118_1_OFFSET UNITYSDK_OFFSET(0x139F69F0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_2BC55A66CB2B0118_OFFSET UNITYSDK_OFFSET(0x139F69A0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x139F6870)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_59646316BC2281C2_OFFSET UNITYSDK_OFFSET(0x139F65F0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_C445993D022B1BA1_OFFSET UNITYSDK_OFFSET(0x139F68D0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_DE7035732E1EE275_OFFSET UNITYSDK_OFFSET(0x139F64E0)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x139F6350)
#define CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_FA656FDDBAF8003E_OFFSET UNITYSDK_OFFSET(0x139F61E0)
#define CLASS_2_E0EE55EDF5B4AB6C_RECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0x139F6930)
#define CLASS_2_E0EE55EDF5B4AB6C__CTOR_OFFSET UNITYSDK_OFFSET(0x139F6110)
#define CLASS_2_E0EE55EDF5B4AB6C__ONDESTROYED_OFFSET UNITYSDK_OFFSET(0x139F6B90)
#define CLASS_2_E0EE55EDF5B4AB6C__TRYFETCHEQUIPTOSELECT_B__8_0_OFFSET UNITYSDK_OFFSET(0x139F6C80)
#define CLASS_2_E0EE55EDF5B4AB6C__TRYFETCHEQUIPTOSELECT_B__8_1_OFFSET UNITYSDK_OFFSET(0x139F6ED0)
#define CLASS_2_E0EE55EDF5B4AB6C___IFIXBASEPROXY__ONDESTROYED_OFFSET UNITYSDK_OFFSET(0x139F6FE0)
#define CLASS_2_E0EE55EDF5B4AB6C___REQUESTGETPENDINGEQUIP_B__14_0_OFFSET UNITYSDK_OFFSET(0x139F6F30)

inline static constexpr unsigned int Class_2_E0EE55EDF5B4AB6C_TypeDefinitionIndex = 70160;

class Class_2_E0EE55EDF5B4AB6C : public ::RPG::Client::BaseGameFlowContext
{
public:
	::RPG::Client::Promises::Promise* Field_2_0; // 0x20
	::RPG::Client::Promises::Promise_1<::Class_1_B87B938F2BCBD84D_3*>* Field_2_1; // 0x28
	::Class_1_4CFEF021C34E7902* Field_2_2; // 0x30
	::Class_1_65F865B949733340* Field_2_3; // 0x38
	...
	::RPG::Client::Promises::Promise_1<::Class_1_B87B938F2BCBD84D_3*>* Method_2_59646316BC2281C2()
	{
		return ((::RPG::Client::Promises::Promise_1<::Class_1_B87B938F2BCBD84D_3*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_E0EE55EDF5B4AB6C_METHOD_2_59646316BC2281C2_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_E0EE55EDF5B4AB6C___IFIXBASEPROXY__ONDESTROYED_OFFSET))(this);
	}
};
