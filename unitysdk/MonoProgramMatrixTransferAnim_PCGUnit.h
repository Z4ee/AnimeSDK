...
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_18D3A646DDD61291_OFFSET UNITYSDK_OFFSET(0x186F5280)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x186F5E40)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_D737CD2779D51A4E_OFFSET UNITYSDK_OFFSET(0x186F5140)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x186F4E40)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_F83AAA65B6159C8A_OFFSET UNITYSDK_OFFSET(0x186F5A70)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT_METHOD_1_FDC478E941B91C50_OFFSET UNITYSDK_OFFSET(0x186F5E90)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT__CCTOR_OFFSET UNITYSDK_OFFSET(0x186F60E0)
#define MONOPROGRAMMATRIXTRANSFERANIM_PCGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x186F60D0)

inline static constexpr unsigned int MonoProgramMatrixTransferAnim_PCGUnit_TypeDefinitionIndex = 45721;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(MonoProgramMatrixTransferAnim_PCGUnit_TypeDefinitionIndex)->GetStaticField(0x5AB70);
	}
