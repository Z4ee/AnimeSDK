...
#define FLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0x10656BB0)
#define FLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0x10656780)
#define FLIPBOOKOPERATION_METHOD_3_85FE18173B52F41D_OFFSET UNITYSDK_OFFSET(0x10656AE0)
#define FLIPBOOKOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x10656EB0)
#define FLIPBOOKOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x10656F20)
#define FLIPBOOKOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x10656F00)

inline static constexpr unsigned int FlipBookOperation_TypeDefinitionIndex = 38036;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FlipBookOperation_TypeDefinitionIndex)->GetStaticField(0x9850);
	}
