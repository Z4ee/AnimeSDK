...
#define FLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_1_OFFSET UNITYSDK_OFFSET(0x1382FE00)
#define FLIPBOOKOPERATION_METHOD_3_6454AD7212B2C6DE_OFFSET UNITYSDK_OFFSET(0x1382FA00)
#define FLIPBOOKOPERATION_METHOD_3_85FE18173B52F41D_OFFSET UNITYSDK_OFFSET(0x1382FD30)
#define FLIPBOOKOPERATION_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x138300D0)
#define FLIPBOOKOPERATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x13830140)
#define FLIPBOOKOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x13830120)

inline static constexpr unsigned int FlipBookOperation_TypeDefinitionIndex = 44463;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FlipBookOperation_TypeDefinitionIndex)->GetStaticField(0x123A0);
	}
