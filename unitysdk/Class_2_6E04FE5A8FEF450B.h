...
#define CLASS_2_6E04FE5A8FEF450B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17889FA0)
#define CLASS_2_6E04FE5A8FEF450B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17889FE0)
#define CLASS_2_6E04FE5A8FEF450B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1788A030)
#define CLASS_2_6E04FE5A8FEF450B_TICK_OFFSET UNITYSDK_OFFSET(0x1788A080)
#define CLASS_2_6E04FE5A8FEF450B__CTOR_OFFSET UNITYSDK_OFFSET(0x17889F90)

inline static constexpr unsigned int Class_2_6E04FE5A8FEF450B_TypeDefinitionIndex = 53200;

class Class_2_6E04FE5A8FEF450B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::IncreaseMissionCustomValue* OFKGLJOAMLD; // 0x18
