...
#define CLASS_2_6E04FE5A8FEF450B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11174EE0)
#define CLASS_2_6E04FE5A8FEF450B_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x11174F20)
#define CLASS_2_6E04FE5A8FEF450B_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x11174F70)
#define CLASS_2_6E04FE5A8FEF450B_TICK_OFFSET UNITYSDK_OFFSET(0x11174FC0)
#define CLASS_2_6E04FE5A8FEF450B__CTOR_OFFSET UNITYSDK_OFFSET(0x11174ED0)

inline static constexpr unsigned int Class_2_6E04FE5A8FEF450B_TypeDefinitionIndex = 42832;

class Class_2_6E04FE5A8FEF450B : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::IncreaseMissionCustomValue* Field_2_0; // 0x20
