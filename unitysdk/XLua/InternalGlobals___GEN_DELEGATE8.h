...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE8_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xFF5F7C0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE8_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xFF5F840)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE8_INVOKE_OFFSET UNITYSDK_OFFSET(0xFF5F1C0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE8__CTOR_OFFSET UNITYSDK_OFFSET(0xFF49A50)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE8_TypeDefinitionIndex = 40425;
