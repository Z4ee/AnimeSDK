...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE4_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11220C40)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE4_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11220C70)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE4_INVOKE_OFFSET UNITYSDK_OFFSET(0x112206E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE4__CTOR_OFFSET UNITYSDK_OFFSET(0x11212B80)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE4_TypeDefinitionIndex = 46330;
