...
namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator___c__DisplayClass7017_0_1_TypeDefinitionIndex = 50459;

	template <typename T>
	class ObjectTranslator___c__DisplayClass7017_0_1 : public ::System::Object
	{
	public:
