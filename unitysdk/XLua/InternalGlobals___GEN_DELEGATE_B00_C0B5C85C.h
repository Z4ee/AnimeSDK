...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE_B00_C0B5C85C_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14B1E4F0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE_B00_C0B5C85C_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14B1E550)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE_B00_C0B5C85C_INVOKE_OFFSET UNITYSDK_OFFSET(0x14B1E4E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE_B00_C0B5C85C__CTOR_OFFSET UNITYSDK_OFFSET(0x14B1E3F0)
