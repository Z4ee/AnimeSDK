...
#define XLUA_LUADLL_LUA_CSFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12E92C60)
#define XLUA_LUADLL_LUA_CSFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12E92CB0)
#define XLUA_LUADLL_LUA_CSFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x12E92C50)
#define XLUA_LUADLL_LUA_CSFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x12E92BE0)

namespace XLua::LuaDLL
{
	inline static constexpr unsigned int lua_CSFunction_TypeDefinitionIndex = 48386;
