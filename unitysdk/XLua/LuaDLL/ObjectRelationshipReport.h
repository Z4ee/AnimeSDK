...
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12E929D0)
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12E92AD0)
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT_INVOKE_OFFSET UNITYSDK_OFFSET(0x12E92980)
#define XLUA_LUADLL_OBJECTRELATIONSHIPREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x12E92910)

namespace XLua::LuaDLL
{
	inline static constexpr unsigned int ObjectRelationshipReport_TypeDefinitionIndex = 48383;
