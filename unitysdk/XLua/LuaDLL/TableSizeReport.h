...
#define XLUA_LUADLL_TABLESIZEREPORT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x10BE69F0)
#define XLUA_LUADLL_TABLESIZEREPORT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x10BE6A60)
#define XLUA_LUADLL_TABLESIZEREPORT_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BE69E0)
#define XLUA_LUADLL_TABLESIZEREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x10BE6970)

namespace XLua::LuaDLL
{
	inline static constexpr unsigned int TableSizeReport_TypeDefinitionIndex = 49381;
