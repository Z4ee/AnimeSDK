...
namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator___c__DisplayClass6312_0_1_TypeDefinitionIndex = 40411;

	template <typename T>
	class ObjectTranslator___c__DisplayClass6312_0_1 : public ::System::Object
	{
	public:
