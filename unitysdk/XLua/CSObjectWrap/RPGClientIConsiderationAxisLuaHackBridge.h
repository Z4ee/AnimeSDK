...
#define XLUA_CSOBJECTWRAP_RPGCLIENTICONSIDERATIONAXISLUAHACKBRIDGE_RPG_CLIENT_ICONSIDERATIONAXISLUAHACK_END_SCORE_OFFSET UNITYSDK_OFFSET(0xFBC9AF0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICONSIDERATIONAXISLUAHACKBRIDGE_RPG_CLIENT_ICONSIDERATIONAXISLUAHACK_END_SETUP_OFFSET UNITYSDK_OFFSET(0xFBCA5B0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICONSIDERATIONAXISLUAHACKBRIDGE_RPG_CLIENT_ICONSIDERATIONAXISLUAHACK_START_SCORE_OFFSET UNITYSDK_OFFSET(0xFBC9550)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICONSIDERATIONAXISLUAHACKBRIDGE_RPG_CLIENT_ICONSIDERATIONAXISLUAHACK_START_SETUP_OFFSET UNITYSDK_OFFSET(0xFBCA030)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICONSIDERATIONAXISLUAHACKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xFBC9540)
#define XLUA_CSOBJECTWRAP_RPGCLIENTICONSIDERATIONAXISLUAHACKBRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0xFBC94F0)

namespace XLua::CSObjectWrap
{
	inline static constexpr unsigned int RPGClientIConsiderationAxisLuaHackBridge_TypeDefinitionIndex = 41792;
