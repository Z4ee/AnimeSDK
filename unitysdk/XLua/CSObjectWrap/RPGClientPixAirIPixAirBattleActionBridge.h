...
#define XLUA_CSOBJECTWRAP_RPGCLIENTPIXAIRIPIXAIRBATTLEACTIONBRIDGE_RPG_CLIENT_PIXAIR_IPIXAIRBATTLEACTION_CREATEENEMYPLANESNAPSHOTS_OFFSET UNITYSDK_OFFSET(0x12A4A2B0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTPIXAIRIPIXAIRBATTLEACTIONBRIDGE_RPG_CLIENT_PIXAIR_IPIXAIRBATTLEACTION_CREATEPLAYERPLANESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x12A49CC0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTPIXAIRIPIXAIRBATTLEACTIONBRIDGE_RPG_CLIENT_PIXAIR_IPIXAIRBATTLEACTION_GET_BATTLEROUNDINFO_OFFSET UNITYSDK_OFFSET(0x12A4AE10)
#define XLUA_CSOBJECTWRAP_RPGCLIENTPIXAIRIPIXAIRBATTLEACTIONBRIDGE_RPG_CLIENT_PIXAIR_IPIXAIRBATTLEACTION_RESOLVEBATTLE_OFFSET UNITYSDK_OFFSET(0x12A4A890)
#define XLUA_CSOBJECTWRAP_RPGCLIENTPIXAIRIPIXAIRBATTLEACTIONBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x12A49CB0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTPIXAIRIPIXAIRBATTLEACTIONBRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0x12A49C60)

namespace XLua::CSObjectWrap
{
	inline static constexpr unsigned int RPGClientPixAirIPixAirBattleActionBridge_TypeDefinitionIndex = 48376;
