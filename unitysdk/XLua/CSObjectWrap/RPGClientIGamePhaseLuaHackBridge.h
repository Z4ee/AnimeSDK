...
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_ENTER_OFFSET UNITYSDK_OFFSET(0xFBCD0E0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_LATE_UPDATE_OFFSET UNITYSDK_OFFSET(0xFBCE700)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_LEAVE_OFFSET UNITYSDK_OFFSET(0xFBCF1F0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_END_TICK_OFFSET UNITYSDK_OFFSET(0xFBCDBB0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_ENTER_OFFSET UNITYSDK_OFFSET(0xFBCCB80)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_LATE_UPDATE_OFFSET UNITYSDK_OFFSET(0xFBCE120)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_LEAVE_OFFSET UNITYSDK_OFFSET(0xFBCEC70)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE_RPG_CLIENT_IGAMEPHASELUAHACK_START_TICK_OFFSET UNITYSDK_OFFSET(0xFBCD5D0)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0xFBCCB70)
#define XLUA_CSOBJECTWRAP_RPGCLIENTIGAMEPHASELUAHACKBRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0xFBCCB20)

namespace XLua::CSObjectWrap
{
	inline static constexpr unsigned int RPGClientIGamePhaseLuaHackBridge_TypeDefinitionIndex = 41794;
