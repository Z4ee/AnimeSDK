...
#define XLUA_CSOBJECTWRAP_SYSTEMCOLLECTIONSGENERICIENUMERABLE_1_SYSTEMUINT32_BRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_UINT32__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x12BEB0A0)
#define XLUA_CSOBJECTWRAP_SYSTEMCOLLECTIONSGENERICIENUMERABLE_1_SYSTEMUINT32_BRIDGE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x12BEB5E0)
#define XLUA_CSOBJECTWRAP_SYSTEMCOLLECTIONSGENERICIENUMERABLE_1_SYSTEMUINT32_BRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x12BEB090)
#define XLUA_CSOBJECTWRAP_SYSTEMCOLLECTIONSGENERICIENUMERABLE_1_SYSTEMUINT32_BRIDGE___CREATE_OFFSET UNITYSDK_OFFSET(0x12BEB040)

namespace XLua::CSObjectWrap
{
	inline static constexpr unsigned int SystemCollectionsGenericIEnumerable_1_SystemUInt32_Bridge_TypeDefinitionIndex = 48377;
