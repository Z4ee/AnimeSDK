...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x112192F0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11219320)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20_INVOKE_OFFSET UNITYSDK_OFFSET(0x11218D90)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20__CTOR_OFFSET UNITYSDK_OFFSET(0x11212DA0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE20_TypeDefinitionIndex = 46346;
