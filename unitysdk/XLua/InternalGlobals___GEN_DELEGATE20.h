...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8FE0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9010)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20_INVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8FD0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE20__CTOR_OFFSET UNITYSDK_OFFSET(0x11CE8EE0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE20_TypeDefinitionIndex = 47901;
