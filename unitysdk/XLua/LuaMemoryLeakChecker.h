...
#define XLUA_LUAMEMORYLEAKCHECKER_FINDGROWING_OFFSET UNITYSDK_OFFSET(0xFF6D490)
#define XLUA_LUAMEMORYLEAKCHECKER_GETRELATIONSHIP_OFFSET UNITYSDK_OFFSET(0xFF6D110)
#define XLUA_LUAMEMORYLEAKCHECKER_GETSIZEREPORT_OFFSET UNITYSDK_OFFSET(0xFF6CC80)
#define XLUA_LUAMEMORYLEAKCHECKER_MAKEKEY_OFFSET UNITYSDK_OFFSET(0xFF6CFA0)
#define XLUA_LUAMEMORYLEAKCHECKER_MEMORYLEAKCHECK_OFFSET UNITYSDK_OFFSET(0xFF6D750)
#define XLUA_LUAMEMORYLEAKCHECKER_MEMORYLEAKREPORT_OFFSET UNITYSDK_OFFSET(0xFF6D840)
#define XLUA_LUAMEMORYLEAKCHECKER_STARTMEMORYLEAKCHECK_OFFSET UNITYSDK_OFFSET(0xFF6D3B0)

namespace XLua
{
	inline static constexpr unsigned int LuaMemoryLeakChecker_TypeDefinitionIndex = 40381;
