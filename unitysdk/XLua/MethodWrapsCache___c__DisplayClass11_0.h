...
#define XLUA_METHODWRAPSCACHE___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0xFF719A0)
#define XLUA_METHODWRAPSCACHE___C__DISPLAYCLASS11_0__GETEVENTWRAP_B__0_OFFSET UNITYSDK_OFFSET(0xFF71CD0)
...
namespace XLua
{
	...
	public:
		...
		::System::Reflection::MethodInfo* remove; // 0x18
