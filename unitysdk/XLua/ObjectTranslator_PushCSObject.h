...
#define XLUA_OBJECTTRANSLATOR_PUSHCSOBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAE0EFC0)
#define XLUA_OBJECTTRANSLATOR_PUSHCSOBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAE0F030)
#define XLUA_OBJECTTRANSLATOR_PUSHCSOBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0xAE0EFB0)
#define XLUA_OBJECTTRANSLATOR_PUSHCSOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAE0EF40)

namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator_PushCSObject_TypeDefinitionIndex = 47860;
