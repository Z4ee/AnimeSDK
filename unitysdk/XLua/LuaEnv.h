...
#define XLUA_LUAENV_ADDBUILDIN_OFFSET UNITYSDK_OFFSET(0x112342E0)
#define XLUA_LUAENV_ADDINITER_OFFSET UNITYSDK_OFFSET(0x112344F0)
#define XLUA_LUAENV_ADDLOADER_OFFSET UNITYSDK_OFFSET(0x11235380)
#define XLUA_LUAENV_ADDSEARCHER_OFFSET UNITYSDK_OFFSET(0x11233D70)
#define XLUA_LUAENV_ALIAS_OFFSET UNITYSDK_OFFSET(0x11234B30)
#define XLUA_LUAENV_CREATEUSERDATADTOR_OFFSET UNITYSDK_OFFSET(0x112343A0)
#define XLUA_LUAENV_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x11235180)
#define XLUA_LUAENV_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11234F40)
#define XLUA_LUAENV_DOSTRING_1_OFFSET UNITYSDK_OFFSET(0x11234220)
#define XLUA_LUAENV_DOSTRING_OFFSET UNITYSDK_OFFSET(0x11234660)
#define XLUA_LUAENV_DTORFUNCTIONMETAFUNCTION_OFFSET UNITYSDK_OFFSET(0x11231F10)
#define XLUA_LUAENV_EQUEUEGCACTION_OFFSET UNITYSDK_OFFSET(0x1122B040)
#define XLUA_LUAENV_FULLGC_OFFSET UNITYSDK_OFFSET(0x112350C0)
#define XLUA_LUAENV_GCSTEP_OFFSET UNITYSDK_OFFSET(0x11235770)
#define XLUA_LUAENV_GC_OFFSET UNITYSDK_OFFSET(0x11234D10)
#define XLUA_LUAENV_GET_GCSTEPMUL_OFFSET UNITYSDK_OFFSET(0x112353B0)
#define XLUA_LUAENV_GET_GLOBAL_OFFSET UNITYSDK_OFFSET(0x112345F0)
#define XLUA_LUAENV_GET_L_OFFSET UNITYSDK_OFFSET(0x1120E010)
#define XLUA_LUAENV_GET_MEMROY_OFFSET UNITYSDK_OFFSET(0x11235840)
#define XLUA_LUAENV_GET_TRACEBACK_OFFSET UNITYSDK_OFFSET(0x11235900)
#define XLUA_LUAENV_GET_TRANSLATOR_OFFSET UNITYSDK_OFFSET(0x11231F50)
#define XLUA_LUAENV_LOADSTRING_OFFSET UNITYSDK_OFFSET(0x11234600)
#define XLUA_LUAENV_NEWTABLE_OFFSET UNITYSDK_OFFSET(0x11234D20)
#define XLUA_LUAENV_OBJECTVALIDCHECK_OFFSET UNITYSDK_OFFSET(0x11234B50)
#define XLUA_LUAENV_ONDISPOSEDEBUGGER_OFFSET UNITYSDK_OFFSET(0x112344E0)
#define XLUA_LUAENV_RESTARTGC_OFFSET UNITYSDK_OFFSET(0x112356B0)
#define XLUA_LUAENV_SET_GCSTEPMUL_OFFSET UNITYSDK_OFFSET(0x11235530)
#define XLUA_LUAENV_STARTDEBUGGER_OFFSET UNITYSDK_OFFSET(0x112344D0)
#define XLUA_LUAENV_STOPGC_OFFSET UNITYSDK_OFFSET(0x112355F0)
#define XLUA_LUAENV_THROWEXCEPTIONFROMERROR_OFFSET UNITYSDK_OFFSET(0x1120DB20)
#define XLUA_LUAENV_TICK_OFFSET UNITYSDK_OFFSET(0x11234B90)
#define XLUA_LUAENV__CCTOR_OFFSET UNITYSDK_OFFSET(0x112359F0)
#define XLUA_LUAENV__CTOR_OFFSET UNITYSDK_OFFSET(0x11231F60)
...
namespace XLua
{
	...
	public:
		...
		::System::Func_2<::System::Object*, ::System::Boolean>* object_valid_checker; // 0x10
		...
		::System::Int32 max_check_per_tick; // 0x54
