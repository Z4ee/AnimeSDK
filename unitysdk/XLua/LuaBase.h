...
#define XLUA_LUABASE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x14B20390)
#define XLUA_LUABASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x14B202B0)
#define XLUA_LUABASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x14B20680)
#define XLUA_LUABASE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x14B201E0)
#define XLUA_LUABASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x14B20C70)
#define XLUA_LUABASE_PUSH_OFFSET UNITYSDK_OFFSET(0x14B21000)
#define XLUA_LUABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x14B201D0)
