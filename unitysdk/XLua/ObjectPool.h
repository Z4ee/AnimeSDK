...
#define XLUA_OBJECTPOOL_ADD_OFFSET UNITYSDK_OFFSET(0x11244EF0)
#define XLUA_OBJECTPOOL_CHECK_OFFSET UNITYSDK_OFFSET(0x11245150)
#define XLUA_OBJECTPOOL_CLEAR_OFFSET UNITYSDK_OFFSET(0x11244DE0)
#define XLUA_OBJECTPOOL_EXTEND_CAPACITY_OFFSET UNITYSDK_OFFSET(0x11244E20)
#define XLUA_OBJECTPOOL_GET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x11244D70)
#define XLUA_OBJECTPOOL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x11244D90)
#define XLUA_OBJECTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x11245030)
#define XLUA_OBJECTPOOL_GET_SLOTSIZE_OFFSET UNITYSDK_OFFSET(0x11244D50)
#define XLUA_OBJECTPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0x11245080)
#define XLUA_OBJECTPOOL_REPLACE_OFFSET UNITYSDK_OFFSET(0x11245100)
#define XLUA_OBJECTPOOL_SET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x11244D80)
#define XLUA_OBJECTPOOL_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x11244FD0)
#define XLUA_OBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x11245410)

namespace XLua
{
	inline static constexpr unsigned int ObjectPool_TypeDefinitionIndex = 46434;
