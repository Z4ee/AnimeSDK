...
#define XLUA_OBJECTPOOL_ADD_OFFSET UNITYSDK_OFFSET(0x10BFBB40)
#define XLUA_OBJECTPOOL_CHECK_OFFSET UNITYSDK_OFFSET(0x10BE9CD0)
#define XLUA_OBJECTPOOL_CLEAR_OFFSET UNITYSDK_OFFSET(0x10BFBA60)
#define XLUA_OBJECTPOOL_EXTEND_CAPACITY_OFFSET UNITYSDK_OFFSET(0x10BFBAA0)
#define XLUA_OBJECTPOOL_GET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x10BFBA00)
#define XLUA_OBJECTPOOL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x10BFBA20)
#define XLUA_OBJECTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x10BFBC60)
#define XLUA_OBJECTPOOL_GET_SLOTSIZE_OFFSET UNITYSDK_OFFSET(0x10BFB9E0)
#define XLUA_OBJECTPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0x10BFBCA0)
#define XLUA_OBJECTPOOL_REPLACE_OFFSET UNITYSDK_OFFSET(0x10BFBD10)
#define XLUA_OBJECTPOOL_SET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x10BFBA10)
#define XLUA_OBJECTPOOL_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x10BFBC00)
#define XLUA_OBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x10BFBD60)

namespace XLua
{
	inline static constexpr unsigned int ObjectPool_TypeDefinitionIndex = 47990;
	...
	public:
		...
		::System::Int32 _allocedCount; // 0x18
		::System::Int32 count; // 0x1C
		::System::Int32 freelist; // 0x20
