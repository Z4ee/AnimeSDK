...
#define XLUA_OBJECTPOOL_ADD_OFFSET UNITYSDK_OFFSET(0x118743B0)
#define XLUA_OBJECTPOOL_CHECK_OFFSET UNITYSDK_OFFSET(0x118627C0)
#define XLUA_OBJECTPOOL_CLEAR_OFFSET UNITYSDK_OFFSET(0x118742D0)
#define XLUA_OBJECTPOOL_EXTEND_CAPACITY_OFFSET UNITYSDK_OFFSET(0x11874310)
#define XLUA_OBJECTPOOL_GET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x11874270)
#define XLUA_OBJECTPOOL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x11874290)
#define XLUA_OBJECTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x118744D0)
#define XLUA_OBJECTPOOL_GET_SLOTSIZE_OFFSET UNITYSDK_OFFSET(0x11874250)
#define XLUA_OBJECTPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0x11874510)
#define XLUA_OBJECTPOOL_REPLACE_OFFSET UNITYSDK_OFFSET(0x11874580)
#define XLUA_OBJECTPOOL_SET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x11874280)
#define XLUA_OBJECTPOOL_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x11874470)
#define XLUA_OBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x118745D0)
