...
#define XLUA_OBJECTPOOL_ADD_OFFSET UNITYSDK_OFFSET(0x14B3BE70)
#define XLUA_OBJECTPOOL_CHECK_OFFSET UNITYSDK_OFFSET(0x14B2A280)
#define XLUA_OBJECTPOOL_CLEAR_OFFSET UNITYSDK_OFFSET(0x14B3BD90)
#define XLUA_OBJECTPOOL_EXTEND_CAPACITY_OFFSET UNITYSDK_OFFSET(0x14B3BDD0)
#define XLUA_OBJECTPOOL_GET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x14B3BD30)
#define XLUA_OBJECTPOOL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x14B3BD50)
#define XLUA_OBJECTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x14B3BF90)
#define XLUA_OBJECTPOOL_GET_SLOTSIZE_OFFSET UNITYSDK_OFFSET(0x14B3BD10)
#define XLUA_OBJECTPOOL_REMOVE_OFFSET UNITYSDK_OFFSET(0x14B3BFD0)
#define XLUA_OBJECTPOOL_REPLACE_OFFSET UNITYSDK_OFFSET(0x14B3C040)
#define XLUA_OBJECTPOOL_SET_ALLOCEDCOUNT_OFFSET UNITYSDK_OFFSET(0x14B3BD40)
#define XLUA_OBJECTPOOL_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x14B3BF30)
#define XLUA_OBJECTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x14B3C090)

namespace XLua
{
	inline static constexpr unsigned int ObjectPool_TypeDefinitionIndex = 50573;
