...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12E865E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12E86640)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0_INVOKE_OFFSET UNITYSDK_OFFSET(0x12E865D0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE0__CTOR_OFFSET UNITYSDK_OFFSET(0x12E864E0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE0_TypeDefinitionIndex = 46916;
