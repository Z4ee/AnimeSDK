...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE41_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x112215C0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE41_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11221610)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE41_INVOKE_OFFSET UNITYSDK_OFFSET(0x112212B0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE41__CTOR_OFFSET UNITYSDK_OFFSET(0x11213060)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE41_TypeDefinitionIndex = 46367;
