...
#define XLUA_OBJECTTRANSLATOR___C__DISPLAYCLASS6798_1__CTOR_OFFSET UNITYSDK_OFFSET(0x157AC010)
#define XLUA_OBJECTTRANSLATOR___C__DISPLAYCLASS6798_1__GETCREATORUSINGGENERIC_B__8_OFFSET UNITYSDK_OFFSET(0x157B4CB0)
...
namespace XLua
{
	...
	{
	public:
		::XLua::ObjectTranslator___c__DisplayClass6798_0* CS___8__locals1; // 0x10
