...
#define XLUA_HOTFIXDELEGATEBRIDGE_GET_OFFSET UNITYSDK_OFFSET(0x11CE0F20)
#define XLUA_HOTFIXDELEGATEBRIDGE_SET_OFFSET UNITYSDK_OFFSET(0x11CE0F80)
#define XLUA_HOTFIXDELEGATEBRIDGE_XLUA_GET_HOTFIX_FLAG_OFFSET UNITYSDK_OFFSET(0x11CE0E70)

namespace XLua
{
	inline static constexpr unsigned int HotfixDelegateBridge_TypeDefinitionIndex = 47949;
