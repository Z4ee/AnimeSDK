...
#define XLUA_OBJECTTRANSLATOR_EXTRAPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1164D1A0)

namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator_ExtraParameter_TypeDefinitionIndex = 46304;
