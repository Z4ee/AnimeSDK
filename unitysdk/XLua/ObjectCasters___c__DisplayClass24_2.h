...
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__CTOR_OFFSET UNITYSDK_OFFSET(0x10BF5F10)
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__GENCASTER_B__8_OFFSET UNITYSDK_OFFSET(0x10BF8480)

namespace XLua
{
	inline static constexpr unsigned int ObjectCasters___c__DisplayClass24_2_TypeDefinitionIndex = 47988;

	class ObjectCasters___c__DisplayClass24_2 : public ::System::Object
	{
	public:
		::System::Type* keyType; // 0x10
		::XLua::ObjectCast* valueCaster; // 0x18
		::XLua::ObjectCast* keyCaster; // 0x20
