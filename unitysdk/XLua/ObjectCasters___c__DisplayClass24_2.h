...
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1186E6E0)
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__GENCASTER_B__8_OFFSET UNITYSDK_OFFSET(0x11870CC0)
...
namespace XLua
{
	...
	public:
		...
		::XLua::ObjectCasters___c__DisplayClass24_0* CS___8__locals2; // 0x30
