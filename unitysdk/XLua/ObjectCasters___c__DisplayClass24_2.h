...
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1123FB20)
#define XLUA_OBJECTCASTERS___C__DISPLAYCLASS24_2__GENCASTER_B__8_OFFSET UNITYSDK_OFFSET(0x11241970)
...
namespace XLua
{
	...
	public:
		...
		::XLua::ObjectCast* valueCaster; // 0x28
