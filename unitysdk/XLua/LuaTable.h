...
#define XLUA_LUATABLE_GETKEYS_OFFSET UNITYSDK_OFFSET(0x10BEDE20)
#define XLUA_LUATABLE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x10BEDB10)
#define XLUA_LUATABLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x10BEDAB0)
#define XLUA_LUATABLE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x10BEDBD0)
#define XLUA_LUATABLE_PUSH_OFFSET UNITYSDK_OFFSET(0x10BE9830)
#define XLUA_LUATABLE_SETMETATABLE_OFFSET UNITYSDK_OFFSET(0x10BEDEA0)
#define XLUA_LUATABLE_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x10BEDB80)
#define XLUA_LUATABLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x10BEDAC0)
#define XLUA_LUATABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10BEE210)
#define XLUA_LUATABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x10BEDAA0)

namespace XLua
{
	inline static constexpr unsigned int LuaTable_TypeDefinitionIndex = 47959;
