...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE25_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9660)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE25_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9690)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE25_INVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9650)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE25__CTOR_OFFSET UNITYSDK_OFFSET(0x11CE9560)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE25_TypeDefinitionIndex = 47906;
