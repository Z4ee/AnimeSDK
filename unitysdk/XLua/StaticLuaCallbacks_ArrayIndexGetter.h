...
#define XLUA_STATICLUACALLBACKS_ARRAYINDEXGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1343B110)
#define XLUA_STATICLUACALLBACKS_ARRAYINDEXGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1343B1A0)
#define XLUA_STATICLUACALLBACKS_ARRAYINDEXGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1343B0E0)
#define XLUA_STATICLUACALLBACKS_ARRAYINDEXGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1343B070)

namespace XLua
{
	inline static constexpr unsigned int StaticLuaCallbacks_ArrayIndexGetter_TypeDefinitionIndex = 46913;
