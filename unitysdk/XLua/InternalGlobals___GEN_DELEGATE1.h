...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xFF4BC00)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xFF4BC30)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1_INVOKE_OFFSET UNITYSDK_OFFSET(0xFF4B6A0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE1__CTOR_OFFSET UNITYSDK_OFFSET(0xFF49970)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE1_TypeDefinitionIndex = 40418;
