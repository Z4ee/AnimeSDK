...
#define XLUA_LUAFUNCTION_CALL_1_OFFSET UNITYSDK_OFFSET(0x14B2B220)
#define XLUA_LUAFUNCTION_CALL_OFFSET UNITYSDK_OFFSET(0x14B2B480)
#define XLUA_LUAFUNCTION_PUSH_OFFSET UNITYSDK_OFFSET(0x14B2BB40)
#define XLUA_LUAFUNCTION_SETENV_OFFSET UNITYSDK_OFFSET(0x14B2B850)
#define XLUA_LUAFUNCTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x14B2BBF0)
#define XLUA_LUAFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x14B2B470)
