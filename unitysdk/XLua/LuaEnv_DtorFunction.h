...
#define XLUA_LUAENV_DTORFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x10BEAE40)
#define XLUA_LUAENV_DTORFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x10BEAEB0)
#define XLUA_LUAENV_DTORFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BEAE30)
#define XLUA_LUAENV_DTORFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x10BEADC0)

namespace XLua
{
	inline static constexpr unsigned int LuaEnv_DtorFunction_TypeDefinitionIndex = 47953;
