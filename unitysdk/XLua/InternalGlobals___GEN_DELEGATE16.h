...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE16_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8940)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE16_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8970)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE16_INVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8930)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE16__CTOR_OFFSET UNITYSDK_OFFSET(0x11CE8840)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE16_TypeDefinitionIndex = 47897;
