...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12E873B0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12E873E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18_INVOKE_OFFSET UNITYSDK_OFFSET(0x12E873A0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18__CTOR_OFFSET UNITYSDK_OFFSET(0x12E872B0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE18_TypeDefinitionIndex = 46934;
