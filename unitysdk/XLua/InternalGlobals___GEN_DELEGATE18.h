...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x112181D0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11218200)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18_INVOKE_OFFSET UNITYSDK_OFFSET(0x11217C70)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE18__CTOR_OFFSET UNITYSDK_OFFSET(0x11212D60)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE18_TypeDefinitionIndex = 46344;
