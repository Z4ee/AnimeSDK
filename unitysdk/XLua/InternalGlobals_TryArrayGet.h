...
#define XLUA_INTERNALGLOBALS_TRYARRAYGET_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11213A00)
#define XLUA_INTERNALGLOBALS_TRYARRAYGET_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11213AA0)
#define XLUA_INTERNALGLOBALS_TRYARRAYGET_INVOKE_OFFSET UNITYSDK_OFFSET(0x11213350)
#define XLUA_INTERNALGLOBALS_TRYARRAYGET__CTOR_OFFSET UNITYSDK_OFFSET(0x11213300)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals_TryArrayGet_TypeDefinitionIndex = 46390;
