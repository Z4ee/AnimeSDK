...
#define XLUA_UTILS_ABS_IDX_OFFSET UNITYSDK_OFFSET(0xE972350)
#define XLUA_UTILS_BEGINCLASSREGISTER_OFFSET UNITYSDK_OFFSET(0xE973D90)
#define XLUA_UTILS_BEGINOBJECTREGISTER_1_OFFSET UNITYSDK_OFFSET(0xE9718C0)
#define XLUA_UTILS_BEGINOBJECTREGISTER_OFFSET UNITYSDK_OFFSET(0xE970D50)
#define XLUA_UTILS_ENDCLASSREGISTER_OFFSET UNITYSDK_OFFSET(0xE974460)
#define XLUA_UTILS_ENDOBJECTREGISTER_OFFSET UNITYSDK_OFFSET(0xE972360)
#define XLUA_UTILS_GENENUMCASTFROM_OFFSET UNITYSDK_OFFSET(0xE966A50)
#define XLUA_UTILS_GENFIELDGETTER_OFFSET UNITYSDK_OFFSET(0xE9660F0)
#define XLUA_UTILS_GENFIELDSETTER_OFFSET UNITYSDK_OFFSET(0xE9661F0)
#define XLUA_UTILS_GENITEMGETTER_OFFSET UNITYSDK_OFFSET(0xE9662F0)
#define XLUA_UTILS_GENITEMSETTER_OFFSET UNITYSDK_OFFSET(0xE9666A0)
#define XLUA_UTILS_GETALLTYPES_OFFSET UNITYSDK_OFFSET(0xE965D90)
#define XLUA_UTILS_GETEXTENDEDTYPE_OFFSET UNITYSDK_OFFSET(0xE976160)
#define XLUA_UTILS_GETEXTENSIONMETHODSOF_OFFSET UNITYSDK_OFFSET(0xE966AD0)
#define XLUA_UTILS_GETMAINSTATE_OFFSET UNITYSDK_OFFSET(0xE965B70)
#define XLUA_UTILS_GETPATHOFTYPE_OFFSET UNITYSDK_OFFSET(0xE974EF0)
#define XLUA_UTILS_ISINBLACKLIST_OFFSET UNITYSDK_OFFSET(0xE9769C0)
#define XLUA_UTILS_ISPARAMSMATCH_OFFSET UNITYSDK_OFFSET(0xE975420)
#define XLUA_UTILS_ISPUBLIC_OFFSET UNITYSDK_OFFSET(0xE976620)
#define XLUA_UTILS_ISSTATICPINVOKECSFUNCTION_OFFSET UNITYSDK_OFFSET(0xE976450)
#define XLUA_UTILS_ISSUPPORTEDMETHOD_OFFSET UNITYSDK_OFFSET(0xE9759B0)
#define XLUA_UTILS_LAZYREFLECTIONCALL_OFFSET UNITYSDK_OFFSET(0xE964080)
#define XLUA_UTILS_LOADCSTABLE_OFFSET UNITYSDK_OFFSET(0xE96D360)
#define XLUA_UTILS_LOADFIELD_OFFSET UNITYSDK_OFFSET(0xE9659F0)
#define XLUA_UTILS_LOADUPVALUE_OFFSET UNITYSDK_OFFSET(0xE96BD70)
#define XLUA_UTILS_MAKEGENERICMETHODWITHCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0xE975E80)
#define XLUA_UTILS_MAKEPRIVATEACCESSIBLE_OFFSET UNITYSDK_OFFSET(0xE96C6B0)
#define XLUA_UTILS_MAKEREFLECTIONWRAP_OFFSET UNITYSDK_OFFSET(0xE968620)
#define XLUA_UTILS_REFLECTIONWRAP_OFFSET UNITYSDK_OFFSET(0xE96D780)
#define XLUA_UTILS_REGISTERENUMTYPE_OFFSET UNITYSDK_OFFSET(0xE96C240)
#define XLUA_UTILS_REGISTERFUNC_OFFSET UNITYSDK_OFFSET(0xE973330)
#define XLUA_UTILS_REGISTERLAZYFUNC_OFFSET UNITYSDK_OFFSET(0xE973AD0)
#define XLUA_UTILS_REGISTEROBJECT_OFFSET UNITYSDK_OFFSET(0xE96C550)
#define XLUA_UTILS_REGISTERREFLECTIONFUNC_OFFSET UNITYSDK_OFFSET(0xE973470)
#define XLUA_UTILS_SETCSTABLE_OFFSET UNITYSDK_OFFSET(0xE970330)
#define XLUA_UTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0xE977360)
#define XLUA_UTILS__M_REFLECTION_FUNC_OFFSET UNITYSDK_OFFSET(0xE973780)

namespace XLua
{
	inline static constexpr unsigned int Utils_TypeDefinitionIndex = 48010;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::XLua::LuaDLL::lua_CSFunction*>**)Il2CppClass::FromTypeDefinitionIndex(Utils_TypeDefinitionIndex)->GetStaticField(0x33800);
		}
