...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE13_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8520)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE13_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8550)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE13_INVOKE_OFFSET UNITYSDK_OFFSET(0x11CE8510)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE13__CTOR_OFFSET UNITYSDK_OFFSET(0x11CE8420)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE13_TypeDefinitionIndex = 47894;
