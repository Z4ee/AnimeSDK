...
#define XLUA_OBJECTTRANSLATOR_INITERADDER_TABLEOPTIMIZE_INIT_OFFSET UNITYSDK_OFFSET(0x15074D00)
#define XLUA_OBJECTTRANSLATOR_INITERADDER_TABLEOPTIMIZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x15074C90)
#define XLUA_OBJECTTRANSLATOR_INITERADDER_TABLEOPTIMIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x15076250)
