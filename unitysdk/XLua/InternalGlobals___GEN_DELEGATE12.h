...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE12_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11215F70)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE12_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11215FA0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE12_INVOKE_OFFSET UNITYSDK_OFFSET(0x11215A10)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE12__CTOR_OFFSET UNITYSDK_OFFSET(0x11212C80)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE12_TypeDefinitionIndex = 46338;
