...
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x14F87A10)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x14F87A90)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x14F84340)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x14F879A0)

namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator_GetCSObject_TypeDefinitionIndex = 50443;
