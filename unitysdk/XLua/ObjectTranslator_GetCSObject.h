...
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x157B4DB0)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x157B4E30)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x157B1970)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x157B4D40)

namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator_GetCSObject_TypeDefinitionIndex = 47861;
