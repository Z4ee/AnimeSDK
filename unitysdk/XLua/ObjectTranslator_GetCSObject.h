...
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1164D1D0)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1164D250)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x11649F90)
#define XLUA_OBJECTTRANSLATOR_GETCSOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1164D1B0)

namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator_GetCSObject_TypeDefinitionIndex = 46306;
