...
#define XLUA_METHODWRAP_CALL_OFFSET UNITYSDK_OFFSET(0xFF6FD60)
#define XLUA_METHODWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0xFF6FD00)

namespace XLua
{
	inline static constexpr unsigned int MethodWrap_TypeDefinitionIndex = 40494;
