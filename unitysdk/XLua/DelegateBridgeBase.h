...
#define XLUA_DELEGATEBRIDGEBASE_ADDDELEGATE_OFFSET UNITYSDK_OFFSET(0x12B17750)
#define XLUA_DELEGATEBRIDGEBASE_GETDELEGATEBYTYPE_OFFSET UNITYSDK_OFFSET(0x12B17900)
#define XLUA_DELEGATEBRIDGEBASE_TRYGETDELEGATE_OFFSET UNITYSDK_OFFSET(0x12B176A0)
#define XLUA_DELEGATEBRIDGEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x12B17370)

namespace XLua
{
	inline static constexpr unsigned int DelegateBridgeBase_TypeDefinitionIndex = 50463;
	...
	public:
		...
		::System::Delegate* firstValue; // 0x30
