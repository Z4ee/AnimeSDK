...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE9_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x10BDF460)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE9_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x10BDF4C0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE9_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BDF450)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE9__CTOR_OFFSET UNITYSDK_OFFSET(0x10BDF360)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE9_TypeDefinitionIndex = 47890;
