...
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE_GET_CONTAININGCLASS_OFFSET UNITYSDK_OFFSET(0xCDFAE40)
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE_GET_FIRSTPARAMTYPE_OFFSET UNITYSDK_OFFSET(0xCDFAE60)
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0xCDFAE50)
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE_GET_ORDER_OFFSET UNITYSDK_OFFSET(0xCDFAE80)
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0xCDFAE70)
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0xCDFAE30)
#define XLUA_XLUAEXTENSIONMETHODREGISTRATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDFAE90)
...
namespace XLua
{
	...
	{
	public:
		::System::String* _ReturnType_k__BackingField; // 0x10
		::System::String* _ContainingClass_k__BackingField; // 0x18
		::System::String* _FirstParamType_k__BackingField; // 0x20
