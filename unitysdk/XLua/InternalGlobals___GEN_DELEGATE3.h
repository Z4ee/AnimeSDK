...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12E88460)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12E88490)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_INVOKE_OFFSET UNITYSDK_OFFSET(0x12E88450)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3__CTOR_OFFSET UNITYSDK_OFFSET(0x12E883E0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE3_TypeDefinitionIndex = 46919;
