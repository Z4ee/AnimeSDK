...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9C90)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9CC0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_INVOKE_OFFSET UNITYSDK_OFFSET(0x11CE9C80)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3__CTOR_OFFSET UNITYSDK_OFFSET(0x11CE9C10)
