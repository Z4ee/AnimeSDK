...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xFF539B0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xFF539E0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3_INVOKE_OFFSET UNITYSDK_OFFSET(0xFF53450)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE3__CTOR_OFFSET UNITYSDK_OFFSET(0xFF499B0)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE3_TypeDefinitionIndex = 40420;
