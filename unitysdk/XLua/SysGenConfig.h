...
#define XLUA_SYSGENCONFIG_GET_ADDITIONALPROPERTIES_OFFSET UNITYSDK_OFFSET(0x10480020)
#define XLUA_SYSGENCONFIG_GET_GCOPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1047FE20)

namespace XLua
{
	inline static constexpr unsigned int SysGenConfig_TypeDefinitionIndex = 40481;
