...
namespace XLua
{
	inline static constexpr unsigned int ObjectTranslator___c__DisplayClass6598_0_1_TypeDefinitionIndex = 46320;

	template <typename T>
	class ObjectTranslator___c__DisplayClass6598_0_1 : public ::System::Object
	{
	public:
