...
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE31_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x12E88700)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE31_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x12E88730)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE31_INVOKE_OFFSET UNITYSDK_OFFSET(0x12E886F0)
#define XLUA_INTERNALGLOBALS___GEN_DELEGATE31__CTOR_OFFSET UNITYSDK_OFFSET(0x12E88600)

namespace XLua
{
	inline static constexpr unsigned int InternalGlobals___GEN_DELEGATE31_TypeDefinitionIndex = 46947;
