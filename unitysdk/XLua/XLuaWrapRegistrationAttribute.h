...
#define XLUA_XLUAWRAPREGISTRATIONATTRIBUTE_GET_REGISTRATIONKIND_OFFSET UNITYSDK_OFFSET(0xCDFBD60)
#define XLUA_XLUAWRAPREGISTRATIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDFBD70)
