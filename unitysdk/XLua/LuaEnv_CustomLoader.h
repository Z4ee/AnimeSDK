...
#define XLUA_LUAENV_CUSTOMLOADER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x10BEAD70)
#define XLUA_LUAENV_CUSTOMLOADER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x10BEADA0)
#define XLUA_LUAENV_CUSTOMLOADER_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BEAD60)
#define XLUA_LUAENV_CUSTOMLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x10BEACF0)

namespace XLua
{
	inline static constexpr unsigned int LuaEnv_CustomLoader_TypeDefinitionIndex = 47955;
