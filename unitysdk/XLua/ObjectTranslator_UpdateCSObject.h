...
#define XLUA_OBJECTTRANSLATOR_UPDATECSOBJECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xF9FE520)
#define XLUA_OBJECTTRANSLATOR_UPDATECSOBJECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xF9FE5A0)
#define XLUA_OBJECTTRANSLATOR_UPDATECSOBJECT_INVOKE_OFFSET UNITYSDK_OFFSET(0xF9FE500)
#define XLUA_OBJECTTRANSLATOR_UPDATECSOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xF9FE490)
