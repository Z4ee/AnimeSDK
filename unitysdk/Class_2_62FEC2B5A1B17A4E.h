...
#define CLASS_2_62FEC2B5A1B17A4E_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1058C3E0)
#define CLASS_2_62FEC2B5A1B17A4E__CTOR_OFFSET UNITYSDK_OFFSET(0x1058C3C0)

inline static constexpr unsigned int Class_2_62FEC2B5A1B17A4E_TypeDefinitionIndex = 47780;
