...
#define CLASS_1_D2AED4305780B250_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15B1CDF0)
#define CLASS_1_D2AED4305780B250_METHOD_1_2AAB40918C8277F3_OFFSET UNITYSDK_OFFSET(0x15B1D1B0)
#define CLASS_1_D2AED4305780B250_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x15B1D4F0)
#define CLASS_1_D2AED4305780B250_METHOD_1_5D2A544B7C1380CA_OFFSET UNITYSDK_OFFSET(0x15B1D060)
#define CLASS_1_D2AED4305780B250_METHOD_1_B3B927A95FA4DBA6_OFFSET UNITYSDK_OFFSET(0x15B1D490)
#define CLASS_1_D2AED4305780B250_METHOD_1_C295037F92779A7C_OFFSET UNITYSDK_OFFSET(0x15B1D010)
#define CLASS_1_D2AED4305780B250_METHOD_1_DA0FD3E637B62044_OFFSET UNITYSDK_OFFSET(0x15B1D3E0)
#define CLASS_1_D2AED4305780B250_METHOD_1_F4C10798A929EC2C_OFFSET UNITYSDK_OFFSET(0x15B1CC20)
#define CLASS_1_D2AED4305780B250__CCTOR_OFFSET UNITYSDK_OFFSET(0x15B1D5B0)
#define CLASS_1_D2AED4305780B250__CTOR_OFFSET UNITYSDK_OFFSET(0x15B1C420)
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Class_1_D2AED4305780B250_TypeDefinitionIndex)->GetStaticField(0x14290);
	}
	::RPG::Client::AdventurePhase* BLAFNEBDBCH; // 0x10
	::Class_1_6838003491506F6E* EFDAADELOHM; // 0x18
