...
#define CLASS_1_C3FD3943CDE7D4EA__CTOR_OFFSET UNITYSDK_OFFSET(0x15AADE00)
...
public:
	...
	::Class_1_843DD6330B22E422* GNHAPABLMDF; // 0x28
	::RPG::GameCore::GameEntity* DLIDCOJKLNI; // 0x30
