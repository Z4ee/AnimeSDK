...
#define CLASS_2_1C96463735C0B8D6_METHOD_2_37917191637BFFF4_OFFSET UNITYSDK_OFFSET(0x13CCB4A0)
#define CLASS_2_1C96463735C0B8D6_METHOD_2_7835DD7D7F7FF1B7_OFFSET UNITYSDK_OFFSET(0x13CCB5F0)
#define CLASS_2_1C96463735C0B8D6_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x13CCB6C0)
#define CLASS_2_1C96463735C0B8D6__CTOR_OFFSET UNITYSDK_OFFSET(0x13CCB6B0)

inline static constexpr unsigned int Class_2_1C96463735C0B8D6_TypeDefinitionIndex = 47875;

class Class_2_1C96463735C0B8D6 : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_3_6F805C3FA3D1D41D<::MoleMole::UIWorkBenchAppBgForTransitionWidgetController*>* Field_2_0; // 0x18
