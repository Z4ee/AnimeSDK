...
#define HEU_BOUNDINGVOLUME_GETALLINTERSECTINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3B7CA0)
#define HEU_BOUNDINGVOLUME_GET_BOUNDINGCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1B3B7C30)
#define HEU_BOUNDINGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3B8110)

inline static constexpr unsigned int HEU_BoundingVolume_TypeDefinitionIndex = 39050;
