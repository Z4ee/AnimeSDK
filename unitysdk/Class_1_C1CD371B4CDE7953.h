...
#define CLASS_1_C1CD371B4CDE7953_EXECUTE_OFFSET UNITYSDK_OFFSET(0x15246D40)
#define CLASS_1_C1CD371B4CDE7953_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x15246D00)
#define CLASS_1_C1CD371B4CDE7953_METHOD_1_03A6C599DB7ABDEA_OFFSET UNITYSDK_OFFSET(0x15246C20)
#define CLASS_1_C1CD371B4CDE7953_TEARDOWN_OFFSET UNITYSDK_OFFSET(0x152470B0)
#define CLASS_1_C1CD371B4CDE7953__CTOR_OFFSET UNITYSDK_OFFSET(0x15246CC0)

inline static constexpr unsigned int Class_1_C1CD371B4CDE7953_TypeDefinitionIndex = 77657;

class Class_1_C1CD371B4CDE7953 : public ::System::Object
{
public:
	::System::Collections::Generic::HashSet_1<::System::Int32>* NNOANAOOOPA; // 0x10
