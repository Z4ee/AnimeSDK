...
#define PARTICLESPERFDISPLAYER_GET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1FC6FBF0)
#define PARTICLESPERFDISPLAYER_SET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1FC6FC50)
#define PARTICLESPERFDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC6FCB0)

inline static constexpr unsigned int ParticlesPerfDisplayer_TypeDefinitionIndex = 94440;
