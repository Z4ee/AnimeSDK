...
#define PARTICLESPERFDISPLAYER_GET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1C560F10)
#define PARTICLESPERFDISPLAYER_SET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1C560F70)
#define PARTICLESPERFDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C560FD0)

inline static constexpr unsigned int ParticlesPerfDisplayer_TypeDefinitionIndex = 84934;
