...
#define STRUCT_2_276321B6B122C69C_6_DECONSTRUCT_OFFSET UNITYSDK_OFFSET(0x7DFB0)
#define STRUCT_2_276321B6B122C69C_6_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7DE80)
#define STRUCT_2_276321B6B122C69C_6_EQUALS_OFFSET UNITYSDK_OFFSET(0x7DE70)
#define STRUCT_2_276321B6B122C69C_6_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7DD60)
#define STRUCT_2_276321B6B122C69C_6_GET_AVATARID_OFFSET UNITYSDK_OFFSET(0x5FB0)
#define STRUCT_2_276321B6B122C69C_6_GET_TEAMID_OFFSET UNITYSDK_OFFSET(0x1E110)
#define STRUCT_2_276321B6B122C69C_6_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xA5538B0)
#define STRUCT_2_276321B6B122C69C_6_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xA553790)
#define STRUCT_2_276321B6B122C69C_6_PRINTMEMBERS_OFFSET UNITYSDK_OFFSET(0x7DD40)
#define STRUCT_2_276321B6B122C69C_6_SET_AVATARID_OFFSET UNITYSDK_OFFSET(0x2C4C0)
#define STRUCT_2_276321B6B122C69C_6_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0x21F0)
#define STRUCT_2_276321B6B122C69C_6_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7DD30)
#define STRUCT_2_276321B6B122C69C_6__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBE0)
#define STRUCT_2_276321B6B122C69C_6___IFIXBASEPROXY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7DFC0)

inline static constexpr unsigned int Struct_2_276321B6B122C69C_6_TypeDefinitionIndex = 63710;
...
struct alignas(4) Struct_2_276321B6B122C69C_6
{
	...
	{
		return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + STRUCT_2_276321B6B122C69C_6___IFIXBASEPROXY_GETHASHCODE_OFFSET))(this);
	}
};
