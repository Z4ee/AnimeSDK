...
#define CLASS_2_4551A380DCBB3F00_CLASS_1_63C9E021BC4D3A9D_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB6910)
...
{
public:
	::System::String* APODMGIFMFI; // 0x10
	::System::String* NHIGJKJJPGM; // 0x18
	::RPG::GameCore::GameEntity* FKMOKGOBEHJ; // 0x20
