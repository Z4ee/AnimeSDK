...
#define SCROLLCIRCLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x13457110)
#define SCROLLCIRCLE_FIXCONTENTPOS_OFFSET UNITYSDK_OFFSET(0x13457370)
#define SCROLLCIRCLE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x13457590)
#define SCROLLCIRCLE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x13457320)
#define SCROLLCIRCLE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x134575E0)
#define SCROLLCIRCLE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x13457650)
#define SCROLLCIRCLE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x134576A0)
#define SCROLLCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x13457710)
#define SCROLLCIRCLE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x13457760)

inline static constexpr unsigned int ScrollCircle_TypeDefinitionIndex = 79474;
