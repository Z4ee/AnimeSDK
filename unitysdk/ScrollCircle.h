...
#define SCROLLCIRCLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E36CA0)
#define SCROLLCIRCLE_FIXCONTENTPOS_OFFSET UNITYSDK_OFFSET(0x19E36F00)
#define SCROLLCIRCLE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x19E37140)
#define SCROLLCIRCLE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x19E36EB0)
#define SCROLLCIRCLE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x19E37190)
#define SCROLLCIRCLE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x19E37200)
#define SCROLLCIRCLE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x19E37250)
#define SCROLLCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E372C0)
#define SCROLLCIRCLE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E37310)

inline static constexpr unsigned int ScrollCircle_TypeDefinitionIndex = 68309;
