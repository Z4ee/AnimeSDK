...
#define CLASS_1_2A8F67D376A2BFDB_CLEAR_OFFSET UNITYSDK_OFFSET(0x1937B460)
#define CLASS_1_2A8F67D376A2BFDB_GET_CAPTURETEXTURE_OFFSET UNITYSDK_OFFSET(0x1937B620)
#define CLASS_1_2A8F67D376A2BFDB_METHOD_1_3844928E9495F691_OFFSET UNITYSDK_OFFSET(0x1937B590)
#define CLASS_1_2A8F67D376A2BFDB_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1937B530)
#define CLASS_1_2A8F67D376A2BFDB_SET_CAPTURETEXTURE_OFFSET UNITYSDK_OFFSET(0x1937B630)
#define CLASS_1_2A8F67D376A2BFDB__CTOR_OFFSET UNITYSDK_OFFSET(0x1937B640)

inline static constexpr unsigned int Class_1_2A8F67D376A2BFDB_TypeDefinitionIndex = 69484;

class Class_1_2A8F67D376A2BFDB : public ::System::Object
{
public:
	::System::Action* Field_1_0; // 0x10
	::UnityEngine::RenderTexture* _CaptureTexture_k__BackingField; // 0x18
	::RPG::Client::UIMeta* Field_1_2; // 0x20
	::UnityEngine::UI::RawImage* Field_1_3; // 0x28
	::RPG::Client::UIValueChangeAnimation* Field_1_4; // 0x30
	::System::Single Field_1_5; // 0x38
	::System::Single Field_1_6; // 0x3C
	::RPG::GameCore::FrameCaptureFadeoutType Field_1_7; // 0x40
