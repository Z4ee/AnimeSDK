...
#define SHARPJSON_JSONDECODER_DECODETEXT_OFFSET UNITYSDK_OFFSET(0x19DC71C0)
#define SHARPJSON_JSONDECODER_DECODE_OFFSET UNITYSDK_OFFSET(0x19DC6D30)
#define SHARPJSON_JSONDECODER_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x19DC6CE0)
#define SHARPJSON_JSONDECODER_GET_PARSENUMBERSASFLOAT_OFFSET UNITYSDK_OFFSET(0x19DC6D00)
#define SHARPJSON_JSONDECODER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x19DC7CF0)
#define SHARPJSON_JSONDECODER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x19DC7210)
#define SHARPJSON_JSONDECODER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x19DC6EC0)
#define SHARPJSON_JSONDECODER_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x19DC6CF0)
#define SHARPJSON_JSONDECODER_SET_PARSENUMBERSASFLOAT_OFFSET UNITYSDK_OFFSET(0x19DC6D10)
#define SHARPJSON_JSONDECODER_TRIGGERERROR_OFFSET UNITYSDK_OFFSET(0x19DC76B0)
#define SHARPJSON_JSONDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DC6D20)

namespace SharpJson
{
	inline static constexpr unsigned int JsonDecoder_TypeDefinitionIndex = 36354;
