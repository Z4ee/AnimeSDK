...
#define SHARPJSON_JSONDECODER_DECODETEXT_OFFSET UNITYSDK_OFFSET(0x1E70E4E0)
#define SHARPJSON_JSONDECODER_DECODE_OFFSET UNITYSDK_OFFSET(0x1E70E120)
#define SHARPJSON_JSONDECODER_GET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1E70E0D0)
#define SHARPJSON_JSONDECODER_GET_PARSENUMBERSASFLOAT_OFFSET UNITYSDK_OFFSET(0x1E70E0F0)
#define SHARPJSON_JSONDECODER_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1E70E9C0)
#define SHARPJSON_JSONDECODER_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1E70E590)
#define SHARPJSON_JSONDECODER_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1E70E190)
#define SHARPJSON_JSONDECODER_SET_ERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x1E70E0E0)
#define SHARPJSON_JSONDECODER_SET_PARSENUMBERSASFLOAT_OFFSET UNITYSDK_OFFSET(0x1E70E100)
#define SHARPJSON_JSONDECODER_TRIGGERERROR_OFFSET UNITYSDK_OFFSET(0x1E70E920)
#define SHARPJSON_JSONDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E70E110)

namespace SharpJson
{
	inline static constexpr unsigned int JsonDecoder_TypeDefinitionIndex = 32797;
