...
#define CLASS_3_D92ADC48CDFCC09B_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A640F70)
#define CLASS_3_D92ADC48CDFCC09B_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A640FE0)
#define CLASS_3_D92ADC48CDFCC09B_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A63BDD0)
#define CLASS_3_D92ADC48CDFCC09B__CTOR_OFFSET UNITYSDK_OFFSET(0x1A630D20)

inline static constexpr unsigned int Class_3_D92ADC48CDFCC09B_TypeDefinitionIndex = 32959;
