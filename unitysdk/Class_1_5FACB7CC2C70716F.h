...
#define CLASS_1_5FACB7CC2C70716F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DDBAA40)
#define CLASS_1_5FACB7CC2C70716F_CLONE_OFFSET UNITYSDK_OFFSET(0x1DDBA520)
#define CLASS_1_5FACB7CC2C70716F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DDBA660)
#define CLASS_1_5FACB7CC2C70716F_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DDBA5C0)
#define CLASS_1_5FACB7CC2C70716F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DDBA760)
#define CLASS_1_5FACB7CC2C70716F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DDBAC80)
#define CLASS_1_5FACB7CC2C70716F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DDBAC20)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DDBA5A0)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DDBA3D0)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x1DDBA590)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_554199E0076172C5_OFFSET UNITYSDK_OFFSET(0x1DDBA570)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DDBA5B0)
#define CLASS_1_5FACB7CC2C70716F_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x1DDBA580)
#define CLASS_1_5FACB7CC2C70716F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DDBA430)
#define CLASS_1_5FACB7CC2C70716F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DDBA860)
#define CLASS_1_5FACB7CC2C70716F_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DDBA8C0)
#define CLASS_1_5FACB7CC2C70716F__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DDBAD60)
#define CLASS_1_5FACB7CC2C70716F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DDBA490)
#define CLASS_1_5FACB7CC2C70716F__CTOR_OFFSET UNITYSDK_OFFSET(0x1DDBA440)

inline static constexpr unsigned int Class_1_5FACB7CC2C70716F_TypeDefinitionIndex = 28777;
...
public:
	...
	{
		return (::Google::Protobuf::FieldCodec_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5FACB7CC2C70716F_TypeDefinitionIndex)->GetStaticField(0x1CF50);
	}
	static ::Google::Protobuf::MessageParser_1<::Class_1_5FACB7CC2C70716F*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5FACB7CC2C70716F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5FACB7CC2C70716F_TypeDefinitionIndex)->GetStaticField(0x1CF58);
	}
	// static const ::System::Int32 GEJEJNNMGGP = 0x4; // 0x0
	// static const ::System::Int32 BGEAMGMALCL = 0x6; // 0x0
	// static const ::System::Int32 HDCJFJNBNBA = 0xE; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* AFNHANNCAMC; // 0x18
	::Enum_3_4608E37A1B3D374A_19 IDDLDFAPGBE; // 0x20
	::System::UInt32 KBNPEDMOEMA; // 0x24
