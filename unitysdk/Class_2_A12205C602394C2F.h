...
#define CLASS_2_A12205C602394C2F_METHOD_2_4D92CAACEA159BBF_OFFSET UNITYSDK_OFFSET(0x129FD3D0)
#define CLASS_2_A12205C602394C2F__CTOR_OFFSET UNITYSDK_OFFSET(0x129FD4A0)
#define CLASS_2_A12205C602394C2F__ONBIND_OFFSET UNITYSDK_OFFSET(0x129FD350)
#define CLASS_2_A12205C602394C2F___IFIXBASEPROXY__ONBIND_OFFSET UNITYSDK_OFFSET(0x129FD4D0)

inline static constexpr unsigned int Class_2_A12205C602394C2F_TypeDefinitionIndex = 65743;
