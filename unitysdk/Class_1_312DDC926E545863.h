...
#define CLASS_1_312DDC926E545863__CTOR_OFFSET UNITYSDK_OFFSET(0x155A2430)
...
{
public:
	::Class_0_16E4307DCC419505_417* JBOIBJCAMCN; // 0x10
	::RPG::GameCore::GameEntity* FNDHDEOILCK; // 0x18
	::RPG::GameCore::GameEntity* DICKLIFEALI; // 0x20
	::RPG::GameCore::StageRow* EAEJMOGDAEC; // 0x28
	::System::Object* FGNHFJHBPIM; // 0x30
	::RPG::GameCore::GameEntity* JFEANHJCLAA; // 0x38
	::RPG::GameCore::BattleEventConfig* COKHBDEGLIA; // 0x40
	::RPG::GameCore::FixPoint JCDBMGGLNIB; // 0x48
	::System::UInt32 DFEJABODPGM; // 0x50
	::System::Boolean FMOOJHANGAJ; // 0x54
	::RPG::GameCore::BattleEventCreateType BIGMDKMFENB; // 0x58
	::RPG::GameCore::FixPoint AIFOJKHJLDD; // 0x60
