...
#define SGF_SEVENT_DELEGATEINFO_GETDELEGATEINFO_OFFSET UNITYSDK_OFFSET(0x1E373E30)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1E374BD0)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1E373FE0)
#define SGF_SEVENT_DELEGATEINFO_GETFRIENDLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1E375220)
#define SGF_SEVENT_DELEGATEINFO_GETORIGINALTYPEFROMCLOSURE_OFFSET UNITYSDK_OFFSET(0x1E374620)
#define SGF_SEVENT_DELEGATEINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1E373D70)
#define SGF_SEVENT_DELEGATEINFO_GET_FRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1E373D30)
#define SGF_SEVENT_DELEGATEINFO_GET_ISCLOSURE_OFFSET UNITYSDK_OFFSET(0x1E373E10)
#define SGF_SEVENT_DELEGATEINFO_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1E373DF0)
#define SGF_SEVENT_DELEGATEINFO_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1E373D10)
#define SGF_SEVENT_DELEGATEINFO_GET_ORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1E373D90)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGETORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1E373DD0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1E373DB0)
#define SGF_SEVENT_DELEGATEINFO_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1E373D50)
#define SGF_SEVENT_DELEGATEINFO_GUESSORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1E374910)
#define SGF_SEVENT_DELEGATEINFO_ISCOMPILERGENERATED_OFFSET UNITYSDK_OFFSET(0x1E3744C0)
#define SGF_SEVENT_DELEGATEINFO_SET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1E373D80)
#define SGF_SEVENT_DELEGATEINFO_SET_FRIENDLYMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1E373D40)
#define SGF_SEVENT_DELEGATEINFO_SET_ISCLOSURE_OFFSET UNITYSDK_OFFSET(0x1E373E20)
#define SGF_SEVENT_DELEGATEINFO_SET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x1E373E00)
#define SGF_SEVENT_DELEGATEINFO_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1E373D20)
#define SGF_SEVENT_DELEGATEINFO_SET_ORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1E373DA0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGETORIGINALTYPE_OFFSET UNITYSDK_OFFSET(0x1E373DE0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGETTYPE_OFFSET UNITYSDK_OFFSET(0x1E373DC0)
#define SGF_SEVENT_DELEGATEINFO_SET_TARGET_OFFSET UNITYSDK_OFFSET(0x1E373D60)
#define SGF_SEVENT_DELEGATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1E373FD0)

namespace SGF::SEvent
{
	inline static constexpr unsigned int DelegateInfo_TypeDefinitionIndex = 7864;

	class DelegateInfo : public ::System::Object
	{
	public:
		::System::String* _FriendlyMethodName_k__BackingField; // 0x10
		...
		::System::Type* _TargetType_k__BackingField; // 0x30
		::System::Object* _Target_k__BackingField; // 0x38
		::System::Reflection::MethodInfo* _Method_k__BackingField; // 0x40
