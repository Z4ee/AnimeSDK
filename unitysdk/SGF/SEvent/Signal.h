...
#define SGF_SEVENT_SIGNAL_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1E1F1AD0)
#define SGF_SEVENT_SIGNAL_INVOKESAFE_OFFSET UNITYSDK_OFFSET(0x1E1F1F70)
#define SGF_SEVENT_SIGNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E1F1C10)
#define SGF_SEVENT_SIGNAL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1E1F1A40)
#define SGF_SEVENT_SIGNAL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1E1F1B30)
#define SGF_SEVENT_SIGNAL_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1E1F1BC0)
#define SGF_SEVENT_SIGNAL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E1F22F0)
#define SGF_SEVENT_SIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F22E0)

namespace SGF::SEvent
{
	inline static constexpr unsigned int Signal_TypeDefinitionIndex = 8258;
