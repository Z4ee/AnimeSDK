...
#define SGF_SEVENT_SIGNAL_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1F69A040)
#define SGF_SEVENT_SIGNAL_INVOKESAFE_OFFSET UNITYSDK_OFFSET(0x1F69A310)
#define SGF_SEVENT_SIGNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1F69A180)
#define SGF_SEVENT_SIGNAL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1F699FB0)
#define SGF_SEVENT_SIGNAL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1F69A0A0)
#define SGF_SEVENT_SIGNAL_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1F69A130)
#define SGF_SEVENT_SIGNAL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F69A510)
#define SGF_SEVENT_SIGNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1F69A500)

namespace SGF::SEvent
{
	inline static constexpr unsigned int Signal_TypeDefinitionIndex = 8008;
