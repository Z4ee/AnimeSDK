...
#define SGF_SEVENT_SIGNALEXWRAPPER_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1BAEC140)
#define SGF_SEVENT_SIGNALEXWRAPPER_OP_ADDITION_2_OFFSET UNITYSDK_OFFSET(0x1BAEC230)
#define SGF_SEVENT_SIGNALEXWRAPPER_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1BAEC0C0)
#define SGF_SEVENT_SIGNALEXWRAPPER_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1BAEC3A0)
#define SGF_SEVENT_SIGNALEXWRAPPER_OP_SUBTRACTION_2_OFFSET UNITYSDK_OFFSET(0x1BAEC490)
#define SGF_SEVENT_SIGNALEXWRAPPER_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1BAEC320)
#define SGF_SEVENT_SIGNALEXWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2E5940)

namespace SGF::SEvent
{
	inline static constexpr unsigned int SignalExWrapper_TypeDefinitionIndex = 7719;
