...
#define SGF_SEVENT_DELEGATEEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9C4B80)
#define SGF_SEVENT_DELEGATEEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C4AC0)
#define SGF_SEVENT_DELEGATEEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9C4B90)
#define SGF_SEVENT_DELEGATEEX_GET_DELEGATE_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define SGF_SEVENT_DELEGATEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x9C4A00)
#define SGF_SEVENT_DELEGATEEX___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9C4C50)
#define SGF_SEVENT_DELEGATEEX___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9C4BE0)

namespace SGF::SEvent
{
	inline static constexpr unsigned int DelegateEx_TypeDefinitionIndex = 7976;
