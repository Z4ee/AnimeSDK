...
#define SGF_SEVENT_SIGNALBASEEX_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1B47C480)
#define SGF_SEVENT_SIGNALBASEEX_GET__METHODDIC_OFFSET UNITYSDK_OFFSET(0x1B47C3C0)
#define SGF_SEVENT_SIGNALBASEEX_REMOVEALLLISTENERS_OFFSET UNITYSDK_OFFSET(0x1B47D5D0)
#define SGF_SEVENT_SIGNALBASEEX_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1B47D110)
#define SGF_SEVENT_SIGNALBASEEX_TRYCLEAN_OFFSET UNITYSDK_OFFSET(0x1B47D760)
#define SGF_SEVENT_SIGNALBASEEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B47C470)
#define SGF_SEVENT_SIGNALBASEEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B47C460)

namespace SGF::SEvent
{
	inline static constexpr unsigned int SignalBaseEx_TypeDefinitionIndex = 8050;
