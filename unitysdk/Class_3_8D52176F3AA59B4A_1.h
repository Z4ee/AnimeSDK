...
#define CLASS_3_8D52176F3AA59B4A_1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1598EAE0)
#define CLASS_3_8D52176F3AA59B4A_1_METHOD_3_2C14C45522A03B0D_OFFSET UNITYSDK_OFFSET(0x1598FDC0)
#define CLASS_3_8D52176F3AA59B4A_1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1598EC40)
#define CLASS_3_8D52176F3AA59B4A_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1598E9C0)

inline static constexpr unsigned int Class_3_8D52176F3AA59B4A_1_TypeDefinitionIndex = 55266;

class Class_3_8D52176F3AA59B4A_1 : public ::RPG::GameCore::ImmediateTaskBase_1<::Class_3_C3F11EA7F494BEBC*>
{
public:
	::Class_3_07C3C4D2990C49EE* IOJBMHGLOFP; // 0x28
	::Class_3_07C3C4D2990C49EE* HGJLJCFHOIH; // 0x30
