...
#define CLASS_2_7A756395C8B7A419_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15895290)
#define CLASS_2_7A756395C8B7A419_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x15895330)
#define CLASS_2_7A756395C8B7A419_METHOD_2_DF3C54A5ADEABAF1_OFFSET UNITYSDK_OFFSET(0x158951E0)
#define CLASS_2_7A756395C8B7A419_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15894F20)
#define CLASS_2_7A756395C8B7A419_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15895240)
#define CLASS_2_7A756395C8B7A419_TICK_OFFSET UNITYSDK_OFFSET(0x158952D0)
#define CLASS_2_7A756395C8B7A419__CTOR_OFFSET UNITYSDK_OFFSET(0x15894F10)

inline static constexpr unsigned int Class_2_7A756395C8B7A419_TypeDefinitionIndex = 55698;
