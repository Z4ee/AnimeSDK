...
#define MB3_MESHBAKERGROUPER_CREATEGROUPER_OFFSET UNITYSDK_OFFSET(0x1E145C60)
#define MB3_MESHBAKERGROUPER_DELETEALLCHILDMESHBAKERS_OFFSET UNITYSDK_OFFSET(0x1E145CF0)
#define MB3_MESHBAKERGROUPER_GENERATEMESHBAKERS_OFFSET UNITYSDK_OFFSET(0x1E145E40)
#define MB3_MESHBAKERGROUPER_GETMESHBAKERSETTINGSASSERIALIZEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E145A00)
#define MB3_MESHBAKERGROUPER_GETMESHBAKERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1E145880)
#define MB3_MESHBAKERGROUPER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1E145B60)
#define MB3_MESHBAKERGROUPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E1469D0)
#define MB3_MESHBAKERGROUPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E146910)

inline static constexpr unsigned int MB3_MeshBakerGrouper_TypeDefinitionIndex = 90542;
...
public:
	...
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(MB3_MeshBakerGrouper_TypeDefinitionIndex)->GetStaticField(0x12C60);
	}
