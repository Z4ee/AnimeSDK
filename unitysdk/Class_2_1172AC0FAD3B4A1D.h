...
#define CLASS_2_1172AC0FAD3B4A1D_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB47BC50)
#define CLASS_2_1172AC0FAD3B4A1D_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xB47BD70)
#define CLASS_2_1172AC0FAD3B4A1D_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xB47BCA0)
#define CLASS_2_1172AC0FAD3B4A1D_TICK_OFFSET UNITYSDK_OFFSET(0xB47C2B0)
#define CLASS_2_1172AC0FAD3B4A1D__CTOR_OFFSET UNITYSDK_OFFSET(0xB47BC40)
...
public:
	...
	::RPG::GameCore::ShowHintEffect* OFKGLJOAMLD; // 0x20
