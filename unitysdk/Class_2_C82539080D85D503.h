...
#define CLASS_2_C82539080D85D503_METHOD_2_2F3709D27A34AA00_OFFSET UNITYSDK_OFFSET(0x89B2FD0)
#define CLASS_2_C82539080D85D503_RECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x89B31D0)
#define CLASS_2_C82539080D85D503_RECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0x89B3230)
#define CLASS_2_C82539080D85D503__CTOR_OFFSET UNITYSDK_OFFSET(0x89B2E40)

inline static constexpr unsigned int Class_2_C82539080D85D503_TypeDefinitionIndex = 61977;
...
public:
	...
	::System::Void ReceiveEvent(::Class_0_16E4307DCC419505_539* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_539*))((::PBYTE)hIl2Cpp + CLASS_2_C82539080D85D503_RECEIVEEVENT_OFFSET))(this, a1);
	}
