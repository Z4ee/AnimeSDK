...
#define CLASS_1_75D3FF54F4C359AB_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAFAFD90)
#define CLASS_1_75D3FF54F4C359AB_METHOD_1_4AC38C7D74462263_OFFSET UNITYSDK_OFFSET(0xAFAFC40)
#define CLASS_1_75D3FF54F4C359AB_METHOD_1_4BF6F95CB7C46B46_OFFSET UNITYSDK_OFFSET(0xAFAFB60)
#define CLASS_1_75D3FF54F4C359AB_METHOD_1_6815AD8D97959763_OFFSET UNITYSDK_OFFSET(0xAFAFF50)
#define CLASS_1_75D3FF54F4C359AB_METHOD_1_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0xAFAFD00)
#define CLASS_1_75D3FF54F4C359AB_METHOD_1_D41F2EAAA87E2BFD_OFFSET UNITYSDK_OFFSET(0xAFAFEF0)
#define CLASS_1_75D3FF54F4C359AB_METHOD_1_EA3781602A491EEE_OFFSET UNITYSDK_OFFSET(0xAFAFA70)
#define CLASS_1_75D3FF54F4C359AB_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0xAFAFE40)
#define CLASS_1_75D3FF54F4C359AB__CTOR_OFFSET UNITYSDK_OFFSET(0xAFB0340)

inline static constexpr unsigned int Class_1_75D3FF54F4C359AB_TypeDefinitionIndex = 62807;
...
public:
	...
	::Class_0_16E4307DCC419505_864* Method_1_D41F2EAAA87E2BFD()
	{
		return ((::Class_0_16E4307DCC419505_864*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_75D3FF54F4C359AB_METHOD_1_D41F2EAAA87E2BFD_OFFSET))(this);
	}

	::System::Void Method_1_6815AD8D97959763(::Class_1_75D3FF54F4C359AB* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_75D3FF54F4C359AB*))((::PBYTE)hIl2Cpp + CLASS_1_75D3FF54F4C359AB_METHOD_1_6815AD8D97959763_OFFSET))(this, a1);
	}
};
