...
#define CLASS_1_FA49C91DF77C981E_CLEAR_OFFSET UNITYSDK_OFFSET(0x1460C180)
#define CLASS_1_FA49C91DF77C981E_GET_REFERENCESTATE_OFFSET UNITYSDK_OFFSET(0x1460C1C0)
#define CLASS_1_FA49C91DF77C981E_METHOD_1_2FE338807A102453_OFFSET UNITYSDK_OFFSET(0x1460C130)
#define CLASS_1_FA49C91DF77C981E_METHOD_1_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x1460C2B0)
#define CLASS_1_FA49C91DF77C981E_ONALLOC_OFFSET UNITYSDK_OFFSET(0x1460C1E0)
#define CLASS_1_FA49C91DF77C981E_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x1460C260)
#define CLASS_1_FA49C91DF77C981E_SET_REFERENCESTATE_OFFSET UNITYSDK_OFFSET(0x1460C1D0)
#define CLASS_1_FA49C91DF77C981E__CTOR_OFFSET UNITYSDK_OFFSET(0x1460C300)

inline static constexpr unsigned int Class_1_FA49C91DF77C981E_TypeDefinitionIndex = 56544;
