...
#define DG_TWEENING_COLOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1C4DA080)
#define DG_TWEENING_COLOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1C4DA0E0)
#define DG_TWEENING_COLOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1C4DA0B0)
#define DG_TWEENING_COLOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x364A80)

namespace DG::Tweening
{
	inline static constexpr unsigned int Color2_TypeDefinitionIndex = 25340;
