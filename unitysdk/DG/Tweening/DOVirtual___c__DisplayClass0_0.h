...
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E61AB60)
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__FLOAT_B__0_OFFSET UNITYSDK_OFFSET(0x1E61AB70)
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__FLOAT_B__1_OFFSET UNITYSDK_OFFSET(0x1E61AB80)
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__FLOAT_B__2_OFFSET UNITYSDK_OFFSET(0x1E61AB90)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOVirtual___c__DisplayClass0_0_TypeDefinitionIndex = 27838;
