...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC0620)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS35_0__DORESIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1FBC0630)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS35_0__DORESIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1FBC0690)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass35_0_TypeDefinitionIndex = 28490;
