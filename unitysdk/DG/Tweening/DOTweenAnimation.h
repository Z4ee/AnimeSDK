...
#define DG_TWEENING_DOTWEENANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x11A056C0)
#define DG_TWEENING_DOTWEENANIMATION_CREATETWEEN_OFFSET UNITYSDK_OFFSET(0x11A05880)
#define DG_TWEENING_DOTWEENANIMATION_DOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x11A06710)
#define DG_TWEENING_DOTWEENANIMATION_DOKILL_OFFSET UNITYSDK_OFFSET(0x11A06820)
#define DG_TWEENING_DOTWEENANIMATION_DOPAUSE_OFFSET UNITYSDK_OFFSET(0x11A05E30)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYALLBYID_OFFSET UNITYSDK_OFFSET(0x11A06A70)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDSALLBYID_OFFSET UNITYSDK_OFFSET(0x11A06CB0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDSBYID_OFFSET UNITYSDK_OFFSET(0x11A06B80)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x11A05C10)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBYID_OFFSET UNITYSDK_OFFSET(0x11A06940)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARDALLBYID_OFFSET UNITYSDK_OFFSET(0x11A06EF0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARDBYID_OFFSET UNITYSDK_OFFSET(0x11A06DC0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x11A05D20)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x11A07000)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAY_OFFSET UNITYSDK_OFFSET(0x11A05B00)
#define DG_TWEENING_DOTWEENANIMATION_DORESTARTALLBYID_OFFSET UNITYSDK_OFFSET(0x11A074B0)
#define DG_TWEENING_DOTWEENANIMATION_DORESTARTBYID_OFFSET UNITYSDK_OFFSET(0x11A07380)
#define DG_TWEENING_DOTWEENANIMATION_DORESTART_OFFSET UNITYSDK_OFFSET(0x11A06190)
#define DG_TWEENING_DOTWEENANIMATION_DOREWINDANDPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x11A07250)
#define DG_TWEENING_DOTWEENANIMATION_DOREWIND_OFFSET UNITYSDK_OFFSET(0x11A06050)
#define DG_TWEENING_DOTWEENANIMATION_DOTOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x11A05F40)
#define DG_TWEENING_DOTWEENANIMATION_GETTWEENS_OFFSET UNITYSDK_OFFSET(0x11A075D0)
#define DG_TWEENING_DOTWEENANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11A05820)
#define DG_TWEENING_DOTWEENANIMATION_REEVALUATERELATIVETWEEN_OFFSET UNITYSDK_OFFSET(0x11A064E0)
#define DG_TWEENING_DOTWEENANIMATION_START_OFFSET UNITYSDK_OFFSET(0x11A05770)
#define DG_TWEENING_DOTWEENANIMATION_TYPETODOTARGETTYPE_OFFSET UNITYSDK_OFFSET(0x11A07760)
#define DG_TWEENING_DOTWEENANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x11A07A80)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenAnimation_TypeDefinitionIndex = 91474;
