...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DBEE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1C4DBEF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1C4DBF10)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass17_0_TypeDefinitionIndex = 25377;
