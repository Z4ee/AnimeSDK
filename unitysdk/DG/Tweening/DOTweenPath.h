...
#define DG_TWEENING_DOTWEENPATH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1E7B15F0)
#define DG_TWEENING_DOTWEENPATH_DOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1E7B2AA0)
#define DG_TWEENING_DOTWEENPATH_DOKILL_OFFSET UNITYSDK_OFFSET(0x1E7B2AB0)
#define DG_TWEENING_DOTWEENPATH_DOPAUSE_OFFSET UNITYSDK_OFFSET(0x1E7B2960)
#define DG_TWEENING_DOTWEENPATH_DOPLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x1E7B2940)
#define DG_TWEENING_DOTWEENPATH_DOPLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x1E7B2950)
#define DG_TWEENING_DOTWEENPATH_DOPLAY_OFFSET UNITYSDK_OFFSET(0x1E7B2900)
#define DG_TWEENING_DOTWEENPATH_DORESTART_OFFSET UNITYSDK_OFFSET(0x1E7B29C0)
#define DG_TWEENING_DOTWEENPATH_DOREWIND_OFFSET UNITYSDK_OFFSET(0x1E7B29B0)
#define DG_TWEENING_DOTWEENPATH_DOTOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x1E7B29A0)
#define DG_TWEENING_DOTWEENPATH_GETDRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1E7B2BD0)
#define DG_TWEENING_DOTWEENPATH_GETFULLWPS_OFFSET UNITYSDK_OFFSET(0x1E7B2CA0)
#define DG_TWEENING_DOTWEENPATH_GETTWEEN_OFFSET UNITYSDK_OFFSET(0x1E7B2AC0)
#define DG_TWEENING_DOTWEENPATH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1E7B28D0)
#define DG_TWEENING_DOTWEENPATH_REEVALUATERELATIVETWEEN_OFFSET UNITYSDK_OFFSET(0x1E7B25B0)
#define DG_TWEENING_DOTWEENPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1E7B27D0)
#define DG_TWEENING_DOTWEENPATH__AWAKE_B__36_0_OFFSET UNITYSDK_OFFSET(0x1E7B30B0)
#define DG_TWEENING_DOTWEENPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B2EA0)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenPath_TypeDefinitionIndex = 34478;
