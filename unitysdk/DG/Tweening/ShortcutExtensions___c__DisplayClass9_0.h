...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E8909C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS9_0__DORECT_B__0_OFFSET UNITYSDK_OFFSET(0x1E8909D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS9_0__DORECT_B__1_OFFSET UNITYSDK_OFFSET(0x1E890A10)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass9_0_TypeDefinitionIndex = 27860;
