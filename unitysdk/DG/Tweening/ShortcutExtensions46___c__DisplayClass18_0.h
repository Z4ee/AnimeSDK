...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FA1E6D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS18_0__DOANCHORMIN_B__0_OFFSET UNITYSDK_OFFSET(0x1FA20C90)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS18_0__DOANCHORMIN_B__1_OFFSET UNITYSDK_OFFSET(0x1FA20CD0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass18_0_TypeDefinitionIndex = 35108;
