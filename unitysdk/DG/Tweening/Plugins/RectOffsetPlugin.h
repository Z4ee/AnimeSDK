...
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C24EA50)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C24EEA0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C24EE10)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C24E850)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C24EC60)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C24E880)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C24EB20)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C24F7D0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24F7B0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectOffsetPlugin_TypeDefinitionIndex = 25454;
	...
	public:
		...
		{
			return (::UnityEngine::RectOffset**)Il2CppClass::FromTypeDefinitionIndex(RectOffsetPlugin_TypeDefinitionIndex)->GetStaticField(0x1F000);
		}
