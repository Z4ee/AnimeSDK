...
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E583C80)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1E5840D0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1E584040)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1E583A80)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1E583E90)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1E583AB0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1E583D50)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E584A00)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5849E0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectOffsetPlugin_TypeDefinitionIndex = 27945;
	...
	public:
		...
		{
			return (::UnityEngine::RectOffset**)Il2CppClass::FromTypeDefinitionIndex(RectOffsetPlugin_TypeDefinitionIndex)->GetStaticField(0x22C30);
		}
