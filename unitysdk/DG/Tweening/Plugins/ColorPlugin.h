...
#define DG_TWEENING_PLUGINS_COLORPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1BF44830)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1BF448B0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1BF448A0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1BF446F0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1BF44870)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1BF44700)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1BF44840)
#define DG_TWEENING_PLUGINS_COLORPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF44AF0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int ColorPlugin_TypeDefinitionIndex = 25451;
