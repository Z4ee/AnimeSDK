...
#define DG_TWEENING_PLUGINS_COLORPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1F69FCD0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1F69FD50)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1F69FD40)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1F69FB90)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1F69FD10)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1F69FBA0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1F69FCE0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1F69FFB0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int ColorPlugin_TypeDefinitionIndex = 28546;
