...
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C54C7B0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C54C860)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C54C820)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C54C700)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C54C7F0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C54C710)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C54C7C0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54CB80)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int UlongPlugin_TypeDefinitionIndex = 25448;
