...
#define DG_TWEENING_PLUGINS_RECTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E8768C0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1E876970)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1E876930)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1E8764F0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1E876900)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1E876500)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1E8768D0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E876D70)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectPlugin_TypeDefinitionIndex = 27946;
