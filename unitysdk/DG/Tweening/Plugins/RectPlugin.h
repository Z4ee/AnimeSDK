...
#define DG_TWEENING_PLUGINS_RECTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C5457B0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C545860)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C545820)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C5453E0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C5457F0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C5453F0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C5457C0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C545C60)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectPlugin_TypeDefinitionIndex = 25455;
