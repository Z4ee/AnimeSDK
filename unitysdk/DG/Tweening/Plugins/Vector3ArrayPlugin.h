...
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1FACE7F0)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1FACED10)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1FACEC50)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1FACE7B0)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1FACEB00)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1FACE7E0)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1FACE940)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1FACF7A0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector3ArrayPlugin_TypeDefinitionIndex = 28544;
