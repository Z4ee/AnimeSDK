...
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C24E570)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C24E600)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C24E5E0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C24E3F0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C24E5B0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C24E400)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C24E580)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C24E830)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int FloatPlugin_TypeDefinitionIndex = 25461;
