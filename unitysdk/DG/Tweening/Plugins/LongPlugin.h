...
#define DG_TWEENING_PLUGINS_LONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1F655A30)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1F655AC0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1F655AA0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1F655980)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1F655A70)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1F655990)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1F655A40)
#define DG_TWEENING_PLUGINS_LONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1F655CC0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int LongPlugin_TypeDefinitionIndex = 28542;
