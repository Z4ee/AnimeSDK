...
#define DG_TWEENING_PLUGINS_LONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1BF064A0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1BF06530)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1BF06510)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1BF063F0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1BF064E0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1BF06400)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1BF064B0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF06720)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int LongPlugin_TypeDefinitionIndex = 25447;
