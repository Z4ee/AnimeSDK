...
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1BF46B40)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1BF46CA0)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1BF46C50)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1BF468B0)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1BF46BA0)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1BF468C0)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1BF46B50)
#define DG_TWEENING_PLUGINS_VECTOR2PLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1BF47280)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector2Plugin_TypeDefinitionIndex = 25457;
