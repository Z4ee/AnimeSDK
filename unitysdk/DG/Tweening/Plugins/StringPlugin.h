...
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_APPEND_OFFSET UNITYSDK_OFFSET(0x1E80B6A0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E80AE30)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1E80B050)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1E80B010)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1E80AE00)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SCRAMBLEDCHARSTOUSE_OFFSET UNITYSDK_OFFSET(0x1E80C310)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1E80AE50)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1E80AD70)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1E80AE40)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E80C420)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E80C400)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int StringPlugin_TypeDefinitionIndex = 27950;
	...
	public:
		...
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(StringPlugin_TypeDefinitionIndex)->GetStaticField(0x22AC0);
		}
		static ::System::Collections::Generic::List_1<::System::Char>** StaticGet__OpenedTags()
		{
			return (::System::Collections::Generic::List_1<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringPlugin_TypeDefinitionIndex)->GetStaticField(0x22AC8);
		}
