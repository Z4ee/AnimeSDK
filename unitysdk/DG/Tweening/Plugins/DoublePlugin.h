...
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E5E7B20)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1E5E7BB0)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1E5E7B90)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1E5E7A60)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1E5E7B60)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1E5E7A70)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1E5E7B30)
#define DG_TWEENING_PLUGINS_DOUBLEPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5E7D30)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int DoublePlugin_TypeDefinitionIndex = 27937;
