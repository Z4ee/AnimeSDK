...
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETCAMERASHAKEPOSITION_OFFSET UNITYSDK_OFFSET(0x1BF46470)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1BF460B0)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETPUNCH_OFFSET UNITYSDK_OFFSET(0x1BF462E0)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETSHAKE_OFFSET UNITYSDK_OFFSET(0x1BF46440)

namespace DG::Tweening::Plugins::Core
{
	inline static constexpr unsigned int SpecialPluginsUtils_TypeDefinitionIndex = 25475;
