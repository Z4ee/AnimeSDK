...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1FBBF440)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1FBBFE90)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1FBBF730)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1FBBF990)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBC0200)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int CatmullRomDecoder_TypeDefinitionIndex = 28577;
