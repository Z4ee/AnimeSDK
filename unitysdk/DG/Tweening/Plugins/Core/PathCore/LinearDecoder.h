...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1FC5AD20)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1FC5AFD0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1FC5AD60)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1FC5B1B0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC5B1C0)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int LinearDecoder_TypeDefinitionIndex = 28578;
