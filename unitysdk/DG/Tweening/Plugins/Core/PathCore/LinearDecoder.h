...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1E87C940)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1E87CC60)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1E87C980)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1E87CE90)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E87CEA0)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int LinearDecoder_TypeDefinitionIndex = 27974;
