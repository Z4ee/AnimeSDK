...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_ASSIGNDECODER_OFFSET UNITYSDK_OFFSET(0x1E26C740)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_ASSIGNWAYPOINTS_OFFSET UNITYSDK_OFFSET(0x1E26C640)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_CLONEINCREMENTAL_OFFSET UNITYSDK_OFFSET(0x1E26D060)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_CONVERTTOCONSTANTPATHPERC_OFFSET UNITYSDK_OFFSET(0x1E26CA60)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_DESTROY_OFFSET UNITYSDK_OFFSET(0x1E26CF50)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_DRAW_1_OFFSET UNITYSDK_OFFSET(0x1E26D570)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_DRAW_OFFSET UNITYSDK_OFFSET(0x1E26D560)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1E26C800)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_GETDRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1E26CC50)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1E26C9E0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_GETWAYPOINTINDEXFROMPERC_OFFSET UNITYSDK_OFFSET(0x1E26CBC0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_REFRESHNONLINEARDRAWWPS_OFFSET UNITYSDK_OFFSET(0x1E26CDF0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E26C7E0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1E26C440)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int Path_TypeDefinitionIndex = 27975;
	...
	public:
		...
		{
			return (::DG::Tweening::Plugins::Core::PathCore::CatmullRomDecoder**)Il2CppClass::FromTypeDefinitionIndex(Path_TypeDefinitionIndex)->GetStaticField(0x22AB0);
		}
		static ::DG::Tweening::Plugins::Core::PathCore::LinearDecoder** StaticGet__linearDecoder()
		{
			return (::DG::Tweening::Plugins::Core::PathCore::LinearDecoder**)Il2CppClass::FromTypeDefinitionIndex(Path_TypeDefinitionIndex)->GetStaticField(0x22AB8);
		}
