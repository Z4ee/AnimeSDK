...
#define DG_TWEENING_PLUGINS_UINTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C555100)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C555190)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C555170)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C555050)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C555130)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C555060)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C555110)
#define DG_TWEENING_PLUGINS_UINTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C5553D0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int UintPlugin_TypeDefinitionIndex = 25456;
