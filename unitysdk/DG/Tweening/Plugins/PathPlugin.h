...
#define DG_TWEENING_PLUGINS_PATHPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1F9CE960)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1F9CEF60)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1F9CEF40)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1F9CE920)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1F9CE8C0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1F9CEAC0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1F9CE910)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1F9CF2D0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1F9CE980)
#define DG_TWEENING_PLUGINS_PATHPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9D07A0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int PathPlugin_TypeDefinitionIndex = 28545;
