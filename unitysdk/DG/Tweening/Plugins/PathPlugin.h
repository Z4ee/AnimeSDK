...
#define DG_TWEENING_PLUGINS_PATHPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C297D70)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C298390)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C298370)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1C297D30)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C297CD0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C297ED0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C297D20)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1C298710)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C297D90)
#define DG_TWEENING_PLUGINS_PATHPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C299C20)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int PathPlugin_TypeDefinitionIndex = 25450;
