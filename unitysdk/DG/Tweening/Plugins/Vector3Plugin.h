...
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C4EA620)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C4EA7C0)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C4EA770)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C4EA260)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C4EA690)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C4EA270)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C4EA640)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4EAF50)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector3Plugin_TypeDefinitionIndex = 25462;
