...
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E7B3E80)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1E7B3F60)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1E7B3F50)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1E7B3E40)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1E7B3E20)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1E7B3EB0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1E7B3E30)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1E7B3EA0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7B4420)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B4400)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int SpiralPlugin_TypeDefinitionIndex = 34485;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(SpiralPlugin_TypeDefinitionIndex)->GetStaticField(0x8410);
		}
