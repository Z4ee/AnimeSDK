...
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C24FCB0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C24FE50)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C24FDF0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C24F820)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C24FCF0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C24F830)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C24FCC0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2507E0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector4Plugin_TypeDefinitionIndex = 25458;
