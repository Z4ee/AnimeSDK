...
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1F982DC0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1F982F30)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1F982F00)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1F982910)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1F982E00)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1F982920)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1F982DD0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9838E0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector4Plugin_TypeDefinitionIndex = 28553;
