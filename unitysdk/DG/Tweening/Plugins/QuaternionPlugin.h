...
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C53A6F0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C53AAA0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C53AA50)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C539F20)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C53A820)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C539F30)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C53A7D0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C53B0A0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int QuaternionPlugin_TypeDefinitionIndex = 25453;
