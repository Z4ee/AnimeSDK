...
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1E86B480)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1E86B830)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1E86B7E0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1E86ACB0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1E86B5B0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1E86ACC0)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1E86B560)
#define DG_TWEENING_PLUGINS_QUATERNIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1E86BE30)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int QuaternionPlugin_TypeDefinitionIndex = 27944;
