...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC65020)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__0_OFFSET UNITYSDK_OFFSET(0x1FC65030)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__1_OFFSET UNITYSDK_OFFSET(0x1FC65050)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass4_0_TypeDefinitionIndex = 28459;
