...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E885580)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__0_OFFSET UNITYSDK_OFFSET(0x1E885590)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__1_OFFSET UNITYSDK_OFFSET(0x1E8855B0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass4_0_TypeDefinitionIndex = 27855;
