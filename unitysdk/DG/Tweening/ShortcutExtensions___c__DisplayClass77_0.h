...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS77_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F9DE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS77_0__DOBLENDABLESCALEBY_B__0_OFFSET UNITYSDK_OFFSET(0x1C4F9DF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS77_0__DOBLENDABLESCALEBY_B__1_OFFSET UNITYSDK_OFFSET(0x1C4F9E10)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass77_0_TypeDefinitionIndex = 25437;
