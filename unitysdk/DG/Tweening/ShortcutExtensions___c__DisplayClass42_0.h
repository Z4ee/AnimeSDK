...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E61AFE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS42_0__DOLOCALMOVEX_B__0_OFFSET UNITYSDK_OFFSET(0x1E61AFF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS42_0__DOLOCALMOVEX_B__1_OFFSET UNITYSDK_OFFSET(0x1E61B040)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass42_0_TypeDefinitionIndex = 27893;
