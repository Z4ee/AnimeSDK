...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E33C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS5_0__DOFILLAMOUNT_B__0_OFFSET UNITYSDK_OFFSET(0x1C2E7C60)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS5_0__DOFILLAMOUNT_B__1_OFFSET UNITYSDK_OFFSET(0x1C2E7C80)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass5_0_TypeDefinitionIndex = 32889;
