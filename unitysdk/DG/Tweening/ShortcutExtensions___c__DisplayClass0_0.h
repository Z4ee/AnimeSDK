...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E82D1D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1E82D1E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1E82D200)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass0_0_TypeDefinitionIndex = 27851;
