...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS50_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3AB8D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS50_0__DOSCALE_B__0_OFFSET UNITYSDK_OFFSET(0x1C3AB8E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS50_0__DOSCALE_B__1_OFFSET UNITYSDK_OFFSET(0x1C3AB930)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass50_0_TypeDefinitionIndex = 25410;
