...
#define DG_TWEENING_EASEFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C539E20)
#define DG_TWEENING_EASEFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C539EF0)
#define DG_TWEENING_EASEFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C539A20)
#define DG_TWEENING_EASEFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C539A10)

namespace DG::Tweening
{
	inline static constexpr unsigned int EaseFunction_TypeDefinitionIndex = 25343;
