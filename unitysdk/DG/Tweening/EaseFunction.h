...
#define DG_TWEENING_EASEFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FC4A6A0)
#define DG_TWEENING_EASEFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FC4A770)
#define DG_TWEENING_EASEFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FC4A2D0)
#define DG_TWEENING_EASEFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC4A2B0)

namespace DG::Tweening
{
	inline static constexpr unsigned int EaseFunction_TypeDefinitionIndex = 28438;
