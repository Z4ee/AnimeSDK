...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS49_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CDBB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS49_0__DOSCALE_B__0_OFFSET UNITYSDK_OFFSET(0x1C2CDBC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS49_0__DOSCALE_B__1_OFFSET UNITYSDK_OFFSET(0x1C2CDC10)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass49_0_TypeDefinitionIndex = 25409;
