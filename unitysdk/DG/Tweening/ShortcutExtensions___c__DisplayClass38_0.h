...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AD6C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__DOMOVEX_B__0_OFFSET UNITYSDK_OFFSET(0x1C4AD6D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__DOMOVEX_B__1_OFFSET UNITYSDK_OFFSET(0x1C4AD720)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass38_0_TypeDefinitionIndex = 25398;
