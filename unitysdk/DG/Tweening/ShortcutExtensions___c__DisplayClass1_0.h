...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E232020)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS1_0__DOPITCH_B__0_OFFSET UNITYSDK_OFFSET(0x1E23C5A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS1_0__DOPITCH_B__1_OFFSET UNITYSDK_OFFSET(0x1E23C5C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass1_0_TypeDefinitionIndex = 27852;
