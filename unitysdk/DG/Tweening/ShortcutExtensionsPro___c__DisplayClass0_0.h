...
#define DG_TWEENING_SHORTCUTEXTENSIONSPRO___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B47E0)
#define DG_TWEENING_SHORTCUTEXTENSIONSPRO___C__DISPLAYCLASS0_0__DOSPIRAL_B__0_OFFSET UNITYSDK_OFFSET(0x1E7B4BA0)
#define DG_TWEENING_SHORTCUTEXTENSIONSPRO___C__DISPLAYCLASS0_0__DOSPIRAL_B__1_OFFSET UNITYSDK_OFFSET(0x1E7B4BF0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensionsPro___c__DisplayClass0_0_TypeDefinitionIndex = 34481;
