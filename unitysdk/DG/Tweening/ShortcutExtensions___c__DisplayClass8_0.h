...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E585A30)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS8_0__DOPIXELRECT_B__0_OFFSET UNITYSDK_OFFSET(0x1E585A40)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS8_0__DOPIXELRECT_B__1_OFFSET UNITYSDK_OFFSET(0x1E585A80)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass8_0_TypeDefinitionIndex = 27859;
