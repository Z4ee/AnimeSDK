...
#define DG_TWEENING_SHORTCUTEXTENSIONS43___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C52BB80)
#define DG_TWEENING_SHORTCUTEXTENSIONS43___C__DISPLAYCLASS3_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1C52CD00)
#define DG_TWEENING_SHORTCUTEXTENSIONS43___C__DISPLAYCLASS3_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1C52CD40)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions43___c__DisplayClass3_0_TypeDefinitionIndex = 32874;
