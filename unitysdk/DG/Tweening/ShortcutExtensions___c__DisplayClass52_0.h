...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6ECB40)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS52_0__DOSCALEY_B__0_OFFSET UNITYSDK_OFFSET(0x1E6ECB50)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS52_0__DOSCALEY_B__1_OFFSET UNITYSDK_OFFSET(0x1E6ECBA0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass52_0_TypeDefinitionIndex = 27903;
