...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3ABA10)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS52_0__DOSCALEY_B__0_OFFSET UNITYSDK_OFFSET(0x1C3ABA20)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS52_0__DOSCALEY_B__1_OFFSET UNITYSDK_OFFSET(0x1C3ABA70)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass52_0_TypeDefinitionIndex = 25412;
