...
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BF110C0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1BF10FA0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPEND_OFFSET UNITYSDK_OFFSET(0x1BF0A570)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_INSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BF11240)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_INSERT_OFFSET UNITYSDK_OFFSET(0x1BF10F50)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_JOIN_OFFSET UNITYSDK_OFFSET(0x1BF0A5C0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1BF11180)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1BF10FE0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPEND_OFFSET UNITYSDK_OFFSET(0x1BF10F00)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_1_OFFSET UNITYSDK_OFFSET(0x1BF11900)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_2_OFFSET UNITYSDK_OFFSET(0x1BF11960)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1BF115C0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_10_OFFSET UNITYSDK_OFFSET(0x1BF11400)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_11_OFFSET UNITYSDK_OFFSET(0x1BF0C910)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_12_OFFSET UNITYSDK_OFFSET(0x1BF11540)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_13_OFFSET UNITYSDK_OFFSET(0x1BF11560)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_14_OFFSET UNITYSDK_OFFSET(0x1BF11590)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_1_OFFSET UNITYSDK_OFFSET(0x1BF11320)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_2_OFFSET UNITYSDK_OFFSET(0x1BF11340)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_3_OFFSET UNITYSDK_OFFSET(0x1BF095A0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_4_OFFSET UNITYSDK_OFFSET(0x1BF09760)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_5_OFFSET UNITYSDK_OFFSET(0x1BF11360)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_6_OFFSET UNITYSDK_OFFSET(0x1BF11380)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_7_OFFSET UNITYSDK_OFFSET(0x1BF113A0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_8_OFFSET UNITYSDK_OFFSET(0x1BF113C0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_9_OFFSET UNITYSDK_OFFSET(0x1BF113E0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_OFFSET UNITYSDK_OFFSET(0x1BF11300)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETPATHFORWARDDIRECTION_OFFSET UNITYSDK_OFFSET(0x1BF11620)

namespace DG::Tweening
{
	inline static constexpr unsigned int TweenSettingsExtensions_TypeDefinitionIndex = 25439;
