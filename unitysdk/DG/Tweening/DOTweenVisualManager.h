...
#define DG_TWEENING_DOTWEENVISUALMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E7B35F0)
#define DG_TWEENING_DOTWEENVISUALMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E7B32C0)
#define DG_TWEENING_DOTWEENVISUALMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E7B3110)
#define DG_TWEENING_DOTWEENVISUALMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B3DD0)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenVisualManager_TypeDefinitionIndex = 34474;
