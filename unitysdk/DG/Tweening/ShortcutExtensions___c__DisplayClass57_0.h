...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS57_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3ABD10)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS57_0__DOPUNCHROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1C3ABD20)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS57_0__DOPUNCHROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1C3ABE30)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass57_0_TypeDefinitionIndex = 25417;
