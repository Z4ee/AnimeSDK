...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AD5C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS36_0__DOTIME_B__0_OFFSET UNITYSDK_OFFSET(0x1C4AD5D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS36_0__DOTIME_B__1_OFFSET UNITYSDK_OFFSET(0x1C4AD5F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass36_0_TypeDefinitionIndex = 25396;
