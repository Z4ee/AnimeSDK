...
#define DG_TWEENING_SEQUENCE_APPLYINTERNALCYCLE_OFFSET UNITYSDK_OFFSET(0x1C3AB1C0)
#define DG_TWEENING_SEQUENCE_APPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1C3AAD50)
#define DG_TWEENING_SEQUENCE_DOAPPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1C3AA8A0)
#define DG_TWEENING_SEQUENCE_DOAPPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1C3AAD60)
#define DG_TWEENING_SEQUENCE_DOINSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1C3AA9C0)
#define DG_TWEENING_SEQUENCE_DOINSERT_OFFSET UNITYSDK_OFFSET(0x1C3AA6C0)
#define DG_TWEENING_SEQUENCE_DOPREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1C3AA8E0)
#define DG_TWEENING_SEQUENCE_DOPREPEND_OFFSET UNITYSDK_OFFSET(0x1C3AA5B0)
#define DG_TWEENING_SEQUENCE_DOSTARTUP_OFFSET UNITYSDK_OFFSET(0x1C3AAB60)
#define DG_TWEENING_SEQUENCE_RESET_OFFSET UNITYSDK_OFFSET(0x1C3AA470)
#define DG_TWEENING_SEQUENCE_SETUP_OFFSET UNITYSDK_OFFSET(0x1C3AB0A0)
#define DG_TWEENING_SEQUENCE_SORTSEQUENCEDOBJS_OFFSET UNITYSDK_OFFSET(0x1C3AB890)
#define DG_TWEENING_SEQUENCE_STARTUP_OFFSET UNITYSDK_OFFSET(0x1C3AAB50)
#define DG_TWEENING_SEQUENCE_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1C3AAA70)
#define DG_TWEENING_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3AA230)

namespace DG::Tweening
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 25358;
