...
#define DG_TWEENING_SEQUENCE_APPLYINTERNALCYCLE_OFFSET UNITYSDK_OFFSET(0x1E6EC2F0)
#define DG_TWEENING_SEQUENCE_APPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1E6EBE80)
#define DG_TWEENING_SEQUENCE_DOAPPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E6EB9E0)
#define DG_TWEENING_SEQUENCE_DOAPPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1E6EBE90)
#define DG_TWEENING_SEQUENCE_DOINSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1E6EBAF0)
#define DG_TWEENING_SEQUENCE_DOINSERT_OFFSET UNITYSDK_OFFSET(0x1E6EB810)
#define DG_TWEENING_SEQUENCE_DOPREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1E6EBA20)
#define DG_TWEENING_SEQUENCE_DOPREPEND_OFFSET UNITYSDK_OFFSET(0x1E6EB710)
#define DG_TWEENING_SEQUENCE_DOSTARTUP_OFFSET UNITYSDK_OFFSET(0x1E6EBC90)
#define DG_TWEENING_SEQUENCE_RESET_OFFSET UNITYSDK_OFFSET(0x1E6EB600)
#define DG_TWEENING_SEQUENCE_SETUP_OFFSET UNITYSDK_OFFSET(0x1E6EC1D0)
#define DG_TWEENING_SEQUENCE_SORTSEQUENCEDOBJS_OFFSET UNITYSDK_OFFSET(0x1E6EC9C0)
#define DG_TWEENING_SEQUENCE_STARTUP_OFFSET UNITYSDK_OFFSET(0x1E6EBC80)
#define DG_TWEENING_SEQUENCE_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1E6EBBA0)
#define DG_TWEENING_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E6EB3F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 27849;

	class Sequence : public ::DG::Tweening::Tween
	{
	public:
		::System::Collections::Generic::List_1<::DG::Tweening::Core::ABSSequentiable*>* _sequencedObjs; // 0xF0
		::System::Collections::Generic::List_1<::DG::Tweening::Tween*>* sequencedTweens; // 0xF8
