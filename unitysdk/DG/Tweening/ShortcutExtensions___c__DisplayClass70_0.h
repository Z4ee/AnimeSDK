...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS70_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4F90E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS70_0__DOBLENDABLECOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1C4F90F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS70_0__DOBLENDABLECOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1C4F9100)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass70_0_TypeDefinitionIndex = 25430;
