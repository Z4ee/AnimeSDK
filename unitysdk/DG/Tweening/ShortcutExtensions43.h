...
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOBLENDABLECOLOR_OFFSET UNITYSDK_OFFSET(0x1FC3FB80)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOCOLOR_OFFSET UNITYSDK_OFFSET(0x1FC3E9B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOFADE_OFFSET UNITYSDK_OFFSET(0x1FC3EB40)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOGRADIENTCOLOR_1_OFFSET UNITYSDK_OFFSET(0x1FC3E630)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOGRADIENTCOLOR_2_OFFSET UNITYSDK_OFFSET(0x1FC3ECE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOGRADIENTCOLOR_OFFSET UNITYSDK_OFFSET(0x1FC3E2A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOJUMP_OFFSET UNITYSDK_OFFSET(0x1FC3F670)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOMOVEX_OFFSET UNITYSDK_OFFSET(0x1FC3F170)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOMOVEY_OFFSET UNITYSDK_OFFSET(0x1FC3F320)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOMOVE_OFFSET UNITYSDK_OFFSET(0x1FC3EFE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOROTATE_OFFSET UNITYSDK_OFFSET(0x1FC3F4E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions43_TypeDefinitionIndex = 35079;
