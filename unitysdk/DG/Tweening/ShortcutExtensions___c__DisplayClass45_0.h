...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS45_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CD9B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS45_0__DOROTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1C2CD9C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS45_0__DOROTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1C2CDA00)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass45_0_TypeDefinitionIndex = 25405;
