...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DBBD0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1C4DBBE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1C4DBD10)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass13_0_TypeDefinitionIndex = 25373;
