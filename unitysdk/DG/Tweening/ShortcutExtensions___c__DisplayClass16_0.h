...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBE74E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS16_0__DOSHADOWSTRENGTH_B__0_OFFSET UNITYSDK_OFFSET(0x1FBE74F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS16_0__DOSHADOWSTRENGTH_B__1_OFFSET UNITYSDK_OFFSET(0x1FBE7510)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass16_0_TypeDefinitionIndex = 28471;
