...
#define DG_TWEENING_CORE_ABSANIMATIONCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4735E0)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int ABSAnimationComponent_TypeDefinitionIndex = 32933;
