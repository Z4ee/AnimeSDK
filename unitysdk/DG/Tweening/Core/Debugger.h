...
#define DG_TWEENING_CORE_DEBUGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1FBBE900)
#define DG_TWEENING_CORE_DEBUGGER_LOGINVALIDTWEEN_OFFSET UNITYSDK_OFFSET(0x1FBBE9D0)
#define DG_TWEENING_CORE_DEBUGGER_LOGMISSINGMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x1FBBEC10)
#define DG_TWEENING_CORE_DEBUGGER_LOGNESTEDTWEEN_OFFSET UNITYSDK_OFFSET(0x1FBBEA60)
#define DG_TWEENING_CORE_DEBUGGER_LOGNONPATHTWEEN_OFFSET UNITYSDK_OFFSET(0x1FBBEB80)
#define DG_TWEENING_CORE_DEBUGGER_LOGNULLTWEEN_OFFSET UNITYSDK_OFFSET(0x1FBBEAF0)
#define DG_TWEENING_CORE_DEBUGGER_LOGREMOVEACTIVETWEENERROR_OFFSET UNITYSDK_OFFSET(0x1FBBECC0)
#define DG_TWEENING_CORE_DEBUGGER_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x1FBBE960)
#define DG_TWEENING_CORE_DEBUGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1FBBE8A0)
#define DG_TWEENING_CORE_DEBUGGER_LOG_OFFSET UNITYSDK_OFFSET(0x1FBBE840)
#define DG_TWEENING_CORE_DEBUGGER_SETLOGPRIORITY_OFFSET UNITYSDK_OFFSET(0x1FBBED70)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int Debugger_TypeDefinitionIndex = 28584;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Debugger_TypeDefinitionIndex)->GetStaticField(0x7850);
		}
