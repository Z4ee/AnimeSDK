...
#define DG_TWEENING_CORE_DOTWEENSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1FACE0E0)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenSettings_TypeDefinitionIndex = 28592;
