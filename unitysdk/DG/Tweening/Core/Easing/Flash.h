...
#define DG_TWEENING_CORE_EASING_FLASH_EASEINOUT_OFFSET UNITYSDK_OFFSET(0x1C24E1F0)
#define DG_TWEENING_CORE_EASING_FLASH_EASEIN_OFFSET UNITYSDK_OFFSET(0x1C24DE90)
#define DG_TWEENING_CORE_EASING_FLASH_EASEOUT_OFFSET UNITYSDK_OFFSET(0x1C24E030)
#define DG_TWEENING_CORE_EASING_FLASH_EASE_OFFSET UNITYSDK_OFFSET(0x1C24DB90)
#define DG_TWEENING_CORE_EASING_FLASH_WEIGHTEDEASE_OFFSET UNITYSDK_OFFSET(0x1C24DD30)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int Flash_TypeDefinitionIndex = 25514;
