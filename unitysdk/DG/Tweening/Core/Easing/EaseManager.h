...
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1E5E5510)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1E5E54C0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_ISFLASHEASE_OFFSET UNITYSDK_OFFSET(0x1E5E7320)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_TOEASEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1E5E63F0)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int EaseManager_TypeDefinitionIndex = 28002;
