...
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1C2954A0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1C295450)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_ISFLASHEASE_OFFSET UNITYSDK_OFFSET(0x1C2972A0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_TOEASEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1C296380)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int EaseManager_TypeDefinitionIndex = 25511;
