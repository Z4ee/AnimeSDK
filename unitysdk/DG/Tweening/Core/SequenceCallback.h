...
#define DG_TWEENING_CORE_SEQUENCECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4ABBE0)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int SequenceCallback_TypeDefinitionIndex = 25500;
