...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORPOSITION_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C4AB5B0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORPOSITION_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C4AB620)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORPOSITION_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C4AB680)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORPOSITION_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C4AB630)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORPOSITION_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C4AB5A0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORPOSITION_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4AB590)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent__WaitForPosition_d__17_TypeDefinitionIndex = 25495;
