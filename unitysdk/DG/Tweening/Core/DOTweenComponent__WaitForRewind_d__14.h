...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1C54C0B0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C54C120)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1C54C180)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1C54C130)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1C54C0A0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1C54C090)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent__WaitForRewind_d__14_TypeDefinitionIndex = 25492;
