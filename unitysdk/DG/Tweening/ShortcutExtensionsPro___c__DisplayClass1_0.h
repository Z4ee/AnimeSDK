...
#define DG_TWEENING_SHORTCUTEXTENSIONSPRO___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7B4B90)
#define DG_TWEENING_SHORTCUTEXTENSIONSPRO___C__DISPLAYCLASS1_0__DOSPIRAL_B__0_OFFSET UNITYSDK_OFFSET(0x1E7B4C30)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensionsPro___c__DisplayClass1_0_TypeDefinitionIndex = 34482;
