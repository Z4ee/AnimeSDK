...
#define DG_TWEENING_DOVIRTUAL_DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x1E7E3810)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E7E35E0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_2_OFFSET UNITYSDK_OFFSET(0x1E7E36C0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_3_OFFSET UNITYSDK_OFFSET(0x1E7E3720)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_OFFSET UNITYSDK_OFFSET(0x1E7E3520)
#define DG_TWEENING_DOVIRTUAL_FLOAT_OFFSET UNITYSDK_OFFSET(0x1E7E3350)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOVirtual_TypeDefinitionIndex = 27837;
