...
#define DG_TWEENING_DOVIRTUAL_DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x1C4AC0B0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_1_OFFSET UNITYSDK_OFFSET(0x1C4ABE80)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_2_OFFSET UNITYSDK_OFFSET(0x1C4ABF60)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_3_OFFSET UNITYSDK_OFFSET(0x1C4ABFC0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_OFFSET UNITYSDK_OFFSET(0x1C4ABDC0)
#define DG_TWEENING_DOVIRTUAL_FLOAT_OFFSET UNITYSDK_OFFSET(0x1C4ABC00)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOVirtual_TypeDefinitionIndex = 25346;
