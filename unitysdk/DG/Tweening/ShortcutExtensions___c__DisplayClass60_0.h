...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS60_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9D07C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS60_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1F9D07D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS60_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1F9D08E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass60_0_TypeDefinitionIndex = 28515;
