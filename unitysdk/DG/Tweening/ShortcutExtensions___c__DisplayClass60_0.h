...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS60_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C299C40)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS60_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1C299C50)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS60_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1C299D60)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass60_0_TypeDefinitionIndex = 25420;
