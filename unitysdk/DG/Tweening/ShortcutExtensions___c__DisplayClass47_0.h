...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CDAB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS47_0__DOLOCALROTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1C2CDAC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS47_0__DOLOCALROTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1C2CDB00)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass47_0_TypeDefinitionIndex = 25407;
