...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DB940)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__DOSHAKEPOSITION_B__0_OFFSET UNITYSDK_OFFSET(0x1C4DB950)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__DOSHAKEPOSITION_B__1_OFFSET UNITYSDK_OFFSET(0x1C4DB9B0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass11_0_TypeDefinitionIndex = 25371;
