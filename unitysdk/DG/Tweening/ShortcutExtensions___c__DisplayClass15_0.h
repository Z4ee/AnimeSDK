...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBE7480)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__DOINTENSITY_B__0_OFFSET UNITYSDK_OFFSET(0x1FBE7490)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__DOINTENSITY_B__1_OFFSET UNITYSDK_OFFSET(0x1FBE74B0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass15_0_TypeDefinitionIndex = 28470;
