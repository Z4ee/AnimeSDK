...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2CD690)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS40_0__DOMOVEZ_B__0_OFFSET UNITYSDK_OFFSET(0x1C2CD6A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS40_0__DOMOVEZ_B__1_OFFSET UNITYSDK_OFFSET(0x1C2CD6F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass40_0_TypeDefinitionIndex = 25400;
