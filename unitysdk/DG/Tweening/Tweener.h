...
#define DG_TWEENING_TWEENER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FC6F6C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int Tweener_TypeDefinitionIndex = 28537;

	class Tweener : public ::DG::Tweening::Tween
	{
	public:
		::System::Boolean hasManuallySetStartValue; // 0xF0
		::System::Boolean isFromAllowed; // 0xF1
