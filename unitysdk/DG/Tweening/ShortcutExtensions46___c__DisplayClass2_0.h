...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2E2EE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS2_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1C2E7880)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS2_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1C2E78C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass2_0_TypeDefinitionIndex = 32886;
