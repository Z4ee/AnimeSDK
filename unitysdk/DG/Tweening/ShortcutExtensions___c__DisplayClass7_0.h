...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9D1560)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS7_0__DOORTHOSIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1F9D1570)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS7_0__DOORTHOSIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1F9D1590)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass7_0_TypeDefinitionIndex = 28462;
