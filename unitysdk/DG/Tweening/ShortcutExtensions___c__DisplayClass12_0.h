...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4DBA00)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS12_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1C4DBA10)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS12_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1C4DBB40)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass12_0_TypeDefinitionIndex = 25372;
