...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1FAD15C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS6_0__DONEARCLIPPLANE_B__0_OFFSET UNITYSDK_OFFSET(0x1FAD15D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS6_0__DONEARCLIPPLANE_B__1_OFFSET UNITYSDK_OFFSET(0x1FAD15F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass6_0_TypeDefinitionIndex = 28461;
