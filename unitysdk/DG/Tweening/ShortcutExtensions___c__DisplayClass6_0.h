...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3ABFF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS6_0__DONEARCLIPPLANE_B__0_OFFSET UNITYSDK_OFFSET(0x1C3AC000)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS6_0__DONEARCLIPPLANE_B__1_OFFSET UNITYSDK_OFFSET(0x1C3AC020)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass6_0_TypeDefinitionIndex = 25366;
