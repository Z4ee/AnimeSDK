...
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A8EA0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1C3A90E0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1C3A8FD0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_PLUG_OFFSET UNITYSDK_OFFSET(0x1C3A8C70)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1C3A8D10)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A8FA0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1C3A8D20)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1C3A8EB0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3A8CF0)

namespace DG::Tweening::CustomPlugins
{
	inline static constexpr unsigned int PureQuaternionPlugin_TypeDefinitionIndex = 25485;
	...
	public:
		...
		{
			return (::DG::Tweening::CustomPlugins::PureQuaternionPlugin**)Il2CppClass::FromTypeDefinitionIndex(PureQuaternionPlugin_TypeDefinitionIndex)->GetStaticField(0x1F0A0);
		}
