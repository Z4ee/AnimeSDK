...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1E80CDB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS2_0__DOASPECT_B__0_OFFSET UNITYSDK_OFFSET(0x1E80CDC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS2_0__DOASPECT_B__1_OFFSET UNITYSDK_OFFSET(0x1E80CDE0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass2_0_TypeDefinitionIndex = 27853;
