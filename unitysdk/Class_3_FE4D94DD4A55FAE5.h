...
#define CLASS_3_FE4D94DD4A55FAE5_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x1775EC20)
#define CLASS_3_FE4D94DD4A55FAE5_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1775ED00)
#define CLASS_3_FE4D94DD4A55FAE5_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x1775ED90)
#define CLASS_3_FE4D94DD4A55FAE5_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x1775EB70)
#define CLASS_3_FE4D94DD4A55FAE5__CCTOR_OFFSET UNITYSDK_OFFSET(0x1775EC70)
#define CLASS_3_FE4D94DD4A55FAE5__CTOR_OFFSET UNITYSDK_OFFSET(0x1775ECF0)

inline static constexpr unsigned int Class_3_FE4D94DD4A55FAE5_TypeDefinitionIndex = 54049;

class Class_3_FE4D94DD4A55FAE5 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_8 = 0xBE; // 0x0
	::MonoVOPathParticle* Field_3_1; // 0x48
	::MoleMole::EntityHandle Field_3_0; // 0x50
	::Enum_3_F27E25827C684939 Field_3_2; // 0x60
	::System::Single Field_3_5; // 0x64
	::System::Single Field_3_4; // 0x68
	::System::Boolean Field_3_7; // 0x6C
	::System::Single Field_3_6; // 0x70
	::Enum_3_D3876C00D1C08DCB Field_3_3; // 0x74
