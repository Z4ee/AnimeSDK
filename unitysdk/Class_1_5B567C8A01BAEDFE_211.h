...
#define CLASS_1_5B567C8A01BAEDFE_211_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1944FE30)
#define CLASS_1_5B567C8A01BAEDFE_211_CLONE_OFFSET UNITYSDK_OFFSET(0x1944FC40)
#define CLASS_1_5B567C8A01BAEDFE_211_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1944FD40)
#define CLASS_1_5B567C8A01BAEDFE_211_EQUALS_OFFSET UNITYSDK_OFFSET(0x1944FCB0)
#define CLASS_1_5B567C8A01BAEDFE_211_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1944FD90)
#define CLASS_1_5B567C8A01BAEDFE_211_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1944FE80)
#define CLASS_1_5B567C8A01BAEDFE_211_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1944FE50)
#define CLASS_1_5B567C8A01BAEDFE_211_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1944FB90)
#define CLASS_1_5B567C8A01BAEDFE_211_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1944FBF0)
#define CLASS_1_5B567C8A01BAEDFE_211_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1944FDC0)
#define CLASS_1_5B567C8A01BAEDFE_211_WRITETO_OFFSET UNITYSDK_OFFSET(0x1944FE20)
#define CLASS_1_5B567C8A01BAEDFE_211__CCTOR_OFFSET UNITYSDK_OFFSET(0x1944FED0)
#define CLASS_1_5B567C8A01BAEDFE_211__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1944FC10)
#define CLASS_1_5B567C8A01BAEDFE_211__CTOR_OFFSET UNITYSDK_OFFSET(0x1944FC00)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_211_TypeDefinitionIndex = 29311;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_211*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_211_TypeDefinitionIndex)->GetStaticField(0x160D0);
	}
