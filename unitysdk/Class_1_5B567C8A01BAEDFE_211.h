...
#define CLASS_1_5B567C8A01BAEDFE_211_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A798400)
#define CLASS_1_5B567C8A01BAEDFE_211_CLONE_OFFSET UNITYSDK_OFFSET(0x1A798270)
#define CLASS_1_5B567C8A01BAEDFE_211_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A798310)
#define CLASS_1_5B567C8A01BAEDFE_211_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7982B0)
#define CLASS_1_5B567C8A01BAEDFE_211_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A798360)
#define CLASS_1_5B567C8A01BAEDFE_211_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A798450)
#define CLASS_1_5B567C8A01BAEDFE_211_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A798420)
#define CLASS_1_5B567C8A01BAEDFE_211_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A7981F0)
#define CLASS_1_5B567C8A01BAEDFE_211_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A798220)
#define CLASS_1_5B567C8A01BAEDFE_211_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A798390)
#define CLASS_1_5B567C8A01BAEDFE_211_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A7983F0)
#define CLASS_1_5B567C8A01BAEDFE_211__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7984A0)
#define CLASS_1_5B567C8A01BAEDFE_211__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A798240)
#define CLASS_1_5B567C8A01BAEDFE_211__CTOR_OFFSET UNITYSDK_OFFSET(0x1A798230)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_211_TypeDefinitionIndex = 29052;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_211*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_211_TypeDefinitionIndex)->GetStaticField(0x48350);
	}
