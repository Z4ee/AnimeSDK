...
#define CLASS_1_5B567C8A01BAEDFE_230_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1962C6E0)
#define CLASS_1_5B567C8A01BAEDFE_230_CLONE_OFFSET UNITYSDK_OFFSET(0x1962C550)
#define CLASS_1_5B567C8A01BAEDFE_230_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1962C5F0)
#define CLASS_1_5B567C8A01BAEDFE_230_EQUALS_OFFSET UNITYSDK_OFFSET(0x1962C590)
#define CLASS_1_5B567C8A01BAEDFE_230_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1962C640)
#define CLASS_1_5B567C8A01BAEDFE_230_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1962C730)
#define CLASS_1_5B567C8A01BAEDFE_230_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1962C700)
#define CLASS_1_5B567C8A01BAEDFE_230_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1962C4D0)
#define CLASS_1_5B567C8A01BAEDFE_230_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1962C500)
#define CLASS_1_5B567C8A01BAEDFE_230_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1962C670)
#define CLASS_1_5B567C8A01BAEDFE_230_WRITETO_OFFSET UNITYSDK_OFFSET(0x1962C6D0)
#define CLASS_1_5B567C8A01BAEDFE_230__CCTOR_OFFSET UNITYSDK_OFFSET(0x1962C780)
#define CLASS_1_5B567C8A01BAEDFE_230__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1962C520)
#define CLASS_1_5B567C8A01BAEDFE_230__CTOR_OFFSET UNITYSDK_OFFSET(0x1962C510)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_230_TypeDefinitionIndex = 29690;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_230*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_230_TypeDefinitionIndex)->GetStaticField(0x5F550);
	}
