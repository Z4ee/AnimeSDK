...
#define CLASS_1_5B567C8A01BAEDFE_230_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DCE9E20)
#define CLASS_1_5B567C8A01BAEDFE_230_CLONE_OFFSET UNITYSDK_OFFSET(0x1DCE9B10)
#define CLASS_1_5B567C8A01BAEDFE_230_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DCE9C20)
#define CLASS_1_5B567C8A01BAEDFE_230_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DCE9B50)
#define CLASS_1_5B567C8A01BAEDFE_230_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DCE9D80)
#define CLASS_1_5B567C8A01BAEDFE_230_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DCE9E70)
#define CLASS_1_5B567C8A01BAEDFE_230_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DCE9E40)
#define CLASS_1_5B567C8A01BAEDFE_230_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DCE9A90)
#define CLASS_1_5B567C8A01BAEDFE_230_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DCE9AC0)
#define CLASS_1_5B567C8A01BAEDFE_230_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DCE9DB0)
#define CLASS_1_5B567C8A01BAEDFE_230_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DCE9E10)
#define CLASS_1_5B567C8A01BAEDFE_230__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DCE9EC0)
#define CLASS_1_5B567C8A01BAEDFE_230__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DCE9AE0)
#define CLASS_1_5B567C8A01BAEDFE_230__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCE9AD0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_230_TypeDefinitionIndex = 30733;

class Class_1_5B567C8A01BAEDFE_230 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_230*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_230*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_230_TypeDefinitionIndex)->GetStaticField(0x98E0);
	}
