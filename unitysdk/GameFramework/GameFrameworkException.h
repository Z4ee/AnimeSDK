...
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F32030)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18F33950)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x18F339C0)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18F338F0)

namespace GameFramework
{
	inline static constexpr unsigned int GameFrameworkException_TypeDefinitionIndex = 40425;
