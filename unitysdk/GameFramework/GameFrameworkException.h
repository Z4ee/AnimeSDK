...
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D255590)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1D257140)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1D2571B0)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1D2570E0)

namespace GameFramework
{
	inline static constexpr unsigned int GameFrameworkException_TypeDefinitionIndex = 41240;
