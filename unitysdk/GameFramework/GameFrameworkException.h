...
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C6FDC90)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C6FF860)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C6FF8D0)
#define GAMEFRAMEWORK_GAMEFRAMEWORKEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1C6FF800)
