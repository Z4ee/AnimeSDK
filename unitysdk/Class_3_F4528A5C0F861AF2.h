...
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xC124150)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_4FB94B1EADAF1C13_OFFSET UNITYSDK_OFFSET(0xC1240D0)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_A0529F9E6E9763B9_OFFSET UNITYSDK_OFFSET(0xC124220)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xC1241C0)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC123E90)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0xC123ED0)
#define CLASS_3_F4528A5C0F861AF2__CTOR_OFFSET UNITYSDK_OFFSET(0xC123E70)

inline static constexpr unsigned int Class_3_F4528A5C0F861AF2_TypeDefinitionIndex = 76060;

class Class_3_F4528A5C0F861AF2 : public ::RPG::Client::LittleGame::Services_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>
{
public:
	::Class_1_FA6AB3C88A3E6365* DJLBAGILFBI; // 0x90
	::Class_1_38F1A9F0165DAD63* EJNNCAPKAOO; // 0x98
	::Class_1_D33B7D6901AE39E9* FKINCGODJEP; // 0xA0
	::Class_2_579DDCBEB4529D20* MKFMHILGAGI; // 0xA8
	::Class_1_F896A7F19FFA18B0* CHPOLDKNEPK; // 0xB0
	::Class_1_235F6921BD6EA8D9* GOIHPOMCENF; // 0xB8
	::RPG::Client::ElfRestaurantModule* AEJIGLOEOFI; // 0xC0
	::Class_1_3045BDDBFA69FA59* DNLFJKEHLPG; // 0xC8
	::Class_1_EB67B065A0CE0512* GJMEEGNFDBL; // 0xD0
	::Class_1_C8A753BBB389E2BC* MIPNNFMKIEC; // 0xD8
	::RPG::Client::LittleGame::ElfRestaurant::ElfRestaurantAIService* JLMEJDNFAOD; // 0xE0
	::System::Boolean FCKPEHPGGCK; // 0xE8
	::System::Int32 CCNBLGIHHBP; // 0xEC
	::System::Single ADIKIODKIBN; // 0xF0
