...
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x17067C30)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_4FB94B1EADAF1C13_OFFSET UNITYSDK_OFFSET(0x17067BB0)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_A0529F9E6E9763B9_OFFSET UNITYSDK_OFFSET(0x17067D00)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x17067CA0)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17067960)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x170679A0)
#define CLASS_3_F4528A5C0F861AF2__CTOR_OFFSET UNITYSDK_OFFSET(0x17067940)

inline static constexpr unsigned int Class_3_F4528A5C0F861AF2_TypeDefinitionIndex = 72623;

class Class_3_F4528A5C0F861AF2 : public ::RPG::Client::LittleGame::Services_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>
{
public:
	::Class_1_38F1A9F0165DAD63* Field_3_0; // 0x90
	::Class_1_F896A7F19FFA18B0* Field_3_1; // 0x98
	::Class_2_579DDCBEB4529D20* Field_3_2; // 0xA0
	::Class_1_EB67B065A0CE0512* Field_3_3; // 0xA8
	::Class_1_3045BDDBFA69FA59* Field_3_4; // 0xB0
	::Class_1_D33B7D6901AE39E9* Field_3_5; // 0xB8
	::Class_1_FA6AB3C88A3E6365* Field_3_6; // 0xC0
	::Class_1_235F6921BD6EA8D9* Field_3_7; // 0xC8
	::RPG::Client::LittleGame::ElfRestaurant::ElfRestaurantAIService* Field_3_8; // 0xD0
	::RPG::Client::ElfRestaurantModule* Field_3_9; // 0xD8
	::Class_1_C8A753BBB389E2BC* Field_3_10; // 0xE0
	::System::Single Field_3_11; // 0xE8
	::System::Int32 Field_3_12; // 0xEC
	::System::Boolean Field_3_13; // 0xF0
