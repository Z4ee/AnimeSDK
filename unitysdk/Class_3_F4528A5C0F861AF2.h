...
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x11E80C50)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_42D44BFB373F39F8_OFFSET UNITYSDK_OFFSET(0x11E80BE0)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_A00C84EAF431BAA3_OFFSET UNITYSDK_OFFSET(0x11E80D20)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_C7AA0B5353D21688_OFFSET UNITYSDK_OFFSET(0x11E80CC0)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x11E80990)
#define CLASS_3_F4528A5C0F861AF2_METHOD_3_EDFD49C942C75D6C_OFFSET UNITYSDK_OFFSET(0x11E809D0)
#define CLASS_3_F4528A5C0F861AF2__CTOR_OFFSET UNITYSDK_OFFSET(0x11E80970)

inline static constexpr unsigned int Class_3_F4528A5C0F861AF2_TypeDefinitionIndex = 70294;

class Class_3_F4528A5C0F861AF2 : public ::RPG::Client::LittleGame::Services_1<::RPG::Client::LittleGame::ElfRestaurantGameEntity*>
{
public:
	::Class_1_3045BDDBFA69FA59* Field_3_4; // 0x90
	::Class_1_235F6921BD6EA8D9* Field_3_10; // 0x98
	::Class_1_EB67B065A0CE0512* Field_3_11; // 0xA0
	::Class_1_C8A753BBB389E2BC* Field_3_7; // 0xA8
	::Class_2_235EAE06A792DE91* Field_3_5; // 0xB0
	::RPG::Client::LittleGame::ElfRestaurant::ElfRestaurantAIService* Field_3_9; // 0xB8
	::Class_1_867B6CE75953535A* Field_3_3; // 0xC0
	::Class_1_11A601EC692AC3BC* Field_3_8; // 0xC8
	::RPG::Client::ElfRestaurantModule* Field_3_13; // 0xD0
	::Class_1_F896A7F19FFA18B0* Field_3_6; // 0xD8
	::Class_1_38F1A9F0165DAD63* Field_3_12; // 0xE0
	::System::Single Field_3_1; // 0xE8
	::System::Boolean Field_3_2; // 0xEC
