...
#define CLASS_1_3FF63E3B49DB868D_METHOD_1_03E2B9212B4B6EAF_OFFSET UNITYSDK_OFFSET(0x117C1870)
#define CLASS_1_3FF63E3B49DB868D_METHOD_1_2B9B111B4402E23A_OFFSET UNITYSDK_OFFSET(0x117C12F0)
#define CLASS_1_3FF63E3B49DB868D_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x117C18B0)
#define CLASS_1_3FF63E3B49DB868D_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x117C17B0)
#define CLASS_1_3FF63E3B49DB868D_METHOD_1_E34E0CE2E527F293_OFFSET UNITYSDK_OFFSET(0x117C1830)
#define CLASS_1_3FF63E3B49DB868D__CTOR_OFFSET UNITYSDK_OFFSET(0x117C1960)

inline static constexpr unsigned int Class_1_3FF63E3B49DB868D_TypeDefinitionIndex = 66650;
...
public:
	...
	::Il2CppArray<::System::String*>* Field_1_4; // 0x20
	::UnityEngine::Transform* Field_1_0; // 0x28
	::UnityEngine::Animation* Field_1_3; // 0x30
