...
#define CLASS_1_5B567C8A01BAEDFE_256_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C13D010)
#define CLASS_1_5B567C8A01BAEDFE_256_CLONE_OFFSET UNITYSDK_OFFSET(0x1C13CD00)
#define CLASS_1_5B567C8A01BAEDFE_256_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C13CE10)
#define CLASS_1_5B567C8A01BAEDFE_256_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C13CD40)
#define CLASS_1_5B567C8A01BAEDFE_256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C13CF70)
#define CLASS_1_5B567C8A01BAEDFE_256_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C13D060)
#define CLASS_1_5B567C8A01BAEDFE_256_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C13D030)
#define CLASS_1_5B567C8A01BAEDFE_256_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1C13CC80)
#define CLASS_1_5B567C8A01BAEDFE_256_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C13CCB0)
#define CLASS_1_5B567C8A01BAEDFE_256_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C13CFA0)
#define CLASS_1_5B567C8A01BAEDFE_256_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C13D000)
#define CLASS_1_5B567C8A01BAEDFE_256__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C13D0B0)
#define CLASS_1_5B567C8A01BAEDFE_256__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C13CCD0)
#define CLASS_1_5B567C8A01BAEDFE_256__CTOR_OFFSET UNITYSDK_OFFSET(0x1C13CCC0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_256_TypeDefinitionIndex = 30703;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_256*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_256_TypeDefinitionIndex)->GetStaticField(0x5A3B0);
	}
