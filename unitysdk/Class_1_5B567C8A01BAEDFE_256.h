...
#define CLASS_1_5B567C8A01BAEDFE_256_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DA96ED0)
#define CLASS_1_5B567C8A01BAEDFE_256_CLONE_OFFSET UNITYSDK_OFFSET(0x1DA96BC0)
#define CLASS_1_5B567C8A01BAEDFE_256_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DA96CD0)
#define CLASS_1_5B567C8A01BAEDFE_256_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DA96C00)
#define CLASS_1_5B567C8A01BAEDFE_256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DA96E30)
#define CLASS_1_5B567C8A01BAEDFE_256_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DA96F20)
#define CLASS_1_5B567C8A01BAEDFE_256_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DA96EF0)
#define CLASS_1_5B567C8A01BAEDFE_256_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DA96B40)
#define CLASS_1_5B567C8A01BAEDFE_256_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DA96B70)
#define CLASS_1_5B567C8A01BAEDFE_256_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DA96E60)
#define CLASS_1_5B567C8A01BAEDFE_256_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DA96EC0)
#define CLASS_1_5B567C8A01BAEDFE_256__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DA96F70)
#define CLASS_1_5B567C8A01BAEDFE_256__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DA96B90)
#define CLASS_1_5B567C8A01BAEDFE_256__CTOR_OFFSET UNITYSDK_OFFSET(0x1DA96B80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_256_TypeDefinitionIndex = 31392;

class Class_1_5B567C8A01BAEDFE_256 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_256*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_256*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_256_TypeDefinitionIndex)->GetStaticField(0x28A40);
	}
