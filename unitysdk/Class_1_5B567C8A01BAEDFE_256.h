...
#define CLASS_1_5B567C8A01BAEDFE_256_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5FA750)
#define CLASS_1_5B567C8A01BAEDFE_256_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5FA5C0)
#define CLASS_1_5B567C8A01BAEDFE_256_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5FA660)
#define CLASS_1_5B567C8A01BAEDFE_256_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5FA600)
#define CLASS_1_5B567C8A01BAEDFE_256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5FA6B0)
#define CLASS_1_5B567C8A01BAEDFE_256_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5FA7A0)
#define CLASS_1_5B567C8A01BAEDFE_256_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5FA770)
#define CLASS_1_5B567C8A01BAEDFE_256_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A5FA540)
#define CLASS_1_5B567C8A01BAEDFE_256_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5FA570)
#define CLASS_1_5B567C8A01BAEDFE_256_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5FA6E0)
#define CLASS_1_5B567C8A01BAEDFE_256_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5FA740)
#define CLASS_1_5B567C8A01BAEDFE_256__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5FA7F0)
#define CLASS_1_5B567C8A01BAEDFE_256__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5FA590)
#define CLASS_1_5B567C8A01BAEDFE_256__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5FA580)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_256_TypeDefinitionIndex = 30209;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_256*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_256_TypeDefinitionIndex)->GetStaticField(0x1BE40);
	}
