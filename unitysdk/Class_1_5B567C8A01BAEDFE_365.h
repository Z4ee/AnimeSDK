...
#define CLASS_1_5B567C8A01BAEDFE_365_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A18AAA0)
#define CLASS_1_5B567C8A01BAEDFE_365_CLONE_OFFSET UNITYSDK_OFFSET(0x1A18A910)
#define CLASS_1_5B567C8A01BAEDFE_365_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A18A9B0)
#define CLASS_1_5B567C8A01BAEDFE_365_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A18A950)
#define CLASS_1_5B567C8A01BAEDFE_365_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A18AA00)
#define CLASS_1_5B567C8A01BAEDFE_365_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A18AAF0)
#define CLASS_1_5B567C8A01BAEDFE_365_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A18AAC0)
#define CLASS_1_5B567C8A01BAEDFE_365_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A18A890)
#define CLASS_1_5B567C8A01BAEDFE_365_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A18A8C0)
#define CLASS_1_5B567C8A01BAEDFE_365_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A18AA30)
#define CLASS_1_5B567C8A01BAEDFE_365_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A18AA90)
#define CLASS_1_5B567C8A01BAEDFE_365__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A18AB40)
#define CLASS_1_5B567C8A01BAEDFE_365__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A18A8E0)
#define CLASS_1_5B567C8A01BAEDFE_365__CTOR_OFFSET UNITYSDK_OFFSET(0x1A18A8D0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_365_TypeDefinitionIndex = 32606;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_365*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_365_TypeDefinitionIndex)->GetStaticField(0x2E560);
	}
