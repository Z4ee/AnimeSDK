...
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_0F385A3C5FDF01D9_OFFSET UNITYSDK_OFFSET(0x17C95BA0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_4628F59881B23161_OFFSET UNITYSDK_OFFSET(0x17C961D0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_4FB9BE0E17E8AA4E_OFFSET UNITYSDK_OFFSET(0x17C96570)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0x17C981D0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_7267F516B84E2D86_OFFSET UNITYSDK_OFFSET(0x17C98930)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_81483EC470411B74_OFFSET UNITYSDK_OFFSET(0x17C96260)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_9803082DC13B9390_OFFSET UNITYSDK_OFFSET(0x17C965E0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_9BAB385F8658C2AD_OFFSET UNITYSDK_OFFSET(0x17C966E0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_9C1A214F97FB8CE1_OFFSET UNITYSDK_OFFSET(0x17C95CE0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_A1ADC999CFACEB89_OFFSET UNITYSDK_OFFSET(0x17C96640)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_A67D499B6B266137_OFFSET UNITYSDK_OFFSET(0x17C983E0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_A8EE4F706DE7DB8F_OFFSET UNITYSDK_OFFSET(0x17C98470)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_AB7ED27CAB69BE58_OFFSET UNITYSDK_OFFSET(0x17C96A10)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_AF338721792188C4_OFFSET UNITYSDK_OFFSET(0x17C95A60)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_C46E6CD6AE9E1B86_OFFSET UNITYSDK_OFFSET(0x17C95B10)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_C9AD03BD3B583EEE_OFFSET UNITYSDK_OFFSET(0x17C98C20)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_D861EC87938376A1_OFFSET UNITYSDK_OFFSET(0x17C96020)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_E378D9A7A36FC561_OFFSET UNITYSDK_OFFSET(0x17C98FD0)
#define CLASS_1_17628DBDBD20BE6F_METHOD_1_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0x17C976F0)
#define CLASS_1_17628DBDBD20BE6F_ONPLUGININIT_OFFSET UNITYSDK_OFFSET(0x17C95C40)
#define CLASS_1_17628DBDBD20BE6F_ONPLUGINUNINIT_OFFSET UNITYSDK_OFFSET(0x17C95C90)
#define CLASS_1_17628DBDBD20BE6F_TICK_OFFSET UNITYSDK_OFFSET(0x17C96450)
#define CLASS_1_17628DBDBD20BE6F__CTOR_OFFSET UNITYSDK_OFFSET(0x17C99030)

inline static constexpr unsigned int Class_1_17628DBDBD20BE6F_TypeDefinitionIndex = 53886;

class Class_1_17628DBDBD20BE6F : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_D30B741E780CB2FD*>* NEBDHCDMKMK; // 0x10
	::System::Collections::Generic::List_1<::Class_1_98133438BFCB56ED*>* DINHCHDEPMB; // 0x18
	::System::Collections::Generic::List_1<::Class_1_98133438BFCB56ED*>* EGCELIGMFCL; // 0x20
	::RPG::GameCore::GameWorld* IMMBMILPPFB; // 0x28
	::System::Collections::Generic::List_1<::Class_1_98133438BFCB56ED*>* KLFENJMEMJJ; // 0x30
	::System::Collections::Generic::List_1<::Class_1_D30B741E780CB2FD*>* MALANKKMOJI; // 0x38
	::System::Collections::Generic::List_1<::Class_1_D30B741E780CB2FD*>* EIHIOGOPLIN; // 0x40
	::System::Collections::Generic::List_1<::System::UInt32>* DJJJDGJBBBH; // 0x48
	::System::Collections::Generic::SortedDictionary_2<::System::UInt64, ::Class_1_D30B741E780CB2FD*>* GDBPKCFHDMD; // 0x50
	::System::UInt32 MIBPLMILJKC; // 0x58
	::RPG::GameCore::Collision2DUpdateType KFMGEEHOMPO; // 0x5C
	...
	::System::Void Method_1_AF338721792188C4(::Class_0_16E4307DCC419505_476* a1, ::RPG::GameCore::FixVec2 a2, ::RPG::GameCore::FixVec2 a3, ::RPG::MColor a4, ::System::Single a5, ::System::Boolean a6)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_476*, ::RPG::GameCore::FixVec2, ::RPG::GameCore::FixVec2, ::RPG::MColor, ::System::Single, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_1_17628DBDBD20BE6F_METHOD_1_AF338721792188C4_OFFSET))(this, a1, a2, a3, a4, a5, a6);
	}
	...
	::Class_1_98133438BFCB56ED* Method_1_D861EC87938376A1(::Class_0_16E4307DCC419505_476* a1, ::RPG::GameCore::FixVec2 a2, ::RPG::GameCore::FixVec2 a3, ::System::UInt32 a4, ::System::UInt32 a5, ::System::Object* a6, ::Class_0_16E4307DCC419505_475* a7)
	{
		return ((::Class_1_98133438BFCB56ED*(*)(::PVOID, ::Class_0_16E4307DCC419505_476*, ::RPG::GameCore::FixVec2, ::RPG::GameCore::FixVec2, ::System::UInt32, ::System::UInt32, ::System::Object*, ::Class_0_16E4307DCC419505_475*))((::PBYTE)hIl2Cpp + CLASS_1_17628DBDBD20BE6F_METHOD_1_D861EC87938376A1_OFFSET))(this, a1, a2, a3, a4, a5, a6, a7);
	}
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_17628DBDBD20BE6F_METHOD_1_EAD10B3E55E2C4C5_OFFSET))(this);
	}

	::System::Void Method_1_AB7ED27CAB69BE58()
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_17628DBDBD20BE6F_METHOD_1_AB7ED27CAB69BE58_OFFSET))(this);
	}
