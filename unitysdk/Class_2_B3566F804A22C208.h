...
#define CLASS_2_B3566F804A22C208_LOCK_OFFSET UNITYSDK_OFFSET(0x9398C70)
#define CLASS_2_B3566F804A22C208_UNLOCK_OFFSET UNITYSDK_OFFSET(0x9398DF0)
#define CLASS_2_B3566F804A22C208__CTOR_OFFSET UNITYSDK_OFFSET(0x9398C60)
#define CLASS_2_B3566F804A22C208___IFIXBASEPROXY_LOCK_OFFSET UNITYSDK_OFFSET(0x9398F00)
#define CLASS_2_B3566F804A22C208___IFIXBASEPROXY_UNLOCK_OFFSET UNITYSDK_OFFSET(0x9398F70)

inline static constexpr unsigned int Class_2_B3566F804A22C208_TypeDefinitionIndex = 68981;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_303*>*))((::PBYTE)hIl2Cpp + CLASS_2_B3566F804A22C208__CTOR_OFFSET))(this, a1);
	}
