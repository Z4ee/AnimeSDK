...
#define CLASS_1_F05AF62BF42805D9_CLASS_1_60FD03160B03F7FD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08A440)
...
{
public:
	::RPG::GameCore::GameEntity* OFHDAHHPNPJ; // 0x10
	::System::String* NMELLLLPDPM; // 0x18
	::Class_1_E0103A0EA6CD0F4C* FMJPMFEDIJL; // 0x20
	::RPG::GameCore::GameEntity* IFCOJBEEAKG; // 0x28
	::Class_1_BEFFF38E22C3198D* MKLOJCHCKPN; // 0x30
	::RPG::GameCore::LittleGameLevelConfig* PDKOBKPIBPN; // 0x38
