...
#define CLASS_2_7EB6B93CD50E2F99_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x105E9260)
#define CLASS_2_7EB6B93CD50E2F99_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x105E9350)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_007240750E289BD1_OFFSET UNITYSDK_OFFSET(0x105E4D30)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_01C00AED4805279E_OFFSET UNITYSDK_OFFSET(0x105E5390)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_06A2B758FCB8A24E_OFFSET UNITYSDK_OFFSET(0x105E7290)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_0DB4F8DD36A18D8B_OFFSET UNITYSDK_OFFSET(0x105E7C10)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_18E436D8441F7C1E_OFFSET UNITYSDK_OFFSET(0x105E7400)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_1C5B20CA017A0F3F_OFFSET UNITYSDK_OFFSET(0x105E8AE0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_1E47304E326E432A_OFFSET UNITYSDK_OFFSET(0x105E78B0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_2566AD459572DFC3_OFFSET UNITYSDK_OFFSET(0x105E4900)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_289F28027FF47717_OFFSET UNITYSDK_OFFSET(0x105E71F0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_2ED6963ACD80799F_OFFSET UNITYSDK_OFFSET(0x105E64D0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_352108E309FC2A7D_OFFSET UNITYSDK_OFFSET(0x105E8050)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_3B9C56AB1AF0D588_OFFSET UNITYSDK_OFFSET(0x105E6E90)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_3F4BAFD01734FF87_OFFSET UNITYSDK_OFFSET(0x105E8DE0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_42A121C686C73935_OFFSET UNITYSDK_OFFSET(0x105E75F0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_44CE4196FD08AB6A_OFFSET UNITYSDK_OFFSET(0x105E5B70)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_4C81839CB015BA71_OFFSET UNITYSDK_OFFSET(0x105E5F50)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_543BACA46DC7AC45_OFFSET UNITYSDK_OFFSET(0x105E5C90)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_61A6B9CAB65D860D_OFFSET UNITYSDK_OFFSET(0x105E8170)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_655FE4766AD9A1D7_OFFSET UNITYSDK_OFFSET(0x105E7F30)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_6BCEDD4814D8A8D9_OFFSET UNITYSDK_OFFSET(0x105E4040)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_7DFA4D0453DAD789_OFFSET UNITYSDK_OFFSET(0x105E7DD0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x105E7160)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x105E7FC0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_9F30F370AA7FFDB0_OFFSET UNITYSDK_OFFSET(0x105E90E0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A1596F65A2679075_OFFSET UNITYSDK_OFFSET(0x105E79D0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A2140754BB277C2F_OFFSET UNITYSDK_OFFSET(0x105E7520)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A3C36642AA77866E_OFFSET UNITYSDK_OFFSET(0x105E4EC0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A49BE6E62DF652F7_OFFSET UNITYSDK_OFFSET(0x105E6880)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_A727EDC5A74B3CE3_OFFSET UNITYSDK_OFFSET(0x105E4F60)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_AE30D8621FD9E0AB_OFFSET UNITYSDK_OFFSET(0x105E8A30)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_C6629EC30BC4F082_OFFSET UNITYSDK_OFFSET(0x105E7770)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_CCC6A3002C391211_OFFSET UNITYSDK_OFFSET(0x105E4B60)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_CEEE72CC5B6C543B_OFFSET UNITYSDK_OFFSET(0x105E76A0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_D1367138CEC8E0AD_OFFSET UNITYSDK_OFFSET(0x105E56E0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_D9EF75A2D048B8A1_OFFSET UNITYSDK_OFFSET(0x105E5330)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_E4D422DD274C36BD_OFFSET UNITYSDK_OFFSET(0x105E4FE0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_EDF310B07574DC41_OFFSET UNITYSDK_OFFSET(0x105E8BC0)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_EED2E6C457473DEB_OFFSET UNITYSDK_OFFSET(0x105E8F60)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x105E9190)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_FABFA21254FBB3C1_OFFSET UNITYSDK_OFFSET(0x105E6440)
#define CLASS_2_7EB6B93CD50E2F99_METHOD_2_FCB083D83811A7AD_OFFSET UNITYSDK_OFFSET(0x105E8250)
#define CLASS_2_7EB6B93CD50E2F99__CTOR_OFFSET UNITYSDK_OFFSET(0x105E9420)
#define CLASS_2_7EB6B93CD50E2F99__ONBIND_OFFSET UNITYSDK_OFFSET(0x105E40D0)
#define CLASS_2_7EB6B93CD50E2F99___ONBINDHANDLERS_B__45_1_OFFSET UNITYSDK_OFFSET(0x105E9450)

inline static constexpr unsigned int Class_2_7EB6B93CD50E2F99_TypeDefinitionIndex = 71275;
...
public:
	...
	::RPG::Client::PrefabLoadMeta* EAECFIJKDJD; // 0x60
	::UnityEngine::UI::Text* FMLIEJCGKEF; // 0x68
	::UnityEngine::UI::Image* FAGIGDMBBNO; // 0x70
	::Class_1_3FF51CE8B91EFA1B* CDMFHPLLFEC; // 0x78
	::UnityEngine::Transform* OCJAAFKJCNL; // 0x80
	::UnityEngine::UI::Text* CMAELIBLFJL; // 0x88
	::UnityEngine::UI::ScrollRect* DNGOBOCIMNC; // 0x90
	::UnityEngine::Transform* KJBGPLAICDO; // 0x98
	::RPG::Client::UIStateCtrl* OHIFLMNKEFL; // 0xA0
	::UnityEngine::Transform* KLGICMFOPMB; // 0xA8
	::UnityEngine::UI::Image* NBOMMEHFAEH; // 0xB0
	::UnityEngine::UI::Button* LBLGAJJNBNA; // 0xB8
	::UnityEngine::Transform* DDFHOJOLBDC; // 0xC0
	::RPG::Client::LocalizedText* KMOKEOEFJLC; // 0xC8
	::RPG::Client::NodeListViewPanel_1<::Class_2_B28AAD03E01DF611*>* IPOFLNLHNON; // 0xD0
	::UnityEngine::Transform* BJJKLEGOFGK; // 0xD8
	::RPG::Client::LocalizedText* CDKAPPKLOIH; // 0xE0
	::UnityEngine::RectTransform* HKONEDKHNMM; // 0xE8
	::RPG::GameCore::LevelUIComponent* GEAHNEAGEBG; // 0xF0
	::RPG::Client::NodeListViewPanel_1<::Class_2_A12205C602394C2F*>* CMIPAADGHJM; // 0xF8
	::Class_1_DDDB57AA67C3A9EA* KPFKDKLCFKG; // 0x100
	::UnityEngine::Transform* MDOOJBFDMLC; // 0x108
	::UnityEngine::Transform* AKBPGBIPNLD; // 0x110
	::UnityEngine::Transform* NBDAGMFAJFE; // 0x118
	::UnityEngine::Animation* KCOAILOHDND; // 0x120
	::RPG::Client::MonoInControlButton* JCGCFHICIJN; // 0x128
	::UnityEngine::UI::Text* HEBDBKMCKLD; // 0x130
	::RPG::Client::AnimatorButton* CAAMIPIKAFC; // 0x138
	::UnityEngine::Transform* EIPJKCGEGGE; // 0x140
	::UnityEngine::Transform* PGACKAFNKDP; // 0x148
	::UnityEngine::UI::Text* FKFFDCCCGFE; // 0x150
	::UnityEngine::UI::Text* INHMEPCJJDJ; // 0x158
	::UnityEngine::UI::Button* MFNLPKHODLO; // 0x160
	::Class_2_4BD56C05450EB359* DIPNPLJNKMF; // 0x168
	::UnityEngine::Transform* KDFDODMGEPP; // 0x170
	::UnityEngine::UI::Button* OBDDABIIHBM; // 0x178
	::UnityEngine::Transform* ICAENPPDHIM; // 0x180
	::UnityEngine::Transform* MMKMILCLBNP; // 0x188
	::UnityEngine::Transform* JKFHMICGPKA; // 0x190
	::RPG::Client::LocalizedText* HIHOPIGMGLI; // 0x198
	::UnityEngine::Transform* CFOMPKBJGHE; // 0x1A0
