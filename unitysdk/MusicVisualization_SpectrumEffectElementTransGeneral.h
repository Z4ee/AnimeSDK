...
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTTRANSGENERAL_METHOD_2_22AFE080B0CFE687_OFFSET UNITYSDK_OFFSET(0x186F7DE0)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTTRANSGENERAL_METHOD_2_5819D16E6A1B0364_OFFSET UNITYSDK_OFFSET(0x186F7E90)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTTRANSGENERAL__CTOR_OFFSET UNITYSDK_OFFSET(0x186F8470)

inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementTransGeneral_TypeDefinitionIndex = 45685;
