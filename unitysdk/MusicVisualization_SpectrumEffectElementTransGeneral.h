...
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTTRANSGENERAL_METHOD_2_1AD35FA7458984B8_OFFSET UNITYSDK_OFFSET(0x88BFB70)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTTRANSGENERAL_METHOD_2_C14045483B1EE7A4_OFFSET UNITYSDK_OFFSET(0x88BFAD0)
#define MUSICVISUALIZATION_SPECTRUMEFFECTELEMENTTRANSGENERAL__CTOR_OFFSET UNITYSDK_OFFSET(0x88C00B0)

inline static constexpr unsigned int MusicVisualization_SpectrumEffectElementTransGeneral_TypeDefinitionIndex = 38339;
