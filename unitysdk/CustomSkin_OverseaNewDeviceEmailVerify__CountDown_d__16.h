...
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A89BC40)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A89BE90)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A89BEF0)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A89BEA0)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A89BC30)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x1A89BC20)

inline static constexpr unsigned int CustomSkin_OverseaNewDeviceEmailVerify__CountDown_d__16_TypeDefinitionIndex = 68069;
