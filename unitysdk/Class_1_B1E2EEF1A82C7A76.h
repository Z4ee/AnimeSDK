...
#define CLASS_1_B1E2EEF1A82C7A76_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x1C29CC50)
#define CLASS_1_B1E2EEF1A82C7A76_METHOD_1_3B5ED44E3BCB0FFF_OFFSET UNITYSDK_OFFSET(0x1C29CC40)
#define CLASS_1_B1E2EEF1A82C7A76_METHOD_1_7EADEF08F0D4BEB0_OFFSET UNITYSDK_OFFSET(0x1C29CC30)
#define CLASS_1_B1E2EEF1A82C7A76_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1C29CCB0)
#define CLASS_1_B1E2EEF1A82C7A76__CTOR_OFFSET UNITYSDK_OFFSET(0x1C29CD00)
...
{
public:
	::System::Boolean JBBGPCJHBFE; // 0x10
	::System::Boolean PNONHPKIPAJ; // 0x11
	::RPG::MVector3 KIGGGJGOIGD; // 0x14
	::System::Int32 FLEBLJKCIID; // 0x20
	::RPG::GameCore::CakeRaceMoveState DLNIGFGLPLJ; // 0x24
	::System::Int32 IIMCNHKCEJP; // 0x28
	::RPG::MVector3 GCJMFBKLGHI; // 0x2C
	::System::Int32 CPADMPOLGMC; // 0x38
	::System::UInt32 ELFFJOOPKJJ; // 0x3C
