...
#define AKCALLBACKMANAGER_BANKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E79F550)
#define AKCALLBACKMANAGER_BANKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E79F610)
#define AKCALLBACKMANAGER_BANKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E79F170)
#define AKCALLBACKMANAGER_BANKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E79F150)

inline static constexpr unsigned int AkCallbackManager_BankCallback_TypeDefinitionIndex = 33051;
