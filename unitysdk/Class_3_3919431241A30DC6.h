...
#define CLASS_3_3919431241A30DC6_METHOD_3_88B5F069AE1DF533_OFFSET UNITYSDK_OFFSET(0x1CCB7C40)
#define CLASS_3_3919431241A30DC6_METHOD_3_A811EDB6C0C4A1C7_OFFSET UNITYSDK_OFFSET(0x1CCB7D90)
#define CLASS_3_3919431241A30DC6__CTOR_OFFSET UNITYSDK_OFFSET(0x1CCB7C80)
...
{
public:
	::RPG::GameCore::DynamicFloat* BLJPBPBEKJA; // 0x18
	::RPG::GameCore::DynamicFloat* NCDCCHJIBFO; // 0x20
	::RPG::GameCore::DynamicFloat* IKNEMCOPFIN; // 0x28
	::RPG::GameCore::TargetEvaluator* EKNOCCGMJOF; // 0x30
	::RPG::GameCore::TargetEvaluator* HILNFHCPEAD; // 0x38
	::System::Boolean FFJMDIPNLII; // 0x40
	::System::Boolean HIEKAJADECM; // 0x41
