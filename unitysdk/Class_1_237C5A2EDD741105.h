...
#define CLASS_1_237C5A2EDD741105_ADD_ONDIRTY_OFFSET UNITYSDK_OFFSET(0x1561A730)
#define CLASS_1_237C5A2EDD741105_BINDNODE_OFFSET UNITYSDK_OFFSET(0x1561A8F0)
#define CLASS_1_237C5A2EDD741105_GETSTATE_OFFSET UNITYSDK_OFFSET(0x1561A940)
#define CLASS_1_237C5A2EDD741105_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1561A680)
#define CLASS_1_237C5A2EDD741105_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1561A670)
#define CLASS_1_237C5A2EDD741105_GET_NODE_OFFSET UNITYSDK_OFFSET(0x1561A870)
#define CLASS_1_237C5A2EDD741105_MARKDIRTYSILENT_OFFSET UNITYSDK_OFFSET(0x1561ACF0)
#define CLASS_1_237C5A2EDD741105_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0x1561ABF0)
#define CLASS_1_237C5A2EDD741105_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x1561A6D0)
#define CLASS_1_237C5A2EDD741105_METHOD_1_E5695720AB0F6E98_OFFSET UNITYSDK_OFFSET(0x1561A990)
#define CLASS_1_237C5A2EDD741105_REMOVE_ONDIRTY_OFFSET UNITYSDK_OFFSET(0x1561A7D0)
#define CLASS_1_237C5A2EDD741105_SET_NODE_OFFSET UNITYSDK_OFFSET(0x1561A880)
#define CLASS_1_237C5A2EDD741105_SUBSCRIBEFROM_OFFSET UNITYSDK_OFFSET(0x1561AB10)
#define CLASS_1_237C5A2EDD741105__CTOR_OFFSET UNITYSDK_OFFSET(0x1561A890)

inline static constexpr unsigned int Class_1_237C5A2EDD741105_TypeDefinitionIndex = 78676;

class Class_1_237C5A2EDD741105 : public ::System::Object
{
public:
	::Class_1_6045926B515B7744* DLNIGFGLPLJ; // 0x10
	::System::String* _Key_k__BackingField; // 0x18
	::Class_1_F512C5C8F4EF9039* _Node_k__BackingField; // 0x20
