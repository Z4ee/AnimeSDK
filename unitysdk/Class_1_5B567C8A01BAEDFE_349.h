...
#define CLASS_1_5B567C8A01BAEDFE_349_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C9B75A0)
#define CLASS_1_5B567C8A01BAEDFE_349_CLONE_OFFSET UNITYSDK_OFFSET(0x1C9B7240)
#define CLASS_1_5B567C8A01BAEDFE_349_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C9B73A0)
#define CLASS_1_5B567C8A01BAEDFE_349_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C9B72B0)
#define CLASS_1_5B567C8A01BAEDFE_349_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C9B7500)
#define CLASS_1_5B567C8A01BAEDFE_349_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C9B75F0)
#define CLASS_1_5B567C8A01BAEDFE_349_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C9B75C0)
#define CLASS_1_5B567C8A01BAEDFE_349_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C9B7190)
#define CLASS_1_5B567C8A01BAEDFE_349_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C9B71F0)
#define CLASS_1_5B567C8A01BAEDFE_349_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C9B7530)
#define CLASS_1_5B567C8A01BAEDFE_349_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C9B7590)
#define CLASS_1_5B567C8A01BAEDFE_349__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C9B7640)
#define CLASS_1_5B567C8A01BAEDFE_349__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C9B7210)
#define CLASS_1_5B567C8A01BAEDFE_349__CTOR_OFFSET UNITYSDK_OFFSET(0x1C9B7200)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_349_TypeDefinitionIndex = 33111;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_349*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_349_TypeDefinitionIndex)->GetStaticField(0x18E0);
	}
