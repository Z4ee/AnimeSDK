...
#define CLASS_1_F754EC2F24C8D04D_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CA81A0)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_0869E1192F8E01DF_OFFSET UNITYSDK_OFFSET(0x19CA8650)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_0CADEA47024A0255_OFFSET UNITYSDK_OFFSET(0x19CA82B0)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_19B91D58E02869BC_OFFSET UNITYSDK_OFFSET(0x19CA7E30)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_1F5E0226DAD91587_OFFSET UNITYSDK_OFFSET(0x19CA7D90)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_2D0BCE0D36736E0C_OFFSET UNITYSDK_OFFSET(0x19CA8EC0)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_585E2EA201FDE7ED_OFFSET UNITYSDK_OFFSET(0x19CA8600)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_6D93101E4CE10A96_OFFSET UNITYSDK_OFFSET(0x19CA86C0)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x19CA9110)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_8723A000853037DA_OFFSET UNITYSDK_OFFSET(0x19CA8E20)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x19CA7D30)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_A1F9BFB7EBB25DAC_OFFSET UNITYSDK_OFFSET(0x19CA8310)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_AFDE0DA2DAB302EA_OFFSET UNITYSDK_OFFSET(0x19CA8D00)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_B00A1D822E6F5C31_OFFSET UNITYSDK_OFFSET(0x19CA7FC0)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_DCCF63B007FEBD16_OFFSET UNITYSDK_OFFSET(0x19CA8FE0)
#define CLASS_1_F754EC2F24C8D04D_METHOD_1_ECD1AD675584F751_OFFSET UNITYSDK_OFFSET(0x19CA8C90)
#define CLASS_1_F754EC2F24C8D04D__CTOR_OFFSET UNITYSDK_OFFSET(0x19CA7E20)

inline static constexpr unsigned int Class_1_F754EC2F24C8D04D_TypeDefinitionIndex = 77576;

class Class_1_F754EC2F24C8D04D : public ::System::Object
{
public:
	// static const ::System::Single CPNOGDFKCLM; // 0x0
	// static const ::System::Single IHDNABNIJKC; // 0x0
	// static const ::System::Single EPBPEEHCPHB; // 0x0
	::RPG::Client::LittleGame::CakeRace::CakeRaceSupportIndicatorMonoView* JFNFGOOLJIB; // 0x10
	::RPG::Client::LittleGame::CakeRace::CakeRaceCatMonoView* PKLKICDBPGE; // 0x18
	::Class_3_FA020C2C23A72B3F* PDENFEFCAGN; // 0x20
	::UnityEngine::Transform* ICNPLPKEMGH; // 0x28
	::System::Single EAKCFBOHADC; // 0x30
	::System::Boolean KOFOPBKCHDP; // 0x34
	::System::Single BBNACKEDMCK; // 0x38
	::System::Single PGAAMPLHHBK; // 0x3C
	::System::Single PHCDAPJOFGE; // 0x40
