...
#define CLASS_3_9537C50AD930AF13_DISPOSE_OFFSET UNITYSDK_OFFSET(0xECCAE00)
#define CLASS_3_9537C50AD930AF13_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xECCACE0)
#define CLASS_3_9537C50AD930AF13_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xECCADB0)
#define CLASS_3_9537C50AD930AF13_TICK_OFFSET UNITYSDK_OFFSET(0xECCAD50)
#define CLASS_3_9537C50AD930AF13__CTOR_OFFSET UNITYSDK_OFFSET(0xECCACB0)
#define CLASS_3_9537C50AD930AF13___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0xECCAEA0)
#define CLASS_3_9537C50AD930AF13___IFIXBASEPROXY_TICK_OFFSET UNITYSDK_OFFSET(0xECCAE40)

inline static constexpr unsigned int Class_3_9537C50AD930AF13_TypeDefinitionIndex = 48282;
