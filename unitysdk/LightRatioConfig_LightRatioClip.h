...
#define LIGHTRATIOCONFIG_LIGHTRATIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47BE40)

inline static constexpr unsigned int LightRatioConfig_LightRatioClip_TypeDefinitionIndex = 48022;
