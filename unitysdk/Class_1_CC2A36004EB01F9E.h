...
#define CLASS_1_CC2A36004EB01F9E_GET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xB28E880)
#define CLASS_1_CC2A36004EB01F9E_GET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0xB28E980)
#define CLASS_1_CC2A36004EB01F9E_GET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xB28E900)
#define CLASS_1_CC2A36004EB01F9E_GET_CREATES_OFFSET UNITYSDK_OFFSET(0xB28E8A0)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB28E920)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xB28E960)
#define CLASS_1_CC2A36004EB01F9E_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xB28E840)
#define CLASS_1_CC2A36004EB01F9E_GET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0xB28E9A0)
#define CLASS_1_CC2A36004EB01F9E_GET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB28E940)
#define CLASS_1_CC2A36004EB01F9E_GET_REMOVES_OFFSET UNITYSDK_OFFSET(0xB28E8E0)
#define CLASS_1_CC2A36004EB01F9E_GET_REUSES_OFFSET UNITYSDK_OFFSET(0xB28E8C0)
#define CLASS_1_CC2A36004EB01F9E_GET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xB28E860)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_85C746F74910D9C1_OFFSET UNITYSDK_OFFSET(0xB28EA10)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_D66F211912D83957_OFFSET UNITYSDK_OFFSET(0xB28E9C0)
#define CLASS_1_CC2A36004EB01F9E_SET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xB28E890)
#define CLASS_1_CC2A36004EB01F9E_SET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0xB28E990)
#define CLASS_1_CC2A36004EB01F9E_SET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xB28E910)
#define CLASS_1_CC2A36004EB01F9E_SET_CREATES_OFFSET UNITYSDK_OFFSET(0xB28E8B0)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB28E930)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xB28E970)
#define CLASS_1_CC2A36004EB01F9E_SET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xB28E850)
#define CLASS_1_CC2A36004EB01F9E_SET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0xB28E9B0)
#define CLASS_1_CC2A36004EB01F9E_SET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xB28E950)
#define CLASS_1_CC2A36004EB01F9E_SET_REMOVES_OFFSET UNITYSDK_OFFSET(0xB28E8F0)
#define CLASS_1_CC2A36004EB01F9E_SET_REUSES_OFFSET UNITYSDK_OFFSET(0xB28E8D0)
#define CLASS_1_CC2A36004EB01F9E_SET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xB28E870)
#define CLASS_1_CC2A36004EB01F9E__CTOR_OFFSET UNITYSDK_OFFSET(0xB28EA70)

inline static constexpr unsigned int Class_1_CC2A36004EB01F9E_TypeDefinitionIndex = 72365;

class Class_1_CC2A36004EB01F9E : public ::System::Object
{
public:
	::System::String* _EffectPath_k__BackingField; // 0x10
	::System::Int64 _LifetimeSampleCount_k__BackingField; // 0x18
	::System::Int64 _BlockedByMaxCount_k__BackingField; // 0x20
	::System::Int64 _SyncRequests_k__BackingField; // 0x28
	::System::Int64 _Creates_k__BackingField; // 0x30
	::System::Double _AvgLifetimeMs_k__BackingField; // 0x38
	::System::Int64 _Reuses_k__BackingField; // 0x40
	::System::Int32 _CurrentPoolCachedCount_k__BackingField; // 0x48
	::System::Int32 _CurrentActiveCount_k__BackingField; // 0x4C
	::System::Int64 _Removes_k__BackingField; // 0x50
	::System::Int32 _PeakActiveCount_k__BackingField; // 0x58
