...
#define CLASS_1_CC2A36004EB01F9E_GET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xC528630)
#define CLASS_1_CC2A36004EB01F9E_GET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0xC528730)
#define CLASS_1_CC2A36004EB01F9E_GET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xC5286B0)
#define CLASS_1_CC2A36004EB01F9E_GET_CREATES_OFFSET UNITYSDK_OFFSET(0xC528650)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xC5286D0)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xC528710)
#define CLASS_1_CC2A36004EB01F9E_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xC5285F0)
#define CLASS_1_CC2A36004EB01F9E_GET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0xC528750)
#define CLASS_1_CC2A36004EB01F9E_GET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xC5286F0)
#define CLASS_1_CC2A36004EB01F9E_GET_REMOVES_OFFSET UNITYSDK_OFFSET(0xC528690)
#define CLASS_1_CC2A36004EB01F9E_GET_REUSES_OFFSET UNITYSDK_OFFSET(0xC528670)
#define CLASS_1_CC2A36004EB01F9E_GET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xC528610)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_85C746F74910D9C1_OFFSET UNITYSDK_OFFSET(0xC5287C0)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_D66F211912D83957_OFFSET UNITYSDK_OFFSET(0xC528770)
#define CLASS_1_CC2A36004EB01F9E_SET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xC528640)
#define CLASS_1_CC2A36004EB01F9E_SET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0xC528740)
#define CLASS_1_CC2A36004EB01F9E_SET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0xC5286C0)
#define CLASS_1_CC2A36004EB01F9E_SET_CREATES_OFFSET UNITYSDK_OFFSET(0xC528660)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xC5286E0)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0xC528720)
#define CLASS_1_CC2A36004EB01F9E_SET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0xC528600)
#define CLASS_1_CC2A36004EB01F9E_SET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0xC528760)
#define CLASS_1_CC2A36004EB01F9E_SET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0xC528700)
#define CLASS_1_CC2A36004EB01F9E_SET_REMOVES_OFFSET UNITYSDK_OFFSET(0xC5286A0)
#define CLASS_1_CC2A36004EB01F9E_SET_REUSES_OFFSET UNITYSDK_OFFSET(0xC528680)
#define CLASS_1_CC2A36004EB01F9E_SET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0xC528620)
#define CLASS_1_CC2A36004EB01F9E__CTOR_OFFSET UNITYSDK_OFFSET(0xC528820)

inline static constexpr unsigned int Class_1_CC2A36004EB01F9E_TypeDefinitionIndex = 77375;

class Class_1_CC2A36004EB01F9E : public ::System::Object
{
public:
	::System::String* _EffectPath_k__BackingField; // 0x10
	::System::Int32 _CurrentActiveCount_k__BackingField; // 0x18
	::System::Int32 _PeakActiveCount_k__BackingField; // 0x1C
	::System::Double _AvgLifetimeMs_k__BackingField; // 0x20
	::System::Int64 _LifetimeSampleCount_k__BackingField; // 0x28
	::System::Int64 _Removes_k__BackingField; // 0x30
	::System::Int64 _SyncRequests_k__BackingField; // 0x38
	::System::Int32 _CurrentPoolCachedCount_k__BackingField; // 0x40
	::System::Int64 _BlockedByMaxCount_k__BackingField; // 0x48
	::System::Int64 _Reuses_k__BackingField; // 0x50
	::System::Int64 _Creates_k__BackingField; // 0x58
	::System::Int64 _AsyncRequests_k__BackingField; // 0x60
