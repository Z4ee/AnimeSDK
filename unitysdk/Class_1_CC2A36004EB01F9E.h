...
#define CLASS_1_CC2A36004EB01F9E_GET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x18BD7F40)
#define CLASS_1_CC2A36004EB01F9E_GET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0x18BD8040)
#define CLASS_1_CC2A36004EB01F9E_GET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x18BD7FC0)
#define CLASS_1_CC2A36004EB01F9E_GET_CREATES_OFFSET UNITYSDK_OFFSET(0x18BD7F60)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0x18BD7FE0)
#define CLASS_1_CC2A36004EB01F9E_GET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x18BD8020)
#define CLASS_1_CC2A36004EB01F9E_GET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0x18BD7F00)
#define CLASS_1_CC2A36004EB01F9E_GET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x18BD8060)
#define CLASS_1_CC2A36004EB01F9E_GET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0x18BD8000)
#define CLASS_1_CC2A36004EB01F9E_GET_REMOVES_OFFSET UNITYSDK_OFFSET(0x18BD7FA0)
#define CLASS_1_CC2A36004EB01F9E_GET_REUSES_OFFSET UNITYSDK_OFFSET(0x18BD7F80)
#define CLASS_1_CC2A36004EB01F9E_GET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x18BD7F20)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_85C746F74910D9C1_OFFSET UNITYSDK_OFFSET(0x18BD80D0)
#define CLASS_1_CC2A36004EB01F9E_METHOD_1_D66F211912D83957_OFFSET UNITYSDK_OFFSET(0x18BD8080)
#define CLASS_1_CC2A36004EB01F9E_SET_ASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x18BD7F50)
#define CLASS_1_CC2A36004EB01F9E_SET_AVGLIFETIMEMS_OFFSET UNITYSDK_OFFSET(0x18BD8050)
#define CLASS_1_CC2A36004EB01F9E_SET_BLOCKEDBYMAXCOUNT_OFFSET UNITYSDK_OFFSET(0x18BD7FD0)
#define CLASS_1_CC2A36004EB01F9E_SET_CREATES_OFFSET UNITYSDK_OFFSET(0x18BD7F70)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0x18BD7FF0)
#define CLASS_1_CC2A36004EB01F9E_SET_CURRENTPOOLCACHEDCOUNT_OFFSET UNITYSDK_OFFSET(0x18BD8030)
#define CLASS_1_CC2A36004EB01F9E_SET_EFFECTPATH_OFFSET UNITYSDK_OFFSET(0x18BD7F10)
#define CLASS_1_CC2A36004EB01F9E_SET_LIFETIMESAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x18BD8070)
#define CLASS_1_CC2A36004EB01F9E_SET_PEAKACTIVECOUNT_OFFSET UNITYSDK_OFFSET(0x18BD8010)
#define CLASS_1_CC2A36004EB01F9E_SET_REMOVES_OFFSET UNITYSDK_OFFSET(0x18BD7FB0)
#define CLASS_1_CC2A36004EB01F9E_SET_REUSES_OFFSET UNITYSDK_OFFSET(0x18BD7F90)
#define CLASS_1_CC2A36004EB01F9E_SET_SYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x18BD7F30)
#define CLASS_1_CC2A36004EB01F9E__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD8130)

inline static constexpr unsigned int Class_1_CC2A36004EB01F9E_TypeDefinitionIndex = 73890;
...
public:
	...
	::System::Int32 _CurrentPoolCachedCount_k__BackingField; // 0x24
	::System::Int64 _BlockedByMaxCount_k__BackingField; // 0x28
	::System::Int32 _CurrentActiveCount_k__BackingField; // 0x30
	::System::Double _AvgLifetimeMs_k__BackingField; // 0x38
	::System::Int64 _AsyncRequests_k__BackingField; // 0x40
	::System::Int64 _Creates_k__BackingField; // 0x48
	::System::Int64 _Reuses_k__BackingField; // 0x50
	::System::Int64 _SyncRequests_k__BackingField; // 0x58
