...
#define UNREALTYPES_FSTRUCTVIEW_EQUALS_OFFSET UNITYSDK_OFFSET(0x9DDE30)
#define UNREALTYPES_FSTRUCTVIEW_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x9DDD30)
#define UNREALTYPES_FSTRUCTVIEW_GET_MEMORY_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNREALTYPES_FSTRUCTVIEW_GET_POINTER_OFFSET UNITYSDK_OFFSET(0x246290)
#define UNREALTYPES_FSTRUCTVIEW_GET_SCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define UNREALTYPES_FSTRUCTVIEW_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1D1AFEC0)
#define UNREALTYPES_FSTRUCTVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x9DDD50)

namespace UnrealTypes
{
	inline static constexpr unsigned int FStructView_TypeDefinitionIndex = 27826;
