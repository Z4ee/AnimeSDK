...
#define UNREALTYPES_ENUM_GET_ENUMHANDLE_OFFSET UNITYSDK_OFFSET(0x1E384C60)
#define UNREALTYPES_ENUM_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1E3831F0)
#define UNREALTYPES_ENUM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E384D30)
#define UNREALTYPES_ENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1E383160)

namespace UnrealTypes
{
	inline static constexpr unsigned int Enum_TypeDefinitionIndex = 28310;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Enum_TypeDefinitionIndex)->GetStaticField(0x23F40);
		}
		::System::Type* EnumType; // 0x38
