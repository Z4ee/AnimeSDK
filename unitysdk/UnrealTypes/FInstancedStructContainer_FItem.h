...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_ENDOFFSET_OFFSET UNITYSDK_OFFSET(0x93A9D0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x93A8C0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x93A790)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x293FB0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_FItem_TypeDefinitionIndex = 25301;
