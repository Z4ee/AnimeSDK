...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_ENDOFFSET_OFFSET UNITYSDK_OFFSET(0xA154E0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0xA153D0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0xA152B0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x312BA0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_FItem_TypeDefinitionIndex = 28395;
