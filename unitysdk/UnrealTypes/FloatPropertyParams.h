...
#define UNREALTYPES_FLOATPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD98DC0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FloatPropertyParams_TypeDefinitionIndex = 25252;
