...
#define UNREALTYPES_FLOATPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ABFF0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FloatPropertyParams_TypeDefinitionIndex = 27742;
