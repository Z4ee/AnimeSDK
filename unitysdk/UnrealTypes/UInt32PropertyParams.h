...
#define UNREALTYPES_UINT32PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BE5C0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt32PropertyParams_TypeDefinitionIndex = 27740;
