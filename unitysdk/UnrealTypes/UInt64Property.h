...
#define UNREALTYPES_UINT64PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E396560)
#define UNREALTYPES_UINT64PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E396570)
#define UNREALTYPES_UINT64PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E396590)
#define UNREALTYPES_UINT64PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E396580)
#define UNREALTYPES_UINT64PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E384AF0)
#define UNREALTYPES_UINT64PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E395BB0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt64Property_TypeDefinitionIndex = 28375;
