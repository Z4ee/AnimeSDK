...
#define UNREALTYPES_UINT64PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE5D0)
#define UNREALTYPES_UINT64PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE5E0)
#define UNREALTYPES_UINT64PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1BE600)
#define UNREALTYPES_UINT64PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE5F0)
#define UNREALTYPES_UINT64PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1AE640)
#define UNREALTYPES_UINT64PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BC540)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt64Property_TypeDefinitionIndex = 27772;
