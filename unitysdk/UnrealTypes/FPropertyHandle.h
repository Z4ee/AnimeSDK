...
#define UNREALTYPES_FPROPERTYHANDLE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x93AFA0)
#define UNREALTYPES_FPROPERTYHANDLE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNREALTYPES_FPROPERTYHANDLE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x93AF90)
#define UNREALTYPES_FPROPERTYHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNREALTYPES_FPROPERTYHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x661410)
#define UNREALTYPES_FPROPERTYHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x93AF30)
#define UNREALTYPES_FPROPERTYHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNREALTYPES_FPROPERTYHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x4863A0)
#define UNREALTYPES_FPROPERTYHANDLE_GET_REF_OFFSET UNITYSDK_OFFSET(0x93AEC0)
#define UNREALTYPES_FPROPERTYHANDLE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x93B040)
#define UNREALTYPES_FPROPERTYHANDLE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x93B0A0)
#define UNREALTYPES_FPROPERTYHANDLE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define UNREALTYPES_FPROPERTYHANDLE_RESET_OFFSET UNITYSDK_OFFSET(0x93AFF0)
#define UNREALTYPES_FPROPERTYHANDLE_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYHANDLE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x93AFA0)
#define UNREALTYPES_FPROPERTYHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADA2650)
#define UNREALTYPES_FPROPERTYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x2E85F0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyHandle_TypeDefinitionIndex = 25187;

	struct alignas(4) FPropertyHandle
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyHandle_TypeDefinitionIndex)->GetStaticField(0x1ECD0);
		}
		static ::UnrealTypes::FPropertyHandle* StaticGet_Invalid()
		{
			return (::UnrealTypes::FPropertyHandle*)Il2CppClass::FromTypeDefinitionIndex(FPropertyHandle_TypeDefinitionIndex)->GetStaticField(0x4780);
		}
