...
#define UNREALTYPES_FPROPERTYHANDLE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA15AA0)
#define UNREALTYPES_FPROPERTYHANDLE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNREALTYPES_FPROPERTYHANDLE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA15A90)
#define UNREALTYPES_FPROPERTYHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNREALTYPES_FPROPERTYHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x826600)
#define UNREALTYPES_FPROPERTYHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA15A30)
#define UNREALTYPES_FPROPERTYHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNREALTYPES_FPROPERTYHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x59EE80)
#define UNREALTYPES_FPROPERTYHANDLE_GET_REF_OFFSET UNITYSDK_OFFSET(0xA159C0)
#define UNREALTYPES_FPROPERTYHANDLE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA15B40)
#define UNREALTYPES_FPROPERTYHANDLE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA15BA0)
#define UNREALTYPES_FPROPERTYHANDLE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x325570)
#define UNREALTYPES_FPROPERTYHANDLE_RESET_OFFSET UNITYSDK_OFFSET(0xA15AF0)
#define UNREALTYPES_FPROPERTYHANDLE_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYHANDLE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xA15AA0)
#define UNREALTYPES_FPROPERTYHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E38F170)
#define UNREALTYPES_FPROPERTYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3253A0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyHandle_TypeDefinitionIndex = 28275;

	struct alignas(4) FPropertyHandle
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyHandle_TypeDefinitionIndex)->GetStaticField(0x24070);
		}
		static ::UnrealTypes::FPropertyHandle* StaticGet_Invalid()
		{
			return (::UnrealTypes::FPropertyHandle*)Il2CppClass::FromTypeDefinitionIndex(FPropertyHandle_TypeDefinitionIndex)->GetStaticField(0x77E0);
		}
