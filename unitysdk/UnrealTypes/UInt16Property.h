...
#define UNREALTYPES_UINT16PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE530)
#define UNREALTYPES_UINT16PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE540)
#define UNREALTYPES_UINT16PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1BE560)
#define UNREALTYPES_UINT16PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE550)
#define UNREALTYPES_UINT16PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AE5E0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt16Property_TypeDefinitionIndex = 27770;
