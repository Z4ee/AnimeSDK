...
#define UNREALTYPES_UINT16PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADAAF80)
#define UNREALTYPES_UINT16PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADAAF90)
#define UNREALTYPES_UINT16PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1ADAAFB0)
#define UNREALTYPES_UINT16PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADAAFA0)
#define UNREALTYPES_UINT16PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD9B080)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt16Property_TypeDefinitionIndex = 25280;
