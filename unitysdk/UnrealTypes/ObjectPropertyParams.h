...
#define UNREALTYPES_OBJECTPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AC9A0)

namespace UnrealTypes
{
	inline static constexpr unsigned int ObjectPropertyParams_TypeDefinitionIndex = 27746;
