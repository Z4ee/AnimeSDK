...
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_ADD_OFFSET UNITYSDK_OFFSET(0x93AB00)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x93AC70)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x3B5500)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_CREATE_OFFSET UNITYSDK_OFFSET(0x1ADA19E0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x93AC60)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_EQUALS_OFFSET UNITYSDK_OFFSET(0x93ABA0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GETTYPEHASH_OFFSET UNITYSDK_OFFSET(0x1ADA1800)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x93AB20)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_NUM_OFFSET UNITYSDK_OFFSET(0x3F6FF0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x93AC00)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x93AC80)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x3B5500)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1ADA1910)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYBAGCONTAINERTYPES__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x93AC70)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADA1B30)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyBagContainerTypes_TypeDefinitionIndex = 25308;

	struct alignas(1) FPropertyBagContainerTypes
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyBagContainerTypes_TypeDefinitionIndex)->GetStaticField(0x1EC50);
		}
