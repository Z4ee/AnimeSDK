...
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DDF00)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DDF60)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT_UNREALTYPES_ISTRUCT_UNREALTYPES_PROPERTYBAGMISSINGSTRUCT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_PROPERTYBAGMISSINGSTRUCT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D1B8F80)

namespace UnrealTypes
{
	inline static constexpr unsigned int PropertyBagMissingStruct_TypeDefinitionIndex = 27808;

	struct alignas(1) PropertyBagMissingStruct
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(PropertyBagMissingStruct_TypeDefinitionIndex)->GetStaticField(0x22940);
		}
