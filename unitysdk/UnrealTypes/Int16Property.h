...
#define UNREALTYPES_INT16PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6680)
#define UNREALTYPES_INT16PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6690)
#define UNREALTYPES_INT16PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1B66B0)
#define UNREALTYPES_INT16PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B66A0)
#define UNREALTYPES_INT16PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AE520)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int16Property_TypeDefinitionIndex = 27766;
