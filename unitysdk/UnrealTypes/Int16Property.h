...
#define UNREALTYPES_INT16PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FD10)
#define UNREALTYPES_INT16PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FD20)
#define UNREALTYPES_INT16PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E38FD40)
#define UNREALTYPES_INT16PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FD30)
#define UNREALTYPES_INT16PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3849D0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int16Property_TypeDefinitionIndex = 28369;
