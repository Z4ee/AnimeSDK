...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xA15280)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xA152A0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x325A20)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_Enumerator_TypeDefinitionIndex = 28396;
