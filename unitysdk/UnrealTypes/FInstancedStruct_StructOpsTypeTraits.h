...
#define UNREALTYPES_FINSTANCEDSTRUCT_STRUCTOPSTYPETRAITS_GET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x1E38BC50)
#define UNREALTYPES_FINSTANCEDSTRUCT_STRUCTOPSTYPETRAITS_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1E38BC60)
#define UNREALTYPES_FINSTANCEDSTRUCT_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1E38BC20)
#define UNREALTYPES_FINSTANCEDSTRUCT_STRUCTOPSTYPETRAITS_GET_SHOULDCLONE_OFFSET UNITYSDK_OFFSET(0x1E38BC30)
#define UNREALTYPES_FINSTANCEDSTRUCT_STRUCTOPSTYPETRAITS_GET_SHOULDDISPOSE_OFFSET UNITYSDK_OFFSET(0x1E38BC40)
#define UNREALTYPES_FINSTANCEDSTRUCT_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E38BC00)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStruct_StructOpsTypeTraits_TypeDefinitionIndex = 28391;
