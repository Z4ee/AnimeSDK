...
#define UNREALTYPES_INT16PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B66C0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int16PropertyParams_TypeDefinitionIndex = 27735;
