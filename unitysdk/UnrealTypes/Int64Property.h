...
#define UNREALTYPES_INT64PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6780)
#define UNREALTYPES_INT64PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6790)
#define UNREALTYPES_INT64PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1B67B0)
#define UNREALTYPES_INT64PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B67A0)
#define UNREALTYPES_INT64PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1AE580)
#define UNREALTYPES_INT64PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B6750)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int64Property_TypeDefinitionIndex = 27768;
