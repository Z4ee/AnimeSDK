...
#define UNREALTYPES_INT64PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADA3210)
#define UNREALTYPES_INT64PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADA3220)
#define UNREALTYPES_INT64PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1ADA3240)
#define UNREALTYPES_INT64PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADA3230)
#define UNREALTYPES_INT64PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD9B020)
#define UNREALTYPES_INT64PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA31E0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int64Property_TypeDefinitionIndex = 25278;
