...
#define UNREALTYPES_STRUCTPROPERTY_COPYVALUESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E3953D0)
#define UNREALTYPES_STRUCTPROPERTY_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E395360)
#define UNREALTYPES_STRUCTPROPERTY_GET_STRUCTHANDLE_OFFSET UNITYSDK_OFFSET(0x1E3952C0)
#define UNREALTYPES_STRUCTPROPERTY_LINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E395390)
#define UNREALTYPES_STRUCTPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E384BB0)
#define UNREALTYPES_STRUCTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E395380)

namespace UnrealTypes
{
	inline static constexpr unsigned int StructProperty_TypeDefinitionIndex = 28386;
