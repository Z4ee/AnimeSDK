...
#define UNREALTYPES_STRUCTPROPERTY_COPYVALUESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADA87B0)
#define UNREALTYPES_STRUCTPROPERTY_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1ADA8740)
#define UNREALTYPES_STRUCTPROPERTY_GET_STRUCTHANDLE_OFFSET UNITYSDK_OFFSET(0x1ADA86A0)
#define UNREALTYPES_STRUCTPROPERTY_LINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADA8770)
#define UNREALTYPES_STRUCTPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD9B1A0)
#define UNREALTYPES_STRUCTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA8760)

namespace UnrealTypes
{
	inline static constexpr unsigned int StructProperty_TypeDefinitionIndex = 25293;
