...
#define UNREALTYPES_SCRIPTARRAYHELPER_GETRAWPTR_OFFSET UNITYSDK_OFFSET(0xA15ED0)
#define UNREALTYPES_SCRIPTARRAYHELPER_GET_NUM_OFFSET UNITYSDK_OFFSET(0xA15EC0)
#define UNREALTYPES_SCRIPTARRAYHELPER_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0xA15EA0)
#define UNREALTYPES_SCRIPTARRAYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA15E90)

namespace UnrealTypes
{
	inline static constexpr unsigned int ScriptArrayHelper_TypeDefinitionIndex = 28388;
