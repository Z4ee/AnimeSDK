...
#define UNREALTYPES_SCRIPTARRAYHELPER_GETRAWPTR_OFFSET UNITYSDK_OFFSET(0x9DE000)
#define UNREALTYPES_SCRIPTARRAYHELPER_GET_NUM_OFFSET UNITYSDK_OFFSET(0x9DDFF0)
#define UNREALTYPES_SCRIPTARRAYHELPER_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0x9DDFD0)
#define UNREALTYPES_SCRIPTARRAYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x9DDFC0)

namespace UnrealTypes
{
	inline static constexpr unsigned int ScriptArrayHelper_TypeDefinitionIndex = 27785;
