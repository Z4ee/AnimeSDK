...
#define UNREALTYPES_UINT8PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BAF40)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt8PropertyParams_TypeDefinitionIndex = 27738;
