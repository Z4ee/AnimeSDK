...
#define UNREALTYPES_STRUCTOPSTRAITSBASE_GET_CANMOVE_OFFSET UNITYSDK_OFFSET(0x1E395290)
#define UNREALTYPES_STRUCTOPSTRAITSBASE_GET_CANZEROCREATE_OFFSET UNITYSDK_OFFSET(0x1E3952A0)
#define UNREALTYPES_STRUCTOPSTRAITSBASE_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1E3952B0)
#define UNREALTYPES_STRUCTOPSTRAITSBASE_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1E395260)
#define UNREALTYPES_STRUCTOPSTRAITSBASE_GET_SHOULDCLONE_OFFSET UNITYSDK_OFFSET(0x1E395270)
#define UNREALTYPES_STRUCTOPSTRAITSBASE_GET_SHOULDDISPOSE_OFFSET UNITYSDK_OFFSET(0x1E395280)
#define UNREALTYPES_STRUCTOPSTRAITSBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E381F30)

namespace UnrealTypes
{
	inline static constexpr unsigned int StructOpsTraitsBase_TypeDefinitionIndex = 28304;
