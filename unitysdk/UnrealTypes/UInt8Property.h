...
#define UNREALTYPES_UINT8PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE620)
#define UNREALTYPES_UINT8PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE630)
#define UNREALTYPES_UINT8PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1BE650)
#define UNREALTYPES_UINT8PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE640)
#define UNREALTYPES_UINT8PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1AE5B0)
#define UNREALTYPES_UINT8PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BC4E0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt8Property_TypeDefinitionIndex = 27769;
