...
#define UNREALTYPES_STRUCTUTILSPRIVATE_CALCPROPERTYDESCARRAYHASH_OFFSET UNITYSDK_OFFSET(0x1D1B7AC0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_CALCPROPERTYDESCHASH_OFFSET UNITYSDK_OFFSET(0x1D1BBF80)
#define UNREALTYPES_STRUCTUTILSPRIVATE_CANCASTTO_OFFSET UNITYSDK_OFFSET(0x1D1B5540)
#define UNREALTYPES_STRUCTUTILSPRIVATE_COPYMATCHINGVALUESBYID_1_OFFSET UNITYSDK_OFFSET(0x1D1B00B0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_COPYMATCHINGVALUESBYID_OFFSET UNITYSDK_OFFSET(0x1D1BDC00)
#define UNREALTYPES_STRUCTUTILSPRIVATE_CREATEPROPERTYFROMDESC_OFFSET UNITYSDK_OFFSET(0x1D1B7DE0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETOBJECTHASH_OFFSET UNITYSDK_OFFSET(0x1D1BBD80)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETPROPERTYASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D1BCC80)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETPROPERTYASINT64_OFFSET UNITYSDK_OFFSET(0x1D1BC570)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETPROPERTYASUINT64_OFFSET UNITYSDK_OFFSET(0x1D1BC8E0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_REMOVEPROPERTYBYNAME_OFFSET UNITYSDK_OFFSET(0x1D1B7D10)
#define UNREALTYPES_STRUCTUTILSPRIVATE_SETPROPERTYFROMDOUBLE_OFFSET UNITYSDK_OFFSET(0x1D1BD7A0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_SETPROPERTYFROMINT64_OFFSET UNITYSDK_OFFSET(0x1D1BD060)
#define UNREALTYPES_STRUCTUTILSPRIVATE_SETPROPERTYFROMUINT64_OFFSET UNITYSDK_OFFSET(0x1D1BD3E0)

namespace UnrealTypes
{
	inline static constexpr unsigned int StructUtilsPrivate_TypeDefinitionIndex = 27812;
