...
#define UNREALTYPES_INT32PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FD90)
#define UNREALTYPES_INT32PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FDA0)
#define UNREALTYPES_INT32PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E38FDC0)
#define UNREALTYPES_INT32PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FDB0)
#define UNREALTYPES_INT32PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E384A00)
#define UNREALTYPES_INT32PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E38FD60)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int32Property_TypeDefinitionIndex = 28370;
