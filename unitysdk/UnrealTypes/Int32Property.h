...
#define UNREALTYPES_INT32PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6700)
#define UNREALTYPES_INT32PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6710)
#define UNREALTYPES_INT32PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1B6730)
#define UNREALTYPES_INT32PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B6720)
#define UNREALTYPES_INT32PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1AE550)
#define UNREALTYPES_INT32PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B66D0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int32Property_TypeDefinitionIndex = 27767;
