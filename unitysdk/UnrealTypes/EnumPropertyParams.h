...
#define UNREALTYPES_ENUMPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E385500)

namespace UnrealTypes
{
	inline static constexpr unsigned int EnumPropertyParams_TypeDefinitionIndex = 28352;
