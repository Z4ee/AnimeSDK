...
#define UNREALTYPES_UINT16PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAAFC0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt16PropertyParams_TypeDefinitionIndex = 25249;
