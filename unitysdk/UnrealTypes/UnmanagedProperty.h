...
#define UNREALTYPES_UNMANAGEDPROPERTY_GETPROPERTYVALUEPTRINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1E3967D0)
#define UNREALTYPES_UNMANAGEDPROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E396610)
#define UNREALTYPES_UNMANAGEDPROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E396680)
#define UNREALTYPES_UNMANAGEDPROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E396760)
#define UNREALTYPES_UNMANAGEDPROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E3966F0)
#define UNREALTYPES_UNMANAGEDPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E396600)
#define UNREALTYPES_UNMANAGEDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3965F0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UnmanagedProperty_TypeDefinitionIndex = 28366;
