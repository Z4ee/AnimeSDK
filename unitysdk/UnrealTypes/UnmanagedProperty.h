...
#define UNREALTYPES_UNMANAGEDPROPERTY_GETPROPERTYVALUEPTRINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1D1BE840)
#define UNREALTYPES_UNMANAGEDPROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE680)
#define UNREALTYPES_UNMANAGEDPROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE6F0)
#define UNREALTYPES_UNMANAGEDPROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1BE7D0)
#define UNREALTYPES_UNMANAGEDPROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1BE760)
#define UNREALTYPES_UNMANAGEDPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D1BE670)
#define UNREALTYPES_UNMANAGEDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1BE660)

namespace UnrealTypes
{
	inline static constexpr unsigned int UnmanagedProperty_TypeDefinitionIndex = 27763;
