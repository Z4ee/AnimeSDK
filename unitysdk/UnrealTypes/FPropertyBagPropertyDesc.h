...
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DDA50)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9DDA10)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1D1B55D0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DD9F0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x283610)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DD990)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DDA90)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x9DD970)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISCOMPATIBLETYPE_OFFSET UNITYSDK_OFFSET(0x9DD980)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISFLOATNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x9DD950)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x9DD910)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x9DD960)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISUNSIGNEDNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x9DD930)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9DDA10)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYBAGPROPERTYDESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DDA50)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D1B58A0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyBagPropertyDesc_TypeDefinitionIndex = 27803;

	struct alignas(4) FPropertyBagPropertyDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyBagPropertyDesc_TypeDefinitionIndex)->GetStaticField(0x228E0);
		}
