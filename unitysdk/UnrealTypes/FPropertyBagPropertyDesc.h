...
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x93AE20)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x93ADE0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1ADA2040)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x93ADC0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x93AD60)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x93AE60)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x93AD40)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISCOMPATIBLETYPE_OFFSET UNITYSDK_OFFSET(0x93AD50)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISFLOATNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x93AD20)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x93ACE0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x93AD30)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISUNSIGNEDNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x93AD00)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x93ADE0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYBAGPROPERTYDESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x93AE20)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADA2310)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyBagPropertyDesc_TypeDefinitionIndex = 25312;

	struct alignas(4) FPropertyBagPropertyDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyBagPropertyDesc_TypeDefinitionIndex)->GetStaticField(0x1ECB0);
		}
