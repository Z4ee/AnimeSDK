...
#define UNREALTYPES_INT8PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FE60)
#define UNREALTYPES_INT8PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FE70)
#define UNREALTYPES_INT8PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1E38FE90)
#define UNREALTYPES_INT8PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1E38FE80)
#define UNREALTYPES_INT8PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3849A0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int8Property_TypeDefinitionIndex = 28368;
