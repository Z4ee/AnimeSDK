...
#define UNREALTYPES_INT8PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B67D0)
#define UNREALTYPES_INT8PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B67E0)
#define UNREALTYPES_INT8PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1D1B6800)
#define UNREALTYPES_INT8PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1D1B67F0)
#define UNREALTYPES_INT8PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1AE4F0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int8Property_TypeDefinitionIndex = 27765;
