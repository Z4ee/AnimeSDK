...
#define UNREALTYPES_FGUID_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define UNREALTYPES_FGUID_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define UNREALTYPES_FGUID_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x939AB0)
#define UNREALTYPES_FGUID_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2661E0)
#define UNREALTYPES_FGUID_EQUALS_OFFSET UNITYSDK_OFFSET(0x939A10)
#define UNREALTYPES_FGUID_GETTYPEHASH_OFFSET UNITYSDK_OFFSET(0x1AD9C600)
#define UNREALTYPES_FGUID_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x939970)
#define UNREALTYPES_FGUID_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x939A50)
#define UNREALTYPES_FGUID_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x939AC0)
#define UNREALTYPES_FGUID_HEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1AD9C4F0)
#define UNREALTYPES_FGUID_HEXNUMBER_OFFSET UNITYSDK_OFFSET(0x1AD9C2C0)
#define UNREALTYPES_FGUID_ISHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1AD9C2A0)
#define UNREALTYPES_FGUID_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2E1000)
#define UNREALTYPES_FGUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x1AD9C520)
#define UNREALTYPES_FGUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD9BF50)
#define UNREALTYPES_FGUID_PARSE_OFFSET UNITYSDK_OFFSET(0x1AD9BB30)
#define UNREALTYPES_FGUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x939A40)
#define UNREALTYPES_FGUID_UNREALTYPES_ISTRUCT_UNREALTYPES_FGUID__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2E1100)
#define UNREALTYPES_FGUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD9C770)
#define UNREALTYPES_FGUID__CTOR_OFFSET UNITYSDK_OFFSET(0x939990)

namespace UnrealTypes
{
	inline static constexpr unsigned int FGuid_TypeDefinitionIndex = 25193;

	struct alignas(4) FGuid
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FGuid_TypeDefinitionIndex)->GetStaticField(0x1EBC0);
		}
