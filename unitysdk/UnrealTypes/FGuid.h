...
#define UNREALTYPES_FGUID_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x31EB80)
#define UNREALTYPES_FGUID_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x31EA80)
#define UNREALTYPES_FGUID_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0xA137F0)
#define UNREALTYPES_FGUID_DISPOSE_OFFSET UNITYSDK_OFFSET(0x296F30)
#define UNREALTYPES_FGUID_EQUALS_OFFSET UNITYSDK_OFFSET(0xA14110)
#define UNREALTYPES_FGUID_GETTYPEHASH_OFFSET UNITYSDK_OFFSET(0x1E386060)
#define UNREALTYPES_FGUID_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xA14070)
#define UNREALTYPES_FGUID_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0xA14140)
#define UNREALTYPES_FGUID_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0xA141A0)
#define UNREALTYPES_FGUID_HEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1E385F50)
#define UNREALTYPES_FGUID_HEXNUMBER_OFFSET UNITYSDK_OFFSET(0x1E385D10)
#define UNREALTYPES_FGUID_ISHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1E385CF0)
#define UNREALTYPES_FGUID_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x31EA80)
#define UNREALTYPES_FGUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x1E385F80)
#define UNREALTYPES_FGUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1E3859B0)
#define UNREALTYPES_FGUID_PARSE_OFFSET UNITYSDK_OFFSET(0x1E3855A0)
#define UNREALTYPES_FGUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA14130)
#define UNREALTYPES_FGUID_UNREALTYPES_ISTRUCT_UNREALTYPES_FGUID__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x31EB80)
#define UNREALTYPES_FGUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3861D0)
#define UNREALTYPES_FGUID__CTOR_OFFSET UNITYSDK_OFFSET(0xA14090)

namespace UnrealTypes
{
	inline static constexpr unsigned int FGuid_TypeDefinitionIndex = 28285;

	struct alignas(4) FGuid
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FGuid_TypeDefinitionIndex)->GetStaticField(0x23F60);
		}
