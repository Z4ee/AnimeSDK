...
#define UNREALTYPES_INT8PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1E38FEA0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int8PropertyParams_TypeDefinitionIndex = 28337;
