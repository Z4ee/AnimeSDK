...
#define UNREALTYPES_SCRIPTSTRUCT_CLEARSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1D1B1BB0)
#define UNREALTYPES_SCRIPTSTRUCT_COPYSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1D1B17B0)
#define UNREALTYPES_SCRIPTSTRUCT_DESTROYSTRUCT_OFFSET UNITYSDK_OFFSET(0x1D1B1480)
#define UNREALTYPES_SCRIPTSTRUCT_GET_STRUCTHANDLE_OFFSET UNITYSDK_OFFSET(0x1D1B1760)
#define UNREALTYPES_SCRIPTSTRUCT_INITIALIZESTRUCT_OFFSET UNITYSDK_OFFSET(0x1D1B1FD0)
#define UNREALTYPES_SCRIPTSTRUCT_PREPARECPPSTRUCTOPS_OFFSET UNITYSDK_OFFSET(0x1D1ACEF0)
#define UNREALTYPES_SCRIPTSTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1ACE00)

namespace UnrealTypes
{
	inline static constexpr unsigned int ScriptStruct_TypeDefinitionIndex = 27719;
