...
#define UNREALTYPES_SCRIPTSTRUCT_CLEARSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1AD9E600)
#define UNREALTYPES_SCRIPTSTRUCT_COPYSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1AD9E200)
#define UNREALTYPES_SCRIPTSTRUCT_DESTROYSTRUCT_OFFSET UNITYSDK_OFFSET(0x1AD9DED0)
#define UNREALTYPES_SCRIPTSTRUCT_GET_STRUCTHANDLE_OFFSET UNITYSDK_OFFSET(0x1AD9E1B0)
#define UNREALTYPES_SCRIPTSTRUCT_INITIALIZESTRUCT_OFFSET UNITYSDK_OFFSET(0x1AD9EA20)
#define UNREALTYPES_SCRIPTSTRUCT_PREPARECPPSTRUCTOPS_OFFSET UNITYSDK_OFFSET(0x1AD99A50)
#define UNREALTYPES_SCRIPTSTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD999E0)

namespace UnrealTypes
{
	inline static constexpr unsigned int ScriptStruct_TypeDefinitionIndex = 25229;
