...
#define UNREALTYPES_UINT32PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADAAFD0)
#define UNREALTYPES_UINT32PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADAAFE0)
#define UNREALTYPES_UINT32PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1ADAB000)
#define UNREALTYPES_UINT32PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ADAAFF0)
#define UNREALTYPES_UINT32PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD9B0B0)
#define UNREALTYPES_UINT32PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA8F60)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt32Property_TypeDefinitionIndex = 25281;
