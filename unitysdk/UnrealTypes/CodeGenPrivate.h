...
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTCLASS_OFFSET UNITYSDK_OFFSET(0x1AD9A480)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTENUM_OFFSET UNITYSDK_OFFSET(0x1AD99680)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AD9A410)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1AD9A780)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1AD98230)

namespace UnrealTypes
{
	inline static constexpr unsigned int CodeGenPrivate_TypeDefinitionIndex = 25264;
