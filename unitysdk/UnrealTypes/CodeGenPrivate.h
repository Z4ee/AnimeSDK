...
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTCLASS_OFFSET UNITYSDK_OFFSET(0x1E383DB0)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTENUM_OFFSET UNITYSDK_OFFSET(0x1E382E00)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1E383D40)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E384170)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1E381840)

namespace UnrealTypes
{
	inline static constexpr unsigned int CodeGenPrivate_TypeDefinitionIndex = 28357;
