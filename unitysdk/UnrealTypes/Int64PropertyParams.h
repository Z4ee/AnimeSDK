...
#define UNREALTYPES_INT64PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D1B67C0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int64PropertyParams_TypeDefinitionIndex = 27737;
