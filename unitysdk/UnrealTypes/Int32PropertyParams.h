...
#define UNREALTYPES_INT32PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA31D0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int32PropertyParams_TypeDefinitionIndex = 25246;
