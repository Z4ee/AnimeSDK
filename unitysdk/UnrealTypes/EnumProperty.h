...
#define UNREALTYPES_ENUMPROPERTY_ADDCPPPROPERTY_OFFSET UNITYSDK_OFFSET(0x1E3852F0)
#define UNREALTYPES_ENUMPROPERTY_GETPROPERTYVALUEINCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1E385440)
#define UNREALTYPES_ENUMPROPERTY_GETPROPERTYVALUEINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1E3853E0)
#define UNREALTYPES_ENUMPROPERTY_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1E385190)
#define UNREALTYPES_ENUMPROPERTY_LINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E385390)
#define UNREALTYPES_ENUMPROPERTY_SETENUM_OFFSET UNITYSDK_OFFSET(0x1E3853D0)
#define UNREALTYPES_ENUMPROPERTY_SETPROPERTYVALUEINCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1E3854C0)
#define UNREALTYPES_ENUMPROPERTY_SETPROPERTYVALUEINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1E385480)
#define UNREALTYPES_ENUMPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E384BE0)
#define UNREALTYPES_ENUMPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3851D0)

namespace UnrealTypes
{
	inline static constexpr unsigned int EnumProperty_TypeDefinitionIndex = 28385;
