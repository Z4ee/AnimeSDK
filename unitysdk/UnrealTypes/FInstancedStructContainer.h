...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x9DD1F0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x9DD200)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_APPEND_OFFSET UNITYSDK_OFFSET(0x9DD1E0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ASSIGN_OFFSET UNITYSDK_OFFSET(0x9DD230)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_CLEAR_OFFSET UNITYSDK_OFFSET(0x9DD1A0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DD100)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9DCFF0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9DCFD0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9DD160)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_EQUALS_OFFSET UNITYSDK_OFFSET(0x2C34E0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9DD2D0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GETITEMSTRIDE_OFFSET UNITYSDK_OFFSET(0x1D1B4B10)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GETITEM_OFFSET UNITYSDK_OFFSET(0x9DD280)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2C3430)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9DD290)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9DD2F0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9DD350)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_INSERTAT_OFFSET UNITYSDK_OFFSET(0x9DD1B0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0x9DCFB0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9DD110)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9DD040)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1D1B2B80)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_RESERVEBYTES_OFFSET UNITYSDK_OFFSET(0x9DD260)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_RESET_OFFSET UNITYSDK_OFFSET(0x9DD120)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_SETNUM_OFFSET UNITYSDK_OFFSET(0x9DD270)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_UNREALTYPES_ISTRUCT_UNREALTYPES_FINSTANCEDSTRUCTCONTAINER__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9DD100)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D1B4C20)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x9DCFC0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_TypeDefinitionIndex = 27791;

	struct alignas(8) FInstancedStructContainer
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FInstancedStructContainer_TypeDefinitionIndex)->GetStaticField(0x22850);
		}
		static ::System::Int32* StaticGet_DefaultMinAlignment()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FInstancedStructContainer_TypeDefinitionIndex)->GetStaticField(0x7810);
		}
		static ::System::Int32* StaticGet_ItemStride()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FInstancedStructContainer_TypeDefinitionIndex)->GetStaticField(0x7814);
		}
		static ::System::Int32* StaticGet_ItemAlignment()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FInstancedStructContainer_TypeDefinitionIndex)->GetStaticField(0x7818);
		}
