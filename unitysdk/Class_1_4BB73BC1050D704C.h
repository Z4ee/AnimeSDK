...
#define CLASS_1_4BB73BC1050D704C_METHOD_1_68A2CA32DC720C44_OFFSET UNITYSDK_OFFSET(0x138929A0)
#define CLASS_1_4BB73BC1050D704C_METHOD_1_78037B64B814568E_OFFSET UNITYSDK_OFFSET(0x13892430)
#define CLASS_1_4BB73BC1050D704C_METHOD_1_921C3C3E09D59CD4_OFFSET UNITYSDK_OFFSET(0x13892B90)
#define CLASS_1_4BB73BC1050D704C_METHOD_1_A45A820EF9D1A2A1_OFFSET UNITYSDK_OFFSET(0x13892AD0)
#define CLASS_1_4BB73BC1050D704C__CTOR_OFFSET UNITYSDK_OFFSET(0x138923D0)

inline static constexpr unsigned int Class_1_4BB73BC1050D704C_TypeDefinitionIndex = 71586;

class Class_1_4BB73BC1050D704C : public ::System::Object
{
public:
	::UnityEngine::RectTransform* Field_1_3; // 0x10
	::UnityEngine::UI::VerticalLayoutGroup* Field_1_9; // 0x18
	::UnityEngine::UI::GridLayoutGroup* Field_1_2; // 0x20
	::UnityEngine::RectTransform* Field_1_11; // 0x28
	::UnityEngine::RectTransform* Field_1_1; // 0x30
	::UnityEngine::UI::ContentSizeFitter* Field_1_10; // 0x38
	::UnityEngine::TextAnchor Field_1_5; // 0x40
