...
#define CLASS_2_DEB09B6D92A9CA86_METHOD_2_2F3709D27A34AA00_OFFSET UNITYSDK_OFFSET(0xAA55E00)
#define CLASS_2_DEB09B6D92A9CA86_RECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0xAA56000)
#define CLASS_2_DEB09B6D92A9CA86_RECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0xAA56060)
#define CLASS_2_DEB09B6D92A9CA86__CTOR_OFFSET UNITYSDK_OFFSET(0xAA55C70)

inline static constexpr unsigned int Class_2_DEB09B6D92A9CA86_TypeDefinitionIndex = 70715;

class Class_2_DEB09B6D92A9CA86 : public ::RPG::Client::BaseGameFlowContext
{
public:
	::Class_1_4CFEF021C34E7902* Field_2_0; // 0x20
	::Class_1_93CCFC46DF4C9BD2* Field_2_1; // 0x28
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_651*))((::PBYTE)hIl2Cpp + CLASS_2_DEB09B6D92A9CA86_RECEIVEEVENT_OFFSET))(this, a1);
	}
