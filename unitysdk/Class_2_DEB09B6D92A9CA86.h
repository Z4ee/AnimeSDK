...
#define CLASS_2_DEB09B6D92A9CA86_METHOD_2_2F3709D27A34AA00_OFFSET UNITYSDK_OFFSET(0x16597C40)
#define CLASS_2_DEB09B6D92A9CA86_RECEIVEEVENT_OFFSET UNITYSDK_OFFSET(0x16597E40)
#define CLASS_2_DEB09B6D92A9CA86_RECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0x16597EA0)
#define CLASS_2_DEB09B6D92A9CA86__CTOR_OFFSET UNITYSDK_OFFSET(0x16597AB0)

inline static constexpr unsigned int Class_2_DEB09B6D92A9CA86_TypeDefinitionIndex = 72228;

class Class_2_DEB09B6D92A9CA86 : public ::RPG::Client::BaseGameFlowContext
{
public:
	::Class_1_93CCFC46DF4C9BD2* Field_2_0; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_686*))((::PBYTE)hIl2Cpp + CLASS_2_DEB09B6D92A9CA86_RECEIVEEVENT_OFFSET))(this, a1);
	}
