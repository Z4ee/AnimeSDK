...
#define CLASS_1_196CAEC5A1F2ACEA_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1D9A1AE0)
#define CLASS_1_196CAEC5A1F2ACEA_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1D9A1530)
#define CLASS_1_196CAEC5A1F2ACEA_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1D9A1610)
#define CLASS_1_196CAEC5A1F2ACEA_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1D9A15E0)
#define CLASS_1_196CAEC5A1F2ACEA_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1D9A1810)
#define CLASS_1_196CAEC5A1F2ACEA_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1D9A1C60)
#define CLASS_1_196CAEC5A1F2ACEA_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1D9A1C00)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1D9A15C0)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1D9A1580)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x1D9A15A0)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1D9A14A0)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1D9A15D0)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1D9A1590)
#define CLASS_1_196CAEC5A1F2ACEA_1_METHOD_1_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x1D9A15B0)
#define CLASS_1_196CAEC5A1F2ACEA_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1D9A14D0)
#define CLASS_1_196CAEC5A1F2ACEA_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1D9A1930)
#define CLASS_1_196CAEC5A1F2ACEA_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1D9A1990)
#define CLASS_1_196CAEC5A1F2ACEA_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D9A1E00)
#define CLASS_1_196CAEC5A1F2ACEA_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1D9A14F0)
#define CLASS_1_196CAEC5A1F2ACEA_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1D9A14E0)

inline static constexpr unsigned int Class_1_196CAEC5A1F2ACEA_1_TypeDefinitionIndex = 29992;

class Class_1_196CAEC5A1F2ACEA_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_196CAEC5A1F2ACEA_1*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_196CAEC5A1F2ACEA_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_196CAEC5A1F2ACEA_1_TypeDefinitionIndex)->GetStaticField(0x69E0);
	}
	// static const ::System::Int32 IEAPGPOMBIN = 0xB; // 0x0
	// static const ::System::Int32 BPGLOJPGFEK = 0x9; // 0x0
	// static const ::System::Int32 LOPLGJAHIFF = 0x4; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::UInt32 FLBKCMIIFFP; // 0x18
	::System::Single CECIENHJIOP; // 0x1C
	::System::UInt32 BANPOIIJGMG; // 0x20
