...
#define CLASS_1_D4A7FEECE9D0444E_CLEAR_OFFSET UNITYSDK_OFFSET(0x18C024F0)
#define CLASS_1_D4A7FEECE9D0444E_METHOD_1_FEB018A2DA62A6F7_OFFSET UNITYSDK_OFFSET(0x18C029D0)
#define CLASS_1_D4A7FEECE9D0444E_ONALLOC_OFFSET UNITYSDK_OFFSET(0x18C02420)
#define CLASS_1_D4A7FEECE9D0444E_ONRECYCLE_OFFSET UNITYSDK_OFFSET(0x18C024B0)
#define CLASS_1_D4A7FEECE9D0444E__CTOR_OFFSET UNITYSDK_OFFSET(0x18C02D00)

inline static constexpr unsigned int Class_1_D4A7FEECE9D0444E_TypeDefinitionIndex = 38762;
