...
#define CLASS_2_C89A0039A78300D4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17F8FD70)
#define CLASS_2_C89A0039A78300D4_METHOD_2_DE1C1F4DF5D06882_OFFSET UNITYSDK_OFFSET(0x17F8FE90)
#define CLASS_2_C89A0039A78300D4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17F8FBF0)
#define CLASS_2_C89A0039A78300D4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x17F8FD20)
#define CLASS_2_C89A0039A78300D4_TICK_OFFSET UNITYSDK_OFFSET(0x17F8FE30)
#define CLASS_2_C89A0039A78300D4__CTOR_OFFSET UNITYSDK_OFFSET(0x17F8FBE0)

inline static constexpr unsigned int Class_2_C89A0039A78300D4_TypeDefinitionIndex = 58331;

class Class_2_C89A0039A78300D4 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* EEFMDEHLLFI; // 0x18
	::RPG::GameCore::TaskConfig* IGHAHBNLIJA; // 0x20
