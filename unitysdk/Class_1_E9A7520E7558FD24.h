...
#define CLASS_1_E9A7520E7558FD24_METHOD_1_2874116A6B60363E_OFFSET UNITYSDK_OFFSET(0x155A3C50)
#define CLASS_1_E9A7520E7558FD24_METHOD_1_5061D2A51775D8C6_OFFSET UNITYSDK_OFFSET(0x155A3D50)
#define CLASS_1_E9A7520E7558FD24_METHOD_1_FDDC5A41F149A0CC_OFFSET UNITYSDK_OFFSET(0x155A3C60)
#define CLASS_1_E9A7520E7558FD24__CCTOR_OFFSET UNITYSDK_OFFSET(0x155A3C40)

inline static constexpr unsigned int Class_1_E9A7520E7558FD24_TypeDefinitionIndex = 51721;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::MultiVersionInfo*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E9A7520E7558FD24_TypeDefinitionIndex)->GetStaticField(0x45B00);
	}
	static ::Foundation::MultiVersionDiffConfig** StaticGet_Field_1_0()
	{
		return (::Foundation::MultiVersionDiffConfig**)Il2CppClass::FromTypeDefinitionIndex(Class_1_E9A7520E7558FD24_TypeDefinitionIndex)->GetStaticField(0x45B08);
	}
