...
#define CLASS_2_7D656B7D2636EAEB_173_BINARYLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x1C04C290)
#define CLASS_2_7D656B7D2636EAEB_173_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1C04B8C0)
#define CLASS_2_7D656B7D2636EAEB_173_ISTYPESTRICTLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1C04B980)
#define CLASS_2_7D656B7D2636EAEB_173_JSONDESERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1C04B9D0)
#define CLASS_2_7D656B7D2636EAEB_173__CTOR_OFFSET UNITYSDK_OFFSET(0x1C04C930)

inline static constexpr unsigned int Class_2_7D656B7D2636EAEB_173_TypeDefinitionIndex = 90219;
