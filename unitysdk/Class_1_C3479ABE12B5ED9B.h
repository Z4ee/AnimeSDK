...
#define CLASS_1_C3479ABE12B5ED9B_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0x18CDC0F0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_128774387667156B_1_OFFSET UNITYSDK_OFFSET(0x18CDB920)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_128774387667156B_2_OFFSET UNITYSDK_OFFSET(0x18CDB940)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x18CDB900)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_181A405363C9A19F_OFFSET UNITYSDK_OFFSET(0x18CDC0E0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_2439C7815990B9DD_OFFSET UNITYSDK_OFFSET(0x18CDB960)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_2DF74066DD3D92E2_OFFSET UNITYSDK_OFFSET(0x18CDC120)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_30B19D9DA8C0DCB9_OFFSET UNITYSDK_OFFSET(0x18CDD620)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_591D1D0926CC1684_OFFSET UNITYSDK_OFFSET(0x18CDC3D0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_5DF95F1F69FA3997_OFFSET UNITYSDK_OFFSET(0x18CDD910)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_67B250B744475F12_OFFSET UNITYSDK_OFFSET(0x18CDD7E0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_742794713E14EC25_OFFSET UNITYSDK_OFFSET(0x18CDC4E0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_8CEAB4B365735B82_OFFSET UNITYSDK_OFFSET(0x18CDB8F0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_9216B801ACD0B564_OFFSET UNITYSDK_OFFSET(0x18CDB9C0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_9DD597417197010B_OFFSET UNITYSDK_OFFSET(0x18CDC480)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_AA2D3E889C8A52CA_OFFSET UNITYSDK_OFFSET(0x18CDB880)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_AF2DF7DB76141392_OFFSET UNITYSDK_OFFSET(0x18CDCB20)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_BC62B9FB87FD6A48_OFFSET UNITYSDK_OFFSET(0x18CDB8E0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_CD9FE9B72670C13A_OFFSET UNITYSDK_OFFSET(0x18CDDD10)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_D8A7A5265A7DC1FF_OFFSET UNITYSDK_OFFSET(0x18CDCA30)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_E82B049A4C803AA5_OFFSET UNITYSDK_OFFSET(0x18CDC0C0)
#define CLASS_1_C3479ABE12B5ED9B_METHOD_1_EC48DF3597FAAB18_OFFSET UNITYSDK_OFFSET(0x18CDDDE0)
#define CLASS_1_C3479ABE12B5ED9B__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDDED0)
...
public:
	...
	::System::Collections::Generic::SortedDictionary_2<::RPG::GameCore::RtAbilityProperty, ::RPG::GameCore::FixPoint>* NIEFIMNAHMI; // 0x18
	::System::Collections::Generic::List_1<::RPG::GameCore::ILBattleAvatarPromotionConfigRow*>* DHIGDLPBPLN; // 0x20
	::Class_1_0E0403D2B5AD79E8* JLIKCCBDEGD; // 0x28
	::RPG::GameCore::RtCharacterConfig* PPANINAEOFD; // 0x30
	::Il2CppArray<::RPG::GameCore::JsonEnum*>* NNDOBIMOFEO; // 0x38
	::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_522*>* HNAKNKGOJII; // 0x40
	::RPG::AvatarSystem::IAvatar* BBBMGEAKHEB; // 0x48
	::System::UInt32 IACHHFMCKMC; // 0x50
	::System::UInt32 OAIEBAKJKIG; // 0x54
