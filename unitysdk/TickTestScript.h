...
#define TICKTESTSCRIPT_START_OFFSET UNITYSDK_OFFSET(0x1E353760)
#define TICKTESTSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E353870)

inline static constexpr unsigned int TickTestScript_TypeDefinitionIndex = 66186;
