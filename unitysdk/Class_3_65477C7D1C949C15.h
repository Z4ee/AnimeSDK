...
#define CLASS_3_65477C7D1C949C15_METHOD_3_3337B4DA0CB80D20_OFFSET UNITYSDK_OFFSET(0x1514C710)
#define CLASS_3_65477C7D1C949C15_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1514BCA0)
#define CLASS_3_65477C7D1C949C15__CTOR_OFFSET UNITYSDK_OFFSET(0x1514BC50)
#define CLASS_3_65477C7D1C949C15__ONPAGECANCELCLOSE_OFFSET UNITYSDK_OFFSET(0x1514C8D0)
#define CLASS_3_65477C7D1C949C15__ONPAGECONFIRMCLOSE_OFFSET UNITYSDK_OFFSET(0x1514C7E0)

inline static constexpr unsigned int Class_3_65477C7D1C949C15_TypeDefinitionIndex = 55657;
