...
#define CLASS_1_64D84A24F37C31C2_METHOD_1_D7A14FD69B8367D0_OFFSET UNITYSDK_OFFSET(0x16389D40)
#define CLASS_1_64D84A24F37C31C2__CCTOR_OFFSET UNITYSDK_OFFSET(0x16389F30)
#define CLASS_1_64D84A24F37C31C2__CTOR_OFFSET UNITYSDK_OFFSET(0x16389F20)

inline static constexpr unsigned int Class_1_64D84A24F37C31C2_TypeDefinitionIndex = 76827;

class Class_1_64D84A24F37C31C2 : public ::System::Object
{
public:
	static ::Class_1_64D84A24F37C31C2** StaticGet_FMJPMFEDIJL()
	{
		return (::Class_1_64D84A24F37C31C2**)Il2CppClass::FromTypeDefinitionIndex(Class_1_64D84A24F37C31C2_TypeDefinitionIndex)->GetStaticField(0x29080);
	}
