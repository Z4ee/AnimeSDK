...
#define CLASS_2_3A7E8C13A23D1E83_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F582A0)
#define CLASS_2_3A7E8C13A23D1E83_METHOD_2_F1C870D01294DAF7_OFFSET UNITYSDK_OFFSET(0x8F58460)
#define CLASS_2_3A7E8C13A23D1E83_METHOD_2_F5447CD65612575D_OFFSET UNITYSDK_OFFSET(0x8F580A0)
#define CLASS_2_3A7E8C13A23D1E83_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8F58010)
#define CLASS_2_3A7E8C13A23D1E83_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8F58370)
#define CLASS_2_3A7E8C13A23D1E83_TICK_OFFSET UNITYSDK_OFFSET(0x8F583C0)
#define CLASS_2_3A7E8C13A23D1E83__CTOR_OFFSET UNITYSDK_OFFSET(0x8F58000)

inline static constexpr unsigned int Class_2_3A7E8C13A23D1E83_TypeDefinitionIndex = 53430;

class Class_2_3A7E8C13A23D1E83 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::BackToMainPage* Field_2_0; // 0x18
	::Class_0_16E4307DCC419505_544* Field_2_2; // 0x20
