...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x1274EC40)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_OFFSET UNITYSDK_OFFSET(0x1274EB50)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT32__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x1274EE60)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x1274EDD0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x1274EE50)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt32_TypeDefinitionIndex = 45958;
