...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x10CBB900)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_CASTFROM_OFFSET UNITYSDK_OFFSET(0x10CBB7E0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT32__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x10CBBB50)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x10CBBAC0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT32__CTOR_OFFSET UNITYSDK_OFFSET(0x10CBBB40)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt32_TypeDefinitionIndex = 62173;
