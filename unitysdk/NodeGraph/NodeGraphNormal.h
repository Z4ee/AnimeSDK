...
#define NODEGRAPH_NODEGRAPHNORMAL_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x1195F0B0)
#define NODEGRAPH_NODEGRAPHNORMAL_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1195F250)
#define NODEGRAPH_NODEGRAPHNORMAL_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x1195F0A0)
#define NODEGRAPH_NODEGRAPHNORMAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1195F090)
#define NODEGRAPH_NODEGRAPHNORMAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1195F1C0)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphNormal_TypeDefinitionIndex = 64198;
