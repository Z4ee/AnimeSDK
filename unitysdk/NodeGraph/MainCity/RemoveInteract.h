...
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_GETUID_OFFSET UNITYSDK_OFFSET(0x1195EBB0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x1195EE10)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x1195EA00)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0x1195E850)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x1195EF90)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x1195EFC0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x1195EFF0)
#define NODEGRAPH_MAINCITY_REMOVEINTERACT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x1195F000)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RemoveInteract_TypeDefinitionIndex = 79153;
