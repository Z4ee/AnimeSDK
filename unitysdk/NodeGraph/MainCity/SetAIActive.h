...
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xFFE1A70)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xFFE1E60)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xFFE1C60)
#define NODEGRAPH_MAINCITY_SETAIACTIVE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFFE18C0)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0xFFE1710)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xFFE20D0)
#define NODEGRAPH_MAINCITY_SETAIACTIVE__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0xFFE2100)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xFFE2130)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xFFE21D0)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xFFE2260)
#define NODEGRAPH_MAINCITY_SETAIACTIVE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFFE2300)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetAIActive_TypeDefinitionIndex = 85641;
