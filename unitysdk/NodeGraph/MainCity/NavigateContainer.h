...
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_EQUALS_OFFSET UNITYSDK_OFFSET(0xD4570D0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_CHECKSTANDPOS_OFFSET UNITYSDK_OFFSET(0xD457020)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_CHECKSTANDTIMER_OFFSET UNITYSDK_OFFSET(0xD457000)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_CHECKSTANDTIME_OFFSET UNITYSDK_OFFSET(0xD456FE0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_CURRENTPATHINDEX_OFFSET UNITYSDK_OFFSET(0xD457090)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_MAXWAITIDLETIME_OFFSET UNITYSDK_OFFSET(0xD456FC0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_NAVFLAGS_OFFSET UNITYSDK_OFFSET(0xD455560)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_NAVINTERACTIONPOINT_OFFSET UNITYSDK_OFFSET(0xD456EB0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_NAVPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0xD456EC0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_NEEDDETOUR_OFFSET UNITYSDK_OFFSET(0xD457050)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_NOTURNANIM_OFFSET UNITYSDK_OFFSET(0xD456FA0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_OVERRIDERADIUS_OFFSET UNITYSDK_OFFSET(0xD456E20)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0xD456E60)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_SAVEDMUTEANIMATORMOVEINDEX_OFFSET UNITYSDK_OFFSET(0xD456E70)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_SAVEDSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0xD456E90)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_STEPFINISHED_OFFSET UNITYSDK_OFFSET(0xD4570B0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_TASKRUNNING_OFFSET UNITYSDK_OFFSET(0xD456E40)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_TOTALPATH_OFFSET UNITYSDK_OFFSET(0xD457070)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_USENAVMESH_OFFSET UNITYSDK_OFFSET(0xD456F80)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_HANDLEPLAYERNAVIGATEDONE_OFFSET UNITYSDK_OFFSET(0xD456EE0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_CHECKSTANDPOS_OFFSET UNITYSDK_OFFSET(0xD457040)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_CHECKSTANDTIMER_OFFSET UNITYSDK_OFFSET(0xD457010)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_CHECKSTANDTIME_OFFSET UNITYSDK_OFFSET(0xD456FF0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_CURRENTPATHINDEX_OFFSET UNITYSDK_OFFSET(0xD4570A0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_MAXWAITIDLETIME_OFFSET UNITYSDK_OFFSET(0xD456FD0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_NAVINTERACTIONPOINT_OFFSET UNITYSDK_OFFSET(0xD4554B0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_NAVPATHFOLLOW_OFFSET UNITYSDK_OFFSET(0xD456ED0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_NEEDDETOUR_OFFSET UNITYSDK_OFFSET(0xD457060)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_NOTURNANIM_OFFSET UNITYSDK_OFFSET(0xD456FB0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_OVERRIDERADIUS_OFFSET UNITYSDK_OFFSET(0xD456E30)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_SAVEDMUTEANIMATORMOVEINDEX_OFFSET UNITYSDK_OFFSET(0xD456E80)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_SAVEDSPEEDRATIO_OFFSET UNITYSDK_OFFSET(0xD456EA0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_STEPFINISHED_OFFSET UNITYSDK_OFFSET(0xD4570C0)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_TASKRUNNING_OFFSET UNITYSDK_OFFSET(0xD456E50)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_TOTALPATH_OFFSET UNITYSDK_OFFSET(0xD457080)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_USENAVMESH_OFFSET UNITYSDK_OFFSET(0xD456F90)
#define NODEGRAPH_MAINCITY_NAVIGATECONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xD452390)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int NavigateContainer_TypeDefinitionIndex = 49847;

	class NavigateContainer : public ::System::Object
	{
	public:
		::System::Action_2<::MoleMole::Battle::Entity*, ::System::Boolean>* HandlePlayerNavigateDoneAction; // 0x10
		::MoleMole::Battle::Entity* ownerEntity; // 0x18
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_281*>* _TotalPath_k__BackingField; // 0x20
		::Class_1_9DF8A96088853ABF* navPathFollow; // 0x28
		::NodeGraph::MainCity::SimpleInteractionPoint* navInteractionPoint; // 0x30
		::System::Single _OverrideRadius_k__BackingField; // 0x38
		::UnityEngine::Vector2 _SavedSpeedRatio_k__BackingField; // 0x3C
		::Enum_3_4C7CE452CFA7A879 navFlags; // 0x44
		::System::Single _CheckStandTime_k__BackingField; // 0x48
		::System::Boolean _UseNavMesh_k__BackingField; // 0x4C
		::System::Boolean _StepFinished_k__BackingField; // 0x4D
		::System::Boolean _NoTurnAnim_k__BackingField; // 0x4E
		::System::Boolean _NeedDetour_k__BackingField; // 0x4F
		::System::Boolean _TaskRunning_k__BackingField; // 0x50
		::System::Int32 savedMuteAnimatorMoveIndex; // 0x54
		::System::Single _CheckStandTimer_k__BackingField; // 0x58
		::UnityEngine::Vector3 _CheckStandPos_k__BackingField; // 0x5C
		::System::Single _MaxWaitIdleTime_k__BackingField; // 0x68
		...
		{
			return ((::Class_0_16E4307DCC419505_281*(*)(::PVOID))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_NAVINTERACTIONPOINT_OFFSET))(this);
		}

		::System::Void set_NavInteractionPoint(::Class_0_16E4307DCC419505_281* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_281*))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_NAVINTERACTIONPOINT_OFFSET))(this, value);
		}
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_281*>* get_TotalPath()
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_281*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_NAVIGATECONTAINER_GET_TOTALPATH_OFFSET))(this);
		}

		::System::Void set_TotalPath(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_281*>* value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_281*>*))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_NAVIGATECONTAINER_SET_TOTALPATH_OFFSET))(this, value);
		}
