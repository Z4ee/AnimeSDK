...
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x142BB8B0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x142BBA80)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x142BB780)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x142BB5D0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x142BBC60)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x142BBC90)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x142BBCE0)
#define NODEGRAPH_MAINCITY_WAITAIACTIVE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x142BBD40)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAIActive_TypeDefinitionIndex = 89354;
