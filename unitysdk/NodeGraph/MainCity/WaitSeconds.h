...
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD95A730)
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xD95A780)
#define NODEGRAPH_MAINCITY_WAITSECONDS_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD95A580)
#define NODEGRAPH_MAINCITY_WAITSECONDS__CTOR_OFFSET UNITYSDK_OFFSET(0xD95A4B0)
#define NODEGRAPH_MAINCITY_WAITSECONDS__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0xD95A990)
#define NODEGRAPH_MAINCITY_WAITSECONDS__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0xD95A9C0)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD95A9F0)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xD95AA90)
#define NODEGRAPH_MAINCITY_WAITSECONDS___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD95AB30)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitSeconds_TypeDefinitionIndex = 40315;
