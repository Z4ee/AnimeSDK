...
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x1071C140)
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x1071BF20)
#define NODEGRAPH_MAINCITY_ADDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1071BD70)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x1071C480)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x1071C4B0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x1071C4E0)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x1071C510)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x1071C5B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddEffect_TypeDefinitionIndex = 42590;
