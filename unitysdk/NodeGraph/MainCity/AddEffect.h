...
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x142B6E50)
#define NODEGRAPH_MAINCITY_ADDEFFECT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x142B6C30)
#define NODEGRAPH_MAINCITY_ADDEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x142B6A80)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x142B7190)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x142B71C0)
#define NODEGRAPH_MAINCITY_ADDEFFECT__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x142B71F0)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x142B7220)
#define NODEGRAPH_MAINCITY_ADDEFFECT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x142B72C0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddEffect_TypeDefinitionIndex = 70785;
