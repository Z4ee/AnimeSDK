...
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETGALCONFIG_OFFSET UNITYSDK_OFFSET(0x109334C0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETPERFORMCHATSTORYNODELIST_OFFSET UNITYSDK_OFFSET(0x10933C30)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10933150)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10933020)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x10932EC0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x10934160)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10934190)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x109341A0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int GetBubbleTime_TypeDefinitionIndex = 71521;
