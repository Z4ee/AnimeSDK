...
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETGALCONFIG_OFFSET UNITYSDK_OFFSET(0xE041910)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_GETPERFORMCHATSTORYNODELIST_OFFSET UNITYSDK_OFFSET(0xE042070)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xE0415A0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xE041470)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__CTOR_OFFSET UNITYSDK_OFFSET(0xE041310)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xE0425A0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xE0425D0)
#define NODEGRAPH_MAINCITY_GETBUBBLETIME___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xE0425E0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int GetBubbleTime_TypeDefinitionIndex = 70242;
