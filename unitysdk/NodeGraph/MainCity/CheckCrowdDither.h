...
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x177EA650)
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x177EA560)
#define NODEGRAPH_MAINCITY_CHECKCROWDDITHER___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x177EABA0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckCrowdDither_TypeDefinitionIndex = 56590;
