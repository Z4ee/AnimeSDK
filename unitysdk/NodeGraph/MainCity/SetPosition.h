...
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x12D45E70)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x12D46770)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x12D45C50)
#define NODEGRAPH_MAINCITY_SETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x12D45AA0)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x12D46880)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x12D468B0)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0x12D468E0)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x12D46910)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x12D469B0)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x12D46A50)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetPosition_TypeDefinitionIndex = 72700;

	class SetPosition : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::String* npcTransform; // 0x58
		::System::Boolean isLocalAvatar; // 0x60
		::System::Boolean waitFrame; // 0x61
