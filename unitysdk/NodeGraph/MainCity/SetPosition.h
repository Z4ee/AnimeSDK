...
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xFFE2760)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xFFE3060)
#define NODEGRAPH_MAINCITY_SETPOSITION_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFFE2540)
#define NODEGRAPH_MAINCITY_SETPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xFFE2390)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0xFFE3170)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0xFFE31A0)
#define NODEGRAPH_MAINCITY_SETPOSITION__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0xFFE31D0)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xFFE3200)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xFFE32A0)
#define NODEGRAPH_MAINCITY_SETPOSITION___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFFE3340)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetPosition_TypeDefinitionIndex = 63765;

	class SetPosition : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::String* npcTransform; // 0x58
		::System::Boolean waitFrame; // 0x60
		::System::Boolean isLocalAvatar; // 0x61
