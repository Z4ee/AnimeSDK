...
#define NODEGRAPH_MAINCITY_TRIGGER_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x177EABE0)
#define NODEGRAPH_MAINCITY_TRIGGER_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x177EC9F0)
#define NODEGRAPH_MAINCITY_TRIGGER_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x177ECCF0)
#define NODEGRAPH_MAINCITY_TRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x177EC670)
#define NODEGRAPH_MAINCITY_TRIGGER_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x177ED300)
#define NODEGRAPH_MAINCITY_TRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x177EA570)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_0_OFFSET UNITYSDK_OFFSET(0x177ED340)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_1_OFFSET UNITYSDK_OFFSET(0x177ED370)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_2_OFFSET UNITYSDK_OFFSET(0x177ED3A0)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_3_OFFSET UNITYSDK_OFFSET(0x177ED3E0)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_4_OFFSET UNITYSDK_OFFSET(0x177ED410)
#define NODEGRAPH_MAINCITY_TRIGGER__ONREGISTERPARAM_B__13_5_OFFSET UNITYSDK_OFFSET(0x177ED440)
#define NODEGRAPH_MAINCITY_TRIGGER___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x177ED470)
#define NODEGRAPH_MAINCITY_TRIGGER___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x177ED560)
#define NODEGRAPH_MAINCITY_TRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x177ED510)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int Trigger_TypeDefinitionIndex = 89074;
	...
	public:
		...
		::System::Int32 repeatCount; // 0x68
		::System::Single _cdTimer; // 0x6C
		::System::Single _triggerTimer; // 0x70
		::System::Single triggerDelta; // 0x74
		::System::Single conditionDuration; // 0x78
		::System::Int32 _triggerLocalCount; // 0x7C
		::System::Boolean InGroup; // 0x80
		::System::Boolean invert; // 0x81
		::System::Boolean saveToSpecial; // 0x82
		::System::Boolean CheckResultByGroup; // 0x83
