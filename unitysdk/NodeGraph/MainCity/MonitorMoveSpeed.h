...
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONANIMATORSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xF6205C0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONLOCALAVATARANIMATORSTATECHANGED_OFFSET UNITYSDK_OFFSET(0xF61FF60)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF61F9C0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xF620B10)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xF620B80)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF61F890)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED__CTOR_OFFSET UNITYSDK_OFFSET(0xF61F6E0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xF620BF0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF620C20)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xF620C30)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xF620CC0)
#define NODEGRAPH_MAINCITY_MONITORMOVESPEED___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF620D50)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int MonitorMoveSpeed_TypeDefinitionIndex = 79130;
