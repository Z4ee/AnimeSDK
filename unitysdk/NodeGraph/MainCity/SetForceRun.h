...
#define NODEGRAPH_MAINCITY_SETFORCERUN_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10A13F60)
#define NODEGRAPH_MAINCITY_SETFORCERUN_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10A13D40)
#define NODEGRAPH_MAINCITY_SETFORCERUN__CTOR_OFFSET UNITYSDK_OFFSET(0x10A13B90)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x10A14310)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x10A14340)
#define NODEGRAPH_MAINCITY_SETFORCERUN__ONREGISTERPARAM_B__4_2_OFFSET UNITYSDK_OFFSET(0x10A14370)
#define NODEGRAPH_MAINCITY_SETFORCERUN___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10A143A0)
#define NODEGRAPH_MAINCITY_SETFORCERUN___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10A143B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetForceRun_TypeDefinitionIndex = 54585;
