...
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10A13020)
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10A12EF0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x10A12D40)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x10A130F0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10A13120)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10A13130)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ResetTrigger_TypeDefinitionIndex = 47435;
