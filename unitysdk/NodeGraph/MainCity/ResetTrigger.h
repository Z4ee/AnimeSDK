...
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF4FD9A0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF4FD870)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xF4FD6C0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xF4FDA70)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF4FDAA0)
#define NODEGRAPH_MAINCITY_RESETTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF4FDAB0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ResetTrigger_TypeDefinitionIndex = 82997;
