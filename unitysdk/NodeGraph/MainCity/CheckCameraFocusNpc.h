...
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xD959A60)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD959890)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD959620)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xD959610)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0xD95A340)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0xD95A370)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_2_OFFSET UNITYSDK_OFFSET(0xD95A3A0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_3_OFFSET UNITYSDK_OFFSET(0xD95A3D0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xD95A400)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD95A490)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD95A4A0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckCameraFocusNpc_TypeDefinitionIndex = 59721;

	class CheckCameraFocusNpc : public ::NodeGraph::MainCity::Trigger
	{
	public:
		::MoleMole::Battle::Entity* _npc; // 0x88
		::System::Single checkAngle; // 0x90
		::System::Single checknpcFowardAngle; // 0x94
		::System::Int32 focusNpcTag; // 0x98
