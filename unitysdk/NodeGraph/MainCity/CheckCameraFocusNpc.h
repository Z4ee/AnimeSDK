...
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xBDFC280)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xBDFC0A0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xBDFBE30)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xBDFBE20)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0xBDFCB60)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0xBDFCB90)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_2_OFFSET UNITYSDK_OFFSET(0xBDFCBC0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC__ONREGISTERPARAM_B__6_3_OFFSET UNITYSDK_OFFSET(0xBDFCBF0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xBDFCC20)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xBDFCCB0)
#define NODEGRAPH_MAINCITY_CHECKCAMERAFOCUSNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xBDFCCC0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckCameraFocusNpc_TypeDefinitionIndex = 60278;
