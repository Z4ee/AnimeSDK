...
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xD4693C0)
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD469290)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD4690E0)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xD469630)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xD469660)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD469700)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int StopTrigger_TypeDefinitionIndex = 80214;
