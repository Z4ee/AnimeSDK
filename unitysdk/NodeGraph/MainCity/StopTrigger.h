...
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x107206B0)
#define NODEGRAPH_MAINCITY_STOPTRIGGER_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10720580)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x107203D0)
#define NODEGRAPH_MAINCITY_STOPTRIGGER__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x10720920)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10720950)
#define NODEGRAPH_MAINCITY_STOPTRIGGER___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x107209F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int StopTrigger_TypeDefinitionIndex = 66107;
