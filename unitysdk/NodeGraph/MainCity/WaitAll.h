...
#define NODEGRAPH_MAINCITY_WAITALL_CLEARDIC_OFFSET UNITYSDK_OFFSET(0xFB63B70)
#define NODEGRAPH_MAINCITY_WAITALL_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0xFB63910)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xFB638C0)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xFB63F10)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xFB63F80)
#define NODEGRAPH_MAINCITY_WAITALL_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFB63790)
#define NODEGRAPH_MAINCITY_WAITALL__CTOR_OFFSET UNITYSDK_OFFSET(0xFB63740)
#define NODEGRAPH_MAINCITY_WAITALL__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xFB63FF0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0xFB643F0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xFB64480)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xFB64520)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xFB645B0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFB64640)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAll_TypeDefinitionIndex = 39368;
