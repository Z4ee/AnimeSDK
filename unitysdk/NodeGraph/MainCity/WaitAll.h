...
#define NODEGRAPH_MAINCITY_WAITALL_CLEARDIC_OFFSET UNITYSDK_OFFSET(0xEBE8430)
#define NODEGRAPH_MAINCITY_WAITALL_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0xEBE81E0)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xEBE8190)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xEBE87D0)
#define NODEGRAPH_MAINCITY_WAITALL_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xEBE8840)
#define NODEGRAPH_MAINCITY_WAITALL_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xEBE8060)
#define NODEGRAPH_MAINCITY_WAITALL__CTOR_OFFSET UNITYSDK_OFFSET(0xEBE8010)
#define NODEGRAPH_MAINCITY_WAITALL__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xEBE88B0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0xEBE8CB0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xEBE8D40)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xEBE8DE0)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xEBE8E70)
#define NODEGRAPH_MAINCITY_WAITALL___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xEBE8F00)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitAll_TypeDefinitionIndex = 87394;

	class WaitAll : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Collections::Generic::Dictionary_2<::NodeGraph::GraphInputPort*, ::System::Boolean>* _inputPorts; // 0x58
		::NodeGraph::GraphOutputPort* _onAllFinish; // 0x60
