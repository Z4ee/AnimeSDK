...
#define NODEGRAPH_MAINCITY_SPLIT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x102D1100)
#define NODEGRAPH_MAINCITY_SPLIT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x102D0FD0)
#define NODEGRAPH_MAINCITY_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0x102D0F00)
#define NODEGRAPH_MAINCITY_SPLIT__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x102D1280)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x102D1640)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x102D1650)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 43000;
