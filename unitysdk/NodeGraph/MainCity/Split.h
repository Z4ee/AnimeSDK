...
#define NODEGRAPH_MAINCITY_SPLIT_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xE590190)
#define NODEGRAPH_MAINCITY_SPLIT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xE590060)
#define NODEGRAPH_MAINCITY_SPLIT__CTOR_OFFSET UNITYSDK_OFFSET(0xE58FF90)
#define NODEGRAPH_MAINCITY_SPLIT__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xE590310)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xE5906D0)
#define NODEGRAPH_MAINCITY_SPLIT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xE5906E0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int Split_TypeDefinitionIndex = 70388;
