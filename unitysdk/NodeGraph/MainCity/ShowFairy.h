...
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ADDIK_OFFSET UNITYSDK_OFFSET(0xCE7C8E0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_CLOSEIK_OFFSET UNITYSDK_OFFSET(0xCE7C710)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONFAIRYDESTROYHANDLE_OFFSET UNITYSDK_OFFSET(0xCE7CAC0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONFAIRYFADEOUTHANDLE_OFFSET UNITYSDK_OFFSET(0xCE7D3A0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xCE7BA90)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xCE7D760)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xCE7CF80)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xCE7B780)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_REALSTART_OFFSET UNITYSDK_OFFSET(0xCE7BE70)
#define NODEGRAPH_MAINCITY_SHOWFAIRY_SHOWSINGLEFAIRY_OFFSET UNITYSDK_OFFSET(0xCE7C3C0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCE7B6B0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_0_OFFSET UNITYSDK_OFFSET(0xCE7DC40)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_1_OFFSET UNITYSDK_OFFSET(0xCE7E4B0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_2_OFFSET UNITYSDK_OFFSET(0xCE7E970)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_3_OFFSET UNITYSDK_OFFSET(0xCE7E9A0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__ONREGISTERPARAM_B__16_4_OFFSET UNITYSDK_OFFSET(0xCE7E9D0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__SHOWSINGLEFAIRY_B__19_0_OFFSET UNITYSDK_OFFSET(0xCE7EB40)
#define NODEGRAPH_MAINCITY_SHOWFAIRY__SHOWSINGLEFAIRY_B__19_1_OFFSET UNITYSDK_OFFSET(0xCE7EA00)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xCE7ECA0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xCE7ED40)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xCE7EDD0)
#define NODEGRAPH_MAINCITY_SHOWFAIRY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xCE7EE70)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ShowFairy_TypeDefinitionIndex = 82899;

	class ShowFairy : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* _currentIdList; // 0x58
		::NodeGraph::GraphInputValuePort* _fairyIdListPort; // 0x60
		::System::Collections::Generic::List_1<::System::Int32>* ikFairyList; // 0x68
		::NodeGraph::GraphOutputPort* _onFairyEnd; // 0x70
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::System::Int32>*>* fairyIdList; // 0x78
		::System::Action* _callback; // 0x80
		::System::Int32 ikNpcTag; // 0x88
		::System::Boolean useFairy; // 0x8C
		::System::Boolean inPhotoPage; // 0x8D
		::System::Boolean pushedIk; // 0x8E
		::System::Boolean _started; // 0x8F
		::System::Single _timer; // 0x90
		::System::Int32 _currentIndex; // 0x94
		::System::Boolean _fairyFinish; // 0x98
		::System::Boolean _fairyFadeOut; // 0x99
