...
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x13A0BB70)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x13A0B8C0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x13A0B5B0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x13A0B430)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x13A0B420)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x13A0BED0)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0x13A0BF00)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x13A0BF30)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x13A0BF60)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x13A0BF90)
#define NODEGRAPH_MAINCITY_ROTATETOLOCALAVATAR___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x13A0BFA0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RotateToLocalAvatar_TypeDefinitionIndex = 61144;

	class RotateToLocalAvatar : public ::NodeGraph::MainCity::MoveTo
	{
	public:
		::System::Single minDis; // 0xC0
		::System::Boolean invert; // 0xC4
