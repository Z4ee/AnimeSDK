...
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x102CB0A0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x102CBA40)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x102CB5F0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONPERFORMCALLBACK_OFFSET UNITYSDK_OFFSET(0x102CB650)
#define NODEGRAPH_MAINCITY_PERFORMCHAT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x102CAD90)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__CTOR_OFFSET UNITYSDK_OFFSET(0x102CAC30)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_0_OFFSET UNITYSDK_OFFSET(0x102CC180)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_1_OFFSET UNITYSDK_OFFSET(0x102CC330)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_0_OFFSET UNITYSDK_OFFSET(0x102CBD00)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_1_OFFSET UNITYSDK_OFFSET(0x102CBD30)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_2_OFFSET UNITYSDK_OFFSET(0x102CBD60)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_3_OFFSET UNITYSDK_OFFSET(0x102CC120)
#define NODEGRAPH_MAINCITY_PERFORMCHAT__ONREGISTERPARAM_B__8_4_OFFSET UNITYSDK_OFFSET(0x102CC150)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x102CC4A0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x102CC540)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x102CC5D0)
#define NODEGRAPH_MAINCITY_PERFORMCHAT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x102CC670)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int PerformChat_TypeDefinitionIndex = 81120;

	class PerformChat : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Collections::Generic::List_1<::System::String*>* outResultKey; // 0x58
		::NodeGraph::GraphOutputValuePort* _specialOutput; // 0x60
		::System::Int32 targetNpcTag; // 0x68
		::System::Boolean waitTransitionFadeOut; // 0x6C
		::System::Boolean _end; // 0x6D
		...
		::System::Void _OnNodeActiveWithState_b__9_0(::Class_1_7D59F735ACB38970_Enum_3_6E0E8267CDDC65CF reason)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_7D59F735ACB38970_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_PERFORMCHAT__ONNODEACTIVEWITHSTATE_B__9_0_OFFSET))(this, reason);
		}
