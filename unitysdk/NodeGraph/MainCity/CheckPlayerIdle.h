...
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x17FB9660)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ISMATCHIDLESTANDBYCONDITION_OFFSET UNITYSDK_OFFSET(0x17FB9D50)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x17FB9530)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x17FB9430)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FB9420)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x17FB9F30)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x17FB9F60)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x17FB9FF0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x17FBA000)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPlayerIdle_TypeDefinitionIndex = 89875;
