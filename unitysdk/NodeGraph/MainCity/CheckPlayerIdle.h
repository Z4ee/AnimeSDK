...
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x17FACA80)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ISMATCHIDLESTANDBYCONDITION_OFFSET UNITYSDK_OFFSET(0x17FAD170)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x17FAC950)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x17FAC850)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17FAC840)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x17FAD350)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x17FAD380)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x17FAD410)
#define NODEGRAPH_MAINCITY_CHECKPLAYERIDLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x17FAD420)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPlayerIdle_TypeDefinitionIndex = 70215;
