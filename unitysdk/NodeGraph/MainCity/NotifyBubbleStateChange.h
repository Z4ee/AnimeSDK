...
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xE961900)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xE961BE0)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xE961750)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE9615A0)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xE961DF0)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE__ONREGISTERPARAM_B__3_1_OFFSET UNITYSDK_OFFSET(0xE961E20)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xE961E50)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xE961E60)
#define NODEGRAPH_MAINCITY_NOTIFYBUBBLESTATECHANGE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xE961EF0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int NotifyBubbleStateChange_TypeDefinitionIndex = 42031;

	class NotifyBubbleStateChange : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Int32 checkSpecialNodeId; // 0x58
