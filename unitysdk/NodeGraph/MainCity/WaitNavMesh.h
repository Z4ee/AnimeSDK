...
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD46A3E0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xD46A470)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD46A230)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xD46A0B0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0xD46A980)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0xD46A9B0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD46A9E0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xD46AA30)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xD46AA90)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitNavMesh_TypeDefinitionIndex = 77582;

	class WaitNavMesh : public ::NodeGraph::GraphNodeBase
	{
	public:
		::Il2CppArray<::UnityEngine::Vector3>* navMeshPathCorners; // 0x58
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* cachedDataPath; // 0x60
