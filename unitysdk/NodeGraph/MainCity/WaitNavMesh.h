...
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x107216D0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x10721760)
#define NODEGRAPH_MAINCITY_WAITNAVMESH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10721520)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x107213A0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0x10721C70)
#define NODEGRAPH_MAINCITY_WAITNAVMESH__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0x10721CA0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x10721CD0)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x10721D20)
#define NODEGRAPH_MAINCITY_WAITNAVMESH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10721D80)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int WaitNavMesh_TypeDefinitionIndex = 64898;
	...
	public:
		...
		::System::Single _timer; // 0x6C
		::System::Int32 npcTag; // 0x70
