...
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xF4FDF10)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xF4FE130)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF4FDCF0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0xF4FDB40)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONNODEACTIVEWITHSTATE_B__7_0_OFFSET UNITYSDK_OFFSET(0xF4FE330)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0xF4FE2A0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0xF4FE2D0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_2_OFFSET UNITYSDK_OFFSET(0xF4FE300)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xF4FE340)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xF4FE3E0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF4FE480)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetBlackCurtain_TypeDefinitionIndex = 76098;
	...
	public:
		...
		::System::Void _OnNodeActiveWithState_b__7_0(::Class_1_FC3A9C07FC781527_Enum_3_6E0E8267CDDC65CF reason)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_FC3A9C07FC781527_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONNODEACTIVEWITHSTATE_B__7_0_OFFSET))(this, reason);
		}
