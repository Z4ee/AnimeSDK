...
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x157CD150)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x157CD370)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x157CCF30)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x157CCD80)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONNODEACTIVEWITHSTATE_B__7_0_OFFSET UNITYSDK_OFFSET(0x157CD570)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_0_OFFSET UNITYSDK_OFFSET(0x157CD4E0)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_1_OFFSET UNITYSDK_OFFSET(0x157CD510)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONREGISTERPARAM_B__6_2_OFFSET UNITYSDK_OFFSET(0x157CD540)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x157CD580)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x157CD620)
#define NODEGRAPH_MAINCITY_SETBLACKCURTAIN___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x157CD6C0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SetBlackCurtain_TypeDefinitionIndex = 65482;

	class SetBlackCurtain : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Boolean IsBlack; // 0x58
		::System::Boolean _end; // 0x59
		::System::Single _timer; // 0x5C
		::System::Single WaitTime; // 0x60
		::System::Single FadeTime; // 0x64
		...
		::System::Void _OnNodeActiveWithState_b__7_0(::Class_1_5A17F85799580BCA_Enum_3_6E0E8267CDDC65CF reason)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5A17F85799580BCA_Enum_3_6E0E8267CDDC65CF))((::PBYTE)hIl2Cpp + NODEGRAPH_MAINCITY_SETBLACKCURTAIN__ONNODEACTIVEWITHSTATE_B__7_0_OFFSET))(this, reason);
		}
