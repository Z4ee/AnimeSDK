...
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x10CB6850)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_HANDLE_OFFSET UNITYSDK_OFFSET(0x10CB6790)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x10CB6410)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x10CB6C60)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x10CB6E00)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10CB61A0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x10CB67E0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x10CB6190)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_0_OFFSET UNITYSDK_OFFSET(0x10CB6FA0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_1_OFFSET UNITYSDK_OFFSET(0x10CB6FD0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_2_OFFSET UNITYSDK_OFFSET(0x10CB7000)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE__ONREGISTERPARAM_B__8_3_OFFSET UNITYSDK_OFFSET(0x10CB7030)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x10CB7060)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x10CB70F0)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x10CB7100)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x10CB7190)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10CB7220)
#define NODEGRAPH_MAINCITY_CHECKPLAYERNPCDISTANCE___BASE_ONTRIGGER_OFFSET UNITYSDK_OFFSET(0x10CB7230)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckPlayerNpcDistance_TypeDefinitionIndex = 67598;
	...
	public:
		...
		::System::Boolean nearDis; // 0x98
		::System::Boolean checkInPhotoPage; // 0x99
		::System::Boolean _thisPhotoPageChecked; // 0x9A
		::System::Int32 checkNpcTag; // 0x9C
