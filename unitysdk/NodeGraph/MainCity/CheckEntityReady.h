...
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xFB61240)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFB61140)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__CTOR_OFFSET UNITYSDK_OFFSET(0xFB61130)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xFB613F0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xFB61420)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFB614B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckEntityReady_TypeDefinitionIndex = 49074;
