...
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xF61E9C0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF61E8C0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__CTOR_OFFSET UNITYSDK_OFFSET(0xF61E8B0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xF61EAF0)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0xF61EB20)
#define NODEGRAPH_MAINCITY_CHECKENTITYREADY___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF61EBB0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CheckEntityReady_TypeDefinitionIndex = 78637;
