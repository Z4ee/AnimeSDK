...
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xEA6B5A0)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xEA6B6D0)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xEA6BA00)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xEA6BB40)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xEA6BEC0)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xEA6BF50)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int TriggerGroupTask_TypeDefinitionIndex = 63156;
