...
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFDFBA10)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xFDFBB40)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK__CTOR_OFFSET UNITYSDK_OFFSET(0xFDFBE70)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xFDFBFA0)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFDFC320)
#define NODEGRAPH_MAINCITY_TRIGGERGROUPTASK___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xFDFC3B0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int TriggerGroupTask_TypeDefinitionIndex = 49981;
