...
#define NODEGRAPH_MAINCITY_ADDINTERACT_ACTIVEINTERACT_OFFSET UNITYSDK_OFFSET(0xEBE2FE0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CHECKFEATUREPOINT_OFFSET UNITYSDK_OFFSET(0xEBE3990)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CLEARINTERACT_OFFSET UNITYSDK_OFFSET(0xEBE3E20)
#define NODEGRAPH_MAINCITY_ADDINTERACT_CREATEINTERACTTRIGGER_OFFSET UNITYSDK_OFFSET(0xEBE2480)
#define NODEGRAPH_MAINCITY_ADDINTERACT_GETUID_OFFSET UNITYSDK_OFFSET(0xEBE33C0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_MATCHPARENT_OFFSET UNITYSDK_OFFSET(0xEBE2860)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONINTERACT_1_OFFSET UNITYSDK_OFFSET(0xEBE4C80)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONINTERACT_OFFSET UNITYSDK_OFFSET(0xEBE4860)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xEBE3FB0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xEBE4DF0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0xEBE4FC0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xEBE37B0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xEBE22D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONREMOVEINTERACTHANDLE_OFFSET UNITYSDK_OFFSET(0xEBE4A50)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONTRIGGERENTERCALLBACK_OFFSET UNITYSDK_OFFSET(0xEBE2610)
#define NODEGRAPH_MAINCITY_ADDINTERACT_ONTRIGGEREXITCALLBACK_OFFSET UNITYSDK_OFFSET(0xEBE2D90)
#define NODEGRAPH_MAINCITY_ADDINTERACT_UNACTIVEINTERACT_OFFSET UNITYSDK_OFFSET(0xEBE3620)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ACTIVEINTERACT_B__15_0_OFFSET UNITYSDK_OFFSET(0xEBE51D0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CREATEINTERACTTRIGGER_B__11_0_OFFSET UNITYSDK_OFFSET(0xEBE51B0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CREATEINTERACTTRIGGER_B__11_1_OFFSET UNITYSDK_OFFSET(0xEBE51C0)
#define NODEGRAPH_MAINCITY_ADDINTERACT__CTOR_OFFSET UNITYSDK_OFFSET(0xEBE2150)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ONREGISTERPARAM_B__10_0_OFFSET UNITYSDK_OFFSET(0xEBE5150)
#define NODEGRAPH_MAINCITY_ADDINTERACT__ONREGISTERPARAM_B__10_1_OFFSET UNITYSDK_OFFSET(0xEBE5180)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xEBE51E0)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xEBE5280)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0xEBE5310)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xEBE5320)
#define NODEGRAPH_MAINCITY_ADDINTERACT___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xEBE53C0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddInteract_TypeDefinitionIndex = 39682;

	class AddInteract : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::MoleMole::Battle::Entity* _triggerEntity; // 0x58
		::NodeGraph::GraphOutputPort* _onInteract; // 0x60
		::MoleMole::MonoFeaturePoint* _featurePoints; // 0x68
		::MoleMole::FeaturePoint* _currentPoint; // 0x70
