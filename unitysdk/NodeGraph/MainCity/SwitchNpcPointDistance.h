...
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xCD5F300)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xCD5F0E0)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD5F010)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0xCD5F620)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0xCD5F650)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0xCD5F680)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xCD5F800)
#define NODEGRAPH_MAINCITY_SWITCHNPCPOINTDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xCD5F810)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchNpcPointDistance_TypeDefinitionIndex = 78537;
