...
#define NODEGRAPH_MAINCITY_MOVETO_GETTARGETFORWARD_OFFSET UNITYSDK_OFFSET(0x106832A0)
#define NODEGRAPH_MAINCITY_MOVETO_GETTARGETPOS_OFFSET UNITYSDK_OFFSET(0x106830D0)
#define NODEGRAPH_MAINCITY_MOVETO_HANDLEPLAYERNAVIGATEDONEACTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x10686790)
#define NODEGRAPH_MAINCITY_MOVETO_HANDLEPLAYERNAVIGATEDONEACTION_OFFSET UNITYSDK_OFFSET(0x106860E0)
#define NODEGRAPH_MAINCITY_MOVETO_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x10683AE0)
#define NODEGRAPH_MAINCITY_MOVETO_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x10686F30)
#define NODEGRAPH_MAINCITY_MOVETO_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x106850D0)
#define NODEGRAPH_MAINCITY_MOVETO_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10683680)
#define NODEGRAPH_MAINCITY_MOVETO_ONSTOPMOVEHANDLE_OFFSET UNITYSDK_OFFSET(0x10686260)
#define NODEGRAPH_MAINCITY_MOVETO_STARTNEWMOVETO_OFFSET UNITYSDK_OFFSET(0x10684430)
#define NODEGRAPH_MAINCITY_MOVETO__CTOR_OFFSET UNITYSDK_OFFSET(0x10682E20)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_0_OFFSET UNITYSDK_OFFSET(0x10687210)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_1_OFFSET UNITYSDK_OFFSET(0x10687240)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_2_OFFSET UNITYSDK_OFFSET(0x106877A0)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_3_OFFSET UNITYSDK_OFFSET(0x106877D0)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_4_OFFSET UNITYSDK_OFFSET(0x10687800)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_5_OFFSET UNITYSDK_OFFSET(0x10687830)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_6_OFFSET UNITYSDK_OFFSET(0x10687860)
#define NODEGRAPH_MAINCITY_MOVETO__ONREGISTERPARAM_B__28_7_OFFSET UNITYSDK_OFFSET(0x10687890)
#define NODEGRAPH_MAINCITY_MOVETO___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x106878C0)
#define NODEGRAPH_MAINCITY_MOVETO___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x10687960)
#define NODEGRAPH_MAINCITY_MOVETO___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x106879F0)
#define NODEGRAPH_MAINCITY_MOVETO___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10687A90)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int MoveTo_TypeDefinitionIndex = 52381;
	...
	public:
		...
		::NodeGraph::GraphInputValuePort* TargetPosInput; // 0x80
		::NodeGraph::MainCity::NavigateContainer* _navigateContainer; // 0x88
		::System::Single MaxTime; // 0x90
		::System::Single _timer; // 0x94
		::System::Int32 targetNpcTag; // 0x98
		::System::Boolean useNavMesh; // 0x9C
		::System::Boolean needDetour; // 0x9D
		::System::Boolean _waitFrame; // 0x9E
		::System::Boolean _oldWalking; // 0x9F
		::System::Boolean _noTurnAnim; // 0xA0
		::System::Single maxAngle; // 0xA4
		::System::Single range; // 0xA8
		::System::Single MaxWaitIdleTime; // 0xAC
		::System::Int32 _currentIndex; // 0xB0
		::System::Single minAngle; // 0xB4
		::System::Single CheckStandTime; // 0xB8
		::System::Boolean _processed; // 0xBC
		::System::Boolean accurate; // 0xBD
		::System::Boolean moveLocalAvatar; // 0xBE
		::System::Boolean _teleporting; // 0xBF
