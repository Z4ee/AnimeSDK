...
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONACTIVATECAMERAMODE_OFFSET UNITYSDK_OFFSET(0x17FAEC50)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONDEACTIVATECAMERAMODE_OFFSET UNITYSDK_OFFSET(0x17FAE890)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x17FAD800)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x17FAE5E0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x17FAE330)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x17FAE090)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x17FAD5E0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__CTOR_OFFSET UNITYSDK_OFFSET(0x17FAD430)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0x17FAEFF0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0x17FAF020)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI__ONREGISTERPARAM_B__5_2_OFFSET UNITYSDK_OFFSET(0x17FAF050)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x17FAF080)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x17FAF120)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x17FAF1B0)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x17FAF240)
#define NODEGRAPH_MAINCITY_ENABLEBEHAVIOURAI___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x17FAF2E0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int EnableBehaviourAI_TypeDefinitionIndex = 44214;
