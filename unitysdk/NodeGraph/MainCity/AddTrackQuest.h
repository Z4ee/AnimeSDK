...
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x102CA100)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x102C9DF0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x102C9C90)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x102CA8F0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x102CA920)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x102CA950)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x102CA980)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST__ONREGISTERPARAM_B__7_4_OFFSET UNITYSDK_OFFSET(0x102CA9B0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x102CA9E0)
#define NODEGRAPH_MAINCITY_ADDTRACKQUEST___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x102CA9F0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int AddTrackQuest_TypeDefinitionIndex = 67925;
	...
	public:
		...
		::System::Int32 iconType; // 0x6C
		::System::Boolean setIk; // 0x70
		::System::Boolean active; // 0x71
