...
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF860140)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF85FF90)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xF85FE30)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__ONREGISTERPARAM_B__4_0_OFFSET UNITYSDK_OFFSET(0xF8603C0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE__ONREGISTERPARAM_B__4_1_OFFSET UNITYSDK_OFFSET(0xF8603F0)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF860420)
#define NODEGRAPH_MAINCITY_HANDLEACTIONSTATE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF860430)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int HandleActionState_TypeDefinitionIndex = 57954;

	class HandleActionState : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::NodeGraph::GraphInputValuePort* actionStateIdInput; // 0x58
		::System::Int32 actionStateId; // 0x60
		::System::Int32 targetNpcTag; // 0x64
