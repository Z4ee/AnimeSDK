...
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10D9A6A0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10D9A570)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x10D9A3C0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0x10D9A890)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10D9A8C0)
#define NODEGRAPH_MAINCITY_REMOVEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10D9A8D0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RemoveMainCityNpc_TypeDefinitionIndex = 62947;
