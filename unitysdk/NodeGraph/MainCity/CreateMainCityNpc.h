...
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONENTITYREADYCALLBACK_OFFSET UNITYSDK_OFFSET(0x112CEB80)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x112CDE80)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x112CF660)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x112CE0E0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x112CDCD0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x112CDAD0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x112CFA60)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x112CFF30)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x112CFF60)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x112D0000)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x112D0090)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x112D0130)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CreateMainCityNpc_TypeDefinitionIndex = 54475;
	...
	public:
		...
		::System::Boolean _waitFrame; // 0x70
		::System::Boolean useSkin; // 0x71
