...
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONENTITYREADYCALLBACK_OFFSET UNITYSDK_OFFSET(0x10D98D80)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x10D98080)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x10D99860)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x10D982E0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10D97ED0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__CTOR_OFFSET UNITYSDK_OFFSET(0x10D97CD0)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x10D99C60)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x10D9A130)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x10D9A160)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x10D9A200)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x10D9A290)
#define NODEGRAPH_MAINCITY_CREATEMAINCITYNPC___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10D9A330)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int CreateMainCityNpc_TypeDefinitionIndex = 87339;

	class CreateMainCityNpc : public ::NodeGraph::GraphNodeFlow
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _delEntity; // 0x58
		::System::Collections::Generic::List_1<::NodeGraph::MainCity::CreateMainCityNpc_SNpcInfo>* mainCityNpcTagList; // 0x60
		::System::Collections::Generic::List_1<::MoleMole::Battle::Entity*>* _entity; // 0x68
