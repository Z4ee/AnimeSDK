...
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF61EE00)
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xF61F030)
#define NODEGRAPH_MAINCITY_CHILDGRAPH_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF61ED10)
#define NODEGRAPH_MAINCITY_CHILDGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0xF61EBC0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0xF61F1F0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF61F5B0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xF61F5C0)
#define NODEGRAPH_MAINCITY_CHILDGRAPH___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF61F650)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ChildGraph_TypeDefinitionIndex = 58015;
