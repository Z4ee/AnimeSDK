...
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF8607E0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF860630)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__CTOR_OFFSET UNITYSDK_OFFSET(0xF8604C0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0xF861170)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0xF8611D0)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF861200)
#define NODEGRAPH_MAINCITY_REQUESTHALLGAMEEND___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF861210)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RequestHallGameEnd_TypeDefinitionIndex = 51799;
