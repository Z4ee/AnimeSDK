...
#define NODEGRAPH_MAINCITY_RANDOMVALUE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10CB7550)
#define NODEGRAPH_MAINCITY_RANDOMVALUE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10CB7420)
#define NODEGRAPH_MAINCITY_RANDOMVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x10CB72C0)
#define NODEGRAPH_MAINCITY_RANDOMVALUE__ONREGISTERPARAM_B__3_0_OFFSET UNITYSDK_OFFSET(0x10CB7740)
#define NODEGRAPH_MAINCITY_RANDOMVALUE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x10CB7B00)
#define NODEGRAPH_MAINCITY_RANDOMVALUE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x10CB7B10)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int RandomValue_TypeDefinitionIndex = 57909;
