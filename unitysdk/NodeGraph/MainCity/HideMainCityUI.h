...
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF07CF60)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xF07D650)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF07CE30)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI__CTOR_OFFSET UNITYSDK_OFFSET(0xF07CC80)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI__ONREGISTERPARAM_B__2_0_OFFSET UNITYSDK_OFFSET(0xF07DB40)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xF07DB70)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xF07DB80)
#define NODEGRAPH_MAINCITY_HIDEMAINCITYUI___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xF07DC10)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int HideMainCityUI_TypeDefinitionIndex = 47337;
