...
#define NODEGRAPH_MAINCITY_SHOWBUBBLE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x112B3CE0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x112B3A50)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x112B38E0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_0_OFFSET UNITYSDK_OFFSET(0x112B4790)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_1_OFFSET UNITYSDK_OFFSET(0x112B47C0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_2_OFFSET UNITYSDK_OFFSET(0x112B4C50)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE__ONREGISTERPARAM_B__7_3_OFFSET UNITYSDK_OFFSET(0x112B4C80)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x112B4CB0)
#define NODEGRAPH_MAINCITY_SHOWBUBBLE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x112B4CC0)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int ShowBubble_TypeDefinitionIndex = 43202;
