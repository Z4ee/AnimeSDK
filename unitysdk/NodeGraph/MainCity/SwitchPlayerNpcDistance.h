...
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xFFE3650)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFFE34A0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xFFE33D0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__ONREGISTERPARAM_B__5_0_OFFSET UNITYSDK_OFFSET(0xFFE38A0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE__ONREGISTERPARAM_B__5_1_OFFSET UNITYSDK_OFFSET(0xFFE38D0)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE___BASE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xFFE3900)
#define NODEGRAPH_MAINCITY_SWITCHPLAYERNPCDISTANCE___BASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0xFFE3910)

namespace NodeGraph::MainCity
{
	inline static constexpr unsigned int SwitchPlayerNpcDistance_TypeDefinitionIndex = 69280;
