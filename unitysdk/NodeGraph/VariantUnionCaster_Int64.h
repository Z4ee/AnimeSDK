...
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x11B37EF0)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_CASTFROM_OFFSET UNITYSDK_OFFSET(0x11B37DF0)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_INT64__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x11B38120)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x11B380A0)
#define NODEGRAPH_VARIANTUNIONCASTER_INT64__CTOR_OFFSET UNITYSDK_OFFSET(0x11B38110)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Int64_TypeDefinitionIndex = 69462;
