...
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x10725240)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_CASTFROM_OFFSET UNITYSDK_OFFSET(0x10725140)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_UINT64__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x10725480)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x107253F0)
#define NODEGRAPH_VARIANTUNIONCASTER_UINT64__CTOR_OFFSET UNITYSDK_OFFSET(0x10725470)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_UInt64_TypeDefinitionIndex = 70377;
