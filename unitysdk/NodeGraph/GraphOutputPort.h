...
#define NODEGRAPH_GRAPHOUTPUTPORT_GET_PORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x142B6180)
#define NODEGRAPH_GRAPHOUTPUTPORT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x142B61A0)
#define NODEGRAPH_GRAPHOUTPUTPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x142B6190)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphOutputPort_TypeDefinitionIndex = 78536;
