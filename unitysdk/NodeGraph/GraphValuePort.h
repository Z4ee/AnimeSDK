...
#define NODEGRAPH_GRAPHVALUEPORT_GET_PORTTYPE_OFFSET UNITYSDK_OFFSET(0xD9594C0)
#define NODEGRAPH_GRAPHVALUEPORT_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD9594E0)
#define NODEGRAPH_GRAPHVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0xD9594D0)
#define NODEGRAPH_GRAPHVALUEPORT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xD9595D0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphValuePort_TypeDefinitionIndex = 42296;
