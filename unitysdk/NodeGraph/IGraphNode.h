...
#define NODEGRAPH_IGRAPHNODE_ACTIVENODE_OFFSET UNITYSDK_OFFSET(0xD4643D0)
#define NODEGRAPH_IGRAPHNODE_CLEARNODE_OFFSET UNITYSDK_OFFSET(0xD4647E0)
#define NODEGRAPH_IGRAPHNODE_ENDNODE_OFFSET UNITYSDK_OFFSET(0xD4648B0)
#define NODEGRAPH_IGRAPHNODE_GET_GRAPHID_OFFSET UNITYSDK_OFFSET(0xD4642B0)
#define NODEGRAPH_IGRAPHNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xD464350)
#define NODEGRAPH_IGRAPHNODE_GET_NODEGRAPH_OFFSET UNITYSDK_OFFSET(0xD464320)
#define NODEGRAPH_IGRAPHNODE_GET_NODEID_OFFSET UNITYSDK_OFFSET(0xD464300)
#define NODEGRAPH_IGRAPHNODE_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0xD4642A0)
#define NODEGRAPH_IGRAPHNODE_GET_STATE_OFFSET UNITYSDK_OFFSET(0xD464330)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0xD464710)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0xD464670)
#define NODEGRAPH_IGRAPHNODE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0xD464870)
#define NODEGRAPH_IGRAPHNODE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0xD464910)
#define NODEGRAPH_IGRAPHNODE_ONNODEPAUSE_OFFSET UNITYSDK_OFFSET(0xD464760)
#define NODEGRAPH_IGRAPHNODE_ONNODERESUME_OFFSET UNITYSDK_OFFSET(0xD4647A0)
#define NODEGRAPH_IGRAPHNODE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0xD464A20)
#define NODEGRAPH_IGRAPHNODE_PAUSENODE_OFFSET UNITYSDK_OFFSET(0xD4645B0)
#define NODEGRAPH_IGRAPHNODE_RESUMENODE_OFFSET UNITYSDK_OFFSET(0xD464610)
#define NODEGRAPH_IGRAPHNODE_SETNODEDONE_OFFSET UNITYSDK_OFFSET(0xD464550)
#define NODEGRAPH_IGRAPHNODE_SETNODEID_OFFSET UNITYSDK_OFFSET(0xD464380)
#define NODEGRAPH_IGRAPHNODE_SETNODESTATE_OFFSET UNITYSDK_OFFSET(0xD464250)
#define NODEGRAPH_IGRAPHNODE_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0xD464360)
#define NODEGRAPH_IGRAPHNODE_SET_NODEID_OFFSET UNITYSDK_OFFSET(0xD464310)
#define NODEGRAPH_IGRAPHNODE_SET_STATE_OFFSET UNITYSDK_OFFSET(0xD464340)
#define NODEGRAPH_IGRAPHNODE_UPDATENODE_OFFSET UNITYSDK_OFFSET(0xD464950)
#define NODEGRAPH_IGRAPHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD464370)

namespace NodeGraph
{
	inline static constexpr unsigned int IGraphNode_TypeDefinitionIndex = 45141;
	...
	public:
		...
		::System::Boolean _IsPaused_k__BackingField; // 0x28
