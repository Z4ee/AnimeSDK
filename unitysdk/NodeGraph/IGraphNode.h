...
#define NODEGRAPH_IGRAPHNODE_ACTIVENODE_OFFSET UNITYSDK_OFFSET(0x1071B6C0)
#define NODEGRAPH_IGRAPHNODE_CLEARNODE_OFFSET UNITYSDK_OFFSET(0x1071BAD0)
#define NODEGRAPH_IGRAPHNODE_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1071BBA0)
#define NODEGRAPH_IGRAPHNODE_GET_GRAPHID_OFFSET UNITYSDK_OFFSET(0x1071B5A0)
#define NODEGRAPH_IGRAPHNODE_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1071B640)
#define NODEGRAPH_IGRAPHNODE_GET_NODEGRAPH_OFFSET UNITYSDK_OFFSET(0x1071B610)
#define NODEGRAPH_IGRAPHNODE_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1071B5F0)
#define NODEGRAPH_IGRAPHNODE_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1071B590)
#define NODEGRAPH_IGRAPHNODE_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1071B620)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVEWITHSTATE_OFFSET UNITYSDK_OFFSET(0x1071BA00)
#define NODEGRAPH_IGRAPHNODE_ONNODEACTIVE_OFFSET UNITYSDK_OFFSET(0x1071B960)
#define NODEGRAPH_IGRAPHNODE_ONNODECLEAR_OFFSET UNITYSDK_OFFSET(0x1071BB60)
#define NODEGRAPH_IGRAPHNODE_ONNODEEND_OFFSET UNITYSDK_OFFSET(0x1071BC00)
#define NODEGRAPH_IGRAPHNODE_ONNODEPAUSE_OFFSET UNITYSDK_OFFSET(0x1071BA50)
#define NODEGRAPH_IGRAPHNODE_ONNODERESUME_OFFSET UNITYSDK_OFFSET(0x1071BA90)
#define NODEGRAPH_IGRAPHNODE_ONNODEUPDATE_OFFSET UNITYSDK_OFFSET(0x1071BD10)
#define NODEGRAPH_IGRAPHNODE_PAUSENODE_OFFSET UNITYSDK_OFFSET(0x1071B8A0)
#define NODEGRAPH_IGRAPHNODE_RESUMENODE_OFFSET UNITYSDK_OFFSET(0x1071B900)
#define NODEGRAPH_IGRAPHNODE_SETNODEDONE_OFFSET UNITYSDK_OFFSET(0x1071B840)
#define NODEGRAPH_IGRAPHNODE_SETNODEID_OFFSET UNITYSDK_OFFSET(0x1071B670)
#define NODEGRAPH_IGRAPHNODE_SETNODESTATE_OFFSET UNITYSDK_OFFSET(0x1071B540)
#define NODEGRAPH_IGRAPHNODE_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x1071B650)
#define NODEGRAPH_IGRAPHNODE_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1071B600)
#define NODEGRAPH_IGRAPHNODE_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1071B630)
#define NODEGRAPH_IGRAPHNODE_UPDATENODE_OFFSET UNITYSDK_OFFSET(0x1071BC40)
#define NODEGRAPH_IGRAPHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1071B660)

namespace NodeGraph
{
	inline static constexpr unsigned int IGraphNode_TypeDefinitionIndex = 70567;
	...
	public:
		...
		::System::Boolean _IsPaused_k__BackingField; // 0x20
		::NodeGraph::IGraphNode_NodeState _State_k__BackingField; // 0x24
