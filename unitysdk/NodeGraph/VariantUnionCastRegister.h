...
#define NODEGRAPH_VARIANTUNIONCASTREGISTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16149540)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCastRegister_TypeDefinitionIndex = 74539;
