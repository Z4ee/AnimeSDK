...
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_1_OFFSET UNITYSDK_OFFSET(0xD46D330)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_2_OFFSET UNITYSDK_OFFSET(0xD46D590)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_3_OFFSET UNITYSDK_OFFSET(0xD46D7F0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_4_OFFSET UNITYSDK_OFFSET(0xD46D9F0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_5_OFFSET UNITYSDK_OFFSET(0xD46DC40)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_6_OFFSET UNITYSDK_OFFSET(0xD46DDC0)
#define NODEGRAPH_VARIANTUNIONCASTERHELPER_TRYCAST_OFFSET UNITYSDK_OFFSET(0xD46D060)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCasterHelper_TypeDefinitionIndex = 55020;
