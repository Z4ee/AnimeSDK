...
#define NODEGRAPH_NODEGRAPHCHILD_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0xCE7F1A0)
#define NODEGRAPH_NODEGRAPHCHILD_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0xCE7F2B0)
#define NODEGRAPH_NODEGRAPHCHILD_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0xCE7F0D0)
#define NODEGRAPH_NODEGRAPHCHILD_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xCE7F0C0)
#define NODEGRAPH_NODEGRAPHCHILD__CTOR_OFFSET UNITYSDK_OFFSET(0xCE7F100)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphChild_TypeDefinitionIndex = 44100;
