...
#define NODEGRAPH_NODEGRAPHMACRO_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x16146D70)
#define NODEGRAPH_NODEGRAPHMACRO_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x16146F10)
#define NODEGRAPH_NODEGRAPHMACRO_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x16146D60)
#define NODEGRAPH_NODEGRAPHMACRO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x16146D50)
#define NODEGRAPH_NODEGRAPHMACRO__CTOR_OFFSET UNITYSDK_OFFSET(0x16146E80)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphMacro_TypeDefinitionIndex = 43916;
