...
#define NODEGRAPH_NODEGRAPHMACRO_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x177ED620)
#define NODEGRAPH_NODEGRAPHMACRO_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x177ED7C0)
#define NODEGRAPH_NODEGRAPHMACRO_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x177ED610)
#define NODEGRAPH_NODEGRAPHMACRO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x177ED600)
#define NODEGRAPH_NODEGRAPHMACRO__CTOR_OFFSET UNITYSDK_OFFSET(0x177ED730)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphMacro_TypeDefinitionIndex = 56601;
