...
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_CASTFROM_OFFSET UNITYSDK_OFFSET(0xFB646D0)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_OBJECT__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0xFB647D0)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0xFB64750)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xFB647C0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Object_TypeDefinitionIndex = 38330;
