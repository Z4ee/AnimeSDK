...
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_CASTFROM_OFFSET UNITYSDK_OFFSET(0xF621D50)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_OBJECT__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0xF621E50)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0xF621DD0)
#define NODEGRAPH_VARIANTUNIONCASTER_OBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xF621E40)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Object_TypeDefinitionIndex = 59216;
