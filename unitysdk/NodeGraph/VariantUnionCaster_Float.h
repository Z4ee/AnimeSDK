...
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x157CE120)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_CASTFROM_OFFSET UNITYSDK_OFFSET(0x157CE000)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_SINGLE__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x157CE380)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x157CE300)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x157CE370)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Float_TypeDefinitionIndex = 55290;
