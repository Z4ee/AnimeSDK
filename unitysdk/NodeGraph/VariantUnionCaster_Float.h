...
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0x10A14540)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_CASTFROM_OFFSET UNITYSDK_OFFSET(0x10A14440)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_SINGLE__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x10A14790)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0x10A14710)
#define NODEGRAPH_VARIANTUNIONCASTER_FLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x10A14780)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Float_TypeDefinitionIndex = 45069;
