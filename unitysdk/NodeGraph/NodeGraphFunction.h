...
#define NODEGRAPH_NODEGRAPHFUNCTION_CREATEGRAPH_OFFSET UNITYSDK_OFFSET(0x17FB0160)
#define NODEGRAPH_NODEGRAPHFUNCTION_CREATESUBGRAPH_OFFSET UNITYSDK_OFFSET(0x17FB0270)
#define NODEGRAPH_NODEGRAPHFUNCTION_GET_ROOTGRAPH_OFFSET UNITYSDK_OFFSET(0x17FB00A0)
#define NODEGRAPH_NODEGRAPHFUNCTION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x17FB0090)
#define NODEGRAPH_NODEGRAPHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17FB00D0)

namespace NodeGraph
{
	inline static constexpr unsigned int NodeGraphFunction_TypeDefinitionIndex = 46048;
