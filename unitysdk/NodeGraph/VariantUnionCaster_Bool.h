...
#define NODEGRAPH_VARIANTUNIONCASTER_BOOL_CASTFROM_1_OFFSET UNITYSDK_OFFSET(0xBDFED60)
#define NODEGRAPH_VARIANTUNIONCASTER_BOOL_CASTFROM_OFFSET UNITYSDK_OFFSET(0xBDFEC30)
#define NODEGRAPH_VARIANTUNIONCASTER_BOOL_NODEGRAPH_IVARIANTUNIONCASTER_SYSTEM_BOOLEAN__TRYCASTTO_OFFSET UNITYSDK_OFFSET(0xBDFEFC0)
#define NODEGRAPH_VARIANTUNIONCASTER_BOOL_TRYCASTTO_OFFSET UNITYSDK_OFFSET(0xBDFEF40)
#define NODEGRAPH_VARIANTUNIONCASTER_BOOL__CTOR_OFFSET UNITYSDK_OFFSET(0xBDFEFB0)

namespace NodeGraph
{
	inline static constexpr unsigned int VariantUnionCaster_Bool_TypeDefinitionIndex = 68540;
