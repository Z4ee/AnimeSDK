...
#define NODEGRAPH_GRAPHNODEBASE_BUILDEXINPUTPORT_OFFSET UNITYSDK_OFFSET(0x177E9CA0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDEXOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x177E9F40)
#define NODEGRAPH_GRAPHNODEBASE_BUILDINPUTPORT_OFFSET UNITYSDK_OFFSET(0x177E9C20)
#define NODEGRAPH_GRAPHNODEBASE_BUILDINPUTVALUEPORT_OFFSET UNITYSDK_OFFSET(0x177E9DB0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDOUTPUTPORT_OFFSET UNITYSDK_OFFSET(0x177E9EC0)
#define NODEGRAPH_GRAPHNODEBASE_BUILDOUTPUTVALUEPORT_OFFSET UNITYSDK_OFFSET(0x177EA050)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_1_OFFSET UNITYSDK_OFFSET(0x177E9B70)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_2_OFFSET UNITYSDK_OFFSET(0x177E99F0)
#define NODEGRAPH_GRAPHNODEBASE_GETPORT_OFFSET UNITYSDK_OFFSET(0x177E9910)
#define NODEGRAPH_GRAPHNODEBASE_ONACTIVEPORT_OFFSET UNITYSDK_OFFSET(0x177EA370)
#define NODEGRAPH_GRAPHNODEBASE_ONNODEDONE_OFFSET UNITYSDK_OFFSET(0x177EA160)
#define NODEGRAPH_GRAPHNODEBASE_ONREGISTERPARAM_OFFSET UNITYSDK_OFFSET(0x177EA1F0)
#define NODEGRAPH_GRAPHNODEBASE_SETPARAM_OFFSET UNITYSDK_OFFSET(0x177EA240)
#define NODEGRAPH_GRAPHNODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x177E9860)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeBase_TypeDefinitionIndex = 40713;

	class GraphNodeBase : public ::NodeGraph::IGraphNode
	{
	public:
		::NodeGraph::GraphInputPort* _in; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Action_1<::SimpleJSON::JSONNode*>*>* _paramRegister; // 0x38
		::System::Collections::Generic::List_1<::NodeGraph::IGraphPort*>* _outputPortList; // 0x40
		::System::Collections::Generic::List_1<::NodeGraph::IGraphPort*>* _inputPortList; // 0x48
		::NodeGraph::GraphOutputPort* _out; // 0x50
