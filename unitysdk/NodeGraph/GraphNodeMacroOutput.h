...
#define NODEGRAPH_GRAPHNODEMACROOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x17FB8F40)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeMacroOutput_TypeDefinitionIndex = 40946;
