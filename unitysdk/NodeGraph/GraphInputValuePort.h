...
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GETVALUE_OFFSET UNITYSDK_OFFSET(0x13A09FA0)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GET_PORTDIRECTION_OFFSET UNITYSDK_OFFSET(0x13A09E90)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_GET_VALUEGETTER_OFFSET UNITYSDK_OFFSET(0x13A09EA0)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13A09ED0)
#define NODEGRAPH_GRAPHINPUTVALUEPORT_SET_VALUEGETTER_OFFSET UNITYSDK_OFFSET(0x13A09EB0)
#define NODEGRAPH_GRAPHINPUTVALUEPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x13A09EC0)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphInputValuePort_TypeDefinitionIndex = 59990;
