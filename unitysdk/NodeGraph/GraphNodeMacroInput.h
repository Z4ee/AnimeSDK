...
#define NODEGRAPH_GRAPHNODEMACROINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0xE588350)

namespace NodeGraph
{
	inline static constexpr unsigned int GraphNodeMacroInput_TypeDefinitionIndex = 66685;
