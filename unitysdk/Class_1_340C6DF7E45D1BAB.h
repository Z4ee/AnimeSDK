...
#define CLASS_1_340C6DF7E45D1BAB_GET_BLOCKCOMPONENTTYPES_OFFSET UNITYSDK_OFFSET(0x16C11340)
#define CLASS_1_340C6DF7E45D1BAB_GET_GLOBALCOMPONENTTYPES_OFFSET UNITYSDK_OFFSET(0x16C11320)
#define CLASS_1_340C6DF7E45D1BAB_GET__ALLSOURCEPROXY_OFFSET UNITYSDK_OFFSET(0x16C11380)
#define CLASS_1_340C6DF7E45D1BAB_GET__ALLSOURCESTACK_OFFSET UNITYSDK_OFFSET(0x16C11360)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_14BFEE99BA593FDD_OFFSET UNITYSDK_OFFSET(0x16C0D5D0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_1A0D3B20C2CC55DC_OFFSET UNITYSDK_OFFSET(0x16C0FA40)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_1AADDEA5F6FD601A_OFFSET UNITYSDK_OFFSET(0x16C13310)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_1ABE634E489C2299_OFFSET UNITYSDK_OFFSET(0x16C129C0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_1D4018D4200358D0_1_OFFSET UNITYSDK_OFFSET(0x16C0F3E0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x16C0F380)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_306669E8B26524E2_OFFSET UNITYSDK_OFFSET(0x16C15BB0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_323F8D08182C6A68_OFFSET UNITYSDK_OFFSET(0x16C16440)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_367B9590522079D1_OFFSET UNITYSDK_OFFSET(0x16C12690)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_3AF1FD0911B649AF_OFFSET UNITYSDK_OFFSET(0x16C16290)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_3D3A3FC6437445E5_OFFSET UNITYSDK_OFFSET(0x16C10540)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_3E691C90F81C68D2_OFFSET UNITYSDK_OFFSET(0x16C130A0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_4E9ED3C8B72341BE_OFFSET UNITYSDK_OFFSET(0x16C12F10)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_4F287A3C06D170F4_OFFSET UNITYSDK_OFFSET(0x16C10B00)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_62FEFB991479ACCB_OFFSET UNITYSDK_OFFSET(0x16C0F250)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_6C1AC7377B2E2AE4_OFFSET UNITYSDK_OFFSET(0x16C13180)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_735EE20B25F86BF4_OFFSET UNITYSDK_OFFSET(0x16C10EB0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_75E10C86775D877F_OFFSET UNITYSDK_OFFSET(0x16C0E5F0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_780147B637D00196_OFFSET UNITYSDK_OFFSET(0x16C0EBB0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_7E9AC3FFDA4606D5_1_OFFSET UNITYSDK_OFFSET(0x16C12EA0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0x16C12620)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_8C704EC832EDEFC8_OFFSET UNITYSDK_OFFSET(0x16C113A0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x16C161A0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_9B39F7D7C1FF70D6_OFFSET UNITYSDK_OFFSET(0x16C104E0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_AB88190D695EBEA9_OFFSET UNITYSDK_OFFSET(0x16C10150)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_AECF8BEC293ED42A_OFFSET UNITYSDK_OFFSET(0x16BF0C50)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_B2C0ADBFEA309440_OFFSET UNITYSDK_OFFSET(0x16C118B0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_C1D3BDE2A17F5C9D_OFFSET UNITYSDK_OFFSET(0x16C15090)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_C561FF611C07A44C_1_OFFSET UNITYSDK_OFFSET(0x16C0F1B0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_C561FF611C07A44C_OFFSET UNITYSDK_OFFSET(0x16C0F110)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_C65867E022A1F7C0_OFFSET UNITYSDK_OFFSET(0x16C13BB0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_C9D6F9890A05C022_OFFSET UNITYSDK_OFFSET(0x16C0F5D0)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_CB741CCB6B42AFF1_OFFSET UNITYSDK_OFFSET(0x16C13A30)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_CEF2F84573427F6B_OFFSET UNITYSDK_OFFSET(0x16C13B20)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_D40D151FFB9AE5DB_OFFSET UNITYSDK_OFFSET(0x16C14A80)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_D460587695D41831_OFFSET UNITYSDK_OFFSET(0x16C12A20)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0x16C0FE70)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_EC5AF9232853FA6E_OFFSET UNITYSDK_OFFSET(0x16C0F440)
#define CLASS_1_340C6DF7E45D1BAB_METHOD_1_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x16C11660)
#define CLASS_1_340C6DF7E45D1BAB_SET_BLOCKCOMPONENTTYPES_OFFSET UNITYSDK_OFFSET(0x16C11350)
#define CLASS_1_340C6DF7E45D1BAB_SET_GLOBALCOMPONENTTYPES_OFFSET UNITYSDK_OFFSET(0x16C11330)
#define CLASS_1_340C6DF7E45D1BAB_SET__ALLSOURCEPROXY_OFFSET UNITYSDK_OFFSET(0x16C11390)
#define CLASS_1_340C6DF7E45D1BAB_SET__ALLSOURCESTACK_OFFSET UNITYSDK_OFFSET(0x16C11370)
#define CLASS_1_340C6DF7E45D1BAB__CCTOR_OFFSET UNITYSDK_OFFSET(0x16C165C0)
#define CLASS_1_340C6DF7E45D1BAB__CTOR_OFFSET UNITYSDK_OFFSET(0x16C10BA0)

inline static constexpr unsigned int Class_1_340C6DF7E45D1BAB_TypeDefinitionIndex = 73892;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::Class_1_BE2C11D41E955545*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_340C6DF7E45D1BAB_TypeDefinitionIndex)->GetStaticField(0x67740);
	}
	static ::Class_1_340C6DF7E45D1BAB** StaticGet_IPGKOOHKCEG()
	{
		return (::Class_1_340C6DF7E45D1BAB**)Il2CppClass::FromTypeDefinitionIndex(Class_1_340C6DF7E45D1BAB_TypeDefinitionIndex)->GetStaticField(0x67748);
	}
	::System::Collections::Generic::List_1<::Class_1_BE2C11D41E955545*>* EDOKMFCKAJE; // 0x10
	::System::Collections::Generic::List_1<::System::Boolean>* PGFFKGFCBDB; // 0x18
	::Class_2_7F4574E2AA5F0809* NAPMNEDACMI; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_D0766C2D98736D1C*>* INMKDKJGIAD; // 0x28
	::System::Collections::Generic::List_1<::System::String*>* LMFPOIBGDFP; // 0x30
	::Class_1_AD85912B20ABF9D7* BFHBIBBNLLM; // 0x38
	::System::Collections::Generic::List_1<::Class_1_AD85912B20ABF9D7*>* GLHELNNMBDD; // 0x40
	::System::Collections::Generic::List_1<::Class_1_A335CFE48265E251*>* NFNCPOAHIGG; // 0x48
	::Class_1_DE4C6B309308A230* GCBGJCMFIBK; // 0x50
	::System::Collections::Generic::List_1<::Class_1_A335CFE48265E251*>* OIPGKHOKLOM; // 0x58
	::Class_1_BE2C11D41E955545* __AllSourceStack_k__BackingField; // 0x60
	::System::Collections::Generic::Dictionary_2<::System::String*, ::Class_1_AD85912B20ABF9D7*>* DJKHAFIIIBA; // 0x68
	::System::Collections::Generic::List_1<::RPG::Client::OpenWorld::Volume*>* NJMLLOFPDAE; // 0x70
	::System::Collections::Generic::IEnumerable_1<::System::Type*>* _BlockComponentTypes_k__BackingField; // 0x78
	::Class_1_BE2C11D41E955545* __AllSourceProxy_k__BackingField; // 0x80
	::System::Collections::Generic::List_1<::Class_1_A335CFE48265E251*>* FJKDCDHFGJM; // 0x88
	::System::Collections::Generic::List_1<::Class_1_D0766C2D98736D1C*>* IFMBEIBDHMK; // 0x90
	::System::Collections::Generic::IEnumerable_1<::System::Type*>* _GlobalComponentTypes_k__BackingField; // 0x98
	::System::Collections::Generic::List_1<::System::Int32>* KEGHIIFKBCA; // 0xA0
	::System::Collections::Generic::List_1<::System::Int32>* FFHJOFLNCNN; // 0xA8
	::Class_2_FC978391A642283C_1* JKFAJECFNBN; // 0xB0
	::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::Class_1_A335CFE48265E251*>*>* FHHHGCPFMLO; // 0xB8
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* PJKIDLNGJMN; // 0xC0
	::System::Boolean OHOEEOHKDLE; // 0xC8
	::System::Boolean PCDKNIADJOD; // 0xC9
	::System::Boolean JCFBJKMCHGH; // 0xCA
	::System::Boolean BIFGOPGOOOF; // 0xCB
