...
#define CLASS_2_8B5CAF842C5FBAA1_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBB0CBC0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_03334346FF66DC56_OFFSET UNITYSDK_OFFSET(0xBB0D400)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_0B18028B73596FE0_OFFSET UNITYSDK_OFFSET(0xBB0D790)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xBB0CE40)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_29622B5284E27113_OFFSET UNITYSDK_OFFSET(0xBB0DC10)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0xBB0D270)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBB0DB30)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_5CDBA3B04DB53D1D_OFFSET UNITYSDK_OFFSET(0xBB0D920)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xBB0DB90)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xBB0DA90)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0xBB0D100)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_AA907F79A6302F77_OFFSET UNITYSDK_OFFSET(0xBB0D2D0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_DE973A2760D546FC_OFFSET UNITYSDK_OFFSET(0xBB0D7D0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0xBB0DCA0)
#define CLASS_2_8B5CAF842C5FBAA1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBB0CC80)
#define CLASS_2_8B5CAF842C5FBAA1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBB0CED0)
#define CLASS_2_8B5CAF842C5FBAA1_TICK_OFFSET UNITYSDK_OFFSET(0xBB0D000)
#define CLASS_2_8B5CAF842C5FBAA1__CTOR_OFFSET UNITYSDK_OFFSET(0xBB0CA50)
...
public:
	...
	::Class_2_A0580152EB393340* EIJAMKAKADD; // 0x38
	::UnityEngine::Vector3 DINLADADEPH; // 0x40
	::UnityEngine::Vector3 IKKNJMJCDOJ; // 0x4C
	::System::Boolean KJCJMICBBEC; // 0x58
	::System::Boolean HHBGOBMFMML; // 0x59
	::UnityEngine::Vector3 BEDPGAOCOHG; // 0x5C
	::UnityEngine::Vector3 LOHCJHEHNLF; // 0x68
	::RPG::GameCore::SoldierLineupPatrolStatus CPPNFCBEJLK; // 0x74
	::RPG::GameCore::CharacterMotionFlag ODBOHHKMIDP; // 0x78
	::UnityEngine::Vector3 AANPAEBECKM; // 0x7C
