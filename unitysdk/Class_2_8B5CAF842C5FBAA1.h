...
#define CLASS_2_8B5CAF842C5FBAA1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BC70F0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_03334346FF66DC56_OFFSET UNITYSDK_OFFSET(0x18BC7930)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_0B18028B73596FE0_OFFSET UNITYSDK_OFFSET(0x18BC7CC0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0x18BC7370)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_29622B5284E27113_OFFSET UNITYSDK_OFFSET(0x18BC8140)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_40E490E2772D5D75_OFFSET UNITYSDK_OFFSET(0x18BC7790)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x18BC8060)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_5CDBA3B04DB53D1D_OFFSET UNITYSDK_OFFSET(0x18BC7E50)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x18BC80C0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x18BC7FC0)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0x18BC7620)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_AA907F79A6302F77_OFFSET UNITYSDK_OFFSET(0x18BC7800)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_DE973A2760D546FC_OFFSET UNITYSDK_OFFSET(0x18BC7D00)
#define CLASS_2_8B5CAF842C5FBAA1_METHOD_2_F10A0D072D26C4BF_OFFSET UNITYSDK_OFFSET(0x18BC81D0)
#define CLASS_2_8B5CAF842C5FBAA1_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18BC71B0)
#define CLASS_2_8B5CAF842C5FBAA1_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x18BC73F0)
#define CLASS_2_8B5CAF842C5FBAA1_TICK_OFFSET UNITYSDK_OFFSET(0x18BC7520)
#define CLASS_2_8B5CAF842C5FBAA1__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC6F80)

inline static constexpr unsigned int Class_2_8B5CAF842C5FBAA1_TypeDefinitionIndex = 52719;

class Class_2_8B5CAF842C5FBAA1 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::NPCComponent* ACMDKOBBDNJ; // 0x18
	::Class_2_A0580152EB393340* EIJAMKAKADD; // 0x20
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x28
	::Class_2_2ECF3E74BC6E7972* PCGBEAMFBEC; // 0x30
	::RPG::GameCore::AdventureCharacterController* EEMOFHKBEBO; // 0x38
	::RPG::GameCore::SoldierLineupPatrolStatus CPPNFCBEJLK; // 0x40
	::RPG::GameCore::CharacterMotionFlag ODBOHHKMIDP; // 0x44
	::UnityEngine::Vector3 AANPAEBECKM; // 0x48
	::UnityEngine::Vector3 IKKNJMJCDOJ; // 0x54
	::UnityEngine::Vector3 DINLADADEPH; // 0x60
	::System::Boolean HHBGOBMFMML; // 0x6C
	::System::Boolean KJCJMICBBEC; // 0x6D
	::UnityEngine::Vector3 LOHCJHEHNLF; // 0x70
	::UnityEngine::Vector3 BEDPGAOCOHG; // 0x7C
	::UnityEngine::Vector3 IDABEOEFDHE; // 0x88
