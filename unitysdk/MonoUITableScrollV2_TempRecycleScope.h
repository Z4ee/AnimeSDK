...
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xE8719B0)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_GET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x3E5670)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x5C9410)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x623E60)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x623E50)

inline static constexpr unsigned int MonoUITableScrollV2_TempRecycleScope_TypeDefinitionIndex = 69959;
