...
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x10F1BDF0)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_GET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x41FD70)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x622AD0)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x70C150)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x70C140)

inline static constexpr unsigned int MonoUITableScrollV2_TempRecycleScope_TypeDefinitionIndex = 74987;
