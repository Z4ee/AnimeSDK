...
#define ONAGER_FXMESH_FXMESH_APPLYMESH_OFFSET UNITYSDK_OFFSET(0x1F968C00)
#define ONAGER_FXMESH_FXMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1F96A350)
#define ONAGER_FXMESH_FXMESH_GET_MFILTER_OFFSET UNITYSDK_OFFSET(0x1F9688E0)
#define ONAGER_FXMESH_FXMESH_GET_MRENDERER_OFFSET UNITYSDK_OFFSET(0x1F968A70)
#define ONAGER_FXMESH_FXMESH_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1F9688D0)
#define ONAGER_FXMESH_FXMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1F96A360)

namespace Onager::FXMesh
{
	inline static constexpr unsigned int FXMesh_TypeDefinitionIndex = 38712;
