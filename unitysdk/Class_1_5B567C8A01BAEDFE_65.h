...
#define CLASS_1_5B567C8A01BAEDFE_65_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4C2B10)
#define CLASS_1_5B567C8A01BAEDFE_65_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4C2800)
#define CLASS_1_5B567C8A01BAEDFE_65_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4C2910)
#define CLASS_1_5B567C8A01BAEDFE_65_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4C2840)
#define CLASS_1_5B567C8A01BAEDFE_65_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4C2A70)
#define CLASS_1_5B567C8A01BAEDFE_65_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4C2B60)
#define CLASS_1_5B567C8A01BAEDFE_65_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4C2B30)
#define CLASS_1_5B567C8A01BAEDFE_65_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4C2780)
#define CLASS_1_5B567C8A01BAEDFE_65_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4C27B0)
#define CLASS_1_5B567C8A01BAEDFE_65_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4C2AA0)
#define CLASS_1_5B567C8A01BAEDFE_65_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4C2B00)
#define CLASS_1_5B567C8A01BAEDFE_65__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4C2BB0)
#define CLASS_1_5B567C8A01BAEDFE_65__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4C27D0)
#define CLASS_1_5B567C8A01BAEDFE_65__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4C27C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_65*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_65_TypeDefinitionIndex)->GetStaticField(0xA2C0);
	}
