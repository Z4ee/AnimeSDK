...
#define CLASS_1_8C1FA6D12B3CF102_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F60350)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_3360767BB2C4A5D4_OFFSET UNITYSDK_OFFSET(0x18F60610)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_7698449B1E4FFB67_OFFSET UNITYSDK_OFFSET(0x18F5FF00)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_9FA85F81BF5EE3CA_OFFSET UNITYSDK_OFFSET(0x18F603D0)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x18F60550)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_BCAE7F7048277762_OFFSET UNITYSDK_OFFSET(0x18F602F0)
#define CLASS_1_8C1FA6D12B3CF102_METHOD_1_F74441856239DF08_OFFSET UNITYSDK_OFFSET(0x18F60420)
#define CLASS_1_8C1FA6D12B3CF102__CCTOR_OFFSET UNITYSDK_OFFSET(0x18F607F0)
#define CLASS_1_8C1FA6D12B3CF102__CTOR_OFFSET UNITYSDK_OFFSET(0x18F5FDD0)

inline static constexpr unsigned int Class_1_8C1FA6D12B3CF102_TypeDefinitionIndex = 74271;
...
public:
	...
	{
		return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_8C1FA6D12B3CF102_TypeDefinitionIndex)->GetStaticField(0x365A0);
	}
	::Class_1_8C1FA6D12B3CF102_Class_1_95D73FACBABCB404* AOKKCIPBODJ; // 0x10
	::UnityEngine::Material* NCNJEKDLNEN; // 0x18
	::UnityEngine::GameObject* GHKKPFEJLBP; // 0x20
	::System::Collections::Generic::List_1<::UnityEngine::Material*>* ABAJIOEFDFB; // 0x28
	::Class_1_8C1FA6D12B3CF102_Class_1_95D73FACBABCB404* LKGBNJEFHLB; // 0x30
	::Class_1_8C1FA6D12B3CF102_Class_1_95D73FACBABCB404* JJBOPOPCOCH; // 0x38
	::UnityEngine::MeshRenderer* JAMDAALMOAL; // 0x40
	::RPG::CustomRP::AvatarEffectInfo_PerRendererEffect* FJECIBLPPIJ; // 0x48
