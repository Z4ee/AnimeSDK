...
#define CLASS_3_6A3BE16535135C85_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x18BB5060)
#define CLASS_3_6A3BE16535135C85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18BB4FF0)
#define CLASS_3_6A3BE16535135C85__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB4F80)

inline static constexpr unsigned int Class_3_6A3BE16535135C85_TypeDefinitionIndex = 23803;
