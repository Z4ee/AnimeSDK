...
#define CLASS_3_6A3BE16535135C85_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x18F84C40)
#define CLASS_3_6A3BE16535135C85__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F84BD0)
#define CLASS_3_6A3BE16535135C85__CTOR_OFFSET UNITYSDK_OFFSET(0x18F84B60)

inline static constexpr unsigned int Class_3_6A3BE16535135C85_TypeDefinitionIndex = 23636;
