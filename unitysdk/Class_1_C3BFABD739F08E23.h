...
#define CLASS_1_C3BFABD739F08E23__CTOR_OFFSET UNITYSDK_OFFSET(0x18F71980)
...
{
public:
	::System::String* JKMABBEGEAH; // 0x10
	::System::Collections::Generic::List_1<::RPG::GameCore::UIImageNode*>* BEAGALJGPHI; // 0x18
