...
#define CLASS_1_2C04610D4A58FBF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xB7578F0)
#define CLASS_1_2C04610D4A58FBF2_GET_BOUNDSOCCLUDERFORJOB_OFFSET UNITYSDK_OFFSET(0xB75A290)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xB758520)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_3C092CF69374C63B_OFFSET UNITYSDK_OFFSET(0xB759C30)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_4B2C88022C29B618_OFFSET UNITYSDK_OFFSET(0xB75A050)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_61C61A4D5B1CAB1C_OFFSET UNITYSDK_OFFSET(0xB7595B0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_65D79DE7509E7805_OFFSET UNITYSDK_OFFSET(0xB759280)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_66B06D14D5E4D654_OFFSET UNITYSDK_OFFSET(0xB759510)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_6852DC894AC1E216_OFFSET UNITYSDK_OFFSET(0xB7583B0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_7976BB22602FCA77_OFFSET UNITYSDK_OFFSET(0xB757A70)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0xB757810)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xB7585E0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_8E6AA668BCBFD16D_OFFSET UNITYSDK_OFFSET(0xB758060)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xB758E80)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_9B94601409ACF78B_OFFSET UNITYSDK_OFFSET(0xB759470)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_9DA79C3754CF9783_OFFSET UNITYSDK_OFFSET(0xB758ED0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_B10FB9597F17FCB4_OFFSET UNITYSDK_OFFSET(0xB758B90)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_B93A9FB8A3E13C83_OFFSET UNITYSDK_OFFSET(0xB757950)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_C4EFD31239F98A71_OFFSET UNITYSDK_OFFSET(0xB759770)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_DE2C4CD7BF3E857D_OFFSET UNITYSDK_OFFSET(0xB757AC0)
#define CLASS_1_2C04610D4A58FBF2_SET_BOUNDSOCCLUDERFORJOB_OFFSET UNITYSDK_OFFSET(0xB75A2A0)
#define CLASS_1_2C04610D4A58FBF2__CTOR_OFFSET UNITYSDK_OFFSET(0xB7578B0)
...
public:
	...
	{
		return (::Class_1_2C04610D4A58FBF2**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2C04610D4A58FBF2_TypeDefinitionIndex)->GetStaticField(0x67090);
	}
	// static const ::System::Int32 OHBJOEKJBAC = 0x4; // 0x0
	::Class_1_D2B8D50DD9833CFC* _BoundsOccluderForJob_k__BackingField; // 0x10
	::RPG::Client::FiveDimManager* EEOHCCOCEDI; // 0x18
	::System::Collections::Generic::List_1<::Struct_2_8C28452846BC9CD5>* HFBCDHKLFGN; // 0x20
	::Il2CppArray<::System::Collections::Generic::List_1<::Struct_2_EC98B14B1B23001B>*>* ODKMIPIKMNE; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<::System::UInt32, ::System::UInt32, ::System::Int32>, ::System::Int32>* IALOMHHHMJK; // 0x30
	::System::Collections::Generic::List_1<::Struct_2_EC98B14B1B23001B>* IAJGIEJLKBL; // 0x38
