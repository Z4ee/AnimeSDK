...
#define CLASS_1_2C04610D4A58FBF2_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA4A8E70)
#define CLASS_1_2C04610D4A58FBF2_GET_BOUNDSOCCLUDERFORJOB_OFFSET UNITYSDK_OFFSET(0xA4AB820)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_0CC4BC19C602BCD0_OFFSET UNITYSDK_OFFSET(0xA4A9AA0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_3C092CF69374C63B_OFFSET UNITYSDK_OFFSET(0xA4AB1C0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_4B2C88022C29B618_OFFSET UNITYSDK_OFFSET(0xA4AB5E0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_61C61A4D5B1CAB1C_OFFSET UNITYSDK_OFFSET(0xA4AAB20)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_65D79DE7509E7805_OFFSET UNITYSDK_OFFSET(0xA4AA7F0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_66B06D14D5E4D654_OFFSET UNITYSDK_OFFSET(0xA4AAA80)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_6852DC894AC1E216_OFFSET UNITYSDK_OFFSET(0xA4A9930)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_7976BB22602FCA77_OFFSET UNITYSDK_OFFSET(0xA4A8FF0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_7E9AC3FFDA4606D5_OFFSET UNITYSDK_OFFSET(0xA4A8D90)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_805C56F44231AEF9_OFFSET UNITYSDK_OFFSET(0xA4A9B60)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_8E6AA668BCBFD16D_OFFSET UNITYSDK_OFFSET(0xA4A95E0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0xA4AA3F0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_9B94601409ACF78B_OFFSET UNITYSDK_OFFSET(0xA4AA9E0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_9DA79C3754CF9783_OFFSET UNITYSDK_OFFSET(0xA4AA440)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_A56385E6706FA723_OFFSET UNITYSDK_OFFSET(0xA4AACE0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_B10FB9597F17FCB4_OFFSET UNITYSDK_OFFSET(0xA4AA100)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_B93A9FB8A3E13C83_OFFSET UNITYSDK_OFFSET(0xA4A8ED0)
#define CLASS_1_2C04610D4A58FBF2_METHOD_1_DE2C4CD7BF3E857D_OFFSET UNITYSDK_OFFSET(0xA4A9040)
#define CLASS_1_2C04610D4A58FBF2_SET_BOUNDSOCCLUDERFORJOB_OFFSET UNITYSDK_OFFSET(0xA4AB830)
#define CLASS_1_2C04610D4A58FBF2__CTOR_OFFSET UNITYSDK_OFFSET(0xA4A8E30)

inline static constexpr unsigned int Class_1_2C04610D4A58FBF2_TypeDefinitionIndex = 56570;
...
public:
	...
	{
		return (::Class_1_2C04610D4A58FBF2**)Il2CppClass::FromTypeDefinitionIndex(Class_1_2C04610D4A58FBF2_TypeDefinitionIndex)->GetStaticField(0x5CC10);
	}
	// static const ::System::Int32 Field_1_1 = 0x4; // 0x0
	::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<::System::UInt32, ::System::UInt32, ::System::Int32>, ::System::Int32>* Field_1_2; // 0x10
	::Class_1_D2B8D50DD9833CFC* _BoundsOccluderForJob_k__BackingField; // 0x18
	::RPG::Client::FiveDimManager* Field_1_4; // 0x20
	::System::Collections::Generic::List_1<::Struct_2_8C28452846BC9CD5>* Field_1_5; // 0x28
	::Il2CppArray<::System::Collections::Generic::List_1<::Struct_2_EC98B14B1B23001B>*>* Field_1_6; // 0x30
	::System::Collections::Generic::List_1<::Struct_2_EC98B14B1B23001B>* Field_1_7; // 0x38
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_2C04610D4A58FBF2_METHOD_1_A56385E6706FA723_OFFSET))(this);
	}
