...
#define NAPWARNINGLINE_INIT_OFFSET UNITYSDK_OFFSET(0x1C9979E0)
#define NAPWARNINGLINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1C9976B0)
#define NAPWARNINGLINE_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1C998330)
#define NAPWARNINGLINE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C997370)
#define NAPWARNINGLINE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C9978C0)
#define NAPWARNINGLINE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1C997920)
#define NAPWARNINGLINE_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1C997830)
#define NAPWARNINGLINE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1C997430)
#define NAPWARNINGLINE_RECREATEMESH_OFFSET UNITYSDK_OFFSET(0x1C9982E0)
#define NAPWARNINGLINE_SYNCCHARACTERPOS_OFFSET UNITYSDK_OFFSET(0x1C998030)
#define NAPWARNINGLINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C9984D0)
#define NAPWARNINGLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C998480)

inline static constexpr unsigned int NapWarningLine_TypeDefinitionIndex = 27282;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapWarningLine_TypeDefinitionIndex)->GetStaticField(0x62B0);
	}
	static ::System::Int32* StaticGet__FrameXOffset()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapWarningLine_TypeDefinitionIndex)->GetStaticField(0x62B4);
	}
