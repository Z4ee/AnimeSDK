...
#define CLASS_2_EBA4A1090CE915B5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16867270)
#define CLASS_2_EBA4A1090CE915B5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16867310)
#define CLASS_2_EBA4A1090CE915B5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16867390)
#define CLASS_2_EBA4A1090CE915B5_TICK_OFFSET UNITYSDK_OFFSET(0x168672B0)
#define CLASS_2_EBA4A1090CE915B5__CTOR_OFFSET UNITYSDK_OFFSET(0x16867260)

inline static constexpr unsigned int Class_2_EBA4A1090CE915B5_TypeDefinitionIndex = 53698;

class Class_2_EBA4A1090CE915B5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TravelShipResetState* IGHAHBNLIJA; // 0x18
