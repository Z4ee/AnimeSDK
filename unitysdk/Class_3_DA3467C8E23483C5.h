...
#define CLASS_3_DA3467C8E23483C5_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x166CF170)
#define CLASS_3_DA3467C8E23483C5_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x166CF1F0)
#define CLASS_3_DA3467C8E23483C5_INVOKE_OFFSET UNITYSDK_OFFSET(0x166CEE10)
#define CLASS_3_DA3467C8E23483C5__CTOR_OFFSET UNITYSDK_OFFSET(0x166CEDF0)

inline static constexpr unsigned int Class_3_DA3467C8E23483C5_TypeDefinitionIndex = 28948;
