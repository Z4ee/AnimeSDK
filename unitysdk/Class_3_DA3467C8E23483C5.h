...
#define CLASS_3_DA3467C8E23483C5_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1C1A06F0)
#define CLASS_3_DA3467C8E23483C5_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1C1A0770)
#define CLASS_3_DA3467C8E23483C5_INVOKE_OFFSET UNITYSDK_OFFSET(0x1C1A06E0)
#define CLASS_3_DA3467C8E23483C5__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1A0670)
