...
#define CLASS_3_DA3467C8E23483C5_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17C1FDE0)
#define CLASS_3_DA3467C8E23483C5_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17C1FE60)
#define CLASS_3_DA3467C8E23483C5_INVOKE_OFFSET UNITYSDK_OFFSET(0x17C1FA80)
#define CLASS_3_DA3467C8E23483C5__CTOR_OFFSET UNITYSDK_OFFSET(0x17C1FA60)

inline static constexpr unsigned int Class_3_DA3467C8E23483C5_TypeDefinitionIndex = 34682;
