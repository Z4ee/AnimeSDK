...
#define CLASS_1_D808E3F47C1941B7_COMPARETO_OFFSET UNITYSDK_OFFSET(0x155D3070)
#define CLASS_1_D808E3F47C1941B7__CCTOR_OFFSET UNITYSDK_OFFSET(0x155D30F0)
#define CLASS_1_D808E3F47C1941B7__CTOR_OFFSET UNITYSDK_OFFSET(0x155D30E0)
...
public:
	...
	{
		return (::Class_1_D808E3F47C1941B7**)Il2CppClass::FromTypeDefinitionIndex(Class_1_D808E3F47C1941B7_TypeDefinitionIndex)->GetStaticField(0x126F0);
	}
	::Il2CppArray<::RPG::GameCore::SkillLayoutKey>* HHMKJMFNEPO; // 0x10
	::System::Int32 NALMBOOCCIN; // 0x18
	::System::Boolean NIFCBHHPIGD; // 0x1C
	::System::Boolean EMLCJLOIMDK; // 0x1D
