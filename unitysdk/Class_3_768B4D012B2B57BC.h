...
#define CLASS_3_768B4D012B2B57BC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC471150)
#define CLASS_3_768B4D012B2B57BC__CTOR_OFFSET UNITYSDK_OFFSET(0xC471120)

inline static constexpr unsigned int Class_3_768B4D012B2B57BC_TypeDefinitionIndex = 54496;
