...
#define CLASS_3_768B4D012B2B57BC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x18457680)
#define CLASS_3_768B4D012B2B57BC__CTOR_OFFSET UNITYSDK_OFFSET(0x18457650)

inline static constexpr unsigned int Class_3_768B4D012B2B57BC_TypeDefinitionIndex = 55720;
