...
#define CLASS_1_3001A102CF1F3847__CTOR_OFFSET UNITYSDK_OFFSET(0x1C436310)
...
{
public:
	::RPG::GameCore::ChenLingDamageType HODMHEGIDOF; // 0x10
	::System::Int32 CCKOKPOPKKK; // 0x14
	::System::Boolean NFJCFJABEBD; // 0x18
