...
#define CLASS_2_75BE1C9CBBDB2079_DISPOSE_OFFSET UNITYSDK_OFFSET(0xC0CFF20)
#define CLASS_2_75BE1C9CBBDB2079_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xC0CFF60)
#define CLASS_2_75BE1C9CBBDB2079_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xC0D0010)
#define CLASS_2_75BE1C9CBBDB2079_TICK_OFFSET UNITYSDK_OFFSET(0xC0D0060)
#define CLASS_2_75BE1C9CBBDB2079__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CFF10)

inline static constexpr unsigned int Class_2_75BE1C9CBBDB2079_TypeDefinitionIndex = 54381;

class Class_2_75BE1C9CBBDB2079 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::FinishFirstPerformance* Field_2_1; // 0x18
