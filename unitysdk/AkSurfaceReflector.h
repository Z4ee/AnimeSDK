...
#define AKSURFACEREFLECTOR_ADDGEOMETRYSET_OFFSET UNITYSDK_OFFSET(0x1B6DAE90)
#define AKSURFACEREFLECTOR_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6DAD10)
#define AKSURFACEREFLECTOR_GETAKGEOMETRYSETID_OFFSET UNITYSDK_OFFSET(0x1B6DAC90)
#define AKSURFACEREFLECTOR_GETID_OFFSET UNITYSDK_OFFSET(0x1B6D6ED0)
#define AKSURFACEREFLECTOR_GET_ACOUSTICTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B6DB3F0)
#define AKSURFACEREFLECTOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B6DAE40)
#define AKSURFACEREFLECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B6DADD0)
#define AKSURFACEREFLECTOR_REMOVEGEOMETRYSET_OFFSET UNITYSDK_OFFSET(0x1B6DAB10)
#define AKSURFACEREFLECTOR_REMOVEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x1B6DA980)
#define AKSURFACEREFLECTOR_SETASSOCIATEDROOM_OFFSET UNITYSDK_OFFSET(0x1B6DA450)
#define AKSURFACEREFLECTOR_SETGEOMETRYFROMMESH_OFFSET UNITYSDK_OFFSET(0x1B6D7080)
#define AKSURFACEREFLECTOR_SETGEOMETRY_OFFSET UNITYSDK_OFFSET(0x1B6DA5A0)
#define AKSURFACEREFLECTOR_SET_ACOUSTICTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B6DB450)
#define AKSURFACEREFLECTOR_UPDATEGEOMETRY_OFFSET UNITYSDK_OFFSET(0x1B6DA550)
#define AKSURFACEREFLECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DB660)

inline static constexpr unsigned int AkSurfaceReflector_TypeDefinitionIndex = 42153;
