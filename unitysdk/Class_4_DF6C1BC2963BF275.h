...
#define CLASS_4_DF6C1BC2963BF275_GETDYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x1D0DC900)
#define CLASS_4_DF6C1BC2963BF275_METHOD_4_0C2DE072D09B1F26_OFFSET UNITYSDK_OFFSET(0x1D0DC6B0)
#define CLASS_4_DF6C1BC2963BF275_METHOD_4_61ACBD6DF6FE15E4_OFFSET UNITYSDK_OFFSET(0x1D0DC5D0)
#define CLASS_4_DF6C1BC2963BF275__CTOR_OFFSET UNITYSDK_OFFSET(0x1D0DC650)
...
{
public:
	::RPG::GameCore::TargetEvaluator* OLPAJJAEEHH; // 0x18
	::RPG::GameCore::DynamicFloat* CKFBELANALF; // 0x20
	::System::String* FHLJGDGMMHK; // 0x28
	::RPG::GameCore::DynamicValueContextScope AMEKHLANFKP; // 0x30
	::RPG::GameCore::HPDetailParamType IMOPHAJMIFO; // 0x34
