...
#define CLASS_2_4BED51C5AFCE1FC2_DISPOSE_OFFSET UNITYSDK_OFFSET(0x152BFE80)
#define CLASS_2_4BED51C5AFCE1FC2_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x152BFEC0)
#define CLASS_2_4BED51C5AFCE1FC2_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x152C0260)
#define CLASS_2_4BED51C5AFCE1FC2_TICK_OFFSET UNITYSDK_OFFSET(0x152C02B0)
#define CLASS_2_4BED51C5AFCE1FC2__CTOR_OFFSET UNITYSDK_OFFSET(0x152BFE70)
...
public:
	...
	::RPG::GameCore::CharacterChangePhase* OFKGLJOAMLD; // 0x20
