...
#define DEST_MATH_MATHFEX_CARTESIANTOCYLINDRICAL_OFFSET UNITYSDK_OFFSET(0x1B6AAD00)
#define DEST_MATH_MATHFEX_CARTESIANTOPOLAR_OFFSET UNITYSDK_OFFSET(0x1B6AA9B0)
#define DEST_MATH_MATHFEX_CARTESIANTOSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1B6AAB20)
#define DEST_MATH_MATHFEX_COSINTERP_OFFSET UNITYSDK_OFFSET(0x1B6AA700)
#define DEST_MATH_MATHFEX_CURVEINTERP_OFFSET UNITYSDK_OFFSET(0x1B6AA870)
#define DEST_MATH_MATHFEX_CYLINDRICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1B6AAE00)
#define DEST_MATH_MATHFEX_EVALCUBIC_OFFSET UNITYSDK_OFFSET(0x1B6AA450)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN2D_OFFSET UNITYSDK_OFFSET(0x1B6AA5B0)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN_OFFSET UNITYSDK_OFFSET(0x1B6AA570)
#define DEST_MATH_MATHFEX_EVALINVCUBIC_OFFSET UNITYSDK_OFFSET(0x1B6AA460)
#define DEST_MATH_MATHFEX_EVALINVSQUARED_OFFSET UNITYSDK_OFFSET(0x1B6AA430)
#define DEST_MATH_MATHFEX_EVALOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1B6AA4B0)
#define DEST_MATH_MATHFEX_EVALQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1B6AA470)
#define DEST_MATH_MATHFEX_EVALSIGMOID_OFFSET UNITYSDK_OFFSET(0x1B6AA490)
#define DEST_MATH_MATHFEX_EVALSMOOTHOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1B6AA500)
#define DEST_MATH_MATHFEX_EVALSQUARED_OFFSET UNITYSDK_OFFSET(0x1B6AA420)
#define DEST_MATH_MATHFEX_FUNCINTERP_OFFSET UNITYSDK_OFFSET(0x1B6AA8D0)
#define DEST_MATH_MATHFEX_INVSQRT_OFFSET UNITYSDK_OFFSET(0x1B6A6A60)
#define DEST_MATH_MATHFEX_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1B6AA640)
#define DEST_MATH_MATHFEX_LERP_OFFSET UNITYSDK_OFFSET(0x1B6AA610)
#define DEST_MATH_MATHFEX_NEARZERO_OFFSET UNITYSDK_OFFSET(0x1B6AA9A0)
#define DEST_MATH_MATHFEX_NEAR_OFFSET UNITYSDK_OFFSET(0x1B6AA980)
#define DEST_MATH_MATHFEX_POLARTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1B6AAAB0)
#define DEST_MATH_MATHFEX_SIGMOIDINTERP_OFFSET UNITYSDK_OFFSET(0x1B6AA650)
#define DEST_MATH_MATHFEX_SININTERP_OFFSET UNITYSDK_OFFSET(0x1B6AA6A0)
#define DEST_MATH_MATHFEX_SPHERICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1B6AAC50)
#define DEST_MATH_MATHFEX_WOBBLEINTERP_OFFSET UNITYSDK_OFFSET(0x1B6AA770)

namespace Dest::Math
{
	inline static constexpr unsigned int Mathfex_TypeDefinitionIndex = 33176;
