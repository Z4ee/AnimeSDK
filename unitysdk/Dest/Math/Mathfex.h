...
#define DEST_MATH_MATHFEX_CARTESIANTOCYLINDRICAL_OFFSET UNITYSDK_OFFSET(0x1DAADDD0)
#define DEST_MATH_MATHFEX_CARTESIANTOPOLAR_OFFSET UNITYSDK_OFFSET(0x1DAADA80)
#define DEST_MATH_MATHFEX_CARTESIANTOSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1DAADBF0)
#define DEST_MATH_MATHFEX_COSINTERP_OFFSET UNITYSDK_OFFSET(0x1DAAD7D0)
#define DEST_MATH_MATHFEX_CURVEINTERP_OFFSET UNITYSDK_OFFSET(0x1DAAD940)
#define DEST_MATH_MATHFEX_CYLINDRICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1DAADED0)
#define DEST_MATH_MATHFEX_EVALCUBIC_OFFSET UNITYSDK_OFFSET(0x1DAAD520)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN2D_OFFSET UNITYSDK_OFFSET(0x1DAAD680)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN_OFFSET UNITYSDK_OFFSET(0x1DAAD640)
#define DEST_MATH_MATHFEX_EVALINVCUBIC_OFFSET UNITYSDK_OFFSET(0x1DAAD530)
#define DEST_MATH_MATHFEX_EVALINVSQUARED_OFFSET UNITYSDK_OFFSET(0x1DAAD500)
#define DEST_MATH_MATHFEX_EVALOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1DAAD580)
#define DEST_MATH_MATHFEX_EVALQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1DAAD540)
#define DEST_MATH_MATHFEX_EVALSIGMOID_OFFSET UNITYSDK_OFFSET(0x1DAAD560)
#define DEST_MATH_MATHFEX_EVALSMOOTHOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1DAAD5D0)
#define DEST_MATH_MATHFEX_EVALSQUARED_OFFSET UNITYSDK_OFFSET(0x1DAAD4F0)
#define DEST_MATH_MATHFEX_FUNCINTERP_OFFSET UNITYSDK_OFFSET(0x1DAAD9A0)
#define DEST_MATH_MATHFEX_INVSQRT_OFFSET UNITYSDK_OFFSET(0x1DAA9B90)
#define DEST_MATH_MATHFEX_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1DAAD710)
#define DEST_MATH_MATHFEX_LERP_OFFSET UNITYSDK_OFFSET(0x1DAAD6E0)
#define DEST_MATH_MATHFEX_NEARZERO_OFFSET UNITYSDK_OFFSET(0x1DAADA70)
#define DEST_MATH_MATHFEX_NEAR_OFFSET UNITYSDK_OFFSET(0x1DAADA50)
#define DEST_MATH_MATHFEX_POLARTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1DAADB80)
#define DEST_MATH_MATHFEX_SIGMOIDINTERP_OFFSET UNITYSDK_OFFSET(0x1DAAD720)
#define DEST_MATH_MATHFEX_SININTERP_OFFSET UNITYSDK_OFFSET(0x1DAAD770)
#define DEST_MATH_MATHFEX_SPHERICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1DAADD20)
#define DEST_MATH_MATHFEX_WOBBLEINTERP_OFFSET UNITYSDK_OFFSET(0x1DAAD840)

namespace Dest::Math
{
	inline static constexpr unsigned int Mathfex_TypeDefinitionIndex = 34739;
