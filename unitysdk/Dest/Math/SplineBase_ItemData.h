...
#define DEST_MATH_SPLINEBASE_ITEMDATA_ENSURERENDERPOINTSVALIDITY_OFFSET UNITYSDK_OFFSET(0x1F7F97E0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALFIRSTDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1F7F9DE0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1F7FA0A0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_OFFSET UNITYSDK_OFFSET(0x1F7FA020)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1F7F9D80)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1F7F9E40)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSPEED_OFFSET UNITYSDK_OFFSET(0x1F7F9EC0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1F7F9F70)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTHIRDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1F7F9E90)
#define DEST_MATH_SPLINEBASE_ITEMDATA_PROCESSLENGTH_OFFSET UNITYSDK_OFFSET(0x1F7FA130)
#define DEST_MATH_SPLINEBASE_ITEMDATA_UPDATERENDERPOINTS_OFFSET UNITYSDK_OFFSET(0x1F7F9840)
#define DEST_MATH_SPLINEBASE_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7FA1D0)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_ItemData_TypeDefinitionIndex = 35456;
