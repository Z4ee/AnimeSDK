...
#define DEST_MATH_SPLINEBASE_ITEMDATA_ENSURERENDERPOINTSVALIDITY_OFFSET UNITYSDK_OFFSET(0x1E3A6190)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALFIRSTDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1E3A6790)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1E3A6A90)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_OFFSET UNITYSDK_OFFSET(0x1E3A6A10)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1E3A6730)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1E3A67F0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSPEED_OFFSET UNITYSDK_OFFSET(0x1E3A6870)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1E3A6930)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTHIRDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1E3A6840)
#define DEST_MATH_SPLINEBASE_ITEMDATA_PROCESSLENGTH_OFFSET UNITYSDK_OFFSET(0x1E3A6B20)
#define DEST_MATH_SPLINEBASE_ITEMDATA_UPDATERENDERPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3A61F0)
#define DEST_MATH_SPLINEBASE_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3A6BC0)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_ItemData_TypeDefinitionIndex = 34797;
