...
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT2_OFFSET UNITYSDK_OFFSET(0x1BB46B50)
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT3_OFFSET UNITYSDK_OFFSET(0x1BB48030)
#define DEST_MATH_APPROXIMATION_HEIGHTLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1BB474B0)
#define DEST_MATH_APPROXIMATION_HEIGHTPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1BB48E60)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1BB47B90)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1BB49A50)
#define DEST_MATH_APPROXIMATION_LEASTSSQUARESLINEFIT3_OFFSET UNITYSDK_OFFSET(0x1BB488A0)

namespace Dest::Math
{
	inline static constexpr unsigned int Approximation_TypeDefinitionIndex = 33099;
