...
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT2_OFFSET UNITYSDK_OFFSET(0x1F273690)
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT3_OFFSET UNITYSDK_OFFSET(0x1F274B70)
#define DEST_MATH_APPROXIMATION_HEIGHTLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1F273FE0)
#define DEST_MATH_APPROXIMATION_HEIGHTPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1F2759B0)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1F2746C0)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1F2765D0)
#define DEST_MATH_APPROXIMATION_LEASTSSQUARESLINEFIT3_OFFSET UNITYSDK_OFFSET(0x1F275400)

namespace Dest::Math
{
	inline static constexpr unsigned int Approximation_TypeDefinitionIndex = 35321;
