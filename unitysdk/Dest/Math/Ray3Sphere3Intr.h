...
namespace Dest::Math
{
	inline static constexpr unsigned int Ray3Sphere3Intr_TypeDefinitionIndex = 34721;

	struct alignas(4) Ray3Sphere3Intr
	{
		...
		::System::Single RayParameter0; // 0x30
		::System::Single RayParameter1; // 0x34
	};
}
