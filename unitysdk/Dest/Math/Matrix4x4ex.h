...
#define DEST_MATH_MATRIX4X4EX_CALCDETERMINANT_OFFSET UNITYSDK_OFFSET(0x1DE9D410)
#define DEST_MATH_MATRIX4X4EX_COPYMATRIX_OFFSET UNITYSDK_OFFSET(0x1DE9DF30)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONANGLEAXIS_OFFSET UNITYSDK_OFFSET(0x1DE9CB60)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONANGLEUNITAXIS_OFFSET UNITYSDK_OFFSET(0x1DE9CD30)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONEULER_1_OFFSET UNITYSDK_OFFSET(0x1DE9C590)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONEULER_2_OFFSET UNITYSDK_OFFSET(0x1DE9C7A0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONEULER_OFFSET UNITYSDK_OFFSET(0x1DE9C380)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONFROMCOLUMNS_1_OFFSET UNITYSDK_OFFSET(0x1DEA0AE0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONFROMCOLUMNS_OFFSET UNITYSDK_OFFSET(0x1DEA0A10)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONX_OFFSET UNITYSDK_OFFSET(0x1DE9C9B0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONY_OFFSET UNITYSDK_OFFSET(0x1DE9CA40)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1DE9CAD0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATION_1_OFFSET UNITYSDK_OFFSET(0x1DE9D100)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATION_OFFSET UNITYSDK_OFFSET(0x1DE9CEA0)
#define DEST_MATH_MATRIX4X4EX_CREATERT_1_OFFSET UNITYSDK_OFFSET(0x1DEA0310)
#define DEST_MATH_MATRIX4X4EX_CREATERT_2_OFFSET UNITYSDK_OFFSET(0x1DEA04D0)
#define DEST_MATH_MATRIX4X4EX_CREATERT_3_OFFSET UNITYSDK_OFFSET(0x1DEA0740)
#define DEST_MATH_MATRIX4X4EX_CREATERT_OFFSET UNITYSDK_OFFSET(0x1DEA0150)
#define DEST_MATH_MATRIX4X4EX_CREATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1DE9C310)
#define DEST_MATH_MATRIX4X4EX_CREATESCALE_2_OFFSET UNITYSDK_OFFSET(0x1DE9C350)
#define DEST_MATH_MATRIX4X4EX_CREATESCALE_OFFSET UNITYSDK_OFFSET(0x1DE9C2D0)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWDIRECTIONAL_1_OFFSET UNITYSDK_OFFSET(0x1DEA0CF0)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWDIRECTIONAL_OFFSET UNITYSDK_OFFSET(0x1DEA0BB0)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWPOINT_1_OFFSET UNITYSDK_OFFSET(0x1DEA0F70)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWPOINT_OFFSET UNITYSDK_OFFSET(0x1DEA0E20)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOW_1_OFFSET UNITYSDK_OFFSET(0x1DEA1230)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOW_OFFSET UNITYSDK_OFFSET(0x1DEA10A0)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_1_OFFSET UNITYSDK_OFFSET(0x1DE9EEC0)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_2_OFFSET UNITYSDK_OFFSET(0x1DE9F120)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_3_OFFSET UNITYSDK_OFFSET(0x1DE9F350)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_4_OFFSET UNITYSDK_OFFSET(0x1DE9F580)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_5_OFFSET UNITYSDK_OFFSET(0x1DE9F8A0)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_6_OFFSET UNITYSDK_OFFSET(0x1DE9FB80)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_7_OFFSET UNITYSDK_OFFSET(0x1DE9FEB0)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_OFFSET UNITYSDK_OFFSET(0x1DE9EC50)
#define DEST_MATH_MATRIX4X4EX_CREATEST_1_OFFSET UNITYSDK_OFFSET(0x1DEA09B0)
#define DEST_MATH_MATRIX4X4EX_CREATEST_OFFSET UNITYSDK_OFFSET(0x1DEA0950)
#define DEST_MATH_MATRIX4X4EX_CREATETRANSLATION_1_OFFSET UNITYSDK_OFFSET(0x1DE9C290)
#define DEST_MATH_MATRIX4X4EX_CREATETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1DE9C240)
#define DEST_MATH_MATRIX4X4EX_INVERSE_1_OFFSET UNITYSDK_OFFSET(0x1DE9D9E0)
#define DEST_MATH_MATRIX4X4EX_INVERSE_OFFSET UNITYSDK_OFFSET(0x1DE9D580)
#define DEST_MATH_MATRIX4X4EX_MULTIPLYLEFT_OFFSET UNITYSDK_OFFSET(0x1DE9E7E0)
#define DEST_MATH_MATRIX4X4EX_MULTIPLYRIGHT_OFFSET UNITYSDK_OFFSET(0x1DE9E520)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1DE9EA90)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x1DE9EAC0)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_3_OFFSET UNITYSDK_OFFSET(0x1DE9EB70)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_4_OFFSET UNITYSDK_OFFSET(0x1DE9EBE0)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1DE9DFA0)
#define DEST_MATH_MATRIX4X4EX_QUATERNIONTOROTATIONMATRIX_1_OFFSET UNITYSDK_OFFSET(0x1DE9C100)
#define DEST_MATH_MATRIX4X4EX_QUATERNIONTOROTATIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1DE9BFC0)
#define DEST_MATH_MATRIX4X4EX_ROTATIONMATRIXTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1DE9BF30)
#define DEST_MATH_MATRIX4X4EX_TRANSPOSE_1_OFFSET UNITYSDK_OFFSET(0x1DE9D370)
#define DEST_MATH_MATRIX4X4EX_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1DE9D2F0)
#define DEST_MATH_MATRIX4X4EX__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEA1390)

namespace Dest::Math
{
	inline static constexpr unsigned int Matrix4x4ex_TypeDefinitionIndex = 34740;
	...
	public:
		...
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(Matrix4x4ex_TypeDefinitionIndex)->GetStaticField(0x8550);
		}
