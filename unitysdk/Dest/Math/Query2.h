...
#define DEST_MATH_QUERY2_DET2_OFFSET UNITYSDK_OFFSET(0x1C4A5110)
#define DEST_MATH_QUERY2_DET3_OFFSET UNITYSDK_OFFSET(0x1C4A54C0)
#define DEST_MATH_QUERY2_DOT_OFFSET UNITYSDK_OFFSET(0x1C4A5550)
#define DEST_MATH_QUERY2_TOCIRCUMCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1C4A52E0)
#define DEST_MATH_QUERY2_TOCIRCUMCIRCLE_OFFSET UNITYSDK_OFFSET(0x1C4A52A0)
#define DEST_MATH_QUERY2_TOLINE_1_OFFSET UNITYSDK_OFFSET(0x1C4A5060)
#define DEST_MATH_QUERY2_TOLINE_OFFSET UNITYSDK_OFFSET(0x1C4A5020)
#define DEST_MATH_QUERY2_TOTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1C4A5200)
#define DEST_MATH_QUERY2_TOTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1C4A5130)
#define DEST_MATH_QUERY2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4A5570)
#define DEST_MATH_QUERY2__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A5010)

namespace Dest::Math
{
	inline static constexpr unsigned int Query2_TypeDefinitionIndex = 33223;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query2_TypeDefinitionIndex)->GetStaticField(0x8110);
		}
