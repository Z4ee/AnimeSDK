...
#define DEST_MATH_ODEMIDPOINT_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1E88A340)
#define DEST_MATH_ODEMIDPOINT_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1E88A350)
#define DEST_MATH_ODEMIDPOINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E88A420)
#define DEST_MATH_ODEMIDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E88A370)

namespace Dest::Math
{
	inline static constexpr unsigned int OdeMidpoint_TypeDefinitionIndex = 34758;
