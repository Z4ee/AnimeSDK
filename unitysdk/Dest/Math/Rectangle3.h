...
#define DEST_MATH_RECTANGLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x9A92D0)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x9A92B0)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x9A92C0)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x9A91F0)
#define DEST_MATH_RECTANGLE3_CREATEFROMCCWPOINTS_OFFSET UNITYSDK_OFFSET(0x1BB516F0)
#define DEST_MATH_RECTANGLE3_CREATEFROMCWPOINTS_OFFSET UNITYSDK_OFFSET(0x1BB519C0)
#define DEST_MATH_RECTANGLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9A92F0)
#define DEST_MATH_RECTANGLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9A9330)
#define DEST_MATH_RECTANGLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9A9390)
#define DEST_MATH_RECTANGLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A90E0)
#define DEST_MATH_RECTANGLE3__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8FC0)

namespace Dest::Math
{
	inline static constexpr unsigned int Rectangle3_TypeDefinitionIndex = 33218;
