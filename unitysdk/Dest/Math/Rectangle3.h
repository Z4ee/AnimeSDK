...
#define DEST_MATH_RECTANGLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0xA4C130)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0xA4C110)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0xA4C120)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0xA4C050)
#define DEST_MATH_RECTANGLE3_CREATEFROMCCWPOINTS_OFFSET UNITYSDK_OFFSET(0x1DECB080)
#define DEST_MATH_RECTANGLE3_CREATEFROMCWPOINTS_OFFSET UNITYSDK_OFFSET(0x1DECB350)
#define DEST_MATH_RECTANGLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA4C150)
#define DEST_MATH_RECTANGLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0xA4C190)
#define DEST_MATH_RECTANGLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA4C1F0)
#define DEST_MATH_RECTANGLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA4BF40)
#define DEST_MATH_RECTANGLE3__CTOR_OFFSET UNITYSDK_OFFSET(0xA4BE20)

namespace Dest::Math
{
	inline static constexpr unsigned int Rectangle3_TypeDefinitionIndex = 34781;
