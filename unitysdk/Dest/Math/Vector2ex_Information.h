...
#define DEST_MATH_VECTOR2EX_INFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E576C30)

namespace Dest::Math
{
	inline static constexpr unsigned int Vector2ex_Information_TypeDefinitionIndex = 34744;
	...
	public:
		...
		::UnityEngine::Vector2 Origin; // 0x20
		::UnityEngine::Vector2 Max; // 0x28
		::System::Single MaxRange; // 0x30
		::System::Int32 Dimension; // 0x34
		::System::Boolean ExtremeCCW; // 0x38
