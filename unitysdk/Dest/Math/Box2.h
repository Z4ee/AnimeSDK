...
#define DEST_MATH_BOX2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x986C20)
#define DEST_MATH_BOX2_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x986C00)
#define DEST_MATH_BOX2_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x986C10)
#define DEST_MATH_BOX2_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x986B20)
#define DEST_MATH_BOX2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x986CD0)
#define DEST_MATH_BOX2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x986CC0)
#define DEST_MATH_BOX2_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1B6A2760)
#define DEST_MATH_BOX2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x986C40)
#define DEST_MATH_BOX2_GETAXIS_OFFSET UNITYSDK_OFFSET(0x986AB0)
#define DEST_MATH_BOX2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x986CF0)
#define DEST_MATH_BOX2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x986CE0)
#define DEST_MATH_BOX2_PROJECT_OFFSET UNITYSDK_OFFSET(0x986C80)
#define DEST_MATH_BOX2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x986D20)
#define DEST_MATH_BOX2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3E8500)
#define DEST_MATH_BOX2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x986980)
#define DEST_MATH_BOX2__CTOR_3_OFFSET UNITYSDK_OFFSET(0x986A10)
#define DEST_MATH_BOX2__CTOR_OFFSET UNITYSDK_OFFSET(0x986950)

namespace Dest::Math
{
	inline static constexpr unsigned int Box2_TypeDefinitionIndex = 33201;
