...
#define DEST_MATH_BOX2_CALCAREA_OFFSET UNITYSDK_OFFSET(0xA2B3A0)
#define DEST_MATH_BOX2_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0xA2B380)
#define DEST_MATH_BOX2_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0xA2B390)
#define DEST_MATH_BOX2_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0xA2B2A0)
#define DEST_MATH_BOX2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0xA2B450)
#define DEST_MATH_BOX2_CONTAINS_OFFSET UNITYSDK_OFFSET(0xA2B440)
#define DEST_MATH_BOX2_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1DAA5890)
#define DEST_MATH_BOX2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA2B3C0)
#define DEST_MATH_BOX2_GETAXIS_OFFSET UNITYSDK_OFFSET(0xA2B230)
#define DEST_MATH_BOX2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0xA2B470)
#define DEST_MATH_BOX2_INCLUDE_OFFSET UNITYSDK_OFFSET(0xA2B460)
#define DEST_MATH_BOX2_PROJECT_OFFSET UNITYSDK_OFFSET(0xA2B400)
#define DEST_MATH_BOX2_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA2B4A0)
#define DEST_MATH_BOX2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x32DFA0)
#define DEST_MATH_BOX2__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA2B100)
#define DEST_MATH_BOX2__CTOR_3_OFFSET UNITYSDK_OFFSET(0xA2B190)
#define DEST_MATH_BOX2__CTOR_OFFSET UNITYSDK_OFFSET(0xA2B0D0)

namespace Dest::Math
{
	inline static constexpr unsigned int Box2_TypeDefinitionIndex = 34764;
