...
#define DEST_MATH_CUBICSPLINE3_ADDVERTEXFIRST_OFFSET UNITYSDK_OFFSET(0x1C3AD750)
#define DEST_MATH_CUBICSPLINE3_ADDVERTEXLAST_OFFSET UNITYSDK_OFFSET(0x1C3AD810)
#define DEST_MATH_CUBICSPLINE3_BUILDSPLINE_OFFSET UNITYSDK_OFFSET(0x1C3AC0B0)
#define DEST_MATH_CUBICSPLINE3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1C3AD990)
#define DEST_MATH_CUBICSPLINE3_CREATECLOSEDSPLINE_OFFSET UNITYSDK_OFFSET(0x1C3ACBD0)
#define DEST_MATH_CUBICSPLINE3_CREATEOPENEDSPLINE_OFFSET UNITYSDK_OFFSET(0x1C3AC5A0)
#define DEST_MATH_CUBICSPLINE3_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1C3AC1A0)
#define DEST_MATH_CUBICSPLINE3_CREATE_OFFSET UNITYSDK_OFFSET(0x1C3AC0F0)
#define DEST_MATH_CUBICSPLINE3_GETVERTEX_OFFSET UNITYSDK_OFFSET(0x1C3ADB80)
#define DEST_MATH_CUBICSPLINE3_GET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1C3AC050)
#define DEST_MATH_CUBICSPLINE3_INSERTAFTER_OFFSET UNITYSDK_OFFSET(0x1C3ADAB0)
#define DEST_MATH_CUBICSPLINE3_INSERTBEFORE_OFFSET UNITYSDK_OFFSET(0x1C3AD9E0)
#define DEST_MATH_CUBICSPLINE3_REMOVEVERTEX_OFFSET UNITYSDK_OFFSET(0x1C3AD8D0)
#define DEST_MATH_CUBICSPLINE3_SETVERTEX_OFFSET UNITYSDK_OFFSET(0x1C3ADC00)
#define DEST_MATH_CUBICSPLINE3_SET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1C3AC060)
#define DEST_MATH_CUBICSPLINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3ADCB0)

namespace Dest::Math
{
	inline static constexpr unsigned int CubicSpline3_TypeDefinitionIndex = 33228;
