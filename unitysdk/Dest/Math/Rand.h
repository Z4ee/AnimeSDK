...
#define DEST_MATH_RAND_GETSTATE_OFFSET UNITYSDK_OFFSET(0x1E753370)
#define DEST_MATH_RAND_INCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1E752A20)
#define DEST_MATH_RAND_INCIRCLE_OFFSET UNITYSDK_OFFSET(0x1E754CC0)
#define DEST_MATH_RAND_INCUBE_OFFSET UNITYSDK_OFFSET(0x1E754090)
#define DEST_MATH_RAND_INSPHERE_OFFSET UNITYSDK_OFFSET(0x1E754E80)
#define DEST_MATH_RAND_INSQUARE_OFFSET UNITYSDK_OFFSET(0x1E753AA0)
#define DEST_MATH_RAND_INTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1E755280)
#define DEST_MATH_RAND_INTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1E755150)
#define DEST_MATH_RAND_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x1E7536A0)
#define DEST_MATH_RAND_NEXTBYTE_OFFSET UNITYSDK_OFFSET(0x1E7536E0)
#define DEST_MATH_RAND_NEXTDOUBLE_1_OFFSET UNITYSDK_OFFSET(0x1E753580)
#define DEST_MATH_RAND_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1E753530)
#define DEST_MATH_RAND_NEXTFLOAT_1_OFFSET UNITYSDK_OFFSET(0x1E752F60)
#define DEST_MATH_RAND_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x1E753650)
#define DEST_MATH_RAND_NEXTINTINCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1E7534A0)
#define DEST_MATH_RAND_NEXTINT_1_OFFSET UNITYSDK_OFFSET(0x1E753030)
#define DEST_MATH_RAND_NEXTINT_2_OFFSET UNITYSDK_OFFSET(0x1E7533B0)
#define DEST_MATH_RAND_NEXTINT_OFFSET UNITYSDK_OFFSET(0x1E753310)
#define DEST_MATH_RAND_NEXTPOSITIVEINT_OFFSET UNITYSDK_OFFSET(0x1E7534B0)
#define DEST_MATH_RAND_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x1E7534F0)
#define DEST_MATH_RAND_ONCIRCLE_OFFSET UNITYSDK_OFFSET(0x1E754DD0)
#define DEST_MATH_RAND_ONCUBE_OFFSET UNITYSDK_OFFSET(0x1E7542D0)
#define DEST_MATH_RAND_ONSPHERE_OFFSET UNITYSDK_OFFSET(0x1E755010)
#define DEST_MATH_RAND_ONSQUARE_OFFSET UNITYSDK_OFFSET(0x1E753C30)
#define DEST_MATH_RAND_RANDOMANGLEDEGREES_OFFSET UNITYSDK_OFFSET(0x1E753A50)
#define DEST_MATH_RAND_RANDOMANGLERADIANS_OFFSET UNITYSDK_OFFSET(0x1E753A00)
#define DEST_MATH_RAND_RANDOMCOLOR32OPAQUE_OFFSET UNITYSDK_OFFSET(0x1E7538C0)
#define DEST_MATH_RAND_RANDOMCOLOR32TRANSPARENT_OFFSET UNITYSDK_OFFSET(0x1E753950)
#define DEST_MATH_RAND_RANDOMCOLOROPAQUE_OFFSET UNITYSDK_OFFSET(0x1E753720)
#define DEST_MATH_RAND_RANDOMCOLORTRANSPARENT_OFFSET UNITYSDK_OFFSET(0x1E7537E0)
#define DEST_MATH_RAND_RANDOMROTATION_OFFSET UNITYSDK_OFFSET(0x1E7553B0)
#define DEST_MATH_RAND_RESETSEED_OFFSET UNITYSDK_OFFSET(0x1E753350)
#define DEST_MATH_RAND_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1E753390)
#define DEST_MATH_RAND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E753090)
#define DEST_MATH_RAND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E753210)
#define DEST_MATH_RAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1E753230)

namespace Dest::Math
{
	inline static constexpr unsigned int Rand_TypeDefinitionIndex = 34742;
	...
	public:
		...
		{
			return (::Dest::Math::Rand**)Il2CppClass::FromTypeDefinitionIndex(Rand_TypeDefinitionIndex)->GetStaticField(0x27B80);
		}
		static ::Dest::Math::Rand** StaticGet__seedGenerator()
		{
			return (::Dest::Math::Rand**)Il2CppClass::FromTypeDefinitionIndex(Rand_TypeDefinitionIndex)->GetStaticField(0x27B88);
		}
