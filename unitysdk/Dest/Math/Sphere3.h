...
#define DEST_MATH_SPHERE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x9CA940)
#define DEST_MATH_SPHERE3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x9CA960)
#define DEST_MATH_SPHERE3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x9CABC0)
#define DEST_MATH_SPHERE3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9CABC0)
#define DEST_MATH_SPHERE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1C228AA0)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAAB_1_OFFSET UNITYSDK_OFFSET(0x1C227D80)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAAB_OFFSET UNITYSDK_OFFSET(0x1C227AC0)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAVERAGE_1_OFFSET UNITYSDK_OFFSET(0x1C228680)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAVERAGE_OFFSET UNITYSDK_OFFSET(0x1C227F10)
#define DEST_MATH_SPHERE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1C228E30)
#define DEST_MATH_SPHERE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9CAA90)
#define DEST_MATH_SPHERE3_EVAL_OFFSET UNITYSDK_OFFSET(0x9CA980)
#define DEST_MATH_SPHERE3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x9CAD10)
#define DEST_MATH_SPHERE3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x9CAC10)
#define DEST_MATH_SPHERE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9CAB00)
#define DEST_MATH_SPHERE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9CAE30)
#define DEST_MATH_SPHERE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3D5CA0)
#define DEST_MATH_SPHERE3__CTOR_OFFSET UNITYSDK_OFFSET(0x3D5CA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Sphere3_TypeDefinitionIndex = 33220;
