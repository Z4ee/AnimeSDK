...
#define DEST_MATH_SPHERE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0xA675A0)
#define DEST_MATH_SPHERE3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0xA675C0)
#define DEST_MATH_SPHERE3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0xA67820)
#define DEST_MATH_SPHERE3_CONTAINS_OFFSET UNITYSDK_OFFSET(0xA67820)
#define DEST_MATH_SPHERE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1E574210)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAAB_1_OFFSET UNITYSDK_OFFSET(0x1E5734F0)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAAB_OFFSET UNITYSDK_OFFSET(0x1E573230)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAVERAGE_1_OFFSET UNITYSDK_OFFSET(0x1E573DF0)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAVERAGE_OFFSET UNITYSDK_OFFSET(0x1E573680)
#define DEST_MATH_SPHERE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1E5745A0)
#define DEST_MATH_SPHERE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA676F0)
#define DEST_MATH_SPHERE3_EVAL_OFFSET UNITYSDK_OFFSET(0xA675E0)
#define DEST_MATH_SPHERE3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0xA67970)
#define DEST_MATH_SPHERE3_INCLUDE_OFFSET UNITYSDK_OFFSET(0xA67870)
#define DEST_MATH_SPHERE3_PROJECT_OFFSET UNITYSDK_OFFSET(0xA67760)
#define DEST_MATH_SPHERE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA67A90)
#define DEST_MATH_SPHERE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x460B80)
#define DEST_MATH_SPHERE3__CTOR_OFFSET UNITYSDK_OFFSET(0x460B80)

namespace Dest::Math
{
	inline static constexpr unsigned int Sphere3_TypeDefinitionIndex = 34783;
