...
#define DEST_MATH_CONVEXHULL3_TRIANGLE_ATTACHTO_OFFSET UNITYSDK_OFFSET(0x1DAAC590)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_DETACHFROM_OFFSET UNITYSDK_OFFSET(0x1DAAD400)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_GETADJ_OFFSET UNITYSDK_OFFSET(0x1DAAD3D0)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_GETSIGN_OFFSET UNITYSDK_OFFSET(0x1DAAD350)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_GETV_OFFSET UNITYSDK_OFFSET(0x1DAAD490)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_SETADJ_OFFSET UNITYSDK_OFFSET(0x1DAAD4B0)
#define DEST_MATH_CONVEXHULL3_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAAC570)

namespace Dest::Math
{
	inline static constexpr unsigned int ConvexHull3_Triangle_TypeDefinitionIndex = 34673;
	...
	public:
		...
		::System::Int32 V2; // 0x30
		::System::Boolean OnStack; // 0x34
