...
#define DEST_MATH_VISUALDEBUG_DRAWAAB_1_OFFSET UNITYSDK_OFFSET(0x1E6096C0)
#define DEST_MATH_VISUALDEBUG_DRAWAAB_OFFSET UNITYSDK_OFFSET(0x1E6095B0)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_1_OFFSET UNITYSDK_OFFSET(0x1E609CD0)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_OFFSET UNITYSDK_OFFSET(0x1E609AB0)
#define DEST_MATH_VISUALDEBUG_DRAWCAPSULE_OFFSET UNITYSDK_OFFSET(0x1E60B5B0)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1E60A480)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_2_OFFSET UNITYSDK_OFFSET(0x1E60A580)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1E60A360)
#define DEST_MATH_VISUALDEBUG_DRAWFUNC_OFFSET UNITYSDK_OFFSET(0x1E60B2A0)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1E60A890)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1E60A790)
#define DEST_MATH_VISUALDEBUG_DRAWPLANE_OFFSET UNITYSDK_OFFSET(0x1E60AD80)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTSWITHSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1E6092D0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1E608C40)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1E608920)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_1_OFFSET UNITYSDK_OFFSET(0x1E6088A0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1E608820)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1E60B1A0)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_OFFSET UNITYSDK_OFFSET(0x1E60B0B0)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_1_OFFSET UNITYSDK_OFFSET(0x1E60AA60)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_OFFSET UNITYSDK_OFFSET(0x1E60A9A0)
#define DEST_MATH_VISUALDEBUG_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1E60A170)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1E609150)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1E609570)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_2_OFFSET UNITYSDK_OFFSET(0x1E60AB60)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_3_OFFSET UNITYSDK_OFFSET(0x1E60ABB0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_OFFSET UNITYSDK_OFFSET(0x1E609280)
#define DEST_MATH_VISUALDEBUG_DRAWSPHERE_OFFSET UNITYSDK_OFFSET(0x1E60A760)
#define DEST_MATH_VISUALDEBUG_DRAWTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1E60B410)
#define DEST_MATH_VISUALDEBUG_DRAWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1E60BA00)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1E60ACD0)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1E60ABF0)
#define DEST_MATH_VISUALDEBUG_DRAWWIREPOINTS_OFFSET UNITYSDK_OFFSET(0x1E608F70)
#define DEST_MATH_VISUALDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E60C050)
#define DEST_MATH_VISUALDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1E60C040)

namespace Dest::Math
{
	inline static constexpr unsigned int VisualDebug_TypeDefinitionIndex = 34799;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x85D0);
		}
		static ::System::Single* StaticGet__pointRadius()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x85D4);
		}
