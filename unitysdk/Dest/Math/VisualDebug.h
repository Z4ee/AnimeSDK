...
#define DEST_MATH_VISUALDEBUG_DRAWAAB_1_OFFSET UNITYSDK_OFFSET(0x1F9EC220)
#define DEST_MATH_VISUALDEBUG_DRAWAAB_OFFSET UNITYSDK_OFFSET(0x1F9EC120)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_1_OFFSET UNITYSDK_OFFSET(0x1F9EC810)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_OFFSET UNITYSDK_OFFSET(0x1F9EC600)
#define DEST_MATH_VISUALDEBUG_DRAWCAPSULE_OFFSET UNITYSDK_OFFSET(0x1F9EE100)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1F9ECFC0)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_2_OFFSET UNITYSDK_OFFSET(0x1F9ED0D0)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1F9ECEA0)
#define DEST_MATH_VISUALDEBUG_DRAWFUNC_OFFSET UNITYSDK_OFFSET(0x1F9EDDE0)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1F9ED3E0)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1F9ED2E0)
#define DEST_MATH_VISUALDEBUG_DRAWPLANE_OFFSET UNITYSDK_OFFSET(0x1F9ED8C0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTSWITHSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1F9EBE30)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1F9EB7A0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1F9EB470)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_1_OFFSET UNITYSDK_OFFSET(0x1F9EB3F0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1F9EB370)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1F9EDCE0)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_OFFSET UNITYSDK_OFFSET(0x1F9EDBF0)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_1_OFFSET UNITYSDK_OFFSET(0x1F9ED5B0)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_OFFSET UNITYSDK_OFFSET(0x1F9ED4F0)
#define DEST_MATH_VISUALDEBUG_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1F9ECCB0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1F9EBCB0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1F9EC0E0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_2_OFFSET UNITYSDK_OFFSET(0x1F9ED6B0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_3_OFFSET UNITYSDK_OFFSET(0x1F9ED700)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_OFFSET UNITYSDK_OFFSET(0x1F9EBDE0)
#define DEST_MATH_VISUALDEBUG_DRAWSPHERE_OFFSET UNITYSDK_OFFSET(0x1F9ED2B0)
#define DEST_MATH_VISUALDEBUG_DRAWTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1F9EDF60)
#define DEST_MATH_VISUALDEBUG_DRAWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1F9EE540)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1F9ED810)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1F9ED740)
#define DEST_MATH_VISUALDEBUG_DRAWWIREPOINTS_OFFSET UNITYSDK_OFFSET(0x1F9EBAD0)
#define DEST_MATH_VISUALDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F9EEBC0)
#define DEST_MATH_VISUALDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9EEBB0)

namespace Dest::Math
{
	inline static constexpr unsigned int VisualDebug_TypeDefinitionIndex = 35458;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x86B0);
		}
		static ::System::Single* StaticGet__lineLength()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x86B4);
		}
