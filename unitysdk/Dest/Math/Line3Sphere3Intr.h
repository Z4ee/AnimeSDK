...
namespace Dest::Math
{
	inline static constexpr unsigned int Line3Sphere3Intr_TypeDefinitionIndex = 34710;

	struct alignas(4) Line3Sphere3Intr
	{
		...
		::System::Single LineParameter0; // 0x30
		::System::Single LineParameter1; // 0x34
	};
}
