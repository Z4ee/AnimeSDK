...
#define DEST_MATH_SPLINEBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1DAB1F10)
#define DEST_MATH_SPLINEBASE_CALCTOTALLENGTH_OFFSET UNITYSDK_OFFSET(0x1DAB5190)
#define DEST_MATH_SPLINEBASE_EVALCURVATUREPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1DAB4B70)
#define DEST_MATH_SPLINEBASE_EVALCURVATURE_OFFSET UNITYSDK_OFFSET(0x1DAB3450)
#define DEST_MATH_SPLINEBASE_EVALFRAMEPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1DAB4780)
#define DEST_MATH_SPLINEBASE_EVALFRAME_OFFSET UNITYSDK_OFFSET(0x1DAB3080)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1DAB4160)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1DAB3A60)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENTPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1DAB4520)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENTPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1DAB3E30)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1DAB2E30)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENT_OFFSET UNITYSDK_OFFSET(0x1DAB2790)
#define DEST_MATH_SPLINEBASE_EVALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1DAB2AA0)
#define DEST_MATH_SPLINEBASE_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1DAB2400)
#define DEST_MATH_SPLINEBASE_EVALTANGENTPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1DAB4310)
#define DEST_MATH_SPLINEBASE_EVALTANGENTPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1DAB3C10)
#define DEST_MATH_SPLINEBASE_EVALTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1DAB2C30)
#define DEST_MATH_SPLINEBASE_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1DAB2590)
#define DEST_MATH_SPLINEBASE_EVALTORSIONPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1DAB4E90)
#define DEST_MATH_SPLINEBASE_EVALTORSION_OFFSET UNITYSDK_OFFSET(0x1DAB3770)
#define DEST_MATH_SPLINEBASE_GETSEGMENTINDEXANDTIME_OFFSET UNITYSDK_OFFSET(0x1DAB20F0)
#define DEST_MATH_SPLINEBASE_GET_SEGMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1DAB1E90)
#define DEST_MATH_SPLINEBASE_GET_VALID_OFFSET UNITYSDK_OFFSET(0x1DAB1EF0)
#define DEST_MATH_SPLINEBASE_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1DAB1ED0)
#define DEST_MATH_SPLINEBASE_LENGTHTOTIME_1_OFFSET UNITYSDK_OFFSET(0x1DAB5680)
#define DEST_MATH_SPLINEBASE_LENGTHTOTIME_OFFSET UNITYSDK_OFFSET(0x1DAB5240)
#define DEST_MATH_SPLINEBASE_PARAMETRIZEBYARCLENGTH_OFFSET UNITYSDK_OFFSET(0x1DAB56A0)
#define DEST_MATH_SPLINEBASE_PREPAREFORRUNTIME_OFFSET UNITYSDK_OFFSET(0x1DAB1F90)
#define DEST_MATH_SPLINEBASE_RECALCSEGMENTSLENGTH_OFFSET UNITYSDK_OFFSET(0x1DAB21C0)
#define DEST_MATH_SPLINEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAB2010)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_TypeDefinitionIndex = 34796;
