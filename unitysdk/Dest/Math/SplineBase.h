...
#define DEST_MATH_SPLINEBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6AEE40)
#define DEST_MATH_SPLINEBASE_CALCTOTALLENGTH_OFFSET UNITYSDK_OFFSET(0x1B6B20C0)
#define DEST_MATH_SPLINEBASE_EVALCURVATUREPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1B6B1AA0)
#define DEST_MATH_SPLINEBASE_EVALCURVATURE_OFFSET UNITYSDK_OFFSET(0x1B6B0380)
#define DEST_MATH_SPLINEBASE_EVALFRAMEPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1B6B16B0)
#define DEST_MATH_SPLINEBASE_EVALFRAME_OFFSET UNITYSDK_OFFSET(0x1B6AFFB0)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1B6B1090)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1B6B0990)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENTPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1B6B1450)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENTPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1B6B0D60)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1B6AFD60)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENT_OFFSET UNITYSDK_OFFSET(0x1B6AF6C0)
#define DEST_MATH_SPLINEBASE_EVALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1B6AF9D0)
#define DEST_MATH_SPLINEBASE_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1B6AF330)
#define DEST_MATH_SPLINEBASE_EVALTANGENTPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1B6B1240)
#define DEST_MATH_SPLINEBASE_EVALTANGENTPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1B6B0B40)
#define DEST_MATH_SPLINEBASE_EVALTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1B6AFB60)
#define DEST_MATH_SPLINEBASE_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1B6AF4C0)
#define DEST_MATH_SPLINEBASE_EVALTORSIONPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1B6B1DC0)
#define DEST_MATH_SPLINEBASE_EVALTORSION_OFFSET UNITYSDK_OFFSET(0x1B6B06A0)
#define DEST_MATH_SPLINEBASE_GETSEGMENTINDEXANDTIME_OFFSET UNITYSDK_OFFSET(0x1B6AF020)
#define DEST_MATH_SPLINEBASE_GET_SEGMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B6AEDC0)
#define DEST_MATH_SPLINEBASE_GET_VALID_OFFSET UNITYSDK_OFFSET(0x1B6AEE20)
#define DEST_MATH_SPLINEBASE_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B6AEE00)
#define DEST_MATH_SPLINEBASE_LENGTHTOTIME_1_OFFSET UNITYSDK_OFFSET(0x1B6B25B0)
#define DEST_MATH_SPLINEBASE_LENGTHTOTIME_OFFSET UNITYSDK_OFFSET(0x1B6B2170)
#define DEST_MATH_SPLINEBASE_PARAMETRIZEBYARCLENGTH_OFFSET UNITYSDK_OFFSET(0x1B6B25D0)
#define DEST_MATH_SPLINEBASE_PREPAREFORRUNTIME_OFFSET UNITYSDK_OFFSET(0x1B6AEEC0)
#define DEST_MATH_SPLINEBASE_RECALCSEGMENTSLENGTH_OFFSET UNITYSDK_OFFSET(0x1B6AF0F0)
#define DEST_MATH_SPLINEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6AEF40)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_TypeDefinitionIndex = 33233;
