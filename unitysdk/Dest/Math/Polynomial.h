...
#define DEST_MATH_POLYNOMIAL_CALCDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1C3AF2C0)
#define DEST_MATH_POLYNOMIAL_CALCINVERSION_OFFSET UNITYSDK_OFFSET(0x1C3AF460)
#define DEST_MATH_POLYNOMIAL_COMPRESS_OFFSET UNITYSDK_OFFSET(0x1C3AF630)
#define DEST_MATH_POLYNOMIAL_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0x1C3AF1C0)
#define DEST_MATH_POLYNOMIAL_EVAL_OFFSET UNITYSDK_OFFSET(0x1C3AF790)
#define DEST_MATH_POLYNOMIAL_GET_DEGREE_OFFSET UNITYSDK_OFFSET(0x1C3AF090)
#define DEST_MATH_POLYNOMIAL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C3AF0F0)
#define DEST_MATH_POLYNOMIAL_SET_DEGREE_OFFSET UNITYSDK_OFFSET(0x1C3AF0A0)
#define DEST_MATH_POLYNOMIAL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1C3AF130)
#define DEST_MATH_POLYNOMIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3AF170)

namespace Dest::Math
{
	inline static constexpr unsigned int Polynomial_TypeDefinitionIndex = 33098;
