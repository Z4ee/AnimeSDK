...
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1F7F8EE0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_OFFSET UNITYSDK_OFFSET(0x1F7F9490)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1F7F92C0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F7F91E0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F7F91F0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1F7F9280)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1F7F8E60)

namespace Dest::Math
{
	inline static constexpr unsigned int NonIndexedTrianglesSampler_TypeDefinitionIndex = 35466;
