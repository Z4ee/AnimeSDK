...
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1C08FEC0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_OFFSET UNITYSDK_OFFSET(0x1C090530)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1C090360)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C090280)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C090290)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C090320)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C08FE40)

namespace Dest::Math
{
	inline static constexpr unsigned int NonIndexedTrianglesSampler_TypeDefinitionIndex = 33244;
