...
#define DEST_MATH_AAB2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x9C0780)
#define DEST_MATH_AAB2_CALCCENTEREXTENTS_OFFSET UNITYSDK_OFFSET(0x9C0700)
#define DEST_MATH_AAB2_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x9C0760)
#define DEST_MATH_AAB2_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x9C0770)
#define DEST_MATH_AAB2_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x9C0730)
#define DEST_MATH_AAB2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x9C08E0)
#define DEST_MATH_AAB2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9C08A0)
#define DEST_MATH_AAB2_CREATEFROMPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1C08C190)
#define DEST_MATH_AAB2_CREATEFROMPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1C08C480)
#define DEST_MATH_AAB2_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1C08BCA0)
#define DEST_MATH_AAB2_CREATEFROMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1C08BC20)
#define DEST_MATH_AAB2_CREATEFROMPOINT_OFFSET UNITYSDK_OFFSET(0x1C08BC10)
#define DEST_MATH_AAB2_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1C08BC60)
#define DEST_MATH_AAB2_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1C08BC30)
#define DEST_MATH_AAB2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9C07A0)
#define DEST_MATH_AAB2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x9C0970)
#define DEST_MATH_AAB2_INCLUDE_2_OFFSET UNITYSDK_OFFSET(0x9C09C0)
#define DEST_MATH_AAB2_INCLUDE_3_OFFSET UNITYSDK_OFFSET(0x9C0A50)
#define DEST_MATH_AAB2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x9C0920)
#define DEST_MATH_AAB2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1C08BBF0)
#define DEST_MATH_AAB2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C08BBD0)
#define DEST_MATH_AAB2_PROJECT_OFFSET UNITYSDK_OFFSET(0x9C0830)
#define DEST_MATH_AAB2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9C0AE0)
#define DEST_MATH_AAB2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2FED90)
#define DEST_MATH_AAB2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9C06E0)
#define DEST_MATH_AAB2__CTOR_OFFSET UNITYSDK_OFFSET(0x54B460)

namespace Dest::Math
{
	inline static constexpr unsigned int AAB2_TypeDefinitionIndex = 33200;
