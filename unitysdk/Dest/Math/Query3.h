...
#define DEST_MATH_QUERY3_DET3_OFFSET UNITYSDK_OFFSET(0x1E7DCF10)
#define DEST_MATH_QUERY3_DET4_OFFSET UNITYSDK_OFFSET(0x1E7DD6F0)
#define DEST_MATH_QUERY3_DOT_OFFSET UNITYSDK_OFFSET(0x1E7DD8F0)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1E7DD1E0)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_OFFSET UNITYSDK_OFFSET(0x1E7DD1A0)
#define DEST_MATH_QUERY3_TOPLANE_1_OFFSET UNITYSDK_OFFSET(0x1E7DCD60)
#define DEST_MATH_QUERY3_TOPLANE_OFFSET UNITYSDK_OFFSET(0x1E7DCD20)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_1_OFFSET UNITYSDK_OFFSET(0x1E7DD0C0)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1E7DCFA0)
#define DEST_MATH_QUERY3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E7DD910)
#define DEST_MATH_QUERY3__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DCD10)

namespace Dest::Math
{
	inline static constexpr unsigned int Query3_TypeDefinitionIndex = 34787;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query3_TypeDefinitionIndex)->GetStaticField(0x85C0);
		}
