...
#define DEST_MATH_QUERY3_DET3_OFFSET UNITYSDK_OFFSET(0x1C4A5780)
#define DEST_MATH_QUERY3_DET4_OFFSET UNITYSDK_OFFSET(0x1C4A5F60)
#define DEST_MATH_QUERY3_DOT_OFFSET UNITYSDK_OFFSET(0x1C4A6160)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1C4A5A50)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_OFFSET UNITYSDK_OFFSET(0x1C4A5A10)
#define DEST_MATH_QUERY3_TOPLANE_1_OFFSET UNITYSDK_OFFSET(0x1C4A55D0)
#define DEST_MATH_QUERY3_TOPLANE_OFFSET UNITYSDK_OFFSET(0x1C4A5590)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_1_OFFSET UNITYSDK_OFFSET(0x1C4A5930)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1C4A5810)
#define DEST_MATH_QUERY3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C4A6180)
#define DEST_MATH_QUERY3__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A5580)

namespace Dest::Math
{
	inline static constexpr unsigned int Query3_TypeDefinitionIndex = 33224;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query3_TypeDefinitionIndex)->GetStaticField(0x8120);
		}
