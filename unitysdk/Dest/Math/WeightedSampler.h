...
#define DEST_MATH_WEIGHTEDSAMPLER_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1E60C080)
#define DEST_MATH_WEIGHTEDSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1E60C180)
#define DEST_MATH_WEIGHTEDSAMPLER_SAMPLEINDEX_OFFSET UNITYSDK_OFFSET(0x1E60C2B0)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E60C110)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E60C2A0)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E60C070)

namespace Dest::Math
{
	inline static constexpr unsigned int WeightedSampler_TypeDefinitionIndex = 34804;
