...
#define DEST_MATH_CATMULLROMSPLINE3_ADDVERTEXFIRST_OFFSET UNITYSDK_OFFSET(0x1DD5E2C0)
#define DEST_MATH_CATMULLROMSPLINE3_ADDVERTEXLAST_OFFSET UNITYSDK_OFFSET(0x1DD5E400)
#define DEST_MATH_CATMULLROMSPLINE3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DD5E530)
#define DEST_MATH_CATMULLROMSPLINE3_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1DD5DB00)
#define DEST_MATH_CATMULLROMSPLINE3_CREATE_OFFSET UNITYSDK_OFFSET(0x1DD5DA50)
#define DEST_MATH_CATMULLROMSPLINE3_GETVERTEX_OFFSET UNITYSDK_OFFSET(0x1DD5E620)
#define DEST_MATH_CATMULLROMSPLINE3_GET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1DD5D900)
#define DEST_MATH_CATMULLROMSPLINE3_INSERTAFTER_OFFSET UNITYSDK_OFFSET(0x1DD5E580)
#define DEST_MATH_CATMULLROMSPLINE3_INSERTBEFORE_OFFSET UNITYSDK_OFFSET(0x1DD5E360)
#define DEST_MATH_CATMULLROMSPLINE3_REMOVEVERTEX_OFFSET UNITYSDK_OFFSET(0x1DD5E4A0)
#define DEST_MATH_CATMULLROMSPLINE3_SETVERTEX_OFFSET UNITYSDK_OFFSET(0x1DD5E6A0)
#define DEST_MATH_CATMULLROMSPLINE3_SET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1DD5D910)
#define DEST_MATH_CATMULLROMSPLINE3_UPDATEADJACENTSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1DD5D960)
#define DEST_MATH_CATMULLROMSPLINE3_UPDATESEGMENT_OFFSET UNITYSDK_OFFSET(0x1DD5DF30)
#define DEST_MATH_CATMULLROMSPLINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD5E730)

namespace Dest::Math
{
	inline static constexpr unsigned int CatmullRomSpline3_TypeDefinitionIndex = 34790;
