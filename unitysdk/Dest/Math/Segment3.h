...
#define DEST_MATH_SEGMENT3_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x9BB2B0)
#define DEST_MATH_SEGMENT3_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0x9BB370)
#define DEST_MATH_SEGMENT3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9BB420)
#define DEST_MATH_SEGMENT3_EVAL_OFFSET UNITYSDK_OFFSET(0x9BB3D0)
#define DEST_MATH_SEGMENT3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9BB460)
#define DEST_MATH_SEGMENT3_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x9BB240)
#define DEST_MATH_SEGMENT3_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0x9BB160)
#define DEST_MATH_SEGMENT3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9BB4C0)
#define DEST_MATH_SEGMENT3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9BAF80)
#define DEST_MATH_SEGMENT3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9BB070)
#define DEST_MATH_SEGMENT3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9BB0E0)
#define DEST_MATH_SEGMENT3__CTOR_OFFSET UNITYSDK_OFFSET(0x9BAEA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment3_TypeDefinitionIndex = 34782;
