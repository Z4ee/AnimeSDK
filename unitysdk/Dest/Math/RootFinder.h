...
#define DEST_MATH_ROOTFINDER_BRENTSMETHOD_OFFSET UNITYSDK_OFFSET(0x1BB1A3E0)
#define DEST_MATH_ROOTFINDER_CUBIC_OFFSET UNITYSDK_OFFSET(0x1BB1AA10)
#define DEST_MATH_ROOTFINDER_LINEAR_OFFSET UNITYSDK_OFFSET(0x1BB1A830)
#define DEST_MATH_ROOTFINDER_POLYNOMIALBOUND_OFFSET UNITYSDK_OFFSET(0x1BB1B450)
#define DEST_MATH_ROOTFINDER_POLYNOMIAL_1_OFFSET UNITYSDK_OFFSET(0x1BB1B640)
#define DEST_MATH_ROOTFINDER_POLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x1BB1B540)
#define DEST_MATH_ROOTFINDER_QUADRATIC_OFFSET UNITYSDK_OFFSET(0x1BB1A870)
#define DEST_MATH_ROOTFINDER_QUARTIC_OFFSET UNITYSDK_OFFSET(0x1BB1AF40)
#define DEST_MATH_ROOTFINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BB1B7E0)

namespace Dest::Math
{
	inline static constexpr unsigned int RootFinder_TypeDefinitionIndex = 33186;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(RootFinder_TypeDefinitionIndex)->GetStaticField(0x80F0);
		}
