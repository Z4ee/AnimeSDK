...
#define DEST_MATH_ROOTFINDER_BRENTSMETHOD_OFFSET UNITYSDK_OFFSET(0x1DEA1560)
#define DEST_MATH_ROOTFINDER_CUBIC_OFFSET UNITYSDK_OFFSET(0x1DEA1B90)
#define DEST_MATH_ROOTFINDER_LINEAR_OFFSET UNITYSDK_OFFSET(0x1DEA19B0)
#define DEST_MATH_ROOTFINDER_POLYNOMIALBOUND_OFFSET UNITYSDK_OFFSET(0x1DEA25D0)
#define DEST_MATH_ROOTFINDER_POLYNOMIAL_1_OFFSET UNITYSDK_OFFSET(0x1DEA27C0)
#define DEST_MATH_ROOTFINDER_POLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x1DEA26C0)
#define DEST_MATH_ROOTFINDER_QUADRATIC_OFFSET UNITYSDK_OFFSET(0x1DEA19F0)
#define DEST_MATH_ROOTFINDER_QUARTIC_OFFSET UNITYSDK_OFFSET(0x1DEA20C0)
#define DEST_MATH_ROOTFINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEA2960)

namespace Dest::Math
{
	inline static constexpr unsigned int RootFinder_TypeDefinitionIndex = 34749;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(RootFinder_TypeDefinitionIndex)->GetStaticField(0x8590);
		}
