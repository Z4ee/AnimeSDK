...
#define DEST_MATH_AAB3_CALCCENTEREXTENTS_OFFSET UNITYSDK_OFFSET(0xA62C00)
#define DEST_MATH_AAB3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0xA62D30)
#define DEST_MATH_AAB3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0xA62D40)
#define DEST_MATH_AAB3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0xA62C60)
#define DEST_MATH_AAB3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0xA62D50)
#define DEST_MATH_AAB3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0xA62EF0)
#define DEST_MATH_AAB3_CONTAINS_OFFSET UNITYSDK_OFFSET(0xA62EF0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1E3A2D50)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1E3A30B0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3A27C0)
#define DEST_MATH_AAB3_CREATEFROMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1E3A25D0)
#define DEST_MATH_AAB3_CREATEFROMPOINT_OFFSET UNITYSDK_OFFSET(0x1E3A2580)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1E3A26F0)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1E3A2620)
#define DEST_MATH_AAB3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA62D80)
#define DEST_MATH_AAB3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0xA62FB0)
#define DEST_MATH_AAB3_INCLUDE_2_OFFSET UNITYSDK_OFFSET(0xA63020)
#define DEST_MATH_AAB3_INCLUDE_3_OFFSET UNITYSDK_OFFSET(0xA630F0)
#define DEST_MATH_AAB3_INCLUDE_OFFSET UNITYSDK_OFFSET(0xA62F40)
#define DEST_MATH_AAB3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E3A2540)
#define DEST_MATH_AAB3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E3A2490)
#define DEST_MATH_AAB3_PROJECT_OFFSET UNITYSDK_OFFSET(0xA62E40)
#define DEST_MATH_AAB3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA631D0)
#define DEST_MATH_AAB3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3E5800)
#define DEST_MATH_AAB3__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA62BC0)
#define DEST_MATH_AAB3__CTOR_OFFSET UNITYSDK_OFFSET(0x936BA0)

namespace Dest::Math
{
	inline static constexpr unsigned int AAB3_TypeDefinitionIndex = 34772;
