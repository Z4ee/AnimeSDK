...
#define DEST_MATH_AAB3_CALCCENTEREXTENTS_OFFSET UNITYSDK_OFFSET(0x9C0BD0)
#define DEST_MATH_AAB3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x9C0D00)
#define DEST_MATH_AAB3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x9C0D10)
#define DEST_MATH_AAB3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x9C0C30)
#define DEST_MATH_AAB3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x9C0D20)
#define DEST_MATH_AAB3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x9C0EC0)
#define DEST_MATH_AAB3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9C0EC0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1C08D450)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1C08D7B0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1C08CEC0)
#define DEST_MATH_AAB3_CREATEFROMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1C08CCD0)
#define DEST_MATH_AAB3_CREATEFROMPOINT_OFFSET UNITYSDK_OFFSET(0x1C08CC80)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1C08CDF0)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1C08CD20)
#define DEST_MATH_AAB3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9C0D50)
#define DEST_MATH_AAB3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x9C0F80)
#define DEST_MATH_AAB3_INCLUDE_2_OFFSET UNITYSDK_OFFSET(0x9C0FF0)
#define DEST_MATH_AAB3_INCLUDE_3_OFFSET UNITYSDK_OFFSET(0x9C10C0)
#define DEST_MATH_AAB3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x9C0F10)
#define DEST_MATH_AAB3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1C08CC40)
#define DEST_MATH_AAB3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1C08CB90)
#define DEST_MATH_AAB3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9C0E10)
#define DEST_MATH_AAB3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9C11A0)
#define DEST_MATH_AAB3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x317F00)
#define DEST_MATH_AAB3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9C0B90)
#define DEST_MATH_AAB3__CTOR_OFFSET UNITYSDK_OFFSET(0x8A6520)

namespace Dest::Math
{
	inline static constexpr unsigned int AAB3_TypeDefinitionIndex = 33209;
