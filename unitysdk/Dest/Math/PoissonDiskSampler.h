...
#define DEST_MATH_POISSONDISKSAMPLER_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1FB366A0)
#define DEST_MATH_POISSONDISKSAMPLER_CALCGRIDINDICES_OFFSET UNITYSDK_OFFSET(0x1FB365D0)
#define DEST_MATH_POISSONDISKSAMPLER_GET_MAXPOINTS_OFFSET UNITYSDK_OFFSET(0x1FB36390)
#define DEST_MATH_POISSONDISKSAMPLER_INSERTINTOGRID_OFFSET UNITYSDK_OFFSET(0x1FB36600)
#define DEST_MATH_POISSONDISKSAMPLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1FB36BE0)
#define DEST_MATH_POISSONDISKSAMPLER_SET_MAXPOINTS_OFFSET UNITYSDK_OFFSET(0x1FB363A0)
#define DEST_MATH_POISSONDISKSAMPLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB363B0)
#define DEST_MATH_POISSONDISKSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB363C0)

namespace Dest::Math
{
	inline static constexpr unsigned int PoissonDiskSampler_TypeDefinitionIndex = 35461;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(PoissonDiskSampler_TypeDefinitionIndex)->GetStaticField(0x8620);
		}
		::System::Collections::Generic::List_1<::System::Int32>* _activeList; // 0x10
		::Il2CppArray<::System::Nullable_1<::System::Int32>>* _grid; // 0x18
		::Dest::Math::Rand* _rand; // 0x20
		::Dest::Math::PoissonDiskSampler_PointDelegate* DistanceFilter; // 0x28
		::System::Collections::Generic::List_1<::UnityEngine::Vector2>* _points; // 0x30
		::System::Single _cellSize; // 0x38
		::System::Int32 _cellsY; // 0x3C
		::UnityEngine::Vector2 _size; // 0x40
		::System::Int32 _MaxPoints_k__BackingField; // 0x48
		::System::Single _rMin; // 0x4C
		::System::Single _rTwo; // 0x50
		::System::Int32 PointsPerStep; // 0x54
		::System::Single _r; // 0x58
		::UnityEngine::Vector2 _min; // 0x5C
		::System::Int32 _cellsX; // 0x64
		::System::Single _rSquared; // 0x68
		::UnityEngine::Vector2 _max; // 0x6C
