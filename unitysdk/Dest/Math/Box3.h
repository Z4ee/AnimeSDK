...
#define DEST_MATH_BOX3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x987020)
#define DEST_MATH_BOX3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x987030)
#define DEST_MATH_BOX3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x987010)
#define DEST_MATH_BOX3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x987040)
#define DEST_MATH_BOX3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x987110)
#define DEST_MATH_BOX3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x987100)
#define DEST_MATH_BOX3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1B6A4450)
#define DEST_MATH_BOX3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x987060)
#define DEST_MATH_BOX3_GETAXIS_OFFSET UNITYSDK_OFFSET(0x986F80)
#define DEST_MATH_BOX3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x987150)
#define DEST_MATH_BOX3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x987140)
#define DEST_MATH_BOX3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9870A0)
#define DEST_MATH_BOX3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x987190)
#define DEST_MATH_BOX3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x77C640)
#define DEST_MATH_BOX3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x986D80)
#define DEST_MATH_BOX3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x986E70)
#define DEST_MATH_BOX3__CTOR_OFFSET UNITYSDK_OFFSET(0x986D30)

namespace Dest::Math
{
	inline static constexpr unsigned int Box3_TypeDefinitionIndex = 33210;
