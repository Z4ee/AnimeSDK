...
#define DEST_MATH_LINEARSYSTEM_INVERSE_OFFSET UNITYSDK_OFFSET(0x1C351EB0)
#define DEST_MATH_LINEARSYSTEM_SOLVE2_1_OFFSET UNITYSDK_OFFSET(0x1C350900)
#define DEST_MATH_LINEARSYSTEM_SOLVE2_OFFSET UNITYSDK_OFFSET(0x1C3506C0)
#define DEST_MATH_LINEARSYSTEM_SOLVE3_1_OFFSET UNITYSDK_OFFSET(0x1C350F80)
#define DEST_MATH_LINEARSYSTEM_SOLVE3_OFFSET UNITYSDK_OFFSET(0x1C3509E0)
#define DEST_MATH_LINEARSYSTEM_SOLVETRIDIAGONAL_OFFSET UNITYSDK_OFFSET(0x1C351B00)
#define DEST_MATH_LINEARSYSTEM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1C351210)
#define DEST_MATH_LINEARSYSTEM_SWAPROWS_OFFSET UNITYSDK_OFFSET(0x1C351090)

namespace Dest::Math
{
	inline static constexpr unsigned int LinearSystem_TypeDefinitionIndex = 33191;
