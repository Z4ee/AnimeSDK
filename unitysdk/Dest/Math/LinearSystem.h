...
#define DEST_MATH_LINEARSYSTEM_INVERSE_OFFSET UNITYSDK_OFFSET(0x1E694870)
#define DEST_MATH_LINEARSYSTEM_SOLVE2_1_OFFSET UNITYSDK_OFFSET(0x1E6932C0)
#define DEST_MATH_LINEARSYSTEM_SOLVE2_OFFSET UNITYSDK_OFFSET(0x1E693080)
#define DEST_MATH_LINEARSYSTEM_SOLVE3_1_OFFSET UNITYSDK_OFFSET(0x1E693940)
#define DEST_MATH_LINEARSYSTEM_SOLVE3_OFFSET UNITYSDK_OFFSET(0x1E6933A0)
#define DEST_MATH_LINEARSYSTEM_SOLVETRIDIAGONAL_OFFSET UNITYSDK_OFFSET(0x1E6944C0)
#define DEST_MATH_LINEARSYSTEM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1E693BD0)
#define DEST_MATH_LINEARSYSTEM_SWAPROWS_OFFSET UNITYSDK_OFFSET(0x1E693A50)

namespace Dest::Math
{
	inline static constexpr unsigned int LinearSystem_TypeDefinitionIndex = 34754;
