...
#define DEST_MATH_POLYGON3_CALCCENTER_OFFSET UNITYSDK_OFFSET(0x1EE950E0)
#define DEST_MATH_POLYGON3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x1EE95180)
#define DEST_MATH_POLYGON3_GETEDGE_OFFSET UNITYSDK_OFFSET(0x1EE94DA0)
#define DEST_MATH_POLYGON3_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1EE94590)
#define DEST_MATH_POLYGON3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1EE92FC0)
#define DEST_MATH_POLYGON3_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1EE945F0)
#define DEST_MATH_POLYGON3_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1EE92FA0)
#define DEST_MATH_POLYGON3_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1EE94580)
#define DEST_MATH_POLYGON3_HASZEROCORNERS_OFFSET UNITYSDK_OFFSET(0x1EE95230)
#define DEST_MATH_POLYGON3_PROJECTVERTICES_OFFSET UNITYSDK_OFFSET(0x1EE94BE0)
#define DEST_MATH_POLYGON3_REVERSEVERTICES_OFFSET UNITYSDK_OFFSET(0x1EE95320)
#define DEST_MATH_POLYGON3_SETVERTEXPROJECTED_OFFSET UNITYSDK_OFFSET(0x1EE94AB0)
#define DEST_MATH_POLYGON3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1EE945A0)
#define DEST_MATH_POLYGON3_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1EE94600)
#define DEST_MATH_POLYGON3_TOSEGMENTARRAY_OFFSET UNITYSDK_OFFSET(0x1EE95410)
#define DEST_MATH_POLYGON3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1EE955B0)
#define DEST_MATH_POLYGON3_UPDATEEDGES_OFFSET UNITYSDK_OFFSET(0x1EE946B0)
#define DEST_MATH_POLYGON3_UPDATEEDGE_OFFSET UNITYSDK_OFFSET(0x1EE94E00)
#define DEST_MATH_POLYGON3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1EE94620)
#define DEST_MATH_POLYGON3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1EE94A40)
#define DEST_MATH_POLYGON3__CTOR_OFFSET UNITYSDK_OFFSET(0x1EE94610)

namespace Dest::Math
{
	inline static constexpr unsigned int Polygon3_TypeDefinitionIndex = 35438;
