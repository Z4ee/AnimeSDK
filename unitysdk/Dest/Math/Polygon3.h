...
#define DEST_MATH_POLYGON3_CALCCENTER_OFFSET UNITYSDK_OFFSET(0x1B6AD850)
#define DEST_MATH_POLYGON3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x1B6AD900)
#define DEST_MATH_POLYGON3_GETEDGE_OFFSET UNITYSDK_OFFSET(0x1B6AD4F0)
#define DEST_MATH_POLYGON3_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1B6ACCD0)
#define DEST_MATH_POLYGON3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B6AB6B0)
#define DEST_MATH_POLYGON3_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1B6ACD30)
#define DEST_MATH_POLYGON3_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B6AB690)
#define DEST_MATH_POLYGON3_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1B6ACCC0)
#define DEST_MATH_POLYGON3_HASZEROCORNERS_OFFSET UNITYSDK_OFFSET(0x1B6AD9B0)
#define DEST_MATH_POLYGON3_PROJECTVERTICES_OFFSET UNITYSDK_OFFSET(0x1B6AD330)
#define DEST_MATH_POLYGON3_REVERSEVERTICES_OFFSET UNITYSDK_OFFSET(0x1B6ADAA0)
#define DEST_MATH_POLYGON3_SETVERTEXPROJECTED_OFFSET UNITYSDK_OFFSET(0x1B6AD200)
#define DEST_MATH_POLYGON3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B6ACCE0)
#define DEST_MATH_POLYGON3_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1B6ACD40)
#define DEST_MATH_POLYGON3_TOSEGMENTARRAY_OFFSET UNITYSDK_OFFSET(0x1B6ADBA0)
#define DEST_MATH_POLYGON3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B6ADE00)
#define DEST_MATH_POLYGON3_UPDATEEDGES_OFFSET UNITYSDK_OFFSET(0x1B6ACDF0)
#define DEST_MATH_POLYGON3_UPDATEEDGE_OFFSET UNITYSDK_OFFSET(0x1B6AD550)
#define DEST_MATH_POLYGON3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6ACD60)
#define DEST_MATH_POLYGON3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6AD190)
#define DEST_MATH_POLYGON3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6ACD50)

namespace Dest::Math
{
	inline static constexpr unsigned int Polygon3_TypeDefinitionIndex = 33216;

	class Polygon3 : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::Vector3>* _vertices; // 0x10
		::Il2CppArray<::Dest::Math::Edge3>* _edges; // 0x18
