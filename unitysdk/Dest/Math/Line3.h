...
#define DEST_MATH_LINE3_ANGLEBETWEENTWOLINES_OFFSET UNITYSDK_OFFSET(0x9EB190)
#define DEST_MATH_LINE3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1C5558F0)
#define DEST_MATH_LINE3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1C555830)
#define DEST_MATH_LINE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9EAF00)
#define DEST_MATH_LINE3_EVAL_OFFSET UNITYSDK_OFFSET(0x96F200)
#define DEST_MATH_LINE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9EB070)
#define DEST_MATH_LINE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9EB260)
#define DEST_MATH_LINE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x317F00)
#define DEST_MATH_LINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x8A6520)

namespace Dest::Math
{
	inline static constexpr unsigned int Line3_TypeDefinitionIndex = 33213;
