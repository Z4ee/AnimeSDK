...
#define DEST_MATH_LINE3_ANGLEBETWEENTWOLINES_OFFSET UNITYSDK_OFFSET(0xA8D120)
#define DEST_MATH_LINE3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1E885A80)
#define DEST_MATH_LINE3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1E8859C0)
#define DEST_MATH_LINE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA8CE90)
#define DEST_MATH_LINE3_EVAL_OFFSET UNITYSDK_OFFSET(0xA109E0)
#define DEST_MATH_LINE3_PROJECT_OFFSET UNITYSDK_OFFSET(0xA8D000)
#define DEST_MATH_LINE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA8D1F0)
#define DEST_MATH_LINE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3E5800)
#define DEST_MATH_LINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x936BA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Line3_TypeDefinitionIndex = 34776;
