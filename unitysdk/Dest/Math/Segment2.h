...
#define DEST_MATH_SEGMENT2_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0xA0C760)
#define DEST_MATH_SEGMENT2_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0xA0C810)
#define DEST_MATH_SEGMENT2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA0C8A0)
#define DEST_MATH_SEGMENT2_EVAL_OFFSET UNITYSDK_OFFSET(0xA0C860)
#define DEST_MATH_SEGMENT2_PROJECT_OFFSET UNITYSDK_OFFSET(0xA0C9E0)
#define DEST_MATH_SEGMENT2_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0xA0C700)
#define DEST_MATH_SEGMENT2_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0xA0C5E0)
#define DEST_MATH_SEGMENT2_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA0CAD0)
#define DEST_MATH_SEGMENT2__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA0C5E0)
#define DEST_MATH_SEGMENT2__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA0C6A0)
#define DEST_MATH_SEGMENT2__CTOR_3_OFFSET UNITYSDK_OFFSET(0xA0C700)
#define DEST_MATH_SEGMENT2__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C520)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment2_TypeDefinitionIndex = 35429;
