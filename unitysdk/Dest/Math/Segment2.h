...
#define DEST_MATH_SEGMENT2_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x90F8D0)
#define DEST_MATH_SEGMENT2_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0x90F9B0)
#define DEST_MATH_SEGMENT2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x90FA40)
#define DEST_MATH_SEGMENT2_EVAL_OFFSET UNITYSDK_OFFSET(0x90FA00)
#define DEST_MATH_SEGMENT2_PROJECT_OFFSET UNITYSDK_OFFSET(0x90FBA0)
#define DEST_MATH_SEGMENT2_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x90F870)
#define DEST_MATH_SEGMENT2_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0x90F720)
#define DEST_MATH_SEGMENT2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x90FC90)
#define DEST_MATH_SEGMENT2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x90F720)
#define DEST_MATH_SEGMENT2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x90F810)
#define DEST_MATH_SEGMENT2__CTOR_3_OFFSET UNITYSDK_OFFSET(0x90F870)
#define DEST_MATH_SEGMENT2__CTOR_OFFSET UNITYSDK_OFFSET(0x90F630)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment2_TypeDefinitionIndex = 33207;
