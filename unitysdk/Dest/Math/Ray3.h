...
#define DEST_MATH_RAY3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA75CA0)
#define DEST_MATH_RAY3_EVAL_OFFSET UNITYSDK_OFFSET(0xA109E0)
#define DEST_MATH_RAY3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1E695790)
#define DEST_MATH_RAY3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1E6956F0)
#define DEST_MATH_RAY3_PROJECT_OFFSET UNITYSDK_OFFSET(0xA75CE0)
#define DEST_MATH_RAY3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA75D40)
#define DEST_MATH_RAY3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3E5800)
#define DEST_MATH_RAY3__CTOR_OFFSET UNITYSDK_OFFSET(0x936BA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Ray3_TypeDefinitionIndex = 34780;
