...
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1C3ADD40)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1C3AEA30)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_OFFSET UNITYSDK_OFFSET(0x1C3AE620)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1C3AE3E0)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C3AE240)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1C3AE260)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1C3AE350)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C3ADCC0)

namespace Dest::Math
{
	inline static constexpr unsigned int IndexedTrianglesSampler_TypeDefinitionIndex = 33243;
