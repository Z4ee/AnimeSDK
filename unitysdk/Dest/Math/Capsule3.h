...
#define DEST_MATH_CAPSULE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9D6F00)
#define DEST_MATH_CAPSULE3__CTOR_OFFSET UNITYSDK_OFFSET(0x9D6F00)

namespace Dest::Math
{
	inline static constexpr unsigned int Capsule3_TypeDefinitionIndex = 33211;
