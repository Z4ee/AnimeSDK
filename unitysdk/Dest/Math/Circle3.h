...
#define DEST_MATH_CIRCLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0xAC3EC0)
#define DEST_MATH_CIRCLE3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0xAC3EB0)
#define DEST_MATH_CIRCLE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1FA47280)
#define DEST_MATH_CIRCLE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1FA47710)
#define DEST_MATH_CIRCLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xAC4090)
#define DEST_MATH_CIRCLE3_EVAL_1_OFFSET UNITYSDK_OFFSET(0xAC3FC0)
#define DEST_MATH_CIRCLE3_EVAL_OFFSET UNITYSDK_OFFSET(0xAC3EE0)
#define DEST_MATH_CIRCLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0xAC40E0)
#define DEST_MATH_CIRCLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xAC4140)
#define DEST_MATH_CIRCLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0xAC3C30)
#define DEST_MATH_CIRCLE3__CTOR_2_OFFSET UNITYSDK_OFFSET(0xAC3D60)
#define DEST_MATH_CIRCLE3__CTOR_3_OFFSET UNITYSDK_OFFSET(0xAC3E00)
#define DEST_MATH_CIRCLE3__CTOR_OFFSET UNITYSDK_OFFSET(0xAC3B00)

namespace Dest::Math
{
	inline static constexpr unsigned int Circle3_TypeDefinitionIndex = 35434;
