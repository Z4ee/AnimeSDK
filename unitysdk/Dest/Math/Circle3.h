...
#define DEST_MATH_CIRCLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0xA75680)
#define DEST_MATH_CIRCLE3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0xA75670)
#define DEST_MATH_CIRCLE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1E691D10)
#define DEST_MATH_CIRCLE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1E6921A0)
#define DEST_MATH_CIRCLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA75850)
#define DEST_MATH_CIRCLE3_EVAL_1_OFFSET UNITYSDK_OFFSET(0xA75780)
#define DEST_MATH_CIRCLE3_EVAL_OFFSET UNITYSDK_OFFSET(0xA756A0)
#define DEST_MATH_CIRCLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0xA758B0)
#define DEST_MATH_CIRCLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA75910)
#define DEST_MATH_CIRCLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA753F0)
#define DEST_MATH_CIRCLE3__CTOR_2_OFFSET UNITYSDK_OFFSET(0xA75520)
#define DEST_MATH_CIRCLE3__CTOR_3_OFFSET UNITYSDK_OFFSET(0xA755C0)
#define DEST_MATH_CIRCLE3__CTOR_OFFSET UNITYSDK_OFFSET(0xA752C0)

namespace Dest::Math
{
	inline static constexpr unsigned int Circle3_TypeDefinitionIndex = 34775;
