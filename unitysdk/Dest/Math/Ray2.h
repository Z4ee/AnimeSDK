...
#define DEST_MATH_RAY2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0xA759A0)
#define DEST_MATH_RAY2_EVAL_OFFSET UNITYSDK_OFFSET(0xA75970)
#define DEST_MATH_RAY2_PROJECT_OFFSET UNITYSDK_OFFSET(0xA75B00)
#define DEST_MATH_RAY2_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA75BF0)
#define DEST_MATH_RAY2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2BDE80)
#define DEST_MATH_RAY2__CTOR_OFFSET UNITYSDK_OFFSET(0x61A110)

namespace Dest::Math
{
	inline static constexpr unsigned int Ray2_TypeDefinitionIndex = 34769;
