...
#define DEST_MATH_LINE2_ANGLEBETWEENTWOLINES_OFFSET UNITYSDK_OFFSET(0x9E31D0)
#define DEST_MATH_LINE2_CREATEBETWEENANDEQUIDISTANTTOPOINTS_OFFSET UNITYSDK_OFFSET(0x1C542960)
#define DEST_MATH_LINE2_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1C542830)
#define DEST_MATH_LINE2_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1C542780)
#define DEST_MATH_LINE2_CREATEPARALLELTOGIVENLINEATGIVENDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C5429D0)
#define DEST_MATH_LINE2_CREATEPERPTOLINETRHOUGHPOINT_OFFSET UNITYSDK_OFFSET(0x1C5428E0)
#define DEST_MATH_LINE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9E2660)
#define DEST_MATH_LINE2_EVAL_OFFSET UNITYSDK_OFFSET(0x9D40B0)
#define DEST_MATH_LINE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x9E30F0)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_1_OFFSET UNITYSDK_OFFSET(0x9E2AB0)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_2_OFFSET UNITYSDK_OFFSET(0x9E2CE0)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_3_OFFSET UNITYSDK_OFFSET(0x9E2F90)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_OFFSET UNITYSDK_OFFSET(0x9E2830)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_1_OFFSET UNITYSDK_OFFSET(0x9E2BC0)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_2_OFFSET UNITYSDK_OFFSET(0x9E2DD0)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_3_OFFSET UNITYSDK_OFFSET(0x9E3040)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x9E28D0)
#define DEST_MATH_LINE2_QUERYSIDE_1_OFFSET UNITYSDK_OFFSET(0x9E2980)
#define DEST_MATH_LINE2_QUERYSIDE_2_OFFSET UNITYSDK_OFFSET(0x9E2CD0)
#define DEST_MATH_LINE2_QUERYSIDE_3_OFFSET UNITYSDK_OFFSET(0x9E2EC0)
#define DEST_MATH_LINE2_QUERYSIDE_OFFSET UNITYSDK_OFFSET(0x9E2770)
#define DEST_MATH_LINE2_SIGNEDDISTANCETO_OFFSET UNITYSDK_OFFSET(0x9E25D0)
#define DEST_MATH_LINE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9E3290)
#define DEST_MATH_LINE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2FED90)
#define DEST_MATH_LINE2__CTOR_OFFSET UNITYSDK_OFFSET(0x54B460)

namespace Dest::Math
{
	inline static constexpr unsigned int Line2_TypeDefinitionIndex = 33203;
