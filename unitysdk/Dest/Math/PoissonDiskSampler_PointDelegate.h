...
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1E7DC4D0)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1E7DC520)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1E7DC190)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E7DC170)

namespace Dest::Math
{
	inline static constexpr unsigned int PoissonDiskSampler_PointDelegate_TypeDefinitionIndex = 34803;
