...
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1FBBB640)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1FBBB690)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1FBBB350)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1FBBB330)

namespace Dest::Math
{
	inline static constexpr unsigned int PoissonDiskSampler_PointDelegate_TypeDefinitionIndex = 35462;
