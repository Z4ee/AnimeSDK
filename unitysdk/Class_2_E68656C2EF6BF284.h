...
#define CLASS_2_E68656C2EF6BF284_DISPOSE_OFFSET UNITYSDK_OFFSET(0x113C4130)
#define CLASS_2_E68656C2EF6BF284_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x113C4180)
#define CLASS_2_E68656C2EF6BF284_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x113C4530)
#define CLASS_2_E68656C2EF6BF284_TICK_OFFSET UNITYSDK_OFFSET(0x113C4580)
#define CLASS_2_E68656C2EF6BF284__CTOR_OFFSET UNITYSDK_OFFSET(0x113C4120)

inline static constexpr unsigned int Class_2_E68656C2EF6BF284_TypeDefinitionIndex = 46868;

class Class_2_E68656C2EF6BF284 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::ElfProgressUpgrade* Field_2_0; // 0x20
