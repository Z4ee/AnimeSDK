...
#define CLASS_2_E68656C2EF6BF284_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA3C40B0)
#define CLASS_2_E68656C2EF6BF284_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA3C4100)
#define CLASS_2_E68656C2EF6BF284_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA3C4450)
#define CLASS_2_E68656C2EF6BF284_TICK_OFFSET UNITYSDK_OFFSET(0xA3C44A0)
#define CLASS_2_E68656C2EF6BF284__CTOR_OFFSET UNITYSDK_OFFSET(0xA3C40A0)

inline static constexpr unsigned int Class_2_E68656C2EF6BF284_TypeDefinitionIndex = 54294;

class Class_2_E68656C2EF6BF284 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ElfProgressUpgrade* Field_2_0; // 0x18
