...
#define MINIMAPCLIPPER_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x93360E0)
#define MINIMAPCLIPPER_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0x9336240)
#define MINIMAPCLIPPER_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9336190)
#define MINIMAPCLIPPER_METHOD_7_3D57569EEAF613B6_OFFSET UNITYSDK_OFFSET(0x93369E0)
#define MINIMAPCLIPPER_METHOD_7_9C0F83425CE501BF_OFFSET UNITYSDK_OFFSET(0x9337630)
#define MINIMAPCLIPPER_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0x93374D0)
#define MINIMAPCLIPPER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x9337480)
#define MINIMAPCLIPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9338230)
#define MINIMAPCLIPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9338050)
#define MINIMAPCLIPPER_SETCLIPSIZE_OFFSET UNITYSDK_OFFSET(0x9337EB0)
#define MINIMAPCLIPPER_SETUVOFFSET_OFFSET UNITYSDK_OFFSET(0x9336830)
#define MINIMAPCLIPPER_SETUVSCALE_OFFSET UNITYSDK_OFFSET(0x93373F0)
#define MINIMAPCLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x9338290)
#define MINIMAPCLIPPER___IFIXBASEPROXY_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x93382A0)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9338360)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x93382B0)

inline static constexpr unsigned int MiniMapClipper_TypeDefinitionIndex = 44318;
