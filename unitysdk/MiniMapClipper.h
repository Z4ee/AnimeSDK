...
#define MINIMAPCLIPPER_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0xA84B5D0)
#define MINIMAPCLIPPER_GET_MATERIALFORRENDERING_OFFSET UNITYSDK_OFFSET(0xA84B730)
#define MINIMAPCLIPPER_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xA84B680)
#define MINIMAPCLIPPER_METHOD_7_2302CA71309E4198_OFFSET UNITYSDK_OFFSET(0xA84CA10)
#define MINIMAPCLIPPER_METHOD_7_3D57569EEAF613B6_OFFSET UNITYSDK_OFFSET(0xA84BEB0)
#define MINIMAPCLIPPER_MODIFYMESH_1_OFFSET UNITYSDK_OFFSET(0xA84C8B0)
#define MINIMAPCLIPPER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xA84C860)
#define MINIMAPCLIPPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA84D630)
#define MINIMAPCLIPPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA84D450)
#define MINIMAPCLIPPER_SETCLIPSIZE_OFFSET UNITYSDK_OFFSET(0xA84D2A0)
#define MINIMAPCLIPPER_SETUVOFFSET_OFFSET UNITYSDK_OFFSET(0xA84BD00)
#define MINIMAPCLIPPER_SETUVSCALE_OFFSET UNITYSDK_OFFSET(0xA84C7D0)
#define MINIMAPCLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA84D690)
#define MINIMAPCLIPPER___IFIXBASEPROXY_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xA84D6A0)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA84D760)
#define MINIMAPCLIPPER___IFIXBASEPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA84D6B0)

inline static constexpr unsigned int MiniMapClipper_TypeDefinitionIndex = 44864;
...
public:
	...
	::System::Void Method_7_2302CA71309E4198(::UnityEngine::UI::VertexHelper* a1, ::UnityEngine::Pooled::PooledList_1<::UnityEngine::UIVertex>* a2, ::System::Single a3, ::System::Single a4)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::UI::VertexHelper*, ::UnityEngine::Pooled::PooledList_1<::UnityEngine::UIVertex>*, ::System::Single, ::System::Single))((::PBYTE)hIl2Cpp + MINIMAPCLIPPER_METHOD_7_2302CA71309E4198_OFFSET))(this, a1, a2, a3, a4);
	}
	...
	::System::Void __iFixBaseProxy_ModifyMesh(::UnityEngine::Mesh* a1)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::Mesh*))((::PBYTE)hIl2Cpp + MINIMAPCLIPPER___IFIXBASEPROXY_MODIFYMESH_OFFSET))(this, a1);
	}
