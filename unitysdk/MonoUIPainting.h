...
#define MONOUIPAINTING_DOENDDRAW_OFFSET UNITYSDK_OFFSET(0x11BFE320)
#define MONOUIPAINTING_DOPROCESSDRAW_OFFSET UNITYSDK_OFFSET(0x11BFE120)
#define MONOUIPAINTING_DOSTARTDRAW_OFFSET UNITYSDK_OFFSET(0x11BFE2B0)
#define MONOUIPAINTING_DRAWBYGAMEPADJOYSTICK_OFFSET UNITYSDK_OFFSET(0x11BFD710)
#define MONOUIPAINTING_DRAW_OFFSET UNITYSDK_OFFSET(0x11BFE560)
#define MONOUIPAINTING_FILLRENDERTEXTUREWITHBG_OFFSET UNITYSDK_OFFSET(0x11BFD230)
#define MONOUIPAINTING_FULLPROGRESS_OFFSET UNITYSDK_OFFSET(0x11BFBEA0)
#define MONOUIPAINTING_GET_MESH_OFFSET UNITYSDK_OFFSET(0x11BFC1F0)
#define MONOUIPAINTING_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x11BFBE90)
#define MONOUIPAINTING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11BFD140)
#define MONOUIPAINTING_ONDRAG_OFFSET UNITYSDK_OFFSET(0x11BFEFD0)
#define MONOUIPAINTING_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x11BFE370)
#define MONOUIPAINTING_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x11BFF180)
#define MONOUIPAINTING_REFRESHRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x11BFD450)
#define MONOUIPAINTING_RESETIMAGE_OFFSET UNITYSDK_OFFSET(0x11BFCF80)
#define MONOUIPAINTING_SETUP_OFFSET UNITYSDK_OFFSET(0x11BFC710)
#define MONOUIPAINTING_START_OFFSET UNITYSDK_OFFSET(0x11BFC6B0)
#define MONOUIPAINTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x11BFF2B0)
#define MONOUIPAINTING__CTOR_OFFSET UNITYSDK_OFFSET(0x11BFF200)

inline static constexpr unsigned int MonoUIPainting_TypeDefinitionIndex = 72822;
...
public:
	...
	{
		return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0x435F0);
	}
	static ::System::Int32* StaticGet__ScaleOffset()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0x10440);
	}
	static ::System::Int32* StaticGet__MainTex()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0x10444);
	}
