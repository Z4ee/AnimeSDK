...
#define PARTICLEANIMATIONDATA_GETFRAMEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B169A70)
#define PARTICLEANIMATIONDATA_GETFRAMEDATA_1_OFFSET UNITYSDK_OFFSET(0x1B169C20)
#define PARTICLEANIMATIONDATA_GETFRAMEDATA_OFFSET UNITYSDK_OFFSET(0x1B169B80)
#define PARTICLEANIMATIONDATA_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1B169A50)
#define PARTICLEANIMATIONDATA_GET_PARTICLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B169A40)
#define PARTICLEANIMATIONDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B169C90)
#define PARTICLEANIMATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B169CF0)

inline static constexpr unsigned int ParticleAnimationData_TypeDefinitionIndex = 26893;
