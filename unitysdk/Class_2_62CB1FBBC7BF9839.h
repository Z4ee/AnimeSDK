...
#define CLASS_2_62CB1FBBC7BF9839_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13B03CD0)
#define CLASS_2_62CB1FBBC7BF9839_METHOD_2_F240EFA7A704696B_OFFSET UNITYSDK_OFFSET(0x13B04400)
#define CLASS_2_62CB1FBBC7BF9839_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x13B03D10)
#define CLASS_2_62CB1FBBC7BF9839_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x13B044C0)
#define CLASS_2_62CB1FBBC7BF9839_TICK_OFFSET UNITYSDK_OFFSET(0x13B04510)
#define CLASS_2_62CB1FBBC7BF9839__CTOR_OFFSET UNITYSDK_OFFSET(0x13B03C50)

inline static constexpr unsigned int Class_2_62CB1FBBC7BF9839_TypeDefinitionIndex = 51585;

class Class_2_62CB1FBBC7BF9839 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::TargetEvaluator* Field_2_1; // 0x20
	::RPG::GameCore::MoveTeamRootPosByTargetDistance* Field_2_2; // 0x28
