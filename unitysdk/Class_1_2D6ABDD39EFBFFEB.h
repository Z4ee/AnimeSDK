...
#define CLASS_1_2D6ABDD39EFBFFEB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C625450)
...
{
public:
	::System::Boolean CLIIGEPCNDE; // 0x10
	::RPG::Client::LittleGame::Marble::MarbleEventType LAOACNPDOLD; // 0x14
