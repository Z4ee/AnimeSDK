...
#define CLASS_2_73D810C51FF41945_METHOD_2_078D85152011B919_1_OFFSET UNITYSDK_OFFSET(0x185150B0)
#define CLASS_2_73D810C51FF41945_METHOD_2_078D85152011B919_OFFSET UNITYSDK_OFFSET(0x18515050)
#define CLASS_2_73D810C51FF41945_METHOD_2_A0CFDB5F5B1DB2D6_OFFSET UNITYSDK_OFFSET(0x18515110)
#define CLASS_2_73D810C51FF41945__CTOR_OFFSET UNITYSDK_OFFSET(0x18515270)
#define CLASS_2_73D810C51FF41945__ONBIND_OFFSET UNITYSDK_OFFSET(0x185151C0)

inline static constexpr unsigned int Class_2_73D810C51FF41945_TypeDefinitionIndex = 71771;

class Class_2_73D810C51FF41945 : public ::Class_1_34917908B7833130
{
public:
	::System::String* OLOIFNNLKJP; // 0x60
	::UnityEngine::UI::Image* DNICBKPAIDN; // 0x68
	::UnityEngine::Transform* DPHGGCPKAPF; // 0x70
