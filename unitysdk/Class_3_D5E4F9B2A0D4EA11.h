...
#define CLASS_3_D5E4F9B2A0D4EA11_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x13BA5680)
#define CLASS_3_D5E4F9B2A0D4EA11_METHOD_3_01CC46B2EE97FDDD_OFFSET UNITYSDK_OFFSET(0x13BA5D50)
#define CLASS_3_D5E4F9B2A0D4EA11_METHOD_3_411FCB9D08C80CF5_OFFSET UNITYSDK_OFFSET(0x13BA5900)
#define CLASS_3_D5E4F9B2A0D4EA11_METHOD_3_BADC81CF9C936EDA_OFFSET UNITYSDK_OFFSET(0x13BA5870)
#define CLASS_3_D5E4F9B2A0D4EA11_METHOD_3_DB1F5A2F79E86973_OFFSET UNITYSDK_OFFSET(0x13BA5C00)
#define CLASS_3_D5E4F9B2A0D4EA11__CTOR_OFFSET UNITYSDK_OFFSET(0x13BA5820)

inline static constexpr unsigned int Class_3_D5E4F9B2A0D4EA11_TypeDefinitionIndex = 59055;
