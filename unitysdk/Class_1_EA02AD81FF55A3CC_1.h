...
#define CLASS_1_EA02AD81FF55A3CC_1_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1C11FF70)
#define CLASS_1_EA02AD81FF55A3CC_1_CLONE_OFFSET UNITYSDK_OFFSET(0x1C11F990)
#define CLASS_1_EA02AD81FF55A3CC_1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1C11FC20)
#define CLASS_1_EA02AD81FF55A3CC_1_EQUALS_OFFSET UNITYSDK_OFFSET(0x1C11FA70)
#define CLASS_1_EA02AD81FF55A3CC_1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1C11FDA0)
#define CLASS_1_EA02AD81FF55A3CC_1_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1C1200D0)
#define CLASS_1_EA02AD81FF55A3CC_1_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1C120040)
#define CLASS_1_EA02AD81FF55A3CC_1_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1C11FA30)
#define CLASS_1_EA02AD81FF55A3CC_1_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1C11F8A0)
#define CLASS_1_EA02AD81FF55A3CC_1_METHOD_1_686CBC4FBD0AAA58_OFFSET UNITYSDK_OFFSET(0x1C11FA60)
#define CLASS_1_EA02AD81FF55A3CC_1_METHOD_1_6BD2A2909D8CFAD3_OFFSET UNITYSDK_OFFSET(0x1C11FA50)
#define CLASS_1_EA02AD81FF55A3CC_1_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1C11FA40)
#define CLASS_1_EA02AD81FF55A3CC_1_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1C11F900)
#define CLASS_1_EA02AD81FF55A3CC_1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1C11FE30)
#define CLASS_1_EA02AD81FF55A3CC_1_WRITETO_OFFSET UNITYSDK_OFFSET(0x1C11FE90)
#define CLASS_1_EA02AD81FF55A3CC_1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C120290)
#define CLASS_1_EA02AD81FF55A3CC_1__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1C11F920)
#define CLASS_1_EA02AD81FF55A3CC_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1C11F910)

inline static constexpr unsigned int Class_1_EA02AD81FF55A3CC_1_TypeDefinitionIndex = 25663;

class Class_1_EA02AD81FF55A3CC_1 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_EA02AD81FF55A3CC_1*>** StaticGet_Field_1_0()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_EA02AD81FF55A3CC_1*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_EA02AD81FF55A3CC_1_TypeDefinitionIndex)->GetStaticField(0x3C7C0);
	}
