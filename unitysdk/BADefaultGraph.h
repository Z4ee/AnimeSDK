...
#define BADEFAULTGRAPH_GETGRAPH_OFFSET UNITYSDK_OFFSET(0x19290D60)
#define BADEFAULTGRAPH_GET_OFFSET UNITYSDK_OFFSET(0x19290C50)
#define BADEFAULTGRAPH_INIT_OFFSET UNITYSDK_OFFSET(0x19290BC0)
#define BADEFAULTGRAPH_PLAYCLIPS_OFFSET UNITYSDK_OFFSET(0x19290C60)
#define BADEFAULTGRAPH_PLAYCLIP_OFFSET UNITYSDK_OFFSET(0x19290CB0)
#define BADEFAULTGRAPH__CTOR_OFFSET UNITYSDK_OFFSET(0x19290B30)
...
public:
	...
	{
		return (::BADefaultGraph**)Il2CppClass::FromTypeDefinitionIndex(BADefaultGraph_TypeDefinitionIndex)->GetStaticField(0x319B0);
	}
