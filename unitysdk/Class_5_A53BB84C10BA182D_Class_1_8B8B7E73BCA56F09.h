...
#define CLASS_5_A53BB84C10BA182D_CLASS_1_8B8B7E73BCA56F09_METHOD_1_0D7638DBC93E5002_OFFSET UNITYSDK_OFFSET(0x17493470)
#define CLASS_5_A53BB84C10BA182D_CLASS_1_8B8B7E73BCA56F09_METHOD_1_4D95DF046A3D9DF8_OFFSET UNITYSDK_OFFSET(0x174934F0)
#define CLASS_5_A53BB84C10BA182D_CLASS_1_8B8B7E73BCA56F09__CTOR_OFFSET UNITYSDK_OFFSET(0x17493460)

inline static constexpr unsigned int Class_5_A53BB84C10BA182D_Class_1_8B8B7E73BCA56F09_TypeDefinitionIndex = 43057;
...
public:
	...
	::MoleMole::UIHollowChessboard3DModelController* Field_1_3; // 0x20
	::Class_1_E5B7864412CDC074* Field_1_4; // 0x28
	::Class_5_A53BB84C10BA182D* Field_1_1; // 0x30
	::Class_5_A6F8D19602712D95* Field_1_6; // 0x38
	::Class_4_B1EAD8476216C1D8* Field_1_2; // 0x40
	::MoleMole::PlayerOnViewState Field_1_9; // 0x48
	::Enum_3_AE1972D98541A9AF Field_1_5; // 0x4C
	::MoleMole::HollowChessboard::HollowCell Field_1_8; // 0x50
