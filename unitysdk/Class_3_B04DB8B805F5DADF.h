...
#define CLASS_3_B04DB8B805F5DADF_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x19ECCE20)
#define CLASS_3_B04DB8B805F5DADF_METHOD_3_3A54EBF263D9FC88_OFFSET UNITYSDK_OFFSET(0x19ECD0D0)
#define CLASS_3_B04DB8B805F5DADF_METHOD_3_3EEEA77014B05956_OFFSET UNITYSDK_OFFSET(0x19ECCFD0)
#define CLASS_3_B04DB8B805F5DADF_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x19ECCF40)
#define CLASS_3_B04DB8B805F5DADF_METHOD_3_AA6AC38756233BD0_OFFSET UNITYSDK_OFFSET(0x19ECD080)
#define CLASS_3_B04DB8B805F5DADF_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x19ECCDB0)
#define CLASS_3_B04DB8B805F5DADF__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ECCE70)
#define CLASS_3_B04DB8B805F5DADF__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECCEF0)

inline static constexpr unsigned int Class_3_B04DB8B805F5DADF_TypeDefinitionIndex = 54995;

class Class_3_B04DB8B805F5DADF : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_10 = 0x34; // 0x0
