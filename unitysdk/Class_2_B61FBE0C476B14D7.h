...
#define CLASS_2_B61FBE0C476B14D7_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19279F70)
#define CLASS_2_B61FBE0C476B14D7_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x1927A1C0)
#define CLASS_2_B61FBE0C476B14D7_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1927A030)
#define CLASS_2_B61FBE0C476B14D7_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1927A110)
#define CLASS_2_B61FBE0C476B14D7_TICK_OFFSET UNITYSDK_OFFSET(0x1927A160)
#define CLASS_2_B61FBE0C476B14D7__CTOR_OFFSET UNITYSDK_OFFSET(0x19279F60)

inline static constexpr unsigned int Class_2_B61FBE0C476B14D7_TypeDefinitionIndex = 58107;

class Class_2_B61FBE0C476B14D7 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::BattlePlayTalk* EJJEEJENLDA; // 0x18
	::RPG::GameCore::TaskContext* APKCDIIEJLO; // 0x20
