...
#define CLASS_2_A80FFA2F42BC210A_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0xED96B60)
#define CLASS_2_A80FFA2F42BC210A_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0xED96E80)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_1BE562D4DCDDD49D_OFFSET UNITYSDK_OFFSET(0xED95DE0)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_230E8E2F7F1839E2_OFFSET UNITYSDK_OFFSET(0xED96390)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_2A2B4A2E0BDAAF15_OFFSET UNITYSDK_OFFSET(0xED96680)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xED95FF0)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_5C2158E850B02732_OFFSET UNITYSDK_OFFSET(0xED956F0)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_6E520D7D4D494BBE_OFFSET UNITYSDK_OFFSET(0xED95960)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_92ED16ECBAFB45C4_OFFSET UNITYSDK_OFFSET(0xED95800)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xED95660)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_974A70E8019154E7_OFFSET UNITYSDK_OFFSET(0xED968B0)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0xED96A70)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_C8D6B29192F288ED_OFFSET UNITYSDK_OFFSET(0xED95AE0)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_D263FCED0246111F_OFFSET UNITYSDK_OFFSET(0xED95E70)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_F07808AF19FA033A_OFFSET UNITYSDK_OFFSET(0xED96300)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_F162BDE3B419CFCF_OFFSET UNITYSDK_OFFSET(0xED96270)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_F37CDBD6D46274D2_1_OFFSET UNITYSDK_OFFSET(0xED96820)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_F37CDBD6D46274D2_2_OFFSET UNITYSDK_OFFSET(0xED969B0)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0xED96700)
#define CLASS_2_A80FFA2F42BC210A_METHOD_2_FD3B916300F77FDA_OFFSET UNITYSDK_OFFSET(0xED95D90)
#define CLASS_2_A80FFA2F42BC210A__CTOR_OFFSET UNITYSDK_OFFSET(0xED97160)
#define CLASS_2_A80FFA2F42BC210A__ONBIND_OFFSET UNITYSDK_OFFSET(0xED95450)

inline static constexpr unsigned int Class_2_A80FFA2F42BC210A_TypeDefinitionIndex = 71594;
...
public:
	...
	::RPG::Client::SystemOpenModule* AGACAPGOBCI; // 0x68
	::UnityEngine::Transform* COICMBCGBAE; // 0x70
	::UnityEngine::Transform* NAMLIBFIFNE; // 0x78
	::UnityEngine::Transform* CPEBAEFNJKH; // 0x80
	::UnityEngine::Transform* LOOJEDMAKHC; // 0x88
	::UnityEngine::Animator* CFNGLMDMENE; // 0x90
	::System::Boolean HABBLKDIKGK; // 0x98
	::System::Boolean CPDGFJFHMMG; // 0x99
	::System::Boolean GBFBLPJFCGB; // 0x9A
	::System::Boolean BCMBANIDHNP; // 0x9B
	::System::Boolean CBILHPMCOMD; // 0x9C
