...
#define CLASS_1_96EDC22AC7BC5724_ADD_HANDLEEXIT_OFFSET UNITYSDK_OFFSET(0x1783B460)
#define CLASS_1_96EDC22AC7BC5724_METHOD_1_414033B13D333368_OFFSET UNITYSDK_OFFSET(0x1783B1F0)
#define CLASS_1_96EDC22AC7BC5724_METHOD_1_90E86A506042BE77_OFFSET UNITYSDK_OFFSET(0x1783B310)
#define CLASS_1_96EDC22AC7BC5724_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1783B2C0)
#define CLASS_1_96EDC22AC7BC5724_METHOD_1_B213056103887067_OFFSET UNITYSDK_OFFSET(0x1783B3A0)
#define CLASS_1_96EDC22AC7BC5724_METHOD_1_BD83D9A311EA4A81_OFFSET UNITYSDK_OFFSET(0x1783B140)
#define CLASS_1_96EDC22AC7BC5724_METHOD_1_EE3CCB3EBB7312F7_OFFSET UNITYSDK_OFFSET(0x1783B270)
#define CLASS_1_96EDC22AC7BC5724_REMOVE_HANDLEEXIT_OFFSET UNITYSDK_OFFSET(0x1783B4C0)
#define CLASS_1_96EDC22AC7BC5724__CTOR_OFFSET UNITYSDK_OFFSET(0x1783B520)
#define CLASS_1_96EDC22AC7BC5724__GET_EXITCOMMAND_B__13_0_OFFSET UNITYSDK_OFFSET(0x1783B530)

inline static constexpr unsigned int Class_1_96EDC22AC7BC5724_TypeDefinitionIndex = 80234;

class Class_1_96EDC22AC7BC5724 : public ::System::Object
{
public:
	::RPG::Client::ChallengeGroupData* POADJJEHDBL; // 0x10
	::System::Action* HandleExit; // 0x18
	::Class_0_16E4307DCC419505_318* LCGBLFOHNFA; // 0x20
	...
	{
		return ((::Class_0_16E4307DCC419505_318*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_96EDC22AC7BC5724_METHOD_1_B213056103887067_OFFSET))(this);
	}
