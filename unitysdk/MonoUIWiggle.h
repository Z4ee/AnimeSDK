...
#define MONOUIWIGGLE_FRAC_OFFSET UNITYSDK_OFFSET(0xEBE8730)
#define MONOUIWIGGLE_RAND_OFFSET UNITYSDK_OFFSET(0xEBE8790)
#define MONOUIWIGGLE_START_OFFSET UNITYSDK_OFFSET(0xEBE85E0)
#define MONOUIWIGGLE_UPDATE_OFFSET UNITYSDK_OFFSET(0xEBE8850)
#define MONOUIWIGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0xEBE8970)

inline static constexpr unsigned int MonoUIWiggle_TypeDefinitionIndex = 77587;
