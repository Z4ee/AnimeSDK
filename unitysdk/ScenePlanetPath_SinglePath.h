...
#define SCENEPLANETPATH_SINGLEPATH_ADDPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1C1413F0)
#define SCENEPLANETPATH_SINGLEPATH_DELETEPOINT_OFFSET UNITYSDK_OFFSET(0x1C141680)
#define SCENEPLANETPATH_SINGLEPATH_GETLOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x1C140EC0)
#define SCENEPLANETPATH_SINGLEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1C1417E0)

inline static constexpr unsigned int ScenePlanetPath_SinglePath_TypeDefinitionIndex = 26431;
