...
#define CLASS_1_BC601FCB47AEB5E5_METHOD_1_239127A8B01A1A3F_OFFSET UNITYSDK_OFFSET(0x1DACEF40)
#define CLASS_1_BC601FCB47AEB5E5__CTOR_OFFSET UNITYSDK_OFFSET(0x1DACF040)

inline static constexpr unsigned int Class_1_BC601FCB47AEB5E5_TypeDefinitionIndex = 13610;

class Class_1_BC601FCB47AEB5E5 : public ::System::Object
{
public:
	::System::UInt32 POAIHJCEKCF; // 0x10
	::RPG::GameCore::HeartDialEmoType BNFEAFPEOIE; // 0x14
