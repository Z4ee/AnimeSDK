...
#define TRANSFORMPATHANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xAC28400)
#define TRANSFORMPATHANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xAC28840)
#define TRANSFORMPATHANIM_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xAC27C70)
#define TRANSFORMPATHANIM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xAC27E00)
#define TRANSFORMPATHANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0xAC27E60)
#define TRANSFORMPATHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xAC288F0)

inline static constexpr unsigned int TransformPathAnim_TypeDefinitionIndex = 38307;
