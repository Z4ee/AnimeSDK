...
#define TRANSFORMPATHANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0xD0E6990)
#define TRANSFORMPATHANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0xD0E6DD0)
#define TRANSFORMPATHANIM_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0xD0E6200)
#define TRANSFORMPATHANIM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xD0E6390)
#define TRANSFORMPATHANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0xD0E63F0)
#define TRANSFORMPATHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0xD0E6E80)

inline static constexpr unsigned int TransformPathAnim_TypeDefinitionIndex = 44737;
