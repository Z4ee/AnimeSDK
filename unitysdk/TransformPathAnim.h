...
#define TRANSFORMPATHANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x10529640)
#define TRANSFORMPATHANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x10529A80)
#define TRANSFORMPATHANIM_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x10528EB0)
#define TRANSFORMPATHANIM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x10529040)
#define TRANSFORMPATHANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x105290A0)
#define TRANSFORMPATHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x10529B30)
