...
#define TRANSFORMPATHANIM_GET_ARTBOUNDFULL_OFFSET UNITYSDK_OFFSET(0x104F6100)
#define TRANSFORMPATHANIM_GET_ARTBOUND_OFFSET UNITYSDK_OFFSET(0x104F6540)
#define TRANSFORMPATHANIM_METHOD_5_C638E91FC0D3A13A_OFFSET UNITYSDK_OFFSET(0x104F5970)
#define TRANSFORMPATHANIM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x104F5B00)
#define TRANSFORMPATHANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x104F5B60)
#define TRANSFORMPATHANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x104F65F0)
