...
#define CLASS_3_0BEA316B1FD045B6_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B2C9B0)
#define CLASS_3_0BEA316B1FD045B6_METHOD_3_87BD14BAFA89EB07_1_OFFSET UNITYSDK_OFFSET(0x10B2C7B0)
#define CLASS_3_0BEA316B1FD045B6_METHOD_3_87BD14BAFA89EB07_OFFSET UNITYSDK_OFFSET(0x10B2C5B0)
#define CLASS_3_0BEA316B1FD045B6_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10B2C160)
#define CLASS_3_0BEA316B1FD045B6__CTOR_OFFSET UNITYSDK_OFFSET(0x10B2C130)
#define CLASS_3_0BEA316B1FD045B6___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10B2CB90)

inline static constexpr unsigned int Class_3_0BEA316B1FD045B6_TypeDefinitionIndex = 47092;

class Class_3_0BEA316B1FD045B6 : public ::RPG::GameCore::ImmediateTaskBase_1<::RPG::GameCore::PropSetupTwoStateUITrigger*>
{
public:
	::Class_3_1443D71C2B538871* Field_3_3; // 0x28
