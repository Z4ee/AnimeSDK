...
#define STRUCT_2_90E529DB4DCB014F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7D99B0)
#define STRUCT_2_90E529DB4DCB014F_EQUALS_OFFSET UNITYSDK_OFFSET(0x7D9950)
#define STRUCT_2_90E529DB4DCB014F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7D99C0)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x7D9A70)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x7D9B00)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x17F22570)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x7D9A10)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_704CAEDCD95E9E98_OFFSET UNITYSDK_OFFSET(0x17F224B0)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_7499FDA35EC6FE21_OFFSET UNITYSDK_OFFSET(0x7D9B80)
#define STRUCT_2_90E529DB4DCB014F_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x7D9B90)
#define STRUCT_2_90E529DB4DCB014F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7D9940)
#define STRUCT_2_90E529DB4DCB014F__CCTOR_OFFSET UNITYSDK_OFFSET(0x17F22330)
#define STRUCT_2_90E529DB4DCB014F__CTOR_OFFSET UNITYSDK_OFFSET(0x7D98D0)

inline static constexpr unsigned int Struct_2_90E529DB4DCB014F_TypeDefinitionIndex = 75121;

struct alignas(4) Struct_2_90E529DB4DCB014F
{
	static ::Struct_2_90E529DB4DCB014F* StaticGet_Field_2_0()
	{
		return (::Struct_2_90E529DB4DCB014F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_90E529DB4DCB014F_TypeDefinitionIndex)->GetStaticField(0xDEC0);
	}
	static ::System::UInt32* StaticGet_Field_2_1()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_90E529DB4DCB014F_TypeDefinitionIndex)->GetStaticField(0xDEC8);
	}
