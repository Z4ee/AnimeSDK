...
#define CLASS_3_8C126CAEE9EEBC13_DISPOSE_OFFSET UNITYSDK_OFFSET(0x99BB070)
#define CLASS_3_8C126CAEE9EEBC13_EVALUATE_OFFSET UNITYSDK_OFFSET(0x99BAD20)
#define CLASS_3_8C126CAEE9EEBC13__CTOR_OFFSET UNITYSDK_OFFSET(0x99BAC50)
#define CLASS_3_8C126CAEE9EEBC13___IFIXBASEPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x99BB0E0)

inline static constexpr unsigned int Class_3_8C126CAEE9EEBC13_TypeDefinitionIndex = 43791;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_8C126CAEE9EEBC13___IFIXBASEPROXY_DISPOSE_OFFSET))(this);
	}
};
