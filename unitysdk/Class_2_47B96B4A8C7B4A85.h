...
#define CLASS_2_47B96B4A8C7B4A85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16F72DF0)
#define CLASS_2_47B96B4A8C7B4A85_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x16F72E40)
#define CLASS_2_47B96B4A8C7B4A85_METHOD_2_936773021FAF4D21_OFFSET UNITYSDK_OFFSET(0x16F73260)
#define CLASS_2_47B96B4A8C7B4A85_ONSKIP_OFFSET UNITYSDK_OFFSET(0x16F72E50)
#define CLASS_2_47B96B4A8C7B4A85_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16F73370)
#define CLASS_2_47B96B4A8C7B4A85_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16F73540)
#define CLASS_2_47B96B4A8C7B4A85_TICK_OFFSET UNITYSDK_OFFSET(0x16F72FA0)
#define CLASS_2_47B96B4A8C7B4A85__CTOR_OFFSET UNITYSDK_OFFSET(0x16F72DE0)
...
{
public:
	::RPG::GameCore::ClockParkStoryCharacterTriggerAnimState* Field_2_0; // 0x18
