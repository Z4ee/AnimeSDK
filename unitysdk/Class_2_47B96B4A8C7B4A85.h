...
#define CLASS_2_47B96B4A8C7B4A85_DISPOSE_OFFSET UNITYSDK_OFFSET(0x10BEADD0)
#define CLASS_2_47B96B4A8C7B4A85_GET_FORCESKIP_OFFSET UNITYSDK_OFFSET(0x10BEAE20)
#define CLASS_2_47B96B4A8C7B4A85_METHOD_2_8131D4D8C02BAA62_OFFSET UNITYSDK_OFFSET(0x10BEB290)
#define CLASS_2_47B96B4A8C7B4A85_ONSKIP_OFFSET UNITYSDK_OFFSET(0x10BEAE30)
#define CLASS_2_47B96B4A8C7B4A85_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x10BEB330)
#define CLASS_2_47B96B4A8C7B4A85_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x10BEB540)
#define CLASS_2_47B96B4A8C7B4A85_TICK_OFFSET UNITYSDK_OFFSET(0x10BEAFD0)
#define CLASS_2_47B96B4A8C7B4A85__CTOR_OFFSET UNITYSDK_OFFSET(0x10BEADC0)

inline static constexpr unsigned int Class_2_47B96B4A8C7B4A85_TypeDefinitionIndex = 42641;

class Class_2_47B96B4A8C7B4A85 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::MonoClockParkStoryCharacter* Field_2_2; // 0x18
	::RPG::GameCore::TaskContext* Field_2_1; // 0x20
	::RPG::GameCore::ClockParkStoryCharacterTriggerAnimState* Field_2_0; // 0x28
