...
#define CLASS_3_5B3989A017DD01E5__CTOR_OFFSET UNITYSDK_OFFSET(0x16234B80)
...
{
public:
	::Class_1_877AA22B04AFB81F_1* FIDJLAKNAJD; // 0x28
	::Class_1_47EB23CB5C4B2615_2* BPCDCCAJIMK; // 0x30
	::RPG::LittleGameShare::DiceCombatCore::GameMode::DiceCombatGameMode HKEACDBJCOD; // 0x38
	::System::Boolean LHECEINIKOA; // 0x39
