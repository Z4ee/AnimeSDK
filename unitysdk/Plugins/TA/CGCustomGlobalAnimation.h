...
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1E579F80)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_GETTIME_OFFSET UNITYSDK_OFFSET(0x1E579F50)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1E57A150)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E57A160)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1E57AA50)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_PLAYWITHTIME_OFFSET UNITYSDK_OFFSET(0x1E57A1F0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_REFRESH_OFFSET UNITYSDK_OFFSET(0x1E57A130)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_START_OFFSET UNITYSDK_OFFSET(0x1E57A140)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0x1E57A120)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E57A170)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E57AA60)

namespace Plugins::TA
{
	inline static constexpr unsigned int CGCustomGlobalAnimation_TypeDefinitionIndex = 38057;
