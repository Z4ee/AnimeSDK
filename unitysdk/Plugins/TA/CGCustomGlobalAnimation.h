...
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1F96BBE0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_GETTIME_OFFSET UNITYSDK_OFFSET(0x1F96BBB0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1F96BDB0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1F96BDC0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1F96C6B0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_PLAYWITHTIME_OFFSET UNITYSDK_OFFSET(0x1F96BE60)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_REFRESH_OFFSET UNITYSDK_OFFSET(0x1F96BD90)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_START_OFFSET UNITYSDK_OFFSET(0x1F96BDA0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0x1F96BD80)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1F96BDD0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1F96C6C0)

namespace Plugins::TA
{
	inline static constexpr unsigned int CGCustomGlobalAnimation_TypeDefinitionIndex = 38718;
