...
#define PLUGINS_MESHLODSIMPLIFIER_MESHLODCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1C560D40)

namespace Plugins::MeshLodSimplifier
{
	inline static constexpr unsigned int MeshLodCreator_TypeDefinitionIndex = 85183;
