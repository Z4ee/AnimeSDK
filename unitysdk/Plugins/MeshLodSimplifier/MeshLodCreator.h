...
#define PLUGINS_MESHLODSIMPLIFIER_MESHLODCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1E890B90)

namespace Plugins::MeshLodSimplifier
{
	inline static constexpr unsigned int MeshLodCreator_TypeDefinitionIndex = 90757;
