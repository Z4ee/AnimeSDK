...
#define PLUGINS_ROOTMOTION_FINALIK_GLOBALTICKMANAGERROOTMOTION_INITDELAYREFRESHLIST_OFFSET UNITYSDK_OFFSET(0x1E6684D0)
#define PLUGINS_ROOTMOTION_FINALIK_GLOBALTICKMANAGERROOTMOTION_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1E668520)
#define PLUGINS_ROOTMOTION_FINALIK_GLOBALTICKMANAGERROOTMOTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E668560)

namespace Plugins::RootMotion::FinalIK
{
	inline static constexpr unsigned int GlobalTickManagerRootMotion_TypeDefinitionIndex = 38216;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_2*>*))((::PBYTE)hIl2Cpp + PLUGINS_ROOTMOTION_FINALIK_GLOBALTICKMANAGERROOTMOTION_INITDELAYREFRESHLIST_OFFSET))(this, delayRefreshList);
		}
