...
#define CLASS_1_5B567C8A01BAEDFE_289_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19872560)
#define CLASS_1_5B567C8A01BAEDFE_289_CLONE_OFFSET UNITYSDK_OFFSET(0x198723D0)
#define CLASS_1_5B567C8A01BAEDFE_289_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19872470)
#define CLASS_1_5B567C8A01BAEDFE_289_EQUALS_OFFSET UNITYSDK_OFFSET(0x19872410)
#define CLASS_1_5B567C8A01BAEDFE_289_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x198724C0)
#define CLASS_1_5B567C8A01BAEDFE_289_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x198725B0)
#define CLASS_1_5B567C8A01BAEDFE_289_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19872580)
#define CLASS_1_5B567C8A01BAEDFE_289_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19872350)
#define CLASS_1_5B567C8A01BAEDFE_289_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19872380)
#define CLASS_1_5B567C8A01BAEDFE_289_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198724F0)
#define CLASS_1_5B567C8A01BAEDFE_289_WRITETO_OFFSET UNITYSDK_OFFSET(0x19872550)
#define CLASS_1_5B567C8A01BAEDFE_289__CCTOR_OFFSET UNITYSDK_OFFSET(0x19872600)
#define CLASS_1_5B567C8A01BAEDFE_289__CTOR_1_OFFSET UNITYSDK_OFFSET(0x198723A0)
#define CLASS_1_5B567C8A01BAEDFE_289__CTOR_OFFSET UNITYSDK_OFFSET(0x19872390)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_289_TypeDefinitionIndex = 30952;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_289*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_289_TypeDefinitionIndex)->GetStaticField(0x4AB00);
	}
