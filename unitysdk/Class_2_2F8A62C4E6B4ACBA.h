...
#define CLASS_2_2F8A62C4E6B4ACBA_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x17A15F10)
#define CLASS_2_2F8A62C4E6B4ACBA_METHOD_2_D7C20B01999BA144_OFFSET UNITYSDK_OFFSET(0x17A15E20)
#define CLASS_2_2F8A62C4E6B4ACBA__CTOR_OFFSET UNITYSDK_OFFSET(0x17A15F60)

inline static constexpr unsigned int Class_2_2F8A62C4E6B4ACBA_TypeDefinitionIndex = 76305;

class Class_2_2F8A62C4E6B4ACBA : public ::Class_1_0CF1228B0978AEEF
{
public:
	::System::Single BKEPLPHNFIA; // 0x40
