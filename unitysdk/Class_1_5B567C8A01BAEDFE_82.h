...
#define CLASS_1_5B567C8A01BAEDFE_82_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19B79290)
#define CLASS_1_5B567C8A01BAEDFE_82_CLONE_OFFSET UNITYSDK_OFFSET(0x19B790A0)
#define CLASS_1_5B567C8A01BAEDFE_82_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19B791A0)
#define CLASS_1_5B567C8A01BAEDFE_82_EQUALS_OFFSET UNITYSDK_OFFSET(0x19B79110)
#define CLASS_1_5B567C8A01BAEDFE_82_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19B791F0)
#define CLASS_1_5B567C8A01BAEDFE_82_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19B792E0)
#define CLASS_1_5B567C8A01BAEDFE_82_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19B792B0)
#define CLASS_1_5B567C8A01BAEDFE_82_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x19B78FF0)
#define CLASS_1_5B567C8A01BAEDFE_82_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19B79050)
#define CLASS_1_5B567C8A01BAEDFE_82_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19B79220)
#define CLASS_1_5B567C8A01BAEDFE_82_WRITETO_OFFSET UNITYSDK_OFFSET(0x19B79280)
#define CLASS_1_5B567C8A01BAEDFE_82__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B79330)
#define CLASS_1_5B567C8A01BAEDFE_82__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19B79070)
#define CLASS_1_5B567C8A01BAEDFE_82__CTOR_OFFSET UNITYSDK_OFFSET(0x19B79060)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_82_TypeDefinitionIndex = 26020;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_82*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_82_TypeDefinitionIndex)->GetStaticField(0x48BF0);
	}
