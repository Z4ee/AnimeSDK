...
#define CLASS_1_5B567C8A01BAEDFE_82_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x19FD2A80)
#define CLASS_1_5B567C8A01BAEDFE_82_CLONE_OFFSET UNITYSDK_OFFSET(0x19FD28F0)
#define CLASS_1_5B567C8A01BAEDFE_82_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19FD2990)
#define CLASS_1_5B567C8A01BAEDFE_82_EQUALS_OFFSET UNITYSDK_OFFSET(0x19FD2930)
#define CLASS_1_5B567C8A01BAEDFE_82_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19FD29E0)
#define CLASS_1_5B567C8A01BAEDFE_82_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x19FD2AD0)
#define CLASS_1_5B567C8A01BAEDFE_82_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x19FD2AA0)
#define CLASS_1_5B567C8A01BAEDFE_82_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x19FD2870)
#define CLASS_1_5B567C8A01BAEDFE_82_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FD28A0)
#define CLASS_1_5B567C8A01BAEDFE_82_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FD2A10)
#define CLASS_1_5B567C8A01BAEDFE_82_WRITETO_OFFSET UNITYSDK_OFFSET(0x19FD2A70)
#define CLASS_1_5B567C8A01BAEDFE_82__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FD2B20)
#define CLASS_1_5B567C8A01BAEDFE_82__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD28C0)
#define CLASS_1_5B567C8A01BAEDFE_82__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD28B0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_82_TypeDefinitionIndex = 25884;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_82*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_82_TypeDefinitionIndex)->GetStaticField(0x25B20);
	}
