...
#define CLASS_2_7858266B34A2C48E___DOACTIVE_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x185EC7C0)
#define CLASS_2_7858266B34A2C48E___DOACTIVE_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x185ECBF0)
#define CLASS_2_7858266B34A2C48E___DOACTIVE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x185ECC50)
#define CLASS_2_7858266B34A2C48E___DOACTIVE_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x185ECC00)
#define CLASS_2_7858266B34A2C48E___DOACTIVE_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185EC7B0)
#define CLASS_2_7858266B34A2C48E___DOACTIVE_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x185EC510)

inline static constexpr unsigned int Class_2_7858266B34A2C48E___DoActive_d__7_TypeDefinitionIndex = 54572;

class Class_2_7858266B34A2C48E___DoActive_d__7 : public ::System::Object
{
public:
	::Class_2_7858266B34A2C48E* __4__this; // 0x10
	::RPG::GameCore::NPCComponent* _cmpt_5__3; // 0x18
	::RPG::GameCore::GameEntity* _entity_5__2; // 0x20
