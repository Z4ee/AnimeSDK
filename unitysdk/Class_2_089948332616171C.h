...
#define CLASS_2_089948332616171C_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A41DB00)
#define CLASS_2_089948332616171C_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1A41DB40)
#define CLASS_2_089948332616171C_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1A41DB90)
#define CLASS_2_089948332616171C_TICK_OFFSET UNITYSDK_OFFSET(0x1A41DBE0)
#define CLASS_2_089948332616171C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41DAF0)

inline static constexpr unsigned int Class_2_089948332616171C_TypeDefinitionIndex = 55204;

class Class_2_089948332616171C : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x18
	::RPG::GameCore::DefineDynamicStringByAssistantID* OFKGLJOAMLD; // 0x20
