...
#define CLASS_2_6296C16A8E9B046E_METHOD_2_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x19701970)
#define CLASS_2_6296C16A8E9B046E__CTOR_OFFSET UNITYSDK_OFFSET(0x19701960)

inline static constexpr unsigned int Class_2_6296C16A8E9B046E_TypeDefinitionIndex = 35526;

class Class_2_6296C16A8E9B046E : public ::Class_1_43BD383C98B4C0C5_17
{
public:
	::RPG::GameCore::DiceCombatAIEffectEvaluatorConfig_DiceHasNOfAKind* IGHAHBNLIJA; // 0x10
