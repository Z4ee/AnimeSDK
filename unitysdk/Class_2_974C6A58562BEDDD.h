...
#define CLASS_2_974C6A58562BEDDD_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0xA2CD9C0)
#define CLASS_2_974C6A58562BEDDD_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0xA2CD7A0)
#define CLASS_2_974C6A58562BEDDD_GETTYPENAME_OFFSET UNITYSDK_OFFSET(0xA2CD380)
#define CLASS_2_974C6A58562BEDDD_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0xA2CD400)
#define CLASS_2_974C6A58562BEDDD_GET_BLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0xA2CD570)
#define CLASS_2_974C6A58562BEDDD_GET_BLOCKVERSIONNAME_OFFSET UNITYSDK_OFFSET(0xA2CD560)
#define CLASS_2_974C6A58562BEDDD_GET_BUNDLEMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0xA2CD550)
#define CLASS_2_974C6A58562BEDDD_GET_BUNDLEVERSIONNAME_OFFSET UNITYSDK_OFFSET(0xA2CD540)
#define CLASS_2_974C6A58562BEDDD_GET_DEFAULTABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0xA2CD3D0)
#define CLASS_2_974C6A58562BEDDD_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0xA2CD580)
#define CLASS_2_974C6A58562BEDDD_GET_RELATIVEPATH_OFFSET UNITYSDK_OFFSET(0xA2CD510)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_1F55D6FEF27052D4_OFFSET UNITYSDK_OFFSET(0xA2CD5A0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_346F1B59FFBBF26A_OFFSET UNITYSDK_OFFSET(0xA2CDBA0)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_4DF4D9162AD406FC_OFFSET UNITYSDK_OFFSET(0xA2CDA60)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_726FF441D405FD0E_OFFSET UNITYSDK_OFFSET(0xA2CD670)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_A27577C98E9715A0_OFFSET UNITYSDK_OFFSET(0xA2CDE50)
#define CLASS_2_974C6A58562BEDDD_METHOD_2_E815DACFC7B4951E_OFFSET UNITYSDK_OFFSET(0xA2CDDC0)
#define CLASS_2_974C6A58562BEDDD_ONALLSUCCEED_OFFSET UNITYSDK_OFFSET(0xA2CE090)
#define CLASS_2_974C6A58562BEDDD_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0xA2CDB10)
#define CLASS_2_974C6A58562BEDDD_RESET_OFFSET UNITYSDK_OFFSET(0xA2CD8F0)
#define CLASS_2_974C6A58562BEDDD_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0xA2CD590)
#define CLASS_2_974C6A58562BEDDD__CTOR_OFFSET UNITYSDK_OFFSET(0xA2CE190)
#define CLASS_2_974C6A58562BEDDD__LOADINDEXINFO_OFFSET UNITYSDK_OFFSET(0xA2CD750)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_CLEARSERVERCACHE_OFFSET UNITYSDK_OFFSET(0xA2CE2B0)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_GETSERVERBLOCKMANIFESTNAME_OFFSET UNITYSDK_OFFSET(0xA2CE1D0)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_GET_BASEABSOLUTEPATH_OFFSET UNITYSDK_OFFSET(0xA2CE1C0)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_ONENUMBLOCKITEMS_OFFSET UNITYSDK_OFFSET(0xA2CE350)
#define CLASS_2_974C6A58562BEDDD___IFIXBASEPROXY_RESET_OFFSET UNITYSDK_OFFSET(0xA2CE1E0)

inline static constexpr unsigned int Class_2_974C6A58562BEDDD_TypeDefinitionIndex = 54869;
