...
#define CLASS_1_5B567C8A01BAEDFE_355_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A27CA70)
#define CLASS_1_5B567C8A01BAEDFE_355_CLONE_OFFSET UNITYSDK_OFFSET(0x1A27C8E0)
#define CLASS_1_5B567C8A01BAEDFE_355_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A27C980)
#define CLASS_1_5B567C8A01BAEDFE_355_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A27C920)
#define CLASS_1_5B567C8A01BAEDFE_355_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A27C9D0)
#define CLASS_1_5B567C8A01BAEDFE_355_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A27CAC0)
#define CLASS_1_5B567C8A01BAEDFE_355_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A27CA90)
#define CLASS_1_5B567C8A01BAEDFE_355_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1A27C860)
#define CLASS_1_5B567C8A01BAEDFE_355_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A27C890)
#define CLASS_1_5B567C8A01BAEDFE_355_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A27CA00)
#define CLASS_1_5B567C8A01BAEDFE_355_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A27CA60)
#define CLASS_1_5B567C8A01BAEDFE_355__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A27CB10)
#define CLASS_1_5B567C8A01BAEDFE_355__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A27C8B0)
#define CLASS_1_5B567C8A01BAEDFE_355__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27C8A0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_355_TypeDefinitionIndex = 32444;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_355*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_355_TypeDefinitionIndex)->GetStaticField(0x47240);
	}
