...
#define CLASS_2_B99A4A3093028660_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16AAFD10)
#define CLASS_2_B99A4A3093028660_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16AAFD50)
#define CLASS_2_B99A4A3093028660_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16AB00B0)
#define CLASS_2_B99A4A3093028660_TICK_OFFSET UNITYSDK_OFFSET(0x16AB0100)
#define CLASS_2_B99A4A3093028660__CTOR_OFFSET UNITYSDK_OFFSET(0x16AAFD00)

inline static constexpr unsigned int Class_2_B99A4A3093028660_TypeDefinitionIndex = 52512;

class Class_2_B99A4A3093028660 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::DisableCharacterVO* Field_2_0; // 0x18
