...
#define CLASS_2_B99A4A3093028660_DISPOSE_OFFSET UNITYSDK_OFFSET(0x896EE50)
#define CLASS_2_B99A4A3093028660_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x896EE90)
#define CLASS_2_B99A4A3093028660_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x896F150)
#define CLASS_2_B99A4A3093028660_TICK_OFFSET UNITYSDK_OFFSET(0x896F1A0)
#define CLASS_2_B99A4A3093028660__CTOR_OFFSET UNITYSDK_OFFSET(0x896EE40)

inline static constexpr unsigned int Class_2_B99A4A3093028660_TypeDefinitionIndex = 44032;

class Class_2_B99A4A3093028660 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::DisableCharacterVO* Field_2_0; // 0x20
