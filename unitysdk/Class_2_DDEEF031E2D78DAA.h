...
#define CLASS_2_DDEEF031E2D78DAA_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA9B9B80)
#define CLASS_2_DDEEF031E2D78DAA_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xA9B9BC0)
#define CLASS_2_DDEEF031E2D78DAA_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xA9B9D00)
#define CLASS_2_DDEEF031E2D78DAA_TICK_OFFSET UNITYSDK_OFFSET(0xA9B9D50)
#define CLASS_2_DDEEF031E2D78DAA__CTOR_OFFSET UNITYSDK_OFFSET(0xA9B9B70)

inline static constexpr unsigned int Class_2_DDEEF031E2D78DAA_TypeDefinitionIndex = 46687;

class Class_2_DDEEF031E2D78DAA : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::AdventureModifyMazeMP* Field_2_0; // 0x20
