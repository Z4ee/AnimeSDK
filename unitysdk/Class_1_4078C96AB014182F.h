...
#define CLASS_1_4078C96AB014182F_GET_COST_OFFSET UNITYSDK_OFFSET(0x173258F0)
#define CLASS_1_4078C96AB014182F_GET_EFFECTDESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x17325970)
#define CLASS_1_4078C96AB014182F_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x17325950)
#define CLASS_1_4078C96AB014182F_GET_EFFECTTAG_OFFSET UNITYSDK_OFFSET(0x17325910)
#define CLASS_1_4078C96AB014182F_GET_EFFECTTITLE_OFFSET UNITYSDK_OFFSET(0x17325930)
#define CLASS_1_4078C96AB014182F_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x17325890)
#define CLASS_1_4078C96AB014182F_GET_NEXTTALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x173258B0)
#define CLASS_1_4078C96AB014182F_GET_SENDPACKETCMD_OFFSET UNITYSDK_OFFSET(0x17325990)
#define CLASS_1_4078C96AB014182F_GET_TALENTID_OFFSET UNITYSDK_OFFSET(0x17325870)
#define CLASS_1_4078C96AB014182F_GET_UNLOCKIDLIST_OFFSET UNITYSDK_OFFSET(0x173258D0)
#define CLASS_1_4078C96AB014182F_METHOD_1_02D1C9F59EB61FCB_OFFSET UNITYSDK_OFFSET(0x173255E0)
#define CLASS_1_4078C96AB014182F_METHOD_1_D7A4AD29E1AA5C62_OFFSET UNITYSDK_OFFSET(0x173257A0)
#define CLASS_1_4078C96AB014182F_METHOD_1_F0FF75C5B1B78759_OFFSET UNITYSDK_OFFSET(0x173256E0)
#define CLASS_1_4078C96AB014182F_SET_COST_OFFSET UNITYSDK_OFFSET(0x17325900)
#define CLASS_1_4078C96AB014182F_SET_EFFECTDESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x17325980)
#define CLASS_1_4078C96AB014182F_SET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x17325960)
#define CLASS_1_4078C96AB014182F_SET_EFFECTTAG_OFFSET UNITYSDK_OFFSET(0x17325920)
#define CLASS_1_4078C96AB014182F_SET_EFFECTTITLE_OFFSET UNITYSDK_OFFSET(0x17325940)
#define CLASS_1_4078C96AB014182F_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x173258A0)
#define CLASS_1_4078C96AB014182F_SET_NEXTTALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x173258C0)
#define CLASS_1_4078C96AB014182F_SET_SENDPACKETCMD_OFFSET UNITYSDK_OFFSET(0x173259A0)
#define CLASS_1_4078C96AB014182F_SET_TALENTID_OFFSET UNITYSDK_OFFSET(0x17325880)
#define CLASS_1_4078C96AB014182F_SET_UNLOCKIDLIST_OFFSET UNITYSDK_OFFSET(0x173258E0)
#define CLASS_1_4078C96AB014182F__CTOR_OFFSET UNITYSDK_OFFSET(0x173256D0)

inline static constexpr unsigned int Class_1_4078C96AB014182F_TypeDefinitionIndex = 64477;

class Class_1_4078C96AB014182F : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_922* _SendPacketCmd_k__BackingField; // 0x10
	::Il2CppArray<::System::UInt32>* _NextTalentIDList_k__BackingField; // 0x18
	::Il2CppArray<::RPG::GameCore::ItemConfig*>* _Cost_k__BackingField; // 0x20
	::Il2CppArray<::System::UInt32>* _UnlockIDList_k__BackingField; // 0x28
	::System::String* _IconPath_k__BackingField; // 0x30
	::Il2CppArray<::RPG::GameCore::FixPoint>* _EffectDescParamList_k__BackingField; // 0x38
	::System::UInt32 _TalentID_k__BackingField; // 0x40
	::RPG::Client::TextID _EffectTag_k__BackingField; // 0x48
	::RPG::Client::TextID _EffectDesc_k__BackingField; // 0x58
	::RPG::Client::TextID _EffectTitle_k__BackingField; // 0x68
	...
	::Class_0_16E4307DCC419505_922* get_SendPacketCmd()
	{
		return ((::Class_0_16E4307DCC419505_922*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4078C96AB014182F_GET_SENDPACKETCMD_OFFSET))(this);
	}

	::System::Void set_SendPacketCmd(::Class_0_16E4307DCC419505_922* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_922*))((::PBYTE)hIl2Cpp + CLASS_1_4078C96AB014182F_SET_SENDPACKETCMD_OFFSET))(this, a1);
	}
};
