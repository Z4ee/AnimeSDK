...
#define CLASS_1_4078C96AB014182F_GET_COST_OFFSET UNITYSDK_OFFSET(0x10B4AB10)
#define CLASS_1_4078C96AB014182F_GET_EFFECTDESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x10B4AB90)
#define CLASS_1_4078C96AB014182F_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x10B4AB70)
#define CLASS_1_4078C96AB014182F_GET_EFFECTTAG_OFFSET UNITYSDK_OFFSET(0x10B4AB30)
#define CLASS_1_4078C96AB014182F_GET_EFFECTTITLE_OFFSET UNITYSDK_OFFSET(0x10B4AB50)
#define CLASS_1_4078C96AB014182F_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x10B4AAB0)
#define CLASS_1_4078C96AB014182F_GET_NEXTTALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x10B4AAD0)
#define CLASS_1_4078C96AB014182F_GET_SENDPACKETCMD_OFFSET UNITYSDK_OFFSET(0x10B4ABB0)
#define CLASS_1_4078C96AB014182F_GET_TALENTID_OFFSET UNITYSDK_OFFSET(0x10B4AA90)
#define CLASS_1_4078C96AB014182F_GET_UNLOCKIDLIST_OFFSET UNITYSDK_OFFSET(0x10B4AAF0)
#define CLASS_1_4078C96AB014182F_METHOD_1_02D1C9F59EB61FCB_OFFSET UNITYSDK_OFFSET(0x10B4A810)
#define CLASS_1_4078C96AB014182F_METHOD_1_D7A4AD29E1AA5C62_OFFSET UNITYSDK_OFFSET(0x10B4A9C0)
#define CLASS_1_4078C96AB014182F_METHOD_1_F0FF75C5B1B78759_OFFSET UNITYSDK_OFFSET(0x10B4A900)
#define CLASS_1_4078C96AB014182F_SET_COST_OFFSET UNITYSDK_OFFSET(0x10B4AB20)
#define CLASS_1_4078C96AB014182F_SET_EFFECTDESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x10B4ABA0)
#define CLASS_1_4078C96AB014182F_SET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x10B4AB80)
#define CLASS_1_4078C96AB014182F_SET_EFFECTTAG_OFFSET UNITYSDK_OFFSET(0x10B4AB40)
#define CLASS_1_4078C96AB014182F_SET_EFFECTTITLE_OFFSET UNITYSDK_OFFSET(0x10B4AB60)
#define CLASS_1_4078C96AB014182F_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x10B4AAC0)
#define CLASS_1_4078C96AB014182F_SET_NEXTTALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x10B4AAE0)
#define CLASS_1_4078C96AB014182F_SET_SENDPACKETCMD_OFFSET UNITYSDK_OFFSET(0x10B4ABC0)
#define CLASS_1_4078C96AB014182F_SET_TALENTID_OFFSET UNITYSDK_OFFSET(0x10B4AAA0)
#define CLASS_1_4078C96AB014182F_SET_UNLOCKIDLIST_OFFSET UNITYSDK_OFFSET(0x10B4AB00)
#define CLASS_1_4078C96AB014182F__CTOR_OFFSET UNITYSDK_OFFSET(0x10B4ABD0)

inline static constexpr unsigned int Class_1_4078C96AB014182F_TypeDefinitionIndex = 54989;

class Class_1_4078C96AB014182F : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_733* _SendPacketCmd_k__BackingField; // 0x10
	...
	::Class_0_16E4307DCC419505_733* get_SendPacketCmd()
	{
		return ((::Class_0_16E4307DCC419505_733*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4078C96AB014182F_GET_SENDPACKETCMD_OFFSET))(this);
	}

	::System::Void set_SendPacketCmd(::Class_0_16E4307DCC419505_733* value)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_733*))((::PBYTE)hIl2Cpp + CLASS_1_4078C96AB014182F_SET_SENDPACKETCMD_OFFSET))(this, value);
	}
};
