...
#define CLASS_1_4078C96AB014182F_GET_COST_OFFSET UNITYSDK_OFFSET(0x16EE6940)
#define CLASS_1_4078C96AB014182F_GET_EFFECTDESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x16EE69C0)
#define CLASS_1_4078C96AB014182F_GET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x16EE69A0)
#define CLASS_1_4078C96AB014182F_GET_EFFECTTAG_OFFSET UNITYSDK_OFFSET(0x16EE6960)
#define CLASS_1_4078C96AB014182F_GET_EFFECTTITLE_OFFSET UNITYSDK_OFFSET(0x16EE6980)
#define CLASS_1_4078C96AB014182F_GET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16EE68E0)
#define CLASS_1_4078C96AB014182F_GET_NEXTTALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x16EE6900)
#define CLASS_1_4078C96AB014182F_GET_SENDPACKETCMD_OFFSET UNITYSDK_OFFSET(0x16EE69E0)
#define CLASS_1_4078C96AB014182F_GET_TALENTID_OFFSET UNITYSDK_OFFSET(0x16EE68C0)
#define CLASS_1_4078C96AB014182F_GET_UNLOCKIDLIST_OFFSET UNITYSDK_OFFSET(0x16EE6920)
#define CLASS_1_4078C96AB014182F_METHOD_1_02D1C9F59EB61FCB_OFFSET UNITYSDK_OFFSET(0x16EE6630)
#define CLASS_1_4078C96AB014182F_METHOD_1_D7A4AD29E1AA5C62_OFFSET UNITYSDK_OFFSET(0x16EE67F0)
#define CLASS_1_4078C96AB014182F_METHOD_1_F0FF75C5B1B78759_OFFSET UNITYSDK_OFFSET(0x16EE6730)
#define CLASS_1_4078C96AB014182F_SET_COST_OFFSET UNITYSDK_OFFSET(0x16EE6950)
#define CLASS_1_4078C96AB014182F_SET_EFFECTDESCPARAMLIST_OFFSET UNITYSDK_OFFSET(0x16EE69D0)
#define CLASS_1_4078C96AB014182F_SET_EFFECTDESC_OFFSET UNITYSDK_OFFSET(0x16EE69B0)
#define CLASS_1_4078C96AB014182F_SET_EFFECTTAG_OFFSET UNITYSDK_OFFSET(0x16EE6970)
#define CLASS_1_4078C96AB014182F_SET_EFFECTTITLE_OFFSET UNITYSDK_OFFSET(0x16EE6990)
#define CLASS_1_4078C96AB014182F_SET_ICONPATH_OFFSET UNITYSDK_OFFSET(0x16EE68F0)
#define CLASS_1_4078C96AB014182F_SET_NEXTTALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x16EE6910)
#define CLASS_1_4078C96AB014182F_SET_SENDPACKETCMD_OFFSET UNITYSDK_OFFSET(0x16EE69F0)
#define CLASS_1_4078C96AB014182F_SET_TALENTID_OFFSET UNITYSDK_OFFSET(0x16EE68D0)
#define CLASS_1_4078C96AB014182F_SET_UNLOCKIDLIST_OFFSET UNITYSDK_OFFSET(0x16EE6930)
#define CLASS_1_4078C96AB014182F__CTOR_OFFSET UNITYSDK_OFFSET(0x16EE6720)

inline static constexpr unsigned int Class_1_4078C96AB014182F_TypeDefinitionIndex = 67473;

class Class_1_4078C96AB014182F : public ::System::Object
{
public:
	::Class_0_16E4307DCC419505_973* _SendPacketCmd_k__BackingField; // 0x10
	::Il2CppArray<::RPG::GameCore::ItemConfig*>* _Cost_k__BackingField; // 0x18
	::Il2CppArray<::System::UInt32>* _NextTalentIDList_k__BackingField; // 0x20
	::Il2CppArray<::System::UInt32>* _UnlockIDList_k__BackingField; // 0x28
	::Il2CppArray<::RPG::GameCore::FixPoint>* _EffectDescParamList_k__BackingField; // 0x30
	...
	::Class_0_16E4307DCC419505_973* get_SendPacketCmd()
	{
		return ((::Class_0_16E4307DCC419505_973*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_4078C96AB014182F_GET_SENDPACKETCMD_OFFSET))(this);
	}

	::System::Void set_SendPacketCmd(::Class_0_16E4307DCC419505_973* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_973*))((::PBYTE)hIl2Cpp + CLASS_1_4078C96AB014182F_SET_SENDPACKETCMD_OFFSET))(this, a1);
	}
};
