...
#define CLASS_1_5B567C8A01BAEDFE_204_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DFB9E90)
#define CLASS_1_5B567C8A01BAEDFE_204_CLONE_OFFSET UNITYSDK_OFFSET(0x1DFB9B80)
#define CLASS_1_5B567C8A01BAEDFE_204_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DFB9C90)
#define CLASS_1_5B567C8A01BAEDFE_204_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DFB9BC0)
#define CLASS_1_5B567C8A01BAEDFE_204_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DFB9DF0)
#define CLASS_1_5B567C8A01BAEDFE_204_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DFB9EE0)
#define CLASS_1_5B567C8A01BAEDFE_204_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DFB9EB0)
#define CLASS_1_5B567C8A01BAEDFE_204_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DFB9B00)
#define CLASS_1_5B567C8A01BAEDFE_204_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DFB9B30)
#define CLASS_1_5B567C8A01BAEDFE_204_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DFB9E20)
#define CLASS_1_5B567C8A01BAEDFE_204_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DFB9E80)
#define CLASS_1_5B567C8A01BAEDFE_204__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DFB9F30)
#define CLASS_1_5B567C8A01BAEDFE_204__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFB9B50)
#define CLASS_1_5B567C8A01BAEDFE_204__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFB9B40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_204_TypeDefinitionIndex = 30235;

class Class_1_5B567C8A01BAEDFE_204 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_204*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_204*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_204_TypeDefinitionIndex)->GetStaticField(0x5AC60);
	}
