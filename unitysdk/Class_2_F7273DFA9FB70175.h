...
#define CLASS_2_F7273DFA9FB70175_DISPOSE_OFFSET UNITYSDK_OFFSET(0x170598F0)
#define CLASS_2_F7273DFA9FB70175_METHOD_2_091B1F0E0E06E7DD_OFFSET UNITYSDK_OFFSET(0x17059DF0)
#define CLASS_2_F7273DFA9FB70175_METHOD_2_6B4A3A1B5816B81E_OFFSET UNITYSDK_OFFSET(0x17059D10)
#define CLASS_2_F7273DFA9FB70175_METHOD_2_8F6A1B72899F4EA4_OFFSET UNITYSDK_OFFSET(0x17059E60)
#define CLASS_2_F7273DFA9FB70175_METHOD_2_96BDC4B57CCFE000_OFFSET UNITYSDK_OFFSET(0x17059F40)
#define CLASS_2_F7273DFA9FB70175_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x17059C50)
#define CLASS_2_F7273DFA9FB70175_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x170599C0)
#define CLASS_2_F7273DFA9FB70175_TICK_OFFSET UNITYSDK_OFFSET(0x17059B00)
#define CLASS_2_F7273DFA9FB70175__CTOR_OFFSET UNITYSDK_OFFSET(0x170596A0)
...
{
public:
	::Struct_2_D3027B1CDFF61281 DDPDDGJPEBO; // 0x18
	::RPG::GameCore::GameEntity* BFMNFEOMLPF; // 0x48
	::RPG::GameCore::TaskContext* DDDNLILNMKA; // 0x50
	::Struct_2_D3027B1CDFF61281 NKGCIGBAIFD; // 0x58
	::Class_3_7BD30926656A6DD2* IGHAHBNLIJA; // 0x88
	::System::UInt32 PEEFHNHDBMF; // 0x90
	::System::UInt32 JGGDKOCIEGH; // 0x94
