...
#define CLASS_1_6EA5A4B6BD5D6920_CLEAR_OFFSET UNITYSDK_OFFSET(0x9317FF0)
#define CLASS_1_6EA5A4B6BD5D6920_GETALLSLOTCOUNT_OFFSET UNITYSDK_OFFSET(0x9317D00)
#define CLASS_1_6EA5A4B6BD5D6920_GETLOCKEDUNITS_OFFSET UNITYSDK_OFFSET(0x9317CA0)
#define CLASS_1_6EA5A4B6BD5D6920_GETSLOTUNITDATAITEM_OFFSET UNITYSDK_OFFSET(0x9317D60)
#define CLASS_1_6EA5A4B6BD5D6920_GETSLOTUNITUID_OFFSET UNITYSDK_OFFSET(0x9317EA0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_BASICPOWER_OFFSET UNITYSDK_OFFSET(0x9317B20)
#define CLASS_1_6EA5A4B6BD5D6920_GET_EFFECTTYPES_OFFSET UNITYSDK_OFFSET(0x9317C40)
#define CLASS_1_6EA5A4B6BD5D6920_GET_FUNCTYPE_OFFSET UNITYSDK_OFFSET(0x9317AC0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x9317AA0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_LIMITRANGETYPE_OFFSET UNITYSDK_OFFSET(0x9317BE0)
#define CLASS_1_6EA5A4B6BD5D6920_GET_SCEPTERID_OFFSET UNITYSDK_OFFSET(0x9317A80)
#define CLASS_1_6EA5A4B6BD5D6920_GET_STYLETYPE_OFFSET UNITYSDK_OFFSET(0x9317B80)
#define CLASS_1_6EA5A4B6BD5D6920_METHOD_1_7569C64E71BFAC8F_OFFSET UNITYSDK_OFFSET(0x9318150)
#define CLASS_1_6EA5A4B6BD5D6920_METHOD_1_88285E7670833FBE_OFFSET UNITYSDK_OFFSET(0x93180A0)
#define CLASS_1_6EA5A4B6BD5D6920__CTOR_OFFSET UNITYSDK_OFFSET(0x9318230)

inline static constexpr unsigned int Class_1_6EA5A4B6BD5D6920_TypeDefinitionIndex = 62129;
