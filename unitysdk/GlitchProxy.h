...
#define GLITCHPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xEC95CD0)
#define GLITCHPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0xEC960A0)
#define GLITCHPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0xEC96380)
#define GLITCHPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xEC96330)
#define GLITCHPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xEC966B0)

inline static constexpr unsigned int GlitchProxy_TypeDefinitionIndex = 51369;
