...
#define FLATBUFFERS_BYTEBUFFERUTIL_CONVERTUTF16TOUTF8_OFFSET UNITYSDK_OFFSET(0x1BED7060)
#define FLATBUFFERS_BYTEBUFFERUTIL_GETSIZEPREFIX_OFFSET UNITYSDK_OFFSET(0x1BED7040)
#define FLATBUFFERS_BYTEBUFFERUTIL_TRYDATALIST_OFFSET UNITYSDK_OFFSET(0x1BED71B0)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBufferUtil_TypeDefinitionIndex = 8739;
