...
#define FLATBUFFERS_BYTEARRAYALLOCATOR_GET_READONLYSPAN_OFFSET UNITYSDK_OFFSET(0x1BED47C0)
#define FLATBUFFERS_BYTEARRAYALLOCATOR_GET_SPAN_OFFSET UNITYSDK_OFFSET(0x1BED4740)
#define FLATBUFFERS_BYTEARRAYALLOCATOR_GROWFRONT_OFFSET UNITYSDK_OFFSET(0x1BED4650)
#define FLATBUFFERS_BYTEARRAYALLOCATOR_INITBUFFER_OFFSET UNITYSDK_OFFSET(0x1BED4630)
#define FLATBUFFERS_BYTEARRAYALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED4600)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteArrayAllocator_TypeDefinitionIndex = 8734;
