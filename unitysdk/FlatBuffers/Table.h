...
#define FLATBUFFERS_TABLE_COMPARESTRINGS_1_OFFSET UNITYSDK_OFFSET(0x1BEDAC20)
#define FLATBUFFERS_TABLE_COMPARESTRINGS_OFFSET UNITYSDK_OFFSET(0x1BEDAB50)
#define FLATBUFFERS_TABLE_GET_BB_OFFSET UNITYSDK_OFFSET(0x28B580)
#define FLATBUFFERS_TABLE_GET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define FLATBUFFERS_TABLE_GET_BYTEBUFFER_OFFSET UNITYSDK_OFFSET(0x28B580)
#define FLATBUFFERS_TABLE_SET_BB_OFFSET UNITYSDK_OFFSET(0x381830)
#define FLATBUFFERS_TABLE_SET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define FLATBUFFERS_TABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B8680)
#define FLATBUFFERS_TABLE___HAS_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1BEDA8C0)
#define FLATBUFFERS_TABLE___INDIRECT_1_OFFSET UNITYSDK_OFFSET(0x1BEDA7F0)
#define FLATBUFFERS_TABLE___INDIRECT_OFFSET UNITYSDK_OFFSET(0x9B86C0)
#define FLATBUFFERS_TABLE___OFFSET_1_OFFSET UNITYSDK_OFFSET(0x1BEDA7A0)
#define FLATBUFFERS_TABLE___OFFSET_OFFSET UNITYSDK_OFFSET(0x9B86B0)
#define FLATBUFFERS_TABLE___STRING_OFFSET UNITYSDK_OFFSET(0x9B86F0)
#define FLATBUFFERS_TABLE___VECTOR_LEN_OFFSET UNITYSDK_OFFSET(0x9B8750)
#define FLATBUFFERS_TABLE___VECTOR_OFFSET UNITYSDK_OFFSET(0x9B87A0)

namespace FlatBuffers
{
	inline static constexpr unsigned int Table_TypeDefinitionIndex = 8747;
