...
#define FLATBUFFERS_FLATBUFFERCONSTANTS_FLATBUFFERS_2_0_0_OFFSET UNITYSDK_OFFSET(0x1E2159E0)

namespace FlatBuffers
{
	inline static constexpr unsigned int FlatBufferConstants_TypeDefinitionIndex = 6727;
