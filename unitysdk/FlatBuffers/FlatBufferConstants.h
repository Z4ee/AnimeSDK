...
#define FLATBUFFERS_FLATBUFFERCONSTANTS_FLATBUFFERS_2_0_0_OFFSET UNITYSDK_OFFSET(0x1F629E10)

namespace FlatBuffers
{
	inline static constexpr unsigned int FlatBufferConstants_TypeDefinitionIndex = 6731;
