...
#define FLATBUFFERS_STRUCT_GET_BB_OFFSET UNITYSDK_OFFSET(0x28B580)
#define FLATBUFFERS_STRUCT_GET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define FLATBUFFERS_STRUCT_SET_BB_OFFSET UNITYSDK_OFFSET(0x381830)
#define FLATBUFFERS_STRUCT_SET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2E85F0)
#define FLATBUFFERS_STRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B8680)

namespace FlatBuffers
{
	inline static constexpr unsigned int Struct_TypeDefinitionIndex = 8746;
