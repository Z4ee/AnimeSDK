...
#define FLATBUFFERS_BYTEBUFFER_ASSERTOFFSETANDLENGTH_OFFSET UNITYSDK_OFFSET(0x1BED51B0)
#define FLATBUFFERS_BYTEBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1BED4FD0)
#define FLATBUFFERS_BYTEBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1BED4F50)
#define FLATBUFFERS_BYTEBUFFER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BED6970)
#define FLATBUFFERS_BYTEBUFFER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1BED6860)
#define FLATBUFFERS_BYTEBUFFER_GETINT_OFFSET UNITYSDK_OFFSET(0x1BED6540)
#define FLATBUFFERS_BYTEBUFFER_GETLONG_OFFSET UNITYSDK_OFFSET(0x1BED66D0)
#define FLATBUFFERS_BYTEBUFFER_GETSBYTE_OFFSET UNITYSDK_OFFSET(0x1BED6120)
#define FLATBUFFERS_BYTEBUFFER_GETSHORT_OFFSET UNITYSDK_OFFSET(0x1BED63B0)
#define FLATBUFFERS_BYTEBUFFER_GETSTRINGUTF8_OFFSET UNITYSDK_OFFSET(0x1BED6270)
#define FLATBUFFERS_BYTEBUFFER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1BED6260)
#define FLATBUFFERS_BYTEBUFFER_GETUINT_OFFSET UNITYSDK_OFFSET(0x1BED6550)
#define FLATBUFFERS_BYTEBUFFER_GETULONG_OFFSET UNITYSDK_OFFSET(0x1BED66E0)
#define FLATBUFFERS_BYTEBUFFER_GETUSHORT_OFFSET UNITYSDK_OFFSET(0x1BED63C0)
#define FLATBUFFERS_BYTEBUFFER_GET_ISMONOSTRING_OFFSET UNITYSDK_OFFSET(0x1BED5000)
#define FLATBUFFERS_BYTEBUFFER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1BED5040)
#define FLATBUFFERS_BYTEBUFFER_GET_OFFSET UNITYSDK_OFFSET(0x1BED61C0)
#define FLATBUFFERS_BYTEBUFFER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BED5020)
#define FLATBUFFERS_BYTEBUFFER_GROWFRONT_OFFSET UNITYSDK_OFFSET(0x1BED5070)
#define FLATBUFFERS_BYTEBUFFER_PUTBYTE_1_OFFSET UNITYSDK_OFFSET(0x1BED5390)
#define FLATBUFFERS_BYTEBUFFER_PUTBYTE_OFFSET UNITYSDK_OFFSET(0x1BED52E0)
#define FLATBUFFERS_BYTEBUFFER_PUTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1BED6000)
#define FLATBUFFERS_BYTEBUFFER_PUTFLOAT_OFFSET UNITYSDK_OFFSET(0x1BED5EE0)
#define FLATBUFFERS_BYTEBUFFER_PUTINT_OFFSET UNITYSDK_OFFSET(0x1BED5BA0)
#define FLATBUFFERS_BYTEBUFFER_PUTLONG_OFFSET UNITYSDK_OFFSET(0x1BED5D40)
#define FLATBUFFERS_BYTEBUFFER_PUTSBYTE_OFFSET UNITYSDK_OFFSET(0x1BED5230)
#define FLATBUFFERS_BYTEBUFFER_PUTSHORT_OFFSET UNITYSDK_OFFSET(0x1BED5A00)
#define FLATBUFFERS_BYTEBUFFER_PUTSTRINGUTF16_OFFSET UNITYSDK_OFFSET(0x1BED54F0)
#define FLATBUFFERS_BYTEBUFFER_PUTSTRINGUTF8_OFFSET UNITYSDK_OFFSET(0x1BED5810)
#define FLATBUFFERS_BYTEBUFFER_PUTUINT_OFFSET UNITYSDK_OFFSET(0x1BED5BB0)
#define FLATBUFFERS_BYTEBUFFER_PUTULONG_OFFSET UNITYSDK_OFFSET(0x1BED5D50)
#define FLATBUFFERS_BYTEBUFFER_PUTUSHORT_OFFSET UNITYSDK_OFFSET(0x1BED5A10)
#define FLATBUFFERS_BYTEBUFFER_PUT_OFFSET UNITYSDK_OFFSET(0x1BED54E0)
#define FLATBUFFERS_BYTEBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1BED5060)
#define FLATBUFFERS_BYTEBUFFER_REVERSEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1BED5190)
#define FLATBUFFERS_BYTEBUFFER_REVERSEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1BED51A0)
#define FLATBUFFERS_BYTEBUFFER_REVERSEBYTES_OFFSET UNITYSDK_OFFSET(0x1BED5180)
#define FLATBUFFERS_BYTEBUFFER_SET_ISMONOSTRING_OFFSET UNITYSDK_OFFSET(0x1BED5010)
#define FLATBUFFERS_BYTEBUFFER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1BED5030)
#define FLATBUFFERS_BYTEBUFFER_TOARRAY_OFFSET UNITYSDK_OFFSET(0x1BED50A0)
#define FLATBUFFERS_BYTEBUFFER_TOFULLARRAY_OFFSET UNITYSDK_OFFSET(0x1BED50E0)
#define FLATBUFFERS_BYTEBUFFER_TOSIZEDARRAY_OFFSET UNITYSDK_OFFSET(0x1BED50B0)
#define FLATBUFFERS_BYTEBUFFER_TOSPAN_OFFSET UNITYSDK_OFFSET(0x1BED5110)
#define FLATBUFFERS_BYTEBUFFER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BED6A80)
#define FLATBUFFERS_BYTEBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BED4850)
#define FLATBUFFERS_BYTEBUFFER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BED4960)
#define FLATBUFFERS_BYTEBUFFER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1BED4A40)
#define FLATBUFFERS_BYTEBUFFER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1BED4E10)
#define FLATBUFFERS_BYTEBUFFER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1BED4E90)
#define FLATBUFFERS_BYTEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1BED4840)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBuffer_TypeDefinitionIndex = 8738;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ByteBuffer_TypeDefinitionIndex)->GetStaticField(0x7CA0);
		}
		static ::System::Boolean* StaticGet_g_UseNativeArray()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ByteBuffer_TypeDefinitionIndex)->GetStaticField(0x3C60);
		}
