...
#define SCENELIGHTVOLUME_AWAKE_OFFSET UNITYSDK_OFFSET(0xD076630)
#define SCENELIGHTVOLUME_GETLIGHTMODE_OFFSET UNITYSDK_OFFSET(0xD0770A0)
#define SCENELIGHTVOLUME_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xD076620)
#define SCENELIGHTVOLUME_INVOLUME_OFFSET UNITYSDK_OFFSET(0xD076FA0)
#define SCENELIGHTVOLUME_ISALLHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0xD076A60)
#define SCENELIGHTVOLUME_ISHIDEOBJECTS_OFFSET UNITYSDK_OFFSET(0xD076980)
#define SCENELIGHTVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD076CF0)
#define SCENELIGHTVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD076C40)
#define SCENELIGHTVOLUME_ONMAPROTATED_OFFSET UNITYSDK_OFFSET(0xD076DA0)
#define SCENELIGHTVOLUME_ONRESET_OFFSET UNITYSDK_OFFSET(0xD076B30)
#define SCENELIGHTVOLUME_REGENINDEXER_OFFSET UNITYSDK_OFFSET(0xD076730)
#define SCENELIGHTVOLUME_SETBLOCKS_OFFSET UNITYSDK_OFFSET(0xD077170)
#define SCENELIGHTVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xD0773E0)

inline static constexpr unsigned int SceneLightVolume_TypeDefinitionIndex = 44691;
