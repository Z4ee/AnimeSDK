...
#define NAPLODCONTROLLER_APPLYLODLEVELIMPL_OFFSET UNITYSDK_OFFSET(0xFC1E660)
#define NAPLODCONTROLLER_APPLYLODLEVEL_OFFSET UNITYSDK_OFFSET(0xFC1DB90)
#define NAPLODCONTROLLER_APPLY_OFFSET UNITYSDK_OFFSET(0xFC1DF00)
#define NAPLODCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xFC1F3C0)
#define NAPLODCONTROLLER_CLEANUP_OFFSET UNITYSDK_OFFSET(0xFC1F4D0)
#define NAPLODCONTROLLER_GETMESHFILTER_OFFSET UNITYSDK_OFFSET(0xFC1DCE0)
#define NAPLODCONTROLLER_GETMESH_OFFSET UNITYSDK_OFFSET(0xFC1DD20)
#define NAPLODCONTROLLER_GETRENDER_OFFSET UNITYSDK_OFFSET(0xFC1F6C0)
#define NAPLODCONTROLLER_GET_LODBASE_OFFSET UNITYSDK_OFFSET(0xFC1DAC0)
#define NAPLODCONTROLLER_GET_LODLEVEL_OFFSET UNITYSDK_OFFSET(0xFC1DAB0)
#define NAPLODCONTROLLER_GET_LODOFFSET_OFFSET UNITYSDK_OFFSET(0xFC1DC10)
#define NAPLODCONTROLLER_LOADLODMESHASYNC_OFFSET UNITYSDK_OFFSET(0xFC1E3F0)
#define NAPLODCONTROLLER_NAPLODMESHSTREAMINGDEBUGLOG_OFFSET UNITYSDK_OFFSET(0xFC1F8B0)
#define NAPLODCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xFC1F480)
#define NAPLODCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xFC1D8B0)
#define NAPLODCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xFC1CEF0)
#define NAPLODCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xFC1D9F0)
#define NAPLODCONTROLLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xFC1DA50)
#define NAPLODCONTROLLER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0xFC1D970)
#define NAPLODCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0xFC1CFB0)
#define NAPLODCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0xFC1F670)
#define NAPLODCONTROLLER_OVERRIDELODLEVELBYGAMEPLAY_OFFSET UNITYSDK_OFFSET(0xFC1EF10)
#define NAPLODCONTROLLER_RECOVERLODLEVEL_OFFSET UNITYSDK_OFFSET(0xFC1F200)
#define NAPLODCONTROLLER_RELEASELODMESH_OFFSET UNITYSDK_OFFSET(0xFC1EAD0)
#define NAPLODCONTROLLER_SET_LODBASE_OFFSET UNITYSDK_OFFSET(0xFC1DAD0)
#define NAPLODCONTROLLER_SET_LODOFFSET_OFFSET UNITYSDK_OFFSET(0xFC1DC20)
#define NAPLODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xFC1FAC0)

inline static constexpr unsigned int NapLodController_TypeDefinitionIndex = 82239;
