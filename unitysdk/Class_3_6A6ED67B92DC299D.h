...
#define CLASS_3_6A6ED67B92DC299D_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x1395BA80)
#define CLASS_3_6A6ED67B92DC299D_METHOD_3_269C470BC922822D_1_OFFSET UNITYSDK_OFFSET(0x1395C190)
#define CLASS_3_6A6ED67B92DC299D_METHOD_3_269C470BC922822D_OFFSET UNITYSDK_OFFSET(0x1395BB60)
#define CLASS_3_6A6ED67B92DC299D_METHOD_3_627734491883CD35_OFFSET UNITYSDK_OFFSET(0x1395BBB0)
#define CLASS_3_6A6ED67B92DC299D_METHOD_3_8303B7840D4ED892_OFFSET UNITYSDK_OFFSET(0x1395BF20)
#define CLASS_3_6A6ED67B92DC299D_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x1395C1E0)
#define CLASS_3_6A6ED67B92DC299D_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x1395BEA0)
#define CLASS_3_6A6ED67B92DC299D_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x1395BA40)
#define CLASS_3_6A6ED67B92DC299D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1395BAD0)
#define CLASS_3_6A6ED67B92DC299D__CTOR_OFFSET UNITYSDK_OFFSET(0x1395BB50)

inline static constexpr unsigned int Class_3_6A6ED67B92DC299D_TypeDefinitionIndex = 65694;

class Class_3_6A6ED67B92DC299D : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_4 = 0x60; // 0x0
	::UnityEngine::Rigidbody* Field_3_1; // 0x48
	::Class_3_6A6ED67B92DC299D_Config* Field_3_0; // 0x50
	::UnityEngine::Collider* Field_3_2; // 0x58
