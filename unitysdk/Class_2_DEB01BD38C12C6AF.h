...
#define CLASS_2_DEB01BD38C12C6AF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x158B5C10)
#define CLASS_2_DEB01BD38C12C6AF_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x158B5DB0)
#define CLASS_2_DEB01BD38C12C6AF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x158B5CA0)
#define CLASS_2_DEB01BD38C12C6AF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x158B5D00)
#define CLASS_2_DEB01BD38C12C6AF_TICK_OFFSET UNITYSDK_OFFSET(0x158B5D50)
#define CLASS_2_DEB01BD38C12C6AF__CTOR_OFFSET UNITYSDK_OFFSET(0x158B5B80)
