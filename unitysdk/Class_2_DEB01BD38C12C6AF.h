...
#define CLASS_2_DEB01BD38C12C6AF_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1934FE00)
#define CLASS_2_DEB01BD38C12C6AF_METHOD_2_7DD84EAFF333A1E4_OFFSET UNITYSDK_OFFSET(0x1934FFA0)
#define CLASS_2_DEB01BD38C12C6AF_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1934FE90)
#define CLASS_2_DEB01BD38C12C6AF_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1934FEF0)
#define CLASS_2_DEB01BD38C12C6AF_TICK_OFFSET UNITYSDK_OFFSET(0x1934FF40)
#define CLASS_2_DEB01BD38C12C6AF__CTOR_OFFSET UNITYSDK_OFFSET(0x1934FD70)

inline static constexpr unsigned int Class_2_DEB01BD38C12C6AF_TypeDefinitionIndex = 56276;

class Class_2_DEB01BD38C12C6AF : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::Client::WaitPlanetFesGetUseItemFirstTime* Field_2_0; // 0x18
