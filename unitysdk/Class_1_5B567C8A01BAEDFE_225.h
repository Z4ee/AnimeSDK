...
#define CLASS_1_5B567C8A01BAEDFE_225_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DE8FDD0)
#define CLASS_1_5B567C8A01BAEDFE_225_CLONE_OFFSET UNITYSDK_OFFSET(0x1DE8FAC0)
#define CLASS_1_5B567C8A01BAEDFE_225_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DE8FBD0)
#define CLASS_1_5B567C8A01BAEDFE_225_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DE8FB00)
#define CLASS_1_5B567C8A01BAEDFE_225_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DE8FD30)
#define CLASS_1_5B567C8A01BAEDFE_225_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DE8FE20)
#define CLASS_1_5B567C8A01BAEDFE_225_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DE8FDF0)
#define CLASS_1_5B567C8A01BAEDFE_225_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DE8FA40)
#define CLASS_1_5B567C8A01BAEDFE_225_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DE8FA70)
#define CLASS_1_5B567C8A01BAEDFE_225_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DE8FD60)
#define CLASS_1_5B567C8A01BAEDFE_225_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DE8FDC0)
#define CLASS_1_5B567C8A01BAEDFE_225__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE8FE70)
#define CLASS_1_5B567C8A01BAEDFE_225__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DE8FA90)
#define CLASS_1_5B567C8A01BAEDFE_225__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE8FA80)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_225_TypeDefinitionIndex = 30665;

class Class_1_5B567C8A01BAEDFE_225 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_225*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_225*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_225_TypeDefinitionIndex)->GetStaticField(0x55070);
	}
