...
#define CLASS_1_5B567C8A01BAEDFE_225_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A5BAC70)
#define CLASS_1_5B567C8A01BAEDFE_225_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5BAA80)
#define CLASS_1_5B567C8A01BAEDFE_225_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5BAB80)
#define CLASS_1_5B567C8A01BAEDFE_225_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A5BAAF0)
#define CLASS_1_5B567C8A01BAEDFE_225_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5BABD0)
#define CLASS_1_5B567C8A01BAEDFE_225_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A5BACC0)
#define CLASS_1_5B567C8A01BAEDFE_225_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A5BAC90)
#define CLASS_1_5B567C8A01BAEDFE_225_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A5BA9D0)
#define CLASS_1_5B567C8A01BAEDFE_225_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A5BAA30)
#define CLASS_1_5B567C8A01BAEDFE_225_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A5BAC00)
#define CLASS_1_5B567C8A01BAEDFE_225_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A5BAC60)
#define CLASS_1_5B567C8A01BAEDFE_225__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5BAD10)
#define CLASS_1_5B567C8A01BAEDFE_225__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5BAA50)
#define CLASS_1_5B567C8A01BAEDFE_225__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5BAA40)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_225_TypeDefinitionIndex = 29394;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_225*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_225_TypeDefinitionIndex)->GetStaticField(0x173F0);
	}
