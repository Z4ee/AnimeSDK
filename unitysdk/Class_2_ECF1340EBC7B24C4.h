...
#define CLASS_2_ECF1340EBC7B24C4_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9995250)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_7B0A407379BA27E7_OFFSET UNITYSDK_OFFSET(0x9995380)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_DAE67D4DC8B67113_1_OFFSET UNITYSDK_OFFSET(0x99959D0)
#define CLASS_2_ECF1340EBC7B24C4_METHOD_2_DAE67D4DC8B67113_OFFSET UNITYSDK_OFFSET(0x9995840)
#define CLASS_2_ECF1340EBC7B24C4_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x99952A0)
#define CLASS_2_ECF1340EBC7B24C4_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x9995780)
#define CLASS_2_ECF1340EBC7B24C4_TICK_OFFSET UNITYSDK_OFFSET(0x99957E0)
#define CLASS_2_ECF1340EBC7B24C4__CTOR_OFFSET UNITYSDK_OFFSET(0x9995180)

inline static constexpr unsigned int Class_2_ECF1340EBC7B24C4_TypeDefinitionIndex = 48421;

class Class_2_ECF1340EBC7B24C4 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_1; // 0x18
	::RPG::GameCore::AdventureSkillCharacterComponent* Field_2_2; // 0x20
	::RPG::GameCore::AdvNPCUseMazeSkill* Field_2_0; // 0x28
