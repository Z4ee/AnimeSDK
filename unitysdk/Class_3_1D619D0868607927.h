...
#define CLASS_3_1D619D0868607927_METHOD_3_185002BAD0CDE98D_OFFSET UNITYSDK_OFFSET(0x18305230)
#define CLASS_3_1D619D0868607927_METHOD_3_FF096862EF90B096_OFFSET UNITYSDK_OFFSET(0x183051B0)
#define CLASS_3_1D619D0868607927__CTOR_OFFSET UNITYSDK_OFFSET(0x18305200)

inline static constexpr unsigned int Class_3_1D619D0868607927_TypeDefinitionIndex = 21357;

class Class_3_1D619D0868607927 : public ::RPG::GameCore::TaskConfig
{
public:
	::RPG::GameCore::TargetEvaluator* Field_3_1; // 0x18
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::SkillLayoutKey, ::RPG::GameCore::ControlSkillType>* Field_3_2; // 0x20
