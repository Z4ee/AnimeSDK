...
#define UITEXTSELECTION_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A0ED510)
#define UITEXTSELECTION_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x1A0EE780)
#define UITEXTSELECTION_CHECKTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0x1A0EDCE0)
#define UITEXTSELECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A0ED5E0)
#define UITEXTSELECTION_COLLECTALLCHANGETEXT_OFFSET UNITYSDK_OFFSET(0x1A0EE370)
#define UITEXTSELECTION_COLLECTALLTEXT_OFFSET UNITYSDK_OFFSET(0x1A0EE080)
#define UITEXTSELECTION_GETSIMPLETEXT_OFFSET UNITYSDK_OFFSET(0x1A0EE660)
#define UITEXTSELECTION_SETTEXTRAWTEXT_OFFSET UNITYSDK_OFFSET(0x1A0EDBD0)
#define UITEXTSELECTION_START_OFFSET UNITYSDK_OFFSET(0x1A0EDE30)
#define UITEXTSELECTION_UPDATECHANGETEXT_OFFSET UNITYSDK_OFFSET(0x1A0EE4C0)
#define UITEXTSELECTION_UPDATERAWTEXT_OFFSET UNITYSDK_OFFSET(0x1A0EE1E0)
#define UITEXTSELECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0EDE70)
#define UITEXTSELECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0EE970)
#define UITEXTSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0EE7C0)

inline static constexpr unsigned int UITextSelection_TypeDefinitionIndex = 45229;
...
public:
	...
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(UITextSelection_TypeDefinitionIndex)->GetStaticField(0x4B540);
	}
