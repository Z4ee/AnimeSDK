...
#define CLASS_1_EFD3975C6EAC5E80_GETSKILLROWDATABYID_OFFSET UNITYSDK_OFFSET(0xB8E5A50)
#define CLASS_1_EFD3975C6EAC5E80_GETSKILLROWDATABYNAME_OFFSET UNITYSDK_OFFSET(0xB8E5910)
#define CLASS_1_EFD3975C6EAC5E80_GETSKILLROWDATA_OFFSET UNITYSDK_OFFSET(0xB8E57D0)
#define CLASS_1_EFD3975C6EAC5E80_GET_ACTIONICONPATH_OFFSET UNITYSDK_OFFSET(0xB8E51F0)
#define CLASS_1_EFD3975C6EAC5E80_GET_AIPATH_OFFSET UNITYSDK_OFFSET(0xB8E45C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_AVATARSIDEICONPATH_OFFSET UNITYSDK_OFFSET(0xB8E55F0)
#define CLASS_1_EFD3975C6EAC5E80_GET_CHARACTERNAME_OFFSET UNITYSDK_OFFSET(0xB8E4DD0)
#define CLASS_1_EFD3975C6EAC5E80_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0xB8E43C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_DAMAGETYPERESISTANCE_OFFSET UNITYSDK_OFFSET(0xB8E4BC0)
#define CLASS_1_EFD3975C6EAC5E80_GET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0xB8E4AC0)
#define CLASS_1_EFD3975C6EAC5E80_GET_HAVEACTIONDELAY_OFFSET UNITYSDK_OFFSET(0xB8E4DC0)
#define CLASS_1_EFD3975C6EAC5E80_GET_HEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB8E50F0)
#define CLASS_1_EFD3975C6EAC5E80_GET_INTRODUCTION_OFFSET UNITYSDK_OFFSET(0xB8E4EE0)
#define CLASS_1_EFD3975C6EAC5E80_GET_JSONPATH_OFFSET UNITYSDK_OFFSET(0xB8E44C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_JSON_OFFSET UNITYSDK_OFFSET(0xB8E42C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0xB8E47C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_MODELPATH_OFFSET UNITYSDK_OFFSET(0xB8E4FF0)
#define CLASS_1_EFD3975C6EAC5E80_GET_NATUREID_OFFSET UNITYSDK_OFFSET(0xB8E49C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_OVERRIDEAIPATHS_OFFSET UNITYSDK_OFFSET(0xB8E46C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_ROUNDICONPATH_OFFSET UNITYSDK_OFFSET(0xB8E54F0)
#define CLASS_1_EFD3975C6EAC5E80_GET_ROW_OFFSET UNITYSDK_OFFSET(0xB8E4170)
#define CLASS_1_EFD3975C6EAC5E80_GET_SIDEAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB8E52F0)
#define CLASS_1_EFD3975C6EAC5E80_GET_SKILLROWDATAS_OFFSET UNITYSDK_OFFSET(0xB8E48C0)
#define CLASS_1_EFD3975C6EAC5E80_GET_SPNEED_OFFSET UNITYSDK_OFFSET(0xB8E4CC0)
#define CLASS_1_EFD3975C6EAC5E80_GET_WAITINGAVATARHEADICONPATH_OFFSET UNITYSDK_OFFSET(0xB8E53F0)
#define CLASS_1_EFD3975C6EAC5E80_METHOD_1_CE35BF94C300261B_OFFSET UNITYSDK_OFFSET(0xB8E4160)
#define CLASS_1_EFD3975C6EAC5E80_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0xB8E5770)
#define CLASS_1_EFD3975C6EAC5E80_OVERRIDEDISPLAY_OFFSET UNITYSDK_OFFSET(0xB8E56F0)
#define CLASS_1_EFD3975C6EAC5E80_SET_ROW_OFFSET UNITYSDK_OFFSET(0xB8E4270)
#define CLASS_1_EFD3975C6EAC5E80__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E4150)
