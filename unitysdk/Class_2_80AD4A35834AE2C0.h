...
#define CLASS_2_80AD4A35834AE2C0_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16183E80)
#define CLASS_2_80AD4A35834AE2C0_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16183ED0)
#define CLASS_2_80AD4A35834AE2C0_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16184490)
#define CLASS_2_80AD4A35834AE2C0_TICK_OFFSET UNITYSDK_OFFSET(0x16183FA0)
#define CLASS_2_80AD4A35834AE2C0__CTOR_OFFSET UNITYSDK_OFFSET(0x16183E70)
...
{
public:
	::RPG::GameCore::PropCurveReadMoveRatio* IGHAHBNLIJA; // 0x18
	::RPG::GameCore::GameEntity* FFPOIKCEIDI; // 0x20
	::RPG::GameCore::GameEntity* DCOOJFFNBMH; // 0x28
	::System::String* CHMOJFKDIMF; // 0x30
