...
#define AKLOGGER_ERROR_OFFSET UNITYSDK_OFFSET(0x1E77E160)
#define AKLOGGER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1E77DE10)
#define AKLOGGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1E77DDB0)
#define AKLOGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1E77DF90)
#define AKLOGGER_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1E77DFA0)
#define AKLOGGER_WARNING_OFFSET UNITYSDK_OFFSET(0x1E77E080)
#define AKLOGGER_WWISEINTERNALLOGERROR_OFFSET UNITYSDK_OFFSET(0x1E77DB70)
#define AKLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E77E240)
#define AKLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E77DC50)

inline static constexpr unsigned int AkLogger_TypeDefinitionIndex = 33071;
...
public:
	...
	{
		return (::AkLogger**)Il2CppClass::FromTypeDefinitionIndex(AkLogger_TypeDefinitionIndex)->GetStaticField(0x27240);
	}
