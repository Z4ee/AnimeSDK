...
#define AKLOGGER_ERROR_OFFSET UNITYSDK_OFFSET(0x1FB482F0)
#define AKLOGGER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1FB47FA0)
#define AKLOGGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1FB47F40)
#define AKLOGGER_INIT_OFFSET UNITYSDK_OFFSET(0x1FB48120)
#define AKLOGGER_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1FB48130)
#define AKLOGGER_WARNING_OFFSET UNITYSDK_OFFSET(0x1FB48210)
#define AKLOGGER_WWISEINTERNALLOGERROR_OFFSET UNITYSDK_OFFSET(0x1FB47D00)
#define AKLOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1FB483D0)
#define AKLOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1FB47DE0)

inline static constexpr unsigned int AkLogger_TypeDefinitionIndex = 33706;
...
public:
	...
	{
		return (::AkLogger**)Il2CppClass::FromTypeDefinitionIndex(AkLogger_TypeDefinitionIndex)->GetStaticField(0x28A60);
	}
