...
#define CLASS_1_5B567C8A01BAEDFE_30_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DFAAC40)
#define CLASS_1_5B567C8A01BAEDFE_30_CLONE_OFFSET UNITYSDK_OFFSET(0x1DFAA930)
#define CLASS_1_5B567C8A01BAEDFE_30_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DFAAA40)
#define CLASS_1_5B567C8A01BAEDFE_30_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DFAA970)
#define CLASS_1_5B567C8A01BAEDFE_30_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DFAABA0)
#define CLASS_1_5B567C8A01BAEDFE_30_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DFAAC90)
#define CLASS_1_5B567C8A01BAEDFE_30_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DFAAC60)
#define CLASS_1_5B567C8A01BAEDFE_30_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DFAA8B0)
#define CLASS_1_5B567C8A01BAEDFE_30_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DFAA8E0)
#define CLASS_1_5B567C8A01BAEDFE_30_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DFAABD0)
#define CLASS_1_5B567C8A01BAEDFE_30_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DFAAC30)
#define CLASS_1_5B567C8A01BAEDFE_30__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DFAACE0)
#define CLASS_1_5B567C8A01BAEDFE_30__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DFAA900)
#define CLASS_1_5B567C8A01BAEDFE_30__CTOR_OFFSET UNITYSDK_OFFSET(0x1DFAA8F0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE_30*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_30_TypeDefinitionIndex)->GetStaticField(0x59930);
	}
