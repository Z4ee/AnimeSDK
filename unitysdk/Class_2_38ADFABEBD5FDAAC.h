...
#define CLASS_2_38ADFABEBD5FDAAC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1454BF30)
#define CLASS_2_38ADFABEBD5FDAAC_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x1454BF70)
#define CLASS_2_38ADFABEBD5FDAAC_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x1454C010)
#define CLASS_2_38ADFABEBD5FDAAC_TICK_OFFSET UNITYSDK_OFFSET(0x1454C060)
#define CLASS_2_38ADFABEBD5FDAAC__CTOR_OFFSET UNITYSDK_OFFSET(0x1454BF20)

inline static constexpr unsigned int Class_2_38ADFABEBD5FDAAC_TypeDefinitionIndex = 52712;
