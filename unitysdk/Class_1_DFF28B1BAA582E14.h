...
#define CLASS_1_DFF28B1BAA582E14_CLEAR_OFFSET UNITYSDK_OFFSET(0x16BEF0D0)
#define CLASS_1_DFF28B1BAA582E14_GET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x16BEEBC0)
#define CLASS_1_DFF28B1BAA582E14_METHOD_1_6AEE51845DFA6D71_1_OFFSET UNITYSDK_OFFSET(0x16BEEDA0)
#define CLASS_1_DFF28B1BAA582E14_METHOD_1_6AEE51845DFA6D71_OFFSET UNITYSDK_OFFSET(0x16BEED50)
#define CLASS_1_DFF28B1BAA582E14_METHOD_1_AA972BE565DAF9E3_1_OFFSET UNITYSDK_OFFSET(0x16BEEF00)
#define CLASS_1_DFF28B1BAA582E14_METHOD_1_AA972BE565DAF9E3_OFFSET UNITYSDK_OFFSET(0x16BEEDF0)
#define CLASS_1_DFF28B1BAA582E14_METHOD_1_D98DFC1E18F828E2_OFFSET UNITYSDK_OFFSET(0x16BEF010)
#define CLASS_1_DFF28B1BAA582E14_METHOD_1_F492C0E050258EA1_OFFSET UNITYSDK_OFFSET(0x16BEEBE0)
#define CLASS_1_DFF28B1BAA582E14_SET_PARAMLIST_OFFSET UNITYSDK_OFFSET(0x16BEEBD0)
#define CLASS_1_DFF28B1BAA582E14__CTOR_OFFSET UNITYSDK_OFFSET(0x16BEF130)
...
public:
	...
	::Class_2_FC12FDC7914CFFD8* _ParamList_k__BackingField; // 0x18
	::Class_0_16E4307DCC419505_485* FODBMMCKAEN; // 0x20
	::RPG::GameCore::GameEntity* MIAJNJNECOG; // 0x28
	::RPG::GameCore::TaskContext* GPKCGOLOJKC; // 0x30
	::RPG::GameCore::FixPoint DHPDILNLIPC; // 0x38
	::RPG::GameCore::FixPoint PJGLBPCJFEK; // 0x40
	::RPG::GameCore::FixPoint GGOJHJDPDFL; // 0x48
