...
#define MONOINTERACTINFO_GET_INTERACTSINFO_OFFSET UNITYSDK_OFFSET(0xFAF1DA0)
#define MONOINTERACTINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xFAF1D10)
#define MONOINTERACTINFO_GET_SCALE_OFFSET UNITYSDK_OFFSET(0xFAF1D90)
#define MONOINTERACTINFO_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0xFAF1D70)
#define MONOINTERACTINFO_SETINTERACTCONFIG_OFFSET UNITYSDK_OFFSET(0xFAF1DB0)
#define MONOINTERACTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xFAF2290)

inline static constexpr unsigned int MonoInteractInfo_TypeDefinitionIndex = 46044;
