...
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1D8BB670)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1D8BB4E0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D8BA1C0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGREVERSED_OFFSET UNITYSDK_OFFSET(0x1D8BA020)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASING_OFFSET UNITYSDK_OFFSET(0x1D8B9EF0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1D8BAD70)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1D8BABC0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1D8BAA80)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8BB870)

namespace PipelineCamera
{
	inline static constexpr unsigned int TimeBasedAlphaGenerator_TypeDefinitionIndex = 37675;
