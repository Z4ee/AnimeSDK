...
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1EC15EB0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1EC15D20)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EC14A40)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASINGREVERSED_OFFSET UNITYSDK_OFFSET(0x1EC148A0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_EASING_OFFSET UNITYSDK_OFFSET(0x1EC14770)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EC155C0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVEREVERSED_OFFSET UNITYSDK_OFFSET(0x1EC15410)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1EC152D0)
#define PIPELINECAMERA_TIMEBASEDALPHAGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC160B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int TimeBasedAlphaGenerator_TypeDefinitionIndex = 38336;
