...
#define PIPELINECAMERA_METHOD_LOOPINTERVAL_GET_INTERVALINLOOP_OFFSET UNITYSDK_OFFSET(0x951480)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method_LoopInterval_TypeDefinitionIndex = 35882;
