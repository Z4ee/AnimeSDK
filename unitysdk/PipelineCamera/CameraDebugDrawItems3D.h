...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_COMMIT_OFFSET UNITYSDK_OFFSET(0x1AE03B60)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1AE03740)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_1_OFFSET UNITYSDK_OFFSET(0x1AE02EE0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_2_OFFSET UNITYSDK_OFFSET(0x1AE03530)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x1AE029D0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1AE02180)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_2_OFFSET UNITYSDK_OFFSET(0x1AE025B0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1AE02030)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1AE01F00)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_RESET_OFFSET UNITYSDK_OFFSET(0x1AE03970)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE03CB0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems3D_TypeDefinitionIndex = 36012;
