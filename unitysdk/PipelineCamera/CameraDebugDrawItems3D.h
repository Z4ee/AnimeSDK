...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_COMMIT_OFFSET UNITYSDK_OFFSET(0x1D231DA0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1D231980)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_1_OFFSET UNITYSDK_OFFSET(0x1D231120)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_2_OFFSET UNITYSDK_OFFSET(0x1D231770)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x1D230C10)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1D2303C0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_2_OFFSET UNITYSDK_OFFSET(0x1D2307F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1D230270)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1D230140)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D_RESET_OFFSET UNITYSDK_OFFSET(0x1D231BB0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D231EF0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems3D_TypeDefinitionIndex = 37620;

	class CameraDebugDrawItems3D : public ::System::Object
	{
	public:
		::PipelineCamera::CameraDebugDrawLines3D* _lines; // 0x10
		::PipelineCamera::CameraDebugDrawPoints3D* _points; // 0x18
