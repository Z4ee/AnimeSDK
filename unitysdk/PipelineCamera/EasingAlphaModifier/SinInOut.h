...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x9972A0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x997290)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int SinInOut_TypeDefinitionIndex = 36103;
