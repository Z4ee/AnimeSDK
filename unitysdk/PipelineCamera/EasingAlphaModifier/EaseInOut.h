...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEINOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0xA43120)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEINOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA43110)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEINOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x324A50)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int EaseInOut_TypeDefinitionIndex = 38375;
