...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULAROUT_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1E88B8A0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULAROUT_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1E88B820)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULAROUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0xA3F650)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULAROUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA3F590)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULAROUT__PROCESS_OFFSET UNITYSDK_OFFSET(0xA3F4D0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int CircularOut_TypeDefinitionIndex = 38380;
