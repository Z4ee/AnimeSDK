...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0xA43330)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA432A0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_STEP__CTOR_OFFSET UNITYSDK_OFFSET(0xA433F0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int Step_TypeDefinitionIndex = 38369;
