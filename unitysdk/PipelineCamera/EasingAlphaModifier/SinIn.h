...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1B11FE20)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1B11FDB0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x950670)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_SININ_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9505C0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int SinIn_TypeDefinitionIndex = 36101;
