...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEIN_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1DAC9F70)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEIN_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1DAC9F00)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEIN_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0xA2C090)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEIN_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA2C150)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EASEIN__CTOR_OFFSET UNITYSDK_OFFSET(0x55FE60)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int EaseIn_TypeDefinitionIndex = 37712;
