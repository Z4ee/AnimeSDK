...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARINOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0xA5B920)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARINOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA5B910)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int CircularInOut_TypeDefinitionIndex = 37720;
