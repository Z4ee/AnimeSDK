...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARINOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0xAAA040)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_CIRCULARINOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0xAAA030)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int CircularInOut_TypeDefinitionIndex = 38381;
