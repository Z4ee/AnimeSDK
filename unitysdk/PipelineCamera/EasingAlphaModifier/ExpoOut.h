...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1B505DB0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1B505D10)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x971370)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOOUT_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x971290)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int ExpoOut_TypeDefinitionIndex = 36108;
