...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_DODERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1BBD44A0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_DOPROCESS_OFFSET UNITYSDK_OFFSET(0x1BBD4420)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x9AA2B0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_EXPOIN_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9AA1F0)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int ExpoIn_TypeDefinitionIndex = 36107;
