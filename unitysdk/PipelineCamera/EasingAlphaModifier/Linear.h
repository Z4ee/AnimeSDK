...
#define PIPELINECAMERA_EASINGALPHAMODIFIER_LINEAR_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x99BCE0)
#define PIPELINECAMERA_EASINGALPHAMODIFIER_LINEAR_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x99BD60)

namespace PipelineCamera::EasingAlphaModifier
{
	inline static constexpr unsigned int Linear_TypeDefinitionIndex = 36099;
