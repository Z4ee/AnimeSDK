...
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x8DCA60)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x8DC940)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x8DC9D0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x8DC790)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x8DC670)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x8DC700)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x8DC820)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CHECKSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x8DC8B0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4D8BC0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x8DC640)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x883210)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x8DB6F0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x8DB800)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x2E2760)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x58C110)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x8DB710)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x8DC4E0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x8DBFD0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x8DC660)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x8DC130)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x8DB810)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x8DC3A0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x8DBD70)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x8DBEA0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x8DC260)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x8DBAE0)
#define PIPELINECAMERA_LOCALSCREENCAMERADATA_SETSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x8DC3B0)

namespace PipelineCamera
{
	inline static constexpr unsigned int LocalScreenCameraData_TypeDefinitionIndex = 35991;
