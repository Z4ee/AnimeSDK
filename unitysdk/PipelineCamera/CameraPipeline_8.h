...
namespace PipelineCamera { template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8> class ICameraPipelineConfig_8; }
namespace System { class Object; }

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraPipeline_8_TypeDefinitionIndex = 37523;

	template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>
	struct CameraPipeline_8
	{
		...
		::PipelineCamera::CameraModuleFlag _moduleFlag6; // 0x0
		::PipelineCamera::CameraModuleFlag _moduleFlag7; // 0x0
		::PipelineCamera::CameraModuleFlag _moduleFlag8; // 0x0
	};
}
