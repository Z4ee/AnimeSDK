...
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0xA81970)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0xA818A0)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_GET_STIFFNESS_OFFSET UNITYSDK_OFFSET(0xA81840)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA81A00)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA81890)
#define PIPELINECAMERA_PHYSICALCRITICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x324A50)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalCriticalSpringDamper_TypeDefinitionIndex = 38318;
