...
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA3E890)
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA3E880)
#define PIPELINECAMERA_INTERPCONSTANTTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x55FE60)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpConstantToDamper_TypeDefinitionIndex = 37655;
