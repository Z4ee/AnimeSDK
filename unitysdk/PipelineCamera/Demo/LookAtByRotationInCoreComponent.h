...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E914FC0)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E915000)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E915040)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInCoreComponent_TypeDefinitionIndex = 38412;
