...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D565B30)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D565B70)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINCORECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D565BB0)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInCoreComponent_TypeDefinitionIndex = 37751;
