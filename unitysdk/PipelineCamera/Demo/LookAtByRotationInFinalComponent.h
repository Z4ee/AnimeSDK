...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1E6043D0)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1E604410)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E604450)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInFinalComponent_TypeDefinitionIndex = 37752;
