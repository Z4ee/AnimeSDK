...
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1C2B7270)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1C2B72B0)
#define PIPELINECAMERA_DEMO_LOOKATBYROTATIONINFINALCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2B72F0)

namespace PipelineCamera::Demo
{
	inline static constexpr unsigned int LookAtByRotationInFinalComponent_TypeDefinitionIndex = 36144;
