...
#define PIPELINECAMERA_DEMO_FEATURE_DEMOPIVOTDAMPERCOMPONENT_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_WORLDBASICCAMERADATA__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1DE22F00)
#define PIPELINECAMERA_DEMO_FEATURE_DEMOPIVOTDAMPERCOMPONENT_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_WORLDBASICCAMERADATA__ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1DE22FC0)
#define PIPELINECAMERA_DEMO_FEATURE_DEMOPIVOTDAMPERCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE230C0)

namespace PipelineCamera::Demo::Feature
{
	inline static constexpr unsigned int DemoPivotDamperComponent_TypeDefinitionIndex = 37754;
