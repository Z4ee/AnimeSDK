...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_CAMERAFOLLOWTARGETPARAM__CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1EBCABE0)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET_PIPELINECAMERA_ICAMERASUBMODULEBUILDER_PIPELINECAMERA_CAMERAFOLLOWTARGETPARAM__ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1EBCADF0)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPIPELINECONFIG_BUILDFOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBC9600)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPipelineConfig_BuildFollowTarget_TypeDefinitionIndex = 38432;
