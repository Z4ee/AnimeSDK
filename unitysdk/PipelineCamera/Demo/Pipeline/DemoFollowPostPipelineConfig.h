...
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG_INITPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B11FA60)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG_PIPELINECAMERA_ICAMERAPIPELINECONFIG_PIPELINECAMERA_MODULE_INPLACEBLENDER__INITMODULE1_OFFSET UNITYSDK_OFFSET(0x1B11F920)
#define PIPELINECAMERA_DEMO_PIPELINE_DEMOFOLLOWPOSTPIPELINECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11FB20)

namespace PipelineCamera::Demo::Pipeline
{
	inline static constexpr unsigned int DemoFollowPostPipelineConfig_TypeDefinitionIndex = 36159;
