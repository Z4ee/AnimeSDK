...
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B0744D0)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_PROCESSINPUT_OFFSET UNITYSDK_OFFSET(0x1B074510)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B074680)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0746C0)

namespace PipelineCamera::Demo::Data
{
	inline static constexpr unsigned int BasicCameraDataComponent_TypeDefinitionIndex = 36147;
