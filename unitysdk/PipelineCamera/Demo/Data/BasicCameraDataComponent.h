...
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1D4CE7C0)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_PROCESSINPUT_OFFSET UNITYSDK_OFFSET(0x1D4CE800)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1D4CE970)
#define PIPELINECAMERA_DEMO_DATA_BASICCAMERADATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CE9B0)

namespace PipelineCamera::Demo::Data
{
	inline static constexpr unsigned int BasicCameraDataComponent_TypeDefinitionIndex = 37755;
