...
#define PIPELINECAMERA_DEMO_DATA_SCREENCAMERADATACOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC2E1C0)

namespace PipelineCamera::Demo::Data
{
	inline static constexpr unsigned int ScreenCameraDataComponent_TypeDefinitionIndex = 38417;
