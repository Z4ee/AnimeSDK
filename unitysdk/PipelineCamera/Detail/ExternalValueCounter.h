...
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_DECREMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x983CE0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_GET_COUNTER_OFFSET UNITYSDK_OFFSET(0x983CF0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_GET_MASK_OFFSET UNITYSDK_OFFSET(0x983DD0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_INCREMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x983CD0)

namespace PipelineCamera::Detail
{
	inline static constexpr unsigned int ExternalValueCounter_TypeDefinitionIndex = 38034;
