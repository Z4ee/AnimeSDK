...
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_DECREMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x8DB5D0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_GET_COUNTER_OFFSET UNITYSDK_OFFSET(0x8DB5E0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_GET_MASK_OFFSET UNITYSDK_OFFSET(0x8DB6C0)
#define PIPELINECAMERA_DETAIL_EXTERNALVALUECOUNTER_INCREMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x8DB5C0)

namespace PipelineCamera::Detail
{
	inline static constexpr unsigned int ExternalValueCounter_TypeDefinitionIndex = 36426;
