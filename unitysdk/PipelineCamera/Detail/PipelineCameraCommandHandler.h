...
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER_PIPELINEVALUETOPIPELINEINDEX_OFFSET UNITYSDK_OFFSET(0x1EBCB190)
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER_SENDCAMERACOMMAND_OFFSET UNITYSDK_OFFSET(0x1EBCB0C0)
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBCB070)

namespace PipelineCamera::Detail
{
	inline static constexpr unsigned int PipelineCameraCommandHandler_TypeDefinitionIndex = 38696;
