...
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER_PIPELINEVALUETOPIPELINEINDEX_OFFSET UNITYSDK_OFFSET(0x1B489610)
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER_SENDCAMERACOMMAND_OFFSET UNITYSDK_OFFSET(0x1B489540)
#define PIPELINECAMERA_DETAIL_PIPELINECAMERACOMMANDHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4894F0)

namespace PipelineCamera::Detail
{
	inline static constexpr unsigned int PipelineCameraCommandHandler_TypeDefinitionIndex = 36427;
