...
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_COMPOSE_1_OFFSET UNITYSDK_OFFSET(0xA3DFC0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_COMPOSE_OFFSET UNITYSDK_OFFSET(0xA3DEA0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1DD42410)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_CREATE_OFFSET UNITYSDK_OFFSET(0x1DD42140)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_DECOMPOSE_1_OFFSET UNITYSDK_OFFSET(0xA3DD60)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_DECOMPOSE_OFFSET UNITYSDK_OFFSET(0xA3DCC0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER_OVERRIDE_OFFSET UNITYSDK_OFFSET(0xA3DFD0)
#define PIPELINECAMERA_POSITIONAXISDECOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3DC90)

namespace PipelineCamera
{
	inline static constexpr unsigned int PositionAxisDecomposer_TypeDefinitionIndex = 37660;
