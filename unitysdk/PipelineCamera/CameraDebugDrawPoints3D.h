...
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1DE1F8F0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1DE1F9C0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D_DRAW_OFFSET UNITYSDK_OFFSET(0x1DE1FA30)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE1FD80)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawPoints3D_TypeDefinitionIndex = 37627;
