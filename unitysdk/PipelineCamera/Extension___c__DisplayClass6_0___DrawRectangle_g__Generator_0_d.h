...
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D5668C0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D5669E0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D566950)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D566A60)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D5669B0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D566960)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D5668B0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS6_0___DRAWRECTANGLE_G__GENERATOR_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D566890)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___c__DisplayClass6_0___DrawRectangle_g__Generator_0_d_TypeDefinitionIndex = 37570;
	...
	public:
		...
		::UnityEngine::Vector2 __2__current; // 0x1C
