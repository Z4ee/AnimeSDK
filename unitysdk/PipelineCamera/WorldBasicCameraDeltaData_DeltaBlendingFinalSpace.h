...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA43FB0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__APPLY_5_0_OFFSET UNITYSDK_OFFSET(0x1E91A230)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASCURRENT_5_1_OFFSET UNITYSDK_OFFSET(0x1E919F60)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASSOURCE_5_2_OFFSET UNITYSDK_OFFSET(0x1E919B80)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_DeltaBlendingFinalSpace_TypeDefinitionIndex = 38264;
