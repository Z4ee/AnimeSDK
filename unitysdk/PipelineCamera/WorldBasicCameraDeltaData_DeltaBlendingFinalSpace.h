...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x9F42C0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__APPLY_5_0_OFFSET UNITYSDK_OFFSET(0x1D56AF00)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASCURRENT_5_1_OFFSET UNITYSDK_OFFSET(0x1D56AC20)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_DELTABLENDINGFINALSPACE__INVOKE_G__UPDATEASSOURCE_5_2_OFFSET UNITYSDK_OFFSET(0x1D56A840)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_DeltaBlendingFinalSpace_TypeDefinitionIndex = 37603;
