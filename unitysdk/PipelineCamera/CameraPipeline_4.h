...
namespace PipelineCamera { template <typename T1, typename T2, typename T3, typename T4> class ICameraPipelineConfig_4; }
namespace System { class Object; }

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraPipeline_4_TypeDefinitionIndex = 37527;

	template <typename T1, typename T2, typename T3, typename T4>
	struct CameraPipeline_4
	{
