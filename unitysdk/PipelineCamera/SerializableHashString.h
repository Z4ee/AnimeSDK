...
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA92010)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xA91EC0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1F159C70)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1F159C30)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xA91F50)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA91FA0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA91F60)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA92130)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableHashString_TypeDefinitionIndex = 38302;
