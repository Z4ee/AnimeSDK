...
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99B4F0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x99B3A0)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B9BB540)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B9BB500)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x99B430)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x99B480)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x99B440)
#define PIPELINECAMERA_SERIALIZABLEHASHSTRING___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99B500)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableHashString_TypeDefinitionIndex = 36033;
