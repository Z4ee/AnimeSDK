...
#define PIPELINECAMERA_CHECKUTILS_ENSURENORMALIZED_1_OFFSET UNITYSDK_OFFSET(0x1B4CEB60)
#define PIPELINECAMERA_CHECKUTILS_ENSURENORMALIZED_OFFSET UNITYSDK_OFFSET(0x1B4CEB00)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_1_OFFSET UNITYSDK_OFFSET(0x1B4CE900)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_2_OFFSET UNITYSDK_OFFSET(0x1B4CE940)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_3_OFFSET UNITYSDK_OFFSET(0x1B4CE990)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_4_OFFSET UNITYSDK_OFFSET(0x1B4CE9D0)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_5_OFFSET UNITYSDK_OFFSET(0x1B4CEA30)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_6_OFFSET UNITYSDK_OFFSET(0x1B4CEA70)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_7_OFFSET UNITYSDK_OFFSET(0x1B4CEAC0)
#define PIPELINECAMERA_CHECKUTILS_ENSURENOTNAN_OFFSET UNITYSDK_OFFSET(0x1B4CE8B0)
#define PIPELINECAMERA_CHECKUTILS_ENSUREPARTIALORDER_OFFSET UNITYSDK_OFFSET(0x1B4CEC30)
#define PIPELINECAMERA_CHECKUTILS_ENSURERANGE_OFFSET UNITYSDK_OFFSET(0x1B4CEBC0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CheckUtils_TypeDefinitionIndex = 36071;
