...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_COMMIT_OFFSET UNITYSDK_OFFSET(0x1AE01E40)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x1AE01600)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1AE01550)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1AE014A0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1AE01880)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLESTRIP_OFFSET UNITYSDK_OFFSET(0x1AE017A0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1AE016D0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_RESET_OFFSET UNITYSDK_OFFSET(0x1AE01D10)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE01260)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems2D_TypeDefinitionIndex = 36003;

	class CameraDebugDrawItems2D : public ::System::Object
	{
	public:
		::PipelineCamera::CameraDebugDrawTriangles2D* _triangles; // 0x10
		::PipelineCamera::CameraDebugDrawLines2D* _lines; // 0x18
