...
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_COMMIT_OFFSET UNITYSDK_OFFSET(0x1D230080)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINESTRIP_OFFSET UNITYSDK_OFFSET(0x1D22F840)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1D22F790)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1D22F6E0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1D22FAC0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLESTRIP_OFFSET UNITYSDK_OFFSET(0x1D22F9E0)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1D22F910)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D_RESET_OFFSET UNITYSDK_OFFSET(0x1D22FF50)
#define PIPELINECAMERA_CAMERADEBUGDRAWITEMS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D22F4A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawItems2D_TypeDefinitionIndex = 37611;

	class CameraDebugDrawItems2D : public ::System::Object
	{
	public:
		::PipelineCamera::CameraDebugDrawTriangles2D* _triangles; // 0x10
		::PipelineCamera::CameraDebugDrawPoints2D* _points; // 0x18
		::PipelineCamera::CameraDebugDrawLines2D* _lines; // 0x20
