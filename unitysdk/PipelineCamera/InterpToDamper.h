...
#define PIPELINECAMERA_INTERPTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9CEC30)
#define PIPELINECAMERA_INTERPTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9CEC20)
#define PIPELINECAMERA_INTERPTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2E7CE0)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpToDamper_TypeDefinitionIndex = 36046;
