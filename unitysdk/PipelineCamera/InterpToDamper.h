...
#define PIPELINECAMERA_INTERPTODAMPER_PIPELINECAMERA_IVALUEBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA701C0)
#define PIPELINECAMERA_INTERPTODAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA701B0)
#define PIPELINECAMERA_INTERPTODAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x55FE60)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpToDamper_TypeDefinitionIndex = 37654;
