...
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_BEZIER_OFFSET UNITYSDK_OFFSET(0x1D2346E0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_CONSTANT_OFFSET UNITYSDK_OFFSET(0x1D2344A0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_CUBIC_OFFSET UNITYSDK_OFFSET(0x1D2345B0)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_LINEAR_OFFSET UNITYSDK_OFFSET(0x1D234390)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x9DE550)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER_PIPELINECAMERA_IALPHAMODIFIER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9DE480)
#define PIPELINECAMERA_INTERPCURVEALPHAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x342530)

namespace PipelineCamera
{
	inline static constexpr unsigned int InterpCurveAlphaModifier_TypeDefinitionIndex = 37673;
