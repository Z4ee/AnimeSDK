...
#define PIPELINECAMERA_EXTENSION_ASEULER_OFFSET UNITYSDK_OFFSET(0x1B4D21B0)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_1_OFFSET UNITYSDK_OFFSET(0x1B4D1A20)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_OFFSET UNITYSDK_OFFSET(0x1B4D1960)
#define PIPELINECAMERA_EXTENSION_CLAMPTO_OFFSET UNITYSDK_OFFSET(0x1B4D1810)
#define PIPELINECAMERA_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1B4D1AD0)
#define PIPELINECAMERA_EXTENSION_DRAWARROW_OFFSET UNITYSDK_OFFSET(0x1B4CFEA0)
#define PIPELINECAMERA_EXTENSION_DRAWELLIPSE_OFFSET UNITYSDK_OFFSET(0x1B4CF790)
#define PIPELINECAMERA_EXTENSION_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B4CEF90)
#define PIPELINECAMERA_EXTENSION_ENSUREINRANGE_OFFSET UNITYSDK_OFFSET(0x1B4D18B0)
#define PIPELINECAMERA_EXTENSION_ENSURENOTZERO_OFFSET UNITYSDK_OFFSET(0x1B4D1680)
#define PIPELINECAMERA_EXTENSION_FORWARD_OFFSET UNITYSDK_OFFSET(0x1B4D20D0)
#define PIPELINECAMERA_EXTENSION_GETBLENDINGCATEGORY_OFFSET UNITYSDK_OFFSET(0x1B4D0E90)
#define PIPELINECAMERA_EXTENSION_GETELLIPSEDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1B4CF4D0)
#define PIPELINECAMERA_EXTENSION_GETSECTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B4D1300)
#define PIPELINECAMERA_EXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B4D2350)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1B4D1C40)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1B4D1DB0)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1B4D1700)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1B4D1D00)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1B4D1E50)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1B4D17A0)
#define PIPELINECAMERA_EXTENSION_LERPEULERROTATION_OFFSET UNITYSDK_OFFSET(0x1B4D0A10)
#define PIPELINECAMERA_EXTENSION_LERPEULER_OFFSET UNITYSDK_OFFSET(0x1B4D0C30)
#define PIPELINECAMERA_EXTENSION_LERPFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1B4D0970)
#define PIPELINECAMERA_EXTENSION_LERPOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4D0880)
#define PIPELINECAMERA_EXTENSION_LERPPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x1B4D06C0)
#define PIPELINECAMERA_EXTENSION_LERPRADIUS_OFFSET UNITYSDK_OFFSET(0x1B4D07E0)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1B4D1F40)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B4D1ED0)
#define PIPELINECAMERA_EXTENSION_MINMAX_OFFSET UNITYSDK_OFFSET(0x1B4D23E0)
#define PIPELINECAMERA_EXTENSION_MIRROR_OFFSET UNITYSDK_OFFSET(0x1B4D0ED0)
#define PIPELINECAMERA_EXTENSION_PROJECTON_OFFSET UNITYSDK_OFFSET(0x1B4D1B30)
#define PIPELINECAMERA_EXTENSION_REALASPECT_OFFSET UNITYSDK_OFFSET(0x1B4D1580)
#define PIPELINECAMERA_EXTENSION_RIGHT_1_OFFSET UNITYSDK_OFFSET(0x1B4D22C0)
#define PIPELINECAMERA_EXTENSION_RIGHT_OFFSET UNITYSDK_OFFSET(0x1B4D2120)
#define PIPELINECAMERA_EXTENSION_ROTATEBYSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1B4D0660)
#define PIPELINECAMERA_EXTENSION_SIZEXZ_OFFSET UNITYSDK_OFFSET(0x1B4D2250)
#define PIPELINECAMERA_EXTENSION_TESTACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B4CFF80)
#define PIPELINECAMERA_EXTENSION_TESTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1B4D0060)
#define PIPELINECAMERA_EXTENSION_TESTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B4CFFC0)
#define PIPELINECAMERA_EXTENSION_TESTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1B4D0100)
#define PIPELINECAMERA_EXTENSION_TESTFLUSH_OFFSET UNITYSDK_OFFSET(0x1B4D0150)
#define PIPELINECAMERA_EXTENSION_TESTPOSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1B4D00B0)
#define PIPELINECAMERA_EXTENSION_TESTPREPARE_OFFSET UNITYSDK_OFFSET(0x1B4D0010)
#define PIPELINECAMERA_EXTENSION_TESTTOUCH_OFFSET UNITYSDK_OFFSET(0x1B4D01A0)
#define PIPELINECAMERA_EXTENSION_TESTTRACKINCOLLECT_OFFSET UNITYSDK_OFFSET(0x1B4D01F0)
#define PIPELINECAMERA_EXTENSION_TOPRECISESTRING_OFFSET UNITYSDK_OFFSET(0x1B4D1FD0)
#define PIPELINECAMERA_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1B4D1130)
#define PIPELINECAMERA_EXTENSION_UPDATED_OFFSET UNITYSDK_OFFSET(0x1B4CEDE0)
#define PIPELINECAMERA_EXTENSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B4D0240)
#define PIPELINECAMERA_EXTENSION_UP_1_OFFSET UNITYSDK_OFFSET(0x1B4D2300)
#define PIPELINECAMERA_EXTENSION_UP_OFFSET UNITYSDK_OFFSET(0x1B4D2160)
#define PIPELINECAMERA_EXTENSION_VERTICAL_OFFSET UNITYSDK_OFFSET(0x1B4D2390)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_OFFSET UNITYSDK_OFFSET(0x1B4CF740)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_OFFSET UNITYSDK_OFFSET(0x1B4CF6E0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 35960;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::UnityEngine::Vector2>*>**)Il2CppClass::FromTypeDefinitionIndex(Extension_TypeDefinitionIndex)->GetStaticField(0x27110);
		}
