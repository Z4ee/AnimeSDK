...
#define PIPELINECAMERA_EXTENSION_ASEULER_OFFSET UNITYSDK_OFFSET(0x1EC31630)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_1_OFFSET UNITYSDK_OFFSET(0x1EC30EA0)
#define PIPELINECAMERA_EXTENSION_ASPERIODIC_OFFSET UNITYSDK_OFFSET(0x1EC30DE0)
#define PIPELINECAMERA_EXTENSION_CLAMPTO_OFFSET UNITYSDK_OFFSET(0x1EC30C90)
#define PIPELINECAMERA_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1EC30F50)
#define PIPELINECAMERA_EXTENSION_DRAWARROW_OFFSET UNITYSDK_OFFSET(0x1EC2F370)
#define PIPELINECAMERA_EXTENSION_DRAWELLIPSE_OFFSET UNITYSDK_OFFSET(0x1EC2EC40)
#define PIPELINECAMERA_EXTENSION_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1EC2E4D0)
#define PIPELINECAMERA_EXTENSION_ENSUREINRANGE_OFFSET UNITYSDK_OFFSET(0x1EC30D30)
#define PIPELINECAMERA_EXTENSION_ENSURENOTZERO_OFFSET UNITYSDK_OFFSET(0x1EC30B00)
#define PIPELINECAMERA_EXTENSION_FORWARD_OFFSET UNITYSDK_OFFSET(0x1EC31550)
#define PIPELINECAMERA_EXTENSION_GETBLENDINGCATEGORY_OFFSET UNITYSDK_OFFSET(0x1EC30310)
#define PIPELINECAMERA_EXTENSION_GETELLIPSEDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1EC2EA10)
#define PIPELINECAMERA_EXTENSION_GETSECTIONSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1EC30780)
#define PIPELINECAMERA_EXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1EC317C0)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1EC310C0)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1EC31230)
#define PIPELINECAMERA_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1EC30B80)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1EC31180)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1EC312D0)
#define PIPELINECAMERA_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1EC30C20)
#define PIPELINECAMERA_EXTENSION_LERPEULERROTATION_OFFSET UNITYSDK_OFFSET(0x1EC2FEA0)
#define PIPELINECAMERA_EXTENSION_LERPEULER_OFFSET UNITYSDK_OFFSET(0x1EC300C0)
#define PIPELINECAMERA_EXTENSION_LERPFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1EC2FE00)
#define PIPELINECAMERA_EXTENSION_LERPOFFSET_OFFSET UNITYSDK_OFFSET(0x1EC2FD10)
#define PIPELINECAMERA_EXTENSION_LERPPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x1EC2FB50)
#define PIPELINECAMERA_EXTENSION_LERPRADIUS_OFFSET UNITYSDK_OFFSET(0x1EC2FC70)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1EC313C0)
#define PIPELINECAMERA_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1EC31350)
#define PIPELINECAMERA_EXTENSION_MINMAX_OFFSET UNITYSDK_OFFSET(0x1EC31850)
#define PIPELINECAMERA_EXTENSION_MIRROR_OFFSET UNITYSDK_OFFSET(0x1EC30350)
#define PIPELINECAMERA_EXTENSION_PROJECTON_OFFSET UNITYSDK_OFFSET(0x1EC30FB0)
#define PIPELINECAMERA_EXTENSION_REALASPECT_OFFSET UNITYSDK_OFFSET(0x1EC30A00)
#define PIPELINECAMERA_EXTENSION_RIGHT_1_OFFSET UNITYSDK_OFFSET(0x1EC31730)
#define PIPELINECAMERA_EXTENSION_RIGHT_OFFSET UNITYSDK_OFFSET(0x1EC315A0)
#define PIPELINECAMERA_EXTENSION_ROTATEBYSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1EC2FAF0)
#define PIPELINECAMERA_EXTENSION_SIZEXZ_OFFSET UNITYSDK_OFFSET(0x1EC316D0)
#define PIPELINECAMERA_EXTENSION_TESTACTIVATE_OFFSET UNITYSDK_OFFSET(0x1EC2F450)
#define PIPELINECAMERA_EXTENSION_TESTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1EC2F530)
#define PIPELINECAMERA_EXTENSION_TESTDEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1EC2F490)
#define PIPELINECAMERA_EXTENSION_TESTEVALUATE_OFFSET UNITYSDK_OFFSET(0x1EC2F5D0)
#define PIPELINECAMERA_EXTENSION_TESTFLUSH_OFFSET UNITYSDK_OFFSET(0x1EC2F620)
#define PIPELINECAMERA_EXTENSION_TESTPOSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1EC2F580)
#define PIPELINECAMERA_EXTENSION_TESTPREPARE_OFFSET UNITYSDK_OFFSET(0x1EC2F4E0)
#define PIPELINECAMERA_EXTENSION_TESTTOUCH_OFFSET UNITYSDK_OFFSET(0x1EC2F670)
#define PIPELINECAMERA_EXTENSION_TESTTRACKINCOLLECT_OFFSET UNITYSDK_OFFSET(0x1EC2F6B0)
#define PIPELINECAMERA_EXTENSION_TOPRECISESTRING_OFFSET UNITYSDK_OFFSET(0x1EC31450)
#define PIPELINECAMERA_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1EC305B0)
#define PIPELINECAMERA_EXTENSION_UPDATED_OFFSET UNITYSDK_OFFSET(0x1EC2E310)
#define PIPELINECAMERA_EXTENSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1EC2F700)
#define PIPELINECAMERA_EXTENSION_UP_1_OFFSET UNITYSDK_OFFSET(0x1EC31770)
#define PIPELINECAMERA_EXTENSION_UP_OFFSET UNITYSDK_OFFSET(0x1EC315E0)
#define PIPELINECAMERA_EXTENSION_VERTICAL_OFFSET UNITYSDK_OFFSET(0x1EC31800)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_OFFSET UNITYSDK_OFFSET(0x1EC2EBF0)
#define PIPELINECAMERA_EXTENSION__GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_OFFSET UNITYSDK_OFFSET(0x1EC2EB80)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 38229;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::UnityEngine::Vector2>*>**)Il2CppClass::FromTypeDefinitionIndex(Extension_TypeDefinitionIndex)->GetStaticField(0x2A6B0);
		}
