...
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__FROMTO_OFFSET UNITYSDK_OFFSET(0x1C2B8B40)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1C2B8880)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1C2B89B0)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1C2B87B0)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1C2B8700)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1C2B8660)
#define PIPELINECAMERA_VECTOR3MATHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C2B8BE0)
#define PIPELINECAMERA_VECTOR3MATHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1C2B8BD0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Vector3MathOp_TypeDefinitionIndex = 36095;
	...
	public:
		...
		{
			return (::PipelineCamera::Vector3MathOp**)Il2CppClass::FromTypeDefinitionIndex(Vector3MathOp_TypeDefinitionIndex)->GetStaticField(0x270C0);
		}
