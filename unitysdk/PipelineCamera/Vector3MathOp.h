...
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__FROMTO_OFFSET UNITYSDK_OFFSET(0x1F9E8AA0)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_1_OFFSET UNITYSDK_OFFSET(0x1F9E87E0)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_2_OFFSET UNITYSDK_OFFSET(0x1F9E8910)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__LINEARCOMBINE_OFFSET UNITYSDK_OFFSET(0x1F9E8700)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOATADD_OFFSET UNITYSDK_OFFSET(0x1F9E8650)
#define PIPELINECAMERA_VECTOR3MATHOP_PIPELINECAMERA_IMATHOPERATION_UNITYENGINE_VECTOR3__MULTIPLYFLOAT_OFFSET UNITYSDK_OFFSET(0x1F9E85B0)
#define PIPELINECAMERA_VECTOR3MATHOP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F9E8B40)
#define PIPELINECAMERA_VECTOR3MATHOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1F9E8B30)

namespace PipelineCamera
{
	inline static constexpr unsigned int Vector3MathOp_TypeDefinitionIndex = 38364;
	...
	public:
		...
		{
			return (::PipelineCamera::Vector3MathOp**)Il2CppClass::FromTypeDefinitionIndex(Vector3MathOp_TypeDefinitionIndex)->GetStaticField(0x2A660);
		}
