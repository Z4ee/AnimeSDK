...
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_BUILDCACHEINTERNAL_OFFSET UNITYSDK_OFFSET(0xA10290)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKALL_OFFSET UNITYSDK_OFFSET(0xA101A0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKASPECTRATIO_OFFSET UNITYSDK_OFFSET(0xA10160)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKCAMERALOCATION_OFFSET UNITYSDK_OFFSET(0xA10060)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA10120)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0xA100A0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CHECKLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0xA100E0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_CREATE_OFFSET UNITYSDK_OFFSET(0x1D833A20)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA10240)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0xA101E0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x981620)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0xA10260)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_MARKDIRTY_OFFSET UNITYSDK_OFFSET(0xA102A0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETASPECTRATIO_OFFSET UNITYSDK_OFFSET(0xA0FDA0)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETCAMERALOCATION_OFFSET UNITYSDK_OFFSET(0xA0F410)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA0FB70)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETLOOKATLOCATION_OFFSET UNITYSDK_OFFSET(0xA0F650)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETLOOKATSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0xA0F890)
#define PIPELINECAMERA_DATA_LOOKATINFINAL_BYROTATION_SETROTATIONTYPE_OFFSET UNITYSDK_OFFSET(0xA0FFD0)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInFinal_ByRotation_TypeDefinitionIndex = 37781;
