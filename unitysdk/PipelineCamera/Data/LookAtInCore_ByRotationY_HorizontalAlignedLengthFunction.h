...
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_CALCULATEYAWRADIAN_OFFSET UNITYSDK_OFFSET(0x8DB580)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_CONSTANT_OFFSET UNITYSDK_OFFSET(0x8DB0E0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x8DB190)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSESTINDECREASINGINTERVAL_OFFSET UNITYSDK_OFFSET(0x8DB3D0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSESTININCREASINGINTERVAL_OFFSET UNITYSDK_OFFSET(0x8DB220)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETCLOSEST_OFFSET UNITYSDK_OFFSET(0x8DB1D0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_GETMONOTONICALLYINTERVAL_OFFSET UNITYSDK_OFFSET(0x8DB1B0)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION_RESOLVE_OFFSET UNITYSDK_OFFSET(0x8DB180)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x8DB070)
#define PIPELINECAMERA_DATA_LOOKATINCORE_BYROTATIONY_HORIZONTALALIGNEDLENGTHFUNCTION__GETCLOSEST_G__UPDATERESULT_9_0_OFFSET UNITYSDK_OFFSET(0x1A4D5290)

namespace PipelineCamera::Data
{
	inline static constexpr unsigned int LookAtInCore_ByRotationY_HorizontalAlignedLengthFunction_TypeDefinitionIndex = 36170;
