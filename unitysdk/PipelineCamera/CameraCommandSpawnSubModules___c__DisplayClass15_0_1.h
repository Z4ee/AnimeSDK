...
{
	inline static constexpr unsigned int CameraCommandSpawnSubModules___c__DisplayClass15_0_1_TypeDefinitionIndex = 38139;

	template <typename T>
	class CameraCommandSpawnSubModules___c__DisplayClass15_0_1 : public ::System::Object
	{
	public:
