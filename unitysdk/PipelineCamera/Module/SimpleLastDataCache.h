...
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_CREATE_OFFSET UNITYSDK_OFFSET(0x1D837AB0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_GETLASTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1D837B70)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D837CB0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1D837E30)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D837D10)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1D837F50)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1D838000)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1D837C60)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1D837BE0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1D837C20)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1D837EC0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1D837DA0)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1D838090)
#define PIPELINECAMERA_MODULE_SIMPLELASTDATACACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D837A60)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int SimpleLastDataCache_TypeDefinitionIndex = 38004;

	class SimpleLastDataCache : public ::System::Object
	{
	public:
		::System::Int32 _pipelineId; // 0x10
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> _lastData; // 0x14
