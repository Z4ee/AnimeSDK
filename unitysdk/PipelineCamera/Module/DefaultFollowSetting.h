...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1DE23680)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_GET_SETTING_OFFSET UNITYSDK_OFFSET(0x1DE235C0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_INITSUBMODULE_OFFSET UNITYSDK_OFFSET(0x1DE23930)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1DE23D90)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1DE23F10)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1DE23E20)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1DE24040)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1DE24100)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1DE23D40)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1DE23CC0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1DE23D00)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1DE23FB0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1DE23EB0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1DE24160)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE235E0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowSetting_TypeDefinitionIndex = 38011;
	...
	public:
		...
		::PipelineCamera::Module::DefaultFollowSettingParam _cachedOutput; // 0x18
		::Foundation::Unreal::FName _moduleId; // 0x30
		::System::Int32 _pipelineId; // 0x38
		::PipelineCamera::Module::DefaultFollowSettingParam _defaultDefaultFollowSetting; // 0x3C
