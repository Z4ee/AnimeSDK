...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1BABF770)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_GET_SETTING_OFFSET UNITYSDK_OFFSET(0x1BABF6B0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_INITSUBMODULE_OFFSET UNITYSDK_OFFSET(0x1BABFA20)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1BABFE80)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1BAC0000)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1BABFF10)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1BAC0150)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1BAC0210)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1BABFE30)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1BABFDB0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1BABFDF0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1BAC00C0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1BABFFA0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1BAC0270)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1BABF6D0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowSetting_TypeDefinitionIndex = 36403;
	...
	public:
		...
		::PipelineCamera::Module::DefaultFollowSettingParam _defaultDefaultFollowSetting; // 0x20
		::System::Int32 _pipelineId; // 0x38
		::PipelineCamera::Module::DefaultFollowSettingParam _cachedOutput; // 0x3C
