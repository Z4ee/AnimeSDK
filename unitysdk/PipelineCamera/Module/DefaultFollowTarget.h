...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1D836D30)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1D836C80)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_INITSUTMODULE_OFFSET UNITYSDK_OFFSET(0x1D836FE0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D837440)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1D8376B0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D837540)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1D837910)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1D837990)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1D8373F0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1D837370)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1D8373B0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1D837880)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1D837650)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1D8379F0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1D836CA0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowTarget_TypeDefinitionIndex = 38014;
	...
	public:
		...
		::System::Nullable_1<::PipelineCamera::CameraFollowTargetParam> _cachedValue; // 0x18
