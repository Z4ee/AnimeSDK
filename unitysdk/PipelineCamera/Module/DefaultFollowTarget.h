...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1B4899F0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1B489940)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_INITSUTMODULE_OFFSET UNITYSDK_OFFSET(0x1B489CA0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B48A100)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1B48A370)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B48A200)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B48A5D0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B48A650)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1B48A0B0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1B48A030)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1B48A070)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1B48A540)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1B48A310)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1B48A6B0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B489960)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowTarget_TypeDefinitionIndex = 36406;
	...
	public:
		...
		::System::Nullable_1<::PipelineCamera::CameraFollowTargetParam> _cachedValue; // 0x1C
		::Foundation::Unreal::FName _moduleId; // 0x48
