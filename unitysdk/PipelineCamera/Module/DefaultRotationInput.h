...
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1BEB0F60)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_GET_ROTATIONINPUT_OFFSET UNITYSDK_OFFSET(0x1BEB06E0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1BEB1310)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1BEB1490)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1BEB13A0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1BEB1850)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1BEB1910)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1BEB12C0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1BEB1220)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1BEB1270)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1BEB17C0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1BEB1430)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1BEB1970)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEB0E70)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultRotationInput_TypeDefinitionIndex = 36391;
	...
	public:
		...
		::Foundation::Unreal::FName _moduleId; // 0x84
		::System::Int32 _pipelineId; // 0x8C
