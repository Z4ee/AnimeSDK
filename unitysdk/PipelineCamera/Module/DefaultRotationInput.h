...
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1E1F6A80)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_GET_ROTATIONINPUT_OFFSET UNITYSDK_OFFSET(0x1E1F61F0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E1F6E00)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1E1F6F80)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E1F6E90)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1E1F7350)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E1F7410)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1E1F6DB0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1E1F6D30)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1E1F6D70)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1E1F72C0)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1E1F6F20)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1E1F7470)
#define PIPELINECAMERA_MODULE_DEFAULTROTATIONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F6990)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultRotationInput_TypeDefinitionIndex = 37999;

	class DefaultRotationInput : public ::System::Object
	{
	public:
		::PipelineCamera::Module::DefaultRotationInputParam _cachedOutput; // 0x10
		::PipelineCamera::CameraSubModuleContainer_1<::PipelineCamera::Module::DefaultRotationInputParam>* _subModules; // 0x68
		::Foundation::Unreal::FName _moduleId; // 0x70
		::System::Int32 _pipelineId; // 0x78
		::UnityEngine::Vector3 _defaultRotationSpeed; // 0x7C
		::System::Nullable_1<::UnityEngine::Quaternion> _cachedRotationInput; // 0x88
