...
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_BUILDBLENDER_OFFSET UNITYSDK_OFFSET(0x1E919630)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDINGREQUEST_OFFSET UNITYSDK_OFFSET(0x1E9184A0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDING_OFFSET UNITYSDK_OFFSET(0x1E9184F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CLEARBLENDER_OFFSET UNITYSDK_OFFSET(0x1E919920)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CONSUMEBLENDERBUILDER_OFFSET UNITYSDK_OFFSET(0x1E919A50)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CREATE_OFFSET UNITYSDK_OFFSET(0x1E919040)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_GET_LASTOUTPUT_OFFSET UNITYSDK_OFFSET(0x1E918420)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLECURRENTBLENDER_OFFSET UNITYSDK_OFFSET(0x1E919470)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLENEWBLENDER_OFFSET UNITYSDK_OFFSET(0x1E9190E0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E918600)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1E918780)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E918660)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1E918BB0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E918DD0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1E9185B0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1E918530)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1E918570)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1E918920)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1E9186F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1E918EF0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_REQUESTBLENDING_OFFSET UNITYSDK_OFFSET(0x1E918440)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E919010)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int InPlaceBlender_TypeDefinitionIndex = 38663;
	...
	public:
		...
		::Foundation::Unreal::FName _moduleId; // 0x20
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> _cachedOutput; // 0x28
		::System::Boolean _cancelBlending; // 0x58
