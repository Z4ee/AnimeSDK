...
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_BUILDBLENDER_OFFSET UNITYSDK_OFFSET(0x1D56A2F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDINGREQUEST_OFFSET UNITYSDK_OFFSET(0x1D569170)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CANCELBLENDING_OFFSET UNITYSDK_OFFSET(0x1D5691C0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CLEARBLENDER_OFFSET UNITYSDK_OFFSET(0x1D56A5D0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CONSUMEBLENDERBUILDER_OFFSET UNITYSDK_OFFSET(0x1D56A700)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_CREATE_OFFSET UNITYSDK_OFFSET(0x1D569D10)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_GET_LASTOUTPUT_OFFSET UNITYSDK_OFFSET(0x1D5690F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLECURRENTBLENDER_OFFSET UNITYSDK_OFFSET(0x1D56A130)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_HANDLENEWBLENDER_OFFSET UNITYSDK_OFFSET(0x1D569DB0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D5692D0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1D569450)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1D569330)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1D569880)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1D569AA0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1D569280)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1D569200)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1D569240)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1D5695F0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1D5693C0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1D569BC0)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER_REQUESTBLENDING_OFFSET UNITYSDK_OFFSET(0x1D569110)
#define PIPELINECAMERA_MODULE_INPLACEBLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1D569CE0)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int InPlaceBlender_TypeDefinitionIndex = 38002;
	...
	public:
		...
		::Foundation::Unreal::FName _moduleId; // 0x24
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> _cachedOutput; // 0x2C
		::System::Boolean _cancelBlending; // 0x5C
