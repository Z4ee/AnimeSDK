...
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1E1F56A0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E1F5A20)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1E1F5BA0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1E1F5AB0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1E1F6300)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1E1F6730)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1E1F59D0)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1E1F5950)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1E1F5990)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1E1F6270)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1E1F5B40)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1E1F6790)
#define PIPELINECAMERA_MODULE_DEFAULTFOLLOWINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F5610)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int DefaultFollowInitializer_TypeDefinitionIndex = 37995;
	...
	public:
		...
		::System::Nullable_1<::PipelineCamera::Module::DefaultFollowInitialParam> _initialValue; // 0x18
