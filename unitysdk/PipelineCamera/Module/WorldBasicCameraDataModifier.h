...
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_BUILDCAMERACOMMANDHANDLER_OFFSET UNITYSDK_OFFSET(0x1EC14210)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_INITSUTMODULE_OFFSET UNITYSDK_OFFSET(0x1EC13970)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1EC13DB0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_COLLECT_OFFSET UNITYSDK_OFFSET(0x1EC13F30)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1EC13E40)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1EC14030)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_FLUSH_OFFSET UNITYSDK_OFFSET(0x1EC140D0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_GETMODULEFLAG_OFFSET UNITYSDK_OFFSET(0x1EC13D60)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1EC13CE0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_GET_PIPELINETYPE_OFFSET UNITYSDK_OFFSET(0x1EC13D20)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_POSTCOLLECT_OFFSET UNITYSDK_OFFSET(0x1EC13FA0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1EC13ED0)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER_PIPELINECAMERA_ICAMERAMODULE_TOUCH_OFFSET UNITYSDK_OFFSET(0x1EC14130)
#define PIPELINECAMERA_MODULE_WORLDBASICCAMERADATAMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC14190)

namespace PipelineCamera::Module
{
	inline static constexpr unsigned int WorldBasicCameraDataModifier_TypeDefinitionIndex = 38668;
