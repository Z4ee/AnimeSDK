...
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_EVALUATEINTERNAL_OFFSET UNITYSDK_OFFSET(0x997910)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GETDESIREDDISTANCE_OFFSET UNITYSDK_OFFSET(0x997930)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GETSPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x997940)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GET_HITCACHE_OFFSET UNITYSDK_OFFSET(0x1B8A66D0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GROWCACHE_OFFSET UNITYSDK_OFFSET(0x1B8A67F0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x997950)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_COLLECT_OFFSET UNITYSDK_OFFSET(0x997A00)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x997960)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x997A10)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_FLUSH_OFFSET UNITYSDK_OFFSET(0x997A30)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_PREPARE_OFFSET UNITYSDK_OFFSET(0x9979B0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_TOUCH_OFFSET UNITYSDK_OFFSET(0x997A80)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x9978D0)

namespace PipelineCamera::SubModule::Detail
{
	inline static constexpr unsigned int DefaultSightCollisionResolver_TypeDefinitionIndex = 36424;
