...
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_EVALUATEINTERNAL_OFFSET UNITYSDK_OFFSET(0xA38E30)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GETDESIREDDISTANCE_OFFSET UNITYSDK_OFFSET(0xA38E50)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GETSPHERERADIUS_OFFSET UNITYSDK_OFFSET(0xA38E60)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GET_HITCACHE_OFFSET UNITYSDK_OFFSET(0x1DC30110)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_GROWCACHE_OFFSET UNITYSDK_OFFSET(0x1DC30230)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_ACTIVATE_OFFSET UNITYSDK_OFFSET(0xA38E70)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_COLLECT_OFFSET UNITYSDK_OFFSET(0xA38F20)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0xA38E80)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0xA38F30)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_FLUSH_OFFSET UNITYSDK_OFFSET(0xA38F50)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_PREPARE_OFFSET UNITYSDK_OFFSET(0xA38ED0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_TOUCH_OFFSET UNITYSDK_OFFSET(0xA38FA0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTSIGHTCOLLISIONRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0xA38DF0)

namespace PipelineCamera::SubModule::Detail
{
	inline static constexpr unsigned int DefaultSightCollisionResolver_TypeDefinitionIndex = 38032;
