...
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_ACTIVATE_OFFSET UNITYSDK_OFFSET(0xA81A90)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_COLLECT_OFFSET UNITYSDK_OFFSET(0xA81B80)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0xA81AE0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0xA81BD0)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_FLUSH_OFFSET UNITYSDK_OFFSET(0xA81C50)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_PREPARE_OFFSET UNITYSDK_OFFSET(0xA81B30)
#define PIPELINECAMERA_SUBMODULE_DETAIL_DEFAULTVOLUMECOLLISIONRESOLVER_PIPELINECAMERA_SUBMODULE_ICAMERACOLLISIONRESOLVER_TOUCH_OFFSET UNITYSDK_OFFSET(0xA81CA0)

namespace PipelineCamera::SubModule::Detail
{
	inline static constexpr unsigned int DefaultVolumeCollisionResolver_TypeDefinitionIndex = 38694;
