...
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD5F70)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD5FE0)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1BBD5C30)
#define PIPELINECAMERA_SUBMODULE_ONCAMERACOLLISIONRESOLVEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD5C20)

namespace PipelineCamera::SubModule
{
	inline static constexpr unsigned int OnCameraCollisionResolvedDelegate_TypeDefinitionIndex = 36412;
