...
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0x7E7700)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0x7E7680)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x7E7790)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x7E7670)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x7337F0)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalSpringDamper_TypeDefinitionIndex = 36048;
