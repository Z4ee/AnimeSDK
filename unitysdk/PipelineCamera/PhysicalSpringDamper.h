...
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATEINITIALVALUE_OFFSET UNITYSDK_OFFSET(0x8FEB40)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_GENERATERELAXOFFSET_OFFSET UNITYSDK_OFFSET(0x8FEAC0)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x8FEBD0)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x8FEAB0)
#define PIPELINECAMERA_PHYSICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FEAA0)

namespace PipelineCamera
{
	inline static constexpr unsigned int PhysicalSpringDamper_TypeDefinitionIndex = 38317;
