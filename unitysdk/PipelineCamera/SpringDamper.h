...
#define PIPELINECAMERA_SPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9CECE0)
#define PIPELINECAMERA_SPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x9CECD0)
#define PIPELINECAMERA_SPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x9CECC0)

namespace PipelineCamera
{
	inline static constexpr unsigned int SpringDamper_TypeDefinitionIndex = 36050;
