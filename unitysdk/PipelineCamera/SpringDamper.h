...
#define PIPELINECAMERA_SPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA70270)
#define PIPELINECAMERA_SPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0xA70260)
#define PIPELINECAMERA_SPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0xA70250)

namespace PipelineCamera
{
	inline static constexpr unsigned int SpringDamper_TypeDefinitionIndex = 37658;
