...
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EC13560)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE__SYSTEM_SINGLESIN_SYSTEM_SINGLECOS___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EC136A0)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR__SYSTEM_SINGLESIN_SYSTEM_SINGLECOS___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EC135F0)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EC13710)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EC13650)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EC13600)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EC13550)
#define PIPELINECAMERA_METHOD___SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC13530)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method___SampleCircle_g__GetSinCosEnumerable_38_1_d_TypeDefinitionIndex = 38156;
