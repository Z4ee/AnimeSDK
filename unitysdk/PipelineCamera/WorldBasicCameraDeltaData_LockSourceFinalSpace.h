...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA8C050)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASCURRENT_3_0_OFFSET UNITYSDK_OFFSET(0x1F059EB0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASSOURCE_3_1_OFFSET UNITYSDK_OFFSET(0x1F059A50)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceFinalSpace_TypeDefinitionIndex = 38268;
