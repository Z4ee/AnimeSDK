...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x997A90)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASCURRENT_3_0_OFFSET UNITYSDK_OFFSET(0x1B8A8170)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCEFINALSPACE__INVOKE_G__UPDATEASSOURCE_3_1_OFFSET UNITYSDK_OFFSET(0x1B8A7D20)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceFinalSpace_TypeDefinitionIndex = 35999;
