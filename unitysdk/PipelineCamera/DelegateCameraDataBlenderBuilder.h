...
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1DCD5D20)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1DCD5D30)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1DCD5D40)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1DCD5D60)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_GET_BLENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1DCD5E80)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1DCD5DF0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCD5D50)

namespace PipelineCamera
{
	inline static constexpr unsigned int DelegateCameraDataBlenderBuilder_TypeDefinitionIndex = 38239;

	class DelegateCameraDataBlenderBuilder : public ::System::Object
	{
	public:
		::System::Action_1<::PipelineCamera::ICameraDataBlender*>* _OnConstruct_k__BackingField; // 0x10
		::System::Func_2<::PipelineCamera::ICameraDataBlender*, ::PipelineCamera::ICameraDataBlender*>* _Construct_k__BackingField; // 0x18
