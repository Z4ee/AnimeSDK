...
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1C84CFA0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1C84CFB0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1C84CFC0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_CONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1C84CFE0)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_GET_BLENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1C84D100)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER_PIPELINECAMERA_ICAMERADATABLENDERBUILDER_ONCONSTRUCT_OFFSET UNITYSDK_OFFSET(0x1C84D070)
#define PIPELINECAMERA_DELEGATECAMERADATABLENDERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1C84CFD0)

namespace PipelineCamera
{
	inline static constexpr unsigned int DelegateCameraDataBlenderBuilder_TypeDefinitionIndex = 37578;
