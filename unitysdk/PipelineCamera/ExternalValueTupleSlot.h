...
#define PIPELINECAMERA_EXTERNALVALUETUPLESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x778AE0)

namespace PipelineCamera
{
	inline static constexpr unsigned int ExternalValueTupleSlot_TypeDefinitionIndex = 35910;
