...
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_COMPARE_OFFSET UNITYSDK_OFFSET(0xA2C040)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x6400C0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x6400B0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x63FFC0)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int AimingCameraDataBlender_RotationSelector_TypeDefinitionIndex = 37987;
