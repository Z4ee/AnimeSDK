...
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_COMPARE_OFFSET UNITYSDK_OFFSET(0x9878C0)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x746E80)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x746E70)
#define PIPELINECAMERA_BLENDER_AIMINGCAMERADATABLENDER_ROTATIONSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x746D80)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int AimingCameraDataBlender_RotationSelector_TypeDefinitionIndex = 36379;
