...
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_ANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x1B072870)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_EASING_OFFSET UNITYSDK_OFFSET(0x1B072560)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_GETDEBUGNAME_OFFSET UNITYSDK_OFFSET(0x1B072520)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_GETREMAININGTIME_OFFSET UNITYSDK_OFFSET(0x1B06FE40)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_GETREVERSEKEY_OFFSET UNITYSDK_OFFSET(0x1B06FDF0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_INTERPCURVE_OFFSET UNITYSDK_OFFSET(0x1B0726E0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_ISDEACTIVATED_OFFSET UNITYSDK_OFFSET(0x1B06FDB0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x1B06FD70)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B06FB50)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_COLLECT_OFFSET UNITYSDK_OFFSET(0x1B070200)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1B06FD10)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B070250)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B072260)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_PIPELINECAMERA_ICAMERADATABLENDERINTERNAL_TOUCH_OFFSET UNITYSDK_OFFSET(0x1B0723C0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_REPLACEBLEND_OFFSET UNITYSDK_OFFSET(0x1B06FEC0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER_REVERSED_OFFSET UNITYSDK_OFFSET(0x1B0700C0)
#define PIPELINECAMERA_BLENDER_DEFAULTBLENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0701F0)

namespace PipelineCamera::Blender
{
	inline static constexpr unsigned int DefaultBlender_TypeDefinitionIndex = 36384;

	class DefaultBlender : public ::System::Object
	{
	public:
		::PipelineCamera::ICameraTimestamp* _cameraTimestamp; // 0x10
		::PipelineCamera::TimeBasedAlphaGenerator* _alphaModifier; // 0x18
		::Foundation::Unreal::FName _debugName; // 0x20
		::System::Boolean _isFinished; // 0x28
		::System::Boolean _isDeactivated; // 0x29
		::System::Single _timestamp; // 0x2C
		::PipelineCamera::WorldBasicCameraDataDeltaFlag _deltaFlag; // 0x30
		::PipelineCamera::WorldBasicCameraData _lastCameraData; // 0x34
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraDeltaData> _deltaCameraData; // 0x60
		::System::Nullable_1<::System::Int32> _reverseKey; // 0x9C
		::System::Nullable_1<::PipelineCamera::WorldBasicCameraData> _lastEvaluateResult; // 0xA4
