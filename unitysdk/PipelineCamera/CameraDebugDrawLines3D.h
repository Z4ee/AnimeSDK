...
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_ADDLINE_OFFSET UNITYSDK_OFFSET(0x1A4CA290)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A4CA390)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D_DRAW_OFFSET UNITYSDK_OFFSET(0x1A4CA400)
#define PIPELINECAMERA_CAMERADEBUGDRAWLINES3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4CA780)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawLines3D_TypeDefinitionIndex = 36022;
