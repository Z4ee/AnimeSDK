...
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1E1F4A30)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E1F4D00)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E1F4C70)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1E1F4D80)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1E1F4CD0)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1E1F4C80)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1E1F4A20)
#define PIPELINECAMERA_EXTENSION___C__DISPLAYCLASS9_0___DRAWELLIPSE_G__GENERATOR_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F4A00)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___c__DisplayClass9_0___DrawEllipse_g__Generator_0_d_TypeDefinitionIndex = 37572;
	...
	public:
		...
		::System::Int32 __3__startIndex; // 0x20
		::System::Int32 startIndex; // 0x24
		::UnityEngine::Vector2 __2__current; // 0x28
