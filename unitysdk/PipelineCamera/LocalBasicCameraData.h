...
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0x951420)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x951360)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x951320)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKOFFSET_OFFSET UNITYSDK_OFFSET(0x9513E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x9512A0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x9512E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0x9513A0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1217E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x951270)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x58C170)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x950890)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x3A4CE0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x2E2760)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x58C110)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x8DB710)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9511F0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCALCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0x951290)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x950FE0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0x9508B0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x951170)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x950E50)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETPIVOTROTATION_OFFSET UNITYSDK_OFFSET(0x950EE0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0x9510E0)
#define PIPELINECAMERA_LOCALBASICCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0x950B80)

namespace PipelineCamera
{
	inline static constexpr unsigned int LocalBasicCameraData_TypeDefinitionIndex = 35990;
