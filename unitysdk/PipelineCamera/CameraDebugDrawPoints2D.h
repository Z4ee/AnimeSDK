...
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1D82FA30)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_CLEAR_OFFSET UNITYSDK_OFFSET(0x1D82FAF0)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_DRAW_OFFSET UNITYSDK_OFFSET(0x1D82FB90)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D_ENSURE_OFFSET UNITYSDK_OFFSET(0x1D82F880)
#define PIPELINECAMERA_CAMERADEBUGDRAWPOINTS2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D82FFE0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraDebugDrawPoints2D_TypeDefinitionIndex = 37612;
