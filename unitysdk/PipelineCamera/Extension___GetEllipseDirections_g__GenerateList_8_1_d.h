...
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1DC2F500)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DC2F640)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DC2F5B0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1DC2F6C0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1DC2F610)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1DC2F5C0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1DC2F4F0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__GENERATELIST_8_1_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2F4D0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___GetEllipseDirections_g__GenerateList_8_1_d_TypeDefinitionIndex = 37576;

	class Extension___GetEllipseDirections_g__GenerateList_8_1_d : public ::System::Object
	{
	public:
		::System::Int32 __l__initialThreadId; // 0x10
		::System::Single _step_5__2; // 0x14
		::System::Int32 __1__state; // 0x18
		::System::Single _current_5__3; // 0x1C
		::System::Int32 __3__segment; // 0x20
