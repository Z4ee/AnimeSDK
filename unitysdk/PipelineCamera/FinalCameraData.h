...
#define PIPELINECAMERA_FINALCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA38A90)
#define PIPELINECAMERA_FINALCAMERADATA_CHECKLOCATION_OFFSET UNITYSDK_OFFSET(0xA38A10)
#define PIPELINECAMERA_FINALCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0xA38A50)
#define PIPELINECAMERA_FINALCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1DC2FA00)
#define PIPELINECAMERA_FINALCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x9F06F0)
#define PIPELINECAMERA_FINALCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0x388220)
#define PIPELINECAMERA_FINALCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x417280)
#define PIPELINECAMERA_FINALCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA38960)
#define PIPELINECAMERA_FINALCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0xA387D0)
#define PIPELINECAMERA_FINALCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0xA38860)

namespace PipelineCamera
{
	inline static constexpr unsigned int FinalCameraData_TypeDefinitionIndex = 37597;
