...
#define PIPELINECAMERA_SERIALIZABLETYPECLASS_GETTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1D8B9D70)
#define PIPELINECAMERA_SERIALIZABLETYPECLASS_SETTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1D8B9E60)
#define PIPELINECAMERA_SERIALIZABLETYPECLASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8B9EE0)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableTypeClass_TypeDefinitionIndex = 37704;
