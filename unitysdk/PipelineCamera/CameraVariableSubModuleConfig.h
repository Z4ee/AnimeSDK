...
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x2E87C0)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x2F0420)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PROCESSCHANNELMASK_OFFSET UNITYSDK_OFFSET(0x3A4E50)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x8D7A50)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraVariableSubModuleConfig_TypeDefinitionIndex = 35931;
