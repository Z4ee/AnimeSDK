...
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x2B68B0)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x2C19D0)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG_GET_PROCESSCHANNELMASK_OFFSET UNITYSDK_OFFSET(0x3EA3D0)
#define PIPELINECAMERA_CAMERAVARIABLESUBMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x980160)

namespace PipelineCamera
{
	inline static constexpr unsigned int CameraVariableSubModuleConfig_TypeDefinitionIndex = 37539;
