...
#define PIPELINECAMERA_CRITICALSPRINGDAMPER_GET_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x9403F0)
#define PIPELINECAMERA_CRITICALSPRINGDAMPER_PIPELINECAMERA_IVELOCITYBASEDDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x940450)
#define PIPELINECAMERA_CRITICALSPRINGDAMPER_PROCESS_OFFSET UNITYSDK_OFFSET(0x940440)
#define PIPELINECAMERA_CRITICALSPRINGDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x2E7CE0)

namespace PipelineCamera
{
	inline static constexpr unsigned int CriticalSpringDamper_TypeDefinitionIndex = 36051;
