...
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE_INVOKE_OFFSET UNITYSDK_OFFSET(0x985200)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE__INVOKE_G__UPDATEASCURRENT_2_0_OFFSET UNITYSDK_OFFSET(0x1C857CA0)
#define PIPELINECAMERA_WORLDBASICCAMERADELTADATA_LOCKSOURCECORESPACE__INVOKE_G__UPDATEASSOURCE_2_1_OFFSET UNITYSDK_OFFSET(0x1C857760)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraDeltaData_LockSourceCoreSpace_TypeDefinitionIndex = 37608;
