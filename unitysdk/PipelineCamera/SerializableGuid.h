...
#define PIPELINECAMERA_SERIALIZABLEGUID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA8BC00)
#define PIPELINECAMERA_SERIALIZABLEGUID_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x9DA9E0)
#define PIPELINECAMERA_SERIALIZABLEGUID_ISEMPTY_OFFSET UNITYSDK_OFFSET(0xA8BC60)
#define PIPELINECAMERA_SERIALIZABLEGUID_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1F0583A0)
#define PIPELINECAMERA_SERIALIZABLEGUID_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1F058340)
#define PIPELINECAMERA_SERIALIZABLEGUID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA8BB90)
#define PIPELINECAMERA_SERIALIZABLEGUID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA8BB50)
#define PIPELINECAMERA_SERIALIZABLEGUID___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA8BD50)

namespace PipelineCamera
{
	inline static constexpr unsigned int SerializableGuid_TypeDefinitionIndex = 38357;
