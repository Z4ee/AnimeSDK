...
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKALL_OFFSET UNITYSDK_OFFSET(0xA3FC30)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA3FBF0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKOFFSET_OFFSET UNITYSDK_OFFSET(0xA3FBB0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0xA3FAF0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKRADIUS_OFFSET UNITYSDK_OFFSET(0xA3FB70)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CHECKROTATION_OFFSET UNITYSDK_OFFSET(0xA3FB30)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1E88C050)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0xA3FAD0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x5ED190)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_LOCATION_OFFSET UNITYSDK_OFFSET(0xA3F750)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x3D1A20)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x34AF10)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0xA3F7B0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x4963E0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_INTERPTO_OFFSET UNITYSDK_OFFSET(0x1E88CBF0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETCAMERATOPIVOTINTERNAL_OFFSET UNITYSDK_OFFSET(0xA3FAC0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0xA3F900)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETLOCATION_OFFSET UNITYSDK_OFFSET(0xA3F7C0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0xA3FA70)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETPIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0xA3F9B0)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETRADIUS_OFFSET UNITYSDK_OFFSET(0xA3FA10)
#define PIPELINECAMERA_WORLDBASICCAMERADATA_SETROTATION_OFFSET UNITYSDK_OFFSET(0xA3F840)
#define PIPELINECAMERA_WORLDBASICCAMERADATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E88D470)

namespace PipelineCamera
{
	inline static constexpr unsigned int WorldBasicCameraData_TypeDefinitionIndex = 38261;

	struct alignas(4) WorldBasicCameraData
	{
		static ::PipelineCamera::WorldBasicCameraData* StaticGet_Fallback()
		{
			return (::PipelineCamera::WorldBasicCameraData*)Il2CppClass::FromTypeDefinitionIndex(WorldBasicCameraData_TypeDefinitionIndex)->GetStaticField(0x8CA0);
		}
