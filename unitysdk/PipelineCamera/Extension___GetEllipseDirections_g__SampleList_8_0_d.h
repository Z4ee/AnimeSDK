...
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1D8B8920)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D8B8B70)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8B8AE0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1D8B8C00)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1D8B8B40)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1D8B8AF0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1D8B8910)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8B88F0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___GetEllipseDirections_g__SampleList_8_0_d_TypeDefinitionIndex = 37575;
	...
	public:
		...
		::System::Int32 __3__step; // 0x30
		::System::Int32 _total_5__2; // 0x34
		::System::Int32 step; // 0x38
		::UnityEngine::Vector2 __2__current; // 0x3C
		::System::Int32 _current_5__3; // 0x44
