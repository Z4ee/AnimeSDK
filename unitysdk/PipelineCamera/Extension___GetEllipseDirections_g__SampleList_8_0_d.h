...
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1EC131D0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_VECTOR2__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EC13410)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_VECTOR2__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EC13380)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1EC134A0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1EC133E0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1EC13390)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1EC131C0)
#define PIPELINECAMERA_EXTENSION___GETELLIPSEDIRECTIONS_G__SAMPLELIST_8_0_D__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC131A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Extension___GetEllipseDirections_g__SampleList_8_0_d_TypeDefinitionIndex = 38236;

	class Extension___GetEllipseDirections_g__SampleList_8_0_d : public ::System::Object
	{
	public:
		::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::Vector2>* __3__list; // 0x10
		::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::Vector2>* list; // 0x18
		::System::Int32 __3__start; // 0x20
		::System::Int32 __3__step; // 0x24
		::System::Int32 step; // 0x28
		::System::Int32 start; // 0x2C
		::System::Int32 _current_5__3; // 0x30
		::UnityEngine::Vector2 __2__current; // 0x34
