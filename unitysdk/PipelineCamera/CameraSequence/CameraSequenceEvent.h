...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD46380)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CONVERTTO_1_OFFSET UNITYSDK_OFFSET(0x1DD462E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x1DD46270)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_LINK_OFFSET UNITYSDK_OFFSET(0x1DD46030)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT_ONLINKTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1DD46170)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD46590)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENT___BASE_LINK_OFFSET UNITYSDK_OFFSET(0x1DD465D0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEvent_TypeDefinitionIndex = 37828;
