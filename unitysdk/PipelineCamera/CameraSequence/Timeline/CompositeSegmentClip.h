...
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_COMPOSITESEGMENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E88D480)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_COMPOSITESEGMENTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E88D570)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_COMPOSITESEGMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E88D580)

namespace PipelineCamera::CameraSequence::Timeline
{
	inline static constexpr unsigned int CompositeSegmentClip_TypeDefinitionIndex = 90485;
