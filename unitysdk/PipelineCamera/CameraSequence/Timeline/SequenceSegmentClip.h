...
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_SEQUENCESEGMENTCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1E88DB20)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_SEQUENCESEGMENTCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1E88DC10)
#define PIPELINECAMERA_CAMERASEQUENCE_TIMELINE_SEQUENCESEGMENTCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1E88DC20)

namespace PipelineCamera::CameraSequence::Timeline
{
	inline static constexpr unsigned int SequenceSegmentClip_TypeDefinitionIndex = 90494;
