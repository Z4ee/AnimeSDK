...
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1D876660)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_FETCH_CURVE_OFFSET UNITYSDK_OFFSET(0x1D876800)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1D876460)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1D8765B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1D8765C0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1D876900)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8768B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1D876960)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_CURVE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1D876A50)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AlphaGeneratorPolicy_Curve_TypeDefinitionIndex = 37884;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Curve_TypeDefinitionIndex)->GetStaticField(0x8CF0);
		}
