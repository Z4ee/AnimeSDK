...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_EXPIREAT_OFFSET UNITYSDK_OFFSET(0x1EBC68E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x70CD30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x259D70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x66AB70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x82B230)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x324D50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0xA5E7D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_TRIGGERAT_OFFSET UNITYSDK_OFFSET(0x1EBC6700)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventOperation_TypeDefinitionIndex = 38495;
