...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_EXPIREAT_OFFSET UNITYSDK_OFFSET(0x1B484D80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x770220)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x228FE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x58C170)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_OPERATIONTYPE_OFFSET UNITYSDK_OFFSET(0x787C70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_SEQUENCEEVENT_OFFSET UNITYSDK_OFFSET(0x2E5940)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x96C160)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTOPERATION_TRIGGERAT_OFFSET UNITYSDK_OFFSET(0x1B484BA0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventOperation_TypeDefinitionIndex = 36226;
