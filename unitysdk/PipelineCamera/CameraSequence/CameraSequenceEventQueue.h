...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDNOTIFYTRIGGEREVENT_OFFSET UNITYSDK_OFFSET(0x189D9110)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDSTATEBEGINEVENT_OFFSET UNITYSDK_OFFSET(0x189D8FD0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDSTATEENDEVENT_OFFSET UNITYSDK_OFFSET(0x189D9070)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_ADDSTATETICKEVENT_OFFSET UNITYSDK_OFFSET(0x189D91B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_CONSUMEACTIVESTATES_OFFSET UNITYSDK_OFFSET(0x189D5EF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_HANDLEEXPIREOPERATION_OFFSET UNITYSDK_OFFSET(0x189D8AA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_HANDLETRIGGEROPERATION_OFFSET UNITYSDK_OFFSET(0x189D8C20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_INVOKE_OFFSET UNITYSDK_OFFSET(0x189D8810)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE_UPDATE_OFFSET UNITYSDK_OFFSET(0x189D4490)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE__CTOR_OFFSET UNITYSDK_OFFSET(0x189D8620)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventQueue_TypeDefinitionIndex = 36229;
