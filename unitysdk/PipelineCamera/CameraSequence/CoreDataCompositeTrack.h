...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATACOMPOSITETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE1FDF0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataCompositeTrack_TypeDefinitionIndex = 37876;
