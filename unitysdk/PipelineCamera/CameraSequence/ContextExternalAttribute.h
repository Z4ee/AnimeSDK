...
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTEXTERNALATTRIBUTE_GET_ISROOT_OFFSET UNITYSDK_OFFSET(0x1F32A900)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTEXTERNALATTRIBUTE_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1F32A8F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTEXTERNALATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1F32A920)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTEXTERNALATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1F32A930)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTEXTERNALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F32A910)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ContextExternalAttribute_TypeDefinitionIndex = 38594;
