...
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1DC2E6F0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DC2E1D0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1DC2E130)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DC2E330)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1DC2E0E0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1DC2E1C0)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1DC2E180)
#define PIPELINECAMERA_CAMERASEQUENCE_MOVEBYBLENDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1DC2E760)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int MoveByBlending_TypeDefinitionIndex = 37976;
