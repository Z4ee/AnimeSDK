...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_CREATE_OFFSET UNITYSDK_OFFSET(0x1B9B6A20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_GETINVERSED_OFFSET UNITYSDK_OFFSET(0x99ACA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_ISIDENTITY_OFFSET UNITYSDK_OFFSET(0x99AC20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B9B6C80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_TRANSFORMTIMEINTERVAL_OFFSET UNITYSDK_OFFSET(0x99AD20)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM_TRANSFORMTIME_OFFSET UNITYSDK_OFFSET(0x99ACB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B9B70E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCETIMETRANSFORM__TRANSFORMTIMEINTERVAL_G__TRANSFORMBOUND_8_0_OFFSET UNITYSDK_OFFSET(0x1B9B6F50)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceTimeTransform_TypeDefinitionIndex = 36261;
	...
	struct alignas(4) CameraSequenceTimeTransform
	{
		...
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceTimeTransform*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceTimeTransform_TypeDefinitionIndex)->GetStaticField(0x87A0);
		}
