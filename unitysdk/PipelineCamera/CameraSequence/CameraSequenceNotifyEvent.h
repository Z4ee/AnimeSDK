...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1B505480)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1B505430)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1B5054D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1B505320)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1B505300)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B505920)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1B5053E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B5054E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B505CB0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyEvent_TypeDefinitionIndex = 36221;
