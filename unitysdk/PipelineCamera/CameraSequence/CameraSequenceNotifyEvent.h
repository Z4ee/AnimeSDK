...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1D8B7B00)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1D8B7AB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1D8B7B50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1D8B79A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1D8B7980)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1D8B7FA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1D8B7A60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1D8B7B60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D8B8330)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyEvent_TypeDefinitionIndex = 37829;
