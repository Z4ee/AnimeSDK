...
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B4CB8A0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1B4CBA40)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B4CBBA0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_FETCH_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B4CBAF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B4CBC50)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B4CBF40)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1B4CB800)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4CBF70)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CBF50)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B4CC020)
#define PIPELINECAMERA_CAMERASEQUENCE_FIXEDFRAMEPIVOTDATAINCORE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1B4CC110)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FixedFramePivotDataInCore_TypeDefinitionIndex = 36363;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8850);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_fieldOfView()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8858);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_offset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FixedFramePivotDataInCore_TypeDefinitionIndex)->GetStaticField(0x8860);
		}
