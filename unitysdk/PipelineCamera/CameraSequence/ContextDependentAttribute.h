...
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE_GET_ISROOT_OFFSET UNITYSDK_OFFSET(0x1E1F3E70)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1E1F3E60)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E1F3E90)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1E1F3EA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F3E80)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ContextDependentAttribute_TypeDefinitionIndex = 37932;
