...
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE_GET_ISROOT_OFFSET UNITYSDK_OFFSET(0x1BEAE360)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1BEAE350)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1BEAE380)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1BEAE390)
#define PIPELINECAMERA_CAMERASEQUENCE_CONTEXTDEPENDENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAE370)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ContextDependentAttribute_TypeDefinitionIndex = 36324;
