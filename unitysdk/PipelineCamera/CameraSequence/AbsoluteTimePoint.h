...
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1EED0270)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1EECFF30)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1EECFEC0)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1EECFEB0)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1EECFE30)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_ONTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1EECFED0)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1EED0050)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1EED0120)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1EECFE40)
#define PIPELINECAMERA_CAMERASEQUENCE_ABSOLUTETIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EED02B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AbsoluteTimePoint_TypeDefinitionIndex = 38505;
