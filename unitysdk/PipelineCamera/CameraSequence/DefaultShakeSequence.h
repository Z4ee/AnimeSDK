...
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1C113B30)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x1C111760)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1C112060)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETFORWARDTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C1110D0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETPITCHTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C1111B0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1C111FC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRIGHTTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C111110)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETROLLTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C111260)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C1121C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1C111F70)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C1112C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETUPTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C111160)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETYAWTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1C111200)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1C112050)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISFORWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x1C110E90)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISPITCHACTIVE_OFFSET UNITYSDK_OFFSET(0x1C110FB0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISRIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1C110EF0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISROLLACTIVE_OFFSET UNITYSDK_OFFSET(0x1C111070)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISUPACTIVE_OFFSET UNITYSDK_OFFSET(0x1C110F50)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISYAWACTIVE_OFFSET UNITYSDK_OFFSET(0x1C111010)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1C112010)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_PROCESSTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x1C111C90)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1C113BA0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DefaultShakeSequence_TypeDefinitionIndex = 38642;
