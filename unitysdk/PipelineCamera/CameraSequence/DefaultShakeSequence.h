...
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1ABCB270)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x1ABC8EC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1ABC97C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETFORWARDTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC8830)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETPITCHTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC8910)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1ABC9720)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETRIGHTTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC8870)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETROLLTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC89C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ABC9920)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1ABC96D0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC8A20)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETUPTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC88C0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GETYAWTIMEATTENUATIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC8960)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1ABC97B0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISFORWARDACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABC85F0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISPITCHACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABC8710)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISRIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABC8650)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISROLLACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABC87D0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISUPACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABC86B0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_GET_ISYAWACTIVE_OFFSET UNITYSDK_OFFSET(0x1ABC8770)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1ABC9770)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE_PROCESSTIMEATTENUATION_OFFSET UNITYSDK_OFFSET(0x1ABC93E0)
#define PIPELINECAMERA_CAMERASEQUENCE_DEFAULTSHAKESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCB2E0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DefaultShakeSequence_TypeDefinitionIndex = 37981;
