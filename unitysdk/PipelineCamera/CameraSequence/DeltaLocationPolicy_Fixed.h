...
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1BABC2B0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_FETCH_OFFSET_OFFSET UNITYSDK_OFFSET(0x1BABC450)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_GETDATA_OFFSET UNITYSDK_OFFSET(0x1BABC090)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_GET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0x1BABBF40)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1BABC200)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_GET_RIGHTOFFSET_OFFSET UNITYSDK_OFFSET(0x1BABBFB0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_GET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0x1BABC020)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_SETPATH_OFFSET UNITYSDK_OFFSET(0x1BABC210)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_SET_FORWARDOFFSET_OFFSET UNITYSDK_OFFSET(0x1BABBF50)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_SET_RIGHTOFFSET_OFFSET UNITYSDK_OFFSET(0x1BABBFC0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED_SET_UPOFFSET_OFFSET UNITYSDK_OFFSET(0x1BABC030)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BABC580)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED__CTOR_OFFSET UNITYSDK_OFFSET(0x1BABC560)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1BABC5E0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTALOCATIONPOLICY_FIXED___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1BABC6D0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DeltaLocationPolicy_Fixed_TypeDefinitionIndex = 36285;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(DeltaLocationPolicy_Fixed_TypeDefinitionIndex)->GetStaticField(0x8520);
		}
