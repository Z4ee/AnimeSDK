...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DAC7720)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DAC7790)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_FETCH_ONNOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1DAC78F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_FETCH_ONNOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1DAC7A50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_FETCH_ONNOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1DAC79A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1DAC7370)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1DAC73B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1DAC73C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1DAC7620)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1DAC74C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DAC7B50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1DAC7B00)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex = 37891;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex)->GetStaticField(0x8B40);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_OnNotifyBegin()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex)->GetStaticField(0x8B48);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_OnNotifyTick()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex)->GetStaticField(0x8B50);
		}
