...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B6C4720)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B6C4790)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_FETCH_ONNOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1B6C48F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_FETCH_ONNOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1B6C4A50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_FETCH_ONNOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1B6C49A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1B6C4370)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B6C43B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_RECEIVENOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1B6C43C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_RECEIVENOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1B6C4620)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT_RECEIVENOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1B6C44C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6C4B50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESTATEEVENT_TRIGGEREXTERNALEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C4B00)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex = 36283;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex)->GetStaticField(0x8680);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_OnNotifyBegin()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex)->GetStaticField(0x8688);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_OnNotifyEnd()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceStateEvent_TriggerExternalEvent_TypeDefinitionIndex)->GetStaticField(0x8690);
		}
