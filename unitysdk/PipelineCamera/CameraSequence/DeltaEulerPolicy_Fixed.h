...
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD3FBD0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_FETCH_OFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3FD70)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GETDATA_OFFSET UNITYSDK_OFFSET(0x1DD3F9B0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1DD3FB20)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_PITCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3F800)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_ROLLOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3F920)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_GET_YAWOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3F890)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SETPATH_OFFSET UNITYSDK_OFFSET(0x1DD3FB30)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SET_PITCHOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3F810)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SET_ROLLOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3F930)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED_SET_YAWOFFSET_OFFSET UNITYSDK_OFFSET(0x1DD3F8A0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD3FEA0)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD3FE80)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD3FF00)
#define PIPELINECAMERA_CAMERASEQUENCE_DELTAEULERPOLICY_FIXED___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1DD3FFF0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int DeltaEulerPolicy_Fixed_TypeDefinitionIndex = 37892;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(DeltaEulerPolicy_Fixed_TypeDefinitionIndex)->GetStaticField(0x8C70);
		}
