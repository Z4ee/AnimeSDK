...
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1B4857F0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B485830)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1B485780)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x1B4856F0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1B485770)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_ONTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1B485790)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B485930)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1B4859E0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x1B485700)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B485B60)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ProportionalTimePoint_TypeDefinitionIndex = 36238;
