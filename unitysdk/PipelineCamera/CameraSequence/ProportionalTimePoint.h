...
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1EBC7350)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1EBC7390)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1EBC72E0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_RATIO_OFFSET UNITYSDK_OFFSET(0x1EBC7250)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1EBC72D0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_ONTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x1EBC72F0)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1EBC7490)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1EBC7540)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT_SET_RATIO_OFFSET UNITYSDK_OFFSET(0x1EBC7260)
#define PIPELINECAMERA_CAMERASEQUENCE_PROPORTIONALTIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBC76C0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int ProportionalTimePoint_TypeDefinitionIndex = 38507;
