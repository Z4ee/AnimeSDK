...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1D4CD0F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1D4CD0A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_BEGINOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1D4CCE80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_BEGINTIME_OFFSET UNITYSDK_OFFSET(0x1D4CCE10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1D4CD160)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_ENDOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1D4CCF90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x1D4CCE30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYBEGIN_OFFSET UNITYSDK_OFFSET(0x1D4CDC50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYEND_OFFSET UNITYSDK_OFFSET(0x1D4CE380)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_NOTIFYTICK_OFFSET UNITYSDK_OFFSET(0x1D4CDFE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_SET_BEGINOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1D4CCF40)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_SET_ENDOFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1D4CD050)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1D4CD170)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCENOTIFYSTATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1D4CE710)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceNotifyStateEvent_TypeDefinitionIndex = 37831;
