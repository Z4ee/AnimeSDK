...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1F236190)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_FETCH_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1F236330)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F2359F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1F235AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1F235F20)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1F2360F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F236010)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1F235F30)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F236460)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F236440)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1F2364F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1F2365E0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex = 38559;
	...
	public:
		...
		{
			return (::System::Func_3<::PipelineCamera::WorldBasicCameraData, ::UnityEngine::Vector3, ::PipelineCamera::WorldBasicCameraData>**)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x2A4D0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_LastCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8B10);
		}
