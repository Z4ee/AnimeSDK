...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DE22A20)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_FETCH_LASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0x1DE22BC0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DE22280)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GETDATA_OFFSET UNITYSDK_OFFSET(0x1DE22380)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1DE227B0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1DE22980)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DE228A0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1DE227C0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DE22CF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DE22CD0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DE22D80)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINCOREPOLICY_FREEZE___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1DE22E70)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex = 37898;
	...
	public:
		...
		{
			return (::System::Func_3<::PipelineCamera::WorldBasicCameraData, ::UnityEngine::Vector3, ::PipelineCamera::WorldBasicCameraData>**)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x28BB0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_LastCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_Freeze_TypeDefinitionIndex)->GetStaticField(0x8A20);
		}
