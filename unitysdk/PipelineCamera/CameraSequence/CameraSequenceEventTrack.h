...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_COLLECTEVENTS_OFFSET UNITYSDK_OFFSET(0x1E1F3690)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1E1F3290)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_LINK_OFFSET UNITYSDK_OFFSET(0x1E1F3570)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_ONTRACKCHANGED_OFFSET UNITYSDK_OFFSET(0x1E1F3460)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK_SORTEVENTS_OFFSET UNITYSDK_OFFSET(0x1E1F32A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F39F0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventTrack_TypeDefinitionIndex = 37835;
