...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_CLEARENVIRONMENT_OFFSET UNITYSDK_OFFSET(0x1E1F2FC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_ENSUREWORKSPACEID_OFFSET UNITYSDK_OFFSET(0x1E1F2A40)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETBLENDINSETTING_OFFSET UNITYSDK_OFFSET(0x1E1F3180)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETBLENDOUTSETTING_OFFSET UNITYSDK_OFFSET(0x1E1F31D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETINTERNALENVIRONMENT_OFFSET UNITYSDK_OFFSET(0x1E1F2C50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_GETINTERNALIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1E1F2BC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_ISSHAREDCONTEXT_OFFSET UNITYSDK_OFFSET(0x1E1F2B80)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACE_1_OFFSET UNITYSDK_OFFSET(0x1E1F2E70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACE_OFFSET UNITYSDK_OFFSET(0x1E1F2CC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SETBINDINGRESOLVER_OFFSET UNITYSDK_OFFSET(0x1E1F3130)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F2650)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceContext_TypeDefinitionIndex = 37938;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::PipelineCamera::CameraSequence::CameraSequenceEnvironmentPath, ::System::Int32>* _cachedWorkspaceId; // 0x50
