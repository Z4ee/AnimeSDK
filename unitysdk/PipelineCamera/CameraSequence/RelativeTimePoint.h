...
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1BEAE8B0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GETTIME_OFFSET UNITYSDK_OFFSET(0x1BEAE9C0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GET_PLAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1BEAE8A0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GET_RELATIVETIME_OFFSET UNITYSDK_OFFSET(0x1BEAE810)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1BEAE890)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_SETSEGMENT_OFFSET UNITYSDK_OFFSET(0x1BEAE8F0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_SETTIME_OFFSET UNITYSDK_OFFSET(0x1BEAEAE0)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT_SET_RELATIVETIME_OFFSET UNITYSDK_OFFSET(0x1BEAE820)
#define PIPELINECAMERA_CAMERASEQUENCE_RELATIVETIMEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1BEAEC00)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RelativeTimePoint_TypeDefinitionIndex = 36237;
