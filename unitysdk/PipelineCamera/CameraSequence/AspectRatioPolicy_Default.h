...
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1EC2A0F0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_FETCH_ASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x1EC2A290)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GETASPECTRATIOINTERNAL_OFFSET UNITYSDK_OFFSET(0x1EC29EE0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GETDATA_OFFSET UNITYSDK_OFFSET(0x1EC29FD0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1EC2A040)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT_SETPATH_OFFSET UNITYSDK_OFFSET(0x1EC2A050)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC2A350)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC2A340)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1EC2A3B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ASPECTRATIOPOLICY_DEFAULT___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1EC2A4A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AspectRatioPolicy_Default_TypeDefinitionIndex = 38550;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AspectRatioPolicy_Default_TypeDefinitionIndex)->GetStaticField(0x8DF0);
		}
