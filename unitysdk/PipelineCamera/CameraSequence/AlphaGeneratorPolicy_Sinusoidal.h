...
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1BBD3630)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_BIAS_OFFSET UNITYSDK_OFFSET(0x1BBD3930)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_PERIOD_OFFSET UNITYSDK_OFFSET(0x1BBD37D0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_FETCH_PHASE_OFFSET UNITYSDK_OFFSET(0x1BBD3880)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_GETDATA_OFFSET UNITYSDK_OFFSET(0x1BBD2EB0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1BBD3580)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL_SETPATH_OFFSET UNITYSDK_OFFSET(0x1BBD3590)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1BBD39F0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1BBD39E0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1BBD3AA0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SINUSOIDAL___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1BBD3B90)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex = 36277;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x88A0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_bias()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x88A8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_period()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Sinusoidal_TypeDefinitionIndex)->GetStaticField(0x88B0);
		}
