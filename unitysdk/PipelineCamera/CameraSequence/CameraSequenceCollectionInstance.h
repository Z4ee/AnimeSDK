...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1ABC6B30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_COLLECTEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ABC3670)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEDELTATIME_OFFSET UNITYSDK_OFFSET(0x1ABC48E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEONINTERRUPT_OFFSET UNITYSDK_OFFSET(0x1ABC54C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_CONSUMEONSTOP_OFFSET UNITYSDK_OFFSET(0x1ABC5510)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETCURRENTSECTION_OFFSET UNITYSDK_OFFSET(0x1ABC6450)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETINSTANCEID_OFFSET UNITYSDK_OFFSET(0x1ABC62B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC68C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTIONNAME_OFFSET UNITYSDK_OFFSET(0x1ABC6940)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETNEXTSECTION_OFFSET UNITYSDK_OFFSET(0x1ABC6670)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETPLAYRATE_OFFSET UNITYSDK_OFFSET(0x1ABC6340)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1ABC62F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1ABC32F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1ABC58B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABC55E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1ABC6220)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISSTOPPED_OFFSET UNITYSDK_OFFSET(0x1ABC5220)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1ABC3610)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_JUMPTOSECTION_1_OFFSET UNITYSDK_OFFSET(0x1ABC5DA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_JUMPTOSECTION_OFFSET UNITYSDK_OFFSET(0x1ABC5A30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PAUSE_OFFSET UNITYSDK_OFFSET(0x1ABC5560)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PLAY_1_OFFSET UNITYSDK_OFFSET(0x1ABC4B30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_PLAY_OFFSET UNITYSDK_OFFSET(0x1ABC49D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_REBUILDSECTIONGRAPH_OFFSET UNITYSDK_OFFSET(0x1ABC3300)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_RESUME_OFFSET UNITYSDK_OFFSET(0x1ABC55A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONBYID_OFFSET UNITYSDK_OFFSET(0x1ABC60C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONBYNAME_OFFSET UNITYSDK_OFFSET(0x1ABC5EE0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETNEXTSECTIONGRAPH_OFFSET UNITYSDK_OFFSET(0x1ABC6180)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETONSTOPPED_OFFSET UNITYSDK_OFFSET(0x1ABC4CB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETPLAYRATE_OFFSET UNITYSDK_OFFSET(0x1ABC63F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1ABC6390)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_SETTIMESCALE_OFFSET UNITYSDK_OFFSET(0x1ABC4D10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STEPOVERSECTION_OFFSET UNITYSDK_OFFSET(0x1ABC4480)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STOP_1_OFFSET UNITYSDK_OFFSET(0x1ABC4EA0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE_STOP_OFFSET UNITYSDK_OFFSET(0x1ABC4D60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__ADVANCE_B__57_0_OFFSET UNITYSDK_OFFSET(0x1ABC7B60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABC7B00)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC7900)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionInstance_TypeDefinitionIndex = 37803;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceCollectionInstance_TypeDefinitionIndex)->GetStaticField(0x8AF0);
		}
		static ::System::Int32* StaticGet__instanceCounter()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceCollectionInstance_TypeDefinitionIndex)->GetStaticField(0x8AF8);
		}
		// static const ::System::Int32 MaxStepsPerFrame = 0x10; // 0x0
		// static const ::System::String* SequencePlayerContextName; // 0x0
		::PipelineCamera::CameraSequence::ICameraSequenceCollection* _collection; // 0x10
