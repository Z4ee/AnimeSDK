...
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1B9B9750)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B9B97C0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_FETCH_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1B9B9920)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1B9B9A90)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B9B9B30)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1B9B9A40)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B9B9B20)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1B9B9AE0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B9BA170)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9BA0B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int VariableSequence_TypeDefinitionIndex = 36366;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(VariableSequence_TypeDefinitionIndex)->GetStaticField(0x87E0);
		}
