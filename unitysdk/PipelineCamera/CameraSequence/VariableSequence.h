...
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1DD41680)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD416F0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_FETCH_VARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD41850)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1DD419C0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1DD41A60)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1DD41970)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1DD41A50)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1DD41A10)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD420A0)
#define PIPELINECAMERA_CAMERASEQUENCE_VARIABLESEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD41FE0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int VariableSequence_TypeDefinitionIndex = 37974;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(VariableSequence_TypeDefinitionIndex)->GetStaticField(0x8CA0);
		}
