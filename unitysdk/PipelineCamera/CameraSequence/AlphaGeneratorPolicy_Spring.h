...
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B483830)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_FETCH_DAMPING_OFFSET UNITYSDK_OFFSET(0x1B4839D0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_FETCH_INITIALSPEED_OFFSET UNITYSDK_OFFSET(0x1B483A80)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_FETCH_STIFFNESS_OFFSET UNITYSDK_OFFSET(0x1B483B30)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B482D10)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B483780)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING_SETPATH_OFFSET UNITYSDK_OFFSET(0x1B483790)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B483C00)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B483BE0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B483CB0)
#define PIPELINECAMERA_CAMERASEQUENCE_ALPHAGENERATORPOLICY_SPRING___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1B483DA0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int AlphaGeneratorPolicy_Spring_TypeDefinitionIndex = 36279;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Spring_TypeDefinitionIndex)->GetStaticField(0x8740);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_damping()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Spring_TypeDefinitionIndex)->GetStaticField(0x8748);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_initialSpeed()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(AlphaGeneratorPolicy_Spring_TypeDefinitionIndex)->GetStaticField(0x8750);
		}
