...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_BUILDDATAPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E1F3B40)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_COLLECTVARIABLEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1E1F3BB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x1E1F3AF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1E1F3B30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION_RECEIVENOTIFY_OFFSET UNITYSDK_OFFSET(0x1E1F3D10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALEVENT_JUMPTOSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F3DF0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceInternalEvent_JumpToSection_TypeDefinitionIndex = 37975;
