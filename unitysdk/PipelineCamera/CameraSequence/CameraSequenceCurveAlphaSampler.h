...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_CHECKEXTERNALVARIABLES_OFFSET UNITYSDK_OFFSET(0x1DD3E640)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD3E710)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1DD3E520)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_GETEXTERNALVARIABLES_OFFSET UNITYSDK_OFFSET(0x1DD3E5F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1DD3E700)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER_SETPATH_OFFSET UNITYSDK_OFFSET(0x1DD3E6A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD3E780)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1DD3E7D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECURVEALPHASAMPLER___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1DD3E8C0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCurveAlphaSampler_TypeDefinitionIndex = 37859;
