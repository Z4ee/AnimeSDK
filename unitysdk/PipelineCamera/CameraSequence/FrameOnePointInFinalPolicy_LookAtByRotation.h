...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B4CE1F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_FETCH_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1B4CE390)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B4CDA60)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B4CE140)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_SETPATH_OFFSET UNITYSDK_OFFSET(0x1B4CE150)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4CE490)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CE440)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1B4CE4F0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1B4CE5E0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex = 36291;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex)->GetStaticField(0x8890);
		}
