...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1EC2D720)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_FETCH_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1EC2D8C0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GETDATA_OFFSET UNITYSDK_OFFSET(0x1EC2CFF0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1EC2D670)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION_SETPATH_OFFSET UNITYSDK_OFFSET(0x1EC2D680)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EC2D9C0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1EC2D970)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1EC2DA20)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEONEPOINTINFINALPOLICY_LOOKATBYROTATION___BASE_SETPATH_OFFSET UNITYSDK_OFFSET(0x1EC2DB10)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex = 38560;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInFinalPolicy_LookAtByRotation_TypeDefinitionIndex)->GetStaticField(0x8E40);
		}
