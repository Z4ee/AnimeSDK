...
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1F055910)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1F055980)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_FETCH_ACTIVECHANNEL_OFFSET UNITYSDK_OFFSET(0x1F055B90)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_FETCH_RESAMPLEEACHTIME_OFFSET UNITYSDK_OFFSET(0x1F055AE0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1F055C90)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1F055D30)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1F055C40)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1F055D20)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1F055CE0)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1F056440)
#define PIPELINECAMERA_CAMERASEQUENCE_FRAMEPIVOTINCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1F0563E0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int FramePivotInCore_TypeDefinitionIndex = 38629;
	...
	public:
		...
		{
			return (::System::Func_4<::PipelineCamera::CameraSequence::FramePivotInCore_DataProvider*, ::System::Single, ::PipelineCamera::CameraSequence::CameraSequenceContext*, ::PipelineCamera::CameraSequence::FramePivotDataInCore>**)Il2CppClass::FromTypeDefinitionIndex(FramePivotInCore_TypeDefinitionIndex)->GetStaticField(0x2A690);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_resampleEachTime()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FramePivotInCore_TypeDefinitionIndex)->GetStaticField(0x8DB0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_activeChannel()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FramePivotInCore_TypeDefinitionIndex)->GetStaticField(0x8DB8);
		}
		static ::Foundation::Unreal::FName* StaticGet__cacheId()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FramePivotInCore_TypeDefinitionIndex)->GetStaticField(0x8DC0);
		}
