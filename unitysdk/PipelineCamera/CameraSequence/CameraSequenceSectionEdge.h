...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GETFROMSECTION_OFFSET UNITYSDK_OFFSET(0x1B9CCFD0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GETTOSECTION_OFFSET UNITYSDK_OFFSET(0x1B9CD110)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_FROMSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1B9CCFB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_FROMSECTION_OFFSET UNITYSDK_OFFSET(0x1B9CCC30)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_TOSECTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1B9CCFC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_GET_TOSECTION_OFFSET UNITYSDK_OFFSET(0x1B9CCE60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_LINK_OFFSET UNITYSDK_OFFSET(0x1B9CD1A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_SET_FROMSECTION_OFFSET UNITYSDK_OFFSET(0x1B9CCCC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE_SET_TOSECTION_OFFSET UNITYSDK_OFFSET(0x1B9CCEF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CD200)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCESECTIONEDGE__GETFROMSECTION_B__15_0_OFFSET UNITYSDK_OFFSET(0x1B9CD210)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceSectionEdge_TypeDefinitionIndex = 36253;
