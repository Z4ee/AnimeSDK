...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATACOLLECTIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1E9137A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataCollectionTrack_TypeDefinitionIndex = 38540;
