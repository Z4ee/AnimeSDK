...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96BEB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x96BE70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96BFB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETPOPPED_OFFSET UNITYSDK_OFFSET(0x96BDB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GETPUSHED_OFFSET UNITYSDK_OFFSET(0x96BD60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x96BCC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x96BE60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x96BE50)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_POP_OFFSET UNITYSDK_OFFSET(0x96BD90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH_PUSH_OFFSET UNITYSDK_OFFSET(0x96BCD0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4849F0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x96C0C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEENVIRONMENTPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96C050)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEnvironmentPath_TypeDefinitionIndex = 36351;
	...
	struct alignas(8) CameraSequenceEnvironmentPath
	{
		...
		{
			return (::PipelineCamera::CameraSequence::CameraSequenceEnvironmentPath*)Il2CppClass::FromTypeDefinitionIndex(CameraSequenceEnvironmentPath_TypeDefinitionIndex)->GetStaticField(0x26F60);
		}
