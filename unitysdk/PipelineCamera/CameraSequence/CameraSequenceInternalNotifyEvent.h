...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1E5C9070)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1E5C9020)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1E5C90C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1E5C8F10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1E5C8EF0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1E5C9510)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1E5C8FD0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1E5C90D0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1E5C98A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceInternalNotifyEvent_TypeDefinitionIndex = 38491;
