...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GETENDTIME_OFFSET UNITYSDK_OFFSET(0x1AE04A10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GETSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1AE049C0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1AE04A60)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1AE048B0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_GET_TRIGGERTIME_OFFSET UNITYSDK_OFFSET(0x1AE04890)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1AE04EB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_SET_TRIGGEROFFSETTYPE_OFFSET UNITYSDK_OFFSET(0x1AE04970)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1AE04A70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEINTERNALNOTIFYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE05230)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceInternalNotifyEvent_TypeDefinitionIndex = 36222;
