...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATASEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E1F42B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataSequence_TypeDefinitionIndex = 37874;
