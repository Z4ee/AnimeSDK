...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATACOMPOSITEADDITIVETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD48820)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataCompositeAdditiveTrack_TypeDefinitionIndex = 37877;
