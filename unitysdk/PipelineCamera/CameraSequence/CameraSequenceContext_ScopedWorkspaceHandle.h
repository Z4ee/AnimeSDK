...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xA5B890)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA5B830)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECONTEXT_SCOPEDWORKSPACEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0xA5B7A0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceContext_ScopedWorkspaceHandle_TypeDefinitionIndex = 37939;
