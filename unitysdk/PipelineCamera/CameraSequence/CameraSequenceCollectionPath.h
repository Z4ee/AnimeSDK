...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1B504B70)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x971020)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x970FC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x971150)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0x970F90)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_WORKSPACE_OFFSET UNITYSDK_OFFSET(0x340970)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_TOVARIABLESTRING_OFFSET UNITYSDK_OFFSET(0x970FB0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x971160)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x971200)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionPath_TypeDefinitionIndex = 36323;
