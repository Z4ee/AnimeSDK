...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1EC11AC0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA654E0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0xA65480)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA65610)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_VARIABLE_OFFSET UNITYSDK_OFFSET(0xA65450)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_GET_WORKSPACE_OFFSET UNITYSDK_OFFSET(0x3D6960)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH_TOVARIABLESTRING_OFFSET UNITYSDK_OFFSET(0xA65470)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA65620)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCECOLLECTIONPATH___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0xA656C0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceCollectionPath_TypeDefinitionIndex = 38592;
