...
#define PIPELINECAMERA_CAMERASEQUENCE_POSITIONDAMPINGPOLICY_INTERPCONSTONTTO_GETDATA_OFFSET UNITYSDK_OFFSET(0x1EBC6C80)
#define PIPELINECAMERA_CAMERASEQUENCE_POSITIONDAMPINGPOLICY_INTERPCONSTONTTO_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1EBC71C0)
#define PIPELINECAMERA_CAMERASEQUENCE_POSITIONDAMPINGPOLICY_INTERPCONSTONTTO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1EBC71F0)
#define PIPELINECAMERA_CAMERASEQUENCE_POSITIONDAMPINGPOLICY_INTERPCONSTONTTO__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBC71D0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int PositionDampingPolicy_InterpConstontTo_TypeDefinitionIndex = 38563;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(PositionDampingPolicy_InterpConstontTo_TypeDefinitionIndex)->GetStaticField(0x8D10);
		}
