...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_GETLINKTIME_OFFSET UNITYSDK_OFFSET(0x1DCCB500)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_GET_LINKTIME_OFFSET UNITYSDK_OFFSET(0x1DCCAF10)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x1DCCAF00)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_LINK_OFFSET UNITYSDK_OFFSET(0x1DCCB0A0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_SETLINKTIME_OFFSET UNITYSDK_OFFSET(0x1DCCB620)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE_SET_LINKTIME_OFFSET UNITYSDK_OFFSET(0x1DCCB020)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCELINKABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DCCB750)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceLinkable_TypeDefinitionIndex = 38502;
