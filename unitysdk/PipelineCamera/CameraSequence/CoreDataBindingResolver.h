...
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_GETCONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x1B9CD860)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_GET_CONTEXTTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1B9CD570)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_PIPELINECAMERA_CAMERASEQUENCE_ICAMERASEQUENCEBINDINGRESOLVER_RESOLVEDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B9CDBC0)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_PIPELINECAMERA_CAMERASEQUENCE_ICAMERASEQUENCEBINDINGRESOLVER_RESOLVEEXTERNAL_OFFSET UNITYSDK_OFFSET(0x1B9CDA80)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_RESOLVEDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1B9CD740)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_RESOLVEEXTERNAL_OFFSET UNITYSDK_OFFSET(0x1B9CD620)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER_SET_CONTEXTTYPECLASS_OFFSET UNITYSDK_OFFSET(0x1B9CD590)
#define PIPELINECAMERA_CAMERASEQUENCE_COREDATABINDINGRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B9CD8B0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CoreDataBindingResolver_TypeDefinitionIndex = 36264;
