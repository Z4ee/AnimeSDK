...
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x1C114610)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x1C114680)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_FETCH_ANGLESPEED_OFFSET UNITYSDK_OFFSET(0x1C1147E0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x1C114940)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1C1149D0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x1C1148F0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x1C114F70)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_ISLOOP_OFFSET UNITYSDK_OFFSET(0x1C114990)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C114FE0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1C114F80)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RotateEulerByFixedSpeed_TypeDefinitionIndex = 38627;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotateEulerByFixedSpeed_TypeDefinitionIndex)->GetStaticField(0x8C00);
		}
