...
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0x189DC9D0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x189DCA40)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_FETCH_ANGLESPEED_OFFSET UNITYSDK_OFFSET(0x189DCBA0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0x189DCD00)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x189DCD90)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0x189DCCB0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x189DD340)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED_ISLOOP_OFFSET UNITYSDK_OFFSET(0x189DCD50)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED__CCTOR_OFFSET UNITYSDK_OFFSET(0x189DD3B0)
#define PIPELINECAMERA_CAMERASEQUENCE_ROTATEEULERBYFIXEDSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x189DD350)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int RotateEulerByFixedSpeed_TypeDefinitionIndex = 36358;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(RotateEulerByFixedSpeed_TypeDefinitionIndex)->GetStaticField(0x8650);
		}
