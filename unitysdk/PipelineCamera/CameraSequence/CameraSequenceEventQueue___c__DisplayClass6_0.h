...
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE___C__DISPLAYCLASS6_0__CONSUMEACTIVESTATES_B__0_OFFSET UNITYSDK_OFFSET(0x1EBC6AD0)
#define PIPELINECAMERA_CAMERASEQUENCE_CAMERASEQUENCEEVENTQUEUE___C__DISPLAYCLASS6_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1EBC6AC0)

namespace PipelineCamera::CameraSequence
{
	inline static constexpr unsigned int CameraSequenceEventQueue___c__DisplayClass6_0_TypeDefinitionIndex = 38500;

	class CameraSequenceEventQueue___c__DisplayClass6_0 : public ::System::Object
	{
	public:
		::PipelineCamera::CameraSequence::CameraSequenceCollectionInstance* instance; // 0x10
		::System::Collections::Generic::Dictionary_2<::PipelineCamera::CameraSequence::CameraSequenceEnvironmentPath, ::PipelineCamera::CameraSequence::CameraSequenceEvent*>* activeStates; // 0x18
