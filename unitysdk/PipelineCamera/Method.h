...
#define PIPELINECAMERA_METHOD_ADVANCETIME_OFFSET UNITYSDK_OFFSET(0x1C855100)
#define PIPELINECAMERA_METHOD_AVERAGE_1_OFFSET UNITYSDK_OFFSET(0x1C8557F0)
#define PIPELINECAMERA_METHOD_AVERAGE_OFFSET UNITYSDK_OFFSET(0x1C8557A0)
#define PIPELINECAMERA_METHOD_CALCULATECOSANGLE_OFFSET UNITYSDK_OFFSET(0x1C856C00)
#define PIPELINECAMERA_METHOD_CLAMPRELATIVEANGLEXZ_OFFSET UNITYSDK_OFFSET(0x1C851610)
#define PIPELINECAMERA_METHOD_DOWNWARDALIGNMENT_1_OFFSET UNITYSDK_OFFSET(0x1C8556A0)
#define PIPELINECAMERA_METHOD_DOWNWARDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C855650)
#define PIPELINECAMERA_METHOD_EULERDISTANCE_OFFSET UNITYSDK_OFFSET(0x1C850460)
#define PIPELINECAMERA_METHOD_FASTATAN_OFFSET UNITYSDK_OFFSET(0x1C855580)
#define PIPELINECAMERA_METHOD_FASTNEGEXP_OFFSET UNITYSDK_OFFSET(0x1C855500)
#define PIPELINECAMERA_METHOD_GETDESIREDRADIUSBYENTITYSHAPE_OFFSET UNITYSDK_OFFSET(0x1C851A50)
#define PIPELINECAMERA_METHOD_GETNEXTLARGESTPOWERTWO_OFFSET UNITYSDK_OFFSET(0x1C8558D0)
#define PIPELINECAMERA_METHOD_GETNUMBITSET_OFFSET UNITYSDK_OFFSET(0x1C855930)
#define PIPELINECAMERA_METHOD_HALFFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1C850D80)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_1_OFFSET UNITYSDK_OFFSET(0x1C8569B0)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_2_OFFSET UNITYSDK_OFFSET(0x1C857010)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_3_OFFSET UNITYSDK_OFFSET(0x1C857320)
#define PIPELINECAMERA_METHOD_INTERPCONSTANTTO_OFFSET UNITYSDK_OFFSET(0x1C855CF0)
#define PIPELINECAMERA_METHOD_INTERPTO_1_OFFSET UNITYSDK_OFFSET(0x1C8567B0)
#define PIPELINECAMERA_METHOD_INTERPTO_2_OFFSET UNITYSDK_OFFSET(0x1C856EE0)
#define PIPELINECAMERA_METHOD_INTERPTO_3_OFFSET UNITYSDK_OFFSET(0x1C857230)
#define PIPELINECAMERA_METHOD_INTERPTO_OFFSET UNITYSDK_OFFSET(0x1C855C20)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFANGLE_OFFSET UNITYSDK_OFFSET(0x1C851B00)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFPERIODIC_OFFSET UNITYSDK_OFFSET(0x1C8537C0)
#define PIPELINECAMERA_METHOD_INTERSECTIONOFRADIAN_OFFSET UNITYSDK_OFFSET(0x1C853600)
#define PIPELINECAMERA_METHOD_LERPPERCHANNEL_OFFSET UNITYSDK_OFFSET(0x1C856E00)
#define PIPELINECAMERA_METHOD_MINMAX_1_OFFSET UNITYSDK_OFFSET(0x1C8563C0)
#define PIPELINECAMERA_METHOD_MINMAX_OFFSET UNITYSDK_OFFSET(0x1C856340)
#define PIPELINECAMERA_METHOD_OFFSETTOSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1C8512E0)
#define PIPELINECAMERA_METHOD_OFFSETTOUNIFORMSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1C851470)
#define PIPELINECAMERA_METHOD_PRINT_OFFSET UNITYSDK_OFFSET(0x1C850640)
#define PIPELINECAMERA_METHOD_RELATIVEALPHA_OFFSET UNITYSDK_OFFSET(0x1C8559D0)
#define PIPELINECAMERA_METHOD_REVERSE_OFFSET UNITYSDK_OFFSET(0x1C855850)
#define PIPELINECAMERA_METHOD_SAMPLECIRCLE_OFFSET UNITYSDK_OFFSET(0x1C8517B0)
#define PIPELINECAMERA_METHOD_SAMPLEDEFAULTRESOLVERCURVE_OFFSET UNITYSDK_OFFSET(0x1C851840)
#define PIPELINECAMERA_METHOD_SCREENALIGNEDOFFSET_OFFSET UNITYSDK_OFFSET(0x1C850920)
#define PIPELINECAMERA_METHOD_SCREENOFFSETTOOFFSET_OFFSET UNITYSDK_OFFSET(0x1C850EB0)
#define PIPELINECAMERA_METHOD_SCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1C850BC0)
#define PIPELINECAMERA_METHOD_SINCOSDEGREE_OFFSET UNITYSDK_OFFSET(0x1C855B90)
#define PIPELINECAMERA_METHOD_SINCOS_OFFSET UNITYSDK_OFFSET(0x1C855B10)
#define PIPELINECAMERA_METHOD_SINRANGE_OFFSET UNITYSDK_OFFSET(0x1C8564D0)
#define PIPELINECAMERA_METHOD_SOLVEQUADRATICEQUATION_OFFSET UNITYSDK_OFFSET(0x1C850780)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_1_OFFSET UNITYSDK_OFFSET(0x1C856080)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_2_OFFSET UNITYSDK_OFFSET(0x1C8561D0)
#define PIPELINECAMERA_METHOD_SQRTSQUARESUM_OFFSET UNITYSDK_OFFSET(0x1C855F60)
#define PIPELINECAMERA_METHOD_SQUARESUM_1_OFFSET UNITYSDK_OFFSET(0x1C855E30)
#define PIPELINECAMERA_METHOD_SQUARESUM_2_OFFSET UNITYSDK_OFFSET(0x1C855EC0)
#define PIPELINECAMERA_METHOD_SQUARESUM_OFFSET UNITYSDK_OFFSET(0x1C855DC0)
#define PIPELINECAMERA_METHOD_TANGENTHALFFIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x1C850CF0)
#define PIPELINECAMERA_METHOD_TOLOOPINTERVAL_OFFSET UNITYSDK_OFFSET(0x1C855250)
#define PIPELINECAMERA_METHOD_UNIFORMSCREENOFFSETTOOFFSET_OFFSET UNITYSDK_OFFSET(0x1C851010)
#define PIPELINECAMERA_METHOD_UNIFORMSCREENOFFSETTOSCREENOFFSET_OFFSET UNITYSDK_OFFSET(0x1C851140)
#define PIPELINECAMERA_METHOD_UPWARDALIGNMENT_1_OFFSET UNITYSDK_OFFSET(0x1C855740)
#define PIPELINECAMERA_METHOD_UPWARDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1C8556F0)
#define PIPELINECAMERA_METHOD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1C857520)
#define PIPELINECAMERA_METHOD__SAMPLECIRCLE_G__GETSINCOSENUMERABLE_38_1_OFFSET UNITYSDK_OFFSET(0x1C857610)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method_TypeDefinitionIndex = 37487;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::ValueTuple_2<::System::Single, ::System::Single>>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x28BC0);
		}
		...
		{
			return (::System::Action_5<::PipelineCamera::Method_CameraLogCategory, ::System::Boolean, ::System::String*, ::UnityEngine::Color, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x28BC8);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_ValidCircleSegments()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x28BD0);
		}
		static ::System::Single* StaticGet_Log2F()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8A30);
		}
		static ::System::Int32* StaticGet_SizeOfInt32()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8A34);
		}
		static ::System::Double* StaticGet_Log2D()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8A38);
		}
		static ::System::Int32* StaticGet_SizeOfInt64()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8A40);
		}
		static ::System::Int32* StaticGet_SizeofChar()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Method_TypeDefinitionIndex)->GetStaticField(0x8A44);
		}
