...
#define PIPELINECAMERA_METHOD___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C7890)
#define PIPELINECAMERA_METHOD___C__DISPLAYCLASS38_0__SAMPLECIRCLE_B__0_OFFSET UNITYSDK_OFFSET(0x1B6C78A0)

namespace PipelineCamera
{
	inline static constexpr unsigned int Method___c__DisplayClass38_0_TypeDefinitionIndex = 35885;
