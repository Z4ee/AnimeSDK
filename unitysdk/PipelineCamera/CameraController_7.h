...
namespace PipelineCamera { template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7> class CameraController_7; }
...
{
	inline static constexpr unsigned int CameraController_7_TypeDefinitionIndex = 37503;
	...
	public:
		...
		T4 _pipeline4; // 0x0
		T5 _pipeline5; // 0x0
		::PipelineCamera::CameraContext_2<::PipelineCamera::CameraController_7<TPlayerController, TPostPipeline, T1, T2, T3, T4, T5>*, TPlayerController>* _cameraContext; // 0x0
	};
}
