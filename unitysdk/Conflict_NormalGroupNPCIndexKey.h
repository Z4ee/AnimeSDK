...
#define CONFLICT_NORMALGROUPNPCINDEXKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x393DEA0)
#define CONFLICT_NORMALGROUPNPCINDEXKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x393DF10)
#define CONFLICT_NORMALGROUPNPCINDEXKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED5C0)

inline static constexpr unsigned int Conflict_NormalGroupNPCIndexKey_TypeDefinitionIndex = 45366;
