...
#define CLASS_1_C0781D55218EBCF6__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4A30E0)
...
public:
	...
	::Il2CppArray<::RPG::GameCore::BaseLittleGameAbilityValueGetterConfig*>* EJHODPJIFIN; // 0x20
