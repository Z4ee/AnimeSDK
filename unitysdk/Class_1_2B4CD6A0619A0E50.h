...
#define CLASS_1_2B4CD6A0619A0E50_GET_ID_OFFSET UNITYSDK_OFFSET(0x1091C2D0)
#define CLASS_1_2B4CD6A0619A0E50_METHOD_1_7C817AD0B3526BFA_OFFSET UNITYSDK_OFFSET(0x1091C280)
#define CLASS_1_2B4CD6A0619A0E50_METHOD_1_8A76897D6A693475_OFFSET UNITYSDK_OFFSET(0x1091C1B0)
#define CLASS_1_2B4CD6A0619A0E50_METHOD_1_D3B7E4F5CEA0567D_OFFSET UNITYSDK_OFFSET(0x1091C0F0)
#define CLASS_1_2B4CD6A0619A0E50_SET_ID_OFFSET UNITYSDK_OFFSET(0x1091C2E0)
#define CLASS_1_2B4CD6A0619A0E50__CTOR_OFFSET UNITYSDK_OFFSET(0x1091C1A0)

inline static constexpr unsigned int Class_1_2B4CD6A0619A0E50_TypeDefinitionIndex = 53863;
