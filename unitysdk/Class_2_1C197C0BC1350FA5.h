...
#define CLASS_2_1C197C0BC1350FA5_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16DD5B30)
#define CLASS_2_1C197C0BC1350FA5_METHOD_2_A5C4135A88AD533A_OFFSET UNITYSDK_OFFSET(0x16DD5D90)
#define CLASS_2_1C197C0BC1350FA5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16DD5B70)
#define CLASS_2_1C197C0BC1350FA5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x16DD5C80)
#define CLASS_2_1C197C0BC1350FA5_TICK_OFFSET UNITYSDK_OFFSET(0x16DD5D30)
#define CLASS_2_1C197C0BC1350FA5__CTOR_OFFSET UNITYSDK_OFFSET(0x16DD5B20)

inline static constexpr unsigned int Class_2_1C197C0BC1350FA5_TypeDefinitionIndex = 50898;

class Class_2_1C197C0BC1350FA5 : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::SyncWait* Field_2_1; // 0x20
