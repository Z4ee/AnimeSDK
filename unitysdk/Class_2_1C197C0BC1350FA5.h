...
#define CLASS_2_1C197C0BC1350FA5_DISPOSE_OFFSET UNITYSDK_OFFSET(0xBE11650)
#define CLASS_2_1C197C0BC1350FA5_METHOD_2_A5C4135A88AD533A_OFFSET UNITYSDK_OFFSET(0xBE118B0)
#define CLASS_2_1C197C0BC1350FA5_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0xBE11690)
#define CLASS_2_1C197C0BC1350FA5_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0xBE117A0)
#define CLASS_2_1C197C0BC1350FA5_TICK_OFFSET UNITYSDK_OFFSET(0xBE11850)
#define CLASS_2_1C197C0BC1350FA5__CTOR_OFFSET UNITYSDK_OFFSET(0xBE11640)
...
{
public:
	::RPG::GameCore::SyncWait* OFKGLJOAMLD; // 0x18
