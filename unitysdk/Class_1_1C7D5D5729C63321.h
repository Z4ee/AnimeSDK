...
#define CLASS_1_1C7D5D5729C63321_GET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0xBC74A40)
#define CLASS_1_1C7D5D5729C63321_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0xBC747E0)
#define CLASS_1_1C7D5D5729C63321_GET_PLAYTIME_OFFSET UNITYSDK_OFFSET(0xBC74800)
#define CLASS_1_1C7D5D5729C63321_GET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xBC74750)
#define CLASS_1_1C7D5D5729C63321_GET_UNSCALEDDELTATIME_OFFSET UNITYSDK_OFFSET(0xBC74770)
#define CLASS_1_1C7D5D5729C63321_METHOD_1_2685B6183E614529_1_OFFSET UNITYSDK_OFFSET(0xBC749E0)
#define CLASS_1_1C7D5D5729C63321_METHOD_1_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0xBC74980)
#define CLASS_1_1C7D5D5729C63321_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0xBC74790)
#define CLASS_1_1C7D5D5729C63321_METHOD_1_E8C07C74D3D8F211_OFFSET UNITYSDK_OFFSET(0xBC74A60)
#define CLASS_1_1C7D5D5729C63321_METHOD_1_FDE09C8D62639E3E_OFFSET UNITYSDK_OFFSET(0xBC74820)
#define CLASS_1_1C7D5D5729C63321_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xBC74910)
#define CLASS_1_1C7D5D5729C63321_SET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0xBC74A50)
#define CLASS_1_1C7D5D5729C63321_SET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0xBC747F0)
#define CLASS_1_1C7D5D5729C63321_SET_PLAYTIME_OFFSET UNITYSDK_OFFSET(0xBC74810)
#define CLASS_1_1C7D5D5729C63321_SET_TIMESCALE_OFFSET UNITYSDK_OFFSET(0xBC74760)
#define CLASS_1_1C7D5D5729C63321_SET_UNSCALEDDELTATIME_OFFSET UNITYSDK_OFFSET(0xBC74780)
#define CLASS_1_1C7D5D5729C63321__CTOR_OFFSET UNITYSDK_OFFSET(0xBC74AB0)

inline static constexpr unsigned int Class_1_1C7D5D5729C63321_TypeDefinitionIndex = 75513;

class Class_1_1C7D5D5729C63321 : public ::System::Object
{
public:
	::System::Single _UnscaledDeltaTime_k__BackingField; // 0x10
	::System::Single _CurrentTime_k__BackingField; // 0x14
	::System::UInt64 _CurrentFrame_k__BackingField; // 0x18
	::System::Single _PlayTime_k__BackingField; // 0x20
