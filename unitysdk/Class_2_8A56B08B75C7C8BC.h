...
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_0CAD65B68E26D548_OFFSET UNITYSDK_OFFSET(0x16ACC420)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_1167B82216E9F065_OFFSET UNITYSDK_OFFSET(0x16ACC090)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x16ACC070)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_3302777B3F94C762_OFFSET UNITYSDK_OFFSET(0x16ACC580)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_3B9A0ED1BDA79D53_OFFSET UNITYSDK_OFFSET(0x16ACC5E0)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_530316D0AFF9D418_OFFSET UNITYSDK_OFFSET(0x16ACC570)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_9A8E671C8138BCE2_OFFSET UNITYSDK_OFFSET(0x16ACC100)
#define CLASS_2_8A56B08B75C7C8BC_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x16ACC080)
#define CLASS_2_8A56B08B75C7C8BC__CTOR_OFFSET UNITYSDK_OFFSET(0x16ACC560)

inline static constexpr unsigned int Class_2_8A56B08B75C7C8BC_TypeDefinitionIndex = 81429;

class Class_2_8A56B08B75C7C8BC : public ::Class_1_C36D127C88299910
{
public:
	::MoleMole::Config::ConfigHollowCameraShake* Field_2_1; // 0x78
	...
	::Class_0_16E4307DCC419505_230* Method_2_9A8E671C8138BCE2(::MoleMole::UICameraAtom a1, ::MoleMole::UICameraAtom a2)
	{
		return ((::Class_0_16E4307DCC419505_230*(*)(::PVOID, ::MoleMole::UICameraAtom, ::MoleMole::UICameraAtom))((::PBYTE)hIl2Cpp + CLASS_2_8A56B08B75C7C8BC_METHOD_2_9A8E671C8138BCE2_OFFSET))(this, a1, a2);
	}
