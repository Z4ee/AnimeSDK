...
#define CLASS_1_B872C5A8501F8C99_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA47F10)
#define CLASS_1_B872C5A8501F8C99_GET_CANROLL_OFFSET UNITYSDK_OFFSET(0x1AA48770)
#define CLASS_1_B872C5A8501F8C99_GET_FORCESELECTBUFFID_OFFSET UNITYSDK_OFFSET(0x1AA48920)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFCOSTS_OFFSET UNITYSDK_OFFSET(0x1AA487D0)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFMAXTIMES_OFFSET UNITYSDK_OFFSET(0x1AA487B0)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFTIMES_OFFSET UNITYSDK_OFFSET(0x1AA48790)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCECURCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA48730)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCEHINTID_OFFSET UNITYSDK_OFFSET(0x1AA48710)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCETOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA48750)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFS_OFFSET UNITYSDK_OFFSET(0x1AA486F0)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTFIRSTBUFFTYPELIST_OFFSET UNITYSDK_OFFSET(0x1AA487F0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x1AA488D0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x1AA48940)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_7CBC6699BC67CE6E_OFFSET UNITYSDK_OFFSET(0x1AA480A0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_7E950285BD871BF3_OFFSET UNITYSDK_OFFSET(0x1AA481E0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_842446766C7EDE9B_OFFSET UNITYSDK_OFFSET(0x1AA48460)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_90D2A480F48CF56F_OFFSET UNITYSDK_OFFSET(0x1AA48240)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_BAE66D5654320160_OFFSET UNITYSDK_OFFSET(0x1AA484C0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1AA48050)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x1AA48660)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_F42298380B1E0FA3_OFFSET UNITYSDK_OFFSET(0x1AA48810)
#define CLASS_1_B872C5A8501F8C99_SET_CANROLL_OFFSET UNITYSDK_OFFSET(0x1AA48780)
#define CLASS_1_B872C5A8501F8C99_SET_FORCESELECTBUFFID_OFFSET UNITYSDK_OFFSET(0x1AA48930)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFCOSTS_OFFSET UNITYSDK_OFFSET(0x1AA487E0)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFMAXTIMES_OFFSET UNITYSDK_OFFSET(0x1AA487C0)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFTIMES_OFFSET UNITYSDK_OFFSET(0x1AA487A0)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCECURCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA48740)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCEHINTID_OFFSET UNITYSDK_OFFSET(0x1AA48720)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCETOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA48760)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFS_OFFSET UNITYSDK_OFFSET(0x1AA48700)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTFIRSTBUFFTYPELIST_OFFSET UNITYSDK_OFFSET(0x1AA48800)
#define CLASS_1_B872C5A8501F8C99__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA47EF0)

inline static constexpr unsigned int Class_1_B872C5A8501F8C99_TypeDefinitionIndex = 67200;
...
public:
	...
	::Class_1_5A58B1D113B4F87B* _SelectBuffs_k__BackingField; // 0x20
	::System::UInt32 _RollBuffMaxTimes_k__BackingField; // 0x28
	::System::UInt32 _ForceSelectBuffID_k__BackingField; // 0x2C
	::System::UInt32 _SelectBuffSourceCurCount_k__BackingField; // 0x30
	::System::UInt32 _RollBuffTimes_k__BackingField; // 0x34
	::System::UInt32 _SelectBuffSourceTotalCount_k__BackingField; // 0x38
	::System::Boolean _CanRoll_k__BackingField; // 0x3C
	::System::UInt32 _SelectBuffSourceHintID_k__BackingField; // 0x40
	...
	::System::Void Method_1_7CBC6699BC67CE6E(::Class_1_4AF717D30078CC7E* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_4AF717D30078CC7E*))((::PBYTE)hIl2Cpp + CLASS_1_B872C5A8501F8C99_METHOD_1_7CBC6699BC67CE6E_OFFSET))(this, a1);
	}

	::System::Void Method_1_BAE66D5654320160(::Class_1_7FF19F6206AF6DD7_85* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_7FF19F6206AF6DD7_85*))((::PBYTE)hIl2Cpp + CLASS_1_B872C5A8501F8C99_METHOD_1_BAE66D5654320160_OFFSET))(this, a1);
	}
	...
	::System::Void Method_1_F42298380B1E0FA3(::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>*))((::PBYTE)hIl2Cpp + CLASS_1_B872C5A8501F8C99_METHOD_1_F42298380B1E0FA3_OFFSET))(this, a1);
	}
