...
#define CLASS_1_B872C5A8501F8C99_DISPOSE_OFFSET UNITYSDK_OFFSET(0x13D1D0F0)
#define CLASS_1_B872C5A8501F8C99_GET_CANROLL_OFFSET UNITYSDK_OFFSET(0x13D1D950)
#define CLASS_1_B872C5A8501F8C99_GET_FORCESELECTBUFFID_OFFSET UNITYSDK_OFFSET(0x13D1DB00)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFCOSTS_OFFSET UNITYSDK_OFFSET(0x13D1D9B0)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFMAXTIMES_OFFSET UNITYSDK_OFFSET(0x13D1D990)
#define CLASS_1_B872C5A8501F8C99_GET_ROLLBUFFTIMES_OFFSET UNITYSDK_OFFSET(0x13D1D970)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCECURCOUNT_OFFSET UNITYSDK_OFFSET(0x13D1D910)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCEHINTID_OFFSET UNITYSDK_OFFSET(0x13D1D8F0)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFSOURCETOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x13D1D930)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTBUFFS_OFFSET UNITYSDK_OFFSET(0x13D1D8D0)
#define CLASS_1_B872C5A8501F8C99_GET_SELECTFIRSTBUFFTYPELIST_OFFSET UNITYSDK_OFFSET(0x13D1D9D0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x13D1DAB0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_4BCD69BFE2C685EF_OFFSET UNITYSDK_OFFSET(0x13D1D9F0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_6E57D3559C10FFA9_OFFSET UNITYSDK_OFFSET(0x13D1DB20)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_7CBC6699BC67CE6E_OFFSET UNITYSDK_OFFSET(0x13D1D280)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_7E950285BD871BF3_OFFSET UNITYSDK_OFFSET(0x13D1D3C0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_842446766C7EDE9B_OFFSET UNITYSDK_OFFSET(0x13D1D640)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_90D2A480F48CF56F_OFFSET UNITYSDK_OFFSET(0x13D1D420)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_BAE66D5654320160_OFFSET UNITYSDK_OFFSET(0x13D1D6A0)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x13D1D230)
#define CLASS_1_B872C5A8501F8C99_METHOD_1_CFE6FB160FFF5938_OFFSET UNITYSDK_OFFSET(0x13D1D840)
#define CLASS_1_B872C5A8501F8C99_SET_CANROLL_OFFSET UNITYSDK_OFFSET(0x13D1D960)
#define CLASS_1_B872C5A8501F8C99_SET_FORCESELECTBUFFID_OFFSET UNITYSDK_OFFSET(0x13D1DB10)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFCOSTS_OFFSET UNITYSDK_OFFSET(0x13D1D9C0)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFMAXTIMES_OFFSET UNITYSDK_OFFSET(0x13D1D9A0)
#define CLASS_1_B872C5A8501F8C99_SET_ROLLBUFFTIMES_OFFSET UNITYSDK_OFFSET(0x13D1D980)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCECURCOUNT_OFFSET UNITYSDK_OFFSET(0x13D1D920)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCEHINTID_OFFSET UNITYSDK_OFFSET(0x13D1D900)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFSOURCETOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x13D1D940)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTBUFFS_OFFSET UNITYSDK_OFFSET(0x13D1D8E0)
#define CLASS_1_B872C5A8501F8C99_SET_SELECTFIRSTBUFFTYPELIST_OFFSET UNITYSDK_OFFSET(0x13D1D9E0)
#define CLASS_1_B872C5A8501F8C99__CTOR_OFFSET UNITYSDK_OFFSET(0x13D1D0D0)

inline static constexpr unsigned int Class_1_B872C5A8501F8C99_TypeDefinitionIndex = 62838;

class Class_1_B872C5A8501F8C99 : public ::System::Object
{
public:
	::Class_1_5A58B1D113B4F87B* _SelectBuffs_k__BackingField; // 0x10
	::System::Collections::Generic::List_1<::System::UInt32>* _SelectFirstBuffTypeList_k__BackingField; // 0x18
	::System::Collections::Generic::List_1<::Proto::ItemCost*>* _RollBuffCosts_k__BackingField; // 0x20
	::System::UInt32 _SelectBuffSourceCurCount_k__BackingField; // 0x28
	::System::UInt32 _SelectBuffSourceTotalCount_k__BackingField; // 0x2C
	::System::UInt32 _ForceSelectBuffID_k__BackingField; // 0x30
	::System::UInt32 _SelectBuffSourceHintID_k__BackingField; // 0x34
	::System::Boolean _CanRoll_k__BackingField; // 0x38
	::System::UInt32 _RollBuffMaxTimes_k__BackingField; // 0x3C
	::System::UInt32 _RollBuffTimes_k__BackingField; // 0x40
	...
	::System::Void Method_1_7CBC6699BC67CE6E(::Class_1_C9DFE5EE7107C629_12* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_C9DFE5EE7107C629_12*))((::PBYTE)hIl2Cpp + CLASS_1_B872C5A8501F8C99_METHOD_1_7CBC6699BC67CE6E_OFFSET))(this, a1);
	}
	...
	::System::Void Method_1_90D2A480F48CF56F(::Class_1_C74059A83466814F* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_C74059A83466814F*))((::PBYTE)hIl2Cpp + CLASS_1_B872C5A8501F8C99_METHOD_1_90D2A480F48CF56F_OFFSET))(this, a1);
	}
	...
	::System::Void Method_1_4BCD69BFE2C685EF(::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>* a1)
	{
		return ((::System::Void(*)(::PVOID, ::Google::Protobuf::Collections::RepeatedField_1<::System::UInt32>*))((::PBYTE)hIl2Cpp + CLASS_1_B872C5A8501F8C99_METHOD_1_4BCD69BFE2C685EF_OFFSET))(this, a1);
	}
