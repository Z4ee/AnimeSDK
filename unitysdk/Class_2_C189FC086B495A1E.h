...
#define CLASS_2_C189FC086B495A1E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16103FC0)
#define CLASS_2_C189FC086B495A1E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x16104000)
#define CLASS_2_C189FC086B495A1E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x161043F0)
#define CLASS_2_C189FC086B495A1E_TICK_OFFSET UNITYSDK_OFFSET(0x16104440)
#define CLASS_2_C189FC086B495A1E__CTOR_OFFSET UNITYSDK_OFFSET(0x16103F90)

inline static constexpr unsigned int Class_2_C189FC086B495A1E_TypeDefinitionIndex = 55838;

class Class_2_C189FC086B495A1E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::StackProperty* OFKGLJOAMLD; // 0x18
