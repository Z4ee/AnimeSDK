...
#define CLASS_2_B3BCC9AA95120603_METHOD_2_04F02FC65FAA2E0C_OFFSET UNITYSDK_OFFSET(0x177021E0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_074AFBEAE0B41370_OFFSET UNITYSDK_OFFSET(0x176FE000)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_0D61B878F1A21897_OFFSET UNITYSDK_OFFSET(0x176FCC00)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_1B74402525A6379A_OFFSET UNITYSDK_OFFSET(0x176FFAE0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x176F7E20)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_26CB54DADCF3DED9_OFFSET UNITYSDK_OFFSET(0x176FB3B0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_283508AC3D988C69_OFFSET UNITYSDK_OFFSET(0x17703CF0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_3265AEC5435DDEBE_OFFSET UNITYSDK_OFFSET(0x176FD2A0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_33AC5C72E0EF495B_OFFSET UNITYSDK_OFFSET(0x17702070)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_37BE5ABD476D6FFB_OFFSET UNITYSDK_OFFSET(0x176FED10)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_37FF57DC5E531832_OFFSET UNITYSDK_OFFSET(0x176FD260)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_3CCA0B8A31B650A8_OFFSET UNITYSDK_OFFSET(0x176FE400)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_42B06E5564AB755F_OFFSET UNITYSDK_OFFSET(0x177006E0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_43D99DDD80B1E30C_OFFSET UNITYSDK_OFFSET(0x176FD2E0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_4404A5BA7570FF5E_OFFSET UNITYSDK_OFFSET(0x176FDC50)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_47EFDF992485ECD9_OFFSET UNITYSDK_OFFSET(0x176FF0E0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_4993EDAE54425105_OFFSET UNITYSDK_OFFSET(0x17701A60)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_4A5B7F5AD941470C_OFFSET UNITYSDK_OFFSET(0x176FF450)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_4EFB5DFB3E11A6CE_OFFSET UNITYSDK_OFFSET(0x176FDF10)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_4FD8751E0FE2002F_OFFSET UNITYSDK_OFFSET(0x176FDDB0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_559BC39C2D7E6187_OFFSET UNITYSDK_OFFSET(0x176FCB30)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_5AB4693D44B5DE04_OFFSET UNITYSDK_OFFSET(0x176FD940)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_5E1295D9A60D7FEA_OFFSET UNITYSDK_OFFSET(0x176FEF00)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_70C9B102CEA5DBB2_OFFSET UNITYSDK_OFFSET(0x176F87F0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_72A7CD49F8E09611_OFFSET UNITYSDK_OFFSET(0x176FE130)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_7641951E8337159E_OFFSET UNITYSDK_OFFSET(0x17701C00)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_7A4DC46060932235_OFFSET UNITYSDK_OFFSET(0x176F7EC0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_932B91D24BB04156_OFFSET UNITYSDK_OFFSET(0x17701EC0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x17701A70)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_958CA3E3D2C57BAA_OFFSET UNITYSDK_OFFSET(0x176FEB10)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_95B158DAED2F2E71_OFFSET UNITYSDK_OFFSET(0x176F86C0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_9A9E56F26BBA2D43_OFFSET UNITYSDK_OFFSET(0x17700D90)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_9C405B3AD04BC56B_OFFSET UNITYSDK_OFFSET(0x176F80B0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_A087E300DD2D3DE5_OFFSET UNITYSDK_OFFSET(0x17703DA0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_AF73AE834DDD4537_OFFSET UNITYSDK_OFFSET(0x177013D0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_B31940FB2128D653_OFFSET UNITYSDK_OFFSET(0x176F7E30)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_B5E22388974E906E_OFFSET UNITYSDK_OFFSET(0x176FD590)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_BAE31916328829B3_OFFSET UNITYSDK_OFFSET(0x176FE9D0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_C33DBD3EB379F2DB_OFFSET UNITYSDK_OFFSET(0x176F8590)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_C48C857453ECAFF7_OFFSET UNITYSDK_OFFSET(0x176F7FC0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_C82ADB5A7265C586_OFFSET UNITYSDK_OFFSET(0x176FF500)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x176FFAA0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_CE0DC006D21BE898_OFFSET UNITYSDK_OFFSET(0x17702160)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_CFC95121222309BD_OFFSET UNITYSDK_OFFSET(0x176FE9E0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_DA37DFE3A5BDA9F4_OFFSET UNITYSDK_OFFSET(0x17702A40)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_DDEBCDCDB6097768_OFFSET UNITYSDK_OFFSET(0x176FF5E0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_DE1856363A24C0CC_OFFSET UNITYSDK_OFFSET(0x176FDD60)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_DFFB38D72596B8E0_OFFSET UNITYSDK_OFFSET(0x176FCEF0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_E727F9956B5BD78B_OFFSET UNITYSDK_OFFSET(0x176FE950)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_EA7C9571288E1295_OFFSET UNITYSDK_OFFSET(0x176FE900)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_EBAF10BBA97B82DD_OFFSET UNITYSDK_OFFSET(0x176FE6C0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_EC03BF13D7F40502_OFFSET UNITYSDK_OFFSET(0x176F8730)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_EEE02DEC95431962_OFFSET UNITYSDK_OFFSET(0x176FF6A0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_F15EBD88E7E0FA35_OFFSET UNITYSDK_OFFSET(0x176F9040)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_F29D7A7F508EABE1_OFFSET UNITYSDK_OFFSET(0x176FE2B0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_F8E6145ED0829339_OFFSET UNITYSDK_OFFSET(0x17701AC0)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_FF69C3BC5505054C_OFFSET UNITYSDK_OFFSET(0x176FD220)
#define CLASS_2_B3BCC9AA95120603_METHOD_2_FFE24DF54B83FB77_OFFSET UNITYSDK_OFFSET(0x176F8520)
#define CLASS_2_B3BCC9AA95120603__CCTOR_OFFSET UNITYSDK_OFFSET(0x17704590)
#define CLASS_2_B3BCC9AA95120603__CTOR_OFFSET UNITYSDK_OFFSET(0x17704040)
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B3BCC9AA95120603_TypeDefinitionIndex)->GetStaticField(0x65670);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::EnviromentSystem::EnviromentPropertiesID, ::System::ValueTuple_2<::System::String*, ::System::String*>>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B3BCC9AA95120603_TypeDefinitionIndex)->GetStaticField(0x65678);
	}
	static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>** StaticGet_BKBCEJDEFGH()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B3BCC9AA95120603_TypeDefinitionIndex)->GetStaticField(0x65680);
	}
	static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>** StaticGet_JOHJPPOFKHL()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_B3BCC9AA95120603_TypeDefinitionIndex)->GetStaticField(0x65688);
	}
	static ::System::Boolean* StaticGet_ALPCEHOGGOG()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_B3BCC9AA95120603_TypeDefinitionIndex)->GetStaticField(0x15000);
	}
	::Class_1_8C728FF5E0D9FC84* EECNIMFMEPO; // 0x10
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Class_1_EAF7984A8FAD6BE4*>* BHJILPLENLK; // 0x18
	::Class_1_FE03A3C217EBE85C<::System::String*, ::System::Int32>* MIGMCEDIPPH; // 0x20
	::System::Collections::Generic::Dictionary_2<::EnviromentSystem::EnviromentPropertiesID, ::System::String*>* JAFOHFGNLDJ; // 0x28
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::Class_1_EAF7984A8FAD6BE4*>*>* LNMDFOPBCGL; // 0x30
	::System::Collections::Generic::Dictionary_2<::System::Int64, ::System::Collections::Generic::List_1<::System::String*>*>* LOKCABDKPLB; // 0x38
	::System::Collections::Generic::HashSet_1<::System::String*>* HIAKKGBPGAC; // 0x40
	::System::Collections::Generic::List_1<::Class_1_39155512A8777971*>* IFNMCHPBMDN; // 0x48
	::System::Collections::Generic::List_1<::System::String*>* NHILOAEGDJD; // 0x50
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* ACBMMCJOCMO; // 0x58
	::System::Collections::Generic::Dictionary_2<::EnviromentSystem::EnviromentPropertiesID, ::System::Int32>* AKFKOIJKAMM; // 0x60
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::EnviromentControlPriority, ::System::String*>* HFCDFGBDPGC; // 0x68
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>* DOBMODIBDPI; // 0x70
	::System::Collections::Generic::List_1<::Class_2_B3BCC9AA95120603_Struct_2_749864A93B6EEBBE>* EMMMKHJIDAL; // 0x78
	::RPG::Client::LRUCache_2<::System::String*, ::System::Tuple_2<::System::String*, ::EnviromentSystemV2Space::EnvProfileV2*>*>* PAFOEGDMBKK; // 0x80
