...
#define CLASS_1_3A66649CCA9A1059_METHOD_1_097468641FDED14E_OFFSET UNITYSDK_OFFSET(0x1C0AA6E0)
#define CLASS_1_3A66649CCA9A1059__CTOR_OFFSET UNITYSDK_OFFSET(0x1C0AA740)

inline static constexpr unsigned int Class_1_3A66649CCA9A1059_TypeDefinitionIndex = 35512;

class Class_1_3A66649CCA9A1059 : public ::System::Object
{
public:
	::Class_2_AEE59ED8DADEC1A1* GGKGFABFGFE; // 0x10
	::System::Int32 COEPLOMIKJG; // 0x18
	::System::Int32 NMKKAAGNCPC; // 0x1C
	::System::Boolean EKFGAMLDMMN; // 0x20
