...
#define CLASS_2_59B7D0D376F5D526_AUTOBINDCALLBACK_OFFSET UNITYSDK_OFFSET(0x19FED150)
#define CLASS_2_59B7D0D376F5D526_AUTOREMOVECALLBACK_OFFSET UNITYSDK_OFFSET(0x19FED270)
#define CLASS_2_59B7D0D376F5D526_GET_TOPPRIORITY_OFFSET UNITYSDK_OFFSET(0x19FECE90)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_04516DC4047C3A8D_OFFSET UNITYSDK_OFFSET(0x19FEA7D0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_061E09523E43F031_OFFSET UNITYSDK_OFFSET(0x19FEA020)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_0C44FB644D25C1C2_OFFSET UNITYSDK_OFFSET(0x19FEB530)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_0DA2366A4A7DBAA7_1_OFFSET UNITYSDK_OFFSET(0x19FEC720)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_0DA2366A4A7DBAA7_OFFSET UNITYSDK_OFFSET(0x19FE8E50)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_15286982DF950401_OFFSET UNITYSDK_OFFSET(0x19FEB240)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x19FEA740)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_1B9CC121BDC8766D_1_OFFSET UNITYSDK_OFFSET(0x19FE7480)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x19FE8AA0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_1E231E3A449E8C46_OFFSET UNITYSDK_OFFSET(0x19FE9650)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_2303E3416C24D3F9_OFFSET UNITYSDK_OFFSET(0x19FEBC70)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_254E3F47C444DDAE_OFFSET UNITYSDK_OFFSET(0x19FEBEE0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_255C4E8D50663DEF_OFFSET UNITYSDK_OFFSET(0x19FE8F50)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_25FD056A8C10B921_OFFSET UNITYSDK_OFFSET(0x19FE9890)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x19FEBB20)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_2C639A7B266E3F6B_OFFSET UNITYSDK_OFFSET(0x19FE9760)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_32B2368221A04800_OFFSET UNITYSDK_OFFSET(0x19FEC820)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_369BB5E7FA6A1768_OFFSET UNITYSDK_OFFSET(0x19FECB90)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_391A84BCD9F51317_1_OFFSET UNITYSDK_OFFSET(0x19FE7890)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x19FE7730)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_39FD7185C859CEAD_OFFSET UNITYSDK_OFFSET(0x19FE78F0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x19FEBB80)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_4389275F4099DE36_OFFSET UNITYSDK_OFFSET(0x19FE86E0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_48C86576570A48CA_OFFSET UNITYSDK_OFFSET(0x19FE8B20)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_49DF3329552800C8_OFFSET UNITYSDK_OFFSET(0x19FEC070)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_4C6A9BAF3D99BA03_OFFSET UNITYSDK_OFFSET(0x19FEA6E0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_5022DB1DC5AA8CB4_1_OFFSET UNITYSDK_OFFSET(0x19FECCC0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_5022DB1DC5AA8CB4_OFFSET UNITYSDK_OFFSET(0x19FEBD00)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_53F27F73898F1DBC_OFFSET UNITYSDK_OFFSET(0x19FEB780)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_583D59500575D856_OFFSET UNITYSDK_OFFSET(0x19FEC680)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_5C549BF7442375BC_OFFSET UNITYSDK_OFFSET(0x19FE85E0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_5DE2B5657DE4A62B_OFFSET UNITYSDK_OFFSET(0x19FEAD20)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_626867CFE8995B57_OFFSET UNITYSDK_OFFSET(0x19FEB1B0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_6345BF557E4E4E6A_OFFSET UNITYSDK_OFFSET(0x19FEC5B0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_640514F2FC7A7607_OFFSET UNITYSDK_OFFSET(0x19FEBBD0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_66C47ED41C56178D_1_OFFSET UNITYSDK_OFFSET(0x19FEAC90)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_66C47ED41C56178D_OFFSET UNITYSDK_OFFSET(0x19FEAC20)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_6E6682ED9FD6F719_OFFSET UNITYSDK_OFFSET(0x19FEBE50)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_70589F89E4D22649_OFFSET UNITYSDK_OFFSET(0x19FE7780)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_708E5A65B84D5E24_OFFSET UNITYSDK_OFFSET(0x19FEC9C0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_726B11789F671EE9_OFFSET UNITYSDK_OFFSET(0x19FEA2C0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_739DB9F245C7FAD0_OFFSET UNITYSDK_OFFSET(0x19FEBDE0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_755870B55A8B3AFF_OFFSET UNITYSDK_OFFSET(0x19FE73F0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_78F035AC71B8AE49_OFFSET UNITYSDK_OFFSET(0x19FECD80)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_7B6EC255F45D034F_OFFSET UNITYSDK_OFFSET(0x19FE8DC0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x19FE7220)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_8B1D6514BFAE88DD_OFFSET UNITYSDK_OFFSET(0x19FE93D0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_8D099DEEAF2784A3_OFFSET UNITYSDK_OFFSET(0x19FEB330)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_8D61BE16C9463302_OFFSET UNITYSDK_OFFSET(0x19FE87B0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_914575F73265A2FE_OFFSET UNITYSDK_OFFSET(0x19FEC930)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_9D22831EF77D4601_OFFSET UNITYSDK_OFFSET(0x19FE94E0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_9E79A5511E060783_OFFSET UNITYSDK_OFFSET(0x19FE9340)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_A06359FA5E17A386_OFFSET UNITYSDK_OFFSET(0x19FEA590)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_A136AB76EB5E8B3E_OFFSET UNITYSDK_OFFSET(0x19FEB590)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x19FECEF0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_A75D7A9C1392E81B_OFFSET UNITYSDK_OFFSET(0x19FEBA30)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_ABD6C60E1C36A4F4_OFFSET UNITYSDK_OFFSET(0x19FE7500)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_B1936CE4DA97AA45_OFFSET UNITYSDK_OFFSET(0x19FEA670)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_B235E757922104A8_OFFSET UNITYSDK_OFFSET(0x19FE8900)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_B881B32CDE8EA3C3_OFFSET UNITYSDK_OFFSET(0x19FEAEC0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_BCCEF225A11BDA90_OFFSET UNITYSDK_OFFSET(0x19FE7550)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_C450A961450309C9_OFFSET UNITYSDK_OFFSET(0x19FECF50)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x19FE9F90)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_CBEA6C3CA5E42755_OFFSET UNITYSDK_OFFSET(0x19FEC6D0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_D615CB28C5656CC3_OFFSET UNITYSDK_OFFSET(0x19FEC230)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_E11AC65AA0DC2249_OFFSET UNITYSDK_OFFSET(0x19FE6FD0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_EDBE0DAF47EEEEED_OFFSET UNITYSDK_OFFSET(0x19FE71A0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_F0E81349E06FF8CF_OFFSET UNITYSDK_OFFSET(0x19FE91D0)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_F37CDBD6D46274D2_OFFSET UNITYSDK_OFFSET(0x19FED040)
#define CLASS_2_59B7D0D376F5D526_METHOD_2_F74F5C57177D2273_OFFSET UNITYSDK_OFFSET(0x19FEB630)
#define CLASS_2_59B7D0D376F5D526_SET_TOPPRIORITY_OFFSET UNITYSDK_OFFSET(0x19FECEC0)
#define CLASS_2_59B7D0D376F5D526__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FEEC60)
#define CLASS_2_59B7D0D376F5D526__CTOR_OFFSET UNITYSDK_OFFSET(0x19FED360)
#define CLASS_2_59B7D0D376F5D526__ONBIND_OFFSET UNITYSDK_OFFSET(0x19FE6770)
#define CLASS_2_59B7D0D376F5D526__ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x19FE8690)
#define CLASS_2_59B7D0D376F5D526__ONTICK_OFFSET UNITYSDK_OFFSET(0x19FE75D0)

inline static constexpr unsigned int Class_2_59B7D0D376F5D526_TypeDefinitionIndex = 72295;
...
public:
	...
	{
		return (::RPG::Client::UIFloatingTextType*)Il2CppClass::FromTypeDefinitionIndex(Class_2_59B7D0D376F5D526_TypeDefinitionIndex)->GetStaticField(0x9960);
	}
	static ::System::Int32* StaticGet__TopPriority_k__BackingField()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Class_2_59B7D0D376F5D526_TypeDefinitionIndex)->GetStaticField(0x9964);
	}
	...
	::UnityEngine::SimpleAnimation* OAGGNBHMKDP; // 0x60
	::Il2CppArray<::System::String*>* BELIHCMGEAP; // 0x68
	::UnityEngine::UI::Image* EPNEIHOANLA; // 0x70
	::UnityEngine::Transform* DDIBIHFEBNN; // 0x78
	::System::Collections::Generic::List_1<::System::Tuple_2<::RPG::Client::UIFloatingTextType, ::System::String*>*>* KLKONCAMEMD; // 0x80
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::DamateTextFontStyle, ::System::String*>* INAAGBFBAHM; // 0x88
	::UnityEngine::Transform* MEAEKCCGFCN; // 0x90
	::Class_1_40540E08ABD916B4* OFAJEHEKHOJ; // 0x98
	::UnityEngine::UI::LayoutGroup* BPPBHGGCBCH; // 0xA0
	::UnityEngine::UI::ContentSizeFitter* PFIOEBPHDFI; // 0xA8
	::Class_1_C3BEB9A6D7F5D20E* DBLPPCLEGKG; // 0xB0
	::RPG::GameCore::CharacterVisibleComponent* PLDFJEONENF; // 0xB8
	::System::Collections::Generic::List_1<::RPG::Client::SimpleText*>* LGILMMCGOGL; // 0xC0
	::UnityEngine::Transform* BDGOLLLFLMC; // 0xC8
	::Class_1_C3BEB9A6D7F5D20E* EOAPKKDMOGN; // 0xD0
	::UnityEngine::UI::Image* NBMGFFBNGEI; // 0xD8
	::System::Collections::Generic::List_1<::System::Tuple_2<::RPG::Client::UIFloatingTextType, ::System::String*>*>* HAGGCOIDLBJ; // 0xE0
	::System::String* AMMFAOBBPCN; // 0xE8
	::Class_0_16E4307DCC419505_1135* OEDKHBAHFLG; // 0xF0
	::Class_1_40540E08ABD916B4* GHJINFGDKGA; // 0xF8
	::UnityEngine::Animation* BAFAAEFEBPJ; // 0x100
	::Class_1_C3BEB9A6D7F5D20E* PCFDOMBLHBK; // 0x108
	::UnityEngine::Transform* HJMKFAGJIJK; // 0x110
	::Class_1_40540E08ABD916B4* OMBGONFDNKD; // 0x118
	::Class_2_80016B9B50F708B7* DBKMNEAPLDL; // 0x120
	::System::Collections::Generic::Dictionary_2<::RPG::GameCore::DamateTextFontStyle, ::UnityEngine::Font*>* AKNJNJCEFHI; // 0x128
	::System::Collections::Generic::List_1<::Class_2_59B7D0D376F5D526_Class_0_16E7307DCC43CB2C_25*>* HJFBEPJBHEA; // 0x130
	::System::Collections::Generic::List_1<::System::Tuple_2<::RPG::Client::UIFloatingTextType, ::System::String*>*>* DHFGJOEDJEK; // 0x138
	::Il2CppArray<::UnityEngine::Transform*>* KDNFAENPGMO; // 0x140
	::RPG::Client::PrefabLoadMeta* LDGBDIOFKMG; // 0x148
	::System::Collections::Generic::HashSet_1<::System::String*>* GIPEKGCEBKE; // 0x150
	::Il2CppArray<::Class_1_C3BEB9A6D7F5D20E*>* PCIIKFOIAJA; // 0x158
	::System::Collections::Generic::List_1<::Class_1_40540E08ABD916B4*>* BBBAHLJAIGL; // 0x160
	::Class_1_C3BEB9A6D7F5D20E* GNOKHINJONA; // 0x168
	::RPG::Client::UIFollow3DTarget* MCMALLKMDNC; // 0x170
	::Class_1_F7F129640441419D* PICMKGJOBLH; // 0x178
	::Class_1_C3BEB9A6D7F5D20E* JMOHIINCDJO; // 0x180
	::Class_1_40540E08ABD916B4* NNOEDFOPALA; // 0x188
	::UnityEngine::CanvasGroup* LDECKNEDNPI; // 0x190
	::UnityEngine::Transform* FCIHODBGEFL; // 0x198
	::RPG::GameCore::GameEntity* OJAHLJGABMJ; // 0x1A0
	::UnityEngine::RectTransform* NEEDDJHCCND; // 0x1A8
	::UnityEngine::Transform* LFGMLJCCPCH; // 0x1B0
	::RPG::GameCore::UIDamageTextType DBNPLBHAGAK; // 0x1B8
	::System::Boolean MCAPIAKDMAA; // 0x1BC
	::System::Boolean MKMANBDNKOE; // 0x1BD
	::System::Boolean FMNEEONAMNO; // 0x1BE
	::System::Single HBDJCFFDGDD; // 0x1C0
	::System::Single NGMPALMFOKL; // 0x1C4
	::System::Boolean JFICJNIJEEF; // 0x1C8
	::System::Boolean POGICBHCJIB; // 0x1C9
	::RPG::GameCore::TeamType AHJJPBGGOMK; // 0x1CC
	::RPG::GameCore::DamateTextFontStyle IJMCKCJJKIO; // 0x1D0
	::System::Single IONFONLCDPF; // 0x1D4
	::UnityEngine::Vector2 IDGKNMLPGDL; // 0x1D8
