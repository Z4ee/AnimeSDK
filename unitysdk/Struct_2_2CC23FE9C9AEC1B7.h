...
#define STRUCT_2_2CC23FE9C9AEC1B7_METHOD_2_0768FBB1D95A9ECC_OFFSET UNITYSDK_OFFSET(0x13A4C080)
#define STRUCT_2_2CC23FE9C9AEC1B7_METHOD_2_F9A93D24814FDC13_OFFSET UNITYSDK_OFFSET(0x7BF220)

inline static constexpr unsigned int Struct_2_2CC23FE9C9AEC1B7_TypeDefinitionIndex = 50399;

struct alignas(8) Struct_2_2CC23FE9C9AEC1B7
{
	::Enum_3_1FD1CECAB456A68E Field_2_0; // 0x10
	::System::UInt32 Field_2_1; // 0x14
	::UnityEngine::GameObject* Field_2_2; // 0x18
	::MoleMole::Config::CampType Field_2_3; // 0x20
	::System::Single Field_2_4; // 0x24
	::Enum_3_ABFC2C2AD6FA0905 Field_2_5; // 0x28
