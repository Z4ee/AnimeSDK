...
#define CLASS_3_2D9CC120C3114C37_GETCLASSID_OFFSET UNITYSDK_OFFSET(0xE8F5A40)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_2503976170FFA354_OFFSET UNITYSDK_OFFSET(0xE8F55C0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_365F29BEAE9055AF_OFFSET UNITYSDK_OFFSET(0xE8F60C0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_46D78B8894C3D058_OFFSET UNITYSDK_OFFSET(0xE8F5950)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_52FB29FB5E593F19_OFFSET UNITYSDK_OFFSET(0xE8F6790)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_543A0015448C59F2_OFFSET UNITYSDK_OFFSET(0xE8F6280)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_5C8BA5F8E857A2FC_OFFSET UNITYSDK_OFFSET(0xE8F5BD0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_81C4E2D1295BCC95_OFFSET UNITYSDK_OFFSET(0xE8F5FA0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xE8F5CE0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_B2AE43CACB777B2F_OFFSET UNITYSDK_OFFSET(0xE8F67B0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_C38DE0E34C398638_OFFSET UNITYSDK_OFFSET(0xE8F5D70)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xE8F6780)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0xE8F5B50)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_DFBA32323EBA8DC1_OFFSET UNITYSDK_OFFSET(0xE8F67A0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0xE8F5CD0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xE8F5B40)
#define CLASS_3_2D9CC120C3114C37_ONCLEAN_OFFSET UNITYSDK_OFFSET(0xE8F5430)
#define CLASS_3_2D9CC120C3114C37__CCTOR_OFFSET UNITYSDK_OFFSET(0xE8F5A90)
#define CLASS_3_2D9CC120C3114C37__CTOR_OFFSET UNITYSDK_OFFSET(0xE8F5B30)

inline static constexpr unsigned int Class_3_2D9CC120C3114C37_TypeDefinitionIndex = 62189;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_2D9CC120C3114C37_TypeDefinitionIndex)->GetStaticField(0x36800);
	}
	// static const ::System::Int32 Field_3_14 = 0x66; // 0x0
	::System::Collections::Generic::List_1<::Class_3_2D9CC120C3114C37_Struct_2_7D740BB091DF59E1>* Field_3_13; // 0x48
	::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::ParticleSystem_Particle>*>* Field_3_9; // 0x50
	::MoleMole::MonoEffectPluginFollow* Field_3_1; // 0x58
	::System::Nullable_1<::UnityEngine::RaycastHit> Field_3_5; // 0x60
	::System::Int32 Field_3_0; // 0x98
	::Class_3_2D9CC120C3114C37_Enum_3_6A7C46D848DB3953 Field_3_11; // 0x9C
	::UnityEngine::Vector3 Field_3_6; // 0xA0
	::System::UInt16 Field_3_2; // 0xAC
	::UnityEngine::Quaternion Field_3_7; // 0xB0
	::System::Boolean Field_3_12; // 0xC0
	::System::Boolean Field_3_10; // 0xC1
	::System::Boolean Field_3_3; // 0xC2
	::UnityEngine::Vector3 Field_3_8; // 0xC4
