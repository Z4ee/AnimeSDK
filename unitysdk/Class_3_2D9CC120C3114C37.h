...
#define CLASS_3_2D9CC120C3114C37_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x11B45CB0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_2503976170FFA354_OFFSET UNITYSDK_OFFSET(0x11B45830)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_365F29BEAE9055AF_OFFSET UNITYSDK_OFFSET(0x11B463D0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_3A37670C2827DA9B_OFFSET UNITYSDK_OFFSET(0x11B461A0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_46D78B8894C3D058_OFFSET UNITYSDK_OFFSET(0x11B45BC0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_52FB29FB5E593F19_OFFSET UNITYSDK_OFFSET(0x11B46A90)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_543A0015448C59F2_OFFSET UNITYSDK_OFFSET(0x11B46590)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_5C8BA5F8E857A2FC_OFFSET UNITYSDK_OFFSET(0x11B45F90)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_81C4E2D1295BCC95_OFFSET UNITYSDK_OFFSET(0x11B46090)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x11B46B40)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_B2AE43CACB777B2F_OFFSET UNITYSDK_OFFSET(0x11B45DD0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x11B45DC0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x11B46AB0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_DFBA32323EBA8DC1_OFFSET UNITYSDK_OFFSET(0x11B45DB0)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x11B46B30)
#define CLASS_3_2D9CC120C3114C37_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x11B46AA0)
#define CLASS_3_2D9CC120C3114C37_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x11B456B0)
#define CLASS_3_2D9CC120C3114C37__CCTOR_OFFSET UNITYSDK_OFFSET(0x11B45D00)
#define CLASS_3_2D9CC120C3114C37__CTOR_OFFSET UNITYSDK_OFFSET(0x11B45DA0)

inline static constexpr unsigned int Class_3_2D9CC120C3114C37_TypeDefinitionIndex = 57234;

class Class_3_2D9CC120C3114C37 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_Field_3_5()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_3_2D9CC120C3114C37_TypeDefinitionIndex)->GetStaticField(0x4BC20);
	}
	// static const ::System::Int32 Field_3_19 = 0x6A; // 0x0
	::MoleMole::MonoEffectPluginFollow* Field_3_0; // 0x48
	::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::ParticleSystem_Particle>*>* Field_3_8; // 0x50
	::System::Collections::Generic::List_1<::Class_3_2D9CC120C3114C37_Struct_2_7D740BB091DF59E1>* Field_3_12; // 0x58
	::Class_3_2D9CC120C3114C37_Enum_3_6A7C46D848DB3953 Field_3_14; // 0x60
	::UnityEngine::Vector3 Field_3_11; // 0x64
	::System::Int32 Field_3_1; // 0x70
	::UnityEngine::Quaternion Field_3_10; // 0x74
	::System::Nullable_1<::UnityEngine::RaycastHit> Field_3_4; // 0x84
	::UnityEngine::Vector3 Field_3_9; // 0xBC
	::System::Boolean Field_3_15; // 0xC8
	::System::UInt16 Field_3_7; // 0xCA
	::System::Boolean Field_3_6; // 0xCC
	::System::Boolean Field_3_13; // 0xCD
	...
	::System::Void Method_3_3A37670C2827DA9B(::System::Object* a1)
	{
		return ((::System::Void(*)(::PVOID, ::System::Object*))((::PBYTE)hIl2Cpp + CLASS_3_2D9CC120C3114C37_METHOD_3_3A37670C2827DA9B_OFFSET))(this, a1);
	}
