...
#define CLASS_2_9A5A56983985339D_GET_DRAGDELTARATIO_OFFSET UNITYSDK_OFFSET(0x1193AC90)
#define CLASS_2_9A5A56983985339D_GET_GAMEPADDRAGSPEED_OFFSET UNITYSDK_OFFSET(0x1193ACA0)
#define CLASS_2_9A5A56983985339D_METHOD_2_2607E225A39E6739_OFFSET UNITYSDK_OFFSET(0x1193ACB0)
#define CLASS_2_9A5A56983985339D_METHOD_2_6A44D992A1239C6A_OFFSET UNITYSDK_OFFSET(0x1193ACC0)
#define CLASS_2_9A5A56983985339D_METHOD_2_84B92802FDAFF6C8_OFFSET UNITYSDK_OFFSET(0x1193B010)
#define CLASS_2_9A5A56983985339D_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x1193B270)
#define CLASS_2_9A5A56983985339D_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x1193AFD0)
#define CLASS_2_9A5A56983985339D_METHOD_2_CA6BDDCC5F7CE11E_OFFSET UNITYSDK_OFFSET(0x1193AEF0)
#define CLASS_2_9A5A56983985339D_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1193AF70)
#define CLASS_2_9A5A56983985339D__CTOR_OFFSET UNITYSDK_OFFSET(0x1193AD40)

inline static constexpr unsigned int Class_2_9A5A56983985339D_TypeDefinitionIndex = 71522;
...
public:
	...
	::System::Single _DragDeltaRatio_k__BackingField; // 0x38
