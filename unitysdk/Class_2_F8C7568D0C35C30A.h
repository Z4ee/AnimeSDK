...
#define CLASS_2_F8C7568D0C35C30A_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x973BC30)
#define CLASS_2_F8C7568D0C35C30A_METHOD_2_1B80EE1C517B1E05_OFFSET UNITYSDK_OFFSET(0x973BB20)
#define CLASS_2_F8C7568D0C35C30A_METHOD_2_3EDC18A5268B65E7_OFFSET UNITYSDK_OFFSET(0x973BC50)
#define CLASS_2_F8C7568D0C35C30A_METHOD_2_56CE4AFC5339F746_OFFSET UNITYSDK_OFFSET(0x973BA50)
#define CLASS_2_F8C7568D0C35C30A_METHOD_2_88616CED425F4077_OFFSET UNITYSDK_OFFSET(0x973BAA0)
#define CLASS_2_F8C7568D0C35C30A_METHOD_2_CE4CE294A670DA1B_OFFSET UNITYSDK_OFFSET(0x973BCC0)
#define CLASS_2_F8C7568D0C35C30A_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x973BC40)
#define CLASS_2_F8C7568D0C35C30A__CTOR_OFFSET UNITYSDK_OFFSET(0x973BA00)

inline static constexpr unsigned int Class_2_F8C7568D0C35C30A_TypeDefinitionIndex = 52554;

class Class_2_F8C7568D0C35C30A : public ::Class_1_9CEAB4C068D9D9DB
{
public:
	::Class_2_C14C025AFA60DCA2* Field_2_1; // 0x68
	::RPG::GameCore::AdventureAbilityComponent* Field_2_2; // 0x70
