...
#define CLASS_2_AD7CCA6F8C21249E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x198EBBC0)
#define CLASS_2_AD7CCA6F8C21249E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x198EBC00)
#define CLASS_2_AD7CCA6F8C21249E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x198EBEC0)
#define CLASS_2_AD7CCA6F8C21249E_TICK_OFFSET UNITYSDK_OFFSET(0x198EBF10)
#define CLASS_2_AD7CCA6F8C21249E__CTOR_OFFSET UNITYSDK_OFFSET(0x198EBBB0)

inline static constexpr unsigned int Class_2_AD7CCA6F8C21249E_TypeDefinitionIndex = 58809;

class Class_2_AD7CCA6F8C21249E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowGuideText* OFKGLJOAMLD; // 0x18
