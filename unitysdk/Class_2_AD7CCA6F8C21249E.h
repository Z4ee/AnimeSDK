...
#define CLASS_2_AD7CCA6F8C21249E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C29DB0)
#define CLASS_2_AD7CCA6F8C21249E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x8C29DF0)
#define CLASS_2_AD7CCA6F8C21249E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x8C2A0B0)
#define CLASS_2_AD7CCA6F8C21249E_TICK_OFFSET UNITYSDK_OFFSET(0x8C2A100)
#define CLASS_2_AD7CCA6F8C21249E__CTOR_OFFSET UNITYSDK_OFFSET(0x8C29DA0)

inline static constexpr unsigned int Class_2_AD7CCA6F8C21249E_TypeDefinitionIndex = 47347;

class Class_2_AD7CCA6F8C21249E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::ShowGuideText* Field_2_0; // 0x18
