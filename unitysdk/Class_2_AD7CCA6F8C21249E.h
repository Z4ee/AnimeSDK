...
#define CLASS_2_AD7CCA6F8C21249E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15EA7BF0)
#define CLASS_2_AD7CCA6F8C21249E_ONTASKBEGIN_OFFSET UNITYSDK_OFFSET(0x15EA7C30)
#define CLASS_2_AD7CCA6F8C21249E_ONTASKRESET_OFFSET UNITYSDK_OFFSET(0x15EA7EF0)
#define CLASS_2_AD7CCA6F8C21249E_TICK_OFFSET UNITYSDK_OFFSET(0x15EA7F40)
#define CLASS_2_AD7CCA6F8C21249E__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA7BE0)

inline static constexpr unsigned int Class_2_AD7CCA6F8C21249E_TypeDefinitionIndex = 56034;

class Class_2_AD7CCA6F8C21249E : public ::Class_1_5F51D4049EA87B7B
{
public:
	::RPG::GameCore::TaskContext* Field_2_0; // 0x18
	::RPG::GameCore::ShowGuideText* Field_2_1; // 0x20
