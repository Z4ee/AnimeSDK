...
#define CLASS_1_C9E417278351157F_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DEBFDB0)
#define CLASS_1_C9E417278351157F_CLONE_OFFSET UNITYSDK_OFFSET(0x1DEBF950)
#define CLASS_1_C9E417278351157F_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DEBFA80)
#define CLASS_1_C9E417278351157F_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DEBFA30)
#define CLASS_1_C9E417278351157F_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DEBFB60)
#define CLASS_1_C9E417278351157F_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DEC00C0)
#define CLASS_1_C9E417278351157F_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DEC0060)
#define CLASS_1_C9E417278351157F_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1DEBFA10)
#define CLASS_1_C9E417278351157F_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1DEBF9F0)
#define CLASS_1_C9E417278351157F_METHOD_1_4C4B9DFE092840D4_1_OFFSET UNITYSDK_OFFSET(0x1DEBF9E0)
#define CLASS_1_C9E417278351157F_METHOD_1_4C4B9DFE092840D4_OFFSET UNITYSDK_OFFSET(0x1DEBF9C0)
#define CLASS_1_C9E417278351157F_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1DEBF8C0)
#define CLASS_1_C9E417278351157F_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1DEBFA20)
#define CLASS_1_C9E417278351157F_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1DEBFA00)
#define CLASS_1_C9E417278351157F_METHOD_1_7ADD5F1F5E247E3B_1_OFFSET UNITYSDK_OFFSET(0x1DEBF9D0)
#define CLASS_1_C9E417278351157F_METHOD_1_7ADD5F1F5E247E3B_OFFSET UNITYSDK_OFFSET(0x1DEBF9B0)
#define CLASS_1_C9E417278351157F_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DEBF8F0)
#define CLASS_1_C9E417278351157F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DEBFBC0)
#define CLASS_1_C9E417278351157F_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DEBFC20)
#define CLASS_1_C9E417278351157F__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DEC0160)
#define CLASS_1_C9E417278351157F__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DEBF910)
#define CLASS_1_C9E417278351157F__CTOR_OFFSET UNITYSDK_OFFSET(0x1DEBF900)

inline static constexpr unsigned int Class_1_C9E417278351157F_TypeDefinitionIndex = 24974;

class Class_1_C9E417278351157F : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_C9E417278351157F*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_C9E417278351157F*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C9E417278351157F_TypeDefinitionIndex)->GetStaticField(0x3AEA0);
	}
	// static const ::System::Int32 INPMBLCHNGN = 0x1; // 0x0
	// static const ::System::Int32 FIEMKPOELCD = 0x2; // 0x0
	// static const ::System::Int32 EGOMBEJDAMI = 0x3; // 0x0
	// static const ::System::Int32 OKCNBHOLMKD = 0x4; // 0x0
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x10
	::System::Int64 MFHNPAODGGN; // 0x18
	::System::UInt32 APBOGHGFGLC; // 0x20
	::System::UInt32 JPGEGCNOJJC; // 0x24
