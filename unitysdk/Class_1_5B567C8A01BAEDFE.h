...
#define CLASS_1_5B567C8A01BAEDFE_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1DD7B610)
#define CLASS_1_5B567C8A01BAEDFE_CLONE_OFFSET UNITYSDK_OFFSET(0x1DD67BD0)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1DD7B440)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1DD7B350)
#define CLASS_1_5B567C8A01BAEDFE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1DD68D40)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1DD7B630)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1DD6A3D0)
#define CLASS_1_5B567C8A01BAEDFE_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1DD7B2B0)
#define CLASS_1_5B567C8A01BAEDFE_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1DD7B310)
#define CLASS_1_5B567C8A01BAEDFE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1DD7B5A0)
#define CLASS_1_5B567C8A01BAEDFE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1DD7B600)
#define CLASS_1_5B567C8A01BAEDFE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1DD7B680)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1DD7B320)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1DD6A3C0)
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_TypeDefinitionIndex)->GetStaticField(0x15280);
	}
