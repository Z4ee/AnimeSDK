...
#define CLASS_1_5B567C8A01BAEDFE_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1A4B1C20)
#define CLASS_1_5B567C8A01BAEDFE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A4B1A30)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A4B1B30)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A4B1AA0)
#define CLASS_1_5B567C8A01BAEDFE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A4B1B80)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A4B1C70)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1A4B1C40)
#define CLASS_1_5B567C8A01BAEDFE_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1A4B1980)
#define CLASS_1_5B567C8A01BAEDFE_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1A4B19E0)
#define CLASS_1_5B567C8A01BAEDFE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4B1BB0)
#define CLASS_1_5B567C8A01BAEDFE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A4B1C10)
#define CLASS_1_5B567C8A01BAEDFE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4B1CC0)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4B1A00)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B19F0)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_TypeDefinitionIndex = 23818;
...
public:
	...
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_TypeDefinitionIndex)->GetStaticField(0x52D0);
	}
