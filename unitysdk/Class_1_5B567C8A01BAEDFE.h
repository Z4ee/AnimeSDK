...
#define CLASS_1_5B567C8A01BAEDFE_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E3FE070)
#define CLASS_1_5B567C8A01BAEDFE_CLONE_OFFSET UNITYSDK_OFFSET(0x1E3EA630)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E3FDEA0)
#define CLASS_1_5B567C8A01BAEDFE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E3FDDB0)
#define CLASS_1_5B567C8A01BAEDFE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E3EB7A0)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E3FE090)
#define CLASS_1_5B567C8A01BAEDFE_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E3ECE30)
#define CLASS_1_5B567C8A01BAEDFE_METHOD_1_33819E510657F52F_OFFSET UNITYSDK_OFFSET(0x1E3FDD10)
#define CLASS_1_5B567C8A01BAEDFE_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E3FDD70)
#define CLASS_1_5B567C8A01BAEDFE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E3FE000)
#define CLASS_1_5B567C8A01BAEDFE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E3FE060)
#define CLASS_1_5B567C8A01BAEDFE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E3FE0E0)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E3FDD80)
#define CLASS_1_5B567C8A01BAEDFE__CTOR_OFFSET UNITYSDK_OFFSET(0x1E3ECE20)

inline static constexpr unsigned int Class_1_5B567C8A01BAEDFE_TypeDefinitionIndex = 24902;

class Class_1_5B567C8A01BAEDFE : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_5B567C8A01BAEDFE*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5B567C8A01BAEDFE_TypeDefinitionIndex)->GetStaticField(0x142A0);
	}
