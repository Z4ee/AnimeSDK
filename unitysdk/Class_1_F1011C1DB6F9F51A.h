...
#define CLASS_1_F1011C1DB6F9F51A_GET_FILLEDCOUNT_OFFSET UNITYSDK_OFFSET(0x152085E0)
#define CLASS_1_F1011C1DB6F9F51A_GET_MAXCASTCOUNT_OFFSET UNITYSDK_OFFSET(0x152085C0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_03A81715BD2AFEF3_OFFSET UNITYSDK_OFFSET(0x15206F20)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_0DF420E95D6252BE_OFFSET UNITYSDK_OFFSET(0x15207100)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_1808E1CF7A125519_1_OFFSET UNITYSDK_OFFSET(0x15208650)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x152073A0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x152086B0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_2372762F4122DEB8_OFFSET UNITYSDK_OFFSET(0x152080F0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_37011B6DDBE4CF26_OFFSET UNITYSDK_OFFSET(0x15207270)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x15208600)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_3B7145E79424FB75_OFFSET UNITYSDK_OFFSET(0x15206B70)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_420F5543CED5025E_OFFSET UNITYSDK_OFFSET(0x15207BF0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x15206AE0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_4DA6D4A624E42CAB_OFFSET UNITYSDK_OFFSET(0x15207DD0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_4F8C91A8E36C9915_OFFSET UNITYSDK_OFFSET(0x15207E60)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_565211B377738E7A_OFFSET UNITYSDK_OFFSET(0x152067E0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_648916894895FB4D_OFFSET UNITYSDK_OFFSET(0x15207D40)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_6A99795238E657E2_OFFSET UNITYSDK_OFFSET(0x15207610)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_945C71A133E8FA09_OFFSET UNITYSDK_OFFSET(0x15207410)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_95BFADB170F8A42D_OFFSET UNITYSDK_OFFSET(0x15208010)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_A8C8FFA164F2128F_OFFSET UNITYSDK_OFFSET(0x15207220)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_AFA2B05CEDE590D4_OFFSET UNITYSDK_OFFSET(0x152077F0)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_CDB67F8643E189E2_OFFSET UNITYSDK_OFFSET(0x15207A60)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_CE025011FFADCC65_OFFSET UNITYSDK_OFFSET(0x15208150)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_DF051B4CCEC70F95_OFFSET UNITYSDK_OFFSET(0x15206890)
#define CLASS_1_F1011C1DB6F9F51A_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x152070B0)
#define CLASS_1_F1011C1DB6F9F51A_SET_FILLEDCOUNT_OFFSET UNITYSDK_OFFSET(0x152085F0)
#define CLASS_1_F1011C1DB6F9F51A_SET_MAXCASTCOUNT_OFFSET UNITYSDK_OFFSET(0x152085D0)
#define CLASS_1_F1011C1DB6F9F51A__CTOR_OFFSET UNITYSDK_OFFSET(0x15206880)

inline static constexpr unsigned int Class_1_F1011C1DB6F9F51A_TypeDefinitionIndex = 71804;

class Class_1_F1011C1DB6F9F51A : public ::System::Object
{
public:
	// static const ::System::String* CKMGLBMIEAM; // 0x0
	::Class_1_A474572029D08468* ABOBEBEOHPA; // 0x10
	::RPG::GameCore::SkillData* OCOIDGHBAEH; // 0x18
	::Class_1_B803CA670C4DC569* MBBLBGCMALM; // 0x20
	::RPG::GameCore::GameEntity* JDIDAGMBKEL; // 0x28
	::RPG::GameCore::BattleInstance* IFKCCHIFMOC; // 0x30
	::RPG::Client::TextID AGOHEFBOPNO; // 0x38
	::RPG::Client::UISkillIndex FFNBLDFFMCN; // 0x48
	::System::Int32 _FilledCount_k__BackingField; // 0x4C
	::System::Nullable_1<::System::Int32> IOBINHIJKEJ; // 0x50
	::System::Boolean DLGFMPNEHGO; // 0x58
	::System::Boolean FGCCKIKHLGK; // 0x59
