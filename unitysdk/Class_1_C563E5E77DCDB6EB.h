...
#define CLASS_1_C563E5E77DCDB6EB__CTOR_OFFSET UNITYSDK_OFFSET(0x1C4BCA50)
...
public:
	...
	::RPG::Client::LittleGame::ChimeraDuelSettleReason JEHOMBANNLM; // 0x18
	::System::UInt32 HCDNAPNIAJH; // 0x1C
	::System::UInt32 FJPBONGDHLF; // 0x20
