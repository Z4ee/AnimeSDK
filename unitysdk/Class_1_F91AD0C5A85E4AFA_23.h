...
#define CLASS_1_F91AD0C5A85E4AFA_23_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x1E4CE7D0)
#define CLASS_1_F91AD0C5A85E4AFA_23_CLONE_OFFSET UNITYSDK_OFFSET(0x1E4CE120)
#define CLASS_1_F91AD0C5A85E4AFA_23_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1E4CE370)
#define CLASS_1_F91AD0C5A85E4AFA_23_EQUALS_OFFSET UNITYSDK_OFFSET(0x1E4CE2B0)
#define CLASS_1_F91AD0C5A85E4AFA_23_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1E4CE420)
#define CLASS_1_F91AD0C5A85E4AFA_23_MERGEFROM_1_OFFSET UNITYSDK_OFFSET(0x1E4CEA80)
#define CLASS_1_F91AD0C5A85E4AFA_23_MERGEFROM_OFFSET UNITYSDK_OFFSET(0x1E4CEA00)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_02A3D10A9D535169_1_OFFSET UNITYSDK_OFFSET(0x1E4CE270)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_02A3D10A9D535169_2_OFFSET UNITYSDK_OFFSET(0x1E4CE290)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x1E4CE250)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_050E70FEDB783306_1_OFFSET UNITYSDK_OFFSET(0x1E4CE200)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_050E70FEDB783306_OFFSET UNITYSDK_OFFSET(0x1E4CE1A0)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_126AB3935214AA22_1_OFFSET UNITYSDK_OFFSET(0x1E4CE1F0)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_126AB3935214AA22_OFFSET UNITYSDK_OFFSET(0x1E4CE190)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_685747EAFC9F7288_OFFSET UNITYSDK_OFFSET(0x1E4CE060)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_7786DC814C2FC3BE_1_OFFSET UNITYSDK_OFFSET(0x1E4CE280)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_7786DC814C2FC3BE_2_OFFSET UNITYSDK_OFFSET(0x1E4CE2A0)
#define CLASS_1_F91AD0C5A85E4AFA_23_METHOD_1_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x1E4CE260)
#define CLASS_1_F91AD0C5A85E4AFA_23_PB__GOOGLE_PROTOBUF_IMESSAGE_GET_DESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1E4CE090)
#define CLASS_1_F91AD0C5A85E4AFA_23_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1E4CE560)
#define CLASS_1_F91AD0C5A85E4AFA_23_WRITETO_OFFSET UNITYSDK_OFFSET(0x1E4CE5C0)
#define CLASS_1_F91AD0C5A85E4AFA_23__CCTOR_OFFSET UNITYSDK_OFFSET(0x1E4CEBA0)
#define CLASS_1_F91AD0C5A85E4AFA_23__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1E4CE0C0)
#define CLASS_1_F91AD0C5A85E4AFA_23__CTOR_OFFSET UNITYSDK_OFFSET(0x1E4CE0A0)

inline static constexpr unsigned int Class_1_F91AD0C5A85E4AFA_23_TypeDefinitionIndex = 31406;

class Class_1_F91AD0C5A85E4AFA_23 : public ::System::Object
{
public:
	static ::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_23*>** StaticGet_CHLCMCKIGKG()
	{
		return (::Google::Protobuf::MessageParser_1<::Class_1_F91AD0C5A85E4AFA_23*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F91AD0C5A85E4AFA_23_TypeDefinitionIndex)->GetStaticField(0xBCE0);
	}
	// static const ::System::Int32 JKOGPMLPGJJ = 0xC; // 0x0
	// static const ::System::Int32 AHBMGKCFAEL = 0x2; // 0x0
	// static const ::System::Int32 GIACAJKKEJF = 0xE; // 0x0
	// static const ::System::Int32 PLDKENJLKME = 0xF; // 0x0
	// static const ::System::Int32 FPIOLKELJJG = 0x6; // 0x0
	::System::String* NCFALPOHOLI; // 0x10
	::System::String* ACKBJCBOLAK; // 0x18
	::Google::Protobuf::UnknownFieldSet* DHHIJOGAOFI; // 0x20
	::System::UInt32 NAEACGPKNNH; // 0x28
	::System::UInt32 KFLKHNMNBLE; // 0x2C
	::System::UInt32 BHHCNHCDDMA; // 0x30
